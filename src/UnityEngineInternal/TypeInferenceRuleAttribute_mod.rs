...
#[cfg(feature = "cordl_class_UnityEngineInternal+TypeInferenceRuleAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngineInternal::TypeInferenceRuleAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngineInternal";
    const CLASS_NAME: &'static str = "TypeInferenceRuleAttribute";
...
impl crate::UnityEngineInternal::TypeInferenceRuleAttribute {
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rule))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TypeInferenceRules0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (crate::UnityEngineInternal::TypeInferenceRules),
                        quest_hook::libil2cpp::Void,
                        1usize,
                    >(".ctor")
                    .unwrap_or_else(|e| {
...
#[cfg(feature = "cordl_class_UnityEngineInternal+TypeInferenceRuleAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngineInternal::TypeInferenceRuleAttribute {
