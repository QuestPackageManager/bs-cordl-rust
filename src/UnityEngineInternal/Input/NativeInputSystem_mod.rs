#[cfg(feature = "cordl_class_UnityEngineInternal+Input+NativeInputSystem")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngineInternal+Input+NativeInputSystem")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngineInternal::Input::NativeInputSystem {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngineInternal.Input";
    const CLASS_NAME: &'static str = "NativeInputSystem";
...
impl crate::UnityEngineInternal::Input::NativeInputSystem {
    ...
    pub fn GetScrollWheelDeltaPerTick() -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), f32, 0usize>("GetScrollWheelDeltaPerTick")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn IOCTL(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32, i32, crate::System::IntPtr, i32), i64, 4usize>(
                        "IOCTL",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked((), (deviceId, code, data, sizeInBytes))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn NotifyDeviceDiscovered(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (deviceId, deviceDescriptor))? };
        Ok(__cordl_ret.into())
    }
    pub fn NotifyUpdate(
        updateType: crate::UnityEngineInternal::Input::NativeInputUpdateType,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::UnityEngineInternal::Input::NativeInputUpdateType,
                        crate::System::IntPtr,
                    ), quest_hook::libil2cpp::Void, 2usize>("NotifyUpdate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (updateType, eventBuffer))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetPollingFrequency(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (hertz))? };
        Ok(__cordl_ret.into())
    }
    pub fn ShouldRunUpdate(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("ShouldRunUpdate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (updateType, retval))? };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
        updateType: crate::UnityEngineInternal::Input::NativeInputUpdateType,
    ...
    pub fn get_currentTimeOffsetToRealtimeSinceStartup() -> quest_hook::libil2cpp::Result<f64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), f64, 0usize>(
    ...
    pub fn get_normalizeScrollWheelDelta() -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), bool, 0usize>("get_normalizeScrollWheelDelta")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngineInternal+Input+NativeInputSystem")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngineInternal::Input::NativeInputSystem {
