...
impl crate::UnityEngineInternal::Input::NativeUpdateCallback {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (updateType, buffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
#[cfg(feature = "cordl_class_UnityEngineInternal+Input+NativeUpdateCallback")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngineInternal::Input::NativeUpdateCallback {
