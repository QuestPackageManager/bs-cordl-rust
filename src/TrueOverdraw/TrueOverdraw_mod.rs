...
impl crate::TrueOverdraw::TrueOverdraw {
    ...
    pub fn ResolveRendererColor(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Renderer>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Material>,
                    ), crate::UnityEngine::Color, 2usize>("ResolveRendererColor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::Color =
            unsafe { cordl_method_info.invoke_unchecked((), (renderer, material))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetGlobalFloats(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (trueOverdraw, opaque, transparent))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetMaterialValues(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("SetMaterialValues")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (material, color))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetOverdrawValues(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (opaque, transparent))? };
        Ok(__cordl_ret.into())
    }
    pub fn ShowEverything(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn ShowOnlyOpaque(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn ShowOnlyTransparent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ShowOnlyTransparent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_overdrawType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::TrueOverdraw::TrueOverdraw_OverdrawType, 0usize>(
                        "get_overdrawType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::TrueOverdraw::TrueOverdraw_OverdrawType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_TrueOverdraw+TrueOverdraw+OverdrawType")]
unsafe impl quest_hook::libil2cpp::Type for crate::TrueOverdraw::TrueOverdraw_OverdrawType {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "TrueOverdraw";
...
#[cfg(feature = "cordl_class_TrueOverdraw+TrueOverdraw+OverdrawType")]
unsafe impl quest_hook::libil2cpp::Argument for crate::TrueOverdraw::TrueOverdraw_OverdrawType {
    type Type = Self;
...
#[cfg(feature = "cordl_class_TrueOverdraw+TrueOverdraw+OverdrawType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::TrueOverdraw::TrueOverdraw_OverdrawType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_TrueOverdraw+TrueOverdraw+OverdrawType")]
unsafe impl quest_hook::libil2cpp::Returned for crate::TrueOverdraw::TrueOverdraw_OverdrawType {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_TrueOverdraw+TrueOverdraw+OverdrawType")]
unsafe impl quest_hook::libil2cpp::Return for crate::TrueOverdraw::TrueOverdraw_OverdrawType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
