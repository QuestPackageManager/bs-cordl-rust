...
#[cfg(feature = "Environments+Definitions+ColorSchemesAsyncInstaller")]
impl std::ops::DerefMut for crate::Environments::Definitions::ColorSchemesAsyncInstaller {
...
impl crate::Environments::Definitions::ColorSchemesAsyncInstaller {
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (colorSchemes, registry))? };
        Ok(__cordl_ret.into())
    }
