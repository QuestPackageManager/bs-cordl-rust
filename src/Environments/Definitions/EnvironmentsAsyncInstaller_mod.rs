...
#[cfg(feature = "Environments+Definitions+EnvironmentsAsyncInstaller")]
impl std::ops::DerefMut for crate::Environments::Definitions::EnvironmentsAsyncInstaller {
...
impl crate::Environments::Definitions::EnvironmentsAsyncInstaller {
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (environmentInfos, registry))? };
        Ok(__cordl_ret.into())
    }
