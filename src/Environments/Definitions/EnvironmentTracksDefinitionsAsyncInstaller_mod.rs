#[cfg(feature = "cordl_class_Environments+Definitions+EnvironmentTracksDefinitionsAsyncInstaller")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Environments::Definitions::EnvironmentTracksDefinitionsAsyncInstaller {
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tracksDefinitions, registry))? };
        Ok(__cordl_ret.into())
    }
