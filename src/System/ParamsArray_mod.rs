...
unsafe impl quest_hook::libil2cpp::Type for crate::System::ParamsArray {
    ...
    const CLASS_NAME: &'static str = "ParamsArray";
...
impl crate::System::ParamsArray {
    pub fn GetAtSlow(
        ...
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ParamsArray as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ParamsArray as quest_hook::libil2cpp::Type >
                    ::class(), "GetAtSlow", 1usize
                )
            });
