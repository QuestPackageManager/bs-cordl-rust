#[cfg(feature = "cordl_class_System+PasteArguments")]
#[repr(C)]
...
impl crate::System::PasteArguments {
    pub fn AppendArgument(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("AppendArgument")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (stringBuilder, argument))? };
        Ok(__cordl_ret.into())
    }
