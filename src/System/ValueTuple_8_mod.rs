    ...
    > for crate::System::ValueTuple_8<T1, T2, T3, T4, T5, T6, T7, TRest>
{
    fn as_ref(
        &self,
    ) -> &crate::System::IComparable_1<crate::System::ValueTuple_8<T1, T2, T3, T4, T5, T6, T7, TRest>>
    {
        todo!()
    }
}
...
impl<
    ...
    >
    AsRef<
        crate::System::IEquatable_1<crate::System::ValueTuple_8<T1, T2, T3, T4, T5, T6, T7, TRest>>,
    > for crate::System::ValueTuple_8<T1, T2, T3, T4, T5, T6, T7, TRest>
{
    fn as_ref(
        &self,
