...
impl crate::System::__Il2CppComDelegate {
    pub fn Finalize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::__Il2CppComDelegate as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Finalize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::__Il2CppComDelegate as quest_hook::libil2cpp::Type >
