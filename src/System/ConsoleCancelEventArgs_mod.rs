...
unsafe impl quest_hook::libil2cpp::Type for crate::System::ConsoleCancelEventArgs {
    ...
    const CLASS_NAME: &'static str = "ConsoleCancelEventArgs";
...
impl crate::System::ConsoleCancelEventArgs {
    ...
    pub fn _ctor_1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleCancelEventArgs as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ConsoleCancelEventArgs as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
    ...
    pub fn _ctor_ConsoleSpecialKey0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleCancelEventArgs as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::ConsoleSpecialKey),
    ...
    pub fn get_Cancel(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleCancelEventArgs as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_Cancel")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ConsoleCancelEventArgs as quest_hook::libil2cpp::Type
                    > ::class(), "get_Cancel", 0usize
                )
            });
