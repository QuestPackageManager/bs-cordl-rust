#[cfg(feature = "cordl_class_System+Nullable_1")]
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Nullable_1<T> {
    ...
    pub fn GetValueOrDefault_T1(&mut self, defaultValue: T) -> quest_hook::libil2cpp::Result<T>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (defaultValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::System::Nullable_1<T> =
            unsafe { cordl_method_info.invoke_unchecked((), (o))? };
        Ok(__cordl_ret.into())
    }
    pub fn UnboxExact(
