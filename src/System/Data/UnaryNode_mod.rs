...
#[cfg(feature = "System+Data+UnaryNode")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Data::UnaryNode {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Data";
    const CLASS_NAME: &'static str = "UnaryNode";
...
impl crate::System::Data::UnaryNode {
    pub fn Bind(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::UnaryNode as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::UnaryNode as quest_hook::libil2cpp::Type >
                    ::class(), "Bind", 2usize
                )
            });
    ...
    pub fn EvalUnaryOp(
        &mut self,
        op: i32,
        vl: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::UnaryNode as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Data::UnaryNode as quest_hook::libil2cpp::Type >
                    ::class(), "EvalUnaryOp", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe { method.invoke_unchecked(self, (op, vl))? };
        Ok(__cordl_ret.into())
    }
    pub fn Eval_0(
        &mut self,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (table, op, right))?
        };
        Ok(__cordl_ret.into())
    }
}
