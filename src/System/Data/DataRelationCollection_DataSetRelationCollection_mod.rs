#[cfg(feature = "cordl_class_System+Data+DataRelationCollection+DataSetRelationCollection")]
#[repr(C)]
    ...
    for crate::GlobalNamespace::DataRelationCollection_DataSetRelationCollection
{
    ...
    const CLASS_NAME: &'static str = "DataRelationCollection/DataSetRelationCollection";
...
impl std::ops::Deref for crate::GlobalNamespace::DataRelationCollection_DataSetRelationCollection {
