...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Data::XmlDataTreeWriter {
    ...
    const CLASS_NAME: &'static str = "XmlDataTreeWriter";
...
impl crate::System::Data::XmlDataTreeWriter {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetNestedChildRelations", 1usize
                        )
                    })
            });
    ...
    pub fn RowHasErrors(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (row))? };
        Ok(__cordl_ret.into())
    }
    pub fn Save(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (xw, writeSchema))? };
        Ok(__cordl_ret.into())
    }
    pub fn SaveDiffgramData(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("SaveDiffgramData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (xw, rowsOrder))? };
        Ok(__cordl_ret.into())
    }
    pub fn XmlDataRowWriter(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("XmlDataRowWriter")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (row, encodedTableName))? };
        Ok(__cordl_ret.into())
    }
