...
impl crate::System::Data::DataRelationPropertyDescriptor {
    pub fn CanResetValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::DataRelationPropertyDescriptor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::DataRelationPropertyDescriptor as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (dataRelation))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::DataRelationPropertyDescriptor as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Data::DataRelationPropertyDescriptor as
                    quest_hook::libil2cpp::Type > ::class(), "get_Relation", 0usize
                )
            });
