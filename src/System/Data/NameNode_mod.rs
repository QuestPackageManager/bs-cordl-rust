...
impl crate::System::Data::NameNode {
    ...
    > {
        ...
        > = unsafe { cordl_method_info.invoke_unchecked((), (text, start, pos))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_i32_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (table, text, start, pos))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (table, name))?
        };
        Ok(__cordl_ret.into())
    }
