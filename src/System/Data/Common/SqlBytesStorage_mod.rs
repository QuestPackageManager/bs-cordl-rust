...
for crate::System::Data::Common::SqlBytesStorage {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Data.Common";
    const CLASS_NAME: &'static str = "SqlBytesStorage";
...
#[cfg(feature = "System+Data+Common+SqlBytesStorage")]
impl std::ops::DerefMut for crate::System::Data::Common::SqlBytesStorage {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Data+Common+SqlBytesStorage")]
impl crate::System::Data::Common::SqlBytesStorage {
    pub fn Aggregate(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::Common::SqlBytesStorage as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::Common::SqlBytesStorage as
...
#[cfg(feature = "System+Data+Common+SqlBytesStorage")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Data::Common::SqlBytesStorage {
