...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Data::Common::DoubleStorage {
    ...
    const CLASS_NAME: &'static str = "DoubleStorage";
...
impl crate::System::Data::Common::DoubleStorage {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::Common::DoubleStorage as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::Common::DoubleStorage as
