...
impl crate::System::Data::Common::SqlStringStorage {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::Common::SqlStringStorage as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::Common::SqlStringStorage as
