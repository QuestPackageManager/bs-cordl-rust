...
impl crate::System::Data::XmlToDatasetMap {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddColumnSchema", 3usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (col, nameTable, columns))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddColumnSchema_XmlNameTable_DataColumn1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (nameTable, col, columns))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "BuildIdentityMap", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (dataSet, nameTable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BuildIdentityMap_DataTable_XmlNameTable2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (dataTable, nameTable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BuildIdentityMap_XmlNameTable_DataSet1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (nameTable, dataSet))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BuildIdentityMap_XmlNameTable_DataTable3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (nameTable, dataTable))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (table, dataReader, fIgnoreNamespace))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (node, fIgnoreNamespace))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::System::Data::XmlToDatasetMap_TableSchemaInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tableSchema))?
        };
        Ok(__cordl_ret.into())
    }
}
