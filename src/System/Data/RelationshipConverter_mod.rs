...
impl crate::System::Data::RelationshipConverter {
    pub fn CanConvertTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::RelationshipConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::RelationshipConverter as
