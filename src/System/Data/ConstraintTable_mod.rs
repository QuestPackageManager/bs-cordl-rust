...
impl crate::System::Data::ConstraintTable {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::ConstraintTable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::ConstraintTable as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 2usize
                )
            });
