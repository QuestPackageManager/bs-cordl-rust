#[cfg(feature = "cordl_class_System+Data+ConstNode")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Data::ConstNode {
    ...
    pub fn _ctor_DataTable_ValueType_Il2CppObject0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (table, _cordl_type, constant))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (table, _cordl_type, constant, fParseQuotes))?
        };
        Ok(__cordl_ret.into())
    }
}
