...
impl crate::System::Data::RecordManager {
    ...
    pub fn CopyRecord(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (src, record, copy))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FreeRecord(
    ...
    pub fn ImportRecord(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (src, record))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "NormalizedMinimumCapacity", 1usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
    ...
    pub fn SetRowCache(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (newRows))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
