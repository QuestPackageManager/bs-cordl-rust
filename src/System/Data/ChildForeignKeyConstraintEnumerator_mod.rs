...
impl crate::System::Data::ChildForeignKeyConstraintEnumerator {
    pub fn IsValidCandidate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::ChildForeignKeyConstraintEnumerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::ChildForeignKeyConstraintEnumerator as
