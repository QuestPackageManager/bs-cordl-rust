...
impl crate::System::Data::ExpressionParser {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "BuildExpression", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pri))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CheckToken(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "IsAlpha",
                            1usize
                        )
                    })
            });
    ...
    pub fn ScanName__cordl_char__cordl_char_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (chEnd, esc, charsToEscape))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ScanNumeric(
    ...
    pub fn ScanString(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (escape))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ScanToken(
...
impl crate::System::Data::ExpressionParser_ReservedWords {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (word, token, op))?
        };
        Ok(__cordl_ret.into())
    }
}
