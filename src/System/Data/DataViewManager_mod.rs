...
impl crate::System::Data::DataViewManager {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::DataViewManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::DataViewManager as quest_hook::libil2cpp::Type
                    > ::class(), "get_DataViewSettings", 0usize
                )
            });
