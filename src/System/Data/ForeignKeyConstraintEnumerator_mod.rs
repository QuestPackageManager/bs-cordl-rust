...
impl crate::System::Data::ForeignKeyConstraintEnumerator {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::ForeignKeyConstraintEnumerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Data::ForeignKeyConstraint>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::ForeignKeyConstraintEnumerator as
                    quest_hook::libil2cpp::Type > ::class(), "GetForeignKeyConstraint",
                    0usize
                )
            });
