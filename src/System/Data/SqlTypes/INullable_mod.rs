...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Data::SqlTypes::INullable {
    ...
    const CLASS_NAME: &'static str = "INullable";
...
impl crate::System::Data::SqlTypes::INullable {
    ...
    pub fn get_IsNull(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::SqlTypes::INullable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_IsNull")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Data::SqlTypes::INullable as
