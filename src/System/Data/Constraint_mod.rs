#[cfg(feature = "cordl_class_System+Data+Constraint")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Data+Constraint")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Data::Constraint {
...
impl crate::System::Data::Constraint {
    ...
    pub fn CheckConstraint_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CheckConstraint")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::Data::Constraint>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Data::Constraint> = unsafe {
            cordl_method_info.invoke_unchecked(self, (destination, ignoreNSforTableLookup))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_InCollection(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_InCollection")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
