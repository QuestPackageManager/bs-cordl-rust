...
impl crate::System::Data::ZeroOpNode {
    pub fn Bind(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::ZeroOpNode as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Data::ZeroOpNode as quest_hook::libil2cpp::Type >
                    ::class(), "Bind", 2usize
                )
            });
