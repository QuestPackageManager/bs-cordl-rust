...
impl crate::System::Data::XmlIgnoreNamespaceReader {
    pub fn MoveToFirstAttribute(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Data::XmlIgnoreNamespaceReader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("MoveToFirstAttribute")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Data::XmlIgnoreNamespaceReader as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (xdoc, namespacesToIgnore))?
        };
        Ok(__cordl_ret.into())
    }
}
