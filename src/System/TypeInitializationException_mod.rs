#[cfg(feature = "cordl_class_System+TypeInitializationException")]
#[repr(C)]
...
impl crate::System::TypeInitializationException {
    ...
    pub fn _ctor_Il2CppString_Exception1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (fullTypeName, innerException))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString_Exception2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (fullTypeName, message, innerException))?
        };
        Ok(__cordl_ret.into())
    }
