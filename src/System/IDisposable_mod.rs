...
unsafe impl quest_hook::libil2cpp::Type for crate::System::IDisposable {
    ...
    const CLASS_NAME: &'static str = "IDisposable";
...
impl crate::System::IDisposable {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IDisposable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IDisposable as quest_hook::libil2cpp::Type >
