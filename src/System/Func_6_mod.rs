...
unsafe impl<
    ...
    T5: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::Type for crate::System::Func_6<T1, T2, T3, T4, T5, TResult> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Func`6";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Func`6")
                    .unwrap()
                    .make_generic::<(T1, T2, T3, T4, T5, TResult)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    T5: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> std::ops::Deref for crate::System::Func_6<T1, T2, T3, T4, T5, TResult> {
...
impl<
    ...
    T5: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> std::ops::DerefMut for crate::System::Func_6<T1, T2, T3, T4, T5, TResult> {
...
impl<
    ...
    T5: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> crate::System::Func_6<T1, T2, T3, T4, T5, TResult> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_6<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(T1, T2, T3, T4, T5), TResult, 5usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Func_6 < T1, T2, T3, T4, T5, TResult > as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 5usize
                )
            });
        let __cordl_ret: TResult = unsafe {
            method.invoke_unchecked(self, (arg1, arg2, arg3, arg4, arg5))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
for crate::System::Func_6<T1, T2, T3, T4, T5, TResult> {
