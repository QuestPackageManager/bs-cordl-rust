...
unsafe impl quest_hook::libil2cpp::Type for crate::System::ParsingInfo {
    ...
    const CLASS_NAME: &'static str = "ParsingInfo";
...
impl crate::System::ParsingInfo {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ParsingInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Init")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ParsingInfo as quest_hook::libil2cpp::Type >
                    ::class(), "Init", 0usize
                )
            });
