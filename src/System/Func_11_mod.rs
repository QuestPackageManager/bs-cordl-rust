#[cfg(feature = "cordl_class_System+Func_11")]
#[repr(C)]
...
impl<
        ...
        T10: quest_hook::libil2cpp::Type,
        TResult: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::System::Func_11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>
{
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), TResult, 10usize>(
                        "Invoke",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
