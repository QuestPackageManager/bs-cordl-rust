...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Func_10 < T1, T2, T3, T4, T5, T6, T7,
    T8, T9, TResult > => "System"."Func`10" < T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult
    >
);
#[cfg(feature = "System+Func_10")]
impl<
...
> crate::System::Func_10<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TResult = __cordl_object
            .invoke("Invoke", (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9))?;
        Ok(__cordl_ret)
    }
    pub fn New(
