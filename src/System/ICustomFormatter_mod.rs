...
impl crate::System::ICustomFormatter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ICustomFormatter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ICustomFormatter as quest_hook::libil2cpp::Type >
                    ::class(), "Format", 3usize
                )
            });
