#[cfg(feature = "cordl_class_System+WindowsConsoleDriver")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::WindowsConsoleDriver {
    pub fn GetConsoleScreenBufferInfo(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::System::IntPtr,
                        quest_hook::libil2cpp::ByRefMut<crate::System::ConsoleScreenBufferInfo>,
                    ), bool, 2usize>("GetConsoleScreenBufferInfo")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (handle, info))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetStdHandle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::System::Handles), crate::System::IntPtr, 1usize>(
                        "GetStdHandle",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn IsModifierKey(virtualKeyCode: i16) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (virtualKeyCode))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReadConsoleInput(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (handle, record, length, nread))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadKey(
        &mut self,
