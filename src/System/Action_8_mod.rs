...
impl<
    ...
    T7: quest_hook::libil2cpp::Type,
    T8: quest_hook::libil2cpp::Type,
> std::ops::Deref for crate::System::Action_8<T1, T2, T3, T4, T5, T6, T7, T8> {
...
impl<
    ...
    T7: quest_hook::libil2cpp::Type,
    T8: quest_hook::libil2cpp::Type,
> std::ops::DerefMut for crate::System::Action_8<T1, T2, T3, T4, T5, T6, T7, T8> {
...
impl<
    ...
    T7: quest_hook::libil2cpp::Type,
    T8: quest_hook::libil2cpp::Type,
> crate::System::Action_8<T1, T2, T3, T4, T5, T6, T7, T8> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        T8: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Action_8<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Action_8 < T1, T2, T3, T4, T5, T6, T7, T8 > as
