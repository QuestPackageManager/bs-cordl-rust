#[cfg(feature = "cordl_class_System+ValueType")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::ValueType {
    pub fn DefaultEquals(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (o1, o2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Equals(
        &mut self,
    ...
    pub fn InternalEquals(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (o1, o2, fields))? };
        Ok(__cordl_ret.into())
    }
    pub fn InternalGetHashCode(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            ...
                            >,
                        >,
                    ), i32, 2usize>("InternalGetHashCode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (o, fields))? };
        Ok(__cordl_ret.into())
    }
