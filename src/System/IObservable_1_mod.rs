#[cfg(feature = "cordl_class_System+IObservable_1")]
    ...
    for crate::System::IObservable_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IObservable`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System", "IObservable`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::System::IObservable_1<T> {
...
#[cfg(feature = "System+IObservable_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::System::IObservable_1<T> {
