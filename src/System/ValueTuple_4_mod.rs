...
impl<
    ...
    T3: quest_hook::libil2cpp::Type,
    T4: quest_hook::libil2cpp::Type,
> AsRef<quest_hook::libil2cpp::Gc<crate::System::ValueTuple_4<T1, T2, T3, T4>>>
for crate::System::ValueTuple_4<T1, T2, T3, T4> {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::System::ValueTuple_4<T1, T2, T3, T4>> {
        todo!()
    }
}
#[cfg(feature = "System+ValueTuple_4")]
impl<
    ...
    T3: quest_hook::libil2cpp::Type,
    T4: quest_hook::libil2cpp::Type,
> AsMut<quest_hook::libil2cpp::Gc<crate::System::ValueTuple_4<T1, T2, T3, T4>>>
for crate::System::ValueTuple_4<T1, T2, T3, T4> {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::System::ValueTuple_4<T1, T2, T3, T4>> {
        todo!()
    }
}
#[cfg(feature = "System+ValueTuple_4")]
