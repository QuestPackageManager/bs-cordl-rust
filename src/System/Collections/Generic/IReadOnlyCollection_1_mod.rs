#[cfg(feature = "cordl_class_System+Collections+Generic+IReadOnlyCollection_1")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "System+Collections+Generic+IReadOnlyCollection_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::IReadOnlyCollection_1<T> {
