...
> crate::System::Collections::Generic::HashSet_1_Enumerator<T> {
    ...
    pub fn _ctor(
        &mut self,
        set: *mut crate::System::Collections::Generic::HashSet_1<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
...
pub struct HashSet_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _lastIndex: i32,
    pub _freeList: i32,
    pub _comparer: *mut crate::System::Collections::Generic::IEqualityComparer_1<T>,
    pub _version: i32,
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::HashSet_1<T> {
    ...
    pub fn _ctor_IEqualityComparer_1_1(
        &mut self,
        comparer: *mut crate::System::Collections::Generic::IEqualityComparer_1<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    ...
    pub fn IntersectWithHashSetWithSameEC(
        &mut self,
        other: *mut crate::System::Collections::Generic::HashSet_1<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::System::Collections::Generic::IEqualityComparer_1<
            T,
    ...
    pub fn CopyFrom(
        &mut self,
        source: *mut crate::System::Collections::Generic::HashSet_1<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    ...
    pub fn New_i32_2(capacity: i32) -> quest_hook::libil2cpp::Result<&'static mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
