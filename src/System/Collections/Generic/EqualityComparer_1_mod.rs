#[cfg(feature = "cordl_class_System+Collections+Generic+EqualityComparer_1")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "System+Collections+Generic+EqualityComparer_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::EqualityComparer_1<T> {
    pub fn CreateComparer() -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::EqualityComparer_1<T>>,
    >
    where
