...
for crate::System::Collections::Generic::ByteEqualityComparer {
    ...
    const CLASS_NAME: &'static str = "ByteEqualityComparer";
...
impl crate::System::Collections::Generic::ByteEqualityComparer {
    pub fn Equals_Il2CppObject1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::Generic::ByteEqualityComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Collections::Generic::ByteEqualityComparer as
    ...
    pub fn Equals_u8_u8_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::Generic::ByteEqualityComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<(u8, u8), bool, 2usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Collections::Generic::ByteEqualityComparer as
    ...
    pub fn GetHashCode_u8_0(&mut self, b: u8) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::Generic::ByteEqualityComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<(u8), i32, 1usize>("GetHashCode")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Collections::Generic::ByteEqualityComparer as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::Generic::ByteEqualityComparer as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Collections::Generic::ByteEqualityComparer as
                    quest_hook::libil2cpp::Type > ::class(), "LastIndexOf", 4usize
                )
            });
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked(self, (array, value, startIndex, count))?
