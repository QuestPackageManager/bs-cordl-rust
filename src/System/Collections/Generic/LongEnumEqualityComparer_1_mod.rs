...
for crate::System::Collections::Generic::LongEnumEqualityComparer_1<T> {
    ...
    const CLASS_NAME: &'static str = "LongEnumEqualityComparer`1";
...
> crate::System::Collections::Generic::LongEnumEqualityComparer_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::Generic::LongEnumEqualityComparer_1<
            T,
