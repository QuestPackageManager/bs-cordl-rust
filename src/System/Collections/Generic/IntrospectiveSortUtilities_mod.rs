...
impl std::ops::Deref for crate::System::Collections::Generic::IntrospectiveSortUtilities {
...
#[cfg(feature = "System+Collections+Generic+IntrospectiveSortUtilities")]
impl std::ops::DerefMut for crate::System::Collections::Generic::IntrospectiveSortUtilities {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ThrowOrIgnoreBadComparer", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (comparer))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Collections+Generic+IntrospectiveSortUtilities")]
