#[cfg(feature = "cordl_class_System+Collections+Generic+ShortEnumEqualityComparer_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Collections::Generic::ShortEnumEqualityComparer_1<T>
{
    ...
    const CLASS_NAME: &'static str = "ShortEnumEqualityComparer`1";
    ...
    crate::System::Collections::Generic::ShortEnumEqualityComparer_1<T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (information, context))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Collections+Generic+ShortEnumEqualityComparer_1")]
