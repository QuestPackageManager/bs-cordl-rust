...
> crate::System::Collections::Generic::ShortEnumEqualityComparer_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::Generic::ShortEnumEqualityComparer_1<
            T,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (information, context))?
        };
        Ok(__cordl_ret.into())
    }
}
