#[cfg(feature = "cordl_class_System+Collections+Generic+QueueDebugView_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Collections::Generic::QueueDebugView_1<T>
{
    ...
    const CLASS_NAME: &'static str = "QueueDebugView`1";
...
#[cfg(feature = "System+Collections+Generic+QueueDebugView_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::QueueDebugView_1<T> {}
#[cfg(feature = "cordl_class_System+Collections+Generic+QueueDebugView_1")]
