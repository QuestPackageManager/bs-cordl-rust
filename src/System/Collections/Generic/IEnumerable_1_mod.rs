#[cfg(feature = "cordl_class_System+Collections+Generic+IEnumerable_1")]
    ...
    for crate::System::Collections::Generic::IEnumerable_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IEnumerable`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Collections.Generic", "IEnumerable`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "System+Collections+Generic+IEnumerable_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::IEnumerable_1<T> {
