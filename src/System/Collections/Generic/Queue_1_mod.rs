#[cfg(feature = "cordl_class_System+Collections+Generic+Queue_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Collections::Generic::Queue_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Collections.Generic", "Queue`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::Queue_1<T> {
    ...
    pub fn GetEnumerator(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Collections::Generic::Queue_1_Enumerator<T>>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::System::Collections::Generic::Queue_1_Enumerator<T> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn MoveNext(
...
#[cfg(feature = "System+Collections+Generic+Queue_1+Enumerator")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::Queue_1_Enumerator<T> {
