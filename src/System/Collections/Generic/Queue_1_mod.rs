...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Collections::Generic::Queue_1 < T > =>
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::Queue_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = __cordl_object.invoke("TryPeek", (result))?;
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_0(
        &mut self,
...
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate ::System::Collections::Generic::Queue_1_Enumerator
    < T > => "System.Collections.Generic"."Queue`1/Enumerator<T>" < T >
);
#[cfg(feature = "System+Collections+Generic+Queue_1+Enumerator")]
