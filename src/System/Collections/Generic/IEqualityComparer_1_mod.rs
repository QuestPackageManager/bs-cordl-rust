#[cfg(feature = "cordl_class_System+Collections+Generic+IEqualityComparer_1")]
...
#[cfg(feature = "System+Collections+Generic+IEqualityComparer_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::IEqualityComparer_1<T> {
