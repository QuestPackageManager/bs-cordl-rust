#[cfg(feature = "cordl_class_System+Collections+Generic+DictionaryValueCollectionDebugView_2")]
#[repr(C)]
...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    ...
    for crate::System::Collections::Generic::DictionaryValueCollectionDebugView_2<TKey, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Collections.Generic";
    const CLASS_NAME: &'static str = "DictionaryValueCollectionDebugView`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find(
                ...
                "DictionaryValueCollectionDebugView`2",
            )
            .unwrap()
...
impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    crate::System::Collections::Generic::DictionaryValueCollectionDebugView_2<TKey, TValue>
{
}
#[cfg(feature = "cordl_class_System+Collections+Generic+DictionaryValueCollectionDebugView_2")]
impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
