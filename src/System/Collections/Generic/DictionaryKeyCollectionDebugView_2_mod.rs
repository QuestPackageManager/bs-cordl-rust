#[cfg(feature = "cordl_class_System+Collections+Generic+DictionaryKeyCollectionDebugView_2")]
#[repr(C)]
...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    ...
    for crate::System::Collections::Generic::DictionaryKeyCollectionDebugView_2<TKey, TValue>
{
