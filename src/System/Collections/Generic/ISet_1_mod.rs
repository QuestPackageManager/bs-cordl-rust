#[cfg(feature = "cordl_class_System+Collections+Generic+ISet_1")]
    ...
    for crate::System::Collections::Generic::ISet_1<T>
{
    ...
    const CLASS_NAME: &'static str = "ISet`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Collections.Generic", "ISet`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
