...
#[repr(C)]
#[derive(Debug)]
pub struct DictionaryDebugView_2<K: quest_hook::libil2cpp::Type, V: quest_hook::libil2cpp::Type> {
    ...
    for crate::System::Collections::Generic::DictionaryDebugView_2<K, V>
{
    ...
    const CLASS_NAME: &'static str = "DictionaryDebugView`2";
