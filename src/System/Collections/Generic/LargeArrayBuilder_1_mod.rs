#[cfg(feature = "cordl_class_System+Collections+Generic+LargeArrayBuilder_1")]
    ...
    for crate::System::Collections::Generic::LargeArrayBuilder_1<T>
{
    ...
    const CLASS_NAME: &'static str = "LargeArrayBuilder`1";
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::LargeArrayBuilder_1<T> {
    pub fn AddRange(
        &mut self,
        items: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IEnumerable_1<T>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (item, destination, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn AllocateBuffer(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("AllocateBuffer")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (initialize))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_1(
        &mut self,
