    ...
    crate::System::Collections::Generic::LowLevelDictionary_2<TKey, TValue>
{
    ...
    pub type Entry = crate::System::Collections::Generic::LowLevelDictionary_2_Entry<TKey, TValue>;
    pub fn Clear(
        &mut self,
        capacity: i32,
    ...
    pub fn ExpandBuckets(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TKey: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TKey), quest_hook::libil2cpp::Gc<
    ...
    pub fn GetBucket(&mut self, key: TKey, numBuckets: i32) -> quest_hook::libil2cpp::Result<i32>
    where
        TKey: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, numBuckets))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TKey, TValue), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::LowLevelDictionary_2_Entry<
                            TKey,
                            TValue,
                        >,
...
#[cfg(feature = "cordl_class_System+Collections+Generic+LowLevelDictionary_2+DefaultComparer_1")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
...
unsafe impl<
        ...
        T: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type
    for crate::System::Collections::Generic::LowLevelDictionary_2_DefaultComparer_1<TKey, TValue, T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Collections.Generic";
...
impl<
        ...
        TValue: quest_hook::libil2cpp::Type,
        T: quest_hook::libil2cpp::Type,
    > crate::System::Collections::Generic::LowLevelDictionary_2_DefaultComparer_1<TKey, TValue, T>
{
...
impl<
    ...
    for crate::System::Collections::Generic::LowLevelDictionary_2_DefaultComparer_1<TKey, TValue, T>
{
    fn as_mut(&mut self) -> &mut crate::System::Collections::Generic::IEqualityComparer_1<T> {
        unsafe { std::mem::transmute(self) }
    }
}
