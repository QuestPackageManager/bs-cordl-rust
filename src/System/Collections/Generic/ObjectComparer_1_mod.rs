#[cfg(feature = "cordl_class_System+Collections+Generic+ObjectComparer_1")]
#[repr(C)]
...
#[cfg(feature = "System+Collections+Generic+ObjectComparer_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::ObjectComparer_1<T> {
