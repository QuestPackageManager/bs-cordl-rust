#[cfg(feature = "cordl_class_System+Collections+Generic+GenericComparer_1")]
#[repr(C)]
...
#[cfg(feature = "System+Collections+Generic+GenericComparer_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::GenericComparer_1<T> {
