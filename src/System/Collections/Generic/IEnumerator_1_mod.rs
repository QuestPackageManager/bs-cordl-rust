#[cfg(feature = "cordl_class_System+Collections+Generic+IEnumerator_1")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::System::Collections::Generic::IEnumerator_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Collections.Generic", "IEnumerator`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "System+Collections+Generic+IEnumerator_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Generic::IEnumerator_1<T> {
