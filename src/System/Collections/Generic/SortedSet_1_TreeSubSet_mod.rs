...
pub struct SortedSet_1_TreeSubSet<T: quest_hook::libil2cpp::Type> {
    ...
    pub _underlying: quest_hook::libil2cpp::Gc<
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::SortedSet_1_TreeSubSet<T> {
    ...
    pub fn New(
        Underlying: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::SortedSet_1<T>,
        >,
        Min: T,
        Max: T,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<VersionCheckImpl>b__20_0", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
