...
for crate::System::Collections::ReadOnlyCollectionBase {
    ...
    const CLASS_NAME: &'static str = "ReadOnlyCollectionBase";
...
impl crate::System::Collections::ReadOnlyCollectionBase {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::ReadOnlyCollectionBase as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Collections::ReadOnlyCollectionBase as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::ReadOnlyCollectionBase as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Collections::ReadOnlyCollectionBase as
                    quest_hook::libil2cpp::Type > ::class(), "get_InnerList", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
