...
#[cfg(feature = "System+Collections+Concurrent+ConcurrentQueue_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Concurrent::ConcurrentQueue_1<T> {
    #[cfg(feature = "System+Collections+Concurrent+ConcurrentQueue_1+Segment")]
    pub type Segment = crate::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>;
    pub fn CopyTo(
        &mut self,
    ...
    pub fn Enqueue(&mut self, item: T) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::IEnumerator_1<T>,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (head, headHead, tail, tailTail))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked((), (head, headHead, tail, tailTail))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (s, head, tail))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (segment, i))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), quest_hook::libil2cpp::Void, 4usize>("SnapForObservation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (result, resultUsed))? };
        Ok(__cordl_ret.into())
    }
    ...
    crate::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>
{
    ...
    pub type Slot = crate::System::Collections::Concurrent::Segment_ConcurrentQueue_1_Slot<T>;
    ...
    pub fn New(boundedLength: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (boundedLength))? };
        Ok(__cordl_ret.into())
    }
