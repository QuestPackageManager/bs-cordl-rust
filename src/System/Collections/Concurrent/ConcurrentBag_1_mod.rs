...
#[cfg(feature = "System+Collections+Concurrent+ConcurrentBag_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::Concurrent::ConcurrentBag_1<T> {
    #[cfg(feature = "System+Collections+Concurrent+ConcurrentBag_1+Enumerator")]
    pub type Enumerator = crate::System::Collections::Concurrent::ConcurrentBag_1_Enumerator<T>;
    #[cfg(feature = "System+Collections+Concurrent+ConcurrentBag_1+WorkStealingQueue")]
    pub type WorkStealingQueue =
        crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>;
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), i32, 2usize>("CopyFromEachQueueToArray")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (array, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn CopyTo(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<
                            T,
                        >,
                    >, 0usize>("CreateWorkStealingQueueForCurrentThread")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lockTaken))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<
                            T,
                        >,
                    >, 1usize>("GetCurrentThreadWorkStealingQueue")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (forceCreate))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<
                            T,
                        >,
                    >, 0usize>("GetUnownedWorkStealingQueue")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::ByRefMut<T>, bool), bool, 2usize>(
                        "TrySteal",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (result, take))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TryStealFromTo", 4usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (startInclusive, endExclusive, result, take))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryTake(
...
impl<T: quest_hook::libil2cpp::Type>
    ...
    for crate::System::Collections::Concurrent::ConcurrentBag_1<T>
{
    fn as_ref(&self) -> &crate::System::Collections::Concurrent::IProducerConsumerCollection_1<T> {
...
#[cfg(feature = "cordl_class_System+Collections+Concurrent+ConcurrentBag_1+WorkStealingQueue")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
    ...
    crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T>
{
    ...
    pub fn LocalClear(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (item, emptyToNonEmptyListTransitionCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nextQueue))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_DangerousCount(&mut self) -> quest_hook::libil2cpp::Result<i32>
    where
