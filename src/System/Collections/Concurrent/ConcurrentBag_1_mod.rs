...
pub struct ConcurrentBag_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _locals: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Gc<T>>,
    pub _workStealingQueues: quest_hook::libil2cpp::Gc<T>,
...
> crate::System::Collections::Concurrent::ConcurrentBag_1<T> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CopyFromEachQueueToArray", 2usize
                        )
                    })
            });
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lockTaken))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<T> = unsafe {
            cordl_method_info.invoke_unchecked(self, (forceCreate))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (result, take))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryStealFromTo(
        &mut self,
        startInclusive: quest_hook::libil2cpp::Gc<T>,
        endExclusive: quest_hook::libil2cpp::Gc<T>,
        result: quest_hook::libil2cpp::ByRefMut<T>,
        take: bool,
    ) -> quest_hook::libil2cpp::Result<bool>
    where
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "TryTake",
                            1usize
                        )
                    })
            });
...
pub struct ConcurrentBag_1_WorkStealingQueue<T: quest_hook::libil2cpp::Type> {
    ...
    pub _currentOp: i32,
    pub _frozen: bool,
    pub _nextQueue: quest_hook::libil2cpp::Gc<T>,
...
> crate::System::Collections::Concurrent::ConcurrentBag_1_WorkStealingQueue<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (item, emptyToNonEmptyListTransitionCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        nextQueue: quest_hook::libil2cpp::Gc<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>>
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (nextQueue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_DangerousCount(&mut self) -> quest_hook::libil2cpp::Result<i32>
