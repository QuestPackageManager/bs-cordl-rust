#[cfg(feature = "cordl_class_System+Collections+Concurrent+IProducerConsumerCollectionDebugView_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Collections::Concurrent::IProducerConsumerCollectionDebugView_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IProducerConsumerCollectionDebugView`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find(
                ...
                "IProducerConsumerCollectionDebugView`1",
            )
            .unwrap()
            .make_generic::<(T)>()
            .unwrap()
