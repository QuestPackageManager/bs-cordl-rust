...
pub struct Collection_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub items: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IList_1<T>>,
    ...
    for crate::System::Collections::ObjectModel::Collection_1<T>
{
    ...
    const CLASS_NAME: &'static str = "Collection`1";
...
#[cfg(feature = "System+Collections+ObjectModel+Collection_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Collections::ObjectModel::Collection_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, T), quest_hook::libil2cpp::Void, 2usize>("InsertItem")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, T), quest_hook::libil2cpp::Void, 2usize>("SetItem")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn System_Collections_IList_get_IsReadOnly(&mut self) -> quest_hook::libil2cpp::Result<bool>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
