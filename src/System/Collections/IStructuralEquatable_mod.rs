...
for crate::System::Collections::IStructuralEquatable {
    ...
    const CLASS_NAME: &'static str = "IStructuralEquatable";
...
impl crate::System::Collections::IStructuralEquatable {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::IStructuralEquatable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Collections::IStructuralEquatable as
