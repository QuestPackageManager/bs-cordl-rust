...
impl crate::System::Collections::ArrayList {
    ...
    pub fn CopyTo_i32_Array_i32_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, array, arrayIndex, count))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn InsertRange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, c))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Sort_i32_i32_IComparer1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, count, comparer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToArray_0(
