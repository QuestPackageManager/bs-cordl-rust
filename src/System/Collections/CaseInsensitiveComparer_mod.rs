...
for crate::System::Collections::CaseInsensitiveComparer {
    ...
    const CLASS_NAME: &'static str = "CaseInsensitiveComparer";
...
impl crate::System::Collections::CaseInsensitiveComparer {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::CaseInsensitiveComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Collections::CaseInsensitiveComparer as
