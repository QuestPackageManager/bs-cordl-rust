...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Collections::CollectionBase =>
...
impl crate::System::Collections::CollectionBase {
    ...
    pub fn OnInsertComplete(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("OnInsertComplete", (index, value))?;
        Ok(__cordl_ret.into())
    }
    pub fn OnRemove(
        &mut self,
    ...
    pub fn OnRemoveComplete(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("OnRemoveComplete", (index, value))?;
        Ok(__cordl_ret.into())
    }
    pub fn OnSet(
        &mut self,
    ...
    pub fn OnSetComplete(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("OnSetComplete", (index, oldValue, newValue))?;
        Ok(__cordl_ret.into())
    }
    pub fn OnValidate(
        &mut self,
    ...
    > {
        ...
        > = __cordl_object.invoke("get_InnerList", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn get_List(
        &mut self,
