...
#[cfg(feature = "System+Collections+IEnumerable")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Collections::IEnumerable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Collections";
    const CLASS_NAME: &'static str = "IEnumerable";
...
impl crate::System::Collections::IEnumerable {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Collections::IEnumerable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Collections::IEnumerable as
