...
#[cfg(feature = "cordl_class_System+Collections+ArrayList+IListWrapper")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ArrayList_IListWrapper {
...
impl crate::GlobalNamespace::ArrayList_IListWrapper {
    ...
    pub fn Insert(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, obj))? };
        Ok(__cordl_ret.into())
    }
    pub fn InsertRange(
        &mut self,
...
#[cfg(feature = "cordl_class_System+Collections+ArrayList+IListWrapper")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ArrayList_IListWrapper {
