...
unsafe impl<
    ...
    T5: quest_hook::libil2cpp::Type,
    T6: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::Type for crate::System::Action_6<T1, T2, T3, T4, T5, T6> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Action`6";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Action`6")
                    .unwrap()
...
> crate::System::Action_6<T1, T2, T3, T4, T5, T6> {
    ...
    where
        ...
        T6: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Action_6<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Action_6 < T1, T2, T3, T4, T5, T6 > as
