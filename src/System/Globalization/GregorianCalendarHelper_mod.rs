#[cfg(feature = "cordl_class_System+Globalization+GregorianCalendarHelper")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Globalization+GregorianCalendarHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Globalization::GregorianCalendarHelper {
...
impl crate::System::Globalization::GregorianCalendarHelper {
    ...
    pub fn GetAbsoluteDate(year: i32, month: i32, day: i32) -> quest_hook::libil2cpp::Result<i64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn GetDatePart(&mut self, ticks: i64, part: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (ticks, part))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetGregorianYear(&mut self, year: i32, era: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn GetYearOffset(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (year, era, throwOnError))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ToFourDigitYear(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (year, twoDigitYearMax))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cal, eraInfo))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Eras(
        &mut self,
...
#[cfg(feature = "cordl_class_System+Globalization+GregorianCalendarHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Globalization::GregorianCalendarHelper {
