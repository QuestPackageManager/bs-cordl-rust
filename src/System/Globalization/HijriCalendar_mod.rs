...
impl crate::System::Globalization::HijriCalendar {
    ...
    pub fn DaysUpToHijriYear(&mut self, HijriYear: i32) -> quest_hook::libil2cpp::Result<i64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (HijriYear))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetAbsoluteDateHijri(
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (y, m, d))? };
        Ok(__cordl_ret.into())
    }
