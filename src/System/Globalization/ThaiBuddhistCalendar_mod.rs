...
for crate::System::Globalization::ThaiBuddhistCalendar {
    ...
    const CLASS_NAME: &'static str = "ThaiBuddhistCalendar";
...
#[cfg(feature = "System+Globalization+ThaiBuddhistCalendar")]
impl crate::System::Globalization::ThaiBuddhistCalendar {
    pub fn GetDayOfMonth(
        &mut self,
        _cordl_time: crate::System::DateTime,
    ) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::ThaiBuddhistCalendar as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::System::DateTime), i32, 1usize>("GetDayOfMonth")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Globalization::ThaiBuddhistCalendar as
