...
for crate::System::Globalization::JapaneseCalendar {
    ...
    const CLASS_NAME: &'static str = "JapaneseCalendar";
...
impl crate::System::Globalization::JapaneseCalendar {
    pub fn EnglishEraNames() -> quest_hook::libil2cpp::Result<
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::JapaneseCalendar as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Globalization::JapaneseCalendar as
                    quest_hook::libil2cpp::Type > ::class(), "EnglishEraNames", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::JapaneseCalendar as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Globalization::JapaneseCalendar as
                    quest_hook::libil2cpp::Type > ::class(), "EraNames", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::JapaneseCalendar as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Globalization::JapaneseCalendar as
                    quest_hook::libil2cpp::Type > ::class(), "GetEraInfo", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::JapaneseCalendar as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Globalization::JapaneseCalendar as
                    quest_hook::libil2cpp::Type > ::class(), "GetErasFromRegistry",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
