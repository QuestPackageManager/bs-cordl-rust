...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Globalization::SortKey {
    ...
    const CLASS_NAME: &'static str = "SortKey";
...
impl crate::System::Globalization::SortKey {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::SortKey as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Globalization::SortKey as quest_hook::libil2cpp::Type
                    > ::class(), "Compare", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked((), (sortkey1, sortkey2))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Equals(
    ...
    pub fn _ctor_Il2CppString_Il2CppString_CompareOptions_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (localeName, str, options, keyData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Il2CppString_CompareOptions0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (lcid, source, opt))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Globalization::SortKey as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Globalization::SortKey as quest_hook::libil2cpp::Type
                    > ::class(), "get_OriginalString", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
