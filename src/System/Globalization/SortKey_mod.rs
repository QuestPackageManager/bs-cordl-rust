...
impl crate::System::Globalization::SortKey {
    pub fn Compare(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (sortkey1, sortkey2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Equals(
        &mut self,
    ...
    pub fn _ctor_Il2CppString_Il2CppString_CompareOptions_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (localeName, str, options, keyData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Il2CppString_CompareOptions0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lcid, source, opt))? };
        Ok(__cordl_ret.into())
    }
