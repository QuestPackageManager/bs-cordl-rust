#[cfg(feature = "cordl_class_System+AppContextSwitches")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+AppContextSwitches")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::AppContextSwitches {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "AppContextSwitches";
