...
for crate::System::Action_11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Action`11";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Action`11")
                    .unwrap()
                    .make_generic::<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    T10: quest_hook::libil2cpp::Type,
    T11: quest_hook::libil2cpp::Type,
> crate::System::Action_11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        T11: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Action_11<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Action_11 < T1, T2, T3, T4, T5, T6, T7, T8, T9, T10,
                    T11 > as quest_hook::libil2cpp::Type > ::class(), "Invoke", 11usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Action_11 < T1, T2, T3, T4, T5, T6, T7, T8, T9, T10,
                    T11 > as quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
