...
impl crate::System::IConvertible {
    pub fn GetTypeCode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IConvertible as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::System::TypeCode, 0usize>("GetTypeCode")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IConvertible as quest_hook::libil2cpp::Type >
                    ::class(), "GetTypeCode", 0usize
                )
            });
