...
for crate::System::Func_13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> {
    ...
    const CLASS_NAME: &'static str = "Func`13";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Func`13")
                    .unwrap()
                    .make_generic::<
...
impl<
    ...
    T12: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> crate::System::Func_13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_13<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Func_13 < T1, T2, T3, T4, T5, T6, T7, T8, T9, T10,
                    T11, T12, TResult > as quest_hook::libil2cpp::Type > ::class(),
                    "Invoke", 12usize
                )
            });
