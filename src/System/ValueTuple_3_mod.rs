...
> crate::System::ValueTuple_3<T1, T2, T3> {
    ...
    where
        ...
        T3: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ValueTuple_3<
            T1,
            T2,
            T3,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ValueTuple_3 < T1, T2, T3 > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ValueTuple_3 < T1, T2, T3 > as
                    quest_hook::libil2cpp::Type > ::class(), "GetHashCodeCore", 1usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ValueTuple_3 < T1, T2, T3 > as
                    quest_hook::libil2cpp::Type > ::class(),
                    "System.IValueTupleInternal.GetHashCode", 1usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (comparer))? };
        Ok(__cordl_ret.into())
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ValueTuple_3 < T1, T2, T3 > as
                    quest_hook::libil2cpp::Type > ::class(),
                    "System.IValueTupleInternal.ToStringEnd", 0usize
                )
            });
