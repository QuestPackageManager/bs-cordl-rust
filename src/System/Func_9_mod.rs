...
for crate::System::Func_9<T1, T2, T3, T4, T5, T6, T7, T8, TResult> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Func`9";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Func`9")
                    .unwrap()
                    .make_generic::<(T1, T2, T3, T4, T5, T6, T7, T8, TResult)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    T8: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> crate::System::Func_9<T1, T2, T3, T4, T5, T6, T7, T8, TResult> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_9<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(T1, T2, T3, T4, T5, T6, T7, T8), TResult, 8usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Func_9 < T1, T2, T3, T4, T5, T6, T7, T8, TResult > as
