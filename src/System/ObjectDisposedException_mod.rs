...
unsafe impl quest_hook::libil2cpp::Type for crate::System::ObjectDisposedException {
    ...
    const CLASS_NAME: &'static str = "ObjectDisposedException";
...
#[cfg(feature = "System+ObjectDisposedException")]
impl crate::System::ObjectDisposedException {
    pub fn GetObjectData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ObjectDisposedException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ObjectDisposedException as
    ...
    pub fn New_Il2CppString_Il2CppString2(
        ...
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (objectName, message))?;
        Ok(__cordl_object.into())
    }
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (objectName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (objectName, message))?
        };
        Ok(__cordl_ret.into())
    }
