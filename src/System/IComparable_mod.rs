...
unsafe impl quest_hook::libil2cpp::Type for crate::System::IComparable {
    ...
    const CLASS_NAME: &'static str = "IComparable";
...
impl crate::System::IComparable {
    pub fn CompareTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IComparable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::IComparable as quest_hook::libil2cpp::Type >
