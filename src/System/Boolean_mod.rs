#[cfg(feature = "cordl_class_System+Boolean")]
...
#[cfg(feature = "cordl_class_System+Boolean")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Boolean {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+Boolean")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Boolean {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Boolean")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Boolean {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Boolean")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Boolean {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Boolean")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Boolean {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Boolean")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::System::Boolean {
    type Type = Self;
...
impl crate::System::Boolean {
    ...
    pub fn CompareTo__cordl_bool1(&mut self, value: bool) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), i32, 1usize>("CompareTo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Equals__cordl_bool1(&mut self, obj: bool) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Parse_ReadOnlySpan_1_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::System::ReadOnlySpan_1<char>), bool, 1usize>(
                        "Parse",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn TryParse_Il2CppString0(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (value, result))? };
        Ok(__cordl_ret.into())
    }
