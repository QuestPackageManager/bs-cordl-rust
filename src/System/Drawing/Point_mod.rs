...
#[cfg(feature = "System+Drawing+Point")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Drawing::Point {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "System+Drawing+Point")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Drawing::Point {
    type Type = Self;
...
#[cfg(feature = "System+Drawing+Point")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Drawing::Point {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "System+Drawing+Point")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Drawing::Point {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "System+Drawing+Point")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Drawing::Point {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::System::Drawing::Point {
    pub fn Equals_Il2CppObject0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Drawing::Point as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Drawing::Point as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
    ...
    pub fn Equals_Point1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Drawing::Point as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::System::Drawing::Point), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Drawing::Point as quest_hook::libil2cpp::Type >
    ...
    pub fn op_Equality(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Drawing::Point as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (crate::System::Drawing::Point, crate::System::Drawing::Point),
                bool,
                2usize,
            >("op_Equality")
            .unwrap_or_else(|e| {
