...
for crate::System::ComponentModel::NotifyParentPropertyAttribute {
    ...
    const CLASS_NAME: &'static str = "NotifyParentPropertyAttribute";
...
impl crate::System::ComponentModel::NotifyParentPropertyAttribute {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::NotifyParentPropertyAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ComponentModel::NotifyParentPropertyAttribute as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (notifyParent))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_NotifyParent(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::NotifyParentPropertyAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_NotifyParent")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ComponentModel::NotifyParentPropertyAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "get_NotifyParent", 0usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
