...
impl crate::System::ComponentModel::IContainer {
    pub fn Remove(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::IContainer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ComponentModel::IContainer as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::IContainer as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ComponentModel::IContainer as
                    quest_hook::libil2cpp::Type > ::class(), "get_Components", 0usize
                )
            });
