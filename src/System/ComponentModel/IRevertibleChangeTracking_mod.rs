#[cfg(feature = "cordl_class_System+ComponentModel+IRevertibleChangeTracking")]
#[derive(Debug)]
#[repr(C)]
...
impl crate::System::ComponentModel::IRevertibleChangeTracking {
    pub fn RejectChanges(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
