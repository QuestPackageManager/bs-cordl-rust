...
impl crate::System::ComponentModel::IRevertibleChangeTracking {
    pub fn RejectChanges(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::IRevertibleChangeTracking as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RejectChanges")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ComponentModel::IRevertibleChangeTracking as
                    quest_hook::libil2cpp::Type > ::class(), "RejectChanges", 0usize
                )
            });
