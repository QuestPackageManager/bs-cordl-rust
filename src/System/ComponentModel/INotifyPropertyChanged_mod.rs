#[cfg(feature = "cordl_class_System+ComponentModel+INotifyPropertyChanged")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+ComponentModel+INotifyPropertyChanged")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::ComponentModel::INotifyPropertyChanged {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.ComponentModel";
    const CLASS_NAME: &'static str = "INotifyPropertyChanged";
...
#[cfg(feature = "cordl_class_System+ComponentModel+INotifyPropertyChanged")]
impl quest_hook::libil2cpp::ObjectType for crate::System::ComponentModel::INotifyPropertyChanged {
