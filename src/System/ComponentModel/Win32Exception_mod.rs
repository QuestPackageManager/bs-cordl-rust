#[cfg(feature = "cordl_class_System+ComponentModel+Win32Exception")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+ComponentModel+Win32Exception")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::ComponentModel::Win32Exception {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.ComponentModel";
    const CLASS_NAME: &'static str = "Win32Exception";
...
impl crate::System::ComponentModel::Win32Exception {
    ...
    pub fn New_i32_1(error: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn get_NativeErrorCode(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_NativeErrorCode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+ComponentModel+Win32Exception")]
impl quest_hook::libil2cpp::ObjectType for crate::System::ComponentModel::Win32Exception {
