...
for crate::System::ComponentModel::SettingsBindableAttribute {
    ...
    const CLASS_NAME: &'static str = "SettingsBindableAttribute";
...
impl crate::System::ComponentModel::SettingsBindableAttribute {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::SettingsBindableAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ComponentModel::SettingsBindableAttribute as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (bindable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Bindable(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::SettingsBindableAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_Bindable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ComponentModel::SettingsBindableAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "get_Bindable", 0usize
                )
            });
