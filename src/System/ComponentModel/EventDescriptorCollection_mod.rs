...
impl crate::System::ComponentModel::EventDescriptorCollection {
    ...
    pub type ArraySubsetEnumerator =
        crate::System::ComponentModel::EventDescriptorCollection_ArraySubsetEnumerator;
    pub fn Add(
        &mut self,
    ...
    pub fn EnsureSize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sizeNeeded))? };
        Ok(__cordl_ret.into())
    }
    pub fn Find(
        &mut self,
    ...
    pub fn InternalSort_IComparer1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sorter))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("InternalSort")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (events))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (events, readOnly))? };
        Ok(__cordl_ret.into())
    }
