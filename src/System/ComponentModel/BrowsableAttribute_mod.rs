...
#[cfg(feature = "cordl_class_System+ComponentModel+BrowsableAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::ComponentModel::BrowsableAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.ComponentModel";
    const CLASS_NAME: &'static str = "BrowsableAttribute";
...
impl crate::System::ComponentModel::BrowsableAttribute {
    ...
    pub fn New(browsable: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (browsable))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Browsable(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_Browsable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+ComponentModel+BrowsableAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::System::ComponentModel::BrowsableAttribute {
