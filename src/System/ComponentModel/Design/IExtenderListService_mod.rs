...
for crate::System::ComponentModel::Design::IExtenderListService {
    ...
    const CLASS_NAME: &'static str = "IExtenderListService";
...
impl crate::System::ComponentModel::Design::IExtenderListService {
    pub fn GetExtenderProviders(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::Design::IExtenderListService as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ComponentModel::Design::IExtenderListService as
