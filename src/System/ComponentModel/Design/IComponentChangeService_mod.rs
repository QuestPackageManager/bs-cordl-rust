#[cfg(feature = "cordl_class_System+ComponentModel+Design+IComponentChangeService")]
...
#[cfg(feature = "System+ComponentModel+Design+IComponentChangeService")]
impl std::ops::DerefMut for crate::System::ComponentModel::Design::IComponentChangeService {
...
impl crate::System::ComponentModel::Design::IComponentChangeService {
    pub fn OnComponentChanged(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), quest_hook::libil2cpp::Void, 4usize>("OnComponentChanged")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (component, member, oldValue, newValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn OnComponentChanging(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (component, member))? };
        Ok(__cordl_ret.into())
    }
