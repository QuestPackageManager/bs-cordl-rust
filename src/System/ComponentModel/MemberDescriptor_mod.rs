...
impl crate::System::ComponentModel::MemberDescriptor {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (componentClass, name, args, returnType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, attributes))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_MemberDescriptor1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (oldMemberDescriptor, newAttributes))?
        };
        Ok(__cordl_ret.into())
    }
