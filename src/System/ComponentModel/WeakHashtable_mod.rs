...
#[cfg(feature = "cordl_class_System+ComponentModel+WeakHashtable")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::ComponentModel::WeakHashtable {
...
#[cfg(feature = "System+ComponentModel+WeakHashtable+WeakKeyComparer")]
impl std::ops::DerefMut for crate::System::ComponentModel::WeakHashtable_WeakKeyComparer {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
