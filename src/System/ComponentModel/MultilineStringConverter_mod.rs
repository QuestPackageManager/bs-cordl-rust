...
for crate::System::ComponentModel::MultilineStringConverter {
    ...
    const CLASS_NAME: &'static str = "MultilineStringConverter";
...
impl crate::System::ComponentModel::MultilineStringConverter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ComponentModel::MultilineStringConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ComponentModel::MultilineStringConverter as
