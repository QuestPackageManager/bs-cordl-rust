...
for crate::System::Diagnostics::CorrelationManager {
    ...
    const CLASS_NAME: &'static str = "CorrelationManager";
...
impl crate::System::Diagnostics::CorrelationManager {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Diagnostics::CorrelationManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::Stack>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Diagnostics::CorrelationManager as
                    quest_hook::libil2cpp::Type > ::class(), "GetLogicalOperationStack",
                    0usize
                )
            });
