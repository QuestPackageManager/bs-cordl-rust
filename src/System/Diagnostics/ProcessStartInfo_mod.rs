...
pub struct ProcessStartInfo {
    ...
    pub passwordInClearText: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ...
    pub environment: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _StandardInputEncoding_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::System::Text::Encoding>,
}
#[cfg(feature = "cordl_class_System+Diagnostics+ProcessStartInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Diagnostics::ProcessStartInfo {
...
impl crate::System::Diagnostics::ProcessStartInfo {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_EnvironmentVariables")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Security::SecureString> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
