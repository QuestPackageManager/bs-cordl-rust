#[cfg(feature = "cordl_class_System+Diagnostics+ProcessInfo")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Diagnostics+ProcessInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Diagnostics::ProcessInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Diagnostics";
    const CLASS_NAME: &'static str = "ProcessInfo";
