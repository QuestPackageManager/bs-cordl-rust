...
impl crate::System::Diagnostics::BooleanSwitch {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Diagnostics::BooleanSwitch as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Diagnostics::BooleanSwitch as
