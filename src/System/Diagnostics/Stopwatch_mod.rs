#[cfg(feature = "cordl_class_System+Diagnostics+Stopwatch")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Diagnostics::Stopwatch {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Diagnostics::Stopwatch> =
    ...
    pub fn get_Elapsed(&mut self) -> quest_hook::libil2cpp::Result<crate::System::TimeSpan> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
