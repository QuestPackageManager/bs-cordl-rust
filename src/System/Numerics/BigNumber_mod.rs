...
impl crate::System::Numerics::BigNumber {
    ...
    pub fn HexNumberToBigInteger(
        number: quest_hook::libil2cpp::ByRefMut<crate::System::Numerics::BigNumber_BigNumberBuffer>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 2usize>("HexNumberToBigInteger")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        quest_hook::libil2cpp::ByRefMut<crate::System::Numerics::BigInteger>,
                    ), bool, 2usize>("NumberToBigInteger")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ParseBigInteger_Il2CppString0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Globalization::NumberFormatInfo>,
                    ), crate::System::Numerics::BigInteger, 3usize>(
                        "ParseBigInteger"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Numerics::BigInteger =
            unsafe { cordl_method_info.invoke_unchecked((), (value, style, info))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryParseBigInteger(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Globalization::NumberFormatInfo>,
                        quest_hook::libil2cpp::ByRefMut<crate::System::Numerics::BigInteger>,
                    ), bool, 4usize>("TryParseBigInteger")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (value, style, info, result))? };
        Ok(__cordl_ret.into())
    }
    pub fn TryValidateParseStyleInteger(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<crate::System::ArgumentException>,
                        >,
                    ), bool, 2usize>("TryValidateParseStyleInteger")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (style, e))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Numerics+BigNumber")]
...
#[cfg(feature = "cordl_class_System+Numerics+BigNumber+BigNumberBuffer")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Numerics::BigNumber_BigNumberBuffer {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Numerics";
...
#[cfg(feature = "cordl_class_System+Numerics+BigNumber+BigNumberBuffer")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Numerics::BigNumber_BigNumberBuffer {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Numerics+BigNumber+BigNumberBuffer")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Numerics::BigNumber_BigNumberBuffer {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Numerics+BigNumber+BigNumberBuffer")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Numerics::BigNumber_BigNumberBuffer {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::System::Numerics::BigNumber_BigNumberBuffer {
    pub fn Create(
    ) -> quest_hook::libil2cpp::Result<crate::System::Numerics::BigNumber_BigNumberBuffer> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::System::Numerics::BigNumber_BigNumberBuffer =
