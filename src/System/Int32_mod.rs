...
impl crate::System::Int32 {
    ...
    pub fn CompareTo_Il2CppObject0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Int32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Int32 as quest_hook::libil2cpp::Type > ::class(),
                    "CompareTo", 1usize
                )
            });
    ...
    pub fn CompareTo_i32_1(&mut self, value: i32) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Int32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32), i32, 1usize>("CompareTo")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Int32 as quest_hook::libil2cpp::Type > ::class(),
    ...
    pub fn Equals_i32_1(&mut self, obj: i32) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Int32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Int32 as quest_hook::libil2cpp::Type > ::class(),
    ...
    pub fn Parse_Il2CppString_IFormatProvider2(
        ...
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked((), (s, provider))? };
        Ok(__cordl_ret.into())
    }
    pub fn Parse_Il2CppString_NumberStyles1(
        ...
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked((), (s, style))? };
        Ok(__cordl_ret.into())
    }
