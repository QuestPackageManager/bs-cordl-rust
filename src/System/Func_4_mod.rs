#[cfg(feature = "cordl_class_System+Func_4")]
#[repr(C)]
...
unsafe impl<
        ...
        T3: quest_hook::libil2cpp::Type,
        TResult: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::System::Func_4<T1, T2, T3, TResult>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Func`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System", "Func`4")
                .unwrap()
                .make_generic::<(T1, T2, T3, TResult)>()
                .unwrap()
                .unwrap()
        })
    }
...
{
    pub fn Invoke(&mut self, arg1: T1, arg2: T2, arg3: T3) -> quest_hook::libil2cpp::Result<TResult>
    where
        T1: quest_hook::libil2cpp::Type
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T1, T2, T3), TResult, 3usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
