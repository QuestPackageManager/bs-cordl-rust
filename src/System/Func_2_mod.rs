...
> quest_hook::libil2cpp::Type for crate::System::Func_2<T, TResult> {
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Func`2")
                    .unwrap()
...
> crate::System::Func_2<T, TResult> {
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_2<
            T,
            TResult,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(T), TResult, 1usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Func_2 < T, TResult > as quest_hook::libil2cpp::Type
                    > ::class(), "Invoke", 1usize
                )
            });
        let __cordl_ret: TResult = unsafe { method.invoke_unchecked(self, (arg))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
