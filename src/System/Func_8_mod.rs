...
> crate::System::Func_8<T1, T2, T3, T4, T5, T6, T7, TResult> {
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_8<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Func_8 < T1, T2, T3, T4, T5, T6, T7, TResult > as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 7usize
                )
            });
        let __cordl_ret: TResult = unsafe {
            method.invoke_unchecked(self, (arg1, arg2, arg3, arg4, arg5, arg6, arg7))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
