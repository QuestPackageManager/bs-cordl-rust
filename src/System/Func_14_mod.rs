...
> {
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_14<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Func_14 < T1, T2, T3, T4, T5, T6, T7, T8, T9, T10,
                    T11, T12, T13, TResult > as quest_hook::libil2cpp::Type > ::class(),
                    "Invoke", 13usize
                )
            });
