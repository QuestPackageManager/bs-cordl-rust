...
impl crate::System::Text::Base64Encoding {
    ...
    pub fn IsValidLeadBytes(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, i32, i32, i32), bool, 4usize>("IsValidLeadBytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (v1, v2, v3, v4))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsValidTailBytes(&mut self, v3: i32, v4: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (v3, v4))? };
        Ok(__cordl_ret.into())
    }
