...
impl crate::System::Text::RegularExpressions::RegexFC {
    pub fn AddFC(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (fc, concatenate))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString__cordl_bool__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (charClass, nullable, caseInsensitive))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (nullable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_char__cordl_bool__cordl_bool__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (ch, _cordl_not, nullable, caseInsensitive))?
        };
        Ok(__cordl_ret.into())
    }
