...
for crate::System::Text::RegularExpressions::RegexFC {
    ...
    const CLASS_NAME: &'static str = "RegexFC";
...
impl crate::System::Text::RegularExpressions::RegexFC {
    pub fn AddFC(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::RegularExpressions::RegexFC as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Text::RegularExpressions::RegexFC as
                    quest_hook::libil2cpp::Type > ::class(), "AddFC", 2usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (fc, concatenate))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::RegularExpressions::RegexFC as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Text::RegularExpressions::RegexFC as
                    quest_hook::libil2cpp::Type > ::class(), "GetFirstChars", 1usize
                )
            });
    ...
    pub fn _ctor_Il2CppString__cordl_bool__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (charClass, nullable, caseInsensitive))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (nullable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_char__cordl_bool__cordl_bool__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ch, _cordl_not, nullable, caseInsensitive))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_CaseInsensitive(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::RegularExpressions::RegexFC as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_CaseInsensitive")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Text::RegularExpressions::RegexFC as
                    quest_hook::libil2cpp::Type > ::class(), "get_CaseInsensitive",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::RegularExpressions::RegexFC as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Text::RegularExpressions::RegexFC as
                    quest_hook::libil2cpp::Type > ::class(), "set_CaseInsensitive",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
