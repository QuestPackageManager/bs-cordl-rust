...
impl crate::System::Text::RegularExpressions::RegexFCD {
    ...
    pub fn Anchors(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (tree))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CalculateFC(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (NodeType, node, CurIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Dispose(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "PopInt",
                            0usize
                        )
                    })
            });
    ...
    pub fn PushFC(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (fc))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn PushInt(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "PushInt",
                            1usize
                        )
                    })
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (intStack))?
        };
        Ok(__cordl_ret.into())
    }
}
