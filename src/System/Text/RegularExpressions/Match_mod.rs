...
impl crate::System::Text::RegularExpressions::Match {
    pub fn AddMatch(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cap, start, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BalanceMatch(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GroupToStringImpl", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::System::ReadOnlySpan_1<char> = unsafe {
            cordl_method_info.invoke_unchecked(self, (groupnum))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Reset(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (regex, text, textbeg, textend, textstart))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Tidy(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Tidy",
                            1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (textpos))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_1(
