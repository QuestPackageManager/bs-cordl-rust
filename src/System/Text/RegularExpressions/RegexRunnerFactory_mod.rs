...
impl crate::System::Text::RegularExpressions::RegexRunnerFactory {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::RegularExpressions::RegexRunnerFactory as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Text::RegularExpressions::RegexRunnerFactory as
