...
pub struct GroupCollection {
    ...
    pub _match: quest_hook::libil2cpp::Gc<crate::System::Text::RegularExpressions::Match>,
...
impl crate::System::Text::RegularExpressions::GroupCollection {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Text::RegularExpressions::Group> =
    ...
    pub fn _ctor_Match_Hashtable0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_match, caps))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "System+Text+RegularExpressions+GroupCollection+Enumerator")]
impl std::ops::Deref for crate::System::Text::RegularExpressions::GroupCollection_Enumerator {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "System+Text+RegularExpressions+GroupCollection+Enumerator")]
impl std::ops::DerefMut for crate::System::Text::RegularExpressions::GroupCollection_Enumerator {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
