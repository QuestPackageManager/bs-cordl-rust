#[cfg(feature = "cordl_class_System+Text+ValueStringBuilder")]
...
pub struct ValueStringBuilder {
    pub _arrayToReturnToPool: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<char>>,
...
#[cfg(feature = "cordl_class_System+Text+ValueStringBuilder")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Text::ValueStringBuilder {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Text+ValueStringBuilder")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::System::Text::ValueStringBuilder {
    type Type = Self;
...
impl crate::System::Text::ValueStringBuilder {
    ...
    pub fn Append_Il2CppObject_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (value, length))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Grow(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (requiredAdditionalCapacity))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Insert(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, char, i32), quest_hook::libil2cpp::Void, 3usize>("Insert")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (initialBuffer))? };
        Ok(__cordl_ret.into())
    }
