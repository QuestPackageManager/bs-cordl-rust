...
#[cfg(feature = "cordl_class_System+Text+EncoderFallbackException")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Text::EncoderFallbackException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Text";
    const CLASS_NAME: &'static str = "EncoderFallbackException";
...
impl crate::System::Text::EncoderFallbackException {
    ...
    pub fn _ctor_Il2CppString__cordl_char__cordl_char_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (message, charUnknownHigh, charUnknownLow, index))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString__cordl_char_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, charUnknown, index))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Text+EncoderFallbackException")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Text::EncoderFallbackException {
