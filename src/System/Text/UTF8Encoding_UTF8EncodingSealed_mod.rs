...
impl crate::GlobalNamespace::UTF8Encoding_UTF8EncodingSealed {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encoderShouldEmitUTF8Identifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Preamble(
        &mut self,
...
#[cfg(feature = "cordl_class_System+Text+UTF8Encoding+UTF8EncodingSealed")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::UTF8Encoding_UTF8EncodingSealed {
