#[cfg(feature = "cordl_class_System+Text+InternalDecoderBestFitFallbackBuffer")]
#[repr(C)]
...
pub struct InternalDecoderBestFitFallbackBuffer {
    ...
    pub _iCount: i32,
    pub _iSize: i32,
    pub _oFallback: quest_hook::libil2cpp::Gc<crate::System::Text::InternalDecoderBestFitFallback>,
}
#[cfg(feature = "cordl_class_System+Text+InternalDecoderBestFitFallbackBuffer")]
...
impl crate::System::Text::InternalDecoderBestFitFallbackBuffer {
    ...
    pub fn New(
        fallback: quest_hook::libil2cpp::Gc<crate::System::Text::InternalDecoderBestFitFallback>,
    ...
    pub fn TryBestFit(
        ...
        let __cordl_ret: char = unsafe { cordl_method_info.invoke_unchecked(self, (bytesCheck))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
