...
impl crate::System::Text::InternalDecoderBestFitFallbackBuffer {
    pub fn Fallback(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::InternalDecoderBestFitFallbackBuffer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Text::InternalDecoderBestFitFallbackBuffer as
    ...
    pub fn TryBestFit(
        ...
        let __cordl_ret: char = unsafe { method.invoke_unchecked(self, (bytesCheck))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
