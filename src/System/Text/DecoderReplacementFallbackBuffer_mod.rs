...
impl crate::System::Text::DecoderReplacementFallbackBuffer {
    pub fn Fallback(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::DecoderReplacementFallbackBuffer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Text::DecoderReplacementFallbackBuffer as
