...
impl crate::System::Text::EncoderExceptionFallbackBuffer {
    pub fn Fallback__cordl_char_i32_1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Text::EncoderExceptionFallbackBuffer as quest_hook::libil2cpp::Type>::class()
            .find_method::<(char, char, i32), bool, 3usize>("Fallback")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Text::EncoderExceptionFallbackBuffer as
