...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Text::UTF32Encoding {
    ...
    const CLASS_NAME: &'static str = "UTF32Encoding";
...
#[cfg(feature = "System+Text+UTF32Encoding")]
impl crate::System::Text::UTF32Encoding {
    #[cfg(feature = "System+Text+UTF32Encoding+UTF32Decoder")]
    pub type UTF32Decoder = crate::System::Text::UTF32Encoding_UTF32Decoder;
    pub fn Equals(
        &mut self,
    ...
    pub fn GetByteCount_Il2CppObject_i32_2(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (chars, count))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetByteCount_Il2CppObject_i32_EncoderNLS3(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (chars, count, encoder))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetBytes_Il2CppObject_Il2CppObject_i32_2(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (chars, charCount, bytes, byteCount))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetBytes_Il2CppString_i32_Il2CppArray_i32_0(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (s, charIndex, charCount, bytes, byteIndex))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetCharCount_Il2CppObject1(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (bytes, count))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetCharCount_Il2CppObject_DecoderNLS2(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (bytes, count, baseDecoder))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetChars_Il2CppObject_Il2CppObject_i32_1(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (bytes, byteCount, chars, charCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetChars_Il2CppObject_Il2CppObject_i32_DecoderNLS2(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bytes, byteCount, chars, charCount, baseDecoder))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetDecoder(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::Text::Decoder>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Text::Decoder> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn GetEncoder(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::Text::Encoder>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Text::Encoder> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetHighSurrogate(&mut self, iChar: u32) -> quest_hook::libil2cpp::Result<char> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u32), char, 1usize>("GetHighSurrogate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: char = unsafe { cordl_method_info.invoke_unchecked(self, (iChar))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetLowSurrogate(&mut self, iChar: u32) -> quest_hook::libil2cpp::Result<char> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u32), char, 1usize>("GetLowSurrogate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetMaxByteCount(&mut self, charCount: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (charCount))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetMaxCharCount(&mut self, byteCount: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (byteCount))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetPreamble(
        &mut self,
    ...
    pub fn GetSurrogate(&mut self, cHigh: char, cLow: char) -> quest_hook::libil2cpp::Result<u32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(char, char), u32, 2usize>("GetSurrogate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked(self, (cHigh, cLow))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn New__cordl_bool__cordl_bool1(
        ...
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (bigEndian, byteOrderMark))?;
        Ok(__cordl_object.into())
    }
    pub fn New__cordl_bool__cordl_bool__cordl_bool2(
        bigEndian: bool,
        byteOrderMark: bool,
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object).invoke_void(
            ".ctor",
            (bigEndian, byteOrderMark, throwOnInvalidCharacters),
        )?;
        Ok(__cordl_object.into())
    }
    pub fn SetDefaultFallbacks(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetDefaultFallbacks")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor__cordl_bool__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bigEndian, byteOrderMark))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool__cordl_bool__cordl_bool2(
        &mut self,
        bigEndian: bool,
        byteOrderMark: bool,
        throwOnInvalidCharacters: bool,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bigEndian, byteOrderMark, throwOnInvalidCharacters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Preamble(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::ReadOnlySpan_1<u8>, 0usize>("get_Preamble")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::ReadOnlySpan_1<u8> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "cordl_class_System+Text+UTF32Encoding+UTF32Decoder")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Text::UTF32Encoding_UTF32Decoder {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Text";
    const CLASS_NAME: &'static str = "UTF32Encoding/UTF32Decoder";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "System+Text+UTF32Encoding+UTF32Decoder")]
impl crate::System::Text::UTF32Encoding_UTF32Decoder {
    pub fn New(
        encoding: quest_hook::libil2cpp::Gc<crate::System::Text::UTF32Encoding>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<crate::System::Text::UTF32Encoding>),
...
#[cfg(feature = "cordl_class_System+Text+UTF32Encoding+UTF32Decoder")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Text::UTF32Encoding_UTF32Decoder {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
