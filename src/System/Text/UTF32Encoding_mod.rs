...
impl crate::System::Text::UTF32Encoding {
    ...
    pub fn GetCharCount_Il2CppObject_DecoderNLS2(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (bytes, count, baseDecoder))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetHighSurrogate", 1usize
                        )
                    })
            });
        let __cordl_ret: char = unsafe {
            cordl_method_info.invoke_unchecked(self, (iChar))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetSurrogate(
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (cHigh, cLow))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor__cordl_bool__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bigEndian, byteOrderMark))?
        };
        Ok(__cordl_ret.into())
    }
