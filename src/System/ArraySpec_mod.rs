...
impl crate::System::ArraySpec {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ArraySpec as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>),
                quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::ArraySpec as quest_hook::libil2cpp::Type > ::class(),
                    "Append", 1usize
                )
            });
