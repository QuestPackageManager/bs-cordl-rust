#[cfg(feature = "cordl_class_System+UInt64")]
...
#[cfg(feature = "cordl_class_System+UInt64")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::UInt64 {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+UInt64")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::UInt64 {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+UInt64")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::UInt64 {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+UInt64")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::UInt64 {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+UInt64")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::UInt64 {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+UInt64")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::System::UInt64 {
    type Type = Self;
...
impl crate::System::UInt64 {
    ...
    pub fn CompareTo_u64_1(&mut self, value: u64) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u64), i32, 1usize>("CompareTo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Equals_u64_1(&mut self, obj: u64) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u64), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Parse_IFormatProvider2(
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (s, provider))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Parse_NumberStyles1(
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (s, style))? };
        Ok(__cordl_ret.into())
    }
