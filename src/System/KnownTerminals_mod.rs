...
impl crate::System::KnownTerminals {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::KnownTerminals as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::KnownTerminals as quest_hook::libil2cpp::Type >
                    ::class(), "get_ansi", 0usize
                )
            });
