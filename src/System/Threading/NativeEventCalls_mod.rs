#[cfg(feature = "cordl_class_System+Threading+NativeEventCalls")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Threading::NativeEventCalls {
    ...
    pub fn CreateEvent_icall(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::System::IntPtr, 5usize>("CreateEvent_icall")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info
                .invoke_unchecked((), (manual, initial, name, name_length, errorCode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateEvent_internal(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), crate::System::IntPtr, 4usize>("CreateEvent_internal")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (manual, initial, name, errorCode))? };
        Ok(__cordl_ret.into())
    }
    pub fn ResetEvent(
        handle: quest_hook::libil2cpp::Gc<crate::Microsoft::Win32::SafeHandles::SafeWaitHandle>,
    ...
    pub fn SetEvent_internal(handle: crate::System::IntPtr) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
