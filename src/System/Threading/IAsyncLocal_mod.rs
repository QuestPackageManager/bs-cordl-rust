#[cfg(feature = "cordl_class_System+Threading+IAsyncLocal")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Threading+IAsyncLocal")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Threading::IAsyncLocal {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Threading";
    const CLASS_NAME: &'static str = "IAsyncLocal";
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        bool,
                    ), quest_hook::libil2cpp::Void, 3usize>("OnValueChanged")
                    .unwrap_or_else(|e| {
                        panic!(
