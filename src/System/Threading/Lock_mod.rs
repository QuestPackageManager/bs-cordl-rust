...
#[cfg(feature = "System+Threading+Lock")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Threading::Lock {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Threading";
    const CLASS_NAME: &'static str = "Lock";
...
impl crate::System::Threading::Lock {
    pub fn Acquire(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Threading::Lock as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Acquire")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Threading::Lock as quest_hook::libil2cpp::Type >
                    ::class(), "Acquire", 0usize
                )
            });
