...
pub struct TaskCompletionSource_1<TResult: quest_hook::libil2cpp::Type> {
    ...
    pub _task: quest_hook::libil2cpp::Gc<TResult>,
...
> crate::System::Threading::Tasks::TaskCompletionSource_1<TResult> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (state, creationOptions))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (creationOptions))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Task(
