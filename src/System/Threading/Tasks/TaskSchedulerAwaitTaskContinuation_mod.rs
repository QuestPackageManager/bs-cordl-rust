...
impl std::ops::Deref for crate::System::Threading::Tasks::TaskSchedulerAwaitTaskContinuation {
...
#[cfg(feature = "System+Threading+Tasks+TaskSchedulerAwaitTaskContinuation")]
impl std::ops::DerefMut for crate::System::Threading::Tasks::TaskSchedulerAwaitTaskContinuation {
...
impl crate::System::Threading::Tasks::TaskSchedulerAwaitTaskContinuation {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (scheduler, action, flowExecutionContext))?
        };
        Ok(__cordl_ret.into())
    }
}
