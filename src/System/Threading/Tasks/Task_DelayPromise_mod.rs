...
#[cfg(feature = "System+Threading+Tasks+Task+DelayPromise")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::Task_DelayPromise {
...
impl crate::GlobalNamespace::Task_DelayPromise {
    pub fn Complete(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::Task_DelayPromise as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Complete")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::Task_DelayPromise as
