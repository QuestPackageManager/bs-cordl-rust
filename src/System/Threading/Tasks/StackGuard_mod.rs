...
impl crate::System::Threading::Tasks::StackGuard {
    ...
    pub fn EndInliningScope(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Threading::Tasks::StackGuard as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EndInliningScope")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Threading::Tasks::StackGuard as
                    quest_hook::libil2cpp::Type > ::class(), "EndInliningScope", 0usize
                )
            });
    ...
    pub fn TryBeginInliningScope(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Threading::Tasks::StackGuard as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("TryBeginInliningScope")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Threading::Tasks::StackGuard as
                    quest_hook::libil2cpp::Type > ::class(), "TryBeginInliningScope",
                    0usize
                )
            });
