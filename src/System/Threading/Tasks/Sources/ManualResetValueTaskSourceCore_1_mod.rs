#[cfg(
    feature = "cordl_class_System+Threading+Tasks+Sources+ManualResetValueTaskSourceCore_1"
)]
#[repr(C)]
...
pub struct ManualResetValueTaskSourceCore_1<TResult: quest_hook::libil2cpp::Type> {
    pub _continuation: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _continuationState: quest_hook::libil2cpp::Gc<
    ...
    pub _completed: bool,
    pub _result: TResult,
    pub _error: quest_hook::libil2cpp::Gc<
...
> crate::System::Threading::Tasks::Sources::ManualResetValueTaskSourceCore_1<TResult> {
    ...
    pub fn get_RunContinuationsAsynchronously(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_RunContinuationsAsynchronously", 0usize
                        )
                    })
            });
