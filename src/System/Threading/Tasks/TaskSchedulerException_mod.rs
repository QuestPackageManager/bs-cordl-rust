...
impl crate::System::Threading::Tasks::TaskSchedulerException {
    ...
    pub fn _ctor_Exception1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (innerException))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Threading+Tasks+TaskSchedulerException")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Threading::Tasks::TaskSchedulerException {
