#[cfg(feature = "cordl_class_System+Threading+Tasks+ContinuationResultTaskFromResultTask_2")]
#[repr(C)]
#[derive(Debug)]
...
> {
    ...
    pub m_antecedent:
        quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task_1<TAntecedentResult>>,
    __cordl_phantom_TAntecedentResult: std::marker::PhantomData<TAntecedentResult>,
    __cordl_phantom_TResult: std::marker::PhantomData<TResult>,
}
#[cfg(feature = "cordl_class_System+Threading+Tasks+ContinuationResultTaskFromResultTask_2")]
unsafe impl<TAntecedentResult: quest_hook::libil2cpp::Type, TResult: quest_hook::libil2cpp::Type>
...
impl<TAntecedentResult: quest_hook::libil2cpp::Type, TResult: quest_hook::libil2cpp::Type>
    std::ops::Deref
    for crate::System::Threading::Tasks::ContinuationResultTaskFromResultTask_2<
        TAntecedentResult,
        TResult,
...
impl<TAntecedentResult: quest_hook::libil2cpp::Type, TResult: quest_hook::libil2cpp::Type>
    ...
    >
{
    pub fn InnerInvoke(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TAntecedentResult: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InnerInvoke")
                    .unwrap_or_else(|e| {
                        panic!(
