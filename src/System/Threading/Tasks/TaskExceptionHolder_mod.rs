...
pub struct TaskExceptionHolder {
    ...
    pub m_faultExceptions: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub m_cancellationException:
        quest_hook::libil2cpp::Gc<crate::System::Runtime::ExceptionServices::ExceptionDispatchInfo>,
    pub m_isHandled: bool,
}
#[cfg(feature = "cordl_class_System+Threading+Tasks+TaskExceptionHolder")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Threading::Tasks::TaskExceptionHolder {
...
impl crate::System::Threading::Tasks::TaskExceptionHolder {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateExceptionObject", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::AggregateException> = unsafe {
            cordl_method_info.invoke_unchecked(self, (calledFromFinalizer, includeThisException))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MarkAsHandled(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (calledFromFinalizer))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetCancellationException", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn ShouldFailFastOnUnobservedException() -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), bool, 0usize>("ShouldFailFastOnUnobservedException")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Threading+Tasks+TaskExceptionHolder")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Threading::Tasks::TaskExceptionHolder {
