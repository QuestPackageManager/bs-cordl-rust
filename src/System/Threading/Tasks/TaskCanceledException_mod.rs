...
for crate::System::Threading::Tasks::TaskCanceledException {
    ...
    const CLASS_NAME: &'static str = "TaskCanceledException";
...
#[cfg(feature = "System+Threading+Tasks+TaskCanceledException")]
impl crate::System::Threading::Tasks::TaskCanceledException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Threading::Tasks::TaskCanceledException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Threading::Tasks::TaskCanceledException as
