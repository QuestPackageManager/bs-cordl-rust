...
pub struct ThreadPoolWorkQueueThreadLocals {
    ...
    pub workQueue: quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueue>,
    pub workStealingQueue:
        quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueue_WorkStealingQueue>,
    ...
    for crate::System::Threading::ThreadPoolWorkQueueThreadLocals
{
    ...
    const CLASS_NAME: &'static str = "ThreadPoolWorkQueueThreadLocals";
...
impl crate::System::Threading::ThreadPoolWorkQueueThreadLocals {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tpq))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Threading+ThreadPoolWorkQueueThreadLocals")]
