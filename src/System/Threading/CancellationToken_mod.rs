...
impl crate::System::Threading::CancellationToken {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InternalRegisterWithoutEC", 2usize
                        )
                    })
            });
    ...
    pub fn Register_Gc_Il2CppObject1(
        &mut self,
        callback: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
        >,
    ...
    pub fn Register_Gc_Il2CppObject__cordl_bool__cordl_bool2(
        &mut self,
        callback: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
        >,
    ...
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (canceled))?
        };
        Ok(__cordl_ret.into())
    }
