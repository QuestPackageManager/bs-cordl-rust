#[cfg(feature = "cordl_class_System+Threading+AsyncLocalValueChangedArgs_1")]
    ...
    for crate::System::Threading::AsyncLocalValueChangedArgs_1<T>
{
    ...
    const CLASS_NAME: &'static str = "AsyncLocalValueChangedArgs`1";
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Threading::AsyncLocalValueChangedArgs_1<T> {
    pub fn _ctor(
        &mut self,
        previousValue: T,
        currentValue: T,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T, T, bool), quest_hook::libil2cpp::Void, 3usize>(".ctor")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (previousValue, currentValue, contextChanged))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), T, 0usize>("get_CurrentValue")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
