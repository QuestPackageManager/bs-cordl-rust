...
impl crate::System::Threading::LockQueue {
    ...
    pub fn Pulse(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn Wait(&mut self, timeout: i32) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (timeout))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::System::Threading::ReaderWriterLock,
                        >),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rwlock))? };
        Ok(__cordl_ret.into())
    }
