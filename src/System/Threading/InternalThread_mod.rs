...
pub struct InternalThread {
    ...
    pub abort_exc: *mut quest_hook::libil2cpp::Il2CppObject,
    ...
    pub current_appcontext: *mut quest_hook::libil2cpp::Il2CppObject,
    pub root_domain_thread: *mut quest_hook::libil2cpp::Il2CppObject,
