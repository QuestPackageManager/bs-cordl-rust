...
impl crate::GlobalNamespace::CancellationTokenSource_Linked1CancellationTokenSource {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CancellationTokenSource_Linked1CancellationTokenSource as quest_hook::libil2cpp::Type>::class()
