...
impl crate::System::Threading::ThreadPoolWorkQueue {
    ...
    pub fn Dequeue(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tl, callback, missedSteal))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Enqueue(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (callback, forceGlobal))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CompareExchangeIndexes", 4usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (prevUpper, newUpper, prevLower, newLower))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetIndexes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (upper, lower))?
        };
        Ok(__cordl_ret.into())
    }
...
> crate::System::Threading::ThreadPoolWorkQueue_SparseArray_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (initialSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
...
impl crate::System::Threading::ThreadPoolWorkQueue_WorkStealingQueue {
    ...
    pub fn TrySteal_ByRefMut_ByRefMut0(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (obj, missedSteal))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TrySteal_i32_1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (obj, missedSteal, millisecondsTimeout))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
