...
pub struct ThreadPoolWorkQueue {
    ...
    pub queueHead:
        quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueue_QueueSegment>,
    pub queueTail:
        quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueue_QueueSegment>,
    pub numOutstandingThreadRequests: i32,
}
#[cfg(feature = "cordl_class_System+Threading+ThreadPoolWorkQueue")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Threading::ThreadPoolWorkQueue {
...
impl crate::System::Threading::ThreadPoolWorkQueue {
    ...
    pub type SparseArray_1<T: quest_hook::libil2cpp::Type> =
    ...
    pub fn Dequeue(
        &mut self,
        tl: quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueueThreadLocals>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("Dequeue")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tl, callback, missedSteal))? };
        Ok(__cordl_ret.into())
    }
    pub fn Dispatch() -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), bool, 0usize>("Dispatch")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Enqueue(
        &mut self,
        callback: quest_hook::libil2cpp::Gc<crate::System::Threading::IThreadPoolWorkItem>,
        forceGlobal: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (callback, forceGlobal))? };
        Ok(__cordl_ret.into())
    }
    pub fn EnsureCurrentThreadHasQueue(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueueThreadLocals>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Threading::ThreadPoolWorkQueueThreadLocals,
                    >, 0usize>("EnsureCurrentThreadHasQueue")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn EnsureThreadRequested(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EnsureThreadRequested")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "LocalFindAndPop", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (callback))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Threading+ThreadPoolWorkQueue")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Threading::ThreadPoolWorkQueue {
...
pub struct ThreadPoolWorkQueue_QueueSegment {
    ...
    >,
    pub indexes: i32,
    pub Next: quest_hook::libil2cpp::Gc<crate::System::Threading::ThreadPoolWorkQueue_QueueSegment>,
}
#[cfg(feature = "cordl_class_System+Threading+ThreadPoolWorkQueue+QueueSegment")]
...
impl crate::System::Threading::ThreadPoolWorkQueue_QueueSegment {
    pub fn CompareExchangeIndexes(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<i32>,
                        i32,
                    ), bool, 4usize>("CompareExchangeIndexes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (prevUpper, newUpper, prevLower, newLower))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetIndexes(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::ByRefMut<i32>,
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), quest_hook::libil2cpp::Void, 2usize>("GetIndexes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (upper, lower))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsUsedUp(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsUsedUp")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    crate::System::Threading::ThreadPoolWorkQueue_SparseArray_1<T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (e))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(initialSize: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
    ...
    pub fn Remove(&mut self, e: T) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (initialSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
        &mut self,
...
#[cfg(feature = "System+Threading+ThreadPoolWorkQueue+WorkStealingQueue")]
impl std::ops::Deref for crate::System::Threading::ThreadPoolWorkQueue_WorkStealingQueue {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "System+Threading+ThreadPoolWorkQueue+WorkStealingQueue")]
impl std::ops::DerefMut for crate::System::Threading::ThreadPoolWorkQueue_WorkStealingQueue {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::System::Threading::ThreadPoolWorkQueue_WorkStealingQueue {
    ...
    pub fn TrySteal_ByRefMut_ByRefMut0(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (obj, missedSteal))? };
        Ok(__cordl_ret.into())
    }
    pub fn TrySteal_i32_1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (obj, missedSteal, millisecondsTimeout))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
