...
pub struct CancellationCallbackInfo {
    ...
    pub TargetExecutionContext:
        quest_hook::libil2cpp::Gc<crate::System::Threading::ExecutionContext>,
    pub CancellationTokenSource:
        quest_hook::libil2cpp::Gc<crate::System::Threading::CancellationTokenSource>,
}
#[cfg(feature = "cordl_class_System+Threading+CancellationCallbackInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Threading::CancellationCallbackInfo {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ExecutionContextCallback", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_System+Threading+CancellationCallbackInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Threading::CancellationCallbackInfo {
