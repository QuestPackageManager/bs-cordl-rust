...
impl crate::System::Threading::WaitHandle {
    ...
    pub fn Dispose__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (explicitDisposing))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("SetHandleInternal")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ThrowAbandonedMutexException_0(
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn ThrowAbandonedMutexException_i32_WaitHandle1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (location, handle))? };
        Ok(__cordl_ret.into())
    }
    pub fn WaitAny_TimeSpan1(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (waitHandles, timeout, exitContext))? };
        Ok(__cordl_ret.into())
    }
    pub fn WaitAny_i32_0(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked((), (waitHandles, millisecondsTimeout, exitContext))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WaitMultiple(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked((), (waitHandles, millisecondsTimeout, exitContext, WaitAll))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WaitOne_TimeSpan__cordl_bool1(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (timeout, exitContext))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WaitOne_i32__cordl_bool0(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (millisecondsTimeout, exitContext))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Wait_internal(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (handles, numHandles, waitAll, ms))? };
        Ok(__cordl_ret.into())
    }
