#[cfg(feature = "cordl_class_System+Threading+ThreadHelper")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Threading::ThreadHelper {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetExecutionContextHelper", 1usize
                        )
                    })
            });
    ...
    pub fn ThreadStart_1(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
