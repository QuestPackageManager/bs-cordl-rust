...
pub struct SparselyPopulatedArrayFragment_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _freeCount: i32,
    pub _next: quest_hook::libil2cpp::Gc<T>,
    pub _prev: quest_hook::libil2cpp::Gc<T>,
...
> crate::System::Threading::SparselyPopulatedArrayFragment_1<T> {
    pub fn New_Gc1(
        _cordl_size: i32,
        prev: quest_hook::libil2cpp::Gc<T>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SafeAtomicRemove", 2usize
                        )
                    })
            });
        let __cordl_ret: T = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, expectedElement))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Gc1(
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_size, prev))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_0(
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<T>, 0usize>("get_Prev")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
