#[cfg(feature = "cordl_class_System+Threading+SparselyPopulatedArrayFragment_1")]
#[repr(C)]
#[derive(Debug)]
pub struct SparselyPopulatedArrayFragment_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _freeCount: i32,
    pub _next:
        quest_hook::libil2cpp::Gc<crate::System::Threading::SparselyPopulatedArrayFragment_1<T>>,
    pub _prev:
        quest_hook::libil2cpp::Gc<crate::System::Threading::SparselyPopulatedArrayFragment_1<T>>,
    ...
    for crate::System::Threading::SparselyPopulatedArrayFragment_1<T>
{
    ...
    const CLASS_NAME: &'static str = "SparselyPopulatedArrayFragment`1";
...
#[cfg(feature = "System+Threading+SparselyPopulatedArrayFragment_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Threading::SparselyPopulatedArrayFragment_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, T), T, 2usize>("SafeAtomicRemove")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: T =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, expectedElement))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_size, prev))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_0(
        &mut self,
