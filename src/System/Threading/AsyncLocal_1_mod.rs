...
pub struct AsyncLocal_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_valueChangedHandler: quest_hook::libil2cpp::Gc<
        crate::System::Action_1<crate::System::Threading::AsyncLocalValueChangedArgs_1<T>>,
    >,
    ...
    for crate::System::Threading::AsyncLocal_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Threading", "AsyncLocal`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::System::Threading::AsyncLocal_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Threading::AsyncLocal_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (previousValueObj, currentValueObj, contextChanged))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (valueChangedHandler))? };
        Ok(__cordl_ret.into())
    }
    pub fn set_Value(
        &mut self,
