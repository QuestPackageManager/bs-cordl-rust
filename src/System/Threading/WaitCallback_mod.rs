...
#[cfg(feature = "System+Threading+WaitCallback")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Threading::WaitCallback {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Threading";
    const CLASS_NAME: &'static str = "WaitCallback";
...
impl crate::System::Threading::WaitCallback {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Threading::WaitCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Threading::WaitCallback as
