...
impl crate::System::Threading::CancellationTokenSource {
    ...
    pub fn CancelAfter_TimeSpan0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (delay))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CancelAfter_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (millisecondsDelay))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Cancel_0(
    ...
    pub fn Cancel__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (throwOnFirstException))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ExecuteCallbackHandlers", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn WaitForCallbackToComplete(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (callbackInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_0(
