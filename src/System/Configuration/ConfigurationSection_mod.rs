...
impl crate::System::Configuration::ConfigurationSection {
    pub fn DeserializeSection(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Configuration::ConfigurationSection as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Configuration::ConfigurationSection as
    ...
    > {
        ...
        > = unsafe { method.invoke_unchecked(self, (parentElement, name, saveMode))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "System+Configuration+ConfigurationSection")]
