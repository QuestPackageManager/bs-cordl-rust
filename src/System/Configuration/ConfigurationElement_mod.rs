...
impl crate::System::Configuration::ConfigurationElement {
    pub fn IsModified(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Configuration::ConfigurationElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("IsModified")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Configuration::ConfigurationElement as
