...
impl crate::System::IO::FileStream {
    ...
    pub fn InitBuffer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_size, isZeroSize))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Read(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (array, offset, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadAsync(
    ...
    pub fn ReadData(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (safeHandle, buf, offset, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadInternal(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (dest, offset, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadSegment(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (dest, dest_offset, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn RefillBuffer(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteInternal", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (src, offset, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteSegment(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (src, src_offset, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_FileMode_FileAccess2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (path, mode, access))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_FileMode_FileAccess_FileShare3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (path, mode, access, share))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_FileMode_FileAccess_FileShare_i32_4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (path, mode, access, share, bufferSize))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IntPtr_FileAccess__cordl_bool_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (handle, access, ownsHandle, bufferSize))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::System::IO::FileStream_ReadDelegate {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (buffer, offset, count, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
