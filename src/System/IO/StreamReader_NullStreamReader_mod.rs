...
for crate::GlobalNamespace::StreamReader_NullStreamReader {
    ...
    const CLASS_NAME: &'static str = "StreamReader/NullStreamReader";
...
impl crate::GlobalNamespace::StreamReader_NullStreamReader {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StreamReader_NullStreamReader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::StreamReader_NullStreamReader as
    ...
    pub fn ReadBuffer(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StreamReader_NullStreamReader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("ReadBuffer")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::StreamReader_NullStreamReader as
                    quest_hook::libil2cpp::Type > ::class(), "ReadBuffer", 0usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StreamReader_NullStreamReader as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::StreamReader_NullStreamReader as
                    quest_hook::libil2cpp::Type > ::class(), "get_BaseStream", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StreamReader_NullStreamReader as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::StreamReader_NullStreamReader as
                    quest_hook::libil2cpp::Type > ::class(), "get_CurrentEncoding",
                    0usize
                )
            });
