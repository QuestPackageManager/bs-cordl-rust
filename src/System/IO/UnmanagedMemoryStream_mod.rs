...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::IO::UnmanagedMemoryStream => "System.IO"
...
impl crate::System::IO::UnmanagedMemoryStream {
    ...
    pub fn Initialize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("Initialize", (pointer, length, capacity, access))?;
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Gc_i64_i64_FileAccess1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke(".ctor", (pointer, length, capacity, access))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = __cordl_object.invoke("get_PositionPointer", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn set_Position(
        &mut self,
