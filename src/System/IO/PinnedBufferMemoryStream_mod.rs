...
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::PinnedBufferMemoryStream {
    ...
    const CLASS_NAME: &'static str = "PinnedBufferMemoryStream";
...
impl crate::System::IO::PinnedBufferMemoryStream {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IO::PinnedBufferMemoryStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IO::PinnedBufferMemoryStream as
