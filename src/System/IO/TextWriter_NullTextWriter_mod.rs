...
for crate::GlobalNamespace::TextWriter_NullTextWriter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.IO";
    const CLASS_NAME: &'static str = "TextWriter/NullTextWriter";
...
#[cfg(feature = "System+IO+TextWriter+NullTextWriter")]
impl std::ops::DerefMut for crate::GlobalNamespace::TextWriter_NullTextWriter {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+IO+TextWriter+NullTextWriter")]
impl crate::GlobalNamespace::TextWriter_NullTextWriter {
    ...
    pub fn WriteLine_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TextWriter_NullTextWriter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("WriteLine")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::TextWriter_NullTextWriter as
