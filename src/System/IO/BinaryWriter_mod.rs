...
pub struct BinaryWriter {
    ...
    pub _leaveOpen: bool,
    pub _largeByteBuffer: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub _maxChars: i32,
}
#[cfg(feature = "cordl_class_System+IO+BinaryWriter")]
...
impl crate::System::IO::BinaryWriter {
    ...
    pub fn _ctor_Stream_Encoding2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, encoding))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Stream_Encoding__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, encoding, leaveOpen))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+IO+BinaryWriter")]
