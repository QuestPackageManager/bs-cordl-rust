...
pub struct MemoryStream {
    ...
    pub _length: i32,
    pub _capacity: i32,
    pub _expandable: bool,
    pub _writable: bool,
    pub _exposable: bool,
    pub _isOpen: bool,
    pub _lastReadTask: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task_1<i32>>,
}
#[cfg(feature = "cordl_class_System+IO+MemoryStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::MemoryStream {
    ...
    const CLASS_NAME: &'static str = "MemoryStream";
...
#[cfg(feature = "System+IO+MemoryStream")]
impl std::ops::DerefMut for crate::System::IO::MemoryStream {
...
impl crate::System::IO::MemoryStream {
    ...
    pub fn EnsureCapacity(&mut self, value: i32) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), bool, 1usize>("EnsureCapacity")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn EnsureWriteable(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EnsureWriteable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InternalEmulateRead(&mut self, count: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), i32, 1usize>("InternalEmulateRead")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (count))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn InternalGetPosition(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("InternalGetPosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InternalReadInt32(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("InternalReadInt32")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Seek(
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (offset, loc))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetLength(
        &mut self,
    ...
    pub fn _ctor_Il2CppArray__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (buffer, writable))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppArray_i32_i32__cordl_bool5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (buffer, index, count, writable))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_i32_i32__cordl_bool__cordl_bool6(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (buffer, index, count, writable, publiclyVisible))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_1(
...
#[cfg(feature = "cordl_class_System+IO+MemoryStream")]
impl quest_hook::libil2cpp::ObjectType for crate::System::IO::MemoryStream {
