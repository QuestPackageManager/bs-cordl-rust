...
impl crate::System::IO::MemoryStream {
    ...
    pub fn Seek(
        ...
        let __cordl_ret: i64 = unsafe {
            cordl_method_info.invoke_unchecked(self, (offset, loc))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetLength(
    ...
    pub fn _ctor_Il2CppArray__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, writable))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppArray_i32_i32__cordl_bool5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, index, count, writable))?
        };
        Ok(__cordl_ret.into())
    }
