...
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::StringReader {
    ...
    const CLASS_NAME: &'static str = "StringReader";
...
impl crate::System::IO::StringReader {
    pub fn Close(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IO::StringReader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Close")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IO::StringReader as quest_hook::libil2cpp::Type >
                    ::class(), "Close", 0usize
                )
            });
