...
impl crate::System::IO::FileInfo {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::StreamWriter> = __cordl_object
            .invoke("AppendText", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn CreateText(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::FileStream> = __cordl_object
            .invoke("OpenRead", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_0(
