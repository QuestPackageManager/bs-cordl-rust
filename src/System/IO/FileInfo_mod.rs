#[cfg(feature = "cordl_class_System+IO+FileInfo")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+IO+FileInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::FileInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.IO";
    const CLASS_NAME: &'static str = "FileInfo";
...
impl crate::System::IO::FileInfo {
    ...
    pub fn _ctor_Il2CppString_Il2CppString_Il2CppString__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (originalPath, fullPath, fileName, isNormalized))?
        };
        Ok(__cordl_ret.into())
    }
