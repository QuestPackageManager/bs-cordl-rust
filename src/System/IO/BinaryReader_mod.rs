...
impl crate::System::IO::BinaryReader {
    ...
    pub fn _ctor_Encoding1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (input, encoding))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Encoding__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (input, encoding, leaveOpen))?
        };
        Ok(__cordl_ret.into())
    }
