...
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::StringWriter {
    ...
    const CLASS_NAME: &'static str = "StringWriter";
...
impl crate::System::IO::StringWriter {
    pub fn Close(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IO::StringWriter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Close")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IO::StringWriter as quest_hook::libil2cpp::Type >
                    ::class(), "Close", 0usize
                )
            });
    ...
    pub fn _ctor_IFormatProvider1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (formatProvider))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_StringBuilder_IFormatProvider3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sb, formatProvider))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Encoding(
