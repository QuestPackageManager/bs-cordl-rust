...
#[cfg(feature = "System+IO+TextWriter")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::TextWriter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.IO";
    const CLASS_NAME: &'static str = "TextWriter";
...
impl crate::System::IO::TextWriter {
    ...
    pub fn Close(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IO::TextWriter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Close")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IO::TextWriter as quest_hook::libil2cpp::Type >
                    ::class(), "Close", 0usize
                )
            });
