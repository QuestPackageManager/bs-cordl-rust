...
#[cfg(feature = "cordl_class_System+IO+Enumeration+FileSystemName")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::Enumeration::FileSystemName {
...
impl crate::System::IO::Enumeration::FileSystemName {
    pub fn MatchPattern(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (expression, name, ignoreCase, useExtendedWildcards))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn MatchesSimpleExpression(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::ReadOnlySpan_1<char>,
                        bool,
                    ), bool, 3usize>("MatchesSimpleExpression")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (expression, name, ignoreCase))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::ReadOnlySpan_1<char>,
                        bool,
                    ), bool, 3usize>("MatchesWin32Expression")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+IO+Enumeration+FileSystemName")]
impl quest_hook::libil2cpp::ObjectType for crate::System::IO::Enumeration::FileSystemName {
