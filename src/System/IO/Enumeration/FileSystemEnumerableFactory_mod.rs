#[cfg(feature = "cordl_class_System+IO+Enumeration+FileSystemEnumerableFactory")]
#[repr(C)]
...
impl crate::System::IO::Enumeration::FileSystemEnumerableFactory {
    pub fn MatchesPattern(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (expression, name, options))? };
        Ok(__cordl_ret.into())
    }
    pub fn NormalizeInputs(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        quest_hook::libil2cpp::Gc<crate::System::IO::EnumerationOptions>,
                    ), quest_hook::libil2cpp::Void, 3usize>("NormalizeInputs")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (directory, expression, options))? };
        Ok(__cordl_ret.into())
    }
