    ...
    crate::System::IO::Enumeration::FileSystemEnumerable_1<TResult>
{
    ...
    pub type DelegateEnumerator =
        crate::System::IO::Enumeration::FileSystemEnumerable_1_DelegateEnumerator<TResult>;
    #[cfg(feature = "System+IO+Enumeration+FileSystemEnumerable_1+FindPredicate")]
    pub type FindPredicate =
        crate::System::IO::Enumeration::FileSystemEnumerable_1_FindPredicate<TResult>;
    #[cfg(feature = "System+IO+Enumeration+FileSystemEnumerable_1+FindTransform")]
    pub type FindTransform =
        crate::System::IO::Enumeration::FileSystemEnumerable_1_FindTransform<TResult>;
    pub fn GetEnumerator(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IEnumerator_1<TResult>>,
    >
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (directory, transform, options))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::IO::Enumeration::FileSystemEnumerable_1_FindPredicate<
                            TResult,
                        >,
                    >, 0usize>("get_ShouldIncludePredicate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::IO::Enumeration::FileSystemEnumerable_1_FindPredicate<
                            TResult,
                        >,
                    >, 0usize>("get_ShouldRecursePredicate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
impl<TResult: quest_hook::libil2cpp::Type>
    ...
    for crate::System::IO::Enumeration::FileSystemEnumerable_1<TResult>
{
    fn as_mut(&mut self) -> &mut crate::System::Collections::Generic::IEnumerable_1<TResult> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "System+IO+Enumeration+FileSystemEnumerable_1")]
...
pub struct FileSystemEnumerable_1_DelegateEnumerator<TResult: quest_hook::libil2cpp::Type> {
    ...
    pub _enumerable:
        quest_hook::libil2cpp::Gc<crate::System::IO::Enumeration::FileSystemEnumerable_1<TResult>>,
    __cordl_phantom_TResult: std::marker::PhantomData<TResult>,
}
#[cfg(feature = "cordl_class_System+IO+Enumeration+FileSystemEnumerable_1+DelegateEnumerator")]
unsafe impl<TResult: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
