...
unsafe impl quest_hook::libil2cpp::Type for crate::System::IO::CStreamReader {
    ...
    const CLASS_NAME: &'static str = "CStreamReader";
...
impl crate::System::IO::CStreamReader {
    ...
    pub fn Peek(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IO::CStreamReader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("Peek")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IO::CStreamReader as quest_hook::libil2cpp::Type >
                    ::class(), "Peek", 0usize
                )
            });
