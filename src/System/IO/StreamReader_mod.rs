#[cfg(feature = "cordl_class_System+IO+StreamReader")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::IO::StreamReader {
    ...
    pub fn DetectEncoding(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn ReadBuffer_Span_1_ByRefMut1(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (userBuffer, readToUserBuffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadLine(
        &mut self,
    ...
    pub fn _ctor_Il2CppString_Encoding8(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (path, encoding))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Encoding__cordl_bool9(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (path, encoding, detectEncodingFromByteOrderMarks))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString__cordl_bool7(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (path, detectEncodingFromByteOrderMarks))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Stream_Encoding__cordl_bool4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (stream, encoding, detectEncodingFromByteOrderMarks))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Stream__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (stream, detectEncodingFromByteOrderMarks))?
        };
        Ok(__cordl_ret.into())
    }
