#[cfg(feature = "cordl_class_System+IO+StreamHelpers")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::IO::StreamHelpers {
    pub fn ValidateCopyToArgs(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("ValidateCopyToArgs")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (source, destination, bufferSize))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+IO+StreamHelpers")]
