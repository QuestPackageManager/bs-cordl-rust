...
for crate::System::IO::UnexceptionalStreamWriter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.IO";
    const CLASS_NAME: &'static str = "UnexceptionalStreamWriter";
...
impl crate::System::IO::UnexceptionalStreamWriter {
    pub fn Flush(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::IO::UnexceptionalStreamWriter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Flush")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::IO::UnexceptionalStreamWriter as
