...
impl crate::GlobalNamespace::TextReader_NullTextReader {
    ...
    pub fn Read(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TextReader_NullTextReader as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TextReader_NullTextReader as
