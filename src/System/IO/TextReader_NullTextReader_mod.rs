...
#[cfg(feature = "cordl_class_System+IO+TextReader+NullTextReader")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TextReader_NullTextReader {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.IO";
    const CLASS_NAME: &'static str = "TextReader/NullTextReader";
...
#[cfg(feature = "cordl_class_System+IO+TextReader+NullTextReader")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TextReader_NullTextReader {
