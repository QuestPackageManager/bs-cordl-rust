#[cfg(feature = "cordl_class_System+IO+DirectoryInfo")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::IO::DirectoryInfo {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (searchPattern, enumerationOptions))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
