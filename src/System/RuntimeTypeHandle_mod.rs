#[cfg(feature = "cordl_class_System+RuntimeTypeHandle")]
...
impl crate::System::RuntimeTypeHandle {
    pub fn CanCastTo(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type, target))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Equals_RuntimeTypeHandle1(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::System::RuntimeTypeHandle), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetCorElementType(
        ...
        let __cordl_ret: crate::System::Reflection::CorElementType =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Gc<crate::System::RuntimeType>, 6usize>(
                        "GetTypeByName",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn IsComObject__cordl_bool1(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type, isGenericCOM))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsContextful(
        _cordl_type: quest_hook::libil2cpp::Gc<crate::System::RuntimeType>,
    ...
    pub fn IsEquivalentTo(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (rtType1, rtType2))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsInstanceOfType(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type, o))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsInterface(
        _cordl_type: quest_hook::libil2cpp::Gc<crate::System::RuntimeType>,
    ...
    pub fn IsSubclassOf(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (childType, baseType))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsSzArray(
        _cordl_type: quest_hook::libil2cpp::Gc<crate::System::RuntimeType>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::System::Type>,
                        quest_hook::libil2cpp::Gc<crate::System::Type>,
                    ), bool, 2usize>("type_is_assignable_from")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
