...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Func_3 < T1, T2, TResult > => "System"
    ."Func`3" < T1, T2, TResult >
);
#[cfg(feature = "System+Func_3")]
impl<
    T1: quest_hook::libil2cpp::Type,
...
> crate::System::Func_3<T1, T2, TResult> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TResult = __cordl_object.invoke("Invoke", (arg1, arg2))?;
        Ok(__cordl_ret)
    }
    pub fn New(
        object: *mut crate::System::Object,
