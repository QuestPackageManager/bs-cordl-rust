#[cfg(feature = "cordl_class_System+TypeLoadException")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::TypeLoadException {
    ...
    pub fn _ctor_Il2CppString_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (className, assemblyName))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString_Il2CppString_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (className, assemblyName, messageArg, resourceId))?
        };
        Ok(__cordl_ret.into())
    }
