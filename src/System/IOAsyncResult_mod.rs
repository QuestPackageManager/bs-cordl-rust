...
pub struct IOAsyncResult {
    ...
    pub wait_handle: quest_hook::libil2cpp::Gc<crate::System::Threading::ManualResetEvent>,
...
impl crate::System::IOAsyncResult {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (async_callback, async_state))? };
        Ok(__cordl_ret.into())
    }
