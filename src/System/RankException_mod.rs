...
unsafe impl quest_hook::libil2cpp::Type for crate::System::RankException {
    ...
    const CLASS_NAME: &'static str = "RankException";
...
impl crate::System::RankException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::RankException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::RankException as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
