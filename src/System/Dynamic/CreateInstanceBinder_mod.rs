#[cfg(feature = "cordl_class_System+Dynamic+CreateInstanceBinder")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Dynamic+CreateInstanceBinder")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Dynamic::CreateInstanceBinder {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Dynamic";
    const CLASS_NAME: &'static str = "CreateInstanceBinder";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FallbackCreateInstance", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Dynamic::DynamicMetaObject> =
            unsafe { cordl_method_info.invoke_unchecked(self, (target, args, errorSuggestion))? };
        Ok(__cordl_ret.into())
    }
