#[cfg(feature = "cordl_class_System+Dynamic+ExpandoClass")]
#[repr(C)]
...
impl crate::System::Dynamic::ExpandoClass {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Dynamic::ExpandoClass> =
            unsafe { cordl_method_info.invoke_unchecked(self, (newKey))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetValueIndex(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, caseInsensitive, obj))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetValueIndexCaseInsensitive(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        quest_hook::libil2cpp::Gc<crate::System::Dynamic::ExpandoObject>,
                    ), i32, 2usize>("GetValueIndexCaseInsensitive")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (name, obj))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetValueIndexCaseSensitive", 1usize
                        )
                    })
            });
    ...
    pub fn _ctor_Il2CppArray_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keys, hashCode))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Keys(
        &mut self,
