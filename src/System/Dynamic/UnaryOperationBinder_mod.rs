...
for crate::System::Dynamic::UnaryOperationBinder {
    ...
    const CLASS_NAME: &'static str = "UnaryOperationBinder";
...
impl crate::System::Dynamic::UnaryOperationBinder {
    pub fn Bind(
        ...
        quest_hook::libil2cpp::Gc<crate::System::Dynamic::DynamicMetaObject>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Dynamic::UnaryOperationBinder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<crate::System::Dynamic::DynamicMetaObject>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Dynamic::UnaryOperationBinder as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Dynamic::UnaryOperationBinder as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Dynamic::UnaryOperationBinder as
                    quest_hook::libil2cpp::Type > ::class(), "FallbackUnaryOperation",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
