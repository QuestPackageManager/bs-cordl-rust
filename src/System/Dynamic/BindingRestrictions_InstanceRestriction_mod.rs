...
impl crate::GlobalNamespace::BindingRestrictions_InstanceRestriction {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BindingRestrictions_InstanceRestriction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BindingRestrictions_InstanceRestriction as
