...
impl std::ops::Deref for crate::GlobalNamespace::BindingRestrictions_InstanceRestriction {
...
#[cfg(feature = "System+Dynamic+BindingRestrictions+InstanceRestriction")]
impl std::ops::DerefMut for crate::GlobalNamespace::BindingRestrictions_InstanceRestriction {
...
impl crate::GlobalNamespace::BindingRestrictions_InstanceRestriction {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameter, instance))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Dynamic+BindingRestrictions+InstanceRestriction")]
