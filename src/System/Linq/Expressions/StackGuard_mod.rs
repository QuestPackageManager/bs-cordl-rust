#[cfg(feature = "cordl_class_System+Linq+Expressions+StackGuard")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+StackGuard")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Linq::Expressions::StackGuard {
...
impl crate::System::Linq::Expressions::StackGuard {
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        T1,
                        T2,
                    ), quest_hook::libil2cpp::Void, 3usize>("RunOnEmptyStack")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (action, arg1, arg2))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: R = unsafe { cordl_method_info.invoke_unchecked(self, (action, state))? };
        Ok(__cordl_ret.into())
    }
