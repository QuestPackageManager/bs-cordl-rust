#[cfg(feature = "System+Linq+Expressions+InvocationExpression0")]
#[repr(C)]
#[derive(Debug)]
pub struct InvocationExpression0 {
    __cordl_parent: crate::System::Linq::Expressions::InvocationExpression,
}
#[cfg(feature = "System+Linq+Expressions+InvocationExpression0")]
unsafe impl quest_hook::libil2cpp::Type
for crate::System::Linq::Expressions::InvocationExpression0 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions";
    const CLASS_NAME: &'static str = "InvocationExpression0";
...
#[cfg(feature = "System+Linq+Expressions+InvocationExpression0")]
impl std::ops::Deref for crate::System::Linq::Expressions::InvocationExpression0 {
...
#[cfg(feature = "System+Linq+Expressions+InvocationExpression0")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::InvocationExpression0 {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Linq+Expressions+InvocationExpression0")]
impl crate::System::Linq::Expressions::InvocationExpression0 {
    pub fn GetArgument(
        &mut self,
        index: i32,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::InvocationExpression0 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                quest_hook::libil2cpp::Gc<crate::System::Linq::Expressions::Expression>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::InvocationExpression0 as
    ...
    pub fn New(
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (lambda, returnType))?;
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (lambda, returnType))?
        };
        Ok(__cordl_ret.into())
    }
