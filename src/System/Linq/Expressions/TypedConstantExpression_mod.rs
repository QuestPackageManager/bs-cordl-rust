...
for crate::System::Linq::Expressions::TypedConstantExpression {
    ...
    const CLASS_NAME: &'static str = "TypedConstantExpression";
...
impl crate::System::Linq::Expressions::TypedConstantExpression {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::TypedConstantExpression as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::TypedConstantExpression as
