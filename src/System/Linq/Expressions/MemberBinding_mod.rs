...
impl crate::System::Linq::Expressions::MemberBinding {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::MemberBinding as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                crate::System::Linq::Expressions::MemberBindingType,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::MemberBinding as
                    quest_hook::libil2cpp::Type > ::class(), "get_BindingType", 0usize
                )
            });
