...
for crate::System::Linq::Expressions::FieldExpression {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions";
    const CLASS_NAME: &'static str = "FieldExpression";
...
#[cfg(feature = "System+Linq+Expressions+FieldExpression")]
impl std::ops::Deref for crate::System::Linq::Expressions::FieldExpression {
...
#[cfg(feature = "System+Linq+Expressions+FieldExpression")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::FieldExpression {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Linq+Expressions+FieldExpression")]
impl crate::System::Linq::Expressions::FieldExpression {
    pub fn GetMember(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Reflection::MemberInfo>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::FieldExpression as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Reflection::MemberInfo>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::FieldExpression as
                    quest_hook::libil2cpp::Type > ::class(), "GetMember", 0usize
                )
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (expression, member))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
