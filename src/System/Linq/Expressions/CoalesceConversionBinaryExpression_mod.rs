...
impl crate::System::Linq::Expressions::CoalesceConversionBinaryExpression {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::CoalesceConversionBinaryExpression as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::CoalesceConversionBinaryExpression
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::CoalesceConversionBinaryExpression as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Linq::Expressions::CoalesceConversionBinaryExpression
                    as quest_hook::libil2cpp::Type > ::class(), "get_NodeType", 0usize
                )
            });
