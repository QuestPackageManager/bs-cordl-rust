...
impl crate::System::Linq::Expressions::NewArrayExpression {
    ...
    pub fn Update(
        &mut self,
        expressions: *mut crate::System::Collections::Generic::IEnumerable_1<
            *mut crate::System::Linq::Expressions::Expression,
        >,
    ) -> quest_hook::libil2cpp::Result<
        *mut crate::System::Linq::Expressions::NewArrayExpression,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::System::Linq::Expressions::NewArrayExpression = __cordl_object
            .invoke("Update", (expressions))?;
        Ok(__cordl_ret)
    }
    pub fn _ctor(
        &mut self,
