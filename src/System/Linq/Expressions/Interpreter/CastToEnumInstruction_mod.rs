...
for crate::System::Linq::Expressions::Interpreter::CastToEnumInstruction {
    ...
    const CLASS_NAME: &'static str = "CastToEnumInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+CastToEnumInstruction")]
impl crate::System::Linq::Expressions::Interpreter::CastToEnumInstruction {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::CastToEnumInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::CastToEnumInstruction
