...
for crate::System::Linq::Expressions::Interpreter::ByRefNewInstruction {
    ...
    const CLASS_NAME: &'static str = "ByRefNewInstruction";
...
impl crate::System::Linq::Expressions::Interpreter::ByRefNewInstruction {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::ByRefNewInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::System::Linq::Expressions::Interpreter::InterpretedFrame,
                >),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::ByRefNewInstruction
