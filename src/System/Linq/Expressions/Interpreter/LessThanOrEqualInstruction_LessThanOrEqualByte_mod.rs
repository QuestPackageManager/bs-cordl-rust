...
#[repr(C)]
#[derive(Debug)]
pub struct LessThanOrEqualInstruction_LessThanOrEqualByte {
    ...
    for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualByte
{
    ...
    const CLASS_NAME: &'static str = "LessThanOrEqualInstruction/LessThanOrEqualByte";
...
impl std::ops::Deref for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualByte {
...
impl std::ops::DerefMut for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualByte {
...
impl crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualByte {
    pub fn New(
