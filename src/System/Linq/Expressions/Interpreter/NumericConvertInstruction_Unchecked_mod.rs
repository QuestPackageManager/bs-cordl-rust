...
for crate::GlobalNamespace::NumericConvertInstruction_Unchecked {
    ...
    const CLASS_NAME: &'static str = "NumericConvertInstruction/Unchecked";
...
impl crate::GlobalNamespace::NumericConvertInstruction_Unchecked {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NumericConvertInstruction_Unchecked as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NumericConvertInstruction_Unchecked as
