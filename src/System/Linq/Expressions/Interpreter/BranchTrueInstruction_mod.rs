...
for crate::System::Linq::Expressions::Interpreter::BranchTrueInstruction {
    ...
    const CLASS_NAME: &'static str = "BranchTrueInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+BranchTrueInstruction")]
impl crate::System::Linq::Expressions::Interpreter::BranchTrueInstruction {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::BranchTrueInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::BranchTrueInstruction
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::BranchTrueInstruction as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Linq::Expressions::Interpreter::BranchTrueInstruction
                    as quest_hook::libil2cpp::Type > ::class(), "get_Cache", 0usize
                )
            });
