#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+BranchInstruction")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Linq::Expressions::Interpreter::BranchInstruction
{
    ...
    const CLASS_NAME: &'static str = "BranchInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::BranchInstruction {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+BranchInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::BranchInstruction {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Linq+Expressions+Interpreter+BranchInstruction")]
impl crate::System::Linq::Expressions::Interpreter::BranchInstruction {
    ...
    pub fn New__cordl_bool__cordl_bool1(
        ...
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (hasResult, hasValue))?;
        Ok(__cordl_object.into())
    }
    pub fn Run(
        &mut self,
    ...
    pub fn _ctor__cordl_bool__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hasResult, hasValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Cache(
        &mut self,
