...
impl crate::System::Linq::Expressions::Interpreter::CreateDelegateInstruction {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::CreateDelegateInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (delegateCreator))?
        };
        Ok(__cordl_ret.into())
    }
