#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+CreateDelegateInstruction")]
#[repr(C)]
    ...
    for crate::System::Linq::Expressions::Interpreter::CreateDelegateInstruction
{
    ...
    const CLASS_NAME: &'static str = "CreateDelegateInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::CreateDelegateInstruction {
...
impl crate::System::Linq::Expressions::Interpreter::CreateDelegateInstruction {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (delegateCreator))? };
        Ok(__cordl_ret.into())
    }
