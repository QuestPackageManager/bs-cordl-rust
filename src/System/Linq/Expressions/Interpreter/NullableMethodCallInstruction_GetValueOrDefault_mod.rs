...
for crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault {
    ...
    const CLASS_NAME: &'static str = "NullableMethodCallInstruction/GetValueOrDefault";
...
impl crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (mi))?
        };
        Ok(__cordl_ret.into())
    }
}
