...
for crate::GlobalNamespace::LessThanInstruction_LessThanUInt16 {
    ...
    const CLASS_NAME: &'static str = "LessThanInstruction/LessThanUInt16";
...
impl crate::GlobalNamespace::LessThanInstruction_LessThanUInt16 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanInstruction_LessThanUInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LessThanInstruction_LessThanUInt16 as
