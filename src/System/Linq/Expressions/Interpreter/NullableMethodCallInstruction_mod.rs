#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NullableMethodCallInstruction")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Linq::Expressions::Interpreter::NullableMethodCallInstruction {
    ...
    pub type GetHashCodeClass =
        crate::GlobalNamespace::NullableMethodCallInstruction_GetHashCodeClass;
    #[cfg(feature = "System+Linq+Expressions+Interpreter+NullableMethodCallInstruction+GetValue")]
    ...
    pub type GetValueOrDefault =
        crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault;
    #[cfg(
        feature = "System+Linq+Expressions+Interpreter+NullableMethodCallInstruction+GetValueOrDefault1"
    )]
    pub type GetValueOrDefault1 =
        crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1;
    #[cfg(feature = "System+Linq+Expressions+Interpreter+NullableMethodCallInstruction+HasValue")]
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Linq::Expressions::Interpreter::Instruction,
        > = unsafe { cordl_method_info.invoke_unchecked((), (method, argCount, mi))? };
        Ok(__cordl_ret.into())
    }
