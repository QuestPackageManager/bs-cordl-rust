...
for crate::GlobalNamespace::EqualInstruction_EqualReference {
    ...
    const CLASS_NAME: &'static str = "EqualInstruction/EqualReference";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+EqualInstruction+EqualReference")]
impl crate::GlobalNamespace::EqualInstruction_EqualReference {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EqualInstruction_EqualReference as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EqualInstruction_EqualReference as
