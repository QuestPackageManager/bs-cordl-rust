#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EqualInstruction+EqualReference")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EqualInstruction+EqualReference")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EqualInstruction_EqualReference {
