    ...
    for crate::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrInt16
{
    ...
    const CLASS_NAME: &'static str = "ExclusiveOrInstruction/ExclusiveOrInt16";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+ExclusiveOrInstruction+ExclusiveOrInt16")]
impl std::ops::Deref for crate::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrInt16 {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+ExclusiveOrInstruction+ExclusiveOrInt16")]
impl std::ops::DerefMut for crate::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrInt16 {
