...
for crate::GlobalNamespace::EqualInstruction_EqualBoolean {
...
impl crate::GlobalNamespace::EqualInstruction_EqualBoolean {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EqualInstruction_EqualBoolean as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EqualInstruction_EqualBoolean as
