...
for crate::GlobalNamespace::DecrementInstruction_DecrementInt16 {
    ...
    const CLASS_NAME: &'static str = "DecrementInstruction/DecrementInt16";
...
impl crate::GlobalNamespace::DecrementInstruction_DecrementInt16 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DecrementInstruction_DecrementInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DecrementInstruction_DecrementInt16 as
