#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+LoadCachedObjectInstruction")]
#[repr(C)]
...
impl crate::System::Linq::Expressions::Interpreter::LoadCachedObjectInstruction {
    pub fn New(index: u32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
