...
impl crate::GlobalNamespace::CastInstructionNoT_CastInstruction_Value {
    pub fn ConvertNull(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CastInstructionNoT_CastInstruction_Value as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CastInstructionNoT_CastInstruction_Value as
