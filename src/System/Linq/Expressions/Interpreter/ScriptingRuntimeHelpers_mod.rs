...
impl crate::System::Linq::Expressions::Interpreter::ScriptingRuntimeHelpers {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::ScriptingRuntimeHelpers as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Linq::Expressions::Interpreter::ScriptingRuntimeHelpers as
                    quest_hook::libil2cpp::Type > ::class(), "GetPrimitiveDefaultValue",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::ScriptingRuntimeHelpers as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Linq::Expressions::Interpreter::ScriptingRuntimeHelpers as
                    quest_hook::libil2cpp::Type > ::class(), "Int32ToObject", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe { method.invoke_unchecked((), (i))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "System+Linq+Expressions+Interpreter+ScriptingRuntimeHelpers")]
