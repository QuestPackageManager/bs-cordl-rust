...
for crate::System::Linq::Expressions::Interpreter::IBoxableInstruction {
    ...
    const CLASS_NAME: &'static str = "IBoxableInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+IBoxableInstruction")]
impl crate::System::Linq::Expressions::Interpreter::IBoxableInstruction {
    pub fn BoxIfIndexMatches(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::IBoxableInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                quest_hook::libil2cpp::Gc<
                    crate::System::Linq::Expressions::Interpreter::Instruction,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "BoxIfIndexMatches",
                    1usize
                )
            });
