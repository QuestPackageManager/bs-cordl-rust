...
for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16 {
    ...
    const CLASS_NAME: &'static str = "LessThanOrEqualInstruction/LessThanOrEqualInt16";
...
impl crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16 as
