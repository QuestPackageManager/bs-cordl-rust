#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+LessThanOrEqualInstruction+LessThanOrEqualInt16"
)]
#[repr(C)]
...
impl std::ops::Deref for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt16 {
