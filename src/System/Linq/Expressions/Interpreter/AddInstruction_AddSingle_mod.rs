#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction+AddSingle")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction+AddSingle")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AddInstruction_AddSingle {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "AddInstruction/AddSingle";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction+AddSingle")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AddInstruction_AddSingle {
