...
impl crate::System::Linq::Expressions::Interpreter::FieldByRefUpdater {
    ...
    pub fn UndefineTemps(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::FieldByRefUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::FieldByRefUpdater as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (obj, field, argumentIndex))?
        };
        Ok(__cordl_ret.into())
    }
}
