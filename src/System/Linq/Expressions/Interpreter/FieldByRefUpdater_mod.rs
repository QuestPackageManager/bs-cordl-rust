...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::FieldByRefUpdater {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+FieldByRefUpdater")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::FieldByRefUpdater {
...
impl crate::System::Linq::Expressions::Interpreter::FieldByRefUpdater {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (obj, field, argumentIndex))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+FieldByRefUpdater")]
