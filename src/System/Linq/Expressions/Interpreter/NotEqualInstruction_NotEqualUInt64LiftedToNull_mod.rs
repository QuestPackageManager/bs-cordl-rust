#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+NotEqualInstruction+NotEqualUInt64LiftedToNull"
)]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt64LiftedToNull
{
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualUInt64LiftedToNull";
...
impl std::ops::Deref for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt64LiftedToNull {
...
impl std::ops::DerefMut for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt64LiftedToNull {
