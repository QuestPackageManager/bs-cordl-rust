...
impl crate::GlobalNamespace::NegateInstruction_NegateSingle {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NegateInstruction_NegateSingle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NegateInstruction_NegateSingle as
