...
for crate::System::Linq::Expressions::Interpreter::CoalescingBranchInstruction {
    ...
    const CLASS_NAME: &'static str = "CoalescingBranchInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+CoalescingBranchInstruction")]
impl crate::System::Linq::Expressions::Interpreter::CoalescingBranchInstruction {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::CoalescingBranchInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
