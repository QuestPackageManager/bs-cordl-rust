...
for crate::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrByte {
    ...
    const CLASS_NAME: &'static str = "ExclusiveOrInstruction/ExclusiveOrByte";
...
impl crate::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrByte {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrByte as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrByte as
