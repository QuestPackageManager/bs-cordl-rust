#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NegateCheckedInstruction")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Linq::Expressions::Interpreter::NegateCheckedInstruction
{
    ...
    const CLASS_NAME: &'static str = "NegateCheckedInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::NegateCheckedInstruction {
...
impl crate::System::Linq::Expressions::Interpreter::NegateCheckedInstruction {
    ...
    pub type NegateCheckedInt32 =
        crate::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt32;
    #[cfg(
        feature = "System+Linq+Expressions+Interpreter+NegateCheckedInstruction+NegateCheckedInt64"
    )]
    pub type NegateCheckedInt64 =
