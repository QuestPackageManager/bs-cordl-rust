...
for crate::System::Linq::Expressions::Interpreter::AssignLocalToClosureInstruction {
    ...
    const CLASS_NAME: &'static str = "AssignLocalToClosureInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+AssignLocalToClosureInstruction")]
impl crate::System::Linq::Expressions::Interpreter::AssignLocalToClosureInstruction {
    pub fn New(
        index: i32,
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::AssignLocalToClosureInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
