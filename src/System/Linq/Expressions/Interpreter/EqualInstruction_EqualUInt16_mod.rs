#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EqualInstruction+EqualUInt16")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EqualInstruction+EqualUInt16")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EqualInstruction_EqualUInt16 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "EqualInstruction/EqualUInt16";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EqualInstruction+EqualUInt16")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EqualInstruction_EqualUInt16 {
