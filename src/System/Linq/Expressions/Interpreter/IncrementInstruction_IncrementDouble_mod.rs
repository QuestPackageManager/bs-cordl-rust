...
#[repr(C)]
#[derive(Debug)]
pub struct IncrementInstruction_IncrementDouble {
...
for crate::GlobalNamespace::IncrementInstruction_IncrementDouble {
    ...
    const CLASS_NAME: &'static str = "IncrementInstruction/IncrementDouble";
...
impl crate::GlobalNamespace::IncrementInstruction_IncrementDouble {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IncrementInstruction_IncrementDouble as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IncrementInstruction_IncrementDouble as
