...
impl crate::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt32 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LeftShiftInstruction_LeftShiftUInt32 as
