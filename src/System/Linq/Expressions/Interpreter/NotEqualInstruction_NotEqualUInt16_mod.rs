...
#[repr(C)]
#[derive(Debug)]
pub struct NotEqualInstruction_NotEqualUInt16 {
...
for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt16 {
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualUInt16";
...
impl crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt16 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NotEqualInstruction_NotEqualUInt16 as
