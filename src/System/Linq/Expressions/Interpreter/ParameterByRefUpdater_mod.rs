...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::ParameterByRefUpdater {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+ParameterByRefUpdater")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::ParameterByRefUpdater {
...
impl crate::System::Linq::Expressions::Interpreter::ParameterByRefUpdater {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameter, argumentIndex))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+ParameterByRefUpdater")]
