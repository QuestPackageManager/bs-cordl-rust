...
impl crate::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (hasValue))?
        };
        Ok(__cordl_ret.into())
    }
