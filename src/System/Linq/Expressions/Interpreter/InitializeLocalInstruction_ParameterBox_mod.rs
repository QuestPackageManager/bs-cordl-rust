...
impl std::ops::Deref for crate::GlobalNamespace::InitializeLocalInstruction_ParameterBox {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+InitializeLocalInstruction+ParameterBox")]
impl std::ops::DerefMut for crate::GlobalNamespace::InitializeLocalInstruction_ParameterBox {
