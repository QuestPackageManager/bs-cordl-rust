...
for crate::GlobalNamespace::InitializeLocalInstruction_ParameterBox {
    ...
    const CLASS_NAME: &'static str = "InitializeLocalInstruction/ParameterBox";
...
impl crate::GlobalNamespace::InitializeLocalInstruction_ParameterBox {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::InitializeLocalInstruction_ParameterBox as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::InitializeLocalInstruction_ParameterBox as
