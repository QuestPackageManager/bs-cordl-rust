...
for crate::GlobalNamespace::LessThanInstruction_LessThanInt16 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "LessThanInstruction/LessThanInt16";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+LessThanInstruction+LessThanInt16")]
impl std::ops::DerefMut for crate::GlobalNamespace::LessThanInstruction_LessThanInt16 {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Linq+Expressions+Interpreter+LessThanInstruction+LessThanInt16")]
impl crate::GlobalNamespace::LessThanInstruction_LessThanInt16 {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanInstruction_LessThanInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LessThanInstruction_LessThanInt16 as
