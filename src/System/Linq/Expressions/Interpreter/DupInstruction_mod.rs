#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+DupInstruction")]
#[repr(C)]
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+DupInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::DupInstruction {
