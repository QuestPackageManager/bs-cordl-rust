...
for crate::GlobalNamespace::OrInstruction_OrInt64 {
...
impl crate::GlobalNamespace::OrInstruction_OrInt64 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OrInstruction_OrInt64 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OrInstruction_OrInt64 as
