#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrUInt64")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrUInt64")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OrInstruction_OrUInt64 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "OrInstruction/OrUInt64";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrUInt64")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OrInstruction_OrUInt64 {
