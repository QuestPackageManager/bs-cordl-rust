...
#[repr(C)]
#[derive(Debug)]
pub struct LessThanInstruction_LessThanUInt32 {
...
for crate::GlobalNamespace::LessThanInstruction_LessThanUInt32 {
    ...
    const CLASS_NAME: &'static str = "LessThanInstruction/LessThanUInt32";
...
impl crate::GlobalNamespace::LessThanInstruction_LessThanUInt32 {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanInstruction_LessThanUInt32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LessThanInstruction_LessThanUInt32 as
