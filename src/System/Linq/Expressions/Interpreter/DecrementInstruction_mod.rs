...
impl crate::System::Linq::Expressions::Interpreter::DecrementInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::DecrementInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
