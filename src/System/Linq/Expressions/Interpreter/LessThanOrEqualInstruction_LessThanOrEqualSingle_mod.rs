#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+LessThanOrEqualInstruction+LessThanOrEqualSingle"
)]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSingle
{
    ...
    const CLASS_NAME: &'static str = "LessThanOrEqualInstruction/LessThanOrEqualSingle";
...
impl std::ops::Deref for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSingle {
