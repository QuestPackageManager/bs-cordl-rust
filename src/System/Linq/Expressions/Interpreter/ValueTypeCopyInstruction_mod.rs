#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+ValueTypeCopyInstruction")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::ValueTypeCopyInstruction {
