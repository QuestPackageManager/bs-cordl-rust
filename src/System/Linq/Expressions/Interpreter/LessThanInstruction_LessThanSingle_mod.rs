...
for crate::GlobalNamespace::LessThanInstruction_LessThanSingle {
    ...
    const CLASS_NAME: &'static str = "LessThanInstruction/LessThanSingle";
...
impl crate::GlobalNamespace::LessThanInstruction_LessThanSingle {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanInstruction_LessThanSingle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LessThanInstruction_LessThanSingle as
