...
for crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSByte {
    ...
    const CLASS_NAME: &'static str = "GreaterThanOrEqualInstruction/GreaterThanOrEqualSByte";
...
impl crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSByte {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSByte as quest_hook::libil2cpp::Type>::class()
            .find_method::<
