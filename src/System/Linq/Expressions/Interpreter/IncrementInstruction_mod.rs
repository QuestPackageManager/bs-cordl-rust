...
impl crate::System::Linq::Expressions::Interpreter::IncrementInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::IncrementInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
