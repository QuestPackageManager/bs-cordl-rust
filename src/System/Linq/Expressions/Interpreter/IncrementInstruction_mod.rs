#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+IncrementInstruction")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::IncrementInstruction {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+IncrementInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::IncrementInstruction {
...
impl crate::System::Linq::Expressions::Interpreter::IncrementInstruction {
    #[cfg(feature = "System+Linq+Expressions+Interpreter+IncrementInstruction+IncrementDouble")]
