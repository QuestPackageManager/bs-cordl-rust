    ...
    for crate::GlobalNamespace::InitializeLocalInstruction_ImmutableValue
{
    ...
    const CLASS_NAME: &'static str = "InitializeLocalInstruction/ImmutableValue";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+InitializeLocalInstruction+ImmutableValue")]
impl std::ops::Deref for crate::GlobalNamespace::InitializeLocalInstruction_ImmutableValue {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+InitializeLocalInstruction+ImmutableValue")]
impl std::ops::DerefMut for crate::GlobalNamespace::InitializeLocalInstruction_ImmutableValue {
