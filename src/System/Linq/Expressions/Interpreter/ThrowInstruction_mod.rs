...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::ThrowInstruction {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+ThrowInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::ThrowInstruction {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WrapThrownObject", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Exception> =
            unsafe { cordl_method_info.invoke_unchecked((), (thrown))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hasResult, isRethrow))? };
        Ok(__cordl_ret.into())
    }
