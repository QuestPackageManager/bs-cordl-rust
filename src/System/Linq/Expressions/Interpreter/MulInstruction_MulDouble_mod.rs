...
for crate::GlobalNamespace::MulInstruction_MulDouble {
...
impl crate::GlobalNamespace::MulInstruction_MulDouble {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MulInstruction_MulDouble as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MulInstruction_MulDouble as
