...
for crate::System::Linq::Expressions::Interpreter::TypeAsInstruction {
    ...
    const CLASS_NAME: &'static str = "TypeAsInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+TypeAsInstruction")]
impl crate::System::Linq::Expressions::Interpreter::TypeAsInstruction {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::TypeAsInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::TypeAsInstruction as
