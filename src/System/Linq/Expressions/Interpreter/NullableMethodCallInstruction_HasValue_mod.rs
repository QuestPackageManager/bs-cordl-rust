...
impl crate::GlobalNamespace::NullableMethodCallInstruction_HasValue {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NullableMethodCallInstruction_HasValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NullableMethodCallInstruction_HasValue as
