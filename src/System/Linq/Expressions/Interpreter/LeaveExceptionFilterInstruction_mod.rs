#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+LeaveExceptionFilterInstruction")]
#[repr(C)]
    ...
    for crate::System::Linq::Expressions::Interpreter::LeaveExceptionFilterInstruction
{
    ...
    const CLASS_NAME: &'static str = "LeaveExceptionFilterInstruction";
