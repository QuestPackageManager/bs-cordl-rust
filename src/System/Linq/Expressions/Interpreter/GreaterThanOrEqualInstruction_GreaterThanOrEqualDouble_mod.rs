...
for crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualDouble {
    ...
    const CLASS_NAME: &'static str = "GreaterThanOrEqualInstruction/GreaterThanOrEqualDouble";
...
impl crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualDouble {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualDouble as quest_hook::libil2cpp::Type>::class()
            .find_method::<
