#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+InitializeLocalInstruction+MutableBox"
)]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::InitializeLocalInstruction_MutableBox
{
    ...
    const CLASS_NAME: &'static str = "InitializeLocalInstruction/MutableBox";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+InitializeLocalInstruction+MutableBox")]
impl std::ops::DerefMut for crate::GlobalNamespace::InitializeLocalInstruction_MutableBox {
