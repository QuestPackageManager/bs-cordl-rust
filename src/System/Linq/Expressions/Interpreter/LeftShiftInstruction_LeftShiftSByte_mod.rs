...
for crate::GlobalNamespace::LeftShiftInstruction_LeftShiftSByte {
    ...
    const CLASS_NAME: &'static str = "LeftShiftInstruction/LeftShiftSByte";
...
impl crate::GlobalNamespace::LeftShiftInstruction_LeftShiftSByte {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LeftShiftInstruction_LeftShiftSByte as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LeftShiftInstruction_LeftShiftSByte as
