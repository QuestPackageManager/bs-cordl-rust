#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+IntSwitchInstruction_1")]
#[repr(C)]
    ...
    for crate::System::Linq::Expressions::Interpreter::IntSwitchInstruction_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IntSwitchInstruction`1";
...
{
    pub fn New(
        cases: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::Dictionary_2<T, i32>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cases))? };
        Ok(__cordl_ret.into())
    }
