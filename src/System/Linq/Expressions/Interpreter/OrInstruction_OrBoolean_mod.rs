#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrBoolean")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrBoolean")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OrInstruction_OrBoolean {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "OrInstruction/OrBoolean";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrBoolean")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OrInstruction_OrBoolean {
