#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NotInstruction")]
#[repr(C)]
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+NotInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::NotInstruction {
