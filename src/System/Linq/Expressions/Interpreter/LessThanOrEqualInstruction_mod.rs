...
impl crate::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
