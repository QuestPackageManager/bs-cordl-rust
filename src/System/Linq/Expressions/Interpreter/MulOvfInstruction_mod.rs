...
impl crate::System::Linq::Expressions::Interpreter::MulOvfInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::MulOvfInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::MulOvfInstruction as
