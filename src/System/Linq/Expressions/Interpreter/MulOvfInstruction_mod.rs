#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulOvfInstruction")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Linq::Expressions::Interpreter::MulOvfInstruction
{
    ...
    const CLASS_NAME: &'static str = "MulOvfInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::MulOvfInstruction {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+MulOvfInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::MulOvfInstruction {
