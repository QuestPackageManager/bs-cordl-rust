#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+NotEqualInstruction+NotEqualUInt16LiftedToNull"
)]
#[repr(C)]
    ...
    for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt16LiftedToNull
{
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualUInt16LiftedToNull";
...
impl std::ops::Deref for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt16LiftedToNull {
...
impl std::ops::DerefMut for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt16LiftedToNull {
