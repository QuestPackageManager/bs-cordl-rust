#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+LessThanOrEqualInstruction+LessThanOrEqualDouble"
)]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct LessThanOrEqualInstruction_LessThanOrEqualDouble {
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualDouble
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "LessThanOrEqualInstruction/LessThanOrEqualDouble";
...
impl std::ops::Deref for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualDouble {
