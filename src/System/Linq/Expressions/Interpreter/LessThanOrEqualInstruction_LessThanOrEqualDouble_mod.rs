...
impl crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualDouble {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualDouble as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualDouble
