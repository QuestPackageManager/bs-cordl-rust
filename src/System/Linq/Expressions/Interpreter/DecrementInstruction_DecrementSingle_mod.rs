#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+DecrementInstruction+DecrementSingle"
)]
#[repr(C)]
    ...
    for crate::GlobalNamespace::DecrementInstruction_DecrementSingle
{
    ...
    const CLASS_NAME: &'static str = "DecrementInstruction/DecrementSingle";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+DecrementInstruction+DecrementSingle")]
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+DecrementInstruction+DecrementSingle")]
impl std::ops::DerefMut for crate::GlobalNamespace::DecrementInstruction_DecrementSingle {
