...
#[repr(C)]
#[derive(Debug)]
pub struct GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64 {
...
for crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "GreaterThanOrEqualInstruction/GreaterThanOrEqualInt64";
...
impl crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64 {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64
