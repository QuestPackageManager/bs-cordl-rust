...
for crate::System::Linq::Expressions::Interpreter::TypeIsInstruction {
    ...
    const CLASS_NAME: &'static str = "TypeIsInstruction";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+TypeIsInstruction")]
impl crate::System::Linq::Expressions::Interpreter::TypeIsInstruction {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::TypeIsInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::TypeIsInstruction as
