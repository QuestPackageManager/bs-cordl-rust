...
impl crate::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt32 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
