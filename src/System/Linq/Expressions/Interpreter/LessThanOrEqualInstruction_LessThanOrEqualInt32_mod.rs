#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+LessThanOrEqualInstruction+LessThanOrEqualInt32"
)]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt32
{
    ...
    const CLASS_NAME: &'static str = "LessThanOrEqualInstruction/LessThanOrEqualInt32";
...
impl std::ops::Deref for crate::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt32 {
