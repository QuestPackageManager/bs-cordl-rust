...
impl crate::System::Linq::Expressions::Interpreter::GreaterThanOrEqualInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::GreaterThanOrEqualInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
