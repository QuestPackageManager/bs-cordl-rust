...
for crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualChar {
    ...
    const CLASS_NAME: &'static str = "GreaterThanOrEqualInstruction/GreaterThanOrEqualChar";
...
impl crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualChar {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualChar as quest_hook::libil2cpp::Type>::class()
            .find_method::<
