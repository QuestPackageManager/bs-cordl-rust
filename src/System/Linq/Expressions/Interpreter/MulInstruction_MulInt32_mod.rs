#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulInstruction+MulInt32")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulInstruction+MulInt32")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MulInstruction_MulInt32 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "MulInstruction/MulInt32";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulInstruction+MulInt32")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MulInstruction_MulInt32 {
