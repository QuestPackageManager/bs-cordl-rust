#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EnterTryCatchFinallyInstruction")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Linq::Expressions::Interpreter::EnterTryCatchFinallyInstruction {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (targetIndex, hasFinally))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Handler(
        &mut self,
