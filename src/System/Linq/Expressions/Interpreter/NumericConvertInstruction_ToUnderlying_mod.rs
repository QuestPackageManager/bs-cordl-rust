...
#[cfg(feature = "System+Linq+Expressions+Interpreter+NumericConvertInstruction+ToUnderlying")]
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+NumericConvertInstruction+ToUnderlying")]
impl std::ops::DerefMut for crate::GlobalNamespace::NumericConvertInstruction_ToUnderlying {
...
impl crate::GlobalNamespace::NumericConvertInstruction_ToUnderlying {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (to, isLiftedToNull))? };
        Ok(__cordl_ret.into())
    }
