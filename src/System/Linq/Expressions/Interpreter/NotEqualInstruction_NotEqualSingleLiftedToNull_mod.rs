...
for crate::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull {
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualSingleLiftedToNull";
...
impl crate::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull as
