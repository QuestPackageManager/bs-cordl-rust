...
impl crate::GlobalNamespace::InitializeLocalInstruction_ImmutableBox {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::InitializeLocalInstruction_ImmutableBox as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::InitializeLocalInstruction_ImmutableBox as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (index, defaultValue))?
        };
        Ok(__cordl_ret.into())
    }
