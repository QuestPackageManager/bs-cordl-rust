    ...
    for crate::GlobalNamespace::InitializeLocalInstruction_ImmutableBox
{
    ...
    const CLASS_NAME: &'static str = "InitializeLocalInstruction/ImmutableBox";
...
impl std::ops::Deref for crate::GlobalNamespace::InitializeLocalInstruction_ImmutableBox {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+InitializeLocalInstruction+ImmutableBox")]
impl std::ops::DerefMut for crate::GlobalNamespace::InitializeLocalInstruction_ImmutableBox {
...
impl crate::GlobalNamespace::InitializeLocalInstruction_ImmutableBox {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, defaultValue))? };
        Ok(__cordl_ret.into())
    }
