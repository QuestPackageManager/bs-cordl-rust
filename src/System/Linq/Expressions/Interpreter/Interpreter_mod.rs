#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+Interpreter")]
#[repr(C)]
...
impl crate::System::Linq::Expressions::Interpreter::Interpreter {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Linq::Expressions::Interpreter::InterpretedFrame,
                    >), quest_hook::libil2cpp::Void, 1usize>("Run")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, locals, instructions, debugInfos))?
        };
        Ok(__cordl_ret.into())
    }
