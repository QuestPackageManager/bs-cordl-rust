#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AssignLocalInstruction")]
#[repr(C)]
    ...
    for crate::System::Linq::Expressions::Interpreter::AssignLocalInstruction
{
    ...
    const CLASS_NAME: &'static str = "AssignLocalInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::AssignLocalInstruction {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+AssignLocalInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::AssignLocalInstruction {
