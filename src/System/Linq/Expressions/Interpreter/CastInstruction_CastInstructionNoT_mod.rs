...
impl crate::GlobalNamespace::CastInstruction_CastInstructionNoT {
    #[cfg(feature = "System+Linq+Expressions+Interpreter+CastInstruction+CastInstructionNoT+Ref")]
    ...
    pub fn Create(
        ...
        quest_hook::libil2cpp::Gc<crate::System::Linq::Expressions::Interpreter::CastInstruction>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
