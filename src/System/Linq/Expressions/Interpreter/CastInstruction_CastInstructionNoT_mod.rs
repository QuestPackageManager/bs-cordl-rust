...
impl crate::GlobalNamespace::CastInstruction_CastInstructionNoT {
    ...
    pub fn ConvertNull(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CastInstruction_CastInstructionNoT as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CastInstruction_CastInstructionNoT as
