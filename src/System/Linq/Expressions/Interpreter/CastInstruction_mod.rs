...
for crate::System::Linq::Expressions::Interpreter::CastInstruction {
    ...
    const CLASS_NAME: &'static str = "CastInstruction";
...
impl crate::System::Linq::Expressions::Interpreter::CastInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::CastInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::CastInstruction as
