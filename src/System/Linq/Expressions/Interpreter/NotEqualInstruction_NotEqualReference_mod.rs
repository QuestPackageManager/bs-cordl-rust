...
#[repr(C)]
#[derive(Debug)]
pub struct NotEqualInstruction_NotEqualReference {
...
for crate::GlobalNamespace::NotEqualInstruction_NotEqualReference {
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualReference";
...
impl crate::GlobalNamespace::NotEqualInstruction_NotEqualReference {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NotEqualInstruction_NotEqualReference as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NotEqualInstruction_NotEqualReference as
