...
for crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt64 {
    ...
    const CLASS_NAME: &'static str = "GreaterThanOrEqualInstruction/GreaterThanOrEqualUInt64";
...
impl crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt64 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualUInt64 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
