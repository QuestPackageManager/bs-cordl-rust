...
#[repr(C)]
#[derive(Debug)]
pub struct LessThanInstruction_LessThanChar {
    __cordl_parent: crate::System::Linq::Expressions::Interpreter::LessThanInstruction,
}
#[cfg(feature = "System+Linq+Expressions+Interpreter+LessThanInstruction+LessThanChar")]
unsafe impl quest_hook::libil2cpp::Type
for crate::GlobalNamespace::LessThanInstruction_LessThanChar {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "LessThanInstruction/LessThanChar";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+LessThanInstruction+LessThanChar")]
impl crate::GlobalNamespace::LessThanInstruction_LessThanChar {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanInstruction_LessThanChar as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LessThanInstruction_LessThanChar as
