...
for crate::GlobalNamespace::ModuloInstruction_ModuloInt16 {
    ...
    const CLASS_NAME: &'static str = "ModuloInstruction/ModuloInt16";
...
impl crate::GlobalNamespace::ModuloInstruction_ModuloInt16 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ModuloInstruction_ModuloInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ModuloInstruction_ModuloInt16 as
