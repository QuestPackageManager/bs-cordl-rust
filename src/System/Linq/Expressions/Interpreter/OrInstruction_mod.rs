...
for crate::System::Linq::Expressions::Interpreter::OrInstruction {
    ...
    const CLASS_NAME: &'static str = "OrInstruction";
...
impl crate::System::Linq::Expressions::Interpreter::OrInstruction {
    ...
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::OrInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Interpreter::OrInstruction as
