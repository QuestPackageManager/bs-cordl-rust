...
#[repr(C)]
#[derive(Debug)]
pub struct NullableMethodCallInstruction_GetValueOrDefault1 {
...
for crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1 {
    ...
    const CLASS_NAME: &'static str = "NullableMethodCallInstruction/GetValueOrDefault1";
...
impl crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1
