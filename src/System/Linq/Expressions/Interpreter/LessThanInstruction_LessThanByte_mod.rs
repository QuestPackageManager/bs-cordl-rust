...
for crate::GlobalNamespace::LessThanInstruction_LessThanByte {
    ...
    const CLASS_NAME: &'static str = "LessThanInstruction/LessThanByte";
...
impl crate::GlobalNamespace::LessThanInstruction_LessThanByte {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LessThanInstruction_LessThanByte as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LessThanInstruction_LessThanByte as
