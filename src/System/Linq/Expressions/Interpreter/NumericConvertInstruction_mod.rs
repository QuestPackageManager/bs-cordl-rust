#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NumericConvertInstruction")]
#[repr(C)]
    ...
    for crate::System::Linq::Expressions::Interpreter::NumericConvertInstruction
{
    ...
    const CLASS_NAME: &'static str = "NumericConvertInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::NumericConvertInstruction {
...
impl crate::System::Linq::Expressions::Interpreter::NumericConvertInstruction {
    ...
    #[cfg(feature = "System+Linq+Expressions+Interpreter+NumericConvertInstruction+Unchecked")]
