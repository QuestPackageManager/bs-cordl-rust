...
#[repr(C)]
#[derive(Debug)]
pub struct NullableMethodCallInstruction_GetValue {
...
for crate::GlobalNamespace::NullableMethodCallInstruction_GetValue {
    ...
    const CLASS_NAME: &'static str = "NullableMethodCallInstruction/GetValue";
...
impl crate::GlobalNamespace::NullableMethodCallInstruction_GetValue {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NullableMethodCallInstruction_GetValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NullableMethodCallInstruction_GetValue as
