#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+IncrementInstruction+IncrementUInt64"
)]
#[repr(C)]
    ...
    for crate::GlobalNamespace::IncrementInstruction_IncrementUInt64
{
    ...
    const CLASS_NAME: &'static str = "IncrementInstruction/IncrementUInt64";
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+IncrementInstruction+IncrementUInt64")]
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+IncrementInstruction+IncrementUInt64")]
impl std::ops::DerefMut for crate::GlobalNamespace::IncrementInstruction_IncrementUInt64 {
