...
for crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16 {
    ...
    const CLASS_NAME: &'static str = "GreaterThanOrEqualInstruction/GreaterThanOrEqualInt16";
...
impl crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16 {
    pub fn New(
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16
