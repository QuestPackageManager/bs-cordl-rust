#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+ModuloInstruction")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::ModuloInstruction {
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+ModuloInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::ModuloInstruction {
