#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction+AddDouble")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction+AddDouble")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AddInstruction_AddDouble {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "AddInstruction/AddDouble";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction+AddDouble")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AddInstruction_AddDouble {
