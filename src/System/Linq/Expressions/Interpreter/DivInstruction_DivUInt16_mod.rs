...
for crate::GlobalNamespace::DivInstruction_DivUInt16 {
...
impl crate::GlobalNamespace::DivInstruction_DivUInt16 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DivInstruction_DivUInt16 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DivInstruction_DivUInt16 as
