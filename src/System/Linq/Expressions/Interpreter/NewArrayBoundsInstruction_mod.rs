#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NewArrayBoundsInstruction")]
#[repr(C)]
    ...
    for crate::System::Linq::Expressions::Interpreter::NewArrayBoundsInstruction
{
    ...
    const CLASS_NAME: &'static str = "NewArrayBoundsInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::NewArrayBoundsInstruction {
