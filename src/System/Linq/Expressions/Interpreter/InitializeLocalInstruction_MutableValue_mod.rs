...
for crate::GlobalNamespace::InitializeLocalInstruction_MutableValue {
    ...
    const CLASS_NAME: &'static str = "InitializeLocalInstruction/MutableValue";
...
impl crate::GlobalNamespace::InitializeLocalInstruction_MutableValue {
    pub fn BoxIfIndexMatches(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::InitializeLocalInstruction_MutableValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                quest_hook::libil2cpp::Gc<
                    crate::System::Linq::Expressions::Interpreter::Instruction,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::InitializeLocalInstruction_MutableValue as
