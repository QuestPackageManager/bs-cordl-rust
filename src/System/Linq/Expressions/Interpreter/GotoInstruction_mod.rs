...
#[cfg(feature = "System+Linq+Expressions+Interpreter+GotoInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::GotoInstruction {
...
impl crate::System::Linq::Expressions::Interpreter::GotoInstruction {
    pub fn Create(
        ...
        quest_hook::libil2cpp::Gc<crate::System::Linq::Expressions::Interpreter::GotoInstruction>,
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32, bool, bool, bool), quest_hook::libil2cpp::Gc<
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (labelIndex, hasResult, hasValue, labelTargetGetsValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, bool, bool, bool), quest_hook::libil2cpp::Void, 4usize>(
                        ".ctor",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
