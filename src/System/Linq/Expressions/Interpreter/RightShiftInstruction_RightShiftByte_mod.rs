...
for crate::GlobalNamespace::RightShiftInstruction_RightShiftByte {
    ...
    const CLASS_NAME: &'static str = "RightShiftInstruction/RightShiftByte";
...
impl crate::GlobalNamespace::RightShiftInstruction_RightShiftByte {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RightShiftInstruction_RightShiftByte as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RightShiftInstruction_RightShiftByte as
