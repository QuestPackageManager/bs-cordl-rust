...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrSByte")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OrInstruction_OrSByte {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "OrInstruction/OrSByte";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrSByte")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OrInstruction_OrSByte {
