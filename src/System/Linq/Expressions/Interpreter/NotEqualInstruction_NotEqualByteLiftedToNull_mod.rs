...
impl crate::GlobalNamespace::NotEqualInstruction_NotEqualByteLiftedToNull {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NotEqualInstruction_NotEqualByteLiftedToNull as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NotEqualInstruction_NotEqualByteLiftedToNull
