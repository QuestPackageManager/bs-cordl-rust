...
impl crate::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
