#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+LoadLocalBoxedInstruction")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct LoadLocalBoxedInstruction {
    __cordl_parent: crate::System::Linq::Expressions::Interpreter::LocalAccessInstruction,
}
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+LoadLocalBoxedInstruction")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "LoadLocalBoxedInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::LoadLocalBoxedInstruction {
