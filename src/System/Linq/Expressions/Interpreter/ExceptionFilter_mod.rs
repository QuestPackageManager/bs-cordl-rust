...
#[cfg(feature = "System+Linq+Expressions+Interpreter+ExceptionFilter")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::ExceptionFilter {
...
impl crate::System::Linq::Expressions::Interpreter::ExceptionFilter {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (labelIndex, start, end))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+ExceptionFilter")]
