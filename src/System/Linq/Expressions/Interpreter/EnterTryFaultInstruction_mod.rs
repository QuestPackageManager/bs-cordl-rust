#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EnterTryFaultInstruction")]
#[repr(C)]
#[derive(Debug)]
pub struct EnterTryFaultInstruction {
    __cordl_parent: crate::System::Linq::Expressions::Interpreter::IndexedBranchInstruction,
    pub _tryHandler:
        quest_hook::libil2cpp::Gc<crate::System::Linq::Expressions::Interpreter::TryFaultHandler>,
}
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+EnterTryFaultInstruction")]
    ...
    for crate::System::Linq::Expressions::Interpreter::EnterTryFaultInstruction
{
    ...
    const CLASS_NAME: &'static str = "EnterTryFaultInstruction";
...
impl std::ops::Deref for crate::System::Linq::Expressions::Interpreter::EnterTryFaultInstruction {
...
impl crate::System::Linq::Expressions::Interpreter::EnterTryFaultInstruction {
    pub fn New(targetIndex: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
    ...
    pub fn SetTryHandler(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Linq::Expressions::Interpreter::TryFaultHandler,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetTryHandler")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tryHandler))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (targetIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Handler(
        &mut self,
