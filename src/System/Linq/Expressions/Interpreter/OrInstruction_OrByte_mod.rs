#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrByte")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+OrInstruction+OrByte")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OrInstruction_OrByte {
