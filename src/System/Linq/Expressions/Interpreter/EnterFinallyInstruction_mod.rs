...
impl crate::System::Linq::Expressions::Interpreter::EnterFinallyInstruction {
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::EnterFinallyInstruction as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (i32),
                quest_hook::libil2cpp::Gc<
                    crate::System::Linq::Expressions::Interpreter::EnterFinallyInstruction,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Linq::Expressions::Interpreter::EnterFinallyInstruction as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::EnterFinallyInstruction as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Linq::Expressions::Interpreter::EnterFinallyInstruction as
                    quest_hook::libil2cpp::Type > ::class(), "get_ConsumedContinuations",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Interpreter::EnterFinallyInstruction as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Linq::Expressions::Interpreter::EnterFinallyInstruction as
                    quest_hook::libil2cpp::Type > ::class(), "get_ProducedStack", 0usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
