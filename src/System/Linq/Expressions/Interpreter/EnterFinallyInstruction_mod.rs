#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+EnterFinallyInstruction"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Linq::Expressions::Interpreter::EnterFinallyInstruction {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (labelIndex))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_ConsumedContinuations", 0usize
                        )
                    })
            });
