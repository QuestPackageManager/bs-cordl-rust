...
#[repr(C)]
#[derive(Debug)]
pub struct DecrementInstruction_DecrementInt32 {
...
for crate::GlobalNamespace::DecrementInstruction_DecrementInt32 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "DecrementInstruction/DecrementInt32";
...
impl crate::GlobalNamespace::DecrementInstruction_DecrementInt32 {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DecrementInstruction_DecrementInt32 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DecrementInstruction_DecrementInt32 as
