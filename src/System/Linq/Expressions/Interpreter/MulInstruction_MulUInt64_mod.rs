#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulInstruction+MulUInt64")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulInstruction+MulUInt64")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MulInstruction_MulUInt64 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "MulInstruction/MulUInt64";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+MulInstruction+MulUInt64")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MulInstruction_MulUInt64 {
