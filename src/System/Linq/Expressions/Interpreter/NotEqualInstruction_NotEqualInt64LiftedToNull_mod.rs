#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+NotEqualInstruction+NotEqualInt64LiftedToNull"
)]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::NotEqualInstruction_NotEqualInt64LiftedToNull
{
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualInt64LiftedToNull";
...
impl std::ops::Deref for crate::GlobalNamespace::NotEqualInstruction_NotEqualInt64LiftedToNull {
...
impl std::ops::DerefMut for crate::GlobalNamespace::NotEqualInstruction_NotEqualInt64LiftedToNull {
