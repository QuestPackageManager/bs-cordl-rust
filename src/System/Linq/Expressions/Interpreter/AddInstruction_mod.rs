#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+AddInstruction")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "System+Linq+Expressions+Interpreter+AddInstruction")]
impl std::ops::DerefMut for crate::System::Linq::Expressions::Interpreter::AddInstruction {
