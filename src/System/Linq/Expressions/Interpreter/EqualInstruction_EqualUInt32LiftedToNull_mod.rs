...
impl crate::GlobalNamespace::EqualInstruction_EqualUInt32LiftedToNull {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EqualInstruction_EqualUInt32LiftedToNull as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EqualInstruction_EqualUInt32LiftedToNull as
