#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NotInstruction+NotBoolean")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NotInstruction+NotBoolean")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NotInstruction_NotBoolean {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Linq.Expressions.Interpreter";
    const CLASS_NAME: &'static str = "NotInstruction/NotBoolean";
...
#[cfg(feature = "cordl_class_System+Linq+Expressions+Interpreter+NotInstruction+NotBoolean")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NotInstruction_NotBoolean {
