...
for crate::GlobalNamespace::ModuloInstruction_ModuloSingle {
...
impl crate::GlobalNamespace::ModuloInstruction_ModuloSingle {
    ...
    pub fn Run(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ModuloInstruction_ModuloSingle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ModuloInstruction_ModuloSingle as
