...
pub struct BranchLabel {
    ...
    pub _forwardBranchFixups: quest_hook::libil2cpp::Gc<i32>,
...
impl crate::System::Linq::Expressions::Interpreter::BranchLabel {
    pub fn AddBranch(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (instructions, branchIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FixupBranch(
    ...
    pub fn Mark(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (instructions))?
        };
        Ok(__cordl_ret.into())
    }
