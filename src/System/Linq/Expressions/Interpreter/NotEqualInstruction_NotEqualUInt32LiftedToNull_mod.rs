#[cfg(
    feature = "cordl_class_System+Linq+Expressions+Interpreter+NotEqualInstruction+NotEqualUInt32LiftedToNull"
)]
#[repr(C)]
    ...
    for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt32LiftedToNull
{
    ...
    const CLASS_NAME: &'static str = "NotEqualInstruction/NotEqualUInt32LiftedToNull";
...
impl std::ops::Deref for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt32LiftedToNull {
...
impl std::ops::DerefMut for crate::GlobalNamespace::NotEqualInstruction_NotEqualUInt32LiftedToNull {
