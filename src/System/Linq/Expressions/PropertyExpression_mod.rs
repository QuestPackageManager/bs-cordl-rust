...
for crate::System::Linq::Expressions::PropertyExpression {
    ...
    const CLASS_NAME: &'static str = "PropertyExpression";
...
impl crate::System::Linq::Expressions::PropertyExpression {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::PropertyExpression as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Reflection::MemberInfo>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::PropertyExpression as
