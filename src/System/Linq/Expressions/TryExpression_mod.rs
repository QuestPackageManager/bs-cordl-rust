...
impl crate::System::Linq::Expressions::TryExpression {
    ...
    pub fn Update(
        ...
        handlers: *mut crate::System::Collections::Generic::IEnumerable_1<
            *mut crate::System::Linq::Expressions::CatchBlock,
        >,
        finally: *mut crate::System::Linq::Expressions::Expression,
        fault: *mut crate::System::Linq::Expressions::Expression,
    ) -> quest_hook::libil2cpp::Result<
        *mut crate::System::Linq::Expressions::TryExpression,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::System::Linq::Expressions::TryExpression = __cordl_object
            .invoke("Update", (body, handlers, finally, fault))?;
        Ok(__cordl_ret)
    }
    pub fn _ctor(
        &mut self,
