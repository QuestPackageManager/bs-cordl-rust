...
pub struct FullExpression_1<TDelegate: quest_hook::libil2cpp::Type> {
    ...
    pub _NameCore_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ...
    for crate::System::Linq::Expressions::FullExpression_1<TDelegate>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Linq.Expressions", "FullExpression`1")
                .unwrap()
    ...
    crate::System::Linq::Expressions::FullExpression_1<TDelegate>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (body, name, tailCall, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_NameCore(
