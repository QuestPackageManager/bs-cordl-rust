...
> crate::System::Linq::Expressions::Expression2_1<TDelegate> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::Expression2_1<
            TDelegate,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::Expression2_1 < TDelegate > as
                    quest_hook::libil2cpp::Type > ::class(), "GetParameter", 1usize
                )
            });
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (body, par0, par1))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Linq::Expressions::Expression2_1 < TDelegate > as
                    quest_hook::libil2cpp::Type > ::class(), "get_ParameterCount", 0usize
                )
            });
