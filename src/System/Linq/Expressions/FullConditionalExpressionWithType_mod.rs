...
impl crate::System::Linq::Expressions::FullConditionalExpressionWithType {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::FullConditionalExpressionWithType as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::FullConditionalExpressionWithType
                    as quest_hook::libil2cpp::Type > ::class(), ".ctor", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (test, ifTrue, ifFalse, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
