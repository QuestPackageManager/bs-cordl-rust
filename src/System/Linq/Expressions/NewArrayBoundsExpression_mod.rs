...
for crate::System::Linq::Expressions::NewArrayBoundsExpression {
    ...
    const CLASS_NAME: &'static str = "NewArrayBoundsExpression";
...
impl crate::System::Linq::Expressions::NewArrayBoundsExpression {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Linq::Expressions::NewArrayBoundsExpression as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Linq::Expressions::NewArrayBoundsExpression as
