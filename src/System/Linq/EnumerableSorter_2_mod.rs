...
> {
    ...
    pub descending: bool,
    pub next: quest_hook::libil2cpp::Gc<crate::System::Linq::EnumerableSorter_1<TElement>>,
    pub keys: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<TKey>>,
    __cordl_phantom_TElement: std::marker::PhantomData<TElement>,
    __cordl_phantom_TKey: std::marker::PhantomData<TKey>,
}
#[cfg(feature = "cordl_class_System+Linq+EnumerableSorter_2")]
unsafe impl<TElement: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::System::Linq::EnumerableSorter_2<TElement, TKey>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Linq", "EnumerableSorter`2")
                .unwrap()
...
impl<TElement: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type> std::ops::Deref
...
#[cfg(feature = "System+Linq+EnumerableSorter_2")]
impl<TElement: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::System::Linq::EnumerableSorter_2<TElement, TKey>
{
...
#[cfg(feature = "System+Linq+EnumerableSorter_2")]
impl<TElement: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type>
    crate::System::Linq::EnumerableSorter_2<TElement, TKey>
{
    pub fn CompareKeys(&mut self, index1: i32, index2: i32) -> quest_hook::libil2cpp::Result<i32>
    where
        TElement: quest_hook::libil2cpp::Type
    ...
    pub fn ComputeKeys(
        &mut self,
        elements: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<TElement>>,
        count: i32,
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("ComputeKeys")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (elements, count))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keySelector, comparer, descending, next))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Linq+EnumerableSorter_2")]
impl<TElement: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::System::Linq::EnumerableSorter_2<TElement, TKey>
{
