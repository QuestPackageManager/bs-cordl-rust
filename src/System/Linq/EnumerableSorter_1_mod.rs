#[cfg(feature = "cordl_class_System+Linq+EnumerableSorter_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Linq::EnumerableSorter_1<TElement>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Linq", "EnumerableSorter`1")
                .unwrap()
...
#[cfg(feature = "System+Linq+EnumerableSorter_1")]
impl<TElement: quest_hook::libil2cpp::Type> crate::System::Linq::EnumerableSorter_1<TElement> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (map, left, right))? };
        Ok(__cordl_ret.into())
    }
    pub fn Sort(
        &mut self,
