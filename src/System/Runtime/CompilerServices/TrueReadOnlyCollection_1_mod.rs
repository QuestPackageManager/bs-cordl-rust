...
for crate::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T> {
    ...
    const CLASS_NAME: &'static str = "TrueReadOnlyCollection`1";
...
> crate::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T> {
    ...
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<
            T,
