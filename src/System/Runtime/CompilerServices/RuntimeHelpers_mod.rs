#[cfg(feature = "cordl_class_System+Runtime+CompilerServices+RuntimeHelpers")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::CompilerServices::RuntimeHelpers {
    pub fn EnsureSufficientExecutionStack(
    ...
    pub fn InitializeArray_IntPtr0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                    ), quest_hook::libil2cpp::Void, 2usize>("InitializeArray")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (array, fldHandle))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PrepareConstrainedRegions() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
