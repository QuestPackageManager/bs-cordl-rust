...
impl crate::System::Runtime::CompilerServices::AsyncMethodBuilderCore {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateContinuationWrapper", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Action> = unsafe {
            cordl_method_info
                .invoke_unchecked((), (continuation, invokeAction, innerTask))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Action> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (taskForTracing, runnerToInitialize))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Action> = unsafe {
            cordl_method_info.invoke_unchecked(self, (innerTask, continuation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn PostBoxInitialization(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (stateMachine, runner, builtTask))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ThrowAsync(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (exception, targetContext))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::System::Runtime::CompilerServices::AsyncMethodBuilderCore_ContinuationWrapper {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (continuation, invokeAction, innerTask))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::System::Runtime::CompilerServices::AsyncMethodBuilderCore_MoveNextRunner {
    pub fn InvokeMoveNext(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (stateMachine))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (context, stateMachine))?
        };
        Ok(__cordl_ret.into())
    }
}
