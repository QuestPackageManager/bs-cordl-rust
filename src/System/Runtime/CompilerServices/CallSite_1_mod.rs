...
#[cfg(feature = "System+Runtime+CompilerServices+CallSite_1")]
impl<T: quest_hook::libil2cpp::Type> crate::System::Runtime::CompilerServices::CallSite_1<T> {
    pub fn AddRule(
        &mut self,
        newRule: T,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Linq::Expressions::Expression> =
            unsafe { cordl_method_info.invoke_unchecked((), (arg, _cordl_type))? };
        Ok(__cordl_ret.into())
    }
    pub fn Create(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (invoke))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::ByRefMut<T>), T, 1usize>(
                        "GetUpdateDelegate",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (addr))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MoveRule(&mut self, i: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
