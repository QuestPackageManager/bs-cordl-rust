...
> {
    ...
    pub data: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<crate::System::Runtime::CompilerServices::Ephemeron>,
    >,
...
{
    #[cfg(feature = "System+Runtime+CompilerServices+ConditionalWeakTable_2+CreateValueCallback")]
    pub type CreateValueCallback =
    ...
    pub type Enumerator =
        crate::System::Runtime::CompilerServices::ConditionalWeakTable_2_Enumerator<TKey, TValue>;
    pub fn Add(
        &mut self,
        key: TKey,
        value: TValue,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, createValueCallback))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RecomputeSize(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TKey: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RehashWithoutResize")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Runtime+CompilerServices+ConditionalWeakTable_2+Enumerator")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::System::Runtime::CompilerServices::ConditionalWeakTable_2_Enumerator<TKey, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Runtime.CompilerServices";
