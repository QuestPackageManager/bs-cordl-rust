...
for crate::System::Runtime::CompilerServices::ValueTaskAwaiter {
    ...
    const CLASS_NAME: &'static str = "ValueTaskAwaiter";
...
impl crate::System::Runtime::CompilerServices::ValueTaskAwaiter {
    pub fn GetResult(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::CompilerServices::ValueTaskAwaiter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("GetResult")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Runtime::CompilerServices::ValueTaskAwaiter as
