...
pub struct AsyncTaskMethodBuilder_1<TResult: quest_hook::libil2cpp::Type> {
    ...
    pub m_task: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task_1<TResult>>,
    ...
    crate::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResult>
{
    ...
    pub fn SetResult_Task_1_1(
        &mut self,
        completedTask: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task_1<TResult>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TResult: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (completedTask))? };
        Ok(__cordl_ret.into())
    }
