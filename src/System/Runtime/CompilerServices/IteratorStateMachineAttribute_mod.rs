#[cfg(feature = "cordl_class_System+Runtime+CompilerServices+IteratorStateMachineAttribute")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Runtime::CompilerServices::IteratorStateMachineAttribute
{
    ...
    const CLASS_NAME: &'static str = "IteratorStateMachineAttribute";
...
impl std::ops::Deref for crate::System::Runtime::CompilerServices::IteratorStateMachineAttribute {
