...
#[cfg_attr(feature = "derive_PartialEq", derive(PartialEq))]
#[repr(C)]
pub struct ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<TResult: quest_hook::libil2cpp::Type> {
...
#[cfg(feature = "System+Runtime+CompilerServices+ConfiguredTaskAwaitable_1+ConfiguredTaskAwaiter")]
impl<TResult: quest_hook::libil2cpp::Type>
    crate::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<
        TResult,
    >
