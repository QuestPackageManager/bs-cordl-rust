...
for crate::System::Runtime::CompilerServices::IsReadOnlyAttribute {
    ...
    const CLASS_NAME: &'static str = "IsReadOnlyAttribute";
...
impl crate::System::Runtime::CompilerServices::IsReadOnlyAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::CompilerServices::IsReadOnlyAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Runtime::CompilerServices::IsReadOnlyAttribute as
