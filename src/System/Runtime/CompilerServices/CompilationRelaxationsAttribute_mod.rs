...
impl crate::System::Runtime::CompilerServices::CompilationRelaxationsAttribute {
    ...
    pub fn _ctor_CompilationRelaxations1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::CompilerServices::CompilationRelaxationsAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::Runtime::CompilerServices::CompilationRelaxations),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (relaxations))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_0(
    ...
    pub fn get_CompilationRelaxations(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::CompilerServices::CompilationRelaxationsAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_CompilationRelaxations")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ...
                    "get_CompilationRelaxations", 0usize
                )
            });
