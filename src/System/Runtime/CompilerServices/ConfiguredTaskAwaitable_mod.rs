...
impl crate::System::Runtime::CompilerServices::ConfiguredTaskAwaitable {
    ...
    pub type ConfiguredTaskAwaiter =
        crate::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter;
    pub fn GetAwaiter(
        &mut self,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (task, continueOnCapturedContext))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(
...
#[cfg(feature = "System+Runtime+CompilerServices+ConfiguredTaskAwaitable+ConfiguredTaskAwaiter")]
