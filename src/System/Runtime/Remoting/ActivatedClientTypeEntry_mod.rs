#[cfg(feature = "cordl_class_System+Runtime+Remoting+ActivatedClientTypeEntry")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Remoting::ActivatedClientTypeEntry {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (typeName, assemblyName, appUrl))? };
        Ok(__cordl_ret.into())
    }
