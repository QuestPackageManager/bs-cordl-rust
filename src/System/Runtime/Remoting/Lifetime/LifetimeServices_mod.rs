#[cfg(feature = "cordl_class_System+Runtime+Remoting+Lifetime+LifetimeServices")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "System+Runtime+Remoting+Lifetime+LifetimeServices")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Lifetime::LifetimeServices {
...
impl crate::System::Runtime::Remoting::Lifetime::LifetimeServices {
    ...
    pub fn get_LeaseManagerPollTime() -> quest_hook::libil2cpp::Result<crate::System::TimeSpan> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_RenewOnCallTime() -> quest_hook::libil2cpp::Result<crate::System::TimeSpan> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_SponsorshipTimeout() -> quest_hook::libil2cpp::Result<crate::System::TimeSpan> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
