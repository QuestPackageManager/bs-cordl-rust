                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ProcessSponsorResponse", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (state, timedOut))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Renew(
        ...
        let __cordl_ret: crate::System::TimeSpan = unsafe {
            cordl_method_info.invoke_unchecked(self, (renewalTime))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Unregister(
...
impl crate::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (lease, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
