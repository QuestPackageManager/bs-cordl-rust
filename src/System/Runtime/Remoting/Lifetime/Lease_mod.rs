...
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Lifetime+Lease")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Runtime::Remoting::Lifetime::Lease {
...
impl crate::System::Runtime::Remoting::Lifetime::Lease {
    ...
    pub fn ProcessSponsorResponse(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, timedOut))? };
        Ok(__cordl_ret.into())
    }
    pub fn Renew(
        &mut self,
    ...
    pub fn Unregister(
        &mut self,
        obj: quest_hook::libil2cpp::Gc<crate::System::Runtime::Remoting::Lifetime::ISponsor>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn UpdateState(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Lifetime+Lease")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Runtime::Remoting::Lifetime::Lease {
...
#[cfg(feature = "System+Runtime+Remoting+Lifetime+Lease+RenewalDelegate")]
impl std::ops::Deref for crate::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate {
...
#[cfg(feature = "System+Runtime+Remoting+Lifetime+Lease+RenewalDelegate")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (lease, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
