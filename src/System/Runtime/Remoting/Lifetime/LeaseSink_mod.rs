#[cfg(feature = "cordl_class_System+Runtime+Remoting+Lifetime+LeaseSink")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Lifetime+LeaseSink")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Runtime::Remoting::Lifetime::LeaseSink {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Runtime::Remoting::Messaging::IMessage,
                    >), quest_hook::libil2cpp::Void, 1usize>("RenewLease")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Lifetime+LeaseSink")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Runtime::Remoting::Lifetime::LeaseSink {
