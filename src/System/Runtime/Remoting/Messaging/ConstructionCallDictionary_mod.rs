#[cfg(feature = "cordl_class_System+Runtime+Remoting+Messaging+ConstructionCallDictionary")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Messaging::ConstructionCallDictionary {
