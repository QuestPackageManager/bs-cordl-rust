#[cfg(feature = "cordl_class_System+Runtime+Remoting+Messaging+AsyncResult")]
#[repr(C)]
#[derive(Debug)]
pub struct AsyncResult {
    ...
    pub add_time: i64,
    pub call_message:
        quest_hook::libil2cpp::Gc<crate::System::Runtime::Remoting::Messaging::MonoMethodMessage>,
    pub message_ctrl:
...
impl crate::System::Runtime::Remoting::Messaging::AsyncResult {
    ...
    pub fn SetCompletedSynchronously(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (completed))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetMessageCtrl(
        &mut self,
        mc: quest_hook::libil2cpp::Gc<crate::System::Runtime::Remoting::Messaging::IMessageCtrl>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Runtime::Remoting::Messaging::IMessageCtrl,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetMessageCtrl")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mc))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn System_Threading_IThreadPoolWorkItem_MarkAborted(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tae))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Runtime::Remoting::Messaging::MonoMethodMessage,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_CallMessage")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
