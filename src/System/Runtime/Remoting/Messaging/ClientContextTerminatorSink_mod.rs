#[cfg(feature = "cordl_class_System+Runtime+Remoting+Messaging+ClientContextTerminatorSink")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Messaging::ClientContextTerminatorSink {
