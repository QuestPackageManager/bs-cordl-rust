...
pub struct CallContextSecurityData {
    ...
    pub _principal: quest_hook::libil2cpp::Gc<crate::System::Security::Principal::IPrincipal>,
}
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Messaging+CallContextSecurityData")]
    ...
    for crate::System::Runtime::Remoting::Messaging::CallContextSecurityData
{
    ...
    const CLASS_NAME: &'static str = "CallContextSecurityData";
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Messaging::CallContextSecurityData {
...
#[cfg(feature = "System+Runtime+Remoting+Messaging+CallContextSecurityData")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Messaging::CallContextSecurityData {
