...
impl std::ops::Deref for crate::System::Runtime::Remoting::Messaging::CADMethodCallMessage {
...
#[cfg(feature = "System+Runtime+Remoting+Messaging+CADMethodCallMessage")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Messaging::CADMethodCallMessage {
...
impl crate::System::Runtime::Remoting::Messaging::CADMethodCallMessage {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Runtime::Remoting::Messaging::CADMethodCallMessage,
        > = unsafe { cordl_method_info.invoke_unchecked((), (callMsg))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetArgs(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "GetArgs",
                            1usize
                        )
                    })
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (callMsg))? };
        Ok(__cordl_ret.into())
    }
