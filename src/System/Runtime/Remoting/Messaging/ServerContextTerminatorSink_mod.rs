#[cfg(feature = "cordl_class_System+Runtime+Remoting+Messaging+ServerContextTerminatorSink")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Runtime::Remoting::Messaging::ServerContextTerminatorSink
{
    ...
    const CLASS_NAME: &'static str = "ServerContextTerminatorSink";
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Messaging::ServerContextTerminatorSink {
