...
impl crate::System::Runtime::Remoting::Messaging::RemotingSurrogateSelector {
    pub fn GetSurrogate(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Messaging::RemotingSurrogateSelector as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Runtime::Remoting::Messaging::RemotingSurrogateSelector as
                    quest_hook::libil2cpp::Type > ::class(), "GetSurrogate", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Runtime::Serialization::ISerializationSurrogate,
        > = unsafe { method.invoke_unchecked(self, (_cordl_type, context, ssout))? };
        Ok(__cordl_ret.into())
    }
