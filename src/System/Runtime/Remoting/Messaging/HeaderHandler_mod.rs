...
for crate::System::Runtime::Remoting::Messaging::HeaderHandler {
    ...
    const CLASS_NAME: &'static str = "HeaderHandler";
...
impl crate::System::Runtime::Remoting::Messaging::HeaderHandler {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Messaging::HeaderHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
                        quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Remoting::Messaging::HeaderHandler as
