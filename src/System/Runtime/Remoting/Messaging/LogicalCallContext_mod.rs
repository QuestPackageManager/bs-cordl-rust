...
impl std::ops::Deref for crate::System::Runtime::Remoting::Messaging::LogicalCallContext {
...
#[cfg(feature = "System+Runtime+Remoting+Messaging+LogicalCallContext")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Messaging::LogicalCallContext {
...
impl crate::System::Runtime::Remoting::Messaging::LogicalCallContext {
    ...
    pub fn Merge(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Runtime::Remoting::Messaging::LogicalCallContext,
                    >), quest_hook::libil2cpp::Void, 1usize>("Merge")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lc))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, data))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Messaging+LogicalCallContext+Reader")]
