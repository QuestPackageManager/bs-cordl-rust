...
#[cfg(feature = "System+Runtime+Remoting+Services+TrackingServices")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Services::TrackingServices {
...
impl crate::System::Runtime::Remoting::Services::TrackingServices {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "NotifyDisconnectedObject", 1usize
                        )
                    })
            });
    ...
    pub fn NotifyMarshaledObject(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (obj, _cordl_or))? };
        Ok(__cordl_ret.into())
    }
