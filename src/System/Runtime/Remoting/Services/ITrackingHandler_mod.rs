#[cfg(feature = "cordl_class_System+Runtime+Remoting+Services+ITrackingHandler")]
...
#[cfg(feature = "System+Runtime+Remoting+Services+ITrackingHandler")]
impl std::ops::DerefMut for crate::System::Runtime::Remoting::Services::ITrackingHandler {
...
impl crate::System::Runtime::Remoting::Services::ITrackingHandler {
    ...
    pub fn MarshaledObject(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("MarshaledObject")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (obj, _cordl_or))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        quest_hook::libil2cpp::Gc<crate::System::Runtime::Remoting::ObjRef>,
                    ), quest_hook::libil2cpp::Void, 2usize>("UnmarshaledObject")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
