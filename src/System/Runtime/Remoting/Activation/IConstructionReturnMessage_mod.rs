#[cfg(feature = "cordl_class_System+Runtime+Remoting+Activation+IConstructionReturnMessage")]
#[derive(Debug)]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Activation::IConstructionReturnMessage {
