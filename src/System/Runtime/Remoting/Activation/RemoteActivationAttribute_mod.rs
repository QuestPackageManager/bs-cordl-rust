#[cfg(feature = "cordl_class_System+Runtime+Remoting+Activation+RemoteActivationAttribute")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Activation::RemoteActivationAttribute {
...
impl crate::System::Runtime::Remoting::Activation::RemoteActivationAttribute {
    pub fn GetPropertiesForNewContext(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ctor))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsContextOK(
        &mut self,
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (ctx, ctor))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (contextProperties))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Runtime+Remoting+Activation+RemoteActivationAttribute")]
