#[cfg(feature = "cordl_class_System+Runtime+Remoting+Activation+ConstructionLevelActivator")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Activation::ConstructionLevelActivator {
