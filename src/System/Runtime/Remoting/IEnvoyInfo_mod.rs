...
for crate::System::Runtime::Remoting::IEnvoyInfo {
    ...
    const CLASS_NAME: &'static str = "IEnvoyInfo";
...
impl crate::System::Runtime::Remoting::IEnvoyInfo {
    ...
    pub fn get_EnvoySinks(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::IEnvoyInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Runtime::Remoting::Messaging::IMessageSink,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Remoting::IEnvoyInfo as
