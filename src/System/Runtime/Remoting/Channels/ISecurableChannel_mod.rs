...
for crate::System::Runtime::Remoting::Channels::ISecurableChannel {
    ...
    const CLASS_NAME: &'static str = "ISecurableChannel";
...
impl crate::System::Runtime::Remoting::Channels::ISecurableChannel {
    ...
    pub fn set_IsSecured(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Channels::ISecurableChannel as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_IsSecured")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Runtime::Remoting::Channels::ISecurableChannel as
                    quest_hook::libil2cpp::Type > ::class(), "set_IsSecured", 1usize
                )
            });
