...
impl crate::System::Runtime::Remoting::Contexts::IContributeObjectSink {
    pub fn GetObjectSink(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Contexts::IContributeObjectSink as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Remoting::Contexts::IContributeObjectSink as
                    quest_hook::libil2cpp::Type > ::class(), "GetObjectSink", 2usize
                )
            });
