...
impl crate::System::Runtime::Remoting::Contexts::IContributeDynamicSink {
    pub fn GetDynamicSink(
        ...
        *mut crate::System::Runtime::Remoting::Contexts::IDynamicMessageSink,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::System::Runtime::Remoting::Contexts::IDynamicMessageSink = __cordl_object
            .invoke("GetDynamicSink", ())?;
        Ok(__cordl_ret)
    }
