...
impl crate::System::Runtime::Remoting::Contexts::IContributeEnvoySink {
    pub fn GetEnvoySink(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Contexts::IContributeEnvoySink as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Remoting::Contexts::IContributeEnvoySink as
                    quest_hook::libil2cpp::Type > ::class(), "GetEnvoySink", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Runtime::Remoting::Messaging::IMessageSink,
        > = unsafe { method.invoke_unchecked(self, (obj, nextSink))? };
        Ok(__cordl_ret.into())
    }
