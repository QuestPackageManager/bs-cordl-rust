...
for crate::System::Runtime::Remoting::Contexts::IContributeClientContextSink {
    ...
    const CLASS_NAME: &'static str = "IContributeClientContextSink";
...
impl crate::System::Runtime::Remoting::Contexts::IContributeClientContextSink {
    pub fn GetClientContextSink(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Contexts::IContributeClientContextSink as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::System::Runtime::Remoting::Messaging::IMessageSink,
                >),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "GetClientContextSink",
                    1usize
                )
            });
