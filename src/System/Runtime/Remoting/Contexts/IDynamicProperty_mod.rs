...
for crate::System::Runtime::Remoting::Contexts::IDynamicProperty {
    ...
    const CLASS_NAME: &'static str = "IDynamicProperty";
...
impl crate::System::Runtime::Remoting::Contexts::IDynamicProperty {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Contexts::IDynamicProperty as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Remoting::Contexts::IDynamicProperty as
