#[cfg(feature = "cordl_class_System+Runtime+Remoting+Contexts+IContributeServerContextSink")]
...
impl std::ops::Deref for crate::System::Runtime::Remoting::Contexts::IContributeServerContextSink {
