...
for crate::System::Runtime::Remoting::Metadata::SoapFieldAttribute {
    ...
    const CLASS_NAME: &'static str = "SoapFieldAttribute";
...
impl crate::System::Runtime::Remoting::Metadata::SoapFieldAttribute {
    pub fn IsInteropXmlElement(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Remoting::Metadata::SoapFieldAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("IsInteropXmlElement")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Runtime::Remoting::Metadata::SoapFieldAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "IsInteropXmlElement",
                    0usize
                )
            });
