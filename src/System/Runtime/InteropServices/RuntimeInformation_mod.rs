#[cfg(feature = "cordl_class_System+Runtime+InteropServices+RuntimeInformation")]
#[repr(C)]
...
impl crate::System::Runtime::InteropServices::RuntimeInformation {
    ...
    pub fn IsOSPlatform(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (osPlatform))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Runtime+InteropServices+RuntimeInformation")]
