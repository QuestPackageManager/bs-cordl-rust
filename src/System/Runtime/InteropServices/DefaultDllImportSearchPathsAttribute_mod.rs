...
impl crate::System::Runtime::InteropServices::DefaultDllImportSearchPathsAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::InteropServices::DefaultDllImportSearchPathsAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (paths))?
        };
        Ok(__cordl_ret.into())
    }
}
