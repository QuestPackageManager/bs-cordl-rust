#[cfg(feature = "cordl_class_System+Runtime+InteropServices+_ParameterInfo")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::System::Runtime::InteropServices::_ParameterInfo
{
    ...
    const CLASS_NAME: &'static str = "_ParameterInfo";
...
#[cfg(feature = "cordl_class_System+Runtime+InteropServices+_ParameterInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Runtime::InteropServices::_ParameterInfo {
