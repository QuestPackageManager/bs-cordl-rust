#[cfg(feature = "cordl_class_System+Runtime+InteropServices+ComVisibleAttribute")]
#[repr(C)]
    ...
    for crate::System::Runtime::InteropServices::ComVisibleAttribute
{
    ...
    const CLASS_NAME: &'static str = "ComVisibleAttribute";
...
#[cfg(feature = "System+Runtime+InteropServices+ComVisibleAttribute")]
impl std::ops::DerefMut for crate::System::Runtime::InteropServices::ComVisibleAttribute {
...
impl crate::System::Runtime::InteropServices::ComVisibleAttribute {
    pub fn New(visibility: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
