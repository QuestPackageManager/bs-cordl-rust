...
impl crate::System::Runtime::InteropServices::GCHandle {
    ...
    > {
        ...
        let __cordl_ret: crate::System::Runtime::InteropServices::GCHandle = unsafe {
            cordl_method_info.invoke_unchecked((), (value, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetTargetHandle", 3usize
                        )
                    })
            });
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked((), (obj, handle, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetRef(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "SetRef",
                            2usize
                        )
                    })
            });
