...
impl std::ops::Deref for crate::System::Runtime::ExceptionServices::ExceptionDispatchInfo {
...
#[cfg(feature = "System+Runtime+ExceptionServices+ExceptionDispatchInfo")]
impl std::ops::DerefMut for crate::System::Runtime::ExceptionServices::ExceptionDispatchInfo {
...
impl crate::System::Runtime::ExceptionServices::ExceptionDispatchInfo {
    ...
    pub fn Throw_0(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_BinaryStackTraceArray", 0usize
                        )
                    })
            });
