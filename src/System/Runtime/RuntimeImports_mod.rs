#[cfg(feature = "cordl_class_System+Runtime+RuntimeImports")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::RuntimeImports {
    ...
    pub fn Memmove_wbarrier(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        u32,
                        crate::System::IntPtr,
                    ), quest_hook::libil2cpp::Void, 4usize>("Memmove_wbarrier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (dest, src, len, type_handle))? };
        Ok(__cordl_ret.into())
    }
    pub fn RhZeroMemory(
    ...
    pub fn ZeroMemory(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (p, byteLength))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Runtime+RuntimeImports")]
