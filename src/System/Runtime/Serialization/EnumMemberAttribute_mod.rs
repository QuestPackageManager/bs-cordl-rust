...
for crate::System::Runtime::Serialization::EnumMemberAttribute {
    ...
    const CLASS_NAME: &'static str = "EnumMemberAttribute";
...
impl crate::System::Runtime::Serialization::EnumMemberAttribute {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::EnumMemberAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Serialization::EnumMemberAttribute as
