#[cfg(feature = "cordl_class_System+Runtime+Serialization+XmlFormatCollectionReaderDelegate")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Runtime::Serialization::XmlFormatCollectionReaderDelegate {
