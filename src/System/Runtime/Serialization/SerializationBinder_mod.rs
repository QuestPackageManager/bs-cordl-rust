...
for crate::System::Runtime::Serialization::SerializationBinder {
    ...
    const CLASS_NAME: &'static str = "SerializationBinder";
...
impl crate::System::Runtime::Serialization::SerializationBinder {
    pub fn BindToName(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::SerializationBinder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Serialization::SerializationBinder as
