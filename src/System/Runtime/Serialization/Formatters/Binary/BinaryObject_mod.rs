...
#[cfg(feature = "System+Runtime+Serialization+Formatters+Binary+BinaryObject")]
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryObject {
    pub fn Dump(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::Formatters::Binary::BinaryObject as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Dump")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::System::Runtime::Serialization::Formatters::Binary::BinaryObject as
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (objectId, mapId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
