#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+BinaryObject")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::BinaryObject {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryObject {
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (objectId, mapId))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
