#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+PrimitiveArray")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::PrimitiveArray {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::PrimitiveArray {
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (code, array))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        code: crate::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE,
