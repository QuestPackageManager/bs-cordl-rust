...
#[cfg(feature = "System+Runtime+Serialization+Formatters+Binary+SerializationHeaderRecord")]
impl std::ops::Deref
    for crate::System::Runtime::Serialization::Formatters::Binary::SerializationHeaderRecord
{
...
impl crate::System::Runtime::Serialization::Formatters::Binary::SerializationHeaderRecord {
    ...
    pub fn GetInt32(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (buffer, index))? };
        Ok(__cordl_ret.into())
    }
