#[cfg(
    feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+MemberPrimitiveUnTyped"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped {
    ...
    pub fn Set_Il2CppObject0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (typeInformation, value))? };
        Ok(__cordl_ret.into())
    }
    pub fn Set_InternalPrimitiveTypeE1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (typeInformation))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
