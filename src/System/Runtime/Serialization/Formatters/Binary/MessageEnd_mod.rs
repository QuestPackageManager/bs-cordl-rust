#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+MessageEnd")]
#[repr(C)]
    ...
    for crate::System::Runtime::Serialization::Formatters::Binary::MessageEnd
{
    ...
    const CLASS_NAME: &'static str = "MessageEnd";
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::MessageEnd {
...
#[cfg(feature = "System+Runtime+Serialization+Formatters+Binary+MessageEnd")]
impl std::ops::DerefMut for crate::System::Runtime::Serialization::Formatters::Binary::MessageEnd {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::MessageEnd {
    pub fn Dump_0(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Dump",
                            1usize
                        )
                    })
            });
