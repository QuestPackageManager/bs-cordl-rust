...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::SerStack {
...
#[cfg(feature = "System+Runtime+Serialization+Formatters+Binary+SerStack")]
impl std::ops::DerefMut for crate::System::Runtime::Serialization::Formatters::Binary::SerStack {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::SerStack {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (stackId))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+SerStack")]
