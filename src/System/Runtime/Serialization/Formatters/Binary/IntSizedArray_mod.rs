...
for crate::System::Runtime::Serialization::Formatters::Binary::IntSizedArray {
    ...
    const CLASS_NAME: &'static str = "IntSizedArray";
...
impl crate::System::Runtime::Serialization::Formatters::Binary::IntSizedArray {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::Formatters::Binary::IntSizedArray as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                0usize,
    ...
    pub fn _ctor_IntSizedArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sizedArray))?
        };
        Ok(__cordl_ret.into())
    }
