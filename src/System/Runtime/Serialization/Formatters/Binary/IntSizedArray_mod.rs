#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+IntSizedArray")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::IntSizedArray {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::IntSizedArray {
    ...
    pub fn IncreaseCapacity(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("IncreaseCapacity")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_IntSizedArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sizedArray))? };
        Ok(__cordl_ret.into())
    }
