#[cfg(
    feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+IntSizedArray"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::IntSizedArray {
    ...
    pub fn _ctor_IntSizedArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sizedArray))?
        };
        Ok(__cordl_ret.into())
    }
