#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+BinaryAssembly")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::BinaryAssembly {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryAssembly {
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (assemId, assemblyString))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
