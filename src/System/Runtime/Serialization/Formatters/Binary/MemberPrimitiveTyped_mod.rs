...
for crate::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped {
    ...
    const CLASS_NAME: &'static str = "MemberPrimitiveTyped";
...
impl crate::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped {
    pub fn Dump(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped as quest_hook::libil2cpp::Type>::class()
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (primitiveTypeEnum, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
