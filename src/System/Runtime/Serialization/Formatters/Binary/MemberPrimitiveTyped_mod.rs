#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+MemberPrimitiveTyped")]
#[repr(C)]
#[derive(Debug)]
pub struct MemberPrimitiveTyped {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub primitiveTypeEnum:
...
impl crate::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveTyped {
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (primitiveTypeEnum, value))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
