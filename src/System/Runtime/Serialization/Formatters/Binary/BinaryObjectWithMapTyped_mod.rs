...
pub struct BinaryObjectWithMapTyped {
    ...
    pub typeInformationA: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub memberAssemIds: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>>,
    pub assemId: i32,
}
#[cfg(
    feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+BinaryObjectWithMapTyped"
...
#[cfg(feature = "System+Runtime+Serialization+Formatters+Binary+BinaryObjectWithMapTyped")]
impl std::ops::Deref
    for crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped
{
