...
impl crate::System::Runtime::Serialization::Formatters::Binary::Converter {
    pub fn CreatePrimitiveArray(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Array> = unsafe {
            cordl_method_info.invoke_unchecked((), (code, length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FromString(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsPrimitiveArray", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_type, typeInformation))?
        };
        Ok(__cordl_ret.into())
    }
