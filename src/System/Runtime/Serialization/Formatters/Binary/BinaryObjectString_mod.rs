#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+BinaryObjectString")]
#[repr(C)]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectString {
    pub fn Dump(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (objectId, value))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
