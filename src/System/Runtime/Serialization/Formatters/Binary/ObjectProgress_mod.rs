#[cfg(
    feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+ObjectProgress"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::ObjectProgress {
    ...
    pub fn GetNext(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (outBinaryTypeEnum, outTypeInformation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
