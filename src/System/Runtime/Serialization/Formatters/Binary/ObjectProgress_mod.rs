#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+ObjectProgress")]
#[repr(C)]
...
pub struct ObjectProgress {
    ...
    pub expectedTypeInformation: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::ObjectProgress {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::ObjectProgress {
    ...
    pub fn GetNext(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (outBinaryTypeEnum, outTypeInformation))?
        };
        Ok(__cordl_ret.into())
    }
