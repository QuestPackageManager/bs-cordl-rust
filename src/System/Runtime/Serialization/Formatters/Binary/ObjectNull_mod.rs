...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::ObjectNull {
...
#[cfg(feature = "System+Runtime+Serialization+Formatters+Binary+ObjectNull")]
impl std::ops::DerefMut for crate::System::Runtime::Serialization::Formatters::Binary::ObjectNull {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::ObjectNull {
    ...
    pub fn Read(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (input, binaryHeaderEnum))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetNullCount(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nullCount))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
