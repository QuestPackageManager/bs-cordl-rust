#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+WriteObjectInfo")]
#[repr(C)]
#[derive(Debug)]
pub struct WriteObjectInfo {
    ...
    pub isTyped: bool,
    pub isArray: bool,
    pub si: quest_hook::libil2cpp::Gc<crate::System::Runtime::Serialization::SerializationInfo>,
    ...
    pub binderAssemblyString: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+WriteObjectInfo")]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo {
    pub fn CheckTypeForwardedFrom(
        ...
        binderAssemblyString: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cache, objectType, binderAssemblyString))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("GetMemberInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InitSiWrite(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn InternalInit(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn PutObjectInfo(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (serObjectInfoInit, objectInfo))? };
        Ok(__cordl_ret.into())
    }
