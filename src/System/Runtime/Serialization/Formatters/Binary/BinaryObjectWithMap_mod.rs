...
for crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap {
    ...
    const CLASS_NAME: &'static str = "BinaryObjectWithMap";
...
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap {
    pub fn Dump(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap as quest_hook::libil2cpp::Type>::class()
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap
                    as quest_hook::libil2cpp::Type > ::class(), "Set", 5usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (objectId, name, numMembers, memberNames, assemId),
                )?
        };
        Ok(__cordl_ret.into())
    }
