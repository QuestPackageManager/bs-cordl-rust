#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+BinaryObjectWithMap")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap {
    ...
    pub fn Set(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        i32,
                    ), quest_hook::libil2cpp::Void, 5usize>("Set")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (objectId, name, numMembers, memberNames, assemId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
