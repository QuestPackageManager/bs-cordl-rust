#[cfg(feature = "cordl_class_System+Runtime+Serialization+Formatters+Binary+TypeInformation")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::Formatters::Binary::TypeInformation {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (fullTypeName, assemblyString, hasTypeForwardedFrom))?
        };
        Ok(__cordl_ret.into())
    }
