...
pub struct ObjectWriter {
    ...
    pub assemblyToIdTable: quest_hook::libil2cpp::Gc<crate::System::Collections::Hashtable>,
...
impl std::ops::Deref for crate::System::Runtime::Serialization::Formatters::Binary::ObjectWriter {
...
impl crate::System::Runtime::Serialization::Formatters::Binary::ObjectWriter {
    ...
    pub fn CheckTypeFormat(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (test, want))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetAssemblyId(
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (objectInfo))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetNameInfo(
        &mut self,
    ...
    pub fn InternalGetId(
        ...
        let __cordl_ret: i64 = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (obj, assignUniqueIdToValueType, _cordl_type, isNew))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PutNameInfo(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Runtime::Serialization::Formatters::Binary::NameInfo,
                    >), quest_hook::libil2cpp::Void, 1usize>("PutNameInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nameInfo))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Serialize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (graph, inHeaders, serWriter, fCheck))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToCode(
    ...
    pub fn TypeToNameInfo_Type_NameInfo4(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::System::Runtime::Serialization::Formatters::Binary::NameInfo,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("TypeToNameInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, nameInfo))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Runtime::Serialization::Formatters::Binary::NameInfo,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, objectInfo, code, nameInfo))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteArrayMember(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (objectInfo, arrayElemTypeNameInfo, data))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteKnownValueClass(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), bool, 3usize>("WriteKnownValueClass")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (memberNameInfo, typeNameInfo, data))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteObjectRef(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        i64,
                    ), quest_hook::libil2cpp::Void, 2usize>("WriteObjectRef")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nameInfo, objectId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteSerializedStreamHeader(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64, i64), quest_hook::libil2cpp::Void, 2usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (topId, headerId))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteString(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), quest_hook::libil2cpp::Void, 3usize>("WriteString")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Write_WriteObjectInfo_NameInfo_NameInfo0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (objectInfo, memberNameInfo, typeNameInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selector, context, formatterEnums, binder))?
        };
        Ok(__cordl_ret.into())
    }
