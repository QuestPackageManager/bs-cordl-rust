...
impl crate::System::Runtime::Serialization::Formatters::Binary::BinaryFormatter {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (serializationStream, handler))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (serializationStream, handler, fCheck))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Serialize_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (serializationStream, graph, headers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Serialize_Stream_Il2CppObject0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (serializationStream, graph))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_0(
    ...
    pub fn _ctor_ISurrogateSelector_StreamingContext1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selector, context))?
        };
        Ok(__cordl_ret.into())
    }
