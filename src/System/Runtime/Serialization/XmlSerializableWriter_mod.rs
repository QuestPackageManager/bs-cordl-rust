...
for crate::System::Runtime::Serialization::XmlSerializableWriter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Runtime.Serialization";
    const CLASS_NAME: &'static str = "XmlSerializableWriter";
...
#[cfg(feature = "System+Runtime+Serialization+XmlSerializableWriter")]
impl std::ops::Deref for crate::System::Runtime::Serialization::XmlSerializableWriter {
...
#[cfg(feature = "System+Runtime+Serialization+XmlSerializableWriter")]
impl crate::System::Runtime::Serialization::XmlSerializableWriter {
    pub fn BeginWrite(
        &mut self,
    ...
    pub fn EndWrite(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EndWrite")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
