...
#[cfg(feature = "System+Runtime+Serialization+XmlSerializableWriter")]
impl std::ops::DerefMut for crate::System::Runtime::Serialization::XmlSerializableWriter {
...
impl crate::System::Runtime::Serialization::XmlSerializableWriter {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("BeginWrite")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn EndWrite(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
