...
for crate::System::Runtime::Serialization::IDeserializationCallback {
    ...
    const CLASS_NAME: &'static str = "IDeserializationCallback";
...
impl crate::System::Runtime::Serialization::IDeserializationCallback {
    pub fn OnDeserialization(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::IDeserializationCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Serialization::IDeserializationCallback as
