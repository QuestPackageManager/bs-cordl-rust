#[cfg(feature = "cordl_class_System+Runtime+Serialization+OptionalFieldAttribute")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "System+Runtime+Serialization+OptionalFieldAttribute")]
impl std::ops::DerefMut for crate::System::Runtime::Serialization::OptionalFieldAttribute {
...
impl crate::System::Runtime::Serialization::OptionalFieldAttribute {
    ...
    pub fn set_VersionAdded(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_VersionAdded")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
