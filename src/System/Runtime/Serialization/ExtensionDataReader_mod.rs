...
pub struct ExtensionDataReader {
    ...
    >,
    pub nextElement: quest_hook::libil2cpp::Gc<
        crate::System::Runtime::Serialization::ElementData,
    >,
    pub readState: crate::System::Xml::ReadState,
    pub internalNodeType: crate::System::Runtime::Serialization::ExtensionDataReader_ExtensionDataNodeType,
...
impl crate::System::Runtime::Serialization::ExtensionDataReader {
    #[cfg(
        feature = "System+Runtime+Serialization+ExtensionDataReader+ExtensionDataNodeType"
    )]
    pub type ExtensionDataNodeType = crate::System::Runtime::Serialization::ExtensionDataReader_ExtensionDataNodeType;
    ...
    pub fn AddPrefix(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (prefix, ns))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MoveNext(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (dataNode))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "MoveNextInISerializable", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn MoveToAttribute_Il2CppString_Il2CppString1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, namespaceURI))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MoveToText(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (_cordl_type, dataNode, isTypedNode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn SetDataNode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (dataNode, name, ns))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetNextElement", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (node, name, ns, prefix))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Skip(
