...
impl crate::System::Runtime::Serialization::SerializationEventsCache {
    pub fn GetSerializationEventsForType(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::SerializationEventsCache as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Serialization::SerializationEventsCache as
