#[cfg(feature = "cordl_class_System+Runtime+Serialization+ObjectIDGenerator")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::ObjectIDGenerator {
    pub fn FindElement(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (obj, found))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetId(
        &mut self,
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked(self, (obj, firstTime))? };
        Ok(__cordl_ret.into())
    }
    pub fn HasId(
        &mut self,
