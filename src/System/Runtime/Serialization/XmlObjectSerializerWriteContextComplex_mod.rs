#[cfg(
    feature = "cordl_class_System+Runtime+Serialization+XmlObjectSerializerWriteContextComplex"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::XmlObjectSerializerWriteContextComplex {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InternalSerializeWithSurrogate", 6usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn _ctor_NetDataContractSerializer_Hashtable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (serializer, surrogateDataContracts))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Mode(
