...
impl crate::System::Runtime::Serialization::SerializationInfo {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddValueInternal", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, value, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Type_IFormatterConverter0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, converter))?
        };
        Ok(__cordl_ret.into())
    }
