...
impl crate::System::Runtime::Serialization::XmlFormatReaderGenerator {
    #[cfg(
        feature = "System+Runtime+Serialization+XmlFormatReaderGenerator+CriticalHelper"
    )]
    pub type CriticalHelper = crate::System::Runtime::Serialization::XmlFormatReaderGenerator_CriticalHelper;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GenerateCollectionReader", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
...
#[cfg(
    feature = "cordl_class_System+Runtime+Serialization+XmlFormatReaderGenerator+CriticalHelper"
)]
#[repr(C)]
#[derive(Debug)]
