#[cfg(feature = "cordl_class_System+Runtime+Serialization+ValueTypeFixupInfo")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Runtime::Serialization::ValueTypeFixupInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (containerID, member, parentIndex))?
        };
        Ok(__cordl_ret.into())
    }
