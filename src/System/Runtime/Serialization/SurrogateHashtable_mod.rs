...
for crate::System::Runtime::Serialization::SurrogateHashtable {
    ...
    const CLASS_NAME: &'static str = "SurrogateHashtable";
...
impl crate::System::Runtime::Serialization::SurrogateHashtable {
    pub fn KeyEquals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Runtime::Serialization::SurrogateHashtable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Runtime::Serialization::SurrogateHashtable as
                    quest_hook::libil2cpp::Type > ::class(), "KeyEquals", 2usize
                )
            });
