...
unsafe impl quest_hook::libil2cpp::Type for crate::System::CultureAwareComparer {
    ...
    const CLASS_NAME: &'static str = "CultureAwareComparer";
...
impl crate::System::CultureAwareComparer {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::CultureAwareComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::CultureAwareComparer as quest_hook::libil2cpp::Type >
    ...
    pub fn _ctor_CompareInfo_CompareOptions1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (compareInfo, options))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_CultureInfo_CompareOptions0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (culture, options))?
        };
        Ok(__cordl_ret.into())
    }
