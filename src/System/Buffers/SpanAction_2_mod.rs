...
> crate::System::Buffers::SpanAction_2<T, TArg> {
    ...
    where
        ...
        TArg: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Buffers::SpanAction_2<
            T,
            TArg,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Buffers::SpanAction_2 < T, TArg > as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (span, arg))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
