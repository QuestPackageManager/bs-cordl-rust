    ...
    crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1<T>
{
    ...
    #[cfg(feature = "System+Buffers+TlsOverPerCoreLockedStacksArrayPool_1+PerCoreLockedStacks")]
    pub type PerCoreLockedStacks =
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<T>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (minimumLength))? };
        Ok(__cordl_ret.into())
    }
    pub fn Return(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<T>>,
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("Return")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (array, clearArray))? };
        Ok(__cordl_ret.into())
    }
    ...
    crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>
{
    ...
    pub fn Trim(
        ...
        tickCount: u32,
        id: i32,
        pressure: crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_MemoryPressure<T>,
        bucketSize: i32,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tickCount, id, pressure, bucketSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryPop(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (array))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
...
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Buffers";
    ...
    crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (tickCount, id, pressure, bucketSizes))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryPop(
