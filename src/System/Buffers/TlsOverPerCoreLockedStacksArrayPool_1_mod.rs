...
> crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (array, clearArray))?
        };
        Ok(__cordl_ret.into())
    }
...
> crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (tickCount, id, pressure, bucketSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryPop(
...
#[cfg(
    feature = "cordl_class_System+Buffers+TlsOverPerCoreLockedStacksArrayPool_1+MemoryPressure"
)]
#[repr(i32)]
...
> crate::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (tickCount, id, pressure, bucketSizes))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryPop(
