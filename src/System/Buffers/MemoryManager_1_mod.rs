#[cfg(feature = "cordl_class_System+Buffers+MemoryManager_1")]
#[repr(C)]
    ...
    for crate::System::Buffers::MemoryManager_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Buffers", "MemoryManager`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Buffers::MemoryManager_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (segment))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Buffers+MemoryManager_1")]
