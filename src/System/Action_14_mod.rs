#[cfg(feature = "cordl_class_System+Action_14")]
#[repr(C)]
...
unsafe impl<
    ...
    for crate::System::Action_14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System", "Action`14")
                .unwrap()
                .make_generic::<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14)>()
                .unwrap()
                .unwrap()
        })
    }
