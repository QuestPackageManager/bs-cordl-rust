...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::XmlSyntaxException {
    ...
    const CLASS_NAME: &'static str = "XmlSyntaxException";
...
#[cfg(feature = "System+Security+XmlSyntaxException")]
impl crate::System::Security::XmlSyntaxException {
    ...
    pub fn New_i32_Il2CppString2(
        ...
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (lineNumber, message))?;
        Ok(__cordl_object.into())
    }
    pub fn _ctor_0(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::XmlSyntaxException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Security::XmlSyntaxException as
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (lineNumber))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (lineNumber, message))?
        };
        Ok(__cordl_ret.into())
    }
}
