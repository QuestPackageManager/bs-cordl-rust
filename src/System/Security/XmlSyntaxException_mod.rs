...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Security::XmlSyntaxException =>
...
impl crate::System::Security::XmlSyntaxException {
    ...
    pub fn New_i32_1(lineNumber: i32) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_i32_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke(".ctor", (lineNumber, message))?;
        Ok(__cordl_ret)
    }
}
#[cfg(feature = "System+Security+XmlSyntaxException")]
