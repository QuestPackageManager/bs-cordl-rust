...
impl crate::System::Security::AccessControl::CommonObjectSecurity {
    pub fn GetAccessRules(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::AccessControl::CommonObjectSecurity as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Security::AccessControl::CommonObjectSecurity as
                    quest_hook::libil2cpp::Type > ::class(), "GetAccessRules", 3usize
                )
            });
