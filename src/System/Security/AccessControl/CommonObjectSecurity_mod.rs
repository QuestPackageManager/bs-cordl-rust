...
#[cfg(feature = "System+Security+AccessControl+CommonObjectSecurity")]
impl std::ops::DerefMut for crate::System::Security::AccessControl::CommonObjectSecurity {
...
impl crate::System::Security::AccessControl::CommonObjectSecurity {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (isContainer))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Security+AccessControl+CommonObjectSecurity")]
