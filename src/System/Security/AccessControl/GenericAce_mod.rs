...
#[cfg(feature = "cordl_class_System+Security+AccessControl+GenericAce")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::AccessControl::GenericAce {
...
impl crate::System::Security::AccessControl::GenericAce {
    ...
    pub fn ReadInt(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (buffer, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadUShort(
        buffer: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        ...
        let __cordl_ret: u16 = unsafe { cordl_method_info.invoke_unchecked((), (buffer, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteInt(
        val: i32,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (val, buffer, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteUShort(
        val: u16,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("WriteUShort")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_AceType_AceFlags0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, flags))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_AceFlags(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Security::AccessControl::AceFlags, 0usize>(
                        "get_AceFlags",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Security::AccessControl::AceFlags =
    ...
    pub fn get_AceType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Security::AccessControl::AceType, 0usize>(
                        "get_AceType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_AuditFlags(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Security::AccessControl::AuditFlags> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Security::AccessControl::AuditFlags, 0usize>(
                        "get_AuditFlags",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Security::AccessControl::AuditFlags =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_InheritanceFlags(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Security::AccessControl::InheritanceFlags>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::System::Security::AccessControl::InheritanceFlags =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_PropagationFlags(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Security::AccessControl::PropagationFlags>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::System::Security::AccessControl::PropagationFlags =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn op_Equality(
        left: quest_hook::libil2cpp::Gc<crate::System::Security::AccessControl::GenericAce>,
        right: quest_hook::libil2cpp::Gc<crate::System::Security::AccessControl::GenericAce>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
...
#[cfg(feature = "cordl_class_System+Security+AccessControl+GenericAce")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::AccessControl::GenericAce {
