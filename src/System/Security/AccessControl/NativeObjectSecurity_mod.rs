...
#[cfg(feature = "System+Security+AccessControl+NativeObjectSecurity")]
impl std::ops::DerefMut for crate::System::Security::AccessControl::NativeObjectSecurity {
...
impl crate::System::Security::AccessControl::NativeObjectSecurity {
    #[cfg(feature = "System+Security+AccessControl+NativeObjectSecurity+ExceptionFromErrorCode")]
    pub type ExceptionFromErrorCode =
        crate::System::Security::AccessControl::NativeObjectSecurity_ExceptionFromErrorCode;
    ...
    pub fn DefaultExceptionFromErrorCode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Exception> =
            unsafe { cordl_method_info.invoke_unchecked((), (errorCode, name, handle, context))? };
        Ok(__cordl_ret.into())
    }
    pub fn InternalGet(
        &mut self,
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, includeSections))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_AccessControlSections1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (isContainer, resourceType, name, includeSections))?
        };
        Ok(__cordl_ret.into())
    }
