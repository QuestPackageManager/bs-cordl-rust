...
#[cfg(feature = "cordl_class_System+Security+AccessControl+AceType")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::AccessControl::AceType {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+Security+AccessControl+AceType")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Security::AccessControl::AceType {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Security+AccessControl+AceType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Security::AccessControl::AceType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Security+AccessControl+AceType")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Security::AccessControl::AceType {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Security+AccessControl+AceType")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Security::AccessControl::AceType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
