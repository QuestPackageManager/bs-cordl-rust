...
impl crate::System::Security::AccessControl::QualifiedAce {
    ...
    pub fn SetOpaque(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (opaque))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AceType_AceFlags_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, flags, opaque))?
        };
        Ok(__cordl_ret.into())
    }
