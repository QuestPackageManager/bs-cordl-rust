...
#[cfg(feature = "System+Security+NamedPermissionSet")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::NamedPermissionSet {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security";
    const CLASS_NAME: &'static str = "NamedPermissionSet";
...
impl crate::System::Security::NamedPermissionSet {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::NamedPermissionSet as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Security::NamedPermissionSet as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::NamedPermissionSet as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Security::NamedPermissionSet as
                    quest_hook::libil2cpp::Type > ::class(), "ToXml", 0usize
                )
            });
    ...
    pub fn _ctor_Il2CppString_PermissionState1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (name, state))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Name(
