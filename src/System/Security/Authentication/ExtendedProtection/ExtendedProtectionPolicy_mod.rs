    ...
    for crate::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy
{
    ...
    const CLASS_NAME: &'static str = "ExtendedProtectionPolicy";
...
#[cfg(feature = "System+Security+Authentication+ExtendedProtection+ExtendedProtectionPolicy")]
impl std::ops::Deref
    for crate::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy
{
...
impl crate::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy {
    ...
    pub fn _ctor_PolicyEnforcement0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (policyEnforcement))? };
        Ok(__cordl_ret.into())
    }
