...
impl std::ops::Deref for crate::System::Security::Principal::WindowsImpersonationContext {
...
#[cfg(feature = "System+Security+Principal+WindowsImpersonationContext")]
impl std::ops::DerefMut for crate::System::Security::Principal::WindowsImpersonationContext {
...
impl crate::System::Security::Principal::WindowsImpersonationContext {
    pub fn CloseToken(token: crate::System::IntPtr) -> quest_hook::libil2cpp::Result<bool> {
    ...
    pub fn SetCurrentToken(token: crate::System::IntPtr) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::System::IntPtr), bool, 1usize>("SetCurrentToken")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
