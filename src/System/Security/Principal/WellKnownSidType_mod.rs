...
#[cfg(feature = "cordl_class_System+Security+Principal+WellKnownSidType")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Principal::WellKnownSidType {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+Security+Principal+WellKnownSidType")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Security::Principal::WellKnownSidType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
