...
#[cfg(feature = "cordl_class_System+Security+Principal+IIdentity")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Principal::IIdentity {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security.Principal";
    const CLASS_NAME: &'static str = "IIdentity";
...
#[cfg(feature = "cordl_class_System+Security+Principal+IIdentity")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Principal::IIdentity {
