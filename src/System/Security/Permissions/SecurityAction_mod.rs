...
#[cfg(feature = "cordl_class_System+Security+Permissions+SecurityAction")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Permissions::SecurityAction {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+Security+Permissions+SecurityAction")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Security::Permissions::SecurityAction {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
