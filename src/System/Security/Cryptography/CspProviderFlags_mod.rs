#[cfg(feature = "cordl_class_System+Security+Cryptography+CspProviderFlags")]
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::System::Security::Cryptography::CspProviderFlags
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "CspProviderFlags";
