...
impl crate::System::Security::Cryptography::TripleDESCryptoServiceProvider {
    pub fn CreateDecryptor(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::TripleDESCryptoServiceProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::System::Security::Cryptography::TripleDESCryptoServiceProvider as
