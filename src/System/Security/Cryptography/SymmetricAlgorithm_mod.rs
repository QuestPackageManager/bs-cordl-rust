...
impl crate::System::Security::Cryptography::SymmetricAlgorithm {
    ...
    pub fn ValidKeySize(&mut self, bitLength: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (bitLength))? };
        Ok(__cordl_ret.into())
    }
