#[cfg(feature = "cordl_class_System+Security+Cryptography+SHA512Managed")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+SHA512Managed")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::SHA512Managed {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "SHA512Managed";
...
impl crate::System::Security::Cryptography::SHA512Managed {
    ...
    pub fn HashCore(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rgb, ibStart, cbSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn HashFinal(
        &mut self,
    ...
    pub fn RotateRight(x: u64, n: i32) -> quest_hook::libil2cpp::Result<u64> {
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (x, n))? };
        Ok(__cordl_ret.into())
    }
    pub fn SHA512Expand(
    ...
    pub fn SHATransform(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), quest_hook::libil2cpp::Void, 3usize>("SHATransform")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (expandedBuffer, state, block))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _HashData(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("_HashData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (partIn, ibStart, cbSize))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+SHA512Managed")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Cryptography::SHA512Managed {
