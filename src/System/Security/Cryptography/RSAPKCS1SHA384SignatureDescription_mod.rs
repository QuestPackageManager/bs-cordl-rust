#[cfg(feature = "cordl_class_System+Security+Cryptography+RSAPKCS1SHA384SignatureDescription")]
#[repr(C)]
    ...
    for crate::System::Security::Cryptography::RSAPKCS1SHA384SignatureDescription
{
    ...
    const CLASS_NAME: &'static str = "RSAPKCS1SHA384SignatureDescription";
...
impl std::ops::Deref for crate::System::Security::Cryptography::RSAPKCS1SHA384SignatureDescription {
