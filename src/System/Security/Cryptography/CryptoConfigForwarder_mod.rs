...
for crate::System::Security::Cryptography::CryptoConfigForwarder {
    ...
    const CLASS_NAME: &'static str = "CryptoConfigForwarder";
...
impl crate::System::Security::Cryptography::CryptoConfigForwarder {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::CryptoConfigForwarder as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Security::Cryptography::CryptoConfigForwarder as
