...
impl std::ops::Deref for crate::System::Security::Cryptography::RNGCryptoServiceProvider {
...
#[cfg(feature = "System+Security+Cryptography+RNGCryptoServiceProvider")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::RNGCryptoServiceProvider {
...
impl crate::System::Security::Cryptography::RNGCryptoServiceProvider {
    pub fn Check(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn RngGetBytes(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                    ), crate::System::IntPtr, 3usize>("RngGetBytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (handle, data, data_length))? };
        Ok(__cordl_ret.into())
    }
    pub fn RngInitialize(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        crate::System::IntPtr,
                    ), crate::System::IntPtr, 2usize>("RngInitialize")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (seed, seed_length))? };
        Ok(__cordl_ret.into())
    }
