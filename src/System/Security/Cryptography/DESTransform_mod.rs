#[cfg(feature = "cordl_class_System+Security+Cryptography+DESTransform")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+DESTransform")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::DESTransform {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "DESTransform";
...
impl crate::System::Security::Cryptography::DESTransform {
    pub fn BSwap(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (byteBuff))? };
        Ok(__cordl_ret.into())
    }
    pub fn CipherFunct(&mut self, r: u32, n: i32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked(self, (r, n))? };
        Ok(__cordl_ret.into())
    }
    pub fn ECB(
        &mut self,
    ...
    pub fn Permutation(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 4usize>("Permutation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (input, output, permTab, preSwap))? };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessBlock(
        &mut self,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (symmAlgo, encryption, key, iv))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Security+Cryptography+DESTransform")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Cryptography::DESTransform {
