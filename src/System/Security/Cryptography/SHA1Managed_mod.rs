...
pub struct SHA1Managed {
    ...
    pub _count: i64,
    pub _stateSHA1: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u32>>,
    pub _expandedBuffer: quest_hook::libil2cpp::Gc<
...
for crate::System::Security::Cryptography::SHA1Managed {
    ...
    const CLASS_NAME: &'static str = "SHA1Managed";
...
impl crate::System::Security::Cryptography::SHA1Managed {
    pub fn HashCore(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::SHA1Managed as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Security::Cryptography::SHA1Managed as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::SHA1Managed as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Security::Cryptography::SHA1Managed as
                    quest_hook::libil2cpp::Type > ::class(), "SHAExpand", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
