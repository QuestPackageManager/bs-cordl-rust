...
impl crate::System::Security::Cryptography::DESCryptoServiceProvider {
    pub fn CreateDecryptor(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::DESCryptoServiceProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Security::Cryptography::DESCryptoServiceProvider as
