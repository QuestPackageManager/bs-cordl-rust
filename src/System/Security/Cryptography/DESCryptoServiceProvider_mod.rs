#[cfg(feature = "cordl_class_System+Security+Cryptography+DESCryptoServiceProvider")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Security::Cryptography::DESCryptoServiceProvider
{
    ...
    const CLASS_NAME: &'static str = "DESCryptoServiceProvider";
...
impl std::ops::Deref for crate::System::Security::Cryptography::DESCryptoServiceProvider {
...
#[cfg(feature = "System+Security+Cryptography+DESCryptoServiceProvider")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::DESCryptoServiceProvider {
