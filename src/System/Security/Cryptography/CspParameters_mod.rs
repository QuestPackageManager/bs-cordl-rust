#[cfg(feature = "cordl_class_System+Security+Cryptography+CspParameters")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+CspParameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::CspParameters {
...
impl crate::System::Security::Cryptography::CspParameters {
    ...
    pub fn New_i32_Il2CppString_Il2CppString2(
        dwTypeIn: i32,
        strProviderNameIn: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        strContainerNameIn: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (dwTypeIn))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Il2CppString_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (dwTypeIn, strProviderNameIn, strContainerNameIn))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Il2CppString_Il2CppString_CspProviderFlags3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (providerType, providerName, keyContainerName, flags))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Flags(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Security::Cryptography::CspProviderFlags>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::System::Security::Cryptography::CspProviderFlags =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_Flags(
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+CspParameters")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Cryptography::CspParameters {
