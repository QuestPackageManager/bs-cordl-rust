#[cfg(feature = "cordl_class_System+Security+Cryptography+AsymmetricSignatureDeformatter")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Security::Cryptography::AsymmetricSignatureDeformatter
{
    ...
    const CLASS_NAME: &'static str = "AsymmetricSignatureDeformatter";
...
impl std::ops::Deref for crate::System::Security::Cryptography::AsymmetricSignatureDeformatter {
...
#[cfg(feature = "System+Security+Cryptography+AsymmetricSignatureDeformatter")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::AsymmetricSignatureDeformatter {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetHashAlgorithm", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (strName))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetKey(
        &mut self,
        key: quest_hook::libil2cpp::Gc<crate::System::Security::Cryptography::AsymmetricAlgorithm>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("SetKey")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
