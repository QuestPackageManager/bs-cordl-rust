#[cfg(feature = "cordl_class_System+Security+Cryptography+RSAPKCS1SHA1SignatureDescription")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Security::Cryptography::RSAPKCS1SHA1SignatureDescription {
