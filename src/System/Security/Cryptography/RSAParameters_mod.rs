#[cfg(feature = "cordl_class_System+Security+Cryptography+RSAParameters")]
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+RSAParameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::RSAParameters {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "RSAParameters";
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+RSAParameters")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Security::Cryptography::RSAParameters {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
