#[cfg(feature = "cordl_class_System+Security+Cryptography+RSAPKCS1SignatureFormatter")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Security::Cryptography::RSAPKCS1SignatureFormatter
{
    ...
    const CLASS_NAME: &'static str = "RSAPKCS1SignatureFormatter";
...
impl std::ops::Deref for crate::System::Security::Cryptography::RSAPKCS1SignatureFormatter {
...
#[cfg(feature = "System+Security+Cryptography+RSAPKCS1SignatureFormatter")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::RSAPKCS1SignatureFormatter {
