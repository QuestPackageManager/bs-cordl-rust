...
#[cfg(feature = "cordl_class_System+Security+Cryptography+RijndaelManaged")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::RijndaelManaged {
...
impl crate::System::Security::Cryptography::RijndaelManaged {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (rgbKey, mode, rgbIV, feedbackSize, encryptMode))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+RijndaelManaged")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Cryptography::RijndaelManaged {
