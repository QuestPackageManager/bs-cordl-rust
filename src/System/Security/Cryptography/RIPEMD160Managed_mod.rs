...
impl crate::System::Security::Cryptography::RIPEMD160Managed {
    ...
    pub fn HashCore(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rgb, ibStart, cbSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HashFinal(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "I",
                            3usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "J",
                            3usize
                        )
                    })
            });
    ...
    pub fn MDTransform(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (blockDWords, state, block))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _HashData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (partIn, ibStart, cbSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
