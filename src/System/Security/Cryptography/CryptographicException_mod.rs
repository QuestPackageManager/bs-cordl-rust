#[cfg(feature = "cordl_class_System+Security+Cryptography+CryptographicException")]
#[repr(C)]
...
#[cfg(feature = "System+Security+Cryptography+CryptographicException")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::CryptographicException {
...
impl crate::System::Security::Cryptography::CryptographicException {
    ...
    pub fn _ctor_Il2CppString_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (format, insert))? };
        Ok(__cordl_ret.into())
    }
