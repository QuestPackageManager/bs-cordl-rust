#[cfg(feature = "cordl_class_System+Security+Cryptography+CryptoStream")]
#[repr(C)]
...
pub struct CryptoStream {
    ...
    pub _lazyAsyncActiveSemaphore:
        quest_hook::libil2cpp::Gc<crate::System::Threading::SemaphoreSlim>,
    pub _leaveOpen: bool,
}
#[cfg(feature = "cordl_class_System+Security+Cryptography+CryptoStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::CryptoStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "CryptoStream";
...
impl crate::System::Security::Cryptography::CryptoStream {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("CheckReadArguments")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn FlushFinalBlock(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FlushFinalBlock")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InitializeBuffer(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InitializeBuffer")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadAsyncCore", 5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task_1<i32>> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (buffer, offset, count, cancellationToken, useAsync))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Stream_ICryptoTransform_CryptoStreamMode0(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::System::Security::Cryptography::ICryptoTransform,
                        >,
                        crate::System::Security::Cryptography::CryptoStreamMode,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (stream, transform, mode))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (stream, transform, mode, leaveOpen))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_AsyncActiveSemaphore", 0usize
                        )
                    })
            });
    ...
    pub fn get_HasFlushedFinalBlock(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_HasFlushedFinalBlock")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+CryptoStream")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Cryptography::CryptoStream {
...
#[cfg(feature = "System+Security+Cryptography+CryptoStream")]
impl AsRef<crate::System::IDisposable> for crate::System::Security::Cryptography::CryptoStream {
    fn as_ref(&self) -> &crate::System::IDisposable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "System+Security+Cryptography+CryptoStream")]
impl AsMut<crate::System::IDisposable> for crate::System::Security::Cryptography::CryptoStream {
