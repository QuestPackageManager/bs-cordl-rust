#[cfg(feature = "cordl_class_System+Security+Cryptography+Rijndael")]
#[repr(C)]
#[derive(Debug)]
pub struct Rijndael {
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+Rijndael")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Security::Cryptography::Rijndael {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "Rijndael";
...
#[cfg(feature = "cordl_class_System+Security+Cryptography+Rijndael")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Security::Cryptography::Rijndael {
