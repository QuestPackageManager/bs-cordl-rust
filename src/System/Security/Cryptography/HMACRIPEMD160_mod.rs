...
for crate::System::Security::Cryptography::HMACRIPEMD160 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Security.Cryptography";
    const CLASS_NAME: &'static str = "HMACRIPEMD160";
...
#[cfg(feature = "System+Security+Cryptography+HMACRIPEMD160")]
impl crate::System::Security::Cryptography::HMACRIPEMD160 {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::HMACRIPEMD160 as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Security::Cryptography::HMACRIPEMD160 as
