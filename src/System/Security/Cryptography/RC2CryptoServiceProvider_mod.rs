...
impl crate::System::Security::Cryptography::RC2CryptoServiceProvider {
    pub fn CreateDecryptor(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::RC2CryptoServiceProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Security::Cryptography::RC2CryptoServiceProvider as
    ...
    pub fn get_EffectiveKeySize(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::RC2CryptoServiceProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_EffectiveKeySize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Security::Cryptography::RC2CryptoServiceProvider as
                    quest_hook::libil2cpp::Type > ::class(), "get_EffectiveKeySize",
                    0usize
                )
            });
