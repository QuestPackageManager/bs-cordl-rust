...
for crate::System::Security::Cryptography::KeyedHashAlgorithm {
    ...
    const CLASS_NAME: &'static str = "KeyedHashAlgorithm";
...
impl crate::System::Security::Cryptography::KeyedHashAlgorithm {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::KeyedHashAlgorithm as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Security::Cryptography::KeyedHashAlgorithm as
