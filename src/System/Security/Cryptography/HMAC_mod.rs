...
impl crate::System::Security::Cryptography::HMAC {
    ...
    pub fn get_BlockSizeValue(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = __cordl_object.invoke("get_BlockSizeValue", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn get_Key(
        &mut self,
    ...
    pub fn set_BlockSizeValue(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("set_BlockSizeValue", (value))?;
        Ok(__cordl_ret.into())
    }
    pub fn set_Key(
        &mut self,
