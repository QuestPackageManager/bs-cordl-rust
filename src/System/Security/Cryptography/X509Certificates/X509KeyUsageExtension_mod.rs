#[cfg(feature = "cordl_class_System+Security+Cryptography+X509Certificates+X509KeyUsageExtension")]
#[repr(C)]
...
impl crate::System::Security::Cryptography::X509Certificates::X509KeyUsageExtension {
    ...
    pub fn _ctor_AsnEncodedData__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encodedKeyUsage, critical))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X509KeyUsageFlags__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyUsages, critical))? };
        Ok(__cordl_ret.into())
    }
