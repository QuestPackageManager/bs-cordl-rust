...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509Certificate2ImplMono")]
impl std::ops::Deref
    for crate::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono
{
...
impl crate::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono {
    ...
    pub fn Verify(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (thisCertificate))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_SafePasswordHandle_X509KeyStorageFlags2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rawData, password, keyStorageFlags))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Security::Cryptography::AsymmetricAlgorithm,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_PrivateKey")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
