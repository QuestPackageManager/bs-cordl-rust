...
impl std::ops::Deref for crate::System::Security::Cryptography::X509Certificates::X509Chain {
...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509Chain")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::X509Certificates::X509Chain {
...
impl crate::System::Security::Cryptography::X509Certificates::X509Chain {
    ...
    pub fn _ctor_IntPtr3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (chainContext))? };
        Ok(__cordl_ret.into())
    }
