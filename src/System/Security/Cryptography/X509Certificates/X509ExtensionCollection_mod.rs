...
impl crate::System::Security::Cryptography::X509Certificates::X509ExtensionCollection {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Security::Cryptography::X509Certificates::X509ExtensionCollection as quest_hook::libil2cpp::Type>::class()
            .find_method::<
        ...
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (extension))? };
        Ok(__cordl_ret.into())
    }
