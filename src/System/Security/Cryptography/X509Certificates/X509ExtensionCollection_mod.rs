#[cfg(
    feature = "cordl_class_System+Security+Cryptography+X509Certificates+X509ExtensionCollection"
)]
#[repr(C)]
...
impl crate::System::Security::Cryptography::X509Certificates::X509ExtensionCollection {
    pub fn Add(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (extension))? };
        Ok(__cordl_ret.into())
    }
