#[cfg(feature = "cordl_class_System+Security+Cryptography+X509Certificates+X500DistinguishedName")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Security::Cryptography::X509Certificates::X500DistinguishedName {
    pub fn AreEqual(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (name1, name2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Canonize(
    ...
    pub fn DecodeRawData(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (flag))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        encodedDistinguishedName: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encodedDistinguishedName))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Name(
        &mut self,
