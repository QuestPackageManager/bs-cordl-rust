...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509CertificateImplCollection")]
impl std::ops::Deref
    for crate::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection
{
...
impl crate::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection {
    pub fn Add(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_impl, takeOwnership))? };
        Ok(__cordl_ret.into())
    }
    pub fn Clone(
        &mut self,
