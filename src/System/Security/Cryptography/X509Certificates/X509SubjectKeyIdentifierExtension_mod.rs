...
impl crate::System::Security::Cryptography::X509Certificates::X509SubjectKeyIdentifierExtension {
    ...
    pub fn _ctor_AsnEncodedData__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (encodedSubjectKeyIdentifier, critical))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (subjectKeyIdentifier, critical))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_PublicKey_X509SubjectKeyIdentifierHashAlgorithm__cordl_bool5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, algorithm, critical))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PublicKey__cordl_bool4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, critical))?
        };
        Ok(__cordl_ret.into())
    }
