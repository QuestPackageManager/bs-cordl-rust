...
impl std::ops::Deref for crate::System::Security::Cryptography::X509Certificates::X509Extension {
...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509Extension")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::X509Certificates::X509Extension {
...
impl crate::System::Security::Cryptography::X509Certificates::X509Extension {
    ...
    pub fn _ctor_Il2CppString_Il2CppArray__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, rawData, critical))? };
        Ok(__cordl_ret.into())
    }
