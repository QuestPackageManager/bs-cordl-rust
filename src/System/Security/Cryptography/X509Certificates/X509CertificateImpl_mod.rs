#[cfg(feature = "cordl_class_System+Security+Cryptography+X509Certificates+X509CertificateImpl")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Security::Cryptography::X509Certificates::X509CertificateImpl {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Security::Cryptography::DSA> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ThrowIfContextInvalid(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ThrowIfContextInvalid")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
