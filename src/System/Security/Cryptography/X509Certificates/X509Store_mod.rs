...
impl std::ops::Deref for crate::System::Security::Cryptography::X509Certificates::X509Store {
...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509Store")]
impl std::ops::DerefMut for crate::System::Security::Cryptography::X509Certificates::X509Store {
...
impl crate::System::Security::Cryptography::X509Certificates::X509Store {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (storeName, storeLocation))? };
        Ok(__cordl_ret.into())
    }
