...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509Certificate2Collection")]
impl std::ops::Deref
    for crate::System::Security::Cryptography::X509Certificates::X509Certificate2Collection
{
    type Target =
...
impl crate::System::Security::Cryptography::X509Certificates::X509Certificate2Collection {
    pub fn Add(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (certificate))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddRange(
        &mut self,
    ...
    pub fn Contains(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (certificate))? };
        Ok(__cordl_ret.into())
    }
    pub fn Find(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Security::Cryptography::X509Certificates::X509Certificate2Collection,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (findType, findValue, validOnly))? };
        Ok(__cordl_ret.into())
    }
