...
impl crate::System::Security::Cryptography::X509Certificates::X509Certificate {
    ...
    pub fn ImportHandle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_impl))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ValidateKeyStorageFlags(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (keyStorageFlags))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_0(
    ...
    pub fn _ctor_Il2CppString_Il2CppString_X509KeyStorageFlags4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (fileName, password, keyStorageFlags))?
        };
        Ok(__cordl_ret.into())
    }
