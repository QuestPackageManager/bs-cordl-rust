...
#[cfg(feature = "System+Security+Cryptography+X509Certificates+X509EnhancedKeyUsageExtension")]
impl std::ops::Deref
    for crate::System::Security::Cryptography::X509Certificates::X509EnhancedKeyUsageExtension
{
...
impl crate::System::Security::Cryptography::X509Certificates::X509EnhancedKeyUsageExtension {
    ...
    pub fn _ctor_AsnEncodedData__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (encodedEnhancedKeyUsages, critical))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_OidCollection__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (enhancedKeyUsages, critical))? };
        Ok(__cordl_ret.into())
    }
