#[cfg(feature = "cordl_class_System+GC")]
#[repr(C)]
...
impl crate::System::GC {
    ...
    pub fn CollectionCount(generation: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (generation))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetMemoryInfo(
        ...
        lastRecordedFragmentation: quest_hook::libil2cpp::ByRefMut<crate::System::UIntPtr>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<crate::System::UIntPtr>,
                    ), quest_hook::libil2cpp::Void, 5usize>("GetMemoryInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InternalCollect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (generation))? };
        Ok(__cordl_ret.into())
    }
    pub fn KeepAlive(
    ...
    pub fn get_ephemeron_tombstone(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_ephemeron_tombstone", 0usize
                        )
                    })
            });
