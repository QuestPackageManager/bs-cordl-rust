...
impl crate::System::AggregateException {
    ...
    pub fn _ctor_IEnumerable_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (innerExceptions))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IEnumerable_1_6(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (innerExceptionInfos))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_IEnumerable_1_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, innerExceptions))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_IEnumerable_1_7(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, innerExceptionInfos))? };
        Ok(__cordl_ret.into())
    }
