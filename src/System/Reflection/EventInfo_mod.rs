...
impl crate::System::Reflection::EventInfo {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Reflection::EventInfo,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (event_handle, type_handle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn op_Equality(
...
impl crate::System::Reflection::EventInfo_AddEventAdapter {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_this, dele))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
