...
impl crate::System::Reflection::MethodBase {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (obj, parameters))? };
        Ok(__cordl_ret.into())
    }
