...
impl crate::System::Reflection::TypeDelegator {
    ...
    pub fn GetInterface(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, ignoreCase))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetInterfaceMap(
        ...
        let __cordl_ret: crate::System::Reflection::InterfaceMapping = unsafe {
            cordl_method_info.invoke_unchecked(self, (interfaceType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, _cordl_type, bindingAttr))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetMembers(
    ...
    pub fn GetNestedType(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, bindingAttr))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (delegatingType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Assembly(
