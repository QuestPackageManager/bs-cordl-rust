...
impl crate::System::Reflection::SignatureArrayType {
    pub fn GetArrayRank(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::SignatureArrayType as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("GetArrayRank")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Reflection::SignatureArrayType as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (elementType, rank, isMultiDim))?
        };
        Ok(__cordl_ret.into())
    }
