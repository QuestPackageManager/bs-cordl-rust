...
impl crate::System::Reflection::IReflectableType {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::IReflectableType as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Reflection::TypeInfo>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Reflection::IReflectableType as
                    quest_hook::libil2cpp::Type > ::class(), "GetTypeInfo", 0usize
                )
            });
