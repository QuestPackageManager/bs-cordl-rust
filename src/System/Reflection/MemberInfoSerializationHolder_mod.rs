...
pub struct MemberInfoSerializationHolder {
    ...
    pub m_info: quest_hook::libil2cpp::Gc<crate::System::Runtime::Serialization::SerializationInfo>,
}
#[cfg(feature = "cordl_class_System+Reflection+MemberInfoSerializationHolder")]
...
impl crate::System::Reflection::MemberInfoSerializationHolder {
    ...
    pub fn GetSerializationInfo_MemberTypes0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (info, name, reflectedClass, signature, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
