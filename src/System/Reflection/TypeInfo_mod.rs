...
impl crate::System::Reflection::TypeInfo {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::TypeInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Reflection::TypeInfo>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Reflection::TypeInfo as quest_hook::libil2cpp::Type >
                    ::class(), "System.Reflection.IReflectableType.GetTypeInfo", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::TypeInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Reflection::TypeInfo as quest_hook::libil2cpp::Type >
                    ::class(), "get_ImplementedInterfaces", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::IEnumerable_1<
