#[cfg(feature = "System+Reflection+SignaturePointerType")]
#[repr(C)]
#[derive(Debug)]
...
for crate::System::Reflection::SignaturePointerType {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Reflection";
    const CLASS_NAME: &'static str = "SignaturePointerType";
...
#[cfg(feature = "System+Reflection+SignaturePointerType")]
impl std::ops::Deref for crate::System::Reflection::SignaturePointerType {
...
#[cfg(feature = "System+Reflection+SignaturePointerType")]
impl std::ops::DerefMut for crate::System::Reflection::SignaturePointerType {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Reflection+SignaturePointerType")]
impl crate::System::Reflection::SignaturePointerType {
    pub fn GetArrayRank(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::SignaturePointerType as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("GetArrayRank")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Reflection::SignaturePointerType as
                    quest_hook::libil2cpp::Type > ::class(), "GetArrayRank", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::SignaturePointerType as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Reflection::SignaturePointerType as
                    quest_hook::libil2cpp::Type > ::class(), "get_IsVariableBoundArray",
                    0usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, ())? };
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Reflection::SignaturePointerType as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Reflection::SignaturePointerType as
                    quest_hook::libil2cpp::Type > ::class(), "get_Suffix", 0usize
                )
            });
