...
impl crate::System::Math {
    pub fn Abs_Decimal2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Math as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Math as quest_hook::libil2cpp::Type > ::class(),
                    "Abs", 1usize
                )
            });
