...
impl crate::System::Math {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Ceiling",
                            1usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Cosh",
                            1usize
                        )
                    })
            });
    ...
    pub fn Log_f64_0(a: f64, newBase: f64) -> quest_hook::libil2cpp::Result<f64> {
        ...
        let __cordl_ret: f64 = unsafe {
            cordl_method_info.invoke_unchecked((), (a, newBase))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "ModF",
                            2usize
                        )
                    })
            });
        let __cordl_ret: f64 = unsafe {
            cordl_method_info.invoke_unchecked((), (x, intptr))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Round_f64_MidpointRounding3(
        ...
        let __cordl_ret: f64 = unsafe {
            cordl_method_info.invoke_unchecked((), (value, mode))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Round_f64_i32_MidpointRounding4(
        ...
        let __cordl_ret: f64 = unsafe {
            cordl_method_info.invoke_unchecked((), (value, digits, mode))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Sinh",
                            1usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Tanh",
                            1usize
                        )
                    })
            });
