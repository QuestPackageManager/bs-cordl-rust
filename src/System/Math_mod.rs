#[cfg(feature = "cordl_class_System+Math")]
#[repr(C)]
#[derive(Debug)]
pub struct Math {
...
impl crate::System::Math {
    ...
    pub fn Atan2(y: f64, x: f64) -> quest_hook::libil2cpp::Result<f64> {
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (y, x))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "DivRem",
                            3usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (a, b, result))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Log_f64_0(a: f64, newBase: f64) -> quest_hook::libil2cpp::Result<f64> {
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (a, newBase))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Max_Decimal_Decimal1(
        ...
        let __cordl_ret: crate::System::Decimal =
            unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_f32_f32_7(val1: f32, val2: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_f64_f64_2(val1: f64, val2: f64) -> quest_hook::libil2cpp::Result<f64> {
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_i16_i16_3(val1: i16, val2: i16) -> quest_hook::libil2cpp::Result<i16> {
        ...
        let __cordl_ret: i16 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_i32_i32_4(val1: i32, val2: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_i64_i64_5(val1: i64, val2: i64) -> quest_hook::libil2cpp::Result<i64> {
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_i8_i8_6(val1: i8, val2: i8) -> quest_hook::libil2cpp::Result<i8> {
        ...
        let __cordl_ret: i8 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_u16_u16_8(val1: u16, val2: u16) -> quest_hook::libil2cpp::Result<u16> {
        ...
        let __cordl_ret: u16 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_u32_u32_9(val1: u32, val2: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_u64_u64_10(val1: u64, val2: u64) -> quest_hook::libil2cpp::Result<u64> {
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Max_u8_u8_0(val1: u8, val2: u8) -> quest_hook::libil2cpp::Result<u8> {
        ...
        let __cordl_ret: u8 = unsafe { cordl_method_info.invoke_unchecked((), (val1, val2))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ModF(
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (x, intptr))? };
        Ok(__cordl_ret.into())
    }
    pub fn Pow(x: f64, y: f64) -> quest_hook::libil2cpp::Result<f64> {
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (x, y))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Round_f64_MidpointRounding3(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f64, crate::System::MidpointRounding), f64, 2usize>(
                        "Round",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (value, mode))? };
        Ok(__cordl_ret.into())
    }
    pub fn Round_f64_i32_2(value: f64, digits: i32) -> quest_hook::libil2cpp::Result<f64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (value, digits))? };
        Ok(__cordl_ret.into())
    }
    pub fn Round_f64_i32_MidpointRounding4(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f64, i32, crate::System::MidpointRounding), f64, 3usize>(
                        "Round",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: f64 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, digits, mode))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ThrowAbsOverflow() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(T, T), quest_hook::libil2cpp::Void, 2usize>(
