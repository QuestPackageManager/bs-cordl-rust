...
impl crate::System::Net::ChunkedInputStream {
    ...
    pub fn OnRead(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (base_ares))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Read(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (context, stream, buffer, offset, length))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::System::Net::ChunkedInputStream_ReadBufferState {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, offset, count, ares))?
        };
        Ok(__cordl_ret.into())
    }
}
