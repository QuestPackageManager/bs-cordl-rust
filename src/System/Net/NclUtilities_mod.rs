#[cfg(feature = "cordl_class_System+Net+NclUtilities")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Net::NclUtilities {
    ...
    pub fn IsAddressLocal(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (ipAddress))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsFatal(
