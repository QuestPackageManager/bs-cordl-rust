...
impl crate::System::Net::Sockets::SocketException {
    ...
    pub fn _ctor_SocketError3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (socketError))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (errorCode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (error, message))?
        };
        Ok(__cordl_ret.into())
    }
