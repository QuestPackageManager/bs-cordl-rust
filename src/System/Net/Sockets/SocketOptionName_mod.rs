...
#[cfg(feature = "cordl_class_System+Net+Sockets+SocketOptionName")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::Sockets::SocketOptionName {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+Net+Sockets+SocketOptionName")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Net::Sockets::SocketOptionName {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Net+Sockets+SocketOptionName")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Net::Sockets::SocketOptionName {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Net+Sockets+SocketOptionName")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Net::Sockets::SocketOptionName {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Net+Sockets+SocketOptionName")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Net::Sockets::SocketOptionName {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
