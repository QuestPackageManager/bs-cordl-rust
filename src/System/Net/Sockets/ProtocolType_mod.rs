#[cfg(feature = "cordl_class_System+Net+Sockets+ProtocolType")]
...
#[cfg(feature = "cordl_class_System+Net+Sockets+ProtocolType")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Net::Sockets::ProtocolType {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Net+Sockets+ProtocolType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Net::Sockets::ProtocolType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Net+Sockets+ProtocolType")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Net::Sockets::ProtocolType {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
