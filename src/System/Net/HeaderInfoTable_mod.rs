#[cfg(feature = "cordl_class_System+Net+HeaderInfoTable")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Net::HeaderInfoTable {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::Net::HeaderInfo>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Net::HeaderInfo> =
