...
impl crate::System::Net::FtpDataStream {
    ...
    pub fn EndRead(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (ar))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndWrite(
        &mut self,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (networkStream, request, writeOnly))?
        };
        Ok(__cordl_ret.into())
    }
