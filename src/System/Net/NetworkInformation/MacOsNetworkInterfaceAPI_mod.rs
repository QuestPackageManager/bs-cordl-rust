    ...
    for crate::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI
{
    ...
    const CLASS_NAME: &'static str = "MacOsNetworkInterfaceAPI";
...
impl std::ops::Deref for crate::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI {
...
#[cfg(feature = "System+Net+NetworkInformation+MacOsNetworkInterfaceAPI")]
impl std::ops::DerefMut for crate::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI {
...
impl crate::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI {
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (AF_INET6))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+MacOsNetworkInterfaceAPI")]
