...
impl crate::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI {
    pub fn GetAllNetworkInterfaces(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::NetworkInformation::MacOsNetworkInterfaceAPI as
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (AF_INET6))?
        };
        Ok(__cordl_ret.into())
    }
}
