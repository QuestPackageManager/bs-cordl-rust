...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+ifaddrs")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::NetworkInformation::ifaddrs {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Net.NetworkInformation";
    const CLASS_NAME: &'static str = "ifaddrs";
...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+ifaddrs")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Net::NetworkInformation::ifaddrs {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+ifaddrs")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Net::NetworkInformation::ifaddrs {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+ifaddrs")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Net::NetworkInformation::ifaddrs {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+ifaddrs")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Net::NetworkInformation::ifaddrs {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
