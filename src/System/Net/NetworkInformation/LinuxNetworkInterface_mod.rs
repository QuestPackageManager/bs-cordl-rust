...
pub struct LinuxNetworkInterface {
    ...
    pub iface_operstate_path: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
#[cfg(feature = "System+Net+NetworkInformation+LinuxNetworkInterface")]
impl std::ops::DerefMut for crate::System::Net::NetworkInformation::LinuxNetworkInterface {
...
impl crate::System::Net::NetworkInformation::LinuxNetworkInterface {
    ...
    pub fn unitydroid_get_network_interface_up_state(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 2usize>("unitydroid_get_network_interface_up_state")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (ifname, is_up))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+LinuxNetworkInterface")]
