#[cfg(feature = "cordl_class_System+Net+NetworkInformation+LinuxNetworkInterfaceAPI")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Net::NetworkInformation::LinuxNetworkInterfaceAPI
{
    ...
    const CLASS_NAME: &'static str = "LinuxNetworkInterfaceAPI";
...
impl std::ops::Deref for crate::System::Net::NetworkInformation::LinuxNetworkInterfaceAPI {
...
#[cfg(feature = "System+Net+NetworkInformation+LinuxNetworkInterfaceAPI")]
impl std::ops::DerefMut for crate::System::Net::NetworkInformation::LinuxNetworkInterfaceAPI {
...
impl crate::System::Net::NetworkInformation::LinuxNetworkInterfaceAPI {
    pub fn FreeInterfaceAddresses(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (ifap))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetAllNetworkInterfaces(
        ...
        quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
                quest_hook::libil2cpp::Gc<crate::System::Net::NetworkInformation::NetworkInterface>,
            >,
        >,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            ...
                            >,
                        >,
                    >, 0usize>("GetAllNetworkInterfaces")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetInterfaceAddresses(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (ifap))? };
        Ok(__cordl_ret.into())
    }
