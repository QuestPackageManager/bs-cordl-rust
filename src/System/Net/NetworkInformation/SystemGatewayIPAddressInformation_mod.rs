#[cfg(feature = "cordl_class_System+Net+NetworkInformation+SystemGatewayIPAddressInformation")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Net::NetworkInformation::SystemGatewayIPAddressInformation {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ToGatewayIpAddressInformationCollection", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Net::NetworkInformation::GatewayIPAddressInformationCollection,
        > = unsafe { cordl_method_info.invoke_unchecked((), (addresses))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
