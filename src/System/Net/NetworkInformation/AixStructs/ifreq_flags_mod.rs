#[cfg(feature = "System+Net+NetworkInformation+AixStructs+ifreq_flags")]
#[repr(C)]
...
for crate::System::Net::NetworkInformation::AixStructs::ifreq_flags {
    ...
    const CLASS_NAME: &'static str = "ifreq_flags";
...
#[cfg(feature = "System+Net+NetworkInformation+AixStructs+ifreq_flags")]
impl crate::System::Net::NetworkInformation::AixStructs::ifreq_flags {
    #[cfg(
...
for crate::System::Net::NetworkInformation::AixStructs::ifreq_flags__ifr_name_e__FixedBuffer {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Net.NetworkInformation.AixStructs";
    const CLASS_NAME: &'static str = "ifreq_flags/<ifr_name>e__FixedBuffer";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
