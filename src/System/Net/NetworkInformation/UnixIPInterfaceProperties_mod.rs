...
impl crate::System::Net::NetworkInformation::UnixIPInterfaceProperties {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::UnixIPInterfaceProperties as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::NetworkInformation::UnixIPInterfaceProperties as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::UnixIPInterfaceProperties as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::NetworkInformation::UnixIPInterfaceProperties as
                    quest_hook::libil2cpp::Type > ::class(), "get_UnicastAddresses",
                    0usize
                )
            });
