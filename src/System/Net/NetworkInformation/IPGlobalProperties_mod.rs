...
for crate::System::Net::NetworkInformation::IPGlobalProperties {
    ...
    const CLASS_NAME: &'static str = "IPGlobalProperties";
...
impl crate::System::Net::NetworkInformation::IPGlobalProperties {
    pub fn GetIPGlobalProperties() -> quest_hook::libil2cpp::Result<
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::IPGlobalProperties as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Net::NetworkInformation::IPGlobalProperties,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::NetworkInformation::IPGlobalProperties as
                    quest_hook::libil2cpp::Type > ::class(), "GetIPGlobalProperties",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::IPGlobalProperties as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "InternalGetIPGlobalProperties", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Net::NetworkInformation::IPGlobalProperties,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::IPGlobalProperties as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::NetworkInformation::IPGlobalProperties as
                    quest_hook::libil2cpp::Type > ::class(), "get_DomainName", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
