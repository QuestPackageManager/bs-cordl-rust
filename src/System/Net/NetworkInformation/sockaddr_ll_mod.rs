...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+sockaddr_ll")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::NetworkInformation::sockaddr_ll {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_System+Net+NetworkInformation+sockaddr_ll")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Net::NetworkInformation::sockaddr_ll {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
