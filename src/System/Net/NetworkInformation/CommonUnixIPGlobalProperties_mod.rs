...
for crate::System::Net::NetworkInformation::CommonUnixIPGlobalProperties {
    ...
    const CLASS_NAME: &'static str = "CommonUnixIPGlobalProperties";
...
impl crate::System::Net::NetworkInformation::CommonUnixIPGlobalProperties {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::CommonUnixIPGlobalProperties as quest_hook::libil2cpp::Type>::class()
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::NetworkInformation::CommonUnixIPGlobalProperties as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::NetworkInformation::CommonUnixIPGlobalProperties
                    as quest_hook::libil2cpp::Type > ::class(), "getdomainname", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked((), (name, len))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "System+Net+NetworkInformation+CommonUnixIPGlobalProperties")]
