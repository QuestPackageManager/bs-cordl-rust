#[cfg(feature = "cordl_class_System+Net+NetworkInformation+GatewayIPAddressInformationCollection")]
#[repr(C)]
...
impl crate::System::Net::NetworkInformation::GatewayIPAddressInformationCollection {
    ...
    pub fn Contains(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (address))? };
        Ok(__cordl_ret.into())
    }
    pub fn CopyTo(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Net::NetworkInformation::GatewayIPAddressInformation,
                    >), quest_hook::libil2cpp::Void, 1usize>("InternalAdd")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
