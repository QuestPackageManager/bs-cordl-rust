...
#[cfg(feature = "System+Net+NetworkInformation+UnixNetworkInterface")]
impl std::ops::DerefMut for crate::System::Net::NetworkInformation::UnixNetworkInterface {
...
impl crate::System::Net::NetworkInformation::UnixNetworkInterface {
    pub fn AddAddress(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (address))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn SetLinkLayerInfo(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("SetLinkLayerInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, macAddress, _cordl_type))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
    ...
    pub fn get_NetworkInterfaceType(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Net::NetworkInformation::NetworkInterfaceType>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::System::Net::NetworkInformation::NetworkInterfaceType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
