#[cfg(feature = "cordl_class_System+Net+NetworkInformation+UnixIPGlobalPropertiesFactoryPal")]
#[repr(C)]
...
impl std::ops::Deref for crate::System::Net::NetworkInformation::UnixIPGlobalPropertiesFactoryPal {
