#[cfg(feature = "cordl_class_System+Net+SocketAddress")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Net::SocketAddress {
    ...
    pub fn _ctor_AddressFamily_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (family, _cordl_size))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IPAddress_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ipaddress, port))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Family(
        &mut self,
