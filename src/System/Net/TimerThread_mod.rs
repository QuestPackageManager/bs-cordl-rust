                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsTickBetween", 3usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (start, end, comparand))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Prod",
                            0usize
                        )
                    })
            });
...
impl crate::System::Net::TimerThread_Callback {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (timer, timeNoticed, context))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::System::Net::TimerThread_Queue {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (durationMilliseconds))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::System::Net::TimerThread_TimerQueue {
    ...
    pub fn Fire(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (nextExpiration))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
