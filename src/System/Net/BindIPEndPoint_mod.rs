...
#[cfg(feature = "System+Net+BindIPEndPoint")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::BindIPEndPoint {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Net";
    const CLASS_NAME: &'static str = "BindIPEndPoint";
...
impl crate::System::Net::BindIPEndPoint {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::BindIPEndPoint as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::BindIPEndPoint as quest_hook::libil2cpp::Type >
                    ::class(), "Invoke", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Net::IPEndPoint> = unsafe {
            method.invoke_unchecked(self, (servicePoint, remoteEndPoint, retryCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
