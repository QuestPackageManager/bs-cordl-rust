#[cfg(feature = "cordl_class_System+Net+Configuration+DefaultProxySectionInternal")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "System+Net+Configuration+DefaultProxySectionInternal")]
impl std::ops::DerefMut for crate::System::Net::Configuration::DefaultProxySectionInternal {
...
impl crate::System::Net::Configuration::DefaultProxySectionInternal {
    pub fn GetDefaultProxy_UsingOldMonoCode(
    ...
    pub fn GetSection() -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Net::Configuration::DefaultProxySectionInternal>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
