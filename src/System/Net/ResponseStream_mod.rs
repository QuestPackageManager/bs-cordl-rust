...
impl crate::System::Net::ResponseStream {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_size, _cordl_final))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetHeaders(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::MemoryStream> = unsafe {
            cordl_method_info.invoke_unchecked(self, (closing))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (stream, response, ignore_errors))?
        };
        Ok(__cordl_ret.into())
    }
