...
#[cfg(feature = "System+Net+ServiceNameStore")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::ServiceNameStore {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Net";
    const CLASS_NAME: &'static str = "ServiceNameStore";
...
impl crate::System::Net::ServiceNameStore {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::ServiceNameStore as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::ServiceNameStore as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
