...
impl crate::System::Net::Comparer {
    ...
    pub fn System_Collections_IComparer_Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::Comparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::Comparer as quest_hook::libil2cpp::Type >
                    ::class(), "System.Collections.IComparer.Compare", 2usize
                )
            });
