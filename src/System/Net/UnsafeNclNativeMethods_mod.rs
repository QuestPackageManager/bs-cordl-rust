...
impl std::ops::Deref for crate::System::Net::HttpApi_UnsafeNclNativeMethods_HTTP_REQUEST_HEADER_ID {
...
#[cfg(feature = "cordl_class_System+Net+UnsafeNclNativeMethods+HttpApi")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::UnsafeNclNativeMethods_HttpApi {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Net";
...
impl crate::System::Net::UnsafeNclNativeMethods_HttpApi {
    #[cfg(feature = "System+Net+UnsafeNclNativeMethods+HttpApi+HTTP_REQUEST_HEADER_ID")]
    pub type HTTP_REQUEST_HEADER_ID =
        crate::System::Net::HttpApi_UnsafeNclNativeMethods_HTTP_REQUEST_HEADER_ID;
}
#[cfg(feature = "cordl_class_System+Net+UnsafeNclNativeMethods+HttpApi")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Net::UnsafeNclNativeMethods_HttpApi {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
#[cfg(feature = "System+Net+UnsafeNclNativeMethods+SecureStringHelper")]
impl std::ops::DerefMut for crate::System::Net::UnsafeNclNativeMethods_SecureStringHelper {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
