...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::SystemNetworkCredential {
    ...
    const CLASS_NAME: &'static str = "SystemNetworkCredential";
...
impl crate::System::Net::SystemNetworkCredential {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::SystemNetworkCredential as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::SystemNetworkCredential as
