#[cfg(feature = "cordl_class_System+Net+Mail+MailAddress")]
#[repr(C)]
...
impl crate::System::Net::Mail::MailAddress {
    ...
    pub fn _ctor_Il2CppString_Encoding2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (address, displayName, displayNameEncoding))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (displayName, userName, domain))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Address(
        &mut self,
