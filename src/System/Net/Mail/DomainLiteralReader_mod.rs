...
impl crate::System::Net::Mail::DomainLiteralReader {
    pub fn ReadReverse(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::Mail::DomainLiteralReader as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::Mail::DomainLiteralReader as
                    quest_hook::libil2cpp::Type > ::class(), "ReadReverse", 2usize
                )
            });
