...
impl std::ops::Deref for crate::System::Net::Security::RemoteCertificateValidationCallback {
...
#[cfg(feature = "System+Net+Security+RemoteCertificateValidationCallback")]
impl std::ops::DerefMut for crate::System::Net::Security::RemoteCertificateValidationCallback {
...
impl crate::System::Net::Security::RemoteCertificateValidationCallback {
    pub fn Invoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (sender, certificate, chain, sslPolicyErrors))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
