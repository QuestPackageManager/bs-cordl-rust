...
pub struct SslClientAuthenticationOptions {
    ...
    pub _checkCertificateRevocation:
    ...
    pub _LocalCertificateSelectionCallback_k__BackingField:
...
#[cfg(feature = "System+Net+Security+SslClientAuthenticationOptions")]
impl std::ops::DerefMut for crate::System::Net::Security::SslClientAuthenticationOptions {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_EnabledSslProtocols", 0usize
                        )
                    })
            });
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_LocalCertificateSelectionCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Net::Security::RemoteCertificateValidationCallback,
                    >, 0usize>("get_RemoteCertificateValidationCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_EnabledSslProtocols", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
