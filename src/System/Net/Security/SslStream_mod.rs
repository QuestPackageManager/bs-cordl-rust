#[cfg(feature = "cordl_class_System+Net+Security+SslStream")]
#[repr(C)]
#[derive(Debug)]
pub struct SslStream {
    ...
    >,
    pub selectionCallback:
        quest_hook::libil2cpp::Gc<crate::System::Net::Security::LocalCertificateSelectionCallback>,
    pub _cordl_impl:
        quest_hook::libil2cpp::Gc<crate::Mono::Net::Security::MobileAuthenticatedStream>,
    pub explicitSettings: bool,
}
#[cfg(feature = "cordl_class_System+Net+Security+SslStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::Security::SslStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Net.Security";
    const CLASS_NAME: &'static str = "SslStream";
...
impl crate::System::Net::Security::SslStream {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "BeginAuthenticateAsClient", 6usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "EndAuthenticateAsClient", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn New_MonoTlsProvider_MonoTlsSettings2(
        ...
        provider: quest_hook::libil2cpp::Gc<crate::Mono::Security::Interface::MonoTlsProvider>,
