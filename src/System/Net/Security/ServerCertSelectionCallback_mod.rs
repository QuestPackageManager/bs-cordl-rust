...
for crate::System::Net::Security::ServerCertSelectionCallback {
    ...
    const CLASS_NAME: &'static str = "ServerCertSelectionCallback";
...
impl crate::System::Net::Security::ServerCertSelectionCallback {
    pub fn Invoke(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::Security::ServerCertSelectionCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::Security::ServerCertSelectionCallback as
