...
impl crate::System::Net::HeaderInfo {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::HeaderInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::HeaderInfo as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 5usize
                )
            });
