#[cfg(feature = "cordl_class_System+Net+ListenerAsyncResult")]
#[repr(C)]
...
impl crate::System::Net::ListenerAsyncResult {
    pub fn Complete_Exception0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (exc))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Complete_HttpListenerContext__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (context, synch))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetContext(
        &mut self,
