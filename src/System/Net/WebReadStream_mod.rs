...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Net::WebReadStream => "System.Net"
    ."WebReadStream"
);
#[cfg(feature = "System+Net+WebReadStream")]
...
impl crate::System::Net::WebReadStream {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = __cordl_object
            .invoke("BeginRead", (buffer, offset, _cordl_size, cb, state))?;
        Ok(__cordl_ret.into())
    }
    pub fn Dispose(
        &mut self,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke(".ctor", (operation, innerStream))?;
        Ok(__cordl_ret.into())
    }
