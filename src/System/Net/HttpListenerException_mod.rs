...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::HttpListenerException {
    ...
    const CLASS_NAME: &'static str = "HttpListenerException";
...
impl crate::System::Net::HttpListenerException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::HttpListenerException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::HttpListenerException as
    ...
    pub fn _ctor_i32_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (errorCode, message))?
        };
        Ok(__cordl_ret.into())
    }
