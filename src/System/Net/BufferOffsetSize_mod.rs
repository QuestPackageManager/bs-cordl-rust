#[cfg(feature = "cordl_class_System+Net+BufferOffsetSize")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Net::BufferOffsetSize {
    ...
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (buffer, copyBuffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, offset, _cordl_size, copyBuffer))?
        };
        Ok(__cordl_ret.into())
    }
}
