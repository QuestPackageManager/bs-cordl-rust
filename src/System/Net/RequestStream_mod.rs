...
impl crate::System::Net::RequestStream {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::RequestStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Net::RequestStream as quest_hook::libil2cpp::Type >
    ...
    pub fn EndWrite(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (async_result))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::RequestStream as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::RequestStream as quest_hook::libil2cpp::Type >
                    ::class(), "FillFromBuffer", 3usize
                )
            });
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked(self, (buffer, off, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Flush(
    ...
    pub fn _ctor_Stream_Il2CppArray_i32_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (stream, buffer, offset, length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i64_1(
