...
impl crate::System::Net::RequestStream {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (buffer, offset, count, cback, state))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BeginWrite(
    ...
    pub fn EndRead(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (ares))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndWrite(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (async_result))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FillFromBuffer", 3usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, off, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Flush(
    ...
    pub fn _ctor_Stream_Il2CppArray_i32_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (stream, buffer, offset, length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i64_1(
