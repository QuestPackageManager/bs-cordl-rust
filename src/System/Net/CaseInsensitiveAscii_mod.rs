...
impl crate::System::Net::CaseInsensitiveAscii {
    pub fn Compare(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (firstObject, secondObject))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Equals(
    ...
    pub fn FastGetHashCode(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (myString))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetHashCode(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (myObject))?
        };
        Ok(__cordl_ret.into())
    }
