#[cfg(feature = "cordl_class_System+Net+CaseInsensitiveAscii")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Net::CaseInsensitiveAscii {
    pub fn Compare(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (firstObject, secondObject))? };
        Ok(__cordl_ret.into())
    }
    pub fn Equals(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FastGetHashCode", 1usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (myString))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetHashCode(
        &mut self,
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (myObject))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "System+Net+CaseInsensitiveAscii")]
impl AsRef<crate::System::Collections::IComparer> for crate::System::Net::CaseInsensitiveAscii {
    fn as_ref(&self) -> &crate::System::Collections::IComparer {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "System+Net+CaseInsensitiveAscii")]
impl AsMut<crate::System::Collections::IComparer> for crate::System::Net::CaseInsensitiveAscii {
