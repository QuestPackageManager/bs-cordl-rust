#[cfg(feature = "cordl_class_System+Net+TransportContext")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Net+TransportContext")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::TransportContext {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Net";
    const CLASS_NAME: &'static str = "TransportContext";
