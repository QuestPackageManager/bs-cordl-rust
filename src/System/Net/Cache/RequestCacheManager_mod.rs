#[cfg(feature = "cordl_class_System+Net+Cache+RequestCacheManager")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Net+Cache+RequestCacheManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Net::Cache::RequestCacheManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Net.Cache";
    const CLASS_NAME: &'static str = "RequestCacheManager";
...
impl crate::System::Net::Cache::RequestCacheManager {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Net::Cache::RequestCacheBinding> =
            unsafe { cordl_method_info.invoke_unchecked((), (internedScheme))? };
        Ok(__cordl_ret.into())
    }
    pub fn LoadConfigSettings() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_System+Net+Cache+RequestCacheManager")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Net::Cache::RequestCacheManager {
