...
> {
    ...
    pub parser: quest_hook::libil2cpp::Gc<crate::System::Net::Http::Headers::TryParseDelegate_1<T>>,
    __cordl_phantom_T: std::marker::PhantomData<T>,
    __cordl_phantom_U: std::marker::PhantomData<U>,
}
#[cfg(feature = "cordl_class_System+Net+Http+Headers+HeaderInfo+HeaderTypeInfo_2")]
unsafe impl<T: quest_hook::libil2cpp::Type, U: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::GlobalNamespace::HeaderInfo_HeaderTypeInfo_2<T, U>
{
    ...
    crate::GlobalNamespace::HeaderInfo_HeaderTypeInfo_2<T, U>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, parser, headerKind))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Net+Http+Headers+HeaderInfo+HeaderTypeInfo_2")]
