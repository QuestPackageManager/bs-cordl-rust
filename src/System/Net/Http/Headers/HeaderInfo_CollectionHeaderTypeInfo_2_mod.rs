#[cfg(feature = "cordl_class_System+Net+Http+Headers+HeaderInfo+CollectionHeaderTypeInfo_2")]
#[repr(C)]
#[derive(Debug)]
...
> {
    ...
    pub parser:
        quest_hook::libil2cpp::Gc<crate::System::Net::Http::Headers::TryParseListDelegate_1<T>>,
    ...
    crate::GlobalNamespace::HeaderInfo_CollectionHeaderTypeInfo_2<T, U>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (name, parser, headerKind, minimalCount, separator))?
        };
        Ok(__cordl_ret.into())
    }
