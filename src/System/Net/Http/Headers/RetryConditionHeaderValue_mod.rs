...
#[cfg(feature = "System+Net+Http+Headers+RetryConditionHeaderValue")]
impl std::ops::DerefMut for crate::System::Net::Http::Headers::RetryConditionHeaderValue {
...
impl crate::System::Net::Http::Headers::RetryConditionHeaderValue {
    ...
    pub fn TryParse(
        ...
        parsedValue: quest_hook::libil2cpp::ByRefMut<
            quest_hook::libil2cpp::Gc<crate::System::Net::Http::Headers::RetryConditionHeaderValue>,
        >,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
