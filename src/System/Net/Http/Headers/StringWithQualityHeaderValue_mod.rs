    ...
    for crate::System::Net::Http::Headers::StringWithQualityHeaderValue
{
    ...
    const CLASS_NAME: &'static str = "StringWithQualityHeaderValue";
...
impl std::ops::Deref for crate::System::Net::Http::Headers::StringWithQualityHeaderValue {
...
#[cfg(feature = "System+Net+Http+Headers+StringWithQualityHeaderValue")]
impl std::ops::DerefMut for crate::System::Net::Http::Headers::StringWithQualityHeaderValue {
...
impl crate::System::Net::Http::Headers::StringWithQualityHeaderValue {
    ...
    pub fn get_Quality(&mut self) -> quest_hook::libil2cpp::Result<crate::System::Nullable_1<f64>> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Nullable_1<f64>, 0usize>("get_Quality")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
