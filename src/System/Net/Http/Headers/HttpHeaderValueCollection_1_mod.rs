#[cfg(feature = "cordl_class_System+Net+Http+Headers+HttpHeaderValueCollection_1")]
#[repr(C)]
...
pub struct HttpHeaderValueCollection_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub headers: quest_hook::libil2cpp::Gc<crate::System::Net::Http::Headers::HttpHeaders>,
    pub headerInfo: quest_hook::libil2cpp::Gc<crate::System::Net::Http::Headers::HeaderInfo>,
    ...
    for crate::System::Net::Http::Headers::HttpHeaderValueCollection_1<T>
{
    ...
    const CLASS_NAME: &'static str = "HttpHeaderValueCollection`1";
    ...
    crate::System::Net::Http::Headers::HttpHeaderValueCollection_1<T>
{
    ...
    pub fn AddInvalidValue(
        &mut self,
        invalidValue: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddInvalidValue", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (invalidValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddRange(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (predicate))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (headers, headerInfo))?;
