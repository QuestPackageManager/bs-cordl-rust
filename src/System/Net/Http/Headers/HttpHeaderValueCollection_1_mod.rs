...
> crate::System::Net::Http::Headers::HttpHeaderValueCollection_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Net::Http::Headers::HttpHeaderValueCollection_1<
            T,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::Http::Headers::HttpHeaderValueCollection_1 < T >
                    as quest_hook::libil2cpp::Type > ::class(), "AddInvalidValue", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (invalidValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddRange(
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { method.invoke_unchecked(self, (predicate))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (headers, headerInfo))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Net::Http::Headers::HttpHeaderValueCollection_1 < T >
                    as quest_hook::libil2cpp::Type > ::class(), "get_InvalidValues",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
