...
pub struct HttpWebResponse {
    ...
    pub cookieCollection: quest_hook::libil2cpp::Gc<crate::System::Net::CookieCollection>,
    ...
    pub statusDescription: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
impl crate::System::Net::HttpWebResponse {
    ...
    pub fn FillCookies(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn _ctor_Uri_Il2CppString_HttpStatusCode_WebHeaderCollection1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (uri, method, status, headers))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Uri_Il2CppString_WebResponseStream_CookieContainer2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (uri, method, stream, container))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Headers(
        &mut self,
