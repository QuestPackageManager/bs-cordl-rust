...
impl crate::System::Net::WebException {
    ...
    pub fn _ctor_Il2CppString_Exception_WebExceptionStatus_WebResponse5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (message, innerException, status, response))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_Il2CppString_Exception_WebExceptionStatus_WebResponse6(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (message, data, innerException, status, response))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_WebExceptionStatus3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, status))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_WebExceptionStatus_WebExceptionInternalStatus_Exception4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (message, status, internalStatus, innerException))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Status(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Net::WebExceptionStatus, 0usize>("get_Status")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
