...
pub struct WebCompletionSource_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub completion: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Gc<T>>,
    pub currentResult: quest_hook::libil2cpp::Gc<T>,
...
impl<T: quest_hook::libil2cpp::Type> crate::System::Net::WebCompletionSource_1<T> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TrySetCompleted", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (argument))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (runAsync))?
        };
        Ok(__cordl_ret.into())
    }
...
> crate::System::Net::WebCompletionSource_1_Result<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (state, error))?
        };
        Ok(__cordl_ret.into())
    }
