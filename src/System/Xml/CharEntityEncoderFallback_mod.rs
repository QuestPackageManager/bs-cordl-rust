...
pub struct CharEntityEncoderFallback {
    ...
    pub fallbackBuffer:
        quest_hook::libil2cpp::Gc<crate::System::Xml::CharEntityEncoderFallbackBuffer>,
...
#[cfg(feature = "cordl_class_System+Xml+CharEntityEncoderFallback")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::CharEntityEncoderFallback {
...
impl crate::System::Xml::CharEntityEncoderFallback {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), bool, 1usize>("CanReplaceAt")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn Reset(
        &mut self,
        textContentMarks: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>>,
        endMarkPos: i32,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (textContentMarks, endMarkPos))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_StartOffset(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_StartOffset")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Xml+CharEntityEncoderFallback")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::CharEntityEncoderFallback {
