#[cfg(feature = "cordl_class_System+Xml+HtmlEncodedRawTextWriter")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Xml::HtmlEncodedRawTextWriter {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteHtmlElementTextBlock", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn WriteProcessingInstruction(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (target, text))?
        };
        Ok(__cordl_ret.into())
    }
