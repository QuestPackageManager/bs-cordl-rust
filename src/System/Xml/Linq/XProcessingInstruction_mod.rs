...
#[cfg(feature = "cordl_class_System+Xml+Linq+XProcessingInstruction")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Linq::XProcessingInstruction {
...
impl crate::System::Xml::Linq::XProcessingInstruction {
    ...
    pub fn New_XProcessingInstruction1(
        other: quest_hook::libil2cpp::Gc<crate::System::Xml::Linq::XProcessingInstruction>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
...
#[cfg(feature = "cordl_class_System+Xml+Linq+XProcessingInstruction")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Linq::XProcessingInstruction {
