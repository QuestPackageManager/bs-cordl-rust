...
pub struct XHashtable_1<TValue: quest_hook::libil2cpp::Type> {
    ...
    pub _state:
        quest_hook::libil2cpp::Gc<crate::System::Xml::Linq::XHashtable_1_XHashtableState<TValue>>,
    __cordl_phantom_TValue: std::marker::PhantomData<TValue>,
}
#[cfg(feature = "cordl_class_System+Xml+Linq+XHashtable_1")]
unsafe impl<TValue: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::System::Xml::Linq::XHashtable_1<TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("System.Xml.Linq", "XHashtable`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "System+Xml+Linq+XHashtable_1")]
impl<TValue: quest_hook::libil2cpp::Type> crate::System::Xml::Linq::XHashtable_1<TValue> {
    #[cfg(feature = "System+Xml+Linq+XHashtable_1+ExtractKeyDelegate")]
    pub type ExtractKeyDelegate = crate::System::Xml::Linq::XHashtable_1_ExtractKeyDelegate<TValue>;
    #[cfg(feature = "System+Xml+Linq+XHashtable_1+XHashtableState")]
    pub type XHashtableState = crate::System::Xml::Linq::XHashtable_1_XHashtableState<TValue>;
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, index, count, value))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (extractKey, capacity))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Xml+Linq+XHashtable_1")]
...
{
    #[cfg(feature = "System+Xml+Linq+XHashtable_1+XHashtableState+Entry")]
    pub type Entry = crate::System::Xml::Linq::XHashtableState_XHashtable_1_Entry<TValue>;
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (key, index, count))? };
        Ok(__cordl_ret.into())
    }
    pub fn FindEntry(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (hashCode, key, index, count, entryIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TValue, quest_hook::libil2cpp::ByRefMut<TValue>), bool, 2usize>(
                        "TryAdd",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
