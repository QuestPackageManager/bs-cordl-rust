...
impl crate::System::Xml::Linq::XObject {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AnnotationForSealedType", 1usize
                        )
                    })
            });
    ...
    pub fn GetSaveOptionsFromAnnotations(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Linq::SaveOptions, 0usize>(
        ...
        let __cordl_ret: crate::System::Xml::Linq::SaveOptions =
    ...
    pub fn NotifyChanged(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (sender, e))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetBaseUri(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (baseUri))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetLineInfo(
        &mut self,
    ...
    pub fn get_Parent(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::Xml::Linq::XElement>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Xml::Linq::XElement> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
