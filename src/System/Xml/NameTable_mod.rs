...
impl crate::System::Xml::NameTable {
    ...
    pub fn TextEquals(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (str1, str2, str2Start, str2Length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::System::Xml::NameTable_Entry {
    ...
    pub fn _ctor(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (
                            ...
                            i32,
                            quest_hook::libil2cpp::Gc<
                                crate::System::Xml::NameTable_Entry,
                            >,
                        ),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (str, hashCode, next))?
        };
        Ok(__cordl_ret.into())
    }
}
