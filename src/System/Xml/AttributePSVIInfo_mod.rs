...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::AttributePSVIInfo {
    ...
    const CLASS_NAME: &'static str = "AttributePSVIInfo";
...
impl crate::System::Xml::AttributePSVIInfo {
    ...
    pub fn Reset(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::AttributePSVIInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Reset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::AttributePSVIInfo as quest_hook::libil2cpp::Type
                    > ::class(), "Reset", 0usize
                )
            });
