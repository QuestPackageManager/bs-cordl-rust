...
pub struct AttributePSVIInfo {
    ...
    pub typedAttributeValue: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    pub attributeSchemaInfo: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaInfo>,
}
#[cfg(feature = "cordl_class_System+Xml+AttributePSVIInfo")]
