...
impl crate::System::Xml::XmlAsyncCheckReaderWithLineInfo {
    pub fn HasLineInfo(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::XmlAsyncCheckReaderWithLineInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("HasLineInfo")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::XmlAsyncCheckReaderWithLineInfo as
