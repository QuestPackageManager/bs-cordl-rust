...
pub struct XmlUrlResolver {
    ...
    pub _cachePolicy: quest_hook::libil2cpp::Gc<crate::System::Net::Cache::RequestCachePolicy>,
}
#[cfg(feature = "cordl_class_System+Xml+XmlUrlResolver")]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_DownloadManager", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Xml::XmlDownloadManager> =
