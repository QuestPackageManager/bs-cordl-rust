#[cfg(feature = "cordl_class_System+Xml+XmlText")]
#[repr(C)]
#[derive(Debug)]
pub struct XmlText {
...
impl crate::System::Xml::XmlText {
    ...
    pub fn _ctor_Il2CppString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (strData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_XmlDocument1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (strData, doc))?
        };
        Ok(__cordl_ret.into())
    }
