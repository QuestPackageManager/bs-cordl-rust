...
impl crate::System::Xml::SecureStringHasher {
    ...
    pub fn GetHashCodeDelegate() -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Xml::SecureStringHasher_HashCodeOfStringDelegate>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn GetHashCodeOfString(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (key, sLen, additionalEntropy))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "System+Xml+SecureStringHasher+HashCodeOfStringDelegate")]
impl std::ops::Deref for crate::System::Xml::SecureStringHasher_HashCodeOfStringDelegate {
...
#[cfg(feature = "System+Xml+SecureStringHasher+HashCodeOfStringDelegate")]
impl std::ops::DerefMut for crate::System::Xml::SecureStringHasher_HashCodeOfStringDelegate {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
