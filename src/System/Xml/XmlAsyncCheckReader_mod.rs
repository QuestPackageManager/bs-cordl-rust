#[cfg(feature = "cordl_class_System+Xml+XmlAsyncCheckReader")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Xml::XmlAsyncCheckReader {
    pub fn CheckAsync(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateAsyncCheckWrapper", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Xml::XmlAsyncCheckReader> =
