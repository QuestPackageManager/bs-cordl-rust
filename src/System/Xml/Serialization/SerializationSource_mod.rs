...
impl crate::System::Xml::Serialization::SerializationSource {
    pub fn BaseEquals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Serialization::SerializationSource as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Serialization::SerializationSource as
                    quest_hook::libil2cpp::Type > ::class(), "BaseEquals", 1usize
                )
            });
