...
for crate::System::Xml::Serialization::XmlTypeMapMemberAnyElement {
    ...
    const CLASS_NAME: &'static str = "XmlTypeMapMemberAnyElement";
...
impl crate::System::Xml::Serialization::XmlTypeMapMemberAnyElement {
    pub fn IsElementDefined(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Serialization::XmlTypeMapMemberAnyElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Serialization::XmlTypeMapMemberAnyElement as
                    quest_hook::libil2cpp::Type > ::class(), "IsElementDefined", 2usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, (name, ns))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_IsDefaultAny(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Serialization::XmlTypeMapMemberAnyElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_IsDefaultAny")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Serialization::XmlTypeMapMemberAnyElement as
                    quest_hook::libil2cpp::Type > ::class(), "get_IsDefaultAny", 0usize
                )
            });
