#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlTypeMapMemberAnyAttribute")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::System::Xml::Serialization::XmlTypeMapMemberAnyAttribute
{
    ...
    const CLASS_NAME: &'static str = "XmlTypeMapMemberAnyAttribute";
...
impl std::ops::Deref for crate::System::Xml::Serialization::XmlTypeMapMemberAnyAttribute {
...
#[cfg(feature = "System+Xml+Serialization+XmlTypeMapMemberAnyAttribute")]
impl std::ops::DerefMut for crate::System::Xml::Serialization::XmlTypeMapMemberAnyAttribute {
