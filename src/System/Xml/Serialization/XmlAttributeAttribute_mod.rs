...
for crate::System::Xml::Serialization::XmlAttributeAttribute {
    ...
    const CLASS_NAME: &'static str = "XmlAttributeAttribute";
...
impl crate::System::Xml::Serialization::XmlAttributeAttribute {
    pub fn AddKeyHash(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Serialization::XmlAttributeAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Serialization::XmlAttributeAttribute as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (attributeName))?
        };
        Ok(__cordl_ret.into())
    }
