...
impl crate::System::Xml::Serialization::XmlSerializer {
    ...
    pub fn Serialize_Il2CppObject_XmlSerializationWriter0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (o, writer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Serialize_TextWriter_Il2CppObject1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (textWriter, o))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Serialize_XmlWriter_Il2CppObject2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (xmlWriter, o))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Serialize_XmlWriter_Il2CppObject_XmlSerializerNamespaces3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (xmlWriter, o, namespaces))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
