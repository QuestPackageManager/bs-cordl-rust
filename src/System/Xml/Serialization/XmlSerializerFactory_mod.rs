#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlSerializerFactory")]
#[repr(C)]
#[derive(Debug)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateSerializer", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Xml::Serialization::XmlSerializer,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, root))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlSerializerFactory")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Serialization::XmlSerializerFactory {
