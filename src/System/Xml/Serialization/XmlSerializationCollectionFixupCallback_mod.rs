#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlSerializationCollectionFixupCallback")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Xml::Serialization::XmlSerializationCollectionFixupCallback {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (collection, collectionItems))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
