...
impl crate::System::Xml::Serialization::XmlSerializationReaderInterpreter {
    ...
    pub fn FillList(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (list, items))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FixupMembers(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (map, obfixup, isValueList))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetEnumValue(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, typeData, typeMap))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (typeMap, isNullable, checkType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReadMembers(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (map, ob, isValueList, readBySoapOrder))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadMessage(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetMemberValue", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (member, ob, value, isValueList))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::System::Xml::Serialization::XmlSerializationReaderInterpreter_FixupCallbackInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sri, map, isValueList))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::System::Xml::Serialization::XmlSerializationReaderInterpreter_ReaderCallbackInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sri, typeMap))?
        };
        Ok(__cordl_ret.into())
    }
}
