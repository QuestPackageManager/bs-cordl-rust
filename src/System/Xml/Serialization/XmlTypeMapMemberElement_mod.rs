...
impl crate::System::Xml::Serialization::XmlTypeMapMemberElement {
    ...
    pub fn SetChoice(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ob, choice))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
