...
pub struct XmlTypeMapMemberElement {
    ...
    pub _choiceTypeData: quest_hook::libil2cpp::Gc<crate::System::Xml::Serialization::TypeData>,
}
#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlTypeMapMemberElement")]
...
impl crate::System::Xml::Serialization::XmlTypeMapMemberElement {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Xml::Serialization::XmlTypeMapElementInfo,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (ob, memberValue))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetChoice(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetChoice")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ob, choice))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Xml::Serialization::XmlTypeMapElementInfoList,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_ElementInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
