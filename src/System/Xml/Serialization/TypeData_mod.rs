...
pub struct TypeData {
    ...
    pub listItemTypeData: quest_hook::libil2cpp::Gc<crate::System::Xml::Serialization::TypeData>,
    pub mappedType: quest_hook::libil2cpp::Gc<crate::System::Xml::Serialization::TypeData>,
    pub facet: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaPatternFacet>,
...
impl crate::System::Xml::Serialization::TypeData {
    ...
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Type>,
                    ), quest_hook::libil2cpp::Gc<crate::System::InvalidOperationException>, 3usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::InvalidOperationException> = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_type, inheritFrom, argumentType))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetIndexerProperty", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Reflection::PropertyInfo> =
            unsafe { cordl_method_info.invoke_unchecked((), (collectionType))? };
        Ok(__cordl_ret.into())
    }
    pub fn LookupTypeConvertor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("LookupTypeConvertor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn New_TypeData_XmlSchemaPatternFacet1(
        ...
        isPrimitive: bool,
        mappedType: quest_hook::libil2cpp::Gc<crate::System::Xml::Serialization::TypeData>,
    ...
    pub fn _ctor_Type_Il2CppString__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, elementName, isPrimitive))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_SchemaType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Serialization::SchemaTypes, 0usize>(
                        "get_SchemaType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Xml::Serialization::SchemaTypes =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
