...
impl crate::System::Xml::Serialization::XmlArrayItemAttributes {
    pub fn Add(
        &mut self,
        attribute: *mut crate::System::Xml::Serialization::XmlArrayItemAttribute,
    ...
    pub fn get_Item(
        ...
        *mut crate::System::Xml::Serialization::XmlArrayItemAttribute,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::System::Xml::Serialization::XmlArrayItemAttribute = __cordl_object
