#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlIncludeAttribute")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlIncludeAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Serialization::XmlIncludeAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Serialization";
    const CLASS_NAME: &'static str = "XmlIncludeAttribute";
...
#[cfg(feature = "cordl_class_System+Xml+Serialization+XmlIncludeAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Serialization::XmlIncludeAttribute {
