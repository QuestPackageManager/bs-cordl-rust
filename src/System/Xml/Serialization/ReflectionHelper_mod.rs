#[cfg(feature = "cordl_class_System+Xml+Serialization+ReflectionHelper")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Serialization+ReflectionHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Serialization::ReflectionHelper {
...
impl crate::System::Xml::Serialization::ReflectionHelper {
    pub fn CheckSerializableType(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_type, allowPrivateConstructors))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Xml::Serialization::XmlTypeMapping,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (xmlType, ns))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RegisterClrType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("RegisterClrType")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (map, _cordl_type, ns))? };
        Ok(__cordl_ret.into())
    }
    pub fn RegisterSchemaType(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 3usize>("RegisterSchemaType")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (map, xmlType, ns))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+Serialization+ReflectionHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Serialization::ReflectionHelper {
