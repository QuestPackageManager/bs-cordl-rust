...
pub struct XmlTypeSerializationSource {
    ...
    pub attributeOverridesHash: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
#[cfg(feature = "System+Xml+Serialization+XmlTypeSerializationSource")]
impl std::ops::DerefMut for crate::System::Xml::Serialization::XmlTypeSerializationSource {
