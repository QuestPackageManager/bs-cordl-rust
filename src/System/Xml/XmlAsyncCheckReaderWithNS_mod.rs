...
pub struct XmlAsyncCheckReaderWithNS {
    ...
    pub readerAsIXmlNamespaceResolver: quest_hook::libil2cpp::Gc<
...
impl crate::System::Xml::XmlAsyncCheckReaderWithNS {
    ...
    pub fn System_Xml_IXmlNamespaceResolver_GetNamespacesInScope(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::XmlAsyncCheckReaderWithNS as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::XmlAsyncCheckReaderWithNS as
