...
impl crate::System::Xml::XmlAutoDetectWriter {
    ...
    pub fn CreateWrappedWriter(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outMethod))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Stream_XmlWriterSettings2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (strm, writerSettings))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TextWriter_XmlWriterSettings1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (textWriter, writerSettings))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_XmlWriterSettings0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (writerSettings))?
        };
        Ok(__cordl_ret.into())
    }
