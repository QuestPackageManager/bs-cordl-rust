...
impl crate::System::Xml::XmlAutoDetectWriter {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateWrappedWriter", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outMethod))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsHtmlTag(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (tagName))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TextBlockCreatesWriter", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (textBlock))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteBase64(
        &mut self,
    ...
    pub fn _ctor_Stream_XmlWriterSettings2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (strm, writerSettings))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TextWriter_XmlWriterSettings1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (textWriter, writerSettings))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_XmlWriterSettings0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (writerSettings))? };
        Ok(__cordl_ret.into())
    }
