#[cfg(feature = "cordl_class_System+Xml+XmlEntity")]
#[repr(C)]
#[derive(Debug)]
pub struct XmlEntity {
    ...
    pub unparsedReplacementStr: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
impl crate::System::Xml::XmlEntity {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (name, strdata, publicId, systemId, notationName, doc))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_BaseURI(
