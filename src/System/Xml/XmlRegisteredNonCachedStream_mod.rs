...
for crate::System::Xml::XmlRegisteredNonCachedStream {
...
impl crate::System::Xml::XmlRegisteredNonCachedStream {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::XmlRegisteredNonCachedStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::XmlRegisteredNonCachedStream as
    ...
    pub fn New(
        ...
        downloadManager: quest_hook::libil2cpp::Gc<
            crate::System::Xml::XmlDownloadManager,
        >,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (stream, downloadManager, host))?
        };
        Ok(__cordl_ret.into())
    }
