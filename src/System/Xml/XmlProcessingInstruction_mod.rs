#[cfg(feature = "cordl_class_System+Xml+XmlProcessingInstruction")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+XmlProcessingInstruction")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::XmlProcessingInstruction {
...
impl crate::System::Xml::XmlProcessingInstruction {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (target, data, doc))? };
        Ok(__cordl_ret.into())
    }
