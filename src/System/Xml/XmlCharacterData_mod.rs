#[cfg(feature = "cordl_class_System+Xml+XmlCharacterData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+XmlCharacterData")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::XmlCharacterData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml";
    const CLASS_NAME: &'static str = "XmlCharacterData";
...
impl crate::System::Xml::XmlCharacterData {
    ...
    pub fn DecideXPNodeTypeForTextNodes(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<crate::System::Xml::XPath::XPathNodeType>,
                    ), bool, 2usize>("DecideXPNodeTypeForTextNodes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (node, xnt))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        data: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, doc))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Data(
        &mut self,
