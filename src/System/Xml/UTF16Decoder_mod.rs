...
impl crate::System::Xml::UTF16Decoder {
    pub fn Convert(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::UTF16Decoder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::UTF16Decoder as quest_hook::libil2cpp::Type >
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (bigEndian))?
        };
        Ok(__cordl_ret.into())
    }
}
