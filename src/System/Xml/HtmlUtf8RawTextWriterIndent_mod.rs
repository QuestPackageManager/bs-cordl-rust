...
impl crate::System::Xml::HtmlUtf8RawTextWriterIndent {
    pub fn FlushBuffer(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::HtmlUtf8RawTextWriterIndent as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FlushBuffer")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::HtmlUtf8RawTextWriterIndent as
