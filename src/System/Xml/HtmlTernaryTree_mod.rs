#[cfg(feature = "cordl_class_System+Xml+HtmlTernaryTree")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+HtmlTernaryTree")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::HtmlTernaryTree {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml";
    const CLASS_NAME: &'static str = "HtmlTernaryTree";
