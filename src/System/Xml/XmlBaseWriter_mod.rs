...
pub struct XmlBaseWriter {
    ...
    pub nsMgr: quest_hook::libil2cpp::Gc<
        crate::System::Xml::XmlBaseWriter_NamespaceManager,
    >,
    ...
    >,
    pub depth: i32,
    pub attributeLocalName: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppString,
    >,
    ...
    >,
    pub textFragmentWriter: quest_hook::libil2cpp::Gc<
        crate::System::Xml::XmlUTF8NodeWriter,
    >,
...
impl crate::System::Xml::XmlBaseWriter {
    ...
    pub fn AutoComplete(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (writeState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Close(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "StartAttribute", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (prefix, localName, ns, xNs))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn StartComment(
    ...
    pub fn WriteStartAttribute_Il2CppString_Il2CppString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (prefix, localName, namespaceUri))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteWhitespace(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (whitespace))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+XmlBaseWriter+DocumentState")]
unsafe impl quest_hook::libil2cpp::Type
for crate::System::Xml::XmlBaseWriter_DocumentState {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Xml";
...
pub struct XmlBaseWriter_NamespaceManager {
    ...
    pub namespaces: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<
                crate::System::Xml::NamespaceManager_XmlBaseWriter_Namespace,
            >,
        >,
    >,
    pub lastNameSpace: quest_hook::libil2cpp::Gc<
        crate::System::Xml::NamespaceManager_XmlBaseWriter_Namespace,
    >,
    pub nsCount: i32,
    pub depth: i32,
    ...
    pub nsTop: i32,
    pub defaultNamespace: quest_hook::libil2cpp::Gc<
        crate::System::Xml::NamespaceManager_XmlBaseWriter_Namespace,
    >,
}
#[cfg(feature = "cordl_class_System+Xml+XmlBaseWriter+NamespaceManager")]
unsafe impl quest_hook::libil2cpp::Type
for crate::System::Xml::XmlBaseWriter_NamespaceManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml";
...
impl crate::System::Xml::XmlBaseWriter_NamespaceManager {
    ...
    pub fn AddNamespaceIfNotDeclared(
        ...
        uriDictionaryString: quest_hook::libil2cpp::Gc<
            crate::System::Xml::XmlDictionaryString,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddNamespaceIfNotDeclared", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (uri, uriDictionaryString))?
        };
        Ok(__cordl_ret.into())
    }
