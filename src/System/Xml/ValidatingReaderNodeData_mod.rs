...
impl crate::System::Xml::ValidatingReaderNodeData {
    ...
    pub fn SetItemData_Il2CppString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, originalStringValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetItemData_Il2CppString_Il2CppString_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (localName, prefix, ns, depth))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetLineInfo_IXmlLineInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lineInfo))?
        };
        Ok(__cordl_ret.into())
    }
