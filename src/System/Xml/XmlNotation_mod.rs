...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::XmlNotation {
    ...
    const CLASS_NAME: &'static str = "XmlNotation";
...
impl crate::System::Xml::XmlNotation {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::XmlNotation as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool),
                quest_hook::libil2cpp::Gc<crate::System::Xml::XmlNode>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::XmlNotation as quest_hook::libil2cpp::Type >
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (name, publicId, systemId, doc))?
        };
        Ok(__cordl_ret.into())
    }
