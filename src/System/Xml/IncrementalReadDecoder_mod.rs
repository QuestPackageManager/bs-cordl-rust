...
#[cfg(feature = "System+Xml+IncrementalReadDecoder")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::IncrementalReadDecoder {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml";
    const CLASS_NAME: &'static str = "IncrementalReadDecoder";
...
impl crate::System::Xml::IncrementalReadDecoder {
    pub fn Decode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::IncrementalReadDecoder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::IncrementalReadDecoder as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::IncrementalReadDecoder as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::IncrementalReadDecoder as
                    quest_hook::libil2cpp::Type > ::class(), "get_IsFull", 0usize
                )
            });
