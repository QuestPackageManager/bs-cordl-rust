#[cfg(feature = "cordl_class_System+Xml+XPath+XPathNavigator")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Xml::XPath::XPathNavigator {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "IsText",
                            1usize
                        )
                    })
            });
    ...
    pub fn MoveToFirstNamespace(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (namespaceScope))?
        };
        Ok(__cordl_ret.into())
    }
