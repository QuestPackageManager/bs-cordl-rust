...
impl crate::System::Xml::XPath::XPathNavigatorKeyComparer {
    ...
    pub fn System_Collections_IEqualityComparer_Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::XPath::XPathNavigatorKeyComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::XPath::XPathNavigatorKeyComparer as
