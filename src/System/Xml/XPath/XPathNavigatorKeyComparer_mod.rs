#[cfg(feature = "cordl_class_System+Xml+XPath+XPathNavigatorKeyComparer")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+XPath+XPathNavigatorKeyComparer")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::XPath::XPathNavigatorKeyComparer {
...
impl crate::System::Xml::XPath::XPathNavigatorKeyComparer {
    ...
    pub fn System_Collections_IEqualityComparer_Equals(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (obj1, obj2))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+XPath+XPathNavigatorKeyComparer")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::XPath::XPathNavigatorKeyComparer {
