...
impl crate::System::Xml::XPath::XPathDocument {
    pub fn GetXmlNamespaceNode(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::ByRefMut<
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    >), i32, 1usize>("GetXmlNamespaceNode")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (pageXmlNmsp))? };
        Ok(__cordl_ret.into())
    }
    pub fn LookupNamespaces(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (pageElem, idxElem, pageNmsp))? };
        Ok(__cordl_ret.into())
    }
