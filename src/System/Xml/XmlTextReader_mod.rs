...
impl crate::System::Xml::XmlTextReader {
    ...
    pub fn New_String_Stream_XmlNameTable1(
    ...
    pub fn _ctor_String_Stream_XmlNameTable1(
        &mut self,
        url: *mut crate::System::String,
        input: *mut crate::System::IO::Stream,
        nt: *mut crate::System::Xml::XmlNameTable,
    ...
    pub fn get_Impl(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<*mut crate::System::Xml::XmlTextReaderImpl> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::System::Xml::XmlTextReaderImpl = __cordl_object
            .invoke("get_Impl", ())?;
        Ok(__cordl_ret)
    }
