...
impl crate::System::Xml::XmlDictionaryReader {
    ...
    pub fn CreateTextReader_Encoding_XmlDictionaryReaderQuotas_OnXmlDictionaryReaderClose1(
        ...
        onClose: quest_hook::libil2cpp::Gc<
            crate::System::Xml::OnXmlDictionaryReaderClose,
        >,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::System::Xml::XmlDictionaryReader>,
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Xml::XmlDictionaryReader,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (stream, encoding, quotas, onClose))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (base64, maxByteArrayContentLength))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (maxStringContentLength))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadElementContentAsGuid", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::System::Guid = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadElementContentAsTimeSpan", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::System::TimeSpan = unsafe {
