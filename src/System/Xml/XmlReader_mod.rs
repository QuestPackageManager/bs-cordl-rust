...
impl crate::System::Xml::XmlReader {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = __cordl_object.invoke("ReadElementString", ())?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = __cordl_object.invoke("ReadInnerXml", ())?;
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SkipSubtree(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = __cordl_object.invoke("SkipSubtree", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn WriteAttributeValue(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteAttributeValue", (xtw))?;
        Ok(__cordl_ret.into())
    }
    pub fn WriteNode(
        &mut self,
    ...
    pub fn get_IsDefaultInternal(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = __cordl_object.invoke("get_IsDefaultInternal", ())?;
        Ok(__cordl_ret.into())
    }
