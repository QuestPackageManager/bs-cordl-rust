...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::System::Xml::XmlTextEncoder => "System.Xml"
    ."XmlTextEncoder"
);
#[cfg(feature = "System+Xml+XmlTextEncoder")]
...
impl crate::System::Xml::XmlTextEncoder {
    ...
    pub fn WriteEntityRefImpl(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteEntityRefImpl", (name))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn WriteSurrogateChar(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteSurrogateChar", (lowChar, highChar))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn WriteRaw(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteRaw", (array, offset, count))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn WriteStringFragment(
        ...
        offset: i32,
        count: i32,
        helperBuffer: *mut quest_hook::libil2cpp::Il2CppArray<char>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteStringFragment", (str, offset, count, helperBuffer))?;
        Ok(__cordl_ret)
    }
    pub fn WriteRawWithSurrogateChecking(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteRawWithSurrogateChecking", (text))?;
        Ok(__cordl_ret)
    }
    pub fn StartAttribute(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("StartAttribute", (cacheAttrValue))?;
        Ok(__cordl_ret)
    }
    pub fn EndAttribute(
        &mut self,
    ...
    pub fn WriteCharEntityImpl__cordl_char0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteCharEntityImpl", (ch))?;
        Ok(__cordl_ret)
    }
    pub fn WriteCharEntityImpl_String1(
        &mut self,
        strVal: *mut crate::System::String,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("WriteCharEntityImpl", (strVal))?;
        Ok(__cordl_ret)
    }
    pub fn New(
        textWriter: *mut crate::System::IO::TextWriter,
