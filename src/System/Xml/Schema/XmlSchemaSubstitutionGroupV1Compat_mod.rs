...
#[cfg(feature = "System+Xml+Schema+XmlSchemaSubstitutionGroupV1Compat")]
impl std::ops::DerefMut for crate::System::Xml::Schema::XmlSchemaSubstitutionGroupV1Compat {
...
impl crate::System::Xml::Schema::XmlSchemaSubstitutionGroupV1Compat {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaChoice> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
