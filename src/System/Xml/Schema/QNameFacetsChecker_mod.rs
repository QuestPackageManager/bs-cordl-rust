#[cfg(feature = "cordl_class_System+Xml+Schema+QNameFacetsChecker")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+QNameFacetsChecker")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::QNameFacetsChecker {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "QNameFacetsChecker";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+QNameFacetsChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::QNameFacetsChecker {
