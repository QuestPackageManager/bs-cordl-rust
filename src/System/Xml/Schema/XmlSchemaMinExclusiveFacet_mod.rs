#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaMinExclusiveFacet")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaMinExclusiveFacet")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaMinExclusiveFacet {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlSchemaMinExclusiveFacet";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaMinExclusiveFacet")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaMinExclusiveFacet {
