...
#[cfg(feature = "cordl_class_System+Xml+Schema+Numeric2FacetsChecker")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Numeric2FacetsChecker {
...
impl crate::System::Xml::Schema::Numeric2FacetsChecker {
    ...
    pub fn MatchEnumeration_f64_XmlValueConverter1(
        ...
        value: f64,
        enumeration: quest_hook::libil2cpp::Gc<crate::System::Collections::ArrayList>,
        valueConverter: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlValueConverter>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, enumeration, valueConverter))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Numeric2FacetsChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::Numeric2FacetsChecker {
