...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XsdSimpleValue {
    ...
    const CLASS_NAME: &'static str = "XsdSimpleValue";
...
impl crate::System::Xml::Schema::XsdSimpleValue {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::XsdSimpleValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Schema::XsdSimpleValue as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (st, value))?
        };
        Ok(__cordl_ret.into())
    }
