...
impl crate::System::Xml::Schema::XmlSchemaObjectTable_ValuesCollection {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (entries, _cordl_size))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Count(&mut self) -> quest_hook::libil2cpp::Result<i32> {
...
impl crate::System::Xml::Schema::XmlSchemaObjectTable_XSODictionaryEnumerator {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (entries, _cordl_size, enumType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Entry(
...
#[cfg(
    feature = "cordl_class_System+Xml+Schema+XmlSchemaObjectTable+XmlSchemaObjectEntry"
)]
#[repr(C)]
