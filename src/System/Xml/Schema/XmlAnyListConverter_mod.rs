#[cfg(feature = "cordl_class_System+Xml+Schema+XmlAnyListConverter")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlAnyListConverter")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlAnyListConverter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlAnyListConverter";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlAnyListConverter")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlAnyListConverter {
