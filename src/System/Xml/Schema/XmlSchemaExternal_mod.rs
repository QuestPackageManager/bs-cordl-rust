#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaExternal")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaExternal")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaExternal {
...
impl crate::System::Xml::Schema::XmlSchemaExternal {
    ...
    pub fn get_Compositor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Schema::Compositor, 0usize>(
                        "get_Compositor",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Xml::Schema::Compositor =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Id(
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaExternal")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaExternal {
