#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaMinLengthFacet")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaMinLengthFacet")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaMinLengthFacet {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlSchemaMinLengthFacet";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaMinLengthFacet")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaMinLengthFacet {
