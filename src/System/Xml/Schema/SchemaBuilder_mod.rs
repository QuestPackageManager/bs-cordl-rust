...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::SchemaBuilder {
    ...
    const CLASS_NAME: &'static str = "SchemaBuilder";
...
#[cfg(feature = "System+Xml+Schema+SchemaBuilder")]
impl crate::System::Xml::Schema::SchemaBuilder {
    pub fn EndChildren(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::SchemaBuilder as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EndChildren")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::SchemaBuilder as
