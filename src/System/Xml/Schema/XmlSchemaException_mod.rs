...
impl crate::System::Xml::Schema::XmlSchemaException {
    ...
    pub fn SetSource_Il2CppString_i32_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (sourceUri, lineNumber, linePosition))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_Il2CppArray_XmlSchemaObject12(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (res, args, source))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_Il2CppString_XmlSchemaObject11(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (res, arg, source))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString_i32_i32_8(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (res, sourceUri, lineNumber, linePosition))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_XmlSchemaObject10(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (res, source))?
        };
        Ok(__cordl_ret.into())
    }
