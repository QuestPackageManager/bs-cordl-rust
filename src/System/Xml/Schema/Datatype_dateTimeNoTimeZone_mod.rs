...
for crate::System::Xml::Schema::Datatype_dateTimeNoTimeZone {
    ...
    const CLASS_NAME: &'static str = "Datatype_dateTimeNoTimeZone";
...
impl crate::System::Xml::Schema::Datatype_dateTimeNoTimeZone {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::Datatype_dateTimeNoTimeZone as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::Datatype_dateTimeNoTimeZone as
