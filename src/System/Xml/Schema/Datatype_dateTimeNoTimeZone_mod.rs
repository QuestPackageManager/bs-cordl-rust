#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_dateTimeNoTimeZone")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_dateTimeNoTimeZone")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::Datatype_dateTimeNoTimeZone {
