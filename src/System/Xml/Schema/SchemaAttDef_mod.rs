...
impl crate::System::Xml::Schema::SchemaAttDef {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CheckXmlSpace", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (validationEventHandling))? };
        Ok(__cordl_ret.into())
    }
    pub fn Clone(
        &mut self,
    ...
    pub fn System_Xml_IDtdAttributeInfo_get_LineNumber(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("System.Xml.IDtdAttributeInfo.get_LineNumber")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn System_Xml_IDtdAttributeInfo_get_LinePosition(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("System.Xml.IDtdAttributeInfo.get_LinePosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_DefaultValueExpanded", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
    ...
    pub fn get_Reserved(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Xml::Schema::SchemaAttDef_Reserve> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Schema::SchemaAttDef_Reserve, 0usize>(
                        "get_Reserved",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Xml::Schema::SchemaAttDef_Reserve =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_DefaultValueExpanded", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn set_LinePosition(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_LinePosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "System+Xml+Schema+SchemaAttDef")]
impl AsRef<crate::System::Xml::IDtdAttributeInfo> for crate::System::Xml::Schema::SchemaAttDef {
    fn as_ref(&self) -> &crate::System::Xml::IDtdAttributeInfo {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "System+Xml+Schema+SchemaAttDef")]
impl AsMut<crate::System::Xml::IDtdAttributeInfo> for crate::System::Xml::Schema::SchemaAttDef {
...
#[cfg(feature = "cordl_class_System+Xml+Schema+SchemaAttDef+Reserve")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::SchemaAttDef_Reserve {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+SchemaAttDef+Reserve")]
unsafe impl quest_hook::libil2cpp::Argument for crate::System::Xml::Schema::SchemaAttDef_Reserve {
    type Type = Self;
...
#[cfg(feature = "cordl_class_System+Xml+Schema+SchemaAttDef+Reserve")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::System::Xml::Schema::SchemaAttDef_Reserve {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Xml+Schema+SchemaAttDef+Reserve")]
unsafe impl quest_hook::libil2cpp::Returned for crate::System::Xml::Schema::SchemaAttDef_Reserve {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_System+Xml+Schema+SchemaAttDef+Reserve")]
unsafe impl quest_hook::libil2cpp::Return for crate::System::Xml::Schema::SchemaAttDef_Reserve {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
