...
#[cfg(feature = "cordl_class_System+Xml+Schema+NamespaceListNode")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::NamespaceListNode {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "NamespaceListNode";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetResolvedSymbols", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::ICollection> =
            unsafe { cordl_method_info.invoke_unchecked(self, (symbols))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
#[cfg(feature = "cordl_class_System+Xml+Schema+NamespaceListNode")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::NamespaceListNode {
