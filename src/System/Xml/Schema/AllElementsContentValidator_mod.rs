...
impl crate::System::Xml::Schema::AllElementsContentValidator {
    pub fn AddElement(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, particle, isEmptiable))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (contentType, _cordl_size, isEmptiable))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+Schema+AllElementsContentValidator")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::AllElementsContentValidator {
