...
#[cfg(feature = "cordl_class_System+Xml+Schema+ValidationEventArgs")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::ValidationEventArgs {
...
impl crate::System::Xml::Schema::ValidationEventArgs {
    ...
    pub fn _ctor_XmlSeverityType1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ex, severity))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaException> =
    ...
    pub fn get_Severity(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Schema::XmlSeverityType, 0usize>(
                        "get_Severity",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Xml::Schema::XmlSeverityType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_System+Xml+Schema+ValidationEventArgs")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::ValidationEventArgs {
