#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaComplexContentExtension")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "System+Xml+Schema+XmlSchemaComplexContentExtension")]
impl std::ops::DerefMut for crate::System::Xml::Schema::XmlSchemaComplexContentExtension {
...
impl crate::System::Xml::Schema::XmlSchemaComplexContentExtension {
    ...
    pub fn SetAttributes(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Xml::Schema::XmlSchemaObjectCollection,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetAttributes")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newAttributes))? };
        Ok(__cordl_ret.into())
    }
