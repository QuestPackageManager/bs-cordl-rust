...
for crate::System::Xml::Schema::XmlSchemaComplexContentExtension {
    ...
    const CLASS_NAME: &'static str = "XmlSchemaComplexContentExtension";
...
impl crate::System::Xml::Schema::XmlSchemaComplexContentExtension {
    ...
    pub fn SetAttributes(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::XmlSchemaComplexContentExtension as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Schema::XmlSchemaComplexContentExtension as
                    quest_hook::libil2cpp::Type > ::class(), "SetAttributes", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::XmlSchemaComplexContentExtension as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::XmlSchemaComplexContentExtension as
                    quest_hook::libil2cpp::Type > ::class(), "get_BaseTypeName", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::XmlSchemaComplexContentExtension as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::XmlSchemaComplexContentExtension as
                    quest_hook::libil2cpp::Type > ::class(), "set_BaseTypeName", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
