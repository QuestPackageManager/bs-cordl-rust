...
#[cfg(feature = "cordl_class_System+Xml+Schema+StringFacetsChecker")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::StringFacetsChecker {
...
impl crate::System::Xml::Schema::StringFacetsChecker {
    pub fn CheckBuiltInFacets(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Exception> =
            unsafe { cordl_method_info.invoke_unchecked(self, (s, typeCode, verifyUri))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CheckValueFacets_Il2CppString__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Exception> =
            unsafe { cordl_method_info.invoke_unchecked(self, (value, datatype, verifyUri))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+Schema+StringFacetsChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::StringFacetsChecker {
