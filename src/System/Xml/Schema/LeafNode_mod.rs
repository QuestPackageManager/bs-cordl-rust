#[cfg(feature = "cordl_class_System+Xml+Schema+LeafNode")]
#[repr(C)]
#[derive(Debug)]
pub struct LeafNode {
...
#[cfg(feature = "cordl_class_System+Xml+Schema+LeafNode")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::LeafNode {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "LeafNode";
...
impl crate::System::Xml::Schema::LeafNode {
    ...
    pub fn ExpandTree(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("ExpandTree")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parent, symbols, positions))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(pos: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
