#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaFacet")]
#[repr(C)]
...
impl crate::System::Xml::Schema::XmlSchemaFacet {
    ...
    pub fn get_FacetType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Schema::FacetType, 0usize>(
                        "get_FacetType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Xml::Schema::FacetType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
