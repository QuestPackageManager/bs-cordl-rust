...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_decimal")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Datatype_decimal {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_decimal";
...
#[cfg(feature = "System+Xml+Schema+Datatype_decimal")]
impl crate::System::Xml::Schema::Datatype_decimal {
    pub fn Compare(
        &mut self,
