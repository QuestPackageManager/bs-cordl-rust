#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaLengthFacet")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaLengthFacet")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaLengthFacet {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlSchemaLengthFacet";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaLengthFacet")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaLengthFacet {
