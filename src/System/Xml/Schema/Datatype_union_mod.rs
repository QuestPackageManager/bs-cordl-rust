...
impl crate::System::Xml::Schema::Datatype_union {
    ...
    pub fn IsUnionBaseOf(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (derivedType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Exception> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (value, nameTable, nsmgr, typedValue))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (types))?
        };
        Ok(__cordl_ret.into())
    }
