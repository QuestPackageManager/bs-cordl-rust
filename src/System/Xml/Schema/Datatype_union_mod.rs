#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_union")]
#[repr(C)]
...
impl crate::System::Xml::Schema::Datatype_union {
    ...
    pub fn IsUnionBaseOf(
        &mut self,
        derivedType: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::DatatypeImplementation>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsUnionBaseOf", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (derivedType))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn TryParseValue_Il2CppObject1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Exception> = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, nameTable, nsmgr, typedValue))?
        };
        Ok(__cordl_ret.into())
    }
