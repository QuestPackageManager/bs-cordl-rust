#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSimpleTypeContent")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSimpleTypeContent")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaSimpleTypeContent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlSchemaSimpleTypeContent";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSimpleTypeContent")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaSimpleTypeContent {
