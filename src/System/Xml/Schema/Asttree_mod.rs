#[cfg(feature = "cordl_class_System+Xml+Schema+Asttree")]
#[repr(C)]
#[derive(Debug)]
pub struct Asttree {
...
impl crate::System::Xml::Schema::Asttree {
    pub fn CompileXPath(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("CompileXPath")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (xPath, isField, nsmgr))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsAttribute(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (ast))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetURN(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Xml::XmlNamespaceManager>,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetURN")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (axis, nsmgr))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
