...
impl crate::System::Xml::Schema::ChoiceNode {
    pub fn ConstructChildPos(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::ChoiceNode as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Schema::ChoiceNode as
                    quest_hook::libil2cpp::Type > ::class(), "ConstructChildPos", 4usize
                )
            });
