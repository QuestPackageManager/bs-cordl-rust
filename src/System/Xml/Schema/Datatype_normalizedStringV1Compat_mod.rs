...
for crate::System::Xml::Schema::Datatype_normalizedStringV1Compat {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_normalizedStringV1Compat";
...
#[cfg(feature = "System+Xml+Schema+Datatype_normalizedStringV1Compat")]
impl crate::System::Xml::Schema::Datatype_normalizedStringV1Compat {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::Datatype_normalizedStringV1Compat as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::Datatype_normalizedStringV1Compat as
