#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaInferenceException")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Xml::Schema::XmlSchemaInferenceException {
    ...
    pub fn _ctor_Il2CppString_i32_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (res, lineNumber, linePosition))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaInferenceException")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaInferenceException {
