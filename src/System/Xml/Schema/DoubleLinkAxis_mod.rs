#[cfg(feature = "cordl_class_System+Xml+Schema+DoubleLinkAxis")]
#[repr(C)]
...
impl crate::System::Xml::Schema::DoubleLinkAxis {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (axis, inputaxis))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Next(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::MS::Internal::Xml::XPath::Axis> =
