#[cfg(feature = "System+Xml+Schema+Datatype_nonNegativeInteger")]
#[repr(C)]
#[derive(Debug)]
...
for crate::System::Xml::Schema::Datatype_nonNegativeInteger {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_nonNegativeInteger";
...
#[cfg(feature = "System+Xml+Schema+Datatype_nonNegativeInteger")]
impl std::ops::Deref for crate::System::Xml::Schema::Datatype_nonNegativeInteger {
...
#[cfg(feature = "System+Xml+Schema+Datatype_nonNegativeInteger")]
impl std::ops::DerefMut for crate::System::Xml::Schema::Datatype_nonNegativeInteger {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "System+Xml+Schema+Datatype_nonNegativeInteger")]
impl crate::System::Xml::Schema::Datatype_nonNegativeInteger {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::Datatype_nonNegativeInteger as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::Datatype_nonNegativeInteger as
