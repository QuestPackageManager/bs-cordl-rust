#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAny")]
#[repr(C)]
...
pub struct XmlSchemaAny {
    ...
    pub namespaceList: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::NamespaceList>,
}
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAny")]
...
impl crate::System::Xml::Schema::XmlSchemaAny {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::NamespaceList> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_ProcessContentsCorrect(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::System::Xml::Schema::XmlSchemaContentProcessing> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::System::Xml::Schema::XmlSchemaContentProcessing =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
