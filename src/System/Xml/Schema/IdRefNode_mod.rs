...
impl crate::System::Xml::Schema::IdRefNode {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::IdRefNode as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Schema::IdRefNode as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 4usize
                )
            });
