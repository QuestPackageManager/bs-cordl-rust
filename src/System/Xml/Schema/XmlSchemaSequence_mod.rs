...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSequence")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaSequence {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlSchemaSequence";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSequence")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaSequence {
