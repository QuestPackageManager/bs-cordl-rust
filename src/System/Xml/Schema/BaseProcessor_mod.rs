...
impl crate::System::Xml::Schema::BaseProcessor {
    ...
    pub fn IsValidAttributeGroupRedefine(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (existingObject, item, table))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SendValidationEvent_Il2CppString_Il2CppArray_Exception_XmlSchemaObject3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (code, args, innerException, source))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SendValidationEvent_Il2CppString_Il2CppString_Il2CppString_XmlSchemaObject2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (code, msg1, msg2, source))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SendValidationEvent_Il2CppString_Il2CppString_XmlSchemaObject1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (code, msg, source))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SendValidationEvent_Il2CppString_Il2CppString_XmlSchemaObject_XmlSeverityType7(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (code, msg, source, severity))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SendValidationEvent_Il2CppString_XmlSchemaObject0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (code, source))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SendValidationEvent_Il2CppString_XmlSchemaObject_XmlSeverityType5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (code, source, severity))?
        };
        Ok(__cordl_ret.into())
    }
