...
#[cfg(feature = "System+Xml+Schema+AxisStack")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::AxisStack {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "AxisStack";
...
impl crate::System::Xml::Schema::AxisStack {
    pub fn Equal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::AxisStack as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Schema::AxisStack as quest_hook::libil2cpp::Type
                    > ::class(), "Equal", 4usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked((), (thisname, thisURN, name, URN))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::AxisStack as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::AxisStack as quest_hook::libil2cpp::Type
                    > ::class(), "MoveToAttribute", 3usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (name, URN, depth))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn MoveToChild(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::AxisStack as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    ...
                    quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::ActiveAxis>,
                ),
                quest_hook::libil2cpp::Void,
                2usize,
            >(".ctor")
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (faxis, parent))?
        };
        Ok(__cordl_ret.into())
    }
