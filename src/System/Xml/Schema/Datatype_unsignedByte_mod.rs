...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_unsignedByte")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Datatype_unsignedByte {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_unsignedByte";
...
#[cfg(feature = "System+Xml+Schema+Datatype_unsignedByte")]
impl crate::System::Xml::Schema::Datatype_unsignedByte {
    pub fn Compare(
        &mut self,
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_unsignedByte")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::Datatype_unsignedByte {
