#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAnnotated")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAnnotated")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaAnnotated {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::System::Xml::XmlAttribute>,
                        >,
                    >, 0usize>("get_UnhandledAttributes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAnnotated")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaAnnotated {
