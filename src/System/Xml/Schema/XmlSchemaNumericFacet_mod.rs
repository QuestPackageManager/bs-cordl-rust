...
for crate::System::Xml::Schema::XmlSchemaNumericFacet {
    ...
    const CLASS_NAME: &'static str = "XmlSchemaNumericFacet";
...
#[cfg(feature = "System+Xml+Schema+XmlSchemaNumericFacet")]
impl crate::System::Xml::Schema::XmlSchemaNumericFacet {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::XmlSchemaNumericFacet as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::XmlSchemaNumericFacet as
