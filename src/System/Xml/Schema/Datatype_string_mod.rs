#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_string")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_string")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Datatype_string {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_string";
