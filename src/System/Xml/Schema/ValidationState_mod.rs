#[cfg(feature = "cordl_class_System+Xml+Schema+ValidationState")]
#[repr(C)]
#[derive(Debug)]
pub struct ValidationState {
    ...
    pub ElementDecl: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::SchemaElementDecl>,
    pub ElementDeclBeforeXsi:
    ...
    pub RunningPositions: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::System::Xml::Schema::RangePositionInfo>,
    >,
    pub TooComplex: bool,
}
#[cfg(feature = "cordl_class_System+Xml+Schema+ValidationState")]
