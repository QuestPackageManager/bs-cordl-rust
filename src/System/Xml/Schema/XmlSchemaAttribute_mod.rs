#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAttribute")]
#[repr(C)]
...
pub struct XmlSchemaAttribute {
    ...
    pub _cordl_type: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaSimpleType>,
    pub attributeType: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaSimpleType>,
    pub attDef: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::SchemaAttDef>,
}
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaAttribute {
...
impl crate::System::Xml::Schema::XmlSchemaAttribute {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_AttributeSchemaType", 0usize
                        )
                    })
            });
    ...
    pub fn get_Use(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::Schema::XmlSchemaUse, 0usize>("get_Use")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::Xml::Schema::XmlSchemaUse =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_AttDef(
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaAttribute {
