#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_base64Binary")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_base64Binary")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Datatype_base64Binary {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_base64Binary";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_base64Binary")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::Datatype_base64Binary {
