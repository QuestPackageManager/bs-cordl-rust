#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSimpleType")]
#[repr(C)]
#[derive(Debug)]
pub struct XmlSchemaSimpleType {
    __cordl_parent: crate::System::Xml::Schema::XmlSchemaType,
    pub content: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaSimpleTypeContent>,
}
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSimpleType")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaSimpleType {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "XmlSchemaSimpleType";
...
impl crate::System::Xml::Schema::XmlSchemaSimpleType {
    ...
    pub fn set_Content(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::System::Xml::Schema::XmlSchemaSimpleTypeContent>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Xml::Schema::XmlSchemaSimpleTypeContent,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_Content")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_System+Xml+Schema+XmlSchemaSimpleType")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::XmlSchemaSimpleType {
