#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_timeTimeZone")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_timeTimeZone")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Datatype_timeTimeZone {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_timeTimeZone";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_timeTimeZone")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::Datatype_timeTimeZone {
