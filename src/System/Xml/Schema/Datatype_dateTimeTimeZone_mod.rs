#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_dateTimeTimeZone")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_dateTimeTimeZone")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Datatype_dateTimeTimeZone {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Datatype_dateTimeTimeZone";
...
#[cfg(feature = "cordl_class_System+Xml+Schema+Datatype_dateTimeTimeZone")]
impl quest_hook::libil2cpp::ObjectType for crate::System::Xml::Schema::Datatype_dateTimeTimeZone {
