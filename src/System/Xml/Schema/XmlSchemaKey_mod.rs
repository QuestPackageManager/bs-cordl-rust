...
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::XmlSchemaKey {
    ...
    const CLASS_NAME: &'static str = "XmlSchemaKey";
...
#[cfg(feature = "System+Xml+Schema+XmlSchemaKey")]
impl crate::System::Xml::Schema::XmlSchemaKey {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::XmlSchemaKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Xml::Schema::XmlSchemaKey as
