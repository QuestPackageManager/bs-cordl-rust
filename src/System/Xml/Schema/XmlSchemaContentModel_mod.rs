...
impl crate::System::Xml::Schema::XmlSchemaContentModel {
    pub fn set_Content(
        &mut self,
        value: *mut crate::System::Xml::Schema::XmlSchemaContent,
    ...
    pub fn get_Content(
        ...
        *mut crate::System::Xml::Schema::XmlSchemaContent,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::System::Xml::Schema::XmlSchemaContent = __cordl_object
            .invoke("get_Content", ())?;
        Ok(__cordl_ret)
    }
