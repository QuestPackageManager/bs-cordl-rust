#[cfg(feature = "cordl_class_System+Xml+Schema+Positions")]
#[repr(C)]
...
impl crate::System::Xml::Schema::Positions {
    pub fn Add(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (symbol, particle))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Item(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), crate::System::Xml::Schema::Position, 1usize>("get_Item")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::Xml::Schema::Position =
