...
pub struct Positions {
    ...
    pub positions: quest_hook::libil2cpp::Gc<crate::System::Collections::ArrayList>,
}
#[cfg(feature = "System+Xml+Schema+Positions")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::Xml::Schema::Positions {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml.Schema";
    const CLASS_NAME: &'static str = "Positions";
...
impl crate::System::Xml::Schema::Positions {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::Positions as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Xml::Schema::Positions as quest_hook::libil2cpp::Type
                    > ::class(), "Add", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked(self, (symbol, particle))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Item(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Xml::Schema::Positions as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                crate::System::Xml::Schema::Position,
                1usize,
            >("get_Item")
            .unwrap_or_else(|e| {
                panic!(
        ...
        let __cordl_ret: crate::System::Xml::Schema::Position = unsafe {
