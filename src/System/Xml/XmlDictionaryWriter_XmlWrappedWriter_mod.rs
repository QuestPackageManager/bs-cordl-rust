...
for crate::GlobalNamespace::XmlDictionaryWriter_XmlWrappedWriter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System.Xml";
    const CLASS_NAME: &'static str = "XmlDictionaryWriter/XmlWrappedWriter";
...
impl std::ops::Deref for crate::GlobalNamespace::XmlDictionaryWriter_XmlWrappedWriter {
...
#[cfg(feature = "System+Xml+XmlDictionaryWriter+XmlWrappedWriter")]
impl crate::GlobalNamespace::XmlDictionaryWriter_XmlWrappedWriter {
    pub fn Close(
        &mut self,
