#[cfg(feature = "cordl_class_System+Xml+ByteStack")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::System::Xml::ByteStack {
    pub fn New(growthRate: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
    ...
    pub fn Push(&mut self, data: u8) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
