...
#[cfg(feature = "System+LocalDataStoreElement")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::LocalDataStoreElement {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "LocalDataStoreElement";
...
impl crate::System::LocalDataStoreElement {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::LocalDataStoreElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i64), quest_hook::libil2cpp::Void, 1usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::LocalDataStoreElement as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 1usize
                )
            });
