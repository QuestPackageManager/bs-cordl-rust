#[cfg(feature = "cordl_class_System+LocalDataStoreSlot")]
#[repr(C)]
...
impl crate::System::LocalDataStoreSlot {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mgr, slot, cookie))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Manager(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::LocalDataStoreMgr>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::LocalDataStoreMgr> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
