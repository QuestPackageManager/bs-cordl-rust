...
unsafe impl<
    ...
    T4: quest_hook::libil2cpp::Type,
    T5: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::Type for crate::System::Action_5<T1, T2, T3, T4, T5> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Action`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Action`5")
                    .unwrap()
...
impl<
    ...
    T4: quest_hook::libil2cpp::Type,
    T5: quest_hook::libil2cpp::Type,
> std::ops::Deref for crate::System::Action_5<T1, T2, T3, T4, T5> {
...
impl<
    ...
    T4: quest_hook::libil2cpp::Type,
    T5: quest_hook::libil2cpp::Type,
> std::ops::DerefMut for crate::System::Action_5<T1, T2, T3, T4, T5> {
...
impl<
    ...
    T4: quest_hook::libil2cpp::Type,
    T5: quest_hook::libil2cpp::Type,
> crate::System::Action_5<T1, T2, T3, T4, T5> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        T5: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Action_5<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Action_5 < T1, T2, T3, T4, T5 > as
...
impl<
    ...
    T4: quest_hook::libil2cpp::Type,
    T5: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::ObjectType for crate::System::Action_5<T1, T2, T3, T4, T5> {
