...
impl crate::System::StringExtensions {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::StringExtensions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::StringExtensions as quest_hook::libil2cpp::Type >
                    ::class(), "SubstringTrim", 3usize
                )
            });
