...
impl crate::System::Byte {
    ...
    pub fn CompareTo_Il2CppObject0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Byte as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Byte as quest_hook::libil2cpp::Type > ::class(),
                    "CompareTo", 1usize
                )
            });
    ...
    pub fn Parse_Il2CppString_IFormatProvider0(
        ...
        let __cordl_ret: u8 = unsafe { method.invoke_unchecked((), (s, provider))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Parse_ReadOnlySpan_1_NumberStyles_NumberFormatInfo2(
        ...
        let __cordl_ret: u8 = unsafe { method.invoke_unchecked((), (s, style, info))? };
        Ok(__cordl_ret.into())
    }
