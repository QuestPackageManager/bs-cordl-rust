...
#[cfg(feature = "System+LocalDataStoreHolder")]
unsafe impl quest_hook::libil2cpp::Type for crate::System::LocalDataStoreHolder {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "LocalDataStoreHolder";
...
impl crate::System::LocalDataStoreHolder {
    pub fn Finalize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::LocalDataStoreHolder as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Finalize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::LocalDataStoreHolder as quest_hook::libil2cpp::Type >
