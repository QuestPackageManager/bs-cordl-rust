...
unsafe impl quest_hook::libil2cpp::Type for crate::System::OrdinalIgnoreCaseComparer {
    ...
    const CLASS_NAME: &'static str = "OrdinalIgnoreCaseComparer";
...
impl crate::System::OrdinalIgnoreCaseComparer {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::OrdinalIgnoreCaseComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::OrdinalIgnoreCaseComparer as
