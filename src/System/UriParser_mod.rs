...
impl crate::System::UriParser {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::UriParser as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::UriParser as quest_hook::libil2cpp::Type > ::class(),
