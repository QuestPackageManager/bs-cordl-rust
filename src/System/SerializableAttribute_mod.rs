...
unsafe impl quest_hook::libil2cpp::Type for crate::System::SerializableAttribute {
    ...
    const CLASS_NAME: &'static str = "SerializableAttribute";
...
#[cfg(feature = "System+SerializableAttribute")]
impl crate::System::SerializableAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::SerializableAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::SerializableAttribute as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
