...
impl crate::System::StringComparer {
    ...
    pub fn Create(
        ...
        ignoreCase: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::StringComparer>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Gc<crate::System::StringComparer>, 2usize>(
                        "Create"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::StringComparer> =
            unsafe { cordl_method_info.invoke_unchecked((), (culture, ignoreCase))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_InvariantCultureIgnoreCase(
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::StringComparer>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_InvariantCultureIgnoreCase", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::StringComparer> =
...
#[cfg(feature = "System+StringComparer")]
impl AsRef<crate::System::Collections::IEqualityComparer> for crate::System::StringComparer {
    fn as_ref(&self) -> &crate::System::Collections::IEqualityComparer {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "System+StringComparer")]
impl AsMut<crate::System::Collections::IEqualityComparer> for crate::System::StringComparer {
