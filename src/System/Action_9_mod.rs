...
for crate::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Action`9";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Action`9")
                    .unwrap()
                    .make_generic::<(T1, T2, T3, T4, T5, T6, T7, T8, T9)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    T8: quest_hook::libil2cpp::Type,
    T9: quest_hook::libil2cpp::Type,
> std::ops::Deref for crate::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
...
impl<
    ...
    T8: quest_hook::libil2cpp::Type,
    T9: quest_hook::libil2cpp::Type,
> std::ops::DerefMut for crate::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
...
impl<
    ...
    T8: quest_hook::libil2cpp::Type,
    T9: quest_hook::libil2cpp::Type,
> crate::System::Action_9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        T9: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Action_9<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Action_9 < T1, T2, T3, T4, T5, T6, T7, T8, T9 > as
