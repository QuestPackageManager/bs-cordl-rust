...
unsafe impl quest_hook::libil2cpp::Type for crate::System::ConsoleKeyInfo {
    ...
    const CLASS_NAME: &'static str = "ConsoleKeyInfo";
...
impl crate::System::ConsoleKeyInfo {
    pub fn Equals_ConsoleKeyInfo1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::System::ConsoleKeyInfo), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (char, crate::System::ConsoleKey, bool, bool, bool),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (keyChar, key, shift, alt, control))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Key(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::System::ConsoleKey, 0usize>("get_Key")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type >
        ...
        let __cordl_ret: crate::System::ConsoleKey = unsafe {
    ...
    pub fn get_KeyChar(&mut self) -> quest_hook::libil2cpp::Result<char> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), char, 0usize>("get_KeyChar")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::ConsoleKeyInfo as quest_hook::libil2cpp::Type >
                    ::class(), "get_KeyChar", 0usize
                )
            });
