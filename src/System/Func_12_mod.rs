...
for crate::System::Func_12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "System";
    const CLASS_NAME: &'static str = "Func`12";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("System", "Func`12")
                    .unwrap()
                    .make_generic::<
...
impl<
    ...
    T11: quest_hook::libil2cpp::Type,
    TResult: quest_hook::libil2cpp::Type,
> crate::System::Func_12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> {
    pub fn Invoke(
        &mut self,
        arg1: T1,
        arg2: T2,
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::System::Func_12<
            T1,
            T2,
            T3,
            T4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::System::Func_12 < T1, T2, T3, T4, T5, T6, T7, T8, T9, T10,
                    T11, TResult > as quest_hook::libil2cpp::Type > ::class(), "Invoke",
                    11usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::System::Func_12 < T1, T2, T3, T4, T5, T6, T7, T8, T9, T10,
                    T11, TResult > as quest_hook::libil2cpp::Type > ::class(), ".ctor",
                    2usize
                )
            });
