...
for crate::Assets::OVR::Scripts::FixMethodDelegate {
    ...
    const CLASS_NAME: &'static str = "FixMethodDelegate";
...
impl crate::Assets::OVR::Scripts::FixMethodDelegate {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Assets::OVR::Scripts::FixMethodDelegate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Assets::OVR::Scripts::FixMethodDelegate as
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (obj, isLastInSet, selectedIndex, callback, object),
                )?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Assets::OVR::Scripts::FixMethodDelegate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, bool, i32),
                quest_hook::libil2cpp::Void,
                3usize,
            >("Invoke")
            .unwrap_or_else(|e| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (obj, isLastInSet, selectedIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
