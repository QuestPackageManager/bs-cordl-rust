...
pub struct G_AdvancedData {
    ...
    pub m_backgroundImages: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub m_graphicsDeviceVersionText: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Text>,
    ...
    pub m_graphicsDeviceNameText: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Text>,
    pub m_graphicsMemorySizeText: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Text>,
    pub m_screenResolutionText: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Text>,
    pub m_gameWindowResolutionText: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Text>,
...
#[cfg(feature = "cordl_class_Tayx+Graphy+Advanced+G_AdvancedData")]
unsafe impl quest_hook::libil2cpp::Type for crate::Tayx::Graphy::Advanced::G_AdvancedData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Tayx.Graphy.Advanced";
    const CLASS_NAME: &'static str = "G_AdvancedData";
...
impl crate::Tayx::Graphy::Advanced::G_AdvancedData {
    ...
    pub fn RestorePreviousState(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RestorePreviousState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetPosition(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newModulePosition))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetState(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, silentUpdate))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Tayx+Graphy+Advanced+G_AdvancedData")]
impl quest_hook::libil2cpp::ObjectType for crate::Tayx::Graphy::Advanced::G_AdvancedData {
...
#[cfg(feature = "Tayx+Graphy+Advanced+G_AdvancedData")]
impl AsRef<crate::Tayx::Graphy::UI::IMovable> for crate::Tayx::Graphy::Advanced::G_AdvancedData {
    fn as_ref(&self) -> &crate::Tayx::Graphy::UI::IMovable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Tayx+Graphy+Advanced+G_AdvancedData")]
impl AsMut<crate::Tayx::Graphy::UI::IMovable> for crate::Tayx::Graphy::Advanced::G_AdvancedData {
