...
for crate::Tayx::Graphy::Utils::G_Singleton_1<T> {
    ...
    const CLASS_NAME: &'static str = "G_Singleton`1";
...
impl<T: quest_hook::libil2cpp::Type> crate::Tayx::Graphy::Utils::G_Singleton_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Tayx::Graphy::Utils::G_Singleton_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Tayx::Graphy::Utils::G_Singleton_1 < T > as
