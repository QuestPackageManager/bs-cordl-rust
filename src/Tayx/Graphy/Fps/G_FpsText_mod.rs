...
impl crate::Tayx::Graphy::Fps::G_FpsText {
    ...
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Tayx::Graphy::Fps::G_FpsText as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Tayx::Graphy::Fps::G_FpsText as quest_hook::libil2cpp::Type >
                    ::class(), "Awake", 0usize
                )
            });
    ...
    pub fn SetFpsRelatedTextColor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Tayx::Graphy::Fps::G_FpsText as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Text>, f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Tayx::Graphy::Fps::G_FpsText as quest_hook::libil2cpp::Type >
                    ::class(), "SetFpsRelatedTextColor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (text, fps))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
