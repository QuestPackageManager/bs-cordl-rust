#[cfg(feature = "cordl_class_Tayx+Graphy+UI+IModifiableState")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Tayx+Graphy+UI+IModifiableState")]
unsafe impl quest_hook::libil2cpp::Type for crate::Tayx::Graphy::UI::IModifiableState {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Tayx.Graphy.UI";
    const CLASS_NAME: &'static str = "IModifiableState";
...
impl crate::Tayx::Graphy::UI::IModifiableState {
    pub fn SetState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newState, silentUpdate))? };
        Ok(__cordl_ret.into())
    }
