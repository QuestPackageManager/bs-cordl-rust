...
impl crate::Tayx::Graphy::Audio::G_AudioMonitor {
    ...
    pub fn OnSceneLoaded(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (scene, loadSceneMode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
    ...
    pub fn dBNormalized(&mut self, db: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (db))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_SpectrumDataAvailable", 0usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "lin2dB",
                            1usize
                        )
                    })
            });
