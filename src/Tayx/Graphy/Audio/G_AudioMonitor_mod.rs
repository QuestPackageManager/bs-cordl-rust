...
pub struct G_AudioMonitor {
    ...
    pub _Spectrum_k__BackingField:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
    pub _SpectrumHighestValues_k__BackingField:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
...
impl crate::Tayx::Graphy::Audio::G_AudioMonitor {
    ...
    pub fn OnSceneLoaded(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (scene, loadSceneMode))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn dBNormalized(&mut self, db: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (db))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_SpectrumHighestValues", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>> =
    ...
    pub fn lin2dB(&mut self, linear: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (linear))? };
        Ok(__cordl_ret.into())
    }
    pub fn set_MaxDB(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_SpectrumHighestValues", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
