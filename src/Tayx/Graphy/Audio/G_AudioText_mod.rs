...
unsafe impl quest_hook::libil2cpp::Type for crate::Tayx::Graphy::Audio::G_AudioText {
    ...
    const CLASS_NAME: &'static str = "G_AudioText";
...
#[cfg(feature = "Tayx+Graphy+Audio+G_AudioText")]
impl crate::Tayx::Graphy::Audio::G_AudioText {
    pub fn Awake(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Tayx::Graphy::Audio::G_AudioText as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Tayx::Graphy::Audio::G_AudioText as
