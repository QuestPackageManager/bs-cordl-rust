...
pub struct G_AudioGraph {
    ...
    pub m_imageGraphHighestValues: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Image>,
    ...
    pub m_shaderGraphHighestValues: quest_hook::libil2cpp::Gc<crate::Tayx::Graphy::G_GraphShader>,
    pub m_graphArray: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
    pub m_graphArrayHighestValue:
...
impl crate::Tayx::Graphy::Audio::G_AudioGraph {
    pub fn CreatePoints(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn UpdateGraph(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
