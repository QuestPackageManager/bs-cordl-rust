...
impl crate::Tayx::Graphy::Graph::G_Graph {
    pub fn CreatePoints(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Tayx::Graphy::Graph::G_Graph as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CreatePoints")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Tayx::Graphy::Graph::G_Graph as quest_hook::libil2cpp::Type >
                    ::class(), "CreatePoints", 0usize
                )
            });
