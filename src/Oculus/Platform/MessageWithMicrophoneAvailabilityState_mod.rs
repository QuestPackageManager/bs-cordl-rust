...
impl std::ops::Deref for crate::Oculus::Platform::MessageWithMicrophoneAvailabilityState {
...
#[cfg(feature = "Oculus+Platform+MessageWithMicrophoneAvailabilityState")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithMicrophoneAvailabilityState {
