#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithHttpTransferUpdate")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithHttpTransferUpdate")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithHttpTransferUpdate {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithHttpTransferUpdate";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithHttpTransferUpdate")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithHttpTransferUpdate {
