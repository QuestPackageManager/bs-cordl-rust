...
for crate::Oculus::Platform::MessageWithNetSyncSessionList {
    ...
    const CLASS_NAME: &'static str = "MessageWithNetSyncSessionList";
...
impl crate::Oculus::Platform::MessageWithNetSyncSessionList {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::NetSyncSessionList>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithNetSyncSessionList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithNetSyncSessionList as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithNetSyncSessionList as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithNetSyncSessionList as
                    quest_hook::libil2cpp::Type > ::class(), "GetNetSyncSessionList",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
