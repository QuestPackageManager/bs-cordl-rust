...
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithPartyID {
    ...
    const CLASS_NAME: &'static str = "MessageWithPartyID";
...
#[cfg(feature = "Oculus+Platform+MessageWithPartyID")]
impl crate::Oculus::Platform::MessageWithPartyID {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::PartyID>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithPartyID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::PartyID>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithPartyID as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithPartyID as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithPartyID as
                    quest_hook::libil2cpp::Type > ::class(), "GetPartyID", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Oculus::Platform::Models::PartyID,
