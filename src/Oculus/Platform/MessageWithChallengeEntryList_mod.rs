...
#[repr(C)]
#[derive(Debug)]
pub struct MessageWithChallengeEntryList {
...
for crate::Oculus::Platform::MessageWithChallengeEntryList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithChallengeEntryList";
...
#[cfg(feature = "Oculus+Platform+MessageWithChallengeEntryList")]
impl crate::Oculus::Platform::MessageWithChallengeEntryList {
    pub fn GetChallengeEntryList(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::ChallengeEntryList>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithChallengeEntryList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithChallengeEntryList as
                    quest_hook::libil2cpp::Type > ::class(), "GetChallengeEntryList",
                    0usize
                )
            });
