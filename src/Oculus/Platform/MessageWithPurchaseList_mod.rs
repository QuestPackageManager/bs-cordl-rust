#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithPurchaseList")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithPurchaseList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithPurchaseList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithPurchaseList";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithPurchaseList")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithPurchaseList {
