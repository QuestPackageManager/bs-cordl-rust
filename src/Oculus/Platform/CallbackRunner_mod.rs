...
pub struct CallbackRunner {
    ...
    pub IsPersistantBetweenSceneLoads: bool,
}
#[cfg(feature = "Oculus+Platform+CallbackRunner")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::CallbackRunner {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "CallbackRunner";
...
#[cfg(feature = "Oculus+Platform+CallbackRunner")]
impl std::ops::Deref for crate::Oculus::Platform::CallbackRunner {
...
#[cfg(feature = "Oculus+Platform+CallbackRunner")]
impl std::ops::DerefMut for crate::Oculus::Platform::CallbackRunner {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Oculus+Platform+CallbackRunner")]
impl crate::Oculus::Platform::CallbackRunner {
    pub fn Awake(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::CallbackRunner as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::CallbackRunner as
