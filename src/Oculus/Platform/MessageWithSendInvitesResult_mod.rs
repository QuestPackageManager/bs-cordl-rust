...
impl crate::Oculus::Platform::MessageWithSendInvitesResult {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::SendInvitesResult>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithSendInvitesResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithSendInvitesResult as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithSendInvitesResult as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithSendInvitesResult as
                    quest_hook::libil2cpp::Type > ::class(), "GetSendInvitesResult",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
