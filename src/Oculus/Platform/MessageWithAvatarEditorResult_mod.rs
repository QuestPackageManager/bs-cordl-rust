...
for crate::Oculus::Platform::MessageWithAvatarEditorResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithAvatarEditorResult";
...
#[cfg(feature = "Oculus+Platform+MessageWithAvatarEditorResult")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithAvatarEditorResult {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Oculus+Platform+MessageWithAvatarEditorResult")]
impl crate::Oculus::Platform::MessageWithAvatarEditorResult {
    pub fn GetAvatarEditorResult(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::AvatarEditorResult>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAvatarEditorResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAvatarEditorResult as
                    quest_hook::libil2cpp::Type > ::class(), "GetAvatarEditorResult",
                    0usize
                )
            });
