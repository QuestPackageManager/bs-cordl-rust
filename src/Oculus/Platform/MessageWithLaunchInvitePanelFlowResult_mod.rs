...
impl std::ops::Deref for crate::Oculus::Platform::MessageWithLaunchInvitePanelFlowResult {
...
#[cfg(feature = "Oculus+Platform+MessageWithLaunchInvitePanelFlowResult")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithLaunchInvitePanelFlowResult {
