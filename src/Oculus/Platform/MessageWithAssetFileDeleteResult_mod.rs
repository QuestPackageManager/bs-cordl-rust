...
#[repr(C)]
#[derive(Debug)]
pub struct MessageWithAssetFileDeleteResult {
...
for crate::Oculus::Platform::MessageWithAssetFileDeleteResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithAssetFileDeleteResult";
...
#[cfg(feature = "Oculus+Platform+MessageWithAssetFileDeleteResult")]
impl crate::Oculus::Platform::MessageWithAssetFileDeleteResult {
    pub fn GetAssetFileDeleteResult(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::AssetFileDeleteResult>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAssetFileDeleteResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAssetFileDeleteResult as
                    quest_hook::libil2cpp::Type > ::class(), "GetAssetFileDeleteResult",
                    0usize
                )
            });
