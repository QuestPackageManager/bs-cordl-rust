...
impl crate::Oculus::Platform::StandalonePlatform {
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::Oculus::Platform::Request_1<
                            ...
                            >,
                        >,
                    >, 3usize>("AsyncInitializeWithAccessTokenAndOptions")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (appId, accessToken, initConfigOptions))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "Oculus+Platform+StandalonePlatform+UnityLogDelegate")]
impl std::ops::DerefMut for crate::Oculus::Platform::StandalonePlatform_UnityLogDelegate {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
