...
for crate::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult {
    ...
    const CLASS_NAME: &'static str = "MessageWithNetSyncSetSessionPropertyResult";
...
#[cfg(feature = "Oculus+Platform+MessageWithNetSyncSetSessionPropertyResult")]
impl crate::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::NetSyncSetSessionPropertyResult,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult
                    as quest_hook::libil2cpp::Type > ::class(), "GetDataFromMessage",
                    1usize
                )
            });
