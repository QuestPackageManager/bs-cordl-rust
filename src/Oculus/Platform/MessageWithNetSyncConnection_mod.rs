#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithNetSyncConnection")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithNetSyncConnection")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithNetSyncConnection {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithNetSyncConnection";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithNetSyncConnection")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithNetSyncConnection {
