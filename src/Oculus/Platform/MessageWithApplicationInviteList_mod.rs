...
impl crate::Oculus::Platform::MessageWithApplicationInviteList {
    pub fn GetApplicationInviteList(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::ApplicationInviteList>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithApplicationInviteList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithApplicationInviteList as
                    quest_hook::libil2cpp::Type > ::class(), "GetApplicationInviteList",
                    0usize
                )
            });
