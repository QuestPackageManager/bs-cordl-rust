...
#[cfg(feature = "Oculus+Platform+IMicrophone")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::IMicrophone {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "IMicrophone";
...
impl crate::Oculus::Platform::IMicrophone {
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::IMicrophone as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::IMicrophone as quest_hook::libil2cpp::Type
                    > ::class(), "Start", 0usize
                )
            });
