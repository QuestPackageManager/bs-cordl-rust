...
#[cfg(feature = "Oculus+Platform+MessageWithUser")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithUser {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithUser";
...
impl crate::Oculus::Platform::MessageWithUser {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::User>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithUser as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::User>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithUser as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithUser as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithUser as
                    quest_hook::libil2cpp::Type > ::class(), "GetUser", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Oculus::Platform::Models::User,
