...
impl crate::Oculus::Platform::MessageWithAssetFileDownloadUpdate {
    pub fn GetAssetFileDownloadUpdate(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAssetFileDownloadUpdate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::AssetFileDownloadUpdate,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAssetFileDownloadUpdate as
