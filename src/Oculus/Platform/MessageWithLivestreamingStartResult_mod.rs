...
for crate::Oculus::Platform::MessageWithLivestreamingStartResult {
    ...
    const CLASS_NAME: &'static str = "MessageWithLivestreamingStartResult";
...
impl crate::Oculus::Platform::MessageWithLivestreamingStartResult {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLivestreamingStartResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::LivestreamingStartResult,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLivestreamingStartResult as
