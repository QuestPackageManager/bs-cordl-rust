...
for crate::Oculus::Platform::MessageWithShareMediaResult {
    ...
    const CLASS_NAME: &'static str = "MessageWithShareMediaResult";
...
impl crate::Oculus::Platform::MessageWithShareMediaResult {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::ShareMediaResult>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithShareMediaResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithShareMediaResult as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithShareMediaResult as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithShareMediaResult as
                    quest_hook::libil2cpp::Type > ::class(), "GetShareMediaResult",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
