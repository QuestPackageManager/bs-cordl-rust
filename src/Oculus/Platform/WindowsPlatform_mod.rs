...
#[cfg(feature = "cordl_class_Oculus+Platform+WindowsPlatform")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::WindowsPlatform {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "WindowsPlatform";
...
impl crate::Oculus::Platform::WindowsPlatform {
    ...
    pub fn Initialize(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (appId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn getCallbackPointer(&mut self) -> quest_hook::libil2cpp::Result<crate::System::IntPtr> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    for crate::Oculus::Platform::WindowsPlatform_UnityLogDelegate
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "WindowsPlatform/UnityLogDelegate";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
impl crate::Oculus::Platform::WindowsPlatform_UnityLogDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (tag, msg, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tag, msg))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        object: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
