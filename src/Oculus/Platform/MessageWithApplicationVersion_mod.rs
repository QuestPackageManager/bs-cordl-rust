...
impl crate::Oculus::Platform::MessageWithApplicationVersion {
    pub fn GetApplicationVersion(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::ApplicationVersion>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithApplicationVersion as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithApplicationVersion as
                    quest_hook::libil2cpp::Type > ::class(), "GetApplicationVersion",
                    0usize
                )
            });
