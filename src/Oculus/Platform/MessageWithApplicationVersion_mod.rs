#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithApplicationVersion")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithApplicationVersion")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithApplicationVersion {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithApplicationVersion";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithApplicationVersion")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithApplicationVersion {
