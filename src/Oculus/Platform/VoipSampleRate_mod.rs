#[cfg(feature = "cordl_class_Oculus+Platform+VoipSampleRate")]
...
#[cfg(feature = "cordl_class_Oculus+Platform+VoipSampleRate")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::VoipSampleRate {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "VoipSampleRate";
...
#[cfg(feature = "cordl_class_Oculus+Platform+VoipSampleRate")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Oculus::Platform::VoipSampleRate {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
