#[cfg(feature = "cordl_class_Oculus+Platform+LogEventParameter")]
...
#[cfg(feature = "cordl_class_Oculus+Platform+LogEventParameter")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Oculus::Platform::LogEventParameter {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Oculus+Platform+LogEventParameter")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Oculus::Platform::LogEventParameter {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Oculus+Platform+LogEventParameter")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Oculus::Platform::LogEventParameter {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Oculus+Platform+LogEventParameter")]
unsafe impl quest_hook::libil2cpp::Return for crate::Oculus::Platform::LogEventParameter {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
