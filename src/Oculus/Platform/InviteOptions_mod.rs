...
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::InviteOptions {
    ...
    const CLASS_NAME: &'static str = "InviteOptions";
...
#[cfg(feature = "Oculus+Platform+InviteOptions")]
impl crate::Oculus::Platform::InviteOptions {
    pub fn AddSuggestedUser(
        &mut self,
        userID: u64,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::InviteOptions as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (u64),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::InviteOptions as
