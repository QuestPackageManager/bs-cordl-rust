...
for crate::Oculus::Platform::MessageWithDataStoreUnderPublicUserDataStore {
    ...
    const CLASS_NAME: &'static str = "MessageWithDataStoreUnderPublicUserDataStore";
...
impl crate::Oculus::Platform::MessageWithDataStoreUnderPublicUserDataStore {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithDataStoreUnderPublicUserDataStore as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::Dictionary_2<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Oculus::Platform::MessageWithDataStoreUnderPublicUserDataStore as
