...
for crate::Oculus::Platform::MessageWithUserAccountAgeCategory {
    ...
    const CLASS_NAME: &'static str = "MessageWithUserAccountAgeCategory";
...
impl crate::Oculus::Platform::MessageWithUserAccountAgeCategory {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithUserAccountAgeCategory as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::UserAccountAgeCategory,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithUserAccountAgeCategory as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithUserAccountAgeCategory as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithUserAccountAgeCategory as
                    quest_hook::libil2cpp::Type > ::class(), "GetUserAccountAgeCategory",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
