...
for crate::Oculus::Platform::MessageWithLaunchUnblockFlowResult {
    ...
    const CLASS_NAME: &'static str = "MessageWithLaunchUnblockFlowResult";
...
impl crate::Oculus::Platform::MessageWithLaunchUnblockFlowResult {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLaunchUnblockFlowResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::LaunchUnblockFlowResult,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLaunchUnblockFlowResult as
