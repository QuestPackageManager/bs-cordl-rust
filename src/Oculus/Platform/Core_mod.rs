#[cfg(feature = "cordl_class_Oculus+Platform+Core")]
#[repr(C)]
#[derive(Debug)]
pub struct Core {
...
impl crate::Oculus::Platform::Core {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (accessToken, initConfigOptions, appId))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Oculus::Platform::Request_1<
                quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::PlatformInitialize>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (appId))? };
        Ok(__cordl_ret.into())
    }
    pub fn ForceInitialized() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
