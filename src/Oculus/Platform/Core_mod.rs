...
impl crate::Oculus::Platform::Core {
    pub fn AsyncInitialize_Gc_Il2CppString1(
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (accessToken, initConfigOptions, appId))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Initialize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (appId))?
        };
        Ok(__cordl_ret.into())
    }
