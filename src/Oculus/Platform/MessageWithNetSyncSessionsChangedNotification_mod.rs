#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithNetSyncSessionsChangedNotification")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Oculus::Platform::MessageWithNetSyncSessionsChangedNotification
{
    ...
    const CLASS_NAME: &'static str = "MessageWithNetSyncSessionsChangedNotification";
...
impl std::ops::Deref for crate::Oculus::Platform::MessageWithNetSyncSessionsChangedNotification {
...
#[cfg(feature = "Oculus+Platform+MessageWithNetSyncSessionsChangedNotification")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithNetSyncSessionsChangedNotification {
