...
impl crate::Oculus::Platform::MessageWithAchievementProgressList {
    pub fn GetAchievementProgressList(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAchievementProgressList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::AchievementProgressList,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAchievementProgressList as
