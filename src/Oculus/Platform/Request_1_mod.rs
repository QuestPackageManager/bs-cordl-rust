...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::Oculus::Platform::Request_1<T> {
...
#[cfg(feature = "Oculus+Platform+Request_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::Oculus::Platform::Request_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::Oculus::Platform::Request_1<T> {
    ...
    pub fn New(requestID: u64) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
    ...
    pub fn OnComplete(
        &mut self,
        callback: quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Message_1_Callback<T>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Request_1<T>> =
