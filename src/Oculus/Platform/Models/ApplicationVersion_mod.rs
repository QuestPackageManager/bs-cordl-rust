#[cfg(feature = "cordl_class_Oculus+Platform+Models+ApplicationVersion")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ApplicationVersion")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::ApplicationVersion {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "ApplicationVersion";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ApplicationVersion")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::ApplicationVersion {
