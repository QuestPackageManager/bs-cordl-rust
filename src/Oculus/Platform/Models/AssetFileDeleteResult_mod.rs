#[cfg(feature = "cordl_class_Oculus+Platform+Models+AssetFileDeleteResult")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AssetFileDeleteResult")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::AssetFileDeleteResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "AssetFileDeleteResult";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AssetFileDeleteResult")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::AssetFileDeleteResult {
