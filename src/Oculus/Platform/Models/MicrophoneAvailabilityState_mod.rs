#[cfg(feature = "cordl_class_Oculus+Platform+Models+MicrophoneAvailabilityState")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Oculus+Platform+Models+MicrophoneAvailabilityState")]
impl std::ops::DerefMut for crate::Oculus::Platform::Models::MicrophoneAvailabilityState {
