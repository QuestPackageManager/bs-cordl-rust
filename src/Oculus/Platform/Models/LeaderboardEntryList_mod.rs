#[cfg(feature = "cordl_class_Oculus+Platform+Models+LeaderboardEntryList")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LeaderboardEntryList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::LeaderboardEntryList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "LeaderboardEntryList";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LeaderboardEntryList")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::LeaderboardEntryList {
