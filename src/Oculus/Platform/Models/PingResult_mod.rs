#[cfg(feature = "cordl_class_Oculus+Platform+Models+PingResult")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Oculus::Platform::Models::PingResult {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (id, pingTimeUsec))?
        };
        Ok(__cordl_ret.into())
    }
