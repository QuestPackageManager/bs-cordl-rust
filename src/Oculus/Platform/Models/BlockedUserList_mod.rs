...
for crate::Oculus::Platform::Models::BlockedUserList {
    ...
    const CLASS_NAME: &'static str = "BlockedUserList";
...
#[cfg(feature = "Oculus+Platform+Models+BlockedUserList")]
impl crate::Oculus::Platform::Models::BlockedUserList {
    pub fn New(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::BlockedUserList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::BlockedUserList as
