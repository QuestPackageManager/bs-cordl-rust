#[cfg(feature = "cordl_class_Oculus+Platform+Models+AvatarEditorResult")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AvatarEditorResult")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::AvatarEditorResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "AvatarEditorResult";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AvatarEditorResult")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::AvatarEditorResult {
