...
pub struct NetSyncVoipAttenuationValueList {
    __cordl_parent: crate::Oculus::Platform::Models::DeserializableList_1<
        quest_hook::libil2cpp::Gc<
            crate::Oculus::Platform::Models::NetSyncVoipAttenuationValue,
        >,
    >,
}
#[cfg(feature = "Oculus+Platform+Models+NetSyncVoipAttenuationValueList")]
...
for crate::Oculus::Platform::Models::NetSyncVoipAttenuationValueList {
    ...
    const CLASS_NAME: &'static str = "NetSyncVoipAttenuationValueList";
...
impl crate::Oculus::Platform::Models::NetSyncVoipAttenuationValueList {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::NetSyncVoipAttenuationValueList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList as
