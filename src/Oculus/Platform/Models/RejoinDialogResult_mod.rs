...
for crate::Oculus::Platform::Models::RejoinDialogResult {
    ...
    const CLASS_NAME: &'static str = "RejoinDialogResult";
...
#[cfg(feature = "Oculus+Platform+Models+RejoinDialogResult")]
impl crate::Oculus::Platform::Models::RejoinDialogResult {
    pub fn New(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::RejoinDialogResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::RejoinDialogResult as
