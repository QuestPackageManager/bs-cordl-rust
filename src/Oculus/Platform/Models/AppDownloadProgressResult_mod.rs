...
for crate::Oculus::Platform::Models::AppDownloadProgressResult {
    ...
    const CLASS_NAME: &'static str = "AppDownloadProgressResult";
...
impl crate::Oculus::Platform::Models::AppDownloadProgressResult {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::AppDownloadProgressResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::AppDownloadProgressResult as
