#[cfg(feature = "cordl_class_Oculus+Platform+Models+LaunchBlockFlowResult")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LaunchBlockFlowResult")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::LaunchBlockFlowResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "LaunchBlockFlowResult";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LaunchBlockFlowResult")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::LaunchBlockFlowResult {
