#[cfg(feature = "cordl_class_Oculus+Platform+Models+HttpTransferUpdate")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+HttpTransferUpdate")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::HttpTransferUpdate {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "HttpTransferUpdate";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+HttpTransferUpdate")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::HttpTransferUpdate {
