#[cfg(feature = "cordl_class_Oculus+Platform+Models+Leaderboard")]
#[repr(C)]
#[derive(Debug)]
pub struct Leaderboard {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub ApiName: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub DestinationOptional:
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::Destination>,
    pub Destination: quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::Destination>,
    pub _cordl_ID: u64,
}
#[cfg(feature = "cordl_class_Oculus+Platform+Models+Leaderboard")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::Leaderboard {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "Leaderboard";
