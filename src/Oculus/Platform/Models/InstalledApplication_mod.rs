#[cfg(feature = "cordl_class_Oculus+Platform+Models+InstalledApplication")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+InstalledApplication")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::InstalledApplication {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "InstalledApplication";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+InstalledApplication")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::InstalledApplication {
