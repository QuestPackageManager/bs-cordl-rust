...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ShareMediaResult")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::ShareMediaResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "ShareMediaResult";
...
#[cfg(feature = "Oculus+Platform+Models+ShareMediaResult")]
impl crate::Oculus::Platform::Models::ShareMediaResult {
    pub fn New(
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ShareMediaResult")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::ShareMediaResult {
