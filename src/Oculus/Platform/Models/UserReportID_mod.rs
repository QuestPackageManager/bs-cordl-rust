...
for crate::Oculus::Platform::Models::UserReportID {
    ...
    const CLASS_NAME: &'static str = "UserReportID";
...
#[cfg(feature = "Oculus+Platform+Models+UserReportID")]
impl crate::Oculus::Platform::Models::UserReportID {
    pub fn New(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::UserReportID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::UserReportID as
