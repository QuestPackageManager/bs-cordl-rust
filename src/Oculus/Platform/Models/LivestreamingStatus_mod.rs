#[cfg(feature = "cordl_class_Oculus+Platform+Models+LivestreamingStatus")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LivestreamingStatus")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::LivestreamingStatus {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "LivestreamingStatus";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LivestreamingStatus")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::LivestreamingStatus {
