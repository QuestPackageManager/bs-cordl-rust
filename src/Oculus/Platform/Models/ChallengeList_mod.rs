#[cfg(feature = "cordl_class_Oculus+Platform+Models+ChallengeList")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ChallengeList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::ChallengeList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "ChallengeList";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ChallengeList")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::ChallengeList {
