#[cfg(feature = "cordl_class_Oculus+Platform+Models+Error")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+Error")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::Error {
...
impl crate::Oculus::Platform::Models::Error {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (code, message, httpCode))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Oculus+Platform+Models+Error")]
