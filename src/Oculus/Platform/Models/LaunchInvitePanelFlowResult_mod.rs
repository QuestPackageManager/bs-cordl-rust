#[cfg(feature = "cordl_class_Oculus+Platform+Models+LaunchInvitePanelFlowResult")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Oculus+Platform+Models+LaunchInvitePanelFlowResult")]
impl std::ops::DerefMut for crate::Oculus::Platform::Models::LaunchInvitePanelFlowResult {
