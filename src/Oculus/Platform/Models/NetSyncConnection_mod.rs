#[cfg(feature = "cordl_class_Oculus+Platform+Models+NetSyncConnection")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+NetSyncConnection")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::NetSyncConnection {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "NetSyncConnection";
...
#[cfg(feature = "Oculus+Platform+Models+NetSyncConnection")]
impl std::ops::DerefMut for crate::Oculus::Platform::Models::NetSyncConnection {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Oculus+Platform+Models+NetSyncConnection")]
impl crate::Oculus::Platform::Models::NetSyncConnection {
    pub fn New(
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+NetSyncConnection")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::NetSyncConnection {
