...
for crate::Oculus::Platform::Models::LivestreamingVideoStats {
    ...
    const CLASS_NAME: &'static str = "LivestreamingVideoStats";
...
impl crate::Oculus::Platform::Models::LivestreamingVideoStats {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::LivestreamingVideoStats as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::LivestreamingVideoStats as
