#[cfg(feature = "cordl_class_Oculus+Platform+Models+AchievementProgress")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AchievementProgress")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::AchievementProgress {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "AchievementProgress";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AchievementProgress")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::AchievementProgress {
