#[cfg(feature = "cordl_class_Oculus+Platform+Models+ApplicationInvite")]
#[repr(C)]
#[derive(Debug)]
pub struct ApplicationInvite {
    ...
    pub RecipientOptional: quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::User>,
    pub Recipient: quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::User>,
}
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ApplicationInvite")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::ApplicationInvite {
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+ApplicationInvite")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::ApplicationInvite {
