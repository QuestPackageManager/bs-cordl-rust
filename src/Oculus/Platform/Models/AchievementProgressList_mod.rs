...
for crate::Oculus::Platform::Models::AchievementProgressList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "AchievementProgressList";
...
#[cfg(feature = "Oculus+Platform+Models+AchievementProgressList")]
impl std::ops::DerefMut for crate::Oculus::Platform::Models::AchievementProgressList {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Oculus+Platform+Models+AchievementProgressList")]
impl crate::Oculus::Platform::Models::AchievementProgressList {
    pub fn New(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::AchievementProgressList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::AchievementProgressList as
