...
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::SdkAccount {
    ...
    const CLASS_NAME: &'static str = "SdkAccount";
...
impl crate::Oculus::Platform::Models::SdkAccount {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::SdkAccount as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::SdkAccount as
