...
for crate::Oculus::Platform::Models::LaunchUnblockFlowResult {
    ...
    const CLASS_NAME: &'static str = "LaunchUnblockFlowResult";
...
#[cfg(feature = "Oculus+Platform+Models+LaunchUnblockFlowResult")]
impl crate::Oculus::Platform::Models::LaunchUnblockFlowResult {
    pub fn New(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::LaunchUnblockFlowResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::LaunchUnblockFlowResult as
