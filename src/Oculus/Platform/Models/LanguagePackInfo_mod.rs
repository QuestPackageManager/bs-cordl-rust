#[cfg(feature = "cordl_class_Oculus+Platform+Models+LanguagePackInfo")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LanguagePackInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::LanguagePackInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "LanguagePackInfo";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+LanguagePackInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::LanguagePackInfo {
