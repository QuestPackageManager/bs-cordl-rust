#[cfg(feature = "cordl_class_Oculus+Platform+Models+AssetDetailsList")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AssetDetailsList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Models::AssetDetailsList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform.Models";
    const CLASS_NAME: &'static str = "AssetDetailsList";
...
#[cfg(feature = "cordl_class_Oculus+Platform+Models+AssetDetailsList")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::Models::AssetDetailsList {
