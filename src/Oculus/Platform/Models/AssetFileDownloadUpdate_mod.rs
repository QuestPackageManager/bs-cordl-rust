...
for crate::Oculus::Platform::Models::AssetFileDownloadUpdate {
    ...
    const CLASS_NAME: &'static str = "AssetFileDownloadUpdate";
...
impl crate::Oculus::Platform::Models::AssetFileDownloadUpdate {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Models::AssetFileDownloadUpdate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Models::AssetFileDownloadUpdate as
