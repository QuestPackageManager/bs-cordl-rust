#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithLeaderboardList")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithLeaderboardList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithLeaderboardList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithLeaderboardList";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithLeaderboardList")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithLeaderboardList {
