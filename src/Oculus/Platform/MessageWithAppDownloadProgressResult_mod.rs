...
for crate::Oculus::Platform::MessageWithAppDownloadProgressResult {
    ...
    const CLASS_NAME: &'static str = "MessageWithAppDownloadProgressResult";
...
#[cfg(feature = "Oculus+Platform+MessageWithAppDownloadProgressResult")]
impl crate::Oculus::Platform::MessageWithAppDownloadProgressResult {
    pub fn GetAppDownloadProgressResult(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAppDownloadProgressResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::AppDownloadProgressResult,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAppDownloadProgressResult as
