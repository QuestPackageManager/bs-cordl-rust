...
for crate::Oculus::Platform::MessageWithAbuseReportRecording {
    ...
    const CLASS_NAME: &'static str = "MessageWithAbuseReportRecording";
...
impl crate::Oculus::Platform::MessageWithAbuseReportRecording {
    pub fn GetAbuseReportRecording(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::AbuseReportRecording>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAbuseReportRecording as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAbuseReportRecording as
                    quest_hook::libil2cpp::Type > ::class(), "GetAbuseReportRecording",
                    0usize
                )
            });
