...
#[cfg(feature = "cordl_class_Oculus+Platform+LivestreamingMicrophoneStatus")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::LivestreamingMicrophoneStatus {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "LivestreamingMicrophoneStatus";
