...
for crate::Oculus::Platform::MessageWithPartyUpdateNotification {
    ...
    const CLASS_NAME: &'static str = "MessageWithPartyUpdateNotification";
...
impl crate::Oculus::Platform::MessageWithPartyUpdateNotification {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithPartyUpdateNotification as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::PartyUpdateNotification,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithPartyUpdateNotification as
