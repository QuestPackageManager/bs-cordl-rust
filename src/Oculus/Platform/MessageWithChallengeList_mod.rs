#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithChallengeList")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithChallengeList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithChallengeList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithChallengeList";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithChallengeList")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithChallengeList {
