...
impl crate::Oculus::Platform::MessageWithChallengeList {
    pub fn GetChallengeList(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::ChallengeList>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithChallengeList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithChallengeList as
                    quest_hook::libil2cpp::Type > ::class(), "GetChallengeList", 0usize
                )
            });
