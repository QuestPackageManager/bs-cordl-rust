...
#[cfg(feature = "Oculus+Platform+AndroidPlatform")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::AndroidPlatform {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "AndroidPlatform";
...
impl crate::Oculus::Platform::AndroidPlatform {
    pub fn AsyncInitialize(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::AndroidPlatform as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::AndroidPlatform as
