...
for crate::Oculus::Platform::MessageWithLivestreamingVideoStats {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithLivestreamingVideoStats";
...
#[cfg(feature = "Oculus+Platform+MessageWithLivestreamingVideoStats")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithLivestreamingVideoStats {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Oculus+Platform+MessageWithLivestreamingVideoStats")]
impl crate::Oculus::Platform::MessageWithLivestreamingVideoStats {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLivestreamingVideoStats as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::LivestreamingVideoStats,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLivestreamingVideoStats as
