...
for crate::Oculus::Platform::MessageWithLivestreamingStatus {
    ...
    const CLASS_NAME: &'static str = "MessageWithLivestreamingStatus";
...
impl crate::Oculus::Platform::MessageWithLivestreamingStatus {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::LivestreamingStatus>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLivestreamingStatus as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLivestreamingStatus as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLivestreamingStatus as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithLivestreamingStatus as
                    quest_hook::libil2cpp::Type > ::class(), "GetLivestreamingStatus",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
