...
#[cfg(feature = "Oculus+Platform+VoipPCMSourceNative")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Oculus::Platform::IVoipPCMSource>>
for crate::Oculus::Platform::VoipPCMSourceNative {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::Oculus::Platform::IVoipPCMSource> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Oculus+Platform+VoipPCMSourceNative")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Oculus::Platform::IVoipPCMSource>>
for crate::Oculus::Platform::VoipPCMSourceNative {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Oculus::Platform::IVoipPCMSource> {
        unsafe { std::mem::transmute(self) }
    }
}
