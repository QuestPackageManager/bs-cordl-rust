...
#[cfg(feature = "cordl_class_Oculus+Platform+VoipAudioSourceHiLevel")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::VoipAudioSourceHiLevel {
...
impl crate::Oculus::Platform::VoipAudioSourceHiLevel {
    ...
    pub type FilterReadDelegate =
        crate::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate;
    ...
    pub fn CreatePCMSource(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CreatePCMSource")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn MSToElements(ms: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32), i32, 1usize>("MSToElements")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (ms))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SampleRateToEnum(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), crate::Oculus::Platform::VoipSampleRate, 1usize>(
                        "SampleRateToEnum",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Oculus::Platform::VoipSampleRate =
            unsafe { cordl_method_info.invoke_unchecked(self, (rate))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_senderID(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u64), quest_hook::libil2cpp::Void, 1usize>("set_senderID")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Oculus+Platform+VoipAudioSourceHiLevel")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::VoipAudioSourceHiLevel {
...
pub struct VoipAudioSourceHiLevel_FilterReadDelegate {
    ...
    pub scratchBuffer: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
}
#[cfg(feature = "cordl_class_Oculus+Platform+VoipAudioSourceHiLevel+FilterReadDelegate")]
    ...
    for crate::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "VoipAudioSourceHiLevel/FilterReadDelegate";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "Oculus+Platform+VoipAudioSourceHiLevel+FilterReadDelegate")]
impl std::ops::Deref for crate::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate {
    type Target = crate::UnityEngine::MonoBehaviour;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "Oculus+Platform+VoipAudioSourceHiLevel+FilterReadDelegate")]
impl std::ops::DerefMut for crate::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate {
    ...
    pub fn OnAudioFilterRead(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("OnAudioFilterRead")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, channels))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
