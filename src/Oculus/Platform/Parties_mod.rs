...
#[cfg(feature = "Oculus+Platform+Parties")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::Parties {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "Parties";
...
impl crate::Oculus::Platform::Parties {
    pub fn GetCurrent() -> quest_hook::libil2cpp::Result<
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Parties as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Request_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Parties as quest_hook::libil2cpp::Type >
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Parties as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::Parties as quest_hook::libil2cpp::Type >
                    ::class(), "SetPartyUpdateNotificationCallback", 1usize
                )
            });
