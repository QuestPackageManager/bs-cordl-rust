...
for crate::Oculus::Platform::MessageWithLaunchBlockFlowResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithLaunchBlockFlowResult";
...
#[cfg(feature = "Oculus+Platform+MessageWithLaunchBlockFlowResult")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithLaunchBlockFlowResult {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Oculus+Platform+MessageWithLaunchBlockFlowResult")]
impl crate::Oculus::Platform::MessageWithLaunchBlockFlowResult {
    pub fn GetDataFromMessage(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::LaunchBlockFlowResult>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLaunchBlockFlowResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLaunchBlockFlowResult as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLaunchBlockFlowResult as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::MessageWithLaunchBlockFlowResult as
                    quest_hook::libil2cpp::Type > ::class(), "GetLaunchBlockFlowResult",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
