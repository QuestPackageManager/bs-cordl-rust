...
#[cfg(feature = "cordl_class_Oculus+Platform+MultiplayerErrorOptions")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MultiplayerErrorOptions {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MultiplayerErrorOptions";
...
#[cfg(feature = "Oculus+Platform+MultiplayerErrorOptions")]
impl crate::Oculus::Platform::MultiplayerErrorOptions {
    ...
    pub fn op_Explicit(
        options: quest_hook::libil2cpp::Gc<crate::Oculus::Platform::MultiplayerErrorOptions>,
...
#[cfg(feature = "cordl_class_Oculus+Platform+MultiplayerErrorOptions")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MultiplayerErrorOptions {
