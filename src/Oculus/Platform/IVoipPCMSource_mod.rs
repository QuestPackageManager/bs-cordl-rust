#[cfg(feature = "cordl_class_Oculus+Platform+IVoipPCMSource")]
...
impl crate::Oculus::Platform::IVoipPCMSource {
    pub fn GetPCM(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (dest, length))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetSenderID(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (senderID))? };
        Ok(__cordl_ret.into())
    }
