...
#[cfg(feature = "Oculus+Platform+IVoipPCMSource")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::IVoipPCMSource {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "IVoipPCMSource";
...
impl crate::Oculus::Platform::IVoipPCMSource {
    pub fn GetPCM(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::IVoipPCMSource as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::IVoipPCMSource as
                    quest_hook::libil2cpp::Type > ::class(), "GetPCM", 2usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::IVoipPCMSource as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::IVoipPCMSource as
                    quest_hook::libil2cpp::Type > ::class(), "PeekSizeElements", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::IVoipPCMSource as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::IVoipPCMSource as
                    quest_hook::libil2cpp::Type > ::class(), "SetSenderID", 1usize
                )
            });
