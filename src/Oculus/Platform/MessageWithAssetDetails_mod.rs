#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithAssetDetails")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithAssetDetails")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::MessageWithAssetDetails {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "MessageWithAssetDetails";
...
#[cfg(feature = "cordl_class_Oculus+Platform+MessageWithAssetDetails")]
impl quest_hook::libil2cpp::ObjectType for crate::Oculus::Platform::MessageWithAssetDetails {
