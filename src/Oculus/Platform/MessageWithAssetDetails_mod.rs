...
impl crate::Oculus::Platform::MessageWithAssetDetails {
    pub fn GetAssetDetails(
        ...
        quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::AssetDetails>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithAssetDetails as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Models::AssetDetails>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithAssetDetails as
                    quest_hook::libil2cpp::Type > ::class(), "GetAssetDetails", 0usize
                )
            });
