...
impl crate::Oculus::Platform::Entitlements {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::Entitlements as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Oculus::Platform::Request>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::Entitlements as quest_hook::libil2cpp::Type
                    > ::class(), "IsUserEntitledToApplication", 0usize
                )
            });
