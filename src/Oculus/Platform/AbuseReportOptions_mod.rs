...
#[cfg(feature = "Oculus+Platform+AbuseReportOptions")]
unsafe impl quest_hook::libil2cpp::Type for crate::Oculus::Platform::AbuseReportOptions {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Oculus.Platform";
    const CLASS_NAME: &'static str = "AbuseReportOptions";
...
impl crate::Oculus::Platform::AbuseReportOptions {
    pub fn Finalize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::AbuseReportOptions as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Finalize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::AbuseReportOptions as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::AbuseReportOptions as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Oculus::Platform::AbuseReportOptions as
                    quest_hook::libil2cpp::Type > ::class(), "SetPreventPeopleChooser",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn op_Explicit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::AbuseReportOptions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<crate::Oculus::Platform::AbuseReportOptions>),
                crate::System::IntPtr,
                1usize,
            >("op_Explicit")
            .unwrap_or_else(|e| {
