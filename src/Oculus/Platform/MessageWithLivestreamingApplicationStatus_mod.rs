...
for crate::Oculus::Platform::MessageWithLivestreamingApplicationStatus {
    ...
    const CLASS_NAME: &'static str = "MessageWithLivestreamingApplicationStatus";
...
impl crate::Oculus::Platform::MessageWithLivestreamingApplicationStatus {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLivestreamingApplicationStatus as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::LivestreamingApplicationStatus,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLivestreamingApplicationStatus
