...
impl std::ops::Deref for crate::Oculus::Platform::MessageWithLivestreamingApplicationStatus {
...
#[cfg(feature = "Oculus+Platform+MessageWithLivestreamingApplicationStatus")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithLivestreamingApplicationStatus {
