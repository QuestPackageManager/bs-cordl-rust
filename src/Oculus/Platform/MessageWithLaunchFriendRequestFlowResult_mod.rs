...
impl std::ops::Deref for crate::Oculus::Platform::MessageWithLaunchFriendRequestFlowResult {
...
#[cfg(feature = "Oculus+Platform+MessageWithLaunchFriendRequestFlowResult")]
impl std::ops::DerefMut for crate::Oculus::Platform::MessageWithLaunchFriendRequestFlowResult {
