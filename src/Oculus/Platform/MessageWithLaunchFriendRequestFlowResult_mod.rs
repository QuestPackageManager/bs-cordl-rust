...
#[repr(C)]
#[derive(Debug)]
pub struct MessageWithLaunchFriendRequestFlowResult {
...
for crate::Oculus::Platform::MessageWithLaunchFriendRequestFlowResult {
    ...
    const CLASS_NAME: &'static str = "MessageWithLaunchFriendRequestFlowResult";
...
#[cfg(feature = "Oculus+Platform+MessageWithLaunchFriendRequestFlowResult")]
impl crate::Oculus::Platform::MessageWithLaunchFriendRequestFlowResult {
    pub fn GetDataFromMessage(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Oculus::Platform::MessageWithLaunchFriendRequestFlowResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::System::IntPtr),
                quest_hook::libil2cpp::Gc<
                    crate::Oculus::Platform::Models::LaunchFriendRequestFlowResult,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Oculus::Platform::MessageWithLaunchFriendRequestFlowResult as
