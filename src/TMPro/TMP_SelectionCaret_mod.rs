...
#[cfg(feature = "TMPro+TMP_SelectionCaret")]
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::TMP_SelectionCaret {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "TMPro";
    const CLASS_NAME: &'static str = "TMP_SelectionCaret";
...
impl crate::TMPro::TMP_SelectionCaret {
    pub fn Cull(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_SelectionCaret as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::TMP_SelectionCaret as quest_hook::libil2cpp::Type >
                    ::class(), "Cull", 2usize
                )
            });
