...
impl crate::TMPro::TMP_SubMesh {
    pub fn AddSubTextObject(
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::TMPro::TMP_SubMesh>> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Gc<crate::TMPro::TMP_SubMesh>, 2usize>(
                        "AddSubTextObject",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::TMPro::TMP_SubMesh> =
