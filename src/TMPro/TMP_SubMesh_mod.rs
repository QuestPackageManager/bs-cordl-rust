...
impl crate::TMPro::TMP_SubMesh {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_SubMesh as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::TMP_SubMesh as quest_hook::libil2cpp::Type >
