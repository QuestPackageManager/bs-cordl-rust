...
impl crate::TMPro::TMP_FontFeatureTable {
    ...
    pub fn SortGlyphPairAdjustmentRecords(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_FontFeatureTable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::TMP_FontFeatureTable as quest_hook::libil2cpp::Type >
                    ::class(), "SortGlyphPairAdjustmentRecords", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_FontFeatureTable as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::TMP_FontFeatureTable as quest_hook::libil2cpp::Type >
                    ::class(), "get_glyphPairAdjustmentRecords", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_FontFeatureTable as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::TMP_FontFeatureTable as quest_hook::libil2cpp::Type >
                    ::class(), "set_glyphPairAdjustmentRecords", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
