#[cfg(feature = "cordl_class_TMPro+TMP_Glyph")]
#[repr(C)]
...
impl crate::TMPro::TMP_Glyph {
    pub fn Clone(
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Glyph>> {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Glyph> =
