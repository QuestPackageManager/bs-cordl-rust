...
impl crate::TMPro::TMP_Glyph {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_Glyph as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Glyph>),
                quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Glyph>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::TMP_Glyph as quest_hook::libil2cpp::Type > ::class(),
                    "Clone", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Glyph> = unsafe {
