#[cfg(feature = "cordl_class_TMPro+TMP_TextInfo")]
#[repr(C)]
...
pub struct TMP_TextInfo {
    ...
    >,
    pub wordInfo:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::TMPro::TMP_WordInfo>>,
    pub linkInfo:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::TMPro::TMP_LinkInfo>>,
    pub lineInfo:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::TMPro::TMP_LineInfo>>,
    pub pageInfo:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::TMPro::TMP_PageInfo>>,
    pub meshInfo:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::TMPro::TMP_MeshInfo>>,
    pub m_CachedMeshInfo:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::TMPro::TMP_MeshInfo>>,
}
#[cfg(feature = "cordl_class_TMPro+TMP_TextInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::TMP_TextInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "TMPro";
    const CLASS_NAME: &'static str = "TMP_TextInfo";
...
impl crate::TMPro::TMP_TextInfo {
    ...
    pub fn ClearAllData(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearAllData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ClearAllMeshInfo(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearAllMeshInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ResetVertexLayout(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("ResetVertexLayout")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (isVolumetric))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_TMP_Text2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (textComponent))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_1(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (characterCount))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_TMPro+TMP_TextInfo")]
