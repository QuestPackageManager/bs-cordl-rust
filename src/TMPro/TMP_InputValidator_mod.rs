...
impl crate::TMPro::TMP_InputValidator {
    ...
    pub fn Validate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_InputValidator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::TMP_InputValidator as quest_hook::libil2cpp::Type >
