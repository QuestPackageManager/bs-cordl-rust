...
impl crate::TMPro::KerningPair {
    ...
    pub fn _ctor_u32_u32_f32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (left, right, offset))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_firstGlyphAdjustments(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::TMPro::GlyphValueRecord_Legacy, 0usize>(
        ...
        let __cordl_ret: crate::TMPro::GlyphValueRecord_Legacy =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_ignoreSpacingAdjustments(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
