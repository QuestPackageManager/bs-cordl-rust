#[cfg(feature = "cordl_class_TMPro+TextOverflowModes")]
...
#[cfg(feature = "cordl_class_TMPro+TextOverflowModes")]
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::TextOverflowModes {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "TMPro";
    const CLASS_NAME: &'static str = "TextOverflowModes";
