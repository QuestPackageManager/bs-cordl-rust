...
#[cfg(feature = "TMPro+FastAction_1")]
impl<A: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::TMPro::FastAction_1<A> {
...
impl<A: quest_hook::libil2cpp::Type> crate::TMPro::FastAction_1<A> {
    ...
    pub fn Call(&mut self, a: A) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        A: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
