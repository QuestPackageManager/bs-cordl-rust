...
> crate::TMPro::FastAction_3<A, B, C> {
    ...
    where
        ...
        C: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::FastAction_3<
            A,
            B,
            C,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::FastAction_3 < A, B, C > as
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::FastAction_3<
            ...
            C,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(A, B, C), quest_hook::libil2cpp::Void, 3usize>("Call")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::FastAction_3 < A, B, C > as
