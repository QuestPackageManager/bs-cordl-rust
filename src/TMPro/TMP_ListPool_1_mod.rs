#[cfg(feature = "cordl_class_TMPro+TMP_ListPool_1")]
#[repr(C)]
    ...
    for crate::TMPro::TMP_ListPool_1<T>
{
    ...
    const CLASS_NAME: &'static str = "TMP_ListPool`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("TMPro", "TMP_ListPool`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::TMPro::TMP_ListPool_1<T> {
...
#[cfg(feature = "TMPro+TMP_ListPool_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::TMPro::TMP_ListPool_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::TMPro::TMP_ListPool_1<T> {
    ...
    pub fn Release(
        toRelease: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<T>>,
