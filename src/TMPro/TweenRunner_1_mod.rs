...
pub struct TweenRunner_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_CoroutineContainer: quest_hook::libil2cpp::Gc<crate::UnityEngine::MonoBehaviour>,
    ...
    for crate::TMPro::TweenRunner_1<T>
{
    ...
    const CLASS_NAME: &'static str = "TweenRunner`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("TMPro", "TweenRunner`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "TMPro+TweenRunner_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::TMPro::TweenRunner_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::TMPro::TweenRunner_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (coroutineContainer))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T), quest_hook::libil2cpp::Void, 1usize>("StartTween")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn StopTween(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
