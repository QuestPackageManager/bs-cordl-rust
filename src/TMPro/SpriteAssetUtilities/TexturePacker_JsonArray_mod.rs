...
impl crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray as
...
impl crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteDataObject {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteDataObject as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
...
impl crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteFrame {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteFrame as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteFrame as
...
impl crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize {
    pub fn ToString(
        ...
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize as
                    quest_hook::libil2cpp::Type > ::class(), "ToString", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
