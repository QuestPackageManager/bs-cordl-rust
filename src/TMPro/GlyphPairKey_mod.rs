...
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::GlyphPairKey {
    ...
    const CLASS_NAME: &'static str = "GlyphPairKey";
...
impl crate::TMPro::GlyphPairKey {
    pub fn _ctor_TMP_GlyphPairAdjustmentRecord1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::GlyphPairKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::GlyphPairKey as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 1usize
                )
            });
    ...
    pub fn _ctor_u32_u32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (firstGlyphIndex, secondGlyphIndex))?
        };
        Ok(__cordl_ret.into())
    }
}
