...
impl crate::TMPro::KerningTable {
    pub fn AddGlyphPairAdjustmentRecord(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        u32,
                        crate::TMPro::GlyphValueRecord_Legacy,
                    ), i32, 4usize>("AddGlyphPairAdjustmentRecord")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (first, firstAdjustments, second, secondAdjustments))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AddKerningPair_u32_u32_f32_1(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (first, second, offset))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RemoveKerningPair_i32_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("RemoveKerningPair")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
