...
impl crate::TMPro::ITweenValue {
    pub fn TweenValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::ITweenValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("TweenValue")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::ITweenValue as quest_hook::libil2cpp::Type >
                    ::class(), "TweenValue", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::ITweenValue as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::ITweenValue as quest_hook::libil2cpp::Type >
                    ::class(), "get_ignoreTimeScale", 0usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
