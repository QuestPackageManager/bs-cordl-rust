...
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::Extents {
    ...
    const CLASS_NAME: &'static str = "Extents";
...
impl crate::TMPro::Extents {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::Extents as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::Extents as quest_hook::libil2cpp::Type > ::class(),
                    "ToString", 0usize
                )
            });
