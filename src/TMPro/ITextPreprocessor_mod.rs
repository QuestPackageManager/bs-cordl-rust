...
#[cfg(feature = "TMPro+ITextPreprocessor")]
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::ITextPreprocessor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "TMPro";
    const CLASS_NAME: &'static str = "ITextPreprocessor";
...
impl crate::TMPro::ITextPreprocessor {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::ITextPreprocessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::ITextPreprocessor as quest_hook::libil2cpp::Type >
                    ::class(), "PreprocessText", 1usize
                )
            });
