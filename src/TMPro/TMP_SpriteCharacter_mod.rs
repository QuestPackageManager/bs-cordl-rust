...
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::TMP_SpriteCharacter {
    ...
    const CLASS_NAME: &'static str = "TMP_SpriteCharacter";
...
impl crate::TMPro::TMP_SpriteCharacter {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_SpriteCharacter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::TMP_SpriteCharacter as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
    ...
    pub fn _ctor_u32_TMP_SpriteAsset_TMP_SpriteGlyph2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (unicode, spriteAsset, glyph))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_u32_TMP_SpriteGlyph1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_SpriteCharacter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (u32, quest_hook::libil2cpp::Gc<crate::TMPro::TMP_SpriteGlyph>),
                quest_hook::libil2cpp::Void,
                2usize,
            >(".ctor")
            .unwrap_or_else(|e| {
