...
#[cfg(feature = "TMPro+TMP_StyleSheet")]
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::TMP_StyleSheet {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "TMPro";
    const CLASS_NAME: &'static str = "TMP_StyleSheet";
...
impl crate::TMPro::TMP_StyleSheet {
    pub fn GetStyle_Il2CppString1(
        ...
        quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Style>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_StyleSheet as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::TMP_StyleSheet as quest_hook::libil2cpp::Type >
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::TMP_StyleSheet as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::TMP_StyleSheet as quest_hook::libil2cpp::Type >
                    ::class(), "LoadStyleDictionaryInternal", 0usize
                )
            });
