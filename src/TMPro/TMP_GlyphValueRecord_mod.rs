...
impl crate::TMPro::TMP_GlyphValueRecord {
    pub fn _ctor_GlyphValueRecord2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (valueRecord))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_f32_f32_f32_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (xPlacement, yPlacement, xAdvance, yAdvance))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn op_Addition(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::TMPro::TMP_GlyphValueRecord,
                    ), crate::TMPro::TMP_GlyphValueRecord, 2usize>("op_Addition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::TMPro::TMP_GlyphValueRecord =
