...
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::VertexGradient {
    ...
    const CLASS_NAME: &'static str = "VertexGradient";
...
impl crate::TMPro::VertexGradient {
    pub fn _ctor_Color0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::VertexGradient as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::VertexGradient as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 1usize
                )
            });
