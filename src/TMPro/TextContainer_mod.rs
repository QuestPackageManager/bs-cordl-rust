...
impl crate::TMPro::TextContainer {
    ...
    pub fn GetAnchorPosition(
        ...
        let __cordl_ret: crate::TMPro::TextContainerAnchors = unsafe {
            cordl_method_info.invoke_unchecked(self, (pivot))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetPivot(
