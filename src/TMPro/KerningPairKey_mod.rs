...
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::KerningPairKey {
    ...
    const CLASS_NAME: &'static str = "KerningPairKey";
...
impl crate::TMPro::KerningPairKey {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::KerningPairKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<(u32, u32), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::KerningPairKey as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ascii_left, ascii_right))?
        };
        Ok(__cordl_ret.into())
    }
}
