...
unsafe impl quest_hook::libil2cpp::Type for crate::TMPro::FastAction {
    ...
    const CLASS_NAME: &'static str = "FastAction";
...
impl crate::TMPro::FastAction {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::FastAction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::System::Action>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::TMPro::FastAction as quest_hook::libil2cpp::Type > ::class(),
                    "Add", 1usize
                )
            });
    ...
    pub fn Call(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::TMPro::FastAction as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Call")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::TMPro::FastAction as quest_hook::libil2cpp::Type > ::class(),
