...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkix+PkixBuilderParameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkix::PkixBuilderParameters {
...
impl crate::Org::BouncyCastle::Pkix::PkixBuilderParameters {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Pkix::PkixBuilderParameters,
        > = unsafe { cordl_method_info.invoke_unchecked((), (pkixParams))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn SetExcludedCerts(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Utilities::Collections::ISet,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetExcludedCerts")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (excludedCerts))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetParams(
        &mut self,
        parameters: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Pkix::PkixParameters>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (trustAnchors, targetConstraints))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_MaxPathLength(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_MaxPathLength")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkix+PkixBuilderParameters")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Pkix::PkixBuilderParameters {
