...
impl crate::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder {
    pub fn Build_IX509AttributeCertificate_X509Certificate_PkixBuilderParameters_IList1(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::X509::IX509AttributeCertificate,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder as
