...
pub struct TrustAnchor {
    ...
    pub pubKey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter>,
    pub caName: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub caPrincipal: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
    pub trustedCert: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::X509::X509Certificate>,
    pub ncBytes: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub nc: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::NameConstraints>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkix+TrustAnchor")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkix::TrustAnchor {
    ...
    const CLASS_NAME: &'static str = "TrustAnchor";
...
impl crate::Org::BouncyCastle::Pkix::TrustAnchor {
    pub fn New_Il2CppString_AsymmetricKeyParameter_Il2CppArray2(
        ...
        nameConstraints: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    pub fn New_X509Certificate_Il2CppArray0(
        trustedCert: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::X509::X509Certificate>,
        nameConstraints: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
    ...
    pub fn New_X509Name_AsymmetricKeyParameter_Il2CppArray1(
        caPrincipal: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
        pubKey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter>,
        nameConstraints: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
    ...
    pub fn _ctor_Il2CppString_AsymmetricKeyParameter_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (caName, pubKey, nameConstraints))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X509Certificate_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (trustedCert, nameConstraints))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X509Name_AsymmetricKeyParameter_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (caPrincipal, pubKey, nameConstraints))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_CA(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "get_CA",
                            0usize
                        )
                    })
            });
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        >,
                        0usize,
                    >("get_GetNameConstraints")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_GetNameConstraints", 0usize
                        )
                    })
            });
