...
#[cfg(feature = "Org+BouncyCastle+Pkix+PkixCertPathValidatorException")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Pkix::PkixCertPathValidatorException {
...
impl crate::Org::BouncyCastle::Pkix::PkixCertPathValidatorException {
    ...
    pub fn _ctor_Il2CppString_Exception2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, cause))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Exception_PkixCertPath_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, cause, certPath, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_CertPath(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Pkix::PkixCertPath> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
