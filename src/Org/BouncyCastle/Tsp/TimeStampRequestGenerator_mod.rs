#[cfg(feature = "cordl_class_Org+BouncyCastle+Tsp+TimeStampRequestGenerator")]
#[repr(C)]
#[derive(Debug)]
pub struct TimeStampRequestGenerator {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub reqPolicy: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
...
impl crate::Org::BouncyCastle::Tsp::TimeStampRequestGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Tsp::TimeStampRequest,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (digestAlgorithm, digest))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Tsp::TimeStampRequest,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (digestAlgorithm, digest, nonce))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Generate_Il2CppString_BigInteger1(
        &mut self,
        digestAlgorithmOid: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        digest: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        nonce: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Tsp::TimeStampRequest>,
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Tsp::TimeStampRequest,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (digestAlgorithmOid, digest, nonce))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetCertReq(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (certReq))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetReqPolicy(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (reqPolicy))? };
        Ok(__cordl_ret.into())
    }
