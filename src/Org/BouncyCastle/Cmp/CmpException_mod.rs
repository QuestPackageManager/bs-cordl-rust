...
#[repr(C)]
#[derive(Debug)]
pub struct CmpException {
    __cordl_parent: crate::System::Exception,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cmp+CmpException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cmp::CmpException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cmp";
    const CLASS_NAME: &'static str = "CmpException";
...
#[cfg(feature = "Org+BouncyCastle+Cmp+CmpException")]
impl crate::Org::BouncyCastle::Cmp::CmpException {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cmp+CmpException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cmp::CmpException {
