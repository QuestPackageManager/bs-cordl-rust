#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+IAsn1Convertible")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+IAsn1Convertible")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::IAsn1Convertible {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "IAsn1Convertible";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+IAsn1Convertible")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::IAsn1Convertible {
