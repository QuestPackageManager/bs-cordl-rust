...
impl crate::Org::BouncyCastle::Asn1::Ess::EssCertIDv2 {
    ...
    pub fn _ctor_AlgorithmIdentifier_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algId, certHash))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AlgorithmIdentifier_Il2CppArray_IssuerSerial4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algId, certHash, issuerSerial))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (certHash))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_IssuerSerial3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (certHash, issuerSerial))?
        };
        Ok(__cordl_ret.into())
    }
