#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+ContentIdentifier")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+ContentIdentifier")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Ess::ContentIdentifier {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Ess";
    const CLASS_NAME: &'static str = "ContentIdentifier";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+ContentIdentifier")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Ess::ContentIdentifier {
