...
impl crate::Org::BouncyCastle::Asn1::Ess::EssCertID {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Ess::EssCertID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Ess::EssCertID as
    ...
    pub fn _ctor_Il2CppArray_IssuerSerial2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (hash, issuerSerial))?
        };
        Ok(__cordl_ret.into())
    }
