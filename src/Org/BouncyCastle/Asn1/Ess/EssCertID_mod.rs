#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+EssCertID")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+EssCertID")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Ess::EssCertID {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Ess";
    const CLASS_NAME: &'static str = "EssCertID";
...
impl crate::Org::BouncyCastle::Asn1::Ess::EssCertID {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Ess::EssCertID> =
    ...
    pub fn _ctor_Il2CppArray_IssuerSerial2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hash, issuerSerial))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+EssCertID")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Ess::EssCertID {
