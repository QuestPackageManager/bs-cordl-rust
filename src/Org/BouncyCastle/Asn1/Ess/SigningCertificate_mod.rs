...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Asn1::Ess::SigningCertificate
...
impl crate::Org::BouncyCastle::Asn1::Ess::SigningCertificate {
    pub fn GetCerts(
        ...
        *mut quest_hook::libil2cpp::Il2CppArray<
            *mut crate::Org::BouncyCastle::Asn1::Ess::EssCertID,
        >,
    > {
    ...
    pub fn New_EssCertID1(
        essCertID: *mut crate::Org::BouncyCastle::Asn1::Ess::EssCertID,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
