#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+SigningCertificateV2")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Asn1::Ess::SigningCertificateV2
{
    ...
    const CLASS_NAME: &'static str = "SigningCertificateV2";
...
impl crate::Org::BouncyCastle::Asn1::Ess::SigningCertificateV2 {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Ess::SigningCertificateV2>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
