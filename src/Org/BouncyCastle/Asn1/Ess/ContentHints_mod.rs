#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+ContentHints")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct ContentHints {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub contentDescription:
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+ContentHints")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Ess::ContentHints {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Ess";
    const CLASS_NAME: &'static str = "ContentHints";
...
impl crate::Org::BouncyCastle::Asn1::Ess::ContentHints {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Ess::ContentHints>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Ess::ContentHints,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn _ctor_DerObjectIdentifier_DerUtf8String2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (contentType, contentDescription))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+ContentHints")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Ess::ContentHints {
