...
impl crate::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate {
    pub fn GetCerts(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate as
    ...
    pub fn _ctor_OtherCertID1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (otherCertID))?
        };
        Ok(__cordl_ret.into())
    }
}
