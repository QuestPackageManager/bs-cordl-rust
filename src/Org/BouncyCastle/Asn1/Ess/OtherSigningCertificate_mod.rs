#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+OtherSigningCertificate")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Ess+OtherSigningCertificate")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate {
...
impl crate::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn New_OtherCertID1(
        otherCertID: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Ess::OtherCertID>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_OtherCertID1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (otherCertID))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ess+OtherSigningCertificate")]
