...
pub struct PkiBody {
    ...
    pub tagNo: i32,
    pub body: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
}
#[cfg(feature = "Org+BouncyCastle+Asn1+Cmp+PkiBody")]
...
for crate::Org::BouncyCastle::Asn1::Cmp::PkiBody {
    ...
    const CLASS_NAME: &'static str = "PkiBody";
...
impl crate::Org::BouncyCastle::Asn1::Cmp::PkiBody {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cmp::PkiBody as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cmp::PkiBody as
                    quest_hook::libil2cpp::Type > ::class(), "GetBodyForType", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1Encodable,
        > = unsafe { method.invoke_unchecked((), (_cordl_type, o))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetInstance(
