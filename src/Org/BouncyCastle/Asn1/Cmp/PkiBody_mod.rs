#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+PkiBody")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+PkiBody")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cmp::PkiBody {
