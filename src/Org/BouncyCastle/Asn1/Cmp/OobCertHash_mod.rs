#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+OobCertHash")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+OobCertHash")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cmp::OobCertHash {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cmp";
    const CLASS_NAME: &'static str = "OobCertHash";
...
impl crate::Org::BouncyCastle::Asn1::Cmp::OobCertHash {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::OobCertHash>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Cmp::OobCertHash,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::CertId> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_HashAlg(
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+OobCertHash")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cmp::OobCertHash {
