#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+ErrorMsgContent")]
#[repr(C)]
...
pub struct ErrorMsgContent {
    ...
    pub errorDetails: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::PkiFreeText>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+ErrorMsgContent")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cmp";
    const CLASS_NAME: &'static str = "ErrorMsgContent";
...
impl crate::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn New_PkiStatusInfo_DerInteger_PkiFreeText2(
        ...
        errorDetails: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::PkiFreeText>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_PkiStatusInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pkiStatusInfo))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PkiStatusInfo_DerInteger_PkiFreeText2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pkiStatusInfo, errorCode, errorDetails))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+ErrorMsgContent")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent {
