...
pub struct CmpCertificate {
    ...
    pub x509v3PKCert: quest_hook::libil2cpp::Gc<
        crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure,
    >,
    pub x509v2AttrCert: quest_hook::libil2cpp::Gc<
...
for crate::Org::BouncyCastle::Asn1::Cmp::CmpCertificate {
    ...
    const CLASS_NAME: &'static str = "CmpCertificate";
...
impl crate::Org::BouncyCastle::Asn1::Cmp::CmpCertificate {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as
    ...
    pub fn New_X509CertificateStructure1(
        x509v3PKCert: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
    ...
    pub fn _ctor_AttributeCertificate0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (x509v2AttrCert))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X509CertificateStructure1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (x509v3PKCert))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_IsX509v3PKCert(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_IsX509v3PKCert")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as
                    quest_hook::libil2cpp::Type > ::class(), "get_IsX509v3PKCert", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as
                    quest_hook::libil2cpp::Type > ::class(), "get_X509v2AttrCert", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate as
                    quest_hook::libil2cpp::Type > ::class(), "get_X509v3PKCert", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure,
