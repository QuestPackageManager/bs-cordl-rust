#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cmp+PopoDecKeyRespContent")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyRespContent {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyRespContent>,
    > {
