#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSequence")]
#[repr(C)]
#[derive(Debug)]
pub struct BerSequence {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::DerSequence,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSequence")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::BerSequence {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "BerSequence";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+BerSequence")]
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::BerSequence {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+BerSequence")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::BerSequence {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Asn1+BerSequence")]
impl crate::Org::BouncyCastle::Asn1::BerSequence {
    pub fn Encode(
        &mut self,
    ...
    pub fn FromVector(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::BerSequence>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        >),
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::BerSequence,
                        >,
                        1usize,
                    >("FromVector")
                    .unwrap_or_else(|e| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::BerSequence> =
            unsafe { cordl_method_info.invoke_unchecked((), (elementVector))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Asn1EncodableVector3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (elementVector))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSequence")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::BerSequence {
