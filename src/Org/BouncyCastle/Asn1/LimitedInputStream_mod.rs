...
impl crate::Org::BouncyCastle::Asn1::LimitedInputStream {
    ...
    pub fn SetParentEofDetect(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::LimitedInputStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::LimitedInputStream as
                    quest_hook::libil2cpp::Type > ::class(), "SetParentEofDetect", 1usize
                )
            });
