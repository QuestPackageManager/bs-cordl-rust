...
for crate::Org::BouncyCastle::Asn1::IAsn1ApplicationSpecificParser {
    ...
    const CLASS_NAME: &'static str = "IAsn1ApplicationSpecificParser";
...
impl crate::Org::BouncyCastle::Asn1::IAsn1ApplicationSpecificParser {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::IAsn1ApplicationSpecificParser as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::IAsn1ApplicationSpecificParser as
