#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+CommitmentTypeQualifier")]
#[repr(C)]
#[derive(Debug)]
pub struct CommitmentTypeQualifier {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub commitmentTypeIdentifier:
    ...
    for crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier
{
    ...
    const CLASS_NAME: &'static str = "CommitmentTypeQualifier";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Esf+CommitmentTypeQualifier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier {
...
impl crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn New_DerObjectIdentifier0(
        commitmentTypeIdentifier: quest_hook::libil2cpp::Gc<
    ...
    pub fn New_DerObjectIdentifier_Asn1Encodable1(
        commitmentTypeIdentifier: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
        >,
        qualifier: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (commitmentTypeIdentifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (commitmentTypeIdentifier, qualifier))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        >,
                        0usize,
                    >("get_CommitmentTypeIdentifier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_CommitmentTypeIdentifier", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
