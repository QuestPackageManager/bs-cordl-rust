...
pub struct CompleteCertificateRefs {
    ...
    pub otherCertIDs: quest_hook::libil2cpp::Gc<
...
impl crate::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs {
    pub fn GetInstance(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs as
                    quest_hook::libil2cpp::Type > ::class(), "GetOtherCertIDs", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
    ...
    pub fn _ctor_IEnumerable2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (otherCertIDs))?
        };
        Ok(__cordl_ret.into())
    }
