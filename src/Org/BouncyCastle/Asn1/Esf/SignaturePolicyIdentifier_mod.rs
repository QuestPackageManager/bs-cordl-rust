#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+SignaturePolicyIdentifier")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Asn1::Esf::SignaturePolicyIdentifier
{
    ...
    const CLASS_NAME: &'static str = "SignaturePolicyIdentifier";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Esf+SignaturePolicyIdentifier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Esf::SignaturePolicyIdentifier {
...
impl crate::Org::BouncyCastle::Asn1::Esf::SignaturePolicyIdentifier {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::SignaturePolicyIdentifier>,
    > {
    ...
    pub fn _ctor_SignaturePolicyId1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (signaturePolicyId))? };
        Ok(__cordl_ret.into())
    }
