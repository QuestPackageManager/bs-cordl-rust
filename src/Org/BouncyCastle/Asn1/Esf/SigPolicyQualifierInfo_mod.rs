...
impl crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo {
    pub fn GetInstance(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo as
                    quest_hook::libil2cpp::Type > ::class(), "get_SigPolicyQualifierId",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo as
                    quest_hook::libil2cpp::Type > ::class(), "get_SigQualifier", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1Object,
