...
pub struct SigPolicyQualifierInfo {
    ...
    pub sigPolicyQualifierId: *mut crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
    pub sigQualifier: *mut crate::Org::BouncyCastle::Asn1::Asn1Object,
}
#[cfg(feature = "Org+BouncyCastle+Asn1+Esf+SigPolicyQualifierInfo")]
...
impl crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo {
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        &mut self,
        sigPolicyQualifierId: *mut crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
        sigQualifier: *mut crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
    ...
    > {
        ...
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::DerObjectIdentifier = __cordl_object
            .invoke("get_SigPolicyQualifierId", ())?;
        Ok(__cordl_ret)
    }
    pub fn ToAsn1Object(
        &mut self,
