#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+SigPolicyQualifierInfo")]
#[repr(C)]
#[derive(Debug)]
pub struct SigPolicyQualifierInfo {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub sigPolicyQualifierId:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
    pub sigQualifier: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Object>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+SigPolicyQualifierInfo")]
    ...
    for crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo
{
    ...
    const CLASS_NAME: &'static str = "SigPolicyQualifierInfo";
...
impl crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo>,
    > {
    ...
    pub fn New_DerObjectIdentifier_Asn1Encodable1(
        ...
        >,
        sigQualifier: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sigPolicyQualifierId, sigQualifier))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_SigPolicyQualifierId", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
