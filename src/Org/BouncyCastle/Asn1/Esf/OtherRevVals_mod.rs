#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OtherRevVals")]
#[repr(C)]
...
pub struct OtherRevVals {
    ...
    pub otherRevVals: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Object>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OtherRevVals")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Esf::OtherRevVals {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Esf";
    const CLASS_NAME: &'static str = "OtherRevVals";
...
impl crate::Org::BouncyCastle::Asn1::Esf::OtherRevVals {
    ...
    pub fn New_DerObjectIdentifier_Asn1Encodable1(
        otherRevValType: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
        >,
        otherRevVals: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (otherRevValType, otherRevVals))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        >,
                        0usize,
                    >("get_OtherRevValsObject")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_OtherRevValsObject", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Object> =
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OtherRevVals")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Esf::OtherRevVals {
