#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OcspResponsesID")]
#[repr(C)]
#[derive(Debug)]
pub struct OcspResponsesID {
    ...
    pub ocspRepHash: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::OtherHash>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OcspResponsesID")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Esf::OcspResponsesID {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Esf";
    const CLASS_NAME: &'static str = "OcspResponsesID";
...
impl crate::Org::BouncyCastle::Asn1::Esf::OcspResponsesID {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::OcspResponsesID>,
    > {
    ...
    pub fn New_OcspIdentifier_OtherHash2(
        ocspIdentifier: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Esf::OcspIdentifier,
        >,
        ocspRepHash: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::OtherHash>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_OcspIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ocspIdentifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_OcspIdentifier_OtherHash2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ocspIdentifier, ocspRepHash))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OcspResponsesID")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Esf::OcspResponsesID {
