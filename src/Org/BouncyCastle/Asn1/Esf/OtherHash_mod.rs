...
impl crate::Org::BouncyCastle::Asn1::Esf::OtherHash {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::OtherHash as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Esf::OtherHash as
    ...
    pub fn _ctor_Asn1OctetString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sha1Hash))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_OtherHashAlgAndValue2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (otherHash))?
        };
        Ok(__cordl_ret.into())
    }
