#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+SignerAttribute")]
#[repr(C)]
#[derive(Debug)]
pub struct SignerAttribute {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub claimedAttributes: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Sequence>,
    pub certifiedAttributes:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+SignerAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Esf::SignerAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Esf";
    const CLASS_NAME: &'static str = "SignerAttribute";
...
impl crate::Org::BouncyCastle::Asn1::Esf::SignerAttribute {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::SignerAttribute>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Esf::SignerAttribute,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn New_Asn1Sequence1(
        claimedAttributes: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Sequence>,
    ...
    pub fn New_AttributeCertificate2(
        certifiedAttributes: quest_hook::libil2cpp::Gc<
    ...
    pub fn _ctor_Asn1Sequence1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (claimedAttributes))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AttributeCertificate2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (certifiedAttributes))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate,
                    >, 0usize>("get_CertifiedAttributes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+SignerAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Esf::SignerAttribute {
