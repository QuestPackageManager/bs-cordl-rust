#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OcspIdentifier")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OcspIdentifier")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Esf::OcspIdentifier {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Esf";
    const CLASS_NAME: &'static str = "OcspIdentifier";
...
impl crate::Org::BouncyCastle::Asn1::Esf::OcspIdentifier {
    ...
    pub fn _ctor_ResponderID_DateTime1(
        &mut self,
        ocspResponderID: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Ocsp::ResponderID,
        >,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ocspResponderID, producedAt))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_ProducedAt(&mut self) -> quest_hook::libil2cpp::Result<crate::System::DateTime> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+OcspIdentifier")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Esf::OcspIdentifier {
