...
impl crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication {
    ...
    pub fn New_DerObjectIdentifier1(
        commitmentTypeId: *mut crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn New_DerObjectIdentifier_Asn1Sequence2(
        commitmentTypeId: *mut crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
        commitmentTypeQualifier: *mut crate::Org::BouncyCastle::Asn1::Asn1Sequence,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    > {
        ...
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::Asn1Sequence = __cordl_object
            .invoke("get_CommitmentTypeQualifier", ())?;
        Ok(__cordl_ret)
    }
}
#[cfg(feature = "Org+BouncyCastle+Asn1+Esf+CommitmentTypeIndication")]
