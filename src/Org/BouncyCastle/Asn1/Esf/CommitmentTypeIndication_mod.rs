...
pub struct CommitmentTypeIndication {
    ...
    pub commitmentTypeId: quest_hook::libil2cpp::Gc<
        crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
    >,
    pub commitmentTypeQualifier: quest_hook::libil2cpp::Gc<
...
for crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication {
    ...
    const CLASS_NAME: &'static str = "CommitmentTypeIndication";
...
impl crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication,
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication as
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (commitmentTypeId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier_Asn1Sequence2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (commitmentTypeId, commitmentTypeQualifier))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication as
                    quest_hook::libil2cpp::Type > ::class(), "get_CommitmentTypeID",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Esf::CommitmentTypeIndication as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "get_CommitmentTypeQualifier", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1Sequence,
