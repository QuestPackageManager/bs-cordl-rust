#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+CompleteRevocationRefs")]
#[repr(C)]
#[derive(Debug)]
pub struct CompleteRevocationRefs {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub crlOcspRefs: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Sequence>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Esf+CompleteRevocationRefs")]
    ...
    for crate::Org::BouncyCastle::Asn1::Esf::CompleteRevocationRefs
{
    ...
    const CLASS_NAME: &'static str = "CompleteRevocationRefs";
...
impl crate::Org::BouncyCastle::Asn1::Esf::CompleteRevocationRefs {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Esf::CompleteRevocationRefs>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Esf::CompleteRevocationRefs,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn _ctor_IEnumerable2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (crlOcspRefs))? };
        Ok(__cordl_ret.into())
    }
