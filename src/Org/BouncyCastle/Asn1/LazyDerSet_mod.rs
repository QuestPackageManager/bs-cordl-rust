...
#[cfg(feature = "Org+BouncyCastle+Asn1+LazyDerSet")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::LazyDerSet {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "LazyDerSet";
...
impl crate::Org::BouncyCastle::Asn1::LazyDerSet {
    pub fn Encode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::LazyDerSet as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::LazyDerSet as
