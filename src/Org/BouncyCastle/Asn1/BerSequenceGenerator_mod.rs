#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSequenceGenerator")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSequenceGenerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::BerSequenceGenerator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "BerSequenceGenerator";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSequenceGenerator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::BerSequenceGenerator {
