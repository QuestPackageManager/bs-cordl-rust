...
for crate::Org::BouncyCastle::Asn1::DerSetGenerator {
    ...
    const CLASS_NAME: &'static str = "DerSetGenerator";
...
impl crate::Org::BouncyCastle::Asn1::DerSetGenerator {
    pub fn AddObject(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::DerSetGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::DerSetGenerator as
