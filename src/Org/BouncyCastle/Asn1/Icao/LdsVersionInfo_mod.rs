#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Icao+LdsVersionInfo")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct LdsVersionInfo {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub ldsVersion: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerPrintableString>,
    pub unicodeVersion:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerPrintableString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Icao+LdsVersionInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Icao";
    const CLASS_NAME: &'static str = "LdsVersionInfo";
...
impl crate::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo {
    ...
    pub fn New_Il2CppString_Il2CppString0(
        ldsVersion: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        unicodeVersion: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_Il2CppString_Il2CppString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ldsVersion, unicodeVersion))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Icao+LdsVersionInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo {
