...
impl crate::Org::BouncyCastle::Asn1::Icao::LdsSecurityObject {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Icao::LdsSecurityObject>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor_AlgorithmIdentifier_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (digestAlgorithmIdentifier, datagroupHash))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
                    >, 0usize>("get_DigestAlgorithmIdentifier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Icao+LdsSecurityObject")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Icao::LdsSecurityObject {
