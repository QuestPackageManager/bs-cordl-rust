...
impl crate::Org::BouncyCastle::Asn1::Icao::LdsSecurityObject {
    ...
    pub fn _ctor_AlgorithmIdentifier_Il2CppArray1(
        ...
        datagroupHash: *mut quest_hook::libil2cpp::Il2CppArray<
            *mut crate::Org::BouncyCastle::Asn1::Icao::DataGroupHash,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
    ...
    pub fn _ctor_AlgorithmIdentifier_Il2CppArray_LdsVersionInfo2(
        ...
        datagroupHash: *mut quest_hook::libil2cpp::Il2CppArray<
            *mut crate::Org::BouncyCastle::Asn1::Icao::DataGroupHash,
        >,
        versionInfo: *mut crate::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
    ...
    pub fn get_VersionInfo(
        ...
        *mut crate::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo = __cordl_object
    ...
    > {
        ...
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier = __cordl_object
            .invoke("get_DigestAlgorithmIdentifier", ())?;
        Ok(__cordl_ret)
    }
