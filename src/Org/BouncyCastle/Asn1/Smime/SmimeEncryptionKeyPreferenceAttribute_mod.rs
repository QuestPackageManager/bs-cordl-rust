...
impl crate::Org::BouncyCastle::Asn1::Smime::SmimeEncryptionKeyPreferenceAttribute {
    ...
    pub fn _ctor_Asn1OctetString2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Smime::SmimeEncryptionKeyPreferenceAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
