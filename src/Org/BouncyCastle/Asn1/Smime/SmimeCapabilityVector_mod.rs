    ...
    for crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector
{
    ...
    const CLASS_NAME: &'static str = "SmimeCapabilityVector";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Smime+SmimeCapabilityVector")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector {
...
impl crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector {
    pub fn AddCapability_Asn1Encodable2(
        &mut self,
        capability: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("AddCapability")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (capability, parameters))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddCapability", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (capability))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddCapability_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (capability, value))? };
        Ok(__cordl_ret.into())
    }
