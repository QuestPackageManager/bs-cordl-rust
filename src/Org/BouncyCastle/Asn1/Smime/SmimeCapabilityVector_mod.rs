...
impl crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddCapability", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (capability, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddCapability_DerObjectIdentifier0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (capability))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddCapability_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (capability, value))?
        };
        Ok(__cordl_ret.into())
    }
