#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Smime+SmimeCapabilitiesAttribute")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute
{
    ...
    const CLASS_NAME: &'static str = "SmimeCapabilitiesAttribute";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Smime+SmimeCapabilitiesAttribute")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute {
...
impl crate::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (capabilities))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Smime+SmimeCapabilitiesAttribute")]
