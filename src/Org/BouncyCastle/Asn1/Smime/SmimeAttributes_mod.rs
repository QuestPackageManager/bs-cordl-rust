#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Smime+SmimeAttributes")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Smime+SmimeAttributes")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Smime::SmimeAttributes {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Smime";
    const CLASS_NAME: &'static str = "SmimeAttributes";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Smime+SmimeAttributes")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Smime::SmimeAttributes {
