...
#[repr(C)]
#[derive(Debug)]
pub struct DerSequenceGenerator {
...
for crate::Org::BouncyCastle::Asn1::DerSequenceGenerator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "DerSequenceGenerator";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+DerSequenceGenerator")]
impl crate::Org::BouncyCastle::Asn1::DerSequenceGenerator {
    pub fn AddObject(
        &mut self,
        obj: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::DerSequenceGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::DerSequenceGenerator as
                    quest_hook::libil2cpp::Type > ::class(), "AddObject", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::DerSequenceGenerator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::DerSequenceGenerator as
                    quest_hook::libil2cpp::Type > ::class(), "GetRawOutputStream", 0usize
                )
            });
