...
impl crate::Org::BouncyCastle::Asn1::DerObjectIdentifier {
    ...
    pub fn DoOutput(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bOut))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Encode(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsValidBranchID", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (branchID, start))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn IsValidIdentifier(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (identifier))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn On(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (stem))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
    ...
    pub fn WriteField_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outputStream, fieldValue))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_DerObjectIdentifier_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (oid, branchID))?
        };
        Ok(__cordl_ret.into())
    }
