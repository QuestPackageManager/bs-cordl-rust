#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+CryptoPro+Gost3410ParamSetParameters")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters
{
    ...
    const CLASS_NAME: &'static str = "Gost3410ParamSetParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+CryptoPro+Gost3410ParamSetParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters {
...
impl crate::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters {
    ...
    pub fn _ctor_i32_BigInteger_BigInteger_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keySize, p, q, a))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_A(
        &mut self,
