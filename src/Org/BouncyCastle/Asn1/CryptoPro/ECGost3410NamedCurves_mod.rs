#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+CryptoPro+ECGost3410NamedCurves")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410NamedCurves {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+CryptoPro+ECGost3410NamedCurves")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410NamedCurves {
...
impl crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410NamedCurves {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint> =
            unsafe { cordl_method_info.invoke_unchecked((), (curve, x, y))? };
        Ok(__cordl_ret.into())
    }
