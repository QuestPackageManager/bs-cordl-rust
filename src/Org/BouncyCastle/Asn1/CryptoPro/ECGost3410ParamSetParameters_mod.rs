...
for crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410ParamSetParameters {
    ...
    const CLASS_NAME: &'static str = "ECGost3410ParamSetParameters";
...
impl crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410ParamSetParameters {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410ParamSetParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410ParamSetParameters as
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger_BigInteger_i32_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (a, b, p, q, x, y))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_A(
