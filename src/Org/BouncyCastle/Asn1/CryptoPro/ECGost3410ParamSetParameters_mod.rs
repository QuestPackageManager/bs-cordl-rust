#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+CryptoPro+ECGost3410ParamSetParameters")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410ParamSetParameters {
...
impl crate::Org::BouncyCastle::Asn1::CryptoPro::ECGost3410ParamSetParameters {
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger_BigInteger_i32_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (a, b, p, q, x, y))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_A(
        &mut self,
