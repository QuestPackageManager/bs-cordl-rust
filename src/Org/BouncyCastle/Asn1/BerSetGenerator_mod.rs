...
for crate::Org::BouncyCastle::Asn1::BerSetGenerator {
    ...
    const CLASS_NAME: &'static str = "BerSetGenerator";
...
impl crate::Org::BouncyCastle::Asn1::BerSetGenerator {
    ...
    pub fn _ctor_Stream0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::BerSetGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::BerSetGenerator as
