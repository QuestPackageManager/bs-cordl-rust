#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X500+DirectoryString")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X500+DirectoryString")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X500::DirectoryString {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X500";
    const CLASS_NAME: &'static str = "DirectoryString";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X500+DirectoryString")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X500::DirectoryString {
