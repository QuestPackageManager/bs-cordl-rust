...
impl crate::Org::BouncyCastle::Asn1::Crmf::EncKeyWithID {
    ...
    pub fn _ctor_PrivateKeyInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (privKeyInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PrivateKeyInfo_DerUtf8String2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (privKeyInfo, str))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PrivateKeyInfo_GeneralName3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (privKeyInfo, generalName))?
        };
        Ok(__cordl_ret.into())
    }
