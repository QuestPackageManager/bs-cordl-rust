#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+ProofOfPossession")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession
{
    ...
    const CLASS_NAME: &'static str = "ProofOfPossession";
...
impl crate::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession>,
    > {
    ...
    pub fn New_PopoSigningKey2(
        Poposk: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn New_i32_PopoPrivKey3(
        _cordl_type: i32,
        privkey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_PopoSigningKey2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (Poposk))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_PopoPrivKey3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, privkey))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Object(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+ProofOfPossession")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession {
