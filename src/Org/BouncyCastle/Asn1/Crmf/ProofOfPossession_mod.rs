...
impl crate::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession {
    ...
    pub fn GetInstance(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Crmf::ProofOfPossession as
    ...
    pub fn _ctor_Asn1TaggedObject0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (tagged))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PopoSigningKey2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (Poposk))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_PopoPrivKey3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (_cordl_type, privkey))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Object(
