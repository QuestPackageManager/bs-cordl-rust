#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+AttributeTypeAndValue")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue>,
    > {
