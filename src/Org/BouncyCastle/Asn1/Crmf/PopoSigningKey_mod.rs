...
pub struct PopoSigningKey {
    ...
    pub poposkInput: *mut crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput,
...
impl crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey {
    ...
    pub fn _ctor_PopoSigningKeyInput_AlgorithmIdentifier_DerBitString1(
        &mut self,
        poposkIn: *mut crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput,
    ...
    pub fn get_PoposkInput(
        ...
        *mut crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput = __cordl_object
            .invoke("get_PoposkInput", ())?;
        Ok(__cordl_ret)
    }
