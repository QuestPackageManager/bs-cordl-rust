#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+PopoSigningKey")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct PopoSigningKey {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub poposkInput:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput>,
    pub algorithmIdentifier:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier>,
    pub signature: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+PopoSigningKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Crmf";
    const CLASS_NAME: &'static str = "PopoSigningKey";
...
impl crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey {
    ...
    pub fn New_PopoSigningKeyInput_AlgorithmIdentifier_DerBitString1(
        ...
        signature: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_PopoSigningKeyInput_AlgorithmIdentifier_DerBitString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (poposkIn, aid, signature))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
                    >, 0usize>("get_AlgorithmIdentifier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+PopoSigningKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey {
