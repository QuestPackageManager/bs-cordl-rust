...
impl crate::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions {
    ...
    pub fn _ctor_Asn1OctetString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyGenParameters))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_EncryptedKey1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (encKey))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (archiveRemGenPrivKey))?
        };
        Ok(__cordl_ret.into())
    }
