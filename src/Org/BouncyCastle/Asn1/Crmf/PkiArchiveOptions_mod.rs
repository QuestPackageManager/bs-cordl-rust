#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+PkiArchiveOptions")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions
{
    ...
    const CLASS_NAME: &'static str = "PkiArchiveOptions";
...
impl crate::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions {
    ...
    pub fn New_EncryptedKey1(
        encKey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::EncryptedKey>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_Asn1OctetString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyGenParameters))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_EncryptedKey1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encKey))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (archiveRemGenPrivKey))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+PkiArchiveOptions")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions {
