#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Crmf+PopoSigningKeyInput")]
#[repr(C)]
...
pub struct PopoSigningKeyInput {
    ...
    pub publicKeyMac: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::PKMacValue>,
    pub publicKey:
    ...
    for crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput
{
    ...
    const CLASS_NAME: &'static str = "PopoSigningKeyInput";
...
impl crate::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput {
    ...
    pub fn New_PKMacValue_SubjectPublicKeyInfo2(
        pkmac: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Crmf::PKMacValue>,
        spki: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
    ...
    pub fn _ctor_GeneralName_SubjectPublicKeyInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sender, spki))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PKMacValue_SubjectPublicKeyInfo2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pkmac, spki))? };
        Ok(__cordl_ret.into())
    }
