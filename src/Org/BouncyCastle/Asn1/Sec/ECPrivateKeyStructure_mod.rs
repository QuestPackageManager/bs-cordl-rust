...
impl crate::Org::BouncyCastle::Asn1::Sec::ECPrivateKeyStructure {
    ...
    pub fn _ctor_BigInteger_Asn1Encodable3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_BigInteger_DerBitString_Asn1Encodable4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, publicKey, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_BigInteger2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (orderBitLength, key))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_BigInteger_Asn1Encodable5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (orderBitLength, key, parameters))?
        };
        Ok(__cordl_ret.into())
    }
