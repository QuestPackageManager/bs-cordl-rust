#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Sec+ECPrivateKeyStructure")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::Sec::ECPrivateKeyStructure {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Sec::ECPrivateKeyStructure>,
    > {
    ...
    pub fn New_BigInteger_Asn1Encodable3(
        key: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
        parameters: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn New_BigInteger_DerBitString_Asn1Encodable4(
        key: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
        publicKey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
        parameters: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
    ...
    pub fn _ctor_BigInteger_Asn1Encodable3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_BigInteger_DerBitString_Asn1Encodable4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, publicKey, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_BigInteger2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (orderBitLength, key))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_BigInteger_Asn1Encodable5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (orderBitLength, key, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_BigInteger_DerBitString_Asn1Encodable6(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (orderBitLength, key, publicKey, parameters))?
        };
        Ok(__cordl_ret.into())
    }
}
