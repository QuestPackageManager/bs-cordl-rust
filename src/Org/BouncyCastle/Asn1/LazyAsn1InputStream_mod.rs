#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+LazyAsn1InputStream")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+LazyAsn1InputStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::LazyAsn1InputStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "LazyAsn1InputStream";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+LazyAsn1InputStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::LazyAsn1InputStream {
