...
impl crate::Org::BouncyCastle::Asn1::Asn1Sequence {
    ...
    pub fn get_Parser(
        ...
        *mut crate::Org::BouncyCastle::Asn1::Asn1SequenceParser,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::Asn1SequenceParser = __cordl_object
            .invoke("get_Parser", ())?;
        Ok(__cordl_ret)
    }
}
...
pub struct Asn1Sequence_Asn1SequenceParserImpl {
    ...
    pub outer: *mut crate::Org::BouncyCastle::Asn1::Asn1Sequence,
    pub max: i32,
    pub index: i32,
}
#[cfg(feature = "Org+BouncyCastle+Asn1+Asn1Sequence+Asn1SequenceParserImpl")]
...
impl crate::Org::BouncyCastle::Asn1::Asn1Sequence_Asn1SequenceParserImpl {
    pub fn New(
        outer: *mut crate::Org::BouncyCastle::Asn1::Asn1Sequence,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
