...
for crate::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator {
...
impl crate::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Ocsp::ServiceLocator as
    ...
    pub fn _ctor_X509Name_Asn1Object1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (issuer, locator))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Issuer(
