...
impl crate::Org::BouncyCastle::Asn1::Ocsp::Signature {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Ocsp::Signature as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Ocsp::Signature as
    ...
    pub fn _ctor_AlgorithmIdentifier_DerBitString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (signatureAlgorithm, signatureValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AlgorithmIdentifier_DerBitString_Asn1Sequence1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (signatureAlgorithm, signatureValue, certs))?
        };
        Ok(__cordl_ret.into())
    }
