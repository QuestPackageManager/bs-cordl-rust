#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+Signature")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+Signature")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Ocsp::Signature {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Ocsp";
    const CLASS_NAME: &'static str = "Signature";
...
impl crate::Org::BouncyCastle::Asn1::Ocsp::Signature {
    ...
    pub fn _ctor_AlgorithmIdentifier_DerBitString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (signatureAlgorithm, signatureValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AlgorithmIdentifier_DerBitString_Asn1Sequence1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (signatureAlgorithm, signatureValue, certs))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+Signature")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Ocsp::Signature {
