...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+RevokedInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Ocsp";
    const CLASS_NAME: &'static str = "RevokedInfo";
...
impl crate::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo {
    ...
    pub fn _ctor_DerGeneralizedTime0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (revocationTime))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+RevokedInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo {
