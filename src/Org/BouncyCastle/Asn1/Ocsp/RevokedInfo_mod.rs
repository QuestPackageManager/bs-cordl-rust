...
pub struct RevokedInfo {
    ...
    pub revocationTime: *mut crate::Org::BouncyCastle::Asn1::DerGeneralizedTime,
    pub revocationReason: *mut crate::Org::BouncyCastle::Asn1::X509::CrlReason,
}
#[cfg(feature = "Org+BouncyCastle+Asn1+Ocsp+RevokedInfo")]
...
impl crate::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo {
    ...
    pub fn _ctor_DerGeneralizedTime0(
        &mut self,
        revocationTime: *mut crate::Org::BouncyCastle::Asn1::DerGeneralizedTime,
    ...
    pub fn _ctor_DerGeneralizedTime_CrlReason1(
        &mut self,
        revocationTime: *mut crate::Org::BouncyCastle::Asn1::DerGeneralizedTime,
        revocationReason: *mut crate::Org::BouncyCastle::Asn1::X509::CrlReason,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
    ...
    pub fn get_RevocationReason(
        ...
        *mut crate::Org::BouncyCastle::Asn1::X509::CrlReason,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::X509::CrlReason = __cordl_object
            .invoke("get_RevocationReason", ())?;
        Ok(__cordl_ret)
    }
    pub fn ToAsn1Object(
        &mut self,
