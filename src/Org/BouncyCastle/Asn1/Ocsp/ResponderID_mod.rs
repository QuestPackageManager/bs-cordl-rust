#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+ResponderID")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+ResponderID")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Ocsp::ResponderID {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Ocsp";
    const CLASS_NAME: &'static str = "ResponderID";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Ocsp+ResponderID")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Ocsp::ResponderID {
