#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DefiniteLengthInputStream")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Asn1::DefiniteLengthInputStream {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (inStream, length, limit))?
        };
        Ok(__cordl_ret.into())
    }
