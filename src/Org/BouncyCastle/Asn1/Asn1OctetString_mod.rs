#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Asn1OctetString")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Asn1OctetString")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Asn1OctetString {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "Asn1OctetString";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Asn1OctetString")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Asn1OctetString {
