#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Misc+Cast5CbcParameters")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor_Il2CppArray_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (iv, keyLength))? };
        Ok(__cordl_ret.into())
    }
