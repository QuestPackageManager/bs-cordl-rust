...
for crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters {
    ...
    const CLASS_NAME: &'static str = "Cast5CbcParameters";
...
impl crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters as
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters,
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
    ...
    pub fn _ctor_Il2CppArray_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (iv, keyLength))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_KeyLength(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_KeyLength")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters as
                    quest_hook::libil2cpp::Type > ::class(), "get_KeyLength", 0usize
                )
            });
