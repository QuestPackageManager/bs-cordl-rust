#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Misc+NetscapeCertType")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Misc+NetscapeCertType")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Misc::NetscapeCertType {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Misc";
    const CLASS_NAME: &'static str = "NetscapeCertType";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Misc+NetscapeCertType")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Misc::NetscapeCertType {
