#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+X9Curve")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::X9::X9Curve {
    ...
    pub fn New_X9FieldID_Asn1Sequence2(
        fieldID: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X9::X9FieldID>,
    ...
    pub fn _ctor_ECCurve0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (curve))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECCurve_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (curve, seed))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X9FieldID_Asn1Sequence2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (fieldID, seq))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X9FieldID_BigInteger_BigInteger_Asn1Sequence3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (fieldID, order, cofactor, seq))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Curve(
        &mut self,
