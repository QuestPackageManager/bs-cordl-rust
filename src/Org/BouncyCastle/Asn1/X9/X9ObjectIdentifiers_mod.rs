#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+X9ObjectIdentifiers")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+X9ObjectIdentifiers")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X9::X9ObjectIdentifiers {
