...
impl crate::Org::BouncyCastle::Asn1::X9::X962Parameters {
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (namedCurve))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X9ECParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ecParameters))?
        };
        Ok(__cordl_ret.into())
    }
