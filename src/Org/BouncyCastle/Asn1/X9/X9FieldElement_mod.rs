...
impl crate::Org::BouncyCastle::Asn1::X9::X9FieldElement {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X9::X9FieldElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Object>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X9::X9FieldElement as
    ...
    pub fn _ctor_BigInteger_Asn1OctetString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p, s))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_i32_i32_i32_i32_Asn1OctetString2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (m, k1, k2, k3, s))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Value(
