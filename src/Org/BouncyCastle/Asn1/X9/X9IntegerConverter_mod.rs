...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+X9IntegerConverter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X9::X9IntegerConverter {
...
impl crate::Org::BouncyCastle::Asn1::X9::X9IntegerConverter {
    ...
    pub fn GetByteLength_ECFieldElement0(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (fe))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (s, qLength))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+X9IntegerConverter")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X9::X9IntegerConverter {
