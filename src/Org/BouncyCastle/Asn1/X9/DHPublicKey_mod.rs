#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+DHPublicKey")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+DHPublicKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X9::DHPublicKey {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X9";
    const CLASS_NAME: &'static str = "DHPublicKey";
...
impl crate::Org::BouncyCastle::Asn1::X9::DHPublicKey {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X9::DHPublicKey>,
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::X9::DHPublicKey,
                        >,
                        2usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn New(
        y: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerInteger>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (y))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Y(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+DHPublicKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X9::DHPublicKey {
