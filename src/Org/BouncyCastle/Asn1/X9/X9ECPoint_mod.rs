...
impl crate::Org::BouncyCastle::Asn1::X9::X9ECPoint {
    ...
    pub fn _ctor_ECCurve_Asn1OctetString3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (c, s))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECCurve_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (c, encoding))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_ECPoint__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (p, compressed))?
        };
        Ok(__cordl_ret.into())
    }
