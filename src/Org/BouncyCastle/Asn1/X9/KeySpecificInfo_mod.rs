#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+KeySpecificInfo")]
#[repr(C)]
#[derive(Debug)]
pub struct KeySpecificInfo {
    ...
    pub counter: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+KeySpecificInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X9::KeySpecificInfo {
...
impl crate::Org::BouncyCastle::Asn1::X9::KeySpecificInfo {
    ...
    pub fn New_DerObjectIdentifier_Asn1OctetString0(
        ...
        counter: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1OctetString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (algorithm, counter))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+KeySpecificInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X9::KeySpecificInfo {
