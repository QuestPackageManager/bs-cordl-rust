#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+DHDomainParameters")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+DHDomainParameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X9::DHDomainParameters {
...
impl crate::Org::BouncyCastle::Asn1::X9::DHDomainParameters {
    ...
    pub fn _ctor_DerInteger_DerInteger_DerInteger_DerInteger_DHValidationParms0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p, g, q, j, validationParms))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X9+DHDomainParameters")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X9::DHDomainParameters {
