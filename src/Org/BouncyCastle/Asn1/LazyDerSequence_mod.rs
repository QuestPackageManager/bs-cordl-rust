#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+LazyDerSequence")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+LazyDerSequence")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::LazyDerSequence {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "LazyDerSequence";
...
impl crate::Org::BouncyCastle::Asn1::LazyDerSequence {
    ...
    pub fn Parse(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Parse")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+LazyDerSequence")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::LazyDerSequence {
