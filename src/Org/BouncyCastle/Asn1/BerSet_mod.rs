#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSet")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::BerSet {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::BerSet> =
    ...
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        bool,
                    ), quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::BerSet>, 2usize>(
                        "FromVector",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::BerSet> =
            unsafe { cordl_method_info.invoke_unchecked((), (elementVector, needsSorting))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Asn1EncodableVector__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (elementVector, needsSorting))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+BerSet")]
