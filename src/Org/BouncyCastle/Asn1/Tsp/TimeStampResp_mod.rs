#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Tsp+TimeStampResp")]
#[repr(C)]
#[derive(Debug)]
pub struct TimeStampResp {
    ...
    pub timeStampToken: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::ContentInfo>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Tsp+TimeStampResp")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Tsp::TimeStampResp {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Tsp";
    const CLASS_NAME: &'static str = "TimeStampResp";
...
impl crate::Org::BouncyCastle::Asn1::Tsp::TimeStampResp {
    ...
    pub fn New_PkiStatusInfo_ContentInfo1(
        ...
        >,
        timeStampToken: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::ContentInfo>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_PkiStatusInfo_ContentInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pkiStatusInfo, timeStampToken))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Status(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Tsp+TimeStampResp")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Tsp::TimeStampResp {
