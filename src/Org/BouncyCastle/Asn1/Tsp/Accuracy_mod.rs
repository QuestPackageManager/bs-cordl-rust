#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Tsp+Accuracy")]
#[repr(C)]
#[derive(Debug)]
pub struct Accuracy {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Tsp+Accuracy")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Tsp::Accuracy {
...
impl crate::Org::BouncyCastle::Asn1::Tsp::Accuracy {
    ...
    pub fn _ctor_DerInteger_DerInteger_DerInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (seconds, millis, micros))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Micros(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Tsp+Accuracy")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Tsp::Accuracy {
