#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Mozilla+PublicKeyAndChallenge")]
#[repr(C)]
...
pub struct PublicKeyAndChallenge {
    ...
    pub spki: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo>,
    pub challenge: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerIA5String>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Mozilla+PublicKeyAndChallenge")]
    ...
    for crate::Org::BouncyCastle::Asn1::Mozilla::PublicKeyAndChallenge
{
    ...
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Mozilla";
    const CLASS_NAME: &'static str = "PublicKeyAndChallenge";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Mozilla+PublicKeyAndChallenge")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Mozilla::PublicKeyAndChallenge {
...
impl crate::Org::BouncyCastle::Asn1::Mozilla::PublicKeyAndChallenge {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Mozilla::PublicKeyAndChallenge>,
    > {
