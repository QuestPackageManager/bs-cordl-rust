...
impl crate::Org::BouncyCastle::Asn1::X509::ReasonFlags {
    ...
    pub fn _ctor_DerBitString1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::ReasonFlags as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::ReasonFlags as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (reasons))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_0(
