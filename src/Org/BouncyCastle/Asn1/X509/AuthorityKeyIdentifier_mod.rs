...
pub struct AuthorityKeyIdentifier {
    ...
    pub keyidentifier: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
    pub certissuer: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::GeneralNames>,
    ...
    for crate::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier
{
    ...
    const CLASS_NAME: &'static str = "AuthorityKeyIdentifier";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+AuthorityKeyIdentifier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier {
...
impl crate::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier {
    pub fn FromExtensions(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier>,
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier,
                    >, 1usize>("FromExtensions")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn New_GeneralNames_BigInteger3(
        name: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::GeneralNames>,
    ...
    pub fn _ctor_GeneralNames_BigInteger3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, serialNumber))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyIdentifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_GeneralNames_BigInteger5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyIdentifier, name, serialNumber))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_SubjectPublicKeyInfo_GeneralNames_BigInteger2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (spki, name, serialNumber))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        >,
                        0usize,
                    >("get_AuthorityCertIssuer")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_AuthorityCertIssuer", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        >,
                        0usize,
                    >("get_AuthorityCertSerialNumber")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_AuthorityCertSerialNumber", 0usize
                        )
                    })
            });
