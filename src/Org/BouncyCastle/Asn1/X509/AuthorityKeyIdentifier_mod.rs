...
impl crate::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier {
    ...
    pub fn _ctor_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyIdentifier))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_GeneralNames_BigInteger5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (keyIdentifier, name, serialNumber))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_SubjectPublicKeyInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (spki))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_SubjectPublicKeyInfo_GeneralNames_BigInteger2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (spki, name, serialNumber))?
        };
        Ok(__cordl_ret.into())
    }
