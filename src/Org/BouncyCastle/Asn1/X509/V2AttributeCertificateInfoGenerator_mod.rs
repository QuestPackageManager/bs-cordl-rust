#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+V2AttributeCertificateInfoGenerator")]
#[repr(C)]
#[derive(Debug)]
pub struct V2AttributeCertificateInfoGenerator {
    ...
    pub attributes: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1EncodableVector>,
    ...
    pub startDate: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerGeneralizedTime>,
    pub endDate: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerGeneralizedTime>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+V2AttributeCertificateInfoGenerator")]
    ...
    for crate::Org::BouncyCastle::Asn1::X509::V2AttributeCertificateInfoGenerator
{
    ...
    const CLASS_NAME: &'static str = "V2AttributeCertificateInfoGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::X509::V2AttributeCertificateInfoGenerator {
...
impl crate::Org::BouncyCastle::Asn1::X509::V2AttributeCertificateInfoGenerator {
    pub fn AddAttribute_AttributeX509_1(
        &mut self,
        attribute: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AttributeX509>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("AddAttribute")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("GenerateAttributeCertificateInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetEndDate(
        &mut self,
        endDate: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerGeneralizedTime>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn SetIssuerUniqueID(
        &mut self,
        issuerUniqueID: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (issuerUniqueID))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetStartDate(
        &mut self,
        startDate: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerGeneralizedTime>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
