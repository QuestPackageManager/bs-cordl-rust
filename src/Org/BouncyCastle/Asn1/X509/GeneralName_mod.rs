...
impl crate::Org::BouncyCastle::Asn1::X509::GeneralName {
    ...
    pub fn _ctor_Asn1Object_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, tag))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X509Name0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (directoryName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_Asn1Encodable2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tag, name))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn copyInts(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (parsedIp, addr, offSet))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Name(
    ...
    pub fn parseIPv4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ip, addr, offset))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "parseIPv4Mask", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (mask, addr, offset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn parseIPv6(
