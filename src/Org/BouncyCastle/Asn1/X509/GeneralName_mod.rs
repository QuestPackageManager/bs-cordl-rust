...
impl crate::Org::BouncyCastle::Asn1::X509::GeneralName {
    ...
    > {
        ...
        > = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("GetInstance", (tagObj, explicitly))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = __cordl_object.invoke("parseIPv6", (ip))?;
        Ok(__cordl_ret.into())
    }
    pub fn parseMask(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<i32>,
        > = __cordl_object.invoke("parseMask", (mask))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = __cordl_object.invoke("toGeneralNameEncoding", (ip))?;
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+GeneralName")]
