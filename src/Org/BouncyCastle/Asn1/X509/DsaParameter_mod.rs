#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+DsaParameter")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+DsaParameter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X509::DsaParameter {
...
impl crate::Org::BouncyCastle::Asn1::X509::DsaParameter {
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p, q, g))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+DsaParameter")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::DsaParameter {
