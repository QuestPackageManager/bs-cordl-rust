...
for crate::Org::BouncyCastle::Asn1::X509::DsaParameter {
    ...
    const CLASS_NAME: &'static str = "DsaParameter";
...
impl crate::Org::BouncyCastle::Asn1::X509::DsaParameter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::DsaParameter as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::DsaParameter as
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p, q, g))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
