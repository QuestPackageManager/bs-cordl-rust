...
impl crate::Org::BouncyCastle::Asn1::X509::IssuerSerial {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::IssuerSerial as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::IssuerSerial as
    ...
    pub fn _ctor_GeneralNames_DerInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (issuer, serial))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Issuer(
