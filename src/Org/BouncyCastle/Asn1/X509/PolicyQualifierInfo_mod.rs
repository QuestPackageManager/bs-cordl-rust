#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+PolicyQualifierInfo")]
#[repr(C)]
#[derive(Debug)]
pub struct PolicyQualifierInfo {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub policyQualifierId:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
    pub qualifier: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+PolicyQualifierInfo")]
    ...
    for crate::Org::BouncyCastle::Asn1::X509::PolicyQualifierInfo
{
    ...
    const CLASS_NAME: &'static str = "PolicyQualifierInfo";
...
impl crate::Org::BouncyCastle::Asn1::X509::PolicyQualifierInfo {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::PolicyQualifierInfo>,
    > {
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (policyQualifierId, qualifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cps))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        >,
                        0usize,
                    >("get_PolicyQualifierId")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_PolicyQualifierId", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
