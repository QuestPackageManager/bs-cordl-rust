#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+SubjectKeyIdentifier")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 1usize>("CreateSha1KeyIdentifier")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier,
                    >, 1usize>("CreateTruncatedSha1KeyIdentifier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (spki))? };
        Ok(__cordl_ret.into())
    }
