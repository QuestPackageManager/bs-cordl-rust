...
for crate::Org::BouncyCastle::Asn1::X509::KeyPurposeID {
    ...
    const CLASS_NAME: &'static str = "KeyPurposeID";
...
impl crate::Org::BouncyCastle::Asn1::X509::KeyPurposeID {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::KeyPurposeID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::KeyPurposeID as
