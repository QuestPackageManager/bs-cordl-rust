...
impl crate::Org::BouncyCastle::Asn1::X509::V2Form {
    ...
    pub fn _ctor_GeneralNames0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (issuerName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_GeneralNames_IssuerSerial1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (issuerName, baseCertificateID))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_GeneralNames_ObjectDigestInfo2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (issuerName, objectDigestInfo))?
        };
        Ok(__cordl_ret.into())
    }
