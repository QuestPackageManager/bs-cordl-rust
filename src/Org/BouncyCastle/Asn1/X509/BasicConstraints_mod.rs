...
impl crate::Org::BouncyCastle::Asn1::X509::BasicConstraints {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "IsCA",
                            0usize
                        )
                    })
            });
    ...
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cA))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pathLenConstraint))?
        };
        Ok(__cordl_ret.into())
    }
