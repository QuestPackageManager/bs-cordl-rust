...
impl crate::Org::BouncyCastle::Asn1::X509::X509NameTokenizer {
    ...
    pub fn _ctor__cordl_char1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, separator))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+X509NameTokenizer")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::X509NameTokenizer {
