#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+AttributeCertificate")]
#[repr(C)]
...
pub struct AttributeCertificate {
    ...
    pub signatureValue: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+AttributeCertificate")]
    ...
    for crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate
{
    ...
    const CLASS_NAME: &'static str = "AttributeCertificate";
...
impl crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate>,
    > {
    ...
    pub fn New_AttributeCertificateInfo_AlgorithmIdentifier_DerBitString0(
        ...
        >,
        signatureValue: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_AttributeCertificateInfo_AlgorithmIdentifier_DerBitString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (acinfo, signatureAlgorithm, signatureValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_ACInfo(
