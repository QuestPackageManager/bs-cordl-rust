#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+CertPolicyID")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+CertPolicyID")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X509::CertPolicyID {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X509";
    const CLASS_NAME: &'static str = "CertPolicyID";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+CertPolicyID")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::CertPolicyID {
