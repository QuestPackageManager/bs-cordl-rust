...
impl crate::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax {
    ...
    pub fn GetValues(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax as
                    quest_hook::libil2cpp::Type > ::class(), "GetValues", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax as
                    quest_hook::libil2cpp::Type > ::class(), "get_PolicyAuthority",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
