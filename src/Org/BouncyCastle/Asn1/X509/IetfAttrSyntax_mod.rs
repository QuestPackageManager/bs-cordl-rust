#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+IetfAttrSyntax")]
#[repr(C)]
...
pub struct IetfAttrSyntax {
    ...
    pub values: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1EncodableVector>,
    pub valueChoice: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+IetfAttrSyntax")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X509";
    const CLASS_NAME: &'static str = "IetfAttrSyntax";
...
impl crate::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax {
    ...
    pub fn get_ValueType(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_ValueType")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+IetfAttrSyntax")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::IetfAttrSyntax {
