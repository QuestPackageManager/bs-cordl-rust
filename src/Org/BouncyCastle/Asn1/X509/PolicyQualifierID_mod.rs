#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+PolicyQualifierID")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+PolicyQualifierID")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::PolicyQualifierID {
