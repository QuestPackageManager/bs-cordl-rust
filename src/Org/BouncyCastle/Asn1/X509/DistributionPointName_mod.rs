...
pub struct DistributionPointName {
    ...
    pub name: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    pub _cordl_type: i32,
}
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+DistributionPointName")]
...
for crate::Org::BouncyCastle::Asn1::X509::DistributionPointName {
    ...
    const CLASS_NAME: &'static str = "DistributionPointName";
...
impl crate::Org::BouncyCastle::Asn1::X509::DistributionPointName {
    ...
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::DistributionPointName as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::DistributionPointName as
    ...
    pub fn get_PointType(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::DistributionPointName as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_PointType")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::DistributionPointName as
                    quest_hook::libil2cpp::Type > ::class(), "get_PointType", 0usize
                )
            });
