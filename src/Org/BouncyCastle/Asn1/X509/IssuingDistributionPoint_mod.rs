#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+IssuingDistributionPoint")]
#[repr(C)]
#[derive(Debug)]
pub struct IssuingDistributionPoint {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub _distributionPoint:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::DistributionPointName>,
    pub _onlyContainsUserCerts: bool,
    pub _onlyContainsCACerts: bool,
    pub _onlySomeReasons:
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+IssuingDistributionPoint")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint {
...
impl crate::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint>,
    > {
    ...
    pub fn appendObject(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 4usize>("appendObject")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (buf, sep, name, val))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_OnlyContainsAttributeCerts(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
