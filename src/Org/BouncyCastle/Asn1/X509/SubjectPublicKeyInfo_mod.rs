#[cfg(feature = "Org+BouncyCastle+Asn1+X509+SubjectPublicKeyInfo")]
#[repr(C)]
#[derive(Debug)]
pub struct SubjectPublicKeyInfo {
    ...
    >,
    pub keyData: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
}
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+SubjectPublicKeyInfo")]
unsafe impl quest_hook::libil2cpp::Type
for crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X509";
    const CLASS_NAME: &'static str = "SubjectPublicKeyInfo";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+SubjectPublicKeyInfo")]
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+SubjectPublicKeyInfo")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+SubjectPublicKeyInfo")]
impl crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as
    ...
    pub fn New_AlgorithmIdentifier_Asn1Encodable0(
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (algID, publicKey))?;
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as
                    quest_hook::libil2cpp::Type > ::class(), "ParsePublicKey", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1Object,
    ...
    pub fn _ctor_AlgorithmIdentifier_Asn1Encodable0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (algID, publicKey))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as
                    quest_hook::libil2cpp::Type > ::class(), "get_AlgorithmID", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo as
                    quest_hook::libil2cpp::Type > ::class(), "get_PublicKeyData", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
