#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+AccessDescription")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::X509::AccessDescription {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AccessDescription>,
    > {
    ...
    pub fn New_DerObjectIdentifier_GeneralName1(
        ...
        location: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::GeneralName>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier_GeneralName1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, location))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+AccessDescription")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::AccessDescription {
