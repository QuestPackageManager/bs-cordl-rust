...
impl crate::Org::BouncyCastle::Asn1::X509::Qualified::SemanticsInformation {
    ...
    pub fn _ctor_DerObjectIdentifier2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (semanticsIdentifier))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (semanticsIdentifier, generalNames))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (generalNames))?
        };
        Ok(__cordl_ret.into())
    }
