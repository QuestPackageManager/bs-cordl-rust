...
pub struct BiometricData {
    ...
    pub biometricDataHash:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
    pub sourceDataUri: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerIA5String>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+Qualified+BiometricData")]
    ...
    for crate::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData
{
    ...
    const CLASS_NAME: &'static str = "BiometricData";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+Qualified+BiometricData")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData {
...
impl crate::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::Qualified::BiometricData>,
    > {
    ...
    pub fn New_TypeOfBiometricData_AlgorithmIdentifier_Asn1OctetString_DerIA5String1(
        ...
        biometricDataHash: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1OctetString,
        >,
        sourceDataUri: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerIA5String>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object).invoke_void(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::Qualified::TypeOfBiometricData,
                    >, 0usize>("get_TypeOfBiometricData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
