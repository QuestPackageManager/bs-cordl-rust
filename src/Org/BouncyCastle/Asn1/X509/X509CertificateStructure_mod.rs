#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+X509CertificateStructure")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+X509CertificateStructure")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure {
...
impl crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure {
    ...
    pub fn _ctor_TbsCertificateStructure_AlgorithmIdentifier_DerBitString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tbsCert, sigAlgID, sig))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_EndDate(
        &mut self,
