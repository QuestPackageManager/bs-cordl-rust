#[cfg(feature = "Org+BouncyCastle+Asn1+X509+X509CertificateStructure")]
#[repr(C)]
#[derive(Debug)]
pub struct X509CertificateStructure {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub tbsCert: quest_hook::libil2cpp::Gc<
...
for crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X509";
    const CLASS_NAME: &'static str = "X509CertificateStructure";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+X509CertificateStructure")]
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+X509CertificateStructure")]
impl crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as
    ...
    pub fn New_TbsCertificateStructure_AlgorithmIdentifier_DerBitString0(
        ...
        sigAlgID: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        >,
        sig: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (tbsCert, sigAlgID, sig))?;
        Ok(__cordl_object.into())
    }
    pub fn ToAsn1Object(
        &mut self,
    ...
    pub fn _ctor_TbsCertificateStructure_AlgorithmIdentifier_DerBitString0(
        &mut self,
        tbsCert: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure,
        >,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (tbsCert, sigAlgID, sig))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_EndDate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as
                    quest_hook::libil2cpp::Type > ::class(), "get_EndDate", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as
                    quest_hook::libil2cpp::Type > ::class(), "get_StartDate", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::Time,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure as
                    quest_hook::libil2cpp::Type > ::class(), "get_TbsCertificate", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure,
