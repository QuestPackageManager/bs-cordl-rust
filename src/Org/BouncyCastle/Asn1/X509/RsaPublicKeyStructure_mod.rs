...
for crate::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure {
    ...
    const CLASS_NAME: &'static str = "RsaPublicKeyStructure";
...
impl crate::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure as
    ...
    pub fn _ctor_BigInteger_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (modulus, publicExponent))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Modulus(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure as
                    quest_hook::libil2cpp::Type > ::class(), "get_PublicExponent", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
