#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+RsaPublicKeyStructure")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::RsaPublicKeyStructure>,
    > {
    ...
    pub fn _ctor_BigInteger_BigInteger0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (modulus, publicExponent))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Modulus(
        &mut self,
