#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+X509NameEntryConverter")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Asn1+X509+X509NameEntryConverter")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ConvertHexEncoded", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Object> =
            unsafe { cordl_method_info.invoke_unchecked(self, (hexString, offset))? };
        Ok(__cordl_ret.into())
    }
