#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+AttCertValidityPeriod")]
#[repr(C)]
...
pub struct AttCertValidityPeriod {
    ...
    pub notAfterTime: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerGeneralizedTime>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+AttCertValidityPeriod")]
...
impl crate::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod {
    ...
    pub fn New_DerGeneralizedTime_DerGeneralizedTime1(
        ...
        >,
        notAfterTime: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerGeneralizedTime>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerGeneralizedTime_DerGeneralizedTime1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (notBeforeTime, notAfterTime))? };
        Ok(__cordl_ret.into())
    }
