...
for crate::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod {
    ...
    const CLASS_NAME: &'static str = "AttCertValidityPeriod";
...
impl crate::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool1(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod as
    ...
    pub fn _ctor_DerGeneralizedTime_DerGeneralizedTime1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (notBeforeTime, notAfterTime))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod as
                    quest_hook::libil2cpp::Type > ::class(), "get_NotAfterTime", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::DerGeneralizedTime,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod as
                    quest_hook::libil2cpp::Type > ::class(), "get_NotBeforeTime", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::DerGeneralizedTime,
