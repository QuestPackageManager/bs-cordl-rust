#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+CrlNumber")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+CrlNumber")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::X509::CrlNumber {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.X509";
    const CLASS_NAME: &'static str = "CrlNumber";
...
impl crate::Org::BouncyCastle::Asn1::X509::CrlNumber {
    pub fn New(
        number: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (number))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Number(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+X509+CrlNumber")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::X509::CrlNumber {
