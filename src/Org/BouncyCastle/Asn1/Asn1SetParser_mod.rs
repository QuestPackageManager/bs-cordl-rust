#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Asn1SetParser")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Asn1SetParser")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Asn1SetParser {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "Asn1SetParser";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Asn1SetParser")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Asn1SetParser {
