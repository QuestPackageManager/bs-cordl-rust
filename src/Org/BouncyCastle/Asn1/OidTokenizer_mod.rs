...
for crate::Org::BouncyCastle::Asn1::OidTokenizer {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "OidTokenizer";
...
impl crate::Org::BouncyCastle::Asn1::OidTokenizer {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::OidTokenizer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::OidTokenizer as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (oid))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_HasMoreTokens(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::OidTokenizer as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_HasMoreTokens")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::OidTokenizer as
                    quest_hook::libil2cpp::Type > ::class(), "get_HasMoreTokens", 0usize
                )
            });
