#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerBitString")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerBitString")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::DerBitString {
...
impl crate::Org::BouncyCastle::Asn1::DerBitString {
    ...
    pub fn get_PadBits(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_PadBits")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
