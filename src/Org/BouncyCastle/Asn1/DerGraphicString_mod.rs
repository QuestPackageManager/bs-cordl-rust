#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerGraphicString")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerGraphicString")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::DerGraphicString {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "DerGraphicString";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerGraphicString")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::DerGraphicString {
