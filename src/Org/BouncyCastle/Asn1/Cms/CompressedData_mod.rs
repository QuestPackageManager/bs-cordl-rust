...
impl crate::Org::BouncyCastle::Asn1::Cms::CompressedData {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::CompressedData as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::CompressedData as
    ...
    pub fn _ctor_AlgorithmIdentifier_ContentInfo0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (compressionAlgorithm, encapContentInfo))?
        };
        Ok(__cordl_ret.into())
    }
