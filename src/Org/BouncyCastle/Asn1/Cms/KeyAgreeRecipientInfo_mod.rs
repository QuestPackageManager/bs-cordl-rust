...
for crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cms";
    const CLASS_NAME: &'static str = "KeyAgreeRecipientInfo";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Cms+KeyAgreeRecipientInfo")]
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Cms+KeyAgreeRecipientInfo")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Asn1+Cms+KeyAgreeRecipientInfo")]
impl crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as
    ...
    pub fn New_OriginatorIdentifierOrKey_Asn1OctetString_AlgorithmIdentifier_Asn1Sequence0(
        originator: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::OriginatorIdentifierOrKey,
        >,
        ukm: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
        keyEncryptionAlgorithm: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        >,
        recipientEncryptedKeys: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1Sequence,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
    ...
    pub fn _ctor_OriginatorIdentifierOrKey_Asn1OctetString_AlgorithmIdentifier_Asn1Sequence0(
        &mut self,
        originator: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::OriginatorIdentifierOrKey,
        >,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as
                    quest_hook::libil2cpp::Type > ::class(), "get_Originator", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::OriginatorIdentifierOrKey,
    ...
    pub fn get_RecipientEncryptedKeys(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as
                    quest_hook::libil2cpp::Type > ::class(),
                    "get_RecipientEncryptedKeys", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1Sequence,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo as
                    quest_hook::libil2cpp::Type > ::class(), "get_UserKeyingMaterial",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
