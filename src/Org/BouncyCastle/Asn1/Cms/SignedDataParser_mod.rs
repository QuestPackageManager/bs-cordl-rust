#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+SignedDataParser")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct SignedDataParser {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _seq: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1SequenceParser>,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+SignedDataParser")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cms::SignedDataParser {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cms";
    const CLASS_NAME: &'static str = "SignedDataParser";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+SignedDataParser")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cms::SignedDataParser {
