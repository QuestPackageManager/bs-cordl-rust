#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+Ecc+MQVuserKeyingMaterial")]
#[repr(C)]
#[derive(Debug)]
pub struct MQVuserKeyingMaterial {
    ...
    pub addedukm: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+Ecc+MQVuserKeyingMaterial")]
    ...
    for crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial
{
    ...
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cms.Ecc";
    const CLASS_NAME: &'static str = "MQVuserKeyingMaterial";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial {
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Cms+Ecc+MQVuserKeyingMaterial")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial {
...
impl crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial>,
    > {
    ...
    pub fn New_OriginatorPublicKey_Asn1OctetString0(
        ...
        >,
        addedukm: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1OctetString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_OriginatorPublicKey_Asn1OctetString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ephemeralPublicKey, addedukm))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_AddedUkm(
        &mut self,
