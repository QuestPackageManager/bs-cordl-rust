...
impl crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial as
    ...
    pub fn _ctor_OriginatorPublicKey_Asn1OctetString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ephemeralPublicKey, addedukm))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_AddedUkm(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Cms::Ecc::MQVuserKeyingMaterial as
                    quest_hook::libil2cpp::Type > ::class(), "get_AddedUkm", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1OctetString,
