#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+Attributes")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+Attributes")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cms::Attributes {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cms";
    const CLASS_NAME: &'static str = "Attributes";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+Attributes")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cms::Attributes {
