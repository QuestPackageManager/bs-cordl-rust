#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+RecipientEncryptedKey")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Asn1::Cms::RecipientEncryptedKey {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::RecipientEncryptedKey>,
    > {
    ...
    pub fn _ctor_KeyAgreeRecipientIdentifier_Asn1OctetString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (id, encryptedKey))? };
        Ok(__cordl_ret.into())
    }
