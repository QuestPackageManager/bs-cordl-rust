...
impl crate::Org::BouncyCastle::Asn1::Cms::RecipientEncryptedKey {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::RecipientEncryptedKey as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::RecipientEncryptedKey as
    ...
    pub fn _ctor_KeyAgreeRecipientIdentifier_Asn1OctetString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (id, encryptedKey))?
        };
        Ok(__cordl_ret.into())
    }
