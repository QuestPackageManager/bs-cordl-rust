...
impl crate::Org::BouncyCastle::Asn1::Cms::TimeStampTokenEvidence {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::TimeStampTokenEvidence,
        > = unsafe { cordl_method_info.invoke_unchecked((), (tagged, isExplicit))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (timeStampAndCrls))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TimeStampAndCrl1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (timeStampAndCrl))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+TimeStampTokenEvidence")]
