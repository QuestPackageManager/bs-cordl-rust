#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+KekIdentifier")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+KekIdentifier")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cms::KekIdentifier {
...
impl crate::Org::BouncyCastle::Asn1::Cms::KekIdentifier {
    ...
    pub fn _ctor_Il2CppArray_DerGeneralizedTime_OtherKeyAttribute0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyIdentifier, date, other))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Date(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+KekIdentifier")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cms::KekIdentifier {
