#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+AuthenticatedData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+AuthenticatedData")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cms::AuthenticatedData {
...
impl crate::Org::BouncyCastle::Asn1::Cms::AuthenticatedData {
    pub fn CalculateVersion(
        origInfo: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::OriginatorInfo>,
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (origInfo))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_EncapsulatedContentInfo", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+AuthenticatedData")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cms::AuthenticatedData {
