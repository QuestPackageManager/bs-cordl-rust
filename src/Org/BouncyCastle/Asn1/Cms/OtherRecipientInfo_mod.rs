#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OtherRecipientInfo")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct OtherRecipientInfo {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub oriType: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
    pub oriValue: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OtherRecipientInfo")]
    ...
    for crate::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo
{
    ...
    const CLASS_NAME: &'static str = "OtherRecipientInfo";
...
impl crate::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo {
    pub fn GetInstance_Asn1TaggedObject__cordl_bool0(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo>,
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo,
                    >, 2usize>("GetInstance")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn New_DerObjectIdentifier_Asn1Encodable0(
        oriType: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
        oriValue: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oriType, oriValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_OriType(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OtherRecipientInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo {
