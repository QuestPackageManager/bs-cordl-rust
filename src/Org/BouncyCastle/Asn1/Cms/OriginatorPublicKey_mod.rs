#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OriginatorPublicKey")]
#[repr(C)]
#[derive(Debug)]
pub struct OriginatorPublicKey {
    ...
    pub mPublicKey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OriginatorPublicKey")]
    ...
    for crate::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey
{
    ...
    const CLASS_NAME: &'static str = "OriginatorPublicKey";
