#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+AuthEnvelopedDataParser")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Cms+AuthEnvelopedDataParser")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Cms::AuthEnvelopedDataParser {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("GetAuthEncryptedContentInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
