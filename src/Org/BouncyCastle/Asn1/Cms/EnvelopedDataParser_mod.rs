#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+EnvelopedDataParser")]
#[repr(C)]
#[derive(Debug)]
pub struct EnvelopedDataParser {
    ...
    pub _nextObject: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::IAsn1Convertible>,
    ...
    for crate::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser
{
    ...
    const CLASS_NAME: &'static str = "EnvelopedDataParser";
...
impl crate::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser {
    pub fn GetEncryptedContentInfo(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser>,
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("GetEncryptedContentInfo")
                    .unwrap_or_else(|e| {
                        panic!(
