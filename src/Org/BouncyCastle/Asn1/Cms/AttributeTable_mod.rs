...
impl crate::Org::BouncyCastle::Asn1::Cms::AttributeTable {
    ...
    > {
        ...
        > = __cordl_object.invoke("Add", (attrType, attrValue))?;
        Ok(__cordl_ret.into())
    }
    pub fn AddAttribute(
        &mut self,
    ...
    > {
        ...
        > = __cordl_object.invoke("GetAll", (oid))?;
        Ok(__cordl_ret.into())
    }
    pub fn New_Gc0(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::AttributeTable,
        > = __cordl_object.invoke("Remove", (attrType))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Asn1EncodableVector,
        > = __cordl_object.invoke("ToAsn1EncodableVector", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn ToAttributes(
        &mut self,
    ...
    > {
        ...
        > = __cordl_object.invoke("ToAttributes", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn ToDictionary(
        &mut self,
    ...
    > {
        ...
        > = __cordl_object.invoke("ToHashtable", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Gc0(
        &mut self,
