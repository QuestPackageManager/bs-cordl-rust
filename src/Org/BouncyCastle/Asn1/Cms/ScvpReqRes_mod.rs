...
impl crate::Org::BouncyCastle::Asn1::Cms::ScvpReqRes {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::ScvpReqRes as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::ScvpReqRes as
    ...
    pub fn _ctor_ContentInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (response))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ContentInfo_ContentInfo2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (request, response))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Request(
