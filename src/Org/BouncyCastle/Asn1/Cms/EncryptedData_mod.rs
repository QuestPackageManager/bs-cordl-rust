...
impl crate::Org::BouncyCastle::Asn1::Cms::EncryptedData {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::EncryptedData as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::EncryptedData as
    ...
    pub fn _ctor_EncryptedContentInfo0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (encInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_EncryptedContentInfo_Asn1Set1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (encInfo, unprotectedAttrs))?
        };
        Ok(__cordl_ret.into())
    }
