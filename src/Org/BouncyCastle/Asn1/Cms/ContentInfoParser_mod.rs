...
impl crate::Org::BouncyCastle::Asn1::Cms::ContentInfoParser {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Cms::ContentInfoParser as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Cms::ContentInfoParser as
