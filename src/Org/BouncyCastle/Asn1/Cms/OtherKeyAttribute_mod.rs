#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OtherKeyAttribute")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct OtherKeyAttribute {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub keyAttrId: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
    pub keyAttr: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OtherKeyAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Cms::OtherKeyAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Cms";
    const CLASS_NAME: &'static str = "OtherKeyAttribute";
...
impl crate::Org::BouncyCastle::Asn1::Cms::OtherKeyAttribute {
    ...
    pub fn New_DerObjectIdentifier_Asn1Encodable1(
        keyAttrId: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
        keyAttr: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyAttrId, keyAttr))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_KeyAttr(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Cms+OtherKeyAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Cms::OtherKeyAttribute {
