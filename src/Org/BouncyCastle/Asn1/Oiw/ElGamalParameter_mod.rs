#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Oiw+ElGamalParameter")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Oiw+ElGamalParameter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Oiw::ElGamalParameter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Oiw";
    const CLASS_NAME: &'static str = "ElGamalParameter";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Oiw+ElGamalParameter")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Oiw::ElGamalParameter {
