...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerBmpString")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::DerBmpString {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1";
    const CLASS_NAME: &'static str = "DerBmpString";
...
impl crate::Org::BouncyCastle::Asn1::DerBmpString {
    ...
    pub fn GetInstance_Asn1TaggedObject__cordl_bool1(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBmpString>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::DerBmpString,
                        >,
                        2usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBmpString> =
    ...
    pub fn New_Il2CppArray1(
        str: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<char>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+DerBmpString")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::DerBmpString {
