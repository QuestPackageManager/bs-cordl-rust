#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Asn1+IsisMtt+X509+AdditionalInformationSyntax"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Asn1::IsisMtt::X509::AdditionalInformationSyntax {
    ...
    pub fn _ctor_DirectoryString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (information))?
        };
        Ok(__cordl_ret.into())
    }
