...
for crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit {
    ...
    const CLASS_NAME: &'static str = "MonetaryLimit";
...
impl crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit,
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as
    ...
    pub fn New_Il2CppString_i32_i32_1(
        currency: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        amount: i32,
        exponent: i32,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
    ...
    pub fn _ctor_Il2CppString_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (currency, amount, exponent))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Amount(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as
                    quest_hook::libil2cpp::Type > ::class(), "get_Amount", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as
                    quest_hook::libil2cpp::Type > ::class(), "get_Currency", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::IsisMtt::X509::MonetaryLimit as
                    quest_hook::libil2cpp::Type > ::class(), "get_Exponent", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
