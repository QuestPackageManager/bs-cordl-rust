#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+IsisMtt+X509+AdmissionSyntax")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Asn1+IsisMtt+X509+AdmissionSyntax")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax {
...
impl crate::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            ...
                            >,
                        >,
                    >, 0usize>("GetContentsOfAdmissions")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor_GeneralName_Asn1Sequence1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (admissionAuthority, contentsOfAdmissions))?
        };
        Ok(__cordl_ret.into())
    }
