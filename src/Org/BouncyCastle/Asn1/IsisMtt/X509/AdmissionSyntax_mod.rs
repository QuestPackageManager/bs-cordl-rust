...
impl crate::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax {
    pub fn GetContentsOfAdmissions(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax as
                    quest_hook::libil2cpp::Type > ::class(), "GetContentsOfAdmissions",
                    0usize
                )
            });
    ...
    pub fn _ctor_GeneralName_Asn1Sequence1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (admissionAuthority, contentsOfAdmissions))?
        };
        Ok(__cordl_ret.into())
    }
