#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+CertificationRequestInfo")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequestInfo
{
    ...
    const CLASS_NAME: &'static str = "CertificationRequestInfo";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Pkcs+CertificationRequestInfo")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequestInfo {
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequestInfo {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequestInfo>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ValidateAttributes", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (attributes))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_X509Name_SubjectPublicKeyInfo_Asn1Set0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (subject, pkInfo, attributes))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo,
                    >, 0usize>("get_SubjectPublicKeyInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
