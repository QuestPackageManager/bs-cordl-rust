#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+IssuerAndSerialNumber")]
#[repr(C)]
#[derive(Debug)]
pub struct IssuerAndSerialNumber {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub name: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
    pub certSerialNumber: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerInteger>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+IssuerAndSerialNumber")]
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::IssuerAndSerialNumber {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::IssuerAndSerialNumber>,
    > {
    ...
    pub fn New_X509Name_BigInteger1(
        ...
        certSerialNumber: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn New_X509Name_DerInteger2(
        name: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
        certSerialNumber: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerInteger>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_X509Name_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, certSerialNumber))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_CertificateSerialNumber", 0usize
                        )
                    })
            });
