...
impl crate::Org::BouncyCastle::Asn1::Pkcs::IssuerAndSerialNumber {
    pub fn GetInstance(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::IssuerAndSerialNumber as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Pkcs::IssuerAndSerialNumber as
    ...
    pub fn _ctor_X509Name_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (name, certSerialNumber))?
        };
        Ok(__cordl_ret.into())
    }
