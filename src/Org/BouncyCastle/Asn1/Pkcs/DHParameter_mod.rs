...
for crate::Org::BouncyCastle::Asn1::Pkcs::DHParameter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Pkcs";
    const CLASS_NAME: &'static str = "DHParameter";
...
#[cfg(feature = "Org+BouncyCastle+Asn1+Pkcs+DHParameter")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Asn1::Pkcs::DHParameter {
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::DHParameter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::DHParameter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Object>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Pkcs::DHParameter as
    ...
    pub fn _ctor_BigInteger_BigInteger_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p, g, l))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
