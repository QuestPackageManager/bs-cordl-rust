...
for crate::Org::BouncyCastle::Asn1::Pkcs::ContentInfo {
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::ContentInfo {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::ContentInfo as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo as
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (contentType, content))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Content(
