#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+AuthenticatedSafe")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Asn1::Pkcs::AuthenticatedSafe
{
    ...
    const CLASS_NAME: &'static str = "AuthenticatedSafe";
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::AuthenticatedSafe {
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::AuthenticatedSafe>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Pkcs::AuthenticatedSafe,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+AuthenticatedSafe")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Pkcs::AuthenticatedSafe {
