#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+CertificationRequest")]
#[repr(C)]
#[derive(Debug)]
pub struct CertificationRequest {
    ...
    pub sigBits: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerBitString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+CertificationRequest")]
    ...
    for crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest
{
    ...
    const CLASS_NAME: &'static str = "CertificationRequest";
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("GetCertificationRequestInfo")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor_CertificationRequestInfo_AlgorithmIdentifier_DerBitString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (requestInfo, algorithm, signature))?
        };
        Ok(__cordl_ret.into())
    }
