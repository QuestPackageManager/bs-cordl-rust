...
impl crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest {
    pub fn GetCertificationRequestInfo(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Org::BouncyCastle::Asn1::Pkcs::CertificationRequestInfo,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest as
                    quest_hook::libil2cpp::Type > ::class(),
                    "GetCertificationRequestInfo", 0usize
                )
            });
    ...
    pub fn _ctor_CertificationRequestInfo_AlgorithmIdentifier_DerBitString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (requestInfo, algorithm, signature))?
        };
        Ok(__cordl_ret.into())
    }
