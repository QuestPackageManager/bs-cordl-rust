#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+KeyDerivationFunc")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Asn1::Pkcs::KeyDerivationFunc
{
    ...
    const CLASS_NAME: &'static str = "KeyDerivationFunc";
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::KeyDerivationFunc {
    ...
    pub fn _ctor_DerObjectIdentifier_Asn1Encodable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (id, parameters))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+KeyDerivationFunc")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Pkcs::KeyDerivationFunc {
