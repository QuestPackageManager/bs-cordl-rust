#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+PbeS2Parameters")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct PbeS2Parameters {
    __cordl_parent: crate::Org::BouncyCastle::Asn1::Asn1Encodable,
    pub func: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::KeyDerivationFunc>,
    pub scheme: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::EncryptionScheme>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+PbeS2Parameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Asn1.Pkcs";
    const CLASS_NAME: &'static str = "PbeS2Parameters";
...
impl crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters {
    pub fn GetInstance(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters>,
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters,
                        >,
                        1usize,
                    >("GetInstance")
                    .unwrap_or_else(|e| {
    ...
    pub fn _ctor_KeyDerivationFunc_EncryptionScheme0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyDevFunc, encScheme))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::Pkcs::EncryptionScheme,
                    >, 0usize>("get_EncryptionScheme")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_EncryptionScheme",
                            0usize
                        )
                    })
            });
    ...
    pub fn get_KeyDerivationFunc(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Pkcs::KeyDerivationFunc>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::Pkcs::KeyDerivationFunc,
                    >, 0usize>("get_KeyDerivationFunc")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_KeyDerivationFunc",
                            0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Asn1+Pkcs+PbeS2Parameters")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters {
