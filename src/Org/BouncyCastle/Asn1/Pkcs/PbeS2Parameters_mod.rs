...
impl crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters as
    ...
    pub fn _ctor_KeyDerivationFunc_EncryptionScheme0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (keyDevFunc, encScheme))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters as
                    quest_hook::libil2cpp::Type > ::class(), "get_EncryptionScheme",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Asn1::Pkcs::PbeS2Parameters as
                    quest_hook::libil2cpp::Type > ::class(), "get_KeyDerivationFunc",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
