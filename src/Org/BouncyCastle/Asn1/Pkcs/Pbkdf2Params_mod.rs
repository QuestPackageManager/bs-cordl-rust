...
impl crate::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params {
    ...
    pub fn _ctor_Il2CppArray_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (salt, iterationCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_i32_AlgorithmIdentifier4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (salt, iterationCount, prf))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_i32_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (salt, iterationCount, keyLength))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_i32_i32_AlgorithmIdentifier3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (salt, iterationCount, keyLength, prf))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "get_Prf",
                            0usize
                        )
                    })
            });
