...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Asn1::DerEnumerated =>
...
impl crate::Org::BouncyCastle::Asn1::DerEnumerated {
    ...
    pub fn New_i32_0(val: i32) -> quest_hook::libil2cpp::Result<&'static mut Self> {
    ...
    pub fn New_i64_1(val: i64) -> quest_hook::libil2cpp::Result<&'static mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (val))?;
