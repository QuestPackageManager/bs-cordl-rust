...
impl crate::Org::BouncyCastle::Asn1::Asn1EncodableVector {
    ...
    pub fn AddOptional(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (objs))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddOptionalTagged", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isExplicit, tagNo, obj))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Reallocate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (minCapacity))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TakeElements(
