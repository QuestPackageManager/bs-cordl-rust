#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+PublicSubkeyPacket")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+PublicSubkeyPacket")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::PublicSubkeyPacket {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg";
    const CLASS_NAME: &'static str = "PublicSubkeyPacket";
...
impl crate::Org::BouncyCastle::Bcpg::PublicSubkeyPacket {
    ...
    pub fn _ctor_PublicKeyAlgorithmTag_DateTime_IBcpgKey1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (algorithm, _cordl_time, key))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+PublicSubkeyPacket")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::PublicSubkeyPacket {
