#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+DsaPublicBcpgKey")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+DsaPublicBcpgKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::DsaPublicBcpgKey {
...
impl crate::Org::BouncyCastle::Bcpg::DsaPublicBcpgKey {
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p, q, g, y))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Format(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+DsaPublicBcpgKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::DsaPublicBcpgKey {
