...
impl crate::Org::BouncyCastle::Bcpg::DsaPublicBcpgKey {
    pub fn Encode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::DsaPublicBcpgKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::DsaPublicBcpgKey as
