...
impl crate::Org::BouncyCastle::Bcpg::S2k {
    ...
    pub fn _ctor_HashAlgorithmTag1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_HashAlgorithmTag_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, iv))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_HashAlgorithmTag_Il2CppArray_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, iv, itCount))?
        };
        Ok(__cordl_ret.into())
    }
