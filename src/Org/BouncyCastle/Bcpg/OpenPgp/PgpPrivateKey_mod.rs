...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    i64,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (keyID, publicKeyPacket, privateKey))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Key(
