...
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRingBundle {
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+OpenPgp+PgpPublicKeyRingBundle")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRingBundle {
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRingBundle {
    pub fn AddPublicKeyRing(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRingBundle>,
    > {
    ...
    pub fn _ctor_IDictionary_IList0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pubRings, order))? };
        Ok(__cordl_ret.into())
    }
