...
for crate::Org::BouncyCastle::Bcpg::OpenPgp::IStreamGenerator {
    ...
    const CLASS_NAME: &'static str = "IStreamGenerator";
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::IStreamGenerator {
    pub fn Close(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::OpenPgp::IStreamGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Close")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Bcpg::OpenPgp::IStreamGenerator as
