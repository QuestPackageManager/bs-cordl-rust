#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpUserAttributeSubpacketVector")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpUserAttributeSubpacketVector {
