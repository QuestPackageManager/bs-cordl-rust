#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpMarker")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpMarker")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg.OpenPgp";
    const CLASS_NAME: &'static str = "PgpMarker";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpMarker")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker {
