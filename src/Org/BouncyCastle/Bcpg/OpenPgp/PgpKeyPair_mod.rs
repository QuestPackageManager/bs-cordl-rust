#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpKeyPair")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpKeyPair")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair {
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair {
    ...
    pub fn _ctor_PgpPublicKey_PgpPrivateKey2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_pub, _cordl_priv))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PublicKeyAlgorithmTag_AsymmetricCipherKeyPair_DateTime0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (algorithm, keyPair, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PublicKeyAlgorithmTag_AsymmetricKeyParameter_AsymmetricKeyParameter_DateTime1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, pubKey, privKey, _cordl_time))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpKeyPair")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair {
