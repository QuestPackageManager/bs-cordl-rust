...
for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental {
    ...
    const CLASS_NAME: &'static str = "PgpExperimental";
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental as
