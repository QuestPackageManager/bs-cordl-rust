...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature {
    ...
    pub fn Update_Il2CppArray_i32_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bytes, off, length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Update_u8_0(
    ...
    pub fn Verify(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (pgpSig))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_BcpgInputStream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bcpgInput))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_OnePassSignaturePacket1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sigPack))?
        };
        Ok(__cordl_ret.into())
    }
