#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpOnePassSignature")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct PgpOnePassSignature {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub sigPack: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::OnePassSignaturePacket>,
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+OpenPgp+PgpOnePassSignature")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature {
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("InitVerify")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn New_BcpgInputStream0(
        bcpgInput: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::BcpgInputStream>,
    ...
    pub fn New_OnePassSignaturePacket1(
        sigPack: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::OnePassSignaturePacket>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn Update_Il2CppArray_i32_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bytes, off, length))? };
        Ok(__cordl_ret.into())
    }
    pub fn Update_u8_0(
        &mut self,
    ...
    pub fn Verify(
        &mut self,
        pgpSig: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature>,
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (pgpSig))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_BcpgInputStream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bcpgInput))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_OnePassSignaturePacket1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sigPack))? };
        Ok(__cordl_ret.into())
    }
