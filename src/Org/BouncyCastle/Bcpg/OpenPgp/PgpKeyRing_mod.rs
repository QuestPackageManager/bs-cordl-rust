#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpKeyRing")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpKeyRing")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRing {
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRing {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadOptionalTrustPacket", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::TrustPacket> =
            unsafe { cordl_method_info.invoke_unchecked((), (bcpgInput))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReadUserIDs(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<crate::System::Collections::IList>,
                        >,
                    ), quest_hook::libil2cpp::Void, 4usize>("ReadUserIDs")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (bcpgInput, ids, idTrusts, idSigs))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpKeyRing")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRing {
