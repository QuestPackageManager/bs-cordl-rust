...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyRingGenerator {
    pub fn AddSubKey_HashAlgorithmTag1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyPair, hashAlgorithm))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddSubKey_PgpKeyPair0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyPair))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddSubKey_PgpSignatureSubpacketVector_PgpSignatureSubpacketVector2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (keyPair, hashedPackets, unhashedPackets))?
        };
        Ok(__cordl_ret.into())
    }
