...
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpLiteralDataGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+OpenPgp+PgpLiteralDataGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpLiteralDataGenerator {
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpLiteralDataGenerator {
    ...
    pub fn Open_FileInfo2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::Stream> =
            unsafe { cordl_method_info.invoke_unchecked(self, (outStr, format, file))? };
        Ok(__cordl_ret.into())
    }
    pub fn Open_Il2CppString_DateTime_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::Stream> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (outStr, format, name, modificationTime, buffer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Open_Il2CppString_i64_DateTime0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::Stream> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (outStr, format, name, length, modificationTime))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteHeader(
        &mut self,
        outStr: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::BcpgOutputStream>,
        format: char,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i64,
                    ), quest_hook::libil2cpp::Void, 4usize>("WriteHeader")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStr, format, encName, modificationTime))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oldFormat))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpLiteralDataGenerator")]
