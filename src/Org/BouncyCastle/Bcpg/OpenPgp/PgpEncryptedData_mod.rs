...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData {
    ...
    pub fn New(
        encData: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::InputStreamPacket>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encData))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpEncryptedData")]
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+OpenPgp+PgpEncryptedData+TruncatedStream")]
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData_TruncatedStream {
