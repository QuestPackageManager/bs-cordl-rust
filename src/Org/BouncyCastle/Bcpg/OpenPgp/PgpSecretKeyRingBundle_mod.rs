...
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle {
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+OpenPgp+PgpSecretKeyRingBundle")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle {
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle {
    pub fn AddSecretKeyRing(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRingBundle>,
    > {
    ...
    pub fn Contains(&mut self, keyID: i64) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (keyID))? };
        Ok(__cordl_ret.into())
    }
    pub fn Encode(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        bool,
                    ), quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerable>, 2usize>(
                        "GetKeyRings",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                        bool,
                    ), quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerable>, 3usize>(
                        "GetKeyRings",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerable> = unsafe {
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSecretKeyRing,
                    >, 1usize>("GetSecretKeyRing")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_IDictionary_IList0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (secretRings, order))? };
        Ok(__cordl_ret.into())
    }
