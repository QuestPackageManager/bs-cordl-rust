...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataList {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataList as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataList as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataList as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataList as
                    quest_hook::libil2cpp::Type > ::class(), "GetEncryptedDataObjects",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
