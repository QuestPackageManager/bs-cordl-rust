...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedDataList {
    ...
    pub fn GetEncryptedDataObjects(
        ...
        let __cordl_ret: *mut crate::System::Collections::IEnumerable = __cordl_object
            .invoke("GetEncryptedDataObjects", ())?;
        Ok(__cordl_ret)
    }
    pub fn New(
    ...
    pub fn get_Item(
        ...
        *mut crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData = __cordl_object
