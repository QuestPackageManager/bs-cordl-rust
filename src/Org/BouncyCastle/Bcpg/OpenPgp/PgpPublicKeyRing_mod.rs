#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpPublicKeyRing")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRing {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKeyRing,
        > = unsafe { cordl_method_info.invoke_unchecked((), (pubRing, pubKey))? };
        Ok(__cordl_ret.into())
    }
    pub fn New_IList1(
    ...
    pub fn _ctor_IList1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pubKeys))? };
        Ok(__cordl_ret.into())
    }
