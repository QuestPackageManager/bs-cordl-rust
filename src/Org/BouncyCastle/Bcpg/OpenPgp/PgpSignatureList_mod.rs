#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OpenPgp+PgpSignatureList")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureList
{
    ...
    const CLASS_NAME: &'static str = "PgpSignatureList";
...
impl crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureList {
    ...
    pub fn New_PgpSignature1(
        sig: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sigs))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PgpSignature1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sig))? };
        Ok(__cordl_ret.into())
    }
