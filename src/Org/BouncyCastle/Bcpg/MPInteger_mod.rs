...
#[cfg(feature = "Org+BouncyCastle+Bcpg+MPInteger")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::MPInteger {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg";
    const CLASS_NAME: &'static str = "MPInteger";
...
impl crate::Org::BouncyCastle::Bcpg::MPInteger {
    pub fn Encode_BcpgOutputStream0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::MPInteger as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::MPInteger as
    ...
    pub fn Encode_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (bcpgOut, val))?
        };
        Ok(__cordl_ret.into())
    }
