...
impl crate::Org::BouncyCastle::Bcpg::ArmoredOutputStream {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "DoClose",
                            0usize
                        )
                    })
            });
    ...
    pub fn Encode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (outStream, data, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndClearText(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteHeaderEntry", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, v))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IDictionary1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStream, headers))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Stream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStream))?
        };
        Ok(__cordl_ret.into())
    }
}
