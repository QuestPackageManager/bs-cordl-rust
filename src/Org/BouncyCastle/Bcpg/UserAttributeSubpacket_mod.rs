#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+UserAttributeSubpacket")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+UserAttributeSubpacket")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacket {
...
impl crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacket {
    ...
    pub fn _ctor__cordl_bool_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, forceLongLength, data))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_SubpacketType(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_SubpacketType", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+UserAttributeSubpacket")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacket {
