#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ModDetectionCodePacket")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ModDetectionCodePacket")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::ModDetectionCodePacket {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg";
    const CLASS_NAME: &'static str = "ModDetectionCodePacket";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ModDetectionCodePacket")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::ModDetectionCodePacket {
