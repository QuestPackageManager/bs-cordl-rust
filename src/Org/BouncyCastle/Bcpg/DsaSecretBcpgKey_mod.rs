#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+DsaSecretBcpgKey")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct DsaSecretBcpgKey {
    __cordl_parent: crate::Org::BouncyCastle::Bcpg::BcpgObject,
    pub x: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::MPInteger>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+DsaSecretBcpgKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::DsaSecretBcpgKey {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg";
    const CLASS_NAME: &'static str = "DsaSecretBcpgKey";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::DsaSecretBcpgKey {
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+DsaSecretBcpgKey")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Bcpg::DsaSecretBcpgKey {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Bcpg+DsaSecretBcpgKey")]
impl crate::Org::BouncyCastle::Bcpg::DsaSecretBcpgKey {
    pub fn Encode(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+DsaSecretBcpgKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::DsaSecretBcpgKey {
