#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+KeyExpirationTime")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+KeyExpirationTime")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::Sig::KeyExpirationTime {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg.Sig";
    const CLASS_NAME: &'static str = "KeyExpirationTime";
...
impl crate::Org::BouncyCastle::Bcpg::Sig::KeyExpirationTime {
    ...
    pub fn _ctor_i64_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (critical, seconds))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+KeyExpirationTime")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::Sig::KeyExpirationTime {
