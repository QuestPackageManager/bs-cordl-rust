#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+PrimaryUserId")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+PrimaryUserId")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::Sig::PrimaryUserId {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg.Sig";
    const CLASS_NAME: &'static str = "PrimaryUserId";
...
impl crate::Org::BouncyCastle::Bcpg::Sig::PrimaryUserId {
    ...
    pub fn IsPrimaryUserId(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsPrimaryUserId")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor__cordl_bool__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (critical, isPrimaryUserId))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+PrimaryUserId")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::Sig::PrimaryUserId {
