#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+IssuerKeyId")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+IssuerKeyId")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::Sig::IssuerKeyId {
...
impl crate::Org::BouncyCastle::Bcpg::Sig::IssuerKeyId {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (keyId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_i64_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, i64), quest_hook::libil2cpp::Void, 2usize>(".ctor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (critical, keyId))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+IssuerKeyId")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::Sig::IssuerKeyId {
