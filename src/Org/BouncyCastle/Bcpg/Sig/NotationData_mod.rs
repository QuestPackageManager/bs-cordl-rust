#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+NotationData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+NotationData")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::Sig::NotationData {
...
impl crate::Org::BouncyCastle::Bcpg::Sig::NotationData {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> = unsafe {
            cordl_method_info.invoke_unchecked((), (humanReadable, notationName, notationValue))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (critical, humanReadable, notationName, notationValue))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+NotationData")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::Sig::NotationData {
