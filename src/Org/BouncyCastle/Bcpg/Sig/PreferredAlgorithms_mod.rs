#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+Sig+PreferredAlgorithms")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Bcpg::Sig::PreferredAlgorithms {
    ...
    pub fn _ctor_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, critical, preferences))?
        };
        Ok(__cordl_ret.into())
    }
