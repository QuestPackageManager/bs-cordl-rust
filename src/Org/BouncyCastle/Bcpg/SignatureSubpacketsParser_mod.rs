...
for crate::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser {
    ...
    const CLASS_NAME: &'static str = "SignatureSubpacketsParser";
...
impl crate::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::SignatureSubpacketsParser as
                    quest_hook::libil2cpp::Type > ::class(), "CheckData", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe { method.invoke_unchecked(self, (data, expected, bytesRead, name))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
