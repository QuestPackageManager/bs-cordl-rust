#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OutputStreamPacket")]
#[repr(C)]
#[derive(Debug)]
pub struct OutputStreamPacket {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub bcpgOut: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::BcpgOutputStream>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OutputStreamPacket")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::OutputStreamPacket {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg";
    const CLASS_NAME: &'static str = "OutputStreamPacket";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+OutputStreamPacket")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::OutputStreamPacket {
