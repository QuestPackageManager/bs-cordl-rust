...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ECPublicBcpgKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::ECPublicBcpgKey {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Bcpg";
    const CLASS_NAME: &'static str = "ECPublicBcpgKey";
...
impl crate::Org::BouncyCastle::Bcpg::ECPublicBcpgKey {
    ...
    pub fn New_DerObjectIdentifier_BigInteger2(
        ...
        encodedPoint: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadBytesOfEncodedLength", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (bcpgIn))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_DerObjectIdentifier_BigInteger2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, encodedPoint))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier_ECPoint1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, point))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_CurveOid(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ECPublicBcpgKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::ECPublicBcpgKey {
