#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+TrustPacket")]
#[repr(C)]
#[derive(Debug)]
pub struct TrustPacket {
    __cordl_parent: crate::Org::BouncyCastle::Bcpg::ContainedPacket,
    pub levelAndTrustAmount: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+TrustPacket")]
...
impl crate::Org::BouncyCastle::Bcpg::TrustPacket {
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (trustCode))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+TrustPacket")]
