...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+RevocationKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::RevocationKey {
...
impl crate::Org::BouncyCastle::Bcpg::RevocationKey {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> = unsafe {
            cordl_method_info.invoke_unchecked((), (signatureClass, keyAlgorithm, fingerprint))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_SignatureClass(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Org::BouncyCastle::Bcpg::RevocationKeyTag> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Org::BouncyCastle::Bcpg::RevocationKeyTag, 0usize>(
                        "get_SignatureClass",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Org::BouncyCastle::Bcpg::RevocationKeyTag =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+RevocationKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::RevocationKey {
