...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ElGamalPublicBcpgKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::ElGamalPublicBcpgKey {
...
impl crate::Org::BouncyCastle::Bcpg::ElGamalPublicBcpgKey {
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p, g, y))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Format(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ElGamalPublicBcpgKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::ElGamalPublicBcpgKey {
