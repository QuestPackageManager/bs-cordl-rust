...
pub struct InputStreamPacket {
    __cordl_parent: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::Packet>,
...
impl std::ops::Deref for crate::Org::BouncyCastle::Bcpg::InputStreamPacket {
    type Target = quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::Packet>;
...
impl crate::Org::BouncyCastle::Bcpg::InputStreamPacket {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Bcpg::BcpgInputStream,
        > = __cordl_object.invoke("GetInputStream", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn New(
