...
impl crate::Org::BouncyCastle::Bcpg::BcpgInputStream {
    ...
    pub fn ReadFully_i32_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, off, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadPacket(
...
impl crate::Org::BouncyCastle::Bcpg::BcpgInputStream_PartialInputStream {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bcpgIn, partial, dataLength))?
        };
        Ok(__cordl_ret.into())
    }
}
