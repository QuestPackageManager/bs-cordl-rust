...
for crate::Org::BouncyCastle::Bcpg::ECSecretBcpgKey {
    ...
    const CLASS_NAME: &'static str = "ECSecretBcpgKey";
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+ECSecretBcpgKey")]
impl crate::Org::BouncyCastle::Bcpg::ECSecretBcpgKey {
    pub fn Encode(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::ECSecretBcpgKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::ECSecretBcpgKey as
