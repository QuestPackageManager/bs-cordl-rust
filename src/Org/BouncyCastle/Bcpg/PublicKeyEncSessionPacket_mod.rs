#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+PublicKeyEncSessionPacket")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket {
    ...
    pub fn _ctor_i64_PublicKeyAlgorithmTag_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (keyId, algorithm, data))? };
        Ok(__cordl_ret.into())
    }
