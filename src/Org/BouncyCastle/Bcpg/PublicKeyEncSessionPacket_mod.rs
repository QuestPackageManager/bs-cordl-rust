...
for crate::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket {
    ...
    const CLASS_NAME: &'static str = "PublicKeyEncSessionPacket";
...
impl crate::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket {
    pub fn Encode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket as
                    quest_hook::libil2cpp::Type > ::class(), "GetEncSessionKey", 0usize
                )
            });
    ...
    pub fn _ctor_i64_PublicKeyAlgorithmTag_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (keyId, algorithm, data))?
        };
        Ok(__cordl_ret.into())
    }
