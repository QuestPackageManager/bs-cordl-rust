...
impl crate::Org::BouncyCastle::Bcpg::BcpgOutputStream {
    ...
    pub fn PartialFlush(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isLast))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Wrap(
    ...
    pub fn WriteHeader(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (tag, oldPackets, partial, bodyLen))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteInt(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteNewPacketLength", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bodyLen))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteObject(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bcpgObject))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteObjects(
    ...
    pub fn WritePacket_PacketTag_Il2CppArray__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tag, body, oldFormat))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_PacketTag1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStr, tag))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PacketTag_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStr, tag, buffer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PacketTag_i64_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStr, tag, length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PacketTag_i64__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outStr, tag, length, oldFormat))?
        };
        Ok(__cordl_ret.into())
    }
