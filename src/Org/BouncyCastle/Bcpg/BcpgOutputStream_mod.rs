#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+BcpgOutputStream")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+BcpgOutputStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::BcpgOutputStream {
...
impl crate::Org::BouncyCastle::Bcpg::BcpgOutputStream {
    ...
    pub fn PartialFlush(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (isLast))? };
        Ok(__cordl_ret.into())
    }
    pub fn Wrap(
        outStr: quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Bcpg::BcpgOutputStream,
        > = unsafe { cordl_method_info.invoke_unchecked((), (outStr))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
    ...
    pub fn WriteHeader(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tag, oldPackets, partial, bodyLen))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteInt(
    ...
    pub fn WriteNewPacketLength(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bodyLen))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteObject(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bcpgObject))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteObjects(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Bcpg::BcpgObject>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("WriteObjects")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn WritePacket_PacketTag_Il2CppArray__cordl_bool1(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        bool,
                    ), quest_hook::libil2cpp::Void, 3usize>("WritePacket")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tag, body, oldFormat))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("WritePartial")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_PacketTag1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outStr, tag))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PacketTag_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outStr, tag, buffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PacketTag_i64_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outStr, tag, length))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_PacketTag_i64__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outStr, tag, length, oldFormat))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+BcpgOutputStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::BcpgOutputStream {
