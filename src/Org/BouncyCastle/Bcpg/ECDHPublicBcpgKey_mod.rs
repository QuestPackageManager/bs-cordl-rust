#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ECDHPublicBcpgKey")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ECDHPublicBcpgKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::ECDHPublicBcpgKey {
...
impl crate::Org::BouncyCastle::Bcpg::ECDHPublicBcpgKey {
    ...
    pub fn VerifyHashAlgorithm(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("VerifyHashAlgorithm")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_DerObjectIdentifier_ECPoint_HashAlgorithmTag_SymmetricKeyAlgorithmTag1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (oid, point, hashAlgorithm, symmetricKeyAlgorithm))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_SymmetricKeyAlgorithm", 0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+ECDHPublicBcpgKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::ECDHPublicBcpgKey {
