#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+UserAttributeSubpacketsParser")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Bcpg+UserAttributeSubpacketsParser")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser {
