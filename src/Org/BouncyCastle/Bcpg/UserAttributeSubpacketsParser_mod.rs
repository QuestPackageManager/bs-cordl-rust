...
for crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser {
    ...
    const CLASS_NAME: &'static str = "UserAttributeSubpacketsParser";
...
impl crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Bcpg::UserAttributeSubpacketsParser as
