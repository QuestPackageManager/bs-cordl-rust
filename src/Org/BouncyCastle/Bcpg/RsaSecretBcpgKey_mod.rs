#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+RsaSecretBcpgKey")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+RsaSecretBcpgKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Bcpg::RsaSecretBcpgKey {
...
impl crate::Org::BouncyCastle::Bcpg::RsaSecretBcpgKey {
    ...
    pub fn _ctor_BigInteger_BigInteger_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (d, p, q))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Bcpg+RsaSecretBcpgKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Bcpg::RsaSecretBcpgKey {
