#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+X509CertificateEntry")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+X509CertificateEntry")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkcs::X509CertificateEntry {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Pkcs";
    const CLASS_NAME: &'static str = "X509CertificateEntry";
...
impl crate::Org::BouncyCastle::Pkcs::X509CertificateEntry {
    ...
    pub fn _ctor_Hashtable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cert, attributes))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+X509CertificateEntry")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Pkcs::X509CertificateEntry {
