#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PkcsIOException")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PkcsIOException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkcs::PkcsIOException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Pkcs";
    const CLASS_NAME: &'static str = "PkcsIOException";
...
impl crate::Org::BouncyCastle::Pkcs::PkcsIOException {
    pub fn New_Exception1(
        ...
        underlying: quest_hook::libil2cpp::Gc<crate::System::Exception>,
    ...
    pub fn _ctor_Exception1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, underlying))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PkcsIOException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Pkcs::PkcsIOException {
