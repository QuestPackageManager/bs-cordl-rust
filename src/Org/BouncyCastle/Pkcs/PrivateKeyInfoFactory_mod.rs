#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PrivateKeyInfoFactory")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PrivateKeyInfoFactory")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkcs::PrivateKeyInfoFactory {
...
impl crate::Org::BouncyCastle::Pkcs::PrivateKeyInfoFactory {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreatePrivateKeyInfo", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo,
        > = unsafe { cordl_method_info.invoke_unchecked((), (privateKey, attributes))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (passPhrase, wrongPkcs12Zero, encInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ExtractBytes(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 4usize>("ExtractBytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (encKey, _cordl_size, offSet, bI))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PrivateKeyInfoFactory")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Pkcs::PrivateKeyInfoFactory {
