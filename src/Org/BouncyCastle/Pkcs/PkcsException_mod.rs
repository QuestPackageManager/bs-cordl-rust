...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PkcsException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkcs::PkcsException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Pkcs";
    const CLASS_NAME: &'static str = "PkcsException";
...
#[cfg(feature = "Org+BouncyCastle+Pkcs+PkcsException")]
impl crate::Org::BouncyCastle::Pkcs::PkcsException {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+PkcsException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Pkcs::PkcsException {
