...
impl crate::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry as
    ...
    pub fn _ctor_Hashtable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (key, attributes))?
        };
        Ok(__cordl_ret.into())
    }
