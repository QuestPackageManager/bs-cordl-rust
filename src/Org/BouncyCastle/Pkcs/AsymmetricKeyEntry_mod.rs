...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+AsymmetricKeyEntry")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Pkcs";
    const CLASS_NAME: &'static str = "AsymmetricKeyEntry";
...
#[cfg(feature = "Org+BouncyCastle+Pkcs+AsymmetricKeyEntry")]
impl crate::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry {
    pub fn Equals(
        &mut self,
    ...
    pub fn _ctor_Hashtable1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, attributes))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+AsymmetricKeyEntry")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Pkcs::AsymmetricKeyEntry {
