#[cfg(feature = "cordl_class_Org+BouncyCastle+Pkcs+EncryptedPrivateKeyInfoFactory")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Pkcs+EncryptedPrivateKeyInfoFactory")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Pkcs::EncryptedPrivateKeyInfoFactory {
...
impl crate::Org::BouncyCastle::Pkcs::EncryptedPrivateKeyInfoFactory {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 7usize>("CreateEncryptedPrivateKeyInfo")
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo,
                    >, 5usize>("CreateEncryptedPrivateKeyInfo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (algorithm, passPhrase, salt, iterationCount, keyInfo))?
        };
        Ok(__cordl_ret.into())
    }
