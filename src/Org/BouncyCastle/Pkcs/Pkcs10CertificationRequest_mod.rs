...
impl crate::Org::BouncyCastle::Pkcs::Pkcs10CertificationRequest {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (signatureFactory, subject, publicKey, attributes))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetSignatureParameters(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (signature, asn1Params))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Verify_IVerifierFactory3(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (verifier))? };
        Ok(__cordl_ret.into())
    }
