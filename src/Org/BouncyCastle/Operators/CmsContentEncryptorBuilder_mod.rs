#[cfg(feature = "cordl_class_Org+BouncyCastle+Operators+CmsContentEncryptorBuilder")]
#[repr(C)]
#[derive(Debug)]
pub struct CmsContentEncryptorBuilder {
    ...
    pub keySize: i32,
    pub helper: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Cms::EnvelopedDataHelper>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Operators+CmsContentEncryptorBuilder")]
    ...
    for crate::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder
{
    ...
    const CLASS_NAME: &'static str = "CmsContentEncryptorBuilder";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder {
...
#[cfg(feature = "Org+BouncyCastle+Operators+CmsContentEncryptorBuilder")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder {
...
impl crate::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder {
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encryptionOID, keySize))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Operators+CmsContentEncryptorBuilder")]
