...
impl crate::Org::BouncyCastle::Math::Field::IExtensionField {
    ...
    pub fn get_Degree(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::Field::IExtensionField as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_Degree")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Math::Field::IExtensionField as
