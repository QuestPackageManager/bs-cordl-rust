...
for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement {
    ...
    const CLASS_NAME: &'static str = "SecP192K1FieldElement";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecP192K1FieldElement")]
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement {
    pub fn Add(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement as
