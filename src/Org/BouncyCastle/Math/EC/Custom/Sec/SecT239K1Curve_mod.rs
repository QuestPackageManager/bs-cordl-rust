#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve")]
#[repr(C)]
#[derive(Debug)]
pub struct SecT239K1Curve {
    __cordl_parent: crate::Org::BouncyCastle::Math::EC::AbstractF2mCurve,
    pub m_infinity: quest_hook::libil2cpp::Gc<
        crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Point,
    >,
}
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve")]
unsafe impl quest_hook::libil2cpp::Type
for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Math.EC.Custom.Sec";
    const CLASS_NAME: &'static str = "SecT239K1Curve";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve")]
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve {
    pub const SECT239K1_DEFAULT_COORDS: i32 = 6i32;
    pub const SECT239K1_FE_LONGS: i32 = 4i32;
    #[cfg(
        feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve+SecT239K1LookupTable"
    )]
    pub type SecT239K1LookupTable = crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable;
    pub fn CloneCurve(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECCurve>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECCurve>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve as
...
#[repr(C)]
#[derive(Debug)]
pub struct SecT239K1Curve_SecT239K1LookupTable {
    __cordl_parent: crate::Org::BouncyCastle::Math::EC::AbstractECLookupTable,
    pub m_outer: quest_hook::libil2cpp::Gc<
        crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve,
    >,
...
unsafe impl quest_hook::libil2cpp::Type
for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Math.EC.Custom.Sec";
    const CLASS_NAME: &'static str = "SecT239K1Curve/SecT239K1LookupTable";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable {
    pub fn CreatePoint(
        &mut self,
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable
