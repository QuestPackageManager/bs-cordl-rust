#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve")]
#[repr(C)]
#[derive(Debug)]
pub struct SecT239K1Curve {
    __cordl_parent: crate::Org::BouncyCastle::Math::EC::AbstractF2mCurve,
    pub m_infinity:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Point>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve")]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve {
...
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve {
    ...
    #[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve+SecT239K1LookupTable")]
    pub type SecT239K1LookupTable =
        crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable;
    pub fn CloneCurve(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("CreateDefaultMultiplier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint> =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, y, zs, withCompression))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint> =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, y, withCompression))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SupportsCoordinateSystem(&mut self, coord: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (coord))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Math+EC+Custom+Sec+SecT239K1Curve+SecT239K1LookupTable"
)]
#[repr(C)]
#[derive(Debug)]
pub struct SecT239K1Curve_SecT239K1LookupTable {
    ...
    pub m_outer:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve>,
...
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve_SecT239K1LookupTable {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outer, table, _cordl_size))? };
        Ok(__cordl_ret.into())
    }
