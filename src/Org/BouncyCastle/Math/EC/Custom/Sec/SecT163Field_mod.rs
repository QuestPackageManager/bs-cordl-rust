...
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163Field {
    ...
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163Field as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163Field as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163Field as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163Field as
                    quest_hook::libil2cpp::Type > ::class(), "Reduce29", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
