...
pub struct SecP224K1Curve {
    ...
    pub m_infinity:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Point>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Custom+Sec+SecP224K1Curve")]
    ...
    for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve
{
    ...
    const CLASS_NAME: &'static str = "SecP224K1Curve";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecP224K1Curve")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve {
...
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve {
    ...
    #[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecP224K1Curve+SecP224K1LookupTable")]
    pub type SecP224K1LookupTable =
        crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve_SecP224K1LookupTable;
    pub fn CloneCurve(
        &mut self,
...
pub struct SecP224K1Curve_SecP224K1LookupTable {
    ...
    pub m_outer:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve>,
    ...
    for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve_SecP224K1LookupTable
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Math.EC.Custom.Sec";
    const CLASS_NAME: &'static str = "SecP224K1Curve/SecP224K1LookupTable";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve_SecP224K1LookupTable {
    ...
    pub fn New(
        outer: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve,
        >,
