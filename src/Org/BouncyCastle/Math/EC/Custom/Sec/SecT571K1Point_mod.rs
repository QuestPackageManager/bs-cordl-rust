...
for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571K1Point {
    ...
    const CLASS_NAME: &'static str = "SecT571K1Point";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT571K1Point")]
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571K1Point {
    pub fn Add(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571K1Point as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571K1Point as
