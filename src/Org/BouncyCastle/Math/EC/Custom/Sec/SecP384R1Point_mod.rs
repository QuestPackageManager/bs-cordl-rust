#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Custom+Sec+SecP384R1Point")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP384R1Point
{
    ...
    const CLASS_NAME: &'static str = "SecP384R1Point";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP384R1Point {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecP384R1Point")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP384R1Point {
