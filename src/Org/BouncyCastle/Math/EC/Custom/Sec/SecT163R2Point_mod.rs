...
for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point {
    ...
    const CLASS_NAME: &'static str = "SecT163R2Point";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecT163R2Point")]
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point {
    pub fn Add(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point as
