...
#[repr(C)]
#[derive(Debug)]
pub struct SecP224K1FieldElement {
...
for crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1FieldElement {
    ...
    const CLASS_NAME: &'static str = "SecP224K1FieldElement";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Sec+SecP224K1FieldElement")]
impl crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1FieldElement {
    pub fn Add(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1FieldElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1FieldElement as
    ...
    pub fn Equals_SecP224K1FieldElement2(
        &mut self,
        other: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1FieldElement,
        >,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1FieldElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
