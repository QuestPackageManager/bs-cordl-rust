...
for crate::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement {
    ...
    const CLASS_NAME: &'static str = "Curve25519FieldElement";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+Djb+Curve25519FieldElement")]
impl crate::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement {
    pub fn Add(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement as
    ...
    pub fn Equals_Curve25519FieldElement2(
        &mut self,
