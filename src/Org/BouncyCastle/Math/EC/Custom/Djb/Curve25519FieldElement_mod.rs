#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Custom+Djb+Curve25519FieldElement")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement {
