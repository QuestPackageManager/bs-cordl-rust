...
pub struct SM2P256V1Curve {
    ...
    pub m_infinity: *mut crate::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Point,
}
#[cfg(feature = "Org+BouncyCastle+Math+EC+Custom+GM+SM2P256V1Curve")]
...
pub struct SM2P256V1Curve_SM2P256V1LookupTable {
    ...
    pub m_outer: *mut crate::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve,
...
impl crate::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve_SM2P256V1LookupTable {
    ...
    pub fn New(
        outer: *mut crate::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve,
