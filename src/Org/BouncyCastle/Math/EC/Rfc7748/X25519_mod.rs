#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Rfc7748+X25519")]
#[repr(C)]
#[derive(Debug)]
pub struct X25519 {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Rfc7748+X25519")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Math::EC::Rfc7748::X25519 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Math.EC.Rfc7748";
    const CLASS_NAME: &'static str = "X25519";
...
impl crate::Org::BouncyCastle::Math::EC::Rfc7748::X25519 {
    ...
    pub fn CalculateAgreement(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), bool, 6usize>("CalculateAgreement")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (k, kOff, u, uOff, r, rOff))? };
        Ok(__cordl_ret.into())
    }
    pub fn Decode32(
    ...
    pub fn GeneratePublicKey(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (k, kOff, r, rOff))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>>,
                    ), quest_hook::libil2cpp::Void, 2usize>("PointDouble")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 6usize>("ScalarMult")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 4usize>("ScalarMultBase")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Rfc7748+X25519")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Math::EC::Rfc7748::X25519 {
