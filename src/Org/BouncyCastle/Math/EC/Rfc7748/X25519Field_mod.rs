...
impl crate::Org::BouncyCastle::Math::EC::Rfc7748::X25519Field {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Apm",
                            4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (x, y, zp, zm))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CMov(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cond, x, xOff, z, zOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CNegate(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "CNegate",
                            2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (negate, z))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CSwap(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "CSwap",
                            3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (swap, a, b))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Carry(
    ...
    pub fn Decode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (x, xOff, z))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Decode128(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (bs, off, z, zOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Decode32(
    ...
    pub fn Encode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (x, z, zOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Encode128(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (x, xOff, bs, off))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Encode32(
    ...
    pub fn PowPm5d8(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (x, rx2, rz))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Reduce(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (z, x))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Sqr",
                            2usize
                        )
                    })
            });
    ...
    pub fn SqrtRatioVar(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (u, v, z))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Sub(
