#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Endo+EndoPreCompInfo")]
#[repr(C)]
...
pub struct EndoPreCompInfo {
    ...
    pub m_mappedPoint: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Endo+EndoPreCompInfo")]
...
impl crate::Org::BouncyCastle::Math::EC::Endo::EndoPreCompInfo {
    ...
    pub fn set_Endomorphism(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_Endomorphism")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
