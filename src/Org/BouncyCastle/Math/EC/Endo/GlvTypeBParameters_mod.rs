#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Endo+GlvTypeBParameters")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Endo+GlvTypeBParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters {
...
impl crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters {
    ...
    pub fn _ctor_Il2CppArray_Il2CppArray_BigInteger_BigInteger_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (beta, lambda, v1, v2, g1, g2, bits))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ScalarSplitParameters1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (beta, lambda, splitParams))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Beta(
        &mut self,
