...
impl crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters {
    ...
    pub fn _ctor_Il2CppArray_Il2CppArray_BigInteger_BigInteger_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (beta, lambda, v1, v2, g1, g2, bits))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ScalarSplitParameters1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (beta, lambda, splitParams))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Beta(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "get_V1",
                            0usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "get_V2",
                            0usize
                        )
                    })
            });
