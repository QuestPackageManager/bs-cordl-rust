...
pub struct GlvTypeAEndomorphism {
    ...
    pub m_parameters:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters>,
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Endo+GlvTypeAEndomorphism")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeAEndomorphism {
