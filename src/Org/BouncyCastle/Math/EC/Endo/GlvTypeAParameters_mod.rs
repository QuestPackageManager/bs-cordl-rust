...
pub struct GlvTypeAParameters {
    ...
    pub m_splitParams:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::Endo::ScalarSplitParameters>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Endo+GlvTypeAParameters")]
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Endo+GlvTypeAParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters {
...
impl crate::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (i, lambda, splitParams))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_I(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "get_I",
                            0usize
                        )
                    })
            });
