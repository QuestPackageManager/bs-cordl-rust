...
for crate::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap {
    ...
    const CLASS_NAME: &'static str = "ScaleXNegateYPointMap";
...
impl crate::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap as
                    quest_hook::libil2cpp::Type > ::class(), "Map", 1usize
                )
            });
