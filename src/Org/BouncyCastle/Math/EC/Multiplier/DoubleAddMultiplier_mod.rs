...
for crate::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier {
    ...
    const CLASS_NAME: &'static str = "DoubleAddMultiplier";
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+DoubleAddMultiplier")]
impl crate::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Multiplier::DoubleAddMultiplier
