#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+ECMultiplier")]
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+ECMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier {
