...
for crate::Org::BouncyCastle::Math::EC::Multiplier::MontgomeryLadderMultiplier {
    ...
    const CLASS_NAME: &'static str = "MontgomeryLadderMultiplier";
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::MontgomeryLadderMultiplier {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Multiplier::MontgomeryLadderMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
