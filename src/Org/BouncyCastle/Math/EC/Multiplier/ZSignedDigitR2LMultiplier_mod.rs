#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+ZSignedDigitR2LMultiplier")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitR2LMultiplier {
