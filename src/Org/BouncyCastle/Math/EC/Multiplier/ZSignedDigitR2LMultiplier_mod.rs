...
for crate::Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitR2LMultiplier {
    ...
    const CLASS_NAME: &'static str = "ZSignedDigitR2LMultiplier";
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitR2LMultiplier {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitR2LMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
