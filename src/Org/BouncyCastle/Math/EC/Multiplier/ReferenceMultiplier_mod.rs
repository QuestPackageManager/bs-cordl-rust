...
for crate::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier {
    ...
    const CLASS_NAME: &'static str = "ReferenceMultiplier";
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier
                    as quest_hook::libil2cpp::Type > ::class(), "MultiplyPositive",
                    2usize
                )
            });
