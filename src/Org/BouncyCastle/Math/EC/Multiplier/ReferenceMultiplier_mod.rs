#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+ReferenceMultiplier")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+ReferenceMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier {
