#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+IPreCompCallback")]
#[derive(Debug)]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::IPreCompCallback {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+IPreCompCallback")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::IPreCompCallback {
