...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities {
    ...
    pub fn GetWindowSize_Il2CppArray2(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (bits, windowSizeCutoffs))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetWindowSize_Il2CppArray_i32_3(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (bits, windowSizeCutoffs, maxWidth))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetWindowSize_i32_1(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (bits, maxWidth))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (p, minWidth, includeNegated, pointMap))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (p, minWidth, includeNegated))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (p, pointMap, fromWNaf, includeNegated))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ResizeTable(
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_ConfigureBasepointCallback {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (curve, confWidth))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_MapPointCallback {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (infoP, includeNegated, pointMap))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeCallback {
    ...
    pub fn CheckTable(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (table, reqLen))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (p, minWidth, includeNegated))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities_PrecomputeWithPointMapCallback {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (point, pointMap, fromWNaf, includeNegated))?
        };
        Ok(__cordl_ret.into())
    }
}
