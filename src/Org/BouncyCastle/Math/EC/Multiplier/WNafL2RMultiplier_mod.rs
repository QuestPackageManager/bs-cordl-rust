...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier as
