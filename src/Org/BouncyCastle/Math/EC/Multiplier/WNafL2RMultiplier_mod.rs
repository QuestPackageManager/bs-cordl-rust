#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+WNafL2RMultiplier")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier
{
    ...
    const CLASS_NAME: &'static str = "WNafL2RMultiplier";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+WNafL2RMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier {
