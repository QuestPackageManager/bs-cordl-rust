...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafPreCompInfo {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+WTauNafPreCompInfo")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafPreCompInfo {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_PreComp")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
