#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+AbstractECMultiplier")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+AbstractECMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier {
...
impl AsMut<crate::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier>
    for crate::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier {
        unsafe { std::mem::transmute(self) }
    }
}
