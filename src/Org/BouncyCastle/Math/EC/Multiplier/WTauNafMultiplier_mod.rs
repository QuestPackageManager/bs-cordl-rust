#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+WTauNafMultiplier")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+WTauNafMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier {
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier {
    ...
    pub type WTauNafCallback =
        crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier_WTauNafCallback;
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint> =
            unsafe { cordl_method_info.invoke_unchecked(self, (point, k))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "MultiplyWTnaf", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::EC::AbstractF2mPoint,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (p, lambda, a, mu))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+WTauNafMultiplier+WTauNafCallback"
)]
#[repr(C)]
#[derive(Debug)]
pub struct WTauNafMultiplier_WTauNafCallback {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub m_p: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::AbstractF2mPoint>,
    pub m_a: i8,
}
#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+WTauNafMultiplier+WTauNafCallback"
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier_WTauNafCallback {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p, a))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(
