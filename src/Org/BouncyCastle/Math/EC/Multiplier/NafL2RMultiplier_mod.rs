#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+NafL2RMultiplier")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::NafL2RMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+NafL2RMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::NafL2RMultiplier {
