#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+GlvMultiplier")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+GlvMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier {
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (curve, glvEndomorphism))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+GlvMultiplier")]
