#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+MixedNafR2LMultiplier")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Math::EC::Multiplier::MixedNafR2LMultiplier
{
    ...
    const CLASS_NAME: &'static str = "MixedNafR2LMultiplier";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Math::EC::Multiplier::MixedNafR2LMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Math+EC+Multiplier+MixedNafR2LMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Math::EC::Multiplier::MixedNafR2LMultiplier {
...
impl crate::Org::BouncyCastle::Math::EC::Multiplier::MixedNafR2LMultiplier {
    ...
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (additionCoord, doublingCoord))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+Multiplier+MixedNafR2LMultiplier")]
