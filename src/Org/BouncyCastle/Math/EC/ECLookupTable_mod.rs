#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+ECLookupTable")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+ECLookupTable")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Math::EC::ECLookupTable {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+ECLookupTable")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Math::EC::ECLookupTable {
