#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+AbstractF2mPoint")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+AbstractF2mPoint")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Math::EC::AbstractF2mPoint {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "TauPow",
                            1usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+AbstractF2mPoint")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Math::EC::AbstractF2mPoint {
