...
for crate::Org::BouncyCastle::Math::EC::Abc::ZTauElement {
    ...
    const CLASS_NAME: &'static str = "ZTauElement";
...
impl crate::Org::BouncyCastle::Math::EC::Abc::ZTauElement {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Math::EC::Abc::ZTauElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Math::EC::Abc::ZTauElement as
