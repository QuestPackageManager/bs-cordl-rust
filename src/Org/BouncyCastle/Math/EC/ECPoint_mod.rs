...
impl crate::Org::BouncyCastle::Math::EC::ECPoint {
    ...
    pub fn ImplIsValid(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (decompressed, checkOrder))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_CurveCoordinateSystem", 0usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
...
impl crate::Org::BouncyCastle::Math::EC::ECPoint_ValidityCallback {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outer, decompressed, checkOrder))?
        };
        Ok(__cordl_ret.into())
    }
}
