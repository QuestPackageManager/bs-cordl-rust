#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+AbstractFpPoint")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+AbstractFpPoint")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Math::EC::AbstractFpPoint {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Math.EC";
    const CLASS_NAME: &'static str = "AbstractFpPoint";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Math+EC+AbstractFpPoint")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Math::EC::AbstractFpPoint {
