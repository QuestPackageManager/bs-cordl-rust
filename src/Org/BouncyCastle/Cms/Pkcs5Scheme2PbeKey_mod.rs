#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+Pkcs5Scheme2PbeKey")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+Pkcs5Scheme2PbeKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::Pkcs5Scheme2PbeKey {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "Pkcs5Scheme2PbeKey";
...
impl crate::Org::BouncyCastle::Cms::Pkcs5Scheme2PbeKey {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KeyParameter,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (algorithmOid))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppArray_AlgorithmIdentifier3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (password, keyDerivationAlgorithm))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_Il2CppArray_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (password, salt, iterationCount))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+Pkcs5Scheme2PbeKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::Pkcs5Scheme2PbeKey {
