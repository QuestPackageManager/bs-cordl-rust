...
impl crate::Org::BouncyCastle::Cms::CmsEnvelopedHelper {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Cms::RecipientInformationStore,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (recipientInfos, secureReadable))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetKeySize(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (oid))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::Org::BouncyCastle::Cms::CmsEnvelopedHelper_CmsAuthenticatedSecureReadable {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, readable))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedHelper+CmsEnvelopedSecureReadable"
)]
#[repr(C)]
#[derive(Debug)]
