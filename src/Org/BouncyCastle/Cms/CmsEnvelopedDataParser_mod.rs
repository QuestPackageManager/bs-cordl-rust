#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedDataParser")]
#[repr(C)]
#[derive(Debug)]
pub struct CmsEnvelopedDataParser {
    ...
    pub envelopedData:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser>,
    pub _encAlg:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier>,
    pub _unprotectedAttributes:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::AttributeTable>,
    pub _attrNotRead: bool,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedDataParser")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::CmsEnvelopedDataParser {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "CmsEnvelopedDataParser";
...
impl crate::Org::BouncyCastle::Cms::CmsEnvelopedDataParser {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetUnprotectedAttributes", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
    ...
    pub fn _ctor_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (envelopedData))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_EncryptionAlgParams", 0usize
                        )
                    })
            });
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_EncryptionAlgorithmID")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedDataParser")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::CmsEnvelopedDataParser {
