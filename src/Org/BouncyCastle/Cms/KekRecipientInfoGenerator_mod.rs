#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+KekRecipientInfoGenerator")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct KekRecipientInfoGenerator {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub keyEncryptionKey:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::KeyParameter>,
    pub keyEncryptionKeyOID: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub kekIdentifier:
...
impl crate::Org::BouncyCastle::Cms::KekRecipientInfoGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe { cordl_method_info.invoke_unchecked((), (algorithm, key))? };
        Ok(__cordl_ret.into())
    }
    pub fn Generate(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::RecipientInfo,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (contentEncryptionKey, random))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_KekIdentifier(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::KekIdentifier>,
