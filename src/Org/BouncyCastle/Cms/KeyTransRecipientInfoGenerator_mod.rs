...
pub struct KeyTransRecipientInfoGenerator {
    ...
    pub info: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo>,
    pub issuerAndSerialNumber:
...
#[cfg(feature = "Org+BouncyCastle+Cms+KeyTransRecipientInfoGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Cms::KeyTransRecipientInfoGenerator {
...
impl crate::Org::BouncyCastle::Cms::KeyTransRecipientInfoGenerator {
    ...
    pub fn _ctor_IssuerAndSerialNumber1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (issuerAndSerialNumber))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_RecipientPublicKey(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
