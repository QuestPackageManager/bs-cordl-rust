#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsAuthenticatedDataGenerator")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Cms+CmsAuthenticatedDataGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Cms::CmsAuthenticatedDataGenerator {
...
impl crate::Org::BouncyCastle::Cms::CmsAuthenticatedDataGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Cms::CmsAuthenticatedData,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (content, macOid, keyGen))? };
        Ok(__cordl_ret.into())
    }
