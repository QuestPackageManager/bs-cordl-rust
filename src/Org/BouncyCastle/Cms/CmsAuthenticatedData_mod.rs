...
for crate::Org::BouncyCastle::Cms::CmsAuthenticatedData {
    ...
    const CLASS_NAME: &'static str = "CmsAuthenticatedData";
...
impl crate::Org::BouncyCastle::Cms::CmsAuthenticatedData {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Cms::CmsAuthenticatedData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Cms::CmsAuthenticatedData as
    ...
    pub fn _ctor_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (authData))?
        };
        Ok(__cordl_ret.into())
    }
