#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedData")]
#[repr(C)]
...
pub struct CmsEnvelopedData {
    ...
    pub unprotectedAttributes: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Set>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedData")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::CmsEnvelopedData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "CmsEnvelopedData";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedData")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::CmsEnvelopedData {
