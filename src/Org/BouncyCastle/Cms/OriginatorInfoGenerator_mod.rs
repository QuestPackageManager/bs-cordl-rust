...
impl crate::Org::BouncyCastle::Cms::OriginatorInfoGenerator {
    ...
    pub fn _ctor_IX509Store1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (origCerts))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IX509Store_IX509Store2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (origCerts, origCrls))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X509Certificate0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (origCert))?
        };
        Ok(__cordl_ret.into())
    }
}
