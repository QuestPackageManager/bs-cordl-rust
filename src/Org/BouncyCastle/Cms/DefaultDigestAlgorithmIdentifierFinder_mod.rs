#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+DefaultDigestAlgorithmIdentifierFinder")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder
{
    ...
    const CLASS_NAME: &'static str = "DefaultDigestAlgorithmIdentifierFinder";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder {
...
#[cfg(feature = "Org+BouncyCastle+Cms+DefaultDigestAlgorithmIdentifierFinder")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Cms+DefaultDigestAlgorithmIdentifierFinder")]
impl crate::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (sigAlgId))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (digAlgName))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+DefaultDigestAlgorithmIdentifierFinder")]
