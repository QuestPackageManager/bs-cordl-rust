...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    ...
    ::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder =>
    "Org.BouncyCastle.Cms"."DefaultDigestAlgorithmIdentifierFinder"
);
#[cfg(feature = "Org+BouncyCastle+Cms+DefaultDigestAlgorithmIdentifierFinder")]
impl std::ops::Deref
...
impl crate::Org::BouncyCastle::Cms::DefaultDigestAlgorithmIdentifierFinder {
    ...
    pub fn find_AlgorithmIdentifier0(
        &mut self,
        sigAlgId: *mut crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
    ...
    > {
        ...
        let __cordl_ret: *mut crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier = __cordl_object
            .invoke("find", (sigAlgId))?;
        Ok(__cordl_ret)
    }
    pub fn find_Il2CppString1(
        &mut self,
        digAlgName: *mut quest_hook::libil2cpp::Il2CppString,
    ) -> quest_hook::libil2cpp::Result<
        *mut crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
