...
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::OriginatorID {
    ...
    const CLASS_NAME: &'static str = "OriginatorID";
...
impl crate::Org::BouncyCastle::Cms::OriginatorID {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Cms::OriginatorID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Cms::OriginatorID as
