...
impl crate::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey {
    pub fn GetEncoded(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey as
