...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+Pkcs5Scheme2Utf8PbeKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "Pkcs5Scheme2Utf8PbeKey";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+Pkcs5Scheme2Utf8PbeKey")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::Pkcs5Scheme2Utf8PbeKey {
