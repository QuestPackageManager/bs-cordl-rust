...
impl std::ops::Deref for crate::Org::BouncyCastle::Cms::DefaultSignedAttributeTableGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Cms+DefaultSignedAttributeTableGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Cms::DefaultSignedAttributeTableGenerator {
...
impl crate::Org::BouncyCastle::Cms::DefaultSignedAttributeTableGenerator {
    pub fn DoCreateStandardAttributeTable(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, std))? };
        Ok(__cordl_ret.into())
    }
