#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+RecipientInfoGenerator")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+RecipientInfoGenerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::RecipientInfoGenerator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "RecipientInfoGenerator";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+RecipientInfoGenerator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::RecipientInfoGenerator {
