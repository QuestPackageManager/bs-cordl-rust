...
pub struct PasswordRecipientInformation {
    ...
    pub info: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+PasswordRecipientInformation")]
    ...
    for crate::Org::BouncyCastle::Cms::PasswordRecipientInformation
{
    ...
    const CLASS_NAME: &'static str = "PasswordRecipientInformation";
...
impl crate::Org::BouncyCastle::Cms::PasswordRecipientInformation {
    ...
    pub fn New(
        info: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_KeyDerivationAlgorithm")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
