...
impl crate::Org::BouncyCastle::Cms::CmsSignedDataGenerator {
    ...
    pub fn AddSignerInfoGenerator(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (signerInfoGenerator))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddSigner_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (privateKey, subjectKeyID, digestOID))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AddSigner_X509Certificate0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (privateKey, cert, digestOID))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (signedContentType, content, encapsulate))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::Org::BouncyCastle::Cms::CmsSignedDataGenerator_SignerInf {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::SignerInfo,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (contentType, content, random))?
        };
        Ok(__cordl_ret.into())
    }
