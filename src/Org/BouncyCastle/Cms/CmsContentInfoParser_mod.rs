#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsContentInfoParser")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsContentInfoParser")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::CmsContentInfoParser {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "CmsContentInfoParser";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsContentInfoParser")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::CmsContentInfoParser {
