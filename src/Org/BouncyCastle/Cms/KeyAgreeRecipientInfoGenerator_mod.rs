...
#[cfg(feature = "Org+BouncyCastle+Cms+KeyAgreeRecipientInfoGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Cms::KeyAgreeRecipientInfoGenerator {
...
impl crate::Org::BouncyCastle::Cms::KeyAgreeRecipientInfoGenerator {
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 1usize>("CreateOriginatorPublicKey")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey,
        > = unsafe { cordl_method_info.invoke_unchecked((), (publicKey))? };
        Ok(__cordl_ret.into())
    }
    pub fn Generate(
        &mut self,
    ...
    pub fn set_SenderKeyPair(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("set_SenderKeyPair")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
