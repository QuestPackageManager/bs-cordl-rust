#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+CmsEnvelopedDataGenerator")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator
{
    ...
    const CLASS_NAME: &'static str = "CmsEnvelopedDataGenerator";
...
impl crate::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Cms::CmsEnvelopedData,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (content, cipherBuilder))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Cms::CmsEnvelopedData,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (content, encryptionOid))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Cms::CmsEnvelopedData,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (content, encryptionOid, keyGen))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Cms::CmsEnvelopedData,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (content, encryptionOid, keySize))? };
        Ok(__cordl_ret.into())
    }
