#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+IDigestCalculator")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+IDigestCalculator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Cms::IDigestCalculator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Cms";
    const CLASS_NAME: &'static str = "IDigestCalculator";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Cms+IDigestCalculator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Cms::IDigestCalculator {
