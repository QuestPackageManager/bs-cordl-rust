#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Enums")]
#[repr(C)]
#[derive(Debug)]
pub struct Enums {
...
impl crate::Org::BouncyCastle::Utilities::Enums {
    ...
    pub fn GetEnumValue(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Gc<crate::System::Enum>, 2usize>(
                        "GetEnumValue"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Enum> =
            unsafe { cordl_method_info.invoke_unchecked((), (enumType, s))? };
        Ok(__cordl_ret.into())
    }
