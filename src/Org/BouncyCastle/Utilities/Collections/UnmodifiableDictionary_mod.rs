...
impl crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
