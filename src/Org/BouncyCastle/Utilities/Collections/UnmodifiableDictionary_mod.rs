#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Collections+UnmodifiableDictionary")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary
{
    ...
    const CLASS_NAME: &'static str = "UnmodifiableDictionary";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary {
...
impl crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionary {
    ...
    pub fn Contains(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (k))? };
        Ok(__cordl_ret.into())
    }
    pub fn CopyTo(
        &mut self,
    ...
    pub fn set_Item(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (k, value))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Collections+UnmodifiableDictionary")]
