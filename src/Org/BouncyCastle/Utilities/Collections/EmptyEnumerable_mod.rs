#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Collections+EmptyEnumerable")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable
{
    ...
    const CLASS_NAME: &'static str = "EmptyEnumerable";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable {
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Collections+EmptyEnumerable")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable {
