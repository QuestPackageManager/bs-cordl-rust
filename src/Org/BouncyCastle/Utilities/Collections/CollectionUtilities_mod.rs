#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Collections+CollectionUtilities")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::Collections::CollectionUtilities {
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Collections+CollectionUtilities")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Collections::CollectionUtilities {
...
impl crate::Org::BouncyCastle::Utilities::Collections::CollectionUtilities {
    pub fn AddRange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (to, range))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 2usize>("CheckElementsAreOfType")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "CheckElementsAreOfType",
                            2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (e, t))? };
        Ok(__cordl_ret.into())
    }
