...
for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy {
    ...
    const CLASS_NAME: &'static str = "UnmodifiableDictionaryProxy";
...
impl crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy {
    pub fn Contains(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
        ...
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, (k))? };
        Ok(__cordl_ret.into())
    }
    pub fn CopyTo(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Utilities::Collections::UnmodifiableDictionaryProxy
                    as quest_hook::libil2cpp::Type > ::class(), "get_Values", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::ICollection,
