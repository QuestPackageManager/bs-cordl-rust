...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableList {
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Collections+UnmodifiableList")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableList {
...
impl crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableList {
    ...
    pub fn Insert(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (i, o))? };
        Ok(__cordl_ret.into())
    }
