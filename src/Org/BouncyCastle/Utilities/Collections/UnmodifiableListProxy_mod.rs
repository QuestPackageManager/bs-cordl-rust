...
for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableListProxy {
    ...
    const CLASS_NAME: &'static str = "UnmodifiableListProxy";
...
impl crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableListProxy {
    pub fn Contains(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableListProxy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Utilities::Collections::UnmodifiableListProxy as
