#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Collections+UnmodifiableListProxy")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::Collections::UnmodifiableListProxy {
