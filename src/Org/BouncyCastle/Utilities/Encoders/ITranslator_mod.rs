...
for crate::Org::BouncyCastle::Utilities::Encoders::ITranslator {
    ...
    const CLASS_NAME: &'static str = "ITranslator";
...
impl crate::Org::BouncyCastle::Utilities::Encoders::ITranslator {
    pub fn Decode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Encoders::ITranslator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Utilities::Encoders::ITranslator as
