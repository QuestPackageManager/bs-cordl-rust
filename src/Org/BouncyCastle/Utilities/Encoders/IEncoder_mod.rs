#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Encoders+IEncoder")]
#[derive(Debug)]
#[repr(C)]
pub struct IEncoder {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Encoders+IEncoder")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Encoders::IEncoder {
