#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Encoders+BufferedDecoder")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Encoders+BufferedDecoder")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Encoders::BufferedDecoder {
