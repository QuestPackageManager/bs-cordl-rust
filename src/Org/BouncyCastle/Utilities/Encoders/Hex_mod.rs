...
for crate::Org::BouncyCastle::Utilities::Encoders::Hex {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Utilities.Encoders";
    const CLASS_NAME: &'static str = "Hex";
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Encoders+Hex")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Encoders::Hex {
...
impl crate::Org::BouncyCastle::Utilities::Encoders::Hex {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Encoders::Hex as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Utilities::Encoders::Hex as
                    quest_hook::libil2cpp::Type > ::class(), "DecodeStrict", 1usize
                )
            });
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe { method.invoke_unchecked((), (str, off, len))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Decode_Il2CppString_Stream2(
        ...
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked((), (data, outStream))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe { method.invoke_unchecked((), (data, off, length))? };
        Ok(__cordl_ret.into())
    }
    pub fn Encode_i32_i32_Stream3(
        ...
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked((), (data, off, length, outStream))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Encoders::Hex as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Utilities::Encoders::Hex as
                    quest_hook::libil2cpp::Type > ::class(), "ToHexString", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
