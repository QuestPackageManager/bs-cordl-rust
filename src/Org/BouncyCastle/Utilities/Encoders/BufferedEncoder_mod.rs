#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Encoders+BufferedEncoder")]
#[repr(C)]
...
pub struct BufferedEncoder {
    ...
    pub bufOff: i32,
    pub translator:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::Encoders::ITranslator>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Encoders+BufferedEncoder")]
    ...
    for crate::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder
{
    ...
    const CLASS_NAME: &'static str = "BufferedEncoder";
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Encoders+BufferedEncoder")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder {
...
impl crate::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder {
    ...
    pub fn ProcessBytes(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (input, inOff, len, outBytes, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (translator, bufferSize))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Encoders+BufferedEncoder")]
