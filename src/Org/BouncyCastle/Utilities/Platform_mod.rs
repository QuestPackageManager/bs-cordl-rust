#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Platform")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Platform")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Platform {
...
impl crate::Org::BouncyCastle::Utilities::Platform {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateHashtable", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IDictionary> =
            unsafe { cordl_method_info.invoke_unchecked((), (dictionary))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn EndsWith(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (source, suffix))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn StartsWith(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (source, prefix))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Platform")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Platform {
