#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+TeeInputStream")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Utilities::IO::TeeInputStream
{
    ...
    const CLASS_NAME: &'static str = "TeeInputStream";
...
impl crate::Org::BouncyCastle::Utilities::IO::TeeInputStream {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (input, tee))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+TeeInputStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::IO::TeeInputStream {
