...
for crate::Org::BouncyCastle::Utilities::IO::BaseInputStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Utilities.IO";
    const CLASS_NAME: &'static str = "BaseInputStream";
...
#[cfg(feature = "Org+BouncyCastle+Utilities+IO+BaseInputStream")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::IO::BaseInputStream {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Utilities+IO+BaseInputStream")]
impl crate::Org::BouncyCastle::Utilities::IO::BaseInputStream {
    pub fn Close(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::IO::BaseInputStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Close")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Utilities::IO::BaseInputStream as
