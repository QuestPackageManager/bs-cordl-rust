#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+Pem+PemHeader")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+Pem+PemHeader")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::IO::Pem::PemHeader {
