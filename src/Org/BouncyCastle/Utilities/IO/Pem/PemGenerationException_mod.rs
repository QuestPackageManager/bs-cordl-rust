    ...
    for crate::Org::BouncyCastle::Utilities::IO::Pem::PemGenerationException
{
    ...
    const CLASS_NAME: &'static str = "PemGenerationException";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::IO::Pem::PemGenerationException {
...
#[cfg(feature = "Org+BouncyCastle+Utilities+IO+Pem+PemGenerationException")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::IO::Pem::PemGenerationException {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Utilities+IO+Pem+PemGenerationException")]
impl crate::Org::BouncyCastle::Utilities::IO::Pem::PemGenerationException {
