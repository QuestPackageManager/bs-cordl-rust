#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+PushbackStream")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Utilities::IO::PushbackStream
{
    ...
    const CLASS_NAME: &'static str = "PushbackStream";
...
impl crate::Org::BouncyCastle::Utilities::IO::PushbackStream {
    ...
    pub fn Unread(&mut self, b: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("Unread")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+PushbackStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::IO::PushbackStream {
