#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+Streams")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+Streams")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::IO::Streams {
...
impl crate::Org::BouncyCastle::Utilities::IO::Streams {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Drain",
                            1usize
                        )
                    })
            });
    ...
    pub fn PipeAll(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                        quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                    ), quest_hook::libil2cpp::Void, 2usize>("PipeAll")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (inStr, outStr))? };
        Ok(__cordl_ret.into())
    }
    pub fn PipeAllLimited(
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked((), (inStr, limit, outStr))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadAll(
        inStr: quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadAllLimited", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (inStr, limit))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadFully_Stream_Il2CppArray0(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (inStr, buf))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadFully_i32_i32_1(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (inStr, buf, off, len))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteBufTo_Il2CppArray_i32_1(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (buf, output, offset))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::System::IO::MemoryStream>,
                        quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                    ), quest_hook::libil2cpp::Void, 2usize>("WriteBufTo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn WriteZeroes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (outStr, count))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+IO+Streams")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::IO::Streams {
