...
impl crate::Org::BouncyCastle::Utilities::IO::Streams {
    ...
    pub fn Drain(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (inStr))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "PipeAll",
                            2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (inStr, outStr))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "PipeAllLimited", 3usize
                        )
                    })
            });
        let __cordl_ret: i64 = unsafe {
            cordl_method_info.invoke_unchecked((), (inStr, limit, outStr))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadAll(
    ...
    pub fn ReadFully_Stream_Il2CppArray0(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (inStr, buf))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadFully_i32_i32_1(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (inStr, buf, off, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteBufTo_Il2CppArray_i32_1(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (buf, output, offset))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteZeroes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (outStr, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
