...
for crate::Org::BouncyCastle::Utilities::IO::MemoryInputStream {
    ...
    const CLASS_NAME: &'static str = "MemoryInputStream";
...
impl crate::Org::BouncyCastle::Utilities::IO::MemoryInputStream {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::IO::MemoryInputStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Utilities::IO::MemoryInputStream as
