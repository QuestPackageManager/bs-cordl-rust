...
for crate::Org::BouncyCastle::Utilities::Date::DateTimeObject {
    ...
    const CLASS_NAME: &'static str = "DateTimeObject";
...
impl crate::Org::BouncyCastle::Utilities::Date::DateTimeObject {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Date::DateTimeObject as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Utilities::Date::DateTimeObject as
