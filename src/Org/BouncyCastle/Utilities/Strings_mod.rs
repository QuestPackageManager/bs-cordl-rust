...
impl crate::Org::BouncyCastle::Utilities::Strings {
    ...
    > {
        ...
        > = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("FromAsciiByteArray", (bytes))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("FromUtf8ByteArray", (bytes))?;
        Ok(__cordl_ret.into())
    }
    pub fn IsOneOf(
    ...
    > {
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = <Self as quest_hook::libil2cpp::Type>::class().invoke("ToByteArray", (s))?;
        Ok(__cordl_ret.into())
    }
    pub fn ToUpperCase(
