#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Strings")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Strings")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Strings {
...
impl crate::Org::BouncyCastle::Utilities::Strings {
    ...
    pub fn IsOneOf(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (s, candidates))? };
        Ok(__cordl_ret.into())
    }
