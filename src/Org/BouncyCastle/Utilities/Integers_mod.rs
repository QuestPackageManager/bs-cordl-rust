#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Integers")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Integers")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Integers {
...
impl crate::Org::BouncyCastle::Utilities::Integers {
    ...
    pub fn RotateLeft_i32_0(i: i32, distance: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (i, distance))? };
        Ok(__cordl_ret.into())
    }
    pub fn RotateLeft_u32_1(i: u32, distance: i32) -> quest_hook::libil2cpp::Result<u32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked((), (i, distance))? };
        Ok(__cordl_ret.into())
    }
    pub fn RotateRight_i32_0(i: i32, distance: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn RotateRight_u32_1(i: u32, distance: i32) -> quest_hook::libil2cpp::Result<u32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Integers")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Integers {
