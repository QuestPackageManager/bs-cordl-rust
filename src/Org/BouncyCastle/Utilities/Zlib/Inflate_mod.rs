#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+Inflate")]
#[repr(C)]
#[derive(Debug)]
pub struct Inflate {
    ...
    pub nowrap: i32,
    pub wbits: i32,
    pub blocks: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::Zlib::InfBlocks>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+Inflate")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Zlib::Inflate {
...
impl crate::Org::BouncyCastle::Utilities::Zlib::Inflate {
    ...
    pub fn inflate(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (z, f))? };
        Ok(__cordl_ret.into())
    }
    pub fn inflateEnd(
        &mut self,
    ...
    pub fn inflateInit(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (z, w))? };
        Ok(__cordl_ret.into())
    }
    pub fn inflateReset(
        &mut self,
    ...
    pub fn inflateSetDictionary(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), i32, 3usize>("inflateSetDictionary")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (z, dictionary, dictLength))? };
        Ok(__cordl_ret.into())
    }
    pub fn inflateSync(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+Inflate")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Zlib::Inflate {
