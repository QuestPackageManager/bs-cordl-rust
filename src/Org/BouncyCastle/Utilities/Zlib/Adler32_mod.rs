#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+Adler32")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+Adler32")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Zlib::Adler32 {
...
impl crate::Org::BouncyCastle::Utilities::Zlib::Adler32 {
    ...
    pub fn adler32(
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked(self, (adler, buf, index, len))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+Adler32")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Zlib::Adler32 {
