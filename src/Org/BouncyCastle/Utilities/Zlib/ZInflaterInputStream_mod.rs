...
for crate::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream {
    ...
    const CLASS_NAME: &'static str = "ZInflaterInputStream";
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Zlib+ZInflaterInputStream")]
impl crate::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream {
    pub const BUFSIZE: i32 = 4192i32;
    pub fn Close(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Close")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream as
    ...
    pub fn _ctor_Stream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (inp))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (inp, nowrap))?
        };
        Ok(__cordl_ret.into())
    }
