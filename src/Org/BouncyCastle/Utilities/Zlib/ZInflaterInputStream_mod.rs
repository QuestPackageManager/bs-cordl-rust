...
impl std::ops::Deref for crate::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream {
...
#[cfg(feature = "Org+BouncyCastle+Utilities+Zlib+ZInflaterInputStream")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream {
...
impl crate::Org::BouncyCastle::Utilities::Zlib::ZInflaterInputStream {
    ...
    pub fn _ctor_Stream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (inp))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (inp, nowrap))? };
        Ok(__cordl_ret.into())
    }
