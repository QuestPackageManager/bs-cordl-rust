...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+InfTree")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Zlib::InfTree {
...
impl crate::Org::BouncyCastle::Utilities::Zlib::InfTree {
    ...
    pub fn huft_build(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (b, bindex, n, s, d, e, t, m, hp, hn, v))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn inflate_trees_bits(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (c, bb, tb, hp, z))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Utilities::Zlib::ZStream,
                        >,
                    ), i32, 9usize>("inflate_trees_dynamic")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn inflate_trees_fixed(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Utilities::Zlib::ZStream,
                        >,
                    ), i32, 5usize>("inflate_trees_fixed")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (bl, bd, tl, td, z))? };
        Ok(__cordl_ret.into())
    }
    pub fn initWorkArea(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (vsize))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+InfTree")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Zlib::InfTree {
