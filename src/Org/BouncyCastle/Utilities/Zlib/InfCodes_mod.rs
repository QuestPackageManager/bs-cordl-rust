...
impl crate::Org::BouncyCastle::Utilities::Zlib::InfCodes {
    ...
    pub fn inflate_fast(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bl, bd, tl, tl_index, td, td_index, s, z))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bl, bd, tl, tl_index, td, td_index, z))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn proc(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (s, z, r))?
        };
        Ok(__cordl_ret.into())
    }
}
