...
impl crate::Org::BouncyCastle::Utilities::Zlib::ZDeflaterOutputStream {
    ...
    pub fn _ctor_Stream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outp))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outp, level))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outp, level, nowrap))?
        };
        Ok(__cordl_ret.into())
    }
