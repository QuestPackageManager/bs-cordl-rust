...
pub struct InfBlocks {
    ...
    pub codes: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::Zlib::InfCodes>,
    pub last: i32,
    pub bitk: i32,
    pub bitb: i32,
    ...
    pub check: i64,
    pub inftree: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::Zlib::InfTree>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+InfBlocks")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Utilities::Zlib::InfBlocks {
...
impl crate::Org::BouncyCastle::Utilities::Zlib::InfBlocks {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (z, checkfn, w))? };
        Ok(__cordl_ret.into())
    }
    pub fn free(
        &mut self,
    ...
    pub fn inflate_flush(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (z, r))? };
        Ok(__cordl_ret.into())
    }
    pub fn proc(
        &mut self,
    ...
    pub fn reset(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (z, c))? };
        Ok(__cordl_ret.into())
    }
    pub fn set_dictionary(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("set_dictionary")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (d, start, n))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+InfBlocks")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Utilities::Zlib::InfBlocks {
