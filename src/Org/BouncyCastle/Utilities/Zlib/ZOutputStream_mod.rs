#[cfg(feature = "cordl_class_Org+BouncyCastle+Utilities+Zlib+ZOutputStream")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Utilities::Zlib::ZOutputStream {
    ...
    pub fn _ctor_ZStream2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, z))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, nowrap))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_3(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, level))? };
        Ok(__cordl_ret.into())
    }
