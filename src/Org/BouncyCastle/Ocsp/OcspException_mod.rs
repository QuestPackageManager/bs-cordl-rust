#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspException")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Ocsp::OcspException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Ocsp";
    const CLASS_NAME: &'static str = "OcspException";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Ocsp::OcspException {
