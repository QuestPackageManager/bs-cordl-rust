#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspUtilities")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspUtilities")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Ocsp::OcspUtilities {
...
impl crate::Org::BouncyCastle::Ocsp::OcspUtilities {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe { cordl_method_info.invoke_unchecked((), (sigOid))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspUtilities")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Ocsp::OcspUtilities {
