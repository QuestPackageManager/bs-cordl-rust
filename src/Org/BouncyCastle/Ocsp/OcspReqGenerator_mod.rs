...
pub struct OcspReqGenerator {
    ...
    pub requestorName: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::GeneralName>,
    pub requestExtensions:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Extensions>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspReqGenerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Ocsp::OcspReqGenerator {
...
impl crate::Org::BouncyCastle::Ocsp::OcspReqGenerator {
    ...
    pub fn AddRequest_CertificateID0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (certId))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddRequest_X509Extensions1(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Asn1::X509::X509Extensions,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("AddRequest")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (certId, singleRequestExtensions))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Ocsp::OcspReq>, 4usize>(
                        "GenerateRequest",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Ocsp::OcspReq> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (signingAlgorithm, privateKey, chain, random))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Generate_0(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Ocsp::OcspReq> =
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Ocsp::OcspReq>, 3usize>(
                        "Generate",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Ocsp::OcspReq> = unsafe {
            cordl_method_info.invoke_unchecked(self, (signingAlgorithm, privateKey, chain))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetRequestExtensions(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (requestExtensions))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetRequestorName_GeneralName1(
        &mut self,
        requestorName: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::GeneralName>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetRequestorName", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (requestorName))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetRequestorName_X509Name0(
        &mut self,
        requestorName: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspReqGenerator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Ocsp::OcspReqGenerator {
    ...
    for crate::Org::BouncyCastle::Ocsp::OcspReqGenerator_RequestObject
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Ocsp";
    const CLASS_NAME: &'static str = "OcspReqGenerator/RequestObject";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "Org+BouncyCastle+Ocsp+OcspReqGenerator+RequestObject")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Ocsp::OcspReqGenerator_RequestObject {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::Org::BouncyCastle::Ocsp::OcspReqGenerator_RequestObject {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (certId, extensions))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspReqGenerator+RequestObject")]
