...
impl crate::Org::BouncyCastle::Ocsp::OcspReqGenerator {
    ...
    pub fn AddRequest_CertificateID0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (certId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddRequest_X509Extensions1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (certId, singleRequestExtensions))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (signingAlgorithm, privateKey, chain))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetRequestExtensions", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (requestExtensions))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetRequestorName_GeneralName1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (requestorName))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::Org::BouncyCastle::Ocsp::OcspReqGenerator_RequestObject {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (certId, extensions))?
        };
        Ok(__cordl_ret.into())
    }
}
