...
impl crate::Org::BouncyCastle::Ocsp::OCSPRespGenerator {
    ...
    pub fn Generate(
        &mut self,
        status: i32,
        response: *mut quest_hook::libil2cpp::Il2CppObject,
    ) -> quest_hook::libil2cpp::Result<*mut crate::Org::BouncyCastle::Ocsp::OcspResp> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Org::BouncyCastle::Ocsp::OcspResp = __cordl_object
            .invoke("Generate", (status, response))?;
        Ok(__cordl_ret)
    }
