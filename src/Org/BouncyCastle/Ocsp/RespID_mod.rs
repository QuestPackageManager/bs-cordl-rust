...
#[cfg(feature = "Org+BouncyCastle+Ocsp+RespID")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Ocsp::RespID {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Ocsp";
    const CLASS_NAME: &'static str = "RespID";
...
impl crate::Org::BouncyCastle::Ocsp::RespID {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Ocsp::RespID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Ocsp::RespID as
