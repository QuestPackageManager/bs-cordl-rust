...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Ocsp::OcspReq =>
...
impl crate::Org::BouncyCastle::Ocsp::OcspReq {
    ...
    pub fn GetRequestList(
        ...
        *mut quest_hook::libil2cpp::Il2CppArray<*mut crate::Org::BouncyCastle::Ocsp::Req>,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut quest_hook::libil2cpp::Il2CppArray<
            *mut crate::Org::BouncyCastle::Ocsp::Req,
    ...
    pub fn New_OcspRequest0(
        req: *mut crate::Org::BouncyCastle::Asn1::Ocsp::OcspRequest,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn get_IsSigned(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = __cordl_object.invoke("get_IsSigned", ())?;
        Ok(__cordl_ret)
    }
