#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspReq")]
#[repr(C)]
#[derive(Debug)]
pub struct OcspReq {
    __cordl_parent: crate::Org::BouncyCastle::X509::X509ExtensionBase,
    pub req: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Ocsp::OcspRequest>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Ocsp+OcspReq")]
