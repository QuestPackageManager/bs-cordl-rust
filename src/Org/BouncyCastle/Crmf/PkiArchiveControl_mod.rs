...
pub struct PkiArchiveControl {
    ...
    pub pkiArchiveOptions: *mut crate::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions,
}
#[cfg(feature = "Org+BouncyCastle+Crmf+PkiArchiveControl")]
...
impl crate::Org::BouncyCastle::Crmf::PkiArchiveControl {
    ...
    > {
        ...
        let __cordl_ret: *mut crate::Org::BouncyCastle::Cms::CmsEnvelopedData = __cordl_object
            .invoke("GetEnvelopedData", ())?;
        Ok(__cordl_ret)
    }
    pub fn New(
        pkiArchiveOptions: *mut crate::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions,
