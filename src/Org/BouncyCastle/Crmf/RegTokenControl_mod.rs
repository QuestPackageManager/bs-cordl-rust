...
impl crate::Org::BouncyCastle::Crmf::RegTokenControl {
    ...
    pub fn _ctor_DerUtf8String0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crmf::RegTokenControl as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crmf::RegTokenControl as
