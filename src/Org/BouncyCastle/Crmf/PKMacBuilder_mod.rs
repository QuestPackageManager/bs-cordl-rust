...
pub struct PKMacBuilder {
    ...
    pub parameters: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::PbmParameter>,
    pub iterationCount: i32,
    pub saltLength: i32,
    pub maxIterations: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+PKMacBuilder")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crmf::PKMacBuilder {
...
impl crate::Org::BouncyCastle::Crmf::PKMacBuilder {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IMacFactory> =
    ...
    pub fn GenCalculator(
        &mut self,
        parameters: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Cmp::PbmParameter>,
        password: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<char>>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IMacFactory>,
    > {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crmf::PKMacBuilder> =
            unsafe { cordl_method_info.invoke_unchecked(self, (iterationCount))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IPKMacPrimitivesProvider_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (provider, maxIterations))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+PKMacBuilder")]
