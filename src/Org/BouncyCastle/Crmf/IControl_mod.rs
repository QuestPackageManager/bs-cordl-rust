...
#[cfg(feature = "Org+BouncyCastle+Crmf+IControl")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crmf::IControl {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crmf";
    const CLASS_NAME: &'static str = "IControl";
...
impl crate::Org::BouncyCastle::Crmf::IControl {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crmf::IControl as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crmf::IControl as
