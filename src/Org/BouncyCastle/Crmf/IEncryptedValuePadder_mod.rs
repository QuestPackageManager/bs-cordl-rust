#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+IEncryptedValuePadder")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+IEncryptedValuePadder")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crmf::IEncryptedValuePadder {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crmf";
    const CLASS_NAME: &'static str = "IEncryptedValuePadder";
...
impl crate::Org::BouncyCastle::Crmf::IEncryptedValuePadder {
    ...
    pub fn GetUnpaddedData(
        &mut self,
        paddedData: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetUnpaddedData", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (paddedData))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+IEncryptedValuePadder")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crmf::IEncryptedValuePadder {
