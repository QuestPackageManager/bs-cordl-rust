#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+PKMacFactory")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crmf+PKMacFactory")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crmf::PKMacFactory {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crmf";
    const CLASS_NAME: &'static str = "PKMacFactory";
