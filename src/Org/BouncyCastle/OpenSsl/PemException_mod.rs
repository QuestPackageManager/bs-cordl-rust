...
impl crate::Org::BouncyCastle::OpenSsl::PemException {
    ...
    pub fn _ctor_Exception1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::OpenSsl::PemException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::OpenSsl::PemException as
