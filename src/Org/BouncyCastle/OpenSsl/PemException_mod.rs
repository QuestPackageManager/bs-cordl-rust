...
#[cfg(feature = "cordl_class_Org+BouncyCastle+OpenSsl+PemException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::OpenSsl::PemException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.OpenSsl";
    const CLASS_NAME: &'static str = "PemException";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+OpenSsl+PemException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::OpenSsl::PemException {
