...
#[cfg(feature = "cordl_class_Org+BouncyCastle+OpenSsl+PemWriter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::OpenSsl::PemWriter {
...
impl crate::Org::BouncyCastle::OpenSsl::PemWriter {
    ...
    pub fn WriteObject_Il2CppString_Il2CppArray_SecureRandom1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 4usize>("WriteObject")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (obj, algorithm, password, random))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
