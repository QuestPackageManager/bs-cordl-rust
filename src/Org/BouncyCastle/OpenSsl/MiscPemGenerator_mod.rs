#[cfg(feature = "cordl_class_Org+BouncyCastle+OpenSsl+MiscPemGenerator")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+OpenSsl+MiscPemGenerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::OpenSsl::MiscPemGenerator {
...
impl crate::Org::BouncyCastle::OpenSsl::MiscPemGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Utilities::IO::Pem::PemObject,
        > = unsafe { cordl_method_info.invoke_unchecked((), (obj, algorithm, password, random))? };
        Ok(__cordl_ret.into())
    }
    pub fn EncodePrivateKey(
        akp: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (akp, keyType))? };
        Ok(__cordl_ret.into())
    }
    pub fn Generate(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+OpenSsl+MiscPemGenerator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::OpenSsl::MiscPemGenerator {
