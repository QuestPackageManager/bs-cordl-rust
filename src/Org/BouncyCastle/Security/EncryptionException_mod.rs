#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+EncryptionException")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+EncryptionException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Security::EncryptionException {
