...
for crate::Org::BouncyCastle::Security::EncryptionException {
    ...
    const CLASS_NAME: &'static str = "EncryptionException";
...
impl crate::Org::BouncyCastle::Security::EncryptionException {
    ...
    pub fn _ctor_Exception1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Security::EncryptionException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Security::EncryptionException as
