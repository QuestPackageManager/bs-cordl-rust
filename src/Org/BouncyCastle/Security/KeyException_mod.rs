#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+KeyException")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+KeyException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Security::KeyException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Security";
    const CLASS_NAME: &'static str = "KeyException";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+KeyException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Security::KeyException {
