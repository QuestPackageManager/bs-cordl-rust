#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+SignatureException")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+SignatureException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Security::SignatureException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Security";
    const CLASS_NAME: &'static str = "SignatureException";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+SignatureException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Security::SignatureException {
