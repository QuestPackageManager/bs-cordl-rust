...
impl crate::Org::BouncyCastle::Security::ParameterUtilities {
    pub fn AddAlgorithm(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (canonicalName, aliases))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddBasicIVSizeEntries", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_size, algorithms))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateIV(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KeyParameter,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (algOid, keyBytes, offset, length))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (algorithm, keyBytes, offset, length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FindBasicIVSize(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (canonicalName))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::ICipherParameters,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (algOid, key, asn1Params))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::ICipherParameters,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (algorithm, key, asn1Params))?
        };
        Ok(__cordl_ret.into())
    }
