...
for crate::Org::BouncyCastle::Security::Certificates::CertificateNotYetValidException {
    ...
    const CLASS_NAME: &'static str = "CertificateNotYetValidException";
...
impl crate::Org::BouncyCastle::Security::Certificates::CertificateNotYetValidException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Security::Certificates::CertificateNotYetValidException as quest_hook::libil2cpp::Type>::class()
