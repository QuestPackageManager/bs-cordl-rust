...
for crate::Org::BouncyCastle::Security::Certificates::CertificateEncodingException {
    ...
    const CLASS_NAME: &'static str = "CertificateEncodingException";
...
impl crate::Org::BouncyCastle::Security::Certificates::CertificateEncodingException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Security::Certificates::CertificateEncodingException as quest_hook::libil2cpp::Type>::class()
