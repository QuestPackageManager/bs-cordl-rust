#[cfg(feature = "cordl_class_Org+BouncyCastle+Security+Certificates+CertificateException")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Security::Certificates::CertificateException
{
    ...
    const CLASS_NAME: &'static str = "CertificateException";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Security::Certificates::CertificateException {
...
#[cfg(feature = "Org+BouncyCastle+Security+Certificates+CertificateException")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Security::Certificates::CertificateException {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Security+Certificates+CertificateException")]
impl crate::Org::BouncyCastle::Security::Certificates::CertificateException {
