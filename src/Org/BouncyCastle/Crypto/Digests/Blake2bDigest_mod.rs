...
impl crate::Org::BouncyCastle::Crypto::Digests::Blake2bDigest {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Rotr64",
                            2usize
                        )
                    })
            });
        let __cordl_ret: u64 = unsafe {
            cordl_method_info.invoke_unchecked((), (x, rot))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
    ...
    pub fn _ctor_Il2CppArray_i32_Il2CppArray_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (key, digestLength, salt, personalization))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (digestSize))?
        };
        Ok(__cordl_ret.into())
    }
