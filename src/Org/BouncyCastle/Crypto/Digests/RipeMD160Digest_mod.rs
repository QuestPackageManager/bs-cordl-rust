...
for crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Digests";
    const CLASS_NAME: &'static str = "RipeMD160Digest";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Digests+RipeMD160Digest")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Digests+RipeMD160Digest")]
impl crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest as
                    quest_hook::libil2cpp::Type > ::class(), "F5", 3usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (x, y, z))? };
        Ok(__cordl_ret.into())
