#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+RipeMD160Digest")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest {
    ...
    pub fn CopyIn(
        &mut self,
        t: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest>,
