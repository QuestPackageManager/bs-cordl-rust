...
for crate::Org::BouncyCastle::Crypto::Digests::GeneralDigest {
    ...
    const CLASS_NAME: &'static str = "GeneralDigest";
...
impl crate::Org::BouncyCastle::Crypto::Digests::GeneralDigest {
    ...
    pub fn BlockUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Digests::GeneralDigest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Digests::GeneralDigest as
