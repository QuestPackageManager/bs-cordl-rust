    ...
    for crate::Org::BouncyCastle::Crypto::Digests::Sha512tDigest
{
    ...
    const CLASS_NAME: &'static str = "Sha512tDigest";
...
impl crate::Org::BouncyCastle::Crypto::Digests::Sha512tDigest {
    ...
    pub fn New_Sha512tDigest1(
        t: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Digests::Sha512tDigest>,
    ...
    pub fn UInt32_To_BE(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 4usize>("UInt32_To_BE")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (n, bs, off, max))? };
        Ok(__cordl_ret.into())
    }
    pub fn UInt64_To_BE(
        n: u64,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 4usize>("UInt64_To_BE")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn tIvGenerate(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("tIvGenerate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
