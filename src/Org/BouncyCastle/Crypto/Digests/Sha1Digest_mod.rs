#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+Sha1Digest")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+Sha1Digest")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Digests::Sha1Digest {
...
impl crate::Org::BouncyCastle::Crypto::Digests::Sha1Digest {
    ...
    pub fn CopyIn(
        &mut self,
        t: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Digests::Sha1Digest>,
    ...
    pub fn F(u: u32, v: u32, w: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked((), (u, v, w))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+Sha1Digest")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Digests::Sha1Digest {
