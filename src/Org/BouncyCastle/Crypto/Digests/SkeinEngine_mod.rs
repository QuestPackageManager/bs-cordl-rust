...
impl crate::Org::BouncyCastle::Crypto::Digests::SkeinEngine {
    ...
    pub fn InitialState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (blockSize, outputSize, state))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "UbiInit",
                            1usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "VariantIdentifier", 2usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (blockSizeBytes, outputSizeBytes))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_i32_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (blockSizeBits, outputSizeBits))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::Org::BouncyCastle::Crypto::Digests::SkeinEngine_Configuration {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outputSizeBits))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Bytes(
...
impl crate::Org::BouncyCastle::Crypto::Digests::SkeinEngine_UBI {
    ...
    pub fn Reset_SkeinEngine_UBI0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ubi))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Reset_i32_1(
    ...
    pub fn Update(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, offset, len, output))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (engine, blockSize))?
        };
        Ok(__cordl_ret.into())
    }
}
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AdvancePosition", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (advance))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetWords(
