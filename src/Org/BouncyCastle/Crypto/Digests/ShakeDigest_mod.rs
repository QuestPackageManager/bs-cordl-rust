...
impl crate::Org::BouncyCastle::Crypto::Digests::ShakeDigest {
    pub fn CheckBitLength(bitLength: i32) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Digests::ShakeDigest as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(i32), i32, 1usize>("CheckBitLength")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Digests::ShakeDigest as
    ...
    pub fn DoFinal_i32_u8_i32_3(
        ...
        let __cordl_ret: i32 = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (output, outOff, outLen, partialByte, partialBits),
                )?
        };
        Ok(__cordl_ret.into())
    }
