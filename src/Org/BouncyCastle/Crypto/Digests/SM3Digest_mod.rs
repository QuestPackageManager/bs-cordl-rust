...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Crypto::Digests::SM3Digest =>
...
impl crate::Org::BouncyCastle::Crypto::Digests::SM3Digest {
    ...
    pub fn CopyIn(
        &mut self,
        t: *mut crate::Org::BouncyCastle::Crypto::Digests::SM3Digest,
    ...
    pub fn P0(&mut self, x: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = __cordl_object.invoke("P0", (x))?;
        Ok(__cordl_ret)
    }
    pub fn GG1(&mut self, x: u32, y: u32, z: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = __cordl_object.invoke("GG1", (x, y, z))?;
        Ok(__cordl_ret)
    }
    pub fn ProcessBlock(
        &mut self,
    ...
    pub fn GG0(&mut self, x: u32, y: u32, z: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = __cordl_object.invoke("GG0", (x, y, z))?;
        Ok(__cordl_ret)
    }
    pub fn _ctor_0(
        &mut self,
    ...
    pub fn FF0(&mut self, x: u32, y: u32, z: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = __cordl_object.invoke("FF0", (x, y, z))?;
        Ok(__cordl_ret)
    }
    pub fn ProcessWord(
        &mut self,
    ...
    pub fn P1(&mut self, x: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = __cordl_object.invoke("P1", (x))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn FF1(&mut self, x: u32, y: u32, z: u32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = __cordl_object.invoke("FF1", (x, y, z))?;
        Ok(__cordl_ret)
    }
