#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+Sha3Digest")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+Sha3Digest")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Digests::Sha3Digest {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Digests";
    const CLASS_NAME: &'static str = "Sha3Digest";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Digests+Sha3Digest")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Digests::Sha3Digest {
...
impl crate::Org::BouncyCastle::Crypto::Digests::Sha3Digest {
    pub fn CheckBitLength(bitLength: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32), i32, 1usize>("CheckBitLength")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (bitLength))? };
        Ok(__cordl_ret.into())
    }
    pub fn Copy(
        &mut self,
    ...
    pub fn DoFinal_u8_i32_1(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (output, outOff, partialByte, partialBits))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn New_Sha3Digest2(
        source: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Digests::Sha3Digest>,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Digests+Sha3Digest")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Digests::Sha3Digest {
