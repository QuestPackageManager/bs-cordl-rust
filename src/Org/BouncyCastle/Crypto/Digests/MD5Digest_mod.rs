...
impl crate::Org::BouncyCastle::Crypto::Digests::MD5Digest {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Digests::MD5Digest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Digests::MD5Digest as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Digests::MD5Digest as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Digests::MD5Digest as
                    quest_hook::libil2cpp::Type > ::class(), "K", 3usize
                )
            });
        let __cordl_ret: u32 = unsafe { method.invoke_unchecked((), (u, v, w))? };
        Ok(__cordl_ret.into())
