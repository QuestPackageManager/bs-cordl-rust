#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+AsymmetricKeyParameter")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter {
    pub fn Equals_AsymmetricKeyParameter1(
        &mut self,
        other: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter>,
    ...
    pub fn New(privateKey: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
