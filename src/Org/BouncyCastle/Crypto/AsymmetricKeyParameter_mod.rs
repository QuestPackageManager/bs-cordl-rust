...
for crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter {
    ...
    const CLASS_NAME: &'static str = "AsymmetricKeyParameter";
...
impl crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter {
    pub fn Equals_AsymmetricKeyParameter1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::AsymmetricKeyParameter as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter as
                    quest_hook::libil2cpp::Type > ::class(), "get_IsPrivate", 0usize
                )
            });
