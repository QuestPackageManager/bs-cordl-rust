#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IVerifierFactory")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IVerifierFactory")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IVerifierFactory {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "IVerifierFactory";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IVerifierFactory")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IVerifierFactory {
