...
for crate::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory {
    ...
    const CLASS_NAME: &'static str = "AlgorithmIdentifierFactory";
...
impl crate::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory {
    pub fn GenerateEncryptionAlgID(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory as
                    quest_hook::libil2cpp::Type > ::class(), "GenerateEncryptionAlgID",
                    3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe { method.invoke_unchecked((), (encryptionOID, keySize, random))? };
        Ok(__cordl_ret.into())
    }
