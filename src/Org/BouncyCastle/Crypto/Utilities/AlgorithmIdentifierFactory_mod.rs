#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Crypto+Utilities+AlgorithmIdentifierFactory"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory {
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GenerateEncryptionAlgID", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (encryptionOID, keySize, random))?
        };
        Ok(__cordl_ret.into())
    }
