#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Utilities+AlgorithmIdentifierFactory")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory {
...
impl crate::Org::BouncyCastle::Crypto::Utilities::AlgorithmIdentifierFactory {
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 3usize>("GenerateEncryptionAlgID")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
        > = unsafe { cordl_method_info.invoke_unchecked((), (encryptionOID, keySize, random))? };
        Ok(__cordl_ret.into())
    }
