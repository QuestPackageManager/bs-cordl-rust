#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Utilities+CipherKeyGeneratorFactory")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Utilities::CipherKeyGeneratorFactory {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Utilities+CipherKeyGeneratorFactory")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Utilities::CipherKeyGeneratorFactory {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateCipherKeyGenerator", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::CipherKeyGenerator,
        > = unsafe { cordl_method_info.invoke_unchecked((), (random, keySize))? };
        Ok(__cordl_ret.into())
    }
