#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+ISignatureFactory")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+ISignatureFactory")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::ISignatureFactory {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "ISignatureFactory";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+ISignatureFactory")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::ISignatureFactory {
