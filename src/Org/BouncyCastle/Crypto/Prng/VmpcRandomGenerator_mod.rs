...
impl crate::Org::BouncyCastle::Crypto::Prng::VmpcRandomGenerator {
    pub fn AddSeedMaterial_Il2CppArray0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Prng::VmpcRandomGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Prng::VmpcRandomGenerator as
