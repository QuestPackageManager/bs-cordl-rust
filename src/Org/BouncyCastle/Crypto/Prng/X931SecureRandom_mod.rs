#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Prng+X931SecureRandom")]
#[repr(C)]
...
pub struct X931SecureRandom {
    ...
    pub mDrbg: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Prng::X931Rng>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Prng+X931SecureRandom")]
...
impl crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandom {
    ...
    pub fn _ctor(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Prng::X931Rng>,
                        bool,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (randomSource, drbg, predictionResistant))?
        };
        Ok(__cordl_ret.into())
    }
}
