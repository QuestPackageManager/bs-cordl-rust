...
impl crate::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator {
    ...
    pub fn AddSeedMaterial_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (inSeed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddSeedMaterial_i64_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rSeed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CycleSeed(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DigestAddCounter", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (seedVal))?
        };
        Ok(__cordl_ret.into())
    }
