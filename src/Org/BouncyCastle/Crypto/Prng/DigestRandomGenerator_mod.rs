#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Prng+DigestRandomGenerator")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator
{
    ...
    const CLASS_NAME: &'static str = "DigestRandomGenerator";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Prng+DigestRandomGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator {
    ...
    pub fn AddSeedMaterial_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (inSeed))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddSeedMaterial_i64_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rSeed))? };
        Ok(__cordl_ret.into())
    }
    pub fn CycleSeed(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CycleSeed")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn DigestAddCounter(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64), quest_hook::libil2cpp::Void, 1usize>("DigestAddCounter")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (seedVal))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GenerateState(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("GenerateState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn NextBytes_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bytes, start, len))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
...
impl AsMut<crate::Org::BouncyCastle::Crypto::Prng::IRandomGenerator>
    for crate::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Prng::IRandomGenerator {
        unsafe { std::mem::transmute(self) }
    }
}
