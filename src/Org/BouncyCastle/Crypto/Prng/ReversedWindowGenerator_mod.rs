#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Prng+ReversedWindowGenerator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Prng::ReversedWindowGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Prng+ReversedWindowGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Prng::ReversedWindowGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Prng::ReversedWindowGenerator {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (generator, windowSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn doNextBytes(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("doNextBytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
