#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Prng+X931SecureRandomBuilder")]
#[repr(C)]
#[derive(Debug)]
pub struct X931SecureRandomBuilder {
    ...
    pub mDateTimeVector: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Prng+X931SecureRandomBuilder")]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Prng+X931SecureRandomBuilder")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder {
...
impl crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder {
    pub fn Build(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandom>,
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandom,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (engine, key, predictionResistant))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetDateTimeVector(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetDateTimeVector", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (dateTimeVector))? };
        Ok(__cordl_ret.into())
    }
