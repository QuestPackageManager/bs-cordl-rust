...
#[cfg(feature = "Org+BouncyCastle+Crypto+Prng+ThreadedSeedGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Prng::ThreadedSeedGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Prng::ThreadedSeedGenerator {
    ...
    pub type SeedGenerator =
        crate::Org::BouncyCastle::Crypto::Prng::ThreadedSeedGenerator_SeedGenerator;
    pub fn GenerateSeed(
        &mut self,
        numBytes: i32,
        fast: bool,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (numBytes, fast))? };
        Ok(__cordl_ret.into())
    }
