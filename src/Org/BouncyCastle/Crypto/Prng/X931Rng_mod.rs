...
impl crate::Org::BouncyCastle::Crypto::Prng::X931Rng {
    ...
    pub fn Generate(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (output, predictionResistant))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Increment(
    ...
    pub fn Process(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (res, a, b))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Reseed(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (engine, dateTimeVector, entropySource))?
        };
        Ok(__cordl_ret.into())
    }
