#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+IDsaEncoding")]
    ...
    for crate::Org::BouncyCastle::Crypto::Signers::IDsaEncoding
{
    ...
    const CLASS_NAME: &'static str = "IDsaEncoding";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+IDsaEncoding")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Signers::IDsaEncoding {
