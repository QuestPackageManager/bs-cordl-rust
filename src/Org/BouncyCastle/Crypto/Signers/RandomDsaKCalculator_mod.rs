...
impl crate::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator {
    pub fn Init_BigInteger_Il2CppArray1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator as
