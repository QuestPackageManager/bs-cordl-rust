    ...
    for crate::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator
{
    ...
    const CLASS_NAME: &'static str = "RandomDsaKCalculator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Signers+RandomDsaKCalculator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator {
...
impl AsMut<crate::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator>
    for crate::Org::BouncyCastle::Crypto::Signers::RandomDsaKCalculator
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator {
        unsafe { std::mem::transmute(self) }
    }
}
