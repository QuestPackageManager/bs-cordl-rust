...
#[cfg(feature = "Org+BouncyCastle+Crypto+Signers+Ed25519ctxSigner+Buffer")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Signers+Ed25519ctxSigner+Buffer")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GenerateSignature", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (privateKey, ctx))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn VerifySignature(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (publicKey, ctx, signature))? };
        Ok(__cordl_ret.into())
    }
