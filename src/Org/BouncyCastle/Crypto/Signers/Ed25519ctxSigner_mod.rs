...
for crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner {
    ...
    const CLASS_NAME: &'static str = "Ed25519ctxSigner";
...
impl crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner {
    ...
    pub fn BlockUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner as
...
for crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Signers";
    const CLASS_NAME: &'static str = "Ed25519ctxSigner/Buffer";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer {
    pub fn GenerateSignature(
        ...
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer
                    as quest_hook::libil2cpp::Type > ::class(), "GenerateSignature",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe { method.invoke_unchecked(self, (privateKey, ctx))? };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Signers::Ed25519ctxSigner_Buffer
                    as quest_hook::libil2cpp::Type > ::class(), "VerifySignature", 3usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (publicKey, ctx, signature))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
