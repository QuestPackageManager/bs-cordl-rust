#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+RsaDigestSigner")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Signers::RsaDigestSigner {
    ...
    pub fn _ctor_IAsymmetricBlockCipher_IDigest_AlgorithmIdentifier5(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rsaEngine, digest, algId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IDigest_AlgorithmIdentifier2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (digest, algId))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IDigest_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (digest, digestOid))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IRsa_IDigest_AlgorithmIdentifier4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rsa, digest, algId))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IRsa_IDigest_DerObjectIdentifier3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rsa, digest, digestOid))? };
        Ok(__cordl_ret.into())
    }
