#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+GenericSigner")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Signers::GenericSigner {
    ...
    pub fn New(
        engine: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (engine, digest))? };
        Ok(__cordl_ret.into())
    }
