...
for crate::Org::BouncyCastle::Crypto::Signers::GenericSigner {
    ...
    const CLASS_NAME: &'static str = "GenericSigner";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Signers+GenericSigner")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Signers::GenericSigner {
...
impl crate::Org::BouncyCastle::Crypto::Signers::GenericSigner {
    pub fn BlockUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::GenericSigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Signers::GenericSigner as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (engine, digest))?
        };
        Ok(__cordl_ret.into())
    }
