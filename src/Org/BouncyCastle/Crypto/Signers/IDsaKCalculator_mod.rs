#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+IDsaKCalculator")]
...
impl crate::Org::BouncyCastle::Crypto::Signers::IDsaKCalculator {
    pub fn Init_BigInteger_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (n, d, message))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init_SecureRandom0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (n, random))? };
        Ok(__cordl_ret.into())
    }
    pub fn NextK(
        &mut self,
