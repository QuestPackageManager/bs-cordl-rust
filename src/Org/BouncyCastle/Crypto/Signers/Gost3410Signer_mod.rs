...
for crate::Org::BouncyCastle::Crypto::Signers::Gost3410Signer {
    ...
    const CLASS_NAME: &'static str = "Gost3410Signer";
...
impl crate::Org::BouncyCastle::Crypto::Signers::Gost3410Signer {
    pub fn GenerateSignature(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::Gost3410Signer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Signers::Gost3410Signer as
