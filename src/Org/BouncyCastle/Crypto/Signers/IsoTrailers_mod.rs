#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+IsoTrailers")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+IsoTrailers")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Signers::IsoTrailers {
...
impl crate::Org::BouncyCastle::Crypto::Signers::IsoTrailers {
    ...
    pub fn GetTrailer(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (digest))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "NoTrailerAvailable", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (digest))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+IsoTrailers")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Signers::IsoTrailers {
