...
for crate::Org::BouncyCastle::Crypto::Signers::Ed448phSigner {
    ...
    const CLASS_NAME: &'static str = "Ed448phSigner";
...
impl crate::Org::BouncyCastle::Crypto::Signers::Ed448phSigner {
    pub fn BlockUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::Ed448phSigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Signers::Ed448phSigner as
