#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+ECNRSigner")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+ECNRSigner")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Signers::ECNRSigner {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Signers";
    const CLASS_NAME: &'static str = "ECNRSigner";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+ECNRSigner")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Signers::ECNRSigner {
