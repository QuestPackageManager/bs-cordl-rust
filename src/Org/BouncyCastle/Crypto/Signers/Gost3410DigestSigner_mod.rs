...
for crate::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner {
    ...
    const CLASS_NAME: &'static str = "Gost3410DigestSigner";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Signers+Gost3410DigestSigner")]
impl crate::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner {
    pub fn BlockUpdate(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner as
    ...
    pub fn New(
        signer: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDsa>,
        digest: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (signer, digest))?;
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (signer, digest))?
        };
        Ok(__cordl_ret.into())
    }
