...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Signers+Gost3410DigestSigner")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner {
...
impl crate::Org::BouncyCastle::Crypto::Signers::Gost3410DigestSigner {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (signer, digest))? };
        Ok(__cordl_ret.into())
    }
