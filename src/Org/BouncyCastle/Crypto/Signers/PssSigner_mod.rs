...
pub struct PssSigner {
    ...
    pub contentDigest1: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
    pub contentDigest2: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+PssSigner")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Signers::PssSigner {
...
impl crate::Org::BouncyCastle::Crypto::Signers::PssSigner {
    ...
    pub fn CreateRawSigner_IDigest_i32_u8_1(
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher>,
        contentDigest: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (cipher, contentDigest, mgfDigest, saltLen, trailer))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ItoOSP(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        i32,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                    ), quest_hook::libil2cpp::Void, 2usize>("ItoOSP")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (i, sp))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (Z, zOff, zLen, length))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn New_IDigest_IDigest_i32_Il2CppArray_u8_7(
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher>,
        contentDigest1: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
        contentDigest2: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
        mgfDigest: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDigest>,
        saltLen: i32,
    ...
    pub fn _ctor_IAsymmetricBlockCipher_IDigest0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, digest))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IDigest_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cipher, contentDigest, mgfDigest, salt))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IDigest_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cipher, contentDigest, mgfDigest, saltLen))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IDigest_i32_u8_6(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (cipher, contentDigest, mgfDigest, saltLen, trailer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, digest, salt))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_1(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, digest, saltLen))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Signers+PssSigner")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Signers::PssSigner {
