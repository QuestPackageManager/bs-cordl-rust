#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IDerivationParameters")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IDerivationParameters")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IDerivationParameters {
