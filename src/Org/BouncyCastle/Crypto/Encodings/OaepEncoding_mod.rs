#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Encodings+OaepEncoding")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Encodings::OaepEncoding {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (inBytes, inOff, inLen))? };
        Ok(__cordl_ret.into())
    }
    pub fn EncodeBlock(
        &mut self,
    ...
    pub fn _ctor_IDigest1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, hash))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IDigest_IDigest_Il2CppArray3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cipher, hash, mgf1Hash, encodingParams))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IDigest_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, hash, encodingParams))? };
        Ok(__cordl_ret.into())
    }
