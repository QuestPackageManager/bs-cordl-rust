...
impl crate::Org::BouncyCastle::Crypto::Encodings::OaepEncoding {
    ...
    > {
        ...
        > = __cordl_object.invoke("DecodeBlock", (inBytes, inOff, inLen))?;
        Ok(__cordl_ret.into())
    }
    pub fn EncodeBlock(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = __cordl_object.invoke("EncodeBlock", (inBytes, inOff, inLen))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = __cordl_object.invoke("ProcessBlock", (inBytes, inOff, inLen))?;
        Ok(__cordl_ret.into())
    }
