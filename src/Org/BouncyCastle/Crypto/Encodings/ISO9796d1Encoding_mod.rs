#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Encodings+ISO9796d1Encoding")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Encodings+ISO9796d1Encoding")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Encodings::ISO9796d1Encoding {
...
impl crate::Org::BouncyCastle::Crypto::Encodings::ISO9796d1Encoding {
    ...
    pub fn SetPadBits(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (padBits))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
