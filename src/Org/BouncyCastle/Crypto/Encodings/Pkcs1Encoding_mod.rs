...
impl crate::Org::BouncyCastle::Crypto::Encodings::Pkcs1Encoding {
    ...
    pub fn DecodeBlock(
        ...
        let __cordl_ret: *mut quest_hook::libil2cpp::Il2CppArray<u8> = __cordl_object
            .invoke("DecodeBlock", (input, inOff, inLen))?;
        Ok(__cordl_ret)
    }
    pub fn DecodeBlockOrRandom(
        ...
        let __cordl_ret: *mut quest_hook::libil2cpp::Il2CppArray<u8> = __cordl_object
            .invoke("DecodeBlockOrRandom", (input, inOff, inLen))?;
        Ok(__cordl_ret)
    }
    pub fn EncodeBlock(
        &mut self,
        ...
        let __cordl_ret: *mut quest_hook::libil2cpp::Il2CppArray<u8> = __cordl_object
            .invoke("EncodeBlock", (input, inOff, inLen))?;
        Ok(__cordl_ret)
    }
    pub fn FindStart(
        &mut self,
    ...
    pub fn New_Il2CppArray2(
        cipher: *mut crate::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher,
        fallback: *mut quest_hook::libil2cpp::Il2CppArray<u8>,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
