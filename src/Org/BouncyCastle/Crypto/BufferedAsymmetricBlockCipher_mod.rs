    ...
    for crate::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher
{
    ...
    const CLASS_NAME: &'static str = "BufferedAsymmetricBlockCipher";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedAsymmetricBlockCipher")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedAsymmetricBlockCipher")]
impl crate::Org::BouncyCastle::Crypto::BufferedAsymmetricBlockCipher {
    pub fn DoFinal_0(
        &mut self,
    ...
    pub fn GetBufferPosition(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("GetBufferPosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
