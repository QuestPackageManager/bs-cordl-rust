#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+AsymmetricCipherKeyPair")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (publicParameter, privateParameter))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Private(
