...
for crate::Org::BouncyCastle::Crypto::IDerivationFunction {
    ...
    const CLASS_NAME: &'static str = "IDerivationFunction";
...
impl crate::Org::BouncyCastle::Crypto::IDerivationFunction {
    pub fn GenerateBytes(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::IDerivationFunction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::IDerivationFunction as
