#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+CipherStream")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct CipherStream {
    __cordl_parent: crate::System::IO::Stream,
    pub stream: quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
    pub inCipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBufferedCipher>,
    pub outCipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBufferedCipher>,
    pub mInBuf: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub mInPos: i32,
    pub inStreamEnded: bool,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+CipherStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IO::CipherStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.IO";
    const CLASS_NAME: &'static str = "CipherStream";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+IO+CipherStream")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::IO::CipherStream {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+IO+CipherStream")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::IO::CipherStream {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+IO+CipherStream")]
impl crate::Org::BouncyCastle::Crypto::IO::CipherStream {
    ...
    pub fn FillInBuf(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("FillInBuf")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn New(
        ...
        readCipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBufferedCipher>,
        writeCipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBufferedCipher>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (stream, readCipher, writeCipher))?;
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (stream, readCipher, writeCipher))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+CipherStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IO::CipherStream {
