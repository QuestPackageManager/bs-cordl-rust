...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+MacSink")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IO::MacSink {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.IO";
    const CLASS_NAME: &'static str = "MacSink";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+MacSink")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IO::MacSink {
