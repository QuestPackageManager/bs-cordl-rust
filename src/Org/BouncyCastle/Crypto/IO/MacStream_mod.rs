...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+MacStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IO::MacStream {
...
impl crate::Org::BouncyCastle::Crypto::IO::MacStream {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "ReadMac",
                            0usize
                        )
                    })
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (stream, readMac, writeMac))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+MacStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IO::MacStream {
