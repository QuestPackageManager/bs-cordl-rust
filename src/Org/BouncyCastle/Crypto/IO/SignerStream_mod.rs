#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+SignerStream")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+SignerStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IO::SignerStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.IO";
    const CLASS_NAME: &'static str = "SignerStream";
...
impl crate::Org::BouncyCastle::Crypto::IO::SignerStream {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (stream, readSigner, writeSigner))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+SignerStream")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IO::SignerStream {
