#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+SignerSink")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+SignerSink")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IO::SignerSink {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IO+SignerSink")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IO::SignerSink {
