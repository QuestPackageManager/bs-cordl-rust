...
impl crate::Org::BouncyCastle::Crypto::Engines::AesLightEngine {
    ...
    pub fn DecryptBlock(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (KW))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EncryptBlock(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Mcol",
                            1usize
                        )
                    })
            });
    ...
    pub fn PackBlock(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bytes, off))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessBlock(
    ...
    pub fn Shift(r: u32, shift: i32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked((), (r, shift))?
        };
        Ok(__cordl_ret.into())
    }
