#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+Gost28147Engine")]
#[repr(C)]
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::Org::BouncyCastle::Crypto::Engines::Gost28147Engine
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Engines";
    const CLASS_NAME: &'static str = "Gost28147Engine";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Engines::Gost28147Engine {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+Gost28147Engine")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Engines::Gost28147Engine {
...
impl crate::Org::BouncyCastle::Crypto::Engines::Gost28147Engine {
    ...
    pub fn AddSBox(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("AddSBox")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (sBoxName, sBox))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "GetSBox",
                            1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (sBoxName))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetSBoxName(
        sBox: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (sBox))? };
        Ok(__cordl_ret.into())
    }
    pub fn Gost28147Func(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 5usize>("Gost28147Func")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (workingKey, inBytes, inOff, outBytes, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Gost28147_mainStep(&mut self, n1: i32, key: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (n1, key))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
    ...
    pub fn bytesToint(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (inBytes, inOff))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (forEncryption, userKey))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn intTobytes(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("intTobytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (num, outBytes, outOff))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+Gost28147Engine")]
