#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+NaccacheSternEngine")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+NaccacheSternEngine")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine {
...
impl crate::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (block1, block2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Encrypt(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (plain))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (inBytes, inOff, length))? };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessData(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "chineseRemainder", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked((), (congruences, primes))? };
        Ok(__cordl_ret.into())
    }
