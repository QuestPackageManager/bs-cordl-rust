...
impl crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
    ...
    pub fn DecryptBlock(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC2Engine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::RC2Engine as
    ...
    > {
        ...
        > = unsafe { method.invoke_unchecked(self, (key, bits))? };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC2Engine as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::RC2Engine as
                    quest_hook::libil2cpp::Type > ::class(), "RotateWordLeft", 2usize
                )
            });
