#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RC2Engine")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RC2Engine")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Engines";
    const CLASS_NAME: &'static str = "RC2Engine";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RC2Engine")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RC2Engine")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RC2Engine")]
impl crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
    ...
    pub fn RotateWordLeft(&mut self, x: i32, y: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, i32), i32, 2usize>("RotateWordLeft")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RC2Engine")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
...
impl AsRef<crate::Org::BouncyCastle::Crypto::IBlockCipher>
    for crate::Org::BouncyCastle::Crypto::Engines::RC2Engine
{
