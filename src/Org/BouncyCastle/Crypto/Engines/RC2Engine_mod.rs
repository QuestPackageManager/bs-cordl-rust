...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Crypto::Engines::RC2Engine =>
...
impl crate::Org::BouncyCastle::Crypto::Engines::RC2Engine {
    ...
    > {
        ...
        > = __cordl_object.invoke("GenerateWorkingKey", (key, bits))?;
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RotateWordLeft(
        ...
        let __cordl_ret: i32 = __cordl_object.invoke("RotateWordLeft", (x, y))?;
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
