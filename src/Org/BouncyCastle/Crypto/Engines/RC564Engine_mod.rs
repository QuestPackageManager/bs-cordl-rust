...
impl crate::Org::BouncyCastle::Crypto::Engines::RC564Engine {
    pub fn BytesToWord(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC564Engine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::RC564Engine as
    ...
    pub fn RotateLeft(&mut self, x: i64, y: i64) -> quest_hook::libil2cpp::Result<i64> {
        ...
        let __cordl_ret: i64 = unsafe { method.invoke_unchecked(self, (x, y))? };
        Ok(__cordl_ret.into())
    }
