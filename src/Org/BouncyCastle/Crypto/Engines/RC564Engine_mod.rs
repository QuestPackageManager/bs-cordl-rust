...
pub struct RC564Engine {
    ...
    pub _noRounds: i32,
    pub _S: *mut quest_hook::libil2cpp::Il2CppArray<i64>,
    pub forEncryption: bool,
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RC564Engine")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Crypto::Engines::RC564Engine
...
impl crate::Org::BouncyCastle::Crypto::Engines::RC564Engine {
    ...
    pub fn RotateRight(&mut self, x: i64, y: i64) -> quest_hook::libil2cpp::Result<i64> {
        ...
        let __cordl_ret: i64 = __cordl_object.invoke("RotateRight", (x, y))?;
        Ok(__cordl_ret)
    }
    pub fn _ctor(
        &mut self,
    ...
    pub fn RotateLeft(&mut self, x: i64, y: i64) -> quest_hook::libil2cpp::Result<i64> {
        ...
        let __cordl_ret: i64 = __cordl_object.invoke("RotateLeft", (x, y))?;
        Ok(__cordl_ret)
    }
    pub fn BytesToWord(
        &mut self,
        ...
        let __cordl_ret: i64 = __cordl_object.invoke("BytesToWord", (src, srcOff))?;
        Ok(__cordl_ret)
    }
