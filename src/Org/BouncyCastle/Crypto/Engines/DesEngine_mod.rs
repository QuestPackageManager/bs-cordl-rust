...
impl crate::Org::BouncyCastle::Crypto::Engines::DesEngine {
    ...
    pub fn DesFunc(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::DesEngine as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::DesEngine as
                    quest_hook::libil2cpp::Type > ::class(), "DesFunc", 5usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (wKey, input, inOff, outBytes, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe { method.invoke_unchecked((), (encrypting, key))? };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::DesEngine as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::DesEngine as
                    quest_hook::libil2cpp::Type > ::class(), "GetWorkingKey", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<i32>,
