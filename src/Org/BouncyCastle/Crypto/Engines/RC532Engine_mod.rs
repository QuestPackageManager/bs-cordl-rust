...
impl crate::Org::BouncyCastle::Crypto::Engines::RC532Engine {
    pub fn BytesToWord(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC532Engine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::RC532Engine as
                    quest_hook::libil2cpp::Type > ::class(), "BytesToWord", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (src, srcOff))? };
        Ok(__cordl_ret.into())
    }
    pub fn DecryptBlock(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC532Engine as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::RC532Engine as
                    quest_hook::libil2cpp::Type > ::class(), "WordToBytes", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (word, dst, dstOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
