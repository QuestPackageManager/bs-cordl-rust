...
impl crate::Org::BouncyCastle::Crypto::Engines::RsaCoreEngine {
    ...
    > {
        ...
        > = __cordl_object.invoke("ConvertInput", (inBuf, inOff, inLen))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = __cordl_object.invoke("ConvertOutput", (result))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
        > = __cordl_object.invoke("ProcessBlock", (input))?;
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RsaCoreEngine")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IRsa>>
for crate::Org::BouncyCastle::Crypto::Engines::RsaCoreEngine {
    fn as_ref(
        &self,
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RsaCoreEngine")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IRsa>>
for crate::Org::BouncyCastle::Crypto::Engines::RsaCoreEngine {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IRsa> {
        unsafe { std::mem::transmute(self) }
    }
}
