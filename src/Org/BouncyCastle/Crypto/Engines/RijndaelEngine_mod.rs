...
impl crate::Org::BouncyCastle::Crypto::Engines::RijndaelEngine {
    pub fn ApplyS(
        ...
        let __cordl_ret: i64 = unsafe { method.invoke_unchecked(self, (r, _cordl_box)) };
        Ok(__cordl_ret.into())
    }
    pub fn DecryptBlock(
        &mut self,
