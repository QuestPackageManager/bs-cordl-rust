#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+CamelliaEngine")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Engines::CamelliaEngine
{
    ...
    const CLASS_NAME: &'static str = "CamelliaEngine";
...
impl crate::Org::BouncyCastle::Crypto::Engines::CamelliaEngine {
    ...
    pub fn camelliaF2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (s, skey, keyoff))? };
        Ok(__cordl_ret.into())
    }
    pub fn camelliaFLs(
        s: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u32>>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (s, fkey, keyoff))? };
        Ok(__cordl_ret.into())
    }
    pub fn decroldq(
        rot: i32,
