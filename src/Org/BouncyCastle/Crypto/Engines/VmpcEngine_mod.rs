#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+VmpcEngine")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+VmpcEngine")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Engines::VmpcEngine {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Engines";
    const CLASS_NAME: &'static str = "VmpcEngine";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+VmpcEngine")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Engines::VmpcEngine {
