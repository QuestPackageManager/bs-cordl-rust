...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+NullEngine")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Engines::NullEngine {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Engines";
    const CLASS_NAME: &'static str = "NullEngine";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+NullEngine")]
impl crate::Org::BouncyCastle::Crypto::Engines::NullEngine {
    pub const BlockSize: i32 = 1i32;
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+NullEngine")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Engines::NullEngine {
