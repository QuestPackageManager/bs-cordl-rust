...
for crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Engines";
    const CLASS_NAME: &'static str = "SkipjackEngine";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+SkipjackEngine")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+SkipjackEngine")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+SkipjackEngine")]
impl crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine {
    ...
    pub fn DecryptBlock(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::SkipjackEngine as
    ...
    pub fn G(&mut self, k: i32, w: i32) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32, i32), i32, 2usize>("G")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::SkipjackEngine as
                    quest_hook::libil2cpp::Type > ::class(), "G", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (k, w))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn H(&mut self, k: i32, w: i32) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::SkipjackEngine as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32, i32), i32, 2usize>("H")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::SkipjackEngine as
                    quest_hook::libil2cpp::Type > ::class(), "H", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (k, w))? };
        Ok(__cordl_ret.into())
