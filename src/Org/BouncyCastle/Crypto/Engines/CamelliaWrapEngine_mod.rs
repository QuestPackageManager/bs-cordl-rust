...
for crate::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine {
    ...
    const CLASS_NAME: &'static str = "CamelliaWrapEngine";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+CamelliaWrapEngine")]
impl crate::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::CamelliaWrapEngine as
