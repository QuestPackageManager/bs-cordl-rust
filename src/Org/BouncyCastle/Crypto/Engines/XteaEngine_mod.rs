#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+XteaEngine")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+XteaEngine")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Engines::XteaEngine {
...
impl crate::Org::BouncyCastle::Crypto::Engines::XteaEngine {
    ...
    pub fn ProcessBlock(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (inBytes, inOff, outBytes, outOff))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+XteaEngine")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Engines::XteaEngine {
