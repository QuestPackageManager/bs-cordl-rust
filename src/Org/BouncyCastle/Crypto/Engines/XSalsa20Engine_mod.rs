...
for crate::Org::BouncyCastle::Crypto::Engines::XSalsa20Engine {
    ...
    const CLASS_NAME: &'static str = "XSalsa20Engine";
...
impl crate::Org::BouncyCastle::Crypto::Engines::XSalsa20Engine {
    ...
    pub fn SetKey(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::XSalsa20Engine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::XSalsa20Engine as
