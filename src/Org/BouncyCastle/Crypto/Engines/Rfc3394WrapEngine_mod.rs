...
impl crate::Org::BouncyCastle::Crypto::Engines::Rfc3394WrapEngine {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::Rfc3394WrapEngine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    bool,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::Rfc3394WrapEngine as
