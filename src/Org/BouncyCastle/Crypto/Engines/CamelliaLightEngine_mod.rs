...
impl crate::Org::BouncyCastle::Crypto::Engines::CamelliaLightEngine {
    ...
    pub fn bytes2uint(
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked((), (src, offset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn camelliaF2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (s, skey, keyoff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn camelliaFLs(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (s, fkey, keyoff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn decroldq(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (rot, ki, ioff, ko, ooff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn decroldqo32(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "lRot8",
                            2usize
                        )
                    })
            });
        let __cordl_ret: u8 = unsafe {
            cordl_method_info.invoke_unchecked(self, (v, rot))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn leftRotate(x: u32, s: i32) -> quest_hook::libil2cpp::Result<u32> {
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked((), (x, s))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "roldq",
                            5usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "sbox2",
                            1usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "sbox3",
                            1usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "sbox4",
                            1usize
                        )
                    })
            });
    ...
    pub fn uint2bytes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (word, dst, offset))?
        };
        Ok(__cordl_ret.into())
    }
}
