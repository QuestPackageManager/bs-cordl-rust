#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+IesEngine")]
#[repr(C)]
#[derive(Debug)]
pub struct IesEngine {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub agree: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBasicAgreement>,
    pub kdf: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDerivationFunction>,
    pub mac: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IMac>,
    pub cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::BufferedBlockCipher>,
    pub macBuf: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub forEncryption: bool,
    pub privParam: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::ICipherParameters>,
    pub pubParam: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::ICipherParameters>,
    pub param:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::IesParameters>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+IesEngine")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Engines::IesEngine {
...
impl crate::Org::BouncyCastle::Crypto::Engines::IesEngine {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (in_enc, inOff, inLen, z))? };
        Ok(__cordl_ret.into())
    }
    pub fn EncryptBlock(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (input, inOff, inLen, z))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (kParam, length))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
    ...
    pub fn New_BufferedBlockCipher1(
        agree: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBasicAgreement>,
        kdf: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDerivationFunction>,
        mac: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IMac>,
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::BufferedBlockCipher>,
    ...
    pub fn _ctor_BufferedBlockCipher1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (agree, kdf, mac, cipher))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IBasicAgreement_IDerivationFunction_IMac0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (agree, kdf, mac))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+IesEngine")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Engines::IesEngine {
