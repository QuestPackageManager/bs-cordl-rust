#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RC2WrapEngine")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct RC2WrapEngine {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub engine: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher>,
    pub parameters: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::ICipherParameters>,
    pub paramPlusIV:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV>,
    pub iv: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub forWrapping: bool,
    pub sr: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Security::SecureRandom>,
    ...
    for crate::Org::BouncyCastle::Crypto::Engines::RC2WrapEngine
{
    ...
    const CLASS_NAME: &'static str = "RC2WrapEngine";
...
impl crate::Org::BouncyCastle::Crypto::Engines::RC2WrapEngine {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CalculateCmsKeyChecksum", 1usize
                        )
                    })
            });
    ...
    pub fn CheckCmsKeyChecksum(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                    ), bool, 2usize>("CheckCmsKeyChecksum")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, checksum))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
