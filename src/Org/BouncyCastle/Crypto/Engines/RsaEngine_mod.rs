#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RsaEngine")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RsaEngine")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Engines::RsaEngine {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Engines";
    const CLASS_NAME: &'static str = "RsaEngine";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RsaEngine")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Engines::RsaEngine {
