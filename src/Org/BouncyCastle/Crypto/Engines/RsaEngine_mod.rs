...
impl crate::Org::BouncyCastle::Crypto::Engines::RsaEngine {
    pub fn GetInputBlockSize(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RsaEngine as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("GetInputBlockSize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Engines::RsaEngine as
