...
impl crate::Org::BouncyCastle::Crypto::Engines::RC6Engine {
    pub fn BytesToWord(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC6Engine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::RC6Engine as
