...
impl crate::Org::BouncyCastle::Crypto::Engines::RC4Engine {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Engines::RC4Engine as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    bool,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Engines::RC4Engine as
    ...
    pub fn SetKey(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (keyBytes))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
