#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Engines+RsaBlindingEngine")]
#[repr(C)]
...
pub struct RsaBlindingEngine {
    ...
    pub blindingFactor: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Engines+RsaBlindingEngine")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Engines::RsaBlindingEngine {
...
impl crate::Org::BouncyCastle::Crypto::Engines::RsaBlindingEngine {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (inBuf, inOff, inLen))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UnblindMessage", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked(self, (blindedMsg))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IRsa1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::Org::BouncyCastle::Crypto::IRsa,
                        >),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rsa))? };
        Ok(__cordl_ret.into())
    }
