#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+BufferedBlockCipher")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+BufferedBlockCipher")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::BufferedBlockCipher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "BufferedBlockCipher";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedBlockCipher")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::BufferedBlockCipher {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedBlockCipher")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::BufferedBlockCipher {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedBlockCipher")]
impl crate::Org::BouncyCastle::Crypto::BufferedBlockCipher {
    pub fn DoFinal_0(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+BufferedBlockCipher")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::BufferedBlockCipher {
