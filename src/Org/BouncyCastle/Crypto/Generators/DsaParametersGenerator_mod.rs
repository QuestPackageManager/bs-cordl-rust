...
impl crate::Org::BouncyCastle::Crypto::Generators::DsaParametersGenerator {
    ...
    pub fn Hash(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (d, input, output))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Inc(
    ...
    pub fn Init_i32_i32_SecureRandom0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_size, certainty, random))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsValidDsaStrength", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (strength))?
        };
        Ok(__cordl_ret.into())
    }
