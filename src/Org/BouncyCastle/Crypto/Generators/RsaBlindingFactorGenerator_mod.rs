#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+RsaBlindingFactorGenerator")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Generators::RsaBlindingFactorGenerator
{
    ...
    const CLASS_NAME: &'static str = "RsaBlindingFactorGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::RsaBlindingFactorGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Generators::RsaBlindingFactorGenerator {
    ...
    pub fn Init(
        &mut self,
        param: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::ICipherParameters>,
