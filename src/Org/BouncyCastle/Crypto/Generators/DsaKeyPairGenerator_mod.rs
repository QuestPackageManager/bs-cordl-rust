#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+DsaKeyPairGenerator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::DsaKeyPairGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+DsaKeyPairGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::DsaKeyPairGenerator {
