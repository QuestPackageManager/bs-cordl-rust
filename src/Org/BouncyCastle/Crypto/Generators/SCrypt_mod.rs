...
impl crate::Org::BouncyCastle::Crypto::Generators::SCrypt {
    pub fn BlockMix(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (B, X1, X2, Y, r))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Clear(
    ...
    pub fn ClearAll(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (arrays))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Generate(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "MFcrypt",
                            6usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "SMix",
                            5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (B, BOff, N, d, r))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Xor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (a, b, bOff, output))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
