#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+ElGamalParametersGenerator")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Generators::ElGamalParametersGenerator
{
    ...
    const CLASS_NAME: &'static str = "ElGamalParametersGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::ElGamalParametersGenerator {
