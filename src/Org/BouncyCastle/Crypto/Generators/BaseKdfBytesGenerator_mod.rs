...
for crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator {
    ...
    const CLASS_NAME: &'static str = "BaseKdfBytesGenerator";
...
impl crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator {
    pub fn GenerateBytes(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator
                    as quest_hook::libil2cpp::Type > ::class(), "GenerateBytes", 3usize
                )
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (counterStart, digest))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Digest(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator
                    as quest_hook::libil2cpp::Type > ::class(), "get_Digest", 0usize
                )
            });
