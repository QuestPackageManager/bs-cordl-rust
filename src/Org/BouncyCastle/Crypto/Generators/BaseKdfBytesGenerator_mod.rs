...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+BaseKdfBytesGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Generators::BaseKdfBytesGenerator {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (counterStart, digest))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Digest(
        &mut self,
