#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+DHParametersGenerator")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Generators::DHParametersGenerator
{
    ...
    const CLASS_NAME: &'static str = "DHParametersGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::DHParametersGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+DHParametersGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::DHParametersGenerator {
