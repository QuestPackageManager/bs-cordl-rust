#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+DHKeyPairGenerator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::DHKeyPairGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+DHKeyPairGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::DHKeyPairGenerator {
