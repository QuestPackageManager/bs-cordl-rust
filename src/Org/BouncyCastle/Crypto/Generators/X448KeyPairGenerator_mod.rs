#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+X448KeyPairGenerator")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator
{
    ...
    const CLASS_NAME: &'static str = "X448KeyPairGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+X448KeyPairGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+X448KeyPairGenerator")]
impl crate::Org::BouncyCastle::Crypto::Generators::X448KeyPairGenerator {
