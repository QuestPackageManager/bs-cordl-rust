#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+HkdfBytesGenerator")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct HkdfBytesGenerator {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub hMacHash: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Macs::HMac>,
    pub hashLen: i32,
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::HkdfBytesGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+HkdfBytesGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::HkdfBytesGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Generators::HkdfBytesGenerator {
    pub fn ExpandNext(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ExpandNext")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KeyParameter,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (salt, ikm))? };
        Ok(__cordl_ret.into())
    }
    pub fn GenerateBytes(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, outOff, len))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
