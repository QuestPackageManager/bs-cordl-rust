#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+Pkcs5S1ParametersGenerator")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::Pkcs5S1ParametersGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Generators::Pkcs5S1ParametersGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::ICipherParameters,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (algorithm, keySize, ivSize))? };
        Ok(__cordl_ret.into())
    }
