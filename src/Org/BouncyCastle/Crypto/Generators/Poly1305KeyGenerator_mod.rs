#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+Poly1305KeyGenerator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::Poly1305KeyGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+Poly1305KeyGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::Poly1305KeyGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Generators::Poly1305KeyGenerator {
    ...
    pub fn CheckMask(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (b, mask))? };
        Ok(__cordl_ret.into())
    }
    pub fn Clamp(
        key: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    pub fn engineInit(
        &mut self,
        param: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::KeyGenerationParameters>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
