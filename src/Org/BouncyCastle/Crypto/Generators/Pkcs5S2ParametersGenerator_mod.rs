...
impl crate::Org::BouncyCastle::Crypto::Generators::Pkcs5S2ParametersGenerator {
    pub fn F(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Generators::Pkcs5S2ParametersGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "F", 5usize
                )
            });
