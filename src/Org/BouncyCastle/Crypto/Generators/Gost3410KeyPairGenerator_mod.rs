...
for crate::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator {
    ...
    const CLASS_NAME: &'static str = "Gost3410KeyPairGenerator";
...
impl crate::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator {
    pub fn GenerateKeyPair(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Generators::Gost3410KeyPairGenerator as
