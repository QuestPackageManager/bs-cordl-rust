#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+Pkcs12ParametersGenerator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::Pkcs12ParametersGenerator {
