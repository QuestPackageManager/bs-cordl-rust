#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+NaccacheSternKeyPairGenerator"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Generators::NaccacheSternKeyPairGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (bitLength, certainty, _cordl_rand))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn permuteList(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IList> = unsafe {
            cordl_method_info.invoke_unchecked((), (arr, _cordl_rand))?
        };
        Ok(__cordl_ret.into())
    }
}
