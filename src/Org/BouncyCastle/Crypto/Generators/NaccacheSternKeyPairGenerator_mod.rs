#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+NaccacheSternKeyPairGenerator")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Generators::NaccacheSternKeyPairGenerator {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "generatePrime", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked((), (bitLength, certainty, _cordl_rand))? };
        Ok(__cordl_ret.into())
    }
    pub fn permuteList(
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::System::Collections::IList>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IList> =
            unsafe { cordl_method_info.invoke_unchecked((), (arr, _cordl_rand))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+NaccacheSternKeyPairGenerator")]
