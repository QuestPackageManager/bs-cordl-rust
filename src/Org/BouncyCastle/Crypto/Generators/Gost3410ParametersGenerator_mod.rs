#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+Gost3410ParametersGenerator"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Generators::Gost3410ParametersGenerator {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (_cordl_size, typeProcedure, random))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn procedure_A(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (x0, c, pq, _cordl_size))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn procedure_Aa(
    ...
    pub fn procedure_B(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (x0, c, pq))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn procedure_Bb(
