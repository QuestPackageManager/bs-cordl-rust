#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+OpenSslPbeParametersGenerator")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Generators::OpenSslPbeParametersGenerator {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (bytesNeeded))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Init_Il2CppArray_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (password, salt))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init_i32_0(
        &mut self,
