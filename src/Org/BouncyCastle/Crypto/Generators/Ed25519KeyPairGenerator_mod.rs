#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+Ed25519KeyPairGenerator")]
#[repr(C)]
#[derive(Debug)]
...
for crate::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Generators";
    const CLASS_NAME: &'static str = "Ed25519KeyPairGenerator";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+Ed25519KeyPairGenerator")]
impl crate::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator {
    pub fn GenerateKeyPair(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Generators::Ed25519KeyPairGenerator as
