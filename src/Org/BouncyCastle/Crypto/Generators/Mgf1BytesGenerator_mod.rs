#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+Mgf1BytesGenerator")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator
{
    ...
    const CLASS_NAME: &'static str = "Mgf1BytesGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+Mgf1BytesGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator {
