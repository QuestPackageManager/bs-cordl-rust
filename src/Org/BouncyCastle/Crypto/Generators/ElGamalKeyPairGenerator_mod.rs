#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Generators+ElGamalKeyPairGenerator")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator
{
    ...
    const CLASS_NAME: &'static str = "ElGamalKeyPairGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Generators+ElGamalKeyPairGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator {
