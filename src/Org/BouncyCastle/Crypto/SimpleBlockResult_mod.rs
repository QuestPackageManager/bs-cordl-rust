#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+SimpleBlockResult")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+SimpleBlockResult")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::SimpleBlockResult {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "SimpleBlockResult";
...
impl crate::Org::BouncyCastle::Crypto::SimpleBlockResult {
    ...
    pub fn Collect_Il2CppArray_i32_1(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (destination, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+SimpleBlockResult")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::SimpleBlockResult {
