#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IStreamCalculator")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IStreamCalculator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IStreamCalculator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "IStreamCalculator";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IStreamCalculator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IStreamCalculator {
