#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedAeadBlockCipher")]
#[repr(C)]
#[derive(Debug)]
...
for crate::Org::BouncyCastle::Crypto::BufferedAeadBlockCipher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "BufferedAeadBlockCipher";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedAeadBlockCipher")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::BufferedAeadBlockCipher {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedAeadBlockCipher")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::BufferedAeadBlockCipher {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+BufferedAeadBlockCipher")]
impl crate::Org::BouncyCastle::Crypto::BufferedAeadBlockCipher {
    pub fn DoFinal_0(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::BufferedAeadBlockCipher as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::BufferedAeadBlockCipher as
