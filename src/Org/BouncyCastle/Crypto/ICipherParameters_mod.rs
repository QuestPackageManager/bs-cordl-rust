#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+ICipherParameters")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+ICipherParameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::ICipherParameters {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "ICipherParameters";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+ICipherParameters")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::ICipherParameters {
