...
for crate::Org::BouncyCastle::Crypto::Macs::CbcBlockCipherMac {
    ...
    const CLASS_NAME: &'static str = "CbcBlockCipherMac";
...
impl crate::Org::BouncyCastle::Crypto::Macs::CbcBlockCipherMac {
    pub fn BlockUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Macs::CbcBlockCipherMac as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Macs::CbcBlockCipherMac as
    ...
    pub fn _ctor_i32_IBlockCipherPadding3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (cipher, macSizeInBits, padding))?
        };
        Ok(__cordl_ret.into())
    }
