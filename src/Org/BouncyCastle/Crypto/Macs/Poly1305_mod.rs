#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Poly1305")]
#[repr(C)]
#[derive(Debug)]
pub struct Poly1305 {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Poly1305")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Macs::Poly1305 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Macs";
    const CLASS_NAME: &'static str = "Poly1305";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Macs::Poly1305 {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Macs+Poly1305")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Macs::Poly1305 {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Macs+Poly1305")]
impl crate::Org::BouncyCastle::Crypto::Macs::Poly1305 {
    ...
    pub fn SetKey(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, nonce))? };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
        &mut self,
    ...
    pub fn mul32x32_64(i1: u32, i2: u32) -> quest_hook::libil2cpp::Result<u64> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(u32, u32), u64, 2usize>("mul32x32_64")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (i1, i2))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Poly1305")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Macs::Poly1305 {
...
impl AsRef<crate::Org::BouncyCastle::Crypto::IMac>
    for crate::Org::BouncyCastle::Crypto::Macs::Poly1305
{
