...
impl crate::Org::BouncyCastle::Crypto::Macs::CMac {
    ...
    pub fn BlockUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Macs::CMac as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Macs::CMac as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Macs::CMac as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Macs::CMac as
                    quest_hook::libil2cpp::Type > ::class(), "DoubleLu", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Macs::CMac as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Macs::CMac as
                    quest_hook::libil2cpp::Type > ::class(), "ShiftLeft", 2usize
                )
            });
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked((), (block, output))? };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
        &mut self,
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (cipher, macSizeInBits))?
        };
        Ok(__cordl_ret.into())
    }
