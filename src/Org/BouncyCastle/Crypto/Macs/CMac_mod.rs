#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+CMac")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+CMac")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Macs::CMac {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Macs";
    const CLASS_NAME: &'static str = "CMac";
...
impl crate::Org::BouncyCastle::Crypto::Macs::CMac {
    ...
    pub fn ShiftLeft(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (block, output))? };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
        &mut self,
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, macSizeInBits))? };
        Ok(__cordl_ret.into())
    }
...
impl AsRef<crate::Org::BouncyCastle::Crypto::IMac>
    for crate::Org::BouncyCastle::Crypto::Macs::CMac
{
