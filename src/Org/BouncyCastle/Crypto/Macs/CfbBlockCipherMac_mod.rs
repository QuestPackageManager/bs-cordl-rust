#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+CfbBlockCipherMac")]
#[repr(C)]
#[derive(Debug)]
pub struct CfbBlockCipherMac {
    ...
    pub bufOff: i32,
    pub cipher:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Macs::MacCFBBlockCipher>,
    pub padding:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Paddings::IBlockCipherPadding>,
    pub macSize: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+CfbBlockCipherMac")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Macs";
    const CLASS_NAME: &'static str = "CfbBlockCipherMac";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Macs+CfbBlockCipherMac")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Macs+CfbBlockCipherMac")]
impl crate::Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac {
    pub fn BlockUpdate(
        &mut self,
    ...
    pub fn New_i32_i32_2(
        ...
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (cipher, cfbBitSize, macSizeInBits))?;
        Ok(__cordl_object.into())
    }
    pub fn New_i32_i32_IBlockCipherPadding3(
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBlockCipher>,
        cfbBitSize: i32,
        macSizeInBits: i32,
        padding: quest_hook::libil2cpp::Gc<
        ...
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (cipher, cfbBitSize, macSizeInBits, padding))?;
        Ok(__cordl_object.into())
    }
    ...
    pub fn _ctor_IBlockCipherPadding1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, padding))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cipher, cfbBitSize, macSizeInBits))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_IBlockCipherPadding3(
        &mut self,
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IBlockCipher>,
        cfbBitSize: i32,
        macSizeInBits: i32,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (cipher, cfbBitSize, macSizeInBits, padding))?
        };
        Ok(__cordl_ret.into())
    }
