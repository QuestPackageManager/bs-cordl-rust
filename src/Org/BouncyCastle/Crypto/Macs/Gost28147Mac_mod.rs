#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Gost28147Mac")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Gost28147Mac")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Macs::Gost28147Mac {
...
impl crate::Org::BouncyCastle::Crypto::Macs::Gost28147Mac {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (buf, bufOff, mac))? };
        Ok(__cordl_ret.into())
    }
    pub fn DoFinal(
        &mut self,
    ...
    pub fn bytesToint(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (input, inOff))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn gost28147MacFunc(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 5usize>("gost28147MacFunc")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (workingKey, input, inOff, output, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn intTobytes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (num, output, outOff))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Gost28147Mac")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Macs::Gost28147Mac {
