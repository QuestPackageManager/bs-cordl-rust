...
impl crate::Org::BouncyCastle::Crypto::Macs::Gost28147Mac {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "CM5func",
                            3usize
                        )
                    })
            });
    ...
    pub fn bytesToint(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (input, inOff))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "gost28147MacFunc", 5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (workingKey, input, inOff, output, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn intTobytes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (num, output, outOff))?
        };
        Ok(__cordl_ret.into())
    }
}
