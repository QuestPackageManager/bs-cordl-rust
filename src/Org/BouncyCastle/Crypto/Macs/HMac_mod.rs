#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+HMac")]
#[repr(C)]
#[derive(Debug)]
pub struct HMac {
    ...
    pub digestSize: i32,
    pub blockLength: i32,
    pub ipadState: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::IMemoable>,
    pub opadState: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::IMemoable>,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+HMac")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Macs::HMac {
...
impl crate::Org::BouncyCastle::Crypto::Macs::HMac {
    ...
    pub fn XorPad(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        u8,
                    ), quest_hook::libil2cpp::Void, 3usize>("XorPad")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (pad, len, n))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
