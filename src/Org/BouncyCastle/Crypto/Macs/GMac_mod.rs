#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+GMac")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct GMac {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher>,
    pub macSizeBits: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+GMac")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Macs::GMac {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Macs";
    const CLASS_NAME: &'static str = "GMac";
...
impl crate::Org::BouncyCastle::Crypto::Macs::GMac {
    ...
    pub fn New_GcmBlockCipher0(
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher>,
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, macSizeBits))? };
        Ok(__cordl_ret.into())
    }
