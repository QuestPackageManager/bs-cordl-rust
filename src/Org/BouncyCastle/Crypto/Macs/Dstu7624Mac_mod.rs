#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Dstu7624Mac")]
#[repr(C)]
#[derive(Debug)]
pub struct Dstu7624Mac {
    ...
    pub macSize: i32,
    pub engine:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Engines::Dstu7624Engine>,
    pub blockSize: i32,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Dstu7624Mac")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac {
...
impl crate::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac {
    ...
    pub fn Xor(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                    ), quest_hook::libil2cpp::Void, 5usize>("Xor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (c, cOff, input, inOff, xorResult))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (blockSizeBits, q))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Macs+Dstu7624Mac")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Macs::Dstu7624Mac {
