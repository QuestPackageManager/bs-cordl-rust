#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IRawAgreement")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IRawAgreement")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IRawAgreement {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "IRawAgreement";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IRawAgreement")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IRawAgreement {
