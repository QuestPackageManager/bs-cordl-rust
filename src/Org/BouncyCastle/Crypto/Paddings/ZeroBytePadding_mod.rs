...
impl crate::Org::BouncyCastle::Crypto::Paddings::ZeroBytePadding {
    pub fn AddPadding(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Paddings::ZeroBytePadding as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Paddings::ZeroBytePadding as
