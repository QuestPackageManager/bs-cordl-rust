...
for crate::Org::BouncyCastle::Crypto::Paddings::X923Padding {
    ...
    const CLASS_NAME: &'static str = "X923Padding";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Paddings+X923Padding")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Paddings::X923Padding {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Paddings+X923Padding")]
impl crate::Org::BouncyCastle::Crypto::Paddings::X923Padding {
    pub fn AddPadding(
        &mut self,
        input: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        inOff: i32,
    ) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Paddings::X923Padding as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Paddings::X923Padding as
