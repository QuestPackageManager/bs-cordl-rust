#[cfg(feature = "Org+BouncyCastle+Crypto+Paddings+Pkcs7Padding")]
#[repr(C)]
#[derive(Debug)]
...
for crate::Org::BouncyCastle::Crypto::Paddings::Pkcs7Padding {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Paddings";
    const CLASS_NAME: &'static str = "Pkcs7Padding";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Paddings+Pkcs7Padding")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Paddings::Pkcs7Padding {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Paddings+Pkcs7Padding")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Paddings::Pkcs7Padding {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Paddings+Pkcs7Padding")]
impl crate::Org::BouncyCastle::Crypto::Paddings::Pkcs7Padding {
    pub fn AddPadding(
        &mut self,
        input: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        inOff: i32,
    ) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Paddings::Pkcs7Padding as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Paddings::Pkcs7Padding as
