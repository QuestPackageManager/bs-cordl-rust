#[cfg(feature = "Org+BouncyCastle+Crypto+ISigner")]
#[repr(C)]
#[derive(Debug)]
pub struct ISigner {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+ISigner")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::ISigner {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "ISigner";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+ISigner")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::ISigner {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+ISigner")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::ISigner {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+ISigner")]
impl crate::Org::BouncyCastle::Crypto::ISigner {
    pub fn BlockUpdate(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::ISigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::ISigner as
...
#[cfg(feature = "Org+BouncyCastle+Crypto+ISigner")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::ISigner {
