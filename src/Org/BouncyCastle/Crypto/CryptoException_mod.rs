...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+CryptoException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::CryptoException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "CryptoException";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+CryptoException")]
impl crate::Org::BouncyCastle::Crypto::CryptoException {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+CryptoException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::CryptoException {
