#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsCredentials")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsCredentials")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::TlsCredentials {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Tls";
    const CLASS_NAME: &'static str = "TlsCredentials";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsCredentials")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsCredentials {
