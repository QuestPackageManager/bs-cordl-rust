#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ChangeCipherSpec")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ChangeCipherSpec")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::ChangeCipherSpec {
