#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsAgreementCredentials")]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsAgreementCredentials")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials {
