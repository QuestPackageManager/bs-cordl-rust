...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsAgreementCredentials as
                    quest_hook::libil2cpp::Type > ::class(), "GenerateAgreement", 1usize
                )
            });
