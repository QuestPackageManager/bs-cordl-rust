...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow {
    ...
    pub fn ShouldDiscard(&mut self, seq: i64) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (seq))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsReplayWindow")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow {
