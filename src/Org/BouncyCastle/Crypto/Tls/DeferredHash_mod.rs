...
impl crate::Org::BouncyCastle::Crypto::Tls::DeferredHash {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CheckTrackingHash", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (hashAlgorithm))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn DoFinal(
    ...
    pub fn _ctor_u8_IDigest1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (prfHashAlgorithm, prfHash))?
        };
        Ok(__cordl_ret.into())
    }
