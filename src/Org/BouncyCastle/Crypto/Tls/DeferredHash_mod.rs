...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Crypto::Tls::DeferredHash =>
...
impl crate::Org::BouncyCastle::Crypto::Tls::DeferredHash {
    ...
    pub fn _ctor_u8_IDigest1(
        &mut self,
        prfHashAlgorithm: u8,
        prfHash: *mut crate::Org::BouncyCastle::Crypto::IDigest,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke(".ctor", (prfHashAlgorithm, prfHash))?;
        Ok(__cordl_ret)
    }
    pub fn ForkPrfHash(
        &mut self,
    ...
    pub fn CheckTrackingHash(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("CheckTrackingHash", (hashAlgorithm))?;
        Ok(__cordl_ret)
    }
    pub fn GetFinalHash(
        &mut self,
