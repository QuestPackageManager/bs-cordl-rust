...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+SignerInputBuffer+SigStream")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer_SigStream {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+SignerInputBuffer+SigStream")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::SignerInputBuffer_SigStream {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
