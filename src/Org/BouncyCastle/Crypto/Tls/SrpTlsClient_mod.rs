#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+SrpTlsClient")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+SrpTlsClient")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::SrpTlsClient {
...
impl crate::Org::BouncyCastle::Crypto::Tls::SrpTlsClient {
    ...
    pub fn _ctor_Il2CppArray_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (identity, password))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TlsCipherFactory_Il2CppArray_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cipherFactory, identity, password))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TlsCipherFactory_TlsSrpGroupVerifier_Il2CppArray_Il2CppArray2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (cipherFactory, groupVerifier, identity, password))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_RequireSrpServerExtension(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+SrpTlsClient")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::SrpTlsClient {
