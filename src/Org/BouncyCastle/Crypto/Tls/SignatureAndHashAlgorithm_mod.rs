#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+SignatureAndHashAlgorithm")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+SignatureAndHashAlgorithm")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm {
...
impl crate::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hash, signature))? };
        Ok(__cordl_ret.into())
    }
