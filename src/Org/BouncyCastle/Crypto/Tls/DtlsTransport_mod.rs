#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsTransport")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsTransport")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::DtlsTransport {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsTransport")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::DtlsTransport {
