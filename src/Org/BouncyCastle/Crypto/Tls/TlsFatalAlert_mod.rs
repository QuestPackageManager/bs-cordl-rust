...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert {
    ...
    pub fn _ctor_Exception1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (alertDescription, alertCause))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_u8_0(
