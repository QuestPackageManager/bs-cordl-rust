#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsFatalAlert")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsFatalAlert")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Tls";
    const CLASS_NAME: &'static str = "TlsFatalAlert";
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert {
    ...
    pub fn _ctor_Exception1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (u8, quest_hook::libil2cpp::Gc<crate::System::Exception>),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (alertDescription, alertCause))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_u8_0(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsFatalAlert")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsFatalAlert {
