#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsClientContext")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsClientContext")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsClientContext {
