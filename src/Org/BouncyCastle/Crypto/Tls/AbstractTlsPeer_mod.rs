#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+AbstractTlsPeer")]
#[repr(C)]
#[derive(Debug)]
pub struct AbstractTlsPeer {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub mCloseHandle:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::TlsCloseable>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+AbstractTlsPeer")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsPeer {
...
impl crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsPeer {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 4usize>("NotifyAlertRaised")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn NotifyCloseHandle(
        &mut self,
        closeHandle: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::TlsCloseable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "NotifyCloseHandle", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (closeHandle))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn NotifySecureRenegotiation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (secureRenegotiation))? };
        Ok(__cordl_ret.into())
    }
    pub fn RequiresExtendedMasterSecret(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+AbstractTlsPeer")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsPeer {
