#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ClientCertificateType")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+ClientCertificateType")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::ClientCertificateType {
