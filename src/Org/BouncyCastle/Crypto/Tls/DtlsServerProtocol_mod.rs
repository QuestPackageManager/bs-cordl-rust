#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsServerProtocol")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsServerProtocol {
    ...
    pub fn Accept(
        &mut self,
        server: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::TlsServer>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, certificateRequest))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, certificateStatus))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, newSessionTicket))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn NotifyClientCertificate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, clientCertificate))? };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessCertificateVerify(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, body, prepareFinishHash))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsServerProtocol+ServerHandshakeState")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct DtlsServerProtocol_ServerHandshakeState {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub server: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::TlsServer>,
    pub serverContext:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl>,
