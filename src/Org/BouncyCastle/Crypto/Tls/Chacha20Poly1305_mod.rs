...
impl crate::Org::BouncyCastle::Crypto::Tls::Chacha20Poly1305 {
    ...
    pub fn CalculateRecordMac(
        ...
        >,
        additionalData: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> = unsafe {
            cordl_method_info.invoke_unchecked(self, (macKey, additionalData, buf, off, len))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GenerateRecordMacKey(
        &mut self,
        cipher: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IStreamCipher>,
    ) -> quest_hook::libil2cpp::Result<
    ...
    pub fn UpdateRecordMacLength(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mac, len))? };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateRecordMacText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mac, buf, off, len))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+Chacha20Poly1305")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::Chacha20Poly1305 {
