#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSRTPUtils")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSRTPUtils")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::TlsSRTPUtils {
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsSRTPUtils {
    pub fn AddUseSrtpExtension(
        ...
        useSRTPData: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::UseSrtpData>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (extensions, useSRTPData))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateUseSrtpExtension", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (useSrtpData))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSRTPUtils")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsSRTPUtils {
