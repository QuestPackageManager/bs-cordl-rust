...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsReassembler")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::DtlsReassembler {
...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsReassembler {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 6usize>("ContributeFragment")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (msg_type, length))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DtlsReassembler")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::DtlsReassembler {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+DtlsReassembler+Range")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::DtlsReassembler_Range {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
