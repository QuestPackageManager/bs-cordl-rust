...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+DigestInputBuffer+DigStream")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer_DigStream {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+DigestInputBuffer+DigStream")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::DigestInputBuffer_DigStream {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
