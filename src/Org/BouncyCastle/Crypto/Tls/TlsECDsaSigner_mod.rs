...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsECDsaSigner")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::TlsECDsaSigner {
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsECDsaSigner {
    ...
    pub fn IsValidPublicKey(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (publicKey))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsECDsaSigner")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsECDsaSigner {
