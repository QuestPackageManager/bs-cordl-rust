#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+SupplementalDataEntry")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+SupplementalDataEntry")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::SupplementalDataEntry {
...
impl crate::Org::BouncyCastle::Crypto::Tls::SupplementalDataEntry {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (dataType, data))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Data(
        &mut self,
