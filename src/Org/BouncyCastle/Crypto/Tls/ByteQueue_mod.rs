...
impl crate::Org::BouncyCastle::Crypto::Tls::ByteQueue {
    ...
    pub fn AddData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (data, offset, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CopyTo(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (output, length))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Read(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buf, offset, len, skip))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadFrom(
    ...
    pub fn RemoveData_Il2CppArray_i32_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buf, off, len, skip))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Shrink",
                            0usize
                        )
                    })
            });
