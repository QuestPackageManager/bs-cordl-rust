...
pub struct ByteQueue {
    ...
    pub databuf: *mut quest_hook::libil2cpp::Il2CppArray<u8>,
    pub skipped: i32,
    pub available: i32,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Crypto::Tls::ByteQueue =>
...
impl crate::Org::BouncyCastle::Crypto::Tls::ByteQueue {
    ...
    pub fn AddData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("AddData", (data, offset, len))?;
        Ok(__cordl_ret.into())
    }
    pub fn CopyTo(
        &mut self,
    ...
    pub fn Read(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("Read", (buf, offset, len, skip))?;
        Ok(__cordl_ret.into())
    }
    pub fn ReadFrom(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IO::MemoryStream> = __cordl_object
    ...
    pub fn RemoveData_Il2CppArray_i32_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("RemoveData", (buf, off, len, skip))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = __cordl_object.invoke("RemoveData", (len, skip))?;
        Ok(__cordl_ret.into())
    }
    pub fn Shrink(
        &mut self,
