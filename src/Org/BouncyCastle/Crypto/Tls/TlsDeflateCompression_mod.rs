...
pub struct TlsDeflateCompression {
    ...
    pub zOut: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Utilities::Zlib::ZStream>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsDeflateCompression")]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsDeflateCompression")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression {
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression {
    ...
    pub type DeflateOutputStream =
        crate::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression_DeflateOutputStream;
    pub fn Compress(
        &mut self,
    ...
    pub fn New_i32_1(level: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression_DeflateOutputStream {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (output, z, compress))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(
