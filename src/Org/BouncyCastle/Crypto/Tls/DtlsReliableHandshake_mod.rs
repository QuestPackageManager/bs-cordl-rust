...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake {
    ...
    pub fn BackOff(&mut self, timeoutMillis: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (timeoutMillis))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CheckAll(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (inboundFlight))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PrepareInboundFlight(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (nextFlight))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SendMessage(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (msg_type, body))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteHandshakeFragment(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (message, fragment_offset, fragment_length))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteMessage(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (context, transport, timeoutMillis))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake_Message {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (message_seq, msg_type, body))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Body(
...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake_RecordLayerBuffer {
    ...
    pub fn SendToRecordLayer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (recordLayer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake_Retransmit {
    ...
    pub fn ReceivedHandshakeRecord(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (epoch, buf, off, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
