#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ServerOnlyTlsAuthentication")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::ServerOnlyTlsAuthentication {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+ServerOnlyTlsAuthentication")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::ServerOnlyTlsAuthentication {
...
impl AsMut<crate::Org::BouncyCastle::Crypto::Tls::TlsAuthentication>
    for crate::Org::BouncyCastle::Crypto::Tls::ServerOnlyTlsAuthentication
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Tls::TlsAuthentication {
        unsafe { std::mem::transmute(self) }
    }
}
