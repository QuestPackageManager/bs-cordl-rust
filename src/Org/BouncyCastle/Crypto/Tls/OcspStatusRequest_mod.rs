...
impl crate::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (responderIDList, requestExtensions))?
        };
        Ok(__cordl_ret.into())
    }
