...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::CertificateStatusRequest {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+CertificateStatusRequest")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::CertificateStatusRequest {
...
impl crate::Org::BouncyCastle::Crypto::Tls::CertificateStatusRequest {
    ...
    pub fn GetOcspStatusRequest(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn IsCorrectType(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (statusType, request))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        statusType: u8,
    ...
    pub fn Parse(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::CertificateStatusRequest>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (statusType, request))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Request(
        &mut self,
