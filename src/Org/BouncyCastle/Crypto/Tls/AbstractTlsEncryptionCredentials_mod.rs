#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+AbstractTlsEncryptionCredentials")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials {
...
impl AsRef<crate::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials>
    for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials
{
    fn as_ref(&self) -> &crate::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+AbstractTlsEncryptionCredentials")]
impl AsMut<crate::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials>
    for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials {
        unsafe { std::mem::transmute(self) }
    }
}
