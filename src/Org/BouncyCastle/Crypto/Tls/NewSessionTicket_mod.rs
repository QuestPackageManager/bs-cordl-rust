#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+NewSessionTicket")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Tls::NewSessionTicket {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ticketLifetimeHint, ticket))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Ticket(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+NewSessionTicket")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::NewSessionTicket {
