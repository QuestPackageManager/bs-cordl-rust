...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsProtocolHandler {
    ...
    pub fn _ctor_SecureRandom0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsProtocolHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsProtocolHandler as
