#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+AbstractTlsKeyExchange")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+AbstractTlsKeyExchange")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsKeyExchange {
...
impl crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsKeyExchange {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyExchange, supportedSignatureAlgorithms))?
        };
        Ok(__cordl_ret.into())
    }
