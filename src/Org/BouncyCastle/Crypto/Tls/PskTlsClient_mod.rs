...
impl crate::Org::BouncyCastle::Crypto::Tls::PskTlsClient {
    ...
    pub fn _ctor_TlsCipherFactory_TlsDHVerifier_TlsPskIdentity2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (cipherFactory, dhVerifier, pskIdentity))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TlsCipherFactory_TlsPskIdentity1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cipherFactory, pskIdentity))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_TlsPskIdentity0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pskIdentity))?
        };
        Ok(__cordl_ret.into())
    }
}
