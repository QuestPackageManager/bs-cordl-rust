...
impl crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (u8),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::HashAlgorithm as
    ...
    pub fn IsPrivate(hashAlgorithm: u8) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(u8), bool, 1usize>("IsPrivate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Tls::HashAlgorithm as
                    quest_hook::libil2cpp::Type > ::class(), "IsPrivate", 1usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked((), (hashAlgorithm))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsRecognized(hashAlgorithm: u8) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(u8), bool, 1usize>("IsRecognized")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Tls::HashAlgorithm as
                    quest_hook::libil2cpp::Type > ::class(), "IsRecognized", 1usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked((), (hashAlgorithm))? };
        Ok(__cordl_ret.into())
