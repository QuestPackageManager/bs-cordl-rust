#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HashAlgorithm")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HashAlgorithm")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm {
...
impl crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm {
    ...
    pub fn IsPrivate(hashAlgorithm: u8) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (hashAlgorithm))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HashAlgorithm")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::HashAlgorithm {
