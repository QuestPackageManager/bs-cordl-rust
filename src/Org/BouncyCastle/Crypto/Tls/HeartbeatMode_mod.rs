#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HeartbeatMode")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HeartbeatMode")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMode {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Tls";
    const CLASS_NAME: &'static str = "HeartbeatMode";
...
impl crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMode {
    ...
    pub fn IsValid(heartbeatMode: u8) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (heartbeatMode))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HeartbeatMode")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMode {
