#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSrpLoginParameters")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsSrpLoginParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters {
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (group, verifier, salt))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Group(
        &mut self,
