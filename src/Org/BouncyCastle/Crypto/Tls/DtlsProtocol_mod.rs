...
impl crate::Org::BouncyCastle::Crypto::Tls::DtlsProtocol {
    pub fn ApplyMaxFragmentLengthExtension(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (recordLayer, maxFragmentLength))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ProcessFinished", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (body, expected_verify_data))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ValidateSelectedCipherSuite(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (selectedCipherSuite, alertDescription))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
