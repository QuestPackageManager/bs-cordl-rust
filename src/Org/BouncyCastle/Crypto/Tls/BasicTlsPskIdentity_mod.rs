...
for crate::Org::BouncyCastle::Crypto::Tls::BasicTlsPskIdentity {
    ...
    const CLASS_NAME: &'static str = "BasicTlsPskIdentity";
...
impl crate::Org::BouncyCastle::Crypto::Tls::BasicTlsPskIdentity {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::BasicTlsPskIdentity as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::BasicTlsPskIdentity as
    ...
    pub fn _ctor_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (identity, psk))?
        };
        Ok(__cordl_ret.into())
    }
