...
#[repr(C)]
#[derive(Debug)]
pub struct TlsSignerCredentials {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsSignerCredentials")]
unsafe impl quest_hook::libil2cpp::Type
for crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Tls";
    const CLASS_NAME: &'static str = "TlsSignerCredentials";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsSignerCredentials")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsSignerCredentials")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials {
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials as
                    quest_hook::libil2cpp::Type > ::class(),
                    "GenerateCertificateSignature", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials as
                    quest_hook::libil2cpp::Type > ::class(),
                    "get_SignatureAndHashAlgorithm", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm,
