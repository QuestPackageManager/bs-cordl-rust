#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSignerCredentials")]
#[derive(Debug)]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials {
    ...
    pub fn get_SignatureAndHashAlgorithm(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_SignatureAndHashAlgorithm")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
