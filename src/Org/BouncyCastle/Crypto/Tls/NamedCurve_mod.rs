#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+NamedCurve")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+NamedCurve")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::NamedCurve {
...
impl crate::Org::BouncyCastle::Crypto::Tls::NamedCurve {
    ...
    pub fn IsValid(namedCurve: i32) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (namedCurve))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RefersToASpecificNamedCurve(namedCurve: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+NamedCurve")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::NamedCurve {
