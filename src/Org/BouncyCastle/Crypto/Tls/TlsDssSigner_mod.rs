...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsDssSigner {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsDssSigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (u8),
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IDsa>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsDssSigner as
