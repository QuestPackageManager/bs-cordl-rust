#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+UseSrtpData")]
#[repr(C)]
#[derive(Debug)]
pub struct UseSrtpData {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub mProtectionProfiles: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>>,
    pub mMki: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+UseSrtpData")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::UseSrtpData {
...
impl crate::Org::BouncyCastle::Crypto::Tls::UseSrtpData {
    pub fn New(
        protectionProfiles: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (protectionProfiles, mki))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Mki(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "get_Mki",
                            0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+UseSrtpData")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::UseSrtpData {
