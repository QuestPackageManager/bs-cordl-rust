#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+CipherSuite")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+CipherSuite")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::CipherSuite {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Tls";
    const CLASS_NAME: &'static str = "CipherSuite";
...
impl crate::Org::BouncyCastle::Crypto::Tls::CipherSuite {
    ...
    pub fn IsScsv(cipherSuite: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32), bool, 1usize>("IsScsv")
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+CipherSuite")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::CipherSuite {
