...
impl crate::Org::BouncyCastle::Crypto::Tls::CipherSuite {
    ...
    pub fn IsScsv(cipherSuite: i32) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::CipherSuite as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(i32), bool, 1usize>("IsScsv")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Tls::CipherSuite as
                    quest_hook::libil2cpp::Type > ::class(), "IsScsv", 1usize
                )
            });
