...
for crate::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager {
    ...
    const CLASS_NAME: &'static str = "TlsSrpIdentityManager";
...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager {
    pub fn GetLoginParameters(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager as
