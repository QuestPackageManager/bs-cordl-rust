#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSrpIdentityManager")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+TlsSrpIdentityManager")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager {
