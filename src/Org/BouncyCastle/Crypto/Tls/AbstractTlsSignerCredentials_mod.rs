#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+AbstractTlsSignerCredentials")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsSignerCredentials {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+AbstractTlsSignerCredentials")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsSignerCredentials {
...
impl AsMut<crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials>
    for crate::Org::BouncyCastle::Crypto::Tls::AbstractTlsSignerCredentials
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials {
        unsafe { std::mem::transmute(self) }
    }
}
