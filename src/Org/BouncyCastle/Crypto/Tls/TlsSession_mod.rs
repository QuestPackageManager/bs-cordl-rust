#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSession")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSession")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::TlsSession {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Tls";
    const CLASS_NAME: &'static str = "TlsSession";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsSession")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsSession {
