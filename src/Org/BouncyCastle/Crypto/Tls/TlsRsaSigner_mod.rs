...
impl crate::Org::BouncyCastle::Crypto::Tls::TlsRsaSigner {
    pub fn CreateRsaImpl(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::TlsRsaSigner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::TlsRsaSigner as
                    quest_hook::libil2cpp::Type > ::class(), "CreateRsaImpl", 0usize
                )
            });
