...
impl crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage {
    ...
    pub fn Encode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (context, output))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        _cordl_type: u8,
    ...
    pub fn Parse(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, payload, paddingLength))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+HeartbeatMessage")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+HeartbeatMessage+PayloadBuffer")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage_PayloadBuffer {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Tls+HeartbeatMessage+PayloadBuffer")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Tls::HeartbeatMessage_PayloadBuffer {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ToTruncatedByteArray", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (payloadLength))? };
        Ok(__cordl_ret.into())
    }
