#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+CertificateStatus")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Tls::CertificateStatus {
    ...
    pub fn IsCorrectType(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (statusType, response))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        statusType: u8,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (statusType, response))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Response(
        &mut self,
