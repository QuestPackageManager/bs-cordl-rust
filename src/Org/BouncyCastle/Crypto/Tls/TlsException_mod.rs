#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsException")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::TlsException {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+TlsException")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::TlsException {
