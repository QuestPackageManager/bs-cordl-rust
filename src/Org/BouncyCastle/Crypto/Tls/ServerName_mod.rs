#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ServerName")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ServerName")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Tls::ServerName {
...
impl crate::Org::BouncyCastle::Crypto::Tls::ServerName {
    ...
    pub fn IsCorrectType(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (nameType, name))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        nameType: u8,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nameType, name))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Name(
        &mut self,
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+ServerName")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::ServerName {
