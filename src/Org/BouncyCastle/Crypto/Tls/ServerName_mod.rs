...
for crate::Org::BouncyCastle::Crypto::Tls::ServerName {
    ...
    const CLASS_NAME: &'static str = "ServerName";
...
impl crate::Org::BouncyCastle::Crypto::Tls::ServerName {
    pub fn Encode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::ServerName as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::ServerName as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::ServerName as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Tls::ServerName as
                    quest_hook::libil2cpp::Type > ::class(), "GetHostName", 0usize
                )
            });
    ...
    pub fn IsCorrectType(
        ...
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked((), (nameType, name))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (nameType, name))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Name(
    ...
    pub fn get_NameType(&mut self) -> quest_hook::libil2cpp::Result<u8> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::ServerName as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), u8, 0usize>("get_NameType")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Tls::ServerName as
                    quest_hook::libil2cpp::Type > ::class(), "get_NameType", 0usize
                )
            });
