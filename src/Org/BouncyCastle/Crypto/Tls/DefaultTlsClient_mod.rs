...
for crate::Org::BouncyCastle::Crypto::Tls::DefaultTlsClient {
    ...
    const CLASS_NAME: &'static str = "DefaultTlsClient";
...
impl crate::Org::BouncyCastle::Crypto::Tls::DefaultTlsClient {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Tls::DefaultTlsClient as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Tls::DefaultTlsClient as
    ...
    pub fn _ctor_TlsCipherFactory_TlsDHVerifier2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (cipherFactory, dhVerifier))?
        };
        Ok(__cordl_ret.into())
    }
}
