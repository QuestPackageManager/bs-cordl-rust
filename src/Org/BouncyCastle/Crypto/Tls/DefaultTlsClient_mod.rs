#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DefaultTlsClient")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Tls::DefaultTlsClient {
    ...
    pub fn _ctor_TlsCipherFactory_TlsDHVerifier2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipherFactory, dhVerifier))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Tls+DefaultTlsClient")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Tls::DefaultTlsClient {
