#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+ECDHBasicAgreement")]
#[repr(C)]
#[derive(Debug)]
pub struct ECDHBasicAgreement {
...
for crate::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Agreement";
    const CLASS_NAME: &'static str = "ECDHBasicAgreement";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+ECDHBasicAgreement")]
impl crate::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement as
                    quest_hook::libil2cpp::Type > ::class(), "GetFieldSize", 0usize
                )
            });
