...
pub struct DHAgreement {
    ...
    >,
    pub privateValue: quest_hook::libil2cpp::Gc<
...
for crate::Org::BouncyCastle::Crypto::Agreement::DHAgreement {
    ...
    const CLASS_NAME: &'static str = "DHAgreement";
...
impl crate::Org::BouncyCastle::Crypto::Agreement::DHAgreement {
    pub fn CalculateAgreement(
        ...
        >,
        message: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::DHAgreement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Agreement::DHAgreement as
                    quest_hook::libil2cpp::Type > ::class(), "CalculateAgreement", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
        > = unsafe { method.invoke_unchecked(self, (_cordl_pub, message))? };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::DHAgreement as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Agreement::DHAgreement as
                    quest_hook::libil2cpp::Type > ::class(), "CalculateMessage", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
