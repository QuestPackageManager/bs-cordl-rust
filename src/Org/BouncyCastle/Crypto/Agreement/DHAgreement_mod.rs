#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Agreement+DHAgreement")]
#[repr(C)]
...
pub struct DHAgreement {
    ...
    pub privateValue: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CalculateAgreement", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_pub, message))? };
        Ok(__cordl_ret.into())
    }
