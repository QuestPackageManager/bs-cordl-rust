#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Agreement+X25519Agreement")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+X25519Agreement")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Agreement::X25519Agreement {
...
impl crate::Org::BouncyCastle::Crypto::Agreement::X25519Agreement {
    pub fn CalculateAgreement(
        &mut self,
        publicKey: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::ICipherParameters>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("CalculateAgreement")
                    .unwrap_or_else(|e| {
                        panic!(
