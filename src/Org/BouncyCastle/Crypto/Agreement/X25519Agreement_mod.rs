...
for crate::Org::BouncyCastle::Crypto::Agreement::X25519Agreement {
    ...
    const CLASS_NAME: &'static str = "X25519Agreement";
...
impl crate::Org::BouncyCastle::Crypto::Agreement::X25519Agreement {
    pub fn CalculateAgreement(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::X25519Agreement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Agreement::X25519Agreement as
                    quest_hook::libil2cpp::Type > ::class(), "CalculateAgreement", 3usize
                )
            });
    ...
    pub fn get_AgreementSize(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::X25519Agreement as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_AgreementSize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Agreement::X25519Agreement as
                    quest_hook::libil2cpp::Type > ::class(), "get_AgreementSize", 0usize
                )
            });
