...
for crate::Org::BouncyCastle::Crypto::Agreement::X448Agreement {
    ...
    const CLASS_NAME: &'static str = "X448Agreement";
...
impl crate::Org::BouncyCastle::Crypto::Agreement::X448Agreement {
    pub fn CalculateAgreement(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::X448Agreement as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Agreement::X448Agreement as
