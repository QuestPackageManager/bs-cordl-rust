#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Agreement+ECDHCBasicAgreement")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Agreement::ECDHCBasicAgreement
{
    ...
    const CLASS_NAME: &'static str = "ECDHCBasicAgreement";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Agreement::ECDHCBasicAgreement {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+ECDHCBasicAgreement")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Agreement::ECDHCBasicAgreement {
