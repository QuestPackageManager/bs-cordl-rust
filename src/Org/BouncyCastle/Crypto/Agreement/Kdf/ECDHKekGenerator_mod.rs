    ...
    for crate::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator
{
    ...
    const CLASS_NAME: &'static str = "ECDHKekGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+Kdf+ECDHKekGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator {
    pub fn GenerateBytes(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (outBytes, outOff, len))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
