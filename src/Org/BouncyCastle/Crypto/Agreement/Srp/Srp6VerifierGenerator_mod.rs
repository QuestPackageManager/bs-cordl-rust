#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Agreement+Srp+Srp6VerifierGenerator")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator
{
    ...
    const CLASS_NAME: &'static str = "Srp6VerifierGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator {
...
impl crate::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator {
    ...
    pub fn Init_BigInteger_BigInteger_IDigest0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (N, g, digest))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init_Srp6GroupParameters_IDigest1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (group, digest))? };
        Ok(__cordl_ret.into())
    }
