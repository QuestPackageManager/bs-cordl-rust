#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Agreement+JPake+JPakeRound3Payload")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+JPake+JPakeRound3Payload")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload {
...
impl crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (participantId, magTag))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_MacTag(
        &mut self,
