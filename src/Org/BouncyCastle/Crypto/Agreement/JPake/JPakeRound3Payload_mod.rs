...
for crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload {
    ...
    const CLASS_NAME: &'static str = "JPakeRound3Payload";
...
impl crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (participantId, magTag))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_MacTag(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound3Payload as
                    quest_hook::libil2cpp::Type > ::class(), "get_MacTag", 0usize
                )
            });
