#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Agreement+JPake+JPakeRound2Payload")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Agreement+JPake+JPakeRound2Payload")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload {
...
impl crate::Org::BouncyCastle::Crypto::Agreement::JPake::JPakeRound2Payload {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (participantId, a, knowledgeProofForX2s))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_A(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
                        >,
                    >, 0usize>("get_KnowledgeProofForX2s")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
