#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+BufferedIesCipher")]
#[repr(C)]
#[derive(Debug)]
pub struct BufferedIesCipher {
    __cordl_parent: crate::Org::BouncyCastle::Crypto::BufferedCipherBase,
    pub engine: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Engines::IesEngine>,
    pub forEncryption: bool,
    pub buffer: quest_hook::libil2cpp::Gc<crate::System::IO::MemoryStream>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+BufferedIesCipher")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::BufferedIesCipher {
...
impl crate::Org::BouncyCastle::Crypto::BufferedIesCipher {
    ...
    pub fn New(
        engine: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Engines::IesEngine>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (engine))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+BufferedIesCipher")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::BufferedIesCipher {
