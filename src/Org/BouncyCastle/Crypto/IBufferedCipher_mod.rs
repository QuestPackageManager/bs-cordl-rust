#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IBufferedCipher")]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IBufferedCipher")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::IBufferedCipher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto";
    const CLASS_NAME: &'static str = "IBufferedCipher";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IBufferedCipher")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::IBufferedCipher {
