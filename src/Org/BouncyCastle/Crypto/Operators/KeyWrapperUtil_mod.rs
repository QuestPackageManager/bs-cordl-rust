...
for crate::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil {
    ...
    const CLASS_NAME: &'static str = "KeyWrapperUtil";
...
impl crate::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil as
                    quest_hook::libil2cpp::Type > ::class(), "UnwrapperForName", 2usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Operators::KeyWrapperUtil as
                    quest_hook::libil2cpp::Type > ::class(), "WrapperForName", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
