#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Operators+KeyWrapperUtil")]
#[repr(C)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WrapperForName", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IKeyWrapper> =
            unsafe { cordl_method_info.invoke_unchecked((), (algorithm, parameters))? };
        Ok(__cordl_ret.into())
    }
