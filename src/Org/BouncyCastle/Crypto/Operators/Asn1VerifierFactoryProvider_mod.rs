#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Operators+Asn1VerifierFactoryProvider")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactoryProvider {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateVerifierFactory", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::IVerifierFactory,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (algorithmDetails))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl AsMut<crate::Org::BouncyCastle::Crypto::IVerifierFactoryProvider>
    for crate::Org::BouncyCastle::Crypto::Operators::Asn1VerifierFactoryProvider
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::IVerifierFactoryProvider {
        unsafe { std::mem::transmute(self) }
    }
}
