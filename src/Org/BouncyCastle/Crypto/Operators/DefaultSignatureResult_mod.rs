#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Operators+DefaultSignatureResult")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Operators::DefaultSignatureResult {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Operators+DefaultSignatureResult")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Operators::DefaultSignatureResult {
...
impl crate::Org::BouncyCastle::Crypto::Operators::DefaultSignatureResult {
    ...
    pub fn Collect_Il2CppArray_i32_1(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (sig, sigOff))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
