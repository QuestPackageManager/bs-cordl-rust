...
impl crate::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Operators::Asn1SignatureFactory as
    ...
    pub fn _ctor_Il2CppString_AsymmetricKeyParameter0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (algorithm, privateKey))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_SecureRandom1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (algorithm, privateKey, random))?
        };
        Ok(__cordl_ret.into())
    }
