...
#[cfg(feature = "Org+BouncyCastle+Crypto+Operators+DefaultVerifierResult")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IVerifier>>
for crate::Org::BouncyCastle::Crypto::Operators::DefaultVerifierResult {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IVerifier> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Operators+DefaultVerifierResult")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IVerifier>>
for crate::Org::BouncyCastle::Crypto::Operators::DefaultVerifierResult {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::IVerifier> {
        unsafe { std::mem::transmute(self) }
    }
}
