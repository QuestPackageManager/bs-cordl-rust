#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Operators+DefaultVerifierResult")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Operators::DefaultVerifierResult {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Operators+DefaultVerifierResult")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Operators::DefaultVerifierResult {
...
impl crate::Org::BouncyCastle::Crypto::Operators::DefaultVerifierResult {
    ...
    pub fn IsVerified_i32_i32_1(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (sig, sigOff, sigLen))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
