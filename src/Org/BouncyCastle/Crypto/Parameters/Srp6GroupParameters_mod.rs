...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+Srp6GroupParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (N, g))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
        &mut self,
