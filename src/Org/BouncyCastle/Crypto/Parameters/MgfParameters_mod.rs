...
for crate::Org::BouncyCastle::Crypto::Parameters::MgfParameters {
    ...
    const CLASS_NAME: &'static str = "MgfParameters";
...
impl crate::Org::BouncyCastle::Crypto::Parameters::MgfParameters {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::MgfParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Parameters::MgfParameters as
    ...
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (seed, off, len))?
        };
        Ok(__cordl_ret.into())
    }
}
