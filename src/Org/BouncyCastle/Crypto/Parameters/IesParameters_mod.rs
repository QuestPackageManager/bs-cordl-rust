#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+IesParameters")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::IesParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (derivation, encoding, macKeySize))?
        };
        Ok(__cordl_ret.into())
    }
