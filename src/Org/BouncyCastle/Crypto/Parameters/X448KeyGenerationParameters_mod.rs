#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+X448KeyGenerationParameters")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::X448KeyGenerationParameters
{
    ...
    const CLASS_NAME: &'static str = "X448KeyGenerationParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::X448KeyGenerationParameters {
