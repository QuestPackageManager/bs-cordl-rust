...
impl crate::Org::BouncyCastle::Crypto::Parameters::ECNamedDomainParameters {
    ...
    pub fn _ctor_ECCurve_ECPoint_BigInteger2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, curve, g, n))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECCurve_ECPoint_BigInteger_BigInteger3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, curve, g, n, h))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECCurve_ECPoint_BigInteger_BigInteger_Il2CppArray4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, curve, g, n, h, seed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECDomainParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, dp))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_X9ECParameters1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, x9))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Name(
