#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DHPrivateKeyParameters")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters
{
    ...
    const CLASS_NAME: &'static str = "DHPrivateKeyParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+DHPrivateKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters {
    ...
    pub fn _ctor_BigInteger_DHParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, parameters, algorithmOid))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_X(
        &mut self,
