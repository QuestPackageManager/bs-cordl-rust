...
impl crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters {
    pub fn Equals_DHPrivateKeyParameters1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
    ...
    pub fn _ctor_BigInteger_DHParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (x, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (x, parameters, algorithmOid))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_X(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters
                    as quest_hook::libil2cpp::Type > ::class(), "get_X", 0usize
                )
            });
