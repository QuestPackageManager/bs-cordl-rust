#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DsaParameterGenerationParameters")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DsaParameterGenerationParameters {
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (L, N, certainty, random, usageIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_i32_SecureRandom0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (L, N, certainty, random))? };
        Ok(__cordl_ret.into())
    }
