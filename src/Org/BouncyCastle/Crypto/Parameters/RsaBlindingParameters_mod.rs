...
impl crate::Org::BouncyCastle::Crypto::Parameters::RsaBlindingParameters {
    pub fn New(
        publicKey: *mut crate::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters,
        blindingFactor: *mut crate::Org::BouncyCastle::Math::BigInteger,
