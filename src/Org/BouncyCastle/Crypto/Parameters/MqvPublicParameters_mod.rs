#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+MqvPublicParameters")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::MqvPublicParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+MqvPublicParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::MqvPublicParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::MqvPublicParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (staticPublicKey, ephemeralPublicKey))?
        };
        Ok(__cordl_ret.into())
    }
