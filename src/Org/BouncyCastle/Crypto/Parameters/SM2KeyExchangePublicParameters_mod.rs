...
for crate::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters {
    ...
    const CLASS_NAME: &'static str = "SM2KeyExchangePublicParameters";
...
impl crate::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters
                    as quest_hook::libil2cpp::Type > ::class(), "get_EphemeralPublicKey",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters
                    as quest_hook::libil2cpp::Type > ::class(), "get_StaticPublicKey",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
