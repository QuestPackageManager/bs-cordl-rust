#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+RsaPrivateCrtKeyParameters"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::RsaPrivateCrtKeyParameters {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ValidateValue", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (x, name, desc))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_RsaPrivateKeyStructure1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rsaPrivateKey))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_DP(
