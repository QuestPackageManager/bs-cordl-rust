#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+SM2KeyExchangePrivateParameters")]
#[repr(C)]
#[derive(Debug)]
pub struct SM2KeyExchangePrivateParameters {
    ...
    >,
    pub mStaticPublicPoint: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::EC::ECPoint>,
    pub mEphemeralPrivateKey: quest_hook::libil2cpp::Gc<
        crate::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters,
    >,
    pub mEphemeralPublicPoint:
...
impl crate::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePrivateParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (initiator, staticPrivateKey, ephemeralPrivateKey))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters,
                    >, 0usize>("get_EphemeralPrivateKey")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
