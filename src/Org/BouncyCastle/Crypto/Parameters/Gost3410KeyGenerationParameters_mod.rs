#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+Gost3410KeyGenerationParameters")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct Gost3410KeyGenerationParameters {
    __cordl_parent: crate::Org::BouncyCastle::Crypto::KeyGenerationParameters,
    pub parameters:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters>,
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyGenerationParameters
{
    ...
    const CLASS_NAME: &'static str = "Gost3410KeyGenerationParameters";
...
impl crate::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyGenerationParameters {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "LookupParameters", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters,
        > = unsafe { cordl_method_info.invoke_unchecked((), (publicKeyParamSet))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (random, publicKeyParamSet))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Gost3410Parameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (random, parameters))? };
        Ok(__cordl_ret.into())
    }
