...
pub struct ElGamalKeyParameters {
    ...
    pub parameters:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+ElGamalKeyParameters")]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters
{
    ...
    const CLASS_NAME: &'static str = "ElGamalKeyParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ElGamalKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters {
