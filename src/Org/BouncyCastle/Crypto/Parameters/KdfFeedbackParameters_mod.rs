...
impl crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters {
    pub fn CreateWithCounter(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters,
        > = unsafe { method.invoke_unchecked((), (ki, iv, fixedInputData, r))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters,
        > = unsafe { method.invoke_unchecked((), (ki, iv, fixedInputData))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        ki: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ki, iv, fixedInputData, r, useCounter))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters
                    as quest_hook::libil2cpp::Type > ::class(), "get_Iv", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
