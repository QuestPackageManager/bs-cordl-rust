    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters
{
    ...
    const CLASS_NAME: &'static str = "KdfFeedbackParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+KdfFeedbackParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters,
        > = unsafe { cordl_method_info.invoke_unchecked((), (ki, iv, fixedInputData, r))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::KdfFeedbackParameters,
        > = unsafe { cordl_method_info.invoke_unchecked((), (ki, iv, fixedInputData))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        ki: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ki, iv, fixedInputData, r, useCounter))?
        };
        Ok(__cordl_ret.into())
    }
