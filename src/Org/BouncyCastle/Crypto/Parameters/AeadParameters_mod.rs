...
pub struct AeadParameters {
    ...
    pub associatedText: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub nonce: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub key: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::KeyParameter>,
    pub macSize: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+AeadParameters")]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+AeadParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::AeadParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::AeadParameters {
    ...
    pub fn _ctor_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, macSize, nonce, associatedText))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_KeyParameter_i32_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, macSize, nonce))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Key(
        &mut self,
    ...
    pub fn get_MacSize(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_MacSize")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
