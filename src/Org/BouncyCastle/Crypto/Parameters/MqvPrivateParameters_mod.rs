...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::MqvPrivateParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+MqvPrivateParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::MqvPrivateParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::MqvPrivateParameters {
    ...
    pub fn _ctor_ECPrivateKeyParameters_ECPrivateKeyParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (staticPrivateKey, ephemeralPrivateKey))?
        };
        Ok(__cordl_ret.into())
    }
