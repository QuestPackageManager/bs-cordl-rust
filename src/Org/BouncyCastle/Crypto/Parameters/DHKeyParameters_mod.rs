#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DHKeyParameters")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+DHKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::DHKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DHKeyParameters {
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isPrivate, parameters, algorithmOid))?
        };
        Ok(__cordl_ret.into())
    }
