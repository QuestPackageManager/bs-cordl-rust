#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+ECKeyParameters")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ECKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ECKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ECKeyParameters {
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, isPrivate, publicKeyParamSet))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECDomainParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, isPrivate, parameters))?
        };
        Ok(__cordl_ret.into())
    }
