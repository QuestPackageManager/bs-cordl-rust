#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+NaccacheSternPrivateKeyParameters")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::NaccacheSternPrivateKeyParameters {
    ...
    pub fn _ctor_ArrayList0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (g, n, lowerSigmaBound, smallPrimes, phiN))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_IList1(
