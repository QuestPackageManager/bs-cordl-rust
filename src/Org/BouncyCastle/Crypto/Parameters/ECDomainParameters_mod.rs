...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ECDomainParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters {
    ...
    pub fn _ctor_X9ECParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (x9))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Curve(
        &mut self,
