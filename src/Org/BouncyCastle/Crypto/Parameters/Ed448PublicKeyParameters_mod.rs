#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+Ed448PublicKeyParameters")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters
{
    ...
    const CLASS_NAME: &'static str = "Ed448PublicKeyParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+Ed448PublicKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters {
