#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+Ed25519PrivateKeyParameters")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters
{
    ...
    const CLASS_NAME: &'static str = "Ed25519PrivateKeyParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters {
    ...
    pub fn Sign_Il2CppArray_i32_Il2CppArray_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (algorithm, ctx, msg, msgOff, msgLen, sig, sigOff))?
        };
        Ok(__cordl_ret.into())
    }
