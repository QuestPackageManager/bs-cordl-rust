#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DsaPrivateKeyParameters")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::DsaPrivateKeyParameters
{
    ...
    const CLASS_NAME: &'static str = "DsaPrivateKeyParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::DsaPrivateKeyParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+DsaPrivateKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::DsaPrivateKeyParameters {
