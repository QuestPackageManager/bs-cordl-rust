#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+ParametersWithIV")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV
{
    ...
    const CLASS_NAME: &'static str = "ParametersWithIV";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ParametersWithIV")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV {
    ...
    pub fn _ctor_ICipherParameters_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, iv, ivOff, ivLen))? };
        Ok(__cordl_ret.into())
    }
