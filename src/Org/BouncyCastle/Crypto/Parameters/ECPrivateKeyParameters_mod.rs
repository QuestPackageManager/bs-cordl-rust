...
impl crate::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters {
    ...
    pub fn _ctor_BigInteger_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (d, publicKeyParamSet))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_BigInteger_ECDomainParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (d, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_BigInteger_DerObjectIdentifier3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, d, publicKeyParamSet))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_BigInteger_ECDomainParameters2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (algorithm, d, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_D(
