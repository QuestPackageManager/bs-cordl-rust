...
impl crate::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters {
    pub fn Equals_ECPrivateKeyParameters1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters
                    as quest_hook::libil2cpp::Type > ::class(), "get_D", 0usize
                )
            });
