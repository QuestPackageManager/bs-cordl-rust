#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+ParametersWithID")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithID
{
    ...
    const CLASS_NAME: &'static str = "ParametersWithID";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ParametersWithID")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithID {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithID {
    ...
    pub fn _ctor_ICipherParameters_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, id))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, id, idOff, idLen))? };
        Ok(__cordl_ret.into())
    }
