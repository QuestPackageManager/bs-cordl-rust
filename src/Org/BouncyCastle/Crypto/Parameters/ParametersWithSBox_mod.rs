#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+ParametersWithSBox")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSBox
{
    ...
    const CLASS_NAME: &'static str = "ParametersWithSBox";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSBox {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ParametersWithSBox")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSBox {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSBox {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, sBox))? };
        Ok(__cordl_ret.into())
    }
