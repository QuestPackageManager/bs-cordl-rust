#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+NaccacheSternKeyParameters")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (privateKey, g, n, lowerSigmaBound))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
