#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DHPublicKeyParameters")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+DHPublicKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked((), (y, dhParams))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_BigInteger_DHParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (y, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (y, parameters, algorithmOid))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Y(
        &mut self,
