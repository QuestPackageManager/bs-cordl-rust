#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DesParameters")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DesParameters {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("SetOddParity")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetOddParity_u8_0(b: u8) -> quest_hook::libil2cpp::Result<u8> {
        ...
        let __cordl_ret: u8 = unsafe { cordl_method_info.invoke_unchecked((), (b))? };
        Ok(__cordl_ret.into())
    }
