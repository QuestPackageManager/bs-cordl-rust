...
impl crate::Org::BouncyCastle::Crypto::Parameters::DesParameters {
    ...
    pub fn IsWeakKey_Il2CppArray1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DesParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Parameters::DesParameters as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DesParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Parameters::DesParameters as
                    quest_hook::libil2cpp::Type > ::class(), "SetOddParity", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DesParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Parameters::DesParameters as
                    quest_hook::libil2cpp::Type > ::class(), "SetOddParity", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (bytes, off, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetOddParity_u8_0(b: u8) -> quest_hook::libil2cpp::Result<u8> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DesParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(u8), u8, 1usize>("SetOddParity")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Parameters::DesParameters as
        ...
        let __cordl_ret: u8 = unsafe { method.invoke_unchecked((), (b))? };
        Ok(__cordl_ret.into())
    }
