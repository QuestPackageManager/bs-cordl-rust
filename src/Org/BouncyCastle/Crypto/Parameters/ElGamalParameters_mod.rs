#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+ElGamalParameters")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters
{
    ...
    const CLASS_NAME: &'static str = "ElGamalParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ElGamalParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters {
