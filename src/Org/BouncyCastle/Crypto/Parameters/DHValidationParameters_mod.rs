#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DHValidationParameters")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::DHValidationParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+DHValidationParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::DHValidationParameters {
