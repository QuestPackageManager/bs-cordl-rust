#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+KdfCounterParameters")]
#[repr(C)]
#[derive(Debug)]
pub struct KdfCounterParameters {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub ki: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub fixedInputDataCounterPrefix:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub fixedInputDataCounterSuffix:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub r: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+KdfCounterParameters")]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::KdfCounterParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+KdfCounterParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::KdfCounterParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::KdfCounterParameters {
    ...
    pub fn _ctor_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ki, fixedInputDataCounterSuffix, r))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_FixedInputDataCounterPrefix", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_FixedInputDataCounterSuffix", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
