#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+RC2Parameters")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::RC2Parameters {
    ...
    pub fn _ctor_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, bits))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, keyOff, keyLen))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_i32_3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, keyOff, keyLen, bits))?
        };
        Ok(__cordl_ret.into())
    }
