...
impl crate::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters {
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (publicKeyParamSet, random))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_ECDomainParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (domainParameters, random))?
        };
        Ok(__cordl_ret.into())
    }
