#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+Ed448PrivateKeyParameters")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::Ed448PrivateKeyParameters {
