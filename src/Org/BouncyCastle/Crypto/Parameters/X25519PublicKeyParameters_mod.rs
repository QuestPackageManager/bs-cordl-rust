...
#[repr(C)]
#[derive(Debug)]
pub struct X25519PublicKeyParameters {
...
for crate::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Parameters";
    const CLASS_NAME: &'static str = "X25519PublicKeyParameters";
...
impl crate::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters {
    pub fn Encode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters as
