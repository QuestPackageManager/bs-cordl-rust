#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+X25519PublicKeyParameters")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters {
