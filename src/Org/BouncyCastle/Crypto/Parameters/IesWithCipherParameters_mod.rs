...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+IesWithCipherParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (derivation, encoding, macKeySize, cipherKeySize))?
        };
        Ok(__cordl_ret.into())
    }
