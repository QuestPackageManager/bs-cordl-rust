...
impl crate::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Parameters::IesWithCipherParameters as
                    quest_hook::libil2cpp::Type > ::class(), "get_CipherKeySize", 0usize
                )
            });
