#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+RsaKeyGenerationParameters")]
#[repr(C)]
#[derive(Debug)]
pub struct RsaKeyGenerationParameters {
    __cordl_parent: crate::Org::BouncyCastle::Crypto::KeyGenerationParameters,
    pub publicExponent: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
    pub certainty: i32,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+RsaKeyGenerationParameters")]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (publicExponent, random, strength, certainty))?
        };
        Ok(__cordl_ret.into())
    }
