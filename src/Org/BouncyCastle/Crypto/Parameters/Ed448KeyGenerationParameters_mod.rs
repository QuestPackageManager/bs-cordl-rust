...
impl crate::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::Ed448KeyGenerationParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
