#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+RsaKeyParameters")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+RsaKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked((), (modulus))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (isPrivate, modulus, exponent))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Exponent(
        &mut self,
