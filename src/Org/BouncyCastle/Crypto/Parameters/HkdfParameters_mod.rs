...
impl crate::Org::BouncyCastle::Crypto::Parameters::HkdfParameters {
    ...
    pub fn _ctor_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ikm, salt, info))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ikm, skip, salt, info))?
        };
        Ok(__cordl_ret.into())
    }
