...
impl crate::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyParameters {
    pub fn LookupParameters(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::Gost3410KeyParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::Org::BouncyCastle::Asn1::DerObjectIdentifier,
                >),
    ...
    pub fn _ctor_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (isPrivate, publicKeyParamSet))?
        };
        Ok(__cordl_ret.into())
    }
