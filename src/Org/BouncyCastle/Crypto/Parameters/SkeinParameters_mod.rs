#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+SkeinParameters")]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+SkeinParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters {
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+SkeinParameters+Builder")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+SkeinParameters+Builder")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+SkeinParameters+Builder")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder {
    pub fn Build(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (date, emailAddress, distinguisher))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetPersonalisation_Il2CppArray0(
        &mut self,
        personalisation: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder,
        >,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetPersonalisation", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (personalisation))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetPublicKey(
        &mut self,
    ...
    pub fn _ctor_IDictionary1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (paramsMap))? };
        Ok(__cordl_ret.into())
    }
