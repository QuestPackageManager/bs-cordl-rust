...
#[cfg(
    feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+SkeinParameters+Builder"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::Crypto::Parameters::SkeinParameters_Builder {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (date, emailAddress, distinguisher))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IDictionary1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (paramsMap))?
        };
        Ok(__cordl_ret.into())
    }
