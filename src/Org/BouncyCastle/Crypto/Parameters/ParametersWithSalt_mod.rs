...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+ParametersWithSalt")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt {
    ...
    pub fn _ctor_ICipherParameters_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parameters, salt))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (parameters, salt, saltOff, saltLen))?
        };
        Ok(__cordl_ret.into())
    }
