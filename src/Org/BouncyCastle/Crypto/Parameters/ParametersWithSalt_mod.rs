...
for crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt {
    ...
    const CLASS_NAME: &'static str = "ParametersWithSalt";
...
impl crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Parameters::ParametersWithSalt as
    ...
    pub fn _ctor_ICipherParameters_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (parameters, salt))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (parameters, salt, saltOff, saltLen))?
        };
        Ok(__cordl_ret.into())
    }
