...
impl crate::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters {
    pub fn Equals_DsaPublicKeyParameters1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Math::BigInteger,
        > = unsafe { method.invoke_unchecked((), (y, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
