#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DsaPublicKeyParameters")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters
{
    ...
    const CLASS_NAME: &'static str = "DsaPublicKeyParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+DsaPublicKeyParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked((), (y, parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
