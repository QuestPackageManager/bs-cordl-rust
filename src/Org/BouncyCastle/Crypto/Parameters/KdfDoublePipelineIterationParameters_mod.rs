...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+KdfDoublePipelineIterationParameters")]
impl std::ops::Deref
    for crate::Org::BouncyCastle::Crypto::Parameters::KdfDoublePipelineIterationParameters
{
...
impl crate::Org::BouncyCastle::Crypto::Parameters::KdfDoublePipelineIterationParameters {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ki, fixedInputData, r, useCounter))?
        };
        Ok(__cordl_ret.into())
    }
