...
for crate::Org::BouncyCastle::Crypto::Parameters::DsaParameters {
    ...
    const CLASS_NAME: &'static str = "DsaParameters";
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DsaParameters {
    pub fn Equals_DsaParameters1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DsaParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Parameters::DsaParameters as
    ...
    pub fn _ctor_DsaValidationParameters1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p, q, g, parameters))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_G(
