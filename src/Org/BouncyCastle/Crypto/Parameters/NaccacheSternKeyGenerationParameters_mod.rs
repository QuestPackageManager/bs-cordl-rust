...
#[cfg(feature = "Org+BouncyCastle+Crypto+Parameters+NaccacheSternKeyGenerationParameters")]
impl std::ops::Deref
    for crate::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyGenerationParameters
{
...
impl crate::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyGenerationParameters {
    ...
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (random, strength, certainty, countSmallPrimes, debug))?
        };
        Ok(__cordl_ret.into())
    }
