#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Parameters+DHKeyGenerationParameters")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters {
...
impl crate::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters {
    pub fn GetStrength(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (parameters))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
