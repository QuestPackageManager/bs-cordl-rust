...
impl crate::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters {
    pub fn GetStrength(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters as
                    quest_hook::libil2cpp::Type > ::class(), "GetStrength", 1usize
                )
            });
