#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+IAsymmetricCipherKeyPairGenerator")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::IAsymmetricCipherKeyPairGenerator
{
    ...
    const CLASS_NAME: &'static str = "IAsymmetricCipherKeyPairGenerator";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::IAsymmetricCipherKeyPairGenerator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+IAsymmetricCipherKeyPairGenerator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::IAsymmetricCipherKeyPairGenerator {
