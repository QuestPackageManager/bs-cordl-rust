...
for crate::Org::BouncyCastle::Crypto::IBlockCipher {
...
impl crate::Org::BouncyCastle::Crypto::IBlockCipher {
    pub fn GetBlockSize(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::IBlockCipher as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("GetBlockSize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::IBlockCipher as
    ...
    pub fn ProcessBlock(
        ...
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked(self, (inBuf, inOff, outBuf, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Reset(
