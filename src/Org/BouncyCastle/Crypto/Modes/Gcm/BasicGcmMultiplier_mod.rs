#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+Gcm+BasicGcmMultiplier")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier
{
    ...
    const CLASS_NAME: &'static str = "BasicGcmMultiplier";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+Gcm+BasicGcmMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier {
...
impl AsMut<crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier>
    for crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmMultiplier
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier {
        unsafe { std::mem::transmute(self) }
    }
}
