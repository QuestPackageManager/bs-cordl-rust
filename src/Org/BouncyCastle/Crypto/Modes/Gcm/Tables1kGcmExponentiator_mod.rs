#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+Gcm+Tables1kGcmExponentiator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+Gcm+Tables1kGcmExponentiator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator {
...
impl crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator {
    pub fn EnsureAvailable(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("EnsureAvailable")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bit))? };
        Ok(__cordl_ret.into())
    }
    pub fn ExponentiateX(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("ExponentiateX")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pow, output))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
...
impl AsRef<crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator>
    for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator
{
    fn as_ref(&self) -> &crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator {
...
impl AsMut<crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator>
    for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator {
        unsafe { std::mem::transmute(self) }
    }
}
