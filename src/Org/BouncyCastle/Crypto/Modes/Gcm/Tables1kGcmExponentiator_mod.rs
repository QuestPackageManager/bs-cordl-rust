...
impl crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator {
    pub fn EnsureAvailable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("EnsureAvailable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator as
                    quest_hook::libil2cpp::Type > ::class(), "EnsureAvailable", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator as
                    quest_hook::libil2cpp::Type > ::class(), "ExponentiateX", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (pow, output))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
