...
for crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator {
    ...
    const CLASS_NAME: &'static str = "IGcmExponentiator";
...
impl crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator {
    pub fn ExponentiateX(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator as
