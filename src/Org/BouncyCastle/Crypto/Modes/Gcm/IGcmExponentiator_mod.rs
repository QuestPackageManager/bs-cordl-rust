...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+Gcm+IGcmExponentiator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator {
