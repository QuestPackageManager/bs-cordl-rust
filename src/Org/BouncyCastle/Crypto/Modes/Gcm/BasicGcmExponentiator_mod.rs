#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+Gcm+BasicGcmExponentiator")]
#[repr(C)]
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmExponentiator {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+Gcm+BasicGcmExponentiator")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmExponentiator {
