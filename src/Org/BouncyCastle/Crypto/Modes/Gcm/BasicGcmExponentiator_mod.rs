...
impl crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmExponentiator {
    pub fn ExponentiateX(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmExponentiator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Modes::Gcm::BasicGcmExponentiator
                    as quest_hook::libil2cpp::Type > ::class(), "ExponentiateX", 2usize
                )
            });
