...
impl crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Modes::Gcm::Tables8kGcmMultiplier
                    as quest_hook::libil2cpp::Type > ::class(), "MultiplyH", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
