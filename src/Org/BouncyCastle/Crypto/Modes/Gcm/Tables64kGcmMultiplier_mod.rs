#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+Gcm+Tables64kGcmMultiplier")]
#[repr(C)]
    ...
    for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables64kGcmMultiplier
{
    ...
    const CLASS_NAME: &'static str = "Tables64kGcmMultiplier";
...
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables64kGcmMultiplier {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+Gcm+Tables64kGcmMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::Gcm::Tables64kGcmMultiplier {
