#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+Gcm+IGcmMultiplier")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+Gcm+IGcmMultiplier")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier {
