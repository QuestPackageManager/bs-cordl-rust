...
for crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier {
    ...
    const CLASS_NAME: &'static str = "IGcmMultiplier";
...
impl crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier as
