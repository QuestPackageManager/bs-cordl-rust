#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+OpenPgpCfbBlockCipher")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+OpenPgpCfbBlockCipher")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::OpenPgpCfbBlockCipher {
...
impl crate::Org::BouncyCastle::Crypto::Modes::OpenPgpCfbBlockCipher {
    ...
    pub fn EncryptByte(&mut self, data: u8, blockOff: i32) -> quest_hook::libil2cpp::Result<u8> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: u8 =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, blockOff))? };
        Ok(__cordl_ret.into())
    }
