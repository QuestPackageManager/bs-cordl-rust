#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+CbcBlockCipher")]
#[repr(C)]
#[derive(Debug)]
pub struct CbcBlockCipher {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub IV: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub cbcV: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub cbcNextV: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub blockSize: i32,
...
for crate::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Modes";
    const CLASS_NAME: &'static str = "CbcBlockCipher";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+CbcBlockCipher")]
impl std::ops::Deref for crate::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher {
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+CbcBlockCipher")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+CbcBlockCipher")]
impl crate::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher {
    pub fn DecryptBlock(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher as
