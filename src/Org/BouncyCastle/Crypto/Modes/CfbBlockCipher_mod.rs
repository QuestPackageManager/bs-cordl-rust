#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+CfbBlockCipher")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher
{
    ...
    const CLASS_NAME: &'static str = "CfbBlockCipher";
...
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+CfbBlockCipher")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Org+BouncyCastle+Crypto+Modes+CfbBlockCipher")]
impl crate::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher {
    pub fn DecryptBlock(
        &mut self,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cipher, bitBlockSize))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+CfbBlockCipher")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Modes::CfbBlockCipher {
