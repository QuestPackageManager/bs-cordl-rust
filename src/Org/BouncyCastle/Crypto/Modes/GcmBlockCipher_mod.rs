...
impl crate::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ProcessAadBytes", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (inBytes, inOff, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessBlock(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buf, bufOff, output, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessByte(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ProcessPartial", 5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buf, off, len, output, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Reset_0(
    ...
    pub fn Reset__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (clearMac))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_IGcmMultiplier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (c, m))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn gHASH(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "gHASH",
                            3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (Y, b, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn gHASHBlock_Il2CppArray_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (Y, b))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn gHASHBlock_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (Y, b, off))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn gHASHPartial(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (Y, b, off, len))?
        };
        Ok(__cordl_ret.into())
    }
