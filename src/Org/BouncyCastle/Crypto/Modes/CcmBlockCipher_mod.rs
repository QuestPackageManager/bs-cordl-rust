...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Org::BouncyCastle::Crypto::Modes::CcmBlockCipher
...
impl crate::Org::BouncyCastle::Crypto::Modes::CcmBlockCipher {
    ...
    pub fn ProcessPacket_Gc_i32_i32_0(
        &mut self,
        input: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        inOff: i32,
        inLen: i32,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = __cordl_object.invoke("ProcessPacket", (input, inOff, inLen))?;
        Ok(__cordl_ret.into())
    }
    pub fn Reset(
        &mut self,
