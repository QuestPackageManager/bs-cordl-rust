...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+IAeadCipher")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::Crypto::Modes::IAeadCipher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.Crypto.Modes";
    const CLASS_NAME: &'static str = "IAeadCipher";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+IAeadCipher")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Modes::IAeadCipher {
