...
impl crate::Org::BouncyCastle::Crypto::Modes::KCcmBlockCipher {
    pub fn CalculateMac(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (authText, authOff, len))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn DoFinal(
    ...
    pub fn ProcessAAD(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (assocText, assocOff, assocLen, dataLen))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (engine, Nb))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn getFlag(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "getFlag",
                            2usize
                        )
                    })
            });
        let __cordl_ret: u8 = unsafe {
            cordl_method_info.invoke_unchecked(self, (authTextPresents, macSize))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn intToBytes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (num, outBytes, outOff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn setNb(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "setNb",
                            1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (Nb))?
        };
        Ok(__cordl_ret.into())
    }
}
