#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+SicBlockCipher")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+Crypto+Modes+SicBlockCipher")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::Crypto::Modes::SicBlockCipher {
