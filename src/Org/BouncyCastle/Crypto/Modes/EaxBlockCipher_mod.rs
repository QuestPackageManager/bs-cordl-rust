...
impl crate::Org::BouncyCastle::Crypto::Modes::EaxBlockCipher {
    ...
    pub fn CalculateMac(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::EaxBlockCipher as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CalculateMac")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Modes::EaxBlockCipher as
                    quest_hook::libil2cpp::Type > ::class(), "CalculateMac", 0usize
                )
            });
    ...
    pub fn Process(
        ...
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked(self, (b, outBytes, outOff))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::Crypto::Modes::EaxBlockCipher as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::Crypto::Modes::EaxBlockCipher as
                    quest_hook::libil2cpp::Type > ::class(), "VerifyMac", 2usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, (mac, off))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
