#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509V3CertificateGenerator")]
#[repr(C)]
#[derive(Debug)]
pub struct X509V3CertificateGenerator {
    ...
    pub tbsGen:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::V3TbsCertificateGenerator>,
...
impl crate::Org::BouncyCastle::X509::X509V3CertificateGenerator {
    ...
    pub fn CopyAndAddExtension_DerObjectIdentifier1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, critical, cert))? };
        Ok(__cordl_ret.into())
    }
