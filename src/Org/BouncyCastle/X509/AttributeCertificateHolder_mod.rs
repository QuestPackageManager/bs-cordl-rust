#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+AttributeCertificateHolder")]
#[repr(C)]
...
impl crate::Org::BouncyCastle::X509::AttributeCertificateHolder {
    ...
    pub fn GetPrincipals(
        &mut self,
        names: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::GeneralNames>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
                quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
    ...
    pub fn New_X509Name_BigInteger1(
        issuerName: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Name>,
    ...
    pub fn _ctor_X509Name_BigInteger1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (issuerName, serialNumber))? };
        Ok(__cordl_ret.into())
    }
