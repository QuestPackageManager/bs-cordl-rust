...
impl crate::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::Extension::SubjectKeyIdentifierStructure as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "FromPublicKey", 1usize
                )
            });
