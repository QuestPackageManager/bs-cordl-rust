#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+Extension+AuthorityKeyIdentifierStructure")]
#[repr(C)]
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "FromKey",
                            1usize
                        )
                    })
            });
