...
impl crate::Org::BouncyCastle::X509::PrincipalUtilities {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::PrincipalUtilities as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::X509::PrincipalUtilities as
                    quest_hook::libil2cpp::Type > ::class(), "GetIssuerX509Principal",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::PrincipalUtilities as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::X509::PrincipalUtilities as
                    quest_hook::libil2cpp::Type > ::class(), "GetSubjectX509Principal",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
