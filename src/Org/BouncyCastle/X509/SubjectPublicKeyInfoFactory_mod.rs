#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+SubjectPublicKeyInfoFactory")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Org::BouncyCastle::X509::SubjectPublicKeyInfoFactory {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 1usize>("CreateSubjectPublicKeyInfo")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn ExtractBytes_BigInteger0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("ExtractBytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (encKey, offset, bI))? };
        Ok(__cordl_ret.into())
    }
