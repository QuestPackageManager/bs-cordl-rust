#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509CertPairParser")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509CertPairParser")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::X509::X509CertPairParser {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.X509";
    const CLASS_NAME: &'static str = "X509CertPairParser";
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509CertPairParser")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::X509::X509CertPairParser {
