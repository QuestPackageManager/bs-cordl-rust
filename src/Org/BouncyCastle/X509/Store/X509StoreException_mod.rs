...
for crate::Org::BouncyCastle::X509::Store::X509StoreException {
    ...
    const CLASS_NAME: &'static str = "X509StoreException";
...
impl crate::Org::BouncyCastle::X509::Store::X509StoreException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::Store::X509StoreException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::X509::Store::X509StoreException as
