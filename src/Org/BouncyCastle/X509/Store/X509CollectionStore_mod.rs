...
impl crate::Org::BouncyCastle::X509::Store::X509CollectionStore {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::Store::X509CollectionStore as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::X509::Store::X509CollectionStore as
                    quest_hook::libil2cpp::Type > ::class(), "GetMatches", 1usize
                )
            });
