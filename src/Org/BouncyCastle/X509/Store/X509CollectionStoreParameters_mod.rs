...
impl crate::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::ICollection>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters
                    as quest_hook::libil2cpp::Type > ::class(), "GetCollection", 0usize
                )
            });
