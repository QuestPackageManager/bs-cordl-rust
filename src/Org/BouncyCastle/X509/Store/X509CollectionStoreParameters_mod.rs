#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+Store+X509CollectionStoreParameters")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters
{
    ...
    const CLASS_NAME: &'static str = "X509CollectionStoreParameters";
...
impl std::ops::Deref for crate::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters {
...
#[cfg(feature = "Org+BouncyCastle+X509+Store+X509CollectionStoreParameters")]
impl std::ops::DerefMut for crate::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters {
...
impl AsMut<crate::Org::BouncyCastle::X509::Store::IX509StoreParameters>
    for crate::Org::BouncyCastle::X509::Store::X509CollectionStoreParameters
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::X509::Store::IX509StoreParameters {
        unsafe { std::mem::transmute(self) }
    }
}
