#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509KeyUsage")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509KeyUsage")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::X509::X509KeyUsage {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.X509";
    const CLASS_NAME: &'static str = "X509KeyUsage";
...
impl crate::Org::BouncyCastle::X509::X509KeyUsage {
    ...
    pub fn New(usage: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
