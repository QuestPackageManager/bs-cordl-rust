...
impl crate::Org::BouncyCastle::X509::X509Utilities {
    pub fn CreatePssParams(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::X509Utilities as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Org::BouncyCastle::X509::X509Utilities as
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Org::BouncyCastle::X509::X509Utilities as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Org::BouncyCastle::X509::X509Utilities as
                    quest_hook::libil2cpp::Type > ::class(), "GetSignatureForObject",
                    5usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        > = unsafe {
            method.invoke_unchecked((), (sigOid, sigName, privateKey, random, ae))?
        };
        Ok(__cordl_ret.into())
    }
