...
impl crate::Org::BouncyCastle::X509::X509Certificate {
    ...
    > {
        ...
        > = __cordl_object.invoke("GetAlternativeNames", (oid))?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::ICollection,
        > = __cordl_object.invoke("GetIssuerAlternativeNames", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn GetKeyUsage(
        &mut self,
    ...
    > {
        ...
        > = __cordl_object.invoke("GetKeyUsage", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn GetPublicKey(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::ICollection,
        > = __cordl_object.invoke("GetSubjectAlternativeNames", ())?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = __cordl_object.invoke("GetTbsCertificate", ())?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::X509CertificateStructure,
        > = __cordl_object.invoke("get_CertificateStructure", ())?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = __cordl_object.invoke("get_IssuerUniqueID", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn get_NotAfter(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::X509::X509Name,
        > = __cordl_object.invoke("get_SubjectDN", ())?;
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Asn1::DerBitString,
        > = __cordl_object.invoke("get_SubjectUniqueID", ())?;
        Ok(__cordl_ret.into())
    }
