#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509V2AttributeCertificate")]
#[repr(C)]
#[derive(Debug)]
pub struct X509V2AttributeCertificate {
    __cordl_parent: crate::Org::BouncyCastle::X509::X509ExtensionBase,
    pub cert: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate>,
    ...
    for crate::Org::BouncyCastle::X509::X509V2AttributeCertificate
{
    ...
    const CLASS_NAME: &'static str = "X509V2AttributeCertificate";
...
impl crate::Org::BouncyCastle::X509::X509V2AttributeCertificate {
    ...
    pub fn New_AttributeCertificate2(
        cert: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AttributeCertificate>,
    ...
    pub fn New_Stream0(
        encIn: quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_Stream0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (encIn))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Holder(
        &mut self,
...
impl AsMut<crate::Org::BouncyCastle::X509::IX509AttributeCertificate>
    for crate::Org::BouncyCastle::X509::X509V2AttributeCertificate
{
    fn as_mut(&mut self) -> &mut crate::Org::BouncyCastle::X509::IX509AttributeCertificate {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Org+BouncyCastle+X509+X509V2AttributeCertificate")]
