...
pub struct X509V2CrlGenerator {
    ...
    pub extGenerator:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509ExtensionsGenerator>,
    pub tbsGen:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::V2TbsCertListGenerator>,
    pub sigOID: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::DerObjectIdentifier>,
    pub sigAlgId:
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier>,
    pub signatureAlgorithm: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509V2CrlGenerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Org::BouncyCastle::X509::X509V2CrlGenerator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Org.BouncyCastle.X509";
    const CLASS_NAME: &'static str = "X509V2CrlGenerator";
...
impl crate::Org::BouncyCastle::X509::X509V2CrlGenerator {
    ...
    pub fn AddCrlEntry_X509Extensions2(
        &mut self,
        userCertificate: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Math::BigInteger>,
        revocationDate: crate::System::DateTime,
        extensions: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::X509Extensions>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("AddCrlEntry")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (userCertificate, revocationDate, extensions))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddCrlEntry_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (userCertificate, revocationDate, reason))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        crate::System::DateTime,
                    ), quest_hook::libil2cpp::Void, 4usize>("AddCrlEntry")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn AddExtension_DerObjectIdentifier_Asn1Encodable1(
        ...
        critical: bool,
        extensionValue: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::Asn1Encodable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("AddExtension")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid, critical, extensionValue))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GenerateCertList(
        ...
        quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::TbsCertificateList>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn GenerateJcaObject(
        &mut self,
        tbsCrl: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::Asn1::X509::TbsCertificateList>,
    ...
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                    ), quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::X509::X509Crl>, 3usize>(
                        "GenerateJcaObject",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::X509::X509Crl> =
            unsafe { cordl_method_info.invoke_unchecked(self, (tbsCrl, algId, signature))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::X509::X509Crl> =
            unsafe { cordl_method_info.invoke_unchecked(self, (privateKey, random))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Org::BouncyCastle::X509::X509Crl> =
            unsafe { cordl_method_info.invoke_unchecked(self, (signatureCalculatorFactory))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetNextUpdate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (date))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetSignatureAlgorithm(
        &mut self,
        signatureAlgorithm: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetSignatureAlgorithm", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (signatureAlgorithm))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Org+BouncyCastle+X509+X509V2CrlGenerator")]
impl quest_hook::libil2cpp::ObjectType for crate::Org::BouncyCastle::X509::X509V2CrlGenerator {
