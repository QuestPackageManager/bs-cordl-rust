#[cfg(feature = "cordl_class_BGNet+Logging+ConsoleLogger")]
#[repr(C)]
...
impl crate::BGNet::Logging::ConsoleLogger {
    ...
    pub fn LogException(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (exception, message))? };
        Ok(__cordl_ret.into())
    }
    pub fn LogInfo(
        &mut self,
...
#[cfg(feature = "BGNet+Logging+ConsoleLogger")]
impl AsRef<crate::BGNet::Logging::Debug_ILogger> for crate::BGNet::Logging::ConsoleLogger {
    fn as_ref(&self) -> &crate::BGNet::Logging::Debug_ILogger {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "BGNet+Logging+ConsoleLogger")]
impl AsMut<crate::BGNet::Logging::Debug_ILogger> for crate::BGNet::Logging::ConsoleLogger {
