...
impl crate::BGNet::Core::IPlatformAccessTokenFetcher {
    pub fn GetXPlatformAccessToken(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGNet::Core::IPlatformAccessTokenFetcher as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGNet::Core::IPlatformAccessTokenFetcher as
