...
#[cfg(feature = "BGNet+Core+ITimeProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGNet::Core::ITimeProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BGNet.Core";
    const CLASS_NAME: &'static str = "ITimeProvider";
...
#[cfg(feature = "BGNet+Core+ITimeProvider")]
impl std::ops::Deref for crate::BGNet::Core::ITimeProvider {
...
#[cfg(feature = "BGNet+Core+ITimeProvider")]
impl std::ops::DerefMut for crate::BGNet::Core::ITimeProvider {
...
#[cfg(feature = "BGNet+Core+ITimeProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::BGNet::Core::ITimeProvider {
