#[cfg(feature = "cordl_class_UnityOpus+Encoder")]
#[repr(C)]
...
impl crate::UnityOpus::Encoder {
    ...
    pub fn Encode(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (pcm, count, output))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (samplingFrequency, channels, application))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Signal(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityOpus::OpusSignal> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::UnityOpus::OpusSignal =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_Bitrate(
