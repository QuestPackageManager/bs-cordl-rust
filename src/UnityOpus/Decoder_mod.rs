#[cfg(feature = "cordl_class_UnityOpus+Decoder")]
#[repr(C)]
#[derive(Debug)]
pub struct Decoder {
...
impl crate::UnityOpus::Decoder {
    ...
    pub fn Decode(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (data, dataLength, pcm, decodeFec))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (samplingFrequency, channels))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityOpus+Decoder")]
