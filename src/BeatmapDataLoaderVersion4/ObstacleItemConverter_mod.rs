...
impl crate::BeatmapDataLoaderVersion4::ObstacleItemConverter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapDataLoaderVersion4::ObstacleItemConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapDataLoaderVersion4::ObstacleItemConverter as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (obstacles, bpmTimeProcessor))?
        };
        Ok(__cordl_ret.into())
    }
}
