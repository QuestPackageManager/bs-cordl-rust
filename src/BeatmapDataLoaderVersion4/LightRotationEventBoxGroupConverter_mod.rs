#[cfg(feature = "cordl_class_BeatmapDataLoaderVersion4+LightRotationEventBoxGroupConverter")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::BeatmapDataLoaderVersion4::LightRotationEventBoxGroupConverter
{
    ...
    const CLASS_NAME: &'static str = "LightRotationEventBoxGroupConverter";
...
impl std::ops::Deref for crate::BeatmapDataLoaderVersion4::LightRotationEventBoxGroupConverter {
...
#[cfg(feature = "BeatmapDataLoaderVersion4+LightRotationEventBoxGroupConverter")]
impl std::ops::DerefMut for crate::BeatmapDataLoaderVersion4::LightRotationEventBoxGroupConverter {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BeatmapDataLoaderVersion4+LightRotationEventBoxGroupConverter")]
impl crate::BeatmapDataLoaderVersion4::LightRotationEventBoxGroupConverter {
