...
#[cfg(feature = "BeatmapDataLoaderVersion4+ColorBoostEventItemConverter")]
impl std::ops::DerefMut for crate::BeatmapDataLoaderVersion4::ColorBoostEventItemConverter {
...
impl crate::BeatmapDataLoaderVersion4::ColorBoostEventItemConverter {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (colorBoostEvents, bpmTimeProcessor))?
        };
        Ok(__cordl_ret.into())
    }
}
