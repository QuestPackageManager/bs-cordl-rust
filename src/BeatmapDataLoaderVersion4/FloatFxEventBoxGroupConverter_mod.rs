...
impl crate::BeatmapDataLoaderVersion4::FloatFxEventBoxGroupConverter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapDataLoaderVersion4::FloatFxEventBoxGroupConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapDataLoaderVersion4::FloatFxEventBoxGroupConverter as
