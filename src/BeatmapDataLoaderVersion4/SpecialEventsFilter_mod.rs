...
#[cfg(feature = "cordl_class_BeatmapDataLoaderVersion4+SpecialEventsFilter")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapDataLoaderVersion4::SpecialEventsFilter {
...
impl crate::BeatmapDataLoaderVersion4::SpecialEventsFilter {
    pub fn IsEventValid(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::BeatmapSaveDataCommon::BeatmapEventType), bool, 1usize>(
                        "IsEventValid",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (basicBeatmapEventType))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (basicEventTypesWithKeywords, environmentKeywords))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BeatmapDataLoaderVersion4+SpecialEventsFilter")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatmapDataLoaderVersion4::SpecialEventsFilter {
