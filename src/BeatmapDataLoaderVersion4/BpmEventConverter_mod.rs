...
impl crate::BeatmapDataLoaderVersion4::BpmEventConverter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapDataLoaderVersion4::BpmEventConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapDataLoaderVersion4::BpmEventConverter as
