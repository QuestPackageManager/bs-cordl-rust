#[cfg(feature = "cordl_class_LufsMetering+FilterCoefficients")]
...
#[cfg(feature = "cordl_class_LufsMetering+FilterCoefficients")]
unsafe impl quest_hook::libil2cpp::Type for crate::LufsMetering::FilterCoefficients {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "LufsMetering";
    const CLASS_NAME: &'static str = "FilterCoefficients";
...
#[cfg(feature = "cordl_class_LufsMetering+FilterCoefficients")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::LufsMetering::FilterCoefficients {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_LufsMetering+FilterCoefficients")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::LufsMetering::FilterCoefficients {
    type Type = Self;
