...
impl crate::LufsMetering::CalculateRmsBlockJob {
    pub fn Create(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LufsMetering::CalculateRmsBlockJob as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::LufsMetering::CalculateRmsBlockJob as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 1usize
                )
            });
        let __cordl_ret: crate::LufsMetering::CalculateRmsBlockJob = unsafe {
            method.invoke_unchecked((), (inputData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Execute(
