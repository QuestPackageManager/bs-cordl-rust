#[cfg(feature = "cordl_class_IgnoranceCore+IgnoranceClient")]
#[repr(C)]
#[derive(Debug)]
pub struct IgnoranceClient {
    ...
    pub StatusUpdates: quest_hook::libil2cpp::Gc<
        crate::IgnoranceThirdparty::RingBuffer_1<crate::IgnoranceCore::IgnoranceClientStats>,
    >,
...
#[cfg(feature = "cordl_class_IgnoranceCore+IgnoranceClient+ThreadParamInfo")]
...
#[cfg(feature = "cordl_class_IgnoranceCore+IgnoranceClient+ThreadParamInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::IgnoranceCore::IgnoranceClient_ThreadParamInfo {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "IgnoranceCore";
