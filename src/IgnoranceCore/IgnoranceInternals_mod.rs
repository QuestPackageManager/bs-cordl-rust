...
#[cfg(feature = "IgnoranceCore+IgnoranceInternals")]
unsafe impl quest_hook::libil2cpp::Type for crate::IgnoranceCore::IgnoranceInternals {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "IgnoranceCore";
    const CLASS_NAME: &'static str = "IgnoranceInternals";
...
impl crate::IgnoranceCore::IgnoranceInternals {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::IgnoranceCore::IgnoranceInternals as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::IgnoranceCore::IgnoranceInternals as
