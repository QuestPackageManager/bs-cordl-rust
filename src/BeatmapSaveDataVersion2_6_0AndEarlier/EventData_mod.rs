...
impl crate::BeatmapSaveDataVersion2_6_0AndEarlier::EventData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (_cordl_time, _cordl_type, value, floatValue))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_type(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatmapSaveDataCommon::BeatmapEventType, 0usize>(
                        "get_type",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatmapSaveDataCommon::BeatmapEventType =
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion2_6_0AndEarlier+EventData")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatmapSaveDataVersion2_6_0AndEarlier::EventData {
