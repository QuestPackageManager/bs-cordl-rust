...
impl crate::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    f32,
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData as
