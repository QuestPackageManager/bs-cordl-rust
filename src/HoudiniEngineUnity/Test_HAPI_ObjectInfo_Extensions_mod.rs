...
for crate::HoudiniEngineUnity::Test_HAPI_ObjectInfo_Extensions {
    ...
    const CLASS_NAME: &'static str = "Test_HAPI_ObjectInfo_Extensions";
...
impl crate::HoudiniEngineUnity::Test_HAPI_ObjectInfo_Extensions {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::Test_HAPI_ObjectInfo_Extensions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::Test_HAPI_ObjectInfo_Extensions as
