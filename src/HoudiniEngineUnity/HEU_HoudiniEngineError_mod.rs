...
for crate::HoudiniEngineUnity::HEU_HoudiniEngineError {
    ...
    const CLASS_NAME: &'static str = "HEU_HoudiniEngineError";
...
impl crate::HoudiniEngineUnity::HEU_HoudiniEngineError {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_HoudiniEngineError as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_HoudiniEngineError as
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (errorMsg))?
        };
        Ok(__cordl_ret.into())
    }
}
