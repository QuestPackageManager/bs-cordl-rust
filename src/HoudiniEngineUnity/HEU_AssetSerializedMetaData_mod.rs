...
impl crate::HoudiniEngineUnity::HEU_AssetSerializedMetaData {
    pub fn IsEquivalentTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_AssetSerializedMetaData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::HoudiniEngineUnity::HEU_AssetSerializedMetaData,
                >),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_AssetSerializedMetaData as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_AssetSerializedMetaData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HEU_AssetSerializedMetaData as
                    quest_hook::libil2cpp::Type > ::class(), "get_SavedCurveNodeData",
                    0usize
                )
            });
    ...
    pub fn get_SoftDeleted(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_AssetSerializedMetaData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_SoftDeleted")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HEU_AssetSerializedMetaData as
                    quest_hook::libil2cpp::Type > ::class(), "get_SoftDeleted", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_AssetSerializedMetaData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HEU_AssetSerializedMetaData as
                    quest_hook::libil2cpp::Type > ::class(), "set_SoftDeleted", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
