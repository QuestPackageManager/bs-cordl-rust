...
impl crate::HoudiniEngineUnity::HEU_InputInterfaceMesh {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::HoudiniEngineUnity::HEU_InputInterfaceMesh_HEU_InputDataMesh,
        > = unsafe { cordl_method_info.invoke_unchecked((), (meshGameObject))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Mesh> = unsafe {
            cordl_method_info.invoke_unchecked((), (meshGameObject))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetUVsFromMesh(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (mesh, srcUVs, destUVs, index))?
        };
        Ok(__cordl_ret.into())
    }
