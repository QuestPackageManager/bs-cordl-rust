...
for crate::HoudiniEngineUnity::Test_HAPI_NodeInfo {
    ...
    const CLASS_NAME: &'static str = "Test_HAPI_NodeInfo";
...
impl crate::HoudiniEngineUnity::Test_HAPI_NodeInfo {
    pub fn IsEquivalentTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::Test_HAPI_NodeInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::Test_HAPI_NodeInfo as
