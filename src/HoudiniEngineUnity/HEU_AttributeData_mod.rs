#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_AttributeData")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_AttributeData {
    ...
    pub fn CopyValuesTo(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (destAttrData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn IsColorAttribute(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsColorAttribute")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsColorAttribute", 0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_AttributeData+AttributeState")]
#[repr(i32)]
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_AttributeData+AttributeType")]
#[repr(i32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
