...
#[cfg(feature = "HoudiniEngineUnity+JSONString")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::JSONString {
...
impl crate::HoudiniEngineUnity::JSONString {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::JSONString as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::JSONString as quest_hook::libil2cpp::Type
                    > ::class(), "Equals", 1usize
                )
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (aData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_IsString(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::JSONString as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_IsString")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::JSONString as quest_hook::libil2cpp::Type
                    > ::class(), "get_IsString", 0usize
                )
            });
