...
for crate::HoudiniEngineUnity::HAPI_AttributeInfo {
    ...
    const CLASS_NAME: &'static str = "HAPI_AttributeInfo";
...
impl crate::HoudiniEngineUnity::HAPI_AttributeInfo {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HAPI_AttributeInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HAPI_AttributeInfo as
