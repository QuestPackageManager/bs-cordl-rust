...
for crate::HoudiniEngineUnity::HEU_BakedEventData {
    ...
    const CLASS_NAME: &'static str = "HEU_BakedEventData";
...
impl crate::HoudiniEngineUnity::HEU_BakedEventData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_BakedEventData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_BakedEventData as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (asset, successful, outputObjects, isNewBake))?
        };
        Ok(__cordl_ret.into())
    }
}
