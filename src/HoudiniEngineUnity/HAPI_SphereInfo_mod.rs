...
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::HAPI_SphereInfo {
    ...
    const CLASS_NAME: &'static str = "HAPI_SphereInfo";
...
impl crate::HoudiniEngineUnity::HAPI_SphereInfo {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HAPI_SphereInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HAPI_SphereInfo as
