...
for crate::HoudiniEngineUnity::HEU_MeshIndexFormat {
    ...
    const CLASS_NAME: &'static str = "HEU_MeshIndexFormat";
...
impl crate::HoudiniEngineUnity::HEU_MeshIndexFormat {
    pub fn CalculateIndexFormat(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_MeshIndexFormat as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_MeshIndexFormat as
                    quest_hook::libil2cpp::Type > ::class(), "CalculateIndexFormat",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (numVertices))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_MeshIndexFormat as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HEU_MeshIndexFormat as
                    quest_hook::libil2cpp::Type > ::class(), "SetFormatForMesh", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
