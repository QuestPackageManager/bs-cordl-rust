...
for crate::HoudiniEngineUnity::HAPI_TransformEuler {
    ...
    const CLASS_NAME: &'static str = "HAPI_TransformEuler";
...
impl crate::HoudiniEngineUnity::HAPI_TransformEuler {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HAPI_TransformEuler as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Init")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HAPI_TransformEuler as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (initializeFields))?
        };
        Ok(__cordl_ret.into())
    }
}
