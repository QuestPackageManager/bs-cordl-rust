#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_TaskManager")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_TaskManager {
    ...
    pub fn CompleteTask(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (task, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ExecuteTask(
    ...
    > {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "GetTask",
                            1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::HoudiniEngineUnity::HEU_Task,
        > = unsafe { cordl_method_info.invoke_unchecked((), (taskGuid))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn KillTask_Guid1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (taskGuid, bRemove))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn KillTask_HEU_Task0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (task, bRemove))?
        };
        Ok(__cordl_ret.into())
    }
