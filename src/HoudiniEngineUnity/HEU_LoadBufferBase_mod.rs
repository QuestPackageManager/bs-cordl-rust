...
impl crate::HoudiniEngineUnity::HEU_LoadBufferBase {
    pub fn InitializeBuffer(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_LoadBufferBase as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_LoadBufferBase as
                    quest_hook::libil2cpp::Type > ::class(), "InitializeBuffer", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (id, name, bInstanced, bInstancer))?
        };
        Ok(__cordl_ret.into())
    }
