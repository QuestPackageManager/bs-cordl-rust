#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_LoadBufferBase")]
#[repr(C)]
#[derive(Debug)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InitializeBuffer", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (id, name, bInstanced, bInstancer))?
        };
        Ok(__cordl_ret.into())
    }
