...
#[cfg(feature = "HoudiniEngineUnity+Test_Transform")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::Test_Transform {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "Test_Transform";
...
#[cfg(feature = "HoudiniEngineUnity+Test_Transform")]
impl std::ops::DerefMut for crate::HoudiniEngineUnity::Test_Transform {
...
impl crate::HoudiniEngineUnity::Test_Transform {
    pub fn IsEquivalentTo(
        &mut self,
        other: quest_hook::libil2cpp::Gc<crate::HoudiniEngineUnity::Test_Transform>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::Test_Transform as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::Test_Transform as
...
#[cfg(feature = "HoudiniEngineUnity+Test_Transform")]
impl quest_hook::libil2cpp::ObjectType for crate::HoudiniEngineUnity::Test_Transform {
