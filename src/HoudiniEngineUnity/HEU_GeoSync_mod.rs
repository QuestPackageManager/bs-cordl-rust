...
#[cfg(feature = "HoudiniEngineUnity+HEU_GeoSync")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::HEU_GeoSync {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "HEU_GeoSync";
...
impl crate::HoudiniEngineUnity::HEU_GeoSync {
    ...
    pub fn SetupLoadTask(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_GeoSync as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_GeoSync as
