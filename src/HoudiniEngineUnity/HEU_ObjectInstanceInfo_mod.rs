...
for crate::HoudiniEngineUnity::HEU_ObjectInstanceInfo {
    ...
    const CLASS_NAME: &'static str = "HEU_ObjectInstanceInfo";
...
impl crate::HoudiniEngineUnity::HEU_ObjectInstanceInfo {
    pub fn IsEquivalentTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_ObjectInstanceInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_ObjectInstanceInfo as
