...
impl crate::HoudiniEngineUnity::HEU_Vector3SerializationSurrogate {
    ...
    pub fn System_Runtime_Serialization_ISerializationSurrogate_GetObjectData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_Vector3SerializationSurrogate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_Vector3SerializationSurrogate as
