...
#[cfg(feature = "HoudiniEngineUnity+HEU_InputHDAInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::HEU_InputHDAInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "HEU_InputHDAInfo";
...
impl crate::HoudiniEngineUnity::HEU_InputHDAInfo {
    pub fn CopyTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_InputHDAInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_InputHDAInfo as
                    quest_hook::libil2cpp::Type > ::class(), "CopyTo", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (destInfo))?
        };
        Ok(__cordl_ret.into())
    }
