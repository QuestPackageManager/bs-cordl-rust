...
#[cfg(feature = "HoudiniEngineUnity+ReverseCompare")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::ReverseCompare {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "ReverseCompare";
...
impl crate::HoudiniEngineUnity::ReverseCompare {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::ReverseCompare as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::ReverseCompare as
