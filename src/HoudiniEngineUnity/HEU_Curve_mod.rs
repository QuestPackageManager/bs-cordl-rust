#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_Curve")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_Curve {
    ...
    pub fn GenerateMesh(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (inGameObject))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetCurvePoint(
        ...
        let __cordl_ret: crate::UnityEngine::Vector3 = unsafe {
            cordl_method_info.invoke_unchecked(self, (pointIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetInvertedTransformedDirection(
        ...
        let __cordl_ret: crate::UnityEngine::Vector3 = unsafe {
            cordl_method_info.invoke_unchecked(self, (inPosition))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProjectToColliders(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (parentAsset, rayDirection, rayDistance))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ResetCurveParameters(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (session, parentAsset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetCurveGeometryVisibility(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bVisible))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetCurveName(
    ...
    pub fn SetCurveNodeData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (curveNodeData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetCurveParameterPreset(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (session, parentAsset, parameterPreset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetCurvePoint(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pointIndex, newPosition))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetEditState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (editState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetUploadParameterPreset(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bValue))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateCurve(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (session, partID))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UploadParameterPreset(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (session, geoID, parentAsset))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_Curve+CurveDrawCollision")]
#[repr(i32)]
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_Curve+CurveEditState")]
#[repr(i32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_Curve+Interaction")]
#[repr(i32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
