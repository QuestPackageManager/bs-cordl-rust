#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_CookLogs")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_CookLogs {
    ...
    pub fn AppendCookLog(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (logStr))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ClearCookLog(
    ...
    pub fn WriteToLogFile(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (logStr, checkLastLogStr))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
