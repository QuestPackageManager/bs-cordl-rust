...
for crate::HoudiniEngineUnity::HEU_PreAssetEventData {
    ...
    const CLASS_NAME: &'static str = "HEU_PreAssetEventData";
...
impl crate::HoudiniEngineUnity::HEU_PreAssetEventData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_PreAssetEventData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::HoudiniEngineUnity::HEU_HoudiniAsset,
                    >,
                    crate::HoudiniEngineUnity::HEU_AssetEventType,
                ),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_PreAssetEventData as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (asset, assetType))?
        };
        Ok(__cordl_ret.into())
    }
}
