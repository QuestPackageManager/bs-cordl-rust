...
for crate::HoudiniEngineUnity::HEU_TOPNetworkData {
    ...
    const CLASS_NAME: &'static str = "HEU_TOPNetworkData";
...
impl crate::HoudiniEngineUnity::HEU_TOPNetworkData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_TOPNetworkData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HoudiniEngineUnity::HEU_TOPNetworkData as
