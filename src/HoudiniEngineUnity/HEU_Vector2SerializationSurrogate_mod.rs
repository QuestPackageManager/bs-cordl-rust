...
for crate::HoudiniEngineUnity::HEU_Vector2SerializationSurrogate {
    ...
    const CLASS_NAME: &'static str = "HEU_Vector2SerializationSurrogate";
...
impl crate::HoudiniEngineUnity::HEU_Vector2SerializationSurrogate {
    ...
    pub fn System_Runtime_Serialization_ISerializationSurrogate_GetObjectData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_Vector2SerializationSurrogate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_Vector2SerializationSurrogate as
