#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_Vector2SerializationSurrogate")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_Vector2SerializationSurrogate {
    ...
    pub fn System_Runtime_Serialization_ISerializationSurrogate_GetObjectData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (obj, info, context))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (obj, info, context, selector))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
