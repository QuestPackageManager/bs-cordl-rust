...
for crate::HoudiniEngineUnity::Test_Terrain_Extensions {
    ...
    const CLASS_NAME: &'static str = "Test_Terrain_Extensions";
...
impl crate::HoudiniEngineUnity::Test_Terrain_Extensions {
    pub fn ToTestObject_Il2CppArray1(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::Test_Terrain_Extensions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Terrain>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::Test_Terrain_Extensions as
