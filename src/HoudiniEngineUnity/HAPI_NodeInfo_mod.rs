#[cfg(feature = "cordl_class_HoudiniEngineUnity+HAPI_NodeInfo")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HAPI_NodeInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::HAPI_NodeInfo {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "HAPI_NodeInfo";
...
#[cfg(feature = "cordl_class_HoudiniEngineUnity+HAPI_NodeInfo")]
unsafe impl quest_hook::libil2cpp::Return for crate::HoudiniEngineUnity::HAPI_NodeInfo {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
