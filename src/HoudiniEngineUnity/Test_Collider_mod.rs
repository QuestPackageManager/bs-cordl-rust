...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::HoudiniEngineUnity::Test_Collider =>
...
impl crate::HoudiniEngineUnity::Test_Collider {
    pub fn IsEquivalentTo(
        &mut self,
        other: *mut crate::HoudiniEngineUnity::Test_Collider,
    ...
    pub fn New(
        _cordl_self: *mut crate::UnityEngine::Collider,
