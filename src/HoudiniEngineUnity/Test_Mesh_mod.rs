...
#[cfg(feature = "HoudiniEngineUnity+Test_Mesh")]
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::Test_Mesh {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "Test_Mesh";
...
impl crate::HoudiniEngineUnity::Test_Mesh {
    pub fn IsEquivalentTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::Test_Mesh as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::Test_Mesh as quest_hook::libil2cpp::Type
                    > ::class(), "IsEquivalentTo", 1usize
                )
            });
