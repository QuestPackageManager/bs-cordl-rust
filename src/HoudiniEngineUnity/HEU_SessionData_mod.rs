#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_SessionData")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_SessionData {
    ...
    pub fn SetSessionSync(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (syncData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
