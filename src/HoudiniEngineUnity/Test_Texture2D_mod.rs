...
unsafe impl quest_hook::libil2cpp::Type for crate::HoudiniEngineUnity::Test_Texture2D {
    ...
    const CLASS_NAME: &'static str = "Test_Texture2D";
...
impl crate::HoudiniEngineUnity::Test_Texture2D {
    pub fn IsEquivalentTo(
        &mut self,
        other: quest_hook::libil2cpp::Gc<crate::HoudiniEngineUnity::Test_Texture2D>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::Test_Texture2D as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::Test_Texture2D as
