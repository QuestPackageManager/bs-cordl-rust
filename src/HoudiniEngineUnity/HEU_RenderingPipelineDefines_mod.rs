#[cfg(feature = "cordl_class_HoudiniEngineUnity+HEU_RenderingPipelineDefines")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HoudiniEngineUnity::HEU_RenderingPipelineDefines {
    pub fn AddDefine(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (define))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetDefines(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (definesList))?
        };
        Ok(__cordl_ret.into())
    }
