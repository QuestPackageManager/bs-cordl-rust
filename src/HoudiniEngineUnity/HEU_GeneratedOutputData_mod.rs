...
for crate::HoudiniEngineUnity::HEU_GeneratedOutputData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HoudiniEngineUnity";
    const CLASS_NAME: &'static str = "HEU_GeneratedOutputData";
...
#[cfg(feature = "HoudiniEngineUnity+HEU_GeneratedOutputData")]
impl std::ops::DerefMut for crate::HoudiniEngineUnity::HEU_GeneratedOutputData {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "HoudiniEngineUnity+HEU_GeneratedOutputData")]
impl crate::HoudiniEngineUnity::HEU_GeneratedOutputData {
    pub fn IsEquivalentTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HoudiniEngineUnity::HEU_GeneratedOutputData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HoudiniEngineUnity::HEU_GeneratedOutputData as
