...
impl crate::BeatmapDataLoaderVersion2_6_0AndEarlier::BeatmapDataLoader_BasicEventConverter {
    ...
    pub fn Convert(
        ...
        let __cordl_ret: *mut BeatmapEventData = __cordl_object.invoke("Convert", (e))?;
        Ok(__cordl_ret)
    }
    pub fn New(
        bpmTimeProcessor: *mut IBeatToTimeConverter,
...
impl crate::BeatmapDataLoaderVersion2_6_0AndEarlier::BeatmapDataLoader_ColorNoteConverter {
    ...
    pub fn Convert(
        ...
        let __cordl_ret: *mut BeatmapObjectData = __cordl_object.invoke("Convert", (n))?;
        Ok(__cordl_ret)
    }
    pub fn New(
        bpmTimeProcessor: *mut IBeatToTimeConverter,
...
impl crate::BeatmapDataLoaderVersion2_6_0AndEarlier::BeatmapDataLoader_ObstacleConverter {
    ...
    pub fn Convert(
        ...
        let __cordl_ret: *mut ObstacleData = __cordl_object.invoke("Convert", (o))?;
        Ok(__cordl_ret)
    }
    pub fn New(
        bpmTimeProcessor: *mut IBeatToTimeConverter,
...
impl crate::BeatmapDataLoaderVersion2_6_0AndEarlier::BeatmapDataLoader_SliderConverter {
    ...
    ) -> quest_hook::libil2cpp::Result<*mut SliderData> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut SliderData = __cordl_object.invoke("Convert", (s))?;
        Ok(__cordl_ret)
    }
    pub fn New(
        bpmTimeProcessor: *mut IBeatToTimeConverter,
...
impl crate::BeatmapDataLoaderVersion2_6_0AndEarlier::BeatmapDataLoader_WaypointConverter {
    ...
    ) -> quest_hook::libil2cpp::Result<*mut WaypointData> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut WaypointData = __cordl_object
