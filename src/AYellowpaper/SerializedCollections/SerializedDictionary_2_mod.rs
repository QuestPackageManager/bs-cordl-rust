...
> {
    ...
    pub _serializedList: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<
            crate::AYellowpaper::SerializedCollections::SerializedKeyValuePair_2<
                TKey,
                TValue,
            >,
        >,
...
> crate::AYellowpaper::SerializedCollections::SerializedDictionary_2<TKey, TValue> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SyncDictionaryToBackingField_Editor", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (dictionary, comparer))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (serializedDictionary))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_7(
