...
for crate::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute {
    ...
    const CLASS_NAME: &'static str = "AspMvcMasterLocationFormatAttribute";
...
impl crate::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute
