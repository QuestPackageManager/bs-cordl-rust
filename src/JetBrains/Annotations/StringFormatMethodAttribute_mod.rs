...
pub struct StringFormatMethodAttribute {
    ...
    pub _FormatParameterName_k__BackingField: quest_hook::libil2cpp::Gc<
...
for crate::JetBrains::Annotations::StringFormatMethodAttribute {
    ...
    const CLASS_NAME: &'static str = "StringFormatMethodAttribute";
...
impl crate::JetBrains::Annotations::StringFormatMethodAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::StringFormatMethodAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::StringFormatMethodAttribute as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (formatParameterName))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::StringFormatMethodAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::StringFormatMethodAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "get_FormatParameterName",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::StringFormatMethodAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::StringFormatMethodAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "set_FormatParameterName",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
