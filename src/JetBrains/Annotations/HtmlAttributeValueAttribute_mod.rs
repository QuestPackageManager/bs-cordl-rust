...
for crate::JetBrains::Annotations::HtmlAttributeValueAttribute {
    ...
    const CLASS_NAME: &'static str = "HtmlAttributeValueAttribute";
...
impl crate::JetBrains::Annotations::HtmlAttributeValueAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::HtmlAttributeValueAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::HtmlAttributeValueAttribute as
