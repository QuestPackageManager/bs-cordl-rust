...
for crate::JetBrains::Annotations::RazorHelperCommonAttribute {
    ...
    const CLASS_NAME: &'static str = "RazorHelperCommonAttribute";
...
impl crate::JetBrains::Annotations::RazorHelperCommonAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::RazorHelperCommonAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::RazorHelperCommonAttribute as
