#[cfg(feature = "cordl_class_JetBrains+Annotations+AspMvcTemplateAttribute")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_JetBrains+Annotations+AspMvcTemplateAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::JetBrains::Annotations::AspMvcTemplateAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "JetBrains.Annotations";
    const CLASS_NAME: &'static str = "AspMvcTemplateAttribute";
...
#[cfg(feature = "cordl_class_JetBrains+Annotations+AspMvcTemplateAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::JetBrains::Annotations::AspMvcTemplateAttribute {
