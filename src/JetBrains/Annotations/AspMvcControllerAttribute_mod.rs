#[cfg(feature = "cordl_class_JetBrains+Annotations+AspMvcControllerAttribute")]
#[repr(C)]
...
impl crate::JetBrains::Annotations::AspMvcControllerAttribute {
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (anonymousProperty))? };
        Ok(__cordl_ret.into())
    }
