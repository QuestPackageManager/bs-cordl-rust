...
pub struct RazorInjectionAttribute {
    ...
    pub _FieldName_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_JetBrains+Annotations+RazorInjectionAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::JetBrains::Annotations::RazorInjectionAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "JetBrains.Annotations";
    const CLASS_NAME: &'static str = "RazorInjectionAttribute";
...
impl crate::JetBrains::Annotations::RazorInjectionAttribute {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, fieldName))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_JetBrains+Annotations+RazorInjectionAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::JetBrains::Annotations::RazorInjectionAttribute {
