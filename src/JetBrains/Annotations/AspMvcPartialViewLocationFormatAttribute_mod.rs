#[cfg(feature = "cordl_class_JetBrains+Annotations+AspMvcPartialViewLocationFormatAttribute")]
#[repr(C)]
...
impl std::ops::Deref for crate::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute {
