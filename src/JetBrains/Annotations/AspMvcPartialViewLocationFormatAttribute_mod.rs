...
for crate::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute {
    ...
    const CLASS_NAME: &'static str = "AspMvcPartialViewLocationFormatAttribute";
...
impl crate::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute as
