...
for crate::JetBrains::Annotations::AspRequiredAttributeAttribute {
    ...
    const CLASS_NAME: &'static str = "AspRequiredAttributeAttribute";
...
impl crate::JetBrains::Annotations::AspRequiredAttributeAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspRequiredAttributeAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::AspRequiredAttributeAttribute as
