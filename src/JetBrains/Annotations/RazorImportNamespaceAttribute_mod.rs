#[cfg(feature = "cordl_class_JetBrains+Annotations+RazorImportNamespaceAttribute")]
#[repr(C)]
...
#[cfg(feature = "JetBrains+Annotations+RazorImportNamespaceAttribute")]
impl std::ops::DerefMut for crate::JetBrains::Annotations::RazorImportNamespaceAttribute {
