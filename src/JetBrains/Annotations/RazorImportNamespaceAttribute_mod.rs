...
for crate::JetBrains::Annotations::RazorImportNamespaceAttribute {
    ...
    const CLASS_NAME: &'static str = "RazorImportNamespaceAttribute";
...
impl crate::JetBrains::Annotations::RazorImportNamespaceAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::RazorImportNamespaceAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::RazorImportNamespaceAttribute as
