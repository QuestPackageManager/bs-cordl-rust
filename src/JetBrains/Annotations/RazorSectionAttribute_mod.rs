#[cfg(feature = "cordl_class_JetBrains+Annotations+RazorSectionAttribute")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_JetBrains+Annotations+RazorSectionAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::JetBrains::Annotations::RazorSectionAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "JetBrains.Annotations";
    const CLASS_NAME: &'static str = "RazorSectionAttribute";
...
#[cfg(feature = "cordl_class_JetBrains+Annotations+RazorSectionAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::JetBrains::Annotations::RazorSectionAttribute {
