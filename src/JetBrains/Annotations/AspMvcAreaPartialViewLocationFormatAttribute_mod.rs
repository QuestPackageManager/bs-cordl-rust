...
for crate::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute {
    ...
    const CLASS_NAME: &'static str = "AspMvcAreaPartialViewLocationFormatAttribute";
...
impl crate::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
