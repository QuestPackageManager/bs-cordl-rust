...
impl crate::JetBrains::Annotations::AspTypePropertyAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspTypePropertyAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::AspTypePropertyAttribute as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (createConstructorReferences))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_CreateConstructorReferences(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspTypePropertyAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_CreateConstructorReferences")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::AspTypePropertyAttribute as
                    quest_hook::libil2cpp::Type > ::class(),
                    "get_CreateConstructorReferences", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::AspTypePropertyAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::AspTypePropertyAttribute as
                    quest_hook::libil2cpp::Type > ::class(),
                    "set_CreateConstructorReferences", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
