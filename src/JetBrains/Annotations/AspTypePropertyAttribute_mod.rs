#[cfg(feature = "cordl_class_JetBrains+Annotations+AspTypePropertyAttribute")]
#[repr(C)]
...
impl crate::JetBrains::Annotations::AspTypePropertyAttribute {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (createConstructorReferences))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_CreateConstructorReferences(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_JetBrains+Annotations+AspTypePropertyAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::JetBrains::Annotations::AspTypePropertyAttribute {
