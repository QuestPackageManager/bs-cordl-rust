...
for crate::JetBrains::Annotations::RazorPageBaseTypeAttribute {
    ...
    const CLASS_NAME: &'static str = "RazorPageBaseTypeAttribute";
...
impl crate::JetBrains::Annotations::RazorPageBaseTypeAttribute {
    ...
    pub fn _ctor_Il2CppString0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::RazorPageBaseTypeAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::RazorPageBaseTypeAttribute as
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (baseType, pageName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_BaseType(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::RazorPageBaseTypeAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::RazorPageBaseTypeAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "get_PageName", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::RazorPageBaseTypeAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::JetBrains::Annotations::RazorPageBaseTypeAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "set_PageName", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
