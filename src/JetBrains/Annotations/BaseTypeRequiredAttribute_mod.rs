...
for crate::JetBrains::Annotations::BaseTypeRequiredAttribute {
    ...
    const CLASS_NAME: &'static str = "BaseTypeRequiredAttribute";
...
impl crate::JetBrains::Annotations::BaseTypeRequiredAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::JetBrains::Annotations::BaseTypeRequiredAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::JetBrains::Annotations::BaseTypeRequiredAttribute as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (baseType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_BaseType(
