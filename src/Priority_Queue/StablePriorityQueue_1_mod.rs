...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Priority_Queue::StablePriorityQueue_1 < T > =>
    "Priority_Queue"."StablePriorityQueue`1" < T >
);
#[cfg(feature = "Priority_Queue+StablePriorityQueue_1")]
...
impl<T: quest_hook::libil2cpp::Type> crate::Priority_Queue::StablePriorityQueue_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = __cordl_object.invoke("get_First", ())?;
        Ok(__cordl_ret.into())
    }
