    ...
    for crate::Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Priority_Queue", "GenericPriorityQueue`2")
                .unwrap()
    ...
    crate::Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (maxNodes, comparer))? };
        Ok(__cordl_ret.into())
    }
...
impl<TItem: quest_hook::libil2cpp::Type, TPriority: quest_hook::libil2cpp::Type>
    ...
    for crate::Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>
{
    fn as_ref(&self) -> &crate::Priority_Queue::IFixedSizePriorityQueue_2<TItem, TPriority> {
