...
> crate::Priority_Queue::GenericPriorityQueue_2<TItem, TPriority> {
    ...
    pub fn _ctor_IComparer_1_1(
        &mut self,
        maxNodes: i32,
        comparer: *mut crate::System::Collections::Generic::IComparer_1<TPriority>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TItem: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    ...
    pub fn _ctor_Comparison_1_2(
        &mut self,
        maxNodes: i32,
        comparer: *mut crate::System::Comparison_1<TPriority>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TItem: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    ...
    pub fn New_i32_0(maxNodes: i32) -> quest_hook::libil2cpp::Result<&'static mut Self> {
