...
> {
    ...
    pub _comparer: quest_hook::libil2cpp::Gc<TPriority>,
...
> crate::Priority_Queue::GenericPriorityQueue_2<TItem, TPriority> {
    ...
    pub fn New_Gc1(
        maxNodes: i32,
        comparer: quest_hook::libil2cpp::Gc<TPriority>,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (i32, quest_hook::libil2cpp::Gc<TPriority>),
                        quest_hook::libil2cpp::Void,
                        2usize,
                    >(".ctor")
                    .unwrap_or_else(|e| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (maxNodes, comparer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Gc2(
