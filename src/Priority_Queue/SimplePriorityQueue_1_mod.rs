...
#[cfg(feature = "cordl_class_Priority_Queue+SimplePriorityQueue_1")]
unsafe impl<TItem: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::Priority_Queue::SimplePriorityQueue_1<TItem>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Priority_Queue";
    const CLASS_NAME: &'static str = "SimplePriorityQueue`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Priority_Queue", "SimplePriorityQueue`1")
                .unwrap()
                .make_generic::<(TItem)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Priority_Queue+SimplePriorityQueue_1")]
impl<TItem: quest_hook::libil2cpp::Type> crate::Priority_Queue::SimplePriorityQueue_1<TItem> {
    ...
    pub fn New_IComparer_1_1(
        comparer: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IComparer_1<f32>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>>
    where
        TItem: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<crate::System::Comparison_1<f32>>),
