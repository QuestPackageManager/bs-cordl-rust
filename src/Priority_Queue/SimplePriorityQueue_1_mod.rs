...
> crate::Priority_Queue::SimplePriorityQueue_1<TItem> {
    ...
    where
        TItem: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Priority_Queue::SimplePriorityQueue_1<
            TItem,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Priority_Queue::SimplePriorityQueue_1 < TItem > as
