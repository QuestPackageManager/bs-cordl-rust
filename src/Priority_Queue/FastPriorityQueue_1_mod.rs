...
for crate::Priority_Queue::FastPriorityQueue_1<T> {
    ...
    const CLASS_NAME: &'static str = "FastPriorityQueue`1";
...
impl<T: quest_hook::libil2cpp::Type> crate::Priority_Queue::FastPriorityQueue_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Priority_Queue::FastPriorityQueue_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Priority_Queue::FastPriorityQueue_1 < T > as
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Priority_Queue::FastPriorityQueue_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(T, T), bool, 2usize>("HasHigherOrEqualPriority")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Priority_Queue::FastPriorityQueue_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "HasHigherOrEqualPriority",
                    2usize
                )
            });
