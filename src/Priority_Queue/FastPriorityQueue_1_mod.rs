...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Priority_Queue::FastPriorityQueue_1 < T > =>
    "Priority_Queue"."FastPriorityQueue`1" < T >
);
#[cfg(feature = "Priority_Queue+FastPriorityQueue_1")]
...
#[cfg(feature = "Priority_Queue+FastPriorityQueue_1")]
impl<T: quest_hook::libil2cpp::Type> crate::Priority_Queue::FastPriorityQueue_1<T> {
    #[cfg(feature = "Priority_Queue+FastPriorityQueue_1+_GetEnumerator_d__22")]
    pub type _GetEnumerator_d__22 = crate::Priority_Queue::FastPriorityQueue_1__GetEnumerator_d__22<
        T,
    >;
    pub fn CascadeDown(
        &mut self,
    ...
    pub fn HasHigherOrEqualPriority(
        &mut self,
        higher: T,
        lower: T,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = __cordl_object
            .invoke("HasHigherOrEqualPriority", (higher, lower))?;
        Ok(__cordl_ret)
    }
