...
unsafe impl<TItem: quest_hook::libil2cpp::Type, TPriority: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Priority_Queue::IPriorityQueue_2<TItem, TPriority>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Priority_Queue", "IPriorityQueue`2")
                .unwrap()
