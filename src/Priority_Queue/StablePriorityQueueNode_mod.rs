...
for crate::Priority_Queue::StablePriorityQueueNode {
    ...
    const CLASS_NAME: &'static str = "StablePriorityQueueNode";
...
impl crate::Priority_Queue::StablePriorityQueueNode {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Priority_Queue::StablePriorityQueueNode as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Priority_Queue::StablePriorityQueueNode as
