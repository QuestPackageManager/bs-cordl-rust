...
unsafe impl quest_hook::libil2cpp::Type for crate::SFB::ExtensionFilter {
    ...
    const CLASS_NAME: &'static str = "ExtensionFilter";
...
impl crate::SFB::ExtensionFilter {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::SFB::ExtensionFilter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::SFB::ExtensionFilter as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (filterName, filterExtensions))?
        };
        Ok(__cordl_ret.into())
    }
}
