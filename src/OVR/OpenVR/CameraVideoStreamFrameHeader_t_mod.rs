...
#[cfg(feature = "cordl_class_OVR+OpenVR+CameraVideoStreamFrameHeader_t")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::CameraVideoStreamFrameHeader_t {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "CameraVideoStreamFrameHeader_t";
...
#[cfg(feature = "cordl_class_OVR+OpenVR+CameraVideoStreamFrameHeader_t")]
unsafe impl quest_hook::libil2cpp::Argument for crate::OVR::OpenVR::CameraVideoStreamFrameHeader_t {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVR+OpenVR+CameraVideoStreamFrameHeader_t")]
unsafe impl quest_hook::libil2cpp::Returned for crate::OVR::OpenVR::CameraVideoStreamFrameHeader_t {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+CameraVideoStreamFrameHeader_t")]
unsafe impl quest_hook::libil2cpp::Return for crate::OVR::OpenVR::CameraVideoStreamFrameHeader_t {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
