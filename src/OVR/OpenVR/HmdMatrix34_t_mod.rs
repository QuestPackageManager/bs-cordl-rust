#[cfg(feature = "cordl_class_OVR+OpenVR+HmdMatrix34_t")]
...
#[cfg(feature = "cordl_class_OVR+OpenVR+HmdMatrix34_t")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::HmdMatrix34_t {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "HmdMatrix34_t";
