...
#[cfg(feature = "cordl_class_OVR+OpenVR+Compositor_FrameTiming")]
unsafe impl quest_hook::libil2cpp::Argument for crate::OVR::OpenVR::Compositor_FrameTiming {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVR+OpenVR+Compositor_FrameTiming")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::OVR::OpenVR::Compositor_FrameTiming {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+Compositor_FrameTiming")]
unsafe impl quest_hook::libil2cpp::Returned for crate::OVR::OpenVR::Compositor_FrameTiming {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+Compositor_FrameTiming")]
unsafe impl quest_hook::libil2cpp::Return for crate::OVR::OpenVR::Compositor_FrameTiming {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+Compositor_FrameTiming")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::OVR::OpenVR::Compositor_FrameTiming {
    type Type = Self;
