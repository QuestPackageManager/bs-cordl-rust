...
impl crate::OVR::OpenVR::IVROverlay__SetKeyboardPositionForOverlay {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method.invoke_unchecked(self, (ulOverlayHandle, avoidRect, callback, object))
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
...
impl crate::OVR::OpenVR::IVROverlay__SetOverlayTransformAbsolute {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EVROverlayError = unsafe {
            method.invoke_unchecked(self, (pmatTrackingOriginToOverlayTransform, result))
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
