...
for crate::OVR::OpenVR::VRControllerState_t_Packed {
    ...
    const CLASS_NAME: &'static str = "VRControllerState_t_Packed";
...
impl crate::OVR::OpenVR::VRControllerState_t_Packed {
    pub fn Unpack(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::OVR::OpenVR::VRControllerState_t_Packed as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::OVR::OpenVR::VRControllerState_t_Packed as
