...
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::InputPoseActionData_t {
    ...
    const CLASS_NAME: &'static str = "InputPoseActionData_t";
...
#[cfg(feature = "cordl_class_OVR+OpenVR+InputPoseActionData_t")]
unsafe impl quest_hook::libil2cpp::Argument for crate::OVR::OpenVR::InputPoseActionData_t {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVR+OpenVR+InputPoseActionData_t")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::OVR::OpenVR::InputPoseActionData_t {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+InputPoseActionData_t")]
unsafe impl quest_hook::libil2cpp::Returned for crate::OVR::OpenVR::InputPoseActionData_t {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+InputPoseActionData_t")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::OVR::OpenVR::InputPoseActionData_t {
    type Type = Self;
