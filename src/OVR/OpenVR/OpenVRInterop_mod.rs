#[cfg(feature = "cordl_class_OVR+OpenVR+OpenVRInterop")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_OVR+OpenVR+OpenVRInterop")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::OpenVRInterop {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "OpenVRInterop";
...
impl crate::OVR::OpenVR::OpenVRInterop {
    ...
    pub fn InitInternal2(
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked((), (peError, eApplicationType, pStartupInfo))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsInterfaceVersionValid(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::ByRef<
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    >), bool, 1usize>("IsInterfaceVersionValid")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
