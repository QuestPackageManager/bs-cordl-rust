...
impl crate::OVR::OpenVR::IVRSpatialAnchors__CreateSpatialAnchorFromDescriptor {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EVRSpatialAnchorError = unsafe {
            cordl_method_info.invoke_unchecked(self, (pHandleOut, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRSpatialAnchors__CreateSpatialAnchorFromPose {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EVRSpatialAnchorError = unsafe {
            cordl_method_info.invoke_unchecked(self, (pPose, pHandleOut, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRSpatialAnchors__GetSpatialAnchorDescriptor {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EVRSpatialAnchorError = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (punDescriptorBufferLenInOut, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRSpatialAnchors__GetSpatialAnchorPose {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EVRSpatialAnchorError = unsafe {
            cordl_method_info.invoke_unchecked(self, (pPoseOut, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
