#[cfg(feature = "cordl_class_OVR+OpenVR+RenderModel_ControllerMode_State_t")]
...
#[cfg(feature = "cordl_class_OVR+OpenVR+RenderModel_ControllerMode_State_t")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::RenderModel_ControllerMode_State_t {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "RenderModel_ControllerMode_State_t";
