...
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::VREvent_Scroll_t {
    ...
    const CLASS_NAME: &'static str = "VREvent_Scroll_t";
...
#[cfg(feature = "cordl_class_OVR+OpenVR+VREvent_Scroll_t")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::OVR::OpenVR::VREvent_Scroll_t {
    type Type = Self;
...
impl crate::OVR::OpenVR::VREvent_Scroll_t {}
