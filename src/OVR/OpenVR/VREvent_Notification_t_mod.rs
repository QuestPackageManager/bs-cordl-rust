...
#[cfg(feature = "cordl_class_OVR+OpenVR+VREvent_Notification_t")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::VREvent_Notification_t {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "VREvent_Notification_t";
...
#[cfg(feature = "OVR+OpenVR+VREvent_Notification_t")]
impl crate::OVR::OpenVR::VREvent_Notification_t {}
