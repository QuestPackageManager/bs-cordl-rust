#[cfg(feature = "cordl_class_OVR+OpenVR+EVRRenderModelError")]
...
#[cfg(feature = "cordl_class_OVR+OpenVR+EVRRenderModelError")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::EVRRenderModelError {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "EVRRenderModelError";
...
#[cfg(feature = "cordl_class_OVR+OpenVR+EVRRenderModelError")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::OVR::OpenVR::EVRRenderModelError {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
