...
impl crate::OVR::OpenVR::IVRIOBuffer__Close {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (ulBuffer, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
...
impl crate::OVR::OpenVR::IVRIOBuffer__Open {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EIOBufferError = unsafe {
            cordl_method_info.invoke_unchecked(self, (pulBuffer, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRIOBuffer__Read {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: crate::OVR::OpenVR::EIOBufferError = unsafe {
            cordl_method_info.invoke_unchecked(self, (punRead, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRIOBuffer__Write {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (ulBuffer, pSrc, unBytes, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
