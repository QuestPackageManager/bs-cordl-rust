...
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::VREvent_Keyboard_t {
    ...
    const CLASS_NAME: &'static str = "VREvent_Keyboard_t";
...
impl crate::OVR::OpenVR::VREvent_Keyboard_t {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::OVR::OpenVR::VREvent_Keyboard_t as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::OVR::OpenVR::VREvent_Keyboard_t as
                    quest_hook::libil2cpp::Type > ::class(), "get_cNewInput", 0usize
                )
            });
