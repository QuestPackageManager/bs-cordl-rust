...
impl crate::OVR::OpenVR::IVRChaperone__ForceBoundsVisible {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (bForce, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bForce))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::OVR::OpenVR::IVRChaperone__GetPlayAreaRect {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (rect, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (rect, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRChaperone__GetPlayAreaSize {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (pSizeX, pSizeZ, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
...
impl crate::OVR::OpenVR::IVRChaperone__SetSceneColor {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (color, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
