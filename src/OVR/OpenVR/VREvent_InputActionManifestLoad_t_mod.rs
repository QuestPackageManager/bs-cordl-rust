...
#[cfg(feature = "cordl_class_OVR+OpenVR+VREvent_InputActionManifestLoad_t")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::VREvent_InputActionManifestLoad_t {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "VREvent_InputActionManifestLoad_t";
