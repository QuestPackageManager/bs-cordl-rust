...
impl crate::OVR::OpenVR::IVRSettings__GetBool {
    ...
    pub fn EndInvoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (peError, result))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (pchSection, pchSettingsKey, peError))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::OVR::OpenVR::IVRSettings__GetSettingsErrorNameFromEnum {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (eError, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked(self, (eError))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::OVR::OpenVR::IVRSettings__RemoveSection {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (pchSection, peError, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pchSection, peError))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::OVR::OpenVR::IVRSettings__Sync {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bForce, peError, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (bForce, peError))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
