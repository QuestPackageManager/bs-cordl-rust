...
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::EVRControllerAxisType {
    ...
    const CLASS_NAME: &'static str = "EVRControllerAxisType";
...
#[cfg(feature = "cordl_class_OVR+OpenVR+EVRControllerAxisType")]
unsafe impl quest_hook::libil2cpp::Argument for crate::OVR::OpenVR::EVRControllerAxisType {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVR+OpenVR+EVRControllerAxisType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::OVR::OpenVR::EVRControllerAxisType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+EVRControllerAxisType")]
unsafe impl quest_hook::libil2cpp::Returned for crate::OVR::OpenVR::EVRControllerAxisType {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
