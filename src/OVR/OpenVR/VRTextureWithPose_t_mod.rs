#[cfg(feature = "cordl_class_OVR+OpenVR+VRTextureWithPose_t")]
...
#[cfg(feature = "cordl_class_OVR+OpenVR+VRTextureWithPose_t")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVR::OpenVR::VRTextureWithPose_t {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "OVR.OpenVR";
    const CLASS_NAME: &'static str = "VRTextureWithPose_t";
...
#[cfg(feature = "cordl_class_OVR+OpenVR+VRTextureWithPose_t")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::OVR::OpenVR::VRTextureWithPose_t {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVR+OpenVR+VRTextureWithPose_t")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::OVR::OpenVR::VRTextureWithPose_t {
    type Type = Self;
