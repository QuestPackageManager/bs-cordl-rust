...
pub struct RingBuffer_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _entries: *mut quest_hook::libil2cpp::Il2CppArray<T>,
    pub _modMask: i32,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::IgnoranceThirdparty::RingBuffer_1 < T > =>
    "IgnoranceThirdparty"."RingBuffer`1" < T >
);
#[cfg(feature = "IgnoranceThirdparty+RingBuffer_1")]
