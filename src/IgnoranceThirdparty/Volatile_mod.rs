...
#[cfg(feature = "cordl_class_IgnoranceThirdparty+Volatile+PaddedLong")]
unsafe impl quest_hook::libil2cpp::Type for crate::IgnoranceThirdparty::Volatile_PaddedLong {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "IgnoranceThirdparty";
...
#[cfg(feature = "cordl_class_IgnoranceThirdparty+Volatile+PaddedLong")]
unsafe impl quest_hook::libil2cpp::Argument for crate::IgnoranceThirdparty::Volatile_PaddedLong {
    type Type = Self;
...
#[cfg(feature = "cordl_class_IgnoranceThirdparty+Volatile+PaddedLong")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::IgnoranceThirdparty::Volatile_PaddedLong {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_IgnoranceThirdparty+Volatile+PaddedLong")]
unsafe impl quest_hook::libil2cpp::Returned for crate::IgnoranceThirdparty::Volatile_PaddedLong {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_IgnoranceThirdparty+Volatile+PaddedLong")]
unsafe impl quest_hook::libil2cpp::Return for crate::IgnoranceThirdparty::Volatile_PaddedLong {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::IgnoranceThirdparty::Volatile_PaddedLong {
    pub fn AtomicAddAndGet(&mut self, delta: i64) -> quest_hook::libil2cpp::Result<i64> {
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (delta))? };
        Ok(__cordl_ret.into())
    }
    pub fn AtomicCompareExchange(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (newValue, comparand))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AtomicExchange(&mut self, newValue: i64) -> quest_hook::libil2cpp::Result<i64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (newValue))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteReleaseFence(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64), quest_hook::libil2cpp::Void, 1usize>("WriteReleaseFence")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
