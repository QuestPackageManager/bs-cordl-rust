#[cfg(feature = "cordl_class_LiteNetLib+LocalAddrType")]
#[repr(i32)]
...
#[cfg(feature = "cordl_class_LiteNetLib+LocalAddrType")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::LocalAddrType {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "LiteNetLib";
    const CLASS_NAME: &'static str = "LocalAddrType";
