...
pub struct NetPacketProcessor {
    ...
    pub _callbacks: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _netDataWriter: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataWriter>,
}
#[cfg(feature = "cordl_class_LiteNetLib+Utils+NetPacketProcessor")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::Utils::NetPacketProcessor {
...
impl crate::LiteNetLib::Utils::NetPacketProcessor {
    ...
    pub type HashCache_1<T: quest_hook::libil2cpp::Type> =
    ...
    pub fn GetCallbackFromData(
        ...
        quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetPacketProcessor_SubscribeDelegate>,
    > {
    ...
    pub fn ReadAllPackets_Il2CppObject1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("ReadAllPackets")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (reader, userData))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataReader>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), quest_hook::libil2cpp::Void, 2usize>("ReadPacket")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (writeDelegate, readDelegate))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (manager, packet, options))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (peer, packet, options))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (onReceive))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (onReceive, packetConstructor))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "LiteNetLib+Utils+NetPacketProcessor+HashCache_1")]
impl<T: quest_hook::libil2cpp::Type> crate::LiteNetLib::Utils::NetPacketProcessor_HashCache_1<T> {}
#[cfg(feature = "cordl_class_LiteNetLib+Utils+NetPacketProcessor+HashCache_1")]
...
#[cfg(feature = "LiteNetLib+Utils+NetPacketProcessor+SubscribeDelegate")]
impl std::ops::DerefMut for crate::LiteNetLib::Utils::NetPacketProcessor_SubscribeDelegate {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::LiteNetLib::Utils::NetPacketProcessor_SubscribeDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (reader, userData, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
