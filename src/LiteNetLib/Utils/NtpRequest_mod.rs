...
pub struct NtpRequest {
    ...
    pub _onRequestComplete: quest_hook::libil2cpp::Gc<
        crate::System::Action_1<quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpPacket>>,
    >,
...
impl crate::LiteNetLib::Utils::NtpRequest {
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpRequest>, 2usize>(
                        "Create",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpRequest> =
            unsafe { cordl_method_info.invoke_unchecked((), (ipAddress, onRequestComplete))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpRequest> =
            unsafe { cordl_method_info.invoke_unchecked((), (endPoint, onRequestComplete))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpRequest> = unsafe {
            cordl_method_info.invoke_unchecked((), (ntpServerAddress, onRequestComplete))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpRequest>, 3usize>(
                        "Create",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NtpRequest> = unsafe {
            cordl_method_info.invoke_unchecked((), (ntpServerAddress, port, onRequestComplete))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (endPoint, onRequestComplete))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_LiteNetLib+Utils+NtpRequest")]
...
#[cfg(feature = "LiteNetLib+Utils+NtpRequest")]
impl AsRef<crate::LiteNetLib::INetSocketListener> for crate::LiteNetLib::Utils::NtpRequest {
    fn as_ref(&self) -> &crate::LiteNetLib::INetSocketListener {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "LiteNetLib+Utils+NtpRequest")]
impl AsMut<crate::LiteNetLib::INetSocketListener> for crate::LiteNetLib::Utils::NtpRequest {
