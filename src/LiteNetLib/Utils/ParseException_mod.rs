...
#[cfg(feature = "LiteNetLib+Utils+ParseException")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::Utils::ParseException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "LiteNetLib.Utils";
    const CLASS_NAME: &'static str = "ParseException";
...
impl crate::LiteNetLib::Utils::ParseException {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LiteNetLib::Utils::ParseException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::LiteNetLib::Utils::ParseException as
