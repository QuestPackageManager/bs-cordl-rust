#[cfg(feature = "cordl_class_LiteNetLib+Utils+InvalidTypeException")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_LiteNetLib+Utils+InvalidTypeException")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::Utils::InvalidTypeException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "LiteNetLib.Utils";
    const CLASS_NAME: &'static str = "InvalidTypeException";
...
#[cfg(feature = "cordl_class_LiteNetLib+Utils+InvalidTypeException")]
impl quest_hook::libil2cpp::ObjectType for crate::LiteNetLib::Utils::InvalidTypeException {
