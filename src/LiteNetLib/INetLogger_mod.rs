#[cfg(feature = "cordl_class_LiteNetLib+INetLogger")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_LiteNetLib+INetLogger")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::INetLogger {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "LiteNetLib";
    const CLASS_NAME: &'static str = "INetLogger";
...
impl crate::LiteNetLib::INetLogger {
    pub fn WriteNet(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("WriteNet")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (level, str, args))? };
        Ok(__cordl_ret.into())
    }
