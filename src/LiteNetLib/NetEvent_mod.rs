...
impl crate::LiteNetLib::NetEvent {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LiteNetLib::NetEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::LiteNetLib::NetEvent as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 1usize
                )
            });
