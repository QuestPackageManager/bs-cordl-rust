...
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::Layers::XorEncryptLayer {
    ...
    const CLASS_NAME: &'static str = "XorEncryptLayer";
...
impl crate::LiteNetLib::Layers::XorEncryptLayer {
    ...
    pub fn ProcessInboundPacket(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LiteNetLib::Layers::XorEncryptLayer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::LiteNetLib::Layers::XorEncryptLayer as
