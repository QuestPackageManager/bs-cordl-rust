...
impl crate::LiteNetLib::Layers::Crc32cLayer {
    ...
    pub fn ProcessInboundPacket(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LiteNetLib::Layers::Crc32cLayer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::LiteNetLib::Layers::Crc32cLayer as
