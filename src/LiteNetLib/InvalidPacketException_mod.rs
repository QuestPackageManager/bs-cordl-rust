...
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::InvalidPacketException {
    ...
    const CLASS_NAME: &'static str = "InvalidPacketException";
...
#[cfg(feature = "LiteNetLib+InvalidPacketException")]
impl crate::LiteNetLib::InvalidPacketException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LiteNetLib::InvalidPacketException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::LiteNetLib::InvalidPacketException as
