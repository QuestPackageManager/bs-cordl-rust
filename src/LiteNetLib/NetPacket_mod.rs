...
impl crate::LiteNetLib::NetPacket {
    pub fn FromBytes(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (data, start, packetSize))?
        };
        Ok(__cordl_ret.into())
    }
