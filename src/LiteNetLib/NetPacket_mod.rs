#[cfg(feature = "cordl_class_LiteNetLib+NetPacket")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_LiteNetLib+NetPacket")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::NetPacket {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "LiteNetLib";
    const CLASS_NAME: &'static str = "NetPacket";
...
impl crate::LiteNetLib::NetPacket {
    pub fn FromBytes(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, start, packetSize))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetHeaderSize_PacketProperty0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::LiteNetLib::PacketProperty), i32, 1usize>(
                        "GetHeaderSize",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (property))? };
        Ok(__cordl_ret.into())
    }
    pub fn MarkFragmented(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_Property(
        ...
        let __cordl_ret: crate::LiteNetLib::PacketProperty =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_FragmentPart(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u16), quest_hook::libil2cpp::Void, 1usize>("set_FragmentPart")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_FragmentsTotal(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u16), quest_hook::libil2cpp::Void, 1usize>("set_FragmentsTotal")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
