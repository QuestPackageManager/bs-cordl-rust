#[cfg(feature = "cordl_class_LiteNetLib+NetSocket")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::LiteNetLib::NetSocket {
    ...
    pub fn BindSocket(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (socket, ep, reuseAddress))? };
        Ok(__cordl_ret.into())
    }
    pub fn Close(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (suspend))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SendBroadcast(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, offset, _cordl_size, port))? };
        Ok(__cordl_ret.into())
    }
    pub fn SendTo(
        &mut self,
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (data, offset, _cordl_size, remoteEndPoint, errorCode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
    ...
    pub fn set_LocalPort(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_LocalPort")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
