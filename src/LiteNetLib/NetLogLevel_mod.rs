#[cfg(feature = "cordl_class_LiteNetLib+NetLogLevel")]
#[repr(i32)]
...
#[cfg(feature = "cordl_class_LiteNetLib+NetLogLevel")]
unsafe impl quest_hook::libil2cpp::Type for crate::LiteNetLib::NetLogLevel {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "LiteNetLib";
    const CLASS_NAME: &'static str = "NetLogLevel";
