...
impl crate::Newtonsoft::Json::JsonSerializer {
    pub fn CreateTraceJsonReader(
        ...
        *mut crate::Newtonsoft::Json::Serialization::TraceJsonReader,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Newtonsoft::Json::Serialization::TraceJsonReader = __cordl_object
            .invoke("CreateTraceJsonReader", (reader))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn Deserialize_JsonReader_Type3(
        ...
        let __cordl_ret: *mut quest_hook::libil2cpp::Il2CppObject = __cordl_object
            .invoke("Deserialize", (reader, objectType))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn GetMatchingConverter(
        ...
        let __cordl_ret: *mut crate::Newtonsoft::Json::JsonConverter = __cordl_object
            .invoke("GetMatchingConverter", (_cordl_type))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn OnError(
        &mut self,
        e: *mut crate::Newtonsoft::Json::Serialization::ErrorEventArgs,
    ...
    pub fn ResetReader(
        &mut self,
        reader: *mut crate::Newtonsoft::Json::JsonReader,
        previousCulture: *mut crate::System::Globalization::CultureInfo,
        ...
        previousDateFormatString: *mut quest_hook::libil2cpp::Il2CppString,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
    ...
    pub fn get_Converters(
        ...
        *mut crate::Newtonsoft::Json::JsonConverterCollection,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Newtonsoft::Json::JsonConverterCollection = __cordl_object
            .invoke("get_Converters", ())?;
        Ok(__cordl_ret)
    }
    pub fn get_Culture(
        &mut self,
