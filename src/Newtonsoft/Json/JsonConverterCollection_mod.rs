#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonConverterCollection")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonConverterCollection")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonConverterCollection {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json";
    const CLASS_NAME: &'static str = "JsonConverterCollection";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonConverterCollection")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::JsonConverterCollection {
