#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonContainerAttribute")]
#[repr(C)]
...
pub struct JsonContainerAttribute {
    ...
    pub _ItemConverterParameters_k__BackingField: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _NamingStrategyInstance_k__BackingField:
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonContainerAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonContainerAttribute {
...
impl crate::Newtonsoft::Json::JsonContainerAttribute {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_NamingStrategyInstance")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_NamingStrategyInstance(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Serialization::NamingStrategy>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonContainerAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::JsonContainerAttribute {
