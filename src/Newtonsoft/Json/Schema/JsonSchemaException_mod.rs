#[cfg(feature = "cordl_class_Newtonsoft+Json+Schema+JsonSchemaException")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Schema+JsonSchemaException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Schema::JsonSchemaException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Schema";
    const CLASS_NAME: &'static str = "JsonSchemaException";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Schema+JsonSchemaException")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Schema::JsonSchemaException {
