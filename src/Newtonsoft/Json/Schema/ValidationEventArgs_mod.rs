...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Schema+ValidationEventArgs")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Schema::ValidationEventArgs {
...
impl crate::Newtonsoft::Json::Schema::ValidationEventArgs {
    pub fn New(
        ex: quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Schema::JsonSchemaException>,
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Schema+ValidationEventArgs")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Schema::ValidationEventArgs {
