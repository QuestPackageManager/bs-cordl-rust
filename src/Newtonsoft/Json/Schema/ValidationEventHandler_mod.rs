...
impl crate::Newtonsoft::Json::Schema::ValidationEventHandler {
    pub fn BeginInvoke(
        ...
        e: quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Schema::ValidationEventArgs>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (sender, e, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Schema+ValidationEventHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Schema::ValidationEventHandler {
