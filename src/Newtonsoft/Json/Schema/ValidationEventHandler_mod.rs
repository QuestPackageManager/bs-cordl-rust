...
for crate::Newtonsoft::Json::Schema::ValidationEventHandler {
    ...
    const CLASS_NAME: &'static str = "ValidationEventHandler";
...
#[cfg(feature = "Newtonsoft+Json+Schema+ValidationEventHandler")]
impl crate::Newtonsoft::Json::Schema::ValidationEventHandler {
    pub fn BeginInvoke(
        &mut self,
        sender: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
        e: quest_hook::libil2cpp::Gc<
            crate::Newtonsoft::Json::Schema::ValidationEventArgs,
        >,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Schema::ValidationEventHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Schema::ValidationEventHandler as
                    quest_hook::libil2cpp::Type > ::class(), "BeginInvoke", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method.invoke_unchecked(self, (sender, e, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
