...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Newtonsoft::Json::Schema::ValidationEventHandler
...
impl crate::Newtonsoft::Json::Schema::ValidationEventHandler {
    pub fn BeginInvoke(
        ...
        e: *mut crate::Newtonsoft::Json::Schema::ValidationEventArgs,
        ...
        let __cordl_ret: *mut crate::System::IAsyncResult = __cordl_object
            .invoke("BeginInvoke", (sender, e, callback, object))?;
        Ok(__cordl_ret)
    }
    pub fn EndInvoke(
        &mut self,
