...
impl crate::Newtonsoft::Json::JsonSerializationException {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::JsonSerializationException as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::JsonSerializationException as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Newtonsoft::Json::JsonSerializationException,
        > = unsafe { method.invoke_unchecked((), (lineInfo, path, message, ex))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Newtonsoft::Json::JsonSerializationException,
        > = unsafe { method.invoke_unchecked((), (reader, message))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Newtonsoft::Json::JsonSerializationException,
        > = unsafe { method.invoke_unchecked((), (reader, message, ex))? };
        Ok(__cordl_ret.into())
    }
