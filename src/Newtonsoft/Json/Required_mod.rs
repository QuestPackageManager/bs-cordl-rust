#[cfg(feature = "cordl_class_Newtonsoft+Json+Required")]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Required")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Required {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json";
    const CLASS_NAME: &'static str = "Required";
