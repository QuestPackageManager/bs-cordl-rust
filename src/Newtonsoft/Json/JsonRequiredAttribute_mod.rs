#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonRequiredAttribute")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonRequiredAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonRequiredAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json";
    const CLASS_NAME: &'static str = "JsonRequiredAttribute";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonRequiredAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::JsonRequiredAttribute {
