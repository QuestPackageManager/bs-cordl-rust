#[cfg(feature = "Newtonsoft+Json+JsonReaderException")]
#[repr(C)]
#[derive(Debug)]
pub struct JsonReaderException {
...
for crate::Newtonsoft::Json::JsonReaderException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json";
    const CLASS_NAME: &'static str = "JsonReaderException";
...
#[cfg(feature = "Newtonsoft+Json+JsonReaderException")]
impl std::ops::Deref for crate::Newtonsoft::Json::JsonReaderException {
...
#[cfg(feature = "Newtonsoft+Json+JsonReaderException")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::JsonReaderException {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Newtonsoft+Json+JsonReaderException")]
impl crate::Newtonsoft::Json::JsonReaderException {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::JsonReaderException as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::JsonReaderException as
...
#[cfg(feature = "Newtonsoft+Json+JsonReaderException")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::JsonReaderException {
