#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonLoadSettings")]
#[repr(C)]
...
pub struct JsonLoadSettings {
    ...
    pub _duplicatePropertyNameHandling:
        crate::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling,
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonLoadSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Linq::JsonLoadSettings {
...
impl crate::Newtonsoft::Json::Linq::JsonLoadSettings {
    ...
    pub fn get_CommentHandling(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Newtonsoft::Json::Linq::CommentHandling, 0usize>(
                        "get_CommentHandling",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Newtonsoft::Json::Linq::CommentHandling =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_DuplicatePropertyNameHandling(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_LineInfoHandling(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Newtonsoft::Json::Linq::LineInfoHandling, 0usize>(
        ...
        let __cordl_ret: crate::Newtonsoft::Json::Linq::LineInfoHandling =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonLoadSettings")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Linq::JsonLoadSettings {
