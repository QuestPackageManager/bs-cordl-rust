#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JEnumerable_1")]
    ...
    for crate::Newtonsoft::Json::Linq::JEnumerable_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Newtonsoft.Json.Linq", "JEnumerable`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::Newtonsoft::Json::Linq::JEnumerable_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::Newtonsoft::Json::Linq::JEnumerable_1<T>), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "Newtonsoft+Json+Linq+JEnumerable_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::Newtonsoft::Json::Linq::IJEnumerable_1<T>>
    for crate::Newtonsoft::Json::Linq::JEnumerable_1<T>
{
...
#[cfg(feature = "Newtonsoft+Json+Linq+JEnumerable_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::Newtonsoft::Json::Linq::IJEnumerable_1<T>>
    for crate::Newtonsoft::Json::Linq::JEnumerable_1<T>
{
    ...
    for crate::Newtonsoft::Json::Linq::JEnumerable_1<T>
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::Newtonsoft::Json::Linq::JEnumerable_1<T>> {
        todo!()
    }
}
