...
impl std::ops::Deref for crate::Newtonsoft::Json::Linq::JsonPath::BooleanQueryExpression {
...
#[cfg(feature = "Newtonsoft+Json+Linq+JsonPath+BooleanQueryExpression")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Linq::JsonPath::BooleanQueryExpression {
...
impl crate::Newtonsoft::Json::Linq::JsonPath::BooleanQueryExpression {
    pub fn EqualsWithStrictMatch(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Linq::JValue>,
                    ), bool, 2usize>("EqualsWithStrictMatch")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (value, queryValue))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Linq::JValue>,
                        quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Linq::JValue>,
                    ), bool, 2usize>("EqualsWithStringCoercion")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn IsMatch(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (root, t, settings))? };
        Ok(__cordl_ret.into())
    }
    pub fn MatchTokens(
        &mut self,
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (leftResult, rightResult, settings))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn RegexEquals(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (input, pattern, settings))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_operator, left, right))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonPath+BooleanQueryExpression")]
