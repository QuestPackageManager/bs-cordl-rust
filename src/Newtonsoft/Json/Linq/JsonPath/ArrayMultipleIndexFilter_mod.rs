...
pub struct ArrayMultipleIndexFilter {
    ...
    pub Indexes: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<i32>>,
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonPath+ArrayMultipleIndexFilter")]
    ...
    for crate::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter
{
    ...
    const CLASS_NAME: &'static str = "ArrayMultipleIndexFilter";
...
impl std::ops::Deref for crate::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter {
...
#[cfg(feature = "Newtonsoft+Json+Linq+JsonPath+ArrayMultipleIndexFilter")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter {
