#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonPath+ScanFilter")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonPath+ScanFilter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Linq::JsonPath::ScanFilter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Linq.JsonPath";
    const CLASS_NAME: &'static str = "ScanFilter";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonPath+ScanFilter")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Linq::JsonPath::ScanFilter {
