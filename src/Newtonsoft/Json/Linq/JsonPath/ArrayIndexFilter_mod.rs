#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonPath+ArrayIndexFilter")]
#[repr(C)]
...
impl crate::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter {
    ...
    pub fn get_Index(&mut self) -> quest_hook::libil2cpp::Result<crate::System::Nullable_1<i32>> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
