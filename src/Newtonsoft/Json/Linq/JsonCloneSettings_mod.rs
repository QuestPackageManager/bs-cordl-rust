...
for crate::Newtonsoft::Json::Linq::JsonCloneSettings {
    ...
    const CLASS_NAME: &'static str = "JsonCloneSettings";
...
impl crate::Newtonsoft::Json::Linq::JsonCloneSettings {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Linq::JsonCloneSettings as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Linq::JsonCloneSettings as
    ...
    pub fn get_CopyAnnotations(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Linq::JsonCloneSettings as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_CopyAnnotations")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Linq::JsonCloneSettings as
                    quest_hook::libil2cpp::Type > ::class(), "get_CopyAnnotations",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Linq::JsonCloneSettings as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Linq::JsonCloneSettings as
                    quest_hook::libil2cpp::Type > ::class(), "set_CopyAnnotations",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
