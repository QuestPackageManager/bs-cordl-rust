#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonMergeSettings")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonMergeSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Linq::JsonMergeSettings {
...
impl crate::Newtonsoft::Json::Linq::JsonMergeSettings {
    ...
    pub fn get_MergeArrayHandling(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Newtonsoft::Json::Linq::MergeArrayHandling> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Newtonsoft::Json::Linq::MergeArrayHandling, 0usize>(
        ...
        let __cordl_ret: crate::Newtonsoft::Json::Linq::MergeArrayHandling =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_MergeNullValueHandling(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Newtonsoft::Json::Linq::MergeNullValueHandling> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::Newtonsoft::Json::Linq::MergeNullValueHandling =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_PropertyNameComparison(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::StringComparison, 0usize>(
        ...
        let __cordl_ret: crate::System::StringComparison =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JsonMergeSettings")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Linq::JsonMergeSettings {
