...
impl crate::Newtonsoft::Json::Linq::JProperty {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        i32,
                        quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Linq::JToken>,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetItem")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (task, writer, cancellationToken, converters))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_Il2CppArray3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, content))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JProperty+JPropertyList")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Linq::JProperty_JPropertyList {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Linq";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Linq+JProperty+JPropertyList")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Linq::JProperty_JPropertyList {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
