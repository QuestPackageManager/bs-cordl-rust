...
impl crate::Newtonsoft::Json::Linq::JObject {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Newtonsoft::Json::Linq::JToken,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (propertyName, comparison))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn IndexOfItem(
    ...
    pub fn InternalPropertyChanged(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (childProperty))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryGetValue_StringComparison_ByRefMut0(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (propertyName, comparison, value))?
        };
        Ok(__cordl_ret.into())
    }
