...
#[cfg(feature = "Newtonsoft+Json+JsonException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json";
    const CLASS_NAME: &'static str = "JsonException";
...
impl crate::Newtonsoft::Json::JsonException {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::JsonException as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::JsonException as
...
#[cfg(feature = "Newtonsoft+Json+JsonException")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::JsonException {
