...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonPosition")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::Newtonsoft::Json::JsonPosition {
    type Type = Self;
...
impl crate::Newtonsoft::Json::JsonPosition {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (positions, currentPosition))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteTo(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<char>>,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("WriteTo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sb, writer, buffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
