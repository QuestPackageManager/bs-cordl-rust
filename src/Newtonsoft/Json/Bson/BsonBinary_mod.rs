...
impl crate::Newtonsoft::Json::Bson::BsonBinary {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (value, binaryType))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_BinaryType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Newtonsoft::Json::Bson::BsonBinaryType, 0usize>(
                        "get_BinaryType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Newtonsoft::Json::Bson::BsonBinaryType =
