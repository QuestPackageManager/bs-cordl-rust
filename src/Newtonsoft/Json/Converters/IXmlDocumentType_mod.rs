#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+IXmlDocumentType")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+IXmlDocumentType")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Converters::IXmlDocumentType {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Converters";
    const CLASS_NAME: &'static str = "IXmlDocumentType";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+IXmlDocumentType")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Converters::IXmlDocumentType {
