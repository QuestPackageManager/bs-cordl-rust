...
impl crate::Newtonsoft::Json::Converters::StringEnumConverter {
    ...
    pub fn _ctor_NamingStrategy__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (namingStrategy, allowIntegerValues))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Type3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (namingStrategyType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (camelCaseText))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_CamelCaseText(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_CamelCaseText")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
