...
for crate::Newtonsoft::Json::Converters::ExpandoObjectConverter {
    ...
    const CLASS_NAME: &'static str = "ExpandoObjectConverter";
...
impl crate::Newtonsoft::Json::Converters::ExpandoObjectConverter {
    pub fn CanConvert(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::ExpandoObjectConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::ExpandoObjectConverter as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::ExpandoObjectConverter as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Converters::ExpandoObjectConverter as
                    quest_hook::libil2cpp::Type > ::class(), "ReadObject", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppObject,
