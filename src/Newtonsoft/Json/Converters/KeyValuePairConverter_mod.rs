...
for crate::Newtonsoft::Json::Converters::KeyValuePairConverter {
    ...
    const CLASS_NAME: &'static str = "KeyValuePairConverter";
...
impl crate::Newtonsoft::Json::Converters::KeyValuePairConverter {
    ...
    pub fn CanConvert(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::KeyValuePairConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::KeyValuePairConverter as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::KeyValuePairConverter as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "InitializeReflectionObject", 1usize
                )
            });
