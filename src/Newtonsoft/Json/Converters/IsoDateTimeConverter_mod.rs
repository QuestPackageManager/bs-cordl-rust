#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+IsoDateTimeConverter")]
#[repr(C)]
...
impl crate::Newtonsoft::Json::Converters::IsoDateTimeConverter {
    pub const DefaultDateTimeFormat: &'static str =
    ...
    pub fn get_DateTimeStyles(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Globalization::DateTimeStyles, 0usize>(
                        "get_DateTimeStyles",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
