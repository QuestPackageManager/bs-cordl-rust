...
for crate::Newtonsoft::Json::Converters::DateTimeConverterBase {
    ...
    const CLASS_NAME: &'static str = "DateTimeConverterBase";
...
impl crate::Newtonsoft::Json::Converters::DateTimeConverterBase {
    pub fn CanConvert(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::DateTimeConverterBase as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::DateTimeConverterBase as
