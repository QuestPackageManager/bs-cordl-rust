...
for crate::Newtonsoft::Json::Converters::XmlDeclarationWrapper {
    ...
    const CLASS_NAME: &'static str = "XmlDeclarationWrapper";
...
impl crate::Newtonsoft::Json::Converters::XmlDeclarationWrapper {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::XmlDeclarationWrapper as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::XmlDeclarationWrapper as
