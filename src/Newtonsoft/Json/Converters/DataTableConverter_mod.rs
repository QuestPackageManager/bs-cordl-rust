...
impl crate::Newtonsoft::Json::Converters::DataTableConverter {
    pub fn CanConvert(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (valueType))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateRow(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("CreateRow")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (reader, dt, serializer))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+DataTableConverter")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Converters::DataTableConverter {
