...
for crate::Newtonsoft::Json::Converters::JavaScriptDateTimeConverter {
    ...
    const CLASS_NAME: &'static str = "JavaScriptDateTimeConverter";
...
impl crate::Newtonsoft::Json::Converters::JavaScriptDateTimeConverter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::JavaScriptDateTimeConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::JavaScriptDateTimeConverter as
