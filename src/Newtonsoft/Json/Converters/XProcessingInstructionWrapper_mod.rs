...
impl std::ops::Deref for crate::Newtonsoft::Json::Converters::XProcessingInstructionWrapper {
...
#[cfg(feature = "Newtonsoft+Json+Converters+XProcessingInstructionWrapper")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Converters::XProcessingInstructionWrapper {
...
impl crate::Newtonsoft::Json::Converters::XProcessingInstructionWrapper {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (processingInstruction))? };
        Ok(__cordl_ret.into())
    }
