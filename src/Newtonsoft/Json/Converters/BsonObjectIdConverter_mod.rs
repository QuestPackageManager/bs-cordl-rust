...
impl crate::Newtonsoft::Json::Converters::BsonObjectIdConverter {
    pub fn CanConvert(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::BsonObjectIdConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::BsonObjectIdConverter as
