#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+VersionConverter")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+VersionConverter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Converters::VersionConverter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Converters";
    const CLASS_NAME: &'static str = "VersionConverter";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+VersionConverter")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Converters::VersionConverter {
