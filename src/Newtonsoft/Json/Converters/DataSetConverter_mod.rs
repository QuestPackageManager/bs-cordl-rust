#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+DataSetConverter")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+DataSetConverter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Converters::DataSetConverter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Converters";
    const CLASS_NAME: &'static str = "DataSetConverter";
...
#[cfg(feature = "Newtonsoft+Json+Converters+DataSetConverter")]
impl std::ops::Deref for crate::Newtonsoft::Json::Converters::DataSetConverter {
...
#[cfg(feature = "Newtonsoft+Json+Converters+DataSetConverter")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Converters::DataSetConverter {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Newtonsoft+Json+Converters+DataSetConverter")]
impl crate::Newtonsoft::Json::Converters::DataSetConverter {
    pub fn CanConvert(
        &mut self,
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+DataSetConverter")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Converters::DataSetConverter {
