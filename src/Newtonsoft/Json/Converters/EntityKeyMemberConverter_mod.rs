#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+EntityKeyMemberConverter")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Newtonsoft+Json+Converters+EntityKeyMemberConverter")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Converters::EntityKeyMemberConverter {
...
impl crate::Newtonsoft::Json::Converters::EntityKeyMemberConverter {
    ...
    pub fn ReadAndAssertProperty(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (reader, propertyName))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadJson(
        &mut self,
