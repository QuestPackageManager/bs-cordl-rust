#[cfg(feature = "cordl_class_Newtonsoft+Json+Converters+CustomCreationConverter_1")]
#[repr(C)]
    ...
    for crate::Newtonsoft::Json::Converters::CustomCreationConverter_1<T>
{
    ...
    const CLASS_NAME: &'static str = "CustomCreationConverter`1";
    ...
    crate::Newtonsoft::Json::Converters::CustomCreationConverter_1<T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<crate::System::Type>), T, 1usize>(
                        "Create",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (objectType))? };
        Ok(__cordl_ret.into())
    }
