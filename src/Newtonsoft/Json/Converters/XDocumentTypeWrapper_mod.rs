...
for crate::Newtonsoft::Json::Converters::XDocumentTypeWrapper {
    ...
    const CLASS_NAME: &'static str = "XDocumentTypeWrapper";
...
impl crate::Newtonsoft::Json::Converters::XDocumentTypeWrapper {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::XDocumentTypeWrapper as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::System::Xml::Linq::XDocumentType>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Converters::XDocumentTypeWrapper as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (documentType))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Converters::XDocumentTypeWrapper as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Converters::XDocumentTypeWrapper as
                    quest_hook::libil2cpp::Type > ::class(), "get_InternalSubset", 0usize
                )
            });
