...
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonConverter {
    ...
    const CLASS_NAME: &'static str = "JsonConverter";
...
#[cfg(feature = "Newtonsoft+Json+JsonConverter")]
impl crate::Newtonsoft::Json::JsonConverter {
    pub fn CanConvert(
        &mut self,
        objectType: quest_hook::libil2cpp::Gc<crate::System::Type>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::JsonConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::JsonConverter as
