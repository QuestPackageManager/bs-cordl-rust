...
pub struct JsonObjectAttribute {
    ...
    pub _itemNullValueHandling:
        crate::System::Nullable_1<crate::Newtonsoft::Json::NullValueHandling>,
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonObjectAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonObjectAttribute {
...
impl crate::Newtonsoft::Json::JsonObjectAttribute {
    ...
    pub fn _ctor_MemberSerialization1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (memberSerialization))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_ItemRequired(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Newtonsoft::Json::Required, 0usize>(
                        "get_ItemRequired",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
