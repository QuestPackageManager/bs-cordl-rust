#[cfg(feature = "cordl_class_Newtonsoft+Json+IArrayPool_1")]
    ...
    for crate::Newtonsoft::Json::IArrayPool_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Newtonsoft.Json", "IArrayPool`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::Newtonsoft::Json::IArrayPool_1<T> {
