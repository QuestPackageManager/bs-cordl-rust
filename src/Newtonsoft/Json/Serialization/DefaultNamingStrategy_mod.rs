...
for crate::Newtonsoft::Json::Serialization::DefaultNamingStrategy {
    ...
    const CLASS_NAME: &'static str = "DefaultNamingStrategy";
...
#[cfg(feature = "Newtonsoft+Json+Serialization+DefaultNamingStrategy")]
impl crate::Newtonsoft::Json::Serialization::DefaultNamingStrategy {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Serialization::DefaultNamingStrategy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Serialization::DefaultNamingStrategy as
