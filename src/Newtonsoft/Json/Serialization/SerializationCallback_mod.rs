#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+SerializationCallback")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "Newtonsoft+Json+Serialization+SerializationCallback")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::SerializationCallback {
...
impl crate::Newtonsoft::Json::Serialization::SerializationCallback {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (o, context, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
