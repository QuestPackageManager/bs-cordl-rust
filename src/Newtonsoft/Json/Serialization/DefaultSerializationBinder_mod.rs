...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::DefaultSerializationBinder {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+DefaultSerializationBinder")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::DefaultSerializationBinder {
...
impl crate::Newtonsoft::Json::Serialization::DefaultSerializationBinder {
    pub fn BindToName(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("BindToName")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (serializedType, assemblyName, typeName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BindToType(
    ...
    pub fn GetGenericTypeFromTypeName(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> =
            unsafe { cordl_method_info.invoke_unchecked(self, (typeName, assembly))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetTypeByName(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::Newtonsoft::Json::Utilities::StructMultiKey_2<
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> =
            unsafe { cordl_method_info.invoke_unchecked(self, (typeNameKey))? };
        Ok(__cordl_ret.into())
    }
...
impl AsMut<crate::Newtonsoft::Json::Serialization::ISerializationBinder>
    for crate::Newtonsoft::Json::Serialization::DefaultSerializationBinder
{
    fn as_mut(&mut self) -> &mut crate::Newtonsoft::Json::Serialization::ISerializationBinder {
        unsafe { std::mem::transmute(self) }
    }
}
