...
for crate::Newtonsoft::Json::Serialization::JsonLinqContract {
    ...
    const CLASS_NAME: &'static str = "JsonLinqContract";
...
impl crate::Newtonsoft::Json::Serialization::JsonLinqContract {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Serialization::JsonLinqContract as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Serialization::JsonLinqContract as
