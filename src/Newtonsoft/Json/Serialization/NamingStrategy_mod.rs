#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+NamingStrategy")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+NamingStrategy")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Serialization::NamingStrategy {
...
impl crate::Newtonsoft::Json::Serialization::NamingStrategy {
    ...
    pub fn Equals_NamingStrategy1(
        &mut self,
        other: quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Serialization::NamingStrategy>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, hasSpecifiedName))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_ProcessExtensionDataNames(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+NamingStrategy")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Serialization::NamingStrategy {
