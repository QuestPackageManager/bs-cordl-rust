...
#[cfg(feature = "Newtonsoft+Json+Serialization+JsonPropertyCollection")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::JsonPropertyCollection {
...
impl crate::Newtonsoft::Json::Serialization::JsonPropertyCollection {
    ...
    pub fn GetKeyForItem(
        &mut self,
        item: quest_hook::libil2cpp::Gc<crate::Newtonsoft::Json::Serialization::JsonProperty>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Newtonsoft::Json::Serialization::JsonProperty,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (propertyName, comparisonType))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
