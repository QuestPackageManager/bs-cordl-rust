...
impl crate::Newtonsoft::Json::Serialization::SerializationBinderAdapter {
    pub fn BindToName(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Serialization::SerializationBinderAdapter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Serialization::SerializationBinderAdapter
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (serializationBinder))?
        };
        Ok(__cordl_ret.into())
    }
}
