...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::SerializationBinderAdapter {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+SerializationBinderAdapter")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::SerializationBinderAdapter {
...
impl crate::Newtonsoft::Json::Serialization::SerializationBinderAdapter {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (serializationBinder))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+SerializationBinderAdapter")]
