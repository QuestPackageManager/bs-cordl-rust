#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+SnakeCaseNamingStrategy")]
#[repr(C)]
...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::SnakeCaseNamingStrategy {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+SnakeCaseNamingStrategy")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::SnakeCaseNamingStrategy {
