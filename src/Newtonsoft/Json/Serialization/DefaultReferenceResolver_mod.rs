#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+DefaultReferenceResolver")]
#[repr(C)]
    ...
    for crate::Newtonsoft::Json::Serialization::DefaultReferenceResolver
{
    ...
    const CLASS_NAME: &'static str = "DefaultReferenceResolver";
...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::DefaultReferenceResolver {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+DefaultReferenceResolver")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::DefaultReferenceResolver {
...
impl AsMut<crate::Newtonsoft::Json::Serialization::IReferenceResolver>
    for crate::Newtonsoft::Json::Serialization::DefaultReferenceResolver
{
    fn as_mut(&mut self) -> &mut crate::Newtonsoft::Json::Serialization::IReferenceResolver {
        unsafe { std::mem::transmute(self) }
    }
}
