#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+KebabCaseNamingStrategy")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Newtonsoft::Json::Serialization::KebabCaseNamingStrategy
{
    ...
    const CLASS_NAME: &'static str = "KebabCaseNamingStrategy";
...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::KebabCaseNamingStrategy {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+KebabCaseNamingStrategy")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::KebabCaseNamingStrategy {
