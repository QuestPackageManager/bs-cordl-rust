...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::CamelCaseNamingStrategy {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+CamelCaseNamingStrategy")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::CamelCaseNamingStrategy {
