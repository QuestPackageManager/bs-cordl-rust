#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+IValueProvider")]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+IValueProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Serialization::IValueProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json.Serialization";
    const CLASS_NAME: &'static str = "IValueProvider";
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+IValueProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Serialization::IValueProvider {
