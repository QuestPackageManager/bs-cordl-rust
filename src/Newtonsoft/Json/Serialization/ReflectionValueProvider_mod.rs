#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+ReflectionValueProvider")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Newtonsoft::Json::Serialization::ReflectionValueProvider
{
    ...
    const CLASS_NAME: &'static str = "ReflectionValueProvider";
...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::ReflectionValueProvider {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+ReflectionValueProvider")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::ReflectionValueProvider {
