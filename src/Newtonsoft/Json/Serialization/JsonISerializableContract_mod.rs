...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::JsonISerializableContract {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+JsonISerializableContract")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::JsonISerializableContract {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Newtonsoft::Json::Serialization::ObjectConstructor_1<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        >,
                    >, 0usize>("get_ISerializableCreator")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
