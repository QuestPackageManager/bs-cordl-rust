...
pub struct JsonDictionaryContract {
    ...
    pub _DictionaryKeyResolver_k__BackingField: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _DictionaryKeyType_k__BackingField: quest_hook::libil2cpp::Gc<crate::System::Type>,
    pub _DictionaryValueType_k__BackingField: quest_hook::libil2cpp::Gc<crate::System::Type>,
    pub _KeyContract_k__BackingField:
...
#[cfg(feature = "Newtonsoft+Json+Serialization+JsonDictionaryContract")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::JsonDictionaryContract {
...
impl crate::Newtonsoft::Json::Serialization::JsonDictionaryContract {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateTemporaryDictionary", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Func_2<
                            ...
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    >, 0usize>("get_DictionaryKeyResolver")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_HasParameterizedCreator(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_HasParameterizedCreatorInternal(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::Newtonsoft::Json::Serialization::JsonContract,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_KeyContract")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
