#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+TraceJsonReader")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Newtonsoft::Json::Serialization::TraceJsonReader
{
    ...
    const CLASS_NAME: &'static str = "TraceJsonReader";
...
impl crate::Newtonsoft::Json::Serialization::TraceJsonReader {
    ...
    pub fn WriteCurrentToken(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("WriteCurrentToken")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (innerReader))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Serialization+TraceJsonReader")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Serialization::TraceJsonReader {
