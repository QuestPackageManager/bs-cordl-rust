    ...
    for crate::Newtonsoft::Json::Serialization::SerializationErrorCallback
{
    ...
    const CLASS_NAME: &'static str = "SerializationErrorCallback";
...
impl std::ops::Deref for crate::Newtonsoft::Json::Serialization::SerializationErrorCallback {
...
#[cfg(feature = "Newtonsoft+Json+Serialization+SerializationErrorCallback")]
impl std::ops::DerefMut for crate::Newtonsoft::Json::Serialization::SerializationErrorCallback {
...
impl crate::Newtonsoft::Json::Serialization::SerializationErrorCallback {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (o, context, errorContext, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
