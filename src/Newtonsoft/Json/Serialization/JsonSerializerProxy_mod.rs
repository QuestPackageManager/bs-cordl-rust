...
impl crate::Newtonsoft::Json::Serialization::JsonSerializerProxy {
    ...
    pub fn SerializeInternal(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (jsonWriter, value, rootType))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_JsonSerializerInternalReader0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (serializerReader))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_JsonSerializerInternalWriter1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (serializerWriter))? };
        Ok(__cordl_ret.into())
    }
    pub fn add_Error(
        &mut self,
