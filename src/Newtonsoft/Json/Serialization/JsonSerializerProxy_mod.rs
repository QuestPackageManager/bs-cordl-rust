...
impl crate::Newtonsoft::Json::Serialization::JsonSerializerProxy {
    ...
    pub fn GetInternalSerializer(
        ...
        *mut crate::Newtonsoft::Json::Serialization::JsonSerializerInternalBase,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::Newtonsoft::Json::Serialization::JsonSerializerInternalBase = __cordl_object
            .invoke("GetInternalSerializer", ())?;
        Ok(__cordl_ret)
    }
    pub fn New_JsonSerializerInternalReader0(
        serializerReader: *mut crate::Newtonsoft::Json::Serialization::JsonSerializerInternalReader,
    ...
    pub fn New_JsonSerializerInternalWriter1(
        serializerWriter: *mut crate::Newtonsoft::Json::Serialization::JsonSerializerInternalWriter,
    ) -> quest_hook::libil2cpp::Result<*mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
