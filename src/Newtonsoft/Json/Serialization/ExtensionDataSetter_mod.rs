...
for crate::Newtonsoft::Json::Serialization::ExtensionDataSetter {
    ...
    const CLASS_NAME: &'static str = "ExtensionDataSetter";
...
impl crate::Newtonsoft::Json::Serialization::ExtensionDataSetter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Serialization::ExtensionDataSetter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Serialization::ExtensionDataSetter as
                    quest_hook::libil2cpp::Type > ::class(), "BeginInvoke", 5usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method.invoke_unchecked(self, (o, key, value, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (o, key, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
