#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonNameTable")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+JsonNameTable")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::JsonNameTable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Newtonsoft.Json";
    const CLASS_NAME: &'static str = "JsonNameTable";
