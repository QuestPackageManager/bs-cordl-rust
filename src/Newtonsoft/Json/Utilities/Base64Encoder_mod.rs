...
impl crate::Newtonsoft::Json::Utilities::Base64Encoder {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (buffer, index, count, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Flush(
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (chars, index, count, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
