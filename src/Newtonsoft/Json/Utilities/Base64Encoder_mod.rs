#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+Base64Encoder")]
#[repr(C)]
#[derive(Debug)]
pub struct Base64Encoder {
    ...
    pub _leftOverBytes: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    pub _leftOverBytesCount: i32,
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+Base64Encoder")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Utilities::Base64Encoder {
...
impl crate::Newtonsoft::Json::Utilities::Base64Encoder {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, index, count, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 3usize>("FulfillFromLeftover")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), quest_hook::libil2cpp::Void, 3usize>("StoreLeftOverBytes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("ValidateEncode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> = unsafe {
            cordl_method_info.invoke_unchecked(self, (chars, index, count, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+Base64Encoder")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Utilities::Base64Encoder {
