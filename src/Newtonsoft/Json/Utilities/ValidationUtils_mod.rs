#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+ValidationUtils")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+ValidationUtils")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Utilities::ValidationUtils {
...
impl crate::Newtonsoft::Json::Utilities::ValidationUtils {
    pub fn ArgumentNotNull(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("ArgumentNotNull")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (value, parameterName))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+ValidationUtils")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Utilities::ValidationUtils {
