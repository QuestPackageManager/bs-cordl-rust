...
for crate::Newtonsoft::Json::Utilities::ReflectionDelegateFactory {
    ...
    const CLASS_NAME: &'static str = "ReflectionDelegateFactory";
...
impl crate::Newtonsoft::Json::Utilities::ReflectionDelegateFactory {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Utilities::ReflectionDelegateFactory as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Utilities::ReflectionDelegateFactory as
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Func_2<
                ...
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
            >,
        > = unsafe { method.invoke_unchecked(self, (memberInfo))? };
        Ok(__cordl_ret.into())
    }
