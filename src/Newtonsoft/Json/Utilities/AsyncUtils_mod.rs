#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+AsyncUtils")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+AsyncUtils")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Utilities::AsyncUtils {
...
impl crate::Newtonsoft::Json::Utilities::AsyncUtils {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsCompletedSuccessfully", 1usize
                        )
                    })
            });
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "ToAsync",
                            1usize
                        )
                    })
            });
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> =
            unsafe { cordl_method_info.invoke_unchecked((), (writer, value, cancellationToken))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+AsyncUtils")]
impl quest_hook::libil2cpp::ObjectType for crate::Newtonsoft::Json::Utilities::AsyncUtils {
