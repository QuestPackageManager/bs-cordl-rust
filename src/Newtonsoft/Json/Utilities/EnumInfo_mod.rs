#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+EnumInfo")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+EnumInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Utilities::EnumInfo {
...
impl crate::Newtonsoft::Json::Utilities::EnumInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isFlags, values, names, resolvedNames))?
        };
        Ok(__cordl_ret.into())
    }
}
