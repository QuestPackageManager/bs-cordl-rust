...
#[repr(C)]
pub struct StructMultiKey_2<T1: quest_hook::libil2cpp::Type, T2: quest_hook::libil2cpp::Type> {
    pub Value1: T1,
    pub Value2: T2,
...
unsafe impl<T1: quest_hook::libil2cpp::Type, T2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>
{
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+StructMultiKey_2")]
unsafe impl<T1: quest_hook::libil2cpp::Type, T2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Return for crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>
{
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
    ...
    crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (v1, v2))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "Newtonsoft+Json+Utilities+StructMultiKey_2")]
impl<T1: quest_hook::libil2cpp::Type, T2: quest_hook::libil2cpp::Type>
    AsRef<crate::System::IEquatable_1<crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>>>
    for crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>
{
    fn as_ref(
        &self,
    ) -> &crate::System::IEquatable_1<crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>>
    {
        todo!()
    }
}
#[cfg(feature = "Newtonsoft+Json+Utilities+StructMultiKey_2")]
impl<T1: quest_hook::libil2cpp::Type, T2: quest_hook::libil2cpp::Type>
    AsMut<crate::System::IEquatable_1<crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>>>
    for crate::Newtonsoft::Json::Utilities::StructMultiKey_2<T1, T2>
{
    fn as_mut(
        &mut self,
