...
impl crate::Newtonsoft::Json::Utilities::StringBuffer {
    pub fn Append_Il2CppArray_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bufferPool, buffer, startIndex, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Append__cordl_char0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<char>, char),
                        quest_hook::libil2cpp::Void,
                        2usize,
                    >("Append")
                    .unwrap_or_else(|e| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bufferPool, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Clear(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bufferPool))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EnsureSize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bufferPool, appendLength))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToString_0(
    ...
    pub fn _ctor_Gc_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bufferPool, initalSize))?
        };
        Ok(__cordl_ret.into())
    }
