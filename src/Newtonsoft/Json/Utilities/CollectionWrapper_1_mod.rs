...
pub struct CollectionWrapper_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _genericCollection:
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::ICollection_1<T>>,
    ...
    for crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<T>
{
    ...
    const CLASS_NAME: &'static str = "CollectionWrapper`1";
...
#[cfg(feature = "Newtonsoft+Json+Utilities+CollectionWrapper_1")]
impl<T: quest_hook::libil2cpp::Type> crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<T> {
    ...
    pub fn New_ICollection_1_1(
        list: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::ICollection_1<T>>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_UnderlyingCollection", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject> =
...
#[cfg(feature = "Newtonsoft+Json+Utilities+CollectionWrapper_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::Newtonsoft::Json::Utilities::IWrappedCollection>
    for crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<T>
{
...
#[cfg(feature = "Newtonsoft+Json+Utilities+CollectionWrapper_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::Newtonsoft::Json::Utilities::IWrappedCollection>
    for crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<T>
{
