...
pub struct CollectionWrapper_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _genericCollection: *mut crate::System::Collections::Generic::ICollection_1<T>,
    pub _syncRoot: *mut crate::System::Object,
    __cordl_phantom_T: std::marker::PhantomData<T>,
}
#[cfg(feature = "Newtonsoft+Json+Utilities+CollectionWrapper_1")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Newtonsoft::Json::Utilities::CollectionWrapper_1
    < T > => "Newtonsoft.Json.Utilities"."CollectionWrapper`1" < T >
);
#[cfg(feature = "Newtonsoft+Json+Utilities+CollectionWrapper_1")]
...
> crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<T> {
    ...
    pub fn New_ICollection_1_1(
        list: *mut crate::System::Collections::Generic::ICollection_1<T>,
