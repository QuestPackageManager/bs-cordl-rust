...
> crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Utilities::CollectionWrapper_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Utilities::CollectionWrapper_1 < T > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Utilities::CollectionWrapper_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "VerifyValueType", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Newtonsoft::Json::Utilities::CollectionWrapper_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_UnderlyingCollection",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
