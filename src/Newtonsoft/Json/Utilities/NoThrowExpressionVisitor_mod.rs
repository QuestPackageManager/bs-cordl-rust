...
impl crate::Newtonsoft::Json::Utilities::NoThrowExpressionVisitor {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Newtonsoft::Json::Utilities::NoThrowExpressionVisitor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Newtonsoft::Json::Utilities::NoThrowExpressionVisitor as
