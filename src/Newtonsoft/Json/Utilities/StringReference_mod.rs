...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+StringReference")]
unsafe impl quest_hook::libil2cpp::Type for crate::Newtonsoft::Json::Utilities::StringReference {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_Newtonsoft+Json+Utilities+StringReference")]
unsafe impl quest_hook::libil2cpp::Return for crate::Newtonsoft::Json::Utilities::StringReference {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
