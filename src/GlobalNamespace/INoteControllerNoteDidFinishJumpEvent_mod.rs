...
impl crate::GlobalNamespace::INoteControllerNoteDidFinishJumpEvent {
    pub fn HandleNoteControllerNoteDidFinishJump(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INoteControllerNoteDidFinishJumpEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INoteControllerNoteDidFinishJumpEvent as
