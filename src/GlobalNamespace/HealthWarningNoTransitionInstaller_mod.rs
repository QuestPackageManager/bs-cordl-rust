...
for crate::GlobalNamespace::HealthWarningNoTransitionInstaller {
    ...
    const CLASS_NAME: &'static str = "HealthWarningNoTransitionInstaller";
...
impl crate::GlobalNamespace::HealthWarningNoTransitionInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HealthWarningNoTransitionInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HealthWarningNoTransitionInstaller as
