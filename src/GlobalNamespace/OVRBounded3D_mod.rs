...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRBounded3D {
    ...
    const CLASS_NAME: &'static str = "OVRBounded3D";
...
#[cfg(feature = "cordl_class_OVRBounded3D")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::OVRBounded3D {
    type Type = Self;
...
impl crate::GlobalNamespace::OVRBounded3D {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ConvertBounds", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Bounds =
            unsafe { cordl_method_info.invoke_unchecked(self, (openXrBounds))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Equals_OVRBounded3D0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::OVRBounded3D), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRBounded3D>.FromAnchor", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::OVRBounded3D =
    ...
    pub fn IOVRAnchorComponent_OVRBounded3D__get_Handle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), u64, 0usize>("IOVRAnchorComponent<OVRBounded3D>.get_Handle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRBounded3D>.get_Type", 0usize
                        )
                    })
            });
    ...
    pub fn get_BoundingBox(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Bounds> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Bounds, 0usize>("get_BoundingBox")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "OVRBounded3D")]
impl AsRef<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRBounded3D>>
...
#[cfg(feature = "OVRBounded3D")]
impl AsMut<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRBounded3D>>
    for crate::GlobalNamespace::OVRBounded3D
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRBounded3D>
    {
        todo!()
    }
}
...
impl AsRef<crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded3D>>
    for crate::GlobalNamespace::OVRBounded3D
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded3D> {
        todo!()
    }
}
#[cfg(feature = "OVRBounded3D")]
impl AsMut<crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded3D>>
    for crate::GlobalNamespace::OVRBounded3D
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded3D> {
        todo!()
    }
}
