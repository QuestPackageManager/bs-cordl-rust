...
for crate::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost {
    ...
    const CLASS_NAME: &'static str = "SongPreviewPlayerPauseOnInputFocusLost";
...
impl crate::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost {
    pub fn HandleInputFocusCaptured(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost as
                    quest_hook::libil2cpp::Type > ::class(), "HandleInputFocusCaptured",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost as
                    quest_hook::libil2cpp::Type > ::class(), "HandleInputFocusReleased",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
