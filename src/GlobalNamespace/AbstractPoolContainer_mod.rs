...
#[repr(C)]
#[derive(Debug)]
pub struct AbstractPoolContainer {
...
for crate::GlobalNamespace::AbstractPoolContainer {
    ...
    const CLASS_NAME: &'static str = "AbstractPoolContainer";
...
impl crate::GlobalNamespace::AbstractPoolContainer {
    pub fn DespawnAll(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::AbstractPoolContainer as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("DespawnAll")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::AbstractPoolContainer as
