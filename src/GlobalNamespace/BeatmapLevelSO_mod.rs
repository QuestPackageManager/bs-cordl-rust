...
impl crate::GlobalNamespace::BeatmapLevelSO {
    ...
    pub fn SetCoverImage(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (coverImage))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetData(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 17usize>("SetData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetIntegratedLufs(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("SetIntegratedLufs")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (integratedLufs))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetPreviewDifficultyBeatmaps(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (previewDifficultyBeatmapSets))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetSongDuration(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (songDuration))? };
        Ok(__cordl_ret.into())
    }
    pub fn __SetEnvironmentName(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (targetEnvironmentName))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_allDirectionsEnvironmentName(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::EnvironmentName, 0usize>(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IReadOnlyList_1<
                            ...
                            >,
                        >,
                    >, 0usize>("get_previewDifficultyBeatmapSets")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
impl AsMut<crate::GlobalNamespace::IAssetSongPreviewAudioClipProvider>
    for crate::GlobalNamespace::BeatmapLevelSO
{
    fn as_mut(&mut self) -> &mut crate::GlobalNamespace::IAssetSongPreviewAudioClipProvider {
        unsafe { std::mem::transmute(self) }
    }
}
...
#[cfg(feature = "cordl_class_BeatmapLevelSO+ColorScheme")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapLevelSO_ColorScheme {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_BeatmapLevelSO+ColorScheme")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapLevelSO_ColorScheme {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
#[cfg(feature = "BeatmapLevelSO+PreviewDifficultyBeatmap")]
impl std::ops::Deref for crate::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmap {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "BeatmapLevelSO+PreviewDifficultyBeatmap")]
impl std::ops::DerefMut for crate::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmap {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmap {
    ...
    pub fn get_cuttableBeatmapObjectsCount(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "BeatmapLevelSO+PreviewDifficultyBeatmapSet")]
impl std::ops::Deref for crate::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmapSet {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "BeatmapLevelSO+PreviewDifficultyBeatmapSet")]
impl std::ops::DerefMut for crate::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmapSet {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmapSet {
    ...
    pub fn _ctor_List_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (beatmapCharacteristic, previewDifficultyBeatmaps))?
        };
        Ok(__cordl_ret.into())
    }
