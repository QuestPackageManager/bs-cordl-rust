#[cfg(feature = "cordl_class_HydraulicCarJumpEffect")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_HydraulicCarJumpEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::HydraulicCarJumpEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "HydraulicCarJumpEffect";
...
#[cfg(feature = "cordl_class_HydraulicCarJumpEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::HydraulicCarJumpEffect {
