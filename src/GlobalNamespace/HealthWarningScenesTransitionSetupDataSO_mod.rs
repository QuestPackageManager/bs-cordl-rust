...
impl crate::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO as
                    quest_hook::libil2cpp::Type > ::class(), "Init", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (healthWarningSceneSetupData))?
        };
        Ok(__cordl_ret.into())
    }
