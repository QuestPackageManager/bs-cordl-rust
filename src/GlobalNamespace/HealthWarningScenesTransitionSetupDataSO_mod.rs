...
impl std::ops::Deref for crate::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO {
...
#[cfg(feature = "HealthWarningScenesTransitionSetupDataSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO {
...
impl crate::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (healthWarningSceneSetupData))? };
        Ok(__cordl_ret.into())
    }
