#[cfg(feature = "cordl_class_BeatmapDataAddTestSlidersTransform")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::BeatmapDataAddTestSlidersTransform {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::NoteData>>
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Gc<crate::GlobalNamespace::NoteData>, 3usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::NoteData> = unsafe {
            cordl_method_info.invoke_unchecked((), (beatmapDataItems, startIndex, colorType))?
        };
        Ok(__cordl_ret.into())
    }
