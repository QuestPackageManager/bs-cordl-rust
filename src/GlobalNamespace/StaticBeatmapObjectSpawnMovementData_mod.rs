...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for StaticBeatmapObjectSpawnMovementData => ""
    ."StaticBeatmapObjectSpawnMovementData"
);
#[cfg(feature = "StaticBeatmapObjectSpawnMovementData")]
impl std::ops::Deref for StaticBeatmapObjectSpawnMovementData {
...
#[cfg(feature = "StaticBeatmapObjectSpawnMovementData")]
impl std::ops::DerefMut for StaticBeatmapObjectSpawnMovementData {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "StaticBeatmapObjectSpawnMovementData")]
impl StaticBeatmapObjectSpawnMovementData {
...
#[cfg(feature = "StaticBeatmapObjectSpawnMovementData")]
impl quest_hook::libil2cpp::ObjectType for StaticBeatmapObjectSpawnMovementData {
