...
pub struct EnumTableViewDataSource_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _cellPrefab: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TextOnlyTableCell>,
    pub _cellHeight: f32,
...
#[cfg(feature = "EnumTableViewDataSource_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::EnumTableViewDataSource_1<T> {
