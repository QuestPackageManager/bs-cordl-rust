...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleController {
...
#[cfg(feature = "MultiplayerConnectedPlayerObstacleController")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleController {
...
#[cfg(feature = "MultiplayerConnectedPlayerObstacleController+Pool")]
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleController_Pool {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleController,
                    >), quest_hook::libil2cpp::Void, 1usize>("OnCreated")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
