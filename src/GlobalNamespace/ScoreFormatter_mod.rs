...
#[cfg(feature = "ScoreFormatter")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ScoreFormatter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ScoreFormatter";
...
impl crate::GlobalNamespace::ScoreFormatter {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ScoreFormatter as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (i32),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ScoreFormatter as
                    quest_hook::libil2cpp::Type > ::class(), "Format", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (score))? };
        Ok(__cordl_ret.into())
    }
