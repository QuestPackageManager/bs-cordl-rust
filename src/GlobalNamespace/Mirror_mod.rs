...
pub struct Mirror {
    ...
    pub _reflectionPlaneTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
    pub _isEnabled_k__BackingField: bool,
    pub mirrorDidChangeEnabledStateEvent: quest_hook::libil2cpp::Gc<crate::System::Action_1<bool>>,
}
#[cfg(feature = "cordl_class_Mirror")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::Mirror {
    ...
    const CLASS_NAME: &'static str = "Mirror";
...
#[cfg(feature = "Mirror")]
impl crate::GlobalNamespace::Mirror {
    pub fn ChangeMirrorEnabledState(
        &mut self,
        newIsEnabled: bool,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newIsEnabled))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OnWillRenderObject(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnWillRenderObject")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn RenderMirror(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (currentCamera))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_mirrorDidChangeEnabledStateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn get_reflectionPlaneTransform(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_reflectionPlaneTransform", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_mirrorDidChangeEnabledStateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
