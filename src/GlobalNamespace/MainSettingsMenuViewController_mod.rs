...
pub struct MainSettingsMenuViewController {
    ...
    pub _settingsSubMenuInfos: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _settingsMenuSegmentedControl: quest_hook::libil2cpp::Gc<crate::HMUI::TextSegmentedControl>,
    pub _selectedSubMenuInfo:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SettingsSubMenuInfo>,
    pub _selectedSubMenuInfoIdx: i32,
}
#[cfg(feature = "cordl_class_MainSettingsMenuViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainSettingsMenuViewController {
...
impl crate::GlobalNamespace::MainSettingsMenuViewController {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (selectedSubMenuInfoIdx))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_selectedSubMenuInfo", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SettingsSubMenuInfo> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MainSettingsMenuViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MainSettingsMenuViewController {
