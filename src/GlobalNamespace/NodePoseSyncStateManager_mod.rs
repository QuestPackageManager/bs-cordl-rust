...
#[cfg(feature = "cordl_class_NodePoseSyncStateManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NodePoseSyncStateManager {
...
impl crate::GlobalNamespace::NodePoseSyncStateManager {
    ...
    pub fn Smooth(
        ...
        let __cordl_ret: crate::GlobalNamespace::PoseSerializable =
            unsafe { cordl_method_info.invoke_unchecked(self, (a, b, smooth))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_NodePoseSyncStateManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NodePoseSyncStateManager {
