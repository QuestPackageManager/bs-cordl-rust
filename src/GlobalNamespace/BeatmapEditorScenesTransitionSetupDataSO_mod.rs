...
impl std::ops::Deref for crate::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO {
...
#[cfg(feature = "BeatmapEditorScenesTransitionSetupDataSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO {
...
impl crate::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (goStraightToEditor))? };
        Ok(__cordl_ret.into())
    }
