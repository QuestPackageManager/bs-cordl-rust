...
pub struct StandardLevelDetailViewController___BuyPackButtonWasPressed_b__55_0_d {
    ...
    pub __4__this: *mut StandardLevelDetailViewController,
...
pub struct StandardLevelDetailViewController {
    ...
    pub _standardLevelDetailView: *mut StandardLevelDetailView,
    pub _standardLevelBuyView: *mut StandardLevelBuyView,
    pub _standardLevelBuyInfoView: *mut StandardLevelBuyInfoView,
    ...
    >,
    pub _ownedObjectsEventBinder: *mut EventBinder,
    ...
    pub _pack: *mut BeatmapLevelPack,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for StandardLevelDetailViewController => ""
    ."StandardLevelDetailViewController"
);
#[cfg(feature = "StandardLevelDetailViewController")]
impl std::ops::Deref for StandardLevelDetailViewController {
...
#[cfg(feature = "StandardLevelDetailViewController")]
impl std::ops::DerefMut for StandardLevelDetailViewController {
...
impl StandardLevelDetailViewController {
    ...
    pub fn HandleDidChangeDifficultyBeatmap(
        &mut self,
        view: *mut StandardLevelDetailView,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
...
#[cfg(feature = "StandardLevelDetailViewController")]
impl quest_hook::libil2cpp::ObjectType for StandardLevelDetailViewController {
