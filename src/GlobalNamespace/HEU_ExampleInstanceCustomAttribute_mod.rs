#[cfg(feature = "cordl_class_HEU_ExampleInstanceCustomAttribute")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::HEU_ExampleInstanceCustomAttribute {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (name, arr, tupleSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LogAttr(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "LogAttr",
                            1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (outAttr))?
        };
        Ok(__cordl_ret.into())
    }
