...
for crate::GlobalNamespace::TrailerGameplayManager {
    ...
    const CLASS_NAME: &'static str = "TrailerGameplayManager";
...
impl crate::GlobalNamespace::TrailerGameplayManager {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TrailerGameplayManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TrailerGameplayManager as
