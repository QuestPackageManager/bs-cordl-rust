...
impl crate::GlobalNamespace::SonyLevelProductCollectionModel {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sonyLevelProductPacksSOs))?
        };
        Ok(__cordl_ret.into())
    }
}
