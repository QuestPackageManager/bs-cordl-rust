...
impl crate::GlobalNamespace::CenterStageScreenController {
    ...
    pub fn SetCountdownEndTime(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (countdownEndTime))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Setup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (showModifiers))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Show(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShowCountdownColorPreset", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
