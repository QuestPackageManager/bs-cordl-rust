    ...
    for crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridViewAnimator
{
    ...
    const CLASS_NAME: &'static str = "AnnotatedBeatmapLevelCollectionsGridViewAnimator";
...
impl std::ops::Deref for crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridViewAnimator {
...
impl crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridViewAnimator {
    pub fn AnimateClose(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selectedColumn, selectedRow, animated))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AnimateOpen(
    ...
    pub fn Init(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32, f32, i32, i32, i32), quest_hook::libil2cpp::Void, 5usize>(
                        "Init",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn ScrollToRowIdxInstant(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (selectedColumn, selectedRow))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _AnimateClose_b__19_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<AnimateClose>b__19_1")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _AnimateClose_b__19_3(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<AnimateClose>b__19_3")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _AnimateOpen_b__18_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<AnimateOpen>b__18_1")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _AnimateOpen_b__18_3(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<AnimateOpen>b__18_3")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
