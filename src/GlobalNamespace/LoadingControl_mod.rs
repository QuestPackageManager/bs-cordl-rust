...
pub struct LoadingControl {
    ...
    pub _donwloadingProgressImage: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Image>,
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LoadingControl {
    ...
    const CLASS_NAME: &'static str = "LoadingControl";
...
impl crate::GlobalNamespace::LoadingControl {
    ...
    pub fn ShowDownloadingProgress(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (text, downloadingProgress))? };
        Ok(__cordl_ret.into())
    }
    pub fn ShowLoading(
        &mut self,
    ...
    pub fn ShowText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (text, showRefreshButton))? };
        Ok(__cordl_ret.into())
    }
    pub fn _Awake_b__14_0(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_didPressRefreshButtonEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_didPressRefreshButtonEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
