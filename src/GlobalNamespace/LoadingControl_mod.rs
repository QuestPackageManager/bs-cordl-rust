...
impl crate::GlobalNamespace::LoadingControl {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShowDownloadingProgress", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (text, downloadingProgress))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ShowLoading(
    ...
    pub fn ShowText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (text, showRefreshButton))?
        };
        Ok(__cordl_ret.into())
    }
