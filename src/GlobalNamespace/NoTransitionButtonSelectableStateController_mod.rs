    ...
    for crate::GlobalNamespace::NoTransitionButtonSelectableStateController
{
    ...
    const CLASS_NAME: &'static str = "NoTransitionButtonSelectableStateController";
...
impl std::ops::Deref for crate::GlobalNamespace::NoTransitionButtonSelectableStateController {
...
#[cfg(feature = "NoTransitionButtonSelectableStateController")]
impl std::ops::DerefMut for crate::GlobalNamespace::NoTransitionButtonSelectableStateController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleNoTransitionButtonSelectionStateDidChange", 1usize
                        )
                    })
            });
    ...
    pub fn ResolveSelectionState(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (crate::HMUI::NoTransitionsButton_SelectionState, bool),
                        quest_hook::libil2cpp::Void,
                        2usize,
