...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for CubemapHelpers => ""."CubemapHelpers"
);
#[cfg(feature = "CubemapHelpers")]
impl std::ops::Deref for CubemapHelpers {
...
#[cfg(feature = "CubemapHelpers")]
impl std::ops::DerefMut for CubemapHelpers {
...
#[cfg(feature = "CubemapHelpers")]
impl quest_hook::libil2cpp::ObjectType for CubemapHelpers {
