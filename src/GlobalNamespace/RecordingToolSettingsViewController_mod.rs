...
for crate::GlobalNamespace::RecordingToolSettingsViewController {
    ...
    const CLASS_NAME: &'static str = "RecordingToolSettingsViewController";
...
impl crate::GlobalNamespace::RecordingToolSettingsViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RecordingToolSettingsViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RecordingToolSettingsViewController as
