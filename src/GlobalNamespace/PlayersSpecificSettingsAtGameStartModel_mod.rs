...
pub struct PlayersSpecificSettingsAtGameStartModel {
    ...
    pub _localPlayerSpecificSettings_k__BackingField:
...
impl std::ops::Deref for crate::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel {
...
#[cfg(feature = "PlayersSpecificSettingsAtGameStartModel")]
impl std::ops::DerefMut for crate::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel {
...
impl crate::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel {
    ...
    pub fn SaveFromNetSerializable(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (playersAtGameStartNetSerializable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::PlayerSpecificSettingsNetSerializable,
                    >, 0usize>("get_localPlayerSpecificSettings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable,
                    >, 0usize>("get_playersAtGameStartNetSerializable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
