...
impl crate::GlobalNamespace::SecureRandomProvider {
    ...
    pub fn GetByte() -> quest_hook::libil2cpp::Result<u8> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SecureRandomProvider as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(), u8, 0usize>("GetByte")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SecureRandomProvider as
                    quest_hook::libil2cpp::Type > ::class(), "GetByte", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SecureRandomProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SecureRandomProvider as
                    quest_hook::libil2cpp::Type > ::class(), "GetBytes", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SecureRandomProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SecureRandomProvider as
                    quest_hook::libil2cpp::Type > ::class(), "GetBytes", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (buffer, offset, length))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::SecureRandomProvider_SecureRandomState {
    ...
    pub fn FillBuffer(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SecureRandomProvider_SecureRandomState as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FillBuffer")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SecureRandomProvider_SecureRandomState as
                    quest_hook::libil2cpp::Type > ::class(), "FillBuffer", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
