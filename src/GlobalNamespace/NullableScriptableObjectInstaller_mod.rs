...
pub struct NullableScriptableObjectInstaller {
    ...
    pub _installer: quest_hook::libil2cpp::Gc<crate::Zenject::ScriptableObjectInstaller>,
}
#[cfg(feature = "NullableScriptableObjectInstaller")]
...
for crate::GlobalNamespace::NullableScriptableObjectInstaller {
    ...
    const CLASS_NAME: &'static str = "NullableScriptableObjectInstaller";
...
impl crate::GlobalNamespace::NullableScriptableObjectInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NullableScriptableObjectInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::NullableScriptableObjectInstaller as
