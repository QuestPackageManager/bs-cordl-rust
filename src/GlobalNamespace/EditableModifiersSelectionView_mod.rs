...
pub struct EditableModifiersSelectionView {
    ...
    pub _modifiersListCanvasGroup: quest_hook::libil2cpp::Gc<crate::UnityEngine::CanvasGroup>,
    pub _interactable: bool,
    pub _showClearButton_k__BackingField: bool,
}
#[cfg(feature = "cordl_class_EditableModifiersSelectionView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EditableModifiersSelectionView {
...
impl crate::GlobalNamespace::EditableModifiersSelectionView {
    ...
    pub fn Setup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (showClearButton))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_clearButton(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Button>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_clearButton", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Button> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_EditableModifiersSelectionView")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EditableModifiersSelectionView {
