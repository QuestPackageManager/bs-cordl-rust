...
for crate::GlobalNamespace::ProModeTrailingCollidersController {
    ...
    const CLASS_NAME: &'static str = "ProModeTrailingCollidersController";
...
impl crate::GlobalNamespace::ProModeTrailingCollidersController {
    pub fn HandleNoteDidMoveInJumpPhase(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ProModeTrailingCollidersController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ProModeTrailingCollidersController as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleNoteDidMoveInJumpPhase", 0usize
                )
            });
