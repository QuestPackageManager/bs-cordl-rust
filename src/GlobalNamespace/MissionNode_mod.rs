#[cfg(feature = "cordl_class_MissionNode")]
#[repr(C)]
#[derive(Debug)]
pub struct MissionNode {
    ...
    pub _missionNodeVisualController:
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_formattedMissionNodeName", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_missionData", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionDataSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_missionNodeVisualController", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
...
#[cfg(feature = "MissionNode")]
impl AsRef<crate::GlobalNamespace::IMissionNode> for crate::GlobalNamespace::MissionNode {
    fn as_ref(&self) -> &crate::GlobalNamespace::IMissionNode {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "MissionNode")]
impl AsMut<crate::GlobalNamespace::IMissionNode> for crate::GlobalNamespace::MissionNode {
