...
impl crate::GlobalNamespace::DynamicScenesTransitionSetupDataSO {
    ...
    pub fn SetScenes(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DynamicScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    ...
                    quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<
                                crate::GlobalNamespace::SceneSetupData,
                            >,
                        >,
                    >,
                ),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DynamicScenesTransitionSetupDataSO as
                    quest_hook::libil2cpp::Type > ::class(), "SetScenes", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (scenes, sceneSetupData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
