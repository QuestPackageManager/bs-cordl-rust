...
> {
    ...
    __cordl_phantom_TConnectedPlayerManager: std::marker::PhantomData<TConnectedPlayerManager>,
    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "IMultiplayerSessionManager`4")
                .unwrap()
                .make_generic::<(
                    TConnectedPlayerManager,
                    TConnectedPlayer,
...
impl<
    ...
    >
{
    fn as_ref(&self) -> &crate::GlobalNamespace::IMultiplayerSessionManager_1<TConnectedPlayer> {
