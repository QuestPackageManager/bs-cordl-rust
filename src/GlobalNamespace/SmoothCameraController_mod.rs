#[cfg(feature = "cordl_class_SmoothCameraController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_SmoothCameraController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SmoothCameraController {
...
impl crate::GlobalNamespace::SmoothCameraController {
    ...
    pub fn HandleDidDeactivate(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleDidDeactivate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_SmoothCameraController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SmoothCameraController {
