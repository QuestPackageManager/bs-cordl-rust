...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SteamInit {
    ...
    const CLASS_NAME: &'static str = "SteamInit";
...
impl crate::GlobalNamespace::SteamInit {
    pub fn GetAppVersionAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SteamInit as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Threading::Tasks::Task_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SteamInit as quest_hook::libil2cpp::Type >
