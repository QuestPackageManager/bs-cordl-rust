...
impl crate::GlobalNamespace::StandaloneMonobehavior {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::IEnumerator,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (tcs, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
