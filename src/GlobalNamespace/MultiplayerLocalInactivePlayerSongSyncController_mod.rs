...
impl crate::GlobalNamespace::MultiplayerLocalInactivePlayerSongSyncController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FollowOffsetSyncTime", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (observable, crossFade, forceUpdate))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SeekTo__cordl_bool_f32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (offsetTime, crossFade, toVolume))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SeekTo_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (offsetTime))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateOffsetSyncTime", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (offsetSyncTime, crossFade, forceUpdate))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
