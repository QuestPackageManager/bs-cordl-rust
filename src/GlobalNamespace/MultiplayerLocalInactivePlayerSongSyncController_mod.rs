...
pub struct MultiplayerLocalInactivePlayerSongSyncController {
    ...
    pub _observable: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IMultiplayerObservable>,
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLocalInactivePlayerSongSyncController {
...
impl crate::GlobalNamespace::MultiplayerLocalInactivePlayerSongSyncController {
    ...
    pub fn FollowOffsetSyncTime(
        &mut self,
        observable: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IMultiplayerObservable>,
        crossFade: bool,
        forceUpdate: bool,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (observable, crossFade, forceUpdate))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SeekTo__cordl_bool_f32_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32, bool, f32), quest_hook::libil2cpp::Void, 3usize>("SeekTo")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (offsetTime, crossFade, toVolume))? };
        Ok(__cordl_ret.into())
    }
    pub fn SeekTo_f32_0(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (offsetTime))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateOffsetSyncTime(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64, bool, bool), quest_hook::libil2cpp::Void, 3usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (offsetSyncTime, crossFade, forceUpdate))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _get_waitUntilIsReadyToStartTheSong_b__7_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("<get_waitUntilIsReadyToStartTheSong>b__7_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
