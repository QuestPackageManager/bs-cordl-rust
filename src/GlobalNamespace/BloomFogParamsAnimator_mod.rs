...
impl crate::GlobalNamespace::BloomFogParamsAnimator {
    pub fn AnimateBloomFogParamsChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (envFogParams, duration))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetBloomFogParamsChange", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (envFogParams, transition))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetDefaultBloomFogParams(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (newDefaultBloomFogParams))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
