...
for crate::GlobalNamespace::BasicBeatmapEventDataProcessor {
    ...
    const CLASS_NAME: &'static str = "BasicBeatmapEventDataProcessor";
...
impl crate::GlobalNamespace::BasicBeatmapEventDataProcessor {
    ...
    pub fn ProcessBeforeDeleteEventDataInternal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BasicBeatmapEventDataProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BasicBeatmapEventDataProcessor as
