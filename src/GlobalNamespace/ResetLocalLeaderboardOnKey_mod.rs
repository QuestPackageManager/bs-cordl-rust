...
for crate::GlobalNamespace::ResetLocalLeaderboardOnKey {
    ...
    const CLASS_NAME: &'static str = "ResetLocalLeaderboardOnKey";
...
impl crate::GlobalNamespace::ResetLocalLeaderboardOnKey {
    ...
    pub fn Update(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ResetLocalLeaderboardOnKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Update")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ResetLocalLeaderboardOnKey as
