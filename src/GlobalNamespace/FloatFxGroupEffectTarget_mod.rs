#[cfg(feature = "cordl_class_FloatFxGroupEffectTarget")]
#[repr(C)]
#[derive(Debug)]
pub struct FloatFxGroupEffectTarget {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
}
#[cfg(feature = "cordl_class_FloatFxGroupEffectTarget")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FloatFxGroupEffectTarget {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "FloatFxGroupEffectTarget";
...
#[cfg(feature = "cordl_class_FloatFxGroupEffectTarget")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::FloatFxGroupEffectTarget {
