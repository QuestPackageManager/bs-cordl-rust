...
pub struct OrderedSet_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _comparison: quest_hook::libil2cpp::Gc<T>,
    pub _processOrder: crate::GlobalNamespace::OrderedSet_1_ProcessOrder<T>,
    pub _sortIndices: quest_hook::libil2cpp::Gc<T, quest_hook::libil2cpp::Gc<T>>,
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::OrderedSet_1<T> {
    ...
    pub fn SwapNodes(
        &mut self,
        previous: quest_hook::libil2cpp::Gc<T>,
        next: quest_hook::libil2cpp::Gc<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (previous, next))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateSortedPosition_Gc1(
        &mut self,
        node: quest_hook::libil2cpp::Gc<T>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (comparison, processOrder))?
        };
        Ok(__cordl_ret.into())
    }
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::OrderedSet_1_Node<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, clearCount))?
        };
        Ok(__cordl_ret.into())
    }
}
