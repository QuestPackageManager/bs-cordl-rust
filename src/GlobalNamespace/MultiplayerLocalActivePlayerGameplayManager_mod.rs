...
pub struct MultiplayerLocalActivePlayerGameplayManager {
    ...
    pub _multiplayerLevelEndActions:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IMultiplayerLevelEndActionsListener>,
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayManager {
...
#[cfg(feature = "MultiplayerLocalActivePlayerGameplayManager")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayManager {
...
impl crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayManager {
    ...
    pub fn PerformPlayerGivenUp(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("PerformPlayerGivenUp")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
