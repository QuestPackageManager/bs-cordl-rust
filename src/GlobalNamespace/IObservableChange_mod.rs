...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IObservableChange {
    ...
    const CLASS_NAME: &'static str = "IObservableChange";
...
impl crate::GlobalNamespace::IObservableChange {
    pub fn add_didChangeEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IObservableChange as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IObservableChange as
