...
impl std::ops::Deref for crate::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer {
...
#[cfg(feature = "BloomPrePassBackgroundParticleSystemRenderer")]
impl std::ops::DerefMut for crate::GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer {
