...
pub struct AnnotatedBeatmapLevelCollectionsGridView {
    ...
    >,
    pub _cellPrefab:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionCell>,
    pub _cellWidth: f32,
    pub _cellHeight: f32,
    ...
    pub didOpenAnnotatedBeatmapLevelCollectionEvent:
        quest_hook::libil2cpp::Gc<crate::System::Action>,
    pub didCloseAnnotatedBeatmapLevelCollectionEvent:
        quest_hook::libil2cpp::Gc<crate::System::Action>,
...
impl std::ops::Deref for crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridView {
...
#[cfg(feature = "AnnotatedBeatmapLevelCollectionsGridView")]
impl std::ops::DerefMut for crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridView {
...
impl crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridView {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::Component>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Component> =
            unsafe { cordl_method_info.invoke_unchecked(self, (gridView, idx))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleCellSelectionDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selectableCell, transition, changeOwner))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RefreshAvailability(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RefreshAvailability")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (annotatedBeatmapLevelCollections))?
        };
        Ok(__cordl_ret.into())
    }
