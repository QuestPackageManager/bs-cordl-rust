...
impl crate::GlobalNamespace::ArrayPositionTween {
    pub fn CreatePlayable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ArrayPositionTween as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ArrayPositionTween as
