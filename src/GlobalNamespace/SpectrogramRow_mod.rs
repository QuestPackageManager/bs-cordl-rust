...
#[cfg(feature = "SpectrogramRow")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SpectrogramRow {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SpectrogramRow";
...
impl crate::GlobalNamespace::SpectrogramRow {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SpectrogramRow as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SpectrogramRow as
