...
impl crate::GlobalNamespace::EffectPoolsManualInstaller {
    pub fn ManualInstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EffectPoolsManualInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EffectPoolsManualInstaller as
                    quest_hook::libil2cpp::Type > ::class(), "ManualInstallBindings",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (container, shortBeatEffect))?
        };
        Ok(__cordl_ret.into())
    }
