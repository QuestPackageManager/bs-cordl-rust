...
for crate::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO {
    ...
    const CLASS_NAME: &'static str = "MultiplayerBadgeDataPersonalBestSO";
...
impl crate::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IReadOnlyList_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerBadgeDataPersonalBestSO as
