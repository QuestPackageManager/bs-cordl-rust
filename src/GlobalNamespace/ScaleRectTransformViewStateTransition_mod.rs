...
impl crate::GlobalNamespace::ScaleRectTransformViewStateTransition {
    ...
    pub fn SetDisabledState(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ScaleRectTransformViewStateTransition as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetDisabledState")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ScaleRectTransformViewStateTransition as
    ...
    pub fn StartTween(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (endScale, transitionTiming))?
        };
        Ok(__cordl_ret.into())
    }
