...
pub struct ScaleRectTransformViewStateTransition {
    ...
    >,
    pub _transition: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::Vector3TransitionSO>,
...
#[cfg(feature = "ScaleRectTransformViewStateTransition")]
impl std::ops::DerefMut for crate::GlobalNamespace::ScaleRectTransformViewStateTransition {
...
impl crate::GlobalNamespace::ScaleRectTransformViewStateTransition {
    ...
    pub fn StartTween(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (endScale, transitionTiming))? };
        Ok(__cordl_ret.into())
    }
