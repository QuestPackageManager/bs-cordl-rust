...
#[cfg(feature = "cordl_class_TimelinePauseReceiver")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TimelinePauseReceiver {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("OnNotify")
                    .unwrap_or_else(|e| {
                        panic!(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_timelinePauseEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_TimelinePauseReceiver")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TimelinePauseReceiver {
