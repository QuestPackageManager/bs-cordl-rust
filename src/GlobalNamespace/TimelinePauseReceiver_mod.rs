...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for TimelinePauseReceiver => ""."TimelinePauseReceiver"
);
#[cfg(feature = "TimelinePauseReceiver")]
impl std::ops::Deref for TimelinePauseReceiver {
...
#[cfg(feature = "TimelinePauseReceiver")]
impl std::ops::DerefMut for TimelinePauseReceiver {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "TimelinePauseReceiver")]
impl TimelinePauseReceiver {
    pub fn OnNotify(
        &mut self,
...
#[cfg(feature = "TimelinePauseReceiver")]
impl quest_hook::libil2cpp::ObjectType for TimelinePauseReceiver {
