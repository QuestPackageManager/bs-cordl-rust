...
impl crate::GlobalNamespace::LeaderboardIdsModel {
    ...
    pub fn TryGetPlatformLeaderboardId(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    ), bool, 2usize>("TryGetPlatformLeaderboardId")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (beatmapKey, platformLeaderboardId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (idsMaps))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_LeaderboardIdsModel")]
