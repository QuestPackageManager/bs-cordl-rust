...
#[cfg(feature = "LeaderboardIdsModel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LeaderboardIdsModel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LeaderboardIdsModel";
...
impl crate::GlobalNamespace::LeaderboardIdsModel {
    ...
    pub fn TryGetPlatformLeaderboardId(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LeaderboardIdsModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LeaderboardIdsModel as
                    quest_hook::libil2cpp::Type > ::class(),
                    "TryGetPlatformLeaderboardId", 2usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (beatmapKey, platformLeaderboardId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
