...
impl crate::GlobalNamespace::LeaderboardViewController {
    ...
    pub fn RefreshLevelStats(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LeaderboardViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RefreshLevelStats")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LeaderboardViewController as
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (previewDifficultyBeatmap))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
