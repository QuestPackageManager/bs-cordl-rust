#[cfg(feature = "cordl_class_LeaderboardViewController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_LeaderboardViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LeaderboardViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LeaderboardViewController";
...
impl crate::GlobalNamespace::LeaderboardViewController {
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (previewDifficultyBeatmap))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_LeaderboardViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LeaderboardViewController {
