...
for crate::GlobalNamespace::BakedLightWithIdBase {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BakedLightWithIdBase";
...
impl crate::GlobalNamespace::BakedLightWithIdBase {
    ...
    pub fn SetupLightSource(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BakedLightWithIdBase as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BakedLightWithIdBase as
                    quest_hook::libil2cpp::Type > ::class(), "SetupLightSource", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (intensityMultiplier))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
