#[cfg(feature = "cordl_class_BakedLightWithIdBase")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BakedLightWithIdBase")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BakedLightWithIdBase {
...
impl crate::GlobalNamespace::BakedLightWithIdBase {
    ...
    pub fn SetupLightSource(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("SetupLightSource")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (intensityMultiplier))? };
        Ok(__cordl_ret.into())
    }
