...
impl crate::GlobalNamespace::INoteControllerNoteWasCutEvent {
    pub fn HandleNoteControllerNoteWasCut(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INoteControllerNoteWasCutEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INoteControllerNoteWasCutEvent as
