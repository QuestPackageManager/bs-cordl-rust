...
for crate::GlobalNamespace::LightRotationGroupEffectManager {
    ...
    const CLASS_NAME: &'static str = "LightRotationGroupEffectManager";
...
impl crate::GlobalNamespace::LightRotationGroupEffectManager {
    ...
    pub fn OnDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightRotationGroupEffectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDestroy")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LightRotationGroupEffectManager as
