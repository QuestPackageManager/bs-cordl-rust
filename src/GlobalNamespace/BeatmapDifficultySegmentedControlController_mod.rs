...
pub struct BeatmapDifficultySegmentedControlController {
    ...
    pub _difficultySegmentedControl: quest_hook::libil2cpp::Gc<crate::HMUI::TextSegmentedControl>,
    ...
    pub _difficulties: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::GlobalNamespace::BeatmapDifficulty>,
    >,
    ...
    for crate::GlobalNamespace::BeatmapDifficultySegmentedControlController
{
    ...
    const CLASS_NAME: &'static str = "BeatmapDifficultySegmentedControlController";
...
impl std::ops::Deref for crate::GlobalNamespace::BeatmapDifficultySegmentedControlController {
...
#[cfg(feature = "BeatmapDifficultySegmentedControlController")]
impl std::ops::DerefMut for crate::GlobalNamespace::BeatmapDifficultySegmentedControlController {
...
impl crate::GlobalNamespace::BeatmapDifficultySegmentedControlController {
    ...
    pub fn GetClosestDifficultyIndex(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::BeatmapDifficulty), i32, 1usize>(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (searchDifficulty))? };
        Ok(__cordl_ret.into())
    }
