...
impl crate::GlobalNamespace::BeatmapCallbacksController {
    ...
    pub fn AddBeatmapCallback_Gc_Il2CppArray2<T>(
        &mut self,
        callback: quest_hook::libil2cpp::Gc<T>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::BeatmapDataCallbackWrapper,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (aheadTime, callback))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddBeatmapCallback_f32_Gc_Il2CppArray3<T>(
        &mut self,
        aheadTime: f32,
        callback: quest_hook::libil2cpp::Gc<T>,
        beatmapDataSubtypeIdentifiers: quest_hook::libil2cpp::Gc<
...
impl crate::GlobalNamespace::BeatmapCallbacksController_CallCallbacksBehavior {
    pub fn CallCallbacks(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (callbacksInTime, beatmapDataItem))?
        };
        Ok(__cordl_ret.into())
    }
