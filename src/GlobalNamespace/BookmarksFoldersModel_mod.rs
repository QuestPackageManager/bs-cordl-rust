...
for crate::GlobalNamespace::BookmarksFoldersModel {
    ...
    const CLASS_NAME: &'static str = "BookmarksFoldersModel";
...
impl crate::GlobalNamespace::BookmarksFoldersModel {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BookmarksFoldersModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BookmarksFoldersModel as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BookmarksFoldersModel as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BookmarksFoldersModel as
                    quest_hook::libil2cpp::Type > ::class(), "get_bookmarksFolders",
                    0usize
                )
            });
