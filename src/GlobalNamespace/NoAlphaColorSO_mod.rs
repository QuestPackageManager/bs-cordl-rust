...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoAlphaColorSO {
    ...
    const CLASS_NAME: &'static str = "NoAlphaColorSO";
...
#[cfg(feature = "NoAlphaColorSO")]
impl crate::GlobalNamespace::NoAlphaColorSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoAlphaColorSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::NoAlphaColorSO as
