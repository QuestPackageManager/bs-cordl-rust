...
for crate::GlobalNamespace::ArcVisibilityTypeSettingsDropdown {
    ...
    const CLASS_NAME: &'static str = "ArcVisibilityTypeSettingsDropdown";
...
#[cfg(feature = "ArcVisibilityTypeSettingsDropdown")]
impl crate::GlobalNamespace::ArcVisibilityTypeSettingsDropdown {
    pub fn GetNamedValues(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ArcVisibilityTypeSettingsDropdown as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::IReadOnlyList_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ArcVisibilityTypeSettingsDropdown as
