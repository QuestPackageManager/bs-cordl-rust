...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for PingUtility => ""."PingUtility"
);
#[cfg(feature = "PingUtility")]
impl std::ops::Deref for PingUtility {
...
#[cfg(feature = "PingUtility")]
impl std::ops::DerefMut for PingUtility {
...
#[cfg(feature = "PingUtility")]
impl quest_hook::libil2cpp::ObjectType for PingUtility {
