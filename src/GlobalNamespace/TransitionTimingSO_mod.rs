...
#[cfg(feature = "TransitionTimingSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TransitionTimingSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "TransitionTimingSO";
...
impl crate::GlobalNamespace::TransitionTimingSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TransitionTimingSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::TransitionTimingSO as
    ...
    pub fn get_easeDuration(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TransitionTimingSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("get_easeDuration")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::TransitionTimingSO as
                    quest_hook::libil2cpp::Type > ::class(), "get_easeDuration", 0usize
                )
            });
