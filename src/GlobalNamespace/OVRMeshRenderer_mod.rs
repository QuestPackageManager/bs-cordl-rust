...
pub struct OVRMeshRenderer {
    ...
    pub _skinnedMeshRenderer: quest_hook::libil2cpp::Gc<crate::UnityEngine::SkinnedMeshRenderer>,
...
impl crate::GlobalNamespace::OVRMeshRenderer {
    ...
    pub fn ForceRebind(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ForceRebind")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "OVRMeshRenderer+IOVRMeshRendererDataProvider")]
impl std::ops::Deref for crate::GlobalNamespace::OVRMeshRenderer_IOVRMeshRendererDataProvider {
...
#[cfg(feature = "OVRMeshRenderer+IOVRMeshRendererDataProvider")]
impl std::ops::DerefMut for crate::GlobalNamespace::OVRMeshRenderer_IOVRMeshRendererDataProvider {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
