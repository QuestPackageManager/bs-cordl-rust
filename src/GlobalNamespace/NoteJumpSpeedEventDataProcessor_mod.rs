...
for crate::GlobalNamespace::NoteJumpSpeedEventDataProcessor {
    ...
    const CLASS_NAME: &'static str = "NoteJumpSpeedEventDataProcessor";
...
impl crate::GlobalNamespace::NoteJumpSpeedEventDataProcessor {
    ...
    pub fn ProcessBeforeDeleteEventDataInternal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoteJumpSpeedEventDataProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoteJumpSpeedEventDataProcessor as
