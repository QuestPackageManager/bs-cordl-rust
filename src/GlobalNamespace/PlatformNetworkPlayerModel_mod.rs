...
impl crate::GlobalNamespace::PlatformNetworkPlayerModel {
    ...
    pub fn DestroyPartyConnection(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformNetworkPlayerModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PlatformNetworkPlayerModel as
...
impl crate::GlobalNamespace::PlatformNetworkPlayerModel_CreatePartyConfig {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformNetworkPlayerModel_CreatePartyConfig as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
