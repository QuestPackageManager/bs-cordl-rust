...
pub struct SpectrogramMultiplierFloatFxEffectTarget {
    ...
    pub _spectrogram:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SpectrogramRowPropertyAnimator>,
}
#[cfg(feature = "cordl_class_SpectrogramMultiplierFloatFxEffectTarget")]
    ...
    for crate::GlobalNamespace::SpectrogramMultiplierFloatFxEffectTarget
{
    ...
    const CLASS_NAME: &'static str = "SpectrogramMultiplierFloatFxEffectTarget";
...
impl std::ops::Deref for crate::GlobalNamespace::SpectrogramMultiplierFloatFxEffectTarget {
...
#[cfg(feature = "SpectrogramMultiplierFloatFxEffectTarget")]
impl std::ops::DerefMut for crate::GlobalNamespace::SpectrogramMultiplierFloatFxEffectTarget {
