...
for crate::GlobalNamespace::OVRSampledEventSender {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShouldSendEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (chance))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (markerId, recordRecordChance, addAnnotationsFunc),
                )?
        };
        Ok(__cordl_ret.into())
    }
