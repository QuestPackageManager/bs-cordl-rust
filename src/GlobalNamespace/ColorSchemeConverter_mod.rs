...
#[cfg(feature = "cordl_class_ColorSchemeConverter")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ColorSchemeConverter {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FromNetSerializable", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorScheme> =
            unsafe { cordl_method_info.invoke_unchecked((), (serialized))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_ColorSchemeConverter")]
