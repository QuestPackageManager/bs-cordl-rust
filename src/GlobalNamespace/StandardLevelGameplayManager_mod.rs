#[cfg(feature = "cordl_class_StandardLevelGameplayManager")]
#[repr(C)]
#[derive(Debug)]
pub struct StandardLevelGameplayManager {
    ...
    pub _pauseController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PauseController>,
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::StandardLevelGameplayManager_InitData>,
...
#[cfg(feature = "cordl_class_StandardLevelGameplayManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::StandardLevelGameplayManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StandardLevelGameplayManager";
...
impl crate::GlobalNamespace::StandardLevelGameplayManager {
    ...
    pub fn HandleSongDidFinish(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleSongDidFinish")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_levelEndStateType", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::LevelCompletionResults_LevelEndStateType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_levelDidStartEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_levelFailedEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_StandardLevelGameplayManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::StandardLevelGameplayManager {
...
#[cfg(feature = "cordl_class_StandardLevelGameplayManager+GameState")]
    ...
    for crate::GlobalNamespace::StandardLevelGameplayManager_GameState
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StandardLevelGameplayManager/GameState";
...
#[cfg(feature = "cordl_class_StandardLevelGameplayManager+InitData")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::StandardLevelGameplayManager_InitData
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StandardLevelGameplayManager/InitData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "StandardLevelGameplayManager+InitData")]
impl std::ops::DerefMut for crate::GlobalNamespace::StandardLevelGameplayManager_InitData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::StandardLevelGameplayManager_InitData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (continueGameplayWith0Energy))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_StandardLevelGameplayManager+InitData")]
