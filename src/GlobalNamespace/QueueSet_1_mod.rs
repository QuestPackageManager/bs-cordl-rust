...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for QueueSet_1 < T > => ""."QueueSet`1" < T >
);
#[cfg(feature = "QueueSet_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for QueueSet_1<T> {
...
#[cfg(feature = "QueueSet_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for QueueSet_1<T> {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "QueueSet_1")]
impl<T: quest_hook::libil2cpp::Type> QueueSet_1<T> {
