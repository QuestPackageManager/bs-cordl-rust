#[cfg(feature = "cordl_class_MissionLevelScenesTransitionSetupDataSO")]
#[repr(C)]
#[derive(Debug)]
pub struct MissionLevelScenesTransitionSetupDataSO {
    ...
    pub didFinishEvent: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _missionId_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_MissionLevelScenesTransitionSetupDataSO")]
...
impl std::ops::Deref for crate::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO {
...
#[cfg(feature = "MissionLevelScenesTransitionSetupDataSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 15usize>("Init")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
