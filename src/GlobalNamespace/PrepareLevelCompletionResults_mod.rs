...
impl crate::GlobalNamespace::PrepareLevelCompletionResults {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PrepareLevelCompletionResults as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PrepareLevelCompletionResults as
                    quest_hook::libil2cpp::Type > ::class(),
                    "FillLevelCompletionResults", 2usize
                )
            });
