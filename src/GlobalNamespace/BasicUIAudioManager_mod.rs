...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BasicUIAudioManager => ""."BasicUIAudioManager"
);
#[cfg(feature = "BasicUIAudioManager")]
impl std::ops::Deref for BasicUIAudioManager {
...
#[cfg(feature = "BasicUIAudioManager")]
impl std::ops::DerefMut for BasicUIAudioManager {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BasicUIAudioManager")]
impl BasicUIAudioManager {
...
#[cfg(feature = "BasicUIAudioManager")]
impl quest_hook::libil2cpp::ObjectType for BasicUIAudioManager {
