...
#[cfg(feature = "AudioSettingsDspTimeProvider")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IDspTimeProvider>>
for crate::GlobalNamespace::AudioSettingsDspTimeProvider {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IDspTimeProvider> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "AudioSettingsDspTimeProvider")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IDspTimeProvider>>
for crate::GlobalNamespace::AudioSettingsDspTimeProvider {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IDspTimeProvider> {
        unsafe { std::mem::transmute(self) }
    }
}
