...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for LightTranslationBeatmapEventData => ""
    ."LightTranslationBeatmapEventData"
);
#[cfg(feature = "LightTranslationBeatmapEventData")]
impl std::ops::Deref for LightTranslationBeatmapEventData {
...
#[cfg(feature = "LightTranslationBeatmapEventData")]
impl std::ops::DerefMut for LightTranslationBeatmapEventData {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "LightTranslationBeatmapEventData")]
impl LightTranslationBeatmapEventData {
...
#[cfg(feature = "LightTranslationBeatmapEventData")]
impl quest_hook::libil2cpp::ObjectType for LightTranslationBeatmapEventData {
