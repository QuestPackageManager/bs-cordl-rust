...
impl crate::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RecordingToolSettingsNoTransitionInstaller
                    as quest_hook::libil2cpp::Type > ::class(), "InstallBindings", 1usize
                )
            });
