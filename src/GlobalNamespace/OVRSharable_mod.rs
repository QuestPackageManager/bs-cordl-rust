#[cfg(feature = "cordl_class_OVRSharable")]
...
#[cfg(feature = "cordl_class_OVRSharable")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRSharable {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRSharable";
...
#[cfg(feature = "cordl_class_OVRSharable")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::OVRSharable {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVRSharable")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::OVRSharable {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRSharable")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::OVRSharable {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRSharable")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::OVRSharable {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::OVRSharable {
    ...
    pub fn Equals_OVRSharable0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::OVRSharable), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRSharable>.FromAnchor", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::OVRSharable =
    ...
    pub fn IOVRAnchorComponent_OVRSharable__get_Handle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), u64, 0usize>("IOVRAnchorComponent<OVRSharable>.get_Handle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRSharable>.get_Type", 0usize
                        )
                    })
            });
...
#[cfg(feature = "OVRSharable")]
impl AsRef<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSharable>>
...
#[cfg(feature = "OVRSharable")]
impl AsMut<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSharable>>
    for crate::GlobalNamespace::OVRSharable
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSharable>
    {
        todo!()
    }
}
...
impl AsRef<crate::System::IEquatable_1<crate::GlobalNamespace::OVRSharable>>
    for crate::GlobalNamespace::OVRSharable
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::GlobalNamespace::OVRSharable> {
        todo!()
    }
}
#[cfg(feature = "OVRSharable")]
impl AsMut<crate::System::IEquatable_1<crate::GlobalNamespace::OVRSharable>>
    for crate::GlobalNamespace::OVRSharable
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::GlobalNamespace::OVRSharable> {
        todo!()
    }
}
