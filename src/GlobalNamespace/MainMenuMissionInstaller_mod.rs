...
pub struct MainMenuMissionInstaller {
    ...
    pub _missionNodesManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNodesManager>,
}
#[cfg(feature = "cordl_class_MainMenuMissionInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainMenuMissionInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MainMenuMissionInstaller";
...
#[cfg(feature = "cordl_class_MainMenuMissionInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MainMenuMissionInstaller {
