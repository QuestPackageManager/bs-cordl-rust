...
pub struct TutorialInstaller {
    ...
    pub _sceneSetupData: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TutorialSceneSetupData>,
    pub _environmentSceneSetupData:
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TutorialInstaller {
    ...
    const CLASS_NAME: &'static str = "TutorialInstaller";
