#[cfg(feature = "cordl_class_EnvironmentAudioEffectsPlayer")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_EnvironmentAudioEffectsPlayer")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnvironmentAudioEffectsPlayer {
...
impl crate::GlobalNamespace::EnvironmentAudioEffectsPlayer {
    ...
    pub fn PlayEffect(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        f32,
                    ), quest_hook::libil2cpp::Void, 2usize>("PlayEffect")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (clip, volume))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_audioSource(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioSource>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_audioSource", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioSource> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_EnvironmentAudioEffectsPlayer")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EnvironmentAudioEffectsPlayer {
