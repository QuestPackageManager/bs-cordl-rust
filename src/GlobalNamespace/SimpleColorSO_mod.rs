...
impl crate::GlobalNamespace::SimpleColorSO {
    ...
    pub fn SetColor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SimpleColorSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SimpleColorSO as quest_hook::libil2cpp::Type
