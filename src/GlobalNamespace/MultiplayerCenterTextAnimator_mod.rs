...
impl crate::GlobalNamespace::MultiplayerCenterTextAnimator {
    pub fn AnimateEnabled(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isEnabled, duration, easeType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AnimateFontSize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (fontSize, duration, easeType))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AnimatePositionOffsetSize", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (offset, duration, easeType))?
        };
        Ok(__cordl_ret.into())
    }
