...
#[cfg(feature = "LayerMasks")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LayerMasks {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LayerMasks";
...
impl crate::GlobalNamespace::LayerMasks {
    pub fn GetLayer(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LayerMasks as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LayerMasks as quest_hook::libil2cpp::Type >
                    ::class(), "GetLayer", 1usize
                )
            });
