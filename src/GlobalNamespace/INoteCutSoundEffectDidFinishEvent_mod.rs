...
impl crate::GlobalNamespace::INoteCutSoundEffectDidFinishEvent {
    pub fn HandleNoteCutSoundEffectDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INoteCutSoundEffectDidFinishEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INoteCutSoundEffectDidFinishEvent as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleNoteCutSoundEffectDidFinish", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (noteCutSoundEffect))?
        };
        Ok(__cordl_ret.into())
    }
