#[cfg(feature = "cordl_class_INoteCutSoundEffectDidFinishEvent")]
#[derive(Debug)]
#[repr(C)]
...
impl crate::GlobalNamespace::INoteCutSoundEffectDidFinishEvent {
    pub fn HandleNoteCutSoundEffectDidFinish(
        &mut self,
        noteCutSoundEffect: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::NoteCutSoundEffect>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (noteCutSoundEffect))? };
        Ok(__cordl_ret.into())
    }
