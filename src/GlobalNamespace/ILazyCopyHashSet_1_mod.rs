...
#[repr(C)]
#[derive(Debug)]
pub struct ILazyCopyHashSet_1<T: quest_hook::libil2cpp::Type> {
...
for crate::GlobalNamespace::ILazyCopyHashSet_1<T> {
    ...
    const CLASS_NAME: &'static str = "ILazyCopyHashSet`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("", "ILazyCopyHashSet`1")
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
                    .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::ILazyCopyHashSet_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ILazyCopyHashSet_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ILazyCopyHashSet_1 < T > as
