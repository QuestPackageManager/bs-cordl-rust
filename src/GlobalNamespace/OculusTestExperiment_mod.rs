...
#[cfg(feature = "cordl_class_OculusTestExperiment")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OculusTestExperiment {
...
impl crate::GlobalNamespace::OculusTestExperiment_ExperimentData {
    pub fn New(
        experimentPlatformKey: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (experimentPlatformKey))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_experimentPlatformKey", 0usize
                        )
                    })
            });
