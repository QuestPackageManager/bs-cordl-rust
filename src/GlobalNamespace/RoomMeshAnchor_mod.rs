...
pub struct RoomMeshAnchor {
    ...
    pub _anchor: crate::GlobalNamespace::OVRAnchor,
    pub _labels: crate::GlobalNamespace::OVRSemanticLabels,
    pub _triangleMeshComponent: crate::GlobalNamespace::OVRTriangleMesh,
...
#[cfg(feature = "cordl_class_RoomMeshAnchor")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RoomMeshAnchor {
...
#[cfg(feature = "RoomMeshAnchor")]
impl std::ops::Deref for crate::GlobalNamespace::RoomMeshAnchor {
...
#[cfg(feature = "RoomMeshAnchor")]
impl std::ops::DerefMut for crate::GlobalNamespace::RoomMeshAnchor {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "RoomMeshAnchor")]
impl crate::GlobalNamespace::RoomMeshAnchor {
...
#[cfg(feature = "cordl_class_RoomMeshAnchor")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RoomMeshAnchor {
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RoomMeshAnchor_BakeMeshJob {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RoomMeshAnchor/BakeMeshJob";
    ...
    for crate::GlobalNamespace::RoomMeshAnchor_GetTriangleMeshCountsJob
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RoomMeshAnchor/GetTriangleMeshCountsJob";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
    ...
    for crate::GlobalNamespace::RoomMeshAnchor_GetTriangleMeshJob
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RoomMeshAnchor/GetTriangleMeshJob";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
    ...
    for crate::GlobalNamespace::RoomMeshAnchor_PopulateMeshDataJob
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RoomMeshAnchor/PopulateMeshDataJob";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
