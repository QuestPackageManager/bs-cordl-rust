...
#[cfg(feature = "cordl_class_LevelCompletionResultsHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LevelCompletionResultsHelper {
...
impl crate::GlobalNamespace::LevelCompletionResultsHelper {
    pub fn Create(
        ...
        modifiedScore: i32,
        maxCombo: i32,
        saberActivityValues: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
        leftSaberMovementDistance: f32,
        rightSaberMovementDistance: f32,
        handActivityValues: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::PlatformLeaderboardsModel,
                        >,
                    ), quest_hook::libil2cpp::Void, 6usize>("ProcessScore")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_LevelCompletionResultsHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LevelCompletionResultsHelper {
