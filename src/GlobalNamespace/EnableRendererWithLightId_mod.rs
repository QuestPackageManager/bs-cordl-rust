...
for crate::GlobalNamespace::EnableRendererWithLightId {
    ...
    const CLASS_NAME: &'static str = "EnableRendererWithLightId";
...
impl crate::GlobalNamespace::EnableRendererWithLightId {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnableRendererWithLightId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EnableRendererWithLightId as
