...
for crate::GlobalNamespace::PlayerSensitivityDropdown {
    ...
    const CLASS_NAME: &'static str = "PlayerSensitivityDropdown";
...
impl crate::GlobalNamespace::PlayerSensitivityDropdown {
    pub fn GetNamedValues(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayerSensitivityDropdown as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::IReadOnlyList_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PlayerSensitivityDropdown as
