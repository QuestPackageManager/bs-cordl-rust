...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController {
...
impl crate::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController {
    ...
    pub fn SetConnectedPlayerSongTime(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64, f32), quest_hook::libil2cpp::Void, 2usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (syncTime, songTime))? };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController_InitData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (startSongTime, songTimeOffset, timeScale))?
        };
        Ok(__cordl_ret.into())
    }
}
