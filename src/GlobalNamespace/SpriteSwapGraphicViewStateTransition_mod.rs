#[cfg(feature = "cordl_class_SpriteSwapGraphicViewStateTransition")]
#[repr(C)]
...
pub struct SpriteSwapGraphicViewStateTransition {
    ...
    >,
    pub _transition: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SpriteSwapTransitionSO>,
}
#[cfg(feature = "cordl_class_SpriteSwapGraphicViewStateTransition")]
    ...
    for crate::GlobalNamespace::SpriteSwapGraphicViewStateTransition
{
    ...
    const CLASS_NAME: &'static str = "SpriteSwapGraphicViewStateTransition";
...
#[cfg(feature = "SpriteSwapGraphicViewStateTransition")]
impl std::ops::DerefMut for crate::GlobalNamespace::SpriteSwapGraphicViewStateTransition {
