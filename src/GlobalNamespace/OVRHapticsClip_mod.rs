#[cfg(feature = "cordl_class_OVRHapticsClip")]
#[repr(C)]
#[derive(Debug)]
pub struct OVRHapticsClip {
    ...
    pub _Samples_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
}
#[cfg(feature = "cordl_class_OVRHapticsClip")]
...
impl crate::GlobalNamespace::OVRHapticsClip {
    ...
    pub fn _ctor_AudioClip_i32_4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (audioClip, channel))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppArray_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (samples, samplesCount))? };
        Ok(__cordl_ret.into())
    }
