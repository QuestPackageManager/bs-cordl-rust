...
impl std::ops::Deref for crate::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO {
...
#[cfg(feature = "RecordingToolScenesTransitionSetupDataSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO {
...
impl crate::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (recordingToolSceneSetupData))? };
        Ok(__cordl_ret.into())
    }
