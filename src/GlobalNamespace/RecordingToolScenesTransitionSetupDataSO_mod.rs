...
impl crate::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO as
                    quest_hook::libil2cpp::Type > ::class(), "Init", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (recordingToolSceneSetupData))?
        };
        Ok(__cordl_ret.into())
    }
