...
for crate::GlobalNamespace::InputFieldSelectableStateController {
    ...
    const CLASS_NAME: &'static str = "InputFieldSelectableStateController";
...
impl crate::GlobalNamespace::InputFieldSelectableStateController {
    pub fn HandleInputFieldSelectionStateDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::InputFieldSelectableStateController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::InputFieldSelectableStateController as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleInputFieldSelectionStateDidChange", 1usize
                )
            });
    ...
    pub fn ResolveSelectionState(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::InputFieldSelectableStateController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::HMUI::InputFieldView_SelectionState, bool),
                quest_hook::libil2cpp::Void,
                2usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::InputFieldSelectableStateController as
                    quest_hook::libil2cpp::Type > ::class(), "ResolveSelectionState",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
