...
#[cfg(feature = "cordl_class_AlphaFloatFxGroupEffectTarget")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AlphaFloatFxGroupEffectTarget {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "AlphaFloatFxGroupEffectTarget";
...
#[cfg(feature = "cordl_class_AlphaFloatFxGroupEffectTarget")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AlphaFloatFxGroupEffectTarget {
