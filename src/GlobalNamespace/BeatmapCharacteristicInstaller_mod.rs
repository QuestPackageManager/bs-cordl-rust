...
pub struct BeatmapCharacteristicInstaller {
    __cordl_parent:
        crate::BGLib::AppFlow::Initialization::ScriptableObjectReferenceAsyncInstaller_1<
            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapCharacteristicCollectionSO>,
        >,
}
#[cfg(feature = "cordl_class_BeatmapCharacteristicInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapCharacteristicInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BeatmapCharacteristicInstaller";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "LoadCharacteristicCollectionAsync", 0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_BeatmapCharacteristicInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapCharacteristicInstaller {
