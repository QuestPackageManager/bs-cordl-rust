#[cfg(feature = "cordl_class_OVRBounded2D")]
...
#[cfg(feature = "cordl_class_OVRBounded2D")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::OVRBounded2D {
    type Type = Self;
...
impl crate::GlobalNamespace::OVRBounded2D {
    pub fn ConvertRect(
        ...
        let __cordl_ret: crate::UnityEngine::Rect =
            unsafe { cordl_method_info.invoke_unchecked(self, (openXrRect))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Equals_OVRBounded2D0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::OVRBounded2D), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRBounded2D>.FromAnchor", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::OVRBounded2D =
    ...
    pub fn IOVRAnchorComponent_OVRBounded2D__get_Handle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), u64, 0usize>("IOVRAnchorComponent<OVRBounded2D>.get_Handle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRBounded2D>.get_Type", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TryGetBoundaryPoints", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (positions))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "OVRBounded2D")]
impl AsRef<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRBounded2D>>
...
#[cfg(feature = "OVRBounded2D")]
impl AsMut<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRBounded2D>>
    for crate::GlobalNamespace::OVRBounded2D
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRBounded2D>
    {
        todo!()
    }
}
...
impl AsRef<crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded2D>>
    for crate::GlobalNamespace::OVRBounded2D
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded2D> {
        todo!()
    }
}
#[cfg(feature = "OVRBounded2D")]
impl AsMut<crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded2D>>
    for crate::GlobalNamespace::OVRBounded2D
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::GlobalNamespace::OVRBounded2D> {
        todo!()
    }
}
