...
impl crate::GlobalNamespace::OVRBounded2D {
    pub fn ConvertRect(
        ...
        let __cordl_ret: crate::UnityEngine::Rect = unsafe {
            cordl_method_info.invoke_unchecked(self, (openXrRect))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRBounded2D>.SetEnabledAsync", 2usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRBounded2D>.get_Handle", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TryGetBoundaryPointsCount", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
...
#[cfg(feature = "OVRBounded2D")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRBounded2D>>
for crate::GlobalNamespace::OVRBounded2D {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRBounded2D> {
        todo!()
    }
}
#[cfg(feature = "OVRBounded2D")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRBounded2D>>
for crate::GlobalNamespace::OVRBounded2D {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRBounded2D> {
        todo!()
    }
}
#[cfg(feature = "OVRBounded2D")]
