...
for crate::GlobalNamespace::LicensesDisplayViewController {
    ...
    const CLASS_NAME: &'static str = "LicensesDisplayViewController";
...
impl crate::GlobalNamespace::LicensesDisplayViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LicensesDisplayViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LicensesDisplayViewController as
