...
impl crate::GlobalNamespace::PlayerHeightDetector {
    ...
    pub fn BeatmapObjectSpawnCallback(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayerHeightDetector as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PlayerHeightDetector as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayerHeightDetector as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlayerHeightDetector as
                    quest_hook::libil2cpp::Type > ::class(), "get_playerHeight", 0usize
                )
            });
...
impl crate::GlobalNamespace::PlayerHeightDetector_InitData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayerHeightDetector_InitData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32, f32), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlayerHeightDetector_InitData as
