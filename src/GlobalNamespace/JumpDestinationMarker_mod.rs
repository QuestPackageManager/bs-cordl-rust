#[cfg(feature = "cordl_class_JumpDestinationMarker")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_JumpDestinationMarker")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::JumpDestinationMarker {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "JumpDestinationMarker";
...
#[cfg(feature = "cordl_class_JumpDestinationMarker")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::JumpDestinationMarker {
