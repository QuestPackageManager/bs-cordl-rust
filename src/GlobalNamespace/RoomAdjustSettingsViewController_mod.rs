...
impl crate::GlobalNamespace::RoomAdjustSettingsViewController {
    ...
    pub fn Move(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_move))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RefreshRoomOffsetValuePicker(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (stepValuePicker, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn RefreshTexts(
