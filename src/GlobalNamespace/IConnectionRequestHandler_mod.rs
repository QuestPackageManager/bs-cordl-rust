...
for crate::GlobalNamespace::IConnectionRequestHandler {
    ...
    const CLASS_NAME: &'static str = "IConnectionRequestHandler";
...
impl crate::GlobalNamespace::IConnectionRequestHandler {
    pub fn GetConnectionMessage(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IConnectionRequestHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IConnectionRequestHandler as
