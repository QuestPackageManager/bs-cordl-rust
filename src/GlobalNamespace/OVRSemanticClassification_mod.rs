#[cfg(feature = "cordl_class_OVRSemanticClassification")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_OVRSemanticClassification")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRSemanticClassification {
...
impl crate::GlobalNamespace::OVRSemanticClassification {
    ...
    pub fn Contains(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (label))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ValidateAndUpgradeLabels", 1usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_OVRSemanticClassification")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRSemanticClassification {
