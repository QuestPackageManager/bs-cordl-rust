#[cfg(feature = "cordl_class_BloomPrePassBackgroundNonLightRendererCore")]
#[repr(C)]
...
pub struct BloomPrePassBackgroundNonLightRendererCore {
    ...
    pub _customPropertyBlock: quest_hook::libil2cpp::Gc<crate::UnityEngine::MaterialPropertyBlock>,
}
#[cfg(feature = "cordl_class_BloomPrePassBackgroundNonLightRendererCore")]
    ...
    for crate::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore
{
    ...
    const CLASS_NAME: &'static str = "BloomPrePassBackgroundNonLightRendererCore";
...
impl std::ops::Deref for crate::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore {
...
#[cfg(feature = "BloomPrePassBackgroundNonLightRendererCore")]
impl std::ops::DerefMut for crate::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore {
...
impl crate::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore {
    ...
    pub fn SetCustomPropertyBlock(
        &mut self,
        bloomPropertyBlock: quest_hook::libil2cpp::Gc<crate::UnityEngine::MaterialPropertyBlock>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bloomPropertyBlock))? };
        Ok(__cordl_ret.into())
    }
