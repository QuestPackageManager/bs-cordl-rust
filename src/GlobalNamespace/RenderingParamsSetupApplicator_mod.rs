...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for RenderingParamsSetupApplicator => ""
    ."RenderingParamsSetupApplicator"
);
#[cfg(feature = "RenderingParamsSetupApplicator")]
impl std::ops::Deref for RenderingParamsSetupApplicator {
...
#[cfg(feature = "RenderingParamsSetupApplicator")]
impl std::ops::DerefMut for RenderingParamsSetupApplicator {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "RenderingParamsSetupApplicator")]
impl RenderingParamsSetupApplicator {
    pub fn Apply(
        &mut self,
        sceneType: SceneType,
...
#[cfg(feature = "RenderingParamsSetupApplicator")]
impl quest_hook::libil2cpp::ObjectType for RenderingParamsSetupApplicator {
