...
for crate::GlobalNamespace::TubeBloomPrePassLightWithId {
    ...
    const CLASS_NAME: &'static str = "TubeBloomPrePassLightWithId";
...
impl crate::GlobalNamespace::TubeBloomPrePassLightWithId {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TubeBloomPrePassLightWithId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TubeBloomPrePassLightWithId as
