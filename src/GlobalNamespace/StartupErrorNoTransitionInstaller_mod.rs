...
for crate::GlobalNamespace::StartupErrorNoTransitionInstaller {
    ...
    const CLASS_NAME: &'static str = "StartupErrorNoTransitionInstaller";
...
impl crate::GlobalNamespace::StartupErrorNoTransitionInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StartupErrorNoTransitionInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::StartupErrorNoTransitionInstaller as
                    quest_hook::libil2cpp::Type > ::class(), "InstallBindings", 1usize
                )
            });
