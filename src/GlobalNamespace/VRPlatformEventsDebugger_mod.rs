...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for VRPlatformEventsDebugger => ""
    ."VRPlatformEventsDebugger"
);
#[cfg(feature = "VRPlatformEventsDebugger")]
impl std::ops::Deref for VRPlatformEventsDebugger {
...
#[cfg(feature = "VRPlatformEventsDebugger")]
impl std::ops::DerefMut for VRPlatformEventsDebugger {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "VRPlatformEventsDebugger")]
impl VRPlatformEventsDebugger {
    pub fn Dispose(
        &mut self,
...
#[cfg(feature = "VRPlatformEventsDebugger")]
impl quest_hook::libil2cpp::ObjectType for VRPlatformEventsDebugger {
