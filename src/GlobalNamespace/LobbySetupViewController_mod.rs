...
impl crate::GlobalNamespace::LobbySetupViewController {
    ...
    pub fn SetLobbyPlayerData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lobbyPlayerData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetLobbyState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lobbyState))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetPlayersMissingLevelText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (playersMissingLevelText))?
        };
        Ok(__cordl_ret.into())
    }
