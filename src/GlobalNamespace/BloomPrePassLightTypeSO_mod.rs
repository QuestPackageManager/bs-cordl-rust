...
for crate::GlobalNamespace::BloomPrePassLightTypeSO {
    ...
    const CLASS_NAME: &'static str = "BloomPrePassLightTypeSO";
...
impl crate::GlobalNamespace::BloomPrePassLightTypeSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassLightTypeSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BloomPrePassLightTypeSO as
    ...
    pub fn get_renderingPriority(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassLightTypeSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_renderingPriority")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BloomPrePassLightTypeSO as
                    quest_hook::libil2cpp::Type > ::class(), "get_renderingPriority",
                    0usize
                )
            });
