...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PosesRecorder {
    ...
    const CLASS_NAME: &'static str = "PosesRecorder";
...
impl crate::GlobalNamespace::PosesRecorder {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PosesRecorder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PosesRecorder as quest_hook::libil2cpp::Type
                    > ::class(), "Init", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (poseObjects, externalCameraCalibration))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LateUpdate(
    ...
    pub fn RecordTick(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PosesRecorder as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("RecordTick")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PosesRecorder as quest_hook::libil2cpp::Type
                    > ::class(), "RecordTick", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
