...
impl crate::GlobalNamespace::MonotonicTimeProvider {
    pub fn GetTicks(&mut self) -> quest_hook::libil2cpp::Result<i64> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MonotonicTimeProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i64, 0usize>("GetTicks")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MonotonicTimeProvider as
