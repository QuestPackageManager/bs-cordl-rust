...
for crate::GlobalNamespace::FadeOutOnSceneTransitionStart {
    ...
    const CLASS_NAME: &'static str = "FadeOutOnSceneTransitionStart";
...
impl crate::GlobalNamespace::FadeOutOnSceneTransitionStart {
    pub fn HandleGameScenesManagerTransitionDidStart(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FadeOutOnSceneTransitionStart as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FadeOutOnSceneTransitionStart as
