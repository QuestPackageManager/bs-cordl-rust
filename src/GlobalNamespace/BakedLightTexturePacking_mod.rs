...
#[cfg(feature = "cordl_class_BakedLightTexturePacking")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BakedLightTexturePacking {
...
impl crate::GlobalNamespace::BakedLightTexturePacking {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::RenderTexture>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::RenderTexture> =
            unsafe { cordl_method_info.invoke_unchecked((), (textures, descriptor))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BakedLightTexturePacking")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BakedLightTexturePacking {
