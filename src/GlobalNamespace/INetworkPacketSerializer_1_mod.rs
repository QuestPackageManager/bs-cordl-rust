    ...
    for crate::GlobalNamespace::INetworkPacketSerializer_1<TData>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "INetworkPacketSerializer`1")
                .unwrap()
                .make_generic::<(TData)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "INetworkPacketSerializer_1")]
impl<TData: quest_hook::libil2cpp::Type> crate::GlobalNamespace::INetworkPacketSerializer_1<TData> {
