...
pub struct TextMeshProAutosizeGroup {
    ...
    pub _texts: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<quest_hook::libil2cpp::Gc<crate::TMPro::TMP_Text>>,
    >,
}
#[cfg(feature = "cordl_class_TextMeshProAutosizeGroup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TextMeshProAutosizeGroup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "TextMeshProAutosizeGroup";
...
#[cfg(feature = "cordl_class_TextMeshProAutosizeGroup")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TextMeshProAutosizeGroup {
