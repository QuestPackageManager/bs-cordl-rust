...
pub struct MultiplayerEnvironmentResizeController {
    ...
    pub _resizeData: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _centerResizeController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MultiplayerCenterResizeController>,
...
#[cfg(feature = "MultiplayerEnvironmentResizeController")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerEnvironmentResizeController {
...
impl crate::GlobalNamespace::MultiplayerEnvironmentResizeController {
    ...
    pub fn HandleEdgeDistanceFromCenterWasCalculated(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (edgeDistanceFromCenter))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryResize(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "MultiplayerEnvironmentResizeController+ResizeData")]
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeData {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_resizeType", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::MultiplayerEnvironmentResizeController_ResizeType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
