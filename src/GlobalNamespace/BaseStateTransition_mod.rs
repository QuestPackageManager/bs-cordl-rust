...
impl crate::GlobalNamespace::BaseStateTransition {
    pub fn HandleSelectableStateControllerStateDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (state, animated))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (viewState))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TransitionToDisabledState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (transitionTiming))?
        };
        Ok(__cordl_ret.into())
    }
