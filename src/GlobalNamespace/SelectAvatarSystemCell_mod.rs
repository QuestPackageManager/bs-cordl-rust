...
pub struct SelectAvatarSystemCell {
    ...
    pub didRequestCreationOfAvatarEvent: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _loadedAvatarSystemMetadata:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::IAvatarSystemMetadata>,
    pub _selectedAvatarSystemMetadata:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::IAvatarSystemMetadata>,
    pub _loadedSelectionView:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::AvatarSelectionView>,
    pub _activateViewOnEnable: bool,
}
#[cfg(feature = "cordl_class_SelectAvatarSystemCell")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SelectAvatarSystemCell {
...
impl crate::GlobalNamespace::SelectAvatarSystemCell {
    ...
    pub fn TryActivateOnEnable(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("TryActivateOnEnable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_SelectAvatarSystemCell")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SelectAvatarSystemCell {
