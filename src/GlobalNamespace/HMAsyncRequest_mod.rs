...
impl crate::GlobalNamespace::HMAsyncRequest {
    ...
    pub fn set_CancelHandler(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::HMAsyncRequest_CancelHander>,
...
#[cfg(feature = "cordl_class_HMAsyncRequest+CancelHander")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::HMAsyncRequest_CancelHander {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_HMAsyncRequest+CancelHander")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::HMAsyncRequest_CancelHander {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
