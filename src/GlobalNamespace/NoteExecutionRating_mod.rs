...
#[cfg(feature = "cordl_class_NoteExecutionRating+Rating")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteExecutionRating_Rating {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_NoteExecutionRating+Rating")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::NoteExecutionRating_Rating {
    type Type = Self;
...
#[cfg(feature = "cordl_class_NoteExecutionRating+Rating")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::NoteExecutionRating_Rating {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_NoteExecutionRating+Rating")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::NoteExecutionRating_Rating {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
