...
#[cfg(feature = "OVRHandTest+BoolMonitor+BoolGenerator")]
impl std::ops::DerefMut for crate::GlobalNamespace::BoolMonitor_OVRHandTest_BoolGenerator {
...
pub struct OVRHandTest_BoolMonitor {
    ...
    pub m_generator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BoolMonitor_OVRHandTest_BoolGenerator>,
...
#[cfg(feature = "cordl_class_OVRHandTest+BoolMonitor")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRHandTest_BoolMonitor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_OVRHandTest+BoolMonitor")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRHandTest_BoolMonitor {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
