...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IOVRSceneComponent {
    ...
    const CLASS_NAME: &'static str = "IOVRSceneComponent";
...
impl crate::GlobalNamespace::IOVRSceneComponent {
    pub fn Initialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IOVRSceneComponent as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Initialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IOVRSceneComponent as
