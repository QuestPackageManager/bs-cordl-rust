...
for crate::GlobalNamespace::PhysicsPositionsMovementEventEffect {
    ...
    const CLASS_NAME: &'static str = "PhysicsPositionsMovementEventEffect";
...
impl crate::GlobalNamespace::PhysicsPositionsMovementEventEffect {
    pub fn HandleBeatmapEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PhysicsPositionsMovementEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PhysicsPositionsMovementEventEffect as
    ...
    pub fn HandleSongTimeFixedUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PhysicsPositionsMovementEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                ...
                quest_hook::libil2cpp::Void,
                1usize,
            >("HandleSongTimeFixedUpdate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PhysicsPositionsMovementEventEffect as
                    quest_hook::libil2cpp::Type > ::class(), "HandleSongTimeFixedUpdate",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn HandleSongTimeUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PhysicsPositionsMovementEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                ...
                quest_hook::libil2cpp::Void,
                0usize,
            >("HandleSongTimeUpdate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PhysicsPositionsMovementEventEffect as
                    quest_hook::libil2cpp::Type > ::class(), "HandleSongTimeUpdate",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
