#[cfg(feature = "cordl_class_HeadInObstacleHapticEffect")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct HeadInObstacleHapticEffect {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _headHapticPreset:
    ...
    pub _gameplayLevelSceneTransitionEvents:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayLevelSceneTransitionEvents>,
...
#[cfg(feature = "cordl_class_HeadInObstacleHapticEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::HeadInObstacleHapticEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "HeadInObstacleHapticEffect";
...
impl crate::GlobalNamespace::HeadInObstacleHapticEffect {
    ...
    pub fn HandleDidPauseEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleDidPauseEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn HandleDidResumeEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleDidResumeEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_HeadInObstacleHapticEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::HeadInObstacleHapticEffect {
