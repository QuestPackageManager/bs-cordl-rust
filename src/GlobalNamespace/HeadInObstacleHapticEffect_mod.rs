...
impl crate::GlobalNamespace::HeadInObstacleHapticEffect {
    ...
    pub fn HandleAnyGameplayLevelDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HeadInObstacleHapticEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HeadInObstacleHapticEffect as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleAnyGameplayLevelDidFinish", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HeadInObstacleHapticEffect as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::HeadInObstacleHapticEffect as
                    quest_hook::libil2cpp::Type > ::class(), "HandleDidPauseEvent",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HeadInObstacleHapticEffect as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::HeadInObstacleHapticEffect as
                    quest_hook::libil2cpp::Type > ::class(), "HandleDidResumeEvent",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
