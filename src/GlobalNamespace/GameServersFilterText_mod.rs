#[cfg(feature = "cordl_class_GameServersFilterText")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_GameServersFilterText")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GameServersFilterText {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GameServersFilterText";
...
impl crate::GlobalNamespace::GameServersFilterText {
    ...
    pub fn Setup_BeatmapDifficultyMask_SongPackMask__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (beatmapDifficultyMask, songPackMask, visible))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Setup_GameServersFilter__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (filter, visible))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_GameServersFilterText")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GameServersFilterText {
