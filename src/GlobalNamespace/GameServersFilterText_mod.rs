...
impl crate::GlobalNamespace::GameServersFilterText {
    ...
    pub fn Setup_BeatmapDifficultyMask_SongPackMask__cordl_bool1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameServersFilterText as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::GameServersFilterText as
    ...
    pub fn Setup_GameServersFilter__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (filter, visible))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
