...
for crate::GlobalNamespace::MaterialPropertyBlockFloatAnimator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MaterialPropertyBlockFloatAnimator";
...
#[cfg(feature = "MaterialPropertyBlockFloatAnimator")]
impl crate::GlobalNamespace::MaterialPropertyBlockFloatAnimator {
    ...
    pub fn SetProperty(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MaterialPropertyBlockFloatAnimator as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetProperty")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MaterialPropertyBlockFloatAnimator as
