#[cfg(feature = "cordl_class_SetTubeBloomPrePassLightColor")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_SetTubeBloomPrePassLightColor")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SetTubeBloomPrePassLightColor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SetTubeBloomPrePassLightColor";
...
#[cfg(feature = "cordl_class_SetTubeBloomPrePassLightColor")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SetTubeBloomPrePassLightColor {
