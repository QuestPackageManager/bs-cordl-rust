#[cfg(feature = "cordl_class_ObservableVariableSO_1")]
#[repr(C)]
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::ObservableVariableSO_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked((), (obj))? };
        Ok(__cordl_ret.into())
    }
