...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ObservableVariableSO_1 < T > => ""
    ."ObservableVariableSO`1" < T >
);
#[cfg(feature = "ObservableVariableSO_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for ObservableVariableSO_1<T> {
...
#[cfg(feature = "ObservableVariableSO_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for ObservableVariableSO_1<T> {
