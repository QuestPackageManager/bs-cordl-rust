...
impl crate::GlobalNamespace::OVRSceneLoader {
    ...
    pub fn LoadScene(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sceneInfo))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::OVRSceneLoader_SceneInfo {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (sceneList, currentSceneEpochVersion))?
        };
        Ok(__cordl_ret.into())
    }
}
