#[cfg(feature = "cordl_class_OVRControllerTest+BoolMonitor+BoolGenerator")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::GlobalNamespace::BoolMonitor_OVRControllerTest_BoolGenerator {
...
#[cfg(feature = "OVRControllerTest+BoolMonitor+BoolGenerator")]
impl std::ops::DerefMut for crate::GlobalNamespace::BoolMonitor_OVRControllerTest_BoolGenerator {
...
#[cfg(feature = "cordl_class_OVRControllerTest")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_OVRControllerTest+BoolMonitor")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_OVRControllerTest+BoolMonitor")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRControllerTest_BoolMonitor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::OVRControllerTest_BoolMonitor {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, generator, displayTimeout))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_OVRControllerTest+BoolMonitor")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRControllerTest_BoolMonitor {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
