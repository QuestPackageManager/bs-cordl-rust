...
for crate::GlobalNamespace::ConditionalImageMaterialSwitcher {
    ...
    const CLASS_NAME: &'static str = "ConditionalImageMaterialSwitcher";
...
impl crate::GlobalNamespace::ConditionalImageMaterialSwitcher {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ConditionalImageMaterialSwitcher as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ConditionalImageMaterialSwitcher as
