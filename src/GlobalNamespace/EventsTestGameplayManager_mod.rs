...
impl crate::GlobalNamespace::EventsTestGameplayManager {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddEventsForLightGroup", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lightGroupId))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AddToggleEventsForLightGroup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lightGroupId, color))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bpm))?
        };
        Ok(__cordl_ret.into())
    }
}
