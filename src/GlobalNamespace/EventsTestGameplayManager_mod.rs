...
pub struct EventsTestGameplayManager {
    ...
    pub _intBindings: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::Dictionary_2<crate::UnityEngine::KeyCode, i32>,
    >,
    pub _beatmapValuesBindings: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::Dictionary_2<crate::UnityEngine::KeyCode, i32>,
    >,
    pub _floatValuesBindings: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::Dictionary_2<crate::UnityEngine::KeyCode, f32>,
    >,
    pub _rotatingLasers: bool,
}
#[cfg(feature = "cordl_class_EventsTestGameplayManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EventsTestGameplayManager {
...
impl crate::GlobalNamespace::EventsTestGameplayManager {
    ...
    pub type MockBeatToTimeConverter =
        crate::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter;
    pub fn AddEventsForLightGroup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lightGroupId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AddTestBox(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("AddTestBox")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn AddToggleEventsForLightGroup(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (i32, crate::GlobalNamespace::EnvironmentColorType),
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddToggleEventsForLightGroup", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lightGroupId, color))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_EventsTestGameplayManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EventsTestGameplayManager {
    ...
    for crate::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EventsTestGameplayManager/MockBeatToTimeConverter";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "EventsTestGameplayManager+MockBeatToTimeConverter")]
impl std::ops::Deref for crate::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter {
...
impl crate::GlobalNamespace::EventsTestGameplayManager_MockBeatToTimeConverter {
    pub fn ConvertBeatToTime(&mut self, beat: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn New(bpm: f32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bpm))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_EventsTestGameplayManager+MockBeatToTimeConverter")]
