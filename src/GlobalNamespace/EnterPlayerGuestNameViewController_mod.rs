...
for crate::GlobalNamespace::EnterPlayerGuestNameViewController {
    ...
    const CLASS_NAME: &'static str = "EnterPlayerGuestNameViewController";
...
impl crate::GlobalNamespace::EnterPlayerGuestNameViewController {
    ...
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnterPlayerGuestNameViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EnterPlayerGuestNameViewController as
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (didFinishCallback))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnterPlayerGuestNameViewController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EnterPlayerGuestNameViewController as
                    quest_hook::libil2cpp::Type > ::class(), "OkButtonPressed", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
...
for crate::GlobalNamespace::EnterPlayerGuestNameViewController_FinishDelegate {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EnterPlayerGuestNameViewController/FinishDelegate";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::EnterPlayerGuestNameViewController_FinishDelegate {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnterPlayerGuestNameViewController_FinishDelegate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::EnterPlayerGuestNameViewController,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method
                .invoke_unchecked(self, (viewController, playerName, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (viewController, playerName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
