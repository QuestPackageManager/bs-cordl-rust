...
pub struct ColorTransitionSO {
    ...
    pub _selectedAndHighlightedColor: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSO>,
}
#[cfg(feature = "cordl_class_ColorTransitionSO")]
...
impl crate::GlobalNamespace::ColorTransitionSO {
    ...
    pub fn get_normalColor(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_pressedColor(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
