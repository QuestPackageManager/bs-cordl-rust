...
impl crate::GlobalNamespace::MultiplayerScoreProvider {
    ...
    pub fn TryGetScore(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (userId, data))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
...
impl crate::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (multiplayerSyncState, scoreSyncManager))?
        };
        Ok(__cordl_ret.into())
    }
