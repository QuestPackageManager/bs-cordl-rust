#[cfg(feature = "cordl_class_LightGroupGridLayouter")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_LightGroupGridLayouter")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightGroupGridLayouter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LightGroupGridLayouter";
...
#[cfg(feature = "cordl_class_LightGroupGridLayouter")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LightGroupGridLayouter {
