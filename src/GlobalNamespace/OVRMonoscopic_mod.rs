...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRMonoscopic {
    ...
    const CLASS_NAME: &'static str = "OVRMonoscopic";
...
impl crate::GlobalNamespace::OVRMonoscopic {
    ...
    pub fn Update(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRMonoscopic as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Update")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRMonoscopic as quest_hook::libil2cpp::Type
                    > ::class(), "Update", 0usize
                )
            });
