#[cfg(feature = "cordl_class_TutorialBeatmapObjectPoolsInstaller")]
#[repr(C)]
#[derive(Debug)]
pub struct TutorialBeatmapObjectPoolsInstaller {
    __cordl_parent: crate::Zenject::MonoInstaller,
    pub _basicNotePrefab: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TutorialNoteController>,
    ...
    for crate::GlobalNamespace::TutorialBeatmapObjectPoolsInstaller
{
    ...
    const CLASS_NAME: &'static str = "TutorialBeatmapObjectPoolsInstaller";
