...
#[cfg(feature = "cordl_class_StandardLevelBuyInfoView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::StandardLevelBuyInfoView {
...
impl crate::GlobalNamespace::StandardLevelBuyInfoView {
    ...
    pub fn RefreshView(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("RefreshView")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (infoText, canBuyPack))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_StandardLevelBuyInfoView")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::StandardLevelBuyInfoView {
