    ...
    for crate::GlobalNamespace::FloatFxBeatmapEventDataProcessor_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "FloatFxBeatmapEventDataProcessor`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "FloatFxBeatmapEventDataProcessor_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::FloatFxBeatmapEventDataProcessor_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T, T), quest_hook::libil2cpp::Void, 2usize>("UpdateByOther")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
