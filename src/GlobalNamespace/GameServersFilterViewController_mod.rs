...
pub struct GameServersFilterViewController {
    ...
    pub _filterByDifficultyButton: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Button>,
    pub _beatmapDifficultyDropdown:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapDifficultyDropdown>,
    pub _filterByModifiersToggle: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle>,
    pub _filterByModifiersButton: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Button>,
    pub _gameplayModifiersDropdown:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayModifiersDropdown>,
    ...
    pub _showPasswordProtectedToggle: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle>,
...
impl crate::GlobalNamespace::GameServersFilterViewController {
    ...
    pub fn Refresh(
        &mut self,
        currentFilter: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameServersFilter>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (currentFilter))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetupGameServersFilter(
        &mut self,
        gameServersFilter: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameServersFilter>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetupGameServersFilter", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (gameServersFilter))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_gameServersFilter", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameServersFilter> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_GameServersFilterViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GameServersFilterViewController {
