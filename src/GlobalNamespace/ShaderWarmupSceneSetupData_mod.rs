...
pub struct ShaderWarmupSceneSetupData {
    ...
    pub _nextScenesTransitionSetupData_k__BackingField: *mut ScenesTransitionSetupDataSO,
}
#[cfg(feature = "ShaderWarmupSceneSetupData")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ShaderWarmupSceneSetupData => ""
    ."ShaderWarmupSceneSetupData"
);
#[cfg(feature = "ShaderWarmupSceneSetupData")]
impl std::ops::Deref for ShaderWarmupSceneSetupData {
...
#[cfg(feature = "ShaderWarmupSceneSetupData")]
impl std::ops::DerefMut for ShaderWarmupSceneSetupData {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "ShaderWarmupSceneSetupData")]
impl ShaderWarmupSceneSetupData {
    pub fn set_nextScenesTransitionSetupData(
        &mut self,
        value: *mut ScenesTransitionSetupDataSO,
...
#[cfg(feature = "ShaderWarmupSceneSetupData")]
impl quest_hook::libil2cpp::ObjectType for ShaderWarmupSceneSetupData {
