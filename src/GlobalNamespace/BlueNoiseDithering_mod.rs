...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BlueNoiseDithering {
    ...
    const CLASS_NAME: &'static str = "BlueNoiseDithering";
...
impl crate::GlobalNamespace::BlueNoiseDithering {
    ...
    pub fn SetBlueNoiseShaderParams(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BlueNoiseDithering as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32, i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BlueNoiseDithering as
                    quest_hook::libil2cpp::Type > ::class(), "SetBlueNoiseShaderParams",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (cameraPixelWidth, cameraPixelHeight))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
