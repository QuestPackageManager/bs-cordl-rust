#[cfg(feature = "cordl_class_ILevelStartController")]
...
#[cfg(feature = "cordl_class_ILevelStartController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ILevelStartController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ILevelStartController";
...
#[cfg(feature = "cordl_class_ILevelStartController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ILevelStartController {
