...
for crate::GlobalNamespace::PS5ActivityIdsModelSO {
    ...
    const CLASS_NAME: &'static str = "PS5ActivityIdsModelSO";
...
impl crate::GlobalNamespace::PS5ActivityIdsModelSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PS5ActivityIdsModelSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PS5ActivityIdsModelSO as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PS5ActivityIdsModelSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                ...
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::CompetetiveActivitySO,
                        >,
                    >,
                >,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PS5ActivityIdsModelSO as
                    quest_hook::libil2cpp::Type > ::class(), "get_competetiveActivities",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PS5ActivityIdsModelSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                ...
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::ProgressActivitySO,
                        >,
                    >,
                >,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PS5ActivityIdsModelSO as
                    quest_hook::libil2cpp::Type > ::class(), "get_progressActivities",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
