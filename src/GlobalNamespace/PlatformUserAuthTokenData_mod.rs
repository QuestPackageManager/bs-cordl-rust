#[cfg(feature = "cordl_class_PlatformUserAuthTokenData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_PlatformUserAuthTokenData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PlatformUserAuthTokenData {
...
impl crate::GlobalNamespace::PlatformUserAuthTokenData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (token, validPlatformEnvironment))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_token(
        &mut self,
    ...
    pub fn get_validPlatformEnvironment(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::PlatformEnvironment, 0usize>(
        ...
        let __cordl_ret: crate::GlobalNamespace::PlatformEnvironment =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_token(
...
#[cfg(feature = "cordl_class_PlatformUserAuthTokenData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PlatformUserAuthTokenData {
