...
pub struct PlaybackScreenshotRecorder {
    ...
    pub _playbackRenderer: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlaybackRenderer>,
    pub _frameNumber: i32,
}
#[cfg(feature = "cordl_class_PlaybackScreenshotRecorder")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PlaybackScreenshotRecorder {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PlaybackScreenshotRecorder";
...
impl crate::GlobalNamespace::PlaybackScreenshotRecorder {
    ...
    pub fn HandleTexturesReady(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleTexturesReady")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Init(
        ...
        framerate: i32,
        playbackRenderer: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlaybackRenderer>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlaybackRenderer>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (directory, framerate, playbackRenderer))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SaveScreenshot(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::RenderTexture>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 2usize>("SaveScreenshot")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (renderTexture, directory))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_PlaybackScreenshotRecorder")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PlaybackScreenshotRecorder {
