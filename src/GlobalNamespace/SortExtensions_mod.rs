#[cfg(feature = "cordl_class_SortExtensions")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::SortExtensions {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("InsertSorted")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (list, item, getSortIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn Sort<T>(
        list: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<T>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (list, getSortIndex))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_SortExtensions")]
