#[cfg(feature = "cordl_class_NoteCutDirectionExtensions")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_NoteCutDirectionExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteCutDirectionExtensions {
...
impl crate::GlobalNamespace::NoteCutDirectionExtensions {
    ...
    pub fn IsMainDirection(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::GlobalNamespace::NoteCutDirection), bool, 1usize>(
                        "IsMainDirection",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (cutDirection))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsOnSamePlane(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (noteCutDirection1, noteCutDirection2))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn MainNoteCutDirectionFromCutDirAngle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f32), crate::GlobalNamespace::NoteCutDirection, 1usize>(
    ...
    pub fn Rotation(
        ...
        let __cordl_ret: crate::UnityEngine::Quaternion =
            unsafe { cordl_method_info.invoke_unchecked((), (cutDirection, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn RotationAngle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::GlobalNamespace::NoteCutDirection), f32, 1usize>(
                        "RotationAngle",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (cutDirection))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_NoteCutDirectionExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NoteCutDirectionExtensions {
