...
for crate::GlobalNamespace::SingleFixedSceneScenesTransitionSetupDataSO {
    ...
    const CLASS_NAME: &'static str = "SingleFixedSceneScenesTransitionSetupDataSO";
...
impl crate::GlobalNamespace::SingleFixedSceneScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SingleFixedSceneScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sceneSetupData))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SingleFixedSceneScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SingleFixedSceneScenesTransitionSetupDataSO
                    as quest_hook::libil2cpp::Type > ::class(), "get_sceneInfo", 0usize
                )
            });
