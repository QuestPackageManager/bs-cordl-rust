...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MenuSceneSetup {
    ...
    const CLASS_NAME: &'static str = "MenuSceneSetup";
...
impl crate::GlobalNamespace::MenuSceneSetup {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MenuSceneSetup as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MenuSceneSetup as
