...
#[cfg(feature = "cordl_class_DisableWhenMirrorIsEnabled")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::DisableWhenMirrorIsEnabled {
...
impl crate::GlobalNamespace::DisableWhenMirrorIsEnabled {
    ...
    pub fn get_mirror(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::Mirror>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::Mirror> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_mirror(
...
#[cfg(feature = "cordl_class_DisableWhenMirrorIsEnabled")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::DisableWhenMirrorIsEnabled {
