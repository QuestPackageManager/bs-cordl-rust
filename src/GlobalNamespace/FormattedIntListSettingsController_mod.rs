...
pub struct FormattedIntListSettingsController {
    ...
    pub _minValue: i32,
    pub _maxValue: i32,
    pub _formattingString: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub valueDidChangeEvent: quest_hook::libil2cpp::Gc<
        crate::System::Action_2<
            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::FormattedIntListSettingsController>,
            i32,
        >,
    >,
    pub _value: i32,
    ...
    for crate::GlobalNamespace::FormattedIntListSettingsController
{
    ...
    const CLASS_NAME: &'static str = "FormattedIntListSettingsController";
...
impl crate::GlobalNamespace::FormattedIntListSettingsController {
    ...
    pub fn SetValue(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (value, callCallback))? };
        Ok(__cordl_ret.into())
    }
    pub fn TextForValue(
        &mut self,
