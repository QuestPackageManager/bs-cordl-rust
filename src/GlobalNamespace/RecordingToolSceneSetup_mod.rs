...
for crate::GlobalNamespace::RecordingToolSceneSetup {
    ...
    const CLASS_NAME: &'static str = "RecordingToolSceneSetup";
...
impl crate::GlobalNamespace::RecordingToolSceneSetup {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RecordingToolSceneSetup as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::RecordingToolSceneSetup as
