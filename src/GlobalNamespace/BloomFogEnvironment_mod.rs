...
#[cfg(feature = "BloomFogEnvironment")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomFogEnvironment {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BloomFogEnvironment";
...
impl crate::GlobalNamespace::BloomFogEnvironment {
    ...
    pub fn OnEnable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomFogEnvironment as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnEnable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BloomFogEnvironment as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomFogEnvironment as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BloomFogEnvironment as
                    quest_hook::libil2cpp::Type > ::class(), "get_fogParams", 0usize
                )
            });
