#[cfg(feature = "cordl_class_CustomLevelsSettings")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_CustomLevelsSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CustomLevelsSettings {
...
impl crate::GlobalNamespace::CustomLevelsSettings {
    pub fn New(enabled: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
