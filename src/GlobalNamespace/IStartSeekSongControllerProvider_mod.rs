...
for crate::GlobalNamespace::IStartSeekSongControllerProvider {
    ...
    const CLASS_NAME: &'static str = "IStartSeekSongControllerProvider";
...
impl crate::GlobalNamespace::IStartSeekSongControllerProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IStartSeekSongControllerProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IStartSeekSongControllerProvider as
