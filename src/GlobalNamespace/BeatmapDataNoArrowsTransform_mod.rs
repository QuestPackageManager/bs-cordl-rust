...
impl crate::GlobalNamespace::BeatmapDataNoArrowsTransform {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BeatmapDataNoArrowsTransform as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BeatmapDataNoArrowsTransform as
