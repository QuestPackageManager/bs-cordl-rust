...
impl crate::GlobalNamespace::StartMiddleEndButtonsGroup {
    ...
    pub fn SetLayoutHorizontal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StartMiddleEndButtonsGroup as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::StartMiddleEndButtonsGroup as
