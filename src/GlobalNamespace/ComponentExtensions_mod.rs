...
impl crate::GlobalNamespace::ComponentExtensions {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ComponentExtensions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ComponentExtensions as
                    quest_hook::libil2cpp::Type > ::class(), "GetComponentInParentOnly",
                    1usize
                )
            });
        let __cordl_ret: T = unsafe { method.invoke_unchecked((), (c))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "ComponentExtensions")]
