#[cfg(feature = "cordl_class_INoteControllerDidInitEvent")]
...
#[cfg(feature = "cordl_class_INoteControllerDidInitEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::INoteControllerDidInitEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "INoteControllerDidInitEvent";
...
#[cfg(feature = "cordl_class_INoteControllerDidInitEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::INoteControllerDidInitEvent {
