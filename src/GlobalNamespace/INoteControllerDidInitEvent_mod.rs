...
impl crate::GlobalNamespace::INoteControllerDidInitEvent {
    pub fn HandleNoteControllerDidInit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INoteControllerDidInitEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INoteControllerDidInitEvent as
