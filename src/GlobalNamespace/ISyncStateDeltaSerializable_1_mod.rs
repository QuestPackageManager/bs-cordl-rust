...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ISyncStateDeltaSerializable_1 < T > => ""
    ."ISyncStateDeltaSerializable`1" < T >
);
#[cfg(feature = "ISyncStateDeltaSerializable_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref
for ISyncStateDeltaSerializable_1<T> {
...
#[cfg(feature = "ISyncStateDeltaSerializable_1")]
impl<T: quest_hook::libil2cpp::Type> ISyncStateDeltaSerializable_1<T> {
    pub fn set_delta(
        &mut self,
        value: T,
