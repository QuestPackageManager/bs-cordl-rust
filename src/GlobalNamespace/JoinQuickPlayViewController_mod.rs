...
pub struct JoinQuickPlayViewController {
    ...
    pub _songPacksDropdown:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::QuickPlaySongPacksDropdown>,
    ...
    pub _multiplayerModeSettings:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MultiplayerModeSettings>,
}
#[cfg(feature = "cordl_class_JoinQuickPlayViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::JoinQuickPlayViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "JoinQuickPlayViewController";
...
impl crate::GlobalNamespace::JoinQuickPlayViewController {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("ButtonPressed")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn Setup(
        &mut self,
        quickPlaySetupData: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::QuickPlaySetupData>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (quickPlaySetupData, multiplayerModeSettings))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _DidActivate_b__12_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<DidActivate>b__12_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _DidActivate_b__12_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<DidActivate>b__12_1")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_JoinQuickPlayViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::JoinQuickPlayViewController {
