...
impl crate::GlobalNamespace::BadCutsMissionObjectiveChecker {
    pub fn HandleNoteWasCut(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BadCutsMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BadCutsMissionObjectiveChecker as
