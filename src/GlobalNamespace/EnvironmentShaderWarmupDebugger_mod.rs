...
pub struct EnvironmentShaderWarmupDebugger {
    ...
    pub _materialsThatWereNotRendered: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _reusableStringBuilder: quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FullMaterialLookup")
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_EnvironmentShaderWarmupDebugger")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EnvironmentShaderWarmupDebugger {
