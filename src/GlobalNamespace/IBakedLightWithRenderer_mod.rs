...
impl crate::GlobalNamespace::IBakedLightWithRenderer {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IBakedLightWithRenderer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Material>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IBakedLightWithRenderer as
                    quest_hook::libil2cpp::Type > ::class(), "get_bakingMaterial", 0usize
                )
            });
