...
for crate::GlobalNamespace::ExternalCamerasManager {
    ...
    const CLASS_NAME: &'static str = "ExternalCamerasManager";
...
impl crate::GlobalNamespace::ExternalCamerasManager {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ExternalCamerasManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ExternalCamerasManager as
                    quest_hook::libil2cpp::Type > ::class(),
                    "InstantiateMixedRealityBackgroundCameraGameObject", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject> = unsafe {
            method.invoke_unchecked(self, (mainCameraGameObject))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ExternalCamerasManager as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ExternalCamerasManager as
                    quest_hook::libil2cpp::Type > ::class(),
                    "InstantiateMixedRealityForegroundCameraGameObject", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject> = unsafe {
            method.invoke_unchecked(self, (mainCameraGameObject))?
