...
for crate::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController {
    ...
    const CLASS_NAME: &'static str = "MultiplayerLocalInactivePlayerResultsController";
...
impl crate::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController {
    pub fn HandleMultiplayerStateChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleMultiplayerStateChange", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::MultiplayerLocalInactivePlayerResultsController as
                    quest_hook::libil2cpp::Type > ::class(), "SetMultiplayerState",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
