#[cfg(feature = "cordl_class_ColorNoAlphaSerializable")]
...
#[cfg(feature = "cordl_class_ColorNoAlphaSerializable")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ColorNoAlphaSerializable {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_ColorNoAlphaSerializable")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::ColorNoAlphaSerializable {
    type Type = Self;
...
#[cfg(feature = "cordl_class_ColorNoAlphaSerializable")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::ColorNoAlphaSerializable {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_ColorNoAlphaSerializable")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::ColorNoAlphaSerializable {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_ColorNoAlphaSerializable")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::ColorNoAlphaSerializable {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::ColorNoAlphaSerializable {
    ...
    pub fn op_Implicit_Color1(
    ...
    ) -> quest_hook::libil2cpp::Result<crate::GlobalNamespace::ColorNoAlphaSerializable> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::GlobalNamespace::ColorNoAlphaSerializable =
    ...
    for crate::GlobalNamespace::ColorNoAlphaSerializable
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::GlobalNamespace::ColorNoAlphaSerializable> {
        todo!()
    }
}
