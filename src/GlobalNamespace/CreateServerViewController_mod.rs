...
impl crate::GlobalNamespace::CreateServerViewController {
    pub fn ApplyAndGetData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CreateServerViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CreateServerViewController as
                    quest_hook::libil2cpp::Type > ::class(), "ApplyAndGetData", 0usize
                )
            });
