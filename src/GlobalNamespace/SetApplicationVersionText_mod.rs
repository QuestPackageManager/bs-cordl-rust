#[cfg(feature = "cordl_class_SetApplicationVersionText")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_SetApplicationVersionText")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SetApplicationVersionText {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SetApplicationVersionText";
...
impl crate::GlobalNamespace::SetApplicationVersionText {
    ...
    pub fn SetText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (gameVersion))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ToggleVersionColor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ToggleVersionColor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_SetApplicationVersionText")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SetApplicationVersionText {
