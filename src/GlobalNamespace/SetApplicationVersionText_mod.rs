...
impl crate::GlobalNamespace::SetApplicationVersionText {
    ...
    pub fn SetText(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SetApplicationVersionText as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SetApplicationVersionText as
                    quest_hook::libil2cpp::Type > ::class(), "SetText", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (gameVersion))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
