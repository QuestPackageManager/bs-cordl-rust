...
pub struct BeatmapCharacteristicsViewController {
    ...
    pub _beatmapCharacteristicsTableView:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapCharacteristicsTableView>,
...
#[cfg(feature = "BeatmapCharacteristicsViewController")]
impl std::ops::DerefMut for crate::GlobalNamespace::BeatmapCharacteristicsViewController {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::BeatmapCharacteristicCollection,
                    >, 0usize>("get_beatmapCharacteristicCollection")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
