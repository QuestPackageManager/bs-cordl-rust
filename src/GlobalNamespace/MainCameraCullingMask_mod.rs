...
pub struct MainCameraCullingMask {
    ...
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MainCameraCullingMask_InitData>,
}
#[cfg(feature = "cordl_class_MainCameraCullingMask")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainCameraCullingMask {
...
#[cfg(feature = "cordl_class_MainCameraCullingMask")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MainCameraCullingMask {
...
#[cfg(feature = "cordl_class_MainCameraCullingMask+InitData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainCameraCullingMask_InitData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::MainCameraCullingMask_InitData {
    pub fn New(showDebris: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (showDebris))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_MainCameraCullingMask+InitData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MainCameraCullingMask_InitData {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
