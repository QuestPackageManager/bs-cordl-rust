#[cfg(feature = "cordl_class_PlayerHeightToJumpOffsetYProvider")]
#[repr(C)]
#[derive(Debug)]
pub struct PlayerHeightToJumpOffsetYProvider {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _playerHeightDetector:
...
impl crate::GlobalNamespace::PlayerHeightToJumpOffsetYProvider {
    ...
    pub fn HandlePlayerHeightDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (playerHeight))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn JumpOffsetYForPlayerHeight(playerHeight: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (playerHeight))? };
        Ok(__cordl_ret.into())
    }
