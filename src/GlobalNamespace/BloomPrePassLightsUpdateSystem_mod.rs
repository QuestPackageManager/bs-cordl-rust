#[cfg(feature = "cordl_class_BloomPrePassLightsUpdateSystem")]
#[repr(C)]
#[derive(Debug)]
pub struct BloomPrePassLightsUpdateSystem {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
}
#[cfg(feature = "cordl_class_BloomPrePassLightsUpdateSystem")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomPrePassLightsUpdateSystem {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BloomPrePassLightsUpdateSystem";
...
#[cfg(feature = "cordl_class_BloomPrePassLightsUpdateSystem")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BloomPrePassLightsUpdateSystem {
