...
impl crate::GlobalNamespace::IJumpOffsetYProvider {
    ...
    pub fn get_jumpOffsetY(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IJumpOffsetYProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("get_jumpOffsetY")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IJumpOffsetYProvider as
