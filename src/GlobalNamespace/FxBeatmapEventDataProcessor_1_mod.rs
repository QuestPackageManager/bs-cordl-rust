...
for crate::GlobalNamespace::FxBeatmapEventDataProcessor_1<T> {
    ...
    const CLASS_NAME: &'static str = "FxBeatmapEventDataProcessor`1";
...
> crate::GlobalNamespace::FxBeatmapEventDataProcessor_1<T> {
    ...
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FxBeatmapEventDataProcessor_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FxBeatmapEventDataProcessor_1 < T > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::FxBeatmapEventDataProcessor_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "UpdateByOther", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
