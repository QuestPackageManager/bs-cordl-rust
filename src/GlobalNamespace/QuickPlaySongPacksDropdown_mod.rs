...
#[cfg(feature = "cordl_class_QuickPlaySongPacksDropdown")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::QuickPlaySongPacksDropdown {
...
impl crate::GlobalNamespace::QuickPlaySongPacksDropdown {
    ...
    pub fn SetOverrideSongPacks(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (quickPlaySongPacksOverride))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_QuickPlaySongPacksDropdown")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::QuickPlaySongPacksDropdown {
...
#[cfg(feature = "QuickPlaySongPacksDropdown+SongPackMaskItem")]
impl std::ops::Deref for crate::GlobalNamespace::QuickPlaySongPacksDropdown_SongPackMaskItem {
...
#[cfg(feature = "QuickPlaySongPacksDropdown+SongPackMaskItem")]
impl std::ops::DerefMut for crate::GlobalNamespace::QuickPlaySongPacksDropdown_SongPackMaskItem {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
