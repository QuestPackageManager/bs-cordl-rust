...
pub struct BeatAvatarEditorFlowCoordinator {
    ...
    >,
    pub _avatarContainerGameObject: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
...
impl crate::GlobalNamespace::BeatAvatarEditorFlowCoordinator {
    ...
    pub fn HandleBeatAvatarViewControllerChangedAvatarPart(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (avatarPart))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleBeatAvatarViewControllerDidRequestColorChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (colorCallback, currentColor, editPart, uvSegment))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleEditColorViewControllerControllerDidFinish(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (apply))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BeatAvatarEditorFlowCoordinator")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatAvatarEditorFlowCoordinator {
