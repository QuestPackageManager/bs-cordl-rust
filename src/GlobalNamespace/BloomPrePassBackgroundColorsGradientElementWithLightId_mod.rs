...
impl crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId {
    ...
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
...
impl crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientElementWithLightId_Elements as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
