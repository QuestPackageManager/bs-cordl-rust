...
pub struct MainEffectController {
    ...
    >,
    pub _imageEffectController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ImageEffectController>,
}
#[cfg(feature = "cordl_class_MainEffectController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainEffectController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MainEffectController";
...
impl crate::GlobalNamespace::MainEffectController {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MainEffectContainerSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
