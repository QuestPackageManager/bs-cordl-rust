...
pub struct MultiplayerLocalActiveCenterRingLightsController {
    ...
    pub _verticalLinePositions: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
    ...
    for crate::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerLocalActiveCenterRingLightsController";
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController {
...
impl crate::GlobalNamespace::MultiplayerLocalActiveCenterRingLightsController {
    pub fn HandleEdgeDistanceFromCenterWasCalculated(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (constructEdgeDistanceFromCenter))? };
        Ok(__cordl_ret.into())
    }
