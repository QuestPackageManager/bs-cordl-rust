...
#[cfg(feature = "CutoutEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CutoutEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "CutoutEffect";
...
impl crate::GlobalNamespace::CutoutEffect {
    ...
    pub fn SetCutout_Vector3_1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CutoutEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CutoutEffect as quest_hook::libil2cpp::Type
                    > ::class(), "SetCutout", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (cutout, cutoutOffset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetCutout_f32_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CutoutEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("SetCutout")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CutoutEffect as quest_hook::libil2cpp::Type
                    > ::class(), "SetCutout", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (cutout))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
    ...
    pub fn get_useRandomCutoutOffset(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CutoutEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_useRandomCutoutOffset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CutoutEffect as quest_hook::libil2cpp::Type
                    > ::class(), "get_useRandomCutoutOffset", 0usize
                )
            });
