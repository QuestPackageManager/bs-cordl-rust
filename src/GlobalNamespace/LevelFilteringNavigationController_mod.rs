...
impl crate::GlobalNamespace::LevelFilteringNavigationController {
    ...
    pub fn HandleAnnotatedBeatmapLevelCollectionsViewControllerDidSelectAnnotatedBeatmapLevelCollection(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (annotatedBeatmapLevelCollection))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleLevelSearchViewControllerDidFilterBeatmapLevelCollection(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (annotatedBeatmapLevelCollection, options))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleSelectLevelCategoryViewControllerDidSelectLevelCategory(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (viewController, levelCategory))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SelectAnnotatedBeatmapLevelCollection(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (levelPack))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Setup(
    ...
    pub fn UpdateSecondChildControllerContent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (levelCategory))?
        };
        Ok(__cordl_ret.into())
    }
