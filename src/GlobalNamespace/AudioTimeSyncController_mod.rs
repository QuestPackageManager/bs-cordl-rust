...
pub struct AudioTimeSyncController {
    ...
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioTimeSyncController_InitData>,
    pub _dspTimeProvider: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IDspTimeProvider>,
...
#[cfg(feature = "cordl_class_AudioTimeSyncController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AudioTimeSyncController {
...
impl crate::GlobalNamespace::AudioTimeSyncController {
    ...
    pub fn _get_waitUntilAudioIsLoaded_b__31_0(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("<get_waitUntilAudioIsLoaded>b__31_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_forceNoAudioSyncOrAudioSyncErrorFixing(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_forceNoAudioSyncOrAudioSyncErrorFixing")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_waitUntilAudioIsLoaded(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::WaitUntil>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::WaitUntil> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_stateChangedEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_AudioTimeSyncController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AudioTimeSyncController {
...
impl crate::GlobalNamespace::AudioTimeSyncController_InitData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (audioClip, startSongTime, songTimeOffset, timeScale))?
        };
        Ok(__cordl_ret.into())
    }
}
