...
pub struct OVRMesh {
    ...
    pub _dataProvider:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRMesh_IOVRMeshDataProvider>,
...
#[cfg(feature = "cordl_class_OVRMesh")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRMesh {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRMesh";
...
impl crate::GlobalNamespace::OVRMesh {
    ...
    pub fn Initialize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (meshType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TransformOvrpMesh(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("TransformOvrpMesh")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ovrpMesh, mesh))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_OVRMesh+IOVRMeshDataProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRMesh_IOVRMeshDataProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRMesh/IOVRMeshDataProvider";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "cordl_class_OVRMesh+IOVRMeshDataProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRMesh_IOVRMeshDataProvider {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRMesh_MeshType {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRMesh/MeshType";
...
#[cfg(feature = "cordl_class_OVRMesh+MeshType")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::OVRMesh_MeshType {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVRMesh+MeshType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::OVRMesh_MeshType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRMesh+MeshType")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::OVRMesh_MeshType {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRMesh+MeshType")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::OVRMesh_MeshType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
