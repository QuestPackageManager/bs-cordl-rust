...
impl crate::GlobalNamespace::MultiplayerVerticalPlayerMovementManager {
    pub fn HandleStateChanged(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerVerticalPlayerMovementManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerVerticalPlayerMovementManager as
