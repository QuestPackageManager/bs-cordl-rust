...
pub struct ColorsOverrideSettingsPanelController {
    ...
    pub _colorSchemeDropDown:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSchemeDropdown>,
    pub _editColorSchemeController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EditColorSchemeController>,
    pub _editColorSchemeModalView: quest_hook::libil2cpp::Gc<crate::HMUI::ModalView>,
    pub _editColorSchemeButton: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Button>,
    pub _colorOverrideTypeDropdown: quest_hook::libil2cpp::Gc<crate::HMUI::SimpleTextDropdown>,
...
#[cfg(feature = "ColorsOverrideSettingsPanelController")]
impl std::ops::DerefMut for crate::GlobalNamespace::ColorsOverrideSettingsPanelController {
...
impl crate::GlobalNamespace::ColorsOverrideSettingsPanelController {
    pub fn HandleColorOverrideTypeDropdownDidSelectCellWithIdx(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl__, idx))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleEditColorSchemeControllerDidChangeColorScheme", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (colorSchemesSettings))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_editColorSchemeModalView(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::HMUI::ModalView>> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<crate::HMUI::ModalView>, 0usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::HMUI::ModalView> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
