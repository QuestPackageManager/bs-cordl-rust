...
impl crate::GlobalNamespace::GameplayServerConfiguration {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameplayServerConfiguration as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::GameplayServerConfiguration as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameplayServerConfiguration as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::GameplayServerConfiguration as
                    quest_hook::libil2cpp::Type > ::class(), "WithMaxPlayerCount", 1usize
                )
            });
        let __cordl_ret: crate::GlobalNamespace::GameplayServerConfiguration = unsafe {
