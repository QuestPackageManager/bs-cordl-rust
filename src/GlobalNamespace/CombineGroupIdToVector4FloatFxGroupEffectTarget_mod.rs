...
for crate::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget {
    ...
    const CLASS_NAME: &'static str = "CombineGroupIdToVector4FloatFxGroupEffectTarget";
...
impl crate::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget {
    ...
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::GlobalNamespace::CombineGroupIdToVector4FloatFxGroupEffectTarget as
