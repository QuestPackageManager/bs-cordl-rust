...
for crate::GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart {
    ...
    const CLASS_NAME: &'static str = "FadeOutSongPreviewPlayerOnSceneTransitionStart";
...
impl crate::GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart {
    pub fn HandleGameScenesManagerTransitionDidStart(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::GlobalNamespace::GameScenesManager_SceneTransitionType, f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleGameScenesManagerTransitionDidStart", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sceneTransitionType, duration))?
        };
        Ok(__cordl_ret.into())
    }
