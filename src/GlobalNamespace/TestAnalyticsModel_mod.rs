...
impl crate::GlobalNamespace::TestAnalyticsModel {
    pub fn LogClick(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TestAnalyticsModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TestAnalyticsModel as
    ...
    pub fn LogEditAvatarEvent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (eventType, avatarEventData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LogEvent(
