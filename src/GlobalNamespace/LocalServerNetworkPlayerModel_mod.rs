...
for crate::GlobalNamespace::LocalServerNetworkPlayerModel {
...
impl crate::GlobalNamespace::LocalServerNetworkPlayerModel {
    #[cfg(
        feature = "LocalServerNetworkPlayerModel+LocalServerJoinMatchmakingPartyConfig"
    )]
    pub type LocalServerJoinMatchmakingPartyConfig = crate::GlobalNamespace::LocalServerNetworkPlayerModel_LocalServerJoinMatchmakingPartyConfig;
...
#[cfg(
    feature = "cordl_class_LocalServerNetworkPlayerModel+LocalServerJoinMatchmakingPartyConfig"
)]
#[repr(C)]
#[derive(Debug)]
...
for crate::GlobalNamespace::LocalServerNetworkPlayerModel_LocalServerJoinMatchmakingPartyConfig {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LocalServerNetworkPlayerModel/LocalServerJoinMatchmakingPartyConfig";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
