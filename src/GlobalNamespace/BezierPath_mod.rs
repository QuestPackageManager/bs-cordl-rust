...
pub struct BezierPath {
    ...
    pub _perAnchorNormalsAngle:
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<f32>>,
    pub _neighbourDistances: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
}
#[cfg(feature = "cordl_class_BezierPath")]
...
impl crate::GlobalNamespace::BezierPath {
    ...
    pub fn AddSegmentToEnd(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (anchorPos))? };
        Ok(__cordl_ret.into())
    }
    pub fn AutoSetAllAffectedControlPoints(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (updatedAnchorIndex))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AutoSetAnchorControlPoints(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (anchorIndex))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetAnchorNormalAngle(&mut self, anchorIndex: i32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (anchorIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetPoint(
        &mut self,
    ...
    pub fn GetPointsInSegment_ByRefMut_ByRefMut_ByRefMut1(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Vector3>,
                        quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Vector3>,
                    ), quest_hook::libil2cpp::Void, 5usize>("GetPointsInSegment")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (segmentIndex, p0, p1, p2, p3))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetPointsInSegment_i32_ByRefMut0(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("GetPointsInSegment")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (segmentIndex, points))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn NotifyPathModified(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("NotifyPathModified")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetAnchorNormalAngle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (anchorIndex, angle))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetPoint(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (i, localPosition, suppressPathModified))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateByAnchorPoints(
        ...
        points: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::IReadOnlyList_1<crate::UnityEngine::Vector3>,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (centre, initTwoSegments))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Item(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), crate::UnityEngine::Vector3, 1usize>("get_Item")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_controlPointMode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::BezierPath_ControlMode, 0usize>(
        ...
        let __cordl_ret: crate::GlobalNamespace::BezierPath_ControlMode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BezierPath+ControlMode")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BezierPath_ControlMode {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BezierPath/ControlMode";
...
#[cfg(feature = "cordl_class_BezierPath+ControlMode")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::BezierPath_ControlMode {
    type Type = Self;
...
#[cfg(feature = "cordl_class_BezierPath+ControlMode")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::BezierPath_ControlMode {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_BezierPath+ControlMode")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::BezierPath_ControlMode {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_BezierPath+ControlMode")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::BezierPath_ControlMode {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
