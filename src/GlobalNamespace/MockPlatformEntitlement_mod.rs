#[cfg(feature = "cordl_class_MockPlatformEntitlement")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MockPlatformEntitlement")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockPlatformEntitlement {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MockPlatformEntitlement";
...
impl crate::GlobalNamespace::MockPlatformEntitlement {
    pub fn GetIt(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("GetIt")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (id, status))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_id(
        &mut self,
    ...
    pub fn get_status(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::EntitlementStatus, 0usize>(
                        "get_status",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::GlobalNamespace::EntitlementStatus =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_MockPlatformEntitlement")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MockPlatformEntitlement {
