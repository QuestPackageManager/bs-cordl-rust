...
impl crate::GlobalNamespace::CenterStageLobbyViewController {
    ...
    pub fn SetLevelGameplaySetupData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CenterStageLobbyViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CenterStageLobbyViewController as
