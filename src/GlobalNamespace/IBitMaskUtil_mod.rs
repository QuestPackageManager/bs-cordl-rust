...
impl crate::GlobalNamespace::IBitMaskUtil {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked((), (bytes, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetBase64Char(digit: u64) -> quest_hook::libil2cpp::Result<char> {
        ...
        let __cordl_ret: char = unsafe { cordl_method_info.invoke_unchecked((), (digit))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (bitMask))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToBytes<T>(
        bitMask: T,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (stringSerializedMask, bitMask))? };
        Ok(__cordl_ret.into())
    }
