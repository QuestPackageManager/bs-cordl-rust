#[cfg(feature = "cordl_class_RelativeScoreAndImmediateRankCounter")]
#[repr(C)]
...
pub struct RelativeScoreAndImmediateRankCounter {
    ...
    pub relativeScoreOrImmediateRankDidChangeEvent:
...
#[cfg(feature = "RelativeScoreAndImmediateRankCounter")]
impl std::ops::DerefMut for crate::GlobalNamespace::RelativeScoreAndImmediateRankCounter {
...
impl crate::GlobalNamespace::RelativeScoreAndImmediateRankCounter {
    pub fn HandleScoreDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (scoreWithoutModifiers, scoreWithModifiers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_relativeScore(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("set_relativeScore")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
