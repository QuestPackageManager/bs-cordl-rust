...
#[cfg(feature = "ILeaderboardIdData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ILeaderboardIdData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ILeaderboardIdData";
...
impl crate::GlobalNamespace::ILeaderboardIdData {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ILeaderboardIdData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ILeaderboardIdData as
