...
for crate::GlobalNamespace::BeatmapCharacteristicExtensions {
    ...
    const CLASS_NAME: &'static str = "BeatmapCharacteristicExtensions";
...
impl crate::GlobalNamespace::BeatmapCharacteristicExtensions {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BeatmapCharacteristicExtensions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BeatmapCharacteristicExtensions as
                    quest_hook::libil2cpp::Type > ::class(), "SerializedName", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (beatmapCharacteristic))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "BeatmapCharacteristicExtensions")]
