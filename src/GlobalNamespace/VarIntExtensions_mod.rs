#[cfg(feature = "cordl_class_VarIntExtensions")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::VarIntExtensions {
    ...
    pub fn GetVarInt(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (reader))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetVarLong(
        reader: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataReader>,
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked((), (reader))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetVarUInt(
        reader: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataReader>,
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked((), (reader))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetVarULong(
        reader: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataReader>,
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (reader))? };
        Ok(__cordl_ret.into())
    }
    pub fn PutVarInt(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("PutVarInt")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (writer, val))? };
        Ok(__cordl_ret.into())
    }
    pub fn PutVarLong(
        writer: quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataWriter>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataWriter>,
                        i64,
                    ), quest_hook::libil2cpp::Void, 2usize>("PutVarLong")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataWriter>,
                        u32,
                    ), quest_hook::libil2cpp::Void, 2usize>("PutVarUInt")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::LiteNetLib::Utils::NetDataWriter>,
                        u64,
                    ), quest_hook::libil2cpp::Void, 2usize>("PutVarULong")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn TryGetVarUInt(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (reader, value))? };
        Ok(__cordl_ret.into())
    }
