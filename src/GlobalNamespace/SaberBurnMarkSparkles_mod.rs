...
impl crate::GlobalNamespace::SaberBurnMarkSparkles {
    pub fn GetBurnMarkPos(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SaberBurnMarkSparkles as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SaberBurnMarkSparkles as
                    quest_hook::libil2cpp::Type > ::class(), "GetBurnMarkPos", 3usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (bladeBottomPos, bladeTopPos, burnMarkPos))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LateUpdate(
