...
pub struct SaberBurnMarkSparkles {
    ...
    pub _burnMarksPSPrefab: quest_hook::libil2cpp::Gc<crate::UnityEngine::ParticleSystem>,
...
#[cfg(feature = "cordl_class_SaberBurnMarkSparkles")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SaberBurnMarkSparkles {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SaberBurnMarkSparkles";
...
impl crate::GlobalNamespace::SaberBurnMarkSparkles {
    pub fn GetBurnMarkPos(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (bladeBottomPos, bladeTopPos, burnMarkPos))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_SaberBurnMarkSparkles")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SaberBurnMarkSparkles {
