...
#[cfg(feature = "cordl_class_MainEffectContainerSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainEffectContainerSO {
...
impl crate::GlobalNamespace::MainEffectContainerSO {
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mainEffect))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_mainEffect", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MainEffectSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_MainEffectContainerSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MainEffectContainerSO {
