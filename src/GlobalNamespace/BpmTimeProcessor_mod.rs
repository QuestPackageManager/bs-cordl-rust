...
impl crate::GlobalNamespace::BpmTimeProcessor {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CalculateTime", 2usize
                        )
                    })
            });
        let __cordl_ret: f32 =
            unsafe { cordl_method_info.invoke_unchecked((), (prevBpmChangeData, beat))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_AudioSaveData2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (audioSaveData))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_IReadOnlyList_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (startBpm, events))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_IReadOnlyList_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (startBpm, bpmEventsSaveData))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BpmTimeProcessor")]
...
#[cfg(feature = "cordl_class_BpmTimeProcessor+BpmChangeData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BpmTimeProcessor_BpmChangeData {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
