...
impl crate::GlobalNamespace::BpmTimeProcessor {
    ...
    pub fn CalculateTime(
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info.invoke_unchecked((), (prevBpmChangeData, beat))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_AudioSaveData2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (audioSaveData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_IReadOnlyList_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (startBpm, events))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_IReadOnlyList_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (startBpm, bpmEventsSaveData))?
        };
        Ok(__cordl_ret.into())
    }
}
