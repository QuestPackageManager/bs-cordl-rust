...
impl crate::GlobalNamespace::SetSaberGlowColor {
    ...
    pub type PropertyTintColorPair =
        crate::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair;
    ...
    pub fn SetColors(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
...
#[cfg(feature = "SetSaberGlowColor+PropertyTintColorPair")]
impl std::ops::Deref for crate::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair {
...
#[cfg(feature = "SetSaberGlowColor+PropertyTintColorPair")]
impl std::ops::DerefMut for crate::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
