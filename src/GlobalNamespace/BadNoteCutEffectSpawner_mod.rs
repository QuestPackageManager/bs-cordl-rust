...
impl crate::GlobalNamespace::BadNoteCutEffectSpawner {
    pub fn HandleNoteWasCut(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BadNoteCutEffectSpawner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BadNoteCutEffectSpawner as
