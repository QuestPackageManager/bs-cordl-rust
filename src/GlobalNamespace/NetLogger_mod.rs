...
impl crate::GlobalNamespace::NetLogger {
    ...
    pub fn WriteNet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NetLogger as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NetLogger as quest_hook::libil2cpp::Type >
