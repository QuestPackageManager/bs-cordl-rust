...
pub struct SpawnChevronObjectPoolsInstaller {
    ...
    pub _spawnRotationChevronPrefab: quest_hook::libil2cpp::Gc<
        crate::GlobalNamespace::SpawnRotationChevron,
    >,
}
#[cfg(feature = "SpawnChevronObjectPoolsInstaller")]
...
for crate::GlobalNamespace::SpawnChevronObjectPoolsInstaller {
    ...
    const CLASS_NAME: &'static str = "SpawnChevronObjectPoolsInstaller";
...
impl crate::GlobalNamespace::SpawnChevronObjectPoolsInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SpawnChevronObjectPoolsInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SpawnChevronObjectPoolsInstaller as
