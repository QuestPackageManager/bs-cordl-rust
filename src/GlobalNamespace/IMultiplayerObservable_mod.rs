...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for IMultiplayerObservable => ""."IMultiplayerObservable"
);
#[cfg(feature = "IMultiplayerObservable")]
impl std::ops::Deref for IMultiplayerObservable {
...
#[cfg(feature = "IMultiplayerObservable")]
impl std::ops::DerefMut for IMultiplayerObservable {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "IMultiplayerObservable")]
impl IMultiplayerObservable {
...
#[cfg(feature = "IMultiplayerObservable")]
impl quest_hook::libil2cpp::ObjectType for IMultiplayerObservable {
