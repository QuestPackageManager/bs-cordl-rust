...
#[cfg(feature = "SetPSSaberGlowColor")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SetPSSaberGlowColor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SetPSSaberGlowColor";
...
impl crate::GlobalNamespace::SetPSSaberGlowColor {
    ...
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SetPSSaberGlowColor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SetPSSaberGlowColor as
