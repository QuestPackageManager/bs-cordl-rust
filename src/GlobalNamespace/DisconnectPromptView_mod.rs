#[cfg(feature = "cordl_class_DisconnectPromptView")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_DisconnectPromptView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::DisconnectPromptView {
...
impl crate::GlobalNamespace::DisconnectPromptView {
    pub fn Hide(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (finishedCallback))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_didViewFinishEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
