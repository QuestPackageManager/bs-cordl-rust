...
impl crate::GlobalNamespace::PerceivedLoudnessSO {
    ...
    pub type PerceivedLevelLoudnessPair =
        crate::GlobalNamespace::PerceivedLoudnessSO_PerceivedLevelLoudnessPair;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetLoudnessData", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (loudnessPairs))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToDictionary(
        &mut self,
...
#[cfg(feature = "PerceivedLoudnessSO+PerceivedLevelLoudnessPair")]
impl std::ops::Deref for crate::GlobalNamespace::PerceivedLoudnessSO_PerceivedLevelLoudnessPair {
...
#[cfg(feature = "PerceivedLoudnessSO+PerceivedLevelLoudnessPair")]
impl std::ops::DerefMut for crate::GlobalNamespace::PerceivedLoudnessSO_PerceivedLevelLoudnessPair {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::PerceivedLoudnessSO_PerceivedLevelLoudnessPair {
    ...
    pub fn SetLoudness(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        f32,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetLoudness")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (newPerceivedLoudness, newChecksum))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
