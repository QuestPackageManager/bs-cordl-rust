...
pub struct SceneStartSyncController {
    ...
    pub _sceneStartHandler: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SceneStartHandler>,
    pub _playersAtGameStartModel:
...
#[cfg(feature = "cordl_class_SceneStartSyncController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SceneStartSyncController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SceneStartSyncController";
...
impl crate::GlobalNamespace::SceneStartSyncController {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        1usize,
                    >("HandleSceneSetupDidFinish")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleSceneSetupDidFinish", 1usize
                        )
                    })
            });
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        quest_hook::libil2cpp::Void,
                        1usize,
                    >("HandleSceneSetupDidReceiveTooLate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleSceneSetupDidReceiveTooLate", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn StartSceneLoadSync(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (playersAtGameStartModel))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        quest_hook::libil2cpp::Void,
                        1usize,
                    >("add_syncStartDidFailEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_syncStartDidFailEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        ...
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "add_syncStartDidReceiveTooLateEvent"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        quest_hook::libil2cpp::Void,
                        1usize,
                    >("remove_syncStartDidFailEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_syncStartDidFailEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        ...
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "remove_syncStartDidReceiveTooLateEvent",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        ...
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "remove_syncStartDidSuccessEvent"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
...
#[cfg(feature = "cordl_class_SceneStartSyncController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SceneStartSyncController {
