#[cfg(feature = "cordl_class_IBeatEffectDidFinishEvent")]
...
#[cfg(feature = "cordl_class_IBeatEffectDidFinishEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IBeatEffectDidFinishEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IBeatEffectDidFinishEvent";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleBeatEffectDidFinish", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (beatEffect))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_IBeatEffectDidFinishEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::IBeatEffectDidFinishEvent {
