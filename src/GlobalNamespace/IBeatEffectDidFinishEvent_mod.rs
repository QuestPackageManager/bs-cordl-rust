...
impl crate::GlobalNamespace::IBeatEffectDidFinishEvent {
    pub fn HandleBeatEffectDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IBeatEffectDidFinishEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IBeatEffectDidFinishEvent as
                    quest_hook::libil2cpp::Type > ::class(), "HandleBeatEffectDidFinish",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (beatEffect))?
        };
        Ok(__cordl_ret.into())
    }
