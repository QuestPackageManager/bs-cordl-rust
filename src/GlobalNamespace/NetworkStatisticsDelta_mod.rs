#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
...
#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NetworkStatisticsDelta {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::NetworkStatisticsDelta {
    type Type = Self;
...
#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::NetworkStatisticsDelta {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::NetworkStatisticsDelta {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::NetworkStatisticsDelta {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_NetworkStatisticsDelta")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::NetworkStatisticsDelta {
    type Type = Self;
