...
pub struct RectangleFakeGlowLightWithId {
    ...
    pub _minAlpha: f32,
    pub _alphaMul: f32,
    pub _rectangleFakeGlow: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RectangleFakeGlow>,
}
#[cfg(feature = "cordl_class_RectangleFakeGlowLightWithId")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RectangleFakeGlowLightWithId {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RectangleFakeGlowLightWithId";
...
#[cfg(feature = "cordl_class_RectangleFakeGlowLightWithId")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RectangleFakeGlowLightWithId {
