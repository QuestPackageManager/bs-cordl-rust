...
impl crate::GlobalNamespace::RectangleFakeGlowLightWithId {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RectangleFakeGlowLightWithId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RectangleFakeGlowLightWithId as
