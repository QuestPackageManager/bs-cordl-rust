...
pub struct MultiplayerLobbyAvatarController {
    ...
    pub _despawnVFXController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::VFXController>,
...
impl crate::GlobalNamespace::MultiplayerLobbyAvatarController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DespawnAnimationCoroutine", 0usize
                        )
                    })
            });
    ...
    pub fn DestroySelf(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SpawnAnimationCoroutine", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator> =
...
#[cfg(feature = "MultiplayerLobbyAvatarController+Factory")]
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLobbyAvatarController_Factory {
...
#[cfg(feature = "MultiplayerLobbyAvatarController+Factory")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerLobbyAvatarController_Factory {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
