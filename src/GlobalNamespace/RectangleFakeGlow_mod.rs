...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RectangleFakeGlow {
    ...
    const CLASS_NAME: &'static str = "RectangleFakeGlow";
...
impl crate::GlobalNamespace::RectangleFakeGlow {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RectangleFakeGlow as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::RectangleFakeGlow as
