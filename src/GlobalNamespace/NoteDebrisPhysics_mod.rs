...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteDebrisPhysics {
    ...
    const CLASS_NAME: &'static str = "NoteDebrisPhysics";
...
impl crate::GlobalNamespace::NoteDebrisPhysics {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoteDebrisPhysics as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoteDebrisPhysics as
