#[cfg(feature = "cordl_class_BeatmapDataBasicInfo")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatmapDataBasicInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapDataBasicInfo {
...
impl crate::GlobalNamespace::BeatmapDataBasicInfo {
    ...
    pub fn get_cuttableScoringObjectsCount(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
