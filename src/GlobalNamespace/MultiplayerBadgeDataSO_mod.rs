...
pub struct MultiplayerBadgeDataSO {
    ...
    pub _titleLocalizationKey: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _subtitleLocalizationKey: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _icon: quest_hook::libil2cpp::Gc<crate::UnityEngine::Sprite>,
}
#[cfg(feature = "cordl_class_MultiplayerBadgeDataSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerBadgeDataSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultiplayerBadgeDataSO";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_subtitleLocalizationKey", 0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_MultiplayerBadgeDataSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerBadgeDataSO {
