...
for crate::GlobalNamespace::DeactivateAnimatorOnInputFocusCapture {
    ...
    const CLASS_NAME: &'static str = "DeactivateAnimatorOnInputFocusCapture";
...
impl crate::GlobalNamespace::DeactivateAnimatorOnInputFocusCapture {
    pub fn HandleInputFocusCaptured(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DeactivateAnimatorOnInputFocusCapture as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DeactivateAnimatorOnInputFocusCapture as
