...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SpawnLaserAnimation {
    ...
    const CLASS_NAME: &'static str = "SpawnLaserAnimation";
...
impl crate::GlobalNamespace::SpawnLaserAnimation {
    pub fn InitIfNeeded(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SpawnLaserAnimation as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InitIfNeeded")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SpawnLaserAnimation as
