...
#[cfg(feature = "IPollable")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IPollable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IPollable";
...
impl crate::GlobalNamespace::IPollable {
    pub fn PollUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IPollable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("PollUpdate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IPollable as quest_hook::libil2cpp::Type >
                    ::class(), "PollUpdate", 0usize
                )
            });
