...
#[cfg(feature = "SetSaberBladeParams+PropertyTintColorPair")]
impl std::ops::Deref for crate::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair {
...
#[cfg(feature = "SetSaberBladeParams+PropertyTintColorPair")]
impl std::ops::DerefMut for crate::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
