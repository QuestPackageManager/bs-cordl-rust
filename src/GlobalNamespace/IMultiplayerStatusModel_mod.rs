...
for crate::GlobalNamespace::IMultiplayerStatusModel {
    ...
    const CLASS_NAME: &'static str = "IMultiplayerStatusModel";
...
impl crate::GlobalNamespace::IMultiplayerStatusModel {
    pub fn GetMultiplayerStatusAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IMultiplayerStatusModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IMultiplayerStatusModel as
