...
impl crate::GlobalNamespace::FlowCoordinatorAvatarsHelper {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FlowCoordinatorAvatarsHelper as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FlowCoordinatorAvatarsHelper as
