#[cfg(feature = "cordl_class_IBitMask_1")]
#[derive(Debug)]
#[repr(C)]
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::GlobalNamespace::IBitMask_1<T> {
...
#[cfg(feature = "IBitMask_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::GlobalNamespace::IBitMask_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::IBitMask_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (offset, bits))? };
        Ok(__cordl_ret.into())
    }
