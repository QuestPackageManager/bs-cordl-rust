...
#[cfg(feature = "cordl_class_MoveAndRotateWithMainCamera")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MoveAndRotateWithMainCamera {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MoveAndRotateWithMainCamera";
...
#[cfg(feature = "cordl_class_MoveAndRotateWithMainCamera")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MoveAndRotateWithMainCamera {
