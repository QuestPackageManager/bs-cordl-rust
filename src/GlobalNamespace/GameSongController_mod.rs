...
pub struct GameSongController {
    ...
    pub _beatmapCallbacksUpdater:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapCallbacksUpdater>,
    pub _songDidFinish: bool,
}
#[cfg(feature = "cordl_class_GameSongController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GameSongController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GameSongController";
...
impl crate::GlobalNamespace::GameSongController {
    pub fn FailStopSong(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FailStopSong")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn StartSong(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (songTimeOffset))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _FailStopSong_b__16_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<FailStopSong>b__16_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
