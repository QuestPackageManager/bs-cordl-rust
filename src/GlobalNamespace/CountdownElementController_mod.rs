...
impl crate::GlobalNamespace::CountdownElementController {
    ...
    pub fn SetTextAndRunAnimation(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CountdownElementController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CountdownElementController as
                    quest_hook::libil2cpp::Type > ::class(), "SetTextAndRunAnimation",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CountdownElementController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CountdownElementController as
                    quest_hook::libil2cpp::Type > ::class(), "StopAndHide", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
