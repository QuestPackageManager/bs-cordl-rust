#[cfg(feature = "cordl_class_EditableBeatmapSelectionView")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_EditableBeatmapSelectionView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EditableBeatmapSelectionView {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EditableBeatmapSelectionView";
...
#[cfg(feature = "cordl_class_EditableBeatmapSelectionView")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EditableBeatmapSelectionView {
