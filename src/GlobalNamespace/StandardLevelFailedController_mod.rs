#[cfg(feature = "cordl_class_StandardLevelFailedController")]
#[repr(C)]
...
pub struct StandardLevelFailedController {
    ...
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::StandardLevelFailedController_InitData>,
...
#[cfg(feature = "cordl_class_StandardLevelFailedController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::StandardLevelFailedController {
...
#[cfg(feature = "cordl_class_StandardLevelFailedController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::StandardLevelFailedController {
...
#[cfg(feature = "cordl_class_StandardLevelFailedController+InitData")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
    ...
    for crate::GlobalNamespace::StandardLevelFailedController_InitData
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StandardLevelFailedController/InitData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "StandardLevelFailedController+InitData")]
impl std::ops::DerefMut for crate::GlobalNamespace::StandardLevelFailedController_InitData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
