#[cfg(feature = "cordl_class_MultiplayerLocalActiveClient")]
#[repr(C)]
#[derive(Debug)]
pub struct MultiplayerLocalActiveClient {
    ...
    pub _scoreSyncStateManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IScoreSyncStateManager>,
    pub _nodePoseSyncStateManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::INodePoseSyncStateManager>,
    pub _rpcManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IGameplayRpcManager>,
...
#[cfg(feature = "cordl_class_MultiplayerLocalActiveClient")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerLocalActiveClient {
...
impl crate::GlobalNamespace::MultiplayerLocalActiveClient {
    pub fn HandleComboDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (combo))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleMultiplierDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (multiplier, multiplierProgress))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleNoteWasAdded(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("HandleNoteWasAdded")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (noteData, noteSpawnData))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleObstacleWasAdded(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (obstacleData, obstacleSpawnData, rotation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleScoreDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (multipliedScore, modifiedScore))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MultiplayerLocalActiveClient")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerLocalActiveClient {
