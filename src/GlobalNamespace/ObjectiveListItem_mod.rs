...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ObjectiveListItem => ""."ObjectiveListItem"
);
#[cfg(feature = "ObjectiveListItem")]
impl std::ops::Deref for ObjectiveListItem {
...
#[cfg(feature = "ObjectiveListItem")]
impl std::ops::DerefMut for ObjectiveListItem {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "ObjectiveListItem")]
impl ObjectiveListItem {
...
#[cfg(feature = "ObjectiveListItem")]
impl quest_hook::libil2cpp::ObjectType for ObjectiveListItem {
