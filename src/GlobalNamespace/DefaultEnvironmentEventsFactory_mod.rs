...
impl crate::GlobalNamespace::DefaultEnvironmentEventsFactory {
    pub fn InsertDefaultEvents(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DefaultEnvironmentEventsFactory as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DefaultEnvironmentEventsFactory as
                    quest_hook::libil2cpp::Type > ::class(), "InsertDefaultEvents",
                    1usize
                )
            });
