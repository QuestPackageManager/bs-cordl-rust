...
impl crate::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter {
    pub fn HandleSpawnCenterDistanceWasFound(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter as
