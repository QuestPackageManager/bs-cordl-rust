#[cfg(feature = "cordl_class_NoteBigCuttableColliderSize")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_NoteBigCuttableColliderSize")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteBigCuttableColliderSize {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleNoteControllerDidInit", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_NoteBigCuttableColliderSize")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NoteBigCuttableColliderSize {
