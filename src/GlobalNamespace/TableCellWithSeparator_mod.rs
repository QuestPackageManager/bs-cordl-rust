...
impl crate::GlobalNamespace::TableCellWithSeparator {
    ...
    pub fn TableViewSetup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TableCellWithSeparator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TableCellWithSeparator as
                    quest_hook::libil2cpp::Type > ::class(), "TableViewSetup", 2usize
                )
            });
