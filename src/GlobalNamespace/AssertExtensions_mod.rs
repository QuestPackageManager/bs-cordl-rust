...
impl crate::GlobalNamespace::AssertExtensions {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (pattern, value, other, message))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GreaterOrEqual(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (value, expectedLessValue, message))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LessThan(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (value, expectedGreaterValue, message))?
        };
        Ok(__cordl_ret.into())
    }
}
