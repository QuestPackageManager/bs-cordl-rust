...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissionStage {
    ...
    const CLASS_NAME: &'static str = "MissionStage";
...
impl crate::GlobalNamespace::MissionStage {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MissionStage as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MissionStage as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
    ...
    pub fn get_minimumMissionsToUnlock(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MissionStage as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("get_minimumMissionsToUnlock")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MissionStage as quest_hook::libil2cpp::Type
                    > ::class(), "get_minimumMissionsToUnlock", 0usize
                )
            });
