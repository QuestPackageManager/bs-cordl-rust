...
for crate::GlobalNamespace::NoBeatmapDataAssetFileModel {
    ...
    const CLASS_NAME: &'static str = "NoBeatmapDataAssetFileModel";
...
impl crate::GlobalNamespace::NoBeatmapDataAssetFileModel {
    pub fn GetAssetBundleFileForBeatmapLevelAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoBeatmapDataAssetFileModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoBeatmapDataAssetFileModel as
