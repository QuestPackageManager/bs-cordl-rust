...
pub struct ShaderWarmupSceneSetup {
    ...
    pub _sharedWarmupColorScheme: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSchemeSO>,
}
#[cfg(feature = "cordl_class_ShaderWarmupSceneSetup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ShaderWarmupSceneSetup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ShaderWarmupSceneSetup";
...
#[cfg(feature = "cordl_class_ShaderWarmupSceneSetup")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ShaderWarmupSceneSetup {
