...
#[cfg(feature = "IAudioTimeSource")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IAudioTimeSource {
...
impl crate::GlobalNamespace::IAudioTimeSource {
    ...
    pub fn get_isReady(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IAudioTimeSource as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_isReady")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IAudioTimeSource as
