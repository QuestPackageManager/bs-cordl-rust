...
impl crate::GlobalNamespace::OVRScenePrefabOverride {
    ...
    pub fn UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRScenePrefabOverride as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OVRScenePrefabOverride as
    ...
    pub fn _UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize_g__IndexOf_4_0(
        ...
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked((), (label, collection))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
