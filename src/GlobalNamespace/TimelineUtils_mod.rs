#[cfg(feature = "cordl_class_TimelineUtils")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::TimelineUtils {
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TrackAsset>, 2usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TrackAsset> =
            unsafe { cordl_method_info.invoke_unchecked((), (timeline, name))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_TimelineUtils")]
