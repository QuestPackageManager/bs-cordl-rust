...
impl crate::GlobalNamespace::TimelineUtils {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TimelineUtils as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TimelineUtils as quest_hook::libil2cpp::Type
                    > ::class(), "FindTrackAssetByName", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::Timeline::TrackAsset,
        > = unsafe { method.invoke_unchecked((), (timeline, name))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "TimelineUtils")]
