...
for crate::GlobalNamespace::MultiplayerResultsPyramidViewAvatarInstaller {
    ...
    const CLASS_NAME: &'static str = "MultiplayerResultsPyramidViewAvatarInstaller";
...
impl crate::GlobalNamespace::MultiplayerResultsPyramidViewAvatarInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerResultsPyramidViewAvatarInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MultiplayerResultsPyramidViewAvatarInstaller
                    as quest_hook::libil2cpp::Type > ::class(), "InstallBindings", 0usize
                )
            });
