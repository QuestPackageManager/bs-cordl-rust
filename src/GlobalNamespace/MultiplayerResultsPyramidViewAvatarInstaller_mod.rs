...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerResultsPyramidViewAvatarInstaller {
...
#[cfg(feature = "MultiplayerResultsPyramidViewAvatarInstaller")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerResultsPyramidViewAvatarInstaller {
