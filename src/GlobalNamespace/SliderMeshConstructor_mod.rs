...
pub struct SliderMeshConstructor {
    ...
    pub reusableNormals:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector3>>,
    pub reusableTriangles: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>>,
    pub _mesh: quest_hook::libil2cpp::Gc<crate::UnityEngine::Mesh>,
}
#[cfg(feature = "cordl_class_SliderMeshConstructor")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SliderMeshConstructor {
...
impl crate::GlobalNamespace::SliderMeshConstructor {
    ...
    pub fn CreateSliderMesh(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        f32,
                    ), quest_hook::libil2cpp::Void, 2usize>("CreateSliderMesh")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (path, zDistanceBetweenNotes))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateSliderMeshInternal(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (path, zDistanceBetweenNotes, bounds))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_SliderMeshConstructor")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SliderMeshConstructor {
