...
#[cfg(feature = "cordl_class_ComboMissionObjectiveChecker")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ComboMissionObjectiveChecker {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ComboMissionObjectiveChecker";
...
#[cfg(feature = "cordl_class_ComboMissionObjectiveChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ComboMissionObjectiveChecker {
