...
impl crate::GlobalNamespace::ComboMissionObjectiveChecker {
    pub fn HandleComboDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ComboMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ComboMissionObjectiveChecker as
