...
#[repr(C)]
#[derive(Debug)]
pub struct MultiplayerLobbyCenterScreenSystem {
...
for crate::GlobalNamespace::MultiplayerLobbyCenterScreenSystem {
    ...
    const CLASS_NAME: &'static str = "MultiplayerLobbyCenterScreenSystem";
...
impl crate::GlobalNamespace::MultiplayerLobbyCenterScreenSystem {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLobbyCenterScreenSystem as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MultiplayerLobbyCenterScreenSystem as
