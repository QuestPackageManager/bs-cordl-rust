...
impl crate::GlobalNamespace::BpmController {
    ...
    pub fn HandleBpmChangeBeatmapEvent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bpmChangeBeatmapEventData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (initData, beatmapCallbacksController))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::BpmController_InitData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (startBpm))?
        };
        Ok(__cordl_ret.into())
    }
}
