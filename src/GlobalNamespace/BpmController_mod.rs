...
#[cfg(feature = "BpmController")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBpmController>>
...
#[cfg(feature = "BpmController")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBpmController>>
for crate::GlobalNamespace::BpmController {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBpmController> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "BpmController")]
