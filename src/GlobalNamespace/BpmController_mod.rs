                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleBpmChangeBeatmapEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bpmChangeBeatmapEventData))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        initData: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BpmController_InitData>,
    ...
    pub fn _ctor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BpmController_InitData>,
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::BeatmapCallbacksController,
                        >,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (initData, beatmapCallbacksController))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "BpmController")]
impl AsRef<crate::GlobalNamespace::IBpmController> for crate::GlobalNamespace::BpmController {
    fn as_ref(&self) -> &crate::GlobalNamespace::IBpmController {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "BpmController")]
impl AsMut<crate::GlobalNamespace::IBpmController> for crate::GlobalNamespace::BpmController {
...
#[cfg(feature = "cordl_class_BpmController+InitData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BpmController_InitData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::BpmController_InitData {
    pub fn New(startBpm: f32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (startBpm))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BpmController+InitData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BpmController_InitData {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
