...
impl crate::GlobalNamespace::SignalOnPointerClick {
    ...
    pub fn OnPointerClick(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SignalOnPointerClick as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SignalOnPointerClick as
