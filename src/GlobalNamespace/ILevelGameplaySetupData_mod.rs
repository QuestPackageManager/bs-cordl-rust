...
#[repr(C)]
#[derive(Debug)]
pub struct ILevelGameplaySetupData {
...
for crate::GlobalNamespace::ILevelGameplaySetupData {
    ...
    const CLASS_NAME: &'static str = "ILevelGameplaySetupData";
...
impl crate::GlobalNamespace::ILevelGameplaySetupData {
    ...
    pub fn get_beatmapKey(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ILevelGameplaySetupData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ILevelGameplaySetupData as
