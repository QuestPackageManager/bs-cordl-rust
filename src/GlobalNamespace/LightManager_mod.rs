...
impl crate::GlobalNamespace::LightManager {
    ...
    pub fn OnCameraPreRender(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LightManager as quest_hook::libil2cpp::Type
                    > ::class(), "OnCameraPreRender", 1usize
                )
            });
