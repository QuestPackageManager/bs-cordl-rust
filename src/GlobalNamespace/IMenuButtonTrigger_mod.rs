...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IMenuButtonTrigger {
    ...
    const CLASS_NAME: &'static str = "IMenuButtonTrigger";
...
impl crate::GlobalNamespace::IMenuButtonTrigger {
    pub fn add_menuButtonTriggeredEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IMenuButtonTrigger as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IMenuButtonTrigger as
