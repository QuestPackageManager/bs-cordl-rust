...
#[cfg(feature = "cordl_class_PerformanceConfigurationLog")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PerformanceConfigurationLog {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PerformanceConfigurationLog";
...
impl crate::GlobalNamespace::PerformanceConfigurationLog {
    pub fn Create(
        ...
        stats: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PerformanceConfigurationStats>,
    ...
    pub fn LogDynamicStates(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::PerformanceConfigurationStats,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("LogDynamicStates")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (sb, stats))? };
        Ok(__cordl_ret.into())
    }
    pub fn LogEntry<T>(
        sb: quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        T,
                    ), quest_hook::libil2cpp::Void, 4usize>("LogEntry")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (sb, category, name, value))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn LogLevelSettings(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>,
                        crate::GlobalNamespace::GameplayModifierMask,
                    ), quest_hook::libil2cpp::Void, 2usize>("LogLevelSettings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (sb, modifiers))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn LogPlayerSettings(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>,
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlayerSpecificSettings>,
                    ), quest_hook::libil2cpp::Void, 2usize>("LogPlayerSettings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (sb, playerSettings))? };
        Ok(__cordl_ret.into())
    }
    pub fn LogSettings(
        sb: quest_hook::libil2cpp::Gc<crate::System::Text::StringBuilder>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::Settings>,
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RecPlayBehaviour_State>,
                    ), quest_hook::libil2cpp::Void, 3usize>("LogSettings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (sb, settings, recPlayState))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_PerformanceConfigurationLog")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PerformanceConfigurationLog {
