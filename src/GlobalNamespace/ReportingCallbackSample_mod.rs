...
for crate::GlobalNamespace::ReportingCallbackSample {
    ...
    const CLASS_NAME: &'static str = "ReportingCallbackSample";
...
impl crate::GlobalNamespace::ReportingCallbackSample {
    ...
    pub fn OnReportButtonIntentNotif(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ReportingCallbackSample as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ReportingCallbackSample as
                    quest_hook::libil2cpp::Type > ::class(), "OnReportButtonIntentNotif",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ReportingCallbackSample as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ReportingCallbackSample as
                    quest_hook::libil2cpp::Type > ::class(), "<Start>b__2_0", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (message))?
