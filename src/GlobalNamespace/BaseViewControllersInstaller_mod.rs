...
#[cfg(feature = "cordl_class_BaseViewControllersInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BaseViewControllersInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BaseViewControllersInstaller";
...
#[cfg(feature = "cordl_class_BaseViewControllersInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BaseViewControllersInstaller {
