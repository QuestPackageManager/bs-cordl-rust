...
pub struct ScreenCaptureAfterDelay {
    ...
    pub _mainEffectController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MainEffectController>,
    pub _screenCaptureCache: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ScreenCaptureCache>,
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ScreenCaptureAfterDelay_InitData>,
    pub _captureTexture: quest_hook::libil2cpp::Gc<crate::UnityEngine::Texture2D>,
    pub _captureRenderTexture: quest_hook::libil2cpp::Gc<crate::UnityEngine::RenderTexture>,
}
#[cfg(feature = "cordl_class_ScreenCaptureAfterDelay")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ScreenCaptureAfterDelay {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleMainEffectControllerAfterImageEffectEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (renderTexture))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_ScreenCaptureAfterDelay")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ScreenCaptureAfterDelay {
    ...
    for crate::GlobalNamespace::ScreenCaptureAfterDelay_InitData
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ScreenCaptureAfterDelay/InitData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
