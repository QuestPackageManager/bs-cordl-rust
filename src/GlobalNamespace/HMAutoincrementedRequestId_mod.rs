...
impl crate::GlobalNamespace::HMAutoincrementedRequestId {
    pub fn Equals_HMAutoincrementedRequestId0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HMAutoincrementedRequestId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HMAutoincrementedRequestId as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HMAutoincrementedRequestId as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::HMAutoincrementedRequestId as
                    quest_hook::libil2cpp::Type > ::class(), "get_RequestId", 0usize
                )
            });
