...
#[cfg(feature = "cordl_class_MultiplayerScoreRingItem")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerScoreRingItem {
...
#[cfg(feature = "cordl_class_MultiplayerScoreRingItem")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerScoreRingItem {
...
#[cfg(feature = "cordl_class_MultiplayerScoreRingItem+Pool")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerScoreRingItem_Pool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_MultiplayerScoreRingItem+Pool")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerScoreRingItem_Pool {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
