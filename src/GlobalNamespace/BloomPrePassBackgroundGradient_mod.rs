...
impl crate::GlobalNamespace::BloomPrePassBackgroundGradient {
    ...
    pub fn UpdatePixels(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassBackgroundGradient as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BloomPrePassBackgroundGradient as
