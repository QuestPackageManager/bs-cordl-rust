...
impl crate::GlobalNamespace::ModifiersSelectionView {
    ...
    pub fn SetGameplayModifiers(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ModifiersSelectionView as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ModifiersSelectionView as
