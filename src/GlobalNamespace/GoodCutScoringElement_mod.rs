...
pub struct GoodCutScoringElement {
    ...
    pub _wouldBeCorrectCutBestPossibleMultiplierEventType:
        crate::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType,
}
#[cfg(feature = "cordl_class_GoodCutScoringElement")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GoodCutScoringElement {
...
impl crate::GlobalNamespace::GoodCutScoringElement {
    ...
    pub fn Reinitialize(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_multiplierEventType", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_GoodCutScoringElement")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GoodCutScoringElement {
...
#[cfg(feature = "cordl_class_GoodCutScoringElement+Pool")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GoodCutScoringElement_Pool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_GoodCutScoringElement+Pool")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GoodCutScoringElement_Pool {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
