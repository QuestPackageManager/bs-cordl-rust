...
pub struct OVRHeadsetEmulator {
    ...
    pub activateKeys:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::KeyCode>>,
    pub activateKeyBindings: quest_hook::libil2cpp::Gc<
    ...
    pub pitchKeys:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::KeyCode>>,
    pub pitchKeyBindings: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        >,
    >,
    pub activateKeyActions: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputAction>,
        >,
    >,
    pub pitchKeyActions: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputAction>,
        >,
    >,
    pub middleMouseButtonAction:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputAction>,
    pub mouseScrollAction: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputAction>,
    pub mouseMoveAction: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputAction>,
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRHeadsetEmulator {
    ...
    const CLASS_NAME: &'static str = "OVRHeadsetEmulator";
...
impl crate::GlobalNamespace::OVRHeadsetEmulator {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsEmulationActivated")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn IsTweakingPitch(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsTweakingPitch")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_OVRHeadsetEmulator+OpMode")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRHeadsetEmulator_OpMode {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRHeadsetEmulator/OpMode";
...
#[cfg(feature = "cordl_class_OVRHeadsetEmulator+OpMode")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::OVRHeadsetEmulator_OpMode {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVRHeadsetEmulator+OpMode")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::OVRHeadsetEmulator_OpMode {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRHeadsetEmulator+OpMode")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::OVRHeadsetEmulator_OpMode {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRHeadsetEmulator+OpMode")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::OVRHeadsetEmulator_OpMode {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
