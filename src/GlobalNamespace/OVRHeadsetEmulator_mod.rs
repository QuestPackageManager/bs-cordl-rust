...
impl crate::GlobalNamespace::OVRHeadsetEmulator {
    ...
    pub fn IsEmulationActivated(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRHeadsetEmulator as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("IsEmulationActivated")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRHeadsetEmulator as
                    quest_hook::libil2cpp::Type > ::class(), "IsEmulationActivated",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRHeadsetEmulator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRHeadsetEmulator as
                    quest_hook::libil2cpp::Type > ::class(), "IsTweakingPitch", 0usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
