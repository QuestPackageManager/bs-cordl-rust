...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockVRHelper {
    ...
    const CLASS_NAME: &'static str = "MockVRHelper";
...
#[cfg(feature = "MockVRHelper")]
impl crate::GlobalNamespace::MockVRHelper {
    pub fn GetAnyJoystickMaxAxis(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector2> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockVRHelper as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MockVRHelper as quest_hook::libil2cpp::Type
