...
pub struct OVRVirtualKeyboardSampleControls {
    ...
    pub keyboardPrefab: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRVirtualKeyboard>,
    pub inputHandler:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRVirtualKeyboardSampleInputHandler>,
    pub isMovingKeyboard_: bool,
    pub isMovingKeyboardFinished_: bool,
    pub keyboardMoveDistance_: f32,
    pub keyboardScale_: f32,
    pub keyboardBackup:
        crate::GlobalNamespace::OVRVirtualKeyboardSampleControls_OVRVirtualKeyboardBackup,
}
#[cfg(feature = "cordl_class_OVRVirtualKeyboardSampleControls")]
    ...
    for crate::GlobalNamespace::OVRVirtualKeyboardSampleControls
{
    ...
    const CLASS_NAME: &'static str = "OVRVirtualKeyboardSampleControls";
...
impl crate::GlobalNamespace::OVRVirtualKeyboardSampleControls {
    ...
    pub type OVRVirtualKeyboardBackup =
        crate::GlobalNamespace::OVRVirtualKeyboardSampleControls_OVRVirtualKeyboardBackup;
    ...
    pub fn MoveKeyboard(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("MoveKeyboard")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn MoveKeyboardFar(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("MoveKeyboardFar")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn MoveKeyboardNear(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("MoveKeyboardNear")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn OnHideKeyboard(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnHideKeyboard")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
pub struct OVRVirtualKeyboardSampleControls_OVRVirtualKeyboardBackup {
    ...
    pub _rightControllerDirectTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
    pub _rightControllerRootTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
    pub _leftControllerDirectTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
    pub _leftControllerRootTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
    ...
    for crate::GlobalNamespace::OVRVirtualKeyboardSampleControls_OVRVirtualKeyboardBackup
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRVirtualKeyboardSampleControls/OVRVirtualKeyboardBackup";
