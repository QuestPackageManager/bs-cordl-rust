...
impl crate::GlobalNamespace::GameplayModifierInfoListItem {
    ...
    pub fn SetModifier(
        &mut self,
        modifierParam: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::GameplayModifierParamsSO,
        >,
        showName: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameplayModifierInfoListItem as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::GameplayModifierInfoListItem as
                    quest_hook::libil2cpp::Type > ::class(), "SetModifier", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (modifierParam, showName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
