...
#[cfg(feature = "cordl_class_GameplayModifierInfoListItem")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GameplayModifierInfoListItem {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GameplayModifierInfoListItem";
...
impl crate::GlobalNamespace::GameplayModifierInfoListItem {
    ...
    pub fn SetModifier(
        &mut self,
        modifierParam: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayModifierParamsSO>,
        showName: bool,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetModifier")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (modifierParam, showName))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_GameplayModifierInfoListItem")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GameplayModifierInfoListItem {
