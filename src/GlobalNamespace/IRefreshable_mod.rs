...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IRefreshable {
    ...
    const CLASS_NAME: &'static str = "IRefreshable";
...
impl crate::GlobalNamespace::IRefreshable {
    pub fn Refresh(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IRefreshable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Refresh")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IRefreshable as quest_hook::libil2cpp::Type
