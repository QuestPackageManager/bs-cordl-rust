...
impl crate::GlobalNamespace::MomentaryLoudnessHistory {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MomentaryLoudnessHistory as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("Add")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MomentaryLoudnessHistory as
                    quest_hook::libil2cpp::Type > ::class(), "Add", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (momentaryLoudness))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetAverageLoudness(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MomentaryLoudnessHistory as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("GetAverageLoudness")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MomentaryLoudnessHistory as
                    quest_hook::libil2cpp::Type > ::class(), "GetAverageLoudness", 0usize
                )
            });
