...
pub struct MissionObjectiveGameUIView {
    ...
    pub _missionObjectiveChecker:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionObjectiveChecker>,
}
#[cfg(feature = "cordl_class_MissionObjectiveGameUIView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissionObjectiveGameUIView {
...
impl crate::GlobalNamespace::MissionObjectiveGameUIView {
    ...
    pub fn RefreshIcon(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn RefreshValue(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_MissionObjectiveGameUIView")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissionObjectiveGameUIView {
