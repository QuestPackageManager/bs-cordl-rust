...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for MultiplayerLevelAnalytics => ""
    ."MultiplayerLevelAnalytics"
);
#[cfg(feature = "MultiplayerLevelAnalytics")]
impl std::ops::Deref for MultiplayerLevelAnalytics {
...
#[cfg(feature = "MultiplayerLevelAnalytics")]
impl std::ops::DerefMut for MultiplayerLevelAnalytics {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "MultiplayerLevelAnalytics")]
impl MultiplayerLevelAnalytics {
...
#[cfg(feature = "MultiplayerLevelAnalytics")]
impl quest_hook::libil2cpp::ObjectType for MultiplayerLevelAnalytics {
