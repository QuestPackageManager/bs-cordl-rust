...
for crate::GlobalNamespace::MultiplayerLevelAnalytics {
    ...
    const CLASS_NAME: &'static str = "MultiplayerLevelAnalytics";
...
impl crate::GlobalNamespace::MultiplayerLevelAnalytics {
    pub fn HandleMultiplayerLevelDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLevelAnalytics as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerLevelAnalytics as
