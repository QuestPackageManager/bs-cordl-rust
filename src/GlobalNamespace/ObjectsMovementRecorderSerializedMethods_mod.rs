...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ObjectsMovementRecorderSerializedMethods => ""
    ."ObjectsMovementRecorderSerializedMethods"
);
#[cfg(feature = "ObjectsMovementRecorderSerializedMethods")]
impl std::ops::Deref for ObjectsMovementRecorderSerializedMethods {
...
#[cfg(feature = "ObjectsMovementRecorderSerializedMethods")]
impl std::ops::DerefMut for ObjectsMovementRecorderSerializedMethods {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "ObjectsMovementRecorderSerializedMethods")]
impl ObjectsMovementRecorderSerializedMethods {
...
#[cfg(feature = "ObjectsMovementRecorderSerializedMethods")]
impl quest_hook::libil2cpp::ObjectType for ObjectsMovementRecorderSerializedMethods {
