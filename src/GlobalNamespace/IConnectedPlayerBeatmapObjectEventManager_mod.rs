...
impl std::ops::Deref for crate::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager {
...
#[cfg(feature = "IConnectedPlayerBeatmapObjectEventManager")]
impl std::ops::DerefMut for crate::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager {
