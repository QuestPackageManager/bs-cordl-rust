...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for PerformanceConfigurationStats => ""
    ."PerformanceConfigurationStats"
);
#[cfg(feature = "PerformanceConfigurationStats")]
impl std::ops::Deref for PerformanceConfigurationStats {
...
#[cfg(feature = "PerformanceConfigurationStats")]
impl std::ops::DerefMut for PerformanceConfigurationStats {
...
#[cfg(feature = "PerformanceConfigurationStats")]
impl quest_hook::libil2cpp::ObjectType for PerformanceConfigurationStats {
