...
for crate::GlobalNamespace::HeadsetHapticSettingsSampleController {
    ...
    const CLASS_NAME: &'static str = "HeadsetHapticSettingsSampleController";
...
impl crate::GlobalNamespace::HeadsetHapticSettingsSampleController {
    pub fn HandleHapticSettingValueDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HeadsetHapticSettingsSampleController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HeadsetHapticSettingsSampleController as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleHapticSettingValueDidChange", 2usize
                )
            });
