#[cfg(feature = "cordl_class_ServerAppVersionFileManager")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_ServerAppVersionFileManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ServerAppVersionFileManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ServerAppVersionFileManager";
...
impl crate::GlobalNamespace::ServerAppVersionFileManager {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "BuildFilePath", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (directoryPath))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteAppVersion(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 2usize>("WriteAppVersion")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (directoryPath, appVersion))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_ServerAppVersionFileManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ServerAppVersionFileManager {
