#[cfg(feature = "cordl_class_AudioLatencyViewController")]
#[repr(C)]
...
pub struct AudioLatencyViewController {
    ...
    pub _volumeSettingsList:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::FormattedFloatListSettingsController>,
    pub _ambientSettingsList:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::FormattedFloatListSettingsController>,
    pub _overrideAudioLatencyToggle: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle>,
    pub _slider: quest_hook::libil2cpp::Gc<crate::HMUI::RangeValuesTextSlider>,
    pub _visualMetronome: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::VisualMetronome>,
...
#[cfg(feature = "cordl_class_AudioLatencyViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AudioLatencyViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "AudioLatencyViewController";
...
impl crate::GlobalNamespace::AudioLatencyViewController {
    ...
    pub fn HandleAmbientVolumeChanged(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl__, newValue))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RefreshVisuals(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("RefreshVisuals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (overrideAudioLatencyIsEnabled))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_AudioLatencyViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AudioLatencyViewController {
