#[cfg(feature = "cordl_class_Vector2Extensions")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::Vector2Extensions {
    pub fn Clamp_Rect1(
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, within))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::Vector2,
                        crate::UnityEngine::Vector2,
                    ), crate::UnityEngine::Vector2, 3usize>("Clamp")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SignedAngleToLine(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (vec, line))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Vector2Extensions")]
