...
for crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleClippingController {
    ...
    const CLASS_NAME: &'static str = "MultiplayerConnectedPlayerObstacleClippingController";
...
impl crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleClippingController {
    ...
    pub fn SetClippingParams(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerConnectedPlayerObstacleClippingController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "SetClippingParams",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (position, normal))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
