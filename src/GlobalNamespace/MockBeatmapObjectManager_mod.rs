...
for crate::GlobalNamespace::MockBeatmapObjectManager {
    ...
    const CLASS_NAME: &'static str = "MockBeatmapObjectManager";
...
impl crate::GlobalNamespace::MockBeatmapObjectManager {
    pub fn DespawnInternal_NoteController0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockBeatmapObjectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MockBeatmapObjectManager as
