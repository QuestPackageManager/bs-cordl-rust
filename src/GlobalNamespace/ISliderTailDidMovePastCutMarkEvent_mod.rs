...
impl crate::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent {
    pub fn HandleSliderTailDidMovePastCutMark(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleSliderTailDidMovePastCutMark", 1usize
                )
            });
