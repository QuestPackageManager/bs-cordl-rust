#[cfg(feature = "cordl_class_RecordingToolSettings")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_RecordingToolSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RecordingToolSettings {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RecordingToolSettings";
...
impl crate::GlobalNamespace::RecordingToolSettings {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (recordingSettings))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_RecordingToolSettings")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RecordingToolSettings {
