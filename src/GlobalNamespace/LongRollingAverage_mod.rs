...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LongRollingAverage {
    ...
    const CLASS_NAME: &'static str = "LongRollingAverage";
...
impl crate::GlobalNamespace::LongRollingAverage {
    ...
    pub fn Reset(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LongRollingAverage as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Reset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LongRollingAverage as
    ...
    pub fn get_currentAverage(&mut self) -> quest_hook::libil2cpp::Result<i64> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LongRollingAverage as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i64, 0usize>("get_currentAverage")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LongRollingAverage as
