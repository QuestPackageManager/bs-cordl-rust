...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for LongRollingAverage => ""."LongRollingAverage"
);
#[cfg(feature = "LongRollingAverage")]
impl std::ops::Deref for LongRollingAverage {
...
#[cfg(feature = "LongRollingAverage")]
impl std::ops::DerefMut for LongRollingAverage {
...
#[cfg(feature = "LongRollingAverage")]
impl quest_hook::libil2cpp::ObjectType for LongRollingAverage {
