#[cfg(feature = "cordl_class_LevelFailedTextOverride")]
#[repr(C)]
#[derive(Debug)]
pub struct LevelFailedTextOverride {
    ...
    pub _beatmapLevels: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _levelFailedTextEffect: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LevelFailedText>,
    pub _beatmapKey: crate::GlobalNamespace::BeatmapKey,
}
#[cfg(feature = "cordl_class_LevelFailedTextOverride")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LevelFailedTextOverride {
...
#[cfg(feature = "cordl_class_LevelFailedTextOverride")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LevelFailedTextOverride {
    ...
    for crate::GlobalNamespace::LevelFailedTextOverride_LanguageOverride
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LevelFailedTextOverride/LanguageOverride";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "LevelFailedTextOverride+LanguageOverride")]
impl std::ops::Deref for crate::GlobalNamespace::LevelFailedTextOverride_LanguageOverride {
...
#[cfg(feature = "LevelFailedTextOverride+LanguageOverride")]
impl std::ops::DerefMut for crate::GlobalNamespace::LevelFailedTextOverride_LanguageOverride {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
