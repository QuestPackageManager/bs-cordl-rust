...
pub struct GradientTransitionSO {
    ...
    pub _selectedAndHighlightedColor1: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSO>,
    pub _selectedAndHighlightedColor2: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSO>,
}
#[cfg(feature = "cordl_class_GradientTransitionSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GradientTransitionSO {
...
impl crate::GlobalNamespace::GradientTransitionSO {
    ...
    pub fn get_normalColor1(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_normalColor2(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
