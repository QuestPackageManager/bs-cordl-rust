...
for crate::GlobalNamespace::ParticleSystemEventEffect {
    ...
    const CLASS_NAME: &'static str = "ParticleSystemEventEffect";
...
impl crate::GlobalNamespace::ParticleSystemEventEffect {
    pub fn HandleBeatmapEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ParticleSystemEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ParticleSystemEventEffect as
    ...
    pub fn RefreshParticles(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ParticleSystemEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RefreshParticles")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ParticleSystemEventEffect as
                    quest_hook::libil2cpp::Type > ::class(), "RefreshParticles", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
