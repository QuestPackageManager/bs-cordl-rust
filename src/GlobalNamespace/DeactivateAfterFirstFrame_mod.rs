#[cfg(feature = "cordl_class_DeactivateAfterFirstFrame")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_DeactivateAfterFirstFrame")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::DeactivateAfterFirstFrame {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "DeactivateAfterFirstFrame";
...
#[cfg(feature = "cordl_class_DeactivateAfterFirstFrame")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::DeactivateAfterFirstFrame {
