...
impl crate::GlobalNamespace::MeshRendererSwitchEventEffect {
    pub fn HandleBeatmapEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MeshRendererSwitchEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MeshRendererSwitchEventEffect as
