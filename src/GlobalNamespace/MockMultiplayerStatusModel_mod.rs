#[cfg(feature = "cordl_class_MockMultiplayerStatusModel")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_MockMultiplayerStatusModel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockMultiplayerStatusModel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MockMultiplayerStatusModel";
...
#[cfg(feature = "cordl_class_MockMultiplayerStatusModel")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MockMultiplayerStatusModel {
