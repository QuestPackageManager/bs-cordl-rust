...
impl crate::GlobalNamespace::MockMultiplayerStatusModel {
    pub fn GetMultiplayerStatusAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockMultiplayerStatusModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MockMultiplayerStatusModel as
