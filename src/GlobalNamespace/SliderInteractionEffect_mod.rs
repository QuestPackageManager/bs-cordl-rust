#[cfg(feature = "cordl_class_SliderInteractionEffect")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct SliderInteractionEffect {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _sliderInteractionManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SliderInteractionManager>,
}
#[cfg(feature = "cordl_class_SliderInteractionEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SliderInteractionEffect {
...
impl crate::GlobalNamespace::SliderInteractionEffect {
    pub fn EndEffect(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleAllSliderWereRemovedFromActiveSliders", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sliderInteractionManager))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleSliderWasAddedToActiveSliders(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (sliderInteractionManager, saberInteractionParam))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn StartEffect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (saberInteractionParam))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_colorType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::ColorType, 0usize>("get_colorType")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_SliderInteractionEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SliderInteractionEffect {
