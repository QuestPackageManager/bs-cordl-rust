...
impl std::ops::Deref for crate::GlobalNamespace::SmoothCameraSmoothnessSettingsController {
...
#[cfg(feature = "SmoothCameraSmoothnessSettingsController")]
impl std::ops::DerefMut for crate::GlobalNamespace::SmoothCameraSmoothnessSettingsController {
