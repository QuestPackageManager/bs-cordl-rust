...
for crate::GlobalNamespace::HandsMovementMissionObjectiveChecker {
    ...
    const CLASS_NAME: &'static str = "HandsMovementMissionObjectiveChecker";
...
impl crate::GlobalNamespace::HandsMovementMissionObjectiveChecker {
    pub fn HandleTotalDistanceDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HandsMovementMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HandsMovementMissionObjectiveChecker as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleTotalDistanceDidChange", 1usize
                )
            });
