...
impl crate::GlobalNamespace::BTSCharacterSpawnAnimationController {
    ...
    pub fn HandleSpawnCharacterPlayableDirectorStopped(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (playableDirector))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetCharacter(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (btsCharacter))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
