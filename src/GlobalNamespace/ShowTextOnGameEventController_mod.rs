...
pub struct ShowTextOnGameEventController {
    ...
    pub _textFadeTransitions:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TextFadeTransitions>,
...
#[cfg(feature = "cordl_class_ShowTextOnGameEventController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ShowTextOnGameEventController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ShowTextOnGameEventController";
...
#[cfg(feature = "cordl_class_ShowTextOnGameEventController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ShowTextOnGameEventController {
    ...
    for crate::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ShowTextOnGameEventController/EventTextBinding";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "ShowTextOnGameEventController+EventTextBinding")]
impl std::ops::Deref for crate::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding {
...
#[cfg(feature = "ShowTextOnGameEventController+EventTextBinding")]
impl std::ops::DerefMut for crate::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding {
    pub fn Deinit(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Deinit")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn HandleGameEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleGameEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Init(
        &mut self,
        textFadeTransitions: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TextFadeTransitions>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (textFadeTransitions))? };
        Ok(__cordl_ret.into())
    }
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
