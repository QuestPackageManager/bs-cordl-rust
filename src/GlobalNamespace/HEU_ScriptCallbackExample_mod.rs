...
for crate::GlobalNamespace::HEU_ScriptCallbackExample {
    ...
    const CLASS_NAME: &'static str = "HEU_ScriptCallbackExample";
...
impl crate::GlobalNamespace::HEU_ScriptCallbackExample {
    pub fn AssetCallbackNoMsg(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HEU_ScriptCallbackExample as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("AssetCallbackNoMsg")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::HEU_ScriptCallbackExample as
                    quest_hook::libil2cpp::Type > ::class(), "AssetCallbackNoMsg", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HEU_ScriptCallbackExample as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::HEU_ScriptCallbackExample as
                    quest_hook::libil2cpp::Type > ::class(), "AssetCallbackWithMsg",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
