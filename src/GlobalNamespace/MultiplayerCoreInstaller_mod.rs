...
pub struct MultiplayerCoreInstaller {
    ...
    pub _scoreSyncStateManagerPrefab:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ScoreSyncStateManager>,
    pub _multiplayerBadgesModel:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MultiplayerBadgesModelSO>,
    pub _sceneSetupData:
...
#[cfg(feature = "cordl_class_MultiplayerCoreInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerCoreInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultiplayerCoreInstaller";
...
#[cfg(feature = "cordl_class_MultiplayerCoreInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerCoreInstaller {
