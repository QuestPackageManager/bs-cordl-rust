...
for crate::GlobalNamespace::StandaloneSettingsApplicatorSO {
    ...
    const CLASS_NAME: &'static str = "StandaloneSettingsApplicatorSO";
...
impl crate::GlobalNamespace::StandaloneSettingsApplicatorSO {
    pub fn ApplyWindowSettings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StandaloneSettingsApplicatorSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::StandaloneSettingsApplicatorSO as
