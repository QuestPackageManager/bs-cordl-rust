...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRMaterialData {
    ...
    const CLASS_NAME: &'static str = "OVRMaterialData";
...
#[cfg(feature = "cordl_class_OVRMaterialData")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::OVRMaterialData {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRMaterialData")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::OVRMaterialData {
    type Type = Self;
