...
pub struct OVRFace {
    ...
    pub _faceExpressions: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRFaceExpressions>,
    pub _blendShapeStrengthMultiplier: f32,
    pub _meshWeightsProviderObject: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
    pub _skinnedMeshRenderer: quest_hook::libil2cpp::Gc<crate::UnityEngine::SkinnedMeshRenderer>,
    pub _meshWeightsProvider:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRFace_IMeshWeightsProvider>,
}
#[cfg(feature = "cordl_class_OVRFace")]
...
impl crate::GlobalNamespace::OVRFace {
    ...
    pub fn GetWeightValue(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (blendShapeIndex, weightValue))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::SkinnedMeshRenderer> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRFaceExpressions> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_BlendShapeStrengthMultiplier(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_OVRFace+IMeshWeightsProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRFace_IMeshWeightsProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::OVRFace_IMeshWeightsProvider {
    ...
    pub fn UpdateWeights(
        &mut self,
        faceExpressions: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRFaceExpressions>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (faceExpressions))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_OVRFace+IMeshWeightsProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRFace_IMeshWeightsProvider {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
