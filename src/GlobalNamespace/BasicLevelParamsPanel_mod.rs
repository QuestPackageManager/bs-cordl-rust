...
for crate::GlobalNamespace::BasicLevelParamsPanel {
    ...
    const CLASS_NAME: &'static str = "BasicLevelParamsPanel";
...
impl crate::GlobalNamespace::BasicLevelParamsPanel {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BasicLevelParamsPanel as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BasicLevelParamsPanel as
    ...
    pub fn set_bpm(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BasicLevelParamsPanel as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("set_bpm")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BasicLevelParamsPanel as
                    quest_hook::libil2cpp::Type > ::class(), "set_bpm", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
