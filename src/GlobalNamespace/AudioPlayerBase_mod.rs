#[cfg(feature = "cordl_class_AudioPlayerBase")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_AudioPlayerBase")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AudioPlayerBase {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "AudioPlayerBase";
