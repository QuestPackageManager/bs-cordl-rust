...
#[cfg(feature = "GhostEffectAsset")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GhostEffectAsset {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GhostEffectAsset";
...
impl crate::GlobalNamespace::GhostEffectAsset {
    pub fn CreatePlayable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GhostEffectAsset as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::GhostEffectAsset as
