...
impl crate::GlobalNamespace::UIExtensionMethods {
    pub fn CopySizeAndPositionFrom(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::UIExtensionMethods as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::UIExtensionMethods as
                    quest_hook::libil2cpp::Type > ::class(), "CopySizeAndPositionFrom",
                    2usize
                )
            });
