...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ParticleSystemContinuousEventEffect => ""
    ."ParticleSystemContinuousEventEffect"
);
#[cfg(feature = "ParticleSystemContinuousEventEffect")]
impl std::ops::Deref for ParticleSystemContinuousEventEffect {
...
#[cfg(feature = "ParticleSystemContinuousEventEffect")]
impl std::ops::DerefMut for ParticleSystemContinuousEventEffect {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "ParticleSystemContinuousEventEffect")]
impl ParticleSystemContinuousEventEffect {
...
#[cfg(feature = "ParticleSystemContinuousEventEffect")]
impl quest_hook::libil2cpp::ObjectType for ParticleSystemContinuousEventEffect {
