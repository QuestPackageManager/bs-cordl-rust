...
for crate::GlobalNamespace::ParticleSystemContinuousEventEffect {
    ...
    const CLASS_NAME: &'static str = "ParticleSystemContinuousEventEffect";
...
impl crate::GlobalNamespace::ParticleSystemContinuousEventEffect {
    pub fn HandleBeatmapEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ParticleSystemContinuousEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ParticleSystemContinuousEventEffect as
    ...
    pub fn ToggleEmitting(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ParticleSystemContinuousEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("ToggleEmitting")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ParticleSystemContinuousEventEffect as
                    quest_hook::libil2cpp::Type > ::class(), "ToggleEmitting", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (shouldPlay))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
