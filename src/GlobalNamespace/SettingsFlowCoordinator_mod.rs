...
pub struct SettingsFlowCoordinator {
    ...
    pub didFinishEvent: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _mainSettingsMenuViewController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MainSettingsMenuViewController>,
    pub _settingsNavigationController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SettingsNavigationController>,
    ...
    >,
    pub _dropdownDialogPromptViewController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::DropdownDialogPromptViewController>,
    pub _controllerProfilesModel:
...
#[cfg(feature = "cordl_class_SettingsFlowCoordinator")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SettingsFlowCoordinator {
...
impl crate::GlobalNamespace::SettingsFlowCoordinator {
    ...
    pub fn HandleDidSelectSettingsSubMenu(
        &mut self,
        settingsSubMenuInfo: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SettingsSubMenuInfo>,
        idx: i32,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (settingsSubMenuInfo, idx))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleRequestToSelectProfileToCopyFrom(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (profilesToCopyFrom))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShowSecretViewController", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_SettingsFlowCoordinator")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SettingsFlowCoordinator {
    ...
    for crate::GlobalNamespace::SettingsFlowCoordinator_FinishAction
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SettingsFlowCoordinator/FinishAction";
