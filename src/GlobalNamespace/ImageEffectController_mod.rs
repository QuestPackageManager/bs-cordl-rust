...
#[cfg(feature = "cordl_class_ImageEffectController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ImageEffectController {
...
impl crate::GlobalNamespace::ImageEffectController {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::RenderTexture>,
                    ), quest_hook::libil2cpp::Void, 2usize>("OnRenderImage")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn SetCallback(
        &mut self,
        renderImageCallback: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::ImageEffectController_RenderImageCallback,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::ImageEffectController_RenderImageCallback,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (renderImageCallback))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_ImageEffectController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ImageEffectController {
    ...
    for crate::GlobalNamespace::ImageEffectController_RenderImageCallback
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ImageEffectController/RenderImageCallback";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "ImageEffectController+RenderImageCallback")]
impl std::ops::Deref for crate::GlobalNamespace::ImageEffectController_RenderImageCallback {
...
#[cfg(feature = "ImageEffectController+RenderImageCallback")]
impl std::ops::DerefMut for crate::GlobalNamespace::ImageEffectController_RenderImageCallback {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::ImageEffectController_RenderImageCallback {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (src, dest, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
