...
#[cfg(feature = "cordl_class_GuestNameButtonsListItem")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GuestNameButtonsListItem {
...
impl crate::GlobalNamespace::GuestNameButtonsListItem {
    ...
    pub fn _Awake_b__7_0(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_GuestNameButtonsListItem")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GuestNameButtonsListItem {
