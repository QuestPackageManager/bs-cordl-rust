...
impl crate::GlobalNamespace::IServerSongPackProviderManager {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IServerSongPackProviderManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IServerSongPackProviderManager as
                    quest_hook::libil2cpp::Type > ::class(), "GetServerSongPackProvider",
                    0usize
                )
            });
