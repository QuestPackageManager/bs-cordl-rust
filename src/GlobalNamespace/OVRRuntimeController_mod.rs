...
pub struct OVRRuntimeController {
    ...
    pub m_controllerModelPath: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
#[cfg(feature = "cordl_class_OVRRuntimeController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRRuntimeController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsModelSupported", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (modelPath))? };
        Ok(__cordl_ret.into())
    }
