...
impl crate::GlobalNamespace::IAssetSongAudioClipProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IAssetSongAudioClipProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioClip>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IAssetSongAudioClipProvider as
                    quest_hook::libil2cpp::Type > ::class(), "get_songAudioClip", 0usize
                )
            });
