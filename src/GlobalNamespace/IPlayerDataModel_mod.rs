...
impl crate::GlobalNamespace::IPlayerDataModel {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IPlayerDataModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlayerData>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IPlayerDataModel as
                    quest_hook::libil2cpp::Type > ::class(), "get_playerData", 0usize
                )
            });
