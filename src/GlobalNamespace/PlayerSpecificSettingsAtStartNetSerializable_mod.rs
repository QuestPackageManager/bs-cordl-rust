...
impl std::ops::Deref for crate::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable {
...
#[cfg(feature = "PlayerSpecificSettingsAtStartNetSerializable")]
impl std::ops::DerefMut for crate::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable {
...
impl crate::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable {
    ...
    pub fn _ctor_List_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (activePlayerSpecificSettingsAtGameStart))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IReadOnlyList_1<
                            ...
                            >,
                        >,
                    >, 0usize>("get_activePlayerSpecificSettingsAtGameStart")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            ...
                            >,
                        >,
                    >, 0usize>("get_activePlayersAtGameStart")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
