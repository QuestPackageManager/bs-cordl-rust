...
for crate::GlobalNamespace::IReturnToMenuController {
    ...
    const CLASS_NAME: &'static str = "IReturnToMenuController";
...
impl crate::GlobalNamespace::IReturnToMenuController {
    pub fn ReturnToMenu(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IReturnToMenuController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ReturnToMenu")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IReturnToMenuController as
