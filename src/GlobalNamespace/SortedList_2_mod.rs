...
pub struct SortedList_2<T: quest_hook::libil2cpp::Type, TBase: quest_hook::libil2cpp::Type> {
    ...
    pub _sortedListDataProcessor:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ISortedListItemProcessor_1<TBase>>,
    pub _lastUsedNode:
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::LinkedListNode_1<TBase>>,
    __cordl_phantom_T: std::marker::PhantomData<T>,
    __cordl_phantom_TBase: std::marker::PhantomData<TBase>,
}
#[cfg(feature = "cordl_class_SortedList_2")]
unsafe impl<T: quest_hook::libil2cpp::Type, TBase: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::GlobalNamespace::SortedList_2<T, TBase>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "SortedList`2")
                .unwrap()
                .make_generic::<(T, TBase)>()
                .unwrap()
                .unwrap()
        })
    }
...
#[cfg(feature = "SortedList_2")]
impl<T: quest_hook::libil2cpp::Type, TBase: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::GlobalNamespace::SortedList_2<T, TBase>
{
...
#[cfg(feature = "SortedList_2")]
impl<T: quest_hook::libil2cpp::Type, TBase: quest_hook::libil2cpp::Type>
    crate::GlobalNamespace::SortedList_2<T, TBase>
{
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::LinkedListNode_1<TBase>,
                    >), quest_hook::libil2cpp::Void, 1usize>("InsertInternal")
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::LinkedListNode_1<TBase>,
                    >), quest_hook::libil2cpp::Void, 1usize>("Insert")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newNode))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TBase), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::LinkedListNode_1<TBase>,
                    >, 1usize>("Insert")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::LinkedListNode_1<TBase>,
                    >), quest_hook::libil2cpp::Void, 1usize>("Remove")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::LinkedListNode_1<TBase>,
                    >), quest_hook::libil2cpp::Void, 1usize>("TouchLastUsedNode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sortedListDataProcessor))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_items(
        ...
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::LinkedList_1<TBase>>,
    >
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
