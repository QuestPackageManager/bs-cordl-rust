...
#[cfg(feature = "SliderHapticFeedbackInteractionEffect")]
impl std::ops::DerefMut for crate::GlobalNamespace::SliderHapticFeedbackInteractionEffect {
...
impl crate::GlobalNamespace::SliderHapticFeedbackInteractionEffect {
    ...
    pub fn Vibrate(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
