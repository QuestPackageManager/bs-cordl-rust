...
for crate::GlobalNamespace::SliderHapticFeedbackInteractionEffect {
    ...
    const CLASS_NAME: &'static str = "SliderHapticFeedbackInteractionEffect";
...
impl crate::GlobalNamespace::SliderHapticFeedbackInteractionEffect {
    ...
    pub fn EndEffect(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SliderHapticFeedbackInteractionEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EndEffect")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SliderHapticFeedbackInteractionEffect as
    ...
    pub fn Vibrate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SliderHapticFeedbackInteractionEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Vibrate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SliderHapticFeedbackInteractionEffect as
                    quest_hook::libil2cpp::Type > ::class(), "Vibrate", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
