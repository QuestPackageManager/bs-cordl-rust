...
for crate::GlobalNamespace::LightRotationBeatmapEventDataBox {
    ...
    const CLASS_NAME: &'static str = "LightRotationBeatmapEventDataBox";
...
impl crate::GlobalNamespace::LightRotationBeatmapEventDataBox {
    ...
    pub fn Unpack(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightRotationBeatmapEventDataBox as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    f32,
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LightRotationBeatmapEventDataBox as
