...
pub struct DisappearingArrowControllerBase_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _arrowCutoutEffect: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::CutoutEffect>,
    ...
    for crate::GlobalNamespace::DisappearingArrowControllerBase_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "DisappearingArrowControllerBase`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "DisappearingArrowControllerBase_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::DisappearingArrowControllerBase_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (gameNoteController))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (arrowTransparency))? };
        Ok(__cordl_ret.into())
    }
