...
impl crate::GlobalNamespace::LobbyGameStateModel {
    ...
    pub fn SetGameState__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newGameState, sendNotification))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_gameState(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::MultiplayerGameState, 0usize>(
                        "get_gameState",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::GlobalNamespace::MultiplayerGameState =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
