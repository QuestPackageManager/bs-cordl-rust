#[cfg(feature = "cordl_class_LocalLeaderboardsSettingsSO")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_LocalLeaderboardsSettingsSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LocalLeaderboardsSettingsSO {
...
impl crate::GlobalNamespace::LocalLeaderboardsSettingsSO {
    ...
    pub fn get_maxNumberOfScoresInLeaderboard(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_maxNumberOfScoresInLeaderboard",
                            0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_LocalLeaderboardsSettingsSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LocalLeaderboardsSettingsSO {
