...
for crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget {
    ...
    const CLASS_NAME: &'static str = "VertexDisplacementFloatFxGroupEffectTarget";
...
impl crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget {
    pub fn CalculateDisplacementVector(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget
                    as quest_hook::libil2cpp::Type > ::class(), "OnValidate", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget
                    as quest_hook::libil2cpp::Type > ::class(), "SetValue", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget
                    as quest_hook::libil2cpp::Type > ::class(), "SetValue", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget
                    as quest_hook::libil2cpp::Type > ::class(), "TriggerValue", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (groupId, elementId, value))?
