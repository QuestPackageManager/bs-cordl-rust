...
impl std::ops::Deref for crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget {
...
#[cfg(feature = "VertexDisplacementFloatFxGroupEffectTarget")]
impl std::ops::DerefMut for crate::GlobalNamespace::VertexDisplacementFloatFxGroupEffectTarget {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), crate::UnityEngine::Vector4, 1usize>(
