...
#[cfg(feature = "RecordingConverter")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RecordingConverter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RecordingConverter";
...
impl crate::GlobalNamespace::RecordingConverter {
    ...
    pub fn SaveToOldFormat(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RecordingConverter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RecordingConverter as
