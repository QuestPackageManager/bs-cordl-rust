#[cfg(feature = "cordl_class_INoteVisualModifierTypeProvider")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::GlobalNamespace::INoteVisualModifierTypeProvider
{
    ...
    const CLASS_NAME: &'static str = "INoteVisualModifierTypeProvider";
...
#[cfg(feature = "cordl_class_INoteVisualModifierTypeProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::INoteVisualModifierTypeProvider {
