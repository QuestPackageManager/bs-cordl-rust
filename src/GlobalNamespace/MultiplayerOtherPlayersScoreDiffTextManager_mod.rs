...
pub struct MultiplayerOtherPlayersScoreDiffTextManager {
    ...
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::CoreGameHUDController_InitData>,
    ...
    for crate::GlobalNamespace::MultiplayerOtherPlayersScoreDiffTextManager
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerOtherPlayersScoreDiffTextManager";
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerOtherPlayersScoreDiffTextManager {
...
#[cfg(feature = "MultiplayerOtherPlayersScoreDiffTextManager")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerOtherPlayersScoreDiffTextManager {
...
impl crate::GlobalNamespace::MultiplayerOtherPlayersScoreDiffTextManager {
    ...
    pub fn HideAll(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HideAll")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
