#[cfg(feature = "cordl_class_IBeatmapObjectController")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_IBeatmapObjectController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IBeatmapObjectController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IBeatmapObjectController";
...
#[cfg(feature = "cordl_class_IBeatmapObjectController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::IBeatmapObjectController {
