...
for crate::GlobalNamespace::Parametric3SliceUpdater {
    ...
    const CLASS_NAME: &'static str = "Parametric3SliceUpdater";
...
#[cfg(feature = "Parametric3SliceUpdater")]
impl crate::GlobalNamespace::Parametric3SliceUpdater {
    ...
    pub fn Update(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::Parametric3SliceUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Update")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::Parametric3SliceUpdater as
