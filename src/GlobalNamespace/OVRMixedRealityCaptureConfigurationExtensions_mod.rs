...
impl std::ops::Deref for crate::GlobalNamespace::OVRMixedRealityCaptureConfigurationExtensions {
...
#[cfg(feature = "OVRMixedRealityCaptureConfigurationExtensions")]
impl std::ops::DerefMut for crate::GlobalNamespace::OVRMixedRealityCaptureConfigurationExtensions {
...
impl crate::GlobalNamespace::OVRMixedRealityCaptureConfigurationExtensions {
    pub fn ApplyTo(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (dest, source))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReadFrom(
        dest: quest_hook::libil2cpp::Gc<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::OVRMixedRealityCaptureConfiguration,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("ReadFrom")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
