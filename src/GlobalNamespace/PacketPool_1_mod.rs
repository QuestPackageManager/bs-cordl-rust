...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::GlobalNamespace::PacketPool_1<T> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::IPoolablePacket,
                        >),
