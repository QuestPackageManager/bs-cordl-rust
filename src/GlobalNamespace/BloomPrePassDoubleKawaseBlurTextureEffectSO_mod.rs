...
impl std::ops::Deref for crate::GlobalNamespace::BloomPrePassDoubleKawaseBlurTextureEffectSO {
...
#[cfg(feature = "BloomPrePassDoubleKawaseBlurTextureEffectSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::BloomPrePassDoubleKawaseBlurTextureEffectSO {
