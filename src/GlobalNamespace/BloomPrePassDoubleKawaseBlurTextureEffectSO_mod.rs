...
impl crate::GlobalNamespace::BloomPrePassDoubleKawaseBlurTextureEffectSO {
    ...
    pub fn Render(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassDoubleKawaseBlurTextureEffectSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BloomPrePassDoubleKawaseBlurTextureEffectSO
                    as quest_hook::libil2cpp::Type > ::class(), "Render", 2usize
                )
            });
