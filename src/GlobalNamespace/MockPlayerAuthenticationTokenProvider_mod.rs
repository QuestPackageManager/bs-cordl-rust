...
pub struct MockPlayerAuthenticationTokenProvider {
    ...
    pub _hashedUserId_k__BackingField:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _userName_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
#[cfg(feature = "MockPlayerAuthenticationTokenProvider")]
impl std::ops::DerefMut for crate::GlobalNamespace::MockPlayerAuthenticationTokenProvider {
...
impl crate::GlobalNamespace::MockPlayerAuthenticationTokenProvider {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (userId, userName, password, mockTokenData))?
        };
        Ok(__cordl_ret.into())
    }
