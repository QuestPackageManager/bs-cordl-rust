...
#[cfg(feature = "cordl_class_RandomAnimationStartTime")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RandomAnimationStartTime {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RandomAnimationStartTime";
...
#[cfg(feature = "cordl_class_RandomAnimationStartTime")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RandomAnimationStartTime {
