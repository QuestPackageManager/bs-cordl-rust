...
for crate::GlobalNamespace::IMissionNodesManager {
    ...
    const CLASS_NAME: &'static str = "IMissionNodesManager";
...
impl crate::GlobalNamespace::IMissionNodesManager {
    ...
    pub fn get_allMissionNodes(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IMissionNodesManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::IReadOnlyCollection_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IMissionNodesManager as
