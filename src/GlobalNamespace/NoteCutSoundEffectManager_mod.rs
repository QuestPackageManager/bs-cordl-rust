...
pub struct NoteCutSoundEffectManager {
    ...
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::NoteCutSoundEffectManager_InitData>,
    ...
    pub _noteCutSoundEffectPool:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::NoteCutSoundEffect_Pool>,
...
#[cfg(feature = "cordl_class_NoteCutSoundEffectManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteCutSoundEffectManager {
...
impl crate::GlobalNamespace::NoteCutSoundEffectManager {
    ...
    pub fn get_handleWrongSaberTypeAsGood(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_NoteCutSoundEffectManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NoteCutSoundEffectManager {
...
impl AsMut<crate::GlobalNamespace::INoteCutSoundEffectDidFinishEvent>
    for crate::GlobalNamespace::NoteCutSoundEffectManager
{
    fn as_mut(&mut self) -> &mut crate::GlobalNamespace::INoteCutSoundEffectDidFinishEvent {
        unsafe { std::mem::transmute(self) }
    }
}
