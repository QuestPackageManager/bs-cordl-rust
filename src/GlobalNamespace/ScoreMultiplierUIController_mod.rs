...
pub struct ScoreMultiplierUIController {
    ...
    pub _multiplierTexts: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _multiplierProgressImage: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Image>,
...
#[cfg(feature = "cordl_class_ScoreMultiplierUIController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ScoreMultiplierUIController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ScoreMultiplierUIController";
...
impl crate::GlobalNamespace::ScoreMultiplierUIController {
    pub fn HandleMultiplierDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (multiplier, progress))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_ScoreMultiplierUIController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ScoreMultiplierUIController {
