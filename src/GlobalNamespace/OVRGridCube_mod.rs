...
pub struct OVRGridCube {
    ...
    pub gridScale: f32,
    pub cubeScale: f32,
    pub CameraController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRCameraRig>,
}
#[cfg(feature = "cordl_class_OVRGridCube")]
...
impl crate::GlobalNamespace::OVRGridCube {
    pub fn CreateCubeGrid(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn CubeGridSwitchColor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (CubeSwitchColor))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetOVRCameraController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cameraController))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateCubeGrid(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
