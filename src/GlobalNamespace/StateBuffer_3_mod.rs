...
impl<
        ...
        TType: quest_hook::libil2cpp::Type,
        TState: quest_hook::libil2cpp::Type,
    > std::ops::DerefMut for crate::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>
{
    ...
    > crate::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        _cordl_size: i32,
...
unsafe impl<
        ...
        TState: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type
    for crate::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable, TType, TState>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "StateBuffer`3/InterpolationDelegate")
                .unwrap()
                .make_generic::<(TStateTable, TType, TState)>()
                .unwrap()
                .unwrap()
    ...
    > crate::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable, TType, TState>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (a, timeA, b, timeB, _cordl_time, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TState = unsafe { cordl_method_info.invoke_unchecked(self, (result))? };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
        &mut self,
    ...
    for crate::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable, TType, TState>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "StateBuffer`3/SmoothingDelegate")
                .unwrap()
                .make_generic::<(TStateTable, TType, TState)>()
                .unwrap()
                .unwrap()
    ...
    > crate::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable, TType, TState>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (a, b, smooth, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
...
unsafe impl<
        ...
        TState: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type
    for crate::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "StateBuffer`3/TimestampedStateTable")
                .unwrap()
                .make_generic::<(TStateTable, TType, TState)>()
                .unwrap()
                .unwrap()
    ...
    > crate::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (id, _cordl_time, state))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64, TStateTable), quest_hook::libil2cpp::Void, 2usize>(".ctor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_time, state))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "StateBuffer_3+TimestampedStateTable")]
