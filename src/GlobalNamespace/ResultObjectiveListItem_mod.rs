#[cfg(feature = "cordl_class_ResultObjectiveListItem")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_ResultObjectiveListItem")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ResultObjectiveListItem {
...
impl crate::GlobalNamespace::ResultObjectiveListItem {
    ...
    pub fn set_hideValueText(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_hideValueText")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_ResultObjectiveListItem")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ResultObjectiveListItem {
