...
impl crate::GlobalNamespace::RuntimeLightWithIds {
    ...
    pub fn get_mixType(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::GlobalNamespace::ColorMixAndWeightingApproach> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::GlobalNamespace::ColorMixAndWeightingApproach =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "RuntimeLightWithIds+LightIntensitiesWithId")]
impl std::ops::Deref for crate::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId {
...
#[cfg(feature = "RuntimeLightWithIds+LightIntensitiesWithId")]
impl std::ops::DerefMut for crate::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lightId, lightIntensity))? };
        Ok(__cordl_ret.into())
    }
