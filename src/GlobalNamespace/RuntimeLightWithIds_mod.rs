...
impl crate::GlobalNamespace::RuntimeLightWithIds {
    ...
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RuntimeLightWithIds as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RuntimeLightWithIds as
...
impl crate::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RuntimeLightWithIds_LightIntensitiesWithId as quest_hook::libil2cpp::Type>::class()
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (lightId, lightIntensity))?
        };
        Ok(__cordl_ret.into())
    }
