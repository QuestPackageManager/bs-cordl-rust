...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ParticleSystemLightWithId => ""
    ."ParticleSystemLightWithId"
);
#[cfg(feature = "ParticleSystemLightWithId")]
impl std::ops::Deref for ParticleSystemLightWithId {
...
#[cfg(feature = "ParticleSystemLightWithId")]
impl std::ops::DerefMut for ParticleSystemLightWithId {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "ParticleSystemLightWithId")]
impl ParticleSystemLightWithId {
    pub fn Awake(
        &mut self,
...
#[cfg(feature = "ParticleSystemLightWithId")]
impl quest_hook::libil2cpp::ObjectType for ParticleSystemLightWithId {
