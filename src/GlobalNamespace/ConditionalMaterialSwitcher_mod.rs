...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for ConditionalMaterialSwitcher => ""
    ."ConditionalMaterialSwitcher"
);
#[cfg(feature = "ConditionalMaterialSwitcher")]
impl std::ops::Deref for ConditionalMaterialSwitcher {
...
#[cfg(feature = "ConditionalMaterialSwitcher")]
impl std::ops::DerefMut for ConditionalMaterialSwitcher {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "ConditionalMaterialSwitcher")]
impl ConditionalMaterialSwitcher {
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "ConditionalMaterialSwitcher")]
impl quest_hook::libil2cpp::ObjectType for ConditionalMaterialSwitcher {
