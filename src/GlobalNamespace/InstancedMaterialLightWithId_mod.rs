...
pub struct InstancedMaterialLightWithId {
    ...
    pub _multiplyColorByAlpha:
        crate::GlobalNamespace::InstancedMaterialLightWithId_MultiplyColorByAlphaType,
...
#[cfg(feature = "cordl_class_InstancedMaterialLightWithId")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::InstancedMaterialLightWithId {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "InstancedMaterialLightWithId";
...
#[cfg(feature = "cordl_class_InstancedMaterialLightWithId")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::InstancedMaterialLightWithId {
