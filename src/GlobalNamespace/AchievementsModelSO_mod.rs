#[cfg(feature = "cordl_class_AchievementsModelSO")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::AchievementsModelSO {
    ...
    pub fn IsAchievementUnlocked(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (achievement))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _Initialize_b__3_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (result, achievementIds))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
