#[cfg(feature = "cordl_class_BeatmapObjectsAvoidance")]
#[repr(C)]
...
pub struct BeatmapObjectsAvoidance {
    ...
    pub _towardsPlayerWrapperTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
    ...
    pub _avoidanceYOffsetEvaluatorProvider:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator>,
    pub _pathEvaluator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapObjectAvoidancePathEvaluator>,
    pub _tiltEvaluator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapObjectAvoidanceTiltEvaluator>,
    pub _pathBezierSplineEvaluator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BezierSplineEvaluator>,
    pub _accelerationBezierSplineEvaluator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BezierSplineEvaluator>,
    pub _transform: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
}
#[cfg(feature = "cordl_class_BeatmapObjectsAvoidance")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapObjectsAvoidance {
...
impl crate::GlobalNamespace::BeatmapObjectsAvoidance {
    pub fn AdjustPositionWithOffsetDirection(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (position, lineIndex, offsetDirection))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn BuildAnimationCurvePath(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("BuildAnimationCurvePath")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetupAndRun(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetupAndRun")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_BeatmapObjectsAvoidance")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapObjectsAvoidance {
