...
impl crate::GlobalNamespace::BloomPrePassLight_LightsDataItem {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lightType, lights))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "cordl_class_BloomPrePassLight+QuadData")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BloomPrePassLight+VertexData")]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
