...
#[cfg(feature = "cordl_class_BeatmapLevelPackGroup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapLevelPackGroup {
...
impl crate::GlobalNamespace::BeatmapLevelPackGroup {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (groupName, collections))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BeatmapLevelPackGroup")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapLevelPackGroup {
