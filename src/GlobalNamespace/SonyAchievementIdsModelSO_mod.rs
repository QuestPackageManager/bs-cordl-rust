                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetAchievementId", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (trophyId, achievementId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetTrophyId(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (achievementId, trophyId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetTrophyIds(
...
#[cfg(feature = "cordl_class_SonyAchievementIdsModelSO+AchievementIdData")]
#[repr(C)]
#[derive(Debug)]
