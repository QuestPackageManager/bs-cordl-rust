...
#[cfg(feature = "cordl_class_FireworksItemPoolInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FireworksItemPoolInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "FireworksItemPoolInstaller";
...
#[cfg(feature = "cordl_class_FireworksItemPoolInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::FireworksItemPoolInstaller {
