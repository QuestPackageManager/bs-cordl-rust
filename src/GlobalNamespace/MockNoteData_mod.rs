...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockNoteData {
    ...
    const CLASS_NAME: &'static str = "MockNoteData";
...
impl crate::GlobalNamespace::MockNoteData {
    pub fn Mirror(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lineCount))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_cutDirection(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::NoteCutDirection, 0usize>(
                        "get_cutDirection",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
