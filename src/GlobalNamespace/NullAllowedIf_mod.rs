...
impl crate::GlobalNamespace::NullAllowedIf {
    pub fn IsNullAllowedFor(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (value, context))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppObject_NullAllowed_Context0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (propertyName, equalsTo, context))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_NullAllowedIf")]
