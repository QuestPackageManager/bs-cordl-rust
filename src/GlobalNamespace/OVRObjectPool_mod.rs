...
impl crate::GlobalNamespace::OVRObjectPool {
    ...
    pub type TaskScope_1<T: quest_hook::libil2cpp::Type> = crate::GlobalNamespace::OVRObjectPool_TaskScope_1<
        T,
    >;
...
for crate::GlobalNamespace::OVRObjectPool_IPoolObject {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
> crate::GlobalNamespace::OVRObjectPool_ListScope_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (source, list))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::OVRObjectPool_Storage_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (item))?
        };
        Ok(__cordl_ret.into())
    }
...
pub struct OVRObjectPool_TaskScope_1<T: quest_hook::libil2cpp::Type> {
    pub _tasks: crate::GlobalNamespace::OVRObjectPool_ListScope_1<
...
> crate::GlobalNamespace::OVRObjectPool_TaskScope_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tasks, results))?
        };
        Ok(__cordl_ret.into())
    }
}
