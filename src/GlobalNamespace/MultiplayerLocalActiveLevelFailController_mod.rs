...
impl crate::GlobalNamespace::MultiplayerLocalActiveLevelFailController {
    pub fn HandlePlayerDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalActiveLevelFailController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerLocalActiveLevelFailController as
                    quest_hook::libil2cpp::Type > ::class(), "HandlePlayerDidFinish",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalActiveLevelFailController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MultiplayerLocalActiveLevelFailController as
                    quest_hook::libil2cpp::Type > ::class(), "PlayerFailedCoroutine",
                    0usize
                )
            });
