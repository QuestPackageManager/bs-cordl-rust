...
for crate::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent {
    ...
    const CLASS_NAME: &'static str = "ISliderHeadDidMovePastCutMarkEvent";
...
impl crate::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent {
    pub fn HandleSliderStartDidMovePastCutMark(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleSliderStartDidMovePastCutMark", 1usize
                )
            });
