...
for crate::GlobalNamespace::LightTranslationGroupEffectManager {
    ...
    const CLASS_NAME: &'static str = "LightTranslationGroupEffectManager";
...
impl crate::GlobalNamespace::LightTranslationGroupEffectManager {
    ...
    pub fn OnDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightTranslationGroupEffectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDestroy")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LightTranslationGroupEffectManager as
