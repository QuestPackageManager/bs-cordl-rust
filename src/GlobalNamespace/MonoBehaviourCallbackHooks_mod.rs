...
#[cfg(feature = "cordl_class_MonoBehaviourCallbackHooks")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MonoBehaviourCallbackHooks {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_OnLateUpdateDelegate", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_OnUpdateDelegate", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_MonoBehaviourCallbackHooks")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MonoBehaviourCallbackHooks {
