...
pub struct MenuEnvironmentManager {
    ...
    pub _data: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _prevMenuEnvironmentType:
        crate::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType,
}
#[cfg(feature = "cordl_class_MenuEnvironmentManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MenuEnvironmentManager {
...
impl crate::GlobalNamespace::MenuEnvironmentManager {
    ...
    pub type MenuEnvironmentObjects =
        crate::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects;
    #[cfg(feature = "MenuEnvironmentManager+MenuEnvironmentType")]
    pub type MenuEnvironmentType =
        crate::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShowEnvironmentType", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (menuEnvironmentType))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MenuEnvironmentManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MenuEnvironmentManager {
...
#[cfg(feature = "MenuEnvironmentManager+MenuEnvironmentObjects")]
impl std::ops::Deref for crate::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects {
...
#[cfg(feature = "MenuEnvironmentManager+MenuEnvironmentObjects")]
impl std::ops::DerefMut for crate::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_menuEnvironmentType", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_wrapper(
