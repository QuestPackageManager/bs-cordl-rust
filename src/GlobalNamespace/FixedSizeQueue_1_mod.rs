#[cfg(feature = "cordl_class_FixedSizeQueue_1")]
#[repr(C)]
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::FixedSizeQueue_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, queueSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_0(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (queueSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_data(
        &mut self,
