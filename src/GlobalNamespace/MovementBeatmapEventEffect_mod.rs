...
#[cfg(feature = "cordl_class_MovementBeatmapEventEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MovementBeatmapEventEffect {
...
impl crate::GlobalNamespace::MovementBeatmapEventEffect {
    ...
    pub fn SetLocalPositionOffsetsForAllObjects(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (localPositionOffset))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MovementBeatmapEventEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MovementBeatmapEventEffect {
...
#[cfg(feature = "MovementBeatmapEventEffect+MovementData")]
impl std::ops::Deref for crate::GlobalNamespace::MovementBeatmapEventEffect_MovementData {
...
#[cfg(feature = "MovementBeatmapEventEffect+MovementData")]
impl std::ops::DerefMut for crate::GlobalNamespace::MovementBeatmapEventEffect_MovementData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
