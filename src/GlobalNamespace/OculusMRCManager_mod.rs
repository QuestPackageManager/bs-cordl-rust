...
#[cfg(feature = "OculusMRCManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OculusMRCManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OculusMRCManager";
...
impl crate::GlobalNamespace::OculusMRCManager {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OculusMRCManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OculusMRCManager as
