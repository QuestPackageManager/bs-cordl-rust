...
pub struct MultiplayerLocalActivePlayerGameplayAnimator {
    ...
    pub _coreGameHUDController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::CoreGameHUDController>,
    pub _multiplayerPositionHUDController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MultiplayerPositionHUDController>,
    ...
    for crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerLocalActivePlayerGameplayAnimator";
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator {
...
#[cfg(feature = "MultiplayerLocalActivePlayerGameplayAnimator")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator {
...
impl crate::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator {
    ...
    pub fn InitializeIfNeeded(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InitializeIfNeeded")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
