...
for crate::GlobalNamespace::GameCoreSceneSetupData {
    ...
    const CLASS_NAME: &'static str = "GameCoreSceneSetupData";
...
impl crate::GlobalNamespace::GameCoreSceneSetupData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameCoreSceneSetupData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::GameCoreSceneSetupData as
