...
for crate::GlobalNamespace::EventsTestScenesTransitionSetupDataSO {
    ...
    const CLASS_NAME: &'static str = "EventsTestScenesTransitionSetupDataSO";
...
impl crate::GlobalNamespace::EventsTestScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EventsTestScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Init")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EventsTestScenesTransitionSetupDataSO as
