...
#[cfg(feature = "EventsTestScenesTransitionSetupDataSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::EventsTestScenesTransitionSetupDataSO {
...
impl crate::GlobalNamespace::EventsTestScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (environmentsListModel))? };
        Ok(__cordl_ret.into())
    }
