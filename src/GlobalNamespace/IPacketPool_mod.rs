...
#[cfg(feature = "IPacketPool")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IPacketPool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IPacketPool";
...
impl crate::GlobalNamespace::IPacketPool {
    pub fn Clear(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IPacketPool as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Clear")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IPacketPool as quest_hook::libil2cpp::Type >
                    ::class(), "Clear", 0usize
                )
            });
