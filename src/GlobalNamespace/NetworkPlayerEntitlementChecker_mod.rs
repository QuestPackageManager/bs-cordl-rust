#[cfg(feature = "cordl_class_NetworkPlayerEntitlementChecker")]
#[repr(C)]
...
impl crate::GlobalNamespace::NetworkPlayerEntitlementChecker {
    pub fn GetEntitlementStatus(
        ...
        quest_hook::libil2cpp::Gc<
            crate::System::Threading::Tasks::Task_1<crate::GlobalNamespace::EntitlementsStatus>,
        >,
    > {
    ...
    pub fn HandleDataInvalidated(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleDataInvalidated")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_NetworkPlayerEntitlementChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NetworkPlayerEntitlementChecker {
