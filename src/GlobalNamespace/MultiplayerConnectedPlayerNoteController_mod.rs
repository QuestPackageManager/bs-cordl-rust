...
for crate::GlobalNamespace::MultiplayerConnectedPlayerNoteController {
    ...
    const CLASS_NAME: &'static str = "MultiplayerConnectedPlayerNoteController";
...
impl crate::GlobalNamespace::MultiplayerConnectedPlayerNoteController {
    pub fn HiddenStateDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerConnectedPlayerNoteController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerConnectedPlayerNoteController as
