...
for crate::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper {
    ...
    const CLASS_NAME: &'static str = "MultiplayerLocalPlayerDisconnectHelper";
...
impl crate::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper {
    ...
    pub fn Disconnect(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper as
                    quest_hook::libil2cpp::Type > ::class(), "Disconnect", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (playerLevelEndState, levelCompletionResults))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "ResolveDisconnectButtonString", 0usize
                )
            });
