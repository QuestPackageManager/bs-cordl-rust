...
#[cfg(feature = "MultiplayerLocalPlayerDisconnectHelper")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper {
...
impl crate::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper {
    ...
    pub fn Disconnect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (playerLevelEndState, levelCompletionResults))?
        };
        Ok(__cordl_ret.into())
    }
