...
#[cfg(feature = "cordl_class_UnitySpecificRandomExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::UnitySpecificRandomExtensions {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InsideUnitSphere", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Vector3 =
            unsafe { cordl_method_info.invoke_unchecked((), (random))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnUnitSphere(
        random: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IRandom>,
...
#[cfg(feature = "cordl_class_UnitySpecificRandomExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::UnitySpecificRandomExtensions {
