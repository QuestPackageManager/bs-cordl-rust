...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for UndoRedoBuffer_1 < T > => ""."UndoRedoBuffer`1" < T >
);
#[cfg(feature = "UndoRedoBuffer_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for UndoRedoBuffer_1<T> {
...
#[cfg(feature = "UndoRedoBuffer_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for UndoRedoBuffer_1<T> {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UndoRedoBuffer_1")]
impl<T: quest_hook::libil2cpp::Type> UndoRedoBuffer_1<T> {
    pub fn Add(
        &mut self,
        item: T,
