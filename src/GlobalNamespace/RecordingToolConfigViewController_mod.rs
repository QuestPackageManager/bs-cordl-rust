...
for crate::GlobalNamespace::RecordingToolConfigViewController {
    ...
    const CLASS_NAME: &'static str = "RecordingToolConfigViewController";
...
impl crate::GlobalNamespace::RecordingToolConfigViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RecordingToolConfigViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RecordingToolConfigViewController as
