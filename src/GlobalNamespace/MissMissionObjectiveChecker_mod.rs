#[cfg(feature = "cordl_class_MissMissionObjectiveChecker")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MissMissionObjectiveChecker")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissMissionObjectiveChecker {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MissMissionObjectiveChecker";
...
#[cfg(feature = "cordl_class_MissMissionObjectiveChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissMissionObjectiveChecker {
