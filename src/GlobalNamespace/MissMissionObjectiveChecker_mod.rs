...
impl crate::GlobalNamespace::MissMissionObjectiveChecker {
    pub fn HandleNoteWasMissed(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MissMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MissMissionObjectiveChecker as
