...
#[cfg(feature = "cordl_class_LocalLeaderboardTableView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LocalLeaderboardTableView {
...
impl crate::GlobalNamespace::LocalLeaderboardTableView {
    ...
    pub fn SetScores(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("SetScores")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (scores, specialScorePos, maxNumberOfCells))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_LocalLeaderboardTableView")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LocalLeaderboardTableView {
