...
pub struct BTSCharacter {
    ...
    pub _btsCharacterMaterialSwitcher:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BTSCharacterMaterialSwitcher>,
...
impl crate::GlobalNamespace::BTSCharacter {
    ...
    pub fn SetAlternativeAnimationAndMaterial(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (animation, alternativeMaterialOn))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_materialPropertyBlockController")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
