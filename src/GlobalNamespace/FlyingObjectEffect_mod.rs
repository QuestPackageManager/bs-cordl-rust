...
pub struct FlyingObjectEffect {
    ...
    pub _moveAnimationCurve: quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimationCurve>,
    pub _shakeFrequency: f32,
    pub _shakeStrength: f32,
    pub _shakeStrengthAnimationCurve: quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimationCurve>,
...
impl crate::GlobalNamespace::FlyingObjectEffect {
    pub fn InitAndPresent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (duration, targetPos, rotation, shake))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ManualUpdate(
