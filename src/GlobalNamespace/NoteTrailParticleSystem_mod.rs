#[cfg(feature = "cordl_class_NoteTrailParticleSystem")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_NoteTrailParticleSystem")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteTrailParticleSystem {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "NoteTrailParticleSystem";
...
impl crate::GlobalNamespace::NoteTrailParticleSystem {
    ...
    pub fn Emit(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::UnityEngine::Vector3,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("Emit")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (startPos, endPos, count))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_NoteTrailParticleSystem")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NoteTrailParticleSystem {
