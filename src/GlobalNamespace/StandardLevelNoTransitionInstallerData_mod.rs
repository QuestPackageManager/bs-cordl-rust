...
pub struct StandardLevelNoTransitionInstallerData {
    ...
    pub _playerSpecificSettings:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlayerSpecificSettings>,
    pub _practiceSettings: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PracticeSettings>,
    pub _backButtonText: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _useTestNoteCutSoundEffects: bool,
    pub _selectedBeatmapLevel: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapLevelSO>,
    pub _selectedColorScheme: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSchemeSO>,
    pub _selectedEnvironmentInfo:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EnvironmentInfoSO>,
}
#[cfg(feature = "cordl_class_StandardLevelNoTransitionInstallerData")]
...
#[cfg(feature = "StandardLevelNoTransitionInstallerData")]
impl std::ops::DerefMut for crate::GlobalNamespace::StandardLevelNoTransitionInstallerData {
...
impl crate::GlobalNamespace::StandardLevelNoTransitionInstallerData {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PracticeSettings> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_useTestNoteCutSoundEffects(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_useTestNoteCutSoundEffects",
                            0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_beatmapCharacteristic", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
