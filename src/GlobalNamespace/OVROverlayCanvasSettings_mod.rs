...
pub struct OVROverlayCanvasSettings {
    ...
    pub _transparentImposterShader: quest_hook::libil2cpp::Gc<
...
for crate::GlobalNamespace::OVROverlayCanvasSettings {
...
impl crate::GlobalNamespace::OVROverlayCanvasSettings {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "EnsureShaderInitialized", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (shader, shaderName, replaceShaderName))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Shader> = unsafe {
            cordl_method_info.invoke_unchecked(self, (drawMode))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UsingBuiltInRenderPipeline", 0usize
                        )
                    })
            });
