...
impl std::ops::Deref for crate::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver {
...
#[cfg(feature = "ISaberSwingRatingCounterDidChangeReceiver")]
impl std::ops::DerefMut for crate::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver {
...
impl crate::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver {
    pub fn HandleSaberSwingRatingCounterDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (saberSwingRatingCounter, rating))? };
        Ok(__cordl_ret.into())
    }
