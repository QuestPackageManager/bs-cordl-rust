...
for crate::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver {
    ...
    const CLASS_NAME: &'static str = "ISaberSwingRatingCounterDidChangeReceiver";
...
impl crate::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver {
    pub fn HandleSaberSwingRatingCounterDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleSaberSwingRatingCounterDidChange", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (saberSwingRatingCounter, rating))?
        };
        Ok(__cordl_ret.into())
    }
