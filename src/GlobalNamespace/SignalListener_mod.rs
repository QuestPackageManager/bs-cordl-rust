...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SignalListener {
    ...
    const CLASS_NAME: &'static str = "SignalListener";
...
#[cfg(feature = "SignalListener")]
impl crate::GlobalNamespace::SignalListener {
    pub fn HandleEvent(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SignalListener as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleEvent")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SignalListener as
                    quest_hook::libil2cpp::Type > ::class(), "HandleEvent", 0usize
                )
            });
