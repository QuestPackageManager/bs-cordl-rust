...
#[cfg(feature = "BeatmapLineData")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IReadonlyBeatmapLineData>>
for crate::GlobalNamespace::BeatmapLineData {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IReadonlyBeatmapLineData> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "BeatmapLineData")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IReadonlyBeatmapLineData>>
for crate::GlobalNamespace::BeatmapLineData {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<
        crate::GlobalNamespace::IReadonlyBeatmapLineData,
    > {
        unsafe { std::mem::transmute(self) }
    }
}
