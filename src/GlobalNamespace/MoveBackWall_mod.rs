...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MoveBackWall {
    ...
    const CLASS_NAME: &'static str = "MoveBackWall";
...
impl crate::GlobalNamespace::MoveBackWall {
    ...
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MoveBackWall as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MoveBackWall as quest_hook::libil2cpp::Type
                    > ::class(), "Start", 0usize
                )
            });
