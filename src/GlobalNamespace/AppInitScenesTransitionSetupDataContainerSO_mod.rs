...
pub struct AppInitScenesTransitionSetupDataContainerSO {
    ...
    pub appInitScenesTransitionSetupData: quest_hook::libil2cpp::Gc<
...
for crate::GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO {
    ...
    const CLASS_NAME: &'static str = "AppInitScenesTransitionSetupDataContainerSO";
...
impl crate::GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO as quest_hook::libil2cpp::Type>::class()
