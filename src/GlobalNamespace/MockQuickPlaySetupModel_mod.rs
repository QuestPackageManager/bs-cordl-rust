...
impl crate::GlobalNamespace::MockQuickPlaySetupModel {
    pub fn GetQuickPlaySetupAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockQuickPlaySetupModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MockQuickPlaySetupModel as
