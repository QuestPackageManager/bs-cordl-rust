#[cfg(feature = "cordl_class_MockQuickPlaySetupModel")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_MockQuickPlaySetupModel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockQuickPlaySetupModel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MockQuickPlaySetupModel";
...
#[cfg(feature = "cordl_class_MockQuickPlaySetupModel")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MockQuickPlaySetupModel {
