...
pub struct BaseMultiplayerStartGameCountdownViewController {
    ...
    pub _beatmapSelectionView:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapSelectionView>,
    pub _modifiersSelectionView:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ModifiersSelectionView>,
    pub _spectateToggle: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle>,
    pub playerActiveStateChangedEvent: quest_hook::libil2cpp::Gc<crate::System::Action_1<bool>>,
    ...
    for crate::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController
{
    ...
    const CLASS_NAME: &'static str = "BaseMultiplayerStartGameCountdownViewController";
...
impl std::ops::Deref for crate::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetLevelGameplaySetupData", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
