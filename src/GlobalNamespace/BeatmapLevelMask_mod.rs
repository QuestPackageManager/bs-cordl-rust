...
impl crate::GlobalNamespace::BeatmapLevelMask {
    ...
    pub fn Contains(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (state))? };
        Ok(__cordl_ret.into())
    }
    pub fn Deserialize(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::BeatmapLevelMask,
                        >),
                        bool,
                        1usize,
                    >("Equals")
    ...
    pub fn _ctor_HashSet_1_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (levelSet))? };
        Ok(__cordl_ret.into())
    }
