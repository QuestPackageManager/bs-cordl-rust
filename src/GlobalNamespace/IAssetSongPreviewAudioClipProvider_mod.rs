...
for crate::GlobalNamespace::IAssetSongPreviewAudioClipProvider {
    ...
    const CLASS_NAME: &'static str = "IAssetSongPreviewAudioClipProvider";
...
impl crate::GlobalNamespace::IAssetSongPreviewAudioClipProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IAssetSongPreviewAudioClipProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioClip>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IAssetSongPreviewAudioClipProvider as
