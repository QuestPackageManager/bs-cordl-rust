...
#[cfg(feature = "cordl_class_TextMeshProInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TextMeshProInstaller {
...
impl crate::GlobalNamespace::TextMeshProInstaller {
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (fontAssets, registry))? };
        Ok(__cordl_ret.into())
    }
