...
impl crate::GlobalNamespace::MultiplayerBadgeDataSaberMovementSO {
    pub fn GetValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerBadgeDataSaberMovementSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerBadgeDataSaberMovementSO as
