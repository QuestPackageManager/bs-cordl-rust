#[cfg(
    feature = "cordl_class_ScreenshotLevelStarter+RunScreenshotLevelData+BuildSpecificMetadata"
)]
#[repr(C)]
...
for crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_BuildSpecificMetadata {
    ...
    const CLASS_NAME: &'static str = "ScreenshotLevelStarter/RunScreenshotLevelData/BuildSpecificMetadata";
...
pub struct RunScreenshotLevelData_ScreenshotLevelStarter_Command {
    pub beatmapKey: crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_SerializedBeatmapKey,
    pub screenshotTimes: quest_hook::libil2cpp::Gc<
...
#[cfg(
    feature = "cordl_class_ScreenshotLevelStarter+RunScreenshotLevelData+DeviceMetadata"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
#[cfg(
    feature = "cordl_class_ScreenshotLevelStarter+RunScreenshotLevelData+FolderMetadata"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
#[cfg(
    feature = "cordl_class_ScreenshotLevelStarter+RunScreenshotLevelData+SerializedBeatmapKey"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
for crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_SerializedBeatmapKey {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ScreenshotLevelStarter/RunScreenshotLevelData/SerializedBeatmapKey";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
impl crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_SerializedBeatmapKey {
    pub fn ToBeatmapKey(
        ...
        let __cordl_ret: crate::GlobalNamespace::BeatmapKey = unsafe {
            cordl_method_info.invoke_unchecked(self, (beatmapLevels))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (levelId, characteristic, difficulty))?
        };
        Ok(__cordl_ret.into())
    }
}
...
pub struct ScreenshotLevelStarter {
    ...
    >,
    pub _renderingParamsApplicator: quest_hook::libil2cpp::Gc<
    ...
    pub _commandQueue: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _screenshotQueueCoroutine: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Coroutine,
    >,
    pub _cachedGameVersion: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppString,
    >,
}
#[cfg(feature = "cordl_class_ScreenshotLevelStarter")]
unsafe impl quest_hook::libil2cpp::Type
for crate::GlobalNamespace::ScreenshotLevelStarter {
...
impl crate::GlobalNamespace::ScreenshotLevelStarter {
    ...
    pub const kCancelledGettingLevelDataVersion: &'static str = "ScreenshotLevelStarter: Getting level data version was cancelled.";
    pub const kFmtErrorGettingLevelDataVerison: &'static str = "ScreenshotLevelStarter: Failed getting level data version: {0}";
    pub const kFmtMessageDownloadFolder: &'static str = "ScreenshotLevelStarter: Screenshots for level found under: {0}";
    pub const kFmtMessageErrorCharacteristicNotFound: &'static str = "ScreenshotLevelStarter: Level {0} does not have characteristic {1}";
    pub const kFmtMessageErrorDifficultyNotFound: &'static str = "ScreenshotLevelStarter: Level {0} with characteristic {1} does not have difficulty {2}";
    pub const kFmtMessageErrorMapNotFound: &'static str = "ScreenshotLevelStarter: Could not find beatmap level {0}";
    pub const kFmtMessageErrorParsingDifficulty: &'static str = "ScreenshotLevelStarter: Unknown difficulty {0}, falling back to ExpertPlus";
    pub const kFmtMessageErrorSavingMetadata: &'static str = "ScreenshotLevelStarter: Error while saving metadata to file {0}: {1}";
    pub const kFmtMessageErrorSavingScreenshot: &'static str = "ScreenshotLevelStarter: Error while saving screenshot to path {0}: {1}";
    pub const kFmtMessageSavingMetadata: &'static str = "ScreenshotLevelStarter: Writing metadata to path {0}";
    pub const kFmtMessageScreenshotTaken: &'static str = "ScreenshotLevelStarter: Writing screenshot to path {0}";
    pub const kFmtMessageScreenshottingFinished: &'static str = "ScreenshotLevelStarter: Finished screenshots for level {0}";
    pub const kFmtMessageScreenshottingStarted: &'static str = "ScreenshotLevelStarter: Starting screenshot test for level {0}, will be stored in {1}";
    pub const kFmtMessageSongStarted: &'static str = "ScreenshotLevelStarter: Starting screenshotting of {0}";
    pub const kFmtMessageSongsRemaining: &'static str = "ScreenshotLevelStarter: -- There are {0} songs in queue...";
    pub const kFmtMessaggeWontPlayError: &'static str = "ScreenshotLevelStarter: Failed launching screenshotting for {0} without retrying!";
    ...
    pub const kMessagePlayerSensitivity: &'static str = "ScreenshotLevelStarter: Player not allowed to play explicit songs";
    pub const kMessageQueueFinished: &'static str = "ScreenshotLevelStarter: ---Finished the screenshot level queue---";
    pub const kMessageQueueStarted: &'static str = "ScreenshotLevelStarter: ---Starting the screenshot level queue---";
    ...
    pub type RunScreenshotLevelData = crate::GlobalNamespace::ScreenshotLevelStarter_RunScreenshotLevelData;
    ...
    pub fn SaveBuildSpecificMetadata(
        metadataFolderPath: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        >,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SaveBuildSpecificMetadata", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (metadataFolderPath, gameVersion))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SaveDeviceMetadata(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (metadataFolderPath))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SaveMetadata(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SaveMetadataObject", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (obj, path))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TakeScreenshotFromCamera", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (camera, screenshotTexture))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
pub struct ScreenshotLevelStarter_RunScreenshotLevelData {
    pub globalScreenshotSettings: crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Settings,
...
impl crate::GlobalNamespace::ScreenshotLevelStarter_RunScreenshotLevelData {
    #[cfg(
        feature = "ScreenshotLevelStarter+RunScreenshotLevelData+BuildSpecificMetadata"
    )]
    pub type BuildSpecificMetadata = crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_BuildSpecificMetadata;
    #[cfg(feature = "ScreenshotLevelStarter+RunScreenshotLevelData+Command")]
    pub type Command = crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command;
    #[cfg(feature = "ScreenshotLevelStarter+RunScreenshotLevelData+DeviceMetadata")]
    pub type DeviceMetadata = crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_DeviceMetadata;
    #[cfg(feature = "ScreenshotLevelStarter+RunScreenshotLevelData+FolderMetadata")]
    pub type FolderMetadata = crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_FolderMetadata;
    #[cfg(
        feature = "ScreenshotLevelStarter+RunScreenshotLevelData+SerializedBeatmapKey"
    )]
    pub type SerializedBeatmapKey = crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_SerializedBeatmapKey;
    #[cfg(feature = "ScreenshotLevelStarter+RunScreenshotLevelData+Settings")]
    pub type Settings = crate::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Settings;
}
