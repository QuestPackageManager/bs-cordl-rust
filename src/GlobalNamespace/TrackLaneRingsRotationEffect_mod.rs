...
pub struct TrackLaneRingsRotationEffect {
    ...
    pub _trackLaneRingsManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TrackLaneRingsManager>,
    ...
    pub _ringRotationEffectsPool: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub ringRotationEffectsToDelete:
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<i32>>,
}
#[cfg(feature = "cordl_class_TrackLaneRingsRotationEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TrackLaneRingsRotationEffect {
...
impl crate::GlobalNamespace::TrackLaneRingsRotationEffect {
    ...
    pub fn AddRingRotationEffect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (angle, step, propagationSpeed, flexySpeed))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetFirstRingDestinationRotationAngle(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn RecycleRingRotationEffect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ringRotationEffect))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::TrackLaneRingsRotationEffect_RingRotationEffect,
                    >, 0usize>("SpawnRingRotationEffect")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_TrackLaneRingsRotationEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TrackLaneRingsRotationEffect {
...
#[cfg(feature = "TrackLaneRingsRotationEffect+RingRotationEffect")]
impl std::ops::Deref for crate::GlobalNamespace::TrackLaneRingsRotationEffect_RingRotationEffect {
