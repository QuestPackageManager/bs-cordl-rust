...
pub struct ImmediateRankUIPanel {
    ...
    pub _relativeScoreText: quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshProUGUI>,
    pub _relativeScoreAndImmediateRankCounter: quest_hook::libil2cpp::Gc<
        crate::GlobalNamespace::RelativeScoreAndImmediateRankCounter,
    >,
...
for crate::GlobalNamespace::ImmediateRankUIPanel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ImmediateRankUIPanel";
...
impl crate::GlobalNamespace::ImmediateRankUIPanel {
    pub fn HandleRelativeScoreAndImmediateRankCounterRelativeScoreOrImmediateRankDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ImmediateRankUIPanel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ImmediateRankUIPanel as
