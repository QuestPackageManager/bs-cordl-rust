...
pub struct PerformanceRecorder {
    ...
    pub _SettingsManager_k__BackingField:
    ...
    pub _RecPlayState_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RecPlayBehaviour_State>,
    pub _GamePause_k__BackingField: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IGamePause>,
    pub _SceneSetupData_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayCoreSceneSetupData>,
    pub _ObjectManager_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapObjectManager>,
    pub _CallbackController_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapCallbacksController>,
    pub _TimeSync_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioTimeSyncController>,
    pub _frameTimes: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<f32>>,
    pub _songTimes: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<f32>>,
    pub _configChecks:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PerformanceConfigurationChecks>,
    pub _configStats:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PerformanceConfigurationStats>,
    pub _beatmapItems: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapDataItem>,
        >,
    >,
    pub _beatmapObjectRecorder:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapObjectRecorder>,
    pub _beatmapEventRecorder:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapEventRecorder>,
    pub _beatmapEventTweenRecorder:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapEventTweenRecorder>,
    pub _profilerMetrics: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ProfilerMetrics>,
    pub _oculusMetrics: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OculusMetrics>,
    pub _ovrToolMetrics: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OvrToolMetrics>,
}
#[cfg(feature = "cordl_class_PerformanceRecorder")]
...
impl crate::GlobalNamespace::PerformanceRecorder {
    ...
    pub fn ClearRecordingData(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearRecordingData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn CollectFrameData(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CollectFrameData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn WriteFileReport(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 2usize>("WriteFileReport")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (path, contents))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_GamePause(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IGamePause>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IGamePause> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_GameplayModifiers(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::GameplayModifierMask, 0usize>(
        ...
        let __cordl_ret: crate::GlobalNamespace::GameplayModifierMask =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapObjectManager> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RecPlayBehaviour_State> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_CallbackController(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapCallbacksController>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn set_SceneSetupData(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayCoreSceneSetupData>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn set_StartEnabled(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_StartEnabled")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
