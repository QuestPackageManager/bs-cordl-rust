...
impl crate::GlobalNamespace::CannotStartGameReasonMethods {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CannotStartGameReasonMethods as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CannotStartGameReasonMethods as
                    quest_hook::libil2cpp::Type > ::class(), "LocalizedKey", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (cannotStartGameReason))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "CannotStartGameReasonMethods")]
