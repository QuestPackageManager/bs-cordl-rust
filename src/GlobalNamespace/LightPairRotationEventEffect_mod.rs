#[cfg(feature = "cordl_class_LightPairRotationEventEffect")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_LightPairRotationEventEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightPairRotationEventEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LightPairRotationEventEffect";
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        f32,
                        f32,
                    ), quest_hook::libil2cpp::Void, 4usize>("UpdateRotationData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_LightPairRotationEventEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LightPairRotationEventEffect {
...
#[cfg(feature = "cordl_class_LightPairRotationEventEffect+RotationData")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::LightPairRotationEventEffect_RotationData
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LightPairRotationEventEffect/RotationData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "LightPairRotationEventEffect+RotationData")]
impl std::ops::Deref for crate::GlobalNamespace::LightPairRotationEventEffect_RotationData {
...
#[cfg(feature = "LightPairRotationEventEffect+RotationData")]
impl std::ops::DerefMut for crate::GlobalNamespace::LightPairRotationEventEffect_RotationData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
