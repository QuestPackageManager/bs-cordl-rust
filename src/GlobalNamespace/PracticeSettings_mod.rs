...
#[cfg(feature = "PracticeSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PracticeSettings {
...
impl crate::GlobalNamespace::PracticeSettings {
    ...
    pub fn ResetToDefault(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ResetToDefault")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PracticeSettings as
                    quest_hook::libil2cpp::Type > ::class(), "ResetToDefault", 0usize
                )
            });
    ...
    pub fn _ctor_PracticeSettings1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (practiceSettings))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_f32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (startSongTime, songSpeedMul))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "get_defaultPracticeSettings", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PracticeSettings as
                    quest_hook::libil2cpp::Type > ::class(), "get_songSpeedMul", 0usize
                )
            });
    ...
    pub fn get_startInAdvanceAndClearNotes(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_startInAdvanceAndClearNotes")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PracticeSettings as
                    quest_hook::libil2cpp::Type > ::class(),
                    "get_startInAdvanceAndClearNotes", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PracticeSettings as
                    quest_hook::libil2cpp::Type > ::class(), "set_songSpeedMul", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PracticeSettings as
                    quest_hook::libil2cpp::Type > ::class(),
                    "set_startInAdvanceAndClearNotes", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PracticeSettings as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PracticeSettings as
                    quest_hook::libil2cpp::Type > ::class(), "set_startSongTime", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
