...
impl crate::GlobalNamespace::PracticeSettings {
    ...
    pub fn _ctor_PracticeSettings1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (practiceSettings))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_f32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (startSongTime, songSpeedMul))?
        };
        Ok(__cordl_ret.into())
    }
