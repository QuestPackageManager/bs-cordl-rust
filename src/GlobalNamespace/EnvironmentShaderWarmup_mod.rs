...
for crate::GlobalNamespace::EnvironmentShaderWarmup {
    ...
    const CLASS_NAME: &'static str = "EnvironmentShaderWarmup";
...
impl crate::GlobalNamespace::EnvironmentShaderWarmup {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnvironmentShaderWarmup as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EnvironmentShaderWarmup as
