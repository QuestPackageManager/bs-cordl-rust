...
for crate::GlobalNamespace::FullComboMissionObjectiveChecker {
    ...
    const CLASS_NAME: &'static str = "FullComboMissionObjectiveChecker";
...
impl crate::GlobalNamespace::FullComboMissionObjectiveChecker {
    pub fn HandleComboBreakingEventHappened(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FullComboMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Void,
                0usize,
            >("HandleComboBreakingEventHappened")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::FullComboMissionObjectiveChecker as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleComboBreakingEventHappened", 0usize
                )
            });
