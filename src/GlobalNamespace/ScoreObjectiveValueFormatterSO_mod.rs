...
for crate::GlobalNamespace::ScoreObjectiveValueFormatterSO {
    ...
    const CLASS_NAME: &'static str = "ScoreObjectiveValueFormatterSO";
...
impl crate::GlobalNamespace::ScoreObjectiveValueFormatterSO {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ScoreObjectiveValueFormatterSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ScoreObjectiveValueFormatterSO as
                    quest_hook::libil2cpp::Type > ::class(), "FormatValue", 1usize
                )
            });
