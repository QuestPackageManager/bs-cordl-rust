...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightGroupSubsystem {
    ...
    const CLASS_NAME: &'static str = "LightGroupSubsystem";
...
#[cfg(feature = "LightGroupSubsystem")]
impl crate::GlobalNamespace::LightGroupSubsystem {
    ...
    pub fn OnEnable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightGroupSubsystem as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnEnable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LightGroupSubsystem as
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LightGroup> = unsafe {
            method.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
