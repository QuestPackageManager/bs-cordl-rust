...
for crate::GlobalNamespace::MainSettingsAsyncLoader {
    ...
    const CLASS_NAME: &'static str = "MainSettingsAsyncLoader";
...
impl crate::GlobalNamespace::MainSettingsAsyncLoader {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MainSettingsAsyncLoader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MainSettingsAsyncLoader as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MainSettingsAsyncLoader as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "InstallBindingsThatRelyOnSettings", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (registry, container))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe { method.invoke_unchecked(self, (registry, container))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_isRunningFromTests(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MainSettingsAsyncLoader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_isRunningFromTests")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MainSettingsAsyncLoader as
                    quest_hook::libil2cpp::Type > ::class(), "get_isRunningFromTests",
                    0usize
                )
            });
