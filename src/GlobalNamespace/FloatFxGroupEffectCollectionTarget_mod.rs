...
impl crate::GlobalNamespace::FloatFxGroupEffectCollectionTarget {
    ...
    pub fn SetValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FloatFxGroupEffectCollectionTarget as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32, i32, f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FloatFxGroupEffectCollectionTarget as
