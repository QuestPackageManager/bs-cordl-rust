...
pub struct LevelCollectionViewController {
    ...
    pub _levelCollectionTableView:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LevelCollectionTableView>,
    pub _noDataInfoContainer: quest_hook::libil2cpp::Gc<crate::UnityEngine::RectTransform>,
    ...
    pub _beatmapLevelToBeSelected: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapLevel>,
    pub _crossfadeCancellationTokenSource:
        quest_hook::libil2cpp::Gc<crate::System::Threading::CancellationTokenSource>,
}
#[cfg(feature = "cordl_class_LevelCollectionViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LevelCollectionViewController {
...
impl crate::GlobalNamespace::LevelCollectionViewController {
    ...
    pub fn HandleLevelCollectionTableViewDidSelectLevel(
        &mut self,
        tableView: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LevelCollectionTableView>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tableView, level))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleLevelCollectionTableViewDidSelectPack", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tableView))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 6usize>("SetData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SongPlayerCrossfadeToLevel", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> =
            unsafe { cordl_method_info.invoke_unchecked(self, (level, cancellationToken))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_LevelCollectionViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LevelCollectionViewController {
