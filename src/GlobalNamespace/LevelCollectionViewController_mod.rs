...
impl crate::GlobalNamespace::LevelCollectionViewController {
    ...
    pub fn HandleLevelCollectionTableViewDidSelectLevel(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tableView, level))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleLevelCollectionTableViewDidSelectPack(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tableView))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LateUpdate(
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (level, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
