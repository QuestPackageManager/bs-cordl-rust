#[cfg(feature = "cordl_class_BasicConnectionRequestHandler")]
#[repr(C)]
#[derive(Debug)]
pub struct BasicConnectionRequestHandler {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _secret_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_BasicConnectionRequestHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BasicConnectionRequestHandler {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    ), bool, 5usize>("ValidateConnectionMessage")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_BasicConnectionRequestHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BasicConnectionRequestHandler {
