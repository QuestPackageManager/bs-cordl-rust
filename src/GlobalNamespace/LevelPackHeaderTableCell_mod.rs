...
#[cfg(feature = "cordl_class_LevelPackHeaderTableCell")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LevelPackHeaderTableCell {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LevelPackHeaderTableCell";
...
impl crate::GlobalNamespace::LevelPackHeaderTableCell {
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (headerText))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_LevelPackHeaderTableCell")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LevelPackHeaderTableCell {
