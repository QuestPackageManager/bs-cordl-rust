...
pub struct RecPlayBehaviour {
    ...
    pub _playerControllers:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PlayerVRControllersManager>,
    pub _vrCenterAdjust: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::VRCenterAdjust>,
    pub _hmdCamera: quest_hook::libil2cpp::Gc<crate::UnityEngine::Camera>,
    pub _state: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RecPlayBehaviour_State>,
    pub _capturer: quest_hook::libil2cpp::Gc<crate::BeatSaber::RecPlay::PlayerPoseCapturer>,
    pub _sampler: quest_hook::libil2cpp::Gc<crate::BeatSaber::RecPlay::PlayerPoseSampler>,
    pub _headNoise: crate::BeatSaber::RecPlay::PoseNoise,
    pub _recodingFilePath: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _recording: bool,
    pub _playback: bool,
}
#[cfg(feature = "cordl_class_RecPlayBehaviour")]
...
impl crate::GlobalNamespace::RecPlayBehaviour {
    ...
    pub fn Configure(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Configure")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn CreateAutoLevelRecording(
        sceneSetup: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayCoreSceneSetupData>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::BeatmapObjectSpawnController,
                        >,
                    ), crate::BeatSaber::RecPlay::PlayerPoseFrames, 2usize>(
                        "CreateAutoLevelRecording",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
        ...
        let __cordl_ret: crate::BeatSaber::RecPlay::PlayerPoseFrames = unsafe {
            cordl_method_info.invoke_unchecked((), (sceneSetup, beatmapSpawnerController))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sceneSetup, beatmapSpawnerController))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "LoadLevelRecording", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::BeatSaber::RecPlay::PlayerPoseFrames =
    ...
    pub fn Record(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Record")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SavePlayerPoseFrames(
        path: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        frames: quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::RecPlay::PlayerPoseFrames>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (path, frames))? };
        Ok(__cordl_ret.into())
    }
    pub fn SaveRecording(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SaveRecording")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        1usize,
                    >("<Play>g__ExtractLocalPose|14_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<Play>g__ExtractLocalPose|14_0", 1usize
                        )
                    })
            });
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        crate::UnityEngine::Pose,
                        1usize,
                    >("<Record>g__ExtractGlobalPose|15_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<Record>g__ExtractGlobalPose|15_0", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Pose =
...
#[cfg(feature = "cordl_class_RecPlayBehaviour+State")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RecPlayBehaviour_State {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_RecPlayBehaviour+State")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RecPlayBehaviour_State {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
