...
impl crate::GlobalNamespace::RecPlayBehaviour {
    ...
    pub fn CreateAutoLevelRecording(
        ...
        let __cordl_ret: crate::BeatSaber::RecPlay::PlayerPoseFrames = unsafe {
            cordl_method_info
                .invoke_unchecked((), (sceneSetup, beatmapSpawnerController))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (sceneSetup, beatmapSpawnerController))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LateUpdate(
    ...
    pub fn SavePlayerPoseFrames(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (path, frames))?
        };
        Ok(__cordl_ret.into())
    }
