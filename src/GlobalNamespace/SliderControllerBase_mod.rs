#[cfg(feature = "cordl_class_SliderControllerBase")]
#[repr(C)]
#[derive(Debug)]
pub struct SliderControllerBase {
    ...
    pub _cutoutAnimateEffect:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::CutoutAnimateEffect>,
    pub _dissolving: bool,
}
#[cfg(feature = "cordl_class_SliderControllerBase")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SliderControllerBase {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SliderControllerBase";
