...
pub struct ColorArrayLightWithIds {
    ...
    pub _colorArrayLightWithIds: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _materialController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MaterialController>,
    pub _materialPropertyBlockControllers: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _colorsArrayPropertyName: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _colorsArrayOffsetPropertyName:
...
#[cfg(feature = "cordl_class_ColorArrayLightWithIds")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ColorArrayLightWithIds {
...
impl crate::GlobalNamespace::ColorArrayLightWithIds {
    ...
    pub type ColorArrayLightWithId =
        crate::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleColorLightWithIdDidSetColor", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, color))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProcessNewColorData(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ProcessNewColorData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_ColorArrayLightWithIds")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ColorArrayLightWithIds {
...
pub struct ColorArrayLightWithIds_ColorArrayLightWithId {
    ...
    pub _index: i32,
    pub didSetColorEvent:
        quest_hook::libil2cpp::Gc<crate::System::Action_2<i32, crate::UnityEngine::Color>>,
}
#[cfg(feature = "cordl_class_ColorArrayLightWithIds+ColorArrayLightWithId")]
...
#[cfg(feature = "ColorArrayLightWithIds+ColorArrayLightWithId")]
impl std::ops::Deref for crate::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId {
...
#[cfg(feature = "ColorArrayLightWithIds+ColorArrayLightWithId")]
impl std::ops::DerefMut for crate::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId {
    pub fn ColorWasSet(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newColor))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        index: i32,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, lightId))? };
        Ok(__cordl_ret.into())
    }
    pub fn add_didSetColorEvent(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::System::Action_2<i32, crate::UnityEngine::Color>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
