...
impl crate::GlobalNamespace::ColorArrayLightWithIds {
    ...
    pub fn HandleColorLightWithIdDidSetColor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, color))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::ColorArrayLightWithIds_ColorArrayLightWithId {
    pub fn ColorWasSet(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (newColor))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, lightId))?
        };
        Ok(__cordl_ret.into())
    }
