...
impl crate::GlobalNamespace::NoteJumpStartBeatOffsetDropdown {
    pub fn GetNamedValues(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoteJumpStartBeatOffsetDropdown as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::IReadOnlyList_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoteJumpStartBeatOffsetDropdown as
