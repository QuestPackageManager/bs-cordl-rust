...
for crate::GlobalNamespace::PresentHiddenSettingsAfterNClicks {
    ...
    const CLASS_NAME: &'static str = "PresentHiddenSettingsAfterNClicks";
...
impl crate::GlobalNamespace::PresentHiddenSettingsAfterNClicks {
    ...
    pub fn OnDisable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PresentHiddenSettingsAfterNClicks as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDisable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PresentHiddenSettingsAfterNClicks as
    ...
    pub fn _OnEnable_b__6_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PresentHiddenSettingsAfterNClicks as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<OnEnable>b__6_0")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PresentHiddenSettingsAfterNClicks as
                    quest_hook::libil2cpp::Type > ::class(), "<OnEnable>b__6_0", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
