...
for crate::GlobalNamespace::INoteControllerNoteWasMissedEvent {
    ...
    const CLASS_NAME: &'static str = "INoteControllerNoteWasMissedEvent";
...
impl crate::GlobalNamespace::INoteControllerNoteWasMissedEvent {
    pub fn HandleNoteControllerNoteWasMissed(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INoteControllerNoteWasMissedEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INoteControllerNoteWasMissedEvent as
