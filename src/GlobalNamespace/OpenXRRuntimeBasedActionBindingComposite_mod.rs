...
impl crate::GlobalNamespace::OpenXRRuntimeBasedActionBindingComposite {
    pub fn EvaluateMagnitude(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OpenXRRuntimeBasedActionBindingComposite as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OpenXRRuntimeBasedActionBindingComposite as
