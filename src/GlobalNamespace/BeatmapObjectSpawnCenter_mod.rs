...
pub struct BeatmapObjectSpawnCenter {
    ...
    pub spawnCenterDistanceWasFoundEvent: quest_hook::libil2cpp::Gc<crate::System::Action_1<f32>>,
    pub _spawnCenterDistanceWasFound: bool,
    pub _spawnCenterDistance: f32,
}
#[cfg(feature = "cordl_class_BeatmapObjectSpawnCenter")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapObjectSpawnCenter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BeatmapObjectSpawnCenter";
...
impl crate::GlobalNamespace::BeatmapObjectSpawnCenter {
    ...
    pub type PlayerCountToDistance =
        crate::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance;
    pub fn CalculateSpawnCenterPosition(
        ...
        let __cordl_ret: f32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (numberOfPlayers))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_spawnCenterDistanceWasFound(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_BeatmapObjectSpawnCenter")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapObjectSpawnCenter {
    ...
    for crate::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BeatmapObjectSpawnCenter/PlayerCountToDistance";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "BeatmapObjectSpawnCenter+PlayerCountToDistance")]
impl std::ops::Deref for crate::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance {
...
#[cfg(feature = "BeatmapObjectSpawnCenter+PlayerCountToDistance")]
impl std::ops::DerefMut for crate::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
