...
unsafe impl<
    ...
    for crate::GlobalNamespace::MultiplayerSyncStateManager_5<
        TStateTable,
        TType,
        TState,
        TSerializable,
    ...
    >
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerSyncStateManager`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "MultiplayerSyncStateManager`5")
                .unwrap()
                .make_generic::<(
                    TStateTable,
                    TType,
...
#[cfg(feature = "MultiplayerSyncStateManager_5")]
impl<
        TStateTable: quest_hook::libil2cpp::Type,
        TType: quest_hook::libil2cpp::Type,
        TState: quest_hook::libil2cpp::Type,
...
impl<
        ...
        TDeltaSerializable: quest_hook::libil2cpp::Type,
    >
    crate::GlobalNamespace::MultiplayerSyncStateManager_5<
        TStateTable,
        TType,
        TState,
        TSerializable,
    ...
    >
{
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearBufferedStates")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn GetDisconnectedSyncState(
        &mut self,
        i: i32,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>,
                    >, 1usize>("GetDisconnectedSyncState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn HandleSyncDeltaPacket(
        &mut self,
        packet: TDeltaSerializable,
        player: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IConnectedPlayer>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TStateTable: quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (packet, player))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleSyncPacket(
        &mut self,
        packet: TSerializable,
        player: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IConnectedPlayer>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TStateTable: quest_hook::libil2cpp::Type
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        TSerializable,
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IConnectedPlayer>,
                    ), quest_hook::libil2cpp::Void, 2usize>("HandleSyncPacket")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TState, i64, TState, i64, i64), TState, 5usize>("Interpolate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: TState =
            unsafe { cordl_method_info.invoke_unchecked(self, (a, timeA, b, timeB, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TState =
            unsafe { cordl_method_info.invoke_unchecked(self, (a, b, smoooth))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("TryCreateLocalState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_deltaSerializablePool(
        ...
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IPacketPool_1<TDeltaSerializable>>,
    >
    where
        TStateTable: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
    ...
    pub fn get_disconnectedPlayerCount(&mut self) -> quest_hook::libil2cpp::Result<i32>
    where
        TStateTable: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_multiplayerSessionManager")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_serializablePool(
        ...
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IPacketPool_1<TSerializable>>,
    >
    where
        TStateTable: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
