...
#[cfg(feature = "cordl_class_BloomPrePassEffectContainerSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomPrePassEffectContainerSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BloomPrePassEffectContainerSO";
...
impl crate::GlobalNamespace::BloomPrePassEffectContainerSO {
    pub fn Init(
        &mut self,
        bloomPrePassEffect: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BloomPrePassEffectSO>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bloomPrePassEffect))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_bloomPrePassEffect", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BloomPrePassEffectSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BloomPrePassEffectContainerSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BloomPrePassEffectContainerSO {
