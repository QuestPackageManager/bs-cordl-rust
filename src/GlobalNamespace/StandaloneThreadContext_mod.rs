...
#[cfg(feature = "cordl_class_StandaloneThreadContext")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::StandaloneThreadContext {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StandaloneThreadContext";
...
impl crate::GlobalNamespace::StandaloneThreadContext {
    ...
    pub fn Run(
        &mut self,
        runnable: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IStandaloneThreadRunnable>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (runnable))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_StandaloneThreadContext")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::StandaloneThreadContext {
