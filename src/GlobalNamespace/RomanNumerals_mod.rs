...
#[cfg(feature = "RomanNumerals")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RomanNumerals {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RomanNumerals";
...
impl crate::GlobalNamespace::RomanNumerals {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RomanNumerals as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (i32),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::RomanNumerals as quest_hook::libil2cpp::Type
                    > ::class(), "ToRomanNumeralString", 1usize
                )
            });
