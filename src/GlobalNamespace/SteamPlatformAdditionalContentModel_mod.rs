...
pub struct SteamPlatformAdditionalContentModel {
    ...
    >,
    pub _entitlementsAppIds: quest_hook::libil2cpp::Gc<u32>,
    pub _dataIsValidTaskCompletionSource: quest_hook::libil2cpp::Gc<bool>,
...
impl crate::GlobalNamespace::SteamPlatformAdditionalContentModel {
    ...
    pub fn GetRedirectedLevelPackProductData(
        ...
        quest_hook::libil2cpp::Gc<crate::System::Nullable_1<u32>>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Nullable_1<u32>> = unsafe {
            cordl_method_info.invoke_unchecked(self, (packId, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OpenBundleUrl(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bundleId))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OpenProductStore(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (appId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn OpenStore(
