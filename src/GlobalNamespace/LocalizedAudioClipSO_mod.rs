...
#[cfg(feature = "cordl_class_LocalizedAudioClipSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LocalizedAudioClipSO {
...
impl crate::GlobalNamespace::LocalizedAudioClipSO {
    ...
    pub type LocalizedAudioClipInfo =
        crate::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo;
...
#[cfg(feature = "LocalizedAudioClipSO+LocalizedAudioClipInfo")]
impl std::ops::Deref for crate::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo {
...
#[cfg(feature = "LocalizedAudioClipSO+LocalizedAudioClipInfo")]
impl std::ops::DerefMut for crate::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
