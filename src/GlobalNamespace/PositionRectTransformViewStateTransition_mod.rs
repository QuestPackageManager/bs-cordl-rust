...
impl std::ops::Deref for crate::GlobalNamespace::PositionRectTransformViewStateTransition {
...
#[cfg(feature = "PositionRectTransformViewStateTransition")]
impl std::ops::DerefMut for crate::GlobalNamespace::PositionRectTransformViewStateTransition {
...
impl crate::GlobalNamespace::PositionRectTransformViewStateTransition {
    ...
    pub fn StartTween(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (endPosition, transitionTiming))? };
        Ok(__cordl_ret.into())
    }
