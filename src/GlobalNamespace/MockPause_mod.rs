...
#[cfg(feature = "MockPause")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockPause {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MockPause";
...
#[cfg(feature = "MockPause")]
impl std::ops::DerefMut for crate::GlobalNamespace::MockPause {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "MockPause")]
impl crate::GlobalNamespace::MockPause {
    ...
    pub fn Pause(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockPause as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Pause")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MockPause as quest_hook::libil2cpp::Type >
                    ::class(), "Pause", 0usize
                )
            });
...
#[cfg(feature = "MockPause")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MockPause {
