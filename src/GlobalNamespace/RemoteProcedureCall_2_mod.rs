...
pub struct RemoteProcedureCall_2<T0: quest_hook::libil2cpp::Type, T1: quest_hook::libil2cpp::Type> {
    ...
    crate::GlobalNamespace::RemoteProcedureCall_2<T0, T1>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IRemoteProcedureCall> =
            unsafe { cordl_method_info.invoke_unchecked(self, (syncTime, value0, value1))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_RemoteProcedureCall_2")]
impl<T0: quest_hook::libil2cpp::Type, T1: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RemoteProcedureCall_2<T0, T1>
{
