...
pub struct DeeplinkManagerToDestinationRequestManagerAdapter {
    ...
    pub didSendMenuDestinationRequestEvent: quest_hook::libil2cpp::Gc<
        crate::System::Action_1<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MenuDestination>>,
    >,
    pub _currentMenuDestinationRequest:
    ...
    for crate::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter
{
    ...
    const CLASS_NAME: &'static str = "DeeplinkManagerToDestinationRequestManagerAdapter";
...
impl std::ops::Deref for crate::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter {
...
impl crate::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter {
    ...
    pub fn HandleDeeplinkManagerDidReceiveDeeplink(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (deeplink))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
        deeplinkManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IDeeplinkManager>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (deeplinkManager))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MenuDestination> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
