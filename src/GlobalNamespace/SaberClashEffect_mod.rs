...
#[cfg(feature = "SaberClashEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SaberClashEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SaberClashEffect";
...
impl crate::GlobalNamespace::SaberClashEffect {
    pub fn LateUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SaberClashEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("LateUpdate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SaberClashEffect as
