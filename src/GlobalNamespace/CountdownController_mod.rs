...
pub struct CountdownController {
    ...
    pub _countdownElementControllers: *mut quest_hook::libil2cpp::Il2CppArray<
        *mut CountdownElementController,
    >,
    pub _timeProvider: *mut ITimeProvider,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for CountdownController => ""."CountdownController"
);
#[cfg(feature = "CountdownController")]
impl std::ops::Deref for CountdownController {
...
#[cfg(feature = "CountdownController")]
impl std::ops::DerefMut for CountdownController {
...
#[cfg(feature = "CountdownController")]
impl quest_hook::libil2cpp::ObjectType for CountdownController {
