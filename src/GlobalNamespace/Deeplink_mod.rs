...
pub struct Deeplink {
    ...
    pub MultiplayerLobbyCode: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub MultiplayerSecret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_Deeplink")]
...
impl crate::GlobalNamespace::Deeplink {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::Deeplink>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::Deeplink> =
            unsafe { cordl_method_info.invoke_unchecked((), (jsonDeeplink))? };
        Ok(__cordl_ret.into())
    }
