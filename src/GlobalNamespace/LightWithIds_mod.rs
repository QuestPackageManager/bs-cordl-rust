#[cfg(feature = "cordl_class_LightWithIds")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::LightWithIds {
    ...
    pub fn SetNewLightsWithIds(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lightsWithIds))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_LightWithIds+LightWithId")]
#[repr(C)]
#[derive(Debug)]
pub struct LightWithIds_LightWithId {
    ...
    pub _isRegistered: bool,
    pub _parentLightWithIds: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LightWithIds>,
}
#[cfg(feature = "cordl_class_LightWithIds+LightWithId")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightWithIds_LightWithId {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::LightWithIds_LightWithId {
    ...
    pub fn __SetParentLightWithIds(
        &mut self,
        parentLightWithIds: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LightWithIds>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "__SetParentLightWithIds", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parentLightWithIds))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_LightWithIds+LightWithId")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LightWithIds_LightWithId {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
