...
impl crate::GlobalNamespace::LightWithIds_LightWithId {
    ...
    pub fn __SetParentLightWithIds(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("__SetParentLightWithIds", (parentLightWithIds))?;
        Ok(__cordl_ret)
    }
    ...
    pub fn New_i32_1(lightId: i32) -> quest_hook::libil2cpp::Result<&'static mut Self> {
        let __cordl_object: &mut Self = <Self as quest_hook::libil2cpp::Type>::class()
            .instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
...
impl LightWithIds {
    ...
    pub fn HandleLightManagerDidChangeSomeColorsThisFrame(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("HandleLightManagerDidChangeSomeColorsThisFrame", ())?;
        Ok(__cordl_ret)
    }
    ...
    pub fn RegisterForColorChanges(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("RegisterForColorChanges", ())?;
        Ok(__cordl_ret)
    }
    pub fn SetNewLightsWithIds(
        &mut self,
        lightsWithIds: *mut crate::System::Collections::Generic::IEnumerable_1<
            *mut crate::GlobalNamespace::LightWithIds_LightWithId,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("SetNewLightsWithIds", (lightsWithIds))?;
        Ok(__cordl_ret)
    }
    ...
    > {
        ...
        let __cordl_ret: *mut crate::System::Collections::Generic::IEnumerable_1<
            *mut crate::GlobalNamespace::LightWithIds_LightWithId,
        > = __cordl_object.invoke("get_lightWithIds", ())?;
        Ok(__cordl_ret)
    }
    pub fn UnregisterFromColorChanges(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("UnregisterFromColorChanges", ())?;
        Ok(__cordl_ret)
    }
