...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerActivePlayersTimeOffsetAverage {
...
#[cfg(feature = "MultiplayerActivePlayersTimeOffsetAverage")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerActivePlayersTimeOffsetAverage {
