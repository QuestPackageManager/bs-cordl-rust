#[cfg(feature = "cordl_class_PersistentAudioNoiseController")]
#[repr(C)]
#[derive(Debug)]
pub struct PersistentAudioNoiseController {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _audioSource: quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioSource>,
    pub _shaderWarmupScenesTransitionSetupData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO>,
    pub _gameScenesManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameScenesManager>,
    pub _wasStarted: bool,
}
#[cfg(feature = "cordl_class_PersistentAudioNoiseController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PersistentAudioNoiseController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PersistentAudioNoiseController";
...
#[cfg(feature = "PersistentAudioNoiseController")]
impl std::ops::Deref for crate::GlobalNamespace::PersistentAudioNoiseController {
...
#[cfg(feature = "PersistentAudioNoiseController")]
impl std::ops::DerefMut for crate::GlobalNamespace::PersistentAudioNoiseController {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "PersistentAudioNoiseController")]
impl crate::GlobalNamespace::PersistentAudioNoiseController {
    ...
    pub fn OnResetAudioEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnResetAudioEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_PersistentAudioNoiseController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PersistentAudioNoiseController {
