...
impl crate::GlobalNamespace::BackgroundTextureGradientSwitchEventEffect {
    pub fn HandleBeatmapEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BackgroundTextureGradientSwitchEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BackgroundTextureGradientSwitchEventEffect
