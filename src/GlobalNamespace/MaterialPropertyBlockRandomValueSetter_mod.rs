...
#[cfg(feature = "MaterialPropertyBlockRandomValueSetter")]
impl std::ops::DerefMut for crate::GlobalNamespace::MaterialPropertyBlockRandomValueSetter {
...
impl crate::GlobalNamespace::MaterialPropertyBlockRandomValueSetter {
    pub fn ApplyParams(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
