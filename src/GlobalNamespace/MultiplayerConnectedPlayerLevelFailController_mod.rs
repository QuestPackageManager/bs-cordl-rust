...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerConnectedPlayerLevelFailController {
...
#[cfg(feature = "MultiplayerConnectedPlayerLevelFailController")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerConnectedPlayerLevelFailController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_playerDidFailEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
