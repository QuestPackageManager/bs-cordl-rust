...
impl crate::GlobalNamespace::ScaleAnimator {
    pub fn Animate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (show, duration, easeType, delay))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HideInstant(
