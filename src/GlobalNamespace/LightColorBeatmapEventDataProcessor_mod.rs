...
for crate::GlobalNamespace::LightColorBeatmapEventDataProcessor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LightColorBeatmapEventDataProcessor";
...
#[cfg(feature = "LightColorBeatmapEventDataProcessor")]
impl crate::GlobalNamespace::LightColorBeatmapEventDataProcessor {
    ...
    pub fn ProcessBeforeDeleteEventDataInternal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightColorBeatmapEventDataProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LightColorBeatmapEventDataProcessor as
