#[cfg(feature = "cordl_class_OculusLevelProductPacksSO")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_OculusLevelProductPacksSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OculusLevelProductPacksSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OculusLevelProductPacksSO";
...
#[cfg(feature = "cordl_class_OculusLevelProductPacksSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OculusLevelProductPacksSO {
