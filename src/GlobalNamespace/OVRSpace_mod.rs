...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRSpace {
    ...
    const CLASS_NAME: &'static str = "OVRSpace";
...
impl crate::GlobalNamespace::OVRSpace {
    ...
    pub fn Equals_OVRSpace0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::OVRSpace), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn TryGetUuid(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (uuid))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
    ...
    pub fn op_Implicit_OVRSpace1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::GlobalNamespace::OVRSpace), u64, 1usize>(
                        "op_Implicit",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (space))? };
        Ok(__cordl_ret.into())
    }
    pub fn op_Implicit_u64_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(u64), crate::GlobalNamespace::OVRSpace, 1usize>(
                        "op_Implicit",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
impl AsMut<crate::System::IEquatable_1<crate::GlobalNamespace::OVRSpace>>
    for crate::GlobalNamespace::OVRSpace
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::GlobalNamespace::OVRSpace> {
        todo!()
    }
}
...
#[cfg(feature = "cordl_class_OVRSpace+StorageLocation")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRSpace_StorageLocation {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRSpace/StorageLocation";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
#[cfg(feature = "cordl_class_OVRSpace+StorageLocation")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::OVRSpace_StorageLocation {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_value_argument(ty)
    }
...
#[cfg(feature = "cordl_class_OVRSpace+StorageLocation")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::OVRSpace_StorageLocation {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_value_parameter(ty)
    }
...
#[cfg(feature = "cordl_class_OVRSpace+StorageLocation")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::OVRSpace_StorageLocation {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_returned(ty)
    }
...
#[cfg(feature = "cordl_class_OVRSpace+StorageLocation")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::OVRSpace_StorageLocation {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_return(ty)
    }
