...
impl crate::GlobalNamespace::MultiplayerConditionalActiveByLayout {
    ...
    pub fn HandlePlayersLayoutWasCalculated(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerConditionalActiveByLayout as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerConditionalActiveByLayout as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandlePlayersLayoutWasCalculated", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (layout, playersCount))?
        };
        Ok(__cordl_ret.into())
    }
...
for crate::GlobalNamespace::MultiplayerConditionalActiveByLayout_Condition {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultiplayerConditionalActiveByLayout/Condition";
