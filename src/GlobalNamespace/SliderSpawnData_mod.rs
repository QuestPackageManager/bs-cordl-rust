...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SliderSpawnData {
    ...
    const CLASS_NAME: &'static str = "SliderSpawnData";
...
impl crate::GlobalNamespace::SliderSpawnData {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SliderSpawnData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SliderSpawnData as
