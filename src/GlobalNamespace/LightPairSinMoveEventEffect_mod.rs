...
pub struct LightPairSinMoveEventEffect {
    ...
    pub _movementDataL:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LightPairSinMoveEventEffect_MovementData>,
    pub _movementDataR:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LightPairSinMoveEventEffect_MovementData>,
...
#[cfg(feature = "cordl_class_LightPairSinMoveEventEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightPairSinMoveEventEffect {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        f32,
                    ), quest_hook::libil2cpp::Void, 3usize>("UpdateMovementData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_LightPairSinMoveEventEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LightPairSinMoveEventEffect {
    ...
    for crate::GlobalNamespace::LightPairSinMoveEventEffect_MovementData
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LightPairSinMoveEventEffect/MovementData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "LightPairSinMoveEventEffect+MovementData")]
impl std::ops::Deref for crate::GlobalNamespace::LightPairSinMoveEventEffect_MovementData {
...
#[cfg(feature = "LightPairSinMoveEventEffect+MovementData")]
impl std::ops::DerefMut for crate::GlobalNamespace::LightPairSinMoveEventEffect_MovementData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
