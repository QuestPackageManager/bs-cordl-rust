...
pub struct SimpleMemoryPool_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _activeElements: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LazyCopyHashSet_1<T>>,
    pub _inactiveElements:
    ...
    for crate::GlobalNamespace::SimpleMemoryPool_1<T>
{
    ...
    const CLASS_NAME: &'static str = "SimpleMemoryPool`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "SimpleMemoryPool`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::SimpleMemoryPool_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (startCapacity, createNewItemFunc))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_items(
