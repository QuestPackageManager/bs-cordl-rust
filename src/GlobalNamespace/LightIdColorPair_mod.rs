...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightIdColorPair {
    ...
    const CLASS_NAME: &'static str = "LightIdColorPair";
...
impl crate::GlobalNamespace::LightIdColorPair {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightIdColorPair as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LightIdColorPair as
    ...
    pub fn get_lightColor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightIdColorPair as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::UnityEngine::Color, 0usize>("get_lightColor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LightIdColorPair as
                    quest_hook::libil2cpp::Type > ::class(), "get_lightColor", 0usize
                )
            });
