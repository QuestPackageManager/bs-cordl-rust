...
> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TConnectedPlayerImpl = unsafe {
            cordl_method_info.invoke_unchecked(self, (connectionId))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (
                            quest_hook::libil2cpp::Gc<
                                crate::GlobalNamespace::KickPlayerPacket,
                            >,
                            TConnectedPlayer,
                        ),
                        quest_hook::libil2cpp::Void,
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (
                            quest_hook::libil2cpp::Gc<
                                crate::GlobalNamespace::PlayerStatePacket,
                            >,
                            TConnectedPlayer,
                        ),
                        quest_hook::libil2cpp::Void,
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (
                            quest_hook::libil2cpp::Gc<
                                crate::GlobalNamespace::SyncTimePacket,
                            >,
                            TConnectedPlayer,
                        ),
                        quest_hook::libil2cpp::Void,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "NotifyPlayerStateChangedEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TConnectedPlayer = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
