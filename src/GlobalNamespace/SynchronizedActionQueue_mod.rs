...
#[cfg(feature = "cordl_class_SynchronizedActionQueue")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SynchronizedActionQueue {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "EnqueueAction", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_time, action))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_SynchronizedActionQueue")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SynchronizedActionQueue {
