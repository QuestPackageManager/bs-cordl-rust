#[cfg(feature = "cordl_class_UnityScenesHelper")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::UnityScenesHelper {
    pub fn GetComponentsInScene<T>(
        ...
        components: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<T>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (scene, components, includeInactive))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetActiveRootObjectsInScene(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (scene, active))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityScenesHelper")]
