#[cfg(feature = "cordl_class_FileStorageExtensions")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_FileStorageExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FileStorageExtensions {
...
impl crate::GlobalNamespace::FileStorageExtensions {
    ...
    pub fn DeleteFile(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("DeleteFile")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (fileStorage, fileName, storageLocation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FileExists(
    ...
    pub fn SaveFile(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        crate::GlobalNamespace::StoragePreference,
                    ), quest_hook::libil2cpp::Void, 4usize>("SaveFile")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (fileStorage, fileName, value, storageLocation))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 5usize>("SaveToJSONFile")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_FileStorageExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::FileStorageExtensions {
