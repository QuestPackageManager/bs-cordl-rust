...
impl crate::GlobalNamespace::QuickPlaySetupData {
    ...
    pub type QuickPlaySongPacksOverride =
        crate::GlobalNamespace::QuickPlaySetupData_QuickPlaySongPacksOverride;
...
#[cfg(feature = "QuickPlaySetupData+QuickPlaySongPacksOverride")]
impl std::ops::Deref for crate::GlobalNamespace::QuickPlaySetupData_QuickPlaySongPacksOverride {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "QuickPlaySetupData+QuickPlaySongPacksOverride")]
impl std::ops::DerefMut for crate::GlobalNamespace::QuickPlaySetupData_QuickPlaySongPacksOverride {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
