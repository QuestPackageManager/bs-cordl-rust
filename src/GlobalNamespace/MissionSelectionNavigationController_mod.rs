...
pub struct MissionSelectionNavigationController {
    ...
    pub _missionLevelDetailViewController:
...
#[cfg(feature = "MissionSelectionNavigationController")]
impl std::ops::DerefMut for crate::GlobalNamespace::MissionSelectionNavigationController {
...
impl crate::GlobalNamespace::MissionSelectionNavigationController {
    ...
    pub fn HandleMissionSelectionMapViewControllerDidSelectMissionLevel(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (viewController, missionNode))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_selectedMissionNode", 0usize
                        )
                    })
            });
