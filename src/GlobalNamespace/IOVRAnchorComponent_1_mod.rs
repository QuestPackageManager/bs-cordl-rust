...
for crate::GlobalNamespace::IOVRAnchorComponent_1<T> {
    ...
    const CLASS_NAME: &'static str = "IOVRAnchorComponent`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("", "IOVRAnchorComponent`1")
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
                    .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::IOVRAnchorComponent_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IOVRAnchorComponent_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::GlobalNamespace::OVRAnchor), T, 1usize>("FromAnchor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IOVRAnchorComponent_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "FromAnchor", 1usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IOVRAnchorComponent_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "SetEnabledAsync", 2usize
                )
            });
