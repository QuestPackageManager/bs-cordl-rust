#[cfg(feature = "cordl_class_IOVRAnchorComponent_1")]
#[derive(Debug)]
#[repr(C)]
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::IOVRAnchorComponent_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (anchor))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::GlobalNamespace::OVRTask_1<bool> =
            unsafe { cordl_method_info.invoke_unchecked(self, (enable, timeout))? };
        Ok(__cordl_ret.into())
    }
