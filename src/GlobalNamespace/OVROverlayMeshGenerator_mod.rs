...
impl crate::GlobalNamespace::OVROverlayMeshGenerator {
    ...
    pub fn BuildQuad(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (verts, uv, triangles, rect))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn BuildSphere(
    ...
    pub fn GetCubeVert(
        ...
        let __cordl_ret: crate::UnityEngine::Vector3 = unsafe {
            cordl_method_info.invoke_unchecked((), (face, sideU, sideV))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetSphereUV(
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 = unsafe {
            cordl_method_info.invoke_unchecked((), (theta, phi, expandScale))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetSphereVert", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Vector3 = unsafe {
            cordl_method_info.invoke_unchecked((), (theta, phi))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Initialize(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InverseTransformVert", 4usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Vector3 = unsafe {
            cordl_method_info.invoke_unchecked((), (vert, position, scale, worldScale))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetOverlay(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (overlay))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryUpdateMesh(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
    ...
    pub fn UpdateMesh(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (shape, position, rotation, scale, rect, cubemap),
                )?
        };
        Ok(__cordl_ret.into())
    }
