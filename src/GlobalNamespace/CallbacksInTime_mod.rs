...
impl crate::GlobalNamespace::CallbacksInTime {
    ...
    pub fn CallCallbacks_BeatmapDataItem0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (beatmapDataItem))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CallCallbacks_Type_BeatmapDataItem1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (beatmapEventDataType, beatmapDataItem))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (aheadTime))?
        };
        Ok(__cordl_ret.into())
    }
