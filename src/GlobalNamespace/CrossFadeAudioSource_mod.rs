...
pub struct CrossFadeAudioSource {
    ...
    pub _audioPitchGainEffect1:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioPitchGainEffect>,
    pub _audioPitchGainEffect2:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioPitchGainEffect>,
    ...
    pub _activePitchGainEffect:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioPitchGainEffect>,
    pub _inactivePitchGainEffect:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioPitchGainEffect>,
}
#[cfg(feature = "cordl_class_CrossFadeAudioSource")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CrossFadeAudioSource {
...
impl crate::GlobalNamespace::CrossFadeAudioSource {
    ...
    pub fn CrossFade(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (toSongTime, toVolume))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PlayPitchGainEffect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (volumeScale))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _CrossFade_b__25_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("<CrossFade>b__25_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _CrossFade_b__25_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("<CrossFade>b__25_1")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
