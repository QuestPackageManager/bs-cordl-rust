...
for crate::GlobalNamespace::HealthWarningDisplayViewController {
    ...
    const CLASS_NAME: &'static str = "HealthWarningDisplayViewController";
...
impl crate::GlobalNamespace::HealthWarningDisplayViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HealthWarningDisplayViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HealthWarningDisplayViewController as
