...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BurstFireEffect => ""."BurstFireEffect"
);
#[cfg(feature = "BurstFireEffect")]
impl std::ops::Deref for BurstFireEffect {
...
#[cfg(feature = "BurstFireEffect")]
impl std::ops::DerefMut for BurstFireEffect {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BurstFireEffect")]
impl BurstFireEffect {
    pub fn OnDestroy(
        &mut self,
...
#[cfg(feature = "BurstFireEffect")]
impl quest_hook::libil2cpp::ObjectType for BurstFireEffect {
