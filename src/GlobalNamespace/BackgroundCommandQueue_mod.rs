#[cfg(feature = "cordl_class_BackgroundCommandQueue")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_BackgroundCommandQueue")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BackgroundCommandQueue {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BackgroundCommandQueue";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::IBackgroundCommand,
                        >),
...
#[cfg(feature = "cordl_class_BackgroundCommandQueue")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BackgroundCommandQueue {
