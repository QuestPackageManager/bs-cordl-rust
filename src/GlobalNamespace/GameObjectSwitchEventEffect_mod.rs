#[cfg(feature = "cordl_class_GameObjectSwitchEventEffect")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct GameObjectSwitchEventEffect {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _deactivateOnBoostObjects: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
        >,
    >,
    pub _activateOnBoostObjects: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
        >,
    >,
...
#[cfg(feature = "cordl_class_GameObjectSwitchEventEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GameObjectSwitchEventEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GameObjectSwitchEventEffect";
...
impl crate::GlobalNamespace::GameObjectSwitchEventEffect {
    ...
    pub fn ToggleObjects(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("ToggleObjects")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (isBoostOn))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_GameObjectSwitchEventEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GameObjectSwitchEventEffect {
