...
#[cfg(feature = "cordl_class_BloomPrePassRenderDataSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomPrePassRenderDataSO {
...
#[cfg(feature = "cordl_class_BloomPrePassRenderDataSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BloomPrePassRenderDataSO {
...
#[cfg(feature = "cordl_class_BloomPrePassRenderDataSO+Data")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomPrePassRenderDataSO_Data {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_BloomPrePassRenderDataSO+Data")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BloomPrePassRenderDataSO_Data {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
