...
impl crate::GlobalNamespace::ICutScoreBufferDidFinishReceiver {
    pub fn HandleCutScoreBufferDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ICutScoreBufferDidFinishReceiver as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ICutScoreBufferDidFinishReceiver as
