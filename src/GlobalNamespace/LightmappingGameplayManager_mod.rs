...
for crate::GlobalNamespace::LightmappingGameplayManager {
    ...
    const CLASS_NAME: &'static str = "LightmappingGameplayManager";
...
#[cfg(feature = "LightmappingGameplayManager")]
impl crate::GlobalNamespace::LightmappingGameplayManager {
    ...
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightmappingGameplayManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LightmappingGameplayManager as
