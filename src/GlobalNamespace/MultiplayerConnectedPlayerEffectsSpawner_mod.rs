...
impl crate::GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner {
    pub fn HandleBeatmapObjectEventManagerConnectedPlayerBeatmapObjectWasCut(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner as
