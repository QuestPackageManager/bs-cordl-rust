    ...
    for crate::GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerConnectedPlayerEffectsSpawner";
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner {
...
#[cfg(feature = "MultiplayerConnectedPlayerEffectsSpawner")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner {
