#[cfg(feature = "cordl_class_CreateServerFormController")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_CreateServerFormController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CreateServerFormController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "CreateServerFormController";
...
impl crate::GlobalNamespace::CreateServerFormController {
    ...
    pub fn Setup(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, bool), quest_hook::libil2cpp::Void, 2usize>("Setup")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selectedNumberOfPlayers, netDiscoverable))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_formData(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::CreateServerFormData, 0usize>(
                        "get_formData",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::GlobalNamespace::CreateServerFormData =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_CreateServerFormController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::CreateServerFormController {
