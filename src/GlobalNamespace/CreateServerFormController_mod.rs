...
impl crate::GlobalNamespace::CreateServerFormController {
    ...
    pub fn Setup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CreateServerFormController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32, bool), quest_hook::libil2cpp::Void, 2usize>("Setup")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CreateServerFormController as
                    quest_hook::libil2cpp::Type > ::class(), "Setup", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (selectedNumberOfPlayers, netDiscoverable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CreateServerFormController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CreateServerFormController as
                    quest_hook::libil2cpp::Type > ::class(), "get_formData", 0usize
                )
            });
