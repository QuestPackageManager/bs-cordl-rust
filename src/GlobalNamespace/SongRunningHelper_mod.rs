...
pub struct SongRunningHelper {
    ...
    pub _beatmapCharacteristics: *mut BeatmapCharacteristicCollection,
    pub _menuTransitionsHelper: *mut MenuTransitionsHelper,
    pub _beatmapLevels: *mut BeatmapLevelsModel,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for SongRunningHelper => ""."SongRunningHelper"
);
#[cfg(feature = "SongRunningHelper")]
impl std::ops::Deref for SongRunningHelper {
...
#[cfg(feature = "SongRunningHelper")]
impl std::ops::DerefMut for SongRunningHelper {
...
impl SongRunningHelper {
    ...
    pub fn FindBeatmapLevelPackBeatmaps(
        ...
        *mut quest_hook::libil2cpp::Il2CppArray<*mut BeatmapLevel>,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut quest_hook::libil2cpp::Il2CppArray<*mut BeatmapLevel> = __cordl_object
...
#[cfg(feature = "SongRunningHelper")]
impl quest_hook::libil2cpp::ObjectType for SongRunningHelper {
