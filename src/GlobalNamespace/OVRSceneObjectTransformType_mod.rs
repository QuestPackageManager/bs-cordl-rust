...
for crate::GlobalNamespace::OVRSceneObjectTransformType {
    ...
    const CLASS_NAME: &'static str = "OVRSceneObjectTransformType";
...
impl crate::GlobalNamespace::OVRSceneObjectTransformType {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRSceneObjectTransformType as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRSceneObjectTransformType as
...
for crate::GlobalNamespace::OVRSceneObjectTransformType_Transformation {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRSceneObjectTransformType/Transformation";
