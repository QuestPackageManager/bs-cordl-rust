#[cfg(feature = "cordl_class_XRSubsystemHelper")]
#[repr(C)]
...
impl crate::GlobalNamespace::XRSubsystemHelper {
    pub fn GetCurrentDisplaySubsystem(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::XR::XRInputSubsystem> =
            unsafe { cordl_method_info.invoke_unchecked((), ())? };
        Ok(__cordl_ret.into())
    }
}
