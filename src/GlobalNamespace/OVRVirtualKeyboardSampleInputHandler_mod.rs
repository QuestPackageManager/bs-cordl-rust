#[cfg(feature = "cordl_class_OVRVirtualKeyboardSampleInputHandler")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct OVRVirtualKeyboardSampleInputHandler {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub OVRVirtualKeyboard: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRVirtualKeyboard>,
    ...
    pub interactionDevice_: crate::System::Nullable_1<crate::GlobalNamespace::OVRInput_Controller>,
...
#[cfg(feature = "OVRVirtualKeyboardSampleInputHandler")]
impl std::ops::DerefMut for crate::GlobalNamespace::OVRVirtualKeyboardSampleInputHandler {
...
impl crate::GlobalNamespace::OVRVirtualKeyboardSampleInputHandler {
    ...
    pub fn get_InputRayPosition(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector3, 0usize>("get_InputRayPosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
