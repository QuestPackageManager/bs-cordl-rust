...
for crate::GlobalNamespace::WhiteColorOrAlphaGroupEffectManager {
    ...
    const CLASS_NAME: &'static str = "WhiteColorOrAlphaGroupEffectManager";
...
impl crate::GlobalNamespace::WhiteColorOrAlphaGroupEffectManager {
    ...
    pub fn OnDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::WhiteColorOrAlphaGroupEffectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDestroy")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::WhiteColorOrAlphaGroupEffectManager as
