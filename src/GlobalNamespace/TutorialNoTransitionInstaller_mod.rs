...
for crate::GlobalNamespace::TutorialNoTransitionInstaller {
    ...
    const CLASS_NAME: &'static str = "TutorialNoTransitionInstaller";
...
impl crate::GlobalNamespace::TutorialNoTransitionInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TutorialNoTransitionInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TutorialNoTransitionInstaller as
