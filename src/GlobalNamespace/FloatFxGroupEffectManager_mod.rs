...
for crate::GlobalNamespace::FloatFxGroupEffectManager {
    ...
    const CLASS_NAME: &'static str = "FloatFxGroupEffectManager";
...
impl crate::GlobalNamespace::FloatFxGroupEffectManager {
    ...
    pub fn OnDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FloatFxGroupEffectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDestroy")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::FloatFxGroupEffectManager as
