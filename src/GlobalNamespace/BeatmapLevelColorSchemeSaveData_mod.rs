...
for crate::GlobalNamespace::BeatmapLevelColorSchemeSaveData {
    ...
    const CLASS_NAME: &'static str = "BeatmapLevelColorSchemeSaveData";
...
impl crate::GlobalNamespace::BeatmapLevelColorSchemeSaveData {
    pub fn IsDefault(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BeatmapLevelColorSchemeSaveData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("IsDefault")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::BeatmapLevelColorSchemeSaveData as
                    quest_hook::libil2cpp::Type > ::class(), "IsDefault", 0usize
                )
            });
