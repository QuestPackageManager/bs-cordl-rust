...
for crate::GlobalNamespace::ColorSchemeTableCell {
    ...
    const CLASS_NAME: &'static str = "ColorSchemeTableCell";
...
impl crate::GlobalNamespace::ColorSchemeTableCell {
    ...
    pub fn SetColors(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ColorSchemeTableCell as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ColorSchemeTableCell as
                    quest_hook::libil2cpp::Type > ::class(), "SetColors", 7usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ColorSchemeTableCell as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ColorSchemeTableCell as
                    quest_hook::libil2cpp::Type > ::class(), "set_showEditIcon", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
