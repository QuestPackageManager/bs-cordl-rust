...
#[cfg(feature = "cordl_class_ColorSchemeTableCell")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ColorSchemeTableCell {
...
impl crate::GlobalNamespace::ColorSchemeTableCell {
    ...
    pub fn set_showEditIcon(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_showEditIcon")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
