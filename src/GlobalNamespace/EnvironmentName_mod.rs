...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnvironmentName {
    ...
    const CLASS_NAME: &'static str = "EnvironmentName";
...
#[cfg(feature = "cordl_class_EnvironmentName")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::EnvironmentName {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_EnvironmentName")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::EnvironmentName {
    type Type = Self;
...
impl crate::GlobalNamespace::EnvironmentName {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::EnvironmentName), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn op_Implicit_Il2CppString1(
        ...
        let __cordl_ret: crate::GlobalNamespace::EnvironmentName =
            unsafe { cordl_method_info.invoke_unchecked((), (environmentName))? };
        Ok(__cordl_ret.into())
    }
