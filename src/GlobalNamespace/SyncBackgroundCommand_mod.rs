...
#[cfg(feature = "cordl_class_SyncBackgroundCommand")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SyncBackgroundCommand {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SyncBackgroundCommand";
...
#[cfg(feature = "cordl_class_SyncBackgroundCommand")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SyncBackgroundCommand {
