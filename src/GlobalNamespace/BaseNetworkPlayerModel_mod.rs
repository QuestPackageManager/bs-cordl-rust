...
pub struct BaseNetworkPlayerModel {
    ...
    pub _partyManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::INetworkPlayerModel>,
...
#[cfg(feature = "cordl_class_BaseNetworkPlayerModel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BaseNetworkPlayerModel {
...
impl crate::GlobalNamespace::BaseNetworkPlayerModel {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (createConfig))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IEnumerable_1<
                            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::INetworkPlayer>,
                        >,
                    >, 0usize>("INetworkPlayerModel.get_otherPlayers")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn PartySizeChanged(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("PartySizeChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_BaseNetworkPlayerModel")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BaseNetworkPlayerModel {
...
pub struct BaseNetworkPlayerModel_PartyConfig {
    ...
    pub partyManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::INetworkPlayerModel>,
}
#[cfg(feature = "cordl_class_BaseNetworkPlayerModel+PartyConfig")]
