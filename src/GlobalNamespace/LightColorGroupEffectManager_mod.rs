...
impl crate::GlobalNamespace::LightColorGroupEffectManager {
    pub fn HandleColorBoostBeatmapEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightColorGroupEffectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LightColorGroupEffectManager as
