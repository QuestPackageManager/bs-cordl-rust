...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::HEU_BoundingVolume {
    ...
    const CLASS_NAME: &'static str = "HEU_BoundingVolume";
...
impl crate::GlobalNamespace::HEU_BoundingVolume {
    pub fn GetAllIntersectingObjects(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HEU_BoundingVolume as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::List_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::HEU_BoundingVolume as
                    quest_hook::libil2cpp::Type > ::class(), "GetAllIntersectingObjects",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::HEU_BoundingVolume as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::HEU_BoundingVolume as
                    quest_hook::libil2cpp::Type > ::class(), "get_BoundingCollider",
                    0usize
                )
            });
