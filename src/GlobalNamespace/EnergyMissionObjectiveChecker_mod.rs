...
impl crate::GlobalNamespace::EnergyMissionObjectiveChecker {
    pub fn CheckAndUpdateStatus(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnergyMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EnergyMissionObjectiveChecker as
                    quest_hook::libil2cpp::Type > ::class(), "CheckAndUpdateStatus",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnergyMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EnergyMissionObjectiveChecker as
                    quest_hook::libil2cpp::Type > ::class(), "HandleEnergyDidChange",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (energy))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
