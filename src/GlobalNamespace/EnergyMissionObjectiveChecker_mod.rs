#[cfg(feature = "cordl_class_EnergyMissionObjectiveChecker")]
#[repr(C)]
#[derive(Debug)]
pub struct EnergyMissionObjectiveChecker {
    __cordl_parent: crate::GlobalNamespace::MissionObjectiveChecker,
    pub _energyCounter: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameEnergyCounter>,
}
#[cfg(feature = "cordl_class_EnergyMissionObjectiveChecker")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnergyMissionObjectiveChecker {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EnergyMissionObjectiveChecker";
...
impl crate::GlobalNamespace::EnergyMissionObjectiveChecker {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CheckAndUpdateStatus")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn HandleEnergyDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (energy))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_EnergyMissionObjectiveChecker")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EnergyMissionObjectiveChecker {
