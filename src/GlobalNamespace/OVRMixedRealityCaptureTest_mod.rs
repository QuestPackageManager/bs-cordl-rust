...
for crate::GlobalNamespace::OVRMixedRealityCaptureTest {
    ...
    const CLASS_NAME: &'static str = "OVRMixedRealityCaptureTest";
...
impl crate::GlobalNamespace::OVRMixedRealityCaptureTest {
    ...
    pub fn Initialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRMixedRealityCaptureTest as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Initialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRMixedRealityCaptureTest as
...
for crate::GlobalNamespace::OVRMixedRealityCaptureTest_CameraMode {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRMixedRealityCaptureTest/CameraMode";
