...
pub struct HeadObstacleLowPassAudioEffect {
    ...
    pub _mainAudioEffects: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MainAudioEffects>,
    pub _headWasInObstacle: bool,
}
#[cfg(feature = "cordl_class_HeadObstacleLowPassAudioEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::HeadObstacleLowPassAudioEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "HeadObstacleLowPassAudioEffect";
...
#[cfg(feature = "cordl_class_HeadObstacleLowPassAudioEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::HeadObstacleLowPassAudioEffect {
