...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BeatmapLevelDataUtils => ""."BeatmapLevelDataUtils"
);
#[cfg(feature = "BeatmapLevelDataUtils")]
impl std::ops::Deref for BeatmapLevelDataUtils {
...
#[cfg(feature = "BeatmapLevelDataUtils")]
impl std::ops::DerefMut for BeatmapLevelDataUtils {
