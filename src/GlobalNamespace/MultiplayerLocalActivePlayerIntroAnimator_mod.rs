    ...
    for crate::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerLocalActivePlayerIntroAnimator";
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator {
...
#[cfg(feature = "MultiplayerLocalActivePlayerIntroAnimator")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator {
...
impl crate::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetAfterIntroValues")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn SetBeforeIntroValues(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetBeforeIntroValues")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
