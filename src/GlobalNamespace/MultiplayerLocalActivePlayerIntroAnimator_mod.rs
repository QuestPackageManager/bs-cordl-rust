...
impl crate::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator {
    ...
    pub fn SetAfterIntroValues(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator as
                    quest_hook::libil2cpp::Type > ::class(), "SetAfterIntroValues",
                    0usize
                )
            });
