...
impl crate::GlobalNamespace::ScoringElement {
    ...
    pub type Pool_1<T: quest_hook::libil2cpp::Type> =
        crate::GlobalNamespace::ScoringElement_Pool_1<T>;
    pub fn CompareTo(
        &mut self,
    ...
    pub fn SetMultipliers(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (multiplier, maxMultiplier))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_maxMultiplier(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_maxMultiplier")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
