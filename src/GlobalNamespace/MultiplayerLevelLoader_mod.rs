...
pub struct MultiplayerLevelLoader {
    ...
    pub _getBeatmapCancellationTokenSource:
    ...
    pub _getBeatmapLevelResultTask: quest_hook::libil2cpp::Gc<
        crate::System::Threading::Tasks::Task_1<crate::GlobalNamespace::LoadBeatmapLevelDataResult>,
    >,
    pub _gameplaySetupData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ILevelGameplaySetupData>,
    pub _beatmapLevelData: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBeatmapLevelData>,
    pub _startTime: i64,
    pub _stillDownloadingCalled: bool,
}
#[cfg(feature = "cordl_class_MultiplayerLevelLoader")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerLevelLoader {
...
impl crate::GlobalNamespace::MultiplayerLevelLoader {
    ...
    pub type MultiplayerBeatmapLoaderState =
        crate::GlobalNamespace::MultiplayerLevelLoader_MultiplayerBeatmapLoaderState;
    pub fn ClearLoading(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearLoading")
                    .unwrap_or_else(|e| {
                        panic!(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "LoadBeatmapLevelDataAsync", 1usize
                        )
                    })
            });
    ...
    pub fn LoadLevel(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ILevelGameplaySetupData>,
                        i64,
                    ), quest_hook::libil2cpp::Void, 2usize>("LoadLevel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (gameplaySetupData, initialStartTime))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetNewStartTime(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64), quest_hook::libil2cpp::Void, 1usize>("SetNewStartTime")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newStartTime))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_stillDownloadingSongEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_stillDownloadingSongEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_MultiplayerLevelLoader")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerLevelLoader {
...
#[cfg(feature = "MultiplayerLevelLoader")]
impl AsRef<crate::Zenject::ITickable> for crate::GlobalNamespace::MultiplayerLevelLoader {
    fn as_ref(&self) -> &crate::Zenject::ITickable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "MultiplayerLevelLoader")]
impl AsMut<crate::Zenject::ITickable> for crate::GlobalNamespace::MultiplayerLevelLoader {
