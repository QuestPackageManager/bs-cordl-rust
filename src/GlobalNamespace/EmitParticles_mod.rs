...
#[cfg(feature = "EmitParticles")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EmitParticles {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EmitParticles";
...
impl crate::GlobalNamespace::EmitParticles {
    pub fn Emit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EmitParticles as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("Emit")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EmitParticles as quest_hook::libil2cpp::Type
                    > ::class(), "Emit", 1usize
                )
            });
