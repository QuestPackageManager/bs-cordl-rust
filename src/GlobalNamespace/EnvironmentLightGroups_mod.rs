...
#[cfg(feature = "cordl_class_EnvironmentLightGroups")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnvironmentLightGroups {
...
impl crate::GlobalNamespace::EnvironmentLightGroups {
    pub fn GetDataForGroup(
        &mut self,
        groupId: i32,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ILightGroup>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ILightGroup> =
            unsafe { cordl_method_info.invoke_unchecked(self, (groupId))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lightGroups))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_EnvironmentLightGroups")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EnvironmentLightGroups {
