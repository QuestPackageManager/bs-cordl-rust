...
pub struct IgnoranceConnectionManager {
    ...
    >,
    pub _pendingConnections: quest_hook::libil2cpp::Gc<u32>,
...
impl crate::GlobalNamespace::IgnoranceConnectionManager {
    ...
    pub fn DisconnectPeer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (peerId, disconnectedReason))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Dispose(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleDisconnectionEvents", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn Send(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (peerId, writer, deliveryMethod))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryGetConnection(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (peerId, connection))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WaitForClientShutdown(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (client))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WaitForServerShutdown(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (server))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_0(
