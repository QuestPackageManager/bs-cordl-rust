...
impl crate::GlobalNamespace::PackLevelListHeaderTableCell {
    pub fn HighlightDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PackLevelListHeaderTableCell as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PackLevelListHeaderTableCell as
