...
impl crate::GlobalNamespace::EndOfLifeNoticeViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EndOfLifeNoticeViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EndOfLifeNoticeViewController as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EndOfLifeNoticeViewController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EndOfLifeNoticeViewController as
                    quest_hook::libil2cpp::Type > ::class(), "EnableOkButton", 0usize
                )
            });
