...
pub struct SelectRegionViewController {
    ...
    pub _regionSelectionDropdown: quest_hook::libil2cpp::Gc<crate::HMUI::SimpleTextDropdown>,
...
#[cfg(feature = "cordl_class_SelectRegionViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SelectRegionViewController {
...
impl crate::GlobalNamespace::SelectRegionViewController {
    ...
    pub type RegionToLocalizationKeyPair =
        crate::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair;
    pub fn DidActivate(
        &mut self,
    ...
    pub fn HandleRegionSelectionDropdownDidSelectCell(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (dropdown, idx))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _DidActivate_b__5_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<DidActivate>b__5_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_SelectRegionViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SelectRegionViewController {
...
impl crate::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (region, localizationKey))? };
        Ok(__cordl_ret.into())
    }
}
