...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for GridView => ""."GridView"
);
#[cfg(feature = "GridView")]
impl std::ops::Deref for GridView {
...
#[cfg(feature = "GridView")]
impl std::ops::DerefMut for GridView {
...
#[cfg(feature = "GridView")]
impl quest_hook::libil2cpp::ObjectType for GridView {
