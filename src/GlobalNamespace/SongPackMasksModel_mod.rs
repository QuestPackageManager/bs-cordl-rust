...
pub struct SongPackMasksModel {
    ...
    pub content: *mut SongPackMasksModelSO,
    pub allSongPackMask: SongPackMask,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for SongPackMasksModel => ""."SongPackMasksModel"
);
#[cfg(feature = "SongPackMasksModel")]
impl std::ops::Deref for SongPackMasksModel {
...
#[cfg(feature = "SongPackMasksModel")]
impl std::ops::DerefMut for SongPackMasksModel {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "SongPackMasksModel")]
impl SongPackMasksModel {
    #[cfg(feature = "SongPackMasksModel+MaskInfo")]
...
#[cfg(feature = "SongPackMasksModel")]
impl quest_hook::libil2cpp::ObjectType for SongPackMasksModel {
