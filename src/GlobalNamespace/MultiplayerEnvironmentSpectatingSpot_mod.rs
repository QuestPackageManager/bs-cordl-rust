...
for crate::GlobalNamespace::MultiplayerEnvironmentSpectatingSpot {
    ...
    const CLASS_NAME: &'static str = "MultiplayerEnvironmentSpectatingSpot";
...
impl crate::GlobalNamespace::MultiplayerEnvironmentSpectatingSpot {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerEnvironmentSpectatingSpot as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerEnvironmentSpectatingSpot as
