...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IComponentRefresher {
    ...
    const CLASS_NAME: &'static str = "IComponentRefresher";
...
impl crate::GlobalNamespace::IComponentRefresher {
    pub fn __Refresh(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IComponentRefresher as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("__Refresh")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IComponentRefresher as
                    quest_hook::libil2cpp::Type > ::class(), "__Refresh", 0usize
                )
            });
