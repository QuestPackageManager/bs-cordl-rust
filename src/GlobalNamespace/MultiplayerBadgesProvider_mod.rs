#[cfg(feature = "cordl_class_MultiplayerBadgesProvider")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MultiplayerBadgesProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerBadgesProvider {
...
impl crate::GlobalNamespace::MultiplayerBadgesProvider {
    ...
    pub fn SelectBadgesAndPutThemIntoResults(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "SelectBadgesAndPutThemIntoResults"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (playerResults))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MultiplayerBadgesProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerBadgesProvider {
