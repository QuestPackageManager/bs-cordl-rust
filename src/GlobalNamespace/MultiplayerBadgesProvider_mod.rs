...
impl crate::GlobalNamespace::MultiplayerBadgesProvider {
    ...
    pub fn SelectBadgesAndPutThemIntoResults(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerBadgesProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::IReadOnlyList_1<
                        quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerBadgesProvider as
                    quest_hook::libil2cpp::Type > ::class(),
                    "SelectBadgesAndPutThemIntoResults", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (playerResults))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
