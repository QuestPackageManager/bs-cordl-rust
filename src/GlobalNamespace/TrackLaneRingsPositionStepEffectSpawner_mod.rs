    ...
    for crate::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner
{
    ...
    const CLASS_NAME: &'static str = "TrackLaneRingsPositionStepEffectSpawner";
...
impl std::ops::Deref for crate::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner {
...
#[cfg(feature = "TrackLaneRingsPositionStepEffectSpawner")]
impl std::ops::DerefMut for crate::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner {
