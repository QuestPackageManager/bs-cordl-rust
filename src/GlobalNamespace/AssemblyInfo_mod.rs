...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AssemblyInfo {
    ...
    const CLASS_NAME: &'static str = "AssemblyInfo";
...
#[cfg(feature = "AssemblyInfo")]
impl crate::GlobalNamespace::AssemblyInfo {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::AssemblyInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::AssemblyInfo as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
