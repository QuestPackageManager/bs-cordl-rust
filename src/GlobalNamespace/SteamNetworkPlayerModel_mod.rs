#[cfg(feature = "cordl_class_SteamNetworkPlayerModel")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_SteamNetworkPlayerModel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SteamNetworkPlayerModel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SteamNetworkPlayerModel";
...
#[cfg(feature = "cordl_class_SteamNetworkPlayerModel")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SteamNetworkPlayerModel {
