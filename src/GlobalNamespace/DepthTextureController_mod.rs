#[cfg(feature = "cordl_class_DepthTextureController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_DepthTextureController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::DepthTextureController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "DepthTextureController";
...
impl crate::GlobalNamespace::DepthTextureController {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (settingsManager))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_DepthTextureController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::DepthTextureController {
