...
pub struct RecordingUIController {
    ...
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RecordingUIController_InitData>,
    pub _lastUpdateTime: f32,
}
#[cfg(feature = "cordl_class_RecordingUIController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RecordingUIController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RecordingUIController";
...
#[cfg(feature = "cordl_class_RecordingUIController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RecordingUIController {
...
#[cfg(feature = "cordl_class_RecordingUIController+InitData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RecordingUIController_InitData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RecordingUIController/InitData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
impl crate::GlobalNamespace::RecordingUIController_InitData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (recordingEnabled))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_RecordingUIController+InitData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::RecordingUIController_InitData {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
