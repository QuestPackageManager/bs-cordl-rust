...
for crate::GlobalNamespace::UseOnlyForReflectionProbeBaking {
    ...
    const CLASS_NAME: &'static str = "UseOnlyForReflectionProbeBaking";
...
#[cfg(feature = "UseOnlyForReflectionProbeBaking")]
impl crate::GlobalNamespace::UseOnlyForReflectionProbeBaking {
    pub fn Awake(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::UseOnlyForReflectionProbeBaking as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::UseOnlyForReflectionProbeBaking as
