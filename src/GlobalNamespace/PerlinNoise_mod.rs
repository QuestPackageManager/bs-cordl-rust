#[cfg(feature = "cordl_class_PerlinNoise")]
#[repr(C)]
...
impl crate::GlobalNamespace::PerlinNoise {
    ...
    pub fn Grad3D(hash: i32, x: f32, y: f32, z: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (hash, x, y, z))? };
        Ok(__cordl_ret.into())
    }
    pub fn Inc(num: i32, repeat: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (num, repeat))? };
        Ok(__cordl_ret.into())
    }
    pub fn Lerp(a: f32, b: f32, x: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (a, b, x))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OctavePerlin3D(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f32, f32, f32, i32, f32, i32), f32, 6usize>(
                        "OctavePerlin3D",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info.invoke_unchecked((), (x, y, z, octaves, persistence, repeat))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Perlin3D(x: f32, y: f32, z: f32, repeat: i32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: f32 =
            unsafe { cordl_method_info.invoke_unchecked((), (x, y, z, repeat))? };
        Ok(__cordl_ret.into())
    }
