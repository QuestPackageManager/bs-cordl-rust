...
#[cfg(feature = "cordl_class_IServerBeatmapProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IServerBeatmapProvider {
...
impl crate::GlobalNamespace::IServerBeatmapProvider {
    ...
    pub fn VerifyBeatmapForSelectionMask(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        crate::GlobalNamespace::BeatmapLevelSelectionMask,
                    ), bool, 2usize>("VerifyBeatmapForSelectionMask")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (beatmapKeySerializable, selectionMask))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_IServerBeatmapProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::IServerBeatmapProvider {
