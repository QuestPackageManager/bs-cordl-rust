...
for crate::GlobalNamespace::LoadGameLoaderAfterSplashScreen {
    ...
    const CLASS_NAME: &'static str = "LoadGameLoaderAfterSplashScreen";
...
impl crate::GlobalNamespace::LoadGameLoaderAfterSplashScreen {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LoadGameLoaderAfterSplashScreen as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LoadGameLoaderAfterSplashScreen as
