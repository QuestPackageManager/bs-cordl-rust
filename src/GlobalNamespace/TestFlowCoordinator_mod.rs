...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TestFlowCoordinator {
    ...
    const CLASS_NAME: &'static str = "TestFlowCoordinator";
...
impl crate::GlobalNamespace::TestFlowCoordinator {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TestFlowCoordinator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TestFlowCoordinator as
