#[cfg(feature = "cordl_class_GraphicSettingsViewController")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_GraphicSettingsViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GraphicSettingsViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GraphicSettingsViewController";
...
#[cfg(feature = "cordl_class_GraphicSettingsViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::GraphicSettingsViewController {
