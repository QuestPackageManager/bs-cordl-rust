...
pub struct PlatformAuthenticationTokenProvider {
    ...
    pub _cachedXPlatformAccessToken: XPlatformAccessTokenData,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for PlatformAuthenticationTokenProvider => ""
    ."PlatformAuthenticationTokenProvider"
);
#[cfg(feature = "PlatformAuthenticationTokenProvider")]
impl std::ops::Deref for PlatformAuthenticationTokenProvider {
...
#[cfg(feature = "PlatformAuthenticationTokenProvider")]
impl std::ops::DerefMut for PlatformAuthenticationTokenProvider {
...
#[cfg(feature = "PlatformAuthenticationTokenProvider")]
impl quest_hook::libil2cpp::ObjectType for PlatformAuthenticationTokenProvider {
