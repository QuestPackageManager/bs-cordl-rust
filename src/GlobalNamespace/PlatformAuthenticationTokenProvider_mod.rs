...
impl crate::GlobalNamespace::PlatformAuthenticationTokenProvider {
    ...
    pub fn GetAuthenticationToken(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformAuthenticationTokenProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Threading::Tasks::Task_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PlatformAuthenticationTokenProvider as
                    quest_hook::libil2cpp::Type > ::class(), "GetAuthenticationToken",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformAuthenticationTokenProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlatformAuthenticationTokenProvider as
                    quest_hook::libil2cpp::Type > ::class(), "GetTokenPlatform", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformAuthenticationTokenProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlatformAuthenticationTokenProvider as
                    quest_hook::libil2cpp::Type > ::class(), "GetXPlatformAccessToken",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            method.invoke_unchecked(self, (cancellationToken, skipCacheRead))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (platformUserModel, userInfo))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformAuthenticationTokenProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlatformAuthenticationTokenProvider as
                    quest_hook::libil2cpp::Type > ::class(), "get_hashedUserId", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlatformAuthenticationTokenProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlatformAuthenticationTokenProvider as
                    quest_hook::libil2cpp::Type > ::class(), "get_platform", 0usize
                )
            });
        let __cordl_ret: crate::GlobalNamespace::AuthenticationToken_Platform = unsafe {
