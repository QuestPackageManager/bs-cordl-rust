...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CopyPosition {
    ...
    const CLASS_NAME: &'static str = "CopyPosition";
...
impl crate::GlobalNamespace::CopyPosition {
    ...
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CopyPosition as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CopyPosition as quest_hook::libil2cpp::Type
                    > ::class(), "Awake", 0usize
                )
            });
...
for crate::GlobalNamespace::CopyPosition_CopyPositionUpdater {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "CopyPosition/CopyPositionUpdater";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::CopyPosition_CopyPositionUpdater {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CopyPosition_CopyPositionUpdater as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<crate::GlobalNamespace::CopyPosition>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CopyPosition_CopyPositionUpdater as
                    quest_hook::libil2cpp::Type > ::class(), "Add", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (copyPosition))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LateUpdate(
