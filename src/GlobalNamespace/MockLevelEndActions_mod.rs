...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for MockLevelEndActions => ""."MockLevelEndActions"
);
#[cfg(feature = "MockLevelEndActions")]
impl std::ops::Deref for MockLevelEndActions {
...
#[cfg(feature = "MockLevelEndActions")]
impl std::ops::DerefMut for MockLevelEndActions {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "MockLevelEndActions")]
impl MockLevelEndActions {
...
#[cfg(feature = "MockLevelEndActions")]
impl quest_hook::libil2cpp::ObjectType for MockLevelEndActions {
