...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for IGameNoteMirrorable => ""."IGameNoteMirrorable"
);
#[cfg(feature = "IGameNoteMirrorable")]
impl std::ops::Deref for IGameNoteMirrorable {
...
#[cfg(feature = "IGameNoteMirrorable")]
impl std::ops::DerefMut for IGameNoteMirrorable {
...
#[cfg(feature = "IGameNoteMirrorable")]
impl quest_hook::libil2cpp::ObjectType for IGameNoteMirrorable {
