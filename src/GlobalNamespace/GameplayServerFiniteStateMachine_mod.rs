...
pub struct GameplayServerFiniteStateMachine {
    ...
    pub _taskUtility_k__BackingField: quest_hook::libil2cpp::Gc<crate::BGNet::Core::ITaskUtility>,
    pub _multiplayerSessionManager_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBeatSaberMultiplayerSessionManager>,
    pub _ownerUserId_k__BackingField:
...
impl crate::GlobalNamespace::GameplayServerFiniteStateMachine {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayRpcManager> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MenuRpcManager> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_taskUtility(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::BGNet::Core::ITaskUtility>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::BGNet::Core::ITaskUtility> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
pub struct GameplayServerFiniteStateMachine_InitParams {
    ...
    pub beatmapProvider: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IServerBeatmapProvider>,
}
#[cfg(feature = "cordl_class_GameplayServerFiniteStateMachine+InitParams")]
unsafe impl quest_hook::libil2cpp::Type
...
impl crate::GlobalNamespace::GameplayServerFiniteStateMachine_InitParams {
    pub fn _ctor(
        ...
        beatmapProvider: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IServerBeatmapProvider>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
