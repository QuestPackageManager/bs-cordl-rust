...
for crate::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost {
    ...
    const CLASS_NAME: &'static str = "DeactivateMenuControllersOnFocusCaptureOrTrackingLost";
...
impl crate::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost as quest_hook::libil2cpp::Type>::class()
    ...
    pub fn SetActiveMenuController(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, quest_hook::libil2cpp::Gc<crate::GlobalNamespace::VRController>),
                quest_hook::libil2cpp::Void,
                2usize,
            >("SetActiveMenuController")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ...
                    "SetActiveMenuController", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (active, vrController))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    ::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost
                    as quest_hook::libil2cpp::Type > ::class(),
                    "UpdateMenuControllersState", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::DeactivateMenuControllersOnFocusCaptureOrTrackingLost
                    as quest_hook::libil2cpp::Type > ::class(), "get_loggerPrefix",
                    0usize
                )
            });
