...
impl crate::GlobalNamespace::StringExtensions {
    pub fn AnyContains(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (stringArray, value, stringComparison))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Contains(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (source, substring, comp))? };
        Ok(__cordl_ret.into())
    }
    pub fn Truncate(
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (s, length, appendEllipsis))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_StringExtensions")]
