...
for crate::GlobalNamespace::FinishTutorialAchievementHandler {
    ...
    const CLASS_NAME: &'static str = "FinishTutorialAchievementHandler";
...
impl crate::GlobalNamespace::FinishTutorialAchievementHandler {
    pub fn HandleTutorialFinished(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FinishTutorialAchievementHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FinishTutorialAchievementHandler as
                    quest_hook::libil2cpp::Type > ::class(), "HandleTutorialFinished",
                    0usize
                )
            });
