...
#[cfg(feature = "cordl_class_NetworkPlayerTableCell")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NetworkPlayerTableCell {
...
impl crate::GlobalNamespace::NetworkPlayerTableCell {
    ...
    pub fn get_activeColor(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn set_showSeparator(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_showSeparator")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_NetworkPlayerTableCell")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NetworkPlayerTableCell {
