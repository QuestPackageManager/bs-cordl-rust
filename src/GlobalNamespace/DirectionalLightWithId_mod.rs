...
for crate::GlobalNamespace::DirectionalLightWithId {
    ...
    const CLASS_NAME: &'static str = "DirectionalLightWithId";
...
impl crate::GlobalNamespace::DirectionalLightWithId {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DirectionalLightWithId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DirectionalLightWithId as
