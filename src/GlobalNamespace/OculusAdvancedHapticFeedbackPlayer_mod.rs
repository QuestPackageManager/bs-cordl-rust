...
impl crate::GlobalNamespace::OculusAdvancedHapticFeedbackPlayer {
    ...
    pub fn GetHapticClip(
        node: crate::UnityEngine::XR::XRNode,
        hapticPreset: quest_hook::libil2cpp::Gc<crate::Libraries::HM::HMLib::VR::HapticPresetSO>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Oculus::Haptics::HapticClip>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::UnityEngine::XR::XRNode,
                        quest_hook::libil2cpp::Gc<crate::Libraries::HM::HMLib::VR::HapticPresetSO>,
                    ), quest_hook::libil2cpp::Gc<crate::Oculus::Haptics::HapticClip>, 2usize>(
                        "GetHapticClip",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Oculus::Haptics::HapticClip> =
            unsafe { cordl_method_info.invoke_unchecked((), (node, hapticPreset))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsTouchControllerSupported(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::UnityEngine::XR::XRNode), bool, 1usize>(
