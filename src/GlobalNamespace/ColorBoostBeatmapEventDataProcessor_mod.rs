...
for crate::GlobalNamespace::ColorBoostBeatmapEventDataProcessor {
    ...
    const CLASS_NAME: &'static str = "ColorBoostBeatmapEventDataProcessor";
...
impl crate::GlobalNamespace::ColorBoostBeatmapEventDataProcessor {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ColorBoostBeatmapEventDataProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ColorBoostBeatmapEventDataProcessor as
