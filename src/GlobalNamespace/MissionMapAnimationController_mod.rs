...
impl crate::GlobalNamespace::MissionMapAnimationController {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::IEnumerator,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (lastClearedMissionNode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateMissionMapAfterMissionWasCleared(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (animated, finishCallback))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (lastClearedMissionNode, finishCallback))?
        };
        Ok(__cordl_ret.into())
    }
