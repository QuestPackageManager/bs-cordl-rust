#[cfg(feature = "cordl_class_MissionMapAnimationController")]
#[repr(C)]
...
pub struct MissionMapAnimationController {
    ...
    pub _shockwaveEffect: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MenuShockwave>,
}
#[cfg(feature = "cordl_class_MissionMapAnimationController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissionMapAnimationController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MissionMapAnimationController";
...
impl crate::GlobalNamespace::MissionMapAnimationController {
    ...
    pub fn UpdateClearedNodeStateCoroutine(
        &mut self,
        lastClearedMissionNode: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNode>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator> =
            unsafe { cordl_method_info.invoke_unchecked(self, (lastClearedMissionNode))? };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateMissionMapAfterMissionWasCleared(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (animated, finishCallback))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator> = unsafe {
            cordl_method_info.invoke_unchecked(self, (lastClearedMissionNode, finishCallback))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MissionMapAnimationController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissionMapAnimationController {
