...
#[cfg(feature = "IGameEnergyCounter")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IGameEnergyCounter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IGameEnergyCounter";
...
impl crate::GlobalNamespace::IGameEnergyCounter {
    pub fn add_didInitEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IGameEnergyCounter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IGameEnergyCounter as
