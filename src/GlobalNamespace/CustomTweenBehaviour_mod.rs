...
impl crate::GlobalNamespace::CustomTweenBehaviour {
    ...
    pub fn OnBehaviourPlay(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CustomTweenBehaviour as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CustomTweenBehaviour as
