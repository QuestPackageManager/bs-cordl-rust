#[cfg(feature = "cordl_class_CrashInfoViewController")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_CrashInfoViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CrashInfoViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "CrashInfoViewController";
...
#[cfg(feature = "cordl_class_CrashInfoViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::CrashInfoViewController {
