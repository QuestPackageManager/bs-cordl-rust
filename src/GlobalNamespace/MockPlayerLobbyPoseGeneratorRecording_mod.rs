...
for crate::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording {
    ...
    const CLASS_NAME: &'static str = "MockPlayerLobbyPoseGeneratorRecording";
...
impl crate::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Init")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MockPlayerLobbyPoseGeneratorRecording as
