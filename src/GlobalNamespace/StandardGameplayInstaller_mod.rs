...
pub struct StandardGameplayInstaller {
    ...
    pub _gameplayAdditionalInformation:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayAdditionalInformationSetupData>,
}
#[cfg(feature = "cordl_class_StandardGameplayInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::StandardGameplayInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StandardGameplayInstaller";
...
#[cfg(feature = "cordl_class_StandardGameplayInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::StandardGameplayInstaller {
