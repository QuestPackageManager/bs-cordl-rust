    ...
    for crate::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<TBase>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "BeatmapDataSortedListForTypeAndIds`1")
                .unwrap()
                .make_generic::<(TBase)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "BeatmapDataSortedListForTypeAndIds_1")]
impl<TBase: quest_hook::libil2cpp::Type>
    crate::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<TBase>
{
    pub fn GetCount<T>(&mut self, typeIdentifier: i32) -> quest_hook::libil2cpp::Result<i32>
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (typeIdentifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetItems<T>(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ISortedList_1<TBase>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, typeIdentifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn InsertItem(
        &mut self,
