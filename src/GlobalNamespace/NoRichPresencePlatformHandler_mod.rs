...
pub struct NoRichPresencePlatformHandler {
    ...
    pub _currentPresenceApiName_k__BackingField:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_NoRichPresencePlatformHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoRichPresencePlatformHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "NoRichPresencePlatformHandler";
...
impl crate::GlobalNamespace::NoRichPresencePlatformHandler {
    ...
    pub fn SetPresence(
        &mut self,
        richPresenceData: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IRichPresenceData>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (richPresenceData))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_currentPresenceApiName", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_currentPresenceApiName", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_NoRichPresencePlatformHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NoRichPresencePlatformHandler {
