...
for crate::GlobalNamespace::MockPlatformUserModel {
    ...
    const CLASS_NAME: &'static str = "MockPlatformUserModel";
...
impl crate::GlobalNamespace::MockPlatformUserModel {
    pub fn GetUserAuthToken(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MockPlatformUserModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Threading::Tasks::Task_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MockPlatformUserModel as
