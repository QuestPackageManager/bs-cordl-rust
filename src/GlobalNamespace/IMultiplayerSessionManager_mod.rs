...
for crate::GlobalNamespace::IMultiplayerSessionManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IMultiplayerSessionManager";
...
#[cfg(feature = "IMultiplayerSessionManager")]
impl std::ops::Deref for crate::GlobalNamespace::IMultiplayerSessionManager {
...
#[cfg(feature = "IMultiplayerSessionManager")]
impl std::ops::DerefMut for crate::GlobalNamespace::IMultiplayerSessionManager {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "IMultiplayerSessionManager")]
impl crate::GlobalNamespace::IMultiplayerSessionManager {
    pub fn Disconnect(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IMultiplayerSessionManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Disconnect")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::IMultiplayerSessionManager as
