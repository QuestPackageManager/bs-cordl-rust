...
#[cfg(feature = "LobbyStateDataModel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LobbyStateDataModel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LobbyStateDataModel";
...
impl crate::GlobalNamespace::LobbyStateDataModel {
    pub fn Activate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LobbyStateDataModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Activate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::LobbyStateDataModel as
