#[cfg(feature = "cordl_class_ISaberSwingRatingCounterDidFinishReceiver")]
#[derive(Debug)]
#[repr(C)]
...
impl std::ops::Deref for crate::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver {
...
#[cfg(feature = "ISaberSwingRatingCounterDidFinishReceiver")]
impl std::ops::DerefMut for crate::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver {
...
impl crate::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver {
    pub fn HandleSaberSwingRatingCounterDidFinish(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (saberSwingRatingCounter))? };
        Ok(__cordl_ret.into())
    }
