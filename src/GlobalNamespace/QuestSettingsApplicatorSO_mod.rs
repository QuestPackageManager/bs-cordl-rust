...
impl crate::GlobalNamespace::QuestSettingsApplicatorSO {
    pub fn ApplyGraphicSettings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::QuestSettingsApplicatorSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::QuestSettingsApplicatorSO as
