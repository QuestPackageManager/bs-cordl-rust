...
impl crate::GlobalNamespace::StandardLevelDetailView {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (beatmapKey, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleBeatmapCharacteristicSegmentedControlControllerDidSelectBeatmapCharacteristic(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (controller, beatmapCharacteristic))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleBeatmapDifficultySegmentedControlControllerDidSelectDifficulty(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (controller, difficulty))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleBeatmapLevelsModelLevelDownloadingUpdate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (levelDownloadingUpdate))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetBeatmapLevelVersions", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetContentForBeatmapData", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn ShowContent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (contentType, progress))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TriggerEvent(
