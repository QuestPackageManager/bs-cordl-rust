...
pub struct StandardLevelDetailView {
    ...
    pub _levelParamsPanel: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LevelParamsPanel>,
    pub _levelParamsPanelCanvasGroup: quest_hook::libil2cpp::Gc<crate::UnityEngine::CanvasGroup>,
    ...
    pub _beatmapLevelVersionsWrapper: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
    pub _beatmapLevelVersionText: quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshProUGUI>,
    pub _beatmapLevelDataVersionText: quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshProUGUI>,
    ...
    pub didFavoriteToggleChangeEvent: quest_hook::libil2cpp::Gc<
        crate::System::Action_1<quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle>>,
    >,
    ...
    pub _checkExistsCancellationTokenSource:
        quest_hook::libil2cpp::Gc<crate::System::Threading::CancellationTokenSource>,
    pub _levelParamsPanelCanvasGroupTween: quest_hook::libil2cpp::Gc<crate::Tweening::Tween>,
}
#[cfg(feature = "cordl_class_StandardLevelDetailView")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::StandardLevelDetailView {
...
impl crate::GlobalNamespace::StandardLevelDetailView {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> =
            unsafe { cordl_method_info.invoke_unchecked(self, (beatmapKey, cancellationToken))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> = unsafe {
            cordl_method_info.invoke_unchecked(self, (beatmapLevelId, cancellationToken))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ClearBeatmapLevel(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearBeatmapLevel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn CreateBeatmapKey(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::BeatmapKey, 0usize>(
                        "CreateBeatmapKey",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn HandleBeatmapCharacteristicSegmentedControlControllerDidSelectBeatmapCharacteristic(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (controller, beatmapCharacteristic))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleBeatmapDifficultySegmentedControlControllerDidSelectDifficulty(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (controller, difficulty))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleBeatmapLevelsModelLevelDownloadingUpdate", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (levelDownloadingUpdate))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetContent_1(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetContent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 6usize>("SetContent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (notesCount, obstaclesCount, bombsCount, songLength))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ShowContent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (contentType, progress))? };
        Ok(__cordl_ret.into())
    }
    pub fn TriggerEvent(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("TriggerEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _Awake_b__47_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("<Awake>b__47_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_StandardLevelDetailView")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::StandardLevelDetailView {
