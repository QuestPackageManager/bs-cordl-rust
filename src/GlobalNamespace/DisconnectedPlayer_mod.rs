...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::DisconnectedPlayer {
    ...
    const CLASS_NAME: &'static str = "DisconnectedPlayer";
...
impl crate::GlobalNamespace::DisconnectedPlayer {
    pub fn HasState(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DisconnectedPlayer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::DisconnectedPlayer as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (userId, userName, sortIndex))?
        };
        Ok(__cordl_ret.into())
    }
