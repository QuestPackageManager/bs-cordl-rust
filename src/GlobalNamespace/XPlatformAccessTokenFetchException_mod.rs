...
for crate::GlobalNamespace::XPlatformAccessTokenFetchException {
    ...
    const CLASS_NAME: &'static str = "XPlatformAccessTokenFetchException";
...
impl crate::GlobalNamespace::XPlatformAccessTokenFetchException {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::XPlatformAccessTokenFetchException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::XPlatformAccessTokenFetchException as
