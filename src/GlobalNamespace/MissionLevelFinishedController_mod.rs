#[cfg(feature = "cordl_class_MissionLevelFinishedController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MissionLevelFinishedController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissionLevelFinishedController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MissionLevelFinishedController";
...
#[cfg(feature = "cordl_class_MissionLevelFinishedController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissionLevelFinishedController {
