...
impl crate::GlobalNamespace::MissionLevelFinishedController {
    pub fn HandleLevelFinished(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MissionLevelFinishedController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MissionLevelFinishedController as
