...
pub struct BloomPrePass {
    ...
    pub _bloomPrePassRenderData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BloomPrePassRenderDataSO>,
    pub _mode: crate::GlobalNamespace::BloomPrePass_Mode,
    pub _renderData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BloomPrePassRenderDataSO_Data>,
}
#[cfg(feature = "cordl_class_BloomPrePass")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomPrePass {
    ...
    const CLASS_NAME: &'static str = "BloomPrePass";
...
impl crate::GlobalNamespace::BloomPrePass {
    ...
    pub fn OnPreRender(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnPreRender")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetMode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (crate::GlobalNamespace::BloomPrePass_Mode),
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomPrePass_Mode {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BloomPrePass/Mode";
...
#[cfg(feature = "cordl_class_BloomPrePass+Mode")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::BloomPrePass_Mode {
    type Type = Self;
...
#[cfg(feature = "cordl_class_BloomPrePass+Mode")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::BloomPrePass_Mode {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_BloomPrePass+Mode")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::BloomPrePass_Mode {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
