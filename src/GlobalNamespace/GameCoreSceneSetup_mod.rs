...
#[cfg(feature = "GameCoreSceneSetup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GameCoreSceneSetup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GameCoreSceneSetup";
...
impl crate::GlobalNamespace::GameCoreSceneSetup {
    ...
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameCoreSceneSetup as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::GameCoreSceneSetup as
