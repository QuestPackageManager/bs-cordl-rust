...
for crate::GlobalNamespace::EnvironmentSpawnRotation {
    ...
    const CLASS_NAME: &'static str = "EnvironmentSpawnRotation";
...
impl crate::GlobalNamespace::EnvironmentSpawnRotation {
    pub fn FixedUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnvironmentSpawnRotation as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FixedUpdate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EnvironmentSpawnRotation as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnvironmentSpawnRotation as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "HandleSpawnRotationBeatmapEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn get_targetRotation(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnvironmentSpawnRotation as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("get_targetRotation")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::EnvironmentSpawnRotation as
                    quest_hook::libil2cpp::Type > ::class(), "get_targetRotation", 0usize
                )
            });
