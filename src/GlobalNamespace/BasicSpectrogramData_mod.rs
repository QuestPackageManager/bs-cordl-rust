...
pub struct BasicSpectrogramData {
    ...
    pub _processedSamples:
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<f32>>,
}
#[cfg(feature = "cordl_class_BasicSpectrogramData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BasicSpectrogramData {
...
impl crate::GlobalNamespace::BasicSpectrogramData {
    ...
    pub fn GetFakeSamples(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (samples))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProcessSamples(
        &mut self,
        sourceSamples: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<f32>>,
                    ), quest_hook::libil2cpp::Void, 2usize>("ProcessSamples")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (sourceSamples, processedSamples))? };
        Ok(__cordl_ret.into())
    }
