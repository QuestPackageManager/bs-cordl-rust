...
#[cfg(feature = "OVRResources")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRResources {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRResources";
...
impl crate::GlobalNamespace::OVRResources {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRResources as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OVRResources as quest_hook::libil2cpp::Type
                    > ::class(), "Load", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRResources as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRResources as quest_hook::libil2cpp::Type
                    > ::class(), "SetResourceBundle", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (bundle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
