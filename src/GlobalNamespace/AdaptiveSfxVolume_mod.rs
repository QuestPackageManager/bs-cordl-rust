...
pub struct AdaptiveSfxVolume {
    ...
    pub _initData: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AdaptiveSfxVolume_InitData>,
    pub _minThreshold: f32,
    pub _buffer: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MomentaryLoudnessBuffer>,
    pub _lufsMeter: quest_hook::libil2cpp::Gc<crate::LufsMetering::LufsMeter>,
    pub _loudnessHistory:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MomentaryLoudnessHistory>,
}
#[cfg(feature = "cordl_class_AdaptiveSfxVolume")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AdaptiveSfxVolume {
    ...
    const CLASS_NAME: &'static str = "AdaptiveSfxVolume";
...
impl crate::GlobalNamespace::AdaptiveSfxVolume {
    ...
    pub fn ApplyLoudness(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("ApplyLoudness")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (songLoudness))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_AdaptiveSfxVolume+InitData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AdaptiveSfxVolume_InitData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "AdaptiveSfxVolume/InitData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
impl crate::GlobalNamespace::AdaptiveSfxVolume_InitData {
    ...
    pub fn _ctor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32, bool, i32), quest_hook::libil2cpp::Void, 3usize>(".ctor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (userSettingsVolumeOffset, adaptiveSfx, frequency))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_AdaptiveSfxVolume+InitData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AdaptiveSfxVolume_InitData {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
