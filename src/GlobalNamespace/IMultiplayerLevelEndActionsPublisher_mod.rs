...
for crate::GlobalNamespace::IMultiplayerLevelEndActionsPublisher {
    ...
    const CLASS_NAME: &'static str = "IMultiplayerLevelEndActionsPublisher";
...
impl crate::GlobalNamespace::IMultiplayerLevelEndActionsPublisher {
    pub fn add_playerDidFinishEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IMultiplayerLevelEndActionsPublisher as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::System::Action_1<
                        quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IMultiplayerLevelEndActionsPublisher as
