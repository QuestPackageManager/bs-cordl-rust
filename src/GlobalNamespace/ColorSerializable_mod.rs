...
#[cfg(feature = "cordl_class_ColorSerializable")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::ColorSerializable {
    type Type = Self;
...
#[cfg(feature = "cordl_class_ColorSerializable")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::ColorSerializable {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_ColorSerializable")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::ColorSerializable {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_ColorSerializable")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::ColorSerializable {
    type Type = Self;
...
impl crate::GlobalNamespace::ColorSerializable {
    ...
    pub fn Equals_ColorSerializable0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::ColorSerializable), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn op_Implicit_Color1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        (crate::UnityEngine::Color),
                        crate::GlobalNamespace::ColorSerializable,
                        1usize,
                    >("op_Implicit")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::GlobalNamespace::ColorSerializable =
...
impl AsRef<crate::System::IEquatable_1<crate::GlobalNamespace::ColorSerializable>>
    for crate::GlobalNamespace::ColorSerializable
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::GlobalNamespace::ColorSerializable> {
        todo!()
    }
}
#[cfg(feature = "ColorSerializable")]
