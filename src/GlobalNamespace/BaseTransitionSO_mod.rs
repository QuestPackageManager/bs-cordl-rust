...
impl crate::GlobalNamespace::BaseTransitionSO {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BaseTransitionSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TransitionTimingSO>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BaseTransitionSO as
                    quest_hook::libil2cpp::Type > ::class(), "GetTransitionTiming",
                    0usize
                )
            });
