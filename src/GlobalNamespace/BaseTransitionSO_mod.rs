...
pub struct BaseTransitionSO {
    ...
    pub _transitionTiming: *mut TransitionTimingSO,
}
#[cfg(feature = "BaseTransitionSO")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BaseTransitionSO => ""."BaseTransitionSO"
);
#[cfg(feature = "BaseTransitionSO")]
impl std::ops::Deref for BaseTransitionSO {
...
#[cfg(feature = "BaseTransitionSO")]
impl std::ops::DerefMut for BaseTransitionSO {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BaseTransitionSO")]
impl BaseTransitionSO {
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "BaseTransitionSO")]
impl quest_hook::libil2cpp::ObjectType for BaseTransitionSO {
