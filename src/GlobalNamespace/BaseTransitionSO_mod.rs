...
pub struct BaseTransitionSO {
    ...
    pub _transitionTiming: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TransitionTimingSO>,
}
#[cfg(feature = "cordl_class_BaseTransitionSO")]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetTransitionTiming", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TransitionTimingSO> =
