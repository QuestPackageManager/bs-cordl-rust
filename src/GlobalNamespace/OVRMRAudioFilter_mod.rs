...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRMRAudioFilter {
    ...
    const CLASS_NAME: &'static str = "OVRMRAudioFilter";
...
#[cfg(feature = "OVRMRAudioFilter")]
impl crate::GlobalNamespace::OVRMRAudioFilter {
    ...
    pub fn OnAudioFilterRead(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRMRAudioFilter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OVRMRAudioFilter as
                    quest_hook::libil2cpp::Type > ::class(), "OnAudioFilterRead", 2usize
                )
            });
