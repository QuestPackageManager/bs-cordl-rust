#[cfg(feature = "cordl_class_PlayingCampaignRichPresenceData")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::PlayingCampaignRichPresenceData
{
    ...
    const CLASS_NAME: &'static str = "PlayingCampaignRichPresenceData";
...
impl crate::GlobalNamespace::PlayingCampaignRichPresenceData {
    pub const kPlayingCampaignRichPresenceLocalizationKey: &'static str =
        "PLAYING_CAMPAIGN_PRESENCE";
...
#[cfg(feature = "cordl_class_PlayingCampaignRichPresenceData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PlayingCampaignRichPresenceData {
