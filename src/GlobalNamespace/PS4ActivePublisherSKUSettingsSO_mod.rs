...
for crate::GlobalNamespace::PS4ActivePublisherSKUSettingsSO {
    ...
    const CLASS_NAME: &'static str = "PS4ActivePublisherSKUSettingsSO";
...
impl crate::GlobalNamespace::PS4ActivePublisherSKUSettingsSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PS4ActivePublisherSKUSettingsSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PS4ActivePublisherSKUSettingsSO as
