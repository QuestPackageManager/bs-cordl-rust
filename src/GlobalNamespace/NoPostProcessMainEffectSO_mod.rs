...
pub struct NoPostProcessMainEffectSO {
    ...
    pub _setAlphaShader: quest_hook::libil2cpp::Gc<crate::UnityEngine::Shader>,
...
impl crate::GlobalNamespace::NoPostProcessMainEffectSO {
    ...
    pub fn PostRender(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (fade))? };
        Ok(__cordl_ret.into())
    }
    pub fn PreRender(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_NoPostProcessMainEffectSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::NoPostProcessMainEffectSO {
