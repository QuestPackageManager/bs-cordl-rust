#[cfg(feature = "cordl_class_EditColorSchemeController")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct EditColorSchemeController {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _colorSchemeColorsToggleGroup:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSchemeColorsToggleGroup>,
    pub _rgbPanelController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RGBPanelController>,
    ...
    pub didChangeColorSchemeEvent: quest_hook::libil2cpp::Gc<
        crate::System::Action_1<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorScheme>>,
    >,
    pub _buttonBinder: quest_hook::libil2cpp::Gc<crate::HMUI::ButtonBinder>,
}
#[cfg(feature = "cordl_class_EditColorSchemeController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EditColorSchemeController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EditColorSchemeController";
...
impl crate::GlobalNamespace::EditColorSchemeController {
    ...
    pub fn _Start_b__13_0(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<Start>b__13_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_EditColorSchemeController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EditColorSchemeController {
