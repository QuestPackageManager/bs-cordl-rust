...
for crate::GlobalNamespace::SignalOnToggleChange {
    ...
    const CLASS_NAME: &'static str = "SignalOnToggleChange";
...
#[cfg(feature = "SignalOnToggleChange")]
impl crate::GlobalNamespace::SignalOnToggleChange {
    ...
    pub fn OnDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SignalOnToggleChange as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDestroy")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SignalOnToggleChange as
    ...
    pub fn RaiseSignal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SignalOnToggleChange as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("RaiseSignal")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SignalOnToggleChange as
                    quest_hook::libil2cpp::Type > ::class(), "RaiseSignal", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
