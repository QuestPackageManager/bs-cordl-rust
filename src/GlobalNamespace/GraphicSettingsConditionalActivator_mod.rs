...
impl crate::GlobalNamespace::GraphicSettingsConditionalActivator {
    ...
    pub fn GetGraphicsActivatorType(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GraphicSettingsConditionalActivator as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("GetGraphicsActivatorType")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::GraphicSettingsConditionalActivator as
                    quest_hook::libil2cpp::Type > ::class(), "GetGraphicsActivatorType",
                    0usize
                )
            });
