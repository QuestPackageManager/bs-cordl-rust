#[cfg(feature = "cordl_class_OculusVRHelper")]
#[repr(C)]
...
pub struct OculusVRHelper {
    ...
    pub controllersDidChangeReferenceEvent: quest_hook::libil2cpp::Gc<crate::System::Action>,
    ...
    pub _disabledEventSystem:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::EventSystems::EventSystem>,
}
#[cfg(feature = "cordl_class_OculusVRHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OculusVRHelper {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OculusVRHelper";
...
impl std::ops::Deref for crate::GlobalNamespace::OculusVRHelper {
...
#[cfg(feature = "OculusVRHelper")]
impl std::ops::DerefMut for crate::GlobalNamespace::OculusVRHelper {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "OculusVRHelper")]
impl crate::GlobalNamespace::OculusVRHelper {
    pub const kHorizontalLeftHand: &'static str = "HorizontalLeftHand";
    pub const kHorizontalRightHand: &'static str = "HorizontalRightHand";
    pub const kVerticalLeftHand: &'static str = "VerticalLeftHand";
    pub const kVerticalRightHand: &'static str = "VerticalRightHand";
    pub fn DisableEventSystem(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("DisableEventSystem")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn EnableEventSystem(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("EnableEventSystem")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetAnyJoystickMaxAxis(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector2, 0usize>("GetAnyJoystickMaxAxis")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetInteractionProfile(
        &mut self,
        node: crate::UnityEngine::XR::XRNode,
    ) -> quest_hook::libil2cpp::Result<crate::GlobalNamespace::OVRInput_InteractionProfile> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetInteractionProfile", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::OVRInput_InteractionProfile =
    ...
    pub fn GetNodePose(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (nodeType, idx, pos, rot))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetTriggerValue(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::XR::XRNode), f32, 1usize>("GetTriggerValue")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (node))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsAdvancedHapticsSupported(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::XR::XRNode), bool, 1usize>(
    ...
    pub fn TriggerHapticPulse(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (node, duration, strength, frequency))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryGetLegacyPoseOffsetForNode(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Vector3>,
                        quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Vector3>,
                    ), bool, 3usize>("TryGetLegacyPoseOffsetForNode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (node, position, rotation))? };
        Ok(__cordl_ret.into())
    }
    pub fn TryGetPoseOffsetForNode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 2usize>("TryGetPoseOffsetForNode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (node, poseOffset))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "XRNodeToOVRNode", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::OVRPlugin_Node =
            unsafe { cordl_method_info.invoke_unchecked((), (node))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get__isOVRManagerPresent(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get__isOVRManagerPresent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_vrPlatformSDK(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::VRPlatformSDK, 0usize>(
                        "get_vrPlatformSDK",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::GlobalNamespace::VRPlatformSDK =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_OculusVRHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OculusVRHelper {
...
#[cfg(feature = "OculusVRHelper")]
impl AsRef<crate::GlobalNamespace::IVRPlatformHelper> for crate::GlobalNamespace::OculusVRHelper {
    fn as_ref(&self) -> &crate::GlobalNamespace::IVRPlatformHelper {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "OculusVRHelper")]
impl AsMut<crate::GlobalNamespace::IVRPlatformHelper> for crate::GlobalNamespace::OculusVRHelper {
    fn as_mut(&mut self) -> &mut crate::GlobalNamespace::IVRPlatformHelper {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "OculusVRHelper")]
impl AsRef<crate::GlobalNamespace::IVerboseLogger> for crate::GlobalNamespace::OculusVRHelper {
    fn as_ref(&self) -> &crate::GlobalNamespace::IVerboseLogger {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "OculusVRHelper")]
impl AsMut<crate::GlobalNamespace::IVerboseLogger> for crate::GlobalNamespace::OculusVRHelper {
