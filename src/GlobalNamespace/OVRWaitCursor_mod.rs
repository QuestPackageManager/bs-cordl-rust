...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRWaitCursor {
    ...
    const CLASS_NAME: &'static str = "OVRWaitCursor";
...
impl crate::GlobalNamespace::OVRWaitCursor {
    ...
    pub fn Update(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRWaitCursor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Update")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::OVRWaitCursor as quest_hook::libil2cpp::Type
                    > ::class(), "Update", 0usize
                )
            });
