...
#[cfg(feature = "AsyncComputeManager")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IAsyncComputeManager>>
for crate::GlobalNamespace::AsyncComputeManager {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IAsyncComputeManager> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "AsyncComputeManager")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IAsyncComputeManager>>
for crate::GlobalNamespace::AsyncComputeManager {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IAsyncComputeManager> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "AsyncComputeManager")]
