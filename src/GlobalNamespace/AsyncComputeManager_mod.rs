...
impl crate::GlobalNamespace::AsyncComputeManager {
    pub fn BeginOperation_AsyncComputeOperation0(
        &mut self,
        operation: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AsyncComputeOperation>,
    ...
    pub fn BeginOperation_AsyncComputeOperation_1_1<T>(
        &mut self,
        operation: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AsyncComputeOperation_1<T>>,
