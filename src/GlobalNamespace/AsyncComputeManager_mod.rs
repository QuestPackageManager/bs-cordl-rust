...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for AsyncComputeManager => ""."AsyncComputeManager"
);
#[cfg(feature = "AsyncComputeManager")]
impl std::ops::Deref for AsyncComputeManager {
...
#[cfg(feature = "AsyncComputeManager")]
impl std::ops::DerefMut for AsyncComputeManager {
...
impl AsyncComputeManager {
    pub fn BeginOperation_AsyncComputeOperation0(
        &mut self,
        operation: *mut AsyncComputeOperation,
    ...
    pub fn BeginOperation_AsyncComputeOperation_1_1<T>(
        &mut self,
        operation: *mut AsyncComputeOperation_1<T>,
...
#[cfg(feature = "AsyncComputeManager")]
impl quest_hook::libil2cpp::ObjectType for AsyncComputeManager {
