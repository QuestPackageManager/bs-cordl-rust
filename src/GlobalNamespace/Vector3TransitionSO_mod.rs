...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for Vector3TransitionSO => ""."Vector3TransitionSO"
);
#[cfg(feature = "Vector3TransitionSO")]
impl std::ops::Deref for Vector3TransitionSO {
...
#[cfg(feature = "Vector3TransitionSO")]
impl std::ops::DerefMut for Vector3TransitionSO {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Vector3TransitionSO")]
impl Vector3TransitionSO {
...
#[cfg(feature = "Vector3TransitionSO")]
impl quest_hook::libil2cpp::ObjectType for Vector3TransitionSO {
