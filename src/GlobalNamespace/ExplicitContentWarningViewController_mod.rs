...
for crate::GlobalNamespace::ExplicitContentWarningViewController {
    ...
    const CLASS_NAME: &'static str = "ExplicitContentWarningViewController";
...
impl crate::GlobalNamespace::ExplicitContentWarningViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ExplicitContentWarningViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ExplicitContentWarningViewController as
    ...
    pub fn HandleClickedEvent(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ExplicitContentWarningViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandleClickedEvent")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ExplicitContentWarningViewController as
                    quest_hook::libil2cpp::Type > ::class(), "HandleClickedEvent", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
