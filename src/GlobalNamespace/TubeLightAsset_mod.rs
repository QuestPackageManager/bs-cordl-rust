...
#[cfg(feature = "TubeLightAsset")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TubeLightAsset {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "TubeLightAsset";
...
#[cfg(feature = "TubeLightAsset")]
impl std::ops::DerefMut for crate::GlobalNamespace::TubeLightAsset {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "TubeLightAsset")]
impl crate::GlobalNamespace::TubeLightAsset {
    pub fn CreatePlayable(
        &mut self,
        graph: crate::UnityEngine::Playables::PlayableGraph,
        go: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Playables::Playable> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TubeLightAsset as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TubeLightAsset as
...
#[cfg(feature = "TubeLightAsset")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TubeLightAsset {
