...
impl crate::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData as
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (beatmapKey, beatmapLevel))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        beatmapKey: quest_hook::libil2cpp::ByRefMut<crate::GlobalNamespace::BeatmapKey>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (beatmapKey, beatmapLevel))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_apiName(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData as
                    quest_hook::libil2cpp::Type > ::class(), "get_apiName", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData as
                    quest_hook::libil2cpp::Type > ::class(), "get_localizedDescription",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
