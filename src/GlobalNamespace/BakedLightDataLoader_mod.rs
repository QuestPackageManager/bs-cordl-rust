#[cfg(feature = "cordl_class_BakedLightDataLoader")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BakedLightDataLoader")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BakedLightDataLoader {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_lightmapData", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LightmapDataSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
