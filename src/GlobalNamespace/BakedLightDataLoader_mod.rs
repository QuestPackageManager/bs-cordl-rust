...
impl crate::GlobalNamespace::BakedLightDataLoader {
    ...
    pub fn get_lightmapData(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<*mut crate::GlobalNamespace::LightmapDataSO> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::GlobalNamespace::LightmapDataSO = __cordl_object
            .invoke("get_lightmapData", ())?;
        Ok(__cordl_ret)
    }
    pub fn set_lightmapData(
        &mut self,
        value: *mut crate::GlobalNamespace::LightmapDataSO,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
