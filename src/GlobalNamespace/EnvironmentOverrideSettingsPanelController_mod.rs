...
pub struct EnvironmentOverrideSettingsPanelController {
    ...
    pub _overrideEnvironmentSettings:
...
impl std::ops::Deref for crate::GlobalNamespace::EnvironmentOverrideSettingsPanelController {
...
#[cfg(feature = "EnvironmentOverrideSettingsPanelController")]
impl std::ops::DerefMut for crate::GlobalNamespace::EnvironmentOverrideSettingsPanelController {
...
impl crate::GlobalNamespace::EnvironmentOverrideSettingsPanelController {
    ...
    pub fn SetData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (overrideEnvironmentSettings))? };
        Ok(__cordl_ret.into())
    }
