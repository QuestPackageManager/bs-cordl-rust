...
pub struct PlayerVRControllersManager {
    ...
    pub _rightHandVRController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::VRController>,
}
#[cfg(feature = "cordl_class_PlayerVRControllersManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PlayerVRControllersManager {
...
impl crate::GlobalNamespace::PlayerVRControllersManager {
    pub fn DisableAutoplayForAllControllers(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(
                        "DisableAutoplayForAllControllers",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn SetupAutoplayForAllControllers(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(
                        "SetupAutoplayForAllControllers",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::VRController> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_PlayerVRControllersManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PlayerVRControllersManager {
