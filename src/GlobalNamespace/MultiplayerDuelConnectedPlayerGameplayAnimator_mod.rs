...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator {
...
#[cfg(feature = "MultiplayerDuelConnectedPlayerGameplayAnimator")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator {
...
impl crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator {
    ...
    pub fn HandlePlayerDidFail(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HandlePlayerDidFail")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
