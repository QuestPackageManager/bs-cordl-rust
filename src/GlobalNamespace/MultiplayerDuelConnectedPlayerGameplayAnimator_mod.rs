...
for crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator {
    ...
    const CLASS_NAME: &'static str = "MultiplayerDuelConnectedPlayerGameplayAnimator";
...
impl crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator {
    pub fn AnimateNewLeaderSelected(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator as
                    quest_hook::libil2cpp::Type > ::class(), "AnimateNewLeaderSelected",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (isLeading))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator as
                    quest_hook::libil2cpp::Type > ::class(), "HandlePlayerDidFail",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator as
                    quest_hook::libil2cpp::Type > ::class(), "TransitionIntoFailedState",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
