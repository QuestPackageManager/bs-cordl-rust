...
impl crate::GlobalNamespace::MissedNoteEffectSpawner {
    pub fn HandleNoteWasMissed(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MissedNoteEffectSpawner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MissedNoteEffectSpawner as
