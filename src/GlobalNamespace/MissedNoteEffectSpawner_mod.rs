...
pub struct MissedNoteEffectSpawner {
    ...
    pub _missedNoteFlyingSpriteSpawner:
...
#[cfg(feature = "cordl_class_MissedNoteEffectSpawner")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissedNoteEffectSpawner {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MissedNoteEffectSpawner";
...
#[cfg(feature = "cordl_class_MissedNoteEffectSpawner")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissedNoteEffectSpawner {
