...
pub struct LevelScenesTransitionSetupDataSO {
    ...
    pub _gameplayCoreSceneSetupData_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayCoreSceneSetupData>,
    pub _gameplayAdditionalInformationSetupData_k__BackingField:
...
impl crate::GlobalNamespace::LevelScenesTransitionSetupDataSO {
    ...
    pub fn get_gameplayAdditionalInformationSetupData(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayAdditionalInformationSetupData>,
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_gameplayAdditionalInformationSetupData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_gameplayAdditionalInformationSetupData(
        &mut self,
