...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BlocksBlade => ""."BlocksBlade"
);
#[cfg(feature = "BlocksBlade")]
impl std::ops::Deref for BlocksBlade {
...
#[cfg(feature = "BlocksBlade")]
impl std::ops::DerefMut for BlocksBlade {
...
#[cfg(feature = "BlocksBlade")]
impl quest_hook::libil2cpp::ObjectType for BlocksBlade {
