...
pub struct SongTimeFixedUpdateController {
    ...
    pub songControllerFixedTimeDidUpdateEvent:
        quest_hook::libil2cpp::Gc<crate::System::Action_1<f32>>,
    pub songControllerTimeDidUpdateEvent: quest_hook::libil2cpp::Gc<crate::System::Action>,
    pub _accumulator: f32,
    pub _interpolationFactor: f32,
}
#[cfg(feature = "cordl_class_SongTimeFixedUpdateController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SongTimeFixedUpdateController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SongTimeFixedUpdateController";
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_songControllerFixedTimeDidUpdateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_songControllerTimeDidUpdateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_songControllerFixedTimeDidUpdateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_songControllerTimeDidUpdateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_SongTimeFixedUpdateController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SongTimeFixedUpdateController {
