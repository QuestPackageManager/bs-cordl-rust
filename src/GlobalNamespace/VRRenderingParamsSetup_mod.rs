...
pub struct VRRenderingParamsSetup {
    ...
    pub _applicator: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IRenderingParamsApplicator>,
    pub _sceneSetupData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayCoreSceneSetupData>,
}
#[cfg(feature = "cordl_class_VRRenderingParamsSetup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::VRRenderingParamsSetup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "VRRenderingParamsSetup";
...
#[cfg(feature = "cordl_class_VRRenderingParamsSetup")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::VRRenderingParamsSetup {
