#[cfg(feature = "cordl_class_IEnvironmentColorProvider")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_IEnvironmentColorProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IEnvironmentColorProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IEnvironmentColorProvider";
...
#[cfg(feature = "cordl_class_IEnvironmentColorProvider")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::IEnvironmentColorProvider {
