...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for SonyPublisherSKUSettingsSO => ""
    ."SonyPublisherSKUSettingsSO"
);
#[cfg(feature = "SonyPublisherSKUSettingsSO")]
impl std::ops::Deref for SonyPublisherSKUSettingsSO {
...
#[cfg(feature = "SonyPublisherSKUSettingsSO")]
impl std::ops::DerefMut for SonyPublisherSKUSettingsSO {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "SonyPublisherSKUSettingsSO")]
impl SonyPublisherSKUSettingsSO {
    pub fn get_titleId(
        &mut self,
...
#[cfg(feature = "SonyPublisherSKUSettingsSO")]
impl quest_hook::libil2cpp::ObjectType for SonyPublisherSKUSettingsSO {
