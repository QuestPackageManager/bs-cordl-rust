...
for crate::GlobalNamespace::SongTimeToShaderWriter {
    ...
    const CLASS_NAME: &'static str = "SongTimeToShaderWriter";
...
impl crate::GlobalNamespace::SongTimeToShaderWriter {
    ...
    pub fn Update(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SongTimeToShaderWriter as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Update")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SongTimeToShaderWriter as
