...
impl crate::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (passType, keywords))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_keywords(
...
impl crate::GlobalNamespace::ShaderVariantsSO {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (shaderVariants))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::GlobalNamespace::ShaderVariantsSO_ShaderVariant {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (shader, variants))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_shader(
