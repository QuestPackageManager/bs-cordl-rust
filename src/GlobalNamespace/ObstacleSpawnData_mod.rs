...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ObstacleSpawnData {
    ...
    const CLASS_NAME: &'static str = "ObstacleSpawnData";
...
impl crate::GlobalNamespace::ObstacleSpawnData {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ObstacleSpawnData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ObstacleSpawnData as
