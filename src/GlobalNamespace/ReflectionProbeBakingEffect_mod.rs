#[cfg(feature = "cordl_class_ReflectionProbeBakingEffect")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_ReflectionProbeBakingEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ReflectionProbeBakingEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ReflectionProbeBakingEffect";
...
#[cfg(feature = "cordl_class_ReflectionProbeBakingEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ReflectionProbeBakingEffect {
