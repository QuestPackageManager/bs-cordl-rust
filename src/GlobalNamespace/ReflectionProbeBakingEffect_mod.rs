...
impl crate::GlobalNamespace::ReflectionProbeBakingEffect {
    ...
    pub fn OnRenderImage(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ReflectionProbeBakingEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ReflectionProbeBakingEffect as
