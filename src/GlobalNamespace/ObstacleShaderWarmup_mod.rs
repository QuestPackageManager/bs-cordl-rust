...
pub struct ObstacleShaderWarmup {
    ...
    pub _obstacleMaterialSetter:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ObstacleMaterialSetter>,
    pub _settingsManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SettingsManager>,
}
#[cfg(feature = "cordl_class_ObstacleShaderWarmup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ObstacleShaderWarmup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ObstacleShaderWarmup";
