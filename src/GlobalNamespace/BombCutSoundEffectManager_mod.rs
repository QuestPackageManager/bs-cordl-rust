...
impl crate::GlobalNamespace::BombCutSoundEffectManager {
    pub fn HandleBombCutSoundEffectDidFinish(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BombCutSoundEffectManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BombCutSoundEffectManager as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleBombCutSoundEffectDidFinish", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (bombCutSoundEffect))?
        };
        Ok(__cordl_ret.into())
    }
