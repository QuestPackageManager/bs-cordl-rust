#[cfg(feature = "cordl_class_DeactivateVRControllersOnFocusCapture")]
#[repr(C)]
#[derive(Debug)]
pub struct DeactivateVRControllersOnFocusCapture {
    ...
    pub _vrControllers: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _vrControllerGameObjects: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::GlobalNamespace::DeactivateVRControllersOnFocusCapture
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "DeactivateVRControllersOnFocusCapture";
...
#[cfg(feature = "DeactivateVRControllersOnFocusCapture")]
impl std::ops::Deref for crate::GlobalNamespace::DeactivateVRControllersOnFocusCapture {
...
#[cfg(feature = "DeactivateVRControllersOnFocusCapture")]
impl std::ops::DerefMut for crate::GlobalNamespace::DeactivateVRControllersOnFocusCapture {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "DeactivateVRControllersOnFocusCapture")]
impl crate::GlobalNamespace::DeactivateVRControllersOnFocusCapture {
    ...
    pub fn UpdateVRControllerActiveState(
        &mut self,
