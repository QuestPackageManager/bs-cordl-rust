...
#[cfg(feature = "cordl_class_IntFxBaseData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IntFxBaseData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IntFxBaseData";
...
impl crate::GlobalNamespace::IntFxBaseData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (beat, usePreviousEventValue, value))?
        };
        Ok(__cordl_ret.into())
    }
}
