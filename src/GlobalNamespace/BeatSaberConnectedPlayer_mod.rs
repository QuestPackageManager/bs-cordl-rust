...
#[cfg(feature = "cordl_class_BeatSaberConnectedPlayer")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatSaberConnectedPlayer {
...
impl crate::GlobalNamespace::BeatSaberConnectedPlayer {
    pub fn GetGameSpecificPlayerIdentityData(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::GlobalNamespace::BeatSaberPlayerIdentityPacketData>
    {
        ...
        let __cordl_ret: crate::GlobalNamespace::BeatSaberPlayerIdentityPacketData =
    ...
    pub fn SetMultiplayerAvatarsData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (playerAvatars))? };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateAvatar(
        &mut self,
    ...
    pub fn UpdateIdentity(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (identityData))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "cordl_class_BeatSaberConnectedPlayer")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatSaberConnectedPlayer {
