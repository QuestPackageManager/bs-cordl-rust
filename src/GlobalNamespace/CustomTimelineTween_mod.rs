...
#[cfg(feature = "CustomTimelineTween")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CustomTimelineTween {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "CustomTimelineTween";
...
impl crate::GlobalNamespace::CustomTimelineTween {
    ...
    pub fn OnValidate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CustomTimelineTween as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnValidate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::CustomTimelineTween as
