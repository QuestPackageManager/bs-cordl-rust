#[cfg(feature = "cordl_class_LobbyDataModelInstaller")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_LobbyDataModelInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LobbyDataModelInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LobbyDataModelInstaller";
...
#[cfg(feature = "cordl_class_LobbyDataModelInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LobbyDataModelInstaller {
