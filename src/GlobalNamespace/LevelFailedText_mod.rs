...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LevelFailedText {
    ...
    const CLASS_NAME: &'static str = "LevelFailedText";
...
impl crate::GlobalNamespace::LevelFailedText {
    ...
    pub fn OverrideText(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LevelFailedText as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LevelFailedText as
                    quest_hook::libil2cpp::Type > ::class(), "OverrideText", 1usize
                )
            });
