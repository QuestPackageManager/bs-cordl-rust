...
impl std::ops::Deref for crate::GlobalNamespace::SelectableCellSelectableStateController {
...
#[cfg(feature = "SelectableCellSelectableStateController")]
impl std::ops::DerefMut for crate::GlobalNamespace::SelectableCellSelectableStateController {
...
impl crate::GlobalNamespace::SelectableCellSelectableStateController {
    pub fn HandleSelectableCellHighlightDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (selectableCell, transitionType))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleSelectableCellInteractableDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (interactableCell, interactable))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleSelectableCellSelectionStateDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selectableCell, transitionType, owner))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::HMUI::SelectableCell>,
                        crate::HMUI::SelectableCell_TransitionType,
                    ), quest_hook::libil2cpp::Void, 2usize>("ResolveState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
