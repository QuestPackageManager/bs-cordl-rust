...
impl crate::GlobalNamespace::SelectableCellSelectableStateController {
    pub fn HandleSelectableCellHighlightDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selectableCell, transitionType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleSelectableCellInteractableDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (interactableCell, interactable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleSelectableCellSelectionStateDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (selectableCell, transitionType, owner))?
        };
        Ok(__cordl_ret.into())
    }
