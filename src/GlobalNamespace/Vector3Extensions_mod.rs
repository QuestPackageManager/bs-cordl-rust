#[cfg(feature = "cordl_class_Vector3Extensions")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::Vector3Extensions {
    ...
    pub fn InverseLerp(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (a, b, value))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RotatedAroundPivot(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::Vector3,
                    ), crate::UnityEngine::Vector3, 3usize>("RotatedAroundPivot")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::Vector3 =
            unsafe { cordl_method_info.invoke_unchecked((), (vector, rotation, pivot))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Vector3Extensions")]
