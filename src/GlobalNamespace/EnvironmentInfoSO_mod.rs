...
pub struct EnvironmentInfoSO {
    ...
    pub _environmentSizeData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EnvironmentSizeData>,
    pub _environmentIntensityReductionOptions:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EnvironmentIntensityReductionOptions>,
    pub _environmentKeywords: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<
            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        >,
    >,
    pub _lightGroups: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EnvironmentLightGroups>,
...
impl crate::GlobalNamespace::EnvironmentInfoSO {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ColorSchemeSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_defaultLightshowAsset", 0usize
                        )
                    })
            });
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_environmentIntensityReductionOptions")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IReadOnlyList_1<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    >, 0usize>("get_environmentKeywords")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_environmentLightGroups", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_environmentSizeData", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EnvironmentSizeData> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_environmentType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::EnvironmentType, 0usize>(
                        "get_environmentType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::GlobalNamespace::EnvironmentType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "EnvironmentInfoSO")]
impl AsRef<crate::GlobalNamespace::IEnvironmentInfo> for crate::GlobalNamespace::EnvironmentInfoSO {
    fn as_ref(&self) -> &crate::GlobalNamespace::IEnvironmentInfo {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "EnvironmentInfoSO")]
impl AsMut<crate::GlobalNamespace::IEnvironmentInfo> for crate::GlobalNamespace::EnvironmentInfoSO {
...
#[cfg(feature = "cordl_class_EnvironmentInfoSO+Tags")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnvironmentInfoSO_Tags {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_EnvironmentInfoSO+Tags")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::EnvironmentInfoSO_Tags {
    type Type = Self;
...
#[cfg(feature = "cordl_class_EnvironmentInfoSO+Tags")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::EnvironmentInfoSO_Tags {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_EnvironmentInfoSO+Tags")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::EnvironmentInfoSO_Tags {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_EnvironmentInfoSO+Tags")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::EnvironmentInfoSO_Tags {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
