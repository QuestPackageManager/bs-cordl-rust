...
impl crate::GlobalNamespace::OVRVirtualKeyboard {
    ...
    pub fn ChangeTextContext(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (textContext))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MaxElement(
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (vec))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OnEvent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (eventDataBuffer))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "OnTextCommitFieldChange", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SendVirtualKeyboardInput", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetKeyboardVisibility", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (visible))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ShowKeyboard(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Texture2D> = unsafe {
            cordl_method_info.invoke_unchecked(self, (rawUri, mat))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::GlobalNamespace::OVRVirtualKeyboard_HandInputSource {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyboard, inputSource, hand))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::GlobalNamespace::OVRVirtualKeyboard_InteractorRootTransformOverride {
    ...
    pub fn ApplyOverride(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (interactorOverride))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Enqueue(
