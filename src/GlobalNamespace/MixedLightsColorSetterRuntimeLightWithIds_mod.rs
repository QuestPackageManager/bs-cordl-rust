...
impl crate::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds as
