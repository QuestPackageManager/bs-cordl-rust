    ...
    for crate::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds
{
    ...
    const CLASS_NAME: &'static str = "MixedLightsColorSetterRuntimeLightWithIds";
...
impl std::ops::Deref for crate::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds {
...
#[cfg(feature = "MixedLightsColorSetterRuntimeLightWithIds")]
impl std::ops::DerefMut for crate::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds {
