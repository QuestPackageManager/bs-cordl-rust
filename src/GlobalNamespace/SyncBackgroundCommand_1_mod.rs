...
for crate::GlobalNamespace::SyncBackgroundCommand_1<T> {
    ...
    const CLASS_NAME: &'static str = "SyncBackgroundCommand`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("", "SyncBackgroundCommand`1")
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
                    .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::SyncBackgroundCommand_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SyncBackgroundCommand_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SyncBackgroundCommand_1 < T > as
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SyncBackgroundCommand_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), T, 0usize>("ExecuteInternal")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SyncBackgroundCommand_1 < T > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SyncBackgroundCommand_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_resultTask", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
