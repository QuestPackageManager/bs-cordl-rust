...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for RemoteProcedureCall_1 < T0 > => ""
    ."RemoteProcedureCall`1" < T0 >
);
#[cfg(feature = "RemoteProcedureCall_1")]
impl<T0: quest_hook::libil2cpp::Type> std::ops::Deref for RemoteProcedureCall_1<T0> {
...
#[cfg(feature = "RemoteProcedureCall_1")]
impl<T0: quest_hook::libil2cpp::Type> std::ops::DerefMut for RemoteProcedureCall_1<T0> {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "RemoteProcedureCall_1")]
impl<T0: quest_hook::libil2cpp::Type> RemoteProcedureCall_1<T0> {
