...
impl crate::GlobalNamespace::SliderShaderHelper {
    ...
    pub fn SetColor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (materialPropertyBlock, color))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetInitialProperties_SliderController1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (materialPropertyBlock, sliderController))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetSaberAttractionPoint(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (materialPropertyBlock, attractPoint))?
        };
        Ok(__cordl_ret.into())
    }
