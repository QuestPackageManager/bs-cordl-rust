...
for crate::GlobalNamespace::DisableGCWhileEnabled {
    ...
    const CLASS_NAME: &'static str = "DisableGCWhileEnabled";
...
#[cfg(feature = "DisableGCWhileEnabled")]
impl crate::GlobalNamespace::DisableGCWhileEnabled {
    ...
    pub fn OnDisable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DisableGCWhileEnabled as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnDisable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::DisableGCWhileEnabled as
