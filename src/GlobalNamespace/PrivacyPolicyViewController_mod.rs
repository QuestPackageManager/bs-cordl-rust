...
pub struct PrivacyPolicyViewController {
    ...
    pub _privacyPolicyLocalizedTextAsset:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::LocalizedTextAsset>,
    pub _updateNoticeLocalizationKey:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _showUpdate: bool,
    pub _showIAcceptPrompt: bool,
}
#[cfg(feature = "cordl_class_PrivacyPolicyViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PrivacyPolicyViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PrivacyPolicyViewController";
...
impl crate::GlobalNamespace::PrivacyPolicyViewController {
    ...
    pub fn Init(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, bool), quest_hook::libil2cpp::Void, 2usize>("Init")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (showUpdate, showIAcceptPrompt))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_PrivacyPolicyViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PrivacyPolicyViewController {
