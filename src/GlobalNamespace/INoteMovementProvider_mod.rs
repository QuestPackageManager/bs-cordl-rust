...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for INoteMovementProvider => ""."INoteMovementProvider"
);
#[cfg(feature = "INoteMovementProvider")]
impl std::ops::Deref for INoteMovementProvider {
...
#[cfg(feature = "INoteMovementProvider")]
impl std::ops::DerefMut for INoteMovementProvider {
...
#[cfg(feature = "INoteMovementProvider")]
impl quest_hook::libil2cpp::ObjectType for INoteMovementProvider {
