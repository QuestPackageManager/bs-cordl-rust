...
for crate::GlobalNamespace::SetBlocksBladeSaberGlowColor {
    ...
    const CLASS_NAME: &'static str = "SetBlocksBladeSaberGlowColor";
...
impl crate::GlobalNamespace::SetBlocksBladeSaberGlowColor {
    ...
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SetBlocksBladeSaberGlowColor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SetBlocksBladeSaberGlowColor as
