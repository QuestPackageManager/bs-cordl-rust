...
impl crate::GlobalNamespace::MultiplayerModeSelectionFlowCoordinator {
    ...
    pub fn HandleCreateServerViewControllerDidFinish(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (success, data))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleMultiplayerLobbyConnectionControllerConnectionFailed(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (connectionType, reason))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleMultiplayerLobbyControllerDidFinish(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (viewController, menuButton))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleServerCodeEntryViewControllerDidFinish(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (success, code))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ProcessDeeplinkingToLobby", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn Setup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lobbyDestination))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _PresentConnectionErrorDialog_b__53_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (btnId))?
        };
        Ok(__cordl_ret.into())
    }
