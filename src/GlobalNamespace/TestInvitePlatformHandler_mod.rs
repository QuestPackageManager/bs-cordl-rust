#[cfg(feature = "cordl_class_TestInvitePlatformHandler")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_TestInvitePlatformHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TestInvitePlatformHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "TestInvitePlatformHandler";
...
#[cfg(feature = "cordl_class_TestInvitePlatformHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TestInvitePlatformHandler {
