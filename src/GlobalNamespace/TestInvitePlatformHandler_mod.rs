...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for TestInvitePlatformHandler => ""
    ."TestInvitePlatformHandler"
);
#[cfg(feature = "TestInvitePlatformHandler")]
impl std::ops::Deref for TestInvitePlatformHandler {
...
#[cfg(feature = "TestInvitePlatformHandler")]
impl std::ops::DerefMut for TestInvitePlatformHandler {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "TestInvitePlatformHandler")]
impl TestInvitePlatformHandler {
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "TestInvitePlatformHandler")]
impl quest_hook::libil2cpp::ObjectType for TestInvitePlatformHandler {
