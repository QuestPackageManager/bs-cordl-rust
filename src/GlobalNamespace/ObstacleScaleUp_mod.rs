#[cfg(feature = "cordl_class_ObstacleScaleUp")]
#[repr(C)]
...
pub struct ObstacleScaleUp {
    ...
    pub _obstacleController: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ObstacleController>,
...
impl crate::GlobalNamespace::ObstacleScaleUp {
    ...
    pub fn HandleObstacleControllerDidUpdateProgress(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (obstacleController, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
