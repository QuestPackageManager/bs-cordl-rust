...
pub struct MissionResultsViewController {
    ...
    pub _resultObjectiveListItemList:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ResultObjectiveListItemsList>,
    ...
    pub _levelClearedLocalizationKey:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _fireworksController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::FireworksController>,
    ...
    pub _missionCompletionResults:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionCompletionResults>,
    pub _startFireworksAfterDelayCoroutine:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Coroutine>,
}
#[cfg(feature = "cordl_class_MissionResultsViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissionResultsViewController {
...
impl crate::GlobalNamespace::MissionResultsViewController {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ContinueButtonPressed")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (missionNode, missionCompletionResults))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RetryButtonPressed(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RetryButtonPressed")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetDataToUI(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetDataToUI")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "add_continueButtonPressedEvent"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        ...
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "remove_continueButtonPressedEvent"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        ...
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>(
                        "remove_retryButtonPressedEvent"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
...
#[cfg(feature = "cordl_class_MissionResultsViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissionResultsViewController {
