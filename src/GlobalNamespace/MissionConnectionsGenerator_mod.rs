...
#[cfg(feature = "cordl_class_MissionConnectionsGenerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MissionConnectionsGenerator {
...
impl crate::GlobalNamespace::MissionConnectionsGenerator {
    pub fn CreateConnectionBetweenNodes(
        &mut self,
        parentMissionNode: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNode>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNodeConnection> = unsafe {
    ...
    pub fn CreateConnections(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("CreateConnections")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (missionNode, visitedNodes))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateNodeConnections(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CreateNodeConnections")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn RemoveOldConnections(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RemoveOldConnections")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_MissionConnectionsGenerator")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MissionConnectionsGenerator {
