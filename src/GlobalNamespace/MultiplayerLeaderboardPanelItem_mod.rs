...
impl crate::GlobalNamespace::MultiplayerLeaderboardPanelItem {
    ...
    pub fn SetData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerLeaderboardPanelItem as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerLeaderboardPanelItem as
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (position, playerName, score, failed, numberOfPlayers),
                )?
        };
        Ok(__cordl_ret.into())
    }
