...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PageControlElement {
    ...
    const CLASS_NAME: &'static str = "PageControlElement";
...
impl crate::GlobalNamespace::PageControlElement {
    ...
    pub fn SetSelected(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PageControlElement as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("SetSelected")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PageControlElement as
                    quest_hook::libil2cpp::Type > ::class(), "SetSelected", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (isSelected))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
