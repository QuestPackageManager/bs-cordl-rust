...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TextMeshProButton {
    ...
    const CLASS_NAME: &'static str = "TextMeshProButton";
...
impl crate::GlobalNamespace::TextMeshProButton {
    ...
    pub fn get_text(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshProUGUI>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshProUGUI> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
