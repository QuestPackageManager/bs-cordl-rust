#[cfg(feature = "cordl_class_SmoothStepPositionEventEffect")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_SmoothStepPositionEventEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SmoothStepPositionEventEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SmoothStepPositionEventEffect";
...
#[cfg(feature = "cordl_class_SmoothStepPositionEventEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SmoothStepPositionEventEffect {
