...
#[cfg(feature = "MainCamera")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MainCamera {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MainCamera";
...
impl crate::GlobalNamespace::MainCamera {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MainCamera as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MainCamera as quest_hook::libil2cpp::Type >
                    ::class(), "Awake", 0usize
                )
            });
