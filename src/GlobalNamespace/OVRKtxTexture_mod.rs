...
impl crate::GlobalNamespace::OVRKtxTexture {
    ...
    pub fn Load(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::OVRKtxTexture as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::OVRKtxTexture as quest_hook::libil2cpp::Type
                    > ::class(), "Load", 2usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked((), (data, ktxData))? };
        Ok(__cordl_ret.into())
    }
