...
#[cfg(feature = "PointLightWithIds")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PointLightWithIds {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PointLightWithIds";
...
impl crate::GlobalNamespace::PointLightWithIds {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PointLightWithIds as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PointLightWithIds as
