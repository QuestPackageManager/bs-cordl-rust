...
#[cfg(feature = "PartyMessageHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PartyMessageHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PartyMessageHandler";
...
impl crate::GlobalNamespace::PartyMessageHandler {
    ...
    pub fn ConnectToMasterServer(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PartyMessageHandler as
                    quest_hook::libil2cpp::Type > ::class(), "ConnectToMasterServer",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "HandleConnectToMasterServer", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (connectedPlayerManager))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PartyMessageHandler as
                    quest_hook::libil2cpp::Type > ::class(),
                    "add_connectToMasterServerEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PartyMessageHandler as
                    quest_hook::libil2cpp::Type > ::class(),
                    "remove_connectToMasterServerEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
...
for crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerDelegate {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PartyMessageHandler/ConnectToMasterServerDelegate";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerDelegate {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerDelegate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method.invoke_unchecked(self, (secret, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
...
for crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PartyMessageHandler/ConnectToMasterServerMessage";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage {
    pub fn Deserialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage as quest_hook::libil2cpp::Type>::class()
            .find_method::<
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::PartyMessageHandler_ConnectToMasterServerMessage,
        > = unsafe { method.invoke_unchecked(self, (secret))? };
        Ok(__cordl_ret.into())
    }
...
for crate::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PartyMessageHandler/ServerStatusUpdatedDelegate";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate {
    pub fn BeginInvoke(
        ...
        quest_hook::libil2cpp::Gc<crate::System::IAsyncResult>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::GlobalNamespace::PartyMessageHandler_ServerStatusUpdatedDelegate as
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (selectionMask, configuration, callback, object),
                )?
        };
        Ok(__cordl_ret.into())
    }
