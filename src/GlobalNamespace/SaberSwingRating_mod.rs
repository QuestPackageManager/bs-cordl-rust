...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for SaberSwingRating => ""."SaberSwingRating"
);
#[cfg(feature = "SaberSwingRating")]
impl std::ops::Deref for SaberSwingRating {
...
#[cfg(feature = "SaberSwingRating")]
impl std::ops::DerefMut for SaberSwingRating {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "SaberSwingRating")]
impl SaberSwingRating {
...
#[cfg(feature = "SaberSwingRating")]
impl quest_hook::libil2cpp::ObjectType for SaberSwingRating {
