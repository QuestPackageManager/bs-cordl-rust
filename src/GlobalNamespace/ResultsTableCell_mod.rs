...
impl crate::GlobalNamespace::ResultsTableCell {
    ...
    pub fn SetData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ResultsTableCell as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ResultsTableCell as
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (order, connectedPlayer, levelCompletionResults),
                )?
        };
        Ok(__cordl_ret.into())
    }
