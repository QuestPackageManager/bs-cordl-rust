...
impl crate::GlobalNamespace::MouseLook {
    ...
    pub fn LookRotation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (character, camera))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetRotations(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (characterRotation, cameraRotation))?
        };
        Ok(__cordl_ret.into())
    }
