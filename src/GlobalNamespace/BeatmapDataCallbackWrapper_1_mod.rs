...
pub struct BeatmapDataCallbackWrapper_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _callback: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapDataCallback_1<T>>,
    ...
    for crate::GlobalNamespace::BeatmapDataCallbackWrapper_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "BeatmapDataCallbackWrapper`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "BeatmapDataCallbackWrapper_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::BeatmapDataCallbackWrapper_1<T> {
    pub fn CallCallback(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapDataCallback_1<T>>,
                        f32,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (callback, aheadTime, beatmapEventSubtypeIdentifiers))?
        };
        Ok(__cordl_ret.into())
    }
}
