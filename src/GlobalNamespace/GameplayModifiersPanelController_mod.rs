...
pub struct GameplayModifiersPanelController {
    ...
    pub _totalMultiplierValueText: quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshProUGUI>,
    ...
    pub didChangeGameplayModifiersEvent: quest_hook::libil2cpp::Gc<crate::System::Action>,
    ...
    for crate::GlobalNamespace::GameplayModifiersPanelController
{
    ...
    const CLASS_NAME: &'static str = "GameplayModifiersPanelController";
...
impl crate::GlobalNamespace::GameplayModifiersPanelController {
    ...
    pub fn GetToggleValueWithGameplayModifierParams(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (gameplayModifierParams))? };
        Ok(__cordl_ret.into())
    }
    pub fn IRefreshable_Refresh(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("IRefreshable.Refresh")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetData(
        &mut self,
        newGameplayModifiers: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameplayModifiers>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newGameplayModifiers))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetToggleValueWithGameplayModifierParams(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (gameplayModifierParams, value))? };
        Ok(__cordl_ret.into())
    }
