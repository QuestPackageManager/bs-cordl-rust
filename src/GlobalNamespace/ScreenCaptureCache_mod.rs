...
impl crate::GlobalNamespace::ScreenCaptureCache {
    ...
    pub fn GetLastScreenshot(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Texture2D>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ScreenCaptureCache as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::GlobalNamespace::ScreenCaptureCache_ScreenshotType),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Texture2D>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ScreenCaptureCache as
                    quest_hook::libil2cpp::Type > ::class(), "GetLastScreenshot", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Texture2D> = unsafe {
            method.invoke_unchecked(self, (screenshotType))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ScreenCaptureCache as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ScreenCaptureCache as
                    quest_hook::libil2cpp::Type > ::class(), "StoreScreenshot", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (screenshotType, texture))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
