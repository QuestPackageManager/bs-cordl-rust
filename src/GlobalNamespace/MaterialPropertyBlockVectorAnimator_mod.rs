...
for crate::GlobalNamespace::MaterialPropertyBlockVectorAnimator {
    ...
    const CLASS_NAME: &'static str = "MaterialPropertyBlockVectorAnimator";
...
#[cfg(feature = "MaterialPropertyBlockVectorAnimator")]
impl crate::GlobalNamespace::MaterialPropertyBlockVectorAnimator {
    ...
    pub fn SetProperty(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MaterialPropertyBlockVectorAnimator as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetProperty")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MaterialPropertyBlockVectorAnimator as
