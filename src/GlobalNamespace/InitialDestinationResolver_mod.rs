...
pub struct InitialDestinationResolver {
    ...
    >,
    pub _controller: quest_hook::libil2cpp::Gc<
    ...
    >,
    pub characteristicCollection: quest_hook::libil2cpp::Gc<
    ...
    >,
    pub _lastDestination: quest_hook::libil2cpp::Gc<
...
impl crate::GlobalNamespace::InitialDestinationResolver {
    ...
    pub fn GoToCreditsAsync(
        &mut self,
        targetDestination: quest_hook::libil2cpp::Gc<
            crate::BeatSaber::Destinations::Destination,
        >,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InitializeStandardLevelSetupData", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (setupData, targetDestination))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _GoToCreditsAsync_g__HandleCreditsSceneDidFinish_24_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (setupData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
for crate::GlobalNamespace::InitialDestinationResolver {
    fn as_mut(
        &mut self,
    ) -> &mut crate::BeatSaber::Destinations::IInitialDestinationResolver {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "InitialDestinationResolver")]
