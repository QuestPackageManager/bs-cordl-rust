...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IBeatmapLevelData {
    ...
    const CLASS_NAME: &'static str = "IBeatmapLevelData";
...
impl crate::GlobalNamespace::IBeatmapLevelData {
    pub fn ContainsBeatmapData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::IBeatmapLevelData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::IBeatmapLevelData as
