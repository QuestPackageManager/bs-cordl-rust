...
for crate::GlobalNamespace::MultiplayerBadgeDataPrecisionSO {
    ...
    const CLASS_NAME: &'static str = "MultiplayerBadgeDataPrecisionSO";
...
impl crate::GlobalNamespace::MultiplayerBadgeDataPrecisionSO {
    pub fn GetValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplayerBadgeDataPrecisionSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplayerBadgeDataPrecisionSO as
