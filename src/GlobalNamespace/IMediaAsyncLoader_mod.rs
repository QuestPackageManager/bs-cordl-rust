...
#[cfg(feature = "IMediaAsyncLoader")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::IMediaAsyncLoader {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "IMediaAsyncLoader";
                ...
                Self::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            Self::class(), "LoadAudioClipFromFilePathAsync", 1usize
                        )
                    })
            });
