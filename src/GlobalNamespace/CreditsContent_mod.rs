...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for CreditsContent => ""."CreditsContent"
);
#[cfg(feature = "CreditsContent")]
impl std::ops::Deref for CreditsContent {
...
#[cfg(feature = "CreditsContent")]
impl std::ops::DerefMut for CreditsContent {
...
#[cfg(feature = "CreditsContent")]
impl quest_hook::libil2cpp::ObjectType for CreditsContent {
