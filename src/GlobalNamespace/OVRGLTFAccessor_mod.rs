...
impl crate::GlobalNamespace::OVRGLTFAccessor {
    ...
    pub fn ReadAsBoneWeights(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (chunk, data, offset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadAsColor(
    ...
    pub fn ReadAsMatrix4x4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (chunk, data, offset, conversionScale))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReadElementAsUint(
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (data, index, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToOVRType(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (node, root, bufferViewOnly))?
        };
        Ok(__cordl_ret.into())
    }
}
