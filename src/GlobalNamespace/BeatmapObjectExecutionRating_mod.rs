#[cfg(feature = "cordl_class_BeatmapObjectExecutionRating")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatmapObjectExecutionRating")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapObjectExecutionRating {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BeatmapObjectExecutionRating";
...
impl crate::GlobalNamespace::BeatmapObjectExecutionRating {
    pub fn New(_cordl_time: f32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
...
#[cfg(feature = "cordl_class_BeatmapObjectExecutionRating")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapObjectExecutionRating {
