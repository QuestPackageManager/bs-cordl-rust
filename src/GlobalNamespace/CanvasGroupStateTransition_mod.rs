...
pub struct CanvasGroupStateTransition {
    ...
    >,
    pub _transition: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::CanvasGroupTransitionSO>,
    pub _floatTween: quest_hook::libil2cpp::Gc<crate::Tweening::FloatTween>,
}
#[cfg(feature = "cordl_class_CanvasGroupStateTransition")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CanvasGroupStateTransition {
...
impl crate::GlobalNamespace::CanvasGroupStateTransition {
    ...
    pub fn SetHighlightedState(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetHighlightedState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetNormalState(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn StartTween(
        &mut self,
        endAlpha: f32,
        transitionTiming: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TransitionTimingSO>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("StartTween")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (endAlpha, transitionTiming))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TransitionToDisabledState(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (transitionTiming))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _StartTween_b__17_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<StartTween>b__17_1")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BaseTransitionSO> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_CanvasGroupStateTransition")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::CanvasGroupStateTransition {
