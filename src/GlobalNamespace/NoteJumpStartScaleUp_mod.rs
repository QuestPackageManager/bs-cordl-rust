...
#[cfg(feature = "cordl_class_NoteJumpStartScaleUp")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteJumpStartScaleUp {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "NoteJumpStartScaleUp";
...
impl crate::GlobalNamespace::NoteJumpStartScaleUp {
    ...
    pub fn HandleNoteJumpDidUpdateProgress(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (progress))? };
        Ok(__cordl_ret.into())
    }
