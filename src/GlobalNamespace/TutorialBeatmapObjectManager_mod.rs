...
pub struct TutorialBeatmapObjectManager {
    ...
    >,
    pub _initData:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TutorialBeatmapObjectManager_InitData>,
...
#[cfg(feature = "cordl_class_TutorialBeatmapObjectManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TutorialBeatmapObjectManager {
...
#[cfg(feature = "cordl_class_TutorialBeatmapObjectManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::TutorialBeatmapObjectManager {
...
#[cfg(feature = "TutorialBeatmapObjectManager+InitData")]
impl std::ops::DerefMut for crate::GlobalNamespace::TutorialBeatmapObjectManager_InitData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::GlobalNamespace::TutorialBeatmapObjectManager_InitData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cutAngleTolerance))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_TutorialBeatmapObjectManager+InitData")]
