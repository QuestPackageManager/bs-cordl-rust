...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AvatarColorTrack {
    ...
    const CLASS_NAME: &'static str = "AvatarColorTrack";
...
#[cfg(feature = "AvatarColorTrack")]
impl crate::GlobalNamespace::AvatarColorTrack {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::AvatarColorTrack as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::AvatarColorTrack as
