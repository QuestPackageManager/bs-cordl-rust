...
pub struct ArcAndObstacleHapticEffectManager {
    ...
    pub _obstacleSaberSparkleEffectManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::ObstacleSaberSparkleEffectManager>,
...
impl crate::GlobalNamespace::ArcAndObstacleHapticEffectManager {
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::ColorType), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState,
                    >, 1usize>("GetState")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (colorType))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::SaberType), quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState,
                    >, 1usize>("GetState")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (saberType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleSliderInteractionManagerSliderWasAddedToActiveSliders(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (sliderInteractionManager, sliderInteractionParam))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryDisableThis(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn UpdateHaptic(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("UpdateHaptic")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, node))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "ArcAndObstacleHapticEffectManager+EffectState")]
impl std::ops::Deref for crate::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState {
...
#[cfg(feature = "ArcAndObstacleHapticEffectManager+EffectState")]
impl std::ops::DerefMut for crate::GlobalNamespace::ArcAndObstacleHapticEffectManager_EffectState {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
