...
pub struct HologramRays {
    ...
    pub _bloomLight: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TubeBloomPrePassLight>,
...
impl crate::GlobalNamespace::HologramRays {
    pub fn Animate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (turningOn, duration, easeType))? };
        Ok(__cordl_ret.into())
    }
