...
impl crate::GlobalNamespace::OculusPlatformUserModel {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Threading::Tasks::Task_1<
                ...
                >,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (cached))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetUserInfo(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetUserInfoInternalAsync", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Threading::Tasks::Task_1<
                ...
                >,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (userIds))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (platformInit))?
        };
        Ok(__cordl_ret.into())
    }
