...
#[cfg(feature = "EnableAfterDelay")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnableAfterDelay {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EnableAfterDelay";
...
impl crate::GlobalNamespace::EnableAfterDelay {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::EnableAfterDelay as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::EnableAfterDelay as
