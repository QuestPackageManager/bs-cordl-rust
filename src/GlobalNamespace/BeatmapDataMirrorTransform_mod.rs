...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BeatmapDataMirrorTransform => ""
    ."BeatmapDataMirrorTransform"
);
#[cfg(feature = "BeatmapDataMirrorTransform")]
impl std::ops::Deref for BeatmapDataMirrorTransform {
...
#[cfg(feature = "BeatmapDataMirrorTransform")]
impl std::ops::DerefMut for BeatmapDataMirrorTransform {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BeatmapDataMirrorTransform")]
impl BeatmapDataMirrorTransform {
...
#[cfg(feature = "BeatmapDataMirrorTransform")]
impl quest_hook::libil2cpp::ObjectType for BeatmapDataMirrorTransform {
