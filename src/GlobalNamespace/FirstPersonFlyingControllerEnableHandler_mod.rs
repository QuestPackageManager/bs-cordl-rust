...
pub struct FirstPersonFlyingControllerEnableHandler {
    ...
    pub _flyingController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::FirstPersonFlyingController>,
    ...
    for crate::GlobalNamespace::FirstPersonFlyingControllerEnableHandler
{
    ...
    const CLASS_NAME: &'static str = "FirstPersonFlyingControllerEnableHandler";
...
impl std::ops::Deref for crate::GlobalNamespace::FirstPersonFlyingControllerEnableHandler {
...
#[cfg(feature = "FirstPersonFlyingControllerEnableHandler")]
impl std::ops::DerefMut for crate::GlobalNamespace::FirstPersonFlyingControllerEnableHandler {
...
impl crate::GlobalNamespace::FirstPersonFlyingControllerEnableHandler {
    pub fn InstallDependencies(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (commandLineParserResult))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_flyingControllerEnabled(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
