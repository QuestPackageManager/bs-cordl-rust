...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for AddressablesConstants => ""."AddressablesConstants"
);
#[cfg(feature = "AddressablesConstants")]
impl std::ops::Deref for AddressablesConstants {
...
#[cfg(feature = "AddressablesConstants")]
impl std::ops::DerefMut for AddressablesConstants {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "AddressablesConstants")]
impl AddressablesConstants {
...
#[cfg(feature = "AddressablesConstants")]
impl quest_hook::libil2cpp::ObjectType for AddressablesConstants {
