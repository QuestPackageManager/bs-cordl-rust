...
impl crate::GlobalNamespace::TestPlatformLeaderboardsHandler {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TestPlatformLeaderboardsHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TestPlatformLeaderboardsHandler as
