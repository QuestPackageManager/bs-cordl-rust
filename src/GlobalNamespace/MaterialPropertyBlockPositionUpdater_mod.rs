...
for crate::GlobalNamespace::MaterialPropertyBlockPositionUpdater {
    ...
    const CLASS_NAME: &'static str = "MaterialPropertyBlockPositionUpdater";
...
impl crate::GlobalNamespace::MaterialPropertyBlockPositionUpdater {
    ...
    pub fn SetProperty(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MaterialPropertyBlockPositionUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetProperty")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MaterialPropertyBlockPositionUpdater as
