...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CuttingManager {
    ...
    const CLASS_NAME: &'static str = "CuttingManager";
...
impl crate::GlobalNamespace::CuttingManager {
    pub fn HandleSaberManagerDidUpdateSaberPositions(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::CuttingManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::CuttingManager as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleSaberManagerDidUpdateSaberPositions", 2usize
                )
            });
