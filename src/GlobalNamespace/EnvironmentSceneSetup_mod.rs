...
#[cfg(feature = "cordl_class_EnvironmentSceneSetup")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::EnvironmentSceneSetup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "EnvironmentSceneSetup";
...
#[cfg(feature = "cordl_class_EnvironmentSceneSetup")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::EnvironmentSceneSetup {
