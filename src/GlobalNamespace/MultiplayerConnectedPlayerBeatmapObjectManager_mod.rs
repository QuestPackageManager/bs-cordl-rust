...
impl crate::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectManager {
    ...
    pub fn AreNotesSame(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (noteController, noteCutInfo))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleMultiplayerBeatmapObjectEventManagerBeatmapObjectWasSpawned(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (noteSpawnInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleMultiplayerBeatmapObjectEventManagerObstacleWasSpawned(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (obstacleSpawnInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HandleMultiplayerBeatmapObjectEventManagerSliderWasSpawned(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sliderSpawnInfo))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
