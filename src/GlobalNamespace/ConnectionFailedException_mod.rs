...
impl crate::GlobalNamespace::ConnectionFailedException {
    ...
    pub fn _ctor_ConnectionFailedReason0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ConnectionFailedException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ConnectionFailedException as
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (reason, message))?
        };
        Ok(__cordl_ret.into())
    }
}
