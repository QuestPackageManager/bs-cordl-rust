...
impl crate::GlobalNamespace::OVRSceneRoom {
    ...
    pub fn UpdateRoomInformation(
        &mut self,
        plane: *mut crate::GlobalNamespace::OVRScenePlane,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
    ...
    pub fn _Awake_b__24_0(
        &mut self,
        planeA: *mut crate::GlobalNamespace::OVRScenePlane,
        planeB: *mut crate::GlobalNamespace::OVRScenePlane,
    ...
    pub fn get_Ceiling(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<*mut crate::GlobalNamespace::OVRScenePlane> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::GlobalNamespace::OVRScenePlane = __cordl_object
            .invoke("get_Ceiling", ())?;
        Ok(__cordl_ret)
    }
    pub fn get_Floor(
    ...
    pub fn set_Ceiling(
        &mut self,
        value: *mut crate::GlobalNamespace::OVRScenePlane,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
