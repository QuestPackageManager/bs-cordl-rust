#[cfg(feature = "cordl_class_MockPlayerLobbyPoseGeneratorAI")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MockPlayerLobbyPoseGeneratorAI")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MockPlayerLobbyPoseGeneratorAI {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MockPlayerLobbyPoseGeneratorAI";
...
#[cfg(feature = "cordl_class_MockPlayerLobbyPoseGeneratorAI")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MockPlayerLobbyPoseGeneratorAI {
