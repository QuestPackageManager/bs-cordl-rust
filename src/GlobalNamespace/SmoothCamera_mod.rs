...
#[cfg(feature = "SmoothCamera")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SmoothCamera {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SmoothCamera";
...
impl crate::GlobalNamespace::SmoothCamera {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SmoothCamera as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    f32,
                    f32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SmoothCamera as quest_hook::libil2cpp::Type
                    > ::class(), "Init", 6usize
                )
            });
