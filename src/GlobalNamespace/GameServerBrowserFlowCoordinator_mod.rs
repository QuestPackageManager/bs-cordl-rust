...
#[repr(C)]
#[derive(Debug)]
pub struct GameServerBrowserFlowCoordinator {
...
for crate::GlobalNamespace::GameServerBrowserFlowCoordinator {
    ...
    const CLASS_NAME: &'static str = "GameServerBrowserFlowCoordinator";
...
impl crate::GlobalNamespace::GameServerBrowserFlowCoordinator {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameServerBrowserFlowCoordinator as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::GameServerBrowserFlowCoordinator as
