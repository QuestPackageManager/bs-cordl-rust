...
impl crate::GlobalNamespace::NoPlatformInit {
    pub fn GetAppVersionAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoPlatformInit as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Threading::Tasks::Task_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoPlatformInit as
                    quest_hook::libil2cpp::Type > ::class(), "GetAppVersionAsync", 0usize
                )
            });
