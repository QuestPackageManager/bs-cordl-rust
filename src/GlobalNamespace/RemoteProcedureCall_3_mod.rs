...
unsafe impl<
        ...
        T1: quest_hook::libil2cpp::Type,
        T2: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>
{
    ...
    > crate::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IRemoteProcedureCall> = unsafe {
            cordl_method_info.invoke_unchecked(self, (syncTime, value0, value1, value2))?
        };
        Ok(__cordl_ret.into())
    }
