...
#[cfg(feature = "cordl_class_AudioClipAsyncLoaderExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AudioClipAsyncLoaderExtensions {
...
impl crate::GlobalNamespace::AudioClipAsyncLoaderExtensions {
    pub fn LoadPreview(
        asyncLoader: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioClipAsyncLoader>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Threading::Tasks::Task_1<
                quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioClip>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (asyncLoader, beatmapLevel))? };
        Ok(__cordl_ret.into())
    }
    pub fn LoadSong(
        asyncLoader: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioClipAsyncLoader>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Threading::Tasks::Task_1<
                quest_hook::libil2cpp::Gc<crate::UnityEngine::AudioClip>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (asyncLoader, beatmapLevelData))? };
        Ok(__cordl_ret.into())
    }
    pub fn UnloadPreview(
        _cordl__: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioClipAsyncLoader>,
        beatmapLevel: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapLevel>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioClipAsyncLoader>,
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapLevel>,
                    ), quest_hook::libil2cpp::Void, 2usize>("UnloadPreview")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl__, beatmapLevel))? };
        Ok(__cordl_ret.into())
    }
    pub fn UnloadSong(
        asyncLoader: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioClipAsyncLoader>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioClipAsyncLoader>,
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBeatmapLevelData>,
                    ), quest_hook::libil2cpp::Void, 2usize>("UnloadSong")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_AudioClipAsyncLoaderExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AudioClipAsyncLoaderExtensions {
