...
#[cfg(feature = "FloatSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FloatSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "FloatSO";
...
impl crate::GlobalNamespace::FloatSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FloatSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::FloatSO as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
