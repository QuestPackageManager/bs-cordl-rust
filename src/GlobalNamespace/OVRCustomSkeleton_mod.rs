...
impl crate::GlobalNamespace::OVRCustomSkeleton {
    ...
    pub fn AllocateBones(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn SetSkeletonType(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (skeletonType))? };
        Ok(__cordl_ret.into())
    }
