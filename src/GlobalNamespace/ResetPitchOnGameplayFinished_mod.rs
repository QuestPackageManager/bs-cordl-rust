...
impl crate::GlobalNamespace::ResetPitchOnGameplayFinished {
    pub fn Finalize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ResetPitchOnGameplayFinished as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Finalize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ResetPitchOnGameplayFinished as
            ...
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
                        crate::GlobalNamespace::GameplayLevelSceneTransitionEvents,
                    >,
                    quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AudioManagerSO>,
                ),
                quest_hook::libil2cpp::Void,
                2usize,
            >(".ctor")
