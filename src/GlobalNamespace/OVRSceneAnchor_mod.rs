...
impl crate::GlobalNamespace::OVRSceneAnchor {
    pub fn ClearPoseCache(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRSceneAnchor>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("GetSceneAnchors")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetSceneAnchorsOfType<T>(
        anchors: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<T>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
    ...
    pub fn IsComponentEnabled(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (spaceComponentType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryUpdateTransform(&mut self, useCache: bool) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (useCache))? };
        Ok(__cordl_ret.into())
    }
