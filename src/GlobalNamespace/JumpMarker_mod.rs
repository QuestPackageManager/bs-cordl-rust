...
impl crate::GlobalNamespace::JumpMarker {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::JumpDestinationMarker> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "JumpMarker")]
impl AsRef<crate::UnityEngine::Playables::INotification> for crate::GlobalNamespace::JumpMarker {
    fn as_ref(&self) -> &crate::UnityEngine::Playables::INotification {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "JumpMarker")]
impl AsMut<crate::UnityEngine::Playables::INotification> for crate::GlobalNamespace::JumpMarker {
