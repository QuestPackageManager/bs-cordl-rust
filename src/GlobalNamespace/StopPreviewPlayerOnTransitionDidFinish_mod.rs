#[cfg(feature = "cordl_class_StopPreviewPlayerOnTransitionDidFinish")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct StopPreviewPlayerOnTransitionDidFinish {
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::GlobalNamespace::StopPreviewPlayerOnTransitionDidFinish
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "StopPreviewPlayerOnTransitionDidFinish";
...
#[cfg(feature = "StopPreviewPlayerOnTransitionDidFinish")]
impl std::ops::Deref for crate::GlobalNamespace::StopPreviewPlayerOnTransitionDidFinish {
...
#[cfg(feature = "StopPreviewPlayerOnTransitionDidFinish")]
impl std::ops::DerefMut for crate::GlobalNamespace::StopPreviewPlayerOnTransitionDidFinish {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "StopPreviewPlayerOnTransitionDidFinish")]
impl crate::GlobalNamespace::StopPreviewPlayerOnTransitionDidFinish {
