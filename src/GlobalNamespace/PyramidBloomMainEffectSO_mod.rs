...
impl crate::GlobalNamespace::PyramidBloomMainEffectSO {
    pub fn LazyInitializeMaterials(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PyramidBloomMainEffectSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PyramidBloomMainEffectSO as
                    quest_hook::libil2cpp::Type > ::class(), "LazyInitializeMaterials",
                    0usize
                )
            });
