...
pub struct PyramidBloomMainEffectSO {
    ...
    pub _bloomRenderer: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PyramidBloomRendererSO>,
...
#[cfg(feature = "cordl_class_PyramidBloomMainEffectSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PyramidBloomMainEffectSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PyramidBloomMainEffectSO";
...
impl crate::GlobalNamespace::PyramidBloomMainEffectSO {
    ...
    pub fn get_bloomTextureWidth(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_bloomTextureWidth")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_PyramidBloomMainEffectSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PyramidBloomMainEffectSO {
