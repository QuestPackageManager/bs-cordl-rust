#[cfg(feature = "cordl_class_LightRotationEventEffect")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_LightRotationEventEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightRotationEventEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "LightRotationEventEffect";
...
#[cfg(feature = "cordl_class_LightRotationEventEffect")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LightRotationEventEffect {
