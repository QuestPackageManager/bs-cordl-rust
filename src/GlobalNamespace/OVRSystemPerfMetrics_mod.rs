...
#[cfg(feature = "cordl_class_OVRSystemPerfMetrics")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRSystemPerfMetrics {
...
impl crate::GlobalNamespace::OVRSystemPerfMetrics {
    ...
    pub type OVRSystemPerfMetricsTcpServer =
        crate::GlobalNamespace::OVRSystemPerfMetrics_OVRSystemPerfMetricsTcpServer;
...
pub struct OVRSystemPerfMetrics_OVRSystemPerfMetricsTcpServer {
    ...
    pub tcpServer:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRNetwork_OVRNetworkTcpServer>,
...
impl crate::GlobalNamespace::OVRSystemPerfMetrics_OVRSystemPerfMetricsTcpServer {
    pub fn GatherPerfMetrics(
        ...
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
...
pub struct OVRSystemPerfMetrics_PerfMetrics {
    ...
    pub deviceCpuCoreUtilPercentage_IsValid:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<bool>>,
    pub deviceCpuCoreUtilPercentage:
...
impl crate::GlobalNamespace::OVRSystemPerfMetrics_PerfMetrics {
    pub fn LoadFromJSON(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (json))? };
        Ok(__cordl_ret.into())
    }
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
