...
for crate::GlobalNamespace::NoUserAgeWarningViewController {
    ...
    const CLASS_NAME: &'static str = "NoUserAgeWarningViewController";
...
impl crate::GlobalNamespace::NoUserAgeWarningViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoUserAgeWarningViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoUserAgeWarningViewController as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoUserAgeWarningViewController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::NoUserAgeWarningViewController as
                    quest_hook::libil2cpp::Type > ::class(), "<DidActivate>b__4_0",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
