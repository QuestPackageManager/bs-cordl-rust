...
impl crate::GlobalNamespace::INoteControllerNoteDidDissolveEvent {
    pub fn HandleNoteControllerNoteDidDissolve(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INoteControllerNoteDidDissolveEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INoteControllerNoteDidDissolveEvent as
