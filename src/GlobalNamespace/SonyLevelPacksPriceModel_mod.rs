#[cfg(feature = "cordl_class_SonyLevelPacksPriceModel")]
#[repr(C)]
#[derive(Debug)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetPricePerBundlePair", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::SonyLevelPacksPriceModel_PricePerBundlePair,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (levelsCount))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_pricePairBundlePairs", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
...
#[cfg(feature = "cordl_class_SonyLevelPacksPriceModel+PricePerBundlePair")]
#[repr(C)]
#[derive(Debug)]
