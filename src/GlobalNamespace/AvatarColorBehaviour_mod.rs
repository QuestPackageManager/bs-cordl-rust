...
for crate::GlobalNamespace::AvatarColorBehaviour {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "AvatarColorBehaviour";
...
impl crate::GlobalNamespace::AvatarColorBehaviour {
    ...
    pub fn OnGraphStart(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::AvatarColorBehaviour as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::AvatarColorBehaviour as
