...
pub struct AvatarColorBehaviour {
    ...
    pub _avatarVisualController:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::AvatarVisualController>,
    pub _duration: f32,
}
#[cfg(feature = "cordl_class_AvatarColorBehaviour")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AvatarColorBehaviour {
