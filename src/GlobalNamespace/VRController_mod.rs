...
impl crate::GlobalNamespace::VRController {
    pub fn AdjustPose(
        ...
        let __cordl_ret: crate::UnityEngine::Pose = unsafe {
            cordl_method_info.invoke_unchecked((), (originalPose, adjustment))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (vrPlatformHelper))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn InvertControllerPose(
        ...
        let __cordl_ret: crate::UnityEngine::Pose = unsafe {
            cordl_method_info.invoke_unchecked((), (finalPose))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryGetControllerOffset_ByRefMut0(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (poseOffset))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_anchorUpdateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
