    ...
    pub fn ColorWithMultipliedAlpha(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <Self as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                    self, "ColorWithMultipliedAlpha", 2usize
                )
            });
        let __cordl_ret: crate::UnityEngine::Color = unsafe {
    ...
    pub fn FromHtmlStringRGBA(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <Self as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                    self, "FromHtmlStringRGBA", 2usize
                )
            });
    ...
    pub fn GetColorFromHtmlString(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <Self as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                    self, "GetColorFromHtmlString", 1usize
                )
            });
        let __cordl_ret: crate::UnityEngine::Color = unsafe {
    ...
    pub fn _FromHtmlStringRGBA_g__HtmlStringToFloat_0_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <Self as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                    self, "<FromHtmlStringRGBA>g__HtmlStringToFloat|0_0", 1usize
                )
            });
