#[cfg(feature = "cordl_class_MultiplayerLocalPlayerScoreDiffTextManager")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager
{
    ...
    const CLASS_NAME: &'static str = "MultiplayerLocalPlayerScoreDiffTextManager";
...
impl std::ops::Deref for crate::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager {
...
#[cfg(feature = "MultiplayerLocalPlayerScoreDiffTextManager")]
impl std::ops::DerefMut for crate::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager {
