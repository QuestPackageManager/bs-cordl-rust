...
impl crate::GlobalNamespace::FloatFxBeatmapEventDataProcessor {
    ...
    pub fn UpdateByOther(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FloatFxBeatmapEventDataProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FloatFxBeatmapEventDataProcessor as
