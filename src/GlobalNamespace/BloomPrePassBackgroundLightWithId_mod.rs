...
for crate::GlobalNamespace::BloomPrePassBackgroundLightWithId {
    ...
    const CLASS_NAME: &'static str = "BloomPrePassBackgroundLightWithId";
...
impl crate::GlobalNamespace::BloomPrePassBackgroundLightWithId {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassBackgroundLightWithId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BloomPrePassBackgroundLightWithId as
