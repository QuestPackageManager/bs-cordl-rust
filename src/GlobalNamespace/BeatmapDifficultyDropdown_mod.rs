...
pub struct BeatmapDifficultyDropdown {
    ...
    pub didSelectCellWithIdxEvent: quest_hook::libil2cpp::Gc<crate::System::Action_1<i32>>,
...
#[cfg(feature = "cordl_class_BeatmapDifficultyDropdown")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapDifficultyDropdown {
...
impl crate::GlobalNamespace::BeatmapDifficultyDropdown {
    pub fn GetIdxForBeatmapDifficultyMask(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::BeatmapDifficultyMask), i32, 1usize>(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (beatmapDifficultyMask))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetSelectedBeatmapDifficultyMask(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::BeatmapDifficultyMask, 0usize>(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SelectCellWithBeatmapDifficultyMask", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IReadOnlyList_1<
                            ...
                            >,
                        >,
                    >, 0usize>("get_beatmapDifficultyData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_includeAllDifficulties(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_includeAllDifficulties")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_BeatmapDifficultyDropdown")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapDifficultyDropdown {
