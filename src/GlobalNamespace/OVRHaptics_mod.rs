...
pub struct OVRHapticsOutput_OVRHaptics_ClipPlaybackTracker {
    ...
    pub _Clip_k__BackingField: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRHapticsClip>,
}
#[cfg(feature = "cordl_class_OVRHaptics+OVRHapticsOutput+ClipPlaybackTracker")]
...
impl std::ops::Deref for crate::GlobalNamespace::OVRHapticsOutput_OVRHaptics_ClipPlaybackTracker {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
impl crate::GlobalNamespace::OVRHapticsOutput_OVRHaptics_ClipPlaybackTracker {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRHapticsClip> =
...
#[cfg(feature = "cordl_class_OVRHaptics+OVRHapticsChannel")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRHaptics_OVRHapticsChannel {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::OVRHaptics_OVRHapticsChannel {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Mix",
                            1usize
                        )
                    })
            });
    ...
    pub fn New(outputIndex: u32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Preempt",
                            1usize
                        )
                    })
            });
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Queue",
                            1usize
                        )
                    })
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outputIndex))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_OVRHaptics+OVRHapticsChannel")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRHaptics_OVRHapticsChannel {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
pub struct OVRHaptics_OVRHapticsOutput {
    ...
    pub m_nativeBuffer: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::OVRNativeBuffer>,
    pub PrevSampleRateHz: i32,
}
#[cfg(feature = "cordl_class_OVRHaptics+OVRHapticsOutput")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRHaptics_OVRHapticsOutput {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::OVRHaptics_OVRHapticsOutput {
    ...
    pub fn New(controller: u32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
...
#[cfg(feature = "cordl_class_OVRHaptics+OVRHapticsOutput")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRHaptics_OVRHapticsOutput {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
