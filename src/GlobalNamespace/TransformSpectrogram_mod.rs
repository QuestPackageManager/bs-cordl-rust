...
pub struct TransformSpectrogram {
    ...
    pub _defaultPositions:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector3>>,
}
#[cfg(feature = "cordl_class_TransformSpectrogram")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::TransformSpectrogram {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "TransformSpectrogram";
