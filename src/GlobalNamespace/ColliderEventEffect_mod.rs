...
impl crate::GlobalNamespace::ColliderEventEffect {
    ...
    pub fn SetValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ColliderEventEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32, i32, f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ColliderEventEffect as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ColliderEventEffect as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ColliderEventEffect as
                    quest_hook::libil2cpp::Type > ::class(), "get_effectCollider", 0usize
                )
            });
