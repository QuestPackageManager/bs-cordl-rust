#[cfg(feature = "cordl_class_ConditionalActivation")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_ConditionalActivation")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ConditionalActivation {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ConditionalActivation";
...
#[cfg(feature = "cordl_class_ConditionalActivation")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ConditionalActivation {
