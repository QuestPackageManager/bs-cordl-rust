#[cfg(feature = "cordl_class_CanvasGroupTransitionSO")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_CanvasGroupTransitionSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CanvasGroupTransitionSO {
...
impl crate::GlobalNamespace::CanvasGroupTransitionSO {
    ...
    pub fn get_selectedAndHighlightedAlpha(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_selectedAndHighlightedAlpha",
                            0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_CanvasGroupTransitionSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::CanvasGroupTransitionSO {
