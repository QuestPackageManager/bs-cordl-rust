...
impl std::ops::Deref for crate::GlobalNamespace::SwitchGameObjectArrayEffectTarget {
...
#[cfg(feature = "SwitchGameObjectArrayEffectTarget")]
impl std::ops::DerefMut for crate::GlobalNamespace::SwitchGameObjectArrayEffectTarget {
    ...
    for crate::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SwitchGameObjectArrayEffectTarget/GameObjectActivation";
...
#[cfg(feature = "SwitchGameObjectArrayEffectTarget+GameObjectActivation")]
impl crate::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation {}
