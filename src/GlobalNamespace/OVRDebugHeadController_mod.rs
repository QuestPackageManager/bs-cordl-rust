#[cfg(feature = "cordl_class_OVRDebugHeadController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_OVRDebugHeadController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRDebugHeadController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRDebugHeadController";
...
#[cfg(feature = "cordl_class_OVRDebugHeadController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::OVRDebugHeadController {
