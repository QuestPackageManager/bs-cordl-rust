...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::RandomValueToShader {
    ...
    const CLASS_NAME: &'static str = "RandomValueToShader";
...
impl crate::GlobalNamespace::RandomValueToShader {
    ...
    pub fn SetRandomSeed(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RandomValueToShader as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("SetRandomSeed")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::RandomValueToShader as
                    quest_hook::libil2cpp::Type > ::class(), "SetRandomSeed", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RandomValueToShader as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::RandomValueToShader as
                    quest_hook::libil2cpp::Type > ::class(), "SetRandomValueToShaders",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
