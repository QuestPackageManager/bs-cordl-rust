...
#[cfg(feature = "BufferedAudioStream")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BufferedAudioStream {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BufferedAudioStream";
...
impl crate::GlobalNamespace::BufferedAudioStream {
    ...
    pub fn AddData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BufferedAudioStream as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BufferedAudioStream as
                    quest_hook::libil2cpp::Type > ::class(), "AddData", 1usize
                )
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (audio))?
        };
        Ok(__cordl_ret.into())
    }
}
