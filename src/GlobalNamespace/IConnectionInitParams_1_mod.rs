#[cfg(feature = "cordl_class_IConnectionInitParams_1")]
#[repr(C)]
#[derive(Debug)]
...
for crate::GlobalNamespace::IConnectionInitParams_1<T> {
    ...
    const CLASS_NAME: &'static str = "IConnectionInitParams`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("", "IConnectionInitParams`1")
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
                    .unwrap()
