...
#[cfg(feature = "GameLoader")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::GameLoader {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "GameLoader";
...
impl crate::GlobalNamespace::GameLoader {
    ...
    pub fn HandleSceneContextPostInstall(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::GameLoader as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::GameLoader as quest_hook::libil2cpp::Type >
                    ::class(), "HandleSceneContextPostInstall", 0usize
                )
            });
