#[cfg(feature = "cordl_class_FlyingGameHUDRotation")]
#[repr(C)]
#[derive(Debug)]
pub struct FlyingGameHUDRotation {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _smooth: f32,
    pub _beatLineManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatLineManager>,
    pub _environmentSpawnRotation:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::EnvironmentSpawnRotation>,
    pub _timeHelper: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::TimeHelper>,
    pub _prevYAngle: f32,
    pub _yAngle: f32,
}
#[cfg(feature = "cordl_class_FlyingGameHUDRotation")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FlyingGameHUDRotation {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "FlyingGameHUDRotation";
...
#[cfg(feature = "cordl_class_FlyingGameHUDRotation")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::FlyingGameHUDRotation {
