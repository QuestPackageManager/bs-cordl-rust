...
> {
    ...
    pub _value0:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T0>>,
    pub _value1:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T1>>,
    pub _value2:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T2>>,
    pub _value3:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T3>>,
...
unsafe impl<
    ...
    for crate::GlobalNamespace::RemoteProcedureCall_4<T0, T1, T2, T3>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "RemoteProcedureCall`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "RemoteProcedureCall`4")
                .unwrap()
                .make_generic::<(T0, T1, T2, T3)>()
                .unwrap()
                .unwrap()
        })
    }
...
impl<
        ...
        T2: quest_hook::libil2cpp::Type,
        T3: quest_hook::libil2cpp::Type,
    > std::ops::DerefMut for crate::GlobalNamespace::RemoteProcedureCall_4<T0, T1, T2, T3>
{
...
impl<
        ...
        T2: quest_hook::libil2cpp::Type,
        T3: quest_hook::libil2cpp::Type,
    > crate::GlobalNamespace::RemoteProcedureCall_4<T0, T1, T2, T3>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        u32,
                    ), quest_hook::libil2cpp::Void, 2usize>("DeserializeData")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (reader, protocolVersion))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IRemoteProcedureCall> = unsafe {
            cordl_method_info.invoke_unchecked(self, (syncTime, value0, value1, value2, value3))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        u32,
                    ), quest_hook::libil2cpp::Void, 2usize>("SerializeData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (writer, protocolVersion))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), T2, 0usize>("get_value2")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_value3(&mut self) -> quest_hook::libil2cpp::Result<T3>
    where
        T0: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), T3, 0usize>("get_value3")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
