...
#[cfg(feature = "ShockwaveEffect")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ShockwaveEffect {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ShockwaveEffect";
...
impl crate::GlobalNamespace::ShockwaveEffect {
    ...
    pub fn SpawnShockwave(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ShockwaveEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ShockwaveEffect as
                    quest_hook::libil2cpp::Type > ::class(), "SpawnShockwave", 1usize
                )
            });
