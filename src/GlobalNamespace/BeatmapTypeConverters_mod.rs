...
#[cfg(feature = "cordl_class_BeatmapTypeConverters")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapTypeConverters {
...
impl crate::GlobalNamespace::BeatmapTypeConverters {
    pub fn ConvertBasicBeatmapEventType(
        ...
        let __cordl_ret: crate::GlobalNamespace::BasicBeatmapEventType =
            unsafe { cordl_method_info.invoke_unchecked((), (beatmapEventType))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::GlobalNamespace::BeatmapEventDataBox_DistributionParamType =
            unsafe { cordl_method_info.invoke_unchecked((), (distributionParamType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ConvertEnvironmentColorType(
        ...
        let __cordl_ret: crate::GlobalNamespace::EnvironmentColorType =
            unsafe { cordl_method_info.invoke_unchecked((), (environmentColorType))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertLightAxis(
        ...
        let __cordl_ret: crate::GlobalNamespace::LightAxis =
            unsafe { cordl_method_info.invoke_unchecked((), (axis))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertLightRotationDirection(
        ...
        let __cordl_ret: crate::GlobalNamespace::LightRotationDirection =
            unsafe { cordl_method_info.invoke_unchecked((), (rotationDirection))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertNoteColorType_ColorType0(
        ...
        let __cordl_ret: crate::GlobalNamespace::ColorType =
            unsafe { cordl_method_info.invoke_unchecked((), (noteType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ConvertNoteCutDirection(
        ...
        let __cordl_ret: crate::GlobalNamespace::NoteCutDirection =
            unsafe { cordl_method_info.invoke_unchecked((), (noteCutDirection))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertNoteLineLayer_NoteLineLayer1(
        ...
        let __cordl_ret: crate::GlobalNamespace::NoteLineLayer =
            unsafe { cordl_method_info.invoke_unchecked((), (layer))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertNoteLineLayer_i32_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32), crate::GlobalNamespace::NoteLineLayer, 1usize>(
                        "ConvertNoteLineLayer",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn ConvertOffsetDirection(
        ...
        let __cordl_ret: crate::GlobalNamespace::OffsetDirection =
            unsafe { cordl_method_info.invoke_unchecked((), (offsetDirection))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertSliderDataType(
        ...
        let __cordl_ret: crate::GlobalNamespace::SliderData_Type =
            unsafe { cordl_method_info.invoke_unchecked((), (sliderType))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertSliderMidAnchorMode(
        ...
        let __cordl_ret: crate::GlobalNamespace::SliderMidAnchorMode =
            unsafe { cordl_method_info.invoke_unchecked((), (sliderMidAnchorMode))? };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertTransitionTypeToEaseType(
        ...
        let __cordl_ret: crate::GlobalNamespace::EaseType =
            unsafe { cordl_method_info.invoke_unchecked((), (transitionType))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BeatmapTypeConverters")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapTypeConverters {
