...
#[cfg(feature = "UnityLightWithId")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::UnityLightWithId {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "UnityLightWithId";
...
impl crate::GlobalNamespace::UnityLightWithId {
    pub fn ColorWasSet(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::UnityLightWithId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::UnityLightWithId as
