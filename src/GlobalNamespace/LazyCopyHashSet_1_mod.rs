...
pub struct LazyCopyHashSet_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _itemsCopy: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<T>>,
    pub _items: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::HashSet_1<T>>,
    pub _dirty: bool,
    ...
    for crate::GlobalNamespace::LazyCopyHashSet_1<T>
{
    ...
    const CLASS_NAME: &'static str = "LazyCopyHashSet`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "LazyCopyHashSet`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "LazyCopyHashSet_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::LazyCopyHashSet_1<T> {
    ...
    pub fn Remove(&mut self, item: T) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
