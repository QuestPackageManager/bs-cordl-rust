...
#[cfg(feature = "MirroredNoteController_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::MirroredNoteController_1<T> {
    ...
    pub fn Hide(&mut self, hide: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
    ...
    pub fn RemoveListeners(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RemoveListeners")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
impl<T: quest_hook::libil2cpp::Type>
    ...
    for crate::GlobalNamespace::MirroredNoteController_1<T>
{
    fn as_ref(&self) -> &crate::GlobalNamespace::INoteControllerNoteDidPassJumpThreeQuartersEvent {
