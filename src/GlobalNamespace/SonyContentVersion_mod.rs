#[cfg(feature = "cordl_class_SonyContentVersion")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::SonyContentVersion {
    ...
    > {
        ...
        > = unsafe { cordl_method_info.invoke_unchecked(self, (versionFormat))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetFromString", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::SonyContentVersion,
        > = unsafe { cordl_method_info.invoke_unchecked((), (versionString))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsVersionFormatValid", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (versionString))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (majorVersion, minorVersion, revision))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_SonyContentVersion+VersionFormat")]
#[repr(i32)]
