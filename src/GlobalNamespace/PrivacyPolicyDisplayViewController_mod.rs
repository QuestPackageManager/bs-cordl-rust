...
for crate::GlobalNamespace::PrivacyPolicyDisplayViewController {
    ...
    const CLASS_NAME: &'static str = "PrivacyPolicyDisplayViewController";
...
impl crate::GlobalNamespace::PrivacyPolicyDisplayViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PrivacyPolicyDisplayViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::PrivacyPolicyDisplayViewController as
