...
for crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId {
    ...
    const CLASS_NAME: &'static str = "BloomPrePassBackgroundColorsGradientTintColorWithLightId";
...
#[cfg(feature = "BloomPrePassBackgroundColorsGradientTintColorWithLightId")]
impl crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId {
    pub fn ColorWasSet(
        &mut self,
        color: crate::UnityEngine::Color,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightId
