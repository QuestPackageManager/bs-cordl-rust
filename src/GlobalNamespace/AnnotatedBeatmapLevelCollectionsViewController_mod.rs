...
pub struct AnnotatedBeatmapLevelCollectionsViewController {
    ...
    pub _annotatedBeatmapLevelCollectionsGridView:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridView>,
...
impl std::ops::Deref for crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsViewController {
...
#[cfg(feature = "AnnotatedBeatmapLevelCollectionsViewController")]
impl std::ops::DerefMut for crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsViewController {
...
impl crate::GlobalNamespace::AnnotatedBeatmapLevelCollectionsViewController {
    ...
    pub fn HandleDidSelectAnnotatedBeatmapLevelCollection(
        &mut self,
        beatmapLevelCollection: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatmapLevelPack>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (beatmapLevelCollection))? };
        Ok(__cordl_ret.into())
    }
