...
for crate::GlobalNamespace::INetworkPacketSubSerializer_1<TData> {
    ...
    const CLASS_NAME: &'static str = "INetworkPacketSubSerializer`1";
...
> crate::GlobalNamespace::INetworkPacketSubSerializer_1<TData> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::INetworkPacketSubSerializer_1<
            TData,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::INetworkPacketSubSerializer_1 < TData > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::INetworkPacketSubSerializer_1 < TData > as
                    quest_hook::libil2cpp::Type > ::class(), "HandlesType", 1usize
                )
            });
