...
for crate::GlobalNamespace::MultiplierValuesRecorder {
    ...
    const CLASS_NAME: &'static str = "MultiplierValuesRecorder";
...
impl crate::GlobalNamespace::MultiplierValuesRecorder {
    ...
    pub fn HandleScoreControllerMultiplierDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplierValuesRecorder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32, f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MultiplierValuesRecorder as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleScoreControllerMultiplierDidChange", 2usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplierValuesRecorder as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MultiplierValuesRecorder as
                    quest_hook::libil2cpp::Type > ::class(), "get_multiplierValues",
                    0usize
                )
            });
...
for crate::GlobalNamespace::MultiplierValuesRecorder_MultiplierValue {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultiplierValuesRecorder/MultiplierValue";
...
impl crate::GlobalNamespace::MultiplierValuesRecorder_MultiplierValue {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MultiplierValuesRecorder_MultiplierValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32, f32), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::MultiplierValuesRecorder_MultiplierValue as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (multiplier, _cordl_time))?
        };
        Ok(__cordl_ret.into())
    }
}
