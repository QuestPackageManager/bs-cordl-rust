...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for StretchableCube => ""."StretchableCube"
);
#[cfg(feature = "StretchableCube")]
impl std::ops::Deref for StretchableCube {
...
#[cfg(feature = "StretchableCube")]
impl std::ops::DerefMut for StretchableCube {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "StretchableCube")]
impl StretchableCube {
...
#[cfg(feature = "StretchableCube")]
impl quest_hook::libil2cpp::ObjectType for StretchableCube {
