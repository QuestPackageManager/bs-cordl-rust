...
for crate::GlobalNamespace::PlayingMultiplayerRichPresenceData {
    ...
    const CLASS_NAME: &'static str = "PlayingMultiplayerRichPresenceData";
...
impl crate::GlobalNamespace::PlayingMultiplayerRichPresenceData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayingMultiplayerRichPresenceData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlayingMultiplayerRichPresenceData as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (atMaxPartySize))?
        };
        Ok(__cordl_ret.into())
    }
}
