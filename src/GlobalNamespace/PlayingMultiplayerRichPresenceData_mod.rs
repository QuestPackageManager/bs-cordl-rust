...
impl crate::GlobalNamespace::PlayingMultiplayerRichPresenceData {
    pub const kPlayingMultiplayerLobbyRichPresenceLocalizationKey: &'static str =
        "PLAYING_MULTIPLAYER_PRESENCE";
    pub fn New(
        atMaxPartySize: bool,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (atMaxPartySize))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_PlayingMultiplayerRichPresenceData")]
