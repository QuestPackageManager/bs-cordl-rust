#[cfg(feature = "cordl_class_MultiplayerBadgeDataComboSO")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MultiplayerBadgeDataComboSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerBadgeDataComboSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultiplayerBadgeDataComboSO";
...
#[cfg(feature = "cordl_class_MultiplayerBadgeDataComboSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerBadgeDataComboSO {
