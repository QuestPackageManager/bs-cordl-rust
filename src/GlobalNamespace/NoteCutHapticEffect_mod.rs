...
impl crate::GlobalNamespace::NoteCutHapticEffect {
    ...
    pub fn HitNote(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoteCutHapticEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoteCutHapticEffect as
                    quest_hook::libil2cpp::Type > ::class(), "HitNote", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (saberType, _cordl_type))?
        };
        Ok(__cordl_ret.into())
    }
