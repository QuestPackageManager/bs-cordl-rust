...
for crate::GlobalNamespace::ObjectsMovementRecorderEditorInstaller {
    ...
    const CLASS_NAME: &'static str = "ObjectsMovementRecorderEditorInstaller";
...
#[cfg(feature = "ObjectsMovementRecorderEditorInstaller")]
impl crate::GlobalNamespace::ObjectsMovementRecorderEditorInstaller {
    pub fn InstallBindings(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ObjectsMovementRecorderEditorInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ObjectsMovementRecorderEditorInstaller as
