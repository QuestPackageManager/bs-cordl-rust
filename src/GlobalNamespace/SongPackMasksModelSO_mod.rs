...
for crate::GlobalNamespace::SongPackMasksModelSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "SongPackMasksModelSO";
...
impl crate::GlobalNamespace::SongPackMasksModelSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SongPackMasksModelSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::SongPackMasksModelSO as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SongPackMasksModelSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                ...
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
                        quest_hook::libil2cpp::Gc<
                            crate::GlobalNamespace::SongPackMasksModelItem,
                        >,
                    >,
                >,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "get_customSongPackMaskItems", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SongPackMasksModelSO as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SongPackMasksModelSO as
                    quest_hook::libil2cpp::Type > ::class(),
                    "get_defaultSongPackMaskItems", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::IReadOnlyList_1<
