...
#[cfg(feature = "cordl_class_SpawnRotationChevron")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SpawnRotationChevron {
...
impl crate::GlobalNamespace::SpawnRotationChevron {
    ...
    pub fn UpdateLights(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_SpawnRotationChevron+Pool")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::SpawnRotationChevron_Pool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_SpawnRotationChevron+Pool")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::SpawnRotationChevron_Pool {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
