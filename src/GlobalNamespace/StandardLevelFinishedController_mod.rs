...
for crate::GlobalNamespace::StandardLevelFinishedController {
    ...
    const CLASS_NAME: &'static str = "StandardLevelFinishedController";
...
impl crate::GlobalNamespace::StandardLevelFinishedController {
    pub fn HandleLevelFinished(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StandardLevelFinishedController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::StandardLevelFinishedController as
    ...
    pub fn StartLevelFinished(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StandardLevelFinishedController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("StartLevelFinished")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::StandardLevelFinishedController as
                    quest_hook::libil2cpp::Type > ::class(), "StartLevelFinished", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
