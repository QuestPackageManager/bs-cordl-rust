...
for crate::GlobalNamespace::StaticEnvironmentLights {
    ...
    const CLASS_NAME: &'static str = "StaticEnvironmentLights";
...
#[cfg(feature = "StaticEnvironmentLights")]
impl crate::GlobalNamespace::StaticEnvironmentLights {
    pub fn Awake(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::StaticEnvironmentLights as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::StaticEnvironmentLights as
