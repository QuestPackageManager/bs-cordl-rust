...
impl crate::GlobalNamespace::LocalizedHoverHint {
    ...
    pub fn SetText(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LocalizedHoverHint as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<crate::HMUI::HoverHint>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LocalizedHoverHint as
                    quest_hook::libil2cpp::Type > ::class(), "SetText", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (hoverHint, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateAlignment(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (hoverHint, direction))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
