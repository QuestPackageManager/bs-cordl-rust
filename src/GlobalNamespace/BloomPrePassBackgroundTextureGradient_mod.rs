    ...
    for crate::GlobalNamespace::BloomPrePassBackgroundTextureGradient
{
    ...
    const CLASS_NAME: &'static str = "BloomPrePassBackgroundTextureGradient";
...
#[cfg(feature = "BloomPrePassBackgroundTextureGradient")]
impl std::ops::DerefMut for crate::GlobalNamespace::BloomPrePassBackgroundTextureGradient {
...
impl crate::GlobalNamespace::BloomPrePassBackgroundTextureGradient {
    ...
    pub fn UpdateGradientTexture(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("UpdateGradientTexture")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
