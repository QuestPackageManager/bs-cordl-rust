...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for LevelPackDetailViewController => ""
    ."LevelPackDetailViewController"
);
#[cfg(feature = "LevelPackDetailViewController")]
impl std::ops::Deref for LevelPackDetailViewController {
...
#[cfg(feature = "LevelPackDetailViewController")]
impl std::ops::DerefMut for LevelPackDetailViewController {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "LevelPackDetailViewController")]
impl LevelPackDetailViewController {
...
#[cfg(feature = "LevelPackDetailViewController")]
impl quest_hook::libil2cpp::ObjectType for LevelPackDetailViewController {
