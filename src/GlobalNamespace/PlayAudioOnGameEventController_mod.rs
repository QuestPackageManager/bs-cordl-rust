...
#[cfg(feature = "cordl_class_PlayAudioOnGameEventController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PlayAudioOnGameEventController {
...
#[cfg(feature = "cordl_class_PlayAudioOnGameEventController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PlayAudioOnGameEventController {
...
#[cfg(feature = "PlayAudioOnGameEventController+EventAudioBinding")]
impl std::ops::Deref for crate::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding {
...
impl crate::GlobalNamespace::PlayAudioOnGameEventController_EventAudioBinding {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (audioClipQueue))? };
        Ok(__cordl_ret.into())
    }
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
