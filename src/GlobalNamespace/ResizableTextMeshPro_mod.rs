...
for crate::GlobalNamespace::ResizableTextMeshPro {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "ResizableTextMeshPro";
...
impl crate::GlobalNamespace::ResizableTextMeshPro {
    pub fn HandleTextDidChange(
        &mut self,
        textMeshPro: quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ResizableTextMeshPro as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ResizableTextMeshPro as
                    quest_hook::libil2cpp::Type > ::class(), "HandleTextDidChange",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (textMeshPro))?
        };
        Ok(__cordl_ret.into())
    }
