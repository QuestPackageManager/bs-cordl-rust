#[cfg(feature = "cordl_class_ResizableTextMeshPro")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_ResizableTextMeshPro")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ResizableTextMeshPro {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HandleTextDidChange", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (textMeshPro))? };
        Ok(__cordl_ret.into())
    }
