#[cfg(feature = "cordl_class_BloomFogParamsBehaviour")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_BloomFogParamsBehaviour")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BloomFogParamsBehaviour {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BloomFogParamsBehaviour";
...
#[cfg(feature = "cordl_class_BloomFogParamsBehaviour")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BloomFogParamsBehaviour {
