...
pub struct BloomFogParamsBehaviour {
    ...
    pub _bloomFogParams: *mut BloomFogEnvironmentParams,
    pub _blend: f32,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BloomFogParamsBehaviour => ""."BloomFogParamsBehaviour"
);
#[cfg(feature = "BloomFogParamsBehaviour")]
impl std::ops::Deref for BloomFogParamsBehaviour {
...
#[cfg(feature = "BloomFogParamsBehaviour")]
impl std::ops::DerefMut for BloomFogParamsBehaviour {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BloomFogParamsBehaviour")]
impl BloomFogParamsBehaviour {
...
#[cfg(feature = "BloomFogParamsBehaviour")]
impl quest_hook::libil2cpp::ObjectType for BloomFogParamsBehaviour {
