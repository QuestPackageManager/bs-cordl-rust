...
impl crate::GlobalNamespace::BloomFogParamsBehaviour {
    ...
    pub fn OnPlayableDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::BloomFogParamsBehaviour as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::BloomFogParamsBehaviour as
