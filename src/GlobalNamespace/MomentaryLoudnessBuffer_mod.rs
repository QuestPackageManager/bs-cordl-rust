...
#[cfg(feature = "cordl_class_MomentaryLoudnessBuffer")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MomentaryLoudnessBuffer {
...
impl crate::GlobalNamespace::MomentaryLoudnessBuffer {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("AddSample")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, i32, f32, i32), quest_hook::libil2cpp::Void, 4usize>(
                        ".ctor",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_isNextReadingIntervalReady(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_isNextReadingIntervalReady")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_isNextReadingIntervalReady",
                            0usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_MomentaryLoudnessBuffer")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MomentaryLoudnessBuffer {
