#[cfg(feature = "cordl_class_MaterialPropertyBlockControllerRandomValueSetter")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter
{
    ...
    const CLASS_NAME: &'static str = "MaterialPropertyBlockControllerRandomValueSetter";
...
impl std::ops::Deref for crate::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter {
