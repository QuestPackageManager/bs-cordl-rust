...
impl crate::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter {
    pub fn ApplyParams(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter as quest_hook::libil2cpp::Type>::class()
