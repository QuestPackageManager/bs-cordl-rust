...
for crate::GlobalNamespace::FileBrowserTableCell {
    ...
    const CLASS_NAME: &'static str = "FileBrowserTableCell";
...
#[cfg(feature = "FileBrowserTableCell")]
impl crate::GlobalNamespace::FileBrowserTableCell {
    pub fn HighlightDidChange(
        &mut self,
        transitionType: crate::HMUI::SelectableCell_TransitionType,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::FileBrowserTableCell as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::FileBrowserTableCell as
