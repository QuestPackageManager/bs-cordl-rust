...
impl crate::GlobalNamespace::OVRSemanticLabels {
    pub const DeprecationMessage: &'static str = "String-based labels are deprecated (v65). Please use the equivalent enum-based methods.";
    ...
    > {
        ...
        let __cordl_ret: crate::GlobalNamespace::OVRSemanticLabels_Classification = unsafe {
            cordl_method_info.invoke_unchecked((), (singleLabel))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FromApiString", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (apiLabels, classifications))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetClassifications", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (classifications))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IOVRAnchorComponent_OVRSemanticLabels__FromAnchor(
        ...
        let __cordl_ret: crate::GlobalNamespace::OVRSemanticLabels = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRSemanticLabels>.get_Handle", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<FromApiString>g__AddLabel|30_0", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (label, labels))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _FromApiString_g__IndexOf_30_1(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (s, c, start))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
