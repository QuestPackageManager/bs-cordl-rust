...
#[cfg(feature = "cordl_class_OVRSemanticLabels")]
unsafe impl quest_hook::libil2cpp::Argument for crate::GlobalNamespace::OVRSemanticLabels {
    type Type = Self;
...
#[cfg(feature = "cordl_class_OVRSemanticLabels")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::GlobalNamespace::OVRSemanticLabels {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRSemanticLabels")]
unsafe impl quest_hook::libil2cpp::Returned for crate::GlobalNamespace::OVRSemanticLabels {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_OVRSemanticLabels")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::GlobalNamespace::OVRSemanticLabels {
    type Type = Self;
...
impl crate::GlobalNamespace::OVRSemanticLabels {
    pub const DeprecationMessage: &'static str =
        "String-based labels are deprecated (v65). Please use the equivalent enum-based methods.";
    #[cfg(feature = "OVRSemanticLabels+Classification")]
    pub type Classification = crate::GlobalNamespace::OVRSemanticLabels_Classification;
    ...
    pub fn Equals_OVRSemanticLabels0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::GlobalNamespace::OVRSemanticLabels), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn FromApiLabel(
        singleLabel: crate::System::ReadOnlySpan_1<char>,
    ) -> quest_hook::libil2cpp::Result<crate::GlobalNamespace::OVRSemanticLabels_Classification>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::GlobalNamespace::OVRSemanticLabels_Classification =
            unsafe { cordl_method_info.invoke_unchecked((), (singleLabel))? };
        Ok(__cordl_ret.into())
    }
    pub fn FromApiString(
        apiLabels: crate::System::ReadOnlySpan_1<char>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("FromApiString")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (apiLabels, classifications))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetClassifications(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (classifications))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRSemanticLabels>.FromAnchor", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::GlobalNamespace::OVRSemanticLabels =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IOVRAnchorComponent<OVRSemanticLabels>.get_Type", 0usize
                        )
                    })
            });
    ...
    pub fn ToApiLabel(
        classification: crate::GlobalNamespace::OVRSemanticLabels_Classification,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (classification))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToApiString(
        classifications: quest_hook::libil2cpp::Gc<
    ...
    pub fn _FromApiString_g__AddLabel_30_0(
        label: crate::System::ReadOnlySpan_1<char>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (label, labels))? };
        Ok(__cordl_ret.into())
    }
    pub fn _FromApiString_g__IndexOf_30_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        (crate::System::ReadOnlySpan_1<char>, char, i32),
                        i32,
                        3usize,
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<FromApiString>g__IndexOf|30_1", 3usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (s, c, start))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "OVRSemanticLabels")]
impl AsRef<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSemanticLabels>>
    for crate::GlobalNamespace::OVRSemanticLabels
{
    fn as_ref(
        &self,
    ) -> &crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSemanticLabels>
    {
        todo!()
    }
}
#[cfg(feature = "OVRSemanticLabels")]
impl AsMut<crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSemanticLabels>>
    for crate::GlobalNamespace::OVRSemanticLabels
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::GlobalNamespace::IOVRAnchorComponent_1<crate::GlobalNamespace::OVRSemanticLabels>
    {
        todo!()
    }
}
...
impl AsRef<crate::System::IEquatable_1<crate::GlobalNamespace::OVRSemanticLabels>>
    for crate::GlobalNamespace::OVRSemanticLabels
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::GlobalNamespace::OVRSemanticLabels> {
        todo!()
    }
}
#[cfg(feature = "OVRSemanticLabels")]
...
#[cfg(feature = "cordl_class_OVRSemanticLabels+Classification")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
#[cfg_attr(feature = "derive_Clone", derive(Clone))]
...
#[cfg_attr(feature = "derive_Default", derive(Default))]
#[repr(i32)]
pub enum OVRSemanticLabels_Classification {
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::GlobalNamespace::OVRSemanticLabels_Classification
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "OVRSemanticLabels/Classification";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
