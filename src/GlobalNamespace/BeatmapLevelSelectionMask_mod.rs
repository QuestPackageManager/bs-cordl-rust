...
impl crate::GlobalNamespace::BeatmapLevelSelectionMask {
    ...
    > {
        ...
        let __cordl_ret: crate::GlobalNamespace::BeatmapLevelSelectionMask = unsafe {
            cordl_method_info.invoke_unchecked((), (reader, version))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Serialize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (writer, version))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (difficulties, modifiers, songPacks))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn op_Equality(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (l, r))?
        };
        Ok(__cordl_ret.into())
    }
