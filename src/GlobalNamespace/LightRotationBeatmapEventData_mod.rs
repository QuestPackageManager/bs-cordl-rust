#[cfg(feature = "cordl_class_LightRotationBeatmapEventData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_LightRotationBeatmapEventData")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::LightRotationBeatmapEventData {
...
impl crate::GlobalNamespace::LightRotationBeatmapEventData {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SubtypeIdentifier", 3usize
                        )
                    })
            });
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (groupId, elementId, axis))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
    ...
    pub fn get_axis(&mut self) -> quest_hook::libil2cpp::Result<crate::GlobalNamespace::LightAxis> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_rotationDirection(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::GlobalNamespace::LightRotationDirection, 0usize>(
...
#[cfg(feature = "cordl_class_LightRotationBeatmapEventData")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::LightRotationBeatmapEventData {
