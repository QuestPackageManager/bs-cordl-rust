...
for crate::GlobalNamespace::AppInitSetupInstaller {
    ...
    const CLASS_NAME: &'static str = "AppInitSetupInstaller";
...
impl crate::GlobalNamespace::AppInitSetupInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::AppInitSetupInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::AppInitSetupInstaller as
