...
impl crate::GlobalNamespace::OVRGazePointer {
    ...
    pub fn SetCursorStartDest(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl__, pos, normal))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Show(
