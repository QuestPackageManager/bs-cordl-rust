...
impl crate::GlobalNamespace::ProfanityFilter {
    ...
    pub fn GetLookalikeLetters(
        ...
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IEnumerable_1<char>>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(char), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IEnumerable_1<char>,
                    >, 1usize>("GetLookalikeLetters")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn IsProfane(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (word))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (wordList))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_ProfanityFilter")]
...
#[cfg(feature = "cordl_class_ProfanityFilter+TrieNode")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ProfanityFilter_TrieNode {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::ProfanityFilter_TrieNode {
    pub fn AddWord(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("AddWord")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (word, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsMatch(
        &mut self,
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (word, index))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_ProfanityFilter+TrieNode")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::ProfanityFilter_TrieNode {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
