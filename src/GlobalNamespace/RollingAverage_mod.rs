#[cfg(feature = "cordl_class_RollingAverage")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::GlobalNamespace::RollingAverage {
    ...
    pub fn New(window: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (window))? };
        Ok(__cordl_ret.into())
    }
