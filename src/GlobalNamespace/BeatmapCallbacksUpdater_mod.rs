#[cfg(feature = "cordl_class_BeatmapCallbacksUpdater")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatmapCallbacksUpdater")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::BeatmapCallbacksUpdater {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "BeatmapCallbacksUpdater";
...
#[cfg(feature = "cordl_class_BeatmapCallbacksUpdater")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::BeatmapCallbacksUpdater {
