...
#[cfg(feature = "ITimeProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::ITimeProvider {
...
impl crate::GlobalNamespace::ITimeProvider {
    ...
    pub fn get_time(&mut self) -> quest_hook::libil2cpp::Result<i64> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ITimeProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i64, 0usize>("get_time")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::ITimeProvider as quest_hook::libil2cpp::Type
