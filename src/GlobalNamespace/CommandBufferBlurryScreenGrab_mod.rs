...
#[cfg(feature = "cordl_class_CommandBufferBlurryScreenGrab")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::CommandBufferBlurryScreenGrab {
...
impl crate::GlobalNamespace::CommandBufferBlurryScreenGrab {
    ...
    pub fn CommandBufferCameraEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Rendering::CameraEvent, 0usize>(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::CameraEvent =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_CommandBufferBlurryScreenGrab")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::CommandBufferBlurryScreenGrab {
