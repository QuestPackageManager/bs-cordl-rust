...
impl crate::GlobalNamespace::MissionLevelAnalytics {
    pub fn HandleMissionLevelDidFinishEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::MissionLevelAnalytics as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::MissionLevelAnalytics as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleMissionLevelDidFinishEvent", 2usize
                )
            });
