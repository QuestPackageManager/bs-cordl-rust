...
for crate::GlobalNamespace::RotateBySpawnRotation {
    ...
    const CLASS_NAME: &'static str = "RotateBySpawnRotation";
...
impl crate::GlobalNamespace::RotateBySpawnRotation {
    pub fn FixedUpdate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::RotateBySpawnRotation as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FixedUpdate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::RotateBySpawnRotation as
