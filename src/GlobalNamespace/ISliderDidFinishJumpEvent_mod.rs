...
impl crate::GlobalNamespace::ISliderDidFinishJumpEvent {
    pub fn HandleSliderDidFinishJump(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ISliderDidFinishJumpEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ISliderDidFinishJumpEvent as
