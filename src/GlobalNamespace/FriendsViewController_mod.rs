...
pub struct FriendsViewController {
    ...
    pub _enableOpenPartyToggle: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle>,
    pub _networkPlayerModel:
...
#[cfg(feature = "cordl_class_FriendsViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FriendsViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "FriendsViewController";
...
impl crate::GlobalNamespace::FriendsViewController {
    ...
    pub fn HandleOpenPartyToggleChanged(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (openParty))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RefreshParty(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("RefreshParty")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (overrideHide))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_FriendsViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::FriendsViewController {
