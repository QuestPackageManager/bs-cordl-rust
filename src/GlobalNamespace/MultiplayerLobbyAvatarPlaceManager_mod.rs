...
pub struct MultiplayerLobbyAvatarPlaceManager {
    ...
    pub _avatarPlacesPool:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MultiplayerLobbyAvatarPlace_Pool>,
...
impl crate::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager {
    ...
    pub fn SpawnAllPlaces(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
