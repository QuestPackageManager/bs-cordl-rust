#[cfg(feature = "cordl_class_MultipliedAndAddedColorSO")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_MultipliedAndAddedColorSO")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultipliedAndAddedColorSO {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultipliedAndAddedColorSO";
...
#[cfg(feature = "cordl_class_MultipliedAndAddedColorSO")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultipliedAndAddedColorSO {
