...
#[cfg(feature = "cordl_class_AlphabetScrollInfo+Data")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::AlphabetScrollInfo_Data {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
...
impl crate::GlobalNamespace::AlphabetScrollInfo_Data {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (character, cellIdx))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_AlphabetScrollInfo+Data")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::AlphabetScrollInfo_Data {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
