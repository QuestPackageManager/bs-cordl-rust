...
impl std::ops::Deref for crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO {
...
#[cfg(feature = "ShaderWarmupScenesTransitionSetupDataSO")]
impl std::ops::DerefMut for crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO {
...
impl crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO {
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (shaderWarmupSceneSetupData))? };
        Ok(__cordl_ret.into())
    }
