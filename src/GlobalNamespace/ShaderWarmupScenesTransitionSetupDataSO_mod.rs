...
for crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO {
    ...
    const CLASS_NAME: &'static str = "ShaderWarmupScenesTransitionSetupDataSO";
...
impl crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO {
    pub fn Init(
        &mut self,
        shaderWarmupSceneSetupData: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::ShaderWarmupSceneSetupData,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO as
                    quest_hook::libil2cpp::Type > ::class(), "Init", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (shaderWarmupSceneSetupData))?
        };
        Ok(__cordl_ret.into())
    }
