...
pub struct OVRScenePlane {
    ...
    pub _previousBoundary: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::Vector2>,
    pub _boundaryLength: crate::Unity::Collections::NativeArray_1<i32>,
    pub _boundaryBuffer: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::Vector2>,
...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRScenePlane {
    ...
    const CLASS_NAME: &'static str = "OVRScenePlane";
...
impl crate::GlobalNamespace::OVRScenePlane {
    ...
    pub fn RequestBoundary(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RequestBoundary")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ScheduleGetLengthJob(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ScheduleGetLengthJob")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetChildOffset(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn SetChildScale(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_Boundary(
        ...
        quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::IReadOnlyList_1<crate::UnityEngine::Vector2>,
        >,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
    ...
    pub fn get_Dimensions(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector2> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector2, 0usize>("get_Dimensions")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_ScaleChildren(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_ScaleChildren")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "OVRScenePlane")]
impl AsRef<crate::GlobalNamespace::IOVRSceneComponent> for crate::GlobalNamespace::OVRScenePlane {
    fn as_ref(&self) -> &crate::GlobalNamespace::IOVRSceneComponent {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "OVRScenePlane")]
impl AsMut<crate::GlobalNamespace::IOVRSceneComponent> for crate::GlobalNamespace::OVRScenePlane {
...
pub struct OVRScenePlane_GetBoundaryJob {
    ...
    pub PreviousBoundary: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::Vector2>,
}
#[cfg(feature = "cordl_class_OVRScenePlane+GetBoundaryJob")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::OVRScenePlane_GetBoundaryJob {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "";
...
#[cfg(feature = "cordl_class_OVRScenePlane+GetBoundaryJob")]
unsafe impl quest_hook::libil2cpp::Return for crate::GlobalNamespace::OVRScenePlane_GetBoundaryJob {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::GlobalNamespace::OVRScenePlane_GetBoundaryJob {
    ...
    pub fn HasBoundaryChanged(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("HasBoundaryChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "SetNaN",
                            1usize
                        )
                    })
            });
...
#[cfg(feature = "OVRScenePlane+GetBoundaryJob")]
impl AsRef<crate::Unity::Jobs::IJob> for crate::GlobalNamespace::OVRScenePlane_GetBoundaryJob {
    fn as_ref(&self) -> &crate::Unity::Jobs::IJob {
        todo!()
    }
}
#[cfg(feature = "OVRScenePlane+GetBoundaryJob")]
impl AsMut<crate::Unity::Jobs::IJob> for crate::GlobalNamespace::OVRScenePlane_GetBoundaryJob {
