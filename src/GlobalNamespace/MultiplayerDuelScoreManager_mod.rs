#[cfg(feature = "cordl_class_MultiplayerDuelScoreManager")]
#[repr(C)]
#[derive(Debug)]
pub struct MultiplayerDuelScoreManager {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _scoreItem: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MultiplayerScoreItem>,
    ...
    pub _opponentPlayer: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IConnectedPlayer>,
    pub _timeSinceLastScoreUpdate: f32,
}
#[cfg(feature = "cordl_class_MultiplayerDuelScoreManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::MultiplayerDuelScoreManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "MultiplayerDuelScoreManager";
...
impl crate::GlobalNamespace::MultiplayerDuelScoreManager {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("EnsureOpponentAssigned")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn UpdateScoreAndName(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("UpdateScoreAndName")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_MultiplayerDuelScoreManager")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::MultiplayerDuelScoreManager {
