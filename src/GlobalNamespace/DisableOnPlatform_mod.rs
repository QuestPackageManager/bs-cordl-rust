...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::DisableOnPlatform {
    ...
    const CLASS_NAME: &'static str = "DisableOnPlatform";
...
impl crate::GlobalNamespace::DisableOnPlatform {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::DisableOnPlatform as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::DisableOnPlatform as
