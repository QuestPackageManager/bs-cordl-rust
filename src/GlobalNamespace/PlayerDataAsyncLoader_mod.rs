...
pub struct PlayerDataAsyncLoader {
    ...
    pub _playerDataContent: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_PlayerDataAsyncLoader")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::PlayerDataAsyncLoader {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "PlayerDataAsyncLoader";
...
#[cfg(feature = "cordl_class_PlayerDataAsyncLoader")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::PlayerDataAsyncLoader {
