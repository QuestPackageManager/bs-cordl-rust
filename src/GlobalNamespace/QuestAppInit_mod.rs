...
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::QuestAppInit {
    ...
    const CLASS_NAME: &'static str = "QuestAppInit";
...
impl crate::GlobalNamespace::QuestAppInit {
    pub fn AppStartAndMultiSceneEditorSetup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::QuestAppInit as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::QuestAppInit as quest_hook::libil2cpp::Type
