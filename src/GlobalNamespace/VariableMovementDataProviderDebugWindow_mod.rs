...
for crate::GlobalNamespace::VariableMovementDataProviderDebugWindow {
    ...
    const CLASS_NAME: &'static str = "VariableMovementDataProviderDebugWindow";
...
impl crate::GlobalNamespace::VariableMovementDataProviderDebugWindow {
    ...
    pub fn OnGUI(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::VariableMovementDataProviderDebugWindow as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnGUI")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::VariableMovementDataProviderDebugWindow as
                    quest_hook::libil2cpp::Type > ::class(), "OnGUI", 0usize
                )
            });
