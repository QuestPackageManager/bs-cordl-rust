...
impl crate::GlobalNamespace::TubeLightBehaviour {
    ...
    pub fn OnPlayableDestroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::TubeLightBehaviour as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::TubeLightBehaviour as
