...
for crate::GlobalNamespace::ICutScoreBufferDidChangeReceiver {
    ...
    const CLASS_NAME: &'static str = "ICutScoreBufferDidChangeReceiver";
...
impl crate::GlobalNamespace::ICutScoreBufferDidChangeReceiver {
    pub fn HandleCutScoreBufferDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::ICutScoreBufferDidChangeReceiver as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::ICutScoreBufferDidChangeReceiver as
