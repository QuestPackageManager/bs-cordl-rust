...
#[cfg(feature = "DefaultUnityXRHapticsHandler")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IUnityXRHapticsHandler>>
for crate::GlobalNamespace::DefaultUnityXRHapticsHandler {
    fn as_ref(
        &self,
...
#[cfg(feature = "DefaultUnityXRHapticsHandler")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IUnityXRHapticsHandler>>
for crate::GlobalNamespace::DefaultUnityXRHapticsHandler {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IUnityXRHapticsHandler> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "DefaultUnityXRHapticsHandler")]
