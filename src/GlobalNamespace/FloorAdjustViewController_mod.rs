...
pub struct FloorAdjustViewController {
    ...
    pub _settingsApplicator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SettingsApplicatorSO>,
    pub _playerHeight: f32,
}
#[cfg(feature = "cordl_class_FloorAdjustViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::FloorAdjustViewController {
...
impl crate::GlobalNamespace::FloorAdjustViewController {
    ...
    pub fn _DidActivate_b__10_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<DidActivate>b__10_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _DidActivate_b__10_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("<DidActivate>b__10_1")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_FloorAdjustViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::GlobalNamespace::FloorAdjustViewController {
