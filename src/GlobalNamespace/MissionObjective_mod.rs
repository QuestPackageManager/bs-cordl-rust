...
pub struct MissionObjective {
    ...
    pub _referenceValueComparisonType:
...
impl crate::GlobalNamespace::MissionObjective {
    ...
    pub type ReferenceValueComparisonType =
        crate::GlobalNamespace::MissionObjective_ReferenceValueComparisonType;
    pub fn Equals(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: crate::GlobalNamespace::MissionObjective_ReferenceValueComparisonType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_type(
