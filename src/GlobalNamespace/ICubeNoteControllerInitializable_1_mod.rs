#[cfg(feature = "cordl_class_ICubeNoteControllerInitializable_1")]
    ...
    for crate::GlobalNamespace::ICubeNoteControllerInitializable_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "ICubeNoteControllerInitializable`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "ICubeNoteControllerInitializable_1")]
impl<T: quest_hook::libil2cpp::Type> crate::GlobalNamespace::ICubeNoteControllerInitializable_1<T> {
