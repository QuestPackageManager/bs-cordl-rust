#[cfg(feature = "cordl_class_MissionSelectionMapViewController")]
#[repr(C)]
#[derive(Debug)]
pub struct MissionSelectionMapViewController {
    __cordl_parent: crate::HMUI::ViewController,
    pub _mapScrollView: quest_hook::libil2cpp::Gc<crate::HMUI::ScrollView>,
    pub _missionNodeSelectionManager:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNodeSelectionManager>,
    pub _missionMapAnimationController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionMapAnimationController>,
    ...
    pub didSelectMissionLevelEvent: quest_hook::libil2cpp::Gc<
        crate::System::Action_2<
            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionSelectionMapViewController>,
            quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNode>,
        >,
    >,
    pub _selectedMissionNode: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::MissionNode>,
}
#[cfg(feature = "cordl_class_MissionSelectionMapViewController")]
    ...
    for crate::GlobalNamespace::MissionSelectionMapViewController
{
    ...
    const CLASS_NAME: &'static str = "MissionSelectionMapViewController";
...
impl crate::GlobalNamespace::MissionSelectionMapViewController {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("DeselectSelectedNode")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn HandleMissionNodeSelectionManagerDidSelectMissionNode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (missionNodeVisualController))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShowMissionClearedAnimation", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SongPlayerCrossfadeToLevelAsync", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn get_animatedUpdateIsRequired(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
