...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for BTSCharacterSpawnEventValueParser => ""
    ."BTSCharacterSpawnEventValueParser"
);
#[cfg(feature = "BTSCharacterSpawnEventValueParser")]
impl std::ops::Deref for BTSCharacterSpawnEventValueParser {
...
#[cfg(feature = "BTSCharacterSpawnEventValueParser")]
impl std::ops::DerefMut for BTSCharacterSpawnEventValueParser {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "BTSCharacterSpawnEventValueParser")]
impl BTSCharacterSpawnEventValueParser {
...
#[cfg(feature = "BTSCharacterSpawnEventValueParser")]
impl quest_hook::libil2cpp::ObjectType for BTSCharacterSpawnEventValueParser {
