...
> {
    __cordl_parent: crate::GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>,
    pub _player: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBeatSaberConnectedPlayer>,
    ...
    for crate::GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("", "LocalMultiplayerSyncState`3")
                .unwrap()
...
impl<
    ...
    for crate::GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>
{
    type Target = crate::GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>;
    ...
    > crate::GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i64), quest_hook::libil2cpp::Void, 1usize>("SetCurrentTime")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IPacketPool_1<T>>,
                        quest_hook::libil2cpp::ByRefMut<T>,
                    ), bool, 2usize>("TryGetSerializedState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (pool, serializable))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IPacketPool_1<T>>,
                        quest_hook::libil2cpp::ByRefMut<T>,
                    ), bool, 2usize>("TryGetSerializedStateDelta")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TState = unsafe { cordl_method_info.invoke_unchecked(self, (t))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_player(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TType, TState), quest_hook::libil2cpp::Void, 2usize>("set_Item")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (t, value))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_LocalMultiplayerSyncState_3")]
