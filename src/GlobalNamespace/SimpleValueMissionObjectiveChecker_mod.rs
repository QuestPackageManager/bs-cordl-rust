...
for crate::GlobalNamespace::SimpleValueMissionObjectiveChecker {
    ...
    const CLASS_NAME: &'static str = "SimpleValueMissionObjectiveChecker";
...
impl crate::GlobalNamespace::SimpleValueMissionObjectiveChecker {
    pub fn CheckAndUpdateStatus(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SimpleValueMissionObjectiveChecker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SimpleValueMissionObjectiveChecker as
