...
impl<
        ...
        TType: quest_hook::libil2cpp::Type,
        TState: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::GlobalNamespace::LocalStateBuffer_3<TStateTable, TType, TState>
{
    ...
    > crate::GlobalNamespace::LocalStateBuffer_3<TStateTable, TType, TState>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 3usize>("TryGetSerializedState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, _cordl_time, id))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<crate::GlobalNamespace::SyncStateId>,
                    ), bool, 3usize>("TryGetSerializedStateDelta")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (delta, timeOffset, baseId))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
