#[cfg(feature = "cordl_class_PlayersMissingEntitlementsNetSerializable")]
#[repr(C)]
...
impl std::ops::Deref for crate::GlobalNamespace::PlayersMissingEntitlementsNetSerializable {
...
#[cfg(feature = "PlayersMissingEntitlementsNetSerializable")]
impl std::ops::DerefMut for crate::GlobalNamespace::PlayersMissingEntitlementsNetSerializable {
...
impl crate::GlobalNamespace::PlayersMissingEntitlementsNetSerializable {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::GlobalNamespace::PlayersMissingEntitlementsNetSerializable,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (playersWithoutEntitlements))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    >, 0usize>("get_playersWithoutEntitlements")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
