...
#[cfg(feature = "SimpleDialogPromptViewController")]
impl std::ops::DerefMut for crate::GlobalNamespace::SimpleDialogPromptViewController {
...
impl crate::GlobalNamespace::SimpleDialogPromptViewController {
    pub fn DidActivate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::SimpleDialogPromptViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (bool, bool, bool),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::SimpleDialogPromptViewController as
    ...
    pub fn Init_Action_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (title, message, buttonText, didFinishAction))?
        };
        Ok(__cordl_ret.into())
    }
