...
#[cfg(feature = "NoteCutScoreSpawner")]
unsafe impl quest_hook::libil2cpp::Type for crate::GlobalNamespace::NoteCutScoreSpawner {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "";
    const CLASS_NAME: &'static str = "NoteCutScoreSpawner";
...
impl crate::GlobalNamespace::NoteCutScoreSpawner {
    pub fn HandleScoringForNoteStarted(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::NoteCutScoreSpawner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::NoteCutScoreSpawner as
                    quest_hook::libil2cpp::Type > ::class(),
                    "HandleScoringForNoteStarted", 1usize
                )
            });
