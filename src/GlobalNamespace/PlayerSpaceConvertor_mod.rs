...
for crate::GlobalNamespace::PlayerSpaceConvertor {
    ...
    const CLASS_NAME: &'static str = "PlayerSpaceConvertor";
...
impl crate::GlobalNamespace::PlayerSpaceConvertor {
    ...
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayerSpaceConvertor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::GlobalNamespace::PlayerSpaceConvertor as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::PlayerSpaceConvertor as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "get_worldToPlayerSpaceRotation", 0usize
                )
            });
