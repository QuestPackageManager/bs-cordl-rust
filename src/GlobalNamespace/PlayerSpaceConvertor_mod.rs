...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for PlayerSpaceConvertor => ""."PlayerSpaceConvertor"
);
#[cfg(feature = "PlayerSpaceConvertor")]
impl std::ops::Deref for PlayerSpaceConvertor {
...
#[cfg(feature = "PlayerSpaceConvertor")]
impl std::ops::DerefMut for PlayerSpaceConvertor {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "PlayerSpaceConvertor")]
impl PlayerSpaceConvertor {
...
#[cfg(feature = "PlayerSpaceConvertor")]
impl quest_hook::libil2cpp::ObjectType for PlayerSpaceConvertor {
