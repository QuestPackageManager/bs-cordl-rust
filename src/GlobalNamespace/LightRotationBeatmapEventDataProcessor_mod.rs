...
for crate::GlobalNamespace::LightRotationBeatmapEventDataProcessor {
    ...
    const CLASS_NAME: &'static str = "LightRotationBeatmapEventDataProcessor";
...
impl crate::GlobalNamespace::LightRotationBeatmapEventDataProcessor {
    ...
    pub fn ProcessBeforeDeleteEventDataInternal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::GlobalNamespace::LightRotationBeatmapEventDataProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::GlobalNamespace::LightRotationBeatmapEventDataProcessor as
