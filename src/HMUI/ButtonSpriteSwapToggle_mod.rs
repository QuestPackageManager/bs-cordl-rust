...
#[cfg(feature = "HMUI+ButtonSpriteSwapToggle")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ButtonSpriteSwapToggle {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "ButtonSpriteSwapToggle";
...
impl crate::HMUI::ButtonSpriteSwapToggle {
    pub fn HandleButtonSelectionStateDidChange(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ButtonSpriteSwapToggle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::ButtonSpriteSwapToggle as quest_hook::libil2cpp::Type >
                    ::class(), "HandleButtonSelectionStateDidChange", 1usize
                )
            });
    ...
    pub fn get_isToggled(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ButtonSpriteSwapToggle as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_isToggled")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ButtonSpriteSwapToggle as quest_hook::libil2cpp::Type >
                    ::class(), "get_isToggled", 0usize
                )
            });
    ...
    pub fn set_isToggled(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ButtonSpriteSwapToggle as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_isToggled")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ButtonSpriteSwapToggle as quest_hook::libil2cpp::Type >
                    ::class(), "set_isToggled", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
