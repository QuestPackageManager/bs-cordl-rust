...
impl crate::HMUI::ToggleWithCallbacks {
    ...
    pub fn get_selectionState(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::HMUI::ToggleWithCallbacks_SelectionState, 0usize>(
                        "get_selectionState",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::HMUI::ToggleWithCallbacks_SelectionState =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_HMUI+ToggleWithCallbacks+SelectionState")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ToggleWithCallbacks_SelectionState {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "HMUI";
...
#[cfg(feature = "cordl_class_HMUI+ToggleWithCallbacks+SelectionState")]
unsafe impl quest_hook::libil2cpp::Argument for crate::HMUI::ToggleWithCallbacks_SelectionState {
    type Type = Self;
...
#[cfg(feature = "cordl_class_HMUI+ToggleWithCallbacks+SelectionState")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::HMUI::ToggleWithCallbacks_SelectionState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+ToggleWithCallbacks+SelectionState")]
unsafe impl quest_hook::libil2cpp::Returned for crate::HMUI::ToggleWithCallbacks_SelectionState {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+ToggleWithCallbacks+SelectionState")]
unsafe impl quest_hook::libil2cpp::Return for crate::HMUI::ToggleWithCallbacks_SelectionState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
