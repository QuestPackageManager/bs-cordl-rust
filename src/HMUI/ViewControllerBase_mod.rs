...
pub struct ViewControllerBase {
    ...
    pub didActivateEvent:
        quest_hook::libil2cpp::Gc<crate::HMUI::ViewControllerBase_DidActivateDelegate>,
    pub didDeactivateEvent:
        quest_hook::libil2cpp::Gc<crate::HMUI::ViewControllerBase_DidDeactivateDelegate>,
}
#[cfg(feature = "cordl_class_HMUI+ViewControllerBase")]
...
impl crate::HMUI::ViewControllerBase {
    ...
    pub fn add_didActivateEvent(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::HMUI::ViewControllerBase_DidActivateDelegate>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn add_didDeactivateEvent(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::HMUI::ViewControllerBase_DidDeactivateDelegate>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_didActivateEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_HMUI+ViewControllerBase+DidActivateDelegate")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ViewControllerBase_DidActivateDelegate {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
...
#[cfg(feature = "cordl_class_HMUI+ViewControllerBase+DidActivateDelegate")]
impl quest_hook::libil2cpp::ObjectType for crate::HMUI::ViewControllerBase_DidActivateDelegate {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
#[cfg(feature = "cordl_class_HMUI+ViewControllerBase+DidDeactivateDelegate")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ViewControllerBase_DidDeactivateDelegate {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
...
#[cfg(feature = "cordl_class_HMUI+ViewControllerBase+DidDeactivateDelegate")]
impl quest_hook::libil2cpp::ObjectType for crate::HMUI::ViewControllerBase_DidDeactivateDelegate {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
