...
#[cfg(feature = "cordl_class_HMUI+ScrollViewItemForVisibilityController")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ScrollViewItemForVisibilityController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "ScrollViewItemForVisibilityController";
...
#[cfg(feature = "cordl_class_HMUI+ScrollViewItemForVisibilityController")]
impl quest_hook::libil2cpp::ObjectType for crate::HMUI::ScrollViewItemForVisibilityController {
