...
pub struct AnimatedSwitchView {
    ...
    pub _offColors: quest_hook::libil2cpp::Gc<crate::HMUI::AnimatedSwitchView_ColorBlock>,
    pub _onHighlightedColors: quest_hook::libil2cpp::Gc<crate::HMUI::AnimatedSwitchView_ColorBlock>,
    pub _offHighlightedColors:
        quest_hook::libil2cpp::Gc<crate::HMUI::AnimatedSwitchView_ColorBlock>,
    pub _disabledColors: quest_hook::libil2cpp::Gc<crate::HMUI::AnimatedSwitchView_ColorBlock>,
...
impl crate::HMUI::AnimatedSwitchView {
    ...
    pub fn HandleStateDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (selectionState))? };
        Ok(__cordl_ret.into())
    }
    pub fn LerpColor(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        f32,
                        f32,
                        quest_hook::libil2cpp::Gc<crate::HMUI::AnimatedSwitchView_GetColorDelegate>,
                    ), crate::UnityEngine::Color, 4usize>("LerpColor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn LerpColors(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (switchAmount, highlightAmount, disabledAmount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LerpPosition(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("LerpPosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (switchAmount))? };
        Ok(__cordl_ret.into())
    }
    pub fn LerpStretch(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("LerpStretch")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+AnimationState")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::AnimatedSwitchView_AnimationState {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "AnimatedSwitchView/AnimationState";
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+AnimationState")]
unsafe impl quest_hook::libil2cpp::Argument for crate::HMUI::AnimatedSwitchView_AnimationState {
    type Type = Self;
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+AnimationState")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::HMUI::AnimatedSwitchView_AnimationState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+AnimationState")]
unsafe impl quest_hook::libil2cpp::Returned for crate::HMUI::AnimatedSwitchView_AnimationState {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+AnimationState")]
unsafe impl quest_hook::libil2cpp::Return for crate::HMUI::AnimatedSwitchView_AnimationState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+GetColorDelegate")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::AnimatedSwitchView_GetColorDelegate {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
...
impl crate::HMUI::AnimatedSwitchView_GetColorDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (colorBlock, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: crate::UnityEngine::Color =
            unsafe { cordl_method_info.invoke_unchecked(self, (colorBlock))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        object: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
...
#[cfg(feature = "cordl_class_HMUI+AnimatedSwitchView+GetColorDelegate")]
impl quest_hook::libil2cpp::ObjectType for crate::HMUI::AnimatedSwitchView_GetColorDelegate {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
