...
impl crate::HMUI::AnimatedSwitchView {
    ...
    pub fn HandleStateDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (selectionState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LerpColor(
    ...
    pub fn LerpPosition(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (switchAmount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LerpStretch(
...
impl crate::HMUI::AnimatedSwitchView_GetColorDelegate {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (colorBlock, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: crate::UnityEngine::Color = unsafe {
            cordl_method_info.invoke_unchecked(self, (colorBlock))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
