...
#[cfg(feature = "HMUI+HoverTextController")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::HoverTextController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "HoverTextController";
...
impl crate::HMUI::HoverTextController {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::HoverTextController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::HoverTextController as quest_hook::libil2cpp::Type >
                    ::class(), "Awake", 0usize
                )
            });
    ...
    pub fn HideText(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::HoverTextController as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("HideText")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::HoverTextController as quest_hook::libil2cpp::Type >
                    ::class(), "HideText", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::HoverTextController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::HoverTextController as quest_hook::libil2cpp::Type >
                    ::class(), "HideTextCoroutine", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::HoverTextController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::HoverTextController as quest_hook::libil2cpp::Type >
                    ::class(), "ShowTextCoroutine", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::IEnumerator,
