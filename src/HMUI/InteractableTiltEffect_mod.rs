#[cfg(feature = "cordl_class_HMUI+InteractableTiltEffect")]
#[repr(C)]
...
impl crate::HMUI::InteractableTiltEffect {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ComputeNewTargetRotation", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Quaternion =
            unsafe { cordl_method_info.invoke_unchecked(self, (localPoint))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_effectStrengthMultiplier(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
