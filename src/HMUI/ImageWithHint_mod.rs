...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ImageWithHint {
    ...
    const CLASS_NAME: &'static str = "ImageWithHint";
...
impl crate::HMUI::ImageWithHint {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ImageWithHint as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ImageWithHint as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
    ...
    pub fn get_imageColor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ImageWithHint as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::UnityEngine::Color, 0usize>("get_imageColor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ImageWithHint as quest_hook::libil2cpp::Type >
                    ::class(), "get_imageColor", 0usize
                )
            });
