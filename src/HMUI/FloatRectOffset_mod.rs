...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::FloatRectOffset {
    ...
    const CLASS_NAME: &'static str = "FloatRectOffset";
...
impl crate::HMUI::FloatRectOffset {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::FloatRectOffset as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::FloatRectOffset as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
