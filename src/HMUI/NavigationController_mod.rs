...
impl crate::HMUI::NavigationController {
    ...
    > {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        f32,
                    ), quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>>, 3usize>(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<f32>> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (viewControllers, fixedViewControllers, fixedEndPos))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PositionVector(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), crate::UnityEngine::Vector3, 1usize>("PositionVector")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 3usize>("PushViewController")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetupViewControllerRect", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Alignment")]
unsafe impl quest_hook::libil2cpp::Argument for crate::HMUI::NavigationController_Alignment {
    type Type = Self;
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Alignment")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::HMUI::NavigationController_Alignment {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Alignment")]
unsafe impl quest_hook::libil2cpp::Returned for crate::HMUI::NavigationController_Alignment {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Alignment")]
unsafe impl quest_hook::libil2cpp::Return for crate::HMUI::NavigationController_Alignment {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Orientation")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::NavigationController_Orientation {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "HMUI";
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Orientation")]
unsafe impl quest_hook::libil2cpp::Argument for crate::HMUI::NavigationController_Orientation {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_value_argument(ty)
    }
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Orientation")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::HMUI::NavigationController_Orientation {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_value_parameter(ty)
    }
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Orientation")]
unsafe impl quest_hook::libil2cpp::Returned for crate::HMUI::NavigationController_Orientation {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_returned(ty)
    }
...
#[cfg(feature = "cordl_class_HMUI+NavigationController+Orientation")]
unsafe impl quest_hook::libil2cpp::Return for crate::HMUI::NavigationController_Orientation {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_return(ty)
    }
