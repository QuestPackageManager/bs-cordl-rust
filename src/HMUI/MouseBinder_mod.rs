...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::MouseBinder {
    ...
    const CLASS_NAME: &'static str = "MouseBinder";
...
impl crate::HMUI::MouseBinder {
    ...
    pub fn AddButtonBinding(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::HMUI::MouseBinder_MouseEventType,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::UnityAction>,
                    ), quest_hook::libil2cpp::Void, 3usize>("AddButtonBinding")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (buttonType, keyBindingType, action))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("AddButtonBindings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("AddScrollBindings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_HMUI+MouseBinder+MouseEventType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::HMUI::MouseBinder_MouseEventType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_value_parameter(ty)
    }
