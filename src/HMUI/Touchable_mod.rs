...
#[cfg(feature = "HMUI+Touchable")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::Touchable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "Touchable";
...
impl crate::HMUI::Touchable {
    ...
    pub fn OnPopulateMesh(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::Touchable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::Touchable as quest_hook::libil2cpp::Type > ::class(),
    ...
    pub fn get_skew(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::Touchable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("get_skew")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::Touchable as quest_hook::libil2cpp::Type > ::class(),
