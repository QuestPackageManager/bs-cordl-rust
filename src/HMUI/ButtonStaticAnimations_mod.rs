...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ButtonStaticAnimations {
    ...
    const CLASS_NAME: &'static str = "ButtonStaticAnimations";
...
impl crate::HMUI::ButtonStaticAnimations {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ButtonStaticAnimations as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ButtonStaticAnimations as quest_hook::libil2cpp::Type >
                    ::class(), "Awake", 0usize
                )
            });
