...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ScrollToTopOnEnable {
    ...
    const CLASS_NAME: &'static str = "ScrollToTopOnEnable";
...
#[cfg(feature = "HMUI+ScrollToTopOnEnable")]
impl crate::HMUI::ScrollToTopOnEnable {
    ...
    pub fn OnEnable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ScrollToTopOnEnable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnEnable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ScrollToTopOnEnable as quest_hook::libil2cpp::Type >
