...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::EventSystemListener {
    ...
    const CLASS_NAME: &'static str = "EventSystemListener";
...
impl crate::HMUI::EventSystemListener {
    ...
    pub fn OnPointerEnter(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::EventSystemListener as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::EventSystemListener as quest_hook::libil2cpp::Type >
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::EventSystemListener as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::EventSystemListener as quest_hook::libil2cpp::Type >
                    ::class(), "add_pointerDidEnterEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::EventSystemListener as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::EventSystemListener as quest_hook::libil2cpp::Type >
                    ::class(), "add_pointerDidExitEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::EventSystemListener as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::EventSystemListener as quest_hook::libil2cpp::Type >
                    ::class(), "remove_pointerDidEnterEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::EventSystemListener as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::EventSystemListener as quest_hook::libil2cpp::Type >
                    ::class(), "remove_pointerDidExitEvent", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
