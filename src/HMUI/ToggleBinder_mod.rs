#[cfg(feature = "cordl_class_HMUI+ToggleBinder")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::HMUI::ToggleBinder {
    pub fn AddBinding_Action_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (toggle, action))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddBinding__cordl_bool_Action1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (toggle, enabled, action))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddBindings(
        &mut self,
