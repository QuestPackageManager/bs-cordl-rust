#[cfg(feature = "cordl_class_HMUI+ValueChangedBinder_1")]
#[repr(C)]
#[derive(Debug)]
        ...
        crate::System::Collections::Generic::List_1<
            quest_hook::libil2cpp::Gc<
                crate::System::Tuple_2<
                    quest_hook::libil2cpp::Gc<crate::HMUI::IValueChanger_1<T>>,
    ...
    for crate::HMUI::ValueChangedBinder_1<T>
{
    ...
    const CLASS_NAME: &'static str = "ValueChangedBinder`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("HMUI", "ValueChangedBinder`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::HMUI::ValueChangedBinder_1<T> {
...
#[cfg(feature = "HMUI+ValueChangedBinder_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::HMUI::ValueChangedBinder_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::HMUI::ValueChangedBinder_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::HMUI::IValueChanger_1<T>>,
                        quest_hook::libil2cpp::Gc<crate::System::Action_1<T>>,
                    ), quest_hook::libil2cpp::Void, 2usize>("AddBinding")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (valueChanger, action))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddBindings(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("AddBindings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ClearBindings(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
