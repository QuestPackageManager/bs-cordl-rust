#[cfg(feature = "cordl_class_HMUI+ScreenModeController")]
#[repr(C)]
...
impl crate::HMUI::ScreenModeController {
    ...
    pub fn SetDefaultMode(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn SetMode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (screenModeData))? };
        Ok(__cordl_ret.into())
    }
