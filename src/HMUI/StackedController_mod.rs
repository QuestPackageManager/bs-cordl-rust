...
impl crate::HMUI::StackedController {
    pub fn LayoutViewControllers(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (viewControllers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetupViewControllerRect(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (viewController, index))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _PushViewController_g__AnimationLayouter_3_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (t, viewControllers))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
