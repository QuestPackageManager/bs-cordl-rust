#[cfg(feature = "cordl_class_HMUI+IValueChanger_1")]
    ...
    for crate::HMUI::IValueChanger_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IValueChanger`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("HMUI", "IValueChanger`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::HMUI::IValueChanger_1<T> {
...
#[cfg(feature = "HMUI+IValueChanger_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::HMUI::IValueChanger_1<T> {
