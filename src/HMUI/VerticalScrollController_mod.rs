...
pub struct VerticalScrollController {
    ...
    pub _scrollRectTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::RectTransform>,
    pub _dragPosition: f32,
    pub _handleRectTransform: quest_hook::libil2cpp::Gc<crate::UnityEngine::RectTransform>,
}
#[cfg(feature = "cordl_class_HMUI+VerticalScrollController")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::VerticalScrollController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "VerticalScrollController";
...
#[cfg(feature = "HMUI+VerticalScrollController")]
impl std::ops::Deref for crate::HMUI::VerticalScrollController {
...
#[cfg(feature = "HMUI+VerticalScrollController")]
impl std::ops::DerefMut for crate::HMUI::VerticalScrollController {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "HMUI+VerticalScrollController")]
impl crate::HMUI::VerticalScrollController {
    ...
    pub fn add_updateScrollPositionEvent(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "add_updateScrollPositionEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn remove_updateScrollPositionEvent(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::System::Action_1<f32>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "remove_updateScrollPositionEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_HMUI+VerticalScrollController")]
impl quest_hook::libil2cpp::ObjectType for crate::HMUI::VerticalScrollController {
...
impl AsRef<crate::UnityEngine::EventSystems::IDragHandler>
    for crate::HMUI::VerticalScrollController
{
