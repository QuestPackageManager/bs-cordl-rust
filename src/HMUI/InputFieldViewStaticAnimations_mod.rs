...
#[cfg(feature = "HMUI+InputFieldViewStaticAnimations")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::InputFieldViewStaticAnimations {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "InputFieldViewStaticAnimations";
...
impl crate::HMUI::InputFieldViewStaticAnimations {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::InputFieldViewStaticAnimations as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::InputFieldViewStaticAnimations as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::InputFieldViewStaticAnimations as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "HandleInputFieldViewSelectionStateDidChange", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
