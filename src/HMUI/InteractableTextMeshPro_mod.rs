...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::InteractableTextMeshPro {
    ...
    const CLASS_NAME: &'static str = "InteractableTextMeshPro";
...
impl crate::HMUI::InteractableTextMeshPro {
    ...
    pub fn OnCanvasGroupChanged(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::InteractableTextMeshPro as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::InteractableTextMeshPro as quest_hook::libil2cpp::Type
