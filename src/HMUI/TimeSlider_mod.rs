...
impl crate::HMUI::TimeSlider {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (ts))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetBounds(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, f32, f32), quest_hook::libil2cpp::Void, 3usize>(
                        "SetBounds",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (valuesValid, lowerValue, upperValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TextForValue(
