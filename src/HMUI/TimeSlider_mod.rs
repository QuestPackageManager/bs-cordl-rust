...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::TimeSlider {
    ...
    const CLASS_NAME: &'static str = "TimeSlider";
...
impl crate::HMUI::TimeSlider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::TimeSlider as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::TimeSlider as quest_hook::libil2cpp::Type > ::class(),
                    "FormatTimeSpan", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (ts))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetBounds(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (valuesValid, lowerValue, upperValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TextForValue(
...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::TimeSlider_TimeType {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "TimeSlider/TimeType";
