...
#[cfg(feature = "HMUI+TitleViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::TitleViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "TitleViewController";
...
impl crate::HMUI::TitleViewController {
    ...
    pub fn SetText(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::TitleViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::TitleViewController as quest_hook::libil2cpp::Type >
