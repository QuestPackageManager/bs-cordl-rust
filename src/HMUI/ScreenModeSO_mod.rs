...
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::ScreenModeSO {
    ...
    const CLASS_NAME: &'static str = "ScreenModeSO";
...
impl crate::HMUI::ScreenModeSO {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::ScreenModeSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::HMUI::ScreenModeSO as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::HMUI::ScreenModeData> = unsafe {
            method.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
