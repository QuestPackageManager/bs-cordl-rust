...
pub struct IconAndTextSegmentedControl {
    ...
    pub _firstCellPrefab: quest_hook::libil2cpp::Gc<crate::HMUI::IconAndTextSegmentedControlCell>,
    pub _lastCellPrefab: quest_hook::libil2cpp::Gc<crate::HMUI::IconAndTextSegmentedControlCell>,
    pub _singleCellPrefab: quest_hook::libil2cpp::Gc<crate::HMUI::IconAndTextSegmentedControlCell>,
    pub _middleCellPrefab: quest_hook::libil2cpp::Gc<crate::HMUI::IconAndTextSegmentedControlCell>,
...
impl crate::HMUI::IconAndTextSegmentedControl {
    ...
    pub fn SetData(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (dataItems))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetTextsActive(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("SetTextsActive")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "HMUI+IconAndTextSegmentedControl")]
impl AsRef<crate::HMUI::SegmentedControl_IDataSource> for crate::HMUI::IconAndTextSegmentedControl {
    fn as_ref(&self) -> &crate::HMUI::SegmentedControl_IDataSource {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "HMUI+IconAndTextSegmentedControl")]
impl AsMut<crate::HMUI::SegmentedControl_IDataSource> for crate::HMUI::IconAndTextSegmentedControl {
...
#[cfg(feature = "cordl_class_HMUI+IconAndTextSegmentedControl+DataItem")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::IconAndTextSegmentedControl_DataItem {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
...
impl crate::HMUI::IconAndTextSegmentedControl_DataItem {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (icon, text, interactable))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_icon(
        &mut self,
    ...
    pub fn get_interactable(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_interactable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_interactable(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_interactable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_HMUI+IconAndTextSegmentedControl+DataItem")]
impl quest_hook::libil2cpp::ObjectType for crate::HMUI::IconAndTextSegmentedControl_DataItem {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
