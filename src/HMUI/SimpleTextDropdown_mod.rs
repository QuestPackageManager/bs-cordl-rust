...
pub struct SimpleTextDropdown {
    ...
    pub _cellPrefab: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::SimpleTextTableCell>,
    pub _cellSize: f32,
...
impl crate::HMUI::SimpleTextDropdown {
    ...
    pub fn SetTexts(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IReadOnlyList_1<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetTexts")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (texts))? };
        Ok(__cordl_ret.into())
    }
