...
pub struct FlowCoordinator {
    ...
    pub _mainScreenViewControllers: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _leftScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    pub _rightScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    pub _bottomScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    ...
    pub _providedMainViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    pub _providedLeftScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    pub _providedRightScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    pub _providedBottomScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    pub _providedTopScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    ...
    pub _prevEventSystem: quest_hook::libil2cpp::Gc<crate::UnityEngine::EventSystems::EventSystem>,
}
#[cfg(feature = "cordl_class_HMUI+FlowCoordinator")]
...
impl crate::HMUI::FlowCoordinator {
    ...
    pub fn Deactivate(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, bool), quest_hook::libil2cpp::Void, 2usize>("Deactivate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task> =
            unsafe { cordl_method_info.invoke_unchecked(self, (immediately))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PopViewControllerFromNavigationController(
        &mut self,
        navigationController: quest_hook::libil2cpp::Gc<crate::HMUI::NavigationController>,
        finishedCallback: quest_hook::libil2cpp::Gc<crate::System::Action>,
        immediately: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (navigationController, finishedCallback, immediately))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PresentTitle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("PresentTitle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (title, animationType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProvideInitialViewControllers(
        ...
        rightScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
        bottomScreenViewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
    ...
    pub fn ReplaceTopViewController_FlowCoordinator_FlowCoordinator_Action_ViewController_AnimationType_ViewController_AnimationDirection1(
        &mut self,
        viewController: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>,
        originalOwnerFlowCoordinator: quest_hook::libil2cpp::Gc<crate::HMUI::FlowCoordinator>,
    ...
    pub fn SetBottomScreenViewController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (viewController, animationType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetTitle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (value, animationType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetViewControllerToNavigationController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (navigationController, viewController))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetViewControllersToNavigationController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (navigationController, viewControllers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn YoungestChildFlowCoordinatorOrSelf(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::HMUI::FlowCoordinator>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::HMUI::FlowCoordinator> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn __ExternalDeactivate(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("__ExternalDeactivate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn __StartOnScreenSystem(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (screenSystem))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_rightScreenViewController(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::HMUI::ViewController>> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::HMUI::ViewController> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
