...
impl crate::HMUI::FlowCoordinator {
    ...
    pub fn PresentTitle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (title, animationType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetBottomScreenViewController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (viewController, animationType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetTitle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, animationType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetViewControllerToNavigationController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (navigationController, viewController))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetViewControllersToNavigationController(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (navigationController, viewControllers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn __StartOnScreenSystem(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (screenSystem))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
