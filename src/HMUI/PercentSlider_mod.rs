...
#[cfg(feature = "HMUI+PercentSlider")]
unsafe impl quest_hook::libil2cpp::Type for crate::HMUI::PercentSlider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "HMUI";
    const CLASS_NAME: &'static str = "PercentSlider";
...
impl crate::HMUI::PercentSlider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::PercentSlider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::PercentSlider as quest_hook::libil2cpp::Type >
