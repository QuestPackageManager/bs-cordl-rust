#[cfg(feature = "cordl_class_HMUI+HoverHintController")]
#[repr(C)]
...
impl crate::HMUI::HoverHintController {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform> =
            unsafe { cordl_method_info.invoke_unchecked((), (hoverHint))? };
        Ok(__cordl_ret.into())
    }
    pub fn HideHint(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hoverHint))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator> =
            unsafe { cordl_method_info.invoke_unchecked(self, (hoverHint, delay))? };
        Ok(__cordl_ret.into())
    }
