...
impl crate::HMUI::DropdownWithTitleView {
    ...
    pub fn RefreshSize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::HMUI::DropdownWithTitleView as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::HMUI::DropdownWithTitleView as quest_hook::libil2cpp::Type >
                    ::class(), "RefreshSize", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (dataSource))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
