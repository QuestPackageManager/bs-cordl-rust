#[cfg(feature = "cordl_class_UnityEngine+RaycastCommand")]
...
#[cfg(feature = "cordl_class_UnityEngine+RaycastCommand")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::RaycastCommand {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "RaycastCommand";
...
#[cfg(feature = "cordl_class_UnityEngine+RaycastCommand")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::RaycastCommand {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+RaycastCommand")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::RaycastCommand {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+RaycastCommand")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::RaycastCommand {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+RaycastCommand")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::RaycastCommand {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::RaycastCommand {
    pub fn ScheduleBatch_JobHandle1(
        commands: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::RaycastCommand>,
        results: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::RaycastHit>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        crate::Unity::Collections::NativeArray_1<crate::UnityEngine::RaycastHit>,
                        i32,
                        crate::Unity::Jobs::JobHandle,
                    ), crate::Unity::Jobs::JobHandle, 4usize>("ScheduleBatch")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor_Vector3_QueryParameters_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (from, direction, queryParameters, distance))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Vector3_f32_i32_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (from, direction, distance, layerMask, maxHits))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_direction(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector3> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_from(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector3> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
