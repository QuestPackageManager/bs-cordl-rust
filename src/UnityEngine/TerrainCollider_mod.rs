...
impl crate::UnityEngine::TerrainCollider {
    pub fn set_terrainData(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TerrainCollider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::TerrainCollider as quest_hook::libil2cpp::Type >
