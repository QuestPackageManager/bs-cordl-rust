...
#[cfg(feature = "UnityEngine+AddComponentMenu")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AddComponentMenu {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AddComponentMenu";
...
impl crate::UnityEngine::AddComponentMenu {
    ...
    pub fn _ctor_Il2CppString0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AddComponentMenu as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AddComponentMenu as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (menuName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (menuName, order))?
        };
        Ok(__cordl_ret.into())
    }
}
