...
impl crate::UnityEngine::AsyncInstantiateOperationHelper {
    pub fn SetAsyncInstantiateOperationResult(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AsyncInstantiateOperationHelper as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AsyncInstantiateOperationHelper as
                    quest_hook::libil2cpp::Type > ::class(),
                    "SetAsyncInstantiateOperationResult", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (op, result))?
        };
        Ok(__cordl_ret.into())
    }
}
