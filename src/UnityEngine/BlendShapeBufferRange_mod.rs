...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::BlendShapeBufferRange {
    ...
    const CLASS_NAME: &'static str = "BlendShapeBufferRange";
...
impl crate::UnityEngine::BlendShapeBufferRange {
    pub fn set_endIndex(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::BlendShapeBufferRange as quest_hook::libil2cpp::Type>::class()
            .find_method::<(u32), quest_hook::libil2cpp::Void, 1usize>("set_endIndex")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::BlendShapeBufferRange as
                    quest_hook::libil2cpp::Type > ::class(), "set_endIndex", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::BlendShapeBufferRange as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::BlendShapeBufferRange as
                    quest_hook::libil2cpp::Type > ::class(), "set_startIndex", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
