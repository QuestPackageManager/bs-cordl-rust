...
#[cfg(feature = "UnityEngine+PlayerPrefsException")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::PlayerPrefsException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "PlayerPrefsException";
...
impl crate::UnityEngine::PlayerPrefsException {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::PlayerPrefsException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::PlayerPrefsException as
