...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::GUILayoutGroup {
    ...
    const CLASS_NAME: &'static str = "GUILayoutGroup";
...
impl crate::UnityEngine::GUILayoutGroup {
    pub fn Add(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::GUILayoutGroup as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::UnityEngine::GUILayoutEntry>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::GUILayoutGroup as quest_hook::libil2cpp::Type >
                    ::class(), "Add", 1usize
                )
            });
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::GUILayoutEntry> = unsafe {
            method.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
