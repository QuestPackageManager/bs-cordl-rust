#[cfg(feature = "cordl_class_UnityEngine+ManagedStreamHelpers")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+ManagedStreamHelpers")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ManagedStreamHelpers {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "ManagedStreamHelpers";
...
impl crate::UnityEngine::ManagedStreamHelpers {
    pub fn ManagedStreamLength(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (stream, returnValueAddress))? };
        Ok(__cordl_ret.into())
    }
    pub fn ManagedStreamRead(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                        crate::System::IntPtr,
                    ), quest_hook::libil2cpp::Void, 5usize>("ManagedStreamRead")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (buffer, offset, count, stream, returnValueAddress))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ManagedStreamSeek(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::IO::Stream>,
                        crate::System::IntPtr,
                    ), quest_hook::libil2cpp::Void, 4usize>("ManagedStreamSeek")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (offset, origin, stream, returnValueAddress))?
        };
        Ok(__cordl_ret.into())
    }
