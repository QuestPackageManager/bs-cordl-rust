...
#[cfg(feature = "cordl_class_UnityEngine+AndroidJavaRunnableProxy")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AndroidJavaRunnableProxy {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AndroidJavaRunnableProxy";
...
impl crate::UnityEngine::AndroidJavaRunnableProxy {
    pub fn Invoke(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::System::IntPtr,
                    ), crate::System::IntPtr, 2usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked(self, (methodName, javaArgs))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
