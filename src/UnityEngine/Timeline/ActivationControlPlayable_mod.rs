...
impl crate::UnityEngine::Timeline::ActivationControlPlayable {
    ...
    pub fn Create(
        ...
        crate::UnityEngine::Playables::ScriptPlayable_1<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::ActivationControlPlayable>,
        >,
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Playables::ScriptPlayable_1<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::ActivationControlPlayable>,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (graph, gameObject, postPlaybackState))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProcessFrame(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (playable, info, userData))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+ActivationControlPlayable")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::ActivationControlPlayable {
