...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::IMarker {
    ...
    const CLASS_NAME: &'static str = "IMarker";
...
impl crate::UnityEngine::Timeline::IMarker {
    pub fn Initialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::IMarker as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Timeline::IMarker as quest_hook::libil2cpp::Type
