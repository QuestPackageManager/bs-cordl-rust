#[cfg(feature = "cordl_class_UnityEngine+Timeline+AudioPlayableAsset")]
#[repr(C)]
...
pub struct AudioPlayableAsset {
    ...
    pub m_ClipProperties:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::AudioClipProperties>,
}
#[cfg(feature = "cordl_class_UnityEngine+Timeline+AudioPlayableAsset")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::AudioPlayableAsset {
...
impl crate::UnityEngine::Timeline::AudioPlayableAsset {
    ...
    pub fn set_bufferingTime(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("set_bufferingTime")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+AudioPlayableAsset")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::AudioPlayableAsset {
