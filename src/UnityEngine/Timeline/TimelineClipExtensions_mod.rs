#[cfg(feature = "cordl_class_UnityEngine+Timeline+TimelineClipExtensions")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+TimelineClipExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::TimelineClipExtensions {
...
impl crate::UnityEngine::Timeline::TimelineClipExtensions {
    pub fn MoveToTrack(
        ...
        destinationTrack: quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TrackAsset>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("MoveToTrack")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (clip, destinationTrack))? };
        Ok(__cordl_ret.into())
    }
    pub fn MoveToTrack_Impl(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TrackAsset>,
                    ), quest_hook::libil2cpp::Void, 4usize>("MoveToTrack_Impl")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (clip, destinationTrack, asset, parentTrack))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+TimelineClipExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::TimelineClipExtensions {
