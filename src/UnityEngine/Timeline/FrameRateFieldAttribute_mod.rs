#[cfg(feature = "cordl_class_UnityEngine+Timeline+FrameRateFieldAttribute")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+FrameRateFieldAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::FrameRateFieldAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "FrameRateFieldAttribute";
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+FrameRateFieldAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::FrameRateFieldAttribute {
