...
for crate::UnityEngine::Timeline::BasicPlayableBehaviour {
    ...
    const CLASS_NAME: &'static str = "BasicPlayableBehaviour";
...
impl crate::UnityEngine::Timeline::BasicPlayableBehaviour {
    pub fn CreatePlayable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::BasicPlayableBehaviour as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Timeline::BasicPlayableBehaviour as
