...
for crate::UnityEngine::Timeline::TrackMediaType {
    ...
    const CLASS_NAME: &'static str = "TrackMediaType";
...
impl crate::UnityEngine::Timeline::TrackMediaType {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::TrackMediaType as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::UnityEngine::Timeline::TimelineAsset_MediaType),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Timeline::TrackMediaType as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (mt))?
        };
        Ok(__cordl_ret.into())
    }
}
