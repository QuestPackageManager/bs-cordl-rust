...
impl crate::UnityEngine::Timeline::MarkerList {
    ...
    pub fn Remove_IMarker0(
        &mut self,
        item: *mut crate::UnityEngine::Timeline::IMarker,
    ) -> quest_hook::libil2cpp::Result<bool> {
        let __cordl_ret: bool = quest_hook::libil2cpp::ValueTypeExt::invoke(
            self,
            "Remove",
    ...
    pub fn Remove_ScriptableObject_TimelineAsset_PlayableAsset1(
        &mut self,
        item: *mut crate::UnityEngine::ScriptableObject,
        timelineAsset: *mut crate::UnityEngine::Timeline::TimelineAsset,
        thingToDirty: *mut crate::UnityEngine::Playables::PlayableAsset,
    ) -> quest_hook::libil2cpp::Result<bool> {
        let __cordl_ret: bool = quest_hook::libil2cpp::ValueTypeExt::invoke(
            self,
            "Remove",
