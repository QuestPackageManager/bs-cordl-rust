...
for crate::UnityEngine::Timeline::ITimelineEvaluateCallback {
    ...
    const CLASS_NAME: &'static str = "ITimelineEvaluateCallback";
...
#[cfg(feature = "UnityEngine+Timeline+ITimelineEvaluateCallback")]
impl crate::UnityEngine::Timeline::ITimelineEvaluateCallback {
    pub fn Evaluate(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::ITimelineEvaluateCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Evaluate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Timeline::ITimelineEvaluateCallback as
                    quest_hook::libil2cpp::Type > ::class(), "Evaluate", 0usize
                )
            });
