...
impl crate::UnityEngine::Timeline::ParticleControlPlayable {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Playables::ScriptPlayable_1<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (graph, component, randomSeed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Initialize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ps, randomSeed))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PrepareFrame(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (playable, data))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetRandomSeed", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (particleSystem, randomSeed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Simulate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_time, restart))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
