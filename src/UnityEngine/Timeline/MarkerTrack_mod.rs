...
#[cfg(feature = "UnityEngine+Timeline+MarkerTrack")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::MarkerTrack {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "MarkerTrack";
...
impl crate::UnityEngine::Timeline::MarkerTrack {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::MarkerTrack as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Timeline::MarkerTrack as
