#[cfg(feature = "cordl_class_UnityEngine+Timeline+Extrapolation")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+Extrapolation")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::Extrapolation {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "Extrapolation";
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TimelineClip>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (clips))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Timeline+Extrapolation")]
