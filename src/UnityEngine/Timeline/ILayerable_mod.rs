#[cfg(feature = "cordl_class_UnityEngine+Timeline+ILayerable")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+ILayerable")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::ILayerable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "ILayerable";
