#[cfg(feature = "cordl_class_UnityEngine+Timeline+RuntimeClip")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+RuntimeClip")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::RuntimeClip {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "RuntimeClip";
...
impl crate::UnityEngine::Timeline::RuntimeClip {
    pub fn Create(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (clip, clipPlayable, parentMixer))? };
        Ok(__cordl_ret.into())
    }
    pub fn DisableAt(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (localTime, rootDuration, frameData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EvaluateAt(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (localTime, frameData))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        clip: quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TimelineClip>,
    ...
    pub fn get_mixer(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Playables::Playable, 0usize>("get_mixer")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_playable(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Playables::Playable, 0usize>(
                        "get_playable",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
