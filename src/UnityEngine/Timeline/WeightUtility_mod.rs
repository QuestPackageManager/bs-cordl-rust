#[cfg(feature = "cordl_class_UnityEngine+Timeline+WeightUtility")]
#[repr(C)]
...
impl crate::UnityEngine::Timeline::WeightUtility {
    pub fn NormalizeMixer(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::UnityEngine::Playables::Playable), f32, 1usize>(
                        "NormalizeMixer",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (mixer))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Timeline+WeightUtility")]
