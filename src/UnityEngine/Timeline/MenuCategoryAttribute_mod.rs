...
for crate::UnityEngine::Timeline::MenuCategoryAttribute {
    ...
    const CLASS_NAME: &'static str = "MenuCategoryAttribute";
...
impl crate::UnityEngine::Timeline::MenuCategoryAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::MenuCategoryAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Timeline::MenuCategoryAttribute as
