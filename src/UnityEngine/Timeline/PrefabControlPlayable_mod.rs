...
impl crate::UnityEngine::Timeline::PrefabControlPlayable {
    pub fn Create(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::PrefabControlPlayable as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Timeline::PrefabControlPlayable as
        ...
        let __cordl_ret: crate::UnityEngine::Playables::ScriptPlayable_1<
            ...
            >,
        > = unsafe {
            method.invoke_unchecked((), (graph, prefabGameObject, parentTransform))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Initialize(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject> = unsafe {
            method.invoke_unchecked(self, (prefabGameObject, parentTransform))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::PrefabControlPlayable as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Timeline::PrefabControlPlayable as
                    quest_hook::libil2cpp::Type > ::class(), "SetHideFlagsRecursive",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Timeline::PrefabControlPlayable as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Timeline::PrefabControlPlayable as
                    quest_hook::libil2cpp::Type > ::class(), "get_prefabInstance", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject> = unsafe {
            method.invoke_unchecked(self, ())?
