...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+TrackColorAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::TrackColorAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "TrackColorAttribute";
...
impl crate::UnityEngine::Timeline::TrackColorAttribute {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (r, g, b))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+TrackColorAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::TrackColorAttribute {
