...
pub struct AnimationTrack {
    ...
    pub m_InfiniteClipPostExtrapolation:
        crate::UnityEngine::Timeline::TimelineClip_ClipExtrapolation,
    ...
    pub m_AvatarMask: quest_hook::libil2cpp::Gc<crate::UnityEngine::AvatarMask>,
    pub m_ApplyAvatarMask: bool,
    pub m_TrackOffset: crate::UnityEngine::Timeline::TrackOffset,
    pub m_InfiniteClip: quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimationClip>,
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+AnimationTrack")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::AnimationTrack {
...
impl crate::UnityEngine::Timeline::AnimationTrack {
    ...
    pub type AnimationTrackUpgrade =
    ...
    pub fn ApplyTrackOffset(
        ...
        let __cordl_ret: crate::UnityEngine::Playables::Playable =
            unsafe { cordl_method_info.invoke_unchecked(self, (graph, root, go, mode))? };
        Ok(__cordl_ret.into())
    }
    pub fn AssignAnimationClip(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (clip, animClip))? };
        Ok(__cordl_ret.into())
    }
    pub fn AttachDefaultBlend(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 3usize>("AttachDefaultBlend")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (graph, mixer, requireOffset))? };
        Ok(__cordl_ret.into())
    }
    pub fn AttachOffsetPlayable(
        ...
        let __cordl_ret: crate::UnityEngine::Playables::Playable =
            unsafe { cordl_method_info.invoke_unchecked(self, (graph, playable, pos, rot))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CompileTrackPlayable(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::UnityEngine::Playables::PlayableGraph,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::AnimationTrack>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
        ...
        let __cordl_ret: crate::UnityEngine::Playables::Playable =
            unsafe { cordl_method_info.invoke_unchecked(self, (graph, track, go, tree, mode))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateClip(
        &mut self,
    ...
    pub fn CreateGroupMixer(
        ...
        go: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
        inputCount: i32,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Animations::AnimationLayerMixerPlayable>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
                        i32,
                    ), crate::UnityEngine::Animations::AnimationLayerMixerPlayable, 3usize>(
                        "CreateGroupMixer",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Animations::AnimationLayerMixerPlayable =
            unsafe { cordl_method_info.invoke_unchecked((), (graph, go, inputCount))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateInfiniteClip", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (infiniteClipName))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateInfiniteTrackPlayable(
        ...
        let __cordl_ret: crate::UnityEngine::Playables::Playable =
            unsafe { cordl_method_info.invoke_unchecked(self, (graph, go, tree, mode))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateRecordableClip", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Timeline::TimelineClip> =
            unsafe { cordl_method_info.invoke_unchecked(self, (animClipName))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetAnimationClips(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimationClip>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("GetAnimationClips")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (animClips))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetBinding(
        &mut self,
    ...
    pub fn GetOffsetMode(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
                        bool,
                    ), crate::UnityEngine::Timeline::AppliedOffsetMode, 2usize>(
                        "GetOffsetMode"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Timeline::AppliedOffsetMode =
            unsafe { cordl_method_info.invoke_unchecked(self, (go, animatesRootTransform))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HasController", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (gameObject))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsRootTransformDisabledByMask(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Transform>,
                    ), bool, 2usize>("IsRootTransformDisabledByMask")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (gameObject, genericRootNode))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RequiresMotionXPlayable(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::UnityEngine::Timeline::AppliedOffsetMode,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>,
                    ), bool, 2usize>("RequiresMotionXPlayable")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (mode, gameObject))? };
        Ok(__cordl_ret.into())
    }
    pub fn ResetOffsets(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UsesAbsoluteMotion", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (mode))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_avatarMask(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::AvatarMask>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_avatarMask", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::AvatarMask> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_infiniteClipApplyFootIK(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_infiniteClipLoop(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Timeline::AnimationPlayableAsset_LoopMode>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_infiniteClipLoop", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Timeline::AnimationPlayableAsset_LoopMode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_infiniteClipRemoveOffset(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_matchTargetFields(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Timeline::MatchTargetFields, 0usize>(
        ...
        let __cordl_ret: crate::UnityEngine::Timeline::MatchTargetFields =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_trackOffset(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Timeline::TrackOffset, 0usize>(
                        "get_trackOffset",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Timeline::TrackOffset =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_applyOffsets(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_applyOffsets")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    for crate::UnityEngine::Timeline::AnimationTrack_AnimationTrackUpgrade
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "AnimationTrack/AnimationTrackUpgrade";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+Timeline+AnimationTrack+AnimationTrackUpgrade")]
impl std::ops::Deref for crate::UnityEngine::Timeline::AnimationTrack_AnimationTrackUpgrade {
...
#[cfg(feature = "UnityEngine+Timeline+AnimationTrack+AnimationTrackUpgrade")]
impl std::ops::DerefMut for crate::UnityEngine::Timeline::AnimationTrack_AnimationTrackUpgrade {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ConvertInfiniteTrack", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (track))? };
        Ok(__cordl_ret.into())
    }
