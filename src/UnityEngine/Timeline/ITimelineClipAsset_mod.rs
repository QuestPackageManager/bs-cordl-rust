#[cfg(feature = "cordl_class_UnityEngine+Timeline+ITimelineClipAsset")]
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+ITimelineClipAsset")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Timeline::ITimelineClipAsset {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Timeline";
    const CLASS_NAME: &'static str = "ITimelineClipAsset";
...
#[cfg(feature = "cordl_class_UnityEngine+Timeline+ITimelineClipAsset")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::ITimelineClipAsset {
