#[cfg(feature = "cordl_class_UnityEngine+Timeline+MatchTargetFieldConstants")]
#[repr(C)]
...
impl crate::UnityEngine::Timeline::MatchTargetFieldConstants {
    pub fn HasAny(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (me, fields))? };
        Ok(__cordl_ret.into())
    }
    pub fn Toggle(
        me: crate::UnityEngine::Timeline::MatchTargetFields,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::UnityEngine::Timeline::MatchTargetFields,
                        crate::UnityEngine::Timeline::MatchTargetFields,
                    ), crate::UnityEngine::Timeline::MatchTargetFields, 2usize>(
                        "Toggle"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Timeline::MatchTargetFields =
            unsafe { cordl_method_info.invoke_unchecked((), (me, flag))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Timeline+MatchTargetFieldConstants")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Timeline::MatchTargetFieldConstants {
