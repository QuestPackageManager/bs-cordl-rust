...
for crate::UnityEngine::Experimental::Playables::MaterialEffectPlayable {
    ...
    const CLASS_NAME: &'static str = "MaterialEffectPlayable";
...
impl crate::UnityEngine::Experimental::Playables::MaterialEffectPlayable {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Experimental::Playables::MaterialEffectPlayable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
