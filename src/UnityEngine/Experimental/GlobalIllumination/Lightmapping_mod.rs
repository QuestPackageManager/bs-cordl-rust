...
impl std::ops::Deref for crate::UnityEngine::Experimental::GlobalIllumination::Lightmapping {
...
#[cfg(feature = "UnityEngine+Experimental+GlobalIllumination+Lightmapping")]
impl std::ops::DerefMut for crate::UnityEngine::Experimental::GlobalIllumination::Lightmapping {
...
impl crate::UnityEngine::Experimental::GlobalIllumination::Lightmapping {
    ...
    pub type RequestLightsDelegate =
    ...
    pub fn RequestLights(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("RequestLights")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (lights, outLightsPtr, outLightsCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ResetDelegate() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("ResetDelegate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+Experimental+GlobalIllumination+Lightmapping+RequestLightsDelegate")]
impl std::ops::Deref
    for crate::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate
{
...
impl crate::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (requests, lightsOutput))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
