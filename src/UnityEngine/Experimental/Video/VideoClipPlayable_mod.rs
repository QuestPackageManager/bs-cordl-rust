...
impl crate::UnityEngine::Experimental::Video::VideoClipPlayable {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Experimental::Video::VideoClipPlayable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Experimental::Video::VideoClipPlayable as
