#[cfg(feature = "cordl_class_UnityEngine+Experimental+Rendering+BuiltinRuntimeReflectionSystem")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::UnityEngine::Experimental::Rendering::BuiltinRuntimeReflectionSystem
{
    ...
    const CLASS_NAME: &'static str = "BuiltinRuntimeReflectionSystem";
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), bool, 0usize>("BuiltinUpdate")
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::Experimental::Rendering::BuiltinRuntimeReflectionSystem,
                    >, 0usize>("Internal_BuiltinRuntimeReflectionSystem_New")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+Experimental+Rendering+BuiltinRuntimeReflectionSystem")]
impl AsRef<crate::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem>
    for crate::UnityEngine::Experimental::Rendering::BuiltinRuntimeReflectionSystem
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+Experimental+Rendering+BuiltinRuntimeReflectionSystem")]
impl AsMut<crate::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem>
    for crate::UnityEngine::Experimental::Rendering::BuiltinRuntimeReflectionSystem
{
    fn as_mut(
        &mut self,
