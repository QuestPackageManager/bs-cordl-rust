...
impl crate::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem {
    pub fn TickRealtimeProbes(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "TickRealtimeProbes",
                    0usize
                )
            });
