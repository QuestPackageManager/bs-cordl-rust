#[cfg(
    feature = "cordl_class_UnityEngine+Experimental+Rendering+XRBuiltinShaderConstants"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Experimental::Rendering::XRBuiltinShaderConstants {
    ...
    pub fn Update(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (xrPass, cmd, renderIntoTexture))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateBuiltinShaderConstants", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    (),
                    (viewMatrix, projMatrix, renderIntoTexture, viewIndex),
                )?
        };
        Ok(__cordl_ret.into())
    }
