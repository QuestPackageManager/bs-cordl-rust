...
for crate::UnityEngine::Playables::ScriptPlayableOutput {
    ...
    const CLASS_NAME: &'static str = "ScriptPlayableOutput";
...
impl crate::UnityEngine::Playables::ScriptPlayableOutput {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Playables::ScriptPlayableOutput as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Playables::ScriptPlayableOutput as
