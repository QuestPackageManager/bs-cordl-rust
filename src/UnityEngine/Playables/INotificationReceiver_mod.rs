#[cfg(feature = "cordl_class_UnityEngine+Playables+INotificationReceiver")]
...
#[cfg(feature = "cordl_class_UnityEngine+Playables+INotificationReceiver")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Playables::INotificationReceiver {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Playables";
    const CLASS_NAME: &'static str = "INotificationReceiver";
...
#[cfg(feature = "cordl_class_UnityEngine+Playables+INotificationReceiver")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Playables::INotificationReceiver {
