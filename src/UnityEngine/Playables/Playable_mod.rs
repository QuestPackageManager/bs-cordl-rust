...
#[cfg(feature = "cordl_class_UnityEngine+Playables+Playable")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::Playables::Playable {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Playables+Playable")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::Playables::Playable {
    type Type = Self;
...
impl crate::UnityEngine::Playables::Playable {
    ...
    pub fn Equals(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::Playables::Playable), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_Null() -> quest_hook::libil2cpp::Result<crate::UnityEngine::Playables::Playable> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::UnityEngine::Playables::Playable, 0usize>(
                        "get_Null",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::Playables::Playable> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Playables+Playable")]
...
#[cfg(feature = "UnityEngine+Playables+Playable")]
impl AsRef<crate::UnityEngine::Playables::IPlayable> for crate::UnityEngine::Playables::Playable {
    fn as_ref(&self) -> &crate::UnityEngine::Playables::IPlayable {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Playables+Playable")]
impl AsMut<crate::UnityEngine::Playables::IPlayable> for crate::UnityEngine::Playables::Playable {
