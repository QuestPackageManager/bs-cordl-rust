...
#[cfg(feature = "UnityEngine+Playables+IPlayable")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Playables::IPlayable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Playables";
    const CLASS_NAME: &'static str = "IPlayable";
...
impl crate::UnityEngine::Playables::IPlayable {
    pub fn GetHandle(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Playables::IPlayable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Playables::IPlayable as
