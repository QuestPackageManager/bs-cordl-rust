...
#[cfg(feature = "cordl_class_UnityEngine+Playables+PlayableSystems")]
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::Playables::PlayableSystems {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Playables";
...
impl crate::UnityEngine::Playables::PlayableSystems {
    ...
    pub type DataPlayableOutputList = crate::UnityEngine::Playables::PlayableSystems_DataPlayableOutputList;
    #[cfg(feature = "UnityEngine+Playables+PlayableSystems+PlayableSystemDelegate")]
    pub type PlayableSystemDelegate = crate::UnityEngine::Playables::PlayableSystems_PlayableSystemDelegate;
    #[cfg(feature = "UnityEngine+Playables+PlayableSystems+PlayableSystemStage")]
    pub type PlayableSystemStage = crate::UnityEngine::Playables::PlayableSystems_PlayableSystemStage;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CombineTypeAndIndex", 2usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (typeIndex, stage))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "Internal_CallSystemDelegate", 4usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (systemIndex, stage, outputsPtr, numOutputs))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(
    feature = "cordl_class_UnityEngine+Playables+PlayableSystems+DataPlayableOutputList"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Playables::PlayableSystems_DataPlayableOutputList {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (outputs, count))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+Playables+PlayableSystems+PlayableSystemDelegate"
)]
#[repr(C)]
#[derive(Debug)]
