...
#[cfg(feature = "cordl_class_UnityEngine+Playables+ScriptPlayableBinding")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Playables::ScriptPlayableBinding {
...
impl crate::UnityEngine::Playables::ScriptPlayableBinding {
    pub fn Create(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Playables::PlayableBinding, 3usize>(
                        "Create"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Playables::PlayableBinding =
            unsafe { cordl_method_info.invoke_unchecked((), (name, key, _cordl_type))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Playables+ScriptPlayableBinding")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Playables::ScriptPlayableBinding {
