...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::GraphicsBufferHandle {
    ...
    const CLASS_NAME: &'static str = "GraphicsBufferHandle";
...
impl crate::UnityEngine::GraphicsBufferHandle {
    pub fn Equals_GraphicsBufferHandle1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::GraphicsBufferHandle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::GraphicsBufferHandle as
