...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ResourceRequest {
    ...
    const CLASS_NAME: &'static str = "ResourceRequest";
...
impl crate::UnityEngine::ResourceRequest {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceRequest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ResourceRequest as quest_hook::libil2cpp::Type >
                    ::class(), "GetResult", 0usize
                )
            });
