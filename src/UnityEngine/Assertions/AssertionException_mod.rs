...
#[cfg(feature = "cordl_class_UnityEngine+Assertions+AssertionException")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Assertions::AssertionException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Assertions";
    const CLASS_NAME: &'static str = "AssertionException";
...
impl crate::UnityEngine::Assertions::AssertionException {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (message, userMessage))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Message(
        &mut self,
...
#[cfg(feature = "cordl_class_UnityEngine+Assertions+AssertionException")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Assertions::AssertionException {
