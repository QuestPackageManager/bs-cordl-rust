#[cfg(feature = "cordl_class_UnityEngine+Assertions+AssertionMessageUtil")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+Assertions+AssertionMessageUtil")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Assertions::AssertionMessageUtil {
...
impl crate::UnityEngine::Assertions::AssertionMessageUtil {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (actual, expected, expectEqual))? };
        Ok(__cordl_ret.into())
    }
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (failureMessage, expected))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Assertions+AssertionMessageUtil")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Assertions::AssertionMessageUtil {
