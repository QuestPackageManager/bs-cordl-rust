...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TextAreaAttribute {
    ...
    const CLASS_NAME: &'static str = "TextAreaAttribute";
...
impl crate::UnityEngine::TextAreaAttribute {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TextAreaAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::TextAreaAttribute as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
    ...
    pub fn _ctor_i32_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (minLines, maxLines))?
        };
        Ok(__cordl_ret.into())
    }
}
