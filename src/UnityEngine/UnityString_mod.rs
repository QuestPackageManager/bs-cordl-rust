...
#[cfg(feature = "UnityEngine+UnityString")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UnityString {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "UnityString";
...
impl crate::UnityEngine::UnityString {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UnityString as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UnityString as quest_hook::libil2cpp::Type >
                    ::class(), "Format", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (fmt, args))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "UnityEngine+UnityString")]
