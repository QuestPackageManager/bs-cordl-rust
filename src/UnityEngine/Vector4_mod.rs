...
impl crate::UnityEngine::Vector4 {
    ...
    pub fn Dot(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Vector4 as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Vector4 as quest_hook::libil2cpp::Type >
                    ::class(), "Dot", 2usize
                )
            });
