#[cfg(feature = "cordl_class_UnityEngine+DetailRenderMode")]
#[repr(i32)]
...
#[cfg(feature = "cordl_class_UnityEngine+DetailRenderMode")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::DetailRenderMode {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "DetailRenderMode";
