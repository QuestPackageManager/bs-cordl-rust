#[cfg(feature = "cordl_class_UnityEngine+SendMessageOptions")]
...
#[cfg(feature = "cordl_class_UnityEngine+SendMessageOptions")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::SendMessageOptions {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "SendMessageOptions";
