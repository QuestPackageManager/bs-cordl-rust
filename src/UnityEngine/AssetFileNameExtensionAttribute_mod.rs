...
pub struct AssetFileNameExtensionAttribute {
    ...
    pub _preferredExtension_k__BackingField:
...
#[cfg(feature = "cordl_class_UnityEngine+AssetFileNameExtensionAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AssetFileNameExtensionAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AssetFileNameExtensionAttribute";
...
impl crate::UnityEngine::AssetFileNameExtensionAttribute {
    pub fn New(
        preferredExtension: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (preferredExtension, otherExtensions))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+AssetFileNameExtensionAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::AssetFileNameExtensionAttribute {
