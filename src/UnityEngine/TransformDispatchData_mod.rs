...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TransformDispatchData {
    ...
    const CLASS_NAME: &'static str = "TransformDispatchData";
...
impl crate::UnityEngine::TransformDispatchData {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TransformDispatchData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::TransformDispatchData as
