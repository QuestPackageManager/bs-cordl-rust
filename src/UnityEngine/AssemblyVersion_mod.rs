...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AssemblyVersion {
    ...
    const CLASS_NAME: &'static str = "AssemblyVersion";
...
impl crate::UnityEngine::AssemblyVersion {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AssemblyVersion as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AssemblyVersion as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
    ...
    pub fn op_Equality(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AssemblyVersion as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    crate::UnityEngine::AssemblyVersion,
                    crate::UnityEngine::AssemblyVersion,
                ),
                bool,
                2usize,
