...
#[cfg(feature = "cordl_class_UnityEngine+SpatialTracking+PoseDataSource")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::SpatialTracking::PoseDataSource {
...
impl crate::UnityEngine::SpatialTracking::PoseDataSource {
    pub fn GetDataFromSource(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::SpatialTracking::PoseDataFlags, 2usize>(
                        "GetDataFromSource",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::SpatialTracking::PoseDataFlags =
            unsafe { cordl_method_info.invoke_unchecked((), (poseSource, resultPose))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetNodePoseData(
        ...
        let __cordl_ret: crate::UnityEngine::SpatialTracking::PoseDataFlags =
            unsafe { cordl_method_info.invoke_unchecked((), (node, resultPose))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose,
                        quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Pose>,
                    ), bool, 2usize>("TryGetDataFromSource")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+SpatialTracking+PoseDataSource")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::SpatialTracking::PoseDataSource {
