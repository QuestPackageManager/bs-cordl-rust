#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIElementsUtility")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIElementsUtility")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIElementsUtility {
...
impl crate::UnityEngine::UIElements::UIElementsUtility {
    pub fn BeginContainerGUI(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("BeginContainerGUI")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (cache, evt, container))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn DoDispatch(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (panel))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndContainerGUI(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("EndContainerGUI")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (evt, layoutSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetAllPanels(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("GetAllPanels")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (panels, contextType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PixelsPerUnitScaleForElement(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), f32, 2usize>("PixelsPerUnitScaleForElement")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (ve, sprite))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UnityEngine_UIElements_IUIElementsUtility_ProcessEvent(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (instanceID, nativeEventPtr, eventHandled))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_isOSXContextualMenuPlatform() -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), bool, 0usize>("get_isOSXContextualMenuPlatform")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIElementsUtility")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIElementsUtility {
