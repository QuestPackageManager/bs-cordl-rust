#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseLeaveEvent")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseLeaveEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::MouseLeaveEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "MouseLeaveEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseLeaveEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::MouseLeaveEvent {
