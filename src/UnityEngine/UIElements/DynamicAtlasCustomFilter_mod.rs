...
for crate::UnityEngine::UIElements::DynamicAtlasCustomFilter {
    ...
    const CLASS_NAME: &'static str = "DynamicAtlasCustomFilter";
...
impl crate::UnityEngine::UIElements::DynamicAtlasCustomFilter {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::DynamicAtlasCustomFilter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::DynamicAtlasCustomFilter as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 2usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (texture, filtersToApply))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
