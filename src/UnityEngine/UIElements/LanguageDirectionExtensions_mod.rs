...
#[repr(C)]
#[derive(Debug)]
pub struct LanguageDirectionExtensions {
...
#[cfg(feature = "UnityEngine+UIElements+LanguageDirectionExtensions")]
impl std::ops::Deref for crate::UnityEngine::UIElements::LanguageDirectionExtensions {
...
#[cfg(feature = "UnityEngine+UIElements+LanguageDirectionExtensions")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::LanguageDirectionExtensions {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+LanguageDirectionExtensions")]
impl crate::UnityEngine::UIElements::LanguageDirectionExtensions {
    pub fn toTextCore(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        crate::UnityEngine::TextCore::LanguageDirection,
                        1usize,
                    >("toTextCore")
                    .unwrap_or_else(|e| {
                        panic!(
