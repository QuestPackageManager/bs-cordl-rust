...
impl crate::UnityEngine::UIElements::SortColumnDescription {
    ...
    pub type UxmlObjectFactory = crate::UnityEngine::UIElements::SortColumnDescription_UxmlObjectFactory;
    ...
    pub fn _ctor_Il2CppString_SortDirection2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (columnName, direction))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_SortDirection1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (columnIndex, direction))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn add_changed(
...
#[cfg(
    feature = "cordl_class_UnityEngine+UIElements+SortColumnDescription+UxmlObjectFactory"
)]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+UIElements+SortColumnDescription+UxmlObjectFactory_1"
)]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+UIElements+SortColumnDescription+UxmlObjectTraits_1"
)]
#[repr(C)]
#[derive(Debug)]
