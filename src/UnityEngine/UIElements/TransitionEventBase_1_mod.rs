#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransitionEventBase_1")]
#[repr(C)]
...
pub struct TransitionEventBase_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub _stylePropertyNames_k__BackingField:
    ...
    for crate::UnityEngine::UIElements::TransitionEventBase_1<T>
{
    ...
    const CLASS_NAME: &'static str = "TransitionEventBase`1";
...
#[cfg(feature = "UnityEngine+UIElements+TransitionEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::TransitionEventBase_1<T> {
    pub fn GetPooled(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        (crate::UnityEngine::UIElements::StylePropertyName, f64),
                        T,
                        2usize,
                    >("GetPooled")
                    .unwrap_or_else(|e| {
        ...
        let __cordl_ret: T =
            unsafe { cordl_method_info.invoke_unchecked((), (stylePropertyName, elapsedTime))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_stylePropertyNames(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::UIElements::StylePropertyNameCollection>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_stylePropertyNames", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::UIElements::StylePropertyNameCollection =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f64), quest_hook::libil2cpp::Void, 1usize>("set_elapsedTime")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
