#[cfg(feature = "cordl_class_UnityEngine+UIElements+GeometryChangedEvent")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+GeometryChangedEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::GeometryChangedEvent {
...
impl crate::UnityEngine::UIElements::GeometryChangedEvent {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::GeometryChangedEvent,
        > = unsafe { cordl_method_info.invoke_unchecked((), (oldRect, newRect))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_newRect(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Rect> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_oldRect(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Rect> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+GeometryChangedEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::GeometryChangedEvent {
