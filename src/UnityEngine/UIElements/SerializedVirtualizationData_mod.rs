...
for crate::UnityEngine::UIElements::SerializedVirtualizationData {
    ...
    const CLASS_NAME: &'static str = "SerializedVirtualizationData";
...
impl crate::UnityEngine::UIElements::SerializedVirtualizationData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::SerializedVirtualizationData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::SerializedVirtualizationData as
