...
impl crate::UnityEngine::UIElements::UQuery {
    ...
    pub type IsOfType_1<T: quest_hook::libil2cpp::Type> =
...
impl crate::UnityEngine::UIElements::UQuery_FirstQueryMatcher {
    pub fn CreateNew(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UQuery_SingleQueryMatcher>,
    > {
...
#[cfg(feature = "UnityEngine+UIElements+UQuery+IVisualPredicateWrapper")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UQuery_IVisualPredicateWrapper {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
    ...
    for crate::UnityEngine::UIElements::UQuery_IsOfType_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "UQuery/IsOfType`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+UIElements+UQuery+IsOfType_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UQuery_IsOfType_1<T> {
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>>
    where
...
impl<T: quest_hook::libil2cpp::Type>
    ...
    for crate::UnityEngine::UIElements::UQuery_IsOfType_1<T>
{
    fn as_mut(&mut self) -> &mut crate::UnityEngine::UIElements::UQuery_IVisualPredicateWrapper {
        unsafe { std::mem::transmute(self) }
    }
}
...
impl crate::UnityEngine::UIElements::UQuery_SingleQueryMatcher {
    ...
    pub fn Run(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (root, matchers))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UQuery+UQueryMatcher")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UQuery_UQueryMatcher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
...
impl crate::UnityEngine::UIElements::UQuery_UQueryMatcher {
    ...
    pub fn NoProcessResult(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("NoProcessResult")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (e, i))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnRuleMatchedElement(
        &mut self,
    ...
    pub fn TraverseRecursive(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("TraverseRecursive")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (element, depth))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UQuery+UQueryMatcher")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UQuery_UQueryMatcher {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
