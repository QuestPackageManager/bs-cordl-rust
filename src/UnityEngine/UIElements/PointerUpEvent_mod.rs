...
for crate::UnityEngine::UIElements::PointerUpEvent {
    ...
    const CLASS_NAME: &'static str = "PointerUpEvent";
...
impl crate::UnityEngine::UIElements::PointerUpEvent {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::PointerUpEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Init")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::PointerUpEvent as
