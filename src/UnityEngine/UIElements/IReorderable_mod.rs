...
for crate::UnityEngine::UIElements::IReorderable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "IReorderable";
...
impl crate::UnityEngine::UIElements::IReorderable {
    ...
    pub fn get_enableReordering(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IReorderable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_enableReordering")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::IReorderable as
                    quest_hook::libil2cpp::Type > ::class(), "get_enableReordering",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IReorderable as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::IReorderable as
                    quest_hook::libil2cpp::Type > ::class(), "set_enableReordering",
                    1usize
                )
            });
