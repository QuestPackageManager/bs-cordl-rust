...
impl crate::UnityEngine::UIElements::StyleFontDefinition {
    pub fn Equals_Il2CppObject1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::StyleFontDefinition as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::StyleFontDefinition as
    ...
    pub fn _ctor_StyleKeyword1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (f, keyword))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_keyword(
