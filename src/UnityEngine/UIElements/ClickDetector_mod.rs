...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+ClickDetector")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::ClickDetector {
...
impl crate::UnityEngine::UIElements::ClickDetector {
    ...
    pub fn ContainsPointer(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (element, pe))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProcessEvent<TEvent>(
        &mut self,
        evt: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::PointerEventBase_1<TEvent>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("ProcessEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+ClickDetector")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::ClickDetector {
...
#[cfg(feature = "UnityEngine+UIElements+ClickDetector+ButtonClickStatus")]
impl std::ops::Deref for crate::UnityEngine::UIElements::ClickDetector_ButtonClickStatus {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "UnityEngine+UIElements+ClickDetector+ButtonClickStatus")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::ClickDetector_ButtonClickStatus {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
