...
impl crate::UnityEngine::UIElements::BaseFieldMouseDragger {
    ...
    pub fn SetDragZone_Rect1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::BaseFieldMouseDragger as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::BaseFieldMouseDragger as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::BaseFieldMouseDragger as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::BaseFieldMouseDragger as
                    quest_hook::libil2cpp::Type > ::class(), "SetDragZone", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
