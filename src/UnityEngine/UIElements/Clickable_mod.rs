...
pub struct Clickable {
    ...
    pub m_PendingActivePseudoStateReset:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IVisualElementScheduledItem>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Clickable")]
...
impl crate::UnityEngine::UIElements::Clickable {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "OnTimer",
                            1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (timerState))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SimulateSingleClick(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (evt, delayMs))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Action_i64_i64_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (handler, delay, interval))? };
        Ok(__cordl_ret.into())
    }
    pub fn add_clicked(
        &mut self,
    ...
    pub fn get_invokePolicy(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::InvokePolicy, 0usize>(
                        "get_invokePolicy",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::InvokePolicy =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_lastMousePosition(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector2, 0usize>("get_lastMousePosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
