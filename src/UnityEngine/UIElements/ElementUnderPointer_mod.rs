...
impl crate::UnityEngine::UIElements::ElementUnderPointer {
    pub fn CommitElementUnderPointers(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (dispatcher, contextType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetEventPointerPosition(
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 = unsafe {
            cordl_method_info.invoke_unchecked(self, (triggerEvent))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (pointerId, pickPosition, isTemporary))?
        };
        Ok(__cordl_ret.into())
    }
