...
impl crate::UnityEngine::UIElements::ClickEvent {
    pub fn GetPooled(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::ClickEvent>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::ClickEvent as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::ClickEvent as
                    quest_hook::libil2cpp::Type > ::class(), "GetPooled", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::ClickEvent,
        > = unsafe { method.invoke_unchecked((), (pointerEvent, clickCount))? };
        Ok(__cordl_ret.into())
    }
    pub fn Init(
        &mut self,
