#[cfg(feature = "cordl_class_UnityEngine+UIElements+ClickEvent")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::UIElements::ClickEvent {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::ClickEvent> =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerEvent, clickCount))? };
        Ok(__cordl_ret.into())
    }
