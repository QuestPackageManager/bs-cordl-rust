...
impl crate::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription {
    pub fn ConvertValueToUInt(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "ConvertValueToUInt",
                    2usize
                )
            });
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: u32 = unsafe { method.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
