#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlUnsignedIntAttributeDescription")]
#[repr(C)]
    ...
    for crate::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription
{
    ...
    const CLASS_NAME: &'static str = "UxmlUnsignedIntAttributeDescription";
...
impl std::ops::Deref for crate::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription {
...
#[cfg(feature = "UnityEngine+UIElements+UxmlUnsignedIntAttributeDescription")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription {
...
impl crate::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription {
    pub fn ConvertValueToUInt(
        ...
        let __cordl_ret: u32 =
            unsafe { cordl_method_info.invoke_unchecked((), (v, defaultValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
