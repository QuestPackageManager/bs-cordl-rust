#[cfg(feature = "cordl_class_UnityEngine+UIElements+IVisualElementScheduler")]
...
impl crate::UnityEngine::UIElements::IVisualElementScheduler {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::IVisualElementScheduledItem,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (timerUpdateEvent))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+IVisualElementScheduler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::IVisualElementScheduler {
