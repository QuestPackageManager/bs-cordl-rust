...
for crate::UnityEngine::UIElements::IEventHandler {
    ...
    const CLASS_NAME: &'static str = "IEventHandler";
...
impl crate::UnityEngine::UIElements::IEventHandler {
    pub fn HandleEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IEventHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::IEventHandler as
