#[cfg(feature = "cordl_class_UnityEngine+UIElements+ContextualMenuManager")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+ContextualMenuManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::ContextualMenuManager {
...
impl crate::UnityEngine::UIElements::ContextualMenuManager {
    pub fn DisplayMenuIfEventMatches(
        ...
        eventHandler: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IEventHandler>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (evt, eventHandler))? };
        Ok(__cordl_ret.into())
    }
    pub fn DisplayMenu_DropdownMenu1(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("DisplayMenu")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (triggerEvent, target, menu))? };
        Ok(__cordl_ret.into())
    }
    pub fn DisplayMenu_EventBase_IEventHandler0(
        &mut self,
        triggerEvent: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::EventBase>,
        target: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IEventHandler>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::EventBase>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IEventHandler>,
                    ), quest_hook::libil2cpp::Void, 2usize>("DisplayMenu")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (triggerEvent, target))? };
        Ok(__cordl_ret.into())
    }
    pub fn DoDisplayMenu(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::DropdownMenu>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::EventBase>,
                    ), quest_hook::libil2cpp::Void, 2usize>("DoDisplayMenu")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (menu, triggerEvent))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+ContextualMenuManager")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::ContextualMenuManager {
