    ...
    for crate::UnityEngine::UIElements::VisualTreeHierarchyFlagsUpdater
{
    ...
    const CLASS_NAME: &'static str = "VisualTreeHierarchyFlagsUpdater";
...
impl std::ops::Deref for crate::UnityEngine::UIElements::VisualTreeHierarchyFlagsUpdater {
...
#[cfg(feature = "UnityEngine+UIElements+VisualTreeHierarchyFlagsUpdater")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::VisualTreeHierarchyFlagsUpdater {
...
impl crate::UnityEngine::UIElements::VisualTreeHierarchyFlagsUpdater {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DirtyBoundingBoxHierarchy", 1usize
                        )
                    })
            });
    ...
    pub fn DirtyHierarchy(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("DirtyHierarchy")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (ve, mustDirtyFlags))? };
        Ok(__cordl_ret.into())
    }
    pub fn DirtyParentHierarchy(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (ve, flags))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetChildrenMustDirtyFlags(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::UIElements::VisualElementFlags, 2usize>(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::VisualElementFlags =
            unsafe { cordl_method_info.invoke_unchecked((), (ve, versionChangeType))? };
        Ok(__cordl_ret.into())
    }
