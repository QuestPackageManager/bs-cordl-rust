...
for crate::UnityEngine::UIElements::UxmlStringAttributeDescription {
    ...
    const CLASS_NAME: &'static str = "UxmlStringAttributeDescription";
...
impl crate::UnityEngine::UIElements::UxmlStringAttributeDescription {
    pub fn GetValueFromBag(
        ...
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlStringAttributeDescription as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlStringAttributeDescription as
