#[cfg(feature = "cordl_class_UnityEngine+UIElements+INavigationEvent")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+INavigationEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::INavigationEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "INavigationEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+INavigationEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::INavigationEvent {
