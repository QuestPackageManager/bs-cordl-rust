...
impl crate::UnityEngine::UIElements::MouseEventDispatchingStrategy {
    ...
    pub fn DispatchEvent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (evt, iPanel))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn IsDone(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SendEventToIMGUIContainer", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SendEventToRegularTarget", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateElementUnderMouse", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (evt, panel, elementUnderMouse))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
