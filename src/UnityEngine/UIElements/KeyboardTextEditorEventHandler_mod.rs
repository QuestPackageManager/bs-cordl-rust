    ...
    for crate::UnityEngine::UIElements::KeyboardTextEditorEventHandler
{
    ...
    const CLASS_NAME: &'static str = "KeyboardTextEditorEventHandler";
...
#[cfg(feature = "UnityEngine+UIElements+KeyboardTextEditorEventHandler")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::KeyboardTextEditorEventHandler {
...
impl crate::UnityEngine::UIElements::KeyboardTextEditorEventHandler {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::UIElements::NavigationEventBase_1<TEvent>,
                    >), quest_hook::libil2cpp::Void, 1usize>("OnNavigationEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn UpdateLabel(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("UpdateLabel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (generatePreview))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
