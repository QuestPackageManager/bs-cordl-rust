...
pub struct UxmlRootElementFactory {
    __cordl_parent: crate::UnityEngine::UIElements::UxmlFactory_2<
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UxmlRootElementTraits>,
    >,
}
#[cfg(feature = "UnityEngine+UIElements+UxmlRootElementFactory")]
...
for crate::UnityEngine::UIElements::UxmlRootElementFactory {
    ...
    const CLASS_NAME: &'static str = "UxmlRootElementFactory";
...
impl crate::UnityEngine::UIElements::UxmlRootElementFactory {
    pub fn Create(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlRootElementFactory as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlRootElementFactory as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlRootElementFactory as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UxmlRootElementFactory as
                    quest_hook::libil2cpp::Type > ::class(), "get_uxmlName", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlRootElementFactory as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UxmlRootElementFactory as
                    quest_hook::libil2cpp::Type > ::class(), "get_uxmlQualifiedName",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
