#[cfg(feature = "cordl_class_UnityEngine+UIElements+TreeViewController")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TreeViewController")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::TreeViewController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "TreeViewController";
...
impl crate::UnityEngine::UIElements::TreeViewController {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("BindItem")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::TreeView> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TreeViewController")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::TreeViewController {
