#[cfg(feature = "cordl_class_UnityEngine+UIElements+NavigationEventBase_1")]
#[repr(C)]
...
#[cfg(feature = "UnityEngine+UIElements+NavigationEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::NavigationEventBase_1<T> {
    pub fn Dispatch(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::UnityEngine::EventModifiers), T, 1usize>(
                        "GetPooled",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked((), (modifiers))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T =
            unsafe { cordl_method_info.invoke_unchecked((), (deviceType, modifiers))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_deviceType(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::UIElements::NavigationDeviceType>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::NavigationDeviceType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "UnityEngine+UIElements+NavigationEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::UnityEngine::UIElements::INavigationEvent>
    for crate::UnityEngine::UIElements::NavigationEventBase_1<T>
{
...
#[cfg(feature = "UnityEngine+UIElements+NavigationEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::UnityEngine::UIElements::INavigationEvent>
    for crate::UnityEngine::UIElements::NavigationEventBase_1<T>
{
