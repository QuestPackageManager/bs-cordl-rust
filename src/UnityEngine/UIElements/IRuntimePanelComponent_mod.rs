...
for crate::UnityEngine::UIElements::IRuntimePanelComponent {
    ...
    const CLASS_NAME: &'static str = "IRuntimePanelComponent";
...
impl crate::UnityEngine::UIElements::IRuntimePanelComponent {
    ...
    pub fn set_panel(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IRuntimePanelComponent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::IRuntimePanelComponent as
