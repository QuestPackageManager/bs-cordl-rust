#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlTemplateFactory")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlTemplateFactory")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UxmlTemplateFactory {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "UxmlTemplateFactory";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlTemplateFactory")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UxmlTemplateFactory {
