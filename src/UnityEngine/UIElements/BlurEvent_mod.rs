...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::BlurEvent {
    ...
    const CLASS_NAME: &'static str = "BlurEvent";
...
impl crate::UnityEngine::UIElements::BlurEvent {
    ...
    pub fn PreDispatch(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::BlurEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::BlurEvent as
