#[cfg(feature = "cordl_class_UnityEngine+UIElements+IStyleDataGroup_1")]
    ...
    for crate::UnityEngine::UIElements::IStyleDataGroup_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IStyleDataGroup`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "IStyleDataGroup`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+UIElements+IStyleDataGroup_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::IStyleDataGroup_1<T> {
