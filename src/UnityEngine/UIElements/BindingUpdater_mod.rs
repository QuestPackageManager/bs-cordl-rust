...
for crate::UnityEngine::UIElements::BindingUpdater {
...
impl crate::UnityEngine::UIElements::BindingUpdater {
    ...
    pub type CastDataSourceVisitor = crate::UnityEngine::UIElements::BindingUpdater_CastDataSourceVisitor;
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetExtractValueErrorString", 3usize
                        )
                    })
            });
        ...
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (returnCode, target, path))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetVisitationErrorString", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
    ...
    pub fn ShouldProcessBindingAtStage_Binding0(
        &mut self,
        bindingObject: quest_hook::libil2cpp::Gc<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShouldProcessBindingAtStage", 4usize
                        )
                    })
            });
    ...
    pub fn ShouldProcessBindingAtStage_CustomBinding2(
        &mut self,
        customBinding: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::CustomBinding,
        >,
        stage: crate::UnityEngine::UIElements::BindingUpdateStage,
        versionChanged: bool,
        dirty: bool,
    ...
    pub fn ShouldProcessBindingAtStage_DataBinding1(
        dataBinding: quest_hook::libil2cpp::Gc<
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (dataBinding, stage, versionChanged, dirty))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TryUpdateUIWithNonContainer", 3usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::UIElements::BindingResult = unsafe {
            cordl_method_info.invoke_unchecked((), (context, binding, value))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateDataSource", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::UIElements::BindingResult = unsafe {
            cordl_method_info.invoke_unchecked(self, (context, customBinding))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateDataSource_DataBinding0(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::BindingResult = unsafe {
            cordl_method_info.invoke_unchecked(self, (context, dataBinding))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateSource(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::BindingResult = unsafe {
            cordl_method_info.invoke_unchecked(self, (context, bindingObject))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    (),
                    (dataBinding, direction, container, path, context),
                )?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::System::ValueTuple_3<
            ...
            crate::UnityEngine::UIElements::BindingResult,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (dataBinding, container, context))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
#[cfg(
    feature = "cordl_class_UnityEngine+UIElements+BindingUpdater+CastDataSourceVisitor"
)]
#[repr(C)]
#[derive(Debug)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_bindingContext", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::UIElements::BindingContext = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::UnityEngine::UIElements::BindingUpdater_UIPathVisitor {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::BindingUpdateStage = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
