...
impl std::ops::Deref for crate::UnityEngine::UIElements::CollectionVirtualizationController {
...
#[cfg(feature = "UnityEngine+UIElements+CollectionVirtualizationController")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::CollectionVirtualizationController {
...
impl crate::UnityEngine::UIElements::CollectionVirtualizationController {
    ...
    pub fn OnFocusIn(
        &mut self,
        leafTarget: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (leafTarget))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnFocusOut(
        &mut self,
        willFocus: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (willFocus))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnScroll(
        &mut self,
    ...
    pub fn Refresh(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rebuild))? };
        Ok(__cordl_ret.into())
    }
    pub fn Resize(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("StartDragItem")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (scrollView))? };
        Ok(__cordl_ret.into())
    }
