#[cfg(feature = "cordl_class_UnityEngine+UIElements+DynamicAtlasSettings")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DynamicAtlasSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::DynamicAtlasSettings {
...
impl crate::UnityEngine::UIElements::DynamicAtlasSettings {
    ...
    pub fn get_activeFilters(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::DynamicAtlasFilters, 0usize>(
                        "get_activeFilters",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DynamicAtlasSettings")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::DynamicAtlasSettings {
