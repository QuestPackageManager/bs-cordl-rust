...
> crate::UnityEngine::UIElements::PointerCaptureEventBase_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::PointerCaptureEventBase_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::PointerCaptureEventBase_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "GetPooled", 3usize
                )
            });
        let __cordl_ret: T = unsafe {
            method.invoke_unchecked((), (target, relatedTarget, pointerId))?
        };
        Ok(__cordl_ret.into())
    }
