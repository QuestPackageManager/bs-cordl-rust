...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UQueryState_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe {
            cordl_method_info.invoke_unchecked(self, (matcher))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (element, matchers))?
        };
        Ok(__cordl_ret.into())
    }
}
...
> crate::UnityEngine::UIElements::UQueryState_1_ActionQueryMatcher<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (matcher, element))?
        };
        Ok(__cordl_ret.into())
    }
...
> crate::UnityEngine::UIElements::UQueryState_1_Enumerator<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (queryState))?
        };
        Ok(__cordl_ret.into())
    }
