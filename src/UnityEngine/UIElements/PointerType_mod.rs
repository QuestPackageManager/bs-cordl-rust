#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerType")]
#[repr(C)]
...
impl crate::UnityEngine::UIElements::PointerType {
    ...
    pub fn IsDirectManipulationDevice(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (pointerType))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerType")]
