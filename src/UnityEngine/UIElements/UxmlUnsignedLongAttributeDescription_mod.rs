...
impl crate::UnityEngine::UIElements::UxmlUnsignedLongAttributeDescription {
    pub fn ConvertValueToUlong(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlUnsignedLongAttributeDescription as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "ConvertValueToUlong",
                    2usize
                )
            });
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: u64 = unsafe { method.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
