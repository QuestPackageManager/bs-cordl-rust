#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlUnsignedLongAttributeDescription")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::UIElements::UxmlUnsignedLongAttributeDescription {
...
#[cfg(feature = "UnityEngine+UIElements+UxmlUnsignedLongAttributeDescription")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UxmlUnsignedLongAttributeDescription {
...
impl crate::UnityEngine::UIElements::UxmlUnsignedLongAttributeDescription {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        u64,
                    ), u64, 2usize>("ConvertValueToUlong")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
