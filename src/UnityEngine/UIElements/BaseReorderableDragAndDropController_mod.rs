#[cfg(feature = "cordl_class_UnityEngine+UIElements+BaseReorderableDragAndDropController")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::UIElements::BaseReorderableDragAndDropController {
...
#[cfg(feature = "UnityEngine+UIElements+BaseReorderableDragAndDropController")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::BaseReorderableDragAndDropController {
...
impl crate::UnityEngine::UIElements::BaseReorderableDragAndDropController {
    pub fn CanStartDrag(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (itemIds))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn New(
        view: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::BaseVerticalCollectionView>,
...
impl AsRef<crate::UnityEngine::UIElements::ICollectionDragAndDropController>
    for crate::UnityEngine::UIElements::BaseReorderableDragAndDropController
{
    fn as_ref(&self) -> &crate::UnityEngine::UIElements::ICollectionDragAndDropController {
...
impl AsMut<crate::UnityEngine::UIElements::ICollectionDragAndDropController>
    for crate::UnityEngine::UIElements::BaseReorderableDragAndDropController
{
    fn as_mut(&mut self) -> &mut crate::UnityEngine::UIElements::ICollectionDragAndDropController {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+UIElements+BaseReorderableDragAndDropController")]
