...
#[cfg(feature = "UnityEngine+UIElements+IScheduler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::IScheduler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "IScheduler";
...
impl crate::UnityEngine::UIElements::IScheduler {
    pub fn Schedule(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IScheduler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::IScheduler as
