...
pub struct UITKTextJobSystem {
    ...
    pub m_PrepareTextJobifiedCallback: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::UIElements::UIR::MeshGenerationCallback,
    >,
    pub m_GenerateTextJobifiedCallback: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::UIElements::UIR::MeshGenerationCallback,
    >,
    pub m_AddDrawEntriesCallback: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::UIElements::UIR::MeshGenerationCallback,
    >,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UITKTextJobSystem")]
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::UIElements::UITKTextJobSystem {
...
impl crate::UnityEngine::UIElements::UITKTextJobSystem {
    ...
    pub type GenerateTextJobData = crate::UnityEngine::UIElements::UITKTextJobSystem_GenerateTextJobData;
    ...
    pub type PrepareTextJobData = crate::UnityEngine::UIElements::UITKTextJobSystem_PrepareTextJobData;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "AddDrawEntries", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (mgc, _cordl__))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ConvertMeshInfoToUIRVertex", 7usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn GenerateText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (mgc, textElement))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "OnGetManagedJob", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (managedJobData))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+UIElements+UITKTextJobSystem+GenerateTextJobData"
)]
#[repr(C)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+UIElements+UITKTextJobSystem+PrepareTextJobData"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
