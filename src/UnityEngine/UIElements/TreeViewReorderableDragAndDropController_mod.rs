...
pub struct TreeViewReorderableDragAndDropController {
    ...
    >,
    pub m_TreeView: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::BaseTreeView>,
    pub m_ExpandDropItemScheduledItem:
...
impl std::ops::Deref for crate::UnityEngine::UIElements::TreeViewReorderableDragAndDropController {
...
impl crate::UnityEngine::UIElements::TreeViewReorderableDragAndDropController {
    #[cfg(feature = "UnityEngine+UIElements+TreeViewReorderableDragAndDropController+DropData")]
    pub type DropData =
        crate::UnityEngine::UIElements::TreeViewReorderableDragAndDropController_DropData;
    pub fn CompareId(&mut self, id1: i32, id2: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (id1, id2))? };
        Ok(__cordl_ret.into())
    }
    pub fn DelayExpandDropItem(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("DelayExpandDropItem")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn DragCleanup(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn ExpandDropItem(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn HandleAutoExpand(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("HandleAutoExpand")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (item, pointerPosition))? };
        Ok(__cordl_ret.into())
    }
    pub fn HandleDragAndDrop(
        &mut self,
        args: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IListDragAndDropArgs>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), crate::UnityEngine::UIElements::DragVisualMode, 1usize>(
                        "HandleDragAndDrop"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::UIElements::IListDragAndDropArgs,
                    >), quest_hook::libil2cpp::Void, 1usize>("OnDrop")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetupDragAndDrop(
        &mut self,
        itemIds: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IEnumerable_1<i32>>,
        skipText: bool,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        bool,
                    ), crate::UnityEngine::UIElements::StartDragArgs, 2usize>(
                        "SetupDragAndDrop"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::StartDragArgs =
            unsafe { cordl_method_info.invoke_unchecked(self, (itemIds, skipText))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
