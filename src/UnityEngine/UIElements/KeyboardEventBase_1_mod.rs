#[cfg(feature = "cordl_class_UnityEngine+UIElements+KeyboardEventBase_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::UnityEngine::UIElements::KeyboardEventBase_1<T>
{
    ...
    const CLASS_NAME: &'static str = "KeyboardEventBase`1";
...
#[cfg(feature = "UnityEngine+UIElements+KeyboardEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::KeyboardEventBase_1<T> {
    pub fn Dispatch(
        &mut self,
    ...
    pub fn GetPooled__cordl_char_KeyCode_EventModifiers0(
        c: char,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T =
            unsafe { cordl_method_info.invoke_unchecked((), (c, keyCode, modifiers))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "UnityEngine+UIElements+KeyboardEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::UnityEngine::UIElements::IKeyboardEvent>
    for crate::UnityEngine::UIElements::KeyboardEventBase_1<T>
{
...
#[cfg(feature = "UnityEngine+UIElements+KeyboardEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::UnityEngine::UIElements::IKeyboardEvent>
    for crate::UnityEngine::UIElements::KeyboardEventBase_1<T>
{
