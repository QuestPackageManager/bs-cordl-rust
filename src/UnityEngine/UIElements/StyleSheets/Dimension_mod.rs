...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+Dimension")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::StyleSheets::Dimension {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
impl crate::UnityEngine::UIElements::StyleSheets::Dimension {
    ...
    pub fn ToAngle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::Angle, 0usize>("ToAngle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ToLength(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::Length, 0usize>("ToLength")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ToTime(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::TimeValue, 0usize>("ToTime")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        f32,
                        crate::UnityEngine::UIElements::StyleSheets::Dimension_Unit,
...
#[cfg(feature = "UnityEngine+UIElements+StyleSheets+Dimension")]
impl AsRef<crate::System::IEquatable_1<crate::UnityEngine::UIElements::StyleSheets::Dimension>>
    for crate::UnityEngine::UIElements::StyleSheets::Dimension
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+UIElements+StyleSheets+Dimension")]
impl AsMut<crate::System::IEquatable_1<crate::UnityEngine::UIElements::StyleSheets::Dimension>>
    for crate::UnityEngine::UIElements::StyleSheets::Dimension
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::UnityEngine::UIElements::StyleSheets::Dimension>
    {
        todo!()
    }
}
    ...
    for crate::UnityEngine::UIElements::StyleSheets::Dimension_Unit
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements.StyleSheets";
    const CLASS_NAME: &'static str = "Dimension/Unit";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
