...
impl crate::UnityEngine::UIElements::StyleSheets::StyleSelectorHelper {
    #[cfg(
        feature = "UnityEngine+UIElements+StyleSheets+StyleSelectorHelper+SelectorWorkItem"
    )]
    pub type SelectorWorkItem = crate::UnityEngine::UIElements::StyleSheets::StyleSelectorHelper_SelectorWorkItem;
    pub fn FastLookup(
...
impl crate::UnityEngine::UIElements::StyleSheets::StyleSelectorHelper_SelectorWorkItem {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (_cordl_type, input))?
        };
        Ok(__cordl_ret.into())
    }
}
