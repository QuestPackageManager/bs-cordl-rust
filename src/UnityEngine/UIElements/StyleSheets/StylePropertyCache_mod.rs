#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+StylePropertyCache")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::UnityEngine::UIElements::StyleSheets::StylePropertyCache {
...
#[cfg(feature = "UnityEngine+UIElements+StyleSheets+StylePropertyCache")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::StyleSheets::StylePropertyCache {
...
impl crate::UnityEngine::UIElements::StyleSheets::StylePropertyCache {
    pub fn TryGetNonTerminalValue(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    ), bool, 2usize>("TryGetNonTerminalValue")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (name, syntax))? };
        Ok(__cordl_ret.into())
    }
    pub fn TryGetSyntax(
        name: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
