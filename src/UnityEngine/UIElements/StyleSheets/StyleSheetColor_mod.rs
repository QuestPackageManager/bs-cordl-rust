#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+StyleSheetColor")]
#[repr(C)]
...
#[cfg(feature = "UnityEngine+UIElements+StyleSheets+StyleSheetColor")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::StyleSheets::StyleSheetColor {
...
impl crate::UnityEngine::UIElements::StyleSheets::StyleSheetColor {
    pub fn HexToColor32(color: u32) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(u32), crate::UnityEngine::Color32, 1usize>(
                        "HexToColor32",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn TryGetColor(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (name, color))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+StyleSheetColor")]
