...
impl crate::UnityEngine::UIElements::StyleSheets::HierarchyTraversal {
    ...
    pub fn Recurse(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::StyleSheets::HierarchyTraversal as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::StyleSheets::HierarchyTraversal as
                    quest_hook::libil2cpp::Type > ::class(), "Recurse", 2usize
                )
            });
