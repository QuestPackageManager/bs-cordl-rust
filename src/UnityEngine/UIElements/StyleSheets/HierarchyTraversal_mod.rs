#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+HierarchyTraversal")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::UIElements::StyleSheets::HierarchyTraversal {
...
#[cfg(feature = "UnityEngine+UIElements+StyleSheets+HierarchyTraversal")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::StyleSheets::HierarchyTraversal {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("Recurse")
                    .unwrap_or_else(|e| {
                        panic!(
