...
pub enum StylePropertyId {
    ...
    UnityEditorTextRenderingMode = 65540i32,
    UnityFont = 65541i32,
    UnityFontDefinition = 65542i32,
    UnityFontStyleAndWeight = 65543i32,
    UnityOverflowClipBox = 196611i32,
    UnityParagraphSpacing = 65544i32,
    ...
    UnityTextAlign = 65545i32,
    UnityTextGenerator = 65546i32,
    UnityTextOutline = 262154i32,
    UnityTextOutlineColor = 65547i32,
    UnityTextOutlineWidth = 65548i32,
    UnityTextOverflowPosition = 196617i32,
    Unknown = 0i32,
    Visibility = 65549i32,
    WhiteSpace = 65550i32,
    Width = 131104i32,
    WordSpacing = 65551i32,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+StylePropertyId")]
