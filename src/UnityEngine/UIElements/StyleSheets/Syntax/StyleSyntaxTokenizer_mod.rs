#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleSheets+Syntax+StyleSyntaxTokenizer")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer
{
    ...
    const CLASS_NAME: &'static str = "StyleSyntaxTokenizer";
...
impl std::ops::Deref for crate::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer {
...
impl crate::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer {
    pub fn GlobCharacter(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (s, index, c))? };
        Ok(__cordl_ret.into())
    }
    pub fn IsNextCharacter(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (s, index, c))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        i32,
                    ), bool, 2usize>("IsNextLetterOrDash")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken =
