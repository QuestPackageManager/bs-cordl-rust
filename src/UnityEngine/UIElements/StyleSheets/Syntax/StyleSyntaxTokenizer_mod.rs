...
impl crate::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GlobCharacter", 3usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (s, index, c))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Tokenize(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (syntax))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
