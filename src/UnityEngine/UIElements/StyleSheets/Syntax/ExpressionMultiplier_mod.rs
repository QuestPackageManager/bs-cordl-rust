...
for crate::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplier {
    ...
    const CLASS_NAME: &'static str = "ExpressionMultiplier";
...
impl crate::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplier {
    ...
    pub fn SetType(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    as quest_hook::libil2cpp::Type > ::class(), "SetType", 1usize
                )
            });
