...
#[cfg(feature = "UnityEngine+UIElements+StyleSheets+StylePropertyUtil")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::StyleSheets::StylePropertyUtil {
...
impl crate::UnityEngine::UIElements::StyleSheets::StylePropertyUtil {
    ...
    pub fn IsMatchingShorthand(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::UnityEngine::UIElements::StyleSheets::StylePropertyId,
                        crate::UnityEngine::UIElements::StyleSheets::StylePropertyId,
                    ), bool, 2usize>("IsMatchingShorthand")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (shorthand, id))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 3usize>("TryGetEnumIntValue")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
