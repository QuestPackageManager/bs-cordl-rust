#[cfg(feature = "cordl_class_UnityEngine+UIElements+VisualElementListPool")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+VisualElementListPool")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::VisualElementListPool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "VisualElementListPool";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+VisualElementListPool")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::VisualElementListPool {
