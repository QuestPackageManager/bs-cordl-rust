...
impl crate::UnityEngine::UIElements::IMGUIContainer {
    ...
    pub fn Dispose__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (disposeManaged))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleIMGUIEvent_Action__cordl_bool1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (e, onGUIHandler, canAffectFocus))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn HandleIMGUIEvent__cordl_bool0(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (e, canAffectFocus))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SendEventToIMGUI(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (evt, canAffectFocus, verifyBounds))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Action1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (onGUIHandler))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_cache(
