...
for crate::UnityEngine::UIElements::HandleDragAndDropArgs {
    ...
    const CLASS_NAME: &'static str = "HandleDragAndDropArgs";
...
impl crate::UnityEngine::UIElements::HandleDragAndDropArgs {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::HandleDragAndDropArgs as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::HandleDragAndDropArgs as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (position, dragAndDropArgs))?
        };
        Ok(__cordl_ret.into())
    }
}
