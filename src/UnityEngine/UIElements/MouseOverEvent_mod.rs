#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseOverEvent")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseOverEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::MouseOverEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "MouseOverEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseOverEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::MouseOverEvent {
