#[cfg(feature = "cordl_class_UnityEngine+UIElements+ChangeEvent_1")]
#[repr(C)]
    ...
    for crate::UnityEngine::UIElements::ChangeEvent_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "ChangeEvent`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::ChangeEvent_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::ChangeEvent_1<T>,
        > = unsafe { cordl_method_info.invoke_unchecked((), (previousValue, newValue))? };
        Ok(__cordl_ret.into())
    }
