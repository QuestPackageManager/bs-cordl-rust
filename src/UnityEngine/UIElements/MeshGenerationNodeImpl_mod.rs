#[cfg(feature = "cordl_class_UnityEngine+UIElements+MeshGenerationNodeImpl")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct MeshGenerationNodeImpl {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub m_SelfHandle: crate::System::Runtime::InteropServices::GCHandle,
    pub m_ParentEntry: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::Entry>,
    pub m_EntryRecorder:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::EntryRecorder>,
    pub _disposed_k__BackingField: bool,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MeshGenerationNodeImpl")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "MeshGenerationNodeImpl";
...
#[cfg(feature = "UnityEngine+UIElements+MeshGenerationNodeImpl")]
impl std::ops::Deref for crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
...
#[cfg(feature = "UnityEngine+UIElements+MeshGenerationNodeImpl")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+MeshGenerationNodeImpl")]
impl crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
    ...
    pub fn DrawGradients(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("DrawGradients")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (vertices, indices, gradientsOwner))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn DrawMesh(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (vertices, indices, texture, skipAtlas))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetNode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("GetNode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::ByRefMut<
                        crate::UnityEngine::UIElements::UnsafeMeshGenerationNode,
                    >), quest_hook::libil2cpp::Void, 1usize>("GetUnsafeNode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (parentEntry, entryRecorder, safe))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MeshGenerationNodeImpl")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
...
#[cfg(feature = "UnityEngine+UIElements+MeshGenerationNodeImpl")]
impl AsRef<crate::System::IDisposable> for crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
    fn as_ref(&self) -> &crate::System::IDisposable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+UIElements+MeshGenerationNodeImpl")]
impl AsMut<crate::System::IDisposable> for crate::UnityEngine::UIElements::MeshGenerationNodeImpl {
