#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleProperty")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleProperty")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::StyleProperty {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "StyleProperty";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleProperty")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::StyleProperty {
