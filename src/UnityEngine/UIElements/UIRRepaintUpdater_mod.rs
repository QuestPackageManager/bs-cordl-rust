...
pub struct UIRRepaintUpdater {
    ...
    pub renderChain: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::RenderChain>,
    pub m_ForceGammaRendering: bool,
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRRepaintUpdater")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIRRepaintUpdater {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "UIRRepaintUpdater";
...
impl crate::UnityEngine::UIElements::UIRRepaintUpdater {
    pub fn AttachToPanel(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("AttachToPanel")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn DestroyRenderChain(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("DestroyRenderChain")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn DetachFromPanel(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("DetachFromPanel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InitRenderChain(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InitRenderChain")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn OnGraphicsResourcesRecreate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (recreate))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnPanelAtlasChanged(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnPanelAtlasChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn OnPanelChanged(
        &mut self,
        obj: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::BaseVisualElementPanel>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Void, 1usize>("OnPanelChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn OnPanelDrawsInCamerasChanged(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
    ...
    pub fn OnPanelHierarchyChanged(
        ...
        additionalContext: quest_hook::libil2cpp::Gc<
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ve, changeType, additionalContext))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn OnPanelIsFlatChanged(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnPanelIsFlatChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ResetAllElementsDataRecursive", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn get_profilerMarker(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Unity::Profiling::ProfilerMarker, 0usize>(
                        "get_profilerMarker",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Unity::Profiling::ProfilerMarker =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_forceGammaRendering(
        &mut self,
        value: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRRepaintUpdater")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIRRepaintUpdater {
...
#[cfg(feature = "UnityEngine+UIElements+UIRRepaintUpdater")]
impl AsRef<crate::UnityEngine::UIElements::IPanelRenderer>
    for crate::UnityEngine::UIElements::UIRRepaintUpdater
{
    fn as_ref(&self) -> &crate::UnityEngine::UIElements::IPanelRenderer {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+UIElements+UIRRepaintUpdater")]
impl AsMut<crate::UnityEngine::UIElements::IPanelRenderer>
    for crate::UnityEngine::UIElements::UIRRepaintUpdater
{
    fn as_mut(&mut self) -> &mut crate::UnityEngine::UIElements::IPanelRenderer {
        unsafe { std::mem::transmute(self) }
    }
}
