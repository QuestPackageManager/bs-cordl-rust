...
for crate::UnityEngine::UIElements::PointerDownEvent {
    ...
    const CLASS_NAME: &'static str = "PointerDownEvent";
...
impl crate::UnityEngine::UIElements::PointerDownEvent {
    pub fn Init(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::PointerDownEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Init")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::PointerDownEvent as
