...
impl crate::UnityEngine::UIElements::PropagationPaths {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::PropagationPaths as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::PropagationPaths as
                    quest_hook::libil2cpp::Type > ::class(), "Build", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::PropagationPaths,
        > = unsafe { method.invoke_unchecked((), (elem, evt))? };
        Ok(__cordl_ret.into())
    }
