...
impl crate::UnityEngine::UIElements::MultiColumnTreeViewController {
    pub fn BindItem(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::MultiColumnTreeViewController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::MultiColumnTreeViewController as
