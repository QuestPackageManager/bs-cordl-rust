#[cfg(feature = "cordl_class_UnityEngine+UIElements+RuntimeEventDispatcher")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+RuntimeEventDispatcher")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::RuntimeEventDispatcher {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "RuntimeEventDispatcher";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+RuntimeEventDispatcher")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::RuntimeEventDispatcher {
