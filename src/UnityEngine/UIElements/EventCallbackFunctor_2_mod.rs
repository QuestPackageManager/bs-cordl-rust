...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+EventCallbackFunctor_2")]
unsafe impl<TEventType: quest_hook::libil2cpp::Type, TCallbackArgs: quest_hook::libil2cpp::Type>
...
impl<TEventType: quest_hook::libil2cpp::Type, TCallbackArgs: quest_hook::libil2cpp::Type>
    std::ops::Deref
    for crate::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType, TCallbackArgs>
{
    ...
    crate::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType, TCallbackArgs>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::UIElements::EventCallbackFunctor_2<
                            TEventType,
                            TCallbackArgs,
                        >,
                    >, 4usize>("GetPooled")
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (eventTypeId, callback, userArgs, invokePolicy))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
    ...
    pub fn UnregisterCallback(
        &mut self,
        target: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::CallbackEventHandler>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (target, useTrickleDown))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TCallbackArgs = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_userArgs(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TCallbackArgs), quest_hook::libil2cpp::Void, 1usize>(
                        "set_userArgs",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
