#[cfg(feature = "cordl_class_UnityEngine+UIElements+IKeyboardEvent")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+IKeyboardEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::IKeyboardEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "IKeyboardEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+IKeyboardEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::IKeyboardEvent {
