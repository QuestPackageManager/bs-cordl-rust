...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Experimental+Easing")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::Experimental::Easing {
...
impl crate::UnityEngine::UIElements::Experimental::Easing {
    ...
    pub fn InOutPower(t: f32, power: i32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (t, power))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Experimental+Easing")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::Experimental::Easing {
