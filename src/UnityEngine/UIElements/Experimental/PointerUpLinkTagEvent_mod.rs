    ...
    for crate::UnityEngine::UIElements::Experimental::PointerUpLinkTagEvent
{
    ...
    const CLASS_NAME: &'static str = "PointerUpLinkTagEvent";
...
impl std::ops::Deref for crate::UnityEngine::UIElements::Experimental::PointerUpLinkTagEvent {
...
#[cfg(feature = "UnityEngine+UIElements+Experimental+PointerUpLinkTagEvent")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::Experimental::PointerUpLinkTagEvent {
