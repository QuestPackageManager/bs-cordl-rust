...
pub struct UIRAtlasAllocator {
    ...
    pub m_FirstUnpartitionedArea:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode>,
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRAtlasAllocator")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIRAtlasAllocator {
...
impl crate::UnityEngine::UIElements::UIRAtlasAllocator {
    ...
    pub fn BuildAreas(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn TryAllocate(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (width, height, location))? };
        Ok(__cordl_ret.into())
    }
    pub fn TryPartitionArea(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (areaNode, rowIndex, rowHeight, minWidth))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (initialAtlasSize, maxAtlasSize, sidePadding))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_physicalHeight(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_physicalHeight")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_physicalWidth(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_physicalWidth")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_virtualHeight(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_virtualHeight")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_virtualWidth(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("set_virtualWidth")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRAtlasAllocator")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIRAtlasAllocator {
...
#[cfg(feature = "UnityEngine+UIElements+UIRAtlasAllocator")]
impl AsRef<crate::System::IDisposable> for crate::UnityEngine::UIElements::UIRAtlasAllocator {
    fn as_ref(&self) -> &crate::System::IDisposable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+UIElements+UIRAtlasAllocator")]
impl AsMut<crate::System::IDisposable> for crate::UnityEngine::UIElements::UIRAtlasAllocator {
...
pub struct UIRAtlasAllocator_AreaNode {
    ...
    pub previous:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode>,
    pub next: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRAtlasAllocator+AreaNode")]
...
impl crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode {
    ...
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::UnityEngine::RectInt), quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode,
                    >, 1usize>("Acquire")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode,
        > = unsafe { cordl_method_info.invoke_unchecked((), (rect))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddAfter(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode,
                    >), quest_hook::libil2cpp::Void, 1usize>("AddAfter")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (previous))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRAtlasAllocator+Row")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIRAtlasAllocator_Row {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
...
impl crate::UnityEngine::UIElements::UIRAtlasAllocator_Row {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::UIRAtlasAllocator_Row,
        > = unsafe { cordl_method_info.invoke_unchecked((), (offsetX, offsetY, width, height))? };
        Ok(__cordl_ret.into())
    }
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRAtlasAllocator+Row")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIRAtlasAllocator_Row {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
