...
impl crate::UnityEngine::UIElements::UIRAtlasAllocator {
    ...
    pub fn TryAllocate(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (width, height, location))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryPartitionArea(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (areaNode, rowIndex, rowHeight, minWidth))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode {
    ...
    pub fn AddAfter(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (previous))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::UnityEngine::UIElements::UIRAtlasAllocator_Row {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::UIElements::UIRAtlasAllocator_Row,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (offsetX, offsetY, width, height))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
