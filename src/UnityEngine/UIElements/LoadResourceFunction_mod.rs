...
impl crate::UnityEngine::UIElements::LoadResourceFunction {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::LoadResourceFunction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
