...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+LoadResourceFunction")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::LoadResourceFunction {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "LoadResourceFunction";
...
impl crate::UnityEngine::UIElements::LoadResourceFunction {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Object> = unsafe {
            cordl_method_info.invoke_unchecked(self, (pathName, _cordl_type, dpiScaling))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+LoadResourceFunction")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::LoadResourceFunction {
