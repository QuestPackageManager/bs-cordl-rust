...
for crate::UnityEngine::UIElements::MouseCaptureEventBase_1<T> {
    ...
    const CLASS_NAME: &'static str = "MouseCaptureEventBase`1";
...
> crate::UnityEngine::UIElements::MouseCaptureEventBase_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::MouseCaptureEventBase_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::MouseCaptureEventBase_1 < T > as
