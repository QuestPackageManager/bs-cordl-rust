    ...
    for crate::UnityEngine::UIElements::BaseUxmlFactory_2<TCreatedType, TTraits>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "BaseUxmlFactory`2")
                .unwrap()
...
impl<TCreatedType: quest_hook::libil2cpp::Type, TTraits: quest_hook::libil2cpp::Type>
    std::ops::Deref for crate::UnityEngine::UIElements::BaseUxmlFactory_2<TCreatedType, TTraits>
{
