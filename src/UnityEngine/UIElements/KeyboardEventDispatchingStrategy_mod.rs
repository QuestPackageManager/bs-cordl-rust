...
impl crate::UnityEngine::UIElements::KeyboardEventDispatchingStrategy {
    pub fn CanDispatchEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::KeyboardEventDispatchingStrategy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::KeyboardEventDispatchingStrategy as
