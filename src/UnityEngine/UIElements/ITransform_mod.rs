...
#[cfg(feature = "UnityEngine+UIElements+ITransform")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::ITransform {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "ITransform";
...
impl crate::UnityEngine::UIElements::ITransform {
    ...
    pub fn get_position(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::ITransform as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::UnityEngine::Vector3, 0usize>("get_position")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::ITransform as
