...
impl crate::UnityEngine::UIElements::ContextualMenuPopulateEvent {
    ...
    pub fn get_menu(
        ...
        *mut crate::UnityEngine::UIElements::DropdownMenu,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::UnityEngine::UIElements::DropdownMenu = __cordl_object
            .invoke("get_menu", ())?;
        Ok(__cordl_ret)
    }
    ...
    pub fn set_menu(
        &mut self,
        value: *mut crate::UnityEngine::UIElements::DropdownMenu,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
