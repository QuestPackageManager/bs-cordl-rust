...
pub struct TextEditingManipulator {
    ...
    pub m_EditingEventHandler:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::TextEditorEventHandler>,
    pub editingUtilities: quest_hook::libil2cpp::Gc<crate::UnityEngine::TextEditingUtilities>,
    pub m_TouchScreenTextFieldInitialized: bool,
    pub m_HardwareKeyboardPoller:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IVisualElementScheduledItem>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TextEditingManipulator")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::TextEditingManipulator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "TextEditingManipulator";
...
impl crate::UnityEngine::UIElements::TextEditingManipulator {
    ...
    pub fn OnFocusInEvent(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn OnFocusOutEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnFocusOutEvent")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_editingEventHandler")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_touchScreenTextFieldChanged(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_touchScreenTextFieldChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_editingEventHandler(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::TextEditorEventHandler>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TextEditingManipulator")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::TextEditingManipulator {
