    ...
    for crate::UnityEngine::UIElements::UxmlFloatAttributeDescription
{
    ...
    const CLASS_NAME: &'static str = "UxmlFloatAttributeDescription";
...
#[cfg(feature = "UnityEngine+UIElements+UxmlFloatAttributeDescription")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UxmlFloatAttributeDescription {
...
impl crate::UnityEngine::UIElements::UxmlFloatAttributeDescription {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        f32,
                    ), f32, 2usize>("ConvertValueToFloat")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
