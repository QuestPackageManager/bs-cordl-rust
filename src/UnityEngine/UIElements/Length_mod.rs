...
impl crate::UnityEngine::UIElements::Length {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "IsAuto",
                            0usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "IsNone",
                            0usize
                        )
                    })
            });
    ...
    pub fn get_unit(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::LengthUnit = unsafe {
...
for crate::UnityEngine::UIElements::Length_PropertyBag {
