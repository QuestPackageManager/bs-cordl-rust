...
for crate::UnityEngine::UIElements::Layout::LayoutManager {
...
impl crate::UnityEngine::UIElements::Layout::LayoutManager {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::Layout::LayoutNode = unsafe {
            cordl_method_info.invoke_unchecked(self, (configHandle))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::Layout::LayoutDataAccess = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
