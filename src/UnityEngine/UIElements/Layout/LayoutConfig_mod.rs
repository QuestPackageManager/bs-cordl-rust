...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::Layout::LayoutConfig {
    ...
    const CLASS_NAME: &'static str = "LayoutConfig";
...
#[cfg(feature = "UnityEngine+UIElements+Layout+LayoutConfig")]
impl crate::UnityEngine::UIElements::Layout::LayoutConfig {
    pub fn _ctor(
        &mut self,
