#[cfg(feature = "cordl_class_UnityEngine+UIElements+Layout+InvokeMeasureFunctionDelegate")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct InvokeMeasureFunctionDelegate {
    __cordl_parent: crate::System::MulticastDelegate,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Layout+InvokeMeasureFunctionDelegate")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::UIElements::Layout::InvokeMeasureFunctionDelegate
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements.Layout";
    const CLASS_NAME: &'static str = "InvokeMeasureFunctionDelegate";
...
#[cfg(feature = "UnityEngine+UIElements+Layout+InvokeMeasureFunctionDelegate")]
impl std::ops::Deref for crate::UnityEngine::UIElements::Layout::InvokeMeasureFunctionDelegate {
...
#[cfg(feature = "UnityEngine+UIElements+Layout+InvokeMeasureFunctionDelegate")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::Layout::InvokeMeasureFunctionDelegate {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+Layout+InvokeMeasureFunctionDelegate")]
impl crate::UnityEngine::UIElements::Layout::InvokeMeasureFunctionDelegate {
    pub fn Invoke(
        &mut self,
