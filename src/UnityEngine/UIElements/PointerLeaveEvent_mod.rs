#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerLeaveEvent")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerLeaveEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::PointerLeaveEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "PointerLeaveEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerLeaveEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::PointerLeaveEvent {
