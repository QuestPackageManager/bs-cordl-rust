#[cfg(feature = "cordl_class_UnityEngine+UIElements+NavigationCancelEvent")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+NavigationCancelEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::NavigationCancelEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "NavigationCancelEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+NavigationCancelEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::NavigationCancelEvent {
