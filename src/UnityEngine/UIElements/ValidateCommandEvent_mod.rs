...
for crate::UnityEngine::UIElements::ValidateCommandEvent {
    ...
    const CLASS_NAME: &'static str = "ValidateCommandEvent";
...
impl crate::UnityEngine::UIElements::ValidateCommandEvent {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::ValidateCommandEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::ValidateCommandEvent as
