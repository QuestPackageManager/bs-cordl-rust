...
for crate::UnityEngine::UIElements::DefaultDispatchingStrategy {
    ...
    const CLASS_NAME: &'static str = "DefaultDispatchingStrategy";
...
impl crate::UnityEngine::UIElements::DefaultDispatchingStrategy {
    pub fn CanDispatchEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::DefaultDispatchingStrategy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::DefaultDispatchingStrategy as
