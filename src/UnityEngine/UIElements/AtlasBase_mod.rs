...
impl crate::UnityEngine::UIElements::AtlasBase {
    ...
    pub fn ReturnAtlas(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ctx, src, atlas))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetDynamicTexture", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (id, texture))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TryGetAtlas(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (ctx, src, atlas, atlasRect))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
