#[cfg(feature = "cordl_class_UnityEngine+UIElements+AtlasBase")]
#[repr(C)]
#[derive(Debug)]
pub struct AtlasBase {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub textureRegistry: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::TextureRegistry>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+AtlasBase")]
...
impl crate::UnityEngine::UIElements::AtlasBase {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "RepaintTexturedElements", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn ReturnAtlas(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ctx, src, atlas))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetDynamicTexture(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("SetDynamicTexture")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (id, texture))? };
        Ok(__cordl_ret.into())
    }
    pub fn TryGetAtlas(
        &mut self,
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (ctx, src, atlas, atlasRect))? };
        Ok(__cordl_ret.into())
    }
