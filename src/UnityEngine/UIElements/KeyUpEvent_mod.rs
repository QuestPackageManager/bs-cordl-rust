...
#[cfg(feature = "UnityEngine+UIElements+KeyUpEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::KeyUpEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "KeyUpEvent";
...
#[cfg(feature = "UnityEngine+UIElements+KeyUpEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::KeyUpEvent {
