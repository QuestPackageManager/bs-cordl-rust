...
impl crate::UnityEngine::UIElements::UxmlDoubleAttributeDescription {
    pub fn ConvertValueToDouble(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlDoubleAttributeDescription as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlDoubleAttributeDescription as
                    quest_hook::libil2cpp::Type > ::class(), "ConvertValueToDouble",
                    2usize
                )
            });
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: f64 = unsafe { method.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
