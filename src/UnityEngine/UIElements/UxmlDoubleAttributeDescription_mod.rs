#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlDoubleAttributeDescription")]
#[repr(C)]
    ...
    for crate::UnityEngine::UIElements::UxmlDoubleAttributeDescription
{
    ...
    const CLASS_NAME: &'static str = "UxmlDoubleAttributeDescription";
...
#[cfg(feature = "UnityEngine+UIElements+UxmlDoubleAttributeDescription")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UxmlDoubleAttributeDescription {
...
impl crate::UnityEngine::UIElements::UxmlDoubleAttributeDescription {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        f64,
                    ), f64, 2usize>("ConvertValueToDouble")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
