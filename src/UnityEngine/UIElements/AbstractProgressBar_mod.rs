...
pub struct AbstractProgressBar {
    ...
    pub m_Progress: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+AbstractProgressBar")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::AbstractProgressBar {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "AbstractProgressBar";
...
impl crate::UnityEngine::UIElements::AbstractProgressBar {
    ...
    pub fn CalculateProgressWidth(&mut self, width: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (width))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetProgress(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("SetProgress")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+AbstractProgressBar")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::AbstractProgressBar {
...
impl AsMut<crate::UnityEngine::UIElements::INotifyValueChanged_1<f32>>
    for crate::UnityEngine::UIElements::AbstractProgressBar
{
    fn as_mut(&mut self) -> &mut crate::UnityEngine::UIElements::INotifyValueChanged_1<f32> {
        unsafe { std::mem::transmute(self) }
    }
}
    ...
    for crate::UnityEngine::UIElements::AbstractProgressBar_UxmlTraits
{
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "AbstractProgressBar/UxmlTraits";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+UIElements+AbstractProgressBar+UxmlTraits")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::AbstractProgressBar_UxmlTraits {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
