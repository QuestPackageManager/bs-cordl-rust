...
pub struct TreeDataController_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_NodeStack: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::Stack_1<crate::Unity::Hierarchy::HierarchyNode>,
    >,
...
#[cfg(feature = "UnityEngine+UIElements+TreeDataController_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::TreeDataController_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (list, createNode, updateDictionary))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::Unity::Hierarchy::HierarchyNode), T, 1usize>(
                        "GetDataForNode",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (node, item))? };
        Ok(__cordl_ret.into())
    }
