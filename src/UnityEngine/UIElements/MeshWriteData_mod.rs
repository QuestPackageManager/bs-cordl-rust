...
for crate::UnityEngine::UIElements::MeshWriteData {
    ...
    const CLASS_NAME: &'static str = "MeshWriteData";
...
impl crate::UnityEngine::UIElements::MeshWriteData {
    ...
    pub fn Reset_NativeSlice_1_NativeSlice_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (vertices, indices))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Reset_Rect1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (vertices, indices, uvRegion))?
        };
        Ok(__cordl_ret.into())
    }
