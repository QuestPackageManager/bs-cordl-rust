...
> crate::UnityEngine::UIElements::EventCallback_1<TEventType> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::EventCallback_1<
            TEventType,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(TEventType), quest_hook::libil2cpp::Void, 1usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::EventCallback_1 < TEventType > as
