...
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::UIElements::PropertyBag_Rotate_AngleProperty
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "Rotate/PropertyBag/AngleProperty";
...
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AngleProperty")]
impl std::ops::Deref for crate::UnityEngine::UIElements::PropertyBag_Rotate_AngleProperty {
...
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AngleProperty")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::PropertyBag_Rotate_AngleProperty {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AngleProperty")]
impl crate::UnityEngine::UIElements::PropertyBag_Rotate_AngleProperty {
    pub fn GetValue(
        &mut self,
        container: quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::UIElements::Rotate>,
    ...
    pub fn SetValue(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::UIElements::Rotate>,
                        crate::UnityEngine::UIElements::Angle,
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Rotate+PropertyBag+AxisProperty")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::UIElements::PropertyBag_Rotate_AxisProperty
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "Rotate/PropertyBag/AxisProperty";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AxisProperty")]
impl std::ops::Deref for crate::UnityEngine::UIElements::PropertyBag_Rotate_AxisProperty {
    type Target = crate::Unity::Properties::Property_2<
        crate::UnityEngine::UIElements::Rotate,
        crate::UnityEngine::Vector3,
    >;
...
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AxisProperty")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::PropertyBag_Rotate_AxisProperty {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AxisProperty")]
impl crate::UnityEngine::UIElements::PropertyBag_Rotate_AxisProperty {
    pub fn GetValue(
        &mut self,
        container: quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::UIElements::Rotate>,
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Rotate")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::UIElements::Rotate {
    type Type = Self;
...
impl crate::UnityEngine::UIElements::Rotate {
    #[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag")]
    pub type PropertyBag = crate::UnityEngine::UIElements::Rotate_PropertyBag;
    ...
    pub fn Equals_Rotate0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::UIElements::Rotate), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Initial() -> quest_hook::libil2cpp::Result<crate::UnityEngine::UIElements::Rotate> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn None() -> quest_hook::libil2cpp::Result<crate::UnityEngine::UIElements::Rotate> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn ToQuaternion(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Quaternion, 0usize>("ToQuaternion")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor_Angle0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (angle))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_angle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::Angle, 0usize>("get_angle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::UIElements::Rotate> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+UIElements+Rotate")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Rotate+PropertyBag")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::Rotate_PropertyBag {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "Rotate/PropertyBag";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag")]
impl std::ops::Deref for crate::UnityEngine::UIElements::Rotate_PropertyBag {
    type Target =
        crate::Unity::Properties::ContainerPropertyBag_1<crate::UnityEngine::UIElements::Rotate>;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
...
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::Rotate_PropertyBag {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag")]
impl crate::UnityEngine::UIElements::Rotate_PropertyBag {
    #[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AngleProperty")]
    pub type AngleProperty = crate::UnityEngine::UIElements::PropertyBag_Rotate_AngleProperty;
    #[cfg(feature = "UnityEngine+UIElements+Rotate+PropertyBag+AxisProperty")]
    pub type AxisProperty = crate::UnityEngine::UIElements::PropertyBag_Rotate_AxisProperty;
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Rotate+PropertyBag")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::Rotate_PropertyBag {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
