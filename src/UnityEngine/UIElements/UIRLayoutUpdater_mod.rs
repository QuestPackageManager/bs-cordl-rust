#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRLayoutUpdater")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRLayoutUpdater")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIRLayoutUpdater {
...
impl crate::UnityEngine::UIElements::UIRLayoutUpdater {
    pub fn DispatchChangeEvents(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (changeEvents, currentLayoutPass))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateHierarchyDisplayed(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        bool,
                    ), bool, 3usize>("UpdateHierarchyDisplayed")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (ve, changeEvents, inheritedDisplayed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateSubTree(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("UpdateSubTree")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (ve, changeEvents))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIRLayoutUpdater")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIRLayoutUpdater {
