#[cfg(feature = "cordl_class_UnityEngine+UIElements+HierarchyEvent")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+HierarchyEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::HierarchyEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "HierarchyEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+HierarchyEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::HierarchyEvent {
