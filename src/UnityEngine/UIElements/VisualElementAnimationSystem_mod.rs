#[cfg(feature = "cordl_class_UnityEngine+UIElements+VisualElementAnimationSystem")]
#[repr(C)]
    ...
    for crate::UnityEngine::UIElements::VisualElementAnimationSystem
{
    ...
    const CLASS_NAME: &'static str = "VisualElementAnimationSystem";
...
#[cfg(feature = "UnityEngine+UIElements+VisualElementAnimationSystem")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::VisualElementAnimationSystem {
...
impl crate::UnityEngine::UIElements::VisualElementAnimationSystem {
    ...
    pub fn RegisterAnimation(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::UIElements::Experimental::IValueAnimationUpdate,
                    >), quest_hook::libil2cpp::Void, 1usize>("RegisterAnimation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (anim))? };
        Ok(__cordl_ret.into())
    }
    pub fn RegisterAnimations(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (anims))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_stylePropertyAnimationProfilerMarker(
    ) -> quest_hook::libil2cpp::Result<crate::Unity::Profiling::ProfilerMarker> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::Unity::Profiling::ProfilerMarker, 0usize>(
