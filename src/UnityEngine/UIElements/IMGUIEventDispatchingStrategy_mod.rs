...
for crate::UnityEngine::UIElements::IMGUIEventDispatchingStrategy {
    ...
    const CLASS_NAME: &'static str = "IMGUIEventDispatchingStrategy";
...
impl crate::UnityEngine::UIElements::IMGUIEventDispatchingStrategy {
    pub fn CanDispatchEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IMGUIEventDispatchingStrategy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::IMGUIEventDispatchingStrategy as
                    quest_hook::libil2cpp::Type > ::class(), "CanDispatchEvent", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IMGUIEventDispatchingStrategy as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::IMGUIEventDispatchingStrategy as
                    quest_hook::libil2cpp::Type > ::class(), "DispatchEvent", 2usize
                )
            });
