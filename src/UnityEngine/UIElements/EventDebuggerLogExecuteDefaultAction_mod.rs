...
for crate::UnityEngine::UIElements::EventDebuggerLogExecuteDefaultAction {
    ...
    const CLASS_NAME: &'static str = "EventDebuggerLogExecuteDefaultAction";
...
impl crate::UnityEngine::UIElements::EventDebuggerLogExecuteDefaultAction {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::EventDebuggerLogExecuteDefaultAction as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::EventDebuggerLogExecuteDefaultAction
