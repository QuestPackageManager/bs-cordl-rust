#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlStyleTraits")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlStyleTraits")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UxmlStyleTraits {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "UxmlStyleTraits";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UxmlStyleTraits")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UxmlStyleTraits {
