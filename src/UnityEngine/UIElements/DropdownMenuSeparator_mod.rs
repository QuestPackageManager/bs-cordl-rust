...
pub struct DropdownMenuSeparator {
    ...
    pub _subMenuPath_k__BackingField:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DropdownMenuSeparator")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::DropdownMenuSeparator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "DropdownMenuSeparator";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DropdownMenuSeparator")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::DropdownMenuSeparator {
