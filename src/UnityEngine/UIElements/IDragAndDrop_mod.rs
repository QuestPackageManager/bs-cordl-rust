#[cfg(feature = "cordl_class_UnityEngine+UIElements+IDragAndDrop")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+IDragAndDrop")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::IDragAndDrop {
...
impl crate::UnityEngine::UIElements::IDragAndDrop {
    pub fn AcceptDrag(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetVisualMode", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (visualMode))? };
        Ok(__cordl_ret.into())
    }
    pub fn StartDrag(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("StartDrag")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (args, pointerPosition))? };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateDrag(
        &mut self,
