...
for crate::UnityEngine::UIElements::UxmlObjectListAttributeDescription_1<T> {
    ...
    const CLASS_NAME: &'static str = "UxmlObjectListAttributeDescription`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        ...
                        "UxmlObjectListAttributeDescription`1",
                    )
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
...
> crate::UnityEngine::UIElements::UxmlObjectListAttributeDescription_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlObjectListAttributeDescription_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    < T > as quest_hook::libil2cpp::Type > ::class(), "GetValueFromBag",
                    2usize
                )
            });
