...
impl crate::UnityEngine::UIElements::ReusableMultiColumnTreeViewItem {
    pub fn Init_Columns1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::ReusableMultiColumnTreeViewItem as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::ReusableMultiColumnTreeViewItem as
                    quest_hook::libil2cpp::Type > ::class(), "Init", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (container, columns))?
        };
        Ok(__cordl_ret.into())
    }
