#[cfg(feature = "cordl_class_UnityEngine+UIElements+INotifyValueChanged_1")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "UnityEngine+UIElements+INotifyValueChanged_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::INotifyValueChanged_1<T> {
