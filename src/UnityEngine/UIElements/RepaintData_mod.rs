...
pub struct RepaintData {
    ...
    pub _repaintEvent_k__BackingField: quest_hook::libil2cpp::Gc<crate::UnityEngine::Event>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+RepaintData")]
...
impl crate::UnityEngine::UIElements::RepaintData {
    ...
    pub fn get_currentOffset(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Matrix4x4, 0usize>("get_currentOffset")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
