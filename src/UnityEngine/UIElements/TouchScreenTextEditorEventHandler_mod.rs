...
impl std::ops::Deref for crate::UnityEngine::UIElements::TouchScreenTextEditorEventHandler {
...
#[cfg(feature = "UnityEngine+UIElements+TouchScreenTextEditorEventHandler")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::TouchScreenTextEditorEventHandler {
...
impl crate::UnityEngine::UIElements::TouchScreenTextEditorEventHandler {
    ...
    pub fn New(
        ...
        editingUtilities: quest_hook::libil2cpp::Gc<crate::UnityEngine::TextEditingUtilities>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (textElement, editingUtilities))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_Frame(value: i64) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i64), quest_hook::libil2cpp::Void, 1usize>("set_Frame")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
