...
#[cfg(feature = "UnityEngine+UIElements+EventInterestReflectionUtils")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::EventInterestReflectionUtils {
...
impl crate::UnityEngine::UIElements::EventInterestReflectionUtils {
    #[cfg(feature = "UnityEngine+UIElements+EventInterestReflectionUtils+DefaultEventInterests")]
    pub type DefaultEventInterests =
        crate::UnityEngine::UIElements::EventInterestReflectionUtils_DefaultEventInterests;
    pub fn ComputeDefaultEventInterests(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), i32, 2usize>("ComputeDefaultEventInterests")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (elementType, methodName))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetEventCategory(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::EventCategory =
            unsafe { cordl_method_info.invoke_unchecked((), (eventType))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+EventInterestReflectionUtils")]
