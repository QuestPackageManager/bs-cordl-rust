...
for crate::UnityEngine::UIElements::UxmlAttributeOverridesFactory {
    ...
    const CLASS_NAME: &'static str = "UxmlAttributeOverridesFactory";
...
impl crate::UnityEngine::UIElements::UxmlAttributeOverridesFactory {
    pub fn Create(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlAttributeOverridesFactory as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlAttributeOverridesFactory as
