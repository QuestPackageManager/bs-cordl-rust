...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerMoveEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::PointerMoveEvent {
...
impl crate::UnityEngine::UIElements::PointerMoveEvent {
    ...
    pub fn get_isPointerUp(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_isPointerUp")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerMoveEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::PointerMoveEvent {
