...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::UnityEngine::UIElements::PointerMoveEvent =>
...
impl crate::UnityEngine::UIElements::PointerMoveEvent {
    ...
    pub fn get_isHandledByDraggable(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = __cordl_object.invoke("get_isHandledByDraggable", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn set_isHandledByDraggable(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("set_isHandledByDraggable", (value))?;
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "UnityEngine+UIElements+PointerMoveEvent")]
