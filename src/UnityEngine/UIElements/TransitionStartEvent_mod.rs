...
for crate::UnityEngine::UIElements::TransitionStartEvent {
    ...
    const CLASS_NAME: &'static str = "TransitionStartEvent";
...
impl crate::UnityEngine::UIElements::TransitionStartEvent {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::TransitionStartEvent as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::TransitionStartEvent as
