...
for crate::UnityEngine::UIElements::SavePersistentViewData {
    ...
    const CLASS_NAME: &'static str = "SavePersistentViewData";
...
impl crate::UnityEngine::UIElements::SavePersistentViewData {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::SavePersistentViewData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::SavePersistentViewData as
