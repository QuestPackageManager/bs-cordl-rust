#[cfg(feature = "cordl_class_UnityEngine+UIElements+DragAndDropUtility")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DragAndDropUtility")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::DragAndDropUtility {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetDragAndDrop", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IDragAndDrop> =
            unsafe { cordl_method_info.invoke_unchecked((), (panel))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DragAndDropUtility")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::DragAndDropUtility {
