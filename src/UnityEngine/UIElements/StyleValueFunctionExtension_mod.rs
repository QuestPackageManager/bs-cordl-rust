...
for crate::UnityEngine::UIElements::StyleValueFunctionExtension {
    ...
    const CLASS_NAME: &'static str = "StyleValueFunctionExtension";
...
impl crate::UnityEngine::UIElements::StyleValueFunctionExtension {
    pub fn ToUssString(
        svf: crate::UnityEngine::UIElements::StyleValueFunction,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::StyleValueFunctionExtension as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::StyleValueFunctionExtension as
                    quest_hook::libil2cpp::Type > ::class(), "ToUssString", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (svf))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "UnityEngine+UIElements+StyleValueFunctionExtension")]
