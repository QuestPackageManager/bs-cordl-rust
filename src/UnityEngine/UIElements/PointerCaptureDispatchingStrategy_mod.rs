...
for crate::UnityEngine::UIElements::PointerCaptureDispatchingStrategy {
    ...
    const CLASS_NAME: &'static str = "PointerCaptureDispatchingStrategy";
...
impl crate::UnityEngine::UIElements::PointerCaptureDispatchingStrategy {
    pub fn CanDispatchEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::PointerCaptureDispatchingStrategy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::PointerCaptureDispatchingStrategy as
