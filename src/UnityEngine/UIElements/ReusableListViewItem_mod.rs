...
impl crate::UnityEngine::UIElements::ReusableListViewItem {
    ...
    pub fn Init(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (item, usesAnimatedDragger))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateDragHandle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (needsDragHandle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateHierarchy(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (root, item, usesAnimatedDragger))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
