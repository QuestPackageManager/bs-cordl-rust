...
impl crate::UnityEngine::UIElements::BackgroundRepeat {
    pub fn Equals_BackgroundRepeat1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::BackgroundRepeat as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::BackgroundRepeat as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (repeatX, repeatY))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn op_Equality(
