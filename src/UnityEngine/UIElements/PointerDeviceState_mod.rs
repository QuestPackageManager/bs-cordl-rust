...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerDeviceState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::PointerDeviceState {
...
impl crate::UnityEngine::UIElements::PointerDeviceState {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IPanel> =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerId, contextType))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IPanel> =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetPressedButtons(pointerId: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (pointerId))? };
        Ok(__cordl_ret.into())
    }
    pub fn HasAdditionalPressedButtons(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32, i32), bool, 2usize>("HasAdditionalPressedButtons")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerId, exceptButtonId))? };
        Ok(__cordl_ret.into())
    }
    pub fn HasFlagFast(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (flagSet, flag))? };
        Ok(__cordl_ret.into())
    }
    pub fn HasLocationFlag(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerId, contextType, flag))? };
        Ok(__cordl_ret.into())
    }
    pub fn PressButton(
        pointerId: i32,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerId, buttonId))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SavePointerPosition(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId, position, panel, contextType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetPlayerPanelWithSoftPointerCapture(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerId, panel))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+PointerDeviceState")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::PointerDeviceState {
...
pub struct PointerDeviceState_PointerLocation {
    ...
    pub _Panel_k__BackingField: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IPanel>,
...
impl crate::UnityEngine::UIElements::PointerDeviceState_PointerLocation {
    pub fn SetLocation(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::UnityEngine::Vector2,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IPanel>,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetLocation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (position, panel))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Flags(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::PointerDeviceState_LocationFlag =
