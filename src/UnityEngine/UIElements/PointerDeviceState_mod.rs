...
impl crate::UnityEngine::UIElements::PointerDeviceState {
    ...
    pub fn GetPointerPosition(
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId, contextType))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetPressedButtons", 1usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HasAdditionalPressedButtons(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId, exceptButtonId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HasFlagFast(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (flagSet, flag))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HasLocationFlag", 3usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId, contextType, flag))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn PressButton(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId, buttonId))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SavePointerPosition", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (pointerId, position, panel, contextType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetPlayerPanelWithSoftPointerCapture(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (pointerId, panel))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::UnityEngine::UIElements::PointerDeviceState_PointerLocation {
    pub fn SetLocation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (position, panel))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Flags(
