...
pub struct RuntimeUIElementsBridge {
    __cordl_parent: crate::UnityEngine::UIElements::UIElementsBridge,
}
#[cfg(feature = "UnityEngine+UIElements+RuntimeUIElementsBridge")]
...
for crate::UnityEngine::UIElements::RuntimeUIElementsBridge {
    ...
    const CLASS_NAME: &'static str = "RuntimeUIElementsBridge";
...
impl crate::UnityEngine::UIElements::RuntimeUIElementsBridge {
    ...
    pub fn SetWantsMouseJumping(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::RuntimeUIElementsBridge as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::RuntimeUIElementsBridge as
                    quest_hook::libil2cpp::Type > ::class(), "SetWantsMouseJumping",
                    1usize
                )
            });
