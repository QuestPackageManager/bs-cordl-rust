...
#[cfg(feature = "UnityEngine+UIElements+UIElementsRuntimeUtilityNative")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UIElementsRuntimeUtilityNative {
...
impl crate::UnityEngine::UIElements::UIElementsRuntimeUtilityNative {
    ...
    pub fn VisualElementCreation() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
