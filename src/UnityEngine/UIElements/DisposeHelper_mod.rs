#[cfg(feature = "cordl_class_UnityEngine+UIElements+DisposeHelper")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DisposeHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::DisposeHelper {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "NotifyDisposedUsed", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (disposable))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DisposeHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::DisposeHelper {
