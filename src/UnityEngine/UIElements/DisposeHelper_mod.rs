...
impl crate::UnityEngine::UIElements::DisposeHelper {
    pub fn NotifyDisposedUsed(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::DisposeHelper as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::DisposeHelper as
                    quest_hook::libil2cpp::Type > ::class(), "NotifyDisposedUsed", 1usize
                )
            });
