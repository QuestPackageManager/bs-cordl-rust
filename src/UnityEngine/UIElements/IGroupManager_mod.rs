#[cfg(feature = "cordl_class_UnityEngine+UIElements+IGroupManager")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+IGroupManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::IGroupManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "IGroupManager";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+IGroupManager")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::IGroupManager {
