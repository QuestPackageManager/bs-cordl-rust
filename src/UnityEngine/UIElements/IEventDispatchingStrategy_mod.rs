...
impl crate::UnityEngine::UIElements::IEventDispatchingStrategy {
    pub fn CanDispatchEvent(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::IEventDispatchingStrategy as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::IEventDispatchingStrategy as
