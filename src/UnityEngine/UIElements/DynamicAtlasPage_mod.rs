...
impl crate::UnityEngine::UIElements::DynamicAtlasPage {
    ...
    pub fn TryAdd(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (image, alloc, rect))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (image, rect))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (format, filterMode, minSize, maxSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_atlas(
