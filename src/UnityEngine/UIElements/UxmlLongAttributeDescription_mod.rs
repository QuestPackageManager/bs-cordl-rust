...
#[cfg(feature = "UnityEngine+UIElements+UxmlLongAttributeDescription")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UxmlLongAttributeDescription {
...
impl crate::UnityEngine::UIElements::UxmlLongAttributeDescription {
    ...
    pub fn GetValueFromBag(
        ...
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, (bag, cc))? };
        Ok(__cordl_ret.into())
    }
