#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleScale")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleScale")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::UIElements::StyleScale {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleScale")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::UIElements::StyleScale {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleScale")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::UIElements::StyleScale {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleScale")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::UIElements::StyleScale {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleScale")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::UIElements::StyleScale {
    type Type = Self;
...
impl crate::UnityEngine::UIElements::StyleScale {
    ...
    pub fn _ctor_Scale_StyleKeyword2(
        &mut self,
        v: crate::UnityEngine::UIElements::Scale,
    ...
    pub fn get_value(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::Scale, 0usize>("get_value")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::UIElements::StyleScale> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+UIElements+StyleScale")]
...
#[cfg(feature = "UnityEngine+UIElements+StyleScale")]
impl AsRef<crate::UnityEngine::UIElements::IStyleValue_1<crate::UnityEngine::UIElements::Scale>>
    for crate::UnityEngine::UIElements::StyleScale
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+UIElements+StyleScale")]
impl AsMut<crate::UnityEngine::UIElements::IStyleValue_1<crate::UnityEngine::UIElements::Scale>>
    for crate::UnityEngine::UIElements::StyleScale
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::UnityEngine::UIElements::IStyleValue_1<crate::UnityEngine::UIElements::Scale>
    {
        todo!()
    }
}
