#[cfg(feature = "cordl_class_UnityEngine+UIElements+CommandEventBase_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::UnityEngine::UIElements::CommandEventBase_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "CommandEventBase`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+UIElements+CommandEventBase_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::CommandEventBase_1<T> {
    pub fn Dispatch(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked((), (commandName))? };
        Ok(__cordl_ret.into())
    }
