...
impl crate::UnityEngine::UIElements::UxmlAttributeDescription {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetValueFromBag", 4usize
                        )
                    })
            });
        let __cordl_ret: T = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bag, cc, converterFunc, defaultValue))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryGetValueFromBagAsString(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (bag, cc, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
