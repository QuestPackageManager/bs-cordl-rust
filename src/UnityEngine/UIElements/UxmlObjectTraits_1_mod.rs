    ...
    for crate::UnityEngine::UIElements::UxmlObjectTraits_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "UxmlObjectTraits`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+UIElements+UxmlObjectTraits_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UxmlObjectTraits_1<T> {
    pub fn Init(
        &mut self,
