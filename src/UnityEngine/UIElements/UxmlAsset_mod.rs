...
pub struct UxmlAsset {
    ...
    pub m_XmlNamespace: crate::UnityEngine::UIElements::UxmlNamespaceDefinition,
    pub m_Id: i32,
    pub m_OrderInDocument: i32,
    pub m_ParentId: i32,
    pub m_NamespaceDefinitions: quest_hook::libil2cpp::Gc<
...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UxmlAsset {
    ...
    const CLASS_NAME: &'static str = "UxmlAsset";
...
impl crate::UnityEngine::UIElements::UxmlAsset {
    pub const NullNodeType: &'static str = "null";
    pub fn New(
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (fullTypeName, xmlNamespace))?;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "RemoveAttribute", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (attributeName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetAttribute(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetOrAddProperty", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (propertyName, propertyValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TryGetAttributeValue", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (propertyName, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (fullTypeName, xmlNamespace))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_orderInDocument(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_orderInDocument")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_orderInDocument", 0usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
