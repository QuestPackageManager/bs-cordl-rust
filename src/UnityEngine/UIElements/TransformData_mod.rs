#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::TransformData {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::UIElements::TransformData {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::UIElements::TransformData {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::UIElements::TransformData {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::UIElements::TransformData {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TransformData")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::UIElements::TransformData {
    type Type = Self;
...
impl crate::UnityEngine::UIElements::TransformData {
    pub fn Copy(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::TransformData, 0usize>(
                        "Copy",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::TransformData =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn CopyFrom(
        &mut self,
        other: quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::UIElements::TransformData>,
    ...
    pub fn Equals_TransformData0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::UIElements::TransformData), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    for crate::UnityEngine::UIElements::TransformData
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::UnityEngine::UIElements::TransformData> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+UIElements+TransformData")]
