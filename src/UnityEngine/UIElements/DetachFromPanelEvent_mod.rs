#[cfg(feature = "cordl_class_UnityEngine+UIElements+DetachFromPanelEvent")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DetachFromPanelEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::DetachFromPanelEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "DetachFromPanelEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+DetachFromPanelEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::DetachFromPanelEvent {
