#[cfg(feature = "cordl_class_UnityEngine+UIElements+DefaultMultiColumnTreeViewController_1")]
#[repr(C)]
...
pub struct DefaultMultiColumnTreeViewController_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_TreeDataController:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::TreeDataController_1<T>>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IList_1<
                            crate::UnityEngine::UIElements::TreeViewItemData_1<T>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetRootItems")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (i32, crate::Unity::Hierarchy::HierarchyNode),
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<SetRootItems>b__7_1", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (id, node))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
