...
for crate::UnityEngine::UIElements::WorldSpaceDataStore {
...
impl crate::UnityEngine::UIElements::WorldSpaceDataStore {
    pub fn GetWorldSpaceData(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::WorldSpaceData = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetWorldSpaceData", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (ve, data))?
        };
        Ok(__cordl_ret.into())
    }
}
