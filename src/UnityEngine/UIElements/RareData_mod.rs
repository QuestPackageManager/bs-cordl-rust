...
impl crate::UnityEngine::UIElements::RareData {
    pub fn Copy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::RareData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::UnityEngine::UIElements::RareData, 0usize>("Copy")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::RareData as
