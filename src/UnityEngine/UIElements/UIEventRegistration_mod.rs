#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIEventRegistration")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIEventRegistration")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIEventRegistration {
...
impl crate::UnityEngine::UIElements::UIEventRegistration {
    ...
    pub fn ProcessEvent(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32, crate::System::IntPtr), bool, 2usize>(
                        "ProcessEvent",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (instanceID, nativeEventPtr))? };
        Ok(__cordl_ret.into())
    }
    pub fn RegisterUIElementSystem(
        utility: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::IUIElementsUtility>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "RegisterUIElementSystem", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (utility))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReleaseCapture() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("ReleaseCapture")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIEventRegistration")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIEventRegistration {
