...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TimerEventScheduler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::TimerEventScheduler {
...
impl crate::UnityEngine::UIElements::TimerEventScheduler {
    ...
    pub fn PrivateUnSchedule(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (sItem))? };
        Ok(__cordl_ret.into())
    }
    pub fn RemovedScheduledItemAt(&mut self, index: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn UpdateScheduledEvents(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("UpdateScheduledEvents")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+TimerEventScheduler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::TimerEventScheduler {
