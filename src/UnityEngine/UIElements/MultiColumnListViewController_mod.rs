    ...
    for crate::UnityEngine::UIElements::MultiColumnListViewController
{
    ...
    const CLASS_NAME: &'static str = "MultiColumnListViewController";
...
#[cfg(feature = "UnityEngine+UIElements+MultiColumnListViewController")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::MultiColumnListViewController {
...
impl crate::UnityEngine::UIElements::MultiColumnListViewController {
    ...
    pub fn PrepareView(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
