...
impl crate::UnityEngine::UIElements::UIR::GradientSettingsAtlas {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Commit",
                            0usize
                        )
                    })
            });
    ...
    pub fn Write(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (alloc, settings, remap))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::UnityEngine::UIElements::UIR::GradientSettingsAtlas_RawTexture {
    pub fn WriteRawFloat4Packed(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (f0, f1, f2, f3, destX, destY))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteRawInt2Packed", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (v0, v1, destX, destY))?
        };
        Ok(__cordl_ret.into())
    }
}
