...
impl crate::UnityEngine::UIElements::UIR::TextureBlitter {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "DoBlit",
                            2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (blitInfos, startIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndBlit(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "EndBlit",
                            0usize
                        )
                    })
            });
    ...
    pub fn QueueBlit(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (src, srcRect, dstPos, addBorder, tint))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
