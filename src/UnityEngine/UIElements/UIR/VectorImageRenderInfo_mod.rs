...
for crate::UnityEngine::UIElements::UIR::VectorImageRenderInfo {
    ...
    const CLASS_NAME: &'static str = "VectorImageRenderInfo";
...
#[cfg(feature = "UnityEngine+UIElements+UIR+VectorImageRenderInfo")]
impl crate::UnityEngine::UIElements::UIR::VectorImageRenderInfo {
    ...
    pub fn Reset(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UIR::VectorImageRenderInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Reset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UIR::VectorImageRenderInfo as
