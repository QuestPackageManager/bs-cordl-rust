...
for crate::UnityEngine::UIElements::UIR::GradientRemapPool {
    ...
    const CLASS_NAME: &'static str = "GradientRemapPool";
...
impl crate::UnityEngine::UIElements::UIR::GradientRemapPool {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UIR::GradientRemapPool as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UIR::GradientRemapPool as
