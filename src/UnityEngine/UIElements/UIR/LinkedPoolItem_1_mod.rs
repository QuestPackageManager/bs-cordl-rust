...
for crate::UnityEngine::UIElements::UIR::LinkedPoolItem_1<T> {
    ...
    const CLASS_NAME: &'static str = "LinkedPoolItem`1";
...
> crate::UnityEngine::UIElements::UIR::LinkedPoolItem_1<T> {
    ...
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UIR::LinkedPoolItem_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UIR::LinkedPoolItem_1 < T > as
