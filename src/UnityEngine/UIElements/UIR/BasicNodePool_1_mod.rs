    ...
    for crate::UnityEngine::UIElements::UIR::BasicNodePool_1<T>
{
    ...
    const CLASS_NAME: &'static str = "BasicNodePool`1";
...
#[cfg(feature = "UnityEngine+UIElements+UIR+BasicNodePool_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UIR::BasicNodePool_1<T> {
    ...
    pub fn Reset(
        node: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::BasicNode_1<T>>,
