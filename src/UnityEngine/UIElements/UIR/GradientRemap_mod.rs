...
pub struct GradientRemap {
    ...
    pub next: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::GradientRemap>,
    pub atlas: crate::UnityEngine::UIElements::TextureId,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+GradientRemap")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIR::GradientRemap {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements.UIR";
    const CLASS_NAME: &'static str = "GradientRemap";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+GradientRemap")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIR::GradientRemap {
