#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+GPUBufferAllocator")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct GPUBufferAllocator {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub m_Low: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::BestFitAllocator>,
    pub m_High: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::BestFitAllocator>,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+GPUBufferAllocator")]
    ...
    for crate::UnityEngine::UIElements::UIR::GPUBufferAllocator
{
    ...
    const CLASS_NAME: &'static str = "GPUBufferAllocator";
...
impl crate::UnityEngine::UIElements::UIR::GPUBufferAllocator {
    pub fn Allocate(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u32, bool), crate::UnityEngine::UIElements::UIR::Alloc, 2usize>(
                        "Allocate",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::UIR::Alloc =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_size, shortLived))? };
        Ok(__cordl_ret.into())
    }
    pub fn Free(
        &mut self,
    ...
    pub fn HighLowCollide(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("HighLowCollide")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn New(maxSize: u32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+GPUBufferAllocator")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIR::GPUBufferAllocator {
