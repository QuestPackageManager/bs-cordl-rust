...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+EntryPool")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::UIR::EntryPool {
...
impl crate::UnityEngine::UIElements::UIR::EntryPool {
    ...
    pub fn New(maxCapacity: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (maxCapacity))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+EntryPool")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIR::EntryPool {
