...
pub struct RenderChainCommand {
    ...
    pub prev: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::RenderChainCommand>,
    pub next: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::RenderChainCommand>,
    pub isTail: bool,
...
impl crate::UnityEngine::UIElements::UIR::RenderChainCommand {
    pub fn Blit(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (source, destination, depth))? };
        Ok(__cordl_ret.into())
    }
    pub fn CombineScissorRects(
        ...
        let __cordl_ret: crate::UnityEngine::Rect =
            unsafe { cordl_method_info.invoke_unchecked((), (r0, r1))? };
        Ok(__cordl_ret.into())
    }
    pub fn ExecuteNonDrawMesh(
        &mut self,
        drawParams: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::DrawParams>,
        pixelsPerPoint: f32,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::DrawParams>,
                        f32,
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<crate::System::Exception>,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("ExecuteNonDrawMesh")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (drawParams, pixelsPerPoint, immediateException))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RectPointsToPixelsAndFlipYAxis(
        ...
        let __cordl_ret: crate::UnityEngine::RectInt =
            unsafe { cordl_method_info.invoke_unchecked((), (rect, pixelsPerPoint))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+RenderChainCommand")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::UIR::RenderChainCommand {
