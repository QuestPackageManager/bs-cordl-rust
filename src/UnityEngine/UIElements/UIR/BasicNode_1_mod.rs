...
> crate::UnityEngine::UIElements::UIR::BasicNode_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UIR::BasicNode_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UIR::BasicNode_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "AppendTo", 1usize
                )
            });
