#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+BasicNode_1")]
#[repr(C)]
#[derive(Debug)]
pub struct BasicNode_1<T: quest_hook::libil2cpp::Type> {
    ...
    >,
    pub next: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::BasicNode_1<T>>,
    pub data: T,
    ...
    for crate::UnityEngine::UIElements::UIR::BasicNode_1<T>
{
    ...
    const CLASS_NAME: &'static str = "BasicNode`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements.UIR", "BasicNode`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+UIElements+UIR+BasicNode_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UIR::BasicNode_1<T> {
    pub fn InsertFirst(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::ByRefMut<
                        ...
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("InsertFirst")
                    .unwrap_or_else(|e| {
                        panic!(
