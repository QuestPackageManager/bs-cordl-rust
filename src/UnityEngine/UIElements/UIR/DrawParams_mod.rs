...
for crate::UnityEngine::UIElements::UIR::DrawParams {
    ...
    const CLASS_NAME: &'static str = "DrawParams";
...
impl crate::UnityEngine::UIElements::UIR::DrawParams {
    ...
    pub fn Reset(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UIR::DrawParams as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Reset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UIR::DrawParams as
