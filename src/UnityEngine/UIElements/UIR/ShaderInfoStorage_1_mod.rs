#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+ShaderInfoStorage_1")]
#[repr(C)]
...
pub struct ShaderInfoStorage_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_Convert: quest_hook::libil2cpp::Gc<crate::System::Func_2<crate::UnityEngine::Color, T>>,
    pub m_Allocator: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIRAtlasAllocator>,
...
#[cfg(feature = "UnityEngine+UIElements+UIR+ShaderInfoStorage_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UIR::ShaderInfoStorage_1<T> {
    pub fn AllocateRect(
        &mut self,
        width: i32,
        height: i32,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (width, height, uvs))? };
        Ok(__cordl_ret.into())
    }
    pub fn CpuBlit(
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 6usize>("CpuBlit")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (src, srcWidth, srcHeight, dst, dstWidth, dstHeight))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CreateOrExpandTexture")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn New(
        ...
        convert: quest_hook::libil2cpp::Gc<crate::System::Func_2<crate::UnityEngine::Color, T>>,
        initialSize: i32,
        maxSize: i32,
    ...
    pub fn UpdateTexture(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (format, convert, initialSize, maxSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_texture(
