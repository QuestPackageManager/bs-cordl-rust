...
pub struct NativePagedList_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_Pages: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::Unity::Collections::NativeArray_1<T>>,
    >,
    ...
    pub m_Enumerator: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::Unity::Collections::NativeSlice_1<T>>,
    >,
    ...
    for crate::UnityEngine::UIElements::UIR::NativePagedList_1<T>
{
    ...
    const CLASS_NAME: &'static str = "NativePagedList`1";
...
#[cfg(feature = "UnityEngine+UIElements+UIR+NativePagedList_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UIR::NativePagedList_1<T> {
    #[cfg(feature = "UnityEngine+UIElements+UIR+NativePagedList_1+Enumerator")]
    pub type Enumerator = crate::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>;
    ...
    pub fn Add_T1(&mut self, data: T) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
...
pub struct NativePagedList_1_Enumerator<T: quest_hook::libil2cpp::Type> {
    pub m_NativePagedList:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::UIR::NativePagedList_1<T>>,
    ...
    crate::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nativePagedList, offset))? };
        Ok(__cordl_ret.into())
    }
}
