#[cfg(feature = "cordl_class_UnityEngine+UIElements+UIR+NativeList_1")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct NativeList_1<T: quest_hook::libil2cpp::Type> {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub m_NativeArray: crate::Unity::Collections::NativeArray_1<T>,
    pub m_Count: i32,
...
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::UnityEngine::UIElements::UIR::NativeList_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements.UIR", "NativeList`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+UIElements+UIR+NativeList_1")]
...
#[cfg(feature = "UnityEngine+UIElements+UIR+NativeList_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::UIElements::UIR::NativeList_1<T> {
    pub fn Add(
        &mut self,
        src: crate::Unity::Collections::NativeSlice_1<T>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("Expand")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
