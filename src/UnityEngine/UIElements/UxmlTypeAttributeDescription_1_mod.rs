...
for crate::UnityEngine::UIElements::UxmlTypeAttributeDescription_1<TBase> {
    ...
    const CLASS_NAME: &'static str = "UxmlTypeAttributeDescription`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        ...
                        "UxmlTypeAttributeDescription`1",
                    )
                    .unwrap()
                    .make_generic::<(TBase)>()
                    .unwrap()
...
> crate::UnityEngine::UIElements::UxmlTypeAttributeDescription_1<TBase> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlTypeAttributeDescription_1<
            TBase,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    TBase > as quest_hook::libil2cpp::Type > ::class(),
                    "ConvertValueToType", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> = unsafe {
            method.invoke_unchecked(self, (v, defaultValue))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> = unsafe {
            method.invoke_unchecked(self, (bag, cc))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlTypeAttributeDescription_1 <
                    TBase > as quest_hook::libil2cpp::Type > ::class(),
                    "<GetValueFromBag>b__3_0", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> = unsafe {
            method.invoke_unchecked(self, (s, type1))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UxmlTypeAttributeDescription_1 <
                    TBase > as quest_hook::libil2cpp::Type > ::class(), ".ctor", 0usize
                )
            });
