...
pub struct VisualTreeStyleUpdaterTraversal {
    ...
    pub m_StyleMatchingContext:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::StyleMatchingContext>,
    pub m_StylePropertyReader:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::StyleSheets::StylePropertyReader>,
    pub _currentPanel_k__BackingField:
...
impl std::ops::Deref for crate::UnityEngine::UIElements::VisualTreeStyleUpdaterTraversal {
...
#[cfg(feature = "UnityEngine+UIElements+VisualTreeStyleUpdaterTraversal")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::VisualTreeStyleUpdaterTraversal {
...
impl crate::UnityEngine::UIElements::VisualTreeStyleUpdaterTraversal {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("AddChangedElement")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn CancelAnimationsWithNoTransitionProperty(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (element, newStyle))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OnProcessMatchResult(
        current: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElement>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (current, info))? };
        Ok(__cordl_ret.into())
    }
    pub fn PrepareTraversal(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        f32,
                    ), quest_hook::libil2cpp::Void, 2usize>("PrepareTraversal")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (panel, pixelsPerPoint))? };
        Ok(__cordl_ret.into())
    }
    pub fn ProcessMatchedRules(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), crate::UnityEngine::UIElements::ComputedStyle, 2usize>(
                        "ProcessMatchedRules"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::ComputedStyle =
            unsafe { cordl_method_info.invoke_unchecked(self, (element, matchingSelectors))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProcessTransitions(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            crate::UnityEngine::UIElements::ComputedStyle,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("ProcessTransitions")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (element, oldStyle, newStyle))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::UIElements::BaseVisualElementPanel,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_currentPanel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
