...
for crate::UnityEngine::UIElements::UxmlObjectAttributeDescription_1<T> {
    ...
    const CLASS_NAME: &'static str = "UxmlObjectAttributeDescription`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        ...
                        "UxmlObjectAttributeDescription`1",
                    )
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
...
> crate::UnityEngine::UIElements::UxmlObjectAttributeDescription_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlObjectAttributeDescription_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlObjectAttributeDescription_1 < T
                    > as quest_hook::libil2cpp::Type > ::class(), "GetValueFromBag",
                    2usize
                )
            });
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlObjectAttributeDescription_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), T, 0usize>("get_defaultValue")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::UxmlObjectAttributeDescription_1 < T
                    > as quest_hook::libil2cpp::Type > ::class(), "get_defaultValue",
                    0usize
                )
            });
