...
for crate::UnityEngine::UIElements::ThemeStyleSheet {
    ...
    const CLASS_NAME: &'static str = "ThemeStyleSheet";
...
#[cfg(feature = "UnityEngine+UIElements+ThemeStyleSheet")]
impl crate::UnityEngine::UIElements::ThemeStyleSheet {
    ...
    pub fn OnEnable(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::ThemeStyleSheet as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnEnable")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::ThemeStyleSheet as
