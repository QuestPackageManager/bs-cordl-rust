...
for crate::UnityEngine::UIElements::EventCategoryAttribute {
    ...
    const CLASS_NAME: &'static str = "EventCategoryAttribute";
...
impl crate::UnityEngine::UIElements::EventCategoryAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::EventCategoryAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::EventCategoryAttribute as
