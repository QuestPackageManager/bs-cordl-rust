#[cfg(feature = "cordl_class_UnityEngine+UIElements+IStyleValue_1")]
    ...
    for crate::UnityEngine::UIElements::IStyleValue_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IStyleValue`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "IStyleValue`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
