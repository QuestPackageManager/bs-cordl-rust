...
#[cfg(feature = "UnityEngine+UIElements+VisualElementFocusChangeTarget")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::VisualElementFocusChangeTarget {
...
impl crate::UnityEngine::UIElements::VisualElementFocusChangeTarget {
    ...
    pub fn GetPooled(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::VisualElementFocusChangeTarget>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
