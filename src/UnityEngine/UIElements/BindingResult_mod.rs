...
for crate::UnityEngine::UIElements::BindingResult {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
impl crate::UnityEngine::UIElements::BindingResult {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (status, message))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_message(
    ...
    pub fn get_status(
        ...
        let __cordl_ret: crate::UnityEngine::UIElements::BindingStatus = unsafe {
