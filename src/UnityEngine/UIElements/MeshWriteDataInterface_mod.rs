#[cfg(feature = "cordl_class_UnityEngine+UIElements+MeshWriteDataInterface")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MeshWriteDataInterface")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::MeshWriteDataInterface {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "MeshWriteDataInterface";
