...
for crate::UnityEngine::UIElements::UxmlHash128AttributeDescription {
    ...
    const CLASS_NAME: &'static str = "UxmlHash128AttributeDescription";
...
impl crate::UnityEngine::UIElements::UxmlHash128AttributeDescription {
    pub fn GetValueFromBag(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::UxmlHash128AttributeDescription as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::UxmlHash128AttributeDescription as
