...
impl std::ops::Deref for crate::UnityEngine::UIElements::UxmlHash128AttributeDescription {
...
#[cfg(feature = "UnityEngine+UIElements+UxmlHash128AttributeDescription")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::UxmlHash128AttributeDescription {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Hash128, 2usize>("GetValueFromBag")
                    .unwrap_or_else(|e| {
                        panic!(
