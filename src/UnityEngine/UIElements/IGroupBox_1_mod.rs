#[cfg(feature = "cordl_class_UnityEngine+UIElements+IGroupBox_1")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::UnityEngine::UIElements::IGroupBox_1<T>
{
    ...
    const CLASS_NAME: &'static str = "IGroupBox`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "IGroupBox`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
