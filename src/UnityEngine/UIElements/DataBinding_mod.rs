...
pub struct DataBinding {
    ...
    pub m_SourceToUiConverters: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::UIElements::ConverterGroup,
    >,
    pub m_UiToSourceConverters: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::UIElements::ConverterGroup,
    >,
...
impl crate::UnityEngine::UIElements::DataBinding {
    ...
    pub fn GetSetValueErrorString<TValue>(
        ...
        sourcePath: quest_hook::libil2cpp::ByRefMut<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_bindingMode", 0usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::UIElements::BindingMode = unsafe {
