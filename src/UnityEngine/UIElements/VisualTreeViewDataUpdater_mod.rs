...
impl crate::UnityEngine::UIElements::VisualTreeViewDataUpdater {
    ...
    pub fn OnVersionChanged(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::VisualTreeViewDataUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::VisualTreeViewDataUpdater as
    ...
    pub fn ValidateViewDataOnSubTree(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::VisualTreeViewDataUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                ...
                quest_hook::libil2cpp::Void,
                2usize,
            >("ValidateViewDataOnSubTree")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::VisualTreeViewDataUpdater as
                    quest_hook::libil2cpp::Type > ::class(), "ValidateViewDataOnSubTree",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ve, enablePersistence))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
