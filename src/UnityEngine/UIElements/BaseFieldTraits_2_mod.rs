...
unsafe impl<
    ...
    for crate::UnityEngine::UIElements::BaseFieldTraits_2<TValueType, TValueUxmlAttributeType>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "BaseFieldTraits`2")
                .unwrap()
