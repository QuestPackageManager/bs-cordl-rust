...
#[cfg(feature = "UnityEngine+UIElements+IDragAndDropController_1")]
impl<TArgs: quest_hook::libil2cpp::Type>
    crate::UnityEngine::UIElements::IDragAndDropController_1<TArgs>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TArgs), crate::UnityEngine::UIElements::DragVisualMode, 1usize>(
                        "HandleDragAndDrop",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TArgs), quest_hook::libil2cpp::Void, 1usize>("OnDrop")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
