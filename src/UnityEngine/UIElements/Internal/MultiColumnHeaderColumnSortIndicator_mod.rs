...
for crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator {
    ...
    const CLASS_NAME: &'static str = "MultiColumnHeaderColumnSortIndicator";
...
impl crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator as quest_hook::libil2cpp::Type>::class()
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator
                    as quest_hook::libil2cpp::Type > ::class(), "set_sortOrderLabel",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
