...
pub struct TypePathVisitor {
    ...
    pub _resolvedType_k__BackingField: quest_hook::libil2cpp::Gc<crate::System::Type>,
    pub _ReturnCode_k__BackingField: crate::Unity::Properties::VisitReturnCode,
    pub m_LastType: quest_hook::libil2cpp::Gc<crate::System::Type>,
    pub m_PathIndex: i32,
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+Internal+TypePathVisitor")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::UIElements::Internal::TypePathVisitor
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements.Internal";
    const CLASS_NAME: &'static str = "TypePathVisitor";
...
#[cfg(feature = "UnityEngine+UIElements+Internal+TypePathVisitor")]
impl std::ops::Deref for crate::UnityEngine::UIElements::Internal::TypePathVisitor {
...
#[cfg(feature = "UnityEngine+UIElements+Internal+TypePathVisitor")]
impl std::ops::DerefMut for crate::UnityEngine::UIElements::Internal::TypePathVisitor {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+UIElements+Internal+TypePathVisitor")]
impl crate::UnityEngine::UIElements::Internal::TypePathVisitor {
    ...
    pub fn IsLastPartReached(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsLastPartReached")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
