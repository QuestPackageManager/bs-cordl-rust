...
impl crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon {
    ...
    pub fn UpdateClassList(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("UpdateClassList")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as
                    quest_hook::libil2cpp::Type > ::class(), "UpdateClassList", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as
                    quest_hook::libil2cpp::Type > ::class(), "<.ctor>b__5_0", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as
                    quest_hook::libil2cpp::Type > ::class(), "get_isImageInline", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnIcon as
                    quest_hook::libil2cpp::Type > ::class(), "set_isImageInline", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
