#[cfg(feature = "cordl_class_UnityEngine+UIElements+FocusOutEvent")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+FocusOutEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::FocusOutEvent {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UIElements";
    const CLASS_NAME: &'static str = "FocusOutEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+FocusOutEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::FocusOutEvent {
