#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleLength")]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleLength")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::UIElements::StyleLength {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleLength")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::UIElements::StyleLength {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleLength")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::UIElements::StyleLength {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleLength")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::UIElements::StyleLength {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+StyleLength")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::UIElements::StyleLength {
    type Type = Self;
...
impl crate::UnityEngine::UIElements::StyleLength {
    ...
    pub fn Equals_StyleLength0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::UIElements::StyleLength), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_value(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::UIElements::Length, 0usize>("get_value")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::UIElements::StyleLength> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+UIElements+StyleLength")]
...
#[cfg(feature = "UnityEngine+UIElements+StyleLength")]
impl AsRef<crate::UnityEngine::UIElements::IStyleValue_1<crate::UnityEngine::UIElements::Length>>
    for crate::UnityEngine::UIElements::StyleLength
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+UIElements+StyleLength")]
impl AsMut<crate::UnityEngine::UIElements::IStyleValue_1<crate::UnityEngine::UIElements::Length>>
    for crate::UnityEngine::UIElements::StyleLength
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::UnityEngine::UIElements::IStyleValue_1<crate::UnityEngine::UIElements::Length>
    {
        todo!()
    }
}
