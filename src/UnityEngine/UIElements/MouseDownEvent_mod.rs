...
impl crate::UnityEngine::UIElements::MouseDownEvent {
    pub fn GetPooled_PointerDownEvent0(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::MouseDownEvent>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::MouseDownEvent as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::MouseDownEvent as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::MouseDownEvent as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UIElements::MouseDownEvent as
                    quest_hook::libil2cpp::Type > ::class(), "MakeFromPointerEvent",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
