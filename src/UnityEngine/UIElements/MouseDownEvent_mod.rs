#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseDownEvent")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseDownEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::MouseDownEvent {
...
impl crate::UnityEngine::UIElements::MouseDownEvent {
    pub fn GetPooled_PointerDownEvent0(
        pointerEvent: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::PointerDownEvent>,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::MouseDownEvent> =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerEvent))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetPooled_PointerMoveEvent1(
        pointerEvent: quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::PointerMoveEvent>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::UIElements::MouseDownEvent>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseDownEvent")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::MouseDownEvent {
