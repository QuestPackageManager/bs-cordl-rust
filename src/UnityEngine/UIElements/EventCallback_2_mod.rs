...
> crate::UnityEngine::UIElements::EventCallback_2<TEventType, TCallbackArgs> {
    ...
    where
        ...
        TCallbackArgs: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UIElements::EventCallback_2<
            TEventType,
            TCallbackArgs,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UIElements::EventCallback_2 < TEventType,
                    TCallbackArgs > as quest_hook::libil2cpp::Type > ::class(), "Invoke",
                    2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (evt, userArgs))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
