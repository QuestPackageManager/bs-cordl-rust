    ...
    for crate::UnityEngine::UIElements::EventCallback_2<TEventType, TCallbackArgs>
{
    ...
    const CLASS_NAME: &'static str = "EventCallback`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.UIElements", "EventCallback`2")
                .unwrap()
...
impl<TEventType: quest_hook::libil2cpp::Type, TCallbackArgs: quest_hook::libil2cpp::Type>
    std::ops::Deref for crate::UnityEngine::UIElements::EventCallback_2<TEventType, TCallbackArgs>
{
    ...
    crate::UnityEngine::UIElements::EventCallback_2<TEventType, TCallbackArgs>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (evt, userArgs))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
