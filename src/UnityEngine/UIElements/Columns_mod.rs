...
impl crate::UnityEngine::UIElements::Columns {
    ...
    pub fn Insert(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, column))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn IsPrimary(
