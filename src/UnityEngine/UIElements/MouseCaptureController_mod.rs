#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseCaptureController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseCaptureController")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::MouseCaptureController {
...
impl crate::UnityEngine::UIElements::MouseCaptureController {
    ...
    pub fn HasMouseCapture(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (handler))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UIElements+MouseCaptureController")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UIElements::MouseCaptureController {
