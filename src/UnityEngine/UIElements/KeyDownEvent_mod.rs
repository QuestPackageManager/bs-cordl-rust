#[cfg(feature = "cordl_class_UnityEngine+UIElements+KeyDownEvent")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UIElements+KeyDownEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UIElements::KeyDownEvent {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetEquivalentImguiEvent", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (outImguiEvent))? };
        Ok(__cordl_ret.into())
    }
