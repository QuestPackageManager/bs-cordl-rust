...
for crate::UnityEngine::UIElements::DataBindingUtility {
...
impl crate::UnityEngine::UIElements::DataBindingUtility {
    pub fn TryGetBinding(
        ...
        >,
        bindingInfo: quest_hook::libil2cpp::ByRefMut<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "TryGetBinding", 3usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (element, bindingId, bindingInfo))?
        };
        Ok(__cordl_ret.into())
    }
}
