...
#[cfg(feature = "cordl_class_UnityEngine+IntegratedSubsystem_1")]
unsafe impl<TSubsystemDescriptor: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::UnityEngine::IntegratedSubsystem_1<TSubsystemDescriptor>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine", "IntegratedSubsystem`1")
                .unwrap()
...
#[cfg(feature = "UnityEngine+IntegratedSubsystem_1")]
impl<TSubsystemDescriptor: quest_hook::libil2cpp::Type>
