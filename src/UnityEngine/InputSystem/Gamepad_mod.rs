...
impl crate::UnityEngine::InputSystem::Gamepad {
    ...
    > {
        ...
        let __cordl_ret: *mut crate::UnityEngine::InputSystem::Controls::ButtonControl = __cordl_object
            .invoke("get_crossButton", ())?;
        Ok(__cordl_ret)
    }
    pub fn get_dpad(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        *mut crate::UnityEngine::InputSystem::Controls::DpadControl,
    > {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: *mut crate::UnityEngine::InputSystem::Controls::DpadControl = __cordl_object
            .invoke("get_dpad", ())?;
        Ok(__cordl_ret)
    }
    ...
    pub fn set_dpad(
        &mut self,
        value: *mut crate::UnityEngine::InputSystem::Controls::DpadControl,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
