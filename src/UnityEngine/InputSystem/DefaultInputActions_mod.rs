...
impl crate::UnityEngine::InputSystem::DefaultInputActions_PlayerActions {
    ...
    pub fn SetCallbacks(
        &mut self,
        instance: *mut crate::UnityEngine::InputSystem::DefaultInputActions_IPlayerActions,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_ret: quest_hook::libil2cpp::Void = quest_hook::libil2cpp::ValueTypeExt::invoke(
            self,
            "SetCallbacks",
...
impl crate::UnityEngine::InputSystem::DefaultInputActions_UIActions {
    ...
    pub fn SetCallbacks(
        &mut self,
        instance: *mut crate::UnityEngine::InputSystem::DefaultInputActions_IUIActions,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_ret: quest_hook::libil2cpp::Void = quest_hook::libil2cpp::ValueTypeExt::invoke(
            self,
            "SetCallbacks",
