#[cfg(feature = "cordl_class_UnityEngine+InputSystem+InputBindingComposite_1")]
#[repr(C)]
    ...
    crate::UnityEngine::InputSystem::InputBindingComposite_1<TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = unsafe { cordl_method_info.invoke_unchecked(self, (context))? };
        Ok(__cordl_ret.into())
    }
