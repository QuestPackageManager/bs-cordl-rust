#[cfg(feature = "cordl_class_UnityEngine+InputSystem+DualShock+DualShockSupport")]
#[repr(C)]
...
#[cfg(feature = "UnityEngine+InputSystem+DualShock+DualShockSupport")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::DualShock::DualShockSupport {
