...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+PlayerInputManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::PlayerInputManager {
...
impl crate::UnityEngine::InputSystem::PlayerInputManager {
    ...
    pub fn CheckIfPlayerCanJoin(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (playerIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn DisableJoining(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn EnableJoining(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Action_1<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::PlayerInput>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("add_onPlayerLeft")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_fixedNumberOfSplitScreens(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_joinBehavior(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::PlayerJoinBehavior> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::InputSystem::PlayerJoinBehavior, 0usize>(
                        "get_joinBehavior",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::PlayerJoinBehavior =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_maintainAspectRatioInSplitScreen(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn set_instance(
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::PlayerInputManager>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn set_splitScreen(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_splitScreen")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+PlayerInputManager")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::PlayerInputManager {
...
#[cfg(feature = "UnityEngine+InputSystem+PlayerInputManager+PlayerJoinedEvent")]
impl std::ops::Deref for crate::UnityEngine::InputSystem::PlayerInputManager_PlayerJoinedEvent {
...
#[cfg(feature = "UnityEngine+InputSystem+PlayerInputManager+PlayerJoinedEvent")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::PlayerInputManager_PlayerJoinedEvent {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
#[cfg(feature = "UnityEngine+InputSystem+PlayerInputManager+PlayerLeftEvent")]
impl std::ops::Deref for crate::UnityEngine::InputSystem::PlayerInputManager_PlayerLeftEvent {
    type Target = crate::UnityEngine::Events::UnityEvent_1<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::PlayerInput>,
    >;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
...
#[cfg(feature = "UnityEngine+InputSystem+PlayerInputManager+PlayerLeftEvent")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::PlayerInputManager_PlayerLeftEvent {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
