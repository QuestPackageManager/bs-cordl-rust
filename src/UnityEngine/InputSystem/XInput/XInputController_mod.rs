...
impl crate::UnityEngine::InputSystem::XInput::XInputController {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::XInput::XInputController_DeviceFlags =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_menu(
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::XInput::XInputController_DeviceSubType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_view(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::ButtonControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_view")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
