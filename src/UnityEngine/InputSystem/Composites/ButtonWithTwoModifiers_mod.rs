...
pub struct ButtonWithTwoModifiers {
    ...
    pub modifiersOrder: crate::UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers_ModifiersOrder,
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Composites+ButtonWithTwoModifiers")]
...
impl crate::UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers {
    #[cfg(
        feature = "UnityEngine+InputSystem+Composites+ButtonWithTwoModifiers+ModifiersOrder"
    )]
    pub type ModifiersOrder = crate::UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers_ModifiersOrder;
