    ...
    for crate::UnityEngine::InputSystem::Composites::AxisComposite
{
    ...
    const CLASS_NAME: &'static str = "AxisComposite";
...
impl crate::UnityEngine::InputSystem::Composites::AxisComposite {
    ...
    pub type WhichSideWins =
        crate::UnityEngine::InputSystem::Composites::AxisComposite_WhichSideWins;
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Composites+AxisComposite+WhichSideWins")]
