...
impl crate::UnityEngine::InputSystem::Composites::ButtonWithOneModifier {
    pub fn EvaluateMagnitude(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Composites::ButtonWithOneModifier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::Composites::ButtonWithOneModifier
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Composites::ButtonWithOneModifier as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Composites::ButtonWithOneModifier
                    as quest_hook::libil2cpp::Type > ::class(), "ModifierIsPressed",
                    1usize
                )
            });
