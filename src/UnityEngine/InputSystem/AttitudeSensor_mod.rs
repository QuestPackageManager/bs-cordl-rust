...
pub struct AttitudeSensor {
    ...
    pub _attitude_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::QuaternionControl>,
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+AttitudeSensor")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::AttitudeSensor {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::QuaternionControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_attitude")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+AttitudeSensor")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::AttitudeSensor {
