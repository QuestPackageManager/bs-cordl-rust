#[cfg(feature = "cordl_class_UnityEngine+InputSystem+MagneticFieldSensor")]
#[repr(C)]
#[derive(Debug)]
pub struct MagneticFieldSensor {
    __cordl_parent: crate::UnityEngine::InputSystem::Sensor,
    pub _magneticField_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::Vector3Control>,
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+MagneticFieldSensor")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::MagneticFieldSensor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem";
    const CLASS_NAME: &'static str = "MagneticFieldSensor";
...
impl crate::UnityEngine::InputSystem::MagneticFieldSensor {
    ...
    pub fn set_current(
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::MagneticFieldSensor>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::Vector3Control,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_magneticField")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+MagneticFieldSensor")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::MagneticFieldSensor {
