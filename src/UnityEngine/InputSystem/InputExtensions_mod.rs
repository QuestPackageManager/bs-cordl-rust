#[cfg(feature = "cordl_class_UnityEngine+InputSystem+InputExtensions")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+InputExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::InputExtensions {
...
impl crate::UnityEngine::InputSystem::InputExtensions {
    pub fn IsActive(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (phase))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsModifierKey(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::UnityEngine::InputSystem::Key), bool, 1usize>(
                        "IsModifierKey",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+InputExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::InputExtensions {
