...
pub struct ProximitySensor {
    ...
    pub _distance_k__BackingField: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::InputSystem::Controls::AxisControl,
    >,
}
#[cfg(feature = "UnityEngine+InputSystem+ProximitySensor")]
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::InputSystem::ProximitySensor {
...
impl crate::UnityEngine::InputSystem::ProximitySensor {
    pub fn FinishSetup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::ProximitySensor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FinishSetup")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::ProximitySensor as
