...
impl crate::UnityEngine::InputSystem::InputInteraction {
                ...
                Self::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            Self::class(), "GetDisplayName", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (interaction))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (interactionType))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetValueType(
        interactionType: quest_hook::libil2cpp::Gc<crate::System::Type>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> = unsafe {
            method.invoke_unchecked((), (interactionType))?
        };
        Ok(__cordl_ret.into())
    }
}
