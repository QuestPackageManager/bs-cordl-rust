...
for crate::UnityEngine::InputSystem::Controls::StickControl {
    ...
    const CLASS_NAME: &'static str = "StickControl";
...
#[cfg(feature = "UnityEngine+InputSystem+Controls+StickControl")]
impl crate::UnityEngine::InputSystem::Controls::StickControl {
    pub fn FinishSetup(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Controls::StickControl as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FinishSetup")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Controls::StickControl as
