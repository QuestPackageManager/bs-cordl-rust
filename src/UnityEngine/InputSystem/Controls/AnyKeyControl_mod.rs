...
for crate::UnityEngine::InputSystem::Controls::AnyKeyControl {
    ...
    const CLASS_NAME: &'static str = "AnyKeyControl";
...
impl crate::UnityEngine::InputSystem::Controls::AnyKeyControl {
    ...
    pub fn ReadUnprocessedValueFromState(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Controls::AnyKeyControl as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::Controls::AnyKeyControl as
