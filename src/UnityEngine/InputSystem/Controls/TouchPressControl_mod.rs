...
for crate::UnityEngine::InputSystem::Controls::TouchPressControl {
    ...
    const CLASS_NAME: &'static str = "TouchPressControl";
...
impl crate::UnityEngine::InputSystem::Controls::TouchPressControl {
    pub fn FinishSetup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Controls::TouchPressControl as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FinishSetup")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Controls::TouchPressControl as
