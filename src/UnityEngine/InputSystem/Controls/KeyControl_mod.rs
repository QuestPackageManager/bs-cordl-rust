...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Controls+KeyControl")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::Controls::KeyControl {
...
impl crate::UnityEngine::InputSystem::Controls::KeyControl {
    ...
    pub fn get_keyCode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::InputSystem::Key, 0usize>("get_keyCode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::Key =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Controls+KeyControl")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::Controls::KeyControl {
