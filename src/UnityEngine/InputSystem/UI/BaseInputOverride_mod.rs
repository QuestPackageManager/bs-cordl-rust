...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+UI+BaseInputOverride")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::UI::BaseInputOverride {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem.UI";
    const CLASS_NAME: &'static str = "BaseInputOverride";
...
#[cfg(feature = "UnityEngine+InputSystem+UI+BaseInputOverride")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::UI::BaseInputOverride {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+InputSystem+UI+BaseInputOverride")]
impl crate::UnityEngine::InputSystem::UI::BaseInputOverride {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+UI+BaseInputOverride")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::UI::BaseInputOverride {
