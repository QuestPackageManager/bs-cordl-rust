...
#[cfg(feature = "UnityEngine+InputSystem+UI+ExtendedPointerEventData")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::UI::ExtendedPointerEventData {
...
impl crate::UnityEngine::InputSystem::UI::ExtendedPointerEventData {
    pub fn GetPenPointerId(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (pen))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetTouchPointerId(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (touchControl))? };
        Ok(__cordl_ret.into())
    }
    pub fn MakePointerIdForTouch(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (deviceId, touchId))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
