...
for crate::UnityEngine::InputSystem::OnScreen::OnScreenSupport {
    ...
    const CLASS_NAME: &'static str = "OnScreenSupport";
...
impl crate::UnityEngine::InputSystem::OnScreen::OnScreenSupport {
    pub fn Initialize() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::OnScreen::OnScreenSupport as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("Initialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::OnScreen::OnScreenSupport as
