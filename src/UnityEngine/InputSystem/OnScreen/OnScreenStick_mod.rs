...
impl crate::UnityEngine::InputSystem::OnScreen::OnScreenStick {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "BeginInteraction", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (pointerPosition, uiCamera))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn DrawGizmoCircle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (center, radius))?
        };
        Ok(__cordl_ret.into())
    }
