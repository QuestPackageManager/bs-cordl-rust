...
for crate::UnityEngine::InputSystem::Processors::ScaleProcessor {
    ...
    const CLASS_NAME: &'static str = "ScaleProcessor";
...
impl crate::UnityEngine::InputSystem::Processors::ScaleProcessor {
    ...
    pub fn Process(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Processors::ScaleProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    f32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::Processors::ScaleProcessor as
