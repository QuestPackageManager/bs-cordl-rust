    ...
    for crate::UnityEngine::InputSystem::Processors::InvertVector3Processor
{
    ...
    const CLASS_NAME: &'static str = "InvertVector3Processor";
...
impl std::ops::Deref for crate::UnityEngine::InputSystem::Processors::InvertVector3Processor {
    type Target = crate::UnityEngine::InputSystem::InputProcessor_1<crate::UnityEngine::Vector3>;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+InputSystem+Processors+InvertVector3Processor")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::Processors::InvertVector3Processor {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Vector3, 2usize>("Process")
                    .unwrap_or_else(|e| {
                        panic!(
