...
impl std::ops::Deref for crate::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor {
...
#[cfg(feature = "UnityEngine+InputSystem+Processors+StickDeadzoneProcessor")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor {
...
impl crate::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor {
    pub fn GetDeadZoneAdjustedValue(&mut self, value: f32) -> quest_hook::libil2cpp::Result<f32> {
