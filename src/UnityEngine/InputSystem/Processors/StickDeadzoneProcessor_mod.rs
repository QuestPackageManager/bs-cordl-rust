...
impl crate::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor {
    pub fn GetDeadZoneAdjustedValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), f32, 1usize>("GetDeadZoneAdjustedValue")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Processors::StickDeadzoneProcessor
                    as quest_hook::libil2cpp::Type > ::class(),
                    "GetDeadZoneAdjustedValue", 1usize
                )
            });
