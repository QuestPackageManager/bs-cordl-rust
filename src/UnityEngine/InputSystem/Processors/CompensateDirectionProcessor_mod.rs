#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Processors+CompensateDirectionProcessor")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::UnityEngine::InputSystem::Processors::CompensateDirectionProcessor
{
    ...
    const CLASS_NAME: &'static str = "CompensateDirectionProcessor";
...
impl std::ops::Deref for crate::UnityEngine::InputSystem::Processors::CompensateDirectionProcessor {
