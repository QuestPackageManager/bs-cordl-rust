#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Processors+ScaleVector2Processor")]
#[repr(C)]
    ...
    for crate::UnityEngine::InputSystem::Processors::ScaleVector2Processor
{
    ...
    const CLASS_NAME: &'static str = "ScaleVector2Processor";
...
impl std::ops::Deref for crate::UnityEngine::InputSystem::Processors::ScaleVector2Processor {
    type Target = crate::UnityEngine::InputSystem::InputProcessor_1<crate::UnityEngine::Vector2>;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+InputSystem+Processors+ScaleVector2Processor")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::Processors::ScaleVector2Processor {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Vector2, 2usize>("Process")
                    .unwrap_or_else(|e| {
                        panic!(
