...
impl std::ops::Deref for crate::UnityEngine::InputSystem::Processors::NormalizeProcessor {
...
#[cfg(feature = "UnityEngine+InputSystem+Processors+NormalizeProcessor")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::Processors::NormalizeProcessor {
...
impl crate::UnityEngine::InputSystem::Processors::NormalizeProcessor {
    pub fn Denormalize(
        ...
        let __cordl_ret: f32 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, min, max, zero))? };
        Ok(__cordl_ret.into())
    }
