...
impl crate::UnityEngine::InputSystem::Keyboard {
    ...
    > {
        ...
        let __cordl_ret: *mut crate::UnityEngine::InputSystem::Controls::KeyControl = __cordl_object
            .invoke("FindKeyOnCurrentKeyboardLayout", (displayName))?;
        Ok(__cordl_ret)
    }
    pub fn FinishSetup(
        &mut self,
    ...
    pub fn set_anyKey(
        &mut self,
        value: *mut crate::UnityEngine::InputSystem::Controls::AnyKeyControl,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
