#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+XRFeatureDescriptor")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
pub struct XRFeatureDescriptor {
    pub name: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub usageHints: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::UnityEngine::InputSystem::XR::UsageHint>,
    >,
    ...
    for crate::UnityEngine::InputSystem::XR::XRFeatureDescriptor
{
    ...
    const CLASS_NAME: &'static str = "XRFeatureDescriptor";
