...
for crate::UnityEngine::InputSystem::XR::XRControllerWithRumble {
    ...
    const CLASS_NAME: &'static str = "XRControllerWithRumble";
...
impl crate::UnityEngine::InputSystem::XR::XRControllerWithRumble {
    ...
    pub fn SendImpulse(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::XR::XRControllerWithRumble as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32, f32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::XR::XRControllerWithRumble as
                    quest_hook::libil2cpp::Type > ::class(), "SendImpulse", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (amplitude, duration))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
