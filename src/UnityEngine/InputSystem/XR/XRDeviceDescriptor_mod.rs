...
impl crate::UnityEngine::InputSystem::XR::XRDeviceDescriptor {
    pub fn FromJson(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::XR::XRDeviceDescriptor as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::XR::XRDeviceDescriptor as
