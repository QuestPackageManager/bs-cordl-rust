#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+XRSupport")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+XRSupport")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::XR::XRSupport {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem.XR";
    const CLASS_NAME: &'static str = "XRSupport";
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+XRSupport")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::XR::XRSupport {
