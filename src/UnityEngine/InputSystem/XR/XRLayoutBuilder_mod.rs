...
impl crate::UnityEngine::InputSystem::XR::XRLayoutBuilder {
    ...
    pub fn GetSizeOfFeature(
        ...
        let __cordl_ret: u32 = unsafe {
            cordl_method_info.invoke_unchecked((), (featureDescriptor))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsPoseControl", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (features, startIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn IsSubControl(
