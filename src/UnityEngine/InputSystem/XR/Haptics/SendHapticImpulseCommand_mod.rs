...
impl crate::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (i32, f32, f32),
                crate::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand,
                3usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand as
