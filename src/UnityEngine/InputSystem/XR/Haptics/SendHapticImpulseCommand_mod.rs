#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Haptics+SendHapticImpulseCommand")]
...
impl crate::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand = unsafe {
            cordl_method_info.invoke_unchecked((), (motorChannel, motorAmplitude, motorDuration))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
