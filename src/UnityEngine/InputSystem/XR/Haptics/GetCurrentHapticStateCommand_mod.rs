#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Haptics+GetCurrentHapticStateCommand")]
...
impl crate::UnityEngine::InputSystem::XR::Haptics::GetCurrentHapticStateCommand {
    ...
    pub fn get_currentState(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::XR::Haptics::HapticState>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::XR::Haptics::HapticState =
