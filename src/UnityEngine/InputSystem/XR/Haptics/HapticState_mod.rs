#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Haptics+HapticState")]
...
impl crate::UnityEngine::InputSystem::XR::Haptics::HapticState {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (samplesQueued, samplesAvailable))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_samplesQueued(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u32), quest_hook::libil2cpp::Void, 1usize>("set_samplesQueued")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
