#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Haptics+SendBufferedHapticCommand")]
...
impl crate::UnityEngine::InputSystem::XR::Haptics::SendBufferedHapticCommand {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::XR::Haptics::SendBufferedHapticCommand =
            unsafe { cordl_method_info.invoke_unchecked((), (rumbleBuffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
...
impl
    crate::UnityEngine::InputSystem::XR::Haptics::SendBufferedHapticCommand__buffer_e__FixedBuffer
{
}
