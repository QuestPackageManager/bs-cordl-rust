#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::XR::Bone {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::InputSystem::XR::Bone {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::InputSystem::XR::Bone {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::InputSystem::XR::Bone {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::InputSystem::XR::Bone {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+Bone")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::InputSystem::XR::Bone {
    type Type = Self;
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), u32, 0usize>("get_parentBoneIndex")
                    .unwrap_or_else(|e| {
                        panic!(
