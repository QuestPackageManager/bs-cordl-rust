...
impl crate::UnityEngine::InputSystem::XR::PoseState {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::XR::PoseState as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    bool,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::XR::PoseState as
