...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+PoseState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::XR::PoseState {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+PoseState")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::InputSystem::XR::PoseState {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+PoseState")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::InputSystem::XR::PoseState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+PoseState")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::InputSystem::XR::PoseState {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+PoseState")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::InputSystem::XR::PoseState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+XR+PoseState")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::InputSystem::XR::PoseState {
    type Type = Self;
