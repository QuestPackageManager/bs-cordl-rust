#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LightSensor")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct LightSensor {
    __cordl_parent: crate::UnityEngine::InputSystem::Sensor,
    pub _lightLevel_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::AxisControl>,
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LightSensor")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::LightSensor {
...
impl crate::UnityEngine::InputSystem::LightSensor {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::LightSensor> =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::AxisControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_lightLevel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
