...
impl crate::UnityEngine::InputSystem::InputBindingCompositeContext {
    ...
    pub fn EvaluateMagnitude(
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (partNumber))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetPressTime(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = unsafe {
            cordl_method_info.invoke_unchecked(self, (partNumber, sourceControl))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (partNumber, sourceControl, comparer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadValue_Il2CppObject_i32_4(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (partNumber, buffer, bufferSize))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = unsafe {
            cordl_method_info.invoke_unchecked(self, (partNumber, comparer))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+InputBindingCompositeContext+PartBinding"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
