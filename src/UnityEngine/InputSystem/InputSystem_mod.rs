...
#[repr(C)]
#[derive(Debug, Clone)]
pub struct DeltaStateEventBuffer__data_e__FixedBuffer {
...
quest_hook::libil2cpp::unsafe_impl_value_type!(
    ...
    ::UnityEngine::InputSystem::DeltaStateEventBuffer__data_e__FixedBuffer =>
...
for crate::UnityEngine::InputSystem::DeltaStateEventBuffer__data_e__FixedBuffer {
    type Type = Self;
...
impl crate::UnityEngine::InputSystem::DeltaStateEventBuffer__data_e__FixedBuffer {}
#[cfg(
    feature = "UnityEngine+InputSystem+InputSystem+StateEventBuffer+_data_e__FixedBuffer"
)]
#[repr(C)]
#[derive(Debug, Clone)]
pub struct StateEventBuffer__data_e__FixedBuffer {
    pub FixedElementField: u8,
}
#[cfg(
    feature = "UnityEngine+InputSystem+InputSystem+StateEventBuffer+_data_e__FixedBuffer"
...
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate
    ::UnityEngine::InputSystem::StateEventBuffer__data_e__FixedBuffer =>
...
unsafe impl quest_hook::libil2cpp::ThisArgument
for crate::UnityEngine::InputSystem::StateEventBuffer__data_e__FixedBuffer {
    type Type = Self;
    fn matches(method: &quest_hook::libil2cpp::MethodInfo) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_this_argument(method)
    }
...
impl crate::UnityEngine::InputSystem::StateEventBuffer__data_e__FixedBuffer {}
...
pub struct InputSystem_DeltaStateEventBuffer {
    ...
    pub data: crate::UnityEngine::InputSystem::DeltaStateEventBuffer__data_e__FixedBuffer,
}
#[cfg(feature = "UnityEngine+InputSystem+InputSystem+DeltaStateEventBuffer")]
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate
...
impl crate::UnityEngine::InputSystem::InputSystem_DeltaStateEventBuffer {
    ...
    pub type _data_e__FixedBuffer = crate::UnityEngine::InputSystem::DeltaStateEventBuffer__data_e__FixedBuffer;
}
...
pub struct InputSystem_StateEventBuffer {
    ...
    pub data: crate::UnityEngine::InputSystem::StateEventBuffer__data_e__FixedBuffer,
}
#[cfg(feature = "UnityEngine+InputSystem+InputSystem+StateEventBuffer")]
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate
...
impl crate::UnityEngine::InputSystem::InputSystem_StateEventBuffer {
    ...
    pub type _data_e__FixedBuffer = crate::UnityEngine::InputSystem::StateEventBuffer__data_e__FixedBuffer;
}
