#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LinearAccelerationSensor")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::UnityEngine::InputSystem::LinearAccelerationSensor
{
    ...
    const CLASS_NAME: &'static str = "LinearAccelerationSensor";
...
impl crate::UnityEngine::InputSystem::LinearAccelerationSensor {
    ...
    pub fn get_current() -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::LinearAccelerationSensor>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn set_current(
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::LinearAccelerationSensor>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
