...
for crate::UnityEngine::InputSystem::AmbientTemperatureSensor {
    ...
    const CLASS_NAME: &'static str = "AmbientTemperatureSensor";
...
impl crate::UnityEngine::InputSystem::AmbientTemperatureSensor {
    pub fn FinishSetup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::AmbientTemperatureSensor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FinishSetup")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::AmbientTemperatureSensor as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::AmbientTemperatureSensor as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::AmbientTemperatureSensor as
                    quest_hook::libil2cpp::Type > ::class(), "get_ambientTemperature",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::AmbientTemperatureSensor as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::AmbientTemperatureSensor as
                    quest_hook::libil2cpp::Type > ::class(), "set_ambientTemperature",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
