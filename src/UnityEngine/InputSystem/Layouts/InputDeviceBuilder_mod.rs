...
impl crate::UnityEngine::InputSystem::Layouts::InputDeviceBuilder {
    ...
    pub fn AddChildren(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (parent, left, right))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AddParentDisplayNameRecursive(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (control, stringBuilder, shortName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddProcessors(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (control, controlItem, layoutName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ApplyUseStateFrom(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (parent, controlItem, layout))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ChildControlOverridePath", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FinalizeControlHierarchy", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetBestMidPoint", 2usize
                        )
                    })
            });
        let __cordl_ret: u16 = unsafe {
            cordl_method_info.invoke_unchecked(self, (parent, startOffset))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn InsertChildControlOverride(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (parent, controlItem))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InsertControlBitRangeNode", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::InputSystem::InputControl,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (layout, variants, name, parent))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetFormat(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (control, controlItem))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Setup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (layout, variants, deviceDescription))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ShiftChildIndicesInHierarchyOneUp(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (device, startIndex, exceptControl))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+Layouts+InputDeviceBuilder+RefInstance"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
