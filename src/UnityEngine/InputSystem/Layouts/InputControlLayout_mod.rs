...
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+Layouts+InputControlLayout+ControlItem+Flags"
)]
#[repr(i32)]
...
impl crate::UnityEngine::InputSystem::Layouts::InputControlLayout {
    ...
    pub fn AddControlItems(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (_cordl_type, controlLayouts, layoutName))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn AddControlItemsFromMember(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (member, attributes, controlItems))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn AddControlItemsFromMembers(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (members, controlItems, layoutName))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ParseHeaderFieldsFromJson(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (json, name, baseLayouts, deviceMatcher))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToJson(
    ...
    pub fn VariantsMatch_Il2CppString_Il2CppString1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (expected, actual))?
        };
        Ok(__cordl_ret.into())
    }
...
impl crate::UnityEngine::InputSystem::Layouts::InputControlLayout_Cache {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::InputSystem::Layouts::InputControlLayout,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, throwIfNotFound))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+Layouts+InputControlLayout+CacheRefInstance"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+Layouts+InputControlLayout+Collection"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
impl crate::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection {
    ...
    pub fn AddMatcher(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (layout, matcher))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Allocate(
    ...
    pub fn ComputeDistanceInInheritanceHierarchy(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (firstLayout, secondLayout, distance))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::Utilities::InternedString = unsafe {
            cordl_method_info.invoke_unchecked(self, (control, cache))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsBasedOn(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (parentLayout, childLayout))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::Utilities::InternedString = unsafe {
            cordl_method_info.invoke_unchecked(self, (layoutType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ValueTypeIsAssignableFrom(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (layoutName, valueType))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+Layouts+InputControlLayout+ControlItem"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+InputSystem+Layouts+InputControlLayout+LayoutJson"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
impl crate::UnityEngine::InputSystem::Layouts::InputControlLayout_LayoutJson {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::Layouts::InputControlLayout_LayoutJson = unsafe {
            cordl_method_info.invoke_unchecked((), (layout))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToLayout(
...
impl crate::UnityEngine::InputSystem::Layouts::InputControlLayout_LayoutNotFoundException {
    ...
    pub fn _ctor_Il2CppString_Exception3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (message, innerException))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, message))?
        };
        Ok(__cordl_ret.into())
    }
