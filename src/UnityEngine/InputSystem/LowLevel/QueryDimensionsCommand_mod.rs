...
for crate::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand {
    ...
    const CLASS_NAME: &'static str = "QueryDimensionsCommand";
...
impl crate::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                crate::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 0usize
                )
            });
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand = unsafe {
