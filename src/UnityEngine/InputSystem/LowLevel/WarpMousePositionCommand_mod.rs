...
impl crate::UnityEngine::InputSystem::LowLevel::WarpMousePositionCommand {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::WarpMousePositionCommand as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
