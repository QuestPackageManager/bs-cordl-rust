#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+TouchState")]
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+TouchState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::LowLevel::TouchState {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
impl crate::UnityEngine::InputSystem::LowLevel::TouchState {
    ...
    pub fn set_isTapRelease(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_isTapRelease")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
