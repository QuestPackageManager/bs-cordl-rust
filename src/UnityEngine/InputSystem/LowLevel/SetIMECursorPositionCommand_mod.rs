#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+SetIMECursorPositionCommand")]
...
impl crate::UnityEngine::InputSystem::LowLevel::SetIMECursorPositionCommand {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::SetIMECursorPositionCommand =
            unsafe { cordl_method_info.invoke_unchecked((), (cursorPosition))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
