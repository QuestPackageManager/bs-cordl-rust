...
for crate::UnityEngine::InputSystem::LowLevel::AccelerometerState {
    ...
    const CLASS_NAME: &'static str = "AccelerometerState";
...
impl crate::UnityEngine::InputSystem::LowLevel::AccelerometerState {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::AccelerometerState as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                crate::UnityEngine::InputSystem::Utilities::FourCC,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::LowLevel::AccelerometerState as
