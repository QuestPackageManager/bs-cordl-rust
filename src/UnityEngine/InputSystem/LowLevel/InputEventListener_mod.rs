...
impl crate::UnityEngine::InputSystem::LowLevel::InputEventListener {
    #[cfg(feature = "UnityEngine+InputSystem+LowLevel+InputEventListener+DisposableObserver")]
    pub type DisposableObserver =
        crate::UnityEngine::InputSystem::LowLevel::InputEventListener_DisposableObserver;
    #[cfg(feature = "UnityEngine+InputSystem+LowLevel+InputEventListener+ObserverState")]
    pub type ObserverState =
        crate::UnityEngine::InputSystem::LowLevel::InputEventListener_ObserverState;
    pub fn Subscribe(
        &mut self,
    ...
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::LowLevel::InputEventListener>
    {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), crate::UnityEngine::InputSystem::LowLevel::InputEventListener, 2usize>(
                        "op_Addition",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::InputEventListener =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl__, callback))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::UnityEngine::InputSystem::LowLevel::InputEventPtr,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputDevice>,
                    ), quest_hook::libil2cpp::Void, 2usize>("<.ctor>b__2_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
