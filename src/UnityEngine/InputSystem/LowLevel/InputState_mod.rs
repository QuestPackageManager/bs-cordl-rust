...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+InputState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::LowLevel::InputState {
...
impl crate::UnityEngine::InputSystem::LowLevel::InputState {
    #[cfg(feature = "UnityEngine+InputSystem+LowLevel+InputState+StateChangeMonitorDelegate")]
    pub type StateChangeMonitorDelegate =
        crate::UnityEngine::InputSystem::LowLevel::InputState_StateChangeMonitorDelegate;
    ...
    pub fn AddChangeMonitor_IInputStateChangeMonitor_i64_u32_0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i64,
                        u32,
                    ), quest_hook::libil2cpp::Void, 4usize>("AddChangeMonitor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (control, monitor, monitorIndex, groupIndex))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::InputSystem::LowLevel::InputEventPtr,
                    ), quest_hook::libil2cpp::Void, 4usize>("Change")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (control, state, updateType, eventPtr))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Change_InputDevice_InputEventPtr0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::InputSystem::LowLevel::InputEventPtr,
                        crate::UnityEngine::InputSystem::LowLevel::InputUpdateType,
                    ), quest_hook::libil2cpp::Void, 3usize>("Change")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (device, eventPtr, updateType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RemoveChangeMonitor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (control, monitor, monitorIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn RemoveChangeMonitorTimeout(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (monitor, monitorIndex, timerIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn add_onChange(
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+InputState")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::LowLevel::InputState {
