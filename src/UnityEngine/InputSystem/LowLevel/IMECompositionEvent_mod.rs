...
impl crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::LowLevel::IMECompositionEvent as
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent = unsafe {
            method.invoke_unchecked((), (deviceId, compositionString, _cordl_time))?
        };
        Ok(__cordl_ret.into())
    }
