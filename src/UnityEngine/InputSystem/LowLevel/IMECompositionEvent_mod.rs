#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+IMECompositionEvent")]
...
impl crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent {
    ...
    pub fn Create(
        ...
        _cordl_time: f64,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent>
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        f64,
                    ), crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent, 3usize>(
                        "Create",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::IMECompositionEvent = unsafe {
            cordl_method_info.invoke_unchecked((), (deviceId, compositionString, _cordl_time))?
        };
        Ok(__cordl_ret.into())
    }
