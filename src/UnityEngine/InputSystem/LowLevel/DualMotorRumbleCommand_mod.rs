#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+DualMotorRumbleCommand")]
...
impl crate::UnityEngine::InputSystem::LowLevel::DualMotorRumbleCommand {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::DualMotorRumbleCommand =
            unsafe { cordl_method_info.invoke_unchecked((), (lowFrequency, highFrequency))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
