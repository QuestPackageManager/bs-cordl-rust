...
impl crate::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                crate::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand,
                0usize,
