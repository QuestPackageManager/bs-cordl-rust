#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+InputDeviceExecuteCommandDelegate")]
#[repr(C)]
...
impl crate::UnityEngine::InputSystem::LowLevel::InputDeviceExecuteCommandDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> =
            unsafe { cordl_method_info.invoke_unchecked(self, (command, callback, object))? };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        &mut self,
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked(self, (command, result))? };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
        &mut self,
