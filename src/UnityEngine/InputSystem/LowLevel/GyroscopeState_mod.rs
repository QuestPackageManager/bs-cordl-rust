...
for crate::UnityEngine::InputSystem::LowLevel::GyroscopeState {
    ...
    const CLASS_NAME: &'static str = "GyroscopeState";
...
impl crate::UnityEngine::InputSystem::LowLevel::GyroscopeState {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::GyroscopeState as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                crate::UnityEngine::InputSystem::Utilities::FourCC,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::LowLevel::GyroscopeState as
