...
impl crate::UnityEngine::InputSystem::LowLevel::InputEventTrace {
    ...
    pub fn OnInputEvent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (inputEvent, device))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Resize(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (newBufferSize, newMaxBufferSize))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_allocatedSizeInBytes", 0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_totalEventSizeInBytes", 0usize
                        )
                    })
            });
        let __cordl_ret: i64 = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
...
impl crate::UnityEngine::InputSystem::LowLevel::InputEventTrace_Enumerator {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (trace))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
...
impl crate::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ApplyDeviceMapping", 1usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked(self, (originalDeviceId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Dispose(
    ...
    pub fn MoveNext(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (skipFrameEvents, eventPtr))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (recordedDevice, playbackDevice))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (recordedDeviceId, playbackDeviceId))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
