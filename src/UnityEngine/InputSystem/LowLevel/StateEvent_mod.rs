...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+StateEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::LowLevel::StateEvent {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
impl crate::UnityEngine::InputSystem::LowLevel::StateEvent {
    ...
    pub type _stateData_e__FixedBuffer =
        crate::UnityEngine::InputSystem::LowLevel::StateEvent__stateData_e__FixedBuffer;
    pub fn FromDefaultStateFor(
        ...
        let __cordl_ret: crate::Unity::Collections::NativeArray_1<u8> =
            unsafe { cordl_method_info.invoke_unchecked((), (device, eventPtr, allocator))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::Unity::Collections::Allocator,
                        bool,
                    ), crate::Unity::Collections::NativeArray_1<u8>, 4usize>(
                        "From"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TState = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TState = unsafe { cordl_method_info.invoke_unchecked((), (ptr))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToEventPtr(
        &mut self,
