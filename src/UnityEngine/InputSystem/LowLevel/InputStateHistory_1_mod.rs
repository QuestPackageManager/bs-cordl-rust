    ...
    crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<TValue>
{
    ...
    pub type Record = crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<TValue>;
    pub fn AddRecord(
        &mut self,
        record: crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<TValue>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<
            TValue,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (control, value, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_Item(
        &mut self,
        index: i32,
        value: crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<TValue>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TValue: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
    ...
    crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<TValue>
{
    ...
    pub fn Equals_InputStateHistory_1_Record0(
        &mut self,
        other: crate::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<TValue>,
    ) -> quest_hook::libil2cpp::Result<bool>
    where
        TValue: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (owner, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_control(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputControl_1<TValue>>,
    >
    where
        TValue: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
