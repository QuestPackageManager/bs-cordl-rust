...
for crate::UnityEngine::InputSystem::LowLevel::JoystickState {
    ...
    const CLASS_NAME: &'static str = "JoystickState";
...
impl crate::UnityEngine::InputSystem::LowLevel::JoystickState {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::JoystickState as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                crate::UnityEngine::InputSystem::Utilities::FourCC,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::LowLevel::JoystickState as
...
for crate::UnityEngine::InputSystem::LowLevel::JoystickState_Button {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem.LowLevel";
    const CLASS_NAME: &'static str = "JoystickState/Button";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
