...
impl crate::UnityEngine::InputSystem::LowLevel::InputStateBlock {
    ...
    pub fn CopyToFrom(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (toStatePtr, fromStatePtr))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Write(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (statePtr, value))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteDouble(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_effectiveByteOffset", 0usize
                        )
                    })
            });
        let __cordl_ret: u32 = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
