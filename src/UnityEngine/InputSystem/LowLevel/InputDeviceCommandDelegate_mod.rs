#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+InputDeviceCommandDelegate")]
#[repr(C)]
    ...
    for crate::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate
{
    ...
    const CLASS_NAME: &'static str = "InputDeviceCommandDelegate";
...
impl std::ops::Deref for crate::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate {
...
#[cfg(feature = "UnityEngine+InputSystem+LowLevel+InputDeviceCommandDelegate")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate {
...
impl crate::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (device, command, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::InputDevice>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::System::Nullable_1<i64>, 2usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::Nullable_1<i64> =
            unsafe { cordl_method_info.invoke_unchecked(self, (device, command))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        object: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
