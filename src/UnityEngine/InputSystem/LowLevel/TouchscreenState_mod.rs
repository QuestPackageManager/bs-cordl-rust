...
for crate::UnityEngine::InputSystem::LowLevel::TouchscreenState {
    ...
    const CLASS_NAME: &'static str = "TouchscreenState";
...
impl crate::UnityEngine::InputSystem::LowLevel::TouchscreenState {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::TouchscreenState as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                crate::UnityEngine::InputSystem::Utilities::FourCC,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::LowLevel::TouchscreenState as
