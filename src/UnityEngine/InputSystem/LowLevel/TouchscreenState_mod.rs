...
impl crate::UnityEngine::InputSystem::LowLevel::TouchscreenState {
    ...
    #[cfg(feature = "UnityEngine+InputSystem+LowLevel+TouchscreenState+_touchData_e__FixedBuffer")]
    pub type _touchData_e__FixedBuffer =
        crate::UnityEngine::InputSystem::LowLevel::TouchscreenState__touchData_e__FixedBuffer;
    pub fn get_Format(
