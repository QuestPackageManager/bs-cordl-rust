#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+DeviceResetEvent")]
...
impl crate::UnityEngine::InputSystem::LowLevel::DeviceResetEvent {
    ...
    pub fn Create(
        ...
        hardReset: bool,
        _cordl_time: f64,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::LowLevel::DeviceResetEvent>
    {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::DeviceResetEvent =
            unsafe { cordl_method_info.invoke_unchecked((), (deviceId, hardReset, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
