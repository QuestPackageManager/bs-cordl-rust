...
impl crate::UnityEngine::InputSystem::LowLevel::IInputRuntime {
    pub fn AllocateDeviceId(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::IInputRuntime as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), i32, 0usize>("AllocateDeviceId")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::LowLevel::IInputRuntime as
