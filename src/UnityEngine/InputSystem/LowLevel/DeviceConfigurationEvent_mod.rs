#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+DeviceConfigurationEvent")]
...
impl crate::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent =
            unsafe { cordl_method_info.invoke_unchecked((), (deviceId, _cordl_time))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToEventPtr(
        &mut self,
