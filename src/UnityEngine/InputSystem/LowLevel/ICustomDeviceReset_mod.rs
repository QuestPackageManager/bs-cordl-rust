...
for crate::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset {
    ...
    const CLASS_NAME: &'static str = "ICustomDeviceReset";
...
impl crate::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset {
    pub fn Reset(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Reset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset as
