#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+PenState")]
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+PenState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::LowLevel::PenState {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem.LowLevel";
    const CLASS_NAME: &'static str = "PenState";
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+PenState")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::InputSystem::LowLevel::PenState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::InputSystem::LowLevel::PenState {
    pub fn WithButton(
        ...
        state: bool,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::LowLevel::PenState> {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::PenState =
            unsafe { cordl_method_info.invoke_unchecked(self, (button, state))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Format(
