    ...
    for crate::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate
{
    ...
    const CLASS_NAME: &'static str = "InputUpdateDelegate";
...
#[cfg(feature = "UnityEngine+InputSystem+LowLevel+InputUpdateDelegate")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate {
...
impl crate::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info.invoke_unchecked(self, (updateType, eventBuffer, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (eventBuffer, result))? };
        Ok(__cordl_ret.into())
    }
    pub fn Invoke(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (updateType, eventBuffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        object: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
