#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+SetSamplingFrequencyCommand")]
...
impl crate::UnityEngine::InputSystem::LowLevel::SetSamplingFrequencyCommand {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::SetSamplingFrequencyCommand =
            unsafe { cordl_method_info.invoke_unchecked((), (frequency))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
