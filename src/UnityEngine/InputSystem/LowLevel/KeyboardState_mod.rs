...
impl crate::UnityEngine::InputSystem::LowLevel::KeyboardState {
    ...
    pub type _keys_e__FixedBuffer =
        crate::UnityEngine::InputSystem::LowLevel::KeyboardState__keys_e__FixedBuffer;
    pub fn Press(
        &mut self,
    ...
    pub fn Set(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, state))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (pressedKeys))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Format(
