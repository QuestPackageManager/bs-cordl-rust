#[cfg(feature = "cordl_class_UnityEngine+InputSystem+LowLevel+DeviceRemoveEvent")]
...
impl crate::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent {
    ...
    pub fn Create(
        deviceId: i32,
        _cordl_time: f64,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent>
    {
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent =
