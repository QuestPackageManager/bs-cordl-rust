...
pub struct NativeInputRuntime {
    ...
    pub m_OnUpdate:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate>,
    pub m_OnBeforeUpdate: quest_hook::libil2cpp::Gc<
        crate::System::Action_1<crate::UnityEngine::InputSystem::LowLevel::InputUpdateType>,
    >,
    pub m_OnShouldRunUpdate: quest_hook::libil2cpp::Gc<
        crate::System::Func_2<crate::UnityEngine::InputSystem::LowLevel::InputUpdateType, bool>,
    >,
...
#[cfg(feature = "UnityEngine+InputSystem+LowLevel+NativeInputRuntime")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::LowLevel::NativeInputRuntime {
...
impl crate::UnityEngine::InputSystem::LowLevel::NativeInputRuntime {
    ...
    pub fn DeviceCommand(
        ...
        let __cordl_ret: i64 =
            unsafe { cordl_method_info.invoke_unchecked(self, (deviceId, commandPtr))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OnShutdown(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn Update(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (updateType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_currentTimeForFixedUpdate(&mut self) -> quest_hook::libil2cpp::Result<f64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_currentTimeOffsetToRealtimeSinceStartup(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f64, 0usize>("get_currentTimeOffsetToRealtimeSinceStartup")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_normalizeScrollWheelDelta(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_normalizeScrollWheelDelta")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_onPlayerFocusChanged", 0usize
                        )
                    })
            });
    ...
    pub fn get_screenOrientation(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::ScreenOrientation, 0usize>(
        ...
        let __cordl_ret: crate::UnityEngine::ScreenOrientation =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_screenSize(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector2> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_scrollWheelDeltaPerTick(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f32, 0usize>("get_scrollWheelDeltaPerTick")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_normalizeScrollWheelDelta(
        &mut self,
        value: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_onPlayerFocusChanged", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_onUpdate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
impl AsMut<crate::UnityEngine::InputSystem::LowLevel::IInputRuntime>
    for crate::UnityEngine::InputSystem::LowLevel::NativeInputRuntime
{
    fn as_mut(&mut self) -> &mut crate::UnityEngine::InputSystem::LowLevel::IInputRuntime {
        unsafe { std::mem::transmute(self) }
    }
}
