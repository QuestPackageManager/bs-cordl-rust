...
for crate::UnityEngine::InputSystem::Android::AndroidGyroscope {
    ...
    const CLASS_NAME: &'static str = "AndroidGyroscope";
...
impl crate::UnityEngine::InputSystem::Android::AndroidGyroscope {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Android::AndroidGyroscope as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Android::AndroidGyroscope as
