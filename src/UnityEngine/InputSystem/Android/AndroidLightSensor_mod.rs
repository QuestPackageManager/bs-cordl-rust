...
for crate::UnityEngine::InputSystem::Android::AndroidLightSensor {
    ...
    const CLASS_NAME: &'static str = "AndroidLightSensor";
...
#[cfg(feature = "UnityEngine+InputSystem+Android+AndroidLightSensor")]
impl crate::UnityEngine::InputSystem::Android::AndroidLightSensor {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Android::AndroidLightSensor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Android::AndroidLightSensor as
