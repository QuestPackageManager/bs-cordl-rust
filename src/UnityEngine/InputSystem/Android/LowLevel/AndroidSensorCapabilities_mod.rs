...
impl crate::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorCapabilities {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorCapabilities as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
        ...
        let __cordl_ret: crate::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorCapabilities = unsafe {
