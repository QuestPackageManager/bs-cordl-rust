...
for crate::UnityEngine::InputSystem::Android::AndroidGamepadWithDpadAxes {
    ...
    const CLASS_NAME: &'static str = "AndroidGamepadWithDpadAxes";
...
#[cfg(feature = "UnityEngine+InputSystem+Android+AndroidGamepadWithDpadAxes")]
impl crate::UnityEngine::InputSystem::Android::AndroidGamepadWithDpadAxes {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Android::AndroidGamepadWithDpadAxes as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Android::AndroidGamepadWithDpadAxes
