...
for crate::UnityEngine::InputSystem::Android::DualShock4GamepadAndroid {
    ...
    const CLASS_NAME: &'static str = "DualShock4GamepadAndroid";
...
impl crate::UnityEngine::InputSystem::Android::DualShock4GamepadAndroid {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Android::DualShock4GamepadAndroid as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::InputSystem::Android::DualShock4GamepadAndroid
