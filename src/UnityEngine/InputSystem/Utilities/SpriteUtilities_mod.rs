#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+SpriteUtilities")]
#[repr(C)]
#[derive(Debug)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateCircleSprite", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Sprite> =
            unsafe { cordl_method_info.invoke_unchecked((), (radius, colour))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+SpriteUtilities")]
