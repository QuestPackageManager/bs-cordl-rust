...
unsafe impl<TSource: quest_hook::libil2cpp::Type, TResult: quest_hook::libil2cpp::Type>
    ...
    for crate::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>
{
    ...
    crate::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>
{
    ...
    pub type Select =
        crate::UnityEngine::InputSystem::Utilities::SelectManyObservable_2_Select<TSource, TResult>;
    pub fn New(
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+SelectManyObservable_2+Select")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
...
unsafe impl<TSource: quest_hook::libil2cpp::Type, TResult: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::UnityEngine::InputSystem::Utilities::SelectManyObservable_2_Select<TSource, TResult>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem.Utilities";
