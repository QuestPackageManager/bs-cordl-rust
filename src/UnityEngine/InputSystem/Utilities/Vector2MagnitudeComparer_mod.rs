...
impl crate::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer
