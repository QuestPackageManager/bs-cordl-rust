#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+Vector2MagnitudeComparer")]
    ...
    for crate::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::Collections::Generic::IComparer_1<crate::UnityEngine::Vector2> {
        todo!()
    }
}
