...
impl crate::UnityEngine::InputSystem::Utilities::NumberHelpers {
    pub fn AlignToMultipleOf_i32_i32_0(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (number, alignment))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn NormalizedFloatToInt(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, intMinValue, intMaxValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn NormalizedFloatToUInt(
        ...
        let __cordl_ret: u32 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, uintMinValue, uintMaxValue))? };
        Ok(__cordl_ret.into())
    }
    pub fn RemapUIntBitsToNormalizeFloatToUIntBits(
        ...
        let __cordl_ret: u32 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, inBitSize, outBitSize))? };
        Ok(__cordl_ret.into())
    }
