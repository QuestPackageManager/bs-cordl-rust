#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+ReadOnlyArrayExtensions")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::InputSystem::Utilities::ReadOnlyArrayExtensions {
...
#[cfg(feature = "UnityEngine+InputSystem+Utilities+ReadOnlyArrayExtensions")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::Utilities::ReadOnlyArrayExtensions {
...
impl crate::UnityEngine::InputSystem::Utilities::ReadOnlyArrayExtensions {
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        i32,
                    ), bool, 3usize>("HaveEqualReferences")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (array1, array2, count))? };
        Ok(__cordl_ret.into())
    }
