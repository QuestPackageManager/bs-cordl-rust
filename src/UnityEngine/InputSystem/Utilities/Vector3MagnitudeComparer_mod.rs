...
for crate::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer {
    ...
    const CLASS_NAME: &'static str = "Vector3MagnitudeComparer";
...
impl crate::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer {
    pub fn Compare(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer
