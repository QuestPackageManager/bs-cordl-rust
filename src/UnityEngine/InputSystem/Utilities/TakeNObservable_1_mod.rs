#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+TakeNObservable_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    crate::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>
{
    ...
    pub type Take = crate::UnityEngine::InputSystem::Utilities::TakeNObservable_1_Take<TValue>;
    pub fn New(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (source, count))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+TakeNObservable_1")]
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Utilities+TakeNObservable_1+Take")]
#[repr(C)]
#[derive(Debug)]
