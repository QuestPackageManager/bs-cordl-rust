...
pub struct Touchscreen {
    ...
    pub _primaryTouch_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::TouchControl>,
    pub _touches_k__BackingField: crate::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::TouchControl>,
    >,
}
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Touchscreen")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::Touchscreen {
...
impl crate::UnityEngine::InputSystem::Touchscreen {
    ...
    pub fn TriggerTap(
        control: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::TouchControl>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        crate::UnityEngine::InputSystem::LowLevel::InputEventPtr,
                    ), quest_hook::libil2cpp::Void, 3usize>("TriggerTap")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (control, state, eventPtr))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_GetStateOffsetForEvent(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (control, eventPtr, offset))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_primaryTouch(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::TouchControl>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::TouchControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_primaryTouch")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::InputSystem::Controls::TouchControl,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_touches")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
impl AsMut<crate::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset>
    for crate::UnityEngine::InputSystem::Touchscreen
{
    fn as_mut(&mut self) -> &mut crate::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+InputSystem+Touchscreen")]
