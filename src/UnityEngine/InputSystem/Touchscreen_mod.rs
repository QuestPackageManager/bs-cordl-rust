...
impl crate::UnityEngine::InputSystem::Touchscreen {
    ...
    pub fn TriggerTap(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (control, state, eventPtr))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_GetStateOffsetForEvent(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (control, eventPtr, offset))?
        };
        Ok(__cordl_ret.into())
    }
