...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+StepCounter")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::StepCounter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem";
    const CLASS_NAME: &'static str = "StepCounter";
...
impl crate::UnityEngine::InputSystem::StepCounter {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::StepCounter> =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::IntegerControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_stepCounter")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
