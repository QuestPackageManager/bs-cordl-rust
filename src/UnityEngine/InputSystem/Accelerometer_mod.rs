...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Accelerometer")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputSystem::Accelerometer {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.InputSystem";
    const CLASS_NAME: &'static str = "Accelerometer";
...
impl crate::UnityEngine::InputSystem::Accelerometer {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Accelerometer> =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::Vector3Control,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_acceleration")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+InputSystem+Accelerometer")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::InputSystem::Accelerometer {
