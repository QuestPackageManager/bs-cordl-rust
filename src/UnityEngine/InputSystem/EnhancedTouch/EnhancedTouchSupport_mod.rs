#[cfg(feature = "cordl_class_UnityEngine+InputSystem+EnhancedTouch+EnhancedTouchSupport")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::InputSystem::EnhancedTouch::EnhancedTouchSupport {
...
#[cfg(feature = "UnityEngine+InputSystem+EnhancedTouch+EnhancedTouchSupport")]
impl std::ops::DerefMut for crate::UnityEngine::InputSystem::EnhancedTouch::EnhancedTouchSupport {
...
impl crate::UnityEngine::InputSystem::EnhancedTouch::EnhancedTouchSupport {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("CheckEnabled")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn OnSettingsChange() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn TearDownState() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("TearDownState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
