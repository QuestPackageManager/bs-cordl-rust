...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::RangeInt {
    ...
    const CLASS_NAME: &'static str = "RangeInt";
...
impl crate::UnityEngine::RangeInt {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::RangeInt as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32, i32), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::RangeInt as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 2usize
                )
            });
