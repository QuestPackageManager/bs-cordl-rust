#[cfg(feature = "cordl_class_UnityEngine+ColorUsageAttribute")]
#[repr(C)]
...
impl crate::UnityEngine::ColorUsageAttribute {
    ...
    pub fn _ctor__cordl_bool0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (showAlpha))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (showAlpha, hdr))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+ColorUsageAttribute")]
