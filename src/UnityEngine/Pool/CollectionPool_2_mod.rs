...
#[cfg(feature = "cordl_class_UnityEngine+Pool+CollectionPool_2")]
unsafe impl<TCollection: quest_hook::libil2cpp::Type, TItem: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::UnityEngine::Pool::CollectionPool_2<TCollection, TItem>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Pool", "CollectionPool`2")
                .unwrap()
...
impl<TCollection: quest_hook::libil2cpp::Type, TItem: quest_hook::libil2cpp::Type> std::ops::Deref
...
#[cfg(feature = "UnityEngine+Pool+CollectionPool_2")]
impl<TCollection: quest_hook::libil2cpp::Type, TItem: quest_hook::libil2cpp::Type>
    ...
    crate::UnityEngine::Pool::CollectionPool_2<TCollection, TItem>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TCollection = unsafe { cordl_method_info.invoke_unchecked((), ())? };
        Ok(__cordl_ret.into())
    }
    pub fn Get_ByRefMut1(
        value: quest_hook::libil2cpp::ByRefMut<TCollection>,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Pool::PooledObject_1<TCollection>>
    where
        TCollection: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::UnityEngine::Pool::PooledObject_1<TCollection> =
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(TCollection), quest_hook::libil2cpp::Void, 1usize>(
                        "Release",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
