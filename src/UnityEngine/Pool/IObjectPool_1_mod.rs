...
for crate::UnityEngine::Pool::IObjectPool_1<T> {
    ...
    const CLASS_NAME: &'static str = "IObjectPool`1";
...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::Pool::IObjectPool_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Pool::IObjectPool_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Pool::IObjectPool_1 < T > as
