#[cfg(feature = "cordl_class_UnityEngine+Yoga+YogaConfig")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Yoga::YogaConfig {
    ...
    pub fn _ctor_IntPtr0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (ygConfig))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Handle(
