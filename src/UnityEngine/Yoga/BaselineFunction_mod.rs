...
#[cfg(feature = "UnityEngine+Yoga+BaselineFunction")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Yoga::BaselineFunction {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Yoga";
    const CLASS_NAME: &'static str = "BaselineFunction";
...
impl crate::UnityEngine::Yoga::BaselineFunction {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Yoga::BaselineFunction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Yoga::BaselineFunction as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 3usize
                )
            });
        let __cordl_ret: f32 = unsafe {
            method.invoke_unchecked(self, (node, width, height))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
