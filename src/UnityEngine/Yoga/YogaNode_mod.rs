...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Yoga::YogaNode {
    ...
    const CLASS_NAME: &'static str = "YogaNode";
...
impl crate::UnityEngine::Yoga::YogaNode {
    pub fn BaselineInternal(
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info.invoke_unchecked((), (node, width, height))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CopyStyle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (srcNode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Finalize(
    ...
    pub fn Insert(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, node))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn MarkDirty(
    ...
    pub fn MeasureInternal(
        ...
        let __cordl_ret: crate::UnityEngine::Yoga::YogaSize = unsafe {
            cordl_method_info
                .invoke_unchecked((), (node, width, widthMode, height, heightMode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn SetMeasureFunction(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (measureFunction))?
        };
        Ok(__cordl_ret.into())
    }
