#[cfg(feature = "cordl_class_UnityEngine+Yoga+YogaValue")]
#[repr(C)]
...
impl crate::UnityEngine::Yoga::YogaValue {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Percent",
                            1usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Point",
                            1usize
                        )
                    })
            });
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (),
                        crate::UnityEngine::Yoga::YogaUnit,
                        0usize,
                    >("get_Unit")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn op_Implicit(
        ...
        let __cordl_ret: crate::UnityEngine::Yoga::YogaValue = unsafe {
            cordl_method_info.invoke_unchecked((), (pointValue))?
        };
        Ok(__cordl_ret.into())
    }
}
