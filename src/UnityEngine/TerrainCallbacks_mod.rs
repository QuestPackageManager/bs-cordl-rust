...
impl crate::UnityEngine::TerrainCallbacks {
    ...
    pub type HeightmapChangedCallback =
        crate::UnityEngine::TerrainCallbacks_HeightmapChangedCallback;
    ...
    pub fn InvokeHeightmapChangedCallback(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (terrainData, heightRegion, synched))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "UnityEngine+TerrainCallbacks+HeightmapChangedCallback")]
impl std::ops::DerefMut for crate::UnityEngine::TerrainCallbacks_HeightmapChangedCallback {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::UnityEngine::TerrainCallbacks_HeightmapChangedCallback {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (terrain, heightRegion, synched))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::UnityEngine::TerrainCallbacks_TextureChangedCallback {
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (terrain, textureName, texelRegion, synched))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
