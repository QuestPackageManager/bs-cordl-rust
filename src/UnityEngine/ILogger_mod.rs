...
impl crate::UnityEngine::ILogger {
    pub fn LogError(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ILogger as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ILogger as quest_hook::libil2cpp::Type >
