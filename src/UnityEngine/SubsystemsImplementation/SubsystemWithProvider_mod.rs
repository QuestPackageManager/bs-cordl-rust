#[cfg(feature = "cordl_class_UnityEngine+SubsystemsImplementation+SubsystemWithProvider")]
#[repr(C)]
#[derive(Debug)]
pub struct SubsystemWithProvider {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _running_k__BackingField: bool,
    pub _providerBase_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::SubsystemsImplementation::SubsystemProvider>,
}
#[cfg(feature = "cordl_class_UnityEngine+SubsystemsImplementation+SubsystemWithProvider")]
    ...
    for crate::UnityEngine::SubsystemsImplementation::SubsystemWithProvider
{
    ...
    const CLASS_NAME: &'static str = "SubsystemWithProvider";
...
impl std::ops::Deref for crate::UnityEngine::SubsystemsImplementation::SubsystemWithProvider {
...
#[cfg(feature = "UnityEngine+SubsystemsImplementation+SubsystemWithProvider")]
impl std::ops::DerefMut for crate::UnityEngine::SubsystemsImplementation::SubsystemWithProvider {
...
impl crate::UnityEngine::SubsystemsImplementation::SubsystemWithProvider {
    ...
    pub fn OnStop(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnStop")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_running(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_running")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
