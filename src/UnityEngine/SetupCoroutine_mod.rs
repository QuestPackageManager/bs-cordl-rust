#[cfg(feature = "cordl_class_UnityEngine+SetupCoroutine")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+SetupCoroutine")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::SetupCoroutine {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "SetupCoroutine";
...
impl crate::UnityEngine::SetupCoroutine {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject> =
            unsafe { cordl_method_info.invoke_unchecked((), (behaviour, name, variable))? };
        Ok(__cordl_ret.into())
    }
    pub fn InvokeMoveNext(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                    ), quest_hook::libil2cpp::Void, 2usize>("InvokeMoveNext")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (enumerator, returnValueAddress))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+SetupCoroutine")]
