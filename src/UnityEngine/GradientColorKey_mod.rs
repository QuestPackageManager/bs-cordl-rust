...
#[cfg(feature = "UnityEngine+GradientColorKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::GradientColorKey {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "GradientColorKey";
...
impl crate::UnityEngine::GradientColorKey {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::GradientColorKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::GradientColorKey as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (col, _cordl_time))?
        };
        Ok(__cordl_ret.into())
    }
}
