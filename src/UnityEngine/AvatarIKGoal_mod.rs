#[cfg(feature = "cordl_class_UnityEngine+AvatarIKGoal")]
...
#[cfg(feature = "cordl_class_UnityEngine+AvatarIKGoal")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AvatarIKGoal {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AvatarIKGoal";
