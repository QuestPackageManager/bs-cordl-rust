...
impl crate::UnityEngine::Animations::AnimationOffsetPlayable {
    pub fn Create(
        ...
        inputCount: i32,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Animations::AnimationOffsetPlayable>
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                    ), crate::UnityEngine::Animations::AnimationOffsetPlayable, 4usize>(
                        "Create"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Animations::AnimationOffsetPlayable = unsafe {
            cordl_method_info.invoke_unchecked((), (graph, position, rotation, inputCount))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateHandle(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::Quaternion,
                        i32,
                    ), crate::UnityEngine::Playables::PlayableHandle, 4usize>(
                        "CreateHandle"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn CreateHandleInternal(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                    ), bool, 4usize>("CreateHandleInternal")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (graph, position, rotation, handle))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            crate::UnityEngine::Playables::PlayableHandle,
                        >,
                    ), bool, 4usize>("CreateHandleInternal_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+Animations+AnimationOffsetPlayable")]
impl AsRef<crate::System::IEquatable_1<crate::UnityEngine::Animations::AnimationOffsetPlayable>>
    for crate::UnityEngine::Animations::AnimationOffsetPlayable
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+Animations+AnimationOffsetPlayable")]
impl AsMut<crate::System::IEquatable_1<crate::UnityEngine::Animations::AnimationOffsetPlayable>>
    for crate::UnityEngine::Animations::AnimationOffsetPlayable
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::UnityEngine::Animations::AnimationOffsetPlayable>
    {
        todo!()
    }
}
