#[cfg(feature = "cordl_class_UnityEngine+Animations+AnimationPlayableGraphExtensions")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::Animations::AnimationPlayableGraphExtensions {
...
#[cfg(feature = "UnityEngine+Animations+AnimationPlayableGraphExtensions")]
impl std::ops::DerefMut for crate::UnityEngine::Animations::AnimationPlayableGraphExtensions {
...
impl crate::UnityEngine::Animations::AnimationPlayableGraphExtensions {
    pub fn InternalCreateAnimationOutput(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            crate::UnityEngine::Playables::PlayableOutputHandle,
                        >,
                    ), bool, 3usize>("InternalCreateAnimationOutput")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (graph, name, handle))? };
        Ok(__cordl_ret.into())
    }
    pub fn InternalCreateAnimationOutput_Injected(
        graph: quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Playables::PlayableGraph>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            crate::UnityEngine::Playables::PlayableOutputHandle,
                        >,
                    ), bool, 3usize>("InternalCreateAnimationOutput_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
