...
for crate::UnityEngine::AddressableAssets::AssetReferenceGameObject {
    ...
    const CLASS_NAME: &'static str = "AssetReferenceGameObject";
...
impl crate::UnityEngine::AddressableAssets::AssetReferenceGameObject {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AddressableAssets::AssetReferenceGameObject as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AddressableAssets::AssetReferenceGameObject as
