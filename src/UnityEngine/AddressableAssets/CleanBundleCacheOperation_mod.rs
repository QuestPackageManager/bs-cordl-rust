...
impl std::ops::Deref for crate::UnityEngine::AddressableAssets::CleanBundleCacheOperation {
    type Target =
        crate::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<bool>;
...
#[cfg(feature = "UnityEngine+AddressableAssets+CleanBundleCacheOperation")]
impl std::ops::DerefMut for crate::UnityEngine::AddressableAssets::CleanBundleCacheOperation {
...
impl crate::UnityEngine::AddressableAssets::CleanBundleCacheOperation {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), quest_hook::libil2cpp::Void, 3usize>("CompleteInternal")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn DetermineCacheDirsNotInUse_HashSet_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cacheDirsInUse))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (aa, forceSingleThreading))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+CleanBundleCacheOperation")]
