...
impl crate::UnityEngine::AddressableAssets::Utility::DiagnosticInfo {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AddressableAssets::Utility::DiagnosticInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AddressableAssets::Utility::DiagnosticInfo as
                    quest_hook::libil2cpp::Type > ::class(), "CreateEvent", 4usize
                )
            });
