#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+Utility+SerializationUtilities")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::AddressableAssets::Utility::SerializationUtilities {
...
#[cfg(feature = "UnityEngine+AddressableAssets+Utility+SerializationUtilities")]
impl std::ops::DerefMut for crate::UnityEngine::AddressableAssets::Utility::SerializationUtilities {
...
impl crate::UnityEngine::AddressableAssets::Utility::SerializationUtilities {
    #[cfg(feature = "UnityEngine+AddressableAssets+Utility+SerializationUtilities+ObjectType")]
    pub type ObjectType =
        crate::UnityEngine::AddressableAssets::Utility::SerializationUtilities_ObjectType;
    pub fn ReadInt32FromByteArray(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                    ), i32, 2usize>("ReadInt32FromByteArray")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (data, offset))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteInt32ToByteArray(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), i32, 3usize>("WriteInt32ToByteArray")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (data, val, offset))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteObjectToByteList(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<u8>>,
                    ), i32, 2usize>("WriteObjectToByteList")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (obj, buffer))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+Utility+SerializationUtilities")]
