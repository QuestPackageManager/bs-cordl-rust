#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+ResourceLocators+ResourceLocationData")]
#[repr(C)]
#[derive(Debug)]
pub struct ResourceLocationData {
    ...
    pub SerializedData: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    for crate::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationData
{
    ...
    const CLASS_NAME: &'static str = "ResourceLocationData";
...
impl crate::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationData {
    pub fn New(
        ...
        provider: quest_hook::libil2cpp::Gc<crate::System::Type>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keys, id, provider, t, dependencies))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Data(
