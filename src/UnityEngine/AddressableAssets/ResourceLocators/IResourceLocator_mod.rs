#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+ResourceLocators+IResourceLocator")]
...
impl std::ops::Deref for crate::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator {
