...
#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+AssetReference")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AddressableAssets::AssetReference {
...
impl crate::UnityEngine::AddressableAssets::AssetReference {
    pub fn CreateFailedOperation<T>() -> quest_hook::libil2cpp::Result<
        crate::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T>,
    >
    where
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (loadMode, activateOnLoad, priority))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReleaseAsset(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+AssetReference")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::AddressableAssets::AssetReference {
