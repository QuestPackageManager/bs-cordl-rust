...
for crate::UnityEngine::AddressableAssets::AssetReferenceTexture2D {
    ...
    const CLASS_NAME: &'static str = "AssetReferenceTexture2D";
...
impl crate::UnityEngine::AddressableAssets::AssetReferenceTexture2D {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AddressableAssets::AssetReferenceTexture2D as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AddressableAssets::AssetReferenceTexture2D as
