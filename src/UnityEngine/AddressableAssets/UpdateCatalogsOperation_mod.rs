...
#[cfg(feature = "UnityEngine+AddressableAssets+UpdateCatalogsOperation")]
impl std::ops::DerefMut for crate::UnityEngine::AddressableAssets::UpdateCatalogsOperation {
...
impl crate::UnityEngine::AddressableAssets::UpdateCatalogsOperation {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "OnCleanCacheCompleted", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (handle, catalogs))? };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (catalogIds, autoCleanBundleCache))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
