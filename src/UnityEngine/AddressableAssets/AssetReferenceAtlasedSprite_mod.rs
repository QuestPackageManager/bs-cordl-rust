...
impl crate::UnityEngine::AddressableAssets::AssetReferenceAtlasedSprite {
    ...
    pub fn ValidateAsset_Il2CppString1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AddressableAssets::AssetReferenceAtlasedSprite as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AddressableAssets::AssetReferenceAtlasedSprite
