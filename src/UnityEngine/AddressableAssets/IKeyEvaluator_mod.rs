#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+IKeyEvaluator")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+IKeyEvaluator")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AddressableAssets::IKeyEvaluator {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.AddressableAssets";
    const CLASS_NAME: &'static str = "IKeyEvaluator";
...
#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+IKeyEvaluator")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::AddressableAssets::IKeyEvaluator {
