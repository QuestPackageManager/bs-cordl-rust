#[cfg(feature = "cordl_class_UnityEngine+AddressableAssets+Initialization+InitializationOperation")]
#[repr(C)]
...
impl crate::UnityEngine::AddressableAssets::Initialization::InitializationOperation {
    pub fn CreateInitializationOperation(
        aa: quest_hook::libil2cpp::Gc<crate::UnityEngine::AddressableAssets::AddressablesImpl>,
        playerSettingsLocation: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ...
    pub fn LoadOpComplete(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (op, catalogs, locMap, index, remoteHashLocation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn LoadProvider(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("LoadProvider")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (addressables, providerData, providerSuffix))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (aa))? };
        Ok(__cordl_ret.into())
    }
