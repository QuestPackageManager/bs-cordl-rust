...
#[cfg(feature = "UnityEngine+AddressableAssets+CheckCatalogsOperation")]
impl std::ops::DerefMut for crate::UnityEngine::AddressableAssets::CheckCatalogsOperation {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ProcessDependentOpResults", 5usize
                        )
                    })
            });
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<
            quest_hook::libil2cpp::Gc<
                ...
                >,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (locatorInfos))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
