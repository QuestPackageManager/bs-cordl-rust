#[cfg(feature = "cordl_class_UnityEngine+Pose")]
...
#[cfg(feature = "cordl_class_UnityEngine+Pose")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Pose {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Pose")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::Pose {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Pose")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::Pose {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Pose")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::Pose {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Pose")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::Pose {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::Pose {
    ...
    pub fn Equals_Pose1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::Pose), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetTransformedBy(
        ...
        let __cordl_ret: crate::UnityEngine::Pose =
            unsafe { cordl_method_info.invoke_unchecked(self, (lhs))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
        &mut self,
    ...
    pub fn get_identity() -> quest_hook::libil2cpp::Result<crate::UnityEngine::Pose> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::UnityEngine::Pose, 0usize>("get_identity")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+Pose")]
impl AsRef<crate::System::IEquatable_1<crate::UnityEngine::Pose>> for crate::UnityEngine::Pose {
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::Pose> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Pose")]
impl AsMut<crate::System::IEquatable_1<crate::UnityEngine::Pose>> for crate::UnityEngine::Pose {
