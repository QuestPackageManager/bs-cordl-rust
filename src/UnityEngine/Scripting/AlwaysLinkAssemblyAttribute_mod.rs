...
for crate::UnityEngine::Scripting::AlwaysLinkAssemblyAttribute {
    ...
    const CLASS_NAME: &'static str = "AlwaysLinkAssemblyAttribute";
...
#[cfg(feature = "UnityEngine+Scripting+AlwaysLinkAssemblyAttribute")]
impl crate::UnityEngine::Scripting::AlwaysLinkAssemblyAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Scripting::AlwaysLinkAssemblyAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Scripting::AlwaysLinkAssemblyAttribute as
