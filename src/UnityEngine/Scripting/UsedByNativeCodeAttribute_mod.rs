...
for crate::UnityEngine::Scripting::UsedByNativeCodeAttribute {
    ...
    const CLASS_NAME: &'static str = "UsedByNativeCodeAttribute";
...
#[cfg(feature = "UnityEngine+Scripting+UsedByNativeCodeAttribute")]
impl crate::UnityEngine::Scripting::UsedByNativeCodeAttribute {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Scripting::UsedByNativeCodeAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Scripting::UsedByNativeCodeAttribute as
