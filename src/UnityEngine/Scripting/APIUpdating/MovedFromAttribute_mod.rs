...
impl crate::UnityEngine::Scripting::APIUpdating::MovedFromAttribute {
    ...
    pub fn _ctor_Il2CppString1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Scripting::APIUpdating::MovedFromAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Scripting::APIUpdating::MovedFromAttribute as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sourceNamespace))?
        };
        Ok(__cordl_ret.into())
    }
