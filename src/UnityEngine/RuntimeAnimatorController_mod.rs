...
#[cfg(feature = "cordl_class_UnityEngine+RuntimeAnimatorController")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::RuntimeAnimatorController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "RuntimeAnimatorController";
...
impl crate::UnityEngine::RuntimeAnimatorController {
    ...
    pub fn get_animationClips_Injected(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::System::IntPtr), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimationClip>,
                        >,
                    >, 1usize>("get_animationClips_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+RuntimeAnimatorController")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::RuntimeAnimatorController {
