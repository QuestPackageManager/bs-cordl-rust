...
impl crate::UnityEngine::ResourcesAPIInternal {
    ...
    pub fn FindShaderByName_Injected(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "FindShaderByName_Injected", 1usize
                        )
                    })
            });
