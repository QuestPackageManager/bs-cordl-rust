#[cfg(feature = "cordl_class_UnityEngine+RaycastHit")]
...
impl crate::UnityEngine::RaycastHit {
    pub fn CalculateRaycastTexCoord(
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 = unsafe {
            cordl_method_info
                .invoke_unchecked((), (colliderInstanceID, uv, pos, face, textcoord))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CalculateRaycastTexCoord_Injected(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (colliderInstanceID, uv, pos, face, textcoord, ret))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_barycentricCoordinate", 1usize
                        )
                    })
            });
