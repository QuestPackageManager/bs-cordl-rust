...
#[cfg(feature = "cordl_class_UnityEngine+TerrainUtils+TerrainMap")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TerrainUtils::TerrainMap {
...
impl crate::UnityEngine::TerrainUtils::TerrainMap {
    pub fn AddTerrainInternal(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::Terrain>,
                    ), quest_hook::libil2cpp::Void, 3usize>("AddTerrainInternal")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, z, terrain))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateFromPlacement_Terrain_Predicate_1__cordl_bool0(
        ...
        filter: quest_hook::libil2cpp::Gc<
            crate::System::Predicate_1<quest_hook::libil2cpp::Gc<crate::UnityEngine::Terrain>>,
        >,
        fullValidation: bool,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::TerrainUtils::TerrainMap> = unsafe {
            cordl_method_info.invoke_unchecked((), (originTerrain, filter, fullValidation))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetTerrain(
        ...
        tileX: i32,
        tileZ: i32,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::Terrain>> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Terrain> =
            unsafe { cordl_method_info.invoke_unchecked(self, (tileX, tileZ))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TryToAddTerrain(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (tileX, tileZ, terrain))? };
        Ok(__cordl_ret.into())
    }
    pub fn Validate(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::TerrainUtils::TerrainMapStatusCode> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::UnityEngine::TerrainUtils::TerrainMapStatusCode =
