#[cfg(feature = "cordl_class_UnityEngine+TerrainUtils+TerrainUtility")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+TerrainUtils+TerrainUtility")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TerrainUtils::TerrainUtility {
...
impl crate::UnityEngine::TerrainUtils::TerrainUtility {
    ...
    pub fn ClearConnectivity() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::Dictionary_2<
                ...
                quest_hook::libil2cpp::Gc<crate::UnityEngine::TerrainUtils::TerrainMap>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (onlyAutoConnectedTerrains))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+TerrainUtils+TerrainUtility")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::TerrainUtils::TerrainUtility {
