#[cfg(feature = "cordl_class_UnityEngine+ScriptableObject")]
#[repr(C)]
...
impl crate::UnityEngine::ScriptableObject {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::ScriptableObject> = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_type, applyDefaultsAndReset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateScriptableObjectInstanceFromType_Injected(
        _cordl_type: quest_hook::libil2cpp::Gc<crate::System::Type>,
        applyDefaultsAndReset: bool,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateScriptableObjectInstanceFromType_Injected", 2usize
                        )
                    })
            });
