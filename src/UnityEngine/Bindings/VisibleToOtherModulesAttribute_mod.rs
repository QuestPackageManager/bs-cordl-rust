...
for crate::UnityEngine::Bindings::VisibleToOtherModulesAttribute {
    ...
    const CLASS_NAME: &'static str = "VisibleToOtherModulesAttribute";
...
impl crate::UnityEngine::Bindings::VisibleToOtherModulesAttribute {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::VisibleToOtherModulesAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Bindings::VisibleToOtherModulesAttribute as
    ...
    pub fn _ctor_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (modules))?
        };
        Ok(__cordl_ret.into())
    }
}
