#[cfg(feature = "cordl_class_UnityEngine+Bindings+NativeTypeAttribute")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct NativeTypeAttribute {
    __cordl_parent: crate::System::Attribute,
    pub _Header_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _IntermediateScriptingStructName_k__BackingField:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _CodegenOptions_k__BackingField: crate::UnityEngine::Bindings::CodegenOptions,
}
#[cfg(feature = "cordl_class_UnityEngine+Bindings+NativeTypeAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Bindings::NativeTypeAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Bindings";
    const CLASS_NAME: &'static str = "NativeTypeAttribute";
...
impl crate::UnityEngine::Bindings::NativeTypeAttribute {
    ...
    pub fn New_CodegenOptions_Il2CppString3(
        codegenOptions: crate::UnityEngine::Bindings::CodegenOptions,
        intermediateStructName: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_CodegenOptions1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (crate::UnityEngine::Bindings::CodegenOptions),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (codegenOptions))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_CodegenOptions_Il2CppString3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (codegenOptions, intermediateStructName))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_IntermediateScriptingStructName", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_UnityEngine+Bindings+NativeTypeAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Bindings::NativeTypeAttribute {
