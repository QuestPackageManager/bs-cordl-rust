...
#[cfg(feature = "cordl_class_UnityEngine+Bindings+FreeFunctionAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Bindings::FreeFunctionAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Bindings";
    const CLASS_NAME: &'static str = "FreeFunctionAttribute";
...
impl crate::UnityEngine::Bindings::FreeFunctionAttribute {
    ...
    pub fn _ctor_Il2CppString__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, isThreadSafe))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Bindings+FreeFunctionAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Bindings::FreeFunctionAttribute {
