...
for crate::UnityEngine::Bindings::IgnoreAttribute {
    ...
    const CLASS_NAME: &'static str = "IgnoreAttribute";
...
impl crate::UnityEngine::Bindings::IgnoreAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::IgnoreAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Bindings::IgnoreAttribute as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::IgnoreAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "set_DoesNotContributeToSize", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
