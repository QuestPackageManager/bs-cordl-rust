...
impl crate::UnityEngine::Bindings::NativeMethodAttribute {
    ...
    pub fn _ctor_Il2CppString__cordl_bool2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (name, isFreeFunction))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString__cordl_bool__cordl_bool3(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (name, isFreeFunction, isThreadSafe))?
        };
        Ok(__cordl_ret.into())
    }
