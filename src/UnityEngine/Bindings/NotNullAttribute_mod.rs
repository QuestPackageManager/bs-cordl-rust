...
impl crate::UnityEngine::Bindings::NotNullAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::NotNullAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Bindings::NotNullAttribute as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::NotNullAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Bindings::NotNullAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "set_Exception", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
