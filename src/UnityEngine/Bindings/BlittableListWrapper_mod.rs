...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Bindings::BlittableListWrapper {
    ...
    const CLASS_NAME: &'static str = "BlittableListWrapper";
...
#[cfg(feature = "UnityEngine+Bindings+BlittableListWrapper")]
impl crate::UnityEngine::Bindings::BlittableListWrapper {
    pub fn Unmarshal<T>(
        &mut self,
