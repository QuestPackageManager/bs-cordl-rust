...
for crate::UnityEngine::Bindings::NativeWritableSelfAttribute {
    ...
    const CLASS_NAME: &'static str = "NativeWritableSelfAttribute";
...
impl crate::UnityEngine::Bindings::NativeWritableSelfAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::NativeWritableSelfAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Bindings::NativeWritableSelfAttribute as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::NativeWritableSelfAttribute as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Bindings::NativeWritableSelfAttribute as
                    quest_hook::libil2cpp::Type > ::class(), "set_WritableSelf", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
