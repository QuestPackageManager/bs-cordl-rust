...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Bindings::SpanAttribute {
    ...
    const CLASS_NAME: &'static str = "SpanAttribute";
...
impl crate::UnityEngine::Bindings::SpanAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Bindings::SpanAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Bindings::SpanAttribute as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (sizeParameter, isReadOnly))?
        };
        Ok(__cordl_ret.into())
    }
}
