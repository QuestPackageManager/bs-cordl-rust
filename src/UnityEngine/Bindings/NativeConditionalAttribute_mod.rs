...
pub struct NativeConditionalAttribute {
    ...
    pub _Condition_k__BackingField: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub _StubReturnStatement_k__BackingField:
...
impl crate::UnityEngine::Bindings::NativeConditionalAttribute {
    ...
    pub fn New_Il2CppString1(
        condition: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
        stubReturnStatement: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (condition, stubReturnStatement))? };
        Ok(__cordl_ret.into())
    }
