...
impl crate::UnityEngine::AndroidJavaClass {
    ...
    pub fn _AndroidJavaClass(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AndroidJavaClass as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::AndroidJavaClass as quest_hook::libil2cpp::Type
                    > ::class(), "_AndroidJavaClass", 1usize
                )
            });
