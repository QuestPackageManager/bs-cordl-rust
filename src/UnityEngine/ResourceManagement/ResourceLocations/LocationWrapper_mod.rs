#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+ResourceLocations+LocationWrapper")]
#[repr(C)]
...
impl crate::UnityEngine::ResourceManagement::ResourceLocations::LocationWrapper {
    pub fn Hash(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked(self, (resultType))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
