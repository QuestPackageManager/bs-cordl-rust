...
for crate::UnityEngine::ResourceManagement::ResourceLocations::LocationWrapper {
    ...
    const CLASS_NAME: &'static str = "LocationWrapper";
...
impl crate::UnityEngine::ResourceManagement::ResourceLocations::LocationWrapper {
    pub fn Hash(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ResourceLocations::LocationWrapper as quest_hook::libil2cpp::Type>::class()
            .find_method::<
        ...
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (resultType))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
