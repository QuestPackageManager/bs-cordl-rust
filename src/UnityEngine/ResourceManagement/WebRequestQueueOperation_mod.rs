...
pub struct WebRequestQueueOperation {
    ...
    pub OnComplete: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub m_WebRequest: quest_hook::libil2cpp::Gc<crate::UnityEngine::Networking::UnityWebRequest>,
}
#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+WebRequestQueueOperation")]
...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::WebRequestQueueOperation {
...
#[cfg(feature = "UnityEngine+ResourceManagement+WebRequestQueueOperation")]
impl std::ops::DerefMut for crate::UnityEngine::ResourceManagement::WebRequestQueueOperation {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::Networking::UnityWebRequestAsyncOperation,
                    >), quest_hook::libil2cpp::Void, 1usize>("Complete")
                    .unwrap_or_else(|e| {
                        panic!(
