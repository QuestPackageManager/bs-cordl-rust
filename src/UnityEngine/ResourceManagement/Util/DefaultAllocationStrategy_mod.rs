#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+Util+DefaultAllocationStrategy")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::Util::DefaultAllocationStrategy {
