#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+Util+UnityWebRequestUtilities")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities {
...
#[cfg(feature = "UnityEngine+ResourceManagement+Util+UnityWebRequestUtilities")]
impl std::ops::DerefMut for crate::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities {
...
impl crate::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::Networking::UnityWebRequestAsyncOperation,
                    >), bool, 1usize>("IsAssetBundleDownloaded")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn RequestHasErrors(
        webReq: quest_hook::libil2cpp::Gc<crate::UnityEngine::Networking::UnityWebRequest>,
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (webReq, result))? };
        Ok(__cordl_ret.into())
    }
