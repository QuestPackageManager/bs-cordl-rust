...
impl crate::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities {
    pub fn IsAssetBundleDownloaded(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities as
                    quest_hook::libil2cpp::Type > ::class(), "IsAssetBundleDownloaded",
                    1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::ResourceManagement::Util::UnityWebRequestUtilities as
                    quest_hook::libil2cpp::Type > ::class(), "RequestHasErrors", 2usize
                )
            });
