...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::Util::IInitializableObject {
...
#[cfg(feature = "UnityEngine+ResourceManagement+Util+IInitializableObject")]
impl std::ops::DerefMut for crate::UnityEngine::ResourceManagement::Util::IInitializableObject {
...
impl crate::UnityEngine::ResourceManagement::Util::IInitializableObject {
    pub fn Initialize(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (id, data))? };
        Ok(__cordl_ret.into())
    }
