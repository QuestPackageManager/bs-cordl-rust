...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::Util::PlatformUtilities {
...
#[cfg(feature = "UnityEngine+ResourceManagement+Util+PlatformUtilities")]
impl std::ops::DerefMut for crate::UnityEngine::ResourceManagement::Util::PlatformUtilities {
...
impl crate::UnityEngine::ResourceManagement::Util::PlatformUtilities {
    ...
    pub fn PlatformUsesMultiThreading(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::UnityEngine::RuntimePlatform), bool, 1usize>(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (platform))? };
        Ok(__cordl_ret.into())
    }
