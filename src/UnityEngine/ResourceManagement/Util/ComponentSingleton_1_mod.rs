#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+Util+ComponentSingleton_1")]
#[repr(C)]
    ...
    crate::UnityEngine::ResourceManagement::Util::ComponentSingleton_1<T>
{
    ...
    pub fn DestroySingleton() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
