#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+Util+SerializedType")]
...
impl crate::UnityEngine::ResourceManagement::Util::SerializedType {
    ...
    pub fn set_ValueChanged(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_ValueChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
