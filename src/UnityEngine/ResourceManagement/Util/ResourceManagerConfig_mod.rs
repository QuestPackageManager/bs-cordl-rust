#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+Util+ResourceManagerConfig")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::Util::ResourceManagerConfig {
...
#[cfg(feature = "UnityEngine+ResourceManagement+Util+ResourceManagerConfig")]
impl std::ops::DerefMut for crate::UnityEngine::ResourceManagement::Util::ResourceManagerConfig {
...
impl crate::UnityEngine::ResourceManagement::Util::ResourceManagerConfig {
            ...
            + quest_hook::libil2cpp::Returned,
    {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                        >,
                    >), TObject, 1usize>("CreateArrayResult")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: TObject = unsafe { cordl_method_info.invoke_unchecked((), (allAssets))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateArrayResult_Type_Il2CppArray0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Array> =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type, allAssets))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                        >,
                    >), TObject, 1usize>("CreateListResult")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ExtractKeyAndSubKey(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    ), bool, 3usize>("ExtractKeyAndSubKey")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (keyObj, mainKey, subKey))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsPathRemote(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (path))? };
        Ok(__cordl_ret.into())
    }
