#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+Util+GlobalLinkedListNodeCache_1")]
#[repr(C)]
    ...
    crate::UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1<T>
{
    ...
    pub fn SetCacheSize(length: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
