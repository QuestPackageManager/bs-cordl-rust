...
impl crate::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey {
    pub fn Equals_AsyncOpHandlesCacheKey2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (handles))?
        };
        Ok(__cordl_ret.into())
    }
}
