...
impl crate::UnityEngine::ResourceManagement::Util::DependenciesCacheKey {
    pub fn Equals_DependenciesCacheKey2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::Util::DependenciesCacheKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<
                    crate::UnityEngine::ResourceManagement::Util::DependenciesCacheKey,
                >),
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (dependencies, dependenciesHash))?
        };
        Ok(__cordl_ret.into())
    }
}
