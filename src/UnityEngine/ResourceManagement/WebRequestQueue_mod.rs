#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+WebRequestQueue")]
#[repr(C)]
...
impl crate::UnityEngine::ResourceManagement::WebRequestQueue {
    pub fn BeginWebRequest(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ResourceManagement::WebRequestQueueOperation,
                    >), quest_hook::libil2cpp::Void, 1usize>("BeginWebRequest")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (queueOperation))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::Networking::UnityWebRequestAsyncOperation,
                    >), quest_hook::libil2cpp::Void, 1usize>("DequeueRequest")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetMaxConcurrentRequests(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (maxRequests))? };
        Ok(__cordl_ret.into())
    }
    pub fn WaitForRequestToBeActive(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (request, millisecondsTimeout))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+WebRequestQueue")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ResourceManagement::WebRequestQueue {
