#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+ChainOperationTypelessDepedency_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    crate::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1<TObject>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (dependentOp, callback, releaseDependenciesOnFailure))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OnWrappedCompleted(
        &mut self,
        x: crate::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TObject: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
