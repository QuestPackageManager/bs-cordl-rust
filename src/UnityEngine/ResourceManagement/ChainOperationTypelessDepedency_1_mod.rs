...
for crate::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1<TObject> {
    ...
    const CLASS_NAME: &'static str = "ChainOperationTypelessDepedency`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        ...
                        "ChainOperationTypelessDepedency`1",
                    )
                    .unwrap()
...
> crate::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1<TObject> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1<
            TObject,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1
