#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+AsyncOperations+IAsyncOperation")]
#[derive(Debug)]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation {
