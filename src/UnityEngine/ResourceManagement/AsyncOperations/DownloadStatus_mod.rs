...
for crate::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus {
    ...
    const CLASS_NAME: &'static str = "DownloadStatus";
...
impl crate::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus {
    pub fn get_Percent(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("get_Percent")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus as
                    quest_hook::libil2cpp::Type > ::class(), "get_Percent", 0usize
                )
            });
