#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+AsyncOperations+ICachable")]
...
impl std::ops::Deref for crate::UnityEngine::ResourceManagement::AsyncOperations::ICachable {
...
#[cfg(feature = "UnityEngine+ResourceManagement+AsyncOperations+ICachable")]
impl std::ops::DerefMut for crate::UnityEngine::ResourceManagement::AsyncOperations::ICachable {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ResourceManagement::Util::IOperationCacheKey,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_Key")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
