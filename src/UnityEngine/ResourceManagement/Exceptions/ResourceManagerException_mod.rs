...
for crate::UnityEngine::ResourceManagement::Exceptions::ResourceManagerException {
    ...
    const CLASS_NAME: &'static str = "ResourceManagerException";
...
#[cfg(feature = "UnityEngine+ResourceManagement+Exceptions+ResourceManagerException")]
impl crate::UnityEngine::ResourceManagement::Exceptions::ResourceManagerException {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::Exceptions::ResourceManagerException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
