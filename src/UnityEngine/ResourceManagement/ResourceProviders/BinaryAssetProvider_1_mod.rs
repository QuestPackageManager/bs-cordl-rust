...
> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ResourceProviders::BinaryAssetProvider_1<
            TAdapter,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    < TAdapter > as quest_hook::libil2cpp::Type > ::class(), "Convert",
                    2usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::UnityEngine::ResourceManagement::ResourceProviders::BinaryAssetProvider_1
                    < TAdapter > as quest_hook::libil2cpp::Type > ::class(), ".ctor",
                    0usize
                )
            });
