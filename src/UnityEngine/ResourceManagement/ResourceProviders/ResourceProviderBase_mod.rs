...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::ResourceProviderBase {
    ...
    pub fn CanProvide(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (t, location))? };
        Ok(__cordl_ret.into())
    }
...
impl
    crate::UnityEngine::ResourceManagement::ResourceProviders::ResourceProviderBase_BaseInitAsyncOp
{
