...
for crate::UnityEngine::ResourceManagement::ResourceProviders::JsonAssetProvider {
    ...
    const CLASS_NAME: &'static str = "JsonAssetProvider";
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::JsonAssetProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ResourceProviders::JsonAssetProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
