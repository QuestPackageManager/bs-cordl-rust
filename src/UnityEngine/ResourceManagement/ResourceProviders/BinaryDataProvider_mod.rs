...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::BinaryDataProvider {
    ...
    pub fn Provide(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (provideHandle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::BinaryDataProvider_InternalOp {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CompleteOperation", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (data, exception))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ConvertBytes(
    ...
    pub fn Start(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (provideHandle, rawProvider))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _SendWebRequest_b__13_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (asyncOperation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
