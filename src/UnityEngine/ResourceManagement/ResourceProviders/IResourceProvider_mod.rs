#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+ResourceProviders+IResourceProvider")]
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::IResourceProvider {
    pub fn CanProvide(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_type, location))? };
        Ok(__cordl_ret.into())
    }
