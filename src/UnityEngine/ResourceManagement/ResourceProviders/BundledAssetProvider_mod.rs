...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::BundledAssetProvider {
    ...
    pub type InternalOp =
        crate::UnityEngine::ResourceManagement::ResourceProviders::BundledAssetProvider_InternalOp;
...
pub struct BundledAssetProvider_InternalOp {
    ...
    pub m_RequestOperation: quest_hook::libil2cpp::Gc<crate::UnityEngine::AssetBundleRequest>,
...
#[cfg(feature = "UnityEngine+ResourceManagement+ResourceProviders+BundledAssetProvider+InternalOp")]
impl std::ops::Deref
    for crate::UnityEngine::ResourceManagement::ResourceProviders::BundledAssetProvider_InternalOp
{
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::BundledAssetProvider_InternalOp {
    ...
    pub fn BeginAssetLoad(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn GetArrayResult(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("GetArrayResult")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (allAssets))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("GetListResult")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn IsDownloadOnly(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (results))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IList_1<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        >,
                    >), T, 1usize>("LoadBundleFromDependecies")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked((), (results))? };
        Ok(__cordl_ret.into())
    }
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
