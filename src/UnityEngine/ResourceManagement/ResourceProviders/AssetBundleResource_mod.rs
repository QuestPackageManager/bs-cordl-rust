#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+ResourceProviders+AssetBundleResource")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct AssetBundleResource {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub m_AssetBundle: quest_hook::libil2cpp::Gc<crate::UnityEngine::AssetBundle>,
    pub m_RequestOperation: quest_hook::libil2cpp::Gc<crate::UnityEngine::AsyncOperation>,
    pub m_WebRequestQueueOperation:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::ResourceManagement::WebRequestQueueOperation>,
    ...
    pub m_UnloadOperation:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::AssetBundleUnloadOperation>,
    pub m_TransformedInternalId: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
    pub m_PreloadRequest: quest_hook::libil2cpp::Gc<crate::UnityEngine::AssetBundleRequest>,
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleResource {
    ...
    pub fn AddBeginWebRequestHandler(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (webRequestQueueOperation))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddBundleToProfiler(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (status, source))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddCallbackInvokeIfDone(
        ...
        callback: quest_hook::libil2cpp::Gc<
            crate::System::Action_1<quest_hook::libil2cpp::Gc<crate::UnityEngine::AsyncOperation>>,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (operation, callback))? };
        Ok(__cordl_ret.into())
    }
    pub fn BeginOperation(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("BeginOperation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn BeginWebRequestOperation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (asyncOp))? };
        Ok(__cordl_ret.into())
    }
    pub fn CompleteBundleLoad(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bundle))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetLoadInfo_IResourceLocation_ResourceManager_ByRefMut1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (location, resourceManager, loadType, path))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetLoadInfo_ProvideHandle_ByRefMut0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (handle, loadType, path))? };
        Ok(__cordl_ret.into())
    }
    pub fn LoadLocalBundle(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("LoadLocalBundle")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Start(
        ...
        unloadOp: quest_hook::libil2cpp::Gc<crate::UnityEngine::AssetBundleUnloadOperation>,
    ...
    pub fn Unload(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (unloadOp))? };
        Ok(__cordl_ret.into())
    }
    pub fn Update(
        &mut self,
...
#[cfg(feature = "UnityEngine+ResourceManagement+ResourceProviders+AssetBundleResource")]
impl AsRef<crate::UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource>
    for crate::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleResource
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+ResourceManagement+ResourceProviders+AssetBundleResource")]
impl AsMut<crate::UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource>
    for crate::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleResource
{
    fn as_mut(
        &mut self,
