...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::DownloadOnlyLocation {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ResourceProviders::DownloadOnlyLocation as quest_hook::libil2cpp::Type>::class()
            .find_method::<
