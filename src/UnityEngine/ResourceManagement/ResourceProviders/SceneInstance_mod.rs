#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+ResourceProviders+SceneInstance")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
pub struct SceneInstance {
    pub m_Scene: crate::UnityEngine::SceneManagement::Scene,
    pub m_ReleaseOnSceneUnloaded: bool,
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance {
    ...
    pub fn get_ReleaseSceneOnSceneUnloaded(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_ReleaseSceneOnSceneUnloaded")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_ReleaseSceneOnSceneUnloaded",
                            0usize
                        )
                    })
            });
    ...
    pub fn set_ReleaseSceneOnSceneUnloaded(
        &mut self,
        value: bool,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>(
                        "set_ReleaseSceneOnSceneUnloaded",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
