...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::AssetBundle>,
                0usize,
