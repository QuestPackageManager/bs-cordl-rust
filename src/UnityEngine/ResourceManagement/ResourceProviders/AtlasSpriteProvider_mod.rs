...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::AtlasSpriteProvider {
    ...
    pub fn Provide(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ResourceManagement::ResourceProviders::AtlasSpriteProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
