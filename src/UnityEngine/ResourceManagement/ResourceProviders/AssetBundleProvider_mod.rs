#[cfg(feature = "cordl_class_UnityEngine+ResourceManagement+ResourceProviders+AssetBundleProvider")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleProvider {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::ResourceManagement::Util::IOperationCacheKey,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (rm, location, desiredType))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Release(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (location, asset))? };
        Ok(__cordl_ret.into())
    }
    pub fn ShouldRetryDownloadError(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ResourceManagement::Util::UnityWebRequestResult,
                    >), bool, 1usize>("ShouldRetryDownloadError")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (uwrResult))? };
        Ok(__cordl_ret.into())
    }
    pub fn WaitForAllUnloadingBundlesToComplete(
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
