...
#[cfg(feature = "UnityEngine+HelpURLAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::HelpURLAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "HelpURLAttribute";
...
impl crate::UnityEngine::HelpURLAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::HelpURLAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::HelpURLAttribute as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 1usize
                )
            });
