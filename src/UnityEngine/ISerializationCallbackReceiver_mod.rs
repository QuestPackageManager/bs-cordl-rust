...
for crate::UnityEngine::ISerializationCallbackReceiver {
    ...
    const CLASS_NAME: &'static str = "ISerializationCallbackReceiver";
...
impl crate::UnityEngine::ISerializationCallbackReceiver {
    pub fn OnAfterDeserialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ISerializationCallbackReceiver as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnAfterDeserialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ISerializationCallbackReceiver as
