...
#[cfg(feature = "UnityEngine+AndroidJavaRunnable")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AndroidJavaRunnable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AndroidJavaRunnable";
...
impl crate::UnityEngine::AndroidJavaRunnable {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AndroidJavaRunnable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::AndroidJavaRunnable as
