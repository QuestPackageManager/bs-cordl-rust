#[cfg(feature = "cordl_class_UnityEngine+DisableBatchingType")]
...
#[cfg(feature = "cordl_class_UnityEngine+DisableBatchingType")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::DisableBatchingType {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "DisableBatchingType";
...
#[cfg(feature = "cordl_class_UnityEngine+DisableBatchingType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::DisableBatchingType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
