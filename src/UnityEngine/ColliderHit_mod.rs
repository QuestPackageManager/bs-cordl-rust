...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ColliderHit {
    ...
    const CLASS_NAME: &'static str = "ColliderHit";
...
impl crate::UnityEngine::ColliderHit {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ColliderHit as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Collider>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ColliderHit as quest_hook::libil2cpp::Type >
