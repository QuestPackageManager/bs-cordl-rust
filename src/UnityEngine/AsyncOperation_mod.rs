...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AsyncOperation {
    ...
    const CLASS_NAME: &'static str = "AsyncOperation";
...
impl crate::UnityEngine::AsyncOperation {
    #[cfg(feature = "UnityEngine+AsyncOperation+BindingsMarshaller")]
    pub type BindingsMarshaller = crate::UnityEngine::AsyncOperation_BindingsMarshaller;
    ...
    pub fn InternalSetManagedObject(
        ptr: crate::System::IntPtr,
        _cordl_self: quest_hook::libil2cpp::Gc<crate::UnityEngine::AsyncOperation>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (ptr, _cordl_self))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_allowSceneActivation(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_allowSceneActivation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_allowSceneActivation_Injected(
    ...
    pub fn set_allowSceneActivation_Injected(
        _unity_self: crate::System::IntPtr,
        value: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_allowSceneActivation_Injected", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_UnityEngine+AsyncOperation+BindingsMarshaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AsyncOperation_BindingsMarshaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AsyncOperation/BindingsMarshaller";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+AsyncOperation+BindingsMarshaller")]
impl std::ops::Deref for crate::UnityEngine::AsyncOperation_BindingsMarshaller {
...
#[cfg(feature = "UnityEngine+AsyncOperation+BindingsMarshaller")]
impl std::ops::DerefMut for crate::UnityEngine::AsyncOperation_BindingsMarshaller {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+AsyncOperation+BindingsMarshaller")]
impl crate::UnityEngine::AsyncOperation_BindingsMarshaller {
    ...
    pub fn ConvertToNative(
        asyncOperation: quest_hook::libil2cpp::Gc<crate::UnityEngine::AsyncOperation>,
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (asyncOperation))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+AsyncOperation+BindingsMarshaller")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::AsyncOperation_BindingsMarshaller {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
