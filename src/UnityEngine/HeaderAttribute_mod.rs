...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::HeaderAttribute {
    ...
    const CLASS_NAME: &'static str = "HeaderAttribute";
...
impl crate::UnityEngine::HeaderAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::HeaderAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::HeaderAttribute as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 1usize
                )
            });
