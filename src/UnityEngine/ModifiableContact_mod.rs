#[cfg(feature = "cordl_class_UnityEngine+ModifiableContact")]
...
#[cfg(feature = "cordl_class_UnityEngine+ModifiableContact")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ModifiableContact {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "ModifiableContact";
...
#[cfg(feature = "cordl_class_UnityEngine+ModifiableContact")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::ModifiableContact {
    type Type = Self;
