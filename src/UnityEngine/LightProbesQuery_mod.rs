...
#[cfg(feature = "cordl_class_UnityEngine+LightProbesQuery")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::LightProbesQuery {
    type Type = Self;
...
impl crate::UnityEngine::LightProbesQuery {
    ...
    pub type LightProbesQueryDisposeJob =
        crate::UnityEngine::LightProbesQuery_LightProbesQueryDisposeJob;
    ...
    pub fn CalculateInterpolatedLightAndOcclusionProbes_NativeArray_1_NativeArray_1_NativeArray_1_NativeArray_1_0(
        ...
        >,
        occlusionProbes: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::Vector4>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn Destroy(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (lightProbeContextWrapper))? };
        Ok(__cordl_ret.into())
    }
