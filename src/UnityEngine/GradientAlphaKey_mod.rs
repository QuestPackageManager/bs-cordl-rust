...
#[cfg(feature = "UnityEngine+GradientAlphaKey")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::GradientAlphaKey {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "GradientAlphaKey";
...
impl crate::UnityEngine::GradientAlphaKey {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::GradientAlphaKey as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32, f32), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::GradientAlphaKey as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (alpha, _cordl_time))?
        };
        Ok(__cordl_ret.into())
    }
}
