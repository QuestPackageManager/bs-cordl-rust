...
impl crate::UnityEngine::UI::MaskableGraphic {
    ...
    pub fn UpdateCull(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cull))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
