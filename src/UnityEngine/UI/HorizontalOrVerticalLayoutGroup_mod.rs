...
impl crate::UnityEngine::UI::HorizontalOrVerticalLayoutGroup {
    pub fn CalcAlongAxis(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (axis, isVertical))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<f32>,
                        quest_hook::libil2cpp::ByRefMut<f32>,
                    ), quest_hook::libil2cpp::Void, 7usize>("GetChildSizes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+UI+HorizontalOrVerticalLayoutGroup")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UI::HorizontalOrVerticalLayoutGroup {
