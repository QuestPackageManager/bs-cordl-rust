...
pub struct Toggle {
    ...
    pub onValueChanged: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Toggle_ToggleEvent>,
    pub m_IsOn: bool,
}
#[cfg(feature = "cordl_class_UnityEngine+UI+Toggle")]
...
impl crate::UnityEngine::UI::Toggle {
    ...
    pub fn PlayEffect(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("PlayEffect")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (instant))? };
        Ok(__cordl_ret.into())
    }
    pub fn Rebuild(
        &mut self,
    ...
    pub fn Set(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, bool), quest_hook::libil2cpp::Void, 2usize>("Set")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetToggleGroup(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetToggleGroup")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newGroup, setMemberValue))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_group(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::ToggleGroup>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::ToggleGroup> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_isOn(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_isOn")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_isOn(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_isOn")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+UI+Toggle")]
impl AsRef<crate::UnityEngine::EventSystems::ISubmitHandler> for crate::UnityEngine::UI::Toggle {
    fn as_ref(&self) -> &crate::UnityEngine::EventSystems::ISubmitHandler {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+UI+Toggle")]
impl AsMut<crate::UnityEngine::EventSystems::ISubmitHandler> for crate::UnityEngine::UI::Toggle {
...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::Toggle_ToggleEvent {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "Toggle/ToggleEvent";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+UI+Toggle+ToggleTransition")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::Toggle_ToggleTransition {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "Toggle/ToggleTransition";
...
#[cfg(feature = "cordl_class_UnityEngine+UI+Toggle+ToggleTransition")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::UI::Toggle_ToggleTransition {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UI+Toggle+ToggleTransition")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::UI::Toggle_ToggleTransition {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UI+Toggle+ToggleTransition")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::UI::Toggle_ToggleTransition {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UI+Toggle+ToggleTransition")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::UI::Toggle_ToggleTransition {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
