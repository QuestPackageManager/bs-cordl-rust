...
impl crate::UnityEngine::UI::ClipperRegistry {
    pub fn Cull(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::ClipperRegistry> =
