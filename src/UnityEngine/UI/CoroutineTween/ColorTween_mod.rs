...
#[cfg(feature = "cordl_class_UnityEngine+UI+CoroutineTween+ColorTween")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::CoroutineTween::ColorTween {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UI+CoroutineTween+ColorTween")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::UI::CoroutineTween::ColorTween {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+UI+CoroutineTween+ColorTween")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::UI::CoroutineTween::ColorTween {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+UI+CoroutineTween+ColorTween")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::UI::CoroutineTween::ColorTween {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::UI::CoroutineTween::ColorTween {
    ...
    pub fn TweenValue(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (floatPercentage))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_startColor(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_targetColor(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenMode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn set_duration(
...
#[cfg(feature = "UnityEngine+UI+CoroutineTween+ColorTween+ColorTweenCallback")]
impl std::ops::Deref for crate::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenCallback {
...
#[cfg(feature = "UnityEngine+UI+CoroutineTween+ColorTween+ColorTweenCallback")]
impl std::ops::DerefMut for crate::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenCallback {
