...
impl crate::UnityEngine::UI::CoroutineTween::ITweenValue {
    pub fn TweenValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::CoroutineTween::ITweenValue as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("TweenValue")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UI::CoroutineTween::ITweenValue as
