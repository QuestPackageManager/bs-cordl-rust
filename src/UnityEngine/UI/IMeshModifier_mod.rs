...
#[cfg(feature = "UnityEngine+UI+IMeshModifier")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::IMeshModifier {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "IMeshModifier";
...
impl crate::UnityEngine::UI::IMeshModifier {
    pub fn ModifyMesh_Mesh0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::IMeshModifier as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::IMeshModifier as quest_hook::libil2cpp::Type
