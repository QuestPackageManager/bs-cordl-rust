...
#[cfg(feature = "cordl_class_UnityEngine+UI+MultipleDisplayUtilities")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::MultipleDisplayUtilities {
...
impl crate::UnityEngine::UI::MultipleDisplayUtilities {
    pub fn GetRelativeMousePositionForDrag(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 2usize>("GetRelativeMousePositionForDrag")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (eventData, position))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "RelativeMouseAtScaled", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Vector3 =
            unsafe { cordl_method_info.invoke_unchecked((), (position, displayIndex))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+UI+MultipleDisplayUtilities")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UI::MultipleDisplayUtilities {
