...
for crate::UnityEngine::UI::HorizontalLayoutGroup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "HorizontalLayoutGroup";
...
#[cfg(feature = "UnityEngine+UI+HorizontalLayoutGroup")]
impl std::ops::DerefMut for crate::UnityEngine::UI::HorizontalLayoutGroup {
...
impl crate::UnityEngine::UI::HorizontalLayoutGroup {
    pub fn CalculateLayoutInputHorizontal(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::HorizontalLayoutGroup as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::HorizontalLayoutGroup as
