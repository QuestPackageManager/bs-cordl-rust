...
#[cfg(feature = "UnityEngine+UI+IClippable")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::IClippable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "IClippable";
...
impl crate::UnityEngine::UI::IClippable {
    pub fn Cull(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::IClippable as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::IClippable as quest_hook::libil2cpp::Type >
                    ::class(), "Cull", 2usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::IClippable as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::UI::IClippable as quest_hook::libil2cpp::Type >
                    ::class(), "SetClipRect", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value, validRect))?
        };
        Ok(__cordl_ret.into())
    }
