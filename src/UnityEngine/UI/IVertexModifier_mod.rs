#[cfg(feature = "cordl_class_UnityEngine+UI+IVertexModifier")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+UI+IVertexModifier")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::IVertexModifier {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "IVertexModifier";
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<crate::UnityEngine::UIVertex>,
                    >), quest_hook::libil2cpp::Void, 1usize>("ModifyVertices")
                    .unwrap_or_else(|e| {
                        panic!(
