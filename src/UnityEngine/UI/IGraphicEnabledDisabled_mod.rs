#[cfg(feature = "cordl_class_UnityEngine+UI+IGraphicEnabledDisabled")]
...
#[cfg(feature = "cordl_class_UnityEngine+UI+IGraphicEnabledDisabled")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::IGraphicEnabledDisabled {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "IGraphicEnabledDisabled";
...
#[cfg(feature = "cordl_class_UnityEngine+UI+IGraphicEnabledDisabled")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::UI::IGraphicEnabledDisabled {
