...
impl crate::UnityEngine::UI::IGraphicEnabledDisabled {
    pub fn OnSiblingGraphicEnabledDisabled(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::IGraphicEnabledDisabled as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::IGraphicEnabledDisabled as
                    quest_hook::libil2cpp::Type > ::class(),
                    "OnSiblingGraphicEnabledDisabled", 0usize
                )
            });
