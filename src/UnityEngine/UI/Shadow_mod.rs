...
impl crate::UnityEngine::UI::Shadow {
    ...
    pub fn ApplyShadow(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (verts, color, start, end, x, y))?
        };
        Ok(__cordl_ret.into())
    }
