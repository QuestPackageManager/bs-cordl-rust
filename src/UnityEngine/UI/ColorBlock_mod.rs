#[cfg(feature = "cordl_class_UnityEngine+UI+ColorBlock")]
...
impl crate::UnityEngine::UI::ColorBlock {
    ...
    pub fn op_Equality(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (point1, point2))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_fadeDuration(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("set_fadeDuration")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::UI::ColorBlock> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+UI+ColorBlock")]
impl AsMut<crate::System::IEquatable_1<crate::UnityEngine::UI::ColorBlock>>
    for crate::UnityEngine::UI::ColorBlock
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::UnityEngine::UI::ColorBlock> {
        todo!()
    }
}
