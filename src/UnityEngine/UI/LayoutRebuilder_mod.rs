#[cfg(feature = "cordl_class_UnityEngine+UI+LayoutRebuilder")]
#[repr(C)]
...
impl crate::UnityEngine::UI::LayoutRebuilder {
    ...
    pub fn ForceRebuildLayoutImmediate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (layoutRoot))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PerformLayoutCalculation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rect, action))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReapplyDrivenProperties(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (driven))? };
        Ok(__cordl_ret.into())
    }
    pub fn Rebuild(
        &mut self,
    ...
    pub fn StripDisabledBehavioursFromList(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (components))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
        &mut self,
    ...
    pub fn ValidController(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (layoutRoot, comps))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "UnityEngine+UI+LayoutRebuilder")]
impl AsRef<crate::UnityEngine::UI::ICanvasElement> for crate::UnityEngine::UI::LayoutRebuilder {
    fn as_ref(&self) -> &crate::UnityEngine::UI::ICanvasElement {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+UI+LayoutRebuilder")]
impl AsMut<crate::UnityEngine::UI::ICanvasElement> for crate::UnityEngine::UI::LayoutRebuilder {
