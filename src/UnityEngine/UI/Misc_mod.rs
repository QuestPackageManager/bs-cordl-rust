...
#[cfg(feature = "UnityEngine+UI+Misc")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::Misc {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.UI";
    const CLASS_NAME: &'static str = "Misc";
...
impl crate::UnityEngine::UI::Misc {
    pub fn Destroy(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::Misc as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::Misc as quest_hook::libil2cpp::Type >
                    ::class(), "Destroy", 1usize
                )
            });
