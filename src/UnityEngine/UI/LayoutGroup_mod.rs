...
impl crate::UnityEngine::UI::LayoutGroup {
    ...
    pub fn GetStartOffset(
        ...
        let __cordl_ret: f32 = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (axis, requiredSpaceWithoutPadding))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetChildAlongAxisWithScale_RectTransform_i32_f32_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rect, axis, pos, scaleFactor))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetChildAlongAxisWithScale_f32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (rect, axis, pos, _cordl_size, scaleFactor))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetChildAlongAxis_RectTransform_i32_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rect, axis, pos))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetChildAlongAxis_f32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (rect, axis, pos, _cordl_size))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetDirty(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (currentValue, newValue))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
