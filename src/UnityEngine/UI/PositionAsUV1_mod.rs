...
impl crate::UnityEngine::UI::PositionAsUV1 {
    pub fn ModifyMesh(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::PositionAsUV1 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::PositionAsUV1 as quest_hook::libil2cpp::Type
                    > ::class(), "ModifyMesh", 1usize
                )
            });
