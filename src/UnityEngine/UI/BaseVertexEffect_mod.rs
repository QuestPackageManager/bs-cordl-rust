...
impl crate::UnityEngine::UI::BaseVertexEffect {
    pub fn ModifyVertices(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::BaseVertexEffect as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::BaseVertexEffect as
