...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::UI::Outline {
    ...
    const CLASS_NAME: &'static str = "Outline";
...
impl crate::UnityEngine::UI::Outline {
    pub fn ModifyMesh(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::UI::Outline as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::UI::Outline as quest_hook::libil2cpp::Type >
