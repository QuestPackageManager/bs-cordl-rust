#[cfg(feature = "cordl_class_UnityEngine+Audio+AudioPlayableBinding")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+Audio+AudioPlayableBinding")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Audio::AudioPlayableBinding {
...
impl crate::UnityEngine::Audio::AudioPlayableBinding {
    pub fn Create(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Playables::PlayableBinding, 2usize>(
                        "Create"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Playables::PlayableBinding =
            unsafe { cordl_method_info.invoke_unchecked((), (name, key))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Audio+AudioPlayableBinding")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Audio::AudioPlayableBinding {
