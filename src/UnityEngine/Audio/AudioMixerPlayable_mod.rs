...
impl crate::UnityEngine::Audio::AudioMixerPlayable {
    pub fn Create(
        ...
        let __cordl_ret: crate::UnityEngine::Audio::AudioMixerPlayable = unsafe {
            cordl_method_info
                .invoke_unchecked((), (graph, inputCount, normalizeInputVolumes))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateAudioMixerPlayableInternal(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (graph, normalizeInputVolumes, handle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateHandle(
...
#[cfg(feature = "UnityEngine+Audio+AudioMixerPlayable")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::UnityEngine::Audio::AudioMixerPlayable>>
for crate::UnityEngine::Audio::AudioMixerPlayable {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::UnityEngine::Audio::AudioMixerPlayable> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Audio+AudioMixerPlayable")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::UnityEngine::Audio::AudioMixerPlayable>>
for crate::UnityEngine::Audio::AudioMixerPlayable {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::UnityEngine::Audio::AudioMixerPlayable> {
        todo!()
    }
}
