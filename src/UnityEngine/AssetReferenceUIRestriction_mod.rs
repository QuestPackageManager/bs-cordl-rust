#[cfg(feature = "cordl_class_UnityEngine+AssetReferenceUIRestriction")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+AssetReferenceUIRestriction")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AssetReferenceUIRestriction {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "AssetReferenceUIRestriction";
...
#[cfg(feature = "cordl_class_UnityEngine+AssetReferenceUIRestriction")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::AssetReferenceUIRestriction {
