...
impl crate::UnityEngine::ContextMenu {
    ...
    pub fn _ctor_Il2CppString0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (itemName))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (itemName, isValidateFunction))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (itemName, isValidateFunction, priority))?
        };
        Ok(__cordl_ret.into())
    }
}
