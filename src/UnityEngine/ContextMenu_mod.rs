...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ContextMenu {
    ...
    const CLASS_NAME: &'static str = "ContextMenu";
...
impl crate::UnityEngine::ContextMenu {
    ...
    pub fn _ctor_Il2CppString0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ContextMenu as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ContextMenu as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (itemName))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (itemName, isValidateFunction))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor__cordl_bool_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (itemName, isValidateFunction, priority))?
        };
        Ok(__cordl_ret.into())
    }
}
