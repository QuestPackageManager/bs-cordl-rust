...
#[cfg(feature = "UnityEngine+PropertyName")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::PropertyName {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "PropertyName";
...
#[cfg(feature = "UnityEngine+PropertyName")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::PropertyName {
    type Type = Self;
...
#[cfg(feature = "UnityEngine+PropertyName")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::PropertyName {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "UnityEngine+PropertyName")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::PropertyName {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "UnityEngine+PropertyName")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::PropertyName {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::PropertyName {
    pub fn Equals_Il2CppObject0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::PropertyName as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::PropertyName as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
    ...
    pub fn Equals_PropertyName1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::PropertyName as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::UnityEngine::PropertyName), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::PropertyName as quest_hook::libil2cpp::Type >
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::PropertyName as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::PropertyName as quest_hook::libil2cpp::Type >
                    ::class(), "IsNullOrEmpty", 1usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked((), (prop))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
        &mut self,
    ...
    pub fn op_Equality(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::PropertyName as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (crate::UnityEngine::PropertyName, crate::UnityEngine::PropertyName),
                bool,
                2usize,
            >("op_Equality")
            .unwrap_or_else(|e| {
