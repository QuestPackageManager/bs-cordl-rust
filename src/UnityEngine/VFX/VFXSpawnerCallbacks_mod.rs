...
#[cfg(feature = "cordl_class_UnityEngine+VFX+VFXSpawnerCallbacks")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::VFX::VFXSpawnerCallbacks {
...
impl crate::UnityEngine::VFX::VFXSpawnerCallbacks {
    ...
    pub fn OnPlay(
        ...
        vfxValues: quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VFXExpressionValues>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VFXExpressionValues>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VisualEffect>,
                    ), quest_hook::libil2cpp::Void, 3usize>("OnPlay")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, vfxValues, vfxComponent))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnStop(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VFXExpressionValues>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VisualEffect>,
                    ), quest_hook::libil2cpp::Void, 3usize>("OnStop")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VFXExpressionValues>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::VFX::VisualEffect>,
                    ), quest_hook::libil2cpp::Void, 3usize>("OnUpdate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
