...
impl crate::UnityEngine::NoAllocHelpers {
    ...
    pub type ListPrivateFieldAccess_1<T: quest_hook::libil2cpp::Type> = crate::UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1<
        T,
    >;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ResetListContents", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (list, span))?
        };
        Ok(__cordl_ret.into())
    }
