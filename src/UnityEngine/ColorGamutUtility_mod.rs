...
impl crate::UnityEngine::ColorGamutUtility {
    pub fn GetColorPrimaries(
        ...
        let __cordl_ret: crate::UnityEngine::ColorPrimaries = unsafe {
            cordl_method_info.invoke_unchecked((), (gamut))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetTransferFunction(
        ...
        let __cordl_ret: crate::UnityEngine::TransferFunction = unsafe {
            cordl_method_info.invoke_unchecked((), (gamut))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetWhitePoint(
        ...
        let __cordl_ret: crate::UnityEngine::WhitePoint = unsafe {
            cordl_method_info.invoke_unchecked((), (gamut))?
        };
        Ok(__cordl_ret.into())
    }
