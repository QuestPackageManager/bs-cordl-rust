    ...
    for crate::UnityEngine::Rendering::EditorInstanceDataArrays
{
    ...
    const CLASS_NAME: &'static str = "EditorInstanceDataArrays";
    ...
    for crate::UnityEngine::Rendering::EditorInstanceDataArrays_ReadOnly
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "EditorInstanceDataArrays/ReadOnly";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
#[cfg(feature = "UnityEngine+Rendering+EditorInstanceDataArrays+ReadOnly")]
impl crate::UnityEngine::Rendering::EditorInstanceDataArrays_ReadOnly {
    pub fn _ctor(
        &mut self,
