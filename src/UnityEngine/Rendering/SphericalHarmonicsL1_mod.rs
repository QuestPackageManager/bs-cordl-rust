...
for crate::UnityEngine::Rendering::SphericalHarmonicsL1 {
    ...
    const CLASS_NAME: &'static str = "SphericalHarmonicsL1";
...
#[cfg(feature = "UnityEngine+Rendering+SphericalHarmonicsL1")]
impl crate::UnityEngine::Rendering::SphericalHarmonicsL1 {
    pub fn Equals(
        &mut self,
