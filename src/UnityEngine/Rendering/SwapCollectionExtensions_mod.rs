...
#[repr(C)]
#[derive(Debug)]
pub struct SwapCollectionExtensions {
...
impl std::ops::Deref for crate::UnityEngine::Rendering::SwapCollectionExtensions {
...
#[cfg(feature = "UnityEngine+Rendering+SwapCollectionExtensions")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::SwapCollectionExtensions {
