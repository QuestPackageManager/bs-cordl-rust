...
#[cfg(feature = "UnityEngine+Rendering+DebugDisplaySettings_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::Rendering::DebugDisplaySettings_1<T> {
    #[cfg(
        feature = "UnityEngine+Rendering+DebugDisplaySettings_1+IDebugDisplaySettingsDataComparer"
    )]
    pub type IDebugDisplaySettingsDataComparer =
        crate::UnityEngine::Rendering::DebugDisplaySettings_1_IDebugDisplaySettingsDataComparer<T>;
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TData = unsafe { cordl_method_info.invoke_unchecked(self, (newData))? };
        Ok(__cordl_ret.into())
    }
    pub fn ForEach(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::Rendering::IDebugDisplaySettingsData,
                    >, 1usize>("UnityEngine.Rendering.IDebugDisplaySettings.Add")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+Rendering+DebugDisplaySettings_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::UnityEngine::Rendering::IDebugDisplaySettings>
    for crate::UnityEngine::Rendering::DebugDisplaySettings_1<T>
{
...
#[cfg(feature = "UnityEngine+Rendering+DebugDisplaySettings_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::UnityEngine::Rendering::IDebugDisplaySettings>
    for crate::UnityEngine::Rendering::DebugDisplaySettings_1<T>
{
...
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::DebugDisplaySettings_1_IDebugDisplaySettingsDataComparer<T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
...
#[cfg(feature = "UnityEngine+Rendering+DebugDisplaySettings_1+IDebugDisplaySettingsDataComparer")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::UnityEngine::Rendering::DebugDisplaySettings_1_IDebugDisplaySettingsDataComparer<T>
{
    type Target = quest_hook::libil2cpp::Il2CppObject;
    ...
    crate::UnityEngine::Rendering::DebugDisplaySettings_1_IDebugDisplaySettingsDataComparer<T>
{
    pub fn Equals(
        &mut self,
        x: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::IDebugDisplaySettingsData>,
        y: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::IDebugDisplaySettingsData>,
    ) -> quest_hook::libil2cpp::Result<bool>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
    ...
    pub fn GetHashCode(
        &mut self,
        obj: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::IDebugDisplaySettingsData>,
