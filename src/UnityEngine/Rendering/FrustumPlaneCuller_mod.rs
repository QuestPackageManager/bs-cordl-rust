...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FrustumPlaneCuller")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::FrustumPlaneCuller {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FrustumPlaneCuller")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::Rendering::FrustumPlaneCuller {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FrustumPlaneCuller")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::Rendering::FrustumPlaneCuller {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FrustumPlaneCuller")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::Rendering::FrustumPlaneCuller {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FrustumPlaneCuller")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::Rendering::FrustumPlaneCuller {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::Rendering::FrustumPlaneCuller {
    ...
    pub fn ComputeSplitVisibilityMask(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), u32, 3usize>("ComputeSplitVisibilityMask")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: u32 =
            unsafe { cordl_method_info.invoke_unchecked((), (planePackets, splitInfos, bounds))? };
        Ok(__cordl_ret.into())
    }
    pub fn Create(
        cc: quest_hook::libil2cpp::ByRefMut<crate::UnityEngine::Rendering::BatchCullingContext>,
        receiverPlanes: crate::Unity::Collections::NativeArray_1<crate::UnityEngine::Plane>,
    ...
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Rendering::FrustumPlaneCuller> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Rendering::FrustumPlaneCuller, 4usize>(
                        "Create"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::FrustumPlaneCuller = unsafe {
            cordl_method_info
                .invoke_unchecked((), (cc, receiverPlanes, receiverSphereCuller, allocator))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Dispose(
...
impl crate::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4 {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (planes, offset, limit))? };
        Ok(__cordl_ret.into())
    }
}
