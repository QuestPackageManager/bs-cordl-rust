...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ShaderTagId")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::Rendering::ShaderTagId {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ShaderTagId")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::Rendering::ShaderTagId {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ShaderTagId")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::Rendering::ShaderTagId {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ShaderTagId")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::Rendering::ShaderTagId {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ShaderTagId")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::Rendering::ShaderTagId {
    type Type = Self;
...
impl crate::UnityEngine::Rendering::ShaderTagId {
    ...
    pub fn Equals_ShaderTagId1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::Rendering::ShaderTagId), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn op_Equality(
        tag1: crate::UnityEngine::Rendering::ShaderTagId,
        tag2: crate::UnityEngine::Rendering::ShaderTagId,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (tag1, tag2))? };
        Ok(__cordl_ret.into())
    }
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::Rendering::ShaderTagId> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Rendering+ShaderTagId")]
