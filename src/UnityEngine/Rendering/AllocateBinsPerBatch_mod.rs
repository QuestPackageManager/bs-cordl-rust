...
pub struct AllocateBinsPerBatch {
    ...
    pub binAllocCounter: crate::Unity::Collections::NativeArray_1<i32>,
...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::AllocateBinsPerBatch {
    ...
    const CLASS_NAME: &'static str = "AllocateBinsPerBatch";
...
impl crate::UnityEngine::Rendering::AllocateBinsPerBatch {
    pub fn Execute(
        &mut self,
        batchIndex: i32,
