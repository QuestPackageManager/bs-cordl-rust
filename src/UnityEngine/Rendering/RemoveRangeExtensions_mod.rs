...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RemoveRangeExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::RemoveRangeExtensions {
...
impl crate::UnityEngine::Rendering::RemoveRangeExtensions {
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                    ), bool, 4usize>("TryRemoveElementsInRange")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (list, index, count, error))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RemoveRangeExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Rendering::RemoveRangeExtensions {
