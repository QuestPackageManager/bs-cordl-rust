...
pub struct FrameTimeSample {
    ...
    pub MainThreadCPUFrameTime: f32,
    pub MainThreadCPUPresentWaitTime: f32,
    pub RenderThreadCPUFrameTime: f32,
...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::FrameTimeSample {
    ...
    const CLASS_NAME: &'static str = "FrameTimeSample";
...
#[cfg(feature = "UnityEngine+Rendering+FrameTimeSample")]
impl crate::UnityEngine::Rendering::FrameTimeSample {
    pub fn _ctor(
        &mut self,
        initValue: f32,
