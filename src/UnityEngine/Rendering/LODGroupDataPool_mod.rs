...
pub struct LODGroupDataPool {
    ...
    pub m_LODGroupData: crate::Unity::Collections::NativeList_1<
    ...
    >,
    pub m_LODGroupCullingData: crate::Unity::Collections::NativeList_1<
        crate::UnityEngine::Rendering::LODGroupCullingData,
    >,
    pub m_FreeLODGroupDataHandles: crate::Unity::Collections::NativeList_1<
        crate::UnityEngine::Rendering::GPUInstanceIndex,
    >,
...
for crate::UnityEngine::Rendering::LODGroupDataPool {
...
impl crate::UnityEngine::Rendering::LODGroupDataPool {
    ...
    pub fn FreeLODGroupData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (destroyedLODGroupsID))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn UpdateLODGroupData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (inputData))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateLODGroupTransformData", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
