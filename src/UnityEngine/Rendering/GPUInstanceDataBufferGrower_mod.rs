...
pub struct GPUInstanceDataBufferGrower {
    pub m_SrcBuffer: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::GPUInstanceDataBuffer,
    >,
    pub m_DstBuffer: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::GPUInstanceDataBuffer,
    >,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+GPUInstanceDataBufferGrower")]
...
impl crate::UnityEngine::Rendering::GPUInstanceDataBufferGrower {
    #[cfg(
        feature = "UnityEngine+Rendering+GPUInstanceDataBufferGrower+CopyInstancesKernelIDs"
    )]
    pub type CopyInstancesKernelIDs = crate::UnityEngine::Rendering::GPUInstanceDataBufferGrower_CopyInstancesKernelIDs;
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sourceBuffer, instanceNumInfo))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+GPUInstanceDataBufferGrower+GPUResources"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
