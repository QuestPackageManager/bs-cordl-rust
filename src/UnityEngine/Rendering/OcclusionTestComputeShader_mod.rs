    ...
    for crate::UnityEngine::Rendering::OcclusionTestComputeShader
{
    ...
    const CLASS_NAME: &'static str = "OcclusionTestComputeShader";
...
#[cfg(feature = "UnityEngine+Rendering+OcclusionTestComputeShader")]
impl crate::UnityEngine::Rendering::OcclusionTestComputeShader {
    pub fn Init(
        &mut self,
