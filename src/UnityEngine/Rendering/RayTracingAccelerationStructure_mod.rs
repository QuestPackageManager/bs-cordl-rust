...
impl std::ops::Deref for crate::UnityEngine::Rendering::RayTracingAccelerationStructure {
...
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct RayTracingAccelerationStructure_BindingsMarshaller {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
}
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+RayTracingAccelerationStructure+BindingsMarshaller"
    ...
    for crate::UnityEngine::Rendering::RayTracingAccelerationStructure_BuildSettings
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "RayTracingAccelerationStructure/BuildSettings";
