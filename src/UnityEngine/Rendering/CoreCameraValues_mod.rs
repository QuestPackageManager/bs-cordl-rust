...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+CoreCameraValues")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::CoreCameraValues {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "CoreCameraValues";
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+CoreCameraValues")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::Rendering::CoreCameraValues {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+CoreCameraValues")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::Rendering::CoreCameraValues {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+CoreCameraValues")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::Rendering::CoreCameraValues {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+CoreCameraValues")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::Rendering::CoreCameraValues {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::Rendering::CoreCameraValues), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    for crate::UnityEngine::Rendering::CoreCameraValues
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::UnityEngine::Rendering::CoreCameraValues> {
        todo!()
    }
}
