...
impl crate::UnityEngine::Rendering::CoreCameraValues {
    pub fn Equals_CoreCameraValues0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Rendering::CoreCameraValues as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Rendering::CoreCameraValues as
