...
pub struct BatchRendererGroupGlobals {
    ...
    pub SpecCube1_HDR: crate::UnityEngine::Vector4,
    pub SHCoefficients: crate::UnityEngine::Rendering::SHCoefficients,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+BatchRendererGroupGlobals")]
    ...
    for crate::UnityEngine::Rendering::BatchRendererGroupGlobals
{
    ...
    const CLASS_NAME: &'static str = "BatchRendererGroupGlobals";
...
impl crate::UnityEngine::Rendering::BatchRendererGroupGlobals {
    pub const kGlobalsPropertyName: &'static str = "unity_DOTSInstanceGlobalValues";
    pub fn Equals_BatchRendererGroupGlobals0(
        &mut self,
