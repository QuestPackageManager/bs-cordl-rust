...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::Rendering::ObjectPool_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> = unsafe {
...
pub struct ObjectPool_1_PooledObject<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_Pool: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::ObjectPool_1<T>,
    >,
    __cordl_phantom_T: std::marker::PhantomData<T>,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ObjectPool_1+PooledObject")]
...
> crate::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (value, pool))?
        };
        Ok(__cordl_ret.into())
    }
}
