...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FindDrawInstancesJob")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::FindDrawInstancesJob {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+FindDrawInstancesJob")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::Rendering::FindDrawInstancesJob {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
