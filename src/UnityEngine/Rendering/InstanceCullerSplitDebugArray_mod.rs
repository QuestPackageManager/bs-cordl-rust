...
for crate::UnityEngine::Rendering::InstanceCullerSplitDebugArray {
    ...
    const CLASS_NAME: &'static str = "InstanceCullerSplitDebugArray";
...
impl crate::UnityEngine::Rendering::InstanceCullerSplitDebugArray {
    pub const MaxSplitCount: i32 = 64i32;
    #[cfg(feature = "UnityEngine+Rendering+InstanceCullerSplitDebugArray+Info")]
    pub type Info = crate::UnityEngine::Rendering::InstanceCullerSplitDebugArray_Info;
    pub fn AddSync(
        &mut self,
        baseIndex: i32,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(), "AddSync",
                            2usize
                        )
                    })
            });
    ...
    pub fn TryAddSplits(
        &mut self,
        viewType: crate::UnityEngine::Rendering::BatchCullingViewType,
        viewInstanceID: i32,
        splitCount: i32,
...
for crate::UnityEngine::Rendering::InstanceCullerSplitDebugArray_Info {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "InstanceCullerSplitDebugArray/Info";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
#[cfg(feature = "UnityEngine+Rendering+InstanceCullerSplitDebugArray+Info")]
impl crate::UnityEngine::Rendering::InstanceCullerSplitDebugArray_Info {}
