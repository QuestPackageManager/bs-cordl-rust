...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ArrayExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::ArrayExtensions {
...
impl crate::UnityEngine::Rendering::ArrayExtensions {
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 4usize>("FillArray")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (array, value, startIndex, length))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("ResizeArray")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (array, capacity))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ArrayExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Rendering::ArrayExtensions {
