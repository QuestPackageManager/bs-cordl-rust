...
pub struct AtlasAllocator {
    ...
    pub m_Root: quest_hook::libil2cpp::Gc<
...
for crate::UnityEngine::Rendering::AtlasAllocator {
...
impl crate::UnityEngine::Rendering::AtlasAllocator {
    ...
    pub fn Allocate(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (result, width, height))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (width, height, potPadding))?
        };
        Ok(__cordl_ret.into())
    }
}
...
pub struct AtlasAllocator_AtlasNode {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub m_RightChild: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::AtlasAllocator_AtlasNode,
    >,
    pub m_BottomChild: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::AtlasAllocator_AtlasNode,
    >,
...
impl crate::UnityEngine::Rendering::AtlasAllocator_AtlasNode {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (pool, width, height, powerOfTwoPadding))?
        };
        Ok(__cordl_ret.into())
    }
