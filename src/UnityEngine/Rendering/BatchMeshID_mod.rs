...
impl crate::UnityEngine::Rendering::BatchMeshID {
    pub fn Equals_BatchMeshID1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Rendering::BatchMeshID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Rendering::BatchMeshID as
