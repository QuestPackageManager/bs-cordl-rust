...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+InstanceOcclusionEventDebugArray+Info"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+InstanceOcclusionEventDebugArray+Request"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
