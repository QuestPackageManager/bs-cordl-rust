#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+IRasterRenderGraphBuilder"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Rendering::RenderGraphModule::IRasterRenderGraphBuilder {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetInputAttachment", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tex, index, flags))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetRenderAttachmentDepth", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (tex, flags))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::RenderGraphModule::BufferHandle = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (tex, index, preserveCounterValue, flags))?
        };
        Ok(__cordl_ret.into())
    }
