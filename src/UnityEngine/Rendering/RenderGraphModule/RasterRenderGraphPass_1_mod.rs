#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+RasterRenderGraphPass_1")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct RasterRenderGraphPass_1<PassData: quest_hook::libil2cpp::Type> {
...
unsafe impl<PassData: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::RenderGraphModule::RasterRenderGraphPass_1<PassData>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.RenderGraphModule";
    const CLASS_NAME: &'static str = "RasterRenderGraphPass`1";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+RasterRenderGraphPass_1")]
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+RasterRenderGraphPass_1")]
impl<PassData: quest_hook::libil2cpp::Type>
    crate::UnityEngine::Rendering::RenderGraphModule::RasterRenderGraphPass_1<PassData>
{
    pub fn Execute(
        &mut self,
