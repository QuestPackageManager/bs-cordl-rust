...
for crate::UnityEngine::Rendering::RenderGraphModule::RendererListLegacyResource {
    ...
    const CLASS_NAME: &'static str = "RendererListLegacyResource";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+RendererListLegacyResource")]
impl crate::UnityEngine::Rendering::RenderGraphModule::RendererListLegacyResource {
    pub fn _ctor(
        &mut self,
