...
impl std::ops::Deref for crate::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtils {
...
impl crate::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtils {
    #[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+Util+RenderGraphUtils+BlitFilterMode")]
    pub type BlitFilterMode =
    ...
    #[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+Util+RenderGraphUtils+BlitPassData")]
    pub type BlitPassData =
        crate::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtils_BlitPassData;
    #[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+Util+RenderGraphUtils+CopyPassData")]
    pub type CopyPassData =
    ...
    pub fn AddBlitPass_RenderGraphUtils_BlitMaterialParameters_Il2CppString_Il2CppString_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (graph, blitParameters, passName, file, line))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 10usize>("AddCopyPass")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn BlitMaterialRenderFunc(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (data, context))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CopyRenderFunc(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (data, rgContext))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+Util+RenderGraphUtils")]
    ...
    crate::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtils_BlitMaterialParameters
{
    pub fn _ctor_Material_i32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (source, destination, material, shaderPass))?
        };
        Ok(__cordl_ret.into())
    }
