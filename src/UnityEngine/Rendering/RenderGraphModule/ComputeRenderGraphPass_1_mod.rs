#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+ComputeRenderGraphPass_1"
)]
#[repr(C)]
#[derive(Debug)]
...
for crate::UnityEngine::Rendering::RenderGraphModule::ComputeRenderGraphPass_1<
    PassData,
> {
