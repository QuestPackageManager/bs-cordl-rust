#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+ComputeRenderGraphPass_1")]
#[repr(C)]
#[derive(Debug)]
pub struct ComputeRenderGraphPass_1<PassData: quest_hook::libil2cpp::Type> {
...
unsafe impl<PassData: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::RenderGraphModule::ComputeRenderGraphPass_1<PassData>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.RenderGraphModule";
    const CLASS_NAME: &'static str = "ComputeRenderGraphPass`1";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+ComputeRenderGraphPass_1")]
...
impl<PassData: quest_hook::libil2cpp::Type>
    crate::UnityEngine::Rendering::RenderGraphModule::ComputeRenderGraphPass_1<PassData>
{
    pub fn Execute(
        &mut self,
