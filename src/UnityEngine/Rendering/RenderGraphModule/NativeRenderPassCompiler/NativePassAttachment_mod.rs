...
pub struct NativePassAttachment {
    ...
    pub storeAction: crate::UnityEngine::Rendering::RenderBufferStoreAction,
    pub memoryless: bool,
    pub mipLevel: i32,
    pub depthSlice: i32,
}
...
for crate::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassAttachment {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler";
    const CLASS_NAME: &'static str = "NativePassAttachment";
