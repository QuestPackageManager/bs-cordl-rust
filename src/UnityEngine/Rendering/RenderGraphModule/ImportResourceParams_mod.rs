    ...
    for crate::UnityEngine::Rendering::RenderGraphModule::ImportResourceParams
{
    ...
    const CLASS_NAME: &'static str = "ImportResourceParams";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+ImportResourceParams")]
impl crate::UnityEngine::Rendering::RenderGraphModule::ImportResourceParams {}
