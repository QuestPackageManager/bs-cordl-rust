#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+BaseRenderGraphPass_2"
)]
#[repr(C)]
#[derive(Debug)]
...
> {
    ...
    where
        ...
        TRenderGraphContext: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (passIndex, passData, passName, passType, sampler),
                )?
        };
        Ok(__cordl_ret.into())
    }
