#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+UnsafeGraphContext")]
#[repr(C)]
#[derive(Debug)]
pub struct UnsafeGraphContext {
    ...
    >,
    pub cmd: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::UnsafeCommandBuffer>,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+UnsafeGraphContext")]
...
impl std::ops::Deref for crate::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext {
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+UnsafeGraphContext")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext {
