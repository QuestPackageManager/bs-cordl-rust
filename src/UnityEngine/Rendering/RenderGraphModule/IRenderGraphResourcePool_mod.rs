#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+IRenderGraphResourcePool")]
#[repr(C)]
#[derive(Debug)]
pub struct IRenderGraphResourcePool {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+IRenderGraphResourcePool")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.RenderGraphModule";
    const CLASS_NAME: &'static str = "IRenderGraphResourcePool";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+IRenderGraphResourcePool")]
impl std::ops::Deref
    for crate::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool
{
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+IRenderGraphResourcePool")]
impl crate::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool {
