#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+RenderGraphContext"
)]
#[repr(C)]
...
impl crate::UnityEngine::Rendering::RenderGraphModule::RenderGraphContext {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::ScriptableRenderContext = unsafe {
