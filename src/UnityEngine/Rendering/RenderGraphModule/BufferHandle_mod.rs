#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderGraphModule+BufferHandle")]
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::RenderGraphModule::BufferHandle
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.RenderGraphModule";
    const CLASS_NAME: &'static str = "BufferHandle";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+BufferHandle")]
impl crate::UnityEngine::Rendering::RenderGraphModule::BufferHandle {
    ...
    pub fn _ctor_ByRefMut0(
        &mut self,
        h: quest_hook::libil2cpp::ByRefMut<
    ...
    pub fn _ctor_i32__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (handle, shared))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_nullHandle(
    ...
    pub fn op_Implicit(
        buffer: crate::UnityEngine::Rendering::RenderGraphModule::BufferHandle,
