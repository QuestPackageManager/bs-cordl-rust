    ...
    for crate::UnityEngine::Rendering::RenderGraphModule::TextureHandle
{
    ...
    const CLASS_NAME: &'static str = "TextureHandle";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+TextureHandle")]
impl crate::UnityEngine::Rendering::RenderGraphModule::TextureHandle {
