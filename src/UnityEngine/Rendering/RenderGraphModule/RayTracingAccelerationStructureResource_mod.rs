...
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureResource
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.RenderGraphModule";
    const CLASS_NAME: &'static str = "RayTracingAccelerationStructureResource";
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+RayTracingAccelerationStructureResource")]
impl std::ops::Deref
    for crate::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureResource
{
...
#[cfg(feature = "UnityEngine+Rendering+RenderGraphModule+RayTracingAccelerationStructureResource")]
impl crate::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureResource {
    pub fn GetName(
        &mut self,
