...
#[cfg(feature = "UnityEngine+Rendering+ShaderDebugPrintInputProducer")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::ShaderDebugPrintInputProducer {
...
impl crate::UnityEngine::Rendering::ShaderDebugPrintInputProducer {
    pub fn Get(
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Rendering::ShaderDebugPrintInput> {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::ShaderDebugPrintInput =
