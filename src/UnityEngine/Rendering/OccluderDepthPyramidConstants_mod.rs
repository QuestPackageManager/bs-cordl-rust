...
pub struct OccluderDepthPyramidConstants {
    ...
    pub _SrcOffset: crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___SrcOffset_e__FixedBuffer,
    pub _MipOffsetAndSize: crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer,
    pub _OccluderMipLayoutSizeX: u32,
    pub _OccluderMipLayoutSizeY: u32,
    pub _OccluderDepthPyramidPad0: u32,
    pub _OccluderDepthPyramidPad1: u32,
    pub _SrcSliceIndices: u32,
    pub _DstSubviewIndices: u32,
    pub _MipCount: u32,
    pub _SilhouettePlaneCount: u32,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+OccluderDepthPyramidConstants")]
...
for crate::UnityEngine::Rendering::OccluderDepthPyramidConstants {
    ...
    const CLASS_NAME: &'static str = "OccluderDepthPyramidConstants";
...
#[cfg(feature = "UnityEngine+Rendering+OccluderDepthPyramidConstants")]
impl crate::UnityEngine::Rendering::OccluderDepthPyramidConstants {
    #[cfg(
        feature = "UnityEngine+Rendering+OccluderDepthPyramidConstants+__InvViewProjMatrix_e__FixedBuffer"
    )]
    pub type __InvViewProjMatrix_e__FixedBuffer = crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer;
    #[cfg(
        feature = "UnityEngine+Rendering+OccluderDepthPyramidConstants+__MipOffsetAndSize_e__FixedBuffer"
    )]
    pub type __MipOffsetAndSize_e__FixedBuffer = crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer;
    #[cfg(
        feature = "UnityEngine+Rendering+OccluderDepthPyramidConstants+__SilhouettePlanes_e__FixedBuffer"
    )]
    pub type __SilhouettePlanes_e__FixedBuffer = crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer;
    #[cfg(
...
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "OccluderDepthPyramidConstants/<_InvViewProjMatrix>e__FixedBuffer";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "OccluderDepthPyramidConstants/<_MipOffsetAndSize>e__FixedBuffer";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "OccluderDepthPyramidConstants/<_SilhouettePlanes>e__FixedBuffer";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
for crate::UnityEngine::Rendering::OccluderDepthPyramidConstants___SrcOffset_e__FixedBuffer {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "OccluderDepthPyramidConstants/<_SrcOffset>e__FixedBuffer";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
