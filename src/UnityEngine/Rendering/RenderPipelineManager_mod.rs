...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderPipelineManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::RenderPipelineManager {
...
impl crate::UnityEngine::Rendering::RenderPipelineManager {
    ...
    pub fn CleanupRenderPipeline() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn DoRenderLoop_Internal(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (pipelineAsset, loopPtr, renderRequest))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetCurrentPipelineAssetType(
    ...
    pub fn OnActiveRenderPipelineTypeChanged(
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn TryPrepareRenderPipeline(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (pipelineAsset))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+RenderPipelineManager")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Rendering::RenderPipelineManager {
