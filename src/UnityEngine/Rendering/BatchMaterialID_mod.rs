...
impl crate::UnityEngine::Rendering::BatchMaterialID {
    pub fn Equals_BatchMaterialID1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Rendering::BatchMaterialID as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Rendering::BatchMaterialID as
