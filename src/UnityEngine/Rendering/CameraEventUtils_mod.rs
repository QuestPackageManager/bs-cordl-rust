...
impl crate::UnityEngine::Rendering::CameraEventUtils {
    pub fn IsValid(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Rendering::CameraEventUtils as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Rendering::CameraEventUtils as
