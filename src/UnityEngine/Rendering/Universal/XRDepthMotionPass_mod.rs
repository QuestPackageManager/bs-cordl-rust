...
pub struct XRDepthMotionPass {
    ...
    pub m_XRMotionVectorMaterial: quest_hook::libil2cpp::Gc<
...
impl crate::UnityEngine::Rendering::Universal::XRDepthMotionPass {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ImportXRMotionColorAndDepth", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (renderGraph, cameraData))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn InitPassData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (passData, cameraData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (evt, xrMotionVector))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+XRDepthMotionPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
