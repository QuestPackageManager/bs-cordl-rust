...
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::DecalSkipCulledSystem {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalSkipCulledSystem")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::DecalSkipCulledSystem {
...
impl crate::UnityEngine::Rendering::Universal::DecalSkipCulledSystem {
    ...
    pub fn Execute_DecalCulledChunk_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (culledChunk, count))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetSceneCullingMaskFromCamera(
        ...
        let __cordl_ret: u64 = unsafe { cordl_method_info.invoke_unchecked((), (camera))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
