...
pub struct DecalEntityIndexer {
    ...
    pub m_Entities: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub m_FreeIndices: quest_hook::libil2cpp::Gc<
...
impl crate::UnityEngine::Rendering::Universal::DecalEntityIndexer {
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+DecalEntityIndexer+DecalEntityItem"
    )]
    pub type DecalEntityItem = crate::UnityEngine::Rendering::Universal::DecalEntityIndexer_DecalEntityItem;
    pub fn Clear(
        &mut self,
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::Universal::DecalEntity = unsafe {
            cordl_method_info.invoke_unchecked(self, (arrayIndex, chunkIndex))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RemapChunkIndices(
        &mut self,
        remaper: quest_hook::libil2cpp::Gc<
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (remaper))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateIndex(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (decalEntity, newArrayIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+DecalEntityIndexer+DecalEntityItem"
)]
#[repr(C)]
