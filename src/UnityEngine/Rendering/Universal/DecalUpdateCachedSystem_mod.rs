...
pub struct DecalUpdateCachedSystem {
    ...
    >,
    pub m_SamplerJob: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::ProfilingSampler,
    >,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+DecalUpdateCachedSystem")]
...
impl crate::UnityEngine::Rendering::Universal::DecalUpdateCachedSystem {
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+DecalUpdateCachedSystem+UpdateTransformsJob"
    )]
    pub type UpdateTransformsJob = crate::UnityEngine::Rendering::Universal::DecalUpdateCachedSystem_UpdateTransformsJob;
    pub fn Execute_0(
        &mut self,
    ...
    pub fn Execute_DecalEntityChunk_DecalCachedChunk_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (entityChunk, cachedChunk, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
impl crate::UnityEngine::Rendering::Universal::DecalUpdateCachedSystem_UpdateTransformsJob {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DistanceBetweenQuaternions", 2usize
                        )
                    })
            });
    ...
    pub fn GetDecalProjectBoundingSphere(
        ...
        let __cordl_ret: crate::UnityEngine::BoundingSphere = unsafe {
            cordl_method_info.invoke_unchecked(self, (decalToWorld))?
        };
        Ok(__cordl_ret.into())
    }
}
