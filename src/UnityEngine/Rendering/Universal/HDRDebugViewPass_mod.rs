...
pub struct HDRDebugViewPass {
    ...
    >,
    pub m_CIExyTarget: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
    pub m_PassthroughRT: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
...
impl crate::UnityEngine::Rendering::Universal::HDRDebugViewPass {
    ...
    pub fn ExecuteCIExyPrepass(
        ...
        data: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::Rendering::Universal::HDRDebugViewPass_PassDataCIExy,
        >,
        sourceTexture: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::Rendering::Universal::UniversalCameraData,
                    >), crate::UnityEngine::Vector4, 1usize>(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 6usize>("RenderHDRDebug")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Setup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cameraData, hdrdebugMode))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
...
#[cfg(feature = "UnityEngine+Rendering+Universal+HDRDebugViewPass+PassDataCIExy")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::HDRDebugViewPass_PassDataCIExy {
