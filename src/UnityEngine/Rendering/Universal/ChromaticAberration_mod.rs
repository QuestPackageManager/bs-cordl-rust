#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+ChromaticAberration")]
#[repr(C)]
#[derive(Debug)]
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::Universal::ChromaticAberration
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.Universal";
    const CLASS_NAME: &'static str = "ChromaticAberration";
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ChromaticAberration")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::ChromaticAberration {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ChromaticAberration")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::ChromaticAberration {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+ChromaticAberration")]
impl crate::UnityEngine::Rendering::Universal::ChromaticAberration {
