...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::Universal::ZBinningJob {
    ...
    const CLASS_NAME: &'static str = "ZBinningJob";
...
impl crate::UnityEngine::Rendering::Universal::ZBinningJob {
    pub const batchSize: i32 = 128i32;
    pub const headerLength: i32 = 2i32;
    pub fn DecodeHeader(
        zBin: u32,
