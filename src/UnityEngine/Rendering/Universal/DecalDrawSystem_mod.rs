...
pub struct DecalDrawSystem {
    ...
    pub m_NormalToDecals: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Matrix4x4>,
    >,
    pub m_DecalLayerMasks: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<f32>,
    >,
    pub m_Sampler: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::ProfilingSampler,
    >,
    pub _overrideMaterial_k__BackingField: quest_hook::libil2cpp::Gc<
...
impl crate::UnityEngine::Rendering::Universal::DecalDrawSystem {
    pub fn DrawInstanced_ByRefMut1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (cameraData, decalEntityChunk, decalCachedChunk, decalDrawCallChunk),
                )?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Execute_RasterCommandBuffer_DecalEntityChunk_DecalCachedChunk_DecalDrawCallChunk_i32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (cmd, decalEntityChunk, decalCachedChunk, decalDrawCallChunk, count),
                )?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Material> = unsafe {
            cordl_method_info.invoke_unchecked(self, (decalEntityChunk))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetPassIndex(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (sampler, entityManager))?
        };
        Ok(__cordl_ret.into())
    }
