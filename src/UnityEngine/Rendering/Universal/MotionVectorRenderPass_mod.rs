...
impl crate::UnityEngine::Rendering::Universal::MotionVectorRenderPass {
    ...
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+MotionVectorRenderPass+MotionMatrixPassData"
    )]
    pub type MotionMatrixPassData = crate::UnityEngine::Rendering::Universal::MotionVectorRenderPass_MotionMatrixPassData;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DrawCameraMotionVectors", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cmd, xr, cameraMaterial))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DrawObjectMotionVectors", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cmd, xr, rendererList))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Execute(
    ...
    pub fn GetDrawingSettings(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::DrawingSettings = unsafe {
            cordl_method_info.invoke_unchecked((), (camera, supportsDynamicBatching))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn InitPassData(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetMotionVectorGlobalMatrices", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cmd, cameraData))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetRenderGraphMotionVectorGlobalMatrices", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (renderGraph, cameraData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Setup(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (evt, cameraMaterial, opaqueLayerMask))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+MotionVectorRenderPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
