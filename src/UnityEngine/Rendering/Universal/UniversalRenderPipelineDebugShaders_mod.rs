#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+UniversalRenderPipelineDebugShaders"
)]
#[repr(C)]
#[derive(Debug)]
pub struct UniversalRenderPipelineDebugShaders {
    ...
    pub m_ProbeVolumeSamplingDebugComputeShader: quest_hook::libil2cpp::Gc<
