...
#[cfg(feature = "UnityEngine+Rendering+Universal+XROcclusionMeshPass")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::XROcclusionMeshPass {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+XROcclusionMeshPass+PassData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "UnityEngine+Rendering+Universal+XROcclusionMeshPass+PassData")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::XROcclusionMeshPass_PassData {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+XROcclusionMeshPass+PassData")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::XROcclusionMeshPass_PassData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
