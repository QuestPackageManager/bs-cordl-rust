...
pub struct ProbeVolumeDebugPass {
    ...
    pub m_NormalTexture: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+ProbeVolumeDebugPass")]
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ProbeVolumeDebugPass")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass {
...
impl crate::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass {
    ...
    pub type WriteApvData =
        crate::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass_WriteApvData;
    pub fn Execute(
        &mut self,
    ...
    pub fn Setup(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (depthBuffer, normalBuffer))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (evt, computeShader))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+ProbeVolumeDebugPass")]
