...
pub struct RenderGraphSettings {
    ...
    pub m_Version: crate::UnityEngine::Rendering::Universal::RenderGraphSettings_Version,
    pub m_EnableRenderCompatibilityMode: bool,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+RenderGraphSettings")]
...
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::RenderGraphSettings {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+RenderGraphSettings")]
impl crate::UnityEngine::Rendering::Universal::RenderGraphSettings {
    ...
    pub fn set_enableRenderCompatibilityMode(
        &mut self,
        value: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
...
for crate::UnityEngine::Rendering::Universal::RenderGraphSettings_Version {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.Universal";
    const CLASS_NAME: &'static str = "RenderGraphSettings/Version";
