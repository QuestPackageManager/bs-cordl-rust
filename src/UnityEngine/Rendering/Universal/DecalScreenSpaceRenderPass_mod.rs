#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+DecalScreenSpaceRenderPass"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass {
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+DecalScreenSpaceRenderPass+PassData"
    )]
    pub type PassData = crate::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData;
    ...
    pub fn InitPassData(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cameraData, passData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (settings, drawSystem, decalLayers))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+DecalScreenSpaceRenderPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
