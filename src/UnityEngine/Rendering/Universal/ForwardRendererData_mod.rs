...
impl crate::UnityEngine::Rendering::Universal::ForwardRendererData {
    pub const k_ErrorMessage: &'static str = "ForwardRendererData has been deprecated. Use UniversalRendererData instead";
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+ForwardRendererData+ShaderResources"
    )]
    pub type ShaderResources = crate::UnityEngine::Rendering::Universal::ForwardRendererData_ShaderResources;
    pub fn Create(
        &mut self,
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+ForwardRendererData+ShaderResources"
)]
#[repr(C)]
#[derive(Debug)]
