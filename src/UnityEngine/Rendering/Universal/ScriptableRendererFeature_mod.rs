#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+ScriptableRendererFeature")]
#[repr(C)]
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::Universal::ScriptableRendererFeature
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.Universal";
    const CLASS_NAME: &'static str = "ScriptableRendererFeature";
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ScriptableRendererFeature")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::ScriptableRendererFeature {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ScriptableRendererFeature")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::ScriptableRendererFeature {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+ScriptableRendererFeature")]
impl crate::UnityEngine::Rendering::Universal::ScriptableRendererFeature {
