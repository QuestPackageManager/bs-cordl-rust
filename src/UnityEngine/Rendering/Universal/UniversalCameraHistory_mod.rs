...
pub struct UniversalCameraHistory {
    ...
    >,
    pub m_Version: i32,
    pub m_HistoryTextures: quest_hook::libil2cpp::Gc<
...
impl crate::UnityEngine::Rendering::Universal::UniversalCameraHistory {
    ...
    pub type TypeId_1<T: quest_hook::libil2cpp::Type> = crate::UnityEngine::Rendering::Universal::UniversalCameraHistory_TypeId_1<
        T,
    >;
    pub fn Dispose(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SwapAndSetReferenceSize", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cameraWidth, cameraHeight))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
for crate::UnityEngine::Rendering::Universal::UniversalCameraHistory {
    fn as_mut(
        &mut self,
    ) -> &mut crate::UnityEngine::Rendering::ICameraHistoryReadAccess {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+UniversalCameraHistory")]
...
for crate::UnityEngine::Rendering::Universal::UniversalCameraHistory {
    fn as_mut(
        &mut self,
    ) -> &mut crate::UnityEngine::Rendering::ICameraHistoryWriteAccess {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+UniversalCameraHistory")]
...
for crate::UnityEngine::Rendering::Universal::UniversalCameraHistory {
    fn as_mut(
        &mut self,
    ) -> &mut crate::UnityEngine::Rendering::IPerFrameHistoryAccessTracker {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+UniversalCameraHistory+Item"
)]
#[repr(C)]
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+UniversalCameraHistory+TypeId_1"
)]
#[repr(C)]
#[derive(Debug)]
