...
pub struct DecalPreviewPass {
    ...
    >,
    pub m_ProfilingSampler:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::ProfilingSampler>,
    pub m_PassData: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::Universal::DecalPreviewPass_PassData,
    >,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+DecalPreviewPass")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::Universal::DecalPreviewPass
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.Universal";
    const CLASS_NAME: &'static str = "DecalPreviewPass";
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::DecalPreviewPass {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::DecalPreviewPass {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass")]
impl crate::UnityEngine::Rendering::Universal::DecalPreviewPass {
    #[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass+PassData")]
    pub type PassData = crate::UnityEngine::Rendering::Universal::DecalPreviewPass_PassData;
    pub fn Execute(
        &mut self,
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+DecalPreviewPass+PassData")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::Universal::DecalPreviewPass_PassData
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.Universal";
    const CLASS_NAME: &'static str = "DecalPreviewPass/PassData";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass+PassData")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::DecalPreviewPass_PassData {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass+PassData")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::DecalPreviewPass_PassData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+DecalPreviewPass+PassData")]
impl crate::UnityEngine::Rendering::Universal::DecalPreviewPass_PassData {
    pub fn New() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
