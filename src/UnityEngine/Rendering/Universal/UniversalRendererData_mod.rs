...
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::UniversalRendererData {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+UniversalRendererData")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::UniversalRendererData {
...
impl crate::UnityEngine::Rendering::Universal::UniversalRendererData {
    ...
    pub fn get_copyDepthMode(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Rendering::Universal::CopyDepthMode>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::Universal::CopyDepthMode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_depthAttachmentFormat(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Rendering::Universal::DepthFormat> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::Universal::DepthFormat =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::Universal::IntermediateTextureMode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
