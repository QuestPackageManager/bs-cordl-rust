#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+ScreenSpaceAmbientOcclusionPass"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionPass {
    ...
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+ScreenSpaceAmbientOcclusionPass+BlurTypes"
    )]
    pub type BlurTypes = crate::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionPass_BlurTypes;
    #[cfg(
    ...
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+ScreenSpaceAmbientOcclusionPass+SSAOPassData"
    )]
    pub type SSAOPassData = crate::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionPass_SSAOPassData;
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+ScreenSpaceAmbientOcclusionPass+ShaderPasses"
    )]
    pub type ShaderPasses = crate::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionPass_ShaderPasses;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateRenderTextureHandles", 6usize
                        )
                    })
            });
    ...
    pub fn GetPassOrder(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    (),
                    (blurType, isAfterOpaque, textureIndices, shaderPasses),
                )?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetupKeywordsAndParameters(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (settings, cameraData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionPass_SSAOMaterialParams {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (settings, isOrthographic))?
        };
        Ok(__cordl_ret.into())
    }
}
