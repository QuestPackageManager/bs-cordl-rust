...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+ColorLookup")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::Universal::ColorLookup {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering.Universal";
    const CLASS_NAME: &'static str = "ColorLookup";
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ColorLookup")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::ColorLookup {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+ColorLookup")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::ColorLookup {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+Rendering+Universal+ColorLookup")]
impl crate::UnityEngine::Rendering::Universal::ColorLookup {
    ...
    pub fn ValidateLUT(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("ValidateLUT")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+ColorLookup")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Rendering::Universal::ColorLookup {
...
impl AsRef<crate::UnityEngine::Rendering::IPostProcessComponent>
    for crate::UnityEngine::Rendering::Universal::ColorLookup
{
