...
pub struct DebugRenderSetup {
    ...
    pub m_DebugHandler: quest_hook::libil2cpp::Gc<
...
impl crate::UnityEngine::Rendering::Universal::DebugRenderSetup {
    ...
    pub fn CreateDrawingSettings(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::DrawingSettings = unsafe {
            cordl_method_info.invoke_unchecked(self, (drawingSettings))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DrawWithRendererList", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cmd, rendererList))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn End(
    ...
    pub fn GetRenderStateBlock(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::RenderStateBlock = unsafe {
            cordl_method_info.invoke_unchecked(self, (renderStateBlock))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (debugHandler, index, filteringSettings))?
        };
        Ok(__cordl_ret.into())
    }
