...
pub struct CopyDepthPass {
    ...
    pub _source_k__BackingField: quest_hook::libil2cpp::Gc<
...
impl crate::UnityEngine::Rendering::Universal::Internal::CopyDepthPass {
    ...
    #[cfg(
        feature = "UnityEngine+Rendering+Universal+Internal+CopyDepthPass+ShaderConstants"
    )]
    pub type ShaderConstants = crate::UnityEngine::Rendering::Universal::Internal::CopyDepthPass_ShaderConstants;
    pub fn Dispose(
        &mut self,
    ...
    pub fn ExecutePass(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cmd, passData, source))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+Internal+CopyDepthPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
