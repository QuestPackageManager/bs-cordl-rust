...
pub struct ForwardLights {
    ...
    pub m_AdditionalLightPositions:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector4>>,
    pub m_AdditionalLightColors:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector4>>,
    pub m_AdditionalLightAttenuations:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector4>>,
    pub m_AdditionalLightSpotDirections:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector4>>,
    pub m_AdditionalLightOcclusionProbeChannels:
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector4>>,
    pub m_AdditionalLightsLayerMasks:
...
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::Internal::ForwardLights {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+Internal+ForwardLights")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::Internal::ForwardLights {
...
impl crate::UnityEngine::Rendering::Universal::Internal::ForwardLights {
    ...
    #[cfg(feature = "UnityEngine+Rendering+Universal+Internal+ForwardLights+LightConstantBuffer")]
    pub type LightConstantBuffer =
        crate::UnityEngine::Rendering::Universal::Internal::ForwardLights_LightConstantBuffer;
    #[cfg(feature = "UnityEngine+Rendering+Universal+Internal+ForwardLights+SetupLightPassData")]
    pub type SetupLightPassData =
        crate::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData;
    pub fn AlignByteCount(count: i32, align: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (count, align))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetViewParams(
        ...
        viewToViewportScaleBias: quest_hook::libil2cpp::ByRefMut<crate::Unity::Mathematics::float4>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 5usize>("GetViewParams")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::Universal::UniversalLightData,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("PreSetup")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetupAdditionalLightConstants(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cmd, cullResults, lightData))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetupLights(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::Universal::UniversalLightData,
                        >,
                    ), quest_hook::libil2cpp::Void, 4usize>("SetupLights")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cmd, renderingData, cameraData, lightData))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetupPerObjectLightIndices(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::Universal::UniversalLightData,
                        >,
                    ), i32, 2usize>("SetupPerObjectLightIndices")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (cullResults, lightData))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _PreSetup_g__IsProbeGreater_40_0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::Rendering::VisibleReflectionProbe,
                    ), bool, 2usize>("<PreSetup>g__IsProbeGreater|40_0")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (probe, otherProbe))? };
        Ok(__cordl_ret.into())
    }
