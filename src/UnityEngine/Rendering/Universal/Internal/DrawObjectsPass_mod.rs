...
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::Internal::DrawObjectsPass {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+Internal+DrawObjectsPass")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::Internal::DrawObjectsPass {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+Internal+DrawObjectsPass+PassData")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
