...
impl crate::UnityEngine::Rendering::Universal::Internal::GBufferPass {
    ...
    pub fn ExecutePass(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (cmd, data, rendererList, errorRendererList))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Render(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (renderGraph, frameData, cameraColor, cameraDepth, setGlobalTextures),
                )?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+Internal+GBufferPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
