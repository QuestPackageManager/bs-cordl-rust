...
impl crate::UnityEngine::Rendering::Universal::Internal::DepthOnlyPass {
    ...
    pub fn ExecutePass(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cmd, rendererList))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Setup(
        ...
        depthAttachmentHandle: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::Rendering::RTHandle,
        >,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (baseDescriptor, depthAttachmentHandle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+Internal+DepthOnlyPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
