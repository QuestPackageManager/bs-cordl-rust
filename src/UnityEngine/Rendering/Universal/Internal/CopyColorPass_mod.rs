...
impl crate::UnityEngine::Rendering::Universal::Internal::CopyColorPass {
    ...
    pub fn ConfigureDescriptor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (downsamplingMethod, descriptor, filterMode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Execute(
    ...
    pub fn RenderInternal(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(
                    self,
                    (renderGraph, destination, source, useProceduralBlit),
                )?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "RenderToExistingTexture", 5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn Setup_RTHandle_RTHandle1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (source, destination, downsampling))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+Internal+CopyColorPass+PassData"
)]
#[repr(C)]
#[derive(Debug)]
