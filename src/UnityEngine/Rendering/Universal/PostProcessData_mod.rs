...
impl crate::UnityEngine::Rendering::Universal::PostProcessData {
    ...
    pub type ShaderResources = crate::UnityEngine::Rendering::Universal::PostProcessData_ShaderResources;
    #[cfg(feature = "UnityEngine+Rendering+Universal+PostProcessData+TextureResources")]
    pub type TextureResources = crate::UnityEngine::Rendering::Universal::PostProcessData_TextureResources;
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+PostProcessData+ShaderResources"
)]
#[repr(C)]
#[derive(Debug)]
pub struct PostProcessData_ShaderResources {
    ...
    pub subpixelMorphologicalAntialiasingPS: quest_hook::libil2cpp::Gc<
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+Universal+PostProcessData+TextureResources"
)]
#[repr(C)]
#[derive(Debug)]
