#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+InvokeOnRenderObjectCallbackPass")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::Rendering::Universal::InvokeOnRenderObjectCallbackPass {
    #[cfg(feature = "UnityEngine+Rendering+Universal+InvokeOnRenderObjectCallbackPass+PassData")]
    pub type PassData =
        crate::UnityEngine::Rendering::Universal::InvokeOnRenderObjectCallbackPass_PassData;
    pub fn Execute(
        &mut self,
    ...
    pub fn Render(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (renderGraph, colorTarget, depthTarget))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
