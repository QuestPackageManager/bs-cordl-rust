...
pub struct DBufferRenderPass {
    ...
    >,
    pub m_DBufferClearSampler:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::ProfilingSampler>,
    pub m_DecalLayers: bool,
    pub m_DBufferDepth: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
...
impl crate::UnityEngine::Rendering::Universal::DBufferRenderPass {
    ...
    pub fn ExecutePass(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (cmd, passData, rendererList, renderGraph))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn InitPassData(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::ByRefMut<
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::Universal::DBufferRenderPass_PassData,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("InitPassData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::Universal::DBufferRenderPass_PassData,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetGlobalTextures")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::Universal::DBufferRenderPass_PassData,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetKeywords")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn Setup_RTHandle1(
        ...
        cameraData: quest_hook::libil2cpp::ByRefMut<
            crate::UnityEngine::Rendering::Universal::CameraData,
        >,
        depthTextureHandle: quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (cameraData, depthTextureHandle))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (dBufferClear, settings, drawSystem, decalLayers))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::Rendering::RTHandle>,
                        >,
                    >, 0usize>("get_dBufferColorHandles")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+Universal+DBufferRenderPass+PassData")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DBufferRenderPass+PassData")]
impl std::ops::Deref for crate::UnityEngine::Rendering::Universal::DBufferRenderPass_PassData {
...
#[cfg(feature = "UnityEngine+Rendering+Universal+DBufferRenderPass+PassData")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::Universal::DBufferRenderPass_PassData {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
