...
pub struct UniversalRenderPipelineDebugDisplaySettings {
    ...
    >,
    pub _volumeSettings_k__BackingField: quest_hook::libil2cpp::Gc<
    ...
    pub _displayStats_k__BackingField: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _gpuResidentDrawerSettings_k__BackingField: quest_hook::libil2cpp::Gc<
...
#[cfg(
    feature = "UnityEngine+Rendering+Universal+UniversalRenderPipelineDebugDisplaySettings"
)]
impl std::ops::Deref
for crate::UnityEngine::Rendering::Universal::UniversalRenderPipelineDebugDisplaySettings {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_gpuResidentDrawerSettings", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_gpuResidentDrawerSettings", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
