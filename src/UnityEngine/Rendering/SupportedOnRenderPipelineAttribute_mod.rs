...
impl std::ops::Deref for crate::UnityEngine::Rendering::SupportedOnRenderPipelineAttribute {
...
#[cfg(feature = "UnityEngine+Rendering+SupportedOnRenderPipelineAttribute")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::SupportedOnRenderPipelineAttribute {
...
impl crate::UnityEngine::Rendering::SupportedOnRenderPipelineAttribute {
    #[cfg(feature = "UnityEngine+Rendering+SupportedOnRenderPipelineAttribute+SupportedMode")]
    pub type SupportedMode =
    ...
    pub fn IsTypeSupportedOnRenderPipeline(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::System::Type>,
                        quest_hook::libil2cpp::Gc<crate::System::Type>,
                    ), bool, 2usize>("IsTypeSupportedOnRenderPipeline")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (_cordl_type, renderPipelineAssetType))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (renderPipeline))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Type0(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        quest_hook::libil2cpp::Il2CppArray<
                            quest_hook::libil2cpp::Gc<crate::System::Type>,
                        >,
                    >, 0usize>("get_renderPipelineTypes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
