...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+GPUDrivenProcessor")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::GPUDrivenProcessor {
...
impl crate::UnityEngine::Rendering::GPUDrivenProcessor {
    ...
    pub type BindingsMarshaller =
        crate::UnityEngine::Rendering::GPUDrivenProcessor_BindingsMarshaller;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::Span_1<
                            crate::UnityEngine::Rendering::GPUDrivenPackedMaterialData,
                        >,
                    ), i32, 4usize>("ClassifyMaterialsImpl")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            crate::UnityEngine::Bindings::ManagedSpanWrapper,
                        >,
                    ), i32, 4usize>("ClassifyMaterialsImpl_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ClearMaterialFilters(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearMaterialFilters")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn DisableGPUDrivenRendering(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (renderersID))? };
        Ok(__cordl_ret.into())
    }
    pub fn DisableGPUDrivenRendering_Injected(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (_unity_self, renderersID))? };
        Ok(__cordl_ret.into())
    }
    pub fn DispatchLODGroupData_GPUDrivenLODGroupDataCallback1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lodGroupID, callback))? };
        Ok(__cordl_ret.into())
    }
    pub fn DispatchLODGroupData_GPUDrivenLODGroupDataNativeCallback_GPUDrivenLODGroupDataCallback0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lodGroupID, callback, param))? };
        Ok(__cordl_ret.into())
    }
    pub fn DispatchLODGroupData_Injected(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (_unity_self, lodGroupID, callback, param))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn EnableGPUDrivenRenderingAndDispatchRendererData_GPUDrivenRendererDataCallback__cordl_bool1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (renderersID, callback, materialUpdateOnly))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            quest_hook::libil2cpp::Gc<crate::UnityEngine::Mesh>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_scratchMeshes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+GPUDrivenProcessor")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Rendering::GPUDrivenProcessor {
...
#[cfg(feature = "UnityEngine+Rendering+GPUDrivenProcessor+BindingsMarshaller")]
impl std::ops::Deref for crate::UnityEngine::Rendering::GPUDrivenProcessor_BindingsMarshaller {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "UnityEngine+Rendering+GPUDrivenProcessor+BindingsMarshaller")]
impl std::ops::DerefMut for crate::UnityEngine::Rendering::GPUDrivenProcessor_BindingsMarshaller {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
