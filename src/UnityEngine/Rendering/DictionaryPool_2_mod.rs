...
impl<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> std::ops::Deref for crate::UnityEngine::Rendering::DictionaryPool_2<TKey, TValue> {
...
impl<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> std::ops::DerefMut for crate::UnityEngine::Rendering::DictionaryPool_2<TKey, TValue> {
