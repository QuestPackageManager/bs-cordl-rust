...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+VisibleReflectionProbe")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::VisibleReflectionProbe {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
impl crate::UnityEngine::Rendering::VisibleReflectionProbe {
    ...
    pub fn get_hdrData(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector4> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector4, 0usize>("get_hdrData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_reflectionProbe(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::ReflectionProbe>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::ReflectionProbe> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_texture(
...
#[cfg(feature = "UnityEngine+Rendering+VisibleReflectionProbe")]
impl AsRef<crate::System::IEquatable_1<crate::UnityEngine::Rendering::VisibleReflectionProbe>>
    for crate::UnityEngine::Rendering::VisibleReflectionProbe
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+Rendering+VisibleReflectionProbe")]
impl AsMut<crate::System::IEquatable_1<crate::UnityEngine::Rendering::VisibleReflectionProbe>>
    for crate::UnityEngine::Rendering::VisibleReflectionProbe
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::UnityEngine::Rendering::VisibleReflectionProbe>
    {
        todo!()
    }
}
