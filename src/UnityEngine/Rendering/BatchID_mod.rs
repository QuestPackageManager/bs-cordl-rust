...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::BatchID {
    ...
    const CLASS_NAME: &'static str = "BatchID";
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+BatchID")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::Rendering::BatchID {
    type Type = Self;
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::Rendering::BatchID), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::Rendering::BatchID> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Rendering+BatchID")]
