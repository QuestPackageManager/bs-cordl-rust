...
pub struct DebugDisplaySettingsStats_1<TProfileId: quest_hook::libil2cpp::Type> {
    ...
    pub _debugDisplayStats_k__BackingField: quest_hook::libil2cpp::Gc<
...
> crate::UnityEngine::Rendering::DebugDisplaySettingsStats_1<TProfileId> {
    ...
    pub type StatsPanel = crate::UnityEngine::Rendering::DebugDisplaySettingsStats_1_StatsPanel<
        TProfileId,
    >;
    pub fn CreatePanel(
        &mut self,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::Rendering::DebugDisplayStats_1<
                                TProfileId,
                            >,
                        >),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (debugDisplayStats))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+DebugDisplaySettingsStats_1+StatsPanel"
)]
#[repr(C)]
#[derive(Debug)]
pub struct DebugDisplaySettingsStats_1_StatsPanel<
    TProfileId: quest_hook::libil2cpp::Type,
> {
...
> crate::UnityEngine::Rendering::DebugDisplaySettingsStats_1_StatsPanel<TProfileId> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (displaySettingsStats))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Flags(
