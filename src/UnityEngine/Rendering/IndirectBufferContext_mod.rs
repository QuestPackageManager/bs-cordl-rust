...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::IndirectBufferContext {
    ...
    const CLASS_NAME: &'static str = "IndirectBufferContext";
...
#[cfg(feature = "UnityEngine+Rendering+IndirectBufferContext")]
impl crate::UnityEngine::Rendering::IndirectBufferContext {
    #[cfg(feature = "UnityEngine+Rendering+IndirectBufferContext+BufferState")]
    pub type BufferState = crate::UnityEngine::Rendering::IndirectBufferContext_BufferState;
    pub fn Matches(
        &mut self,
        bufferState: crate::UnityEngine::Rendering::IndirectBufferContext_BufferState,
        occluderVersion: i32,
        subviewMask: i32,
    ...
    for crate::UnityEngine::Rendering::IndirectBufferContext_BufferState
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "IndirectBufferContext/BufferState";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
