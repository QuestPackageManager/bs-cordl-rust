...
pub struct DrawCommandOutputPerBatch {
    ...
    >,
    pub indirectDrawInfoGlobalArray:
...
impl crate::UnityEngine::Rendering::DrawCommandOutputPerBatch {
    pub fn EncodeGPUInstanceIndexAndCrossFade(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, bool), i32, 2usize>("EncodeGPUInstanceIndexAndCrossFade")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (rendererIndex, negateCrossFade))? };
        Ok(__cordl_ret.into())
    }
    pub fn Execute(
        &mut self,
