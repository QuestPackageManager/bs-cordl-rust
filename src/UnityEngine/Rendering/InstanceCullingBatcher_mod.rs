...
pub struct InstanceCullingBatcher {
    ...
    >,
    pub m_DrawInstanceData: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::CPUDrawInstanceData,
    >,
    pub m_BRG: quest_hook::libil2cpp::Gc<
    ...
    pub m_OnCompleteCallback: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::Rendering::OnCullingCompleteCallback,
    >,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+InstanceCullingBatcher")]
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::Rendering::InstanceCullingBatcher {
...
impl crate::UnityEngine::Rendering::InstanceCullingBatcher {
    ...
    pub fn GetBatchID(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::BatchID = unsafe {
            cordl_method_info.invoke_unchecked(self, (componentsOverriden))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "InstanceOccludersUpdated", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (viewInstanceID, subviewMask))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn RegisterBatchMaterials(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (usedMaterialIDs))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn RegisterBatchMeshes(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (meshIDs))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateInstanceDataBufferLayoutVersion", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (batcherContext, desc, onFinishedCulling))?
        };
        Ok(__cordl_ret.into())
    }
