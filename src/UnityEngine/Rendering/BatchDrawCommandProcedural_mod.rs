#[cfg(feature = "cordl_class_UnityEngine+Rendering+BatchDrawCommandProcedural")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
#[cfg_attr(feature = "derive_Clone", derive(Clone))]
#[cfg_attr(feature = "derive_Default", derive(Default))]
#[cfg_attr(feature = "derive_PartialEq", derive(PartialEq))]
#[repr(C)]
pub struct BatchDrawCommandProcedural {
    ...
    pub baseVertex: u32,
    pub indexOffsetBytes: u32,
    pub elementCount: u32,
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+BatchDrawCommandProcedural")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Rendering::BatchDrawCommandProcedural
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "BatchDrawCommandProcedural";
...
#[cfg(feature = "UnityEngine+Rendering+BatchDrawCommandProcedural")]
impl crate::UnityEngine::Rendering::BatchDrawCommandProcedural {}
