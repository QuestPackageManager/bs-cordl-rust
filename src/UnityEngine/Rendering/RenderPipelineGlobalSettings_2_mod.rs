...
> {
    ...
    __cordl_phantom_TGlobalRenderPipelineSettings: std::marker::PhantomData<
...
> {
    ...
    where
        ...
        TRenderPipeline: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TGlobalRenderPipelineSettings = unsafe {
