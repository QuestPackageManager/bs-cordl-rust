...
impl crate::UnityEngine::Rendering::MaterialQualityUtilities {
    pub fn FromIndex(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::MaterialQuality = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetClosestQuality", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::UnityEngine::Rendering::MaterialQuality = unsafe {
            cordl_method_info.invoke_unchecked((), (availableLevels, requestedLevel))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetHighestQuality(
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::MaterialQuality = unsafe {
            cordl_method_info.invoke_unchecked((), (levels))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetGlobalShaderKeywords", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (level, cmd))?
        };
        Ok(__cordl_ret.into())
    }
