...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+LODParameters")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::LODParameters {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
    const CLASS_NAME: &'static str = "LODParameters";
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+LODParameters")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::Rendering::LODParameters {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+LODParameters")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::Rendering::LODParameters {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+LODParameters")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::Rendering::LODParameters {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+LODParameters")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::Rendering::LODParameters {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+LODParameters")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::Rendering::LODParameters {
    type Type = Self;
...
impl crate::UnityEngine::Rendering::LODParameters {
    ...
    pub fn Equals_LODParameters0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::Rendering::LODParameters), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_cameraPosition(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector3, 0usize>("get_cameraPosition")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_orthoSize(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f32, 0usize>("get_orthoSize")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::Rendering::LODParameters> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+Rendering+LODParameters")]
