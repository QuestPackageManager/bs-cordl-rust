...
impl crate::UnityEngine::Rendering::ProbeVolumeScratchBufferPool {
    #[cfg(
        feature = "UnityEngine+Rendering+ProbeVolumeScratchBufferPool+ScratchBufferPool"
    )]
    pub type ScratchBufferPool = crate::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool;
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (chunkCount, allocateGraphicsBuffers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReleaseScratchBuffer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (scratchBuffer))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bakingSet, shBands))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_UnityEngine+Rendering+ProbeVolumeScratchBufferPool+ScratchBufferPool"
)]
#[repr(C)]
#[derive(Debug)]
