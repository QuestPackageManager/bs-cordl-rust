...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ProbeVolumePositioning")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Rendering::ProbeVolumePositioning {
...
impl crate::UnityEngine::Rendering::ProbeVolumePositioning {
    pub fn OBBAABBIntersect(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (a, b, aAABB))? };
        Ok(__cordl_ret.into())
    }
    pub fn OBBContains(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (obb, point))? };
        Ok(__cordl_ret.into())
    }
    pub fn OBBIntersect(
        a: quest_hook::libil2cpp::ByRefMut<
    ...
    pub fn ProjectAABB(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        crate::UnityEngine::Vector3,
                    ), crate::UnityEngine::Vector2, 2usize>("ProjectAABB")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 =
            unsafe { cordl_method_info.invoke_unchecked((), (corners, axis))? };
        Ok(__cordl_ret.into())
    }
    pub fn ProjectOBB(
        a: quest_hook::libil2cpp::ByRefMut<
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        crate::UnityEngine::Vector3,
                    ), crate::UnityEngine::Vector2, 2usize>("ProjectOBB")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::Vector2 =
            unsafe { cordl_method_info.invoke_unchecked((), (a, axis))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Rendering+ProbeVolumePositioning")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Rendering::ProbeVolumePositioning {
