...
for crate::UnityEngine::Rendering::GPUSort {
    type Type = Self;
...
impl crate::UnityEngine::Rendering::GPUSort {
    ...
    pub fn CopyBuffer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cmd, src, dst))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Dispatch(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cmd, args))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "DispatchStage", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (cmd, args, h, stage))?
        };
        Ok(__cordl_ret.into())
    }
...
for crate::UnityEngine::Rendering::GPUSort_Args {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        <Self as quest_hook::libil2cpp::Type>::matches_value_argument(ty)
    }
...
impl crate::UnityEngine::Rendering::GPUSort_RenderGraphResources {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::GPUSort_RenderGraphResources = unsafe {
            cordl_method_info.invoke_unchecked((), (count, renderGraph, builder))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "cordl_class_UnityEngine+Rendering+GPUSort+Stage")]
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::Rendering::GPUSort_Stage {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.Rendering";
...
impl crate::UnityEngine::Rendering::GPUSort_SupportResources {
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::Rendering::GPUSort_SupportResources = unsafe {
            cordl_method_info.invoke_unchecked((), (renderGraphResources))?
        };
        Ok(__cordl_ret.into())
    }
}
