    ...
    for crate::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings
{
    ...
    const CLASS_NAME: &'static str = "InstanceOcclusionTestSubviewSettings";
...
#[cfg(feature = "UnityEngine+Rendering+InstanceOcclusionTestSubviewSettings")]
impl crate::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings {
    pub fn FromSpan(
