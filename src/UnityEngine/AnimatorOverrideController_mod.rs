...
#[cfg(feature = "cordl_class_UnityEngine+AnimatorOverrideController")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AnimatorOverrideController {
...
impl crate::UnityEngine::AnimatorOverrideController {
    #[cfg(feature = "UnityEngine+AnimatorOverrideController+OnOverrideControllerDirtyCallback")]
    pub type OnOverrideControllerDirtyCallback =
        crate::UnityEngine::AnimatorOverrideController_OnOverrideControllerDirtyCallback;
    pub fn ApplyOverrides(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IList_1<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("ApplyOverrides")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (overrides))? };
        Ok(__cordl_ret.into())
    }
    pub fn Internal_Create(
        _cordl_self: quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimatorOverrideController>,
        controller: quest_hook::libil2cpp::Gc<crate::UnityEngine::RuntimeAnimatorController>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimatorOverrideController>,
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::RuntimeAnimatorController>,
                    ), quest_hook::libil2cpp::Void, 2usize>("Internal_Create")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_self, controller))? };
        Ok(__cordl_ret.into())
    }
    pub fn Internal_Create_Injected(
        _cordl_self: quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimatorOverrideController>,
        controller: crate::System::IntPtr,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn OnInvalidateOverrideController(
        controller: quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimatorOverrideController>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "OnInvalidateOverrideController", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn SendNotification(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SendNotification")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SendNotification_Injected(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SendNotification_Injected", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn SetClip(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::AnimationClip>,
                        bool,
                    ), quest_hook::libil2cpp::Void, 3usize>("SetClip")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (originalClip, overrideClip, notify))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetClip_Injected(
        _unity_self: crate::System::IntPtr,
        originalClip: crate::System::IntPtr,
        overrideClip: crate::System::IntPtr,
        notify: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                        bool,
                    ), quest_hook::libil2cpp::Void, 4usize>("SetClip_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (_unity_self, originalClip, overrideClip, notify))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
#[cfg(feature = "cordl_class_UnityEngine+AnimatorOverrideController")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::AnimatorOverrideController {
