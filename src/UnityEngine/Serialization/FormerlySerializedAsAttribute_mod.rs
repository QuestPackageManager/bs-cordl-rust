...
impl crate::UnityEngine::Serialization::FormerlySerializedAsAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Serialization::FormerlySerializedAsAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Serialization::FormerlySerializedAsAttribute as
