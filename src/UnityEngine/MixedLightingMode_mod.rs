#[cfg(feature = "cordl_class_UnityEngine+MixedLightingMode")]
...
#[cfg(feature = "cordl_class_UnityEngine+MixedLightingMode")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::MixedLightingMode {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "MixedLightingMode";
