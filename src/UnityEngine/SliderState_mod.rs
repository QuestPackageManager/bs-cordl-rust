...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::SliderState {
    ...
    const CLASS_NAME: &'static str = "SliderState";
...
#[cfg(feature = "UnityEngine+SliderState")]
impl crate::UnityEngine::SliderState {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::SliderState as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::SliderState as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
