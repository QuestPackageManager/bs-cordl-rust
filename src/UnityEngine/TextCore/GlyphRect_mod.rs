#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TextCore::GlyphRect {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.TextCore";
    const CLASS_NAME: &'static str = "GlyphRect";
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::TextCore::GlyphRect {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::TextCore::GlyphRect {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::TextCore::GlyphRect {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::TextCore::GlyphRect {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphRect")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::TextCore::GlyphRect {
    type Type = Self;
...
impl crate::UnityEngine::TextCore::GlyphRect {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::TextCore::GlyphRect), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, y, width, height))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_zero() -> quest_hook::libil2cpp::Result<crate::UnityEngine::TextCore::GlyphRect> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::UnityEngine::TextCore::GlyphRect, 0usize>(
                        "get_zero",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::TextCore::GlyphRect =
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::TextCore::GlyphRect> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+TextCore+GlyphRect")]
