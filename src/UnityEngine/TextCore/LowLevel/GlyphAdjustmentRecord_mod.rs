...
impl crate::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord {
    pub fn Equals_GlyphAdjustmentRecord1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord as
                    quest_hook::libil2cpp::Type > ::class(), "get_glyphIndex", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord as
                    quest_hook::libil2cpp::Type > ::class(), "get_glyphValueRecord",
                    0usize
                )
            });
