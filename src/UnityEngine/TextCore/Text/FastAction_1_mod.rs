    ...
    for crate::UnityEngine::TextCore::Text::FastAction_1<A>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.TextCore.Text", "FastAction`1")
                .unwrap()
                .make_generic::<(A)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+TextCore+Text+FastAction_1")]
impl<A: quest_hook::libil2cpp::Type> crate::UnityEngine::TextCore::Text::FastAction_1<A> {
