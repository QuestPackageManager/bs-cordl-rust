...
impl crate::UnityEngine::TextCore::Text::CharacterSubstitution {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TextCore::Text::CharacterSubstitution as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32, u32), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::TextCore::Text::CharacterSubstitution as
