#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+SpriteCharacter")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+SpriteCharacter")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TextCore::Text::SpriteCharacter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.TextCore.Text";
    const CLASS_NAME: &'static str = "SpriteCharacter";
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+SpriteCharacter")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::TextCore::Text::SpriteCharacter {
