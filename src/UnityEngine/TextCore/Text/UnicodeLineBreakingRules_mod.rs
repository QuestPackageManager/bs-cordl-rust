...
pub struct UnicodeLineBreakingRules {
    ...
    pub m_UnicodeLineBreakingRules: quest_hook::libil2cpp::Gc<crate::UnityEngine::TextAsset>,
...
#[cfg(feature = "UnityEngine+TextCore+Text+UnicodeLineBreakingRules")]
impl std::ops::DerefMut for crate::UnityEngine::TextCore::Text::UnicodeLineBreakingRules {
...
impl crate::UnityEngine::TextCore::Text::UnicodeLineBreakingRules {
    ...
    pub fn LoadLineBreakingRules(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("LoadLineBreakingRules")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_useModernHangulLineBreakingRules(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
