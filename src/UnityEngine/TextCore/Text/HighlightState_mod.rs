...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+HighlightState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TextCore::Text::HighlightState {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.TextCore.Text";
    const CLASS_NAME: &'static str = "HighlightState";
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+HighlightState")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::TextCore::Text::HighlightState {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+HighlightState")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::TextCore::Text::HighlightState {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+HighlightState")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::TextCore::Text::HighlightState {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::TextCore::Text::HighlightState {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (color, padding))? };
        Ok(__cordl_ret.into())
    }
    pub fn op_Equality(
