#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+Character")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+Character")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::TextCore::Text::Character {
...
impl crate::UnityEngine::TextCore::Text::Character {
    ...
    pub fn _ctor_u32_FontAsset_Glyph1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (unicode, fontAsset, glyph))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_u32_u32_2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (unicode, glyphIndex))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+Character")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::TextCore::Text::Character {
