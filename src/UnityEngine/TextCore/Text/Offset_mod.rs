...
impl crate::UnityEngine::TextCore::Text::Offset {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::TextCore::Text::Offset as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::TextCore::Text::Offset as
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::TextCore::Text::Offset = unsafe {
