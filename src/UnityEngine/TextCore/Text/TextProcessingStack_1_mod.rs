#[cfg(feature = "cordl_class_UnityEngine+TextCore+Text+TextProcessingStack_1")]
...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::TextCore::Text::TextProcessingStack_1<T> {
