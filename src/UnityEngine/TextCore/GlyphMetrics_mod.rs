#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphMetrics")]
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphMetrics")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::TextCore::GlyphMetrics {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphMetrics")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::TextCore::GlyphMetrics {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphMetrics")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::TextCore::GlyphMetrics {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphMetrics")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::TextCore::GlyphMetrics {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+TextCore+GlyphMetrics")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::TextCore::GlyphMetrics {
    type Type = Self;
...
impl crate::UnityEngine::TextCore::GlyphMetrics {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::TextCore::GlyphMetrics), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (width, height, bearingX, bearingY, advance))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_horizontalAdvance(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f32, 0usize>("get_horizontalAdvance")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_horizontalBearingX(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f32, 0usize>("get_horizontalBearingX")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_horizontalBearingY(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f32, 0usize>("get_horizontalBearingY")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::TextCore::GlyphMetrics> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+TextCore+GlyphMetrics")]
