...
#[cfg(feature = "UnityEngine+ExitGUIException")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ExitGUIException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "ExitGUIException";
...
impl crate::UnityEngine::ExitGUIException {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ExitGUIException as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ExitGUIException as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 0usize
                )
            });
