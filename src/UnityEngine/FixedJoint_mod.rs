...
#[cfg(feature = "UnityEngine+FixedJoint")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::FixedJoint {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "FixedJoint";
...
impl crate::UnityEngine::FixedJoint {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::FixedJoint as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::FixedJoint as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
