#[cfg(feature = "cordl_class_UnityEngine+WWWTranscoder")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::WWWTranscoder {
    pub fn Byte2Hex(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (b, hexChars, byte0, byte1))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ByteArrayContains(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (array, b))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ByteSubArrayEquals(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (array, index, comperand))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Decode(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (input, escapeChar, space))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Encode(
    ...
    pub fn Hex2Byte(
        ...
        let __cordl_ret: u8 = unsafe {
            cordl_method_info.invoke_unchecked((), (b, offset))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn URLDecode(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe { cordl_method_info.invoke_unchecked((), (toEncode))? };
        Ok(__cordl_ret.into())
    }
    pub fn URLEncode(
        toEncode: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
