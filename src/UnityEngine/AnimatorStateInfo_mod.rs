...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::AnimatorStateInfo {
    ...
    const CLASS_NAME: &'static str = "AnimatorStateInfo";
...
impl crate::UnityEngine::AnimatorStateInfo {
    pub fn get_normalizedTime(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AnimatorStateInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), f32, 0usize>("get_normalizedTime")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::AnimatorStateInfo as quest_hook::libil2cpp::Type
                    > ::class(), "get_normalizedTime", 0usize
                )
            });
