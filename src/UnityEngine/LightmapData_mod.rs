#[cfg(feature = "cordl_class_UnityEngine+LightmapData")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+LightmapData")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::LightmapData {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "LightmapData";
