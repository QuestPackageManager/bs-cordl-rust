#[cfg(feature = "cordl_class_UnityEngine+Resources")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+Resources")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Resources {
...
impl crate::UnityEngine::Resources {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetBuiltinResource", 1usize
                        )
                    })
            });
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked((), (path))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetBuiltinResource_Injected(
        _cordl_type: quest_hook::libil2cpp::Gc<crate::System::Type>,
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type, path))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (path, systemTypeInstance))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UnloadUnusedAssets_Injected() -> quest_hook::libil2cpp::Result<crate::System::IntPtr> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
