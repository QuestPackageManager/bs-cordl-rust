...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::PS4::XR::PSVRSettings {
    ...
    const CLASS_NAME: &'static str = "PSVRSettings";
...
impl crate::UnityEngine::PS4::XR::PSVRSettings {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::PS4::XR::PSVRSettings as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::PS4::XR::PSVRSettings as
