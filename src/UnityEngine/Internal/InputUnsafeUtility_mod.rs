...
impl crate::UnityEngine::Internal::InputUnsafeUtility {
    ...
    pub fn GetAxisRaw_Injected(
        axisName: quest_hook::libil2cpp::ByRefMut<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetButtonDown__Unmanaged", 2usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetKeyString__Unmanaged", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetKeyUpString__Unmanaged", 2usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
