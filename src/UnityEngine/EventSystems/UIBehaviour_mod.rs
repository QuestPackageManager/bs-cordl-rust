...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+UIBehaviour")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::UIBehaviour {
...
impl crate::UnityEngine::EventSystems::UIBehaviour {
    ...
    pub fn OnCanvasGroupChanged(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnCanvasGroupChanged")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+UIBehaviour")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::UIBehaviour {
