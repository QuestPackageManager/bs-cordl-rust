...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+PointerInputModule")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::PointerInputModule {
...
impl crate::UnityEngine::EventSystems::PointerInputModule {
    ...
    pub fn DeselectIfSelectionChanged(
        ...
        pointerEvent: quest_hook::libil2cpp::Gc<crate::UnityEngine::EventSystems::BaseEventData>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (currentOverGo, pointerEvent))? };
        Ok(__cordl_ret.into())
    }
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("GetMousePointerEventData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::EventSystems::PointerInputModule_MouseState,
                    >, 1usize>("GetMousePointerEventData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::EventSystems::PointerEventData,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (input, pressed, released))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ShouldStartDrag(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (pressPos, currentPos, threshold, useDragThreshold))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::EventSystems::PointerEventData_FramePressState =
            unsafe { cordl_method_info.invoke_unchecked(self, (buttonId))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
        &mut self,
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+PointerInputModule")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::PointerInputModule {
...
#[cfg(feature = "UnityEngine+EventSystems+PointerInputModule+ButtonState")]
impl std::ops::Deref for crate::UnityEngine::EventSystems::PointerInputModule_ButtonState {
...
#[cfg(feature = "UnityEngine+EventSystems+PointerInputModule+ButtonState")]
impl std::ops::DerefMut for crate::UnityEngine::EventSystems::PointerInputModule_ButtonState {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_eventData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
pub struct PointerInputModule_MouseButtonEventData {
    ...
    pub buttonData: quest_hook::libil2cpp::Gc<crate::UnityEngine::EventSystems::PointerEventData>,
}
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+PointerInputModule+MouseButtonEventData")]
unsafe impl quest_hook::libil2cpp::Type
...
#[cfg(feature = "UnityEngine+EventSystems+PointerInputModule+MouseButtonEventData")]
impl std::ops::Deref for crate::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "UnityEngine+EventSystems+PointerInputModule+MouseState")]
impl std::ops::Deref for crate::UnityEngine::EventSystems::PointerInputModule_MouseState {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "UnityEngine+EventSystems+PointerInputModule+MouseState")]
impl std::ops::DerefMut for crate::UnityEngine::EventSystems::PointerInputModule_MouseState {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::UnityEngine::EventSystems::PointerInputModule_MouseState {
    ...
    pub fn GetButtonState(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::EventSystems::PointerInputModule_ButtonState>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn SetButtonState(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::EventSystems::PointerEventData,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("SetButtonState")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (button, stateForMouseButton, data))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
