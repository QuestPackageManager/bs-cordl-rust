#[cfg(feature = "cordl_class_UnityEngine+EventSystems+ICancelHandler")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+ICancelHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::ICancelHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.EventSystems";
    const CLASS_NAME: &'static str = "ICancelHandler";
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+ICancelHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::ICancelHandler {
