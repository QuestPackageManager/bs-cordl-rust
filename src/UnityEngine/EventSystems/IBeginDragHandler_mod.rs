...
impl crate::UnityEngine::EventSystems::IBeginDragHandler {
    pub fn OnBeginDrag(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IBeginDragHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IBeginDragHandler as
                    quest_hook::libil2cpp::Type > ::class(), "OnBeginDrag", 1usize
                )
            });
