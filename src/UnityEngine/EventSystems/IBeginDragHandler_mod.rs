#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IBeginDragHandler")]
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IBeginDragHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::IBeginDragHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.EventSystems";
    const CLASS_NAME: &'static str = "IBeginDragHandler";
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IBeginDragHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::IBeginDragHandler {
