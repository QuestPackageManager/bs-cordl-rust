#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IPointerClickHandler")]
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IPointerClickHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::IPointerClickHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.EventSystems";
    const CLASS_NAME: &'static str = "IPointerClickHandler";
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IPointerClickHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::IPointerClickHandler {
