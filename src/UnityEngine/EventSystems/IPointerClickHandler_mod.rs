...
impl crate::UnityEngine::EventSystems::IPointerClickHandler {
    pub fn OnPointerClick(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IPointerClickHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IPointerClickHandler as
