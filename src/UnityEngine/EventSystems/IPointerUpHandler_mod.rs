...
impl crate::UnityEngine::EventSystems::IPointerUpHandler {
    pub fn OnPointerUp(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IPointerUpHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IPointerUpHandler as
