#[cfg(feature = "cordl_class_UnityEngine+EventSystems+PointerEventDataExtension")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::EventSystems::PointerEventDataExtension {
    pub fn GetRay(
        ...
        let __cordl_ret: crate::UnityEngine::Ray =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerEventData))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetSwipeStart(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        crate::UnityEngine::Vector2,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetSwipeStart")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (pointerEventData, start))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+PointerEventDataExtension")]
