...
impl crate::UnityEngine::EventSystems::IPointerMoveHandler {
    pub fn OnPointerMove(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IPointerMoveHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IPointerMoveHandler as
