...
impl crate::UnityEngine::EventSystems::IPointerDownHandler {
    pub fn OnPointerDown(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IPointerDownHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IPointerDownHandler as
