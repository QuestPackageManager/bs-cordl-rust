...
for crate::UnityEngine::EventSystems::Physics2DRaycaster {
    ...
    const CLASS_NAME: &'static str = "Physics2DRaycaster";
...
impl crate::UnityEngine::EventSystems::Physics2DRaycaster {
    ...
    pub fn Raycast(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::Physics2DRaycaster as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::Physics2DRaycaster as
