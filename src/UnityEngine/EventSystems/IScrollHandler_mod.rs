...
impl crate::UnityEngine::EventSystems::IScrollHandler {
    pub fn OnScroll(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IScrollHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IScrollHandler as
                    quest_hook::libil2cpp::Type > ::class(), "OnScroll", 1usize
                )
            });
