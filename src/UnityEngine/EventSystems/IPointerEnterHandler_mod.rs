...
impl crate::UnityEngine::EventSystems::IPointerEnterHandler {
    pub fn OnPointerEnter(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IPointerEnterHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IPointerEnterHandler as
