...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+AxisEventData")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::AxisEventData {
...
impl crate::UnityEngine::EventSystems::AxisEventData {
    ...
    pub fn get_moveDir(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::EventSystems::MoveDirection, 0usize>(
                        "get_moveDir",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::EventSystems::MoveDirection =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_moveVector(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector2> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+AxisEventData")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::AxisEventData {
