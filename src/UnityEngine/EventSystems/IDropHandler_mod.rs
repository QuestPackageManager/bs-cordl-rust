#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IDropHandler")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IDropHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::IDropHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.EventSystems";
    const CLASS_NAME: &'static str = "IDropHandler";
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IDropHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::IDropHandler {
