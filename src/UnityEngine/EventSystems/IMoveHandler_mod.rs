#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IMoveHandler")]
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IMoveHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::IMoveHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.EventSystems";
    const CLASS_NAME: &'static str = "IMoveHandler";
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+IMoveHandler")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::IMoveHandler {
