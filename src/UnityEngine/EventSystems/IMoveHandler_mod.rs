...
impl crate::UnityEngine::EventSystems::IMoveHandler {
    pub fn OnMove(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::EventSystems::IMoveHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::EventSystems::IMoveHandler as
                    quest_hook::libil2cpp::Type > ::class(), "OnMove", 1usize
                )
            });
