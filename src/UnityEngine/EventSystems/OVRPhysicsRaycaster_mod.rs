...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+OVRPhysicsRaycaster")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::EventSystems::OVRPhysicsRaycaster {
...
impl crate::UnityEngine::EventSystems::OVRPhysicsRaycaster {
    ...
    pub fn Spherecast(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        >,
                        f32,
                    ), quest_hook::libil2cpp::Void, 3usize>("Spherecast")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (eventData, resultAppendList, radius))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+EventSystems+OVRPhysicsRaycaster")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::EventSystems::OVRPhysicsRaycaster {
