#[cfg(feature = "cordl_class_UnityEngine+EventSystems+BaseInput")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::UnityEngine::EventSystems::BaseInput {
    pub fn GetAxisRaw(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (axisName))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetButtonDown(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (buttonName))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetMouseButton(&mut self, button: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (button))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetMouseButtonDown(&mut self, button: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn GetMouseButtonUp(&mut self, button: i32) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn GetTouch(
        ...
        let __cordl_ret: crate::UnityEngine::Touch =
    ...
    pub fn get_imeCompositionMode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::IMECompositionMode, 0usize>(
        ...
        let __cordl_ret: crate::UnityEngine::IMECompositionMode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_mouseScrollDelta(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Vector2, 0usize>("get_mouseScrollDelta")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_mouseScrollDeltaPerTick(&mut self) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), f32, 0usize>("get_mouseScrollDeltaPerTick")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "get_mouseScrollDeltaPerTick",
                            0usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_compositionCursorPos", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
