...
impl crate::UnityEngine::Component {
    ...
    pub fn GetComponentsForListInternal(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (searchType, resultList))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetComponentsForListInternal_Injected(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (_unity_self, searchType, resultList))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (includeInactive, result))? };
        Ok(__cordl_ret.into())
    }
