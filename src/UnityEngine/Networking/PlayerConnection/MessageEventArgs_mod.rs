    ...
    for crate::UnityEngine::Networking::PlayerConnection::MessageEventArgs
{
    ...
    const CLASS_NAME: &'static str = "MessageEventArgs";
...
impl std::ops::Deref for crate::UnityEngine::Networking::PlayerConnection::MessageEventArgs {
...
#[cfg(feature = "UnityEngine+Networking+PlayerConnection+MessageEventArgs")]
impl std::ops::DerefMut for crate::UnityEngine::Networking::PlayerConnection::MessageEventArgs {
