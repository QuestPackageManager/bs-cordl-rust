...
impl std::ops::Deref for crate::UnityEngine::Networking::PlayerConnection::PlayerConnection {
...
#[cfg(feature = "UnityEngine+Networking+PlayerConnection+PlayerConnection")]
impl std::ops::DerefMut for crate::UnityEngine::Networking::PlayerConnection::PlayerConnection {
...
impl crate::UnityEngine::Networking::PlayerConnection::PlayerConnection {
    pub fn BlockUntilRecvMsg(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (messageId, timeout))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn DisconnectAll(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn MessageCallbackInternal(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (data, _cordl_size, guid, messageId))?
        };
        Ok(__cordl_ret.into())
    }
...
impl AsRef<crate::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection>
    for crate::UnityEngine::Networking::PlayerConnection::PlayerConnection
{
    fn as_ref(&self) -> &crate::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection {
