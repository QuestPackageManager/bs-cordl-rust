#[cfg(feature = "cordl_class_UnityEngine+Networking+DownloadHandlerBuffer")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+Networking+DownloadHandlerBuffer")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Networking::DownloadHandlerBuffer {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Networking";
    const CLASS_NAME: &'static str = "DownloadHandlerBuffer";
...
impl std::ops::Deref for crate::UnityEngine::Networking::DownloadHandlerBuffer {
...
#[cfg(feature = "UnityEngine+Networking+DownloadHandlerBuffer")]
impl std::ops::DerefMut for crate::UnityEngine::Networking::DownloadHandlerBuffer {
...
impl crate::UnityEngine::Networking::DownloadHandlerBuffer {
    pub fn Create(
        obj: quest_hook::libil2cpp::Gc<crate::UnityEngine::Networking::DownloadHandlerBuffer>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >), crate::System::IntPtr, 1usize>("Create")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn InternalCreateBuffer(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InternalCreateBuffer")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+Networking+DownloadHandlerBuffer")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Networking::DownloadHandlerBuffer {
