...
#[cfg(feature = "cordl_class_UnityEngine+Networking+UnityWebRequestTexture")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Networking::UnityWebRequestTexture {
...
impl crate::UnityEngine::Networking::UnityWebRequestTexture {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::Networking::UnityWebRequest,
        > = unsafe { cordl_method_info.invoke_unchecked((), (uri, nonReadable))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Networking+UnityWebRequestTexture")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Networking::UnityWebRequestTexture {
