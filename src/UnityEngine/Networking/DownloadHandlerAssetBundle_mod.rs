...
impl crate::UnityEngine::Networking::DownloadHandlerAssetBundle {
    #[cfg(
        feature = "UnityEngine+Networking+DownloadHandlerAssetBundle+BindingsMarshaller"
    )]
    pub type BindingsMarshaller = crate::UnityEngine::Networking::DownloadHandlerAssetBundle_BindingsMarshaller;
    pub fn Create(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_autoLoadAssetBundle_Injected", 1usize
                        )
                    })
            });
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_isDownloadComplete_Injected", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
...
#[cfg(
    feature = "cordl_class_UnityEngine+Networking+DownloadHandlerAssetBundle+BindingsMarshaller"
)]
#[repr(C)]
#[derive(Debug)]
