...
impl crate::UnityEngine::Networking::DownloadHandlerAssetBundle {
    #[cfg(feature = "UnityEngine+Networking+DownloadHandlerAssetBundle+BindingsMarshaller")]
    pub type BindingsMarshaller =
        crate::UnityEngine::Networking::DownloadHandlerAssetBundle_BindingsMarshaller;
    pub fn Create(
        obj: quest_hook::libil2cpp::Gc<crate::UnityEngine::Networking::DownloadHandlerAssetBundle>,
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (obj, url, crc))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateCached(
        obj: quest_hook::libil2cpp::Gc<crate::UnityEngine::Networking::DownloadHandlerAssetBundle>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        u32,
                    ), crate::System::IntPtr, 5usize>("CreateCached")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (obj, url, name, hash, crc))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        u32,
                    ), crate::System::IntPtr, 5usize>("CreateCached_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn InternalCreateAssetBundle(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (url, crc))? };
        Ok(__cordl_ret.into())
    }
    pub fn InternalCreateAssetBundleCached(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (url, name, hash, crc))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_CachedAssetBundle_u32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (url, cachedBundle, crc))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_u32_0(
        &mut self,
    ...
    pub fn get_autoLoadAssetBundle_Injected(
        _unity_self: crate::System::IntPtr,
    ...
    pub fn get_isDownloadComplete_Injected(
        _unity_self: crate::System::IntPtr,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
    ...
    pub fn set_autoLoadAssetBundle_Injected(
        _unity_self: crate::System::IntPtr,
        value: bool,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "set_autoLoadAssetBundle_Injected", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
...
#[cfg(feature = "cordl_class_UnityEngine+Networking+DownloadHandlerAssetBundle+BindingsMarshaller")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::Networking::DownloadHandlerAssetBundle_BindingsMarshaller
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Networking";
    const CLASS_NAME: &'static str = "DownloadHandlerAssetBundle/BindingsMarshaller";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+Networking+DownloadHandlerAssetBundle+BindingsMarshaller")]
impl crate::UnityEngine::Networking::DownloadHandlerAssetBundle_BindingsMarshaller {
