...
impl crate::UnityEngine::Ray2D {
    pub fn GetPoint(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Ray2D as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), crate::UnityEngine::Vector2, 1usize>("GetPoint")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Ray2D as quest_hook::libil2cpp::Type >
