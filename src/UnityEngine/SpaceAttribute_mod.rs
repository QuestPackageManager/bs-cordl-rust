...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::SpaceAttribute {
    ...
    const CLASS_NAME: &'static str = "SpaceAttribute";
...
impl crate::UnityEngine::SpaceAttribute {
    ...
    pub fn _ctor_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::SpaceAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::SpaceAttribute as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
    ...
    pub fn _ctor_f32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (height))?
        };
        Ok(__cordl_ret.into())
    }
}
