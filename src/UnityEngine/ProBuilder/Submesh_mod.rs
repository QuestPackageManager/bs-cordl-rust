...
impl crate::UnityEngine::ProBuilder::Submesh {
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (faces, submeshCount, preferredTopology))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn New_i32_MeshTopology_Gc0(
        submeshIndex: i32,
    ...
    pub fn _ctor_Mesh_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (mesh, subMeshIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_MeshTopology_Gc0(
        &mut self,
        submeshIndex: i32,
        topology: crate::UnityEngine::MeshTopology,
        indexes: quest_hook::libil2cpp::Gc<i32>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (submeshIndex, topology, indexes))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_indexes(
