#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Submesh")]
#[repr(C)]
...
impl crate::UnityEngine::ProBuilder::Submesh {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (faces, submeshCount, preferredTopology))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Mesh_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mesh, subMeshIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_i32_MeshTopology_IEnumerable_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (submeshIndex, topology, indexes))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_indexes(
        &mut self,
    ...
    pub fn set_indexes(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IEnumerable_1<i32>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IEnumerable_1<i32>,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_indexes")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
