...
impl crate::UnityEngine::ProBuilder::MeshOperations::ElementSelection {
    ...
    pub fn FindHoles_ProBuilderMesh0(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Face>,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (mesh, faces, maxAngleDiff))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Flood_ProBuilderMesh_WingedEdge_Vector3_f32_Gc1(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Flood",
                            5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (pb, wing, wingNrm, maxAngle, selection))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Flood_WingedEdge_Gc0(
        wing: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::WingedEdge>,
        selection: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Face>,
        >,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (wing, selection))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetEdgeLoop(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (mesh, edges, _cordl_loop))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetEdgeLoopInternal", 3usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (start, startIndex, used))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetEdgeLoopInternalIterative(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (start, edge, used))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetNeighborFaces", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (mesh, edge, neighborFaces))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetPerimeterEdges_ProBuilderMesh_Gc0(
        mesh: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::ProBuilderMesh>,
        faces: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Face>,
        >,
    ...
    pub fn GetPerimeterEdges_ProBuilderMesh_Gc1(
        mesh: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::ProBuilderMesh>,
        edges: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Edge>,
    ) -> quest_hook::libil2cpp::Result<
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::WingedEdge>,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (wing, sharedIndex, allowHoles))?
        };
        Ok(__cordl_ret.into())
    }
