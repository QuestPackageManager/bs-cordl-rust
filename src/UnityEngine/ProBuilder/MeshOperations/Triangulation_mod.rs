...
#[cfg(feature = "UnityEngine+ProBuilder+MeshOperations+Triangulation")]
impl std::ops::DerefMut for crate::UnityEngine::ProBuilder::MeshOperations::Triangulation {
...
impl crate::UnityEngine::ProBuilder::MeshOperations::Triangulation {
    pub fn SortAndTriangulate(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        bool,
                    ), bool, 3usize>("SortAndTriangulate")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (points, indexes, convex))? };
        Ok(__cordl_ret.into())
    }
    pub fn TriangulateVertices_IList_1__cordl_bool__cordl_bool0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                        bool,
                    ), bool, 4usize>("TriangulateVertices")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (vertices, triangles, unordered, convex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn TriangulateVertices_Il2CppArray_Il2CppArray1(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), bool, 3usize>("TriangulateVertices")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (vertices, triangles, holes))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Triangulate_IList_1_ByRefMut1(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (points, holes, indexes))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_triangulationContext() -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_triangulationContext")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
