#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+MeshOperations+VertexEditing")]
#[repr(C)]
...
#[cfg(feature = "UnityEngine+ProBuilder+MeshOperations+VertexEditing")]
impl std::ops::DerefMut for crate::UnityEngine::ProBuilder::MeshOperations::VertexEditing {
...
impl crate::UnityEngine::ProBuilder::MeshOperations::VertexEditing {
    pub fn AlignEdgeWithDirection(
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::Edge =
            unsafe { cordl_method_info.invoke_unchecked((), (edge, commonIndex))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MergeVertices(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (mesh, indexes, collapseToFirst))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::ProBuilderMesh>,
                        crate::UnityEngine::ProBuilder::Edge,
                    ), quest_hook::libil2cpp::Void, 2usize>("SplitVertices")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<i32>> =
            unsafe { cordl_method_info.invoke_unchecked((), (mesh, indexes, neighborRadius))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+MeshOperations+VertexEditing")]
