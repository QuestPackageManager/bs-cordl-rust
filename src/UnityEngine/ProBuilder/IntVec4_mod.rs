...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+IntVec4")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::ProBuilder::IntVec4 {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+IntVec4")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::ProBuilder::IntVec4 {
    type Type = Self;
...
impl crate::UnityEngine::ProBuilder::IntVec4 {
    ...
    pub fn Equals_IntVec4_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::ProBuilder::IntVec4), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn op_Implicit_Vector4_1(
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::IntVec4 =
            unsafe { cordl_method_info.invoke_unchecked((), (p))? };
        Ok(__cordl_ret.into())
    }
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::ProBuilder::IntVec4> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+ProBuilder+IntVec4")]
