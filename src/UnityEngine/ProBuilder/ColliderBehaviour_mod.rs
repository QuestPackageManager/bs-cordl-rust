...
for crate::UnityEngine::ProBuilder::ColliderBehaviour {
    ...
    const CLASS_NAME: &'static str = "ColliderBehaviour";
...
impl crate::UnityEngine::ProBuilder::ColliderBehaviour {
    pub fn Initialize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::ColliderBehaviour as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Initialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::ColliderBehaviour as
