...
impl crate::UnityEngine::ProBuilder::WingedEdge {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::WingedEdge> =
            unsafe { cordl_method_info.invoke_unchecked(self, (common))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Collections::Generic::List_1<
                quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::WingedEdge>,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (mesh, faces, oneWingPerFace))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_edge(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::ProBuilder::EdgeLookup, 0usize>(
                        "get_edge",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::EdgeLookup =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_face(
