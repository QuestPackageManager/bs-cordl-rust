...
#[cfg(feature = "UnityEngine+ProBuilder+IHasDefault")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::IHasDefault {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.ProBuilder";
    const CLASS_NAME: &'static str = "IHasDefault";
...
impl crate::UnityEngine::ProBuilder::IHasDefault {
    pub fn SetDefaultValues(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::IHasDefault as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("SetDefaultValues")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::IHasDefault as
