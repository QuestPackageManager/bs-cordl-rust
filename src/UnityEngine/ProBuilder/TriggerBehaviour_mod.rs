#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+TriggerBehaviour")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+TriggerBehaviour")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::TriggerBehaviour {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.ProBuilder";
    const CLASS_NAME: &'static str = "TriggerBehaviour";
...
impl crate::UnityEngine::ProBuilder::TriggerBehaviour {
    ...
    pub fn OnEnterPlayMode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnEnterPlayMode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn OnSceneLoaded(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("OnSceneLoaded")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (scene, mode))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+TriggerBehaviour")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ProBuilder::TriggerBehaviour {
