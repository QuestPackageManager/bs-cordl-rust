#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+SemVer")]
#[repr(C)]
...
impl crate::UnityEngine::ProBuilder::SemVer {
    ...
    pub fn TryGetVersionInfo(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (input, version))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_Il2CppString_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (formatted, date))? };
        Ok(__cordl_ret.into())
    }
