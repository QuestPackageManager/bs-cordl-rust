#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+FixedArray3_1")]
...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::ProBuilder::Poly2Tri::FixedArray3_1<T> {
