...
pub struct PolygonPoint {
    ...
    pub _Previous_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint>,
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+PolygonPoint")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint {
...
impl crate::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (x, y, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Next(
        &mut self,
    ...
    pub fn set_Next(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_Previous")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+PolygonPoint")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint {
