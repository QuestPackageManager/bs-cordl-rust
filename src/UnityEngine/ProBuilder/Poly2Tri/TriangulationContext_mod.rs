#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+TriangulationContext")]
#[repr(C)]
...
pub struct TriangulationContext {
    ...
    pub Points: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub _TriangulationMode_k__BackingField:
        crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationMode,
    pub _Triangulatable_k__BackingField:
...
#[cfg(feature = "UnityEngine+ProBuilder+Poly2Tri+TriangulationContext")]
impl std::ops::DerefMut for crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext {
...
impl crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext {
    ...
    pub fn Done(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn NewConstraint(
        &mut self,
        a: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint>,
        b: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint>,
    ...
    pub fn PrepareTriangulation(
        &mut self,
        t: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::Triangulatable>,
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationAlgorithm =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_DTDebugContext(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::DTSweepDebugContext>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_DebugContext")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn set_Triangulatable(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::Triangulatable>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
