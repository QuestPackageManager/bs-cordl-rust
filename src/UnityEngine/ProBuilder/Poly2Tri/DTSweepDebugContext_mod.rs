...
pub struct DTSweepDebugContext {
    ...
    pub _activeConstraint:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint>,
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+DTSweepDebugContext")]
...
#[cfg(feature = "UnityEngine+ProBuilder+Poly2Tri+DTSweepDebugContext")]
impl std::ops::DerefMut for crate::UnityEngine::ProBuilder::Poly2Tri::DTSweepDebugContext {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_ActiveNode")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_ActivePoint")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
