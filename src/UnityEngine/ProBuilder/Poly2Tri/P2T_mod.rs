...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+P2T")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::Poly2Tri::P2T {
...
impl crate::UnityEngine::ProBuilder::Poly2Tri::P2T {
    ...
    pub fn Triangulate_ConstrainedPointSet2(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (cps))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Triangulate_PolygonSet0(
        ps: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::Poly2Tri::PolygonSet>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn Triangulate_TriangulationAlgorithm_Triangulatable4(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("Triangulate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (algorithm, t))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Warmup() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("Warmup")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Poly2Tri+P2T")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ProBuilder::Poly2Tri::P2T {
