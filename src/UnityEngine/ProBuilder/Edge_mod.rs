...
impl crate::UnityEngine::ProBuilder::Edge {
    ...
    pub fn Contains_i32_Gc2(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, lookup))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Equals_Edge0(
    ...
    pub fn Equals_Edge_Gc2(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (other, lookup))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetIndices(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (edges, indices))?
        };
        Ok(__cordl_ret.into())
    }
