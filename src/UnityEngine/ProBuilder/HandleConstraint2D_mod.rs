#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+HandleConstraint2D")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+HandleConstraint2D")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::HandleConstraint2D {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.ProBuilder";
    const CLASS_NAME: &'static str = "HandleConstraint2D";
...
impl crate::UnityEngine::ProBuilder::HandleConstraint2D {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Mask",
                            1usize
                        )
                    })
            });
    ...
    pub fn New(x: i32, y: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+HandleConstraint2D")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ProBuilder::HandleConstraint2D {
