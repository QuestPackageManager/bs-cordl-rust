#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+MaterialUtility")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+MaterialUtility")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::MaterialUtility {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetMaterialCount", 1usize
                        )
                    })
            });
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (renderer))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetSharedMaterial", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::Material> =
            unsafe { cordl_method_info.invoke_unchecked((), (renderer, index))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+MaterialUtility")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ProBuilder::MaterialUtility {
