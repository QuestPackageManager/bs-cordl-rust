...
impl crate::UnityEngine::ProBuilder::Smoothing {
    ...
    pub fn ApplySmoothingGroups_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (mesh, faces, angleThreshold, normals))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ApplySmoothingGroups_ProBuilderMesh_IEnumerable_1_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (mesh, faces, angleThreshold))? };
        Ok(__cordl_ret.into())
    }
    pub fn FindSoftEdgesRecursive(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                    ), bool, 4usize>("FindSoftEdgesRecursive")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (normals, wing, angleThreshold, processed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetNextUnusedSmoothingGroup(
        start: i32,
        used: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::HashSet_1<i32>>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                    ), i32, 2usize>("GetNextUnusedSmoothingGroup")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (start, used))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetUnusedSmoothingGroup(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (mesh))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsSoftEdge(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (normals, left, right, threshold))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Smoothing")]
