#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+KdTree+Math+TypeMath_1")]
#[repr(C)]
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+Math+TypeMath_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::ProBuilder::KdTree::Math::TypeMath_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (a, b))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (a, b))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<T>>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<T>>,
                    ), T, 2usize>("DistanceSquaredBetweenPoints")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+Math+TypeMath_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::UnityEngine::ProBuilder::KdTree::ITypeMath_1<T>>
    for crate::UnityEngine::ProBuilder::KdTree::Math::TypeMath_1<T>
{
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+Math+TypeMath_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::UnityEngine::ProBuilder::KdTree::ITypeMath_1<T>>
    for crate::UnityEngine::ProBuilder::KdTree::Math::TypeMath_1<T>
{
