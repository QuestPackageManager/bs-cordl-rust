...
impl crate::UnityEngine::ProBuilder::KdTree::Math::DoubleMath {
    pub fn Add(&mut self, a: f64, b: f64) -> quest_hook::libil2cpp::Result<f64> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::KdTree::Math::DoubleMath as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f64, f64), f64, 2usize>("Add")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::Math::DoubleMath as
