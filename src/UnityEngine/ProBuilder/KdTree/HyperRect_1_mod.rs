...
> crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "Clone", 0usize
                )
            });
        let __cordl_ret: crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T> = unsafe {
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "GetClosestPoint", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<T>,
        > = unsafe { method.invoke_unchecked(self, (toPoint, math))? };
        Ok(__cordl_ret.into())
    }
    pub fn Infinite(
        dimensions: i32,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "Infinite", 2usize
                )
            });
        let __cordl_ret: crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T> = unsafe {
            method.invoke_unchecked((), (dimensions, math))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_MaxPoint(
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_MaxPoint", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<T>,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_MinPoint", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<T>,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "set_MaxPoint", 1usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::HyperRect_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "set_MinPoint", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
