#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+KdTree+HyperRect_1")]
    ...
    for crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.ProBuilder.KdTree", "HyperRect`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T> {
    pub fn Clone(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T> =
    ...
    pub fn GetClosestPoint(
        ...
        math: quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::KdTree::ITypeMath_1<T>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<T>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (toPoint, math))? };
        Ok(__cordl_ret.into())
    }
    pub fn Infinite(
        dimensions: i32,
            ...
            + quest_hook::libil2cpp::Returned,
    {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::UnityEngine::ProBuilder::KdTree::ITypeMath_1<T>,
                        >,
                    ), crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T>, 2usize>(
                        "Infinite"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::KdTree::HyperRect_1<T> =
            unsafe { cordl_method_info.invoke_unchecked((), (dimensions, math))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_MaxPoint(
        &mut self,
