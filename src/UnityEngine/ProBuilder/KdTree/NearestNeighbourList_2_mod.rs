...
> {
    ...
    >,
    pub distanceMath:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::ProBuilder::KdTree::ITypeMath_1<TDistance>>,
    pub maxCapacity: i32,
    __cordl_phantom_TItem: std::marker::PhantomData<TItem>,
    __cordl_phantom_TDistance: std::marker::PhantomData<TDistance>,
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+KdTree+NearestNeighbourList_2")]
unsafe impl<TItem: quest_hook::libil2cpp::Type, TDistance: quest_hook::libil2cpp::Type>
...
impl<TItem: quest_hook::libil2cpp::Type, TDistance: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem, TDistance>
{
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+NearestNeighbourList_2")]
impl<TItem: quest_hook::libil2cpp::Type, TDistance: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem, TDistance>
{
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+NearestNeighbourList_2")]
impl<TItem: quest_hook::libil2cpp::Type, TDistance: quest_hook::libil2cpp::Type>
    crate::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem, TDistance>
{
    pub fn Add(&mut self, item: TItem, distance: TDistance) -> quest_hook::libil2cpp::Result<bool>
    where
        TItem: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (item, distance))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TDistance = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        maxCapacity: i32,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (maxCapacity, distanceMath))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+NearestNeighbourList_2")]
impl<TItem: quest_hook::libil2cpp::Type, TDistance: quest_hook::libil2cpp::Type>
    AsRef<crate::UnityEngine::ProBuilder::KdTree::INearestNeighbourList_2<TItem, TDistance>>
    for crate::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem, TDistance>
{
    fn as_ref(
        &self,
...
#[cfg(feature = "UnityEngine+ProBuilder+KdTree+NearestNeighbourList_2")]
impl<TItem: quest_hook::libil2cpp::Type, TDistance: quest_hook::libil2cpp::Type>
    AsMut<crate::UnityEngine::ProBuilder::KdTree::INearestNeighbourList_2<TItem, TDistance>>
    for crate::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem, TDistance>
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::UnityEngine::ProBuilder::KdTree::INearestNeighbourList_2<TItem, TDistance>
    {
        unsafe { std::mem::transmute(self) }
    }
}
