...
for crate::UnityEngine::ProBuilder::KdTree::DuplicateNodeError {
    ...
    const CLASS_NAME: &'static str = "DuplicateNodeError";
...
impl crate::UnityEngine::ProBuilder::KdTree::DuplicateNodeError {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::KdTree::DuplicateNodeError as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::KdTree::DuplicateNodeError as
