#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Entity")]
#[repr(C)]
#[derive(Debug)]
pub struct Entity {
...
impl crate::UnityEngine::ProBuilder::Entity {
    ...
    pub fn get_entityType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::ProBuilder::EntityType, 0usize>(
                        "get_entityType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::EntityType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
