...
#[cfg(feature = "UnityEngine+ProBuilder+Entity")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::Entity {
...
impl crate::UnityEngine::ProBuilder::Entity {
    pub fn Awake(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Entity as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Awake")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::Entity as
    ...
    pub fn SetEntity(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Entity as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::UnityEngine::ProBuilder::EntityType),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::Entity as
                    quest_hook::libil2cpp::Type > ::class(), "SetEntity", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Entity as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::Entity as
                    quest_hook::libil2cpp::Type > ::class(), "get_entityType", 0usize
                )
            });
        let __cordl_ret: crate::UnityEngine::ProBuilder::EntityType = unsafe {
            method.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
