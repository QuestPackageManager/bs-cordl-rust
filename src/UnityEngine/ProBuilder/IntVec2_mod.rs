...
impl crate::UnityEngine::ProBuilder::IntVec2 {
    pub fn Equals_Il2CppObject2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::IntVec2 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ProBuilder::IntVec2 as
    ...
    pub fn op_Implicit_Vector2_1(
        ...
        let __cordl_ret: crate::UnityEngine::ProBuilder::IntVec2 = unsafe {
            method.invoke_unchecked((), (p))?
        };
        Ok(__cordl_ret.into())
    }
