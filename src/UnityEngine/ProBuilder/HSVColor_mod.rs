#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+HSVColor")]
#[repr(C)]
...
impl crate::UnityEngine::ProBuilder::HSVColor {
    ...
    pub fn SqrDistance(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked(self, (InColor))? };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
        &mut self,
    ...
    pub fn _ctor_f32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (h, s, v, sv_modifier))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f32_f32_f32_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (h, s, v))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+HSVColor")]
