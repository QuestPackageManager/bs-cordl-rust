...
impl crate::UnityEngine::ProBuilder::Shapes::Stairs {
    pub fn BuildCurvedStairs(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Shapes::Stairs as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::ProBuilder::Shapes::Stairs as
                    quest_hook::libil2cpp::Type > ::class(), "BuildCurvedStairs", 3usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Shapes::Stairs as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::Shapes::Stairs as
                    quest_hook::libil2cpp::Type > ::class(), "BuildStairs", 3usize
                )
            });
        let __cordl_ret: crate::UnityEngine::Bounds = unsafe {
            method.invoke_unchecked(self, (mesh, _cordl_size, rotation))?
    ...
    pub fn get_sides(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Shapes::Stairs as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("get_sides")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::Shapes::Stairs as
                    quest_hook::libil2cpp::Type > ::class(), "get_sides", 0usize
                )
            });
    ...
    pub fn set_sides(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::ProBuilder::Shapes::Stairs as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_sides")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::ProBuilder::Shapes::Stairs as
                    quest_hook::libil2cpp::Type > ::class(), "set_sides", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
