...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Shapes+Torus")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::Shapes::Torus {
...
impl crate::UnityEngine::ProBuilder::Shapes::Torus {
    ...
    pub fn UpdateBounds(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Bounds, 4usize>("UpdateBounds")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::Bounds = unsafe {
            cordl_method_info.invoke_unchecked(self, (mesh, _cordl_size, rotation, bounds))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Shapes+Torus")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::ProBuilder::Shapes::Torus {
