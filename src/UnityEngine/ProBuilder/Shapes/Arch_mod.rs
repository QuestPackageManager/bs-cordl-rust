#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Shapes+Arch")]
#[repr(C)]
#[derive(Debug)]
pub struct Arch {
...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Shapes+Arch")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::Shapes::Arch {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.ProBuilder.Shapes";
    const CLASS_NAME: &'static str = "Arch";
...
impl crate::UnityEngine::ProBuilder::Shapes::Arch {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<crate::UnityEngine::Vector3>,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (vertex1, vertex2, depth))? };
        Ok(__cordl_ret.into())
    }
