...
#[cfg(feature = "cordl_class_UnityEngine+ProBuilder+Shapes+Pipe")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::ProBuilder::Shapes::Pipe {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.ProBuilder.Shapes";
    const CLASS_NAME: &'static str = "Pipe";
...
#[cfg(feature = "UnityEngine+ProBuilder+Shapes+Pipe")]
impl crate::UnityEngine::ProBuilder::Shapes::Pipe {
    pub fn CopyShape(
        &mut self,
