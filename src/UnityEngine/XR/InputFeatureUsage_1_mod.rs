#[cfg(feature = "cordl_class_UnityEngine+XR+InputFeatureUsage_1")]
    ...
    for crate::UnityEngine::XR::InputFeatureUsage_1<T>
{
    ...
    const CLASS_NAME: &'static str = "InputFeatureUsage`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.XR", "InputFeatureUsage`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::XR::InputFeatureUsage_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::XR::InputFeatureUsage_1<T>), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (usageName))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_name(
        &mut self,
    ...
    for crate::UnityEngine::XR::InputFeatureUsage_1<T>
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::System::IEquatable_1<crate::UnityEngine::XR::InputFeatureUsage_1<T>> {
        todo!()
    }
}
