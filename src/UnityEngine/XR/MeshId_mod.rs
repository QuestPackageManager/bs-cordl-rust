...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::XR::MeshId {
    ...
    const CLASS_NAME: &'static str = "MeshId";
...
impl crate::UnityEngine::XR::MeshId {
    pub fn Equals_Il2CppObject0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::XR::MeshId as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::XR::MeshId as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
    ...
    pub fn Equals_MeshId1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::XR::MeshId as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::UnityEngine::XR::MeshId), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::XR::MeshId as quest_hook::libil2cpp::Type >
