...
impl crate::UnityEngine::XR::Eyes {
    pub fn Equals_Eyes1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::XR::Eyes as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::UnityEngine::XR::Eyes), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::XR::Eyes as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
