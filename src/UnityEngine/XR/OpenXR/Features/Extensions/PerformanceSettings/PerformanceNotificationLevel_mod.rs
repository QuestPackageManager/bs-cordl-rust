...
for crate::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings";
    const CLASS_NAME: &'static str = "PerformanceNotificationLevel";
