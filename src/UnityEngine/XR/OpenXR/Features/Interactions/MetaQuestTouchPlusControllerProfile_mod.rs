#[cfg(
    feature = "cordl_class_UnityEngine+XR+OpenXR+Features+Interactions+MetaQuestTouchPlusControllerProfile"
)]
#[repr(C)]
#[derive(Debug)]
pub struct MetaQuestTouchPlusControllerProfile {
...
for crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchPlusControllerProfile {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.OpenXR.Features.Interactions";
    const CLASS_NAME: &'static str = "MetaQuestTouchPlusControllerProfile";
...
#[cfg(
    feature = "UnityEngine+XR+OpenXR+Features+Interactions+MetaQuestTouchPlusControllerProfile"
)]
impl std::ops::Deref
for crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchPlusControllerProfile {
...
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchPlusControllerProfile {
    pub const aim: &'static str = "/input/aim/pose";
    pub const buttonA: &'static str = "/input/a/click";
    pub const buttonATouch: &'static str = "/input/a/touch";
    pub const buttonB: &'static str = "/input/b/click";
    pub const buttonBTouch: &'static str = "/input/b/touch";
    pub const buttonX: &'static str = "/input/x/click";
    pub const buttonXTouch: &'static str = "/input/x/touch";
    pub const buttonY: &'static str = "/input/y/click";
    pub const buttonYTouch: &'static str = "/input/y/touch";
    pub const featureId: &'static str = "com.unity.openxr.feature.input.metaquestplus";
    pub const grip: &'static str = "/input/grip/pose";
    pub const haptic: &'static str = "/output/haptic";
    pub const kDeviceLocalizedName: &'static str = "Meta Quest Touch Plus Controller OpenXR";
    pub const menu: &'static str = "/input/menu/click";
    pub const profile: &'static str = "/interaction_profiles/meta/touch_controller_plus";
    pub const squeeze: &'static str = "/input/squeeze/value";
    pub const system: &'static str = "/input/system/click";
    pub const thumbProximity: &'static str = "/input/thumb_meta/proximity_meta";
    pub const thumbrest: &'static str = "/input/thumbrest/touch";
    pub const thumbstick: &'static str = "/input/thumbstick";
    pub const thumbstickClick: &'static str = "/input/thumbstick/click";
    pub const thumbstickTouch: &'static str = "/input/thumbstick/touch";
    pub const trigger: &'static str = "/input/trigger/value";
    pub const triggerCurl: &'static str = "/input/trigger/curl_meta";
    pub const triggerForce: &'static str = "/input/trigger/force";
    pub const triggerProximity: &'static str = "/input/trigger/proximity_meta";
    pub const triggerSlide: &'static str = "/input/trigger/slide_meta";
    pub const triggerTouch: &'static str = "/input/trigger/touch";
    #[cfg(
        feature = "UnityEngine+XR+OpenXR+Features+Interactions+MetaQuestTouchPlusControllerProfile+QuestTouchPlusController"
    )]
    pub type QuestTouchPlusController = crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchPlusControllerProfile_QuestTouchPlusController;
...
#[cfg(
    feature = "cordl_class_UnityEngine+XR+OpenXR+Features+Interactions+MetaQuestTouchPlusControllerProfile+QuestTouchPlusController"
)]
#[repr(C)]
#[derive(Debug)]
pub struct MetaQuestTouchPlusControllerProfile_QuestTouchPlusController {
    ...
    >,
    pub _triggerForce_k__BackingField: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::InputSystem::Controls::AxisControl,
    >,
...
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchPlusControllerProfile_QuestTouchPlusController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.OpenXR.Features.Interactions";
    const CLASS_NAME: &'static str = "MetaQuestTouchPlusControllerProfile/QuestTouchPlusController";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchPlusControllerProfile_QuestTouchPlusController {
    pub fn FinishSetup(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
