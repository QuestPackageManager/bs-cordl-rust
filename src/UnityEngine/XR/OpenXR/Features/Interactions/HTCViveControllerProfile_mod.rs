#[cfg(
    feature = "cordl_class_UnityEngine+XR+OpenXR+Features+Interactions+HTCViveControllerProfile"
)]
#[repr(C)]
#[derive(Debug)]
...
pub struct HTCViveControllerProfile_ViveController {
    ...
    >,
    pub _trackpadClicked_k__BackingField: quest_hook::libil2cpp::Gc<
        crate::UnityEngine::InputSystem::Controls::ButtonControl,
    >,
...
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::HTCViveControllerProfile_ViveController {
    pub fn FinishSetup(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
