...
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::XR::OpenXR::Features::Interactions::ValveIndexControllerProfile
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.OpenXR.Features.Interactions";
    const CLASS_NAME: &'static str = "ValveIndexControllerProfile";
...
#[cfg(feature = "UnityEngine+XR+OpenXR+Features+Interactions+ValveIndexControllerProfile")]
impl std::ops::Deref
    for crate::UnityEngine::XR::OpenXR::Features::Interactions::ValveIndexControllerProfile
{
...
#[cfg(feature = "UnityEngine+XR+OpenXR+Features+Interactions+ValveIndexControllerProfile")]
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::ValveIndexControllerProfile {
    ...
    pub const featureId: &'static str = "com.unity.openxr.feature.input.valveindex";
    pub const grip: &'static str = "/input/grip/pose";
    pub const haptic: &'static str = "/output/haptic";
    pub const kDeviceLocalizedName: &'static str = "Index Controller OpenXR";
    pub const profile: &'static str = "/interaction_profiles/valve/index_controller";
    pub const squeeze: &'static str = "/input/squeeze/value";
    pub const squeezeForce: &'static str = "/input/squeeze/force";
    pub const system: &'static str = "/input/system/click";
    pub const systemTouch: &'static str = "/input/system/touch";
    ...
    pub const trackpad: &'static str = "/input/trackpad";
    pub const trackpadForce: &'static str = "/input/trackpad/force";
    pub const trackpadTouch: &'static str = "/input/trackpad/touch";
    pub const trigger: &'static str = "/input/trigger/value";
    pub const triggerClick: &'static str = "/input/trigger/click";
    pub const triggerTouch: &'static str = "/input/trigger/touch";
    #[cfg(
        feature = "UnityEngine+XR+OpenXR+Features+Interactions+ValveIndexControllerProfile+ValveIndexController"
    )]
    pub type ValveIndexController = crate::UnityEngine::XR::OpenXR::Features::Interactions::ValveIndexControllerProfile_ValveIndexController;
...
pub struct ValveIndexControllerProfile_ValveIndexController {
    ...
    pub _systemTouched_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::ButtonControl>,
    ...
    pub _gripPressed_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::ButtonControl>,
    pub _gripForce_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::AxisControl>,
    ...
    pub _thumbstickTouched_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::ButtonControl>,
    pub _trackpad_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::Vector2Control>,
    pub _trackpadTouched_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::ButtonControl>,
    pub _trackpadForce_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::InputSystem::Controls::AxisControl>,
...
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::XR::OpenXR::Features::Interactions::ValveIndexControllerProfile_ValveIndexController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.OpenXR.Features.Interactions";
    const CLASS_NAME: &'static str = "ValveIndexControllerProfile/ValveIndexController";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::ValveIndexControllerProfile_ValveIndexController {
    pub fn FinishSetup(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
