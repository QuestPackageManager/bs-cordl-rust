...
#[repr(C)]
#[derive(Debug)]
pub struct MetaQuestTouchProControllerProfile {
...
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchProControllerProfile {
    ...
    pub const featureId: &'static str = "com.unity.openxr.feature.input.metaquestpro";
    pub const grip: &'static str = "/input/grip/pose";
    pub const haptic: &'static str = "/output/haptic";
    pub const hapticThumb: &'static str = "/output/thumb_haptic_fb";
    pub const hapticTrigger: &'static str = "/output/trigger_haptic_fb";
    pub const kDeviceLocalizedName: &'static str = "Meta Quest Pro Touch Controller OpenXR";
    pub const menu: &'static str = "/input/menu/click";
    pub const profile: &'static str = "/interaction_profiles/facebook/touch_controller_pro";
    pub const squeeze: &'static str = "/input/squeeze/value";
    pub const stylusForce: &'static str = "/input/stylus_fb/force";
    pub const system: &'static str = "/input/system/click";
    pub const thumbProximity: &'static str = "/input/thumb_fb/proximity_fb";
    pub const thumbrest: &'static str = "/input/thumbrest/touch";
    pub const thumbrestForce: &'static str = "/input/thumbrest/force";
    ...
    pub const triggerCurl: &'static str = "/input/trigger/curl_fb";
    pub const triggerProximity: &'static str = "/input/trigger/proximity_fb";
    pub const triggerSlide: &'static str = "/input/trigger/slide_fb";
    pub const triggerTouch: &'static str = "/input/trigger/touch";
    #[cfg(
        feature = "UnityEngine+XR+OpenXR+Features+Interactions+MetaQuestTouchProControllerProfile+QuestProTouchController"
    )]
...
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchProControllerProfile_QuestProTouchController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.OpenXR.Features.Interactions";
    const CLASS_NAME: &'static str = "MetaQuestTouchProControllerProfile/QuestProTouchController";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::XR::OpenXR::Features::Interactions::MetaQuestTouchProControllerProfile_QuestProTouchController {
    pub fn FinishSetup(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
