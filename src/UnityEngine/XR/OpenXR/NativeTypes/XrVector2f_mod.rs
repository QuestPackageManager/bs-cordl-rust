...
for crate::UnityEngine::XR::OpenXR::NativeTypes::XrVector2f {
    ...
    const CLASS_NAME: &'static str = "XrVector2f";
...
#[cfg(feature = "UnityEngine+XR+OpenXR+NativeTypes+XrVector2f")]
impl crate::UnityEngine::XR::OpenXR::NativeTypes::XrVector2f {
    pub fn _ctor_Vector2_1(
        &mut self,
