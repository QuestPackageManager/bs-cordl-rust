#[cfg(feature = "cordl_class_UnityEngine+XR+OpenXR+Input+PoseControl")]
#[repr(C)]
#[derive(Debug)]
pub struct PoseControl {
    __cordl_parent: crate::UnityEngine::InputSystem::InputControl_1<
        crate::UnityEngine::XR::OpenXR::Input::Pose,
    >,
...
#[cfg(feature = "UnityEngine+XR+OpenXR+Input+PoseControl")]
impl std::ops::Deref for crate::UnityEngine::XR::OpenXR::Input::PoseControl {
...
#[cfg(feature = "UnityEngine+XR+OpenXR+Input+PoseControl")]
impl std::ops::DerefMut for crate::UnityEngine::XR::OpenXR::Input::PoseControl {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+XR+OpenXR+Input+PoseControl")]
impl crate::UnityEngine::XR::OpenXR::Input::PoseControl {
    ...
    pub fn ReadUnprocessedValueFromState(
    ...
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::XR::OpenXR::Input::Pose> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: crate::UnityEngine::XR::OpenXR::Input::Pose =
            unsafe { cordl_method_info.invoke_unchecked(self, (statePtr))? };
        Ok(__cordl_ret.into())
    }
    pub fn WriteValueIntoState(
        &mut self,
        value: crate::UnityEngine::XR::OpenXR::Input::Pose,
        statePtr: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::QuaternionControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_rotation")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::Vector3Control,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_velocity")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+XR+OpenXR+Input+PoseControl")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::XR::OpenXR::Input::PoseControl {
