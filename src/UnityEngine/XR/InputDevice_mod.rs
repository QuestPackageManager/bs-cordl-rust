#[cfg(feature = "cordl_class_UnityEngine+XR+InputDevice")]
...
#[cfg(feature = "cordl_class_UnityEngine+XR+InputDevice")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::XR::InputDevice {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+XR+InputDevice")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::XR::InputDevice {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+XR+InputDevice")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::XR::InputDevice {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+XR+InputDevice")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::XR::InputDevice {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+XR+InputDevice")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::XR::InputDevice {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::UnityEngine::XR::InputDevice {
    ...
    pub fn Equals_InputDevice1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::XR::InputDevice), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn IsValidId(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("IsValidId")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SendHapticImpulse(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u32, f32, f32), bool, 3usize>("SendHapticImpulse")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (channel, amplitude, duration))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (deviceId))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_characteristics(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::UnityEngine::XR::InputDeviceCharacteristics> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::XR::InputDeviceCharacteristics, 0usize>(
                        "get_characteristics",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::XR::InputDeviceCharacteristics =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::XR::InputDevice> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+XR+InputDevice")]
impl AsMut<crate::System::IEquatable_1<crate::UnityEngine::XR::InputDevice>>
    for crate::UnityEngine::XR::InputDevice
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::UnityEngine::XR::InputDevice> {
        todo!()
    }
}
