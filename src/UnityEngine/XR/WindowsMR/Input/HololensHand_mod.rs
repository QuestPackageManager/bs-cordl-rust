...
#[cfg(feature = "cordl_class_UnityEngine+XR+WindowsMR+Input+HololensHand")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::XR::WindowsMR::Input::HololensHand {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR.WindowsMR.Input";
    const CLASS_NAME: &'static str = "HololensHand";
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::UnityEngine::InputSystem::Controls::ButtonControl,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_airTap")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+XR+WindowsMR+Input+HololensHand")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::XR::WindowsMR::Input::HololensHand {
