...
pub struct XRInputSubsystem {
    ...
    pub boundaryChanged: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub m_DeviceIdsCache:
        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<u64>>,
}
#[cfg(feature = "cordl_class_UnityEngine+XR+XRInputSubsystem")]
...
impl crate::UnityEngine::XR::XRInputSubsystem {
    #[cfg(feature = "UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
    pub type BindingsMarshaller = crate::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller;
    pub fn InvokeBoundaryChangedEvent(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (internalPtr))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn TrySetTrackingOriginMode(
        &mut self,
        origin: crate::UnityEngine::XR::TrackingOriginModeFlags,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::XR::TrackingOriginModeFlags), bool, 1usize>(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (origin))? };
        Ok(__cordl_ret.into())
    }
    pub fn TrySetTrackingOriginMode_Injected(
        _unity_self: crate::System::IntPtr,
        origin: crate::UnityEngine::XR::TrackingOriginModeFlags,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        crate::System::IntPtr,
                        crate::UnityEngine::XR::TrackingOriginModeFlags,
                    ), bool, 2usize>("TrySetTrackingOriginMode_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                            "TrySetTrackingOriginMode_Injected",
                            2usize
                        )
                    })
            });
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (_unity_self, origin))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct XRInputSubsystem_BindingsMarshaller {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
}
#[cfg(feature = "cordl_class_UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.XR";
    const CLASS_NAME: &'static str = "XRInputSubsystem/BindingsMarshaller";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
impl std::ops::Deref for crate::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller {
...
#[cfg(feature = "UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
impl std::ops::DerefMut for crate::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
impl crate::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller {
    pub fn ConvertToNative(
        xrInputSubsystem: quest_hook::libil2cpp::Gc<crate::UnityEngine::XR::XRInputSubsystem>,
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (xrInputSubsystem))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+XR+XRInputSubsystem+BindingsMarshaller")]
