...
pub struct MeshGenerationResult {
    ...
    pub _MeshCollider_k__BackingField: quest_hook::libil2cpp::Gc<crate::UnityEngine::MeshCollider>,
...
#[cfg(feature = "cordl_class_UnityEngine+XR+MeshGenerationResult")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::XR::MeshGenerationResult {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+XR+MeshGenerationResult")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::XR::MeshGenerationResult {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+XR+MeshGenerationResult")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::XR::MeshGenerationResult {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+XR+MeshGenerationResult")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::XR::MeshGenerationResult {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+XR+MeshGenerationResult")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::XR::MeshGenerationResult {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+XR+MeshGenerationResult")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::XR::MeshGenerationResult {
    type Type = Self;
...
impl crate::UnityEngine::XR::MeshGenerationResult {
    ...
    pub fn Equals_MeshGenerationResult1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::UnityEngine::XR::MeshGenerationResult), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_Attributes(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::XR::MeshVertexAttributes, 0usize>(
                        "get_Attributes",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::XR::MeshVertexAttributes =
    ...
    pub fn get_MeshCollider(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::MeshCollider>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_MeshCollider", 0usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::MeshCollider> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_MeshId(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::XR::MeshId> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::XR::MeshId, 0usize>("get_MeshId")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::XR::MeshId =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_Status(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::XR::MeshGenerationStatus, 0usize>(
                        "get_Status",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::UnityEngine::XR::MeshGenerationStatus =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::UnityEngine::XR::MeshGenerationResult> {
        todo!()
    }
}
#[cfg(feature = "UnityEngine+XR+MeshGenerationResult")]
