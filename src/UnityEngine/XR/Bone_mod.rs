...
impl crate::UnityEngine::XR::Bone {
    pub fn Equals_Bone1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::XR::Bone as quest_hook::libil2cpp::Type>::class()
            .find_method::<(crate::UnityEngine::XR::Bone), bool, 1usize>("Equals")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::XR::Bone as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
