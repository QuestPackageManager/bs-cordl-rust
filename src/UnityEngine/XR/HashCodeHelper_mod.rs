#[cfg(feature = "cordl_class_UnityEngine+XR+HashCodeHelper")]
#[repr(C)]
...
impl crate::UnityEngine::XR::HashCodeHelper {
    pub fn Combine_i32_1(hash1: i32, hash2: i32, hash3: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (hash1, hash2, hash3))? };
        Ok(__cordl_ret.into())
    }
    pub fn Combine_i32_i32_0(hash1: i32, hash2: i32) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (hash1, hash2))? };
        Ok(__cordl_ret.into())
    }
    pub fn Combine_i32_i32_2(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (hash1, hash2, hash3, hash4))? };
        Ok(__cordl_ret.into())
    }
    pub fn Combine_i32_i32_i32_3(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (hash1, hash2, hash3, hash4, hash5))? };
        Ok(__cordl_ret.into())
    }
    pub fn Combine_i32_i32_i32_i32_4(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info.invoke_unchecked((), (hash1, hash2, hash3, hash4, hash5, hash6))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Combine_i32_i32_i32_i32_i32_5(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32, i32, i32, i32, i32, i32, i32), i32, 7usize>(
                        "Combine",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn Combine_i32_i32_i32_i32_i32_i32_6(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(i32, i32, i32, i32, i32, i32, i32, i32), i32, 8usize>(
                        "Combine",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 = unsafe {
            cordl_method_info
                .invoke_unchecked((), (hash1, hash2, hash3, hash4, hash5, hash6, hash7, hash8))?
        };
        Ok(__cordl_ret.into())
    }
}
