...
unsafe impl<
        ...
        T2: quest_hook::libil2cpp::Type,
        T3: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::UnityEngine::Events::UnityEvent_4<T0, T1, T2, T3>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Events";
    const CLASS_NAME: &'static str = "UnityEvent`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "UnityEvent`4")
                .unwrap()
