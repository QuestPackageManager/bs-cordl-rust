#[cfg(feature = "cordl_class_UnityEngine+Events+BaseInvokableCall")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+Events+BaseInvokableCall")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Events::BaseInvokableCall {
...
impl crate::UnityEngine::Events::BaseInvokableCall {
    pub fn AllowInvoke(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (delegate))? };
        Ok(__cordl_ret.into())
    }
    pub fn Find(
        &mut self,
    ...
    pub fn _ctor_Il2CppObject_MethodInfo1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (target, function))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Events+BaseInvokableCall")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Events::BaseInvokableCall {
