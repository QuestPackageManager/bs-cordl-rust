#[cfg(feature = "cordl_class_UnityEngine+Events+CachedInvokableCall_1")]
#[repr(C)]
    ...
    for crate::UnityEngine::Events::CachedInvokableCall_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "CachedInvokableCall`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "UnityEngine+Events+CachedInvokableCall_1")]
impl<T: quest_hook::libil2cpp::Type> crate::UnityEngine::Events::CachedInvokableCall_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (target, theFunction, argument))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Events+CachedInvokableCall_1")]
