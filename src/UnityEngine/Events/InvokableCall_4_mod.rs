...
> {
    ...
    pub Delegate:
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::UnityAction_4<T1, T2, T3, T4>>,
...
unsafe impl<
        ...
        T3: quest_hook::libil2cpp::Type,
        T4: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::UnityEngine::Events::InvokableCall_4<T1, T2, T3, T4>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Events";
    const CLASS_NAME: &'static str = "InvokableCall`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "InvokableCall`4")
                .unwrap()
...
impl<
        ...
        T3: quest_hook::libil2cpp::Type,
        T4: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::UnityEngine::Events::InvokableCall_4<T1, T2, T3, T4>
{
...
impl<
        ...
        T3: quest_hook::libil2cpp::Type,
        T4: quest_hook::libil2cpp::Type,
    > std::ops::DerefMut for crate::UnityEngine::Events::InvokableCall_4<T1, T2, T3, T4>
{
...
impl<
    ...
    for crate::UnityEngine::Events::InvokableCall_4<T1, T2, T3, T4>
{
