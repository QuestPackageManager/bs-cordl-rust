...
> {
    ...
    pub Delegate: *mut crate::UnityEngine::Events::UnityAction_4<T1, T2, T3, T4>,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::UnityEngine::Events::InvokableCall_4 < T1, T2,
    T3, T4 > => "UnityEngine.Events"."InvokableCall`4" < T1, T2, T3, T4 >
);
#[cfg(feature = "UnityEngine+Events+InvokableCall_4")]
impl<
    T1: quest_hook::libil2cpp::Type,
