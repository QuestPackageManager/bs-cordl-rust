...
pub struct UnityAction_2<T0: quest_hook::libil2cpp::Type, T1: quest_hook::libil2cpp::Type> {
    ...
    quest_hook::libil2cpp::Type for crate::UnityEngine::Events::UnityAction_2<T0, T1>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "UnityAction`2")
                .unwrap()
                .make_generic::<(T0, T1)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "cordl_class_UnityEngine+Events+UnityAction_2")]
impl<T0: quest_hook::libil2cpp::Type, T1: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Events::UnityAction_2<T0, T1>
{
