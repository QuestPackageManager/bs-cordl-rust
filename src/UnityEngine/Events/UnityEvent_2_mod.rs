    ...
    quest_hook::libil2cpp::Type for crate::UnityEngine::Events::UnityEvent_2<T0, T1>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "UnityEvent`2")
                .unwrap()
                .make_generic::<(T0, T1)>()
                .unwrap()
                .unwrap()
    ...
    crate::UnityEngine::Events::UnityEvent_2<T0, T1>
{
    pub fn AddListener(
        &mut self,
        call: quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::UnityAction_2<T0, T1>>,
    ...
    pub fn GetDelegate_UnityAction_2_1(
        action: quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::UnityAction_2<T0, T1>>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::BaseInvokableCall>,
    >
    where
...
#[cfg(feature = "cordl_class_UnityEngine+Events+UnityEvent_2")]
impl<T0: quest_hook::libil2cpp::Type, T1: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Events::UnityEvent_2<T0, T1>
{
