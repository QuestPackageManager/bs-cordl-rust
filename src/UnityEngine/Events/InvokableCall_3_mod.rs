...
> {
    ...
    pub Delegate: quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::UnityAction_3<T1, T2, T3>>,
...
unsafe impl<
        ...
        T2: quest_hook::libil2cpp::Type,
        T3: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::UnityEngine::Events::InvokableCall_3<T1, T2, T3>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "InvokableCall`3")
                .unwrap()
    ...
    > crate::UnityEngine::Events::InvokableCall_3<T1, T2, T3>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T1, T2, T3), quest_hook::libil2cpp::Void, 3usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (args0, args1, args2))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
