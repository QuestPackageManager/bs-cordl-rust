...
pub struct InvokableCall_1<T1: quest_hook::libil2cpp::Type> {
    ...
    pub Delegate: quest_hook::libil2cpp::Gc<crate::UnityEngine::Events::UnityAction_1<T1>>,
    ...
    for crate::UnityEngine::Events::InvokableCall_1<T1>
{
    ...
    const CLASS_NAME: &'static str = "InvokableCall`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "InvokableCall`1")
                .unwrap()
                .make_generic::<(T1)>()
                .unwrap()
                .unwrap()
...
impl<T1: quest_hook::libil2cpp::Type> crate::UnityEngine::Events::InvokableCall_1<T1> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T1), quest_hook::libil2cpp::Void, 1usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (args0))? };
        Ok(__cordl_ret.into())
    }
