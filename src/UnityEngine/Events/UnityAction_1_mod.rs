    ...
    for crate::UnityEngine::Events::UnityAction_1<T0>
{
    ...
    const CLASS_NAME: &'static str = "UnityAction`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "UnityAction`1")
                .unwrap()
                .make_generic::<(T0)>()
                .unwrap()
                .unwrap()
...
impl<T0: quest_hook::libil2cpp::Type> crate::UnityEngine::Events::UnityAction_1<T0> {
    pub fn Invoke(&mut self, arg0: T0) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(T0), quest_hook::libil2cpp::Void, 1usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
