    ...
    > quest_hook::libil2cpp::Type for crate::UnityEngine::Events::UnityAction_3<T0, T1, T2>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("UnityEngine.Events", "UnityAction`3")
                .unwrap()
...
impl<
        ...
        T1: quest_hook::libil2cpp::Type,
        T2: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Events::UnityAction_3<T0, T1, T2>
{
