...
for crate::UnityEngine::Events::UnityEvent_1<T0> {
    ...
    const CLASS_NAME: &'static str = "UnityEvent`1";
...
impl<T0: quest_hook::libil2cpp::Type> crate::UnityEngine::Events::UnityEvent_1<T0> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Events::UnityEvent_1<
            T0,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::Events::UnityEvent_1 < T0 > as
