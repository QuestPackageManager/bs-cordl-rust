...
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Events::UnityAction {
    ...
    const CLASS_NAME: &'static str = "UnityAction";
...
impl crate::UnityEngine::Events::UnityAction {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::Events::UnityAction as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Invoke")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::Events::UnityAction as
