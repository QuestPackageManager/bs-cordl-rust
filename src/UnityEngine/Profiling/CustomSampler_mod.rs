...
#[cfg(feature = "cordl_class_UnityEngine+Profiling+CustomSampler")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Profiling::CustomSampler {
...
#[cfg(feature = "UnityEngine+Profiling+CustomSampler+BindingsMarshaller")]
impl std::ops::Deref for crate::UnityEngine::Profiling::CustomSampler_BindingsMarshaller {
...
#[cfg(feature = "UnityEngine+Profiling+CustomSampler+BindingsMarshaller")]
impl std::ops::DerefMut for crate::UnityEngine::Profiling::CustomSampler_BindingsMarshaller {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
...
impl crate::UnityEngine::Profiling::CustomSampler_BindingsMarshaller {
    pub fn ConvertToNative(
        customSampler: quest_hook::libil2cpp::Gc<crate::UnityEngine::Profiling::CustomSampler>,
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (customSampler))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Profiling+CustomSampler+BindingsMarshaller")]
