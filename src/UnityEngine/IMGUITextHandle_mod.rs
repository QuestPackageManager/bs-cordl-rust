    ...
    pub tuple: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::LinkedListNode_1<
            quest_hook::libil2cpp::Gc<
                crate::UnityEngine::IMGUITextHandle_TextHandleTuple,
            >,
        >,
    >,
...
impl crate::UnityEngine::IMGUITextHandle {
    ...
    pub fn ClearUnusedTextHandles() -> quest_hook::libil2cpp::Result<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ConvertGUIStyleToGenerationSettings", 5usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (settings, style, textColor, text, rect))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetTextHandle_GUIStyle_Rect_Il2CppString_Color32_0(
        ...
        quest_hook::libil2cpp::Gc<crate::UnityEngine::IMGUITextHandle>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetTextHandle", 4usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::UnityEngine::IMGUITextHandle,
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (style, position, content, textColor))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        > = unsafe {
            cordl_method_info
                .invoke_unchecked((), (settings, isCalledFromNative, isCached))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::UnityEngine::TextCore::Text::TextOverflowMode = unsafe {
            cordl_method_info.invoke_unchecked((), (clipping))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShouldCleanup", 3usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (currentTime, lastTime, cleanupThreshold))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
for crate::UnityEngine::IMGUITextHandle_TextHandleTuple {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine";
...
impl crate::UnityEngine::IMGUITextHandle_TextHandleTuple {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (lastTimeUsed, hashCode))?
        };
        Ok(__cordl_ret.into())
    }
}
