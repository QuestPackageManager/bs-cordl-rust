...
impl crate::UnityEngine::Mathf {
    pub fn Abs_f32_0(f: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (f))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Atan2(y: f32, x: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (y, x))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CeilToInt(f: f32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (f))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CorrelatedColorTemperatureToRGB(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f32), crate::UnityEngine::Color, 1usize>(
        ...
        let __cordl_ret: crate::UnityEngine::Color =
            unsafe { cordl_method_info.invoke_unchecked((), (kelvin))? };
        Ok(__cordl_ret.into())
    }
    pub fn CorrelatedColorTemperatureToRGB_Injected(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (kelvin, ret))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn DeltaAngle(current: f32, target: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 =
            unsafe { cordl_method_info.invoke_unchecked((), (current, target))? };
        Ok(__cordl_ret.into())
    }
    pub fn DiscardLeastSignificantDecimal(v: f64) -> quest_hook::libil2cpp::Result<f64> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f64), f64, 1usize>("DiscardLeastSignificantDecimal")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: f64 = unsafe { cordl_method_info.invoke_unchecked((), (v))? };
        Ok(__cordl_ret.into())
    }
    pub fn Exp(power: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (power))? };
        Ok(__cordl_ret.into())
    }
    pub fn FloatToHalf(val: f32) -> quest_hook::libil2cpp::Result<u16> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f32), u16, 1usize>("FloatToHalf")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetNumberOfDecimalsForMinimumDifference(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f64), i32, 1usize>(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (minDifference))? };
        Ok(__cordl_ret.into())
    }
    pub fn InverseLerp(a: f32, b: f32, value: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn Log_f32_0(f: f32, p: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (f, p))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Max_Il2CppArray1(
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (values))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn MoveTowards(
        ...
        let __cordl_ret: f32 =
            unsafe { cordl_method_info.invoke_unchecked((), (current, target, maxDelta))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn PerlinNoise(x: f32, y: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f32, f32), f32, 2usize>("PerlinNoise")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (x, y))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Repeat(t: f32, length: f32) -> quest_hook::libil2cpp::Result<f32> {
        ...
        let __cordl_ret: f32 = unsafe { cordl_method_info.invoke_unchecked((), (t, length))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn RoundBasedOnMinimumDifference(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f64, f64), f64, 2usize>("RoundBasedOnMinimumDifference")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: f64 =
            unsafe { cordl_method_info.invoke_unchecked((), (valueToRound, minDifference))? };
        Ok(__cordl_ret.into())
    }
