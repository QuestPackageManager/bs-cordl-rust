#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::InputForUI::TextInputEvent {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.InputForUI";
    const CLASS_NAME: &'static str = "TextInputEvent";
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::InputForUI::TextInputEvent {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::InputForUI::TextInputEvent {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::InputForUI::TextInputEvent {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
unsafe impl quest_hook::libil2cpp::Return for crate::UnityEngine::InputForUI::TextInputEvent {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+TextInputEvent")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::InputForUI::TextInputEvent {
    type Type = Self;
...
#[cfg(feature = "UnityEngine+InputForUI+TextInputEvent")]
impl crate::UnityEngine::InputForUI::TextInputEvent {
    pub fn ToString(
        &mut self,
...
impl AsRef<crate::UnityEngine::InputForUI::IEventProperties>
    for crate::UnityEngine::InputForUI::TextInputEvent
{
