#[cfg(
    feature = "cordl_class_UnityEngine+InputForUI+KeyEvent+ButtonsState+_buttons_e__FixedBuffer"
)]
#[repr(C)]
...
impl crate::UnityEngine::InputForUI::KeyEvent_ButtonsState {
    #[cfg(
        feature = "UnityEngine+InputForUI+KeyEvent+ButtonsState+_buttons_e__FixedBuffer"
    )]
    pub type _buttons_e__FixedBuffer = crate::UnityEngine::InputForUI::ButtonsState_KeyEvent__buttons_e__FixedBuffer;
    ...
    pub fn SetPressed(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (keyCode, pressed))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetUnchecked(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ShouldBeProcessed", 1usize
                        )
                    })
            });
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (keyCode))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
...
#[cfg(feature = "cordl_class_UnityEngine+InputForUI+KeyEvent+Type")]
unsafe impl quest_hook::libil2cpp::Type
for crate::UnityEngine::InputForUI::KeyEvent_Type {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine.InputForUI";
