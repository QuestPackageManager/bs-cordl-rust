...
> crate::UnityEngine::IntegratedSubsystemDescriptor_1<TSubsystem> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::IntegratedSubsystemDescriptor_1<
            TSubsystem,
        ...
        let __cordl_ret: TSubsystem = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateImpl(
        &mut self,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::IntegratedSubsystemDescriptor_1 < TSubsystem >
                    as quest_hook::libil2cpp::Type > ::class(), "CreateImpl", 0usize
                )
            });
