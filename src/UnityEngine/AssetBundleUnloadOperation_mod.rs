...
impl crate::UnityEngine::AssetBundleUnloadOperation {
    ...
    pub fn WaitForCompletion(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::AssetBundleUnloadOperation as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("WaitForCompletion")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::UnityEngine::AssetBundleUnloadOperation as
                    quest_hook::libil2cpp::Type > ::class(), "WaitForCompletion", 0usize
                )
            });
