#[cfg(feature = "cordl_class_UnityEngine+FindObjectsSortMode")]
...
#[cfg(feature = "cordl_class_UnityEngine+FindObjectsSortMode")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::FindObjectsSortMode {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "UnityEngine";
    const CLASS_NAME: &'static str = "FindObjectsSortMode";
...
#[cfg(feature = "cordl_class_UnityEngine+FindObjectsSortMode")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::FindObjectsSortMode {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
