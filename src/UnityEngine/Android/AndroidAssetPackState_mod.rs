#[cfg(feature = "cordl_class_UnityEngine+Android+AndroidAssetPackState")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_UnityEngine+Android+AndroidAssetPackState")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Android::AndroidAssetPackState {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "UnityEngine.Android";
    const CLASS_NAME: &'static str = "AndroidAssetPackState";
...
impl crate::UnityEngine::Android::AndroidAssetPackState {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, status, error))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+Android+AndroidAssetPackState")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Android::AndroidAssetPackState {
