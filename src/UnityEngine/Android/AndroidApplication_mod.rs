...
#[cfg(feature = "cordl_class_UnityEngine+Android+AndroidApplication")]
unsafe impl quest_hook::libil2cpp::Type for crate::UnityEngine::Android::AndroidApplication {
...
impl crate::UnityEngine::Android::AndroidApplication {
    pub fn AcquireMainThreadSynchronizationContext(
    ...
    pub fn DispatchConfigurationChanged(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (notifySubscribers))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetCurrentConfiguration(
        config: quest_hook::libil2cpp::Gc<crate::UnityEngine::Android::AndroidConfiguration>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn get_CurrentActivityRaw() -> quest_hook::libil2cpp::Result<crate::System::IntPtr> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_CurrentContextRaw() -> quest_hook::libil2cpp::Result<crate::System::IntPtr> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_UnityPlayerRaw() -> quest_hook::libil2cpp::Result<crate::System::IntPtr> {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::System::IntPtr, 0usize>("get_UnityPlayerRaw")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_UnityEngine+Android+AndroidApplication")]
impl quest_hook::libil2cpp::ObjectType for crate::UnityEngine::Android::AndroidApplication {
