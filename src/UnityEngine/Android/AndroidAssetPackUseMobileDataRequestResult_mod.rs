#[cfg(feature = "cordl_class_UnityEngine+Android+AndroidAssetPackUseMobileDataRequestResult")]
#[repr(C)]
...
impl std::ops::Deref for crate::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult {
...
impl crate::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult {
    pub fn New(allowed: bool) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
