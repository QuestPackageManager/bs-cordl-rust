#[cfg(feature = "cordl_class_UnityEngine+BootConfigData")]
#[repr(C)]
...
impl crate::UnityEngine::BootConfigData {
    ...
    pub fn WrapBootConfigData(
        nativeHandle: crate::System::IntPtr,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::BootConfigData>>
    {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WrapBootConfigData", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::BootConfigData> =
            unsafe { cordl_method_info.invoke_unchecked((), (nativeHandle))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (nativeHandle))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_UnityEngine+BootConfigData")]
