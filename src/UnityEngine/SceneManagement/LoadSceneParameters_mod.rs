...
for crate::UnityEngine::SceneManagement::LoadSceneParameters {
    ...
    const CLASS_NAME: &'static str = "LoadSceneParameters";
...
impl crate::UnityEngine::SceneManagement::LoadSceneParameters {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::UnityEngine::SceneManagement::LoadSceneParameters as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::UnityEngine::SceneManagement::LoadSceneParameters as
