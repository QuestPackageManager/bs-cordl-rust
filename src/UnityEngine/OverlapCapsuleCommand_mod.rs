...
#[cfg(feature = "cordl_class_UnityEngine+OverlapCapsuleCommand")]
unsafe impl quest_hook::libil2cpp::Argument for crate::UnityEngine::OverlapCapsuleCommand {
    type Type = Self;
...
#[cfg(feature = "cordl_class_UnityEngine+OverlapCapsuleCommand")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::UnityEngine::OverlapCapsuleCommand {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+OverlapCapsuleCommand")]
unsafe impl quest_hook::libil2cpp::Returned for crate::UnityEngine::OverlapCapsuleCommand {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_UnityEngine+OverlapCapsuleCommand")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::UnityEngine::OverlapCapsuleCommand {
    type Type = Self;
...
impl crate::UnityEngine::OverlapCapsuleCommand {
    ...
    pub fn _ctor_Vector3_f32_QueryParameters0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (point0, point1, radius, queryParameters))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_point0(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector3> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
    ...
    pub fn get_point1(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Vector3> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
