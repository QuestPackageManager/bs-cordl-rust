...
impl crate::Mono::ISystemDependencyProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::ISystemDependencyProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Mono::ISystemCertificateProvider>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::ISystemDependencyProvider as
                    quest_hook::libil2cpp::Type > ::class(), "get_CertificateProvider",
                    0usize
                )
            });
