...
impl crate::Mono::X509PalImplMono {
    pub fn Import_Il2CppArray0(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::X509PalImplMono as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::X509PalImplMono as quest_hook::libil2cpp::Type >
                    ::class(), "Import", 1usize
                )
            });
