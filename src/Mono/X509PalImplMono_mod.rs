...
pub struct X509PalImplMono {
    __cordl_parent: quest_hook::libil2cpp::Gc<crate::Mono::X509PalImpl>,
}
#[cfg(feature = "Mono+X509PalImplMono")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Mono::X509PalImplMono => "Mono"
    ."X509PalImplMono"
);
#[cfg(feature = "Mono+X509PalImplMono")]
impl std::ops::Deref for crate::Mono::X509PalImplMono {
    type Target = quest_hook::libil2cpp::Gc<crate::Mono::X509PalImpl>;
