...
for crate::Mono::Interop::MonoPInvokeCallbackAttribute {
    ...
    const NAMESPACE: &'static str = "Mono.Interop";
...
#[cfg(feature = "Mono+Interop+MonoPInvokeCallbackAttribute")]
impl crate::Mono::Interop::MonoPInvokeCallbackAttribute {
    pub fn New(
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Interop::MonoPInvokeCallbackAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Interop::MonoPInvokeCallbackAttribute as
