...
impl crate::Mono::RuntimeClassHandle {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::RuntimeClassHandle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::RuntimeClassHandle as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::RuntimeClassHandle as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::RuntimeClassHandle as quest_hook::libil2cpp::Type >
                    ::class(), "GetTypeFromClass", 1usize
                )
            });
        let __cordl_ret: crate::System::IntPtr = unsafe {
            method.invoke_unchecked((), (klass))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetTypeHandle(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::RuntimeClassHandle as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), crate::System::RuntimeTypeHandle, 0usize>("GetTypeHandle")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::RuntimeClassHandle as quest_hook::libil2cpp::Type >
                    ::class(), "GetTypeHandle", 0usize
                )
            });
