...
for crate::Mono::Net::Security::MonoSslClientAuthenticationOptions {
    ...
    const CLASS_NAME: &'static str = "MonoSslClientAuthenticationOptions";
...
impl crate::Mono::Net::Security::MonoSslClientAuthenticationOptions {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Net::Security::MonoSslClientAuthenticationOptions as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Net::Security::MonoSslClientAuthenticationOptions as
