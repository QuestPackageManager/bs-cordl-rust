...
#[cfg(feature = "cordl_class_Mono+Net+Security+BufferOffsetSize2")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Net::Security::BufferOffsetSize2 {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), quest_hook::libil2cpp::Void, 3usize>("AppendData")
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_Mono+Net+Security+BufferOffsetSize2")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Net::Security::BufferOffsetSize2 {
