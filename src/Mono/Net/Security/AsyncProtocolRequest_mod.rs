#[cfg(feature = "cordl_class_Mono+Net+Security+AsyncProtocolRequest")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Mono+Net+Security+AsyncProtocolRequest")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Net::Security::AsyncProtocolRequest {
...
impl crate::Mono::Net::Security::AsyncProtocolRequest {
    ...
    pub fn RequestWrite(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Mono+Net+Security+AsyncProtocolRequest")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Net::Security::AsyncProtocolRequest {
