...
impl crate::Mono::Net::Security::SystemCertificateValidator {
    pub fn NeedsChain(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Net::Security::SystemCertificateValidator as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Net::Security::SystemCertificateValidator as
                    quest_hook::libil2cpp::Type > ::class(), "NeedsChain", 1usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked((), (settings))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "Mono+Net+Security+SystemCertificateValidator")]
