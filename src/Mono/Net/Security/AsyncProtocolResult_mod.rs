...
impl crate::Mono::Net::Security::AsyncProtocolResult {
    ...
    pub fn _ctor_ExceptionDispatchInfo1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Net::Security::AsyncProtocolResult as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Net::Security::AsyncProtocolResult as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Net::Security::AsyncProtocolResult as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Net::Security::AsyncProtocolResult as
                    quest_hook::libil2cpp::Type > ::class(), "get_UserResult", 0usize
                )
            });
