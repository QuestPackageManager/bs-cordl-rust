...
impl crate::Mono::Net::Security::AsyncReadRequest {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Net::Security::AsyncReadRequest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (crate::Mono::Net::Security::AsyncOperationStatus),
                crate::Mono::Net::Security::AsyncOperationStatus,
                1usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Net::Security::AsyncReadRequest as
