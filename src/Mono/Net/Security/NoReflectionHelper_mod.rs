...
for crate::Mono::Net::Security::NoReflectionHelper {
    ...
    const CLASS_NAME: &'static str = "NoReflectionHelper";
...
impl crate::Mono::Net::Security::NoReflectionHelper {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Net::Security::NoReflectionHelper as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Net::Security::NoReflectionHelper as
