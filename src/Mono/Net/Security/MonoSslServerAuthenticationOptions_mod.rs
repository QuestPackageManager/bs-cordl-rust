#[cfg(feature = "cordl_class_Mono+Net+Security+MonoSslServerAuthenticationOptions")]
#[repr(C)]
...
pub struct MonoSslServerAuthenticationOptions {
    ...
    pub _Options_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::System::Net::Security::SslServerAuthenticationOptions>,
}
#[cfg(feature = "cordl_class_Mono+Net+Security+MonoSslServerAuthenticationOptions")]
...
#[cfg(feature = "Mono+Net+Security+MonoSslServerAuthenticationOptions")]
impl std::ops::DerefMut for crate::Mono::Net::Security::MonoSslServerAuthenticationOptions {
...
impl crate::Mono::Net::Security::MonoSslServerAuthenticationOptions {
    ...
    pub fn get_ClientCertificateRequired(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
