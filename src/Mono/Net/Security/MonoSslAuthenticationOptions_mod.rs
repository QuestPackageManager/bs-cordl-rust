#[cfg(feature = "cordl_class_Mono+Net+Security+MonoSslAuthenticationOptions")]
#[repr(C)]
#[derive(Debug)]
pub struct MonoSslAuthenticationOptions {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _ServerCertSelectionDelegate_k__BackingField:
        quest_hook::libil2cpp::Gc<crate::System::Net::Security::ServerCertSelectionCallback>,
}
#[cfg(feature = "cordl_class_Mono+Net+Security+MonoSslAuthenticationOptions")]
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_ServerCertSelectionDelegate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
