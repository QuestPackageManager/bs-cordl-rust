#[cfg(feature = "cordl_class_Mono+X509PalImpl")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Mono::X509PalImpl {
    ...
    > {
        ...
        let __cordl_ret: crate::System::Security::Cryptography::X509Certificates::X509ContentType =
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Security::Cryptography::X509Certificates::X509Certificate2Impl,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (data, password, keyStorageFlags))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_type, data))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_SupportsLegacyBasicConstraintsExtension(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_SupportsLegacyBasicConstraintsExtension")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
