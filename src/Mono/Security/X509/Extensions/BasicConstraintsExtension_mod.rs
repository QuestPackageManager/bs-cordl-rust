...
impl std::ops::Deref for crate::Mono::Security::X509::Extensions::BasicConstraintsExtension {
...
#[cfg(feature = "Mono+Security+X509+Extensions+BasicConstraintsExtension")]
impl std::ops::DerefMut for crate::Mono::Security::X509::Extensions::BasicConstraintsExtension {
...
impl crate::Mono::Security::X509::Extensions::BasicConstraintsExtension {
    pub fn Decode(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
    ...
    pub fn Encode(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
