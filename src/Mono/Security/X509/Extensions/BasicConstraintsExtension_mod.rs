...
impl crate::Mono::Security::X509::Extensions::BasicConstraintsExtension {
    pub fn Decode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::X509::Extensions::BasicConstraintsExtension as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Decode")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Security::X509::Extensions::BasicConstraintsExtension
                    as quest_hook::libil2cpp::Type > ::class(), "Decode", 0usize
                )
            });
