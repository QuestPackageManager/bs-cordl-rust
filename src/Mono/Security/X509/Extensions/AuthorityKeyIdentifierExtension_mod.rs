#[cfg(feature = "cordl_class_Mono+Security+X509+Extensions+AuthorityKeyIdentifierExtension")]
#[repr(C)]
...
impl std::ops::Deref for crate::Mono::Security::X509::Extensions::AuthorityKeyIdentifierExtension {
