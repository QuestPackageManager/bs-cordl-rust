#[cfg(feature = "cordl_class_Mono+Security+X509+X509Store")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Mono::Security::X509::X509Store {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Mono::Security::X509::X509CertificateCollection,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (storeName))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CheckStore(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (path, throwException))? };
        Ok(__cordl_ret.into())
    }
    pub fn Load(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "LoadCrl",
                            1usize
                        )
                    })
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (path, crl, newFormat))? };
        Ok(__cordl_ret.into())
    }
