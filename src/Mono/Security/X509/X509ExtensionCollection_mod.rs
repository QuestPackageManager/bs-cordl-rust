...
#[cfg(feature = "cordl_class_Mono+Security+X509+X509ExtensionCollection")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::X509::X509ExtensionCollection {
...
impl crate::Mono::Security::X509::X509ExtensionCollection {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509Extension> =
            unsafe { cordl_method_info.invoke_unchecked(self, (oid))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Mono+Security+X509+X509ExtensionCollection")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Security::X509::X509ExtensionCollection {
