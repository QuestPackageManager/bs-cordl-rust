...
impl crate::Mono::Security::X509::SafeBag {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::X509::SafeBag as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Security::X509::SafeBag as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 2usize
                )
            });
