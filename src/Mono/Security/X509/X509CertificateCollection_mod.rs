...
#[cfg(feature = "cordl_class_Mono+Security+X509+X509CertificateCollection")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::X509::X509CertificateCollection {
...
impl crate::Mono::Security::X509::X509CertificateCollection {
    #[cfg(feature = "Mono+Security+X509+X509CertificateCollection+X509CertificateEnumerator")]
    pub type X509CertificateEnumerator =
        crate::Mono::Security::X509::X509CertificateCollection_X509CertificateEnumerator;
    pub fn Add(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509Certificate>,
    ...
    pub fn AddRange(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509CertificateCollection>,
...
#[cfg(feature = "cordl_class_Mono+Security+X509+X509CertificateCollection")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Security::X509::X509CertificateCollection {
...
impl crate::Mono::Security::X509::X509CertificateCollection_X509CertificateEnumerator {
    ...
    pub fn New(
        mappings: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509CertificateCollection>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mappings))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
        &mut self,
