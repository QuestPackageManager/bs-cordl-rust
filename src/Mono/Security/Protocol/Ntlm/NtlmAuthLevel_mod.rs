...
#[cfg(feature = "cordl_class_Mono+Security+Protocol+Ntlm+NtlmAuthLevel")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::Protocol::Ntlm::NtlmAuthLevel {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Mono.Security.Protocol.Ntlm";
    const CLASS_NAME: &'static str = "NtlmAuthLevel";
...
#[cfg(feature = "cordl_class_Mono+Security+Protocol+Ntlm+NtlmAuthLevel")]
unsafe impl quest_hook::libil2cpp::Return for crate::Mono::Security::Protocol::Ntlm::NtlmAuthLevel {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
