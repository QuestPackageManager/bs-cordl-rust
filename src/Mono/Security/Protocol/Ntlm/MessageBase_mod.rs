#[cfg(feature = "cordl_class_Mono+Security+Protocol+Ntlm+MessageBase")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Mono+Security+Protocol+Ntlm+MessageBase")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::Protocol::Ntlm::MessageBase {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Security.Protocol.Ntlm";
    const CLASS_NAME: &'static str = "MessageBase";
...
impl crate::Mono::Security::Protocol::Ntlm::MessageBase {
    ...
    pub fn New(messageType: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "PrepareMessage", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>> =
            unsafe { cordl_method_info.invoke_unchecked(self, (messageSize))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (messageType))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Flags(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Mono::Security::Protocol::Ntlm::NtlmFlags> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Mono::Security::Protocol::Ntlm::NtlmFlags, 0usize>(
                        "get_Flags",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Mono::Security::Protocol::Ntlm::NtlmFlags =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Mono+Security+Protocol+Ntlm+MessageBase")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Security::Protocol::Ntlm::MessageBase {
