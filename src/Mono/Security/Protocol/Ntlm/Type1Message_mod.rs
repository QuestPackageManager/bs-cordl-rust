...
for crate::Mono::Security::Protocol::Ntlm::Type1Message {
    ...
    const CLASS_NAME: &'static str = "Type1Message";
...
impl crate::Mono::Security::Protocol::Ntlm::Type1Message {
    pub fn Decode(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Protocol::Ntlm::Type1Message as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Security::Protocol::Ntlm::Type1Message as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Protocol::Ntlm::Type1Message as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Security::Protocol::Ntlm::Type1Message as
                    quest_hook::libil2cpp::Type > ::class(), "set_Host", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
