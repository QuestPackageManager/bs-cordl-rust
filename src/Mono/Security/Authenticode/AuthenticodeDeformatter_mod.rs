...
pub struct AuthenticodeDeformatter {
    ...
    pub coll: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509CertificateCollection>,
    pub signedHash: quest_hook::libil2cpp::Gc<crate::Mono::Security::ASN1>,
    pub timestamp: crate::System::DateTime,
    pub signingCertificate: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509Certificate>,
    pub reason: i32,
    ...
    pub timestampChain: quest_hook::libil2cpp::Gc<crate::Mono::Security::X509::X509Chain>,
}
#[cfg(feature = "cordl_class_Mono+Security+Authenticode+AuthenticodeDeformatter")]
    ...
    for crate::Mono::Security::Authenticode::AuthenticodeDeformatter
{
    ...
    const CLASS_NAME: &'static str = "AuthenticodeDeformatter";
...
#[cfg(feature = "Mono+Security+Authenticode+AuthenticodeDeformatter")]
impl std::ops::DerefMut for crate::Mono::Security::Authenticode::AuthenticodeDeformatter {
...
impl crate::Mono::Security::Authenticode::AuthenticodeDeformatter {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("CheckSignature")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn CompareIssuerSerial(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), bool, 3usize>("CompareIssuerSerial")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (issuer, serial, x509))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn VerifyCounterSignature(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                    ), bool, 2usize>("VerifyCounterSignature")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (cs, signature))? };
        Ok(__cordl_ret.into())
    }
    pub fn VerifySignature(
        &mut self,
        sd: quest_hook::libil2cpp::Gc<crate::Mono::Security::PKCS7_SignedData>,
        calculatedMessageDigest: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        ha: quest_hook::libil2cpp::Gc<crate::System::Security::Cryptography::HashAlgorithm>,
    ) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::Mono::Security::PKCS7_SignedData>,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        quest_hook::libil2cpp::Gc<
                            crate::System::Security::Cryptography::HashAlgorithm,
                        >,
                    ), bool, 3usize>("VerifySignature")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (sd, calculatedMessageDigest, ha))? };
        Ok(__cordl_ret.into())
    }
