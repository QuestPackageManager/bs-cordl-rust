...
#[cfg(feature = "cordl_class_Mono+Security+ASN1")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::ASN1 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Security";
    const CLASS_NAME: &'static str = "ASN1";
...
impl crate::Mono::Security::ASN1 {
    pub fn Add(
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Mono::Security::ASN1>> {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Mono::Security::ASN1> =
            unsafe { cordl_method_info.invoke_unchecked(self, (asn1))? };
        Ok(__cordl_ret.into())
    }
    pub fn CompareArray(
        &mut self,
    ...
    pub fn Decode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (asn1, anPos, anLength))? };
        Ok(__cordl_ret.into())
    }
    pub fn DecodeTLV(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        >,
                    ), quest_hook::libil2cpp::Void, 5usize>("DecodeTLV")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (asn1, pos, tag, length, content))? };
        Ok(__cordl_ret.into())
    }
    pub fn Element(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Element",
                            2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Mono::Security::ASN1> =
            unsafe { cordl_method_info.invoke_unchecked(self, (index, anTag))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetBytes(
        &mut self,
    ...
    pub fn New_u8_0(tag: u8) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
    ...
    pub fn _ctor_u8_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tag))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_u8_Il2CppArray1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (tag, data))? };
        Ok(__cordl_ret.into())
    }
