...
for crate::Mono::Security::Cryptography::RSAManaged {
    ...
    const CLASS_NAME: &'static str = "RSAManaged";
...
impl crate::Mono::Security::Cryptography::RSAManaged {
    ...
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Cryptography::RSAManaged as quest_hook::libil2cpp::Type>::class()
            .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Security::Cryptography::RSAManaged as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Cryptography::RSAManaged as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Security::Cryptography::RSAManaged as
                    quest_hook::libil2cpp::Type > ::class(), "GetPaddedValue", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe { method.invoke_unchecked(self, (value, length))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn _ctor_i32_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (keySize))?
        };
        Ok(__cordl_ret.into())
    }
...
for crate::Mono::Security::Cryptography::RSAManaged_KeyGeneratedEventHandler {
    ...
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Security.Cryptography";
    const CLASS_NAME: &'static str = "RSAManaged/KeyGeneratedEventHandler";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class().is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
    fn matches_value_argument(_: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::Mono::Security::Cryptography::RSAManaged_KeyGeneratedEventHandler {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Cryptography::RSAManaged_KeyGeneratedEventHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
