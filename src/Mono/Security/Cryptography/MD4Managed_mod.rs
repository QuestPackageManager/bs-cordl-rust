...
impl crate::Mono::Security::Cryptography::MD4Managed {
    pub fn Decode(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (output, input, index))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Encode(
    ...
    pub fn HashCore(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (array, ibStart, cbSize))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn HashFinal(
    ...
    pub fn MD4Transform(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (state, block, index))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "ROL",
                            2usize
                        )
                    })
            });
