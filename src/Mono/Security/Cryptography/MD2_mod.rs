...
#[cfg(feature = "Mono+Security+Cryptography+MD2")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::Cryptography::MD2 {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Security.Cryptography";
    const CLASS_NAME: &'static str = "MD2";
...
impl crate::Mono::Security::Cryptography::MD2 {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Cryptography::MD2 as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Mono::Security::Cryptography::MD2>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Security::Cryptography::MD2 as
