...
#[cfg(feature = "cordl_class_Mono+Security+Cryptography+MD2Managed")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::Cryptography::MD2Managed {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Security.Cryptography";
    const CLASS_NAME: &'static str = "MD2Managed";
...
impl crate::Mono::Security::Cryptography::MD2Managed {
    ...
    pub fn MD2Transform(
        &mut self,
        state: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        i32,
                    ), quest_hook::libil2cpp::Void, 4usize>("MD2Transform")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (state, checksum, block, index))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Mono+Security+Cryptography+MD2Managed")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Security::Cryptography::MD2Managed {
