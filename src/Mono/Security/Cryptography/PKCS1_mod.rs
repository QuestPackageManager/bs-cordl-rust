...
impl crate::Mono::Security::Cryptography::PKCS1 {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<u8>,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (hash, hashValue, emLength))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn I2OSP(
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "I2OSP",
                            2usize
                        )
                    })
            });
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "RSAVP1",
                            2usize
                        )
                    })
            });
    ...
    pub fn Verify_v15_HashAlgorithm0(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (rsa, hash, hashValue, signature))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Verify_v15_Il2CppString1(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked((), (rsa, hashName, hashValue, signature))?
        };
        Ok(__cordl_ret.into())
    }
}
