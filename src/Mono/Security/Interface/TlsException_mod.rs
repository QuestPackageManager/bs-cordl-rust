...
#[cfg(feature = "cordl_class_Mono+Security+Interface+TlsException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::Interface::TlsException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Security.Interface";
    const CLASS_NAME: &'static str = "TlsException";
...
impl crate::Mono::Security::Interface::TlsException {
    ...
    pub fn _ctor_Alert0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::Mono::Security::Interface::Alert>,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (alert, message))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AlertDescription1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (description, message))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Mono+Security+Interface+TlsException")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Security::Interface::TlsException {
