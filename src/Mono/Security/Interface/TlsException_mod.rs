...
impl crate::Mono::Security::Interface::TlsException {
    ...
    pub fn _ctor_Alert0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Interface::TlsException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Security::Interface::TlsException as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (alert, message))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_AlertDescription1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (description, message))?
        };
        Ok(__cordl_ret.into())
    }
}
