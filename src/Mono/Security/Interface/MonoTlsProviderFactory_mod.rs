...
impl crate::Mono::Security::Interface::MonoTlsProviderFactory {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Interface::MonoTlsProviderFactory as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Security::Interface::MonoTlsProviderFactory as
