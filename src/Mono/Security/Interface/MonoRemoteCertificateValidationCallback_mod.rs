#[cfg(feature = "cordl_class_Mono+Security+Interface+MonoRemoteCertificateValidationCallback")]
#[repr(C)]
...
impl std::ops::Deref for crate::Mono::Security::Interface::MonoRemoteCertificateValidationCallback {
...
impl crate::Mono::Security::Interface::MonoRemoteCertificateValidationCallback {
    pub fn Invoke(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (targetHost, certificate, chain, sslPolicyErrors))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
