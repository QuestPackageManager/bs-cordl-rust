...
#[cfg(feature = "cordl_class_Mono+Security+Interface+AlertDescription")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Security::Interface::AlertDescription {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_Mono+Security+Interface+AlertDescription")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Mono::Security::Interface::AlertDescription {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Mono+Security+Interface+AlertDescription")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Mono::Security::Interface::AlertDescription {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Mono+Security+Interface+AlertDescription")]
unsafe impl quest_hook::libil2cpp::Return for crate::Mono::Security::Interface::AlertDescription {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
