...
pub struct MonoTlsConnectionInfo {
    ...
    pub _PeerDomainName_k__BackingField:
...
impl crate::Mono::Security::Interface::MonoTlsConnectionInfo {
    ...
    pub fn get_CipherSuiteCode(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Mono::Security::Interface::CipherSuiteCode> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Mono::Security::Interface::CipherSuiteCode, 0usize>(
                        "get_CipherSuiteCode",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Mono::Security::Interface::CipherSuiteCode =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_ProtocolVersion(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Mono::Security::Interface::TlsProtocols, 0usize>(
                        "get_ProtocolVersion",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_Mono+Security+Interface+MonoTlsConnectionInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Security::Interface::MonoTlsConnectionInfo {
