#[cfg(feature = "cordl_class_Mono+Security+Interface+MonoLocalCertificateSelectionCallback")]
#[repr(C)]
...
impl std::ops::Deref for crate::Mono::Security::Interface::MonoLocalCertificateSelectionCallback {
