...
for crate::Mono::Security::Interface::MonoLocalCertificateSelectionCallback {
    ...
    const CLASS_NAME: &'static str = "MonoLocalCertificateSelectionCallback";
...
impl crate::Mono::Security::Interface::MonoLocalCertificateSelectionCallback {
    pub fn Invoke(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Security::Interface::MonoLocalCertificateSelectionCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    quest_hook::libil2cpp::Gc<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Mono::Security::Interface::MonoLocalCertificateSelectionCallback as
