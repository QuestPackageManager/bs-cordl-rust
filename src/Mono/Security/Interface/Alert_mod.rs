...
impl crate::Mono::Security::Interface::Alert {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (description))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Description(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Mono::Security::Interface::AlertDescription, 0usize>(
                        "get_Description",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn get_Level(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Mono::Security::Interface::AlertLevel, 0usize>(
                        "get_Level",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Mono::Security::Interface::AlertLevel =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
