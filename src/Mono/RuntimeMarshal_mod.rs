#[cfg(feature = "cordl_class_Mono+RuntimeMarshal")]
#[repr(C)]
...
impl crate::Mono::RuntimeMarshal {
    ...
    pub fn DecodeBlobSize(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (in_ptr, out_ptr))? };
        Ok(__cordl_ret.into())
    }
    pub fn FreeAssemblyName(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("FreeAssemblyName")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (name, freeStruct))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "MarshalString", 1usize
                        )
                    })
            });
        let __cordl_ret: crate::Mono::SafeStringMarshal =
