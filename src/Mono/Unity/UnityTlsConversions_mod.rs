#[cfg(feature = "cordl_class_Mono+Unity+UnityTlsConversions")]
#[repr(C)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "VerifyResultToChainStatus", 1usize
                        )
                    })
            });
