...
impl crate::Mono::Unity::UnityTlsContext {
    ...
    pub fn ReadCallback_Il2CppObject_IntPtr_Il2CppObject0(
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info
                .invoke_unchecked((), (userData, buffer, bufferLen, errorState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadCallback_IntPtr_Il2CppObject1(
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked(self, (buffer, bufferLen, errorState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Renegotiate(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "VerifyCallback", 3usize
                        )
                    })
            });
        let __cordl_ret: crate::Mono::Unity::UnityTls_unitytls_x509verify_result = unsafe {
            cordl_method_info.invoke_unchecked((), (userData, chain, errorState))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "VerifyCallback", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::Mono::Unity::UnityTls_unitytls_x509verify_result = unsafe {
            cordl_method_info.invoke_unchecked(self, (chain, errorState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteCallback", 4usize
                        )
                    })
            });
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info
                .invoke_unchecked((), (userData, data, bufferLen, errorState))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "WriteCallback", 3usize
                        )
                    })
            });
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked(self, (data, bufferLen, errorState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (parent, options))?
        };
        Ok(__cordl_ret.into())
    }
