...
pub struct UnityTlsContext {
    ...
    pub requestedClientCertChain: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    pub requestedClientKey: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    pub readCallback:
        quest_hook::libil2cpp::Gc<crate::Mono::Unity::UnityTls_unitytls_tlsctx_read_callback>,
    pub writeCallback:
        quest_hook::libil2cpp::Gc<crate::Mono::Unity::UnityTls_unitytls_tlsctx_write_callback>,
    pub certificateCallback: quest_hook::libil2cpp::Gc<
        crate::Mono::Unity::UnityTls_unitytls_tlsctx_certificate_callback,
    >,
    pub verifyCallback:
        quest_hook::libil2cpp::Gc<crate::Mono::Unity::UnityTls_unitytls_tlsctx_x509verify_callback>,
    ...
    >,
    pub connectioninfo:
        quest_hook::libil2cpp::Gc<crate::Mono::Security::Interface::MonoTlsConnectionInfo>,
...
impl crate::Mono::Unity::UnityTlsContext {
    ...
    pub fn ExtractNativeKeyAndChainFromManagedCertificate(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (cert, errorState, nativeCertChain, nativeKey))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn FinishHandshake(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FinishHandshake")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), crate::System::ValueTuple_2<i32, bool>, 3usize>("Read")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ReadCallback_Il2CppObject_IntPtr_Il2CppObject0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::System::IntPtr, 4usize>("ReadCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked((), (userData, buffer, bufferLen, errorState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ReadCallback_IntPtr_Il2CppObject1(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::System::IntPtr,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::System::IntPtr, 3usize>("ReadCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked(self, (buffer, bufferLen, errorState))? };
        Ok(__cordl_ret.into())
    }
    pub fn Renegotiate(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Renegotiate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn StartHandshake(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("StartHandshake")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    ) -> quest_hook::libil2cpp::Result<crate::Mono::Unity::UnityTls_unitytls_x509verify_result>
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::Mono::Unity::UnityTls_unitytls_x509verify_result, 3usize>(
                        "VerifyCallback",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Mono::Unity::UnityTls_unitytls_x509verify_result =
            unsafe { cordl_method_info.invoke_unchecked((), (userData, chain, errorState))? };
        Ok(__cordl_ret.into())
    }
    ...
    ) -> quest_hook::libil2cpp::Result<crate::Mono::Unity::UnityTls_unitytls_x509verify_result>
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::Mono::Unity::UnityTls_unitytls_x509list_ref,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::Mono::Unity::UnityTls_unitytls_x509verify_result, 2usize>(
                        "VerifyCallback",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Mono::Unity::UnityTls_unitytls_x509verify_result =
            unsafe { cordl_method_info.invoke_unchecked(self, (chain, errorState))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                        i32,
                    ), crate::System::ValueTuple_2<i32, bool>, 3usize>("Write")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn WriteCallback_Il2CppObject_IntPtr_Il2CppObject0(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::System::IntPtr,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::System::IntPtr, 4usize>("WriteCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked((), (userData, data, bufferLen, errorState))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn WriteCallback_IntPtr_Il2CppObject1(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::System::IntPtr,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                    ), crate::System::IntPtr, 3usize>("WriteCallback")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked(self, (data, bufferLen, errorState))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (parent, options))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Security::Cryptography::X509Certificates::X509Certificate,
                    >, 0usize>("get_LocalClientCertificate")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
