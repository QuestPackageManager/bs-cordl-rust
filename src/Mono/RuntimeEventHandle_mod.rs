...
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::RuntimeEventHandle {
    ...
    const CLASS_NAME: &'static str = "RuntimeEventHandle";
...
impl crate::Mono::RuntimeEventHandle {
    pub fn Equals(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::RuntimeEventHandle as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::RuntimeEventHandle as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
