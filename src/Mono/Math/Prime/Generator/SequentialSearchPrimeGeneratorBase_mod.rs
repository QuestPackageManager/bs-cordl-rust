...
impl std::ops::Deref for crate::Mono::Math::Prime::Generator::SequentialSearchPrimeGeneratorBase {
...
impl crate::Mono::Math::Prime::Generator::SequentialSearchPrimeGeneratorBase {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Mono::Math::BigInteger>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Mono::Math::BigInteger> =
            unsafe { cordl_method_info.invoke_unchecked(self, (bits, context))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsPrimeAcceptable(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (bi, context))? };
        Ok(__cordl_ret.into())
    }
