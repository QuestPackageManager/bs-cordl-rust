...
impl crate::Mono::Math::Prime::Generator::PrimeGeneratorBase {
    ...
    pub fn get_Confidence(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Mono::Math::Prime::ConfidenceFactor, 0usize>(
                        "get_Confidence",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Mono::Math::Prime::ConfidenceFactor =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Mono::Math::Prime::PrimalityTest> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Mono+Math+Prime+Generator+PrimeGeneratorBase")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Math::Prime::Generator::PrimeGeneratorBase {
