...
#[cfg(feature = "Mono+Math+Prime+PrimalityTest")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Math::Prime::PrimalityTest {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Mono.Math.Prime";
    const CLASS_NAME: &'static str = "PrimalityTest";
...
impl crate::Mono::Math::Prime::PrimalityTest {
    pub fn Invoke(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Math::Prime::PrimalityTest as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Math::Prime::PrimalityTest as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 2usize
                )
            });
        let __cordl_ret: bool = unsafe {
            method.invoke_unchecked(self, (bi, confidence))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
