...
#[cfg(feature = "Mono+SafeStringMarshal")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::SafeStringMarshal {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Mono";
    const CLASS_NAME: &'static str = "SafeStringMarshal";
...
#[cfg(feature = "Mono+SafeStringMarshal")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Mono::SafeStringMarshal {
    type Type = Self;
...
#[cfg(feature = "Mono+SafeStringMarshal")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Mono::SafeStringMarshal {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "Mono+SafeStringMarshal")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Mono::SafeStringMarshal {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "Mono+SafeStringMarshal")]
unsafe impl quest_hook::libil2cpp::Return for crate::Mono::SafeStringMarshal {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::Mono::SafeStringMarshal {
    pub fn Dispose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::SafeStringMarshal as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Dispose")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::SafeStringMarshal as quest_hook::libil2cpp::Type >
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::SafeStringMarshal as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::SafeStringMarshal as quest_hook::libil2cpp::Type >
                    ::class(), "StringToUtf8_icall", 1usize
                )
            });
        let __cordl_ret: crate::System::IntPtr = unsafe {
            method.invoke_unchecked((), (str))?
