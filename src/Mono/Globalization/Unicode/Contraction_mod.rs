...
#[cfg(feature = "cordl_class_Mono+Globalization+Unicode+Contraction")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::Globalization::Unicode::Contraction {
...
impl crate::Mono::Globalization::Unicode::Contraction {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (index, source, replacement, sortkey))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Mono+Globalization+Unicode+Contraction")]
impl quest_hook::libil2cpp::ObjectType for crate::Mono::Globalization::Unicode::Contraction {
