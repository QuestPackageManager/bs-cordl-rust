...
impl crate::Mono::Globalization::Unicode::Contraction {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Globalization::Unicode::Contraction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    i32,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Mono::Globalization::Unicode::Contraction as
