...
impl crate::Mono::Globalization::Unicode::Level2Map {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Mono::Globalization::Unicode::Level2Map as quest_hook::libil2cpp::Type>::class()
            .find_method::<(u8, u8), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Mono::Globalization::Unicode::Level2Map as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (source, replace))?
        };
        Ok(__cordl_ret.into())
    }
}
