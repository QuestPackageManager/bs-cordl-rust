#[cfg(feature = "cordl_class_Mono+CertificateImportFlags")]
...
#[cfg(feature = "cordl_class_Mono+CertificateImportFlags")]
unsafe impl quest_hook::libil2cpp::Type for crate::Mono::CertificateImportFlags {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Mono";
    const CLASS_NAME: &'static str = "CertificateImportFlags";
