...
unsafe impl quest_hook::libil2cpp::Type for crate::StyledUITemplates::OverridableInt {
    ...
    const CLASS_NAME: &'static str = "OverridableInt";
...
impl crate::StyledUITemplates::OverridableInt {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::StyledUITemplates::OverridableInt as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::StyledUITemplates::OverridableInt as
