...
#[cfg(feature = "cordl_class_BeatmapSaveDataCommon+DistributionParamType")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataCommon::DistributionParamType {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_BeatmapSaveDataCommon+DistributionParamType")]
unsafe impl quest_hook::libil2cpp::Return for crate::BeatmapSaveDataCommon::DistributionParamType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
