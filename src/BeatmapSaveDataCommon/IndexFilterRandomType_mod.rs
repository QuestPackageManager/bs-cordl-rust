...
#[cfg(feature = "cordl_class_BeatmapSaveDataCommon+IndexFilterRandomType")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataCommon::IndexFilterRandomType {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_BeatmapSaveDataCommon+IndexFilterRandomType")]
unsafe impl quest_hook::libil2cpp::Return for crate::BeatmapSaveDataCommon::IndexFilterRandomType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
