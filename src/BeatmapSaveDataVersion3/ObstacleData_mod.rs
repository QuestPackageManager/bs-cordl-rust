...
for crate::BeatmapSaveDataVersion3::ObstacleData {
...
impl crate::BeatmapSaveDataVersion3::ObstacleData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapSaveDataVersion3::ObstacleData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (f32, i32, i32, f32, i32, i32),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapSaveDataVersion3::ObstacleData as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 6usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (beat, line, layer, duration, width, height))?
        };
        Ok(__cordl_ret.into())
    }
