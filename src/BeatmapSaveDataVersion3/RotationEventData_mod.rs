...
impl crate::BeatmapSaveDataVersion3::RotationEventData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapSaveDataVersion3::RotationEventData as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapSaveDataVersion3::RotationEventData as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapSaveDataVersion3::RotationEventData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatmapSaveDataVersion3::RotationEventData as
                    quest_hook::libil2cpp::Type > ::class(), "get_executionTime", 0usize
                )
            });
