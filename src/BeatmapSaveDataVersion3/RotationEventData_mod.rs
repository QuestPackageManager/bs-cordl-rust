...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+RotationEventData")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataVersion3::RotationEventData {
...
impl crate::BeatmapSaveDataVersion3::RotationEventData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (beat, executionTime, rotation))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_executionTime(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatmapSaveDataCommon::ExecutionTime, 0usize>(
                        "get_executionTime",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatmapSaveDataCommon::ExecutionTime =
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+RotationEventData")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatmapSaveDataVersion3::RotationEventData {
