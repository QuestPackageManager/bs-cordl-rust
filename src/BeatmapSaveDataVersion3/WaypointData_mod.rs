#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+WaypointData")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+WaypointData")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataVersion3::WaypointData {
...
impl crate::BeatmapSaveDataVersion3::WaypointData {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (beat, line, layer, offsetDirection))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn get_offsetDirection(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatmapSaveDataCommon::OffsetDirection, 0usize>(
                        "get_offsetDirection",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatmapSaveDataCommon::OffsetDirection =
