...
impl crate::BeatmapSaveDataVersion3::LightColorEventBoxGroup {
    pub fn CopyWith(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatmapSaveDataVersion3::LightColorEventBoxGroup as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatmapSaveDataVersion3::LightColorEventBoxGroup as
