#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+LightColorBaseData")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+LightColorBaseData")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataVersion3::LightColorBaseData {
...
impl crate::BeatmapSaveDataVersion3::LightColorBaseData {
    ...
    pub fn get_colorType(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::BeatmapSaveDataCommon::EnvironmentColorType> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatmapSaveDataCommon::EnvironmentColorType, 0usize>(
                        "get_colorType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatmapSaveDataCommon::EnvironmentColorType =
    ...
    pub fn get_transitionType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatmapSaveDataVersion3::TransitionType, 0usize>(
                        "get_transitionType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatmapSaveDataVersion3::TransitionType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion3+LightColorBaseData")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatmapSaveDataVersion3::LightColorBaseData {
