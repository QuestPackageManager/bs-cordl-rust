#[cfg(feature = "cordl_class_Zenject+LazyInject_1")]
#[repr(C)]
#[derive(Debug)]
...
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref for crate::Zenject::LazyInject_1<T> {
...
#[cfg(feature = "Zenject+LazyInject_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::Zenject::LazyInject_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::Zenject::LazyInject_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (container, context))? };
        Ok(__cordl_ret.into())
    }
