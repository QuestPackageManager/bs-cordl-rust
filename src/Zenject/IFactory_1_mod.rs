...
for crate::Zenject::IFactory_1<TValue> {
    ...
    const CLASS_NAME: &'static str = "IFactory`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IFactory`1")
                    .unwrap()
                    .make_generic::<(TValue)>()
                    .unwrap()
                    .unwrap()
...
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::IFactory_1<TValue> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IFactory_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), TValue, 0usize>("Create")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::IFactory_1 < TValue > as quest_hook::libil2cpp::Type
                    > ::class(), "Create", 0usize
                )
            });
