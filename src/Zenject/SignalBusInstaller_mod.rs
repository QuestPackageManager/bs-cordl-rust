...
#[cfg(feature = "Zenject+SignalBusInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::SignalBusInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "SignalBusInstaller";
...
#[cfg(feature = "Zenject+SignalBusInstaller")]
impl std::ops::DerefMut for crate::Zenject::SignalBusInstaller {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Zenject+SignalBusInstaller")]
impl crate::Zenject::SignalBusInstaller {
    pub fn InstallBindings(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SignalBusInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::SignalBusInstaller as quest_hook::libil2cpp::Type >
...
#[cfg(feature = "Zenject+SignalBusInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::SignalBusInstaller {
