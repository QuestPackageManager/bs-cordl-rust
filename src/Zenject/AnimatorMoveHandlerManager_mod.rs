...
#[cfg(feature = "Zenject+AnimatorMoveHandlerManager")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::AnimatorMoveHandlerManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "AnimatorMoveHandlerManager";
...
#[cfg(feature = "Zenject+AnimatorMoveHandlerManager")]
impl crate::Zenject::AnimatorMoveHandlerManager {
    pub fn Construct(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::AnimatorMoveHandlerManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::AnimatorMoveHandlerManager as
                    quest_hook::libil2cpp::Type > ::class(), "Construct", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (handlers))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn OnAnimatorMove(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::AnimatorMoveHandlerManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnAnimatorMove")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::AnimatorMoveHandlerManager as
                    quest_hook::libil2cpp::Type > ::class(), "OnAnimatorMove", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
...
#[cfg(feature = "Zenject+AnimatorMoveHandlerManager")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::AnimatorMoveHandlerManager {
