#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceIdBinder_2")]
#[repr(C)]
...
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "FactoryToChoiceIdBinder`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceIdBinder`2")
                .unwrap()
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Zenject::FactoryArgumentsToChoiceBinder_2<
                                TParam1,
                                TContract,
                            >,
                        >,
