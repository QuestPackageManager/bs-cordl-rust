#[cfg(feature = "cordl_class_Zenject+SignalSubscriptionId")]
...
#[cfg(feature = "cordl_class_Zenject+SignalSubscriptionId")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::Zenject::SignalSubscriptionId {
    type Type = Self;
...
impl crate::Zenject::SignalSubscriptionId {
    ...
    pub fn Equals_SignalSubscriptionId1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::Zenject::SignalSubscriptionId), bool, 1usize>("Equals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (signalId, callback))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Callback(
        &mut self,
...
{
    fn as_ref(&self) -> &crate::System::IEquatable_1<crate::Zenject::SignalSubscriptionId> {
        todo!()
    }
}
#[cfg(feature = "Zenject+SignalSubscriptionId")]
impl AsMut<crate::System::IEquatable_1<crate::Zenject::SignalSubscriptionId>>
    for crate::Zenject::SignalSubscriptionId
{
    fn as_mut(&mut self) -> &mut crate::System::IEquatable_1<crate::Zenject::SignalSubscriptionId> {
        todo!()
    }
}
