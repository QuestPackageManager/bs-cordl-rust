...
for crate::Zenject::PlaceholderFactory_1<TValue> {
    ...
    const CLASS_NAME: &'static str = "PlaceholderFactory`1";
...
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::PlaceholderFactory_1<TValue> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PlaceholderFactory_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PlaceholderFactory_1 < TValue > as
