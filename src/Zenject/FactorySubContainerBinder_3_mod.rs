#[cfg(feature = "cordl_class_Zenject+FactorySubContainerBinder_3")]
#[repr(C)]
    ...
    for crate::Zenject::FactorySubContainerBinder_3<TParam1, TParam2, TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactorySubContainerBinder`3")
                .unwrap()
...
impl<
        ...
        TParam2: quest_hook::libil2cpp::Type,
        TContract: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::FactorySubContainerBinder_3<TParam1, TParam2, TContract>
{
