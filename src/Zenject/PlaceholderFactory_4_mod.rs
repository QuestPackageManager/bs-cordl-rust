    ...
    for crate::Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PlaceholderFactory`4")
                .unwrap()
...
impl<
        ...
        TParam3: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>
{
...
impl<
    ...
    for crate::Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>
{
    fn as_mut(&mut self) -> &mut crate::Zenject::IFactory_4<TParam1, TParam2, TParam3, TValue> {
        unsafe { std::mem::transmute(self) }
    }
}
