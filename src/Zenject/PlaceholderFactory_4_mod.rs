...
impl<
    ...
    TParam3: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> AsRef<quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue>>
for crate::Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue> {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue> {
...
impl<
    ...
    TParam3: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> AsMut<quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue>>
for crate::Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue> {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+PlaceholderFactory_4")]
