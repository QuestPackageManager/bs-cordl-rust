#[cfg(feature = "Zenject+IFactoryProvider_5")]
#[repr(C)]
#[derive(Debug)]
pub struct IFactoryProvider_5<
...
for crate::Zenject::IFactoryProvider_5<TParam1, TParam2, TParam3, TParam4, TContract> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "IFactoryProvider`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IFactoryProvider`5")
                    .unwrap()
...
impl<
    ...
    TParam4: quest_hook::libil2cpp::Type,
    TContract: quest_hook::libil2cpp::Type,
> crate::Zenject::IFactoryProvider_5<TParam1, TParam2, TParam3, TParam4, TContract> {
    ...
    where
        ...
        TContract: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IFactoryProvider_5<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IFactoryProvider_5 < TParam1, TParam2, TParam3,
                    TParam4, TContract > as quest_hook::libil2cpp::Type > ::class(),
