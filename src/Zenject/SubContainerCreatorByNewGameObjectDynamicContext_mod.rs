...
impl std::ops::Deref for crate::Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
...
#[cfg(feature = "Zenject+SubContainerCreatorByNewGameObjectDynamicContext")]
impl std::ops::DerefMut for crate::Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
...
impl crate::Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::UnityEngine::GameObject> =
            unsafe { cordl_method_info.invoke_unchecked(self, (shouldMakeActive))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (container, gameObjectBindInfo))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorByNewGameObjectDynamicContext")]
