...
impl crate::Zenject::InstantiateOnPrefabComponentProvider {
    pub fn GetAllInstancesWithInjectSplit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::InstantiateOnPrefabComponentProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::InstantiateOnPrefabComponentProvider as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (componentType, prefabInstantiator))?
        };
        Ok(__cordl_ret.into())
    }
