...
pub struct GuiRenderer {
    ...
    pub _renderableManager: *mut crate::Zenject::GuiRenderableManager,
}
#[cfg(feature = "Zenject+GuiRenderer")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::GuiRenderer => "Zenject"."GuiRenderer"
);
#[cfg(feature = "Zenject+GuiRenderer")]
...
impl crate::Zenject::GuiRenderer {
    ...
    pub fn Construct(
        &mut self,
        renderableManager: *mut crate::Zenject::GuiRenderableManager,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        let __cordl_object: &mut quest_hook::libil2cpp::Il2CppObject = quest_hook::libil2cpp::ObjectType::as_object_mut(
            self,
        );
        let __cordl_ret: quest_hook::libil2cpp::Void = __cordl_object
            .invoke("Construct", (renderableManager))?;
        Ok(__cordl_ret)
    }
