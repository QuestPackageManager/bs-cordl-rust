#[cfg(feature = "cordl_class_Zenject+KeyedFactory_6")]
#[repr(C)]
    ...
    > crate::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TKey, TParam1, TParam2, TParam3, TParam4), TBase, 5usize>(
                        "Create",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: TBase = unsafe {
            cordl_method_info.invoke_unchecked(self, (key, param1, param2, param3, param4))?
        };
        Ok(__cordl_ret.into())
    }
