#[cfg(feature = "Zenject+KeyedFactory_6")]
#[repr(C)]
#[derive(Debug)]
pub struct KeyedFactory_6<
...
for crate::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "KeyedFactory`6";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "KeyedFactory`6")
                    .unwrap()
                    .make_generic::<(TBase, TKey, TParam1, TParam2, TParam3, TParam4)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    TParam3: quest_hook::libil2cpp::Type,
    TParam4: quest_hook::libil2cpp::Type,
> crate::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4> {
    pub fn Create(
        &mut self,
        key: TKey,
        param1: TParam1,
    ...
    where
        ...
        TParam4: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::KeyedFactory_6<
            TBase,
            TKey,
            TParam1,
            TParam2,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (TKey, TParam1, TParam2, TParam3, TParam4),
                TBase,
                5usize,
            >("Create")
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::KeyedFactory_6 < TBase, TKey, TParam1, TParam2,
                    TParam3, TParam4 > as quest_hook::libil2cpp::Type > ::class(),
                    "Create", 5usize
                )
            });
        let __cordl_ret: TBase = unsafe {
            method.invoke_unchecked(self, (key, param1, param2, param3, param4))?
        };
        Ok(__cordl_ret.into())
    }
