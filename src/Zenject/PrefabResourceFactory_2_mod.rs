...
#[repr(C)]
#[derive(Debug)]
pub struct PrefabResourceFactory_2<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
{
    ...
    quest_hook::libil2cpp::Type for crate::Zenject::PrefabResourceFactory_2<P1, T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PrefabResourceFactory`2")
                .unwrap()
                .make_generic::<(P1, T)>()
                .unwrap()
                .unwrap()
    ...
    crate::Zenject::PrefabResourceFactory_2<P1, T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T =
            unsafe { cordl_method_info.invoke_unchecked(self, (prefabResourceName, param))? };
        Ok(__cordl_ret.into())
    }
