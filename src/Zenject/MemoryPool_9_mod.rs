#[cfg(feature = "Zenject+MemoryPool_9")]
#[repr(C)]
#[derive(Debug)]
pub struct MemoryPool_9<
...
for crate::Zenject::MemoryPool_9<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "MemoryPool`9";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MemoryPool`9")
                    .unwrap()
                    .make_generic::<
                        (
                            TParam1,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MemoryPool_9<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MemoryPool_9 < TParam1, TParam2, TParam3, TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MemoryPool_9 < TParam1, TParam2, TParam3, TParam4,
                    TParam5, TParam6, TParam7, TParam8, TValue > as
                    quest_hook::libil2cpp::Type > ::class(), "Spawn", 8usize
                )
            });
    ...
    pub fn Zenject_IFactory_TParam1_TParam2_TParam3_TParam4_TParam5_TParam6_TParam7_TParam8_TValue__Create(
        &mut self,
        p1: TParam1,
        p2: TParam2,
        p3: TParam3,
...
> {
    fn as_mut(
        &mut self,
    ) -> &mut crate::Zenject::IMemoryPool_9<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
