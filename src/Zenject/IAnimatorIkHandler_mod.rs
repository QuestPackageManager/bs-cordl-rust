...
#[cfg(feature = "Zenject+IAnimatorIkHandler")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::IAnimatorIkHandler {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "IAnimatorIkHandler";
...
impl crate::Zenject::IAnimatorIkHandler {
    pub fn OnAnimatorIk(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IAnimatorIkHandler as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("OnAnimatorIk")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::IAnimatorIkHandler as quest_hook::libil2cpp::Type >
                    ::class(), "OnAnimatorIk", 0usize
                )
            });
