...
#[cfg(feature = "Zenject+ResourceProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ResourceProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ResourceProvider";
...
impl crate::Zenject::ResourceProvider {
    pub fn GetAllInstancesWithInjectSplit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ResourceProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ResourceProvider as quest_hook::libil2cpp::Type >
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (resourcePath, resourceType, matchSingle))?
        };
        Ok(__cordl_ret.into())
    }
