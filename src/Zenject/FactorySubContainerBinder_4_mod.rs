...
> crate::Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract> {
    ...
    where
        ...
        TContract: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::FactorySubContainerBinder_4<
            TParam1,
            TParam2,
            TParam3,
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::FactorySubContainerBinder_4 < TParam1, TParam2,
