...
> crate::Zenject::KeyedFactory_2<TBase, TKey> {
    ...
    where
        ...
        TKey: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::KeyedFactory_2<
            TBase,
            TKey,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::KeyedFactory_2 < TBase, TKey > as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 1usize
                )
            });
        let __cordl_ret: TBase = unsafe { method.invoke_unchecked(self, (key))? };
        Ok(__cordl_ret.into())
    }
