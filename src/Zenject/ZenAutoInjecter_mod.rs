#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenAutoInjecter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ZenAutoInjecter";
...
impl crate::Zenject::ZenAutoInjecter {
    ...
    pub fn get_ContainerSource(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Zenject::ZenAutoInjecter_ContainerSources> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Zenject::ZenAutoInjecter_ContainerSources, 0usize>(
                        "get_ContainerSource",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Zenject::ZenAutoInjecter_ContainerSources =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter+ContainerSources")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter+ContainerSources")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenAutoInjecter_ContainerSources {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Zenject";
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter+ContainerSources")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Zenject::ZenAutoInjecter_ContainerSources {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter+ContainerSources")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Zenject::ZenAutoInjecter_ContainerSources {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter+ContainerSources")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Zenject::ZenAutoInjecter_ContainerSources {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Zenject+ZenAutoInjecter+ContainerSources")]
unsafe impl quest_hook::libil2cpp::Return for crate::Zenject::ZenAutoInjecter_ContainerSources {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
