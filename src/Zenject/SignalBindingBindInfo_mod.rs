...
#[cfg(feature = "Zenject+SignalBindingBindInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::SignalBindingBindInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "SignalBindingBindInfo";
...
impl crate::Zenject::SignalBindingBindInfo {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SignalBindingBindInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SignalBindingBindInfo as quest_hook::libil2cpp::Type
                    > ::class(), ".ctor", 1usize
                )
            });
