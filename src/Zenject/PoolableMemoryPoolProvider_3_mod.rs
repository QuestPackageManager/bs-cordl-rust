#[cfg(feature = "Zenject+PoolableMemoryPoolProvider_3")]
#[repr(C)]
#[derive(Debug)]
pub struct PoolableMemoryPoolProvider_3<
...
for crate::Zenject::PoolableMemoryPoolProvider_3<TParam1, TContract, TMemoryPool> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "PoolableMemoryPoolProvider`3";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        "Zenject",
                        "PoolableMemoryPoolProvider`3",
                    )
                    .unwrap()
                    .make_generic::<(TParam1, TContract, TMemoryPool)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    TContract: quest_hook::libil2cpp::Type,
    TMemoryPool: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPoolProvider_3<TParam1, TContract, TMemoryPool> {
    ...
    where
        ...
        TMemoryPool: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPoolProvider_3<
            TParam1,
            TContract,
            TMemoryPool,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPoolProvider_3 < TParam1, TContract,
