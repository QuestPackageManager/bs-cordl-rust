#[cfg(feature = "Zenject+IMemoryPool_9")]
#[repr(C)]
#[derive(Debug)]
pub struct IMemoryPool_9<
...
for crate::Zenject::IMemoryPool_9<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "IMemoryPool`9";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IMemoryPool`9")
                    .unwrap()
                    .make_generic::<
                        (
                            TParam1,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IMemoryPool_9<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IMemoryPool_9 < TParam1, TParam2, TParam3, TParam4,
