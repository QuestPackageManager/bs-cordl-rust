...
pub struct ZenjectSettings {
    ...
    pub _signalSettings: quest_hook::libil2cpp::Gc<crate::Zenject::ZenjectSettings_SignalSettings>,
}
#[cfg(feature = "cordl_class_Zenject+ZenjectSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenjectSettings {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ZenjectSettings";
...
impl crate::Zenject::ZenjectSettings {
    ...
    pub fn New_ValidationErrorResponses_RootResolveMethods__cordl_bool__cordl_bool_ZenjectSettings_SignalSettings0(
        ...
        signalSettings: quest_hook::libil2cpp::Gc<crate::Zenject::ZenjectSettings_SignalSettings>,
    ...
    pub fn _ctor_ValidationErrorResponses_RootResolveMethods__cordl_bool__cordl_bool_ZenjectSettings_SignalSettings0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::Zenject::ValidationErrorResponses,
                        crate::Zenject::RootResolveMethods,
                        bool,
                        bool,
    ...
    pub fn get_DisplayWarningWhenResolvingDuringInstall(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_DisplayWarningWhenResolvingDuringInstall")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::ZenjectSettings_SignalSettings> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_ValidationErrorResponse(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Zenject::ValidationErrorResponses, 0usize>(
        ...
        let __cordl_ret: crate::Zenject::ValidationErrorResponses =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_ValidationRootResolveMethod(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Zenject::RootResolveMethods, 0usize>(
        ...
        let __cordl_ret: crate::Zenject::RootResolveMethods =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "cordl_class_Zenject+ZenjectSettings+SignalSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenjectSettings_SignalSettings {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ZenjectSettings/SignalSettings";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
impl crate::Zenject::ZenjectSettings_SignalSettings {
    ...
    pub fn _ctor_SignalDefaultSyncModes_SignalMissingHandlerResponses__cordl_bool_i32_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        crate::Zenject::SignalDefaultSyncModes,
    ...
    pub fn get_DefaultAsyncTickPriority(&mut self) -> quest_hook::libil2cpp::Result<i32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), i32, 0usize>("get_DefaultAsyncTickPriority")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_DefaultSyncMode(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Zenject::SignalDefaultSyncModes, 0usize>(
                        "get_DefaultSyncMode",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Zenject::SignalDefaultSyncModes =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_MissingHandlerDefaultResponse(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::Zenject::SignalMissingHandlerResponses, 0usize>(
        ...
        let __cordl_ret: crate::Zenject::SignalMissingHandlerResponses =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_RequireStrictUnsubscribe(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), bool, 0usize>("get_RequireStrictUnsubscribe")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Zenject+ZenjectSettings+SignalSettings")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::ZenjectSettings_SignalSettings {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
