...
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::FactoryFromBinder_2<TParam1, TContract>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "FactoryFromBinder`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryFromBinder`2")
                .unwrap()
    ...
    crate::Zenject::FactoryFromBinder_2<TParam1, TContract>
{
    ...
    pub fn FromSubContainerResolve_0(
        ...
        quest_hook::libil2cpp::Gc<crate::Zenject::FactorySubContainerBinder_2<TParam1, TContract>>,
    >
    where
        TParam1: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::Zenject::FactorySubContainerBinder_2<
                                TParam1,
                                TContract,
                            >,
                        >,
...
#[cfg(feature = "cordl_class_Zenject+FactoryFromBinder_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::Zenject::FactoryFromBinder_2<TParam1, TContract>
{
