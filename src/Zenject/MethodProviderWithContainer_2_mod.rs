#[cfg(feature = "cordl_class_Zenject+MethodProviderWithContainer_2")]
#[repr(C)]
#[derive(Debug)]
...
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::MethodProviderWithContainer_2<TParam1, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MethodProviderWithContainer`2")
                .unwrap()
