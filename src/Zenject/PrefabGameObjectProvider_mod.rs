...
#[cfg(feature = "Zenject+PrefabGameObjectProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::PrefabGameObjectProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "PrefabGameObjectProvider";
...
impl crate::Zenject::PrefabGameObjectProvider {
    pub fn GetAllInstancesWithInjectSplit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabGameObjectProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabGameObjectProvider as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (prefabCreator))?
        };
        Ok(__cordl_ret.into())
    }
