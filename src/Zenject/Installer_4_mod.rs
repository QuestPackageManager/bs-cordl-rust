#[cfg(feature = "cordl_class_Zenject+Installer_4")]
#[repr(C)]
...
impl<
        ...
        TParam3: quest_hook::libil2cpp::Type,
        TDerived: quest_hook::libil2cpp::Type,
    > std::ops::DerefMut for crate::Zenject::Installer_4<TParam1, TParam2, TParam3, TDerived>
{
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        TParam2,
                        TParam3,
                    ), quest_hook::libil2cpp::Void, 4usize>("Install")
                    .unwrap_or_else(|e| {
                        panic!(
