#[cfg(feature = "Zenject+PoolableMemoryPool_6")]
#[repr(C)]
#[derive(Debug)]
pub struct PoolableMemoryPool_6<
...
for crate::Zenject::PoolableMemoryPool_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "PoolableMemoryPool`6";
...
impl<
    ...
    TParam5: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPool_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPool_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPool_6 < TParam1, TParam2, TParam3,
