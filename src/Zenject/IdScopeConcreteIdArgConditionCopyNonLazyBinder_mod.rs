...
for crate::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder {
    ...
    const CLASS_NAME: &'static str = "IdScopeConcreteIdArgConditionCopyNonLazyBinder";
...
impl crate::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder {
    ...
    pub fn WithId(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IdScopeConcreteIdArgConditionCopyNonLazyBinder as
