#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceBinder_4")]
#[repr(C)]
...
> {
    __cordl_parent: crate::Zenject::FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>,
    ...
    for crate::Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>
{
    ...
    const CLASS_NAME: &'static str = "FactoryToChoiceBinder`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceBinder`4")
                .unwrap()
...
impl<
    ...
    for crate::Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>
{
    type Target = crate::Zenject::FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>;
