#[cfg(feature = "Zenject+SubContainerCreatorByNewPrefabMethod_3")]
#[repr(C)]
#[derive(Debug)]
pub struct SubContainerCreatorByNewPrefabMethod_3<
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::SubContainerCreatorByNewPrefabMethod_3
    < TParam1, TParam2, TParam3 > => "Zenject"."SubContainerCreatorByNewPrefabMethod`3" <
...
impl<
    ...
    TParam3: quest_hook::libil2cpp::Type,
> std::ops::Deref
for crate::Zenject::SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3> {
...
impl<
    ...
    TParam2: quest_hook::libil2cpp::Type,
    TParam3: quest_hook::libil2cpp::Type,
> crate::Zenject::SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3> {
    #[cfg(
        feature = "Zenject+SubContainerCreatorByNewPrefabMethod_3+__c__DisplayClass2_0"
    )]
    pub type __c__DisplayClass2_0 = crate::Zenject::SubContainerCreatorByNewPrefabMethod_3___c__DisplayClass2_0<
        TParam1,
        TParam2,
        TParam3,
    >;
