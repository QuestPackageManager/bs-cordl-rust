...
#[cfg(feature = "Zenject+InjectOptionalAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::InjectOptionalAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "InjectOptionalAttribute";
...
impl crate::Zenject::InjectOptionalAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::InjectOptionalAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::InjectOptionalAttribute as
