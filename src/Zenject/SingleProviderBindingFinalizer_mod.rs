...
impl crate::Zenject::SingleProviderBindingFinalizer {
    ...
    pub fn OnFinalizeBinding(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SingleProviderBindingFinalizer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SingleProviderBindingFinalizer as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (bindInfo, providerFactory))?
        };
        Ok(__cordl_ret.into())
    }
}
