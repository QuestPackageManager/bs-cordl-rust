...
#[cfg(feature = "Zenject+IMemoryPool")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::IMemoryPool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "IMemoryPool";
...
impl crate::Zenject::IMemoryPool {
    pub fn Clear(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IMemoryPool as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Clear")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::IMemoryPool as quest_hook::libil2cpp::Type >
                    ::class(), "Clear", 0usize
                )
            });
