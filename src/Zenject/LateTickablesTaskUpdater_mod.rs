...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::LateTickablesTaskUpdater {
    ...
    const CLASS_NAME: &'static str = "LateTickablesTaskUpdater";
...
impl crate::Zenject::LateTickablesTaskUpdater {
    ...
    pub fn UpdateItem(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::LateTickablesTaskUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Zenject::ILateTickable>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::LateTickablesTaskUpdater as
