...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::MonoInstaller_5 < TParam1, TParam2,
    TParam3, TParam4, TDerived > => "Zenject"."MonoInstaller`5" < TParam1, TParam2,
    TParam3, TParam4, TDerived >
);
#[cfg(feature = "Zenject+MonoInstaller_5")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
...
> crate::Zenject::MonoInstaller_5<TParam1, TParam2, TParam3, TParam4, TDerived> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        let __cordl_ret: TDerived = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("InstallFromResource", (container, p1, p2, p3, p4))?;
        Ok(__cordl_ret.into())
    }
    ...
    {
        let __cordl_ret: TDerived = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("InstallFromResource", (resourcePath, container, p1, p2, p3, p4))?;
        Ok(__cordl_ret.into())
    }
