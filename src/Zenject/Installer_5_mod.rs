#[cfg(feature = "cordl_class_Zenject+Installer_5")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct Installer_5<
...
unsafe impl<
    ...
    for crate::Zenject::Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "Installer`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "Installer`5")
                .unwrap()
...
#[cfg(feature = "Zenject+Installer_5")]
impl<
        TParam1: quest_hook::libil2cpp::Type,
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
...
impl<
        ...
        TParam4: quest_hook::libil2cpp::Type,
        TDerived: quest_hook::libil2cpp::Type,
    > crate::Zenject::Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>
{
    pub fn Install(
