...
#[repr(C)]
#[derive(Debug)]
pub struct PoolableMemoryPoolProvider_8<
...
> {
    ...
    const CLASS_NAME: &'static str = "PoolableMemoryPoolProvider`8";
...
impl<
    ...
    TContract: quest_hook::libil2cpp::Type,
    TMemoryPool: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPoolProvider_8<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TMemoryPool: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPoolProvider_8<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPoolProvider_8 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TParam6, TContract, TMemoryPool > as
