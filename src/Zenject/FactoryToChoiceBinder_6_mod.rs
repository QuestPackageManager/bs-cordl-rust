#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceBinder_6")]
#[repr(C)]
#[derive(Debug)]
...
> {
    __cordl_parent:
        crate::Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>,
    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceBinder`6")
                .unwrap()
                .make_generic::<(TParam1, TParam2, TParam3, TParam4, TParam5, TContract)>()
                .unwrap()
                .unwrap()
        })
    }
...
impl<
        ...
        TContract: quest_hook::libil2cpp::Type,
    >
    crate::Zenject::FactoryToChoiceBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>
{
    pub fn New(
