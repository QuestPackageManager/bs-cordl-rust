#[cfg(feature = "cordl_class_Zenject+MemoryPool_4")]
#[repr(C)]
#[derive(Debug)]
pub struct MemoryPool_4<
...
unsafe impl<
    ...
    for crate::Zenject::MemoryPool_4<TParam1, TParam2, TParam3, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "MemoryPool`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MemoryPool`4")
                .unwrap()
...
#[cfg(feature = "Zenject+MemoryPool_4")]
impl<
        TParam1: quest_hook::libil2cpp::Type,
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::MemoryPool_4<TParam1, TParam2, TParam3, TValue>
{
...
impl<
        ...
        TParam3: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > std::ops::DerefMut for crate::Zenject::MemoryPool_4<TParam1, TParam2, TParam3, TValue>
{
...
impl<
        ...
        TParam3: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > crate::Zenject::MemoryPool_4<TParam1, TParam2, TParam3, TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p1, p2, p3, item))? };
        Ok(__cordl_ret.into())
    }
    pub fn Spawn(
        &mut self,
    ...
    pub fn Zenject_IFactory_TParam1_TParam2_TParam3_TValue__Create(
        &mut self,
        p1: TParam1,
        p2: TParam2,
        p3: TParam3,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TParam1, TParam2, TParam3), TValue, 3usize>(
