#[cfg(feature = "cordl_class_Zenject+BindStatement")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Zenject::BindStatement {
    ...
    pub fn SetFinalizer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (bindingFinalizer))?
        };
        Ok(__cordl_ret.into())
    }
