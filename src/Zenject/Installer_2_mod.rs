...
pub struct Installer_2<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type>
{
...
impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::Zenject::Installer_2<TParam1, TDerived>
{
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        TParam1,
                    ), quest_hook::libil2cpp::Void, 2usize>("Install")
                    .unwrap_or_else(|e| {
                        panic!(
