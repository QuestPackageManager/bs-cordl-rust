#[cfg(feature = "cordl_class_Zenject+PlaceholderFactory_6")]
#[repr(C)]
...
unsafe impl<
    ...
    for crate::Zenject::PlaceholderFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PlaceholderFactory`6")
                .unwrap()
