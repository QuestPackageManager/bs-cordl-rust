...
#[cfg(feature = "Zenject+CachedOpenTypeProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::CachedOpenTypeProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "CachedOpenTypeProvider";
...
impl crate::Zenject::CachedOpenTypeProvider {
    pub fn ClearCache(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::CachedOpenTypeProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ClearCache")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::CachedOpenTypeProvider as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::CachedOpenTypeProvider as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::CachedOpenTypeProvider as
                    quest_hook::libil2cpp::Type > ::class(), "get_NumInstances", 0usize
                )
            });
...
#[cfg(feature = "Zenject+CachedOpenTypeProvider")]
impl AsRef<crate::Zenject::IProvider> for crate::Zenject::CachedOpenTypeProvider {
    fn as_ref(&self) -> &crate::Zenject::IProvider {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+CachedOpenTypeProvider")]
impl AsMut<crate::Zenject::IProvider> for crate::Zenject::CachedOpenTypeProvider {
