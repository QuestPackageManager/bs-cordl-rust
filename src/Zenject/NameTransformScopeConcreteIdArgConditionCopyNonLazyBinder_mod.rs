#[cfg(feature = "cordl_class_Zenject+NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder {
...
impl crate::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (bindInfo, gameObjectInfo))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder")]
