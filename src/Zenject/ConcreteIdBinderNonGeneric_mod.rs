...
pub struct ConcreteIdBinderNonGeneric {
    __cordl_parent: quest_hook::libil2cpp::Gc<crate::Zenject::ConcreteBinderNonGeneric>,
}
#[cfg(feature = "Zenject+ConcreteIdBinderNonGeneric")]
...
impl std::ops::Deref for crate::Zenject::ConcreteIdBinderNonGeneric {
    type Target = quest_hook::libil2cpp::Gc<crate::Zenject::ConcreteBinderNonGeneric>;
