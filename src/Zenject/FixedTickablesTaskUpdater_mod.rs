...
#[cfg(feature = "Zenject+FixedTickablesTaskUpdater")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::FixedTickablesTaskUpdater {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "FixedTickablesTaskUpdater";
...
impl crate::Zenject::FixedTickablesTaskUpdater {
    ...
    pub fn UpdateItem(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::FixedTickablesTaskUpdater as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Zenject::IFixedTickable>),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::FixedTickablesTaskUpdater as
