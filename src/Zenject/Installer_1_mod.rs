...
for crate::Zenject::Installer_1<TDerived> {
    ...
    const CLASS_NAME: &'static str = "Installer`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "Installer`1")
                    .unwrap()
...
impl<TDerived: quest_hook::libil2cpp::Type> crate::Zenject::Installer_1<TDerived> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::Installer_1<
            TDerived,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::Installer_1 < TDerived > as
                    quest_hook::libil2cpp::Type > ::class(), "Install", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (container))?
        };
        Ok(__cordl_ret.into())
    }
