...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::IMemoryPool_4 < TParam1, TParam2,
    TParam3, TValue > => "Zenject"."IMemoryPool`4" < TParam1, TParam2, TParam3, TValue >
);
#[cfg(feature = "Zenject+IMemoryPool_4")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
...
> crate::Zenject::IMemoryPool_4<TParam1, TParam2, TParam3, TValue> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = __cordl_object
            .invoke("Spawn", (param1, param2, param3))?;
        Ok(__cordl_ret.into())
    }
