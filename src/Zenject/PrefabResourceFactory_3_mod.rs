...
> crate::Zenject::PrefabResourceFactory_3<P1, P2, T> {
    ...
    where
        ...
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabResourceFactory_3<
            P1,
            P2,
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>, P1, P2),
                T,
                3usize,
            >("Create")
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabResourceFactory_3 < P1, P2, T > as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 3usize
                )
            });
        let __cordl_ret: T = unsafe {
            method.invoke_unchecked(self, (prefabResourceName, param, param2))?
        };
        Ok(__cordl_ret.into())
    }
