...
impl crate::Zenject::NonLazyBinder {
    pub fn Lazy(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Zenject::IfNotBoundBinder>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::IfNotBoundBinder> =
