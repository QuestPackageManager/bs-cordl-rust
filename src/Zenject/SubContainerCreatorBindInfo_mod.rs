#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorBindInfo")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct SubContainerCreatorBindInfo {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _DefaultParentName_k__BackingField:
...
impl crate::Zenject::SubContainerCreatorBindInfo {
    ...
    pub fn set_CreateKernel(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_CreateKernel")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
