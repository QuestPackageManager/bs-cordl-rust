    ...
    for crate::Zenject::ListPool_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "ListPool`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Zenject+ListPool_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::Zenject::ListPool_1<T> {
...
impl<T: quest_hook::libil2cpp::Type> crate::Zenject::ListPool_1<T> {
    ...
    pub fn get_Instance(
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Zenject::ListPool_1<T>>>
    where
        T: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::ListPool_1<T>> =
