...
impl crate::Zenject::IdBinder {
    ...
    pub fn WithId(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IdBinder as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IdBinder as quest_hook::libil2cpp::Type > ::class(),
                    "WithId", 1usize
                )
            });
