#[cfg(feature = "Zenject+FactoryToChoiceIdBinder_11")]
#[repr(C)]
#[derive(Debug)]
pub struct FactoryToChoiceIdBinder_11<
...
> {
    __cordl_parent: crate::Zenject::FactoryArgumentsToChoiceBinder_11<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::FactoryToChoiceIdBinder_11 < TParam1,
    TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10,
    TContract > => "Zenject"."FactoryToChoiceIdBinder`11" < TParam1, TParam2, TParam3,
...
impl<
    ...
    TContract: quest_hook::libil2cpp::Type,
> std::ops::Deref
for crate::Zenject::FactoryToChoiceIdBinder_11<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
    ...
    TContract,
> {
    type Target = crate::Zenject::FactoryArgumentsToChoiceBinder_11<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
> {
    pub fn WithId(
        ...
        *mut crate::Zenject::FactoryArgumentsToChoiceBinder_11<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::Zenject::FactoryArgumentsToChoiceBinder_11<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
