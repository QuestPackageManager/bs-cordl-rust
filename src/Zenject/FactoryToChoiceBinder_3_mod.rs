...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::FactoryToChoiceBinder_3 < TParam1,
    TParam2, TContract > => "Zenject"."FactoryToChoiceBinder`3" < TParam1, TParam2,
    TContract >
);
#[cfg(feature = "Zenject+FactoryToChoiceBinder_3")]
impl<
...
> crate::Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract> {
    ...
    pub fn ToSelf(
        ...
        *mut crate::Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>,
    >
    where
        TParam1: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
