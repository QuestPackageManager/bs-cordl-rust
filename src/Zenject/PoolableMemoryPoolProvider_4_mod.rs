...
pub struct PoolableMemoryPoolProvider_4<
...
unsafe impl<
    ...
    for crate::Zenject::PoolableMemoryPoolProvider_4<TParam1, TParam2, TContract, TMemoryPool>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "PoolableMemoryPoolProvider`4";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableMemoryPoolProvider`4")
                .unwrap()
                .make_generic::<(TParam1, TParam2, TContract, TMemoryPool)>()
                .unwrap()
                .unwrap()
        })
    }
...
impl<
        ...
        TContract: quest_hook::libil2cpp::Type,
        TMemoryPool: quest_hook::libil2cpp::Type,
    > crate::Zenject::PoolableMemoryPoolProvider_4<TParam1, TParam2, TContract, TMemoryPool>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (container, poolId))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+PoolableMemoryPoolProvider_4")]
