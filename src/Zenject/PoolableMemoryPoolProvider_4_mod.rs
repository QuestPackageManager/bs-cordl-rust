...
impl<
    ...
    TContract: quest_hook::libil2cpp::Type,
    TMemoryPool: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPoolProvider_4<
    TParam1,
    TParam2,
    TContract,
    TMemoryPool,
> {
    ...
    where
        ...
        TMemoryPool: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPoolProvider_4<
            TParam1,
            TParam2,
            TContract,
            TMemoryPool,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPoolProvider_4 < TParam1, TParam2,
                    TContract, TMemoryPool > as quest_hook::libil2cpp::Type > ::class(),
