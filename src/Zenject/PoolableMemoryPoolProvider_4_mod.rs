...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::PoolableMemoryPoolProvider_4 < TParam1,
    TParam2, TContract, TMemoryPool > => "Zenject"."PoolableMemoryPoolProvider`4" <
    TParam1, TParam2, TContract, TMemoryPool >
);
#[cfg(feature = "Zenject+PoolableMemoryPoolProvider_4")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
