    ...
    for crate::Zenject::StaticMemoryPool_1<TValue>
{
    ...
    const CLASS_NAME: &'static str = "StaticMemoryPool`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "StaticMemoryPool`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::StaticMemoryPool_1<TValue> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (onSpawnMethod, onDespawnedMethod, initialSize))?
        };
        Ok(__cordl_ret.into())
    }
