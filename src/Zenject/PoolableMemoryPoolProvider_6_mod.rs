#[cfg(feature = "cordl_class_Zenject+PoolableMemoryPoolProvider_6")]
#[repr(C)]
#[derive(Debug)]
    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableMemoryPoolProvider`6")
                .unwrap()
                .make_generic::<(TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool)>()
                .unwrap()
                .unwrap()
        })
    }
