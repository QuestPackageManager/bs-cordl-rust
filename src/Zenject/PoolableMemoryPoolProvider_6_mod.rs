...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::PoolableMemoryPoolProvider_6 < TParam1,
    TParam2, TParam3, TParam4, TContract, TMemoryPool > => "Zenject"
    ."PoolableMemoryPoolProvider`6" < TParam1, TParam2, TParam3, TParam4, TContract,
    TMemoryPool >
);
#[cfg(feature = "Zenject+PoolableMemoryPoolProvider_6")]
impl<
