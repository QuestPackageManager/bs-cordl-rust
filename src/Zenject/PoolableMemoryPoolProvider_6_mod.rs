#[cfg(feature = "Zenject+PoolableMemoryPoolProvider_6")]
#[repr(C)]
#[derive(Debug)]
pub struct PoolableMemoryPoolProvider_6<
...
for crate::Zenject::PoolableMemoryPoolProvider_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "PoolableMemoryPoolProvider`6";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        "Zenject",
                        "PoolableMemoryPoolProvider`6",
                    )
                    .unwrap()
                    .make_generic::<
                        (TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool),
                    >()
                    .unwrap()
                    .unwrap()
            })
...
impl<
    ...
    TContract: quest_hook::libil2cpp::Type,
    TMemoryPool: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPoolProvider_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TMemoryPool: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPoolProvider_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPoolProvider_6 < TParam1, TParam2,
                    TParam3, TParam4, TContract, TMemoryPool > as
