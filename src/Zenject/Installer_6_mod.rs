...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::Installer_6 < TParam1, TParam2,
    TParam3, TParam4, TParam5, TDerived > => "Zenject"."Installer`6" < TParam1, TParam2,
    TParam3, TParam4, TParam5, TDerived >
);
#[cfg(feature = "Zenject+Installer_6")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
...
> crate::Zenject::Installer_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        let __cordl_ret: quest_hook::libil2cpp::Void = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("Install", (container, p1, p2, p3, p4, p5))?;
        Ok(__cordl_ret.into())
    }
