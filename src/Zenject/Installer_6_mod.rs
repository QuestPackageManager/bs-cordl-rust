...
for crate::Zenject::Installer_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "Installer`6";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "Installer`6")
                    .unwrap()
                    .make_generic::<
...
impl<
    ...
    TParam5: quest_hook::libil2cpp::Type,
    TDerived: quest_hook::libil2cpp::Type,
> crate::Zenject::Installer_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived> {
    pub fn Install(
    ...
    where
        ...
        TDerived: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::Installer_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::Installer_6 < TParam1, TParam2, TParam3, TParam4,
                    TParam5, TDerived > as quest_hook::libil2cpp::Type > ::class(),
                    "Install", 6usize
                )
            });
