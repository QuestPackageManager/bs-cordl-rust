...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::ScriptableObjectInstaller_3 < TParam1,
    TParam2, TDerived > => "Zenject"."ScriptableObjectInstaller`3" < TParam1, TParam2,
    TDerived >
);
#[cfg(feature = "Zenject+ScriptableObjectInstaller_3")]
impl<
...
> crate::Zenject::ScriptableObjectInstaller_3<TParam1, TParam2, TDerived> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        let __cordl_ret: TDerived = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("InstallFromResource", (container, p1, p2))?;
        Ok(__cordl_ret.into())
    }
    ...
    {
        let __cordl_ret: TDerived = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("InstallFromResource", (resourcePath, container, p1, p2))?;
        Ok(__cordl_ret.into())
    }
