#[cfg(feature = "cordl_class_Zenject+GetFromGameObjectGetterComponentProvider")]
#[repr(C)]
    ...
    for crate::Zenject::GetFromGameObjectGetterComponentProvider
{
    ...
    const CLASS_NAME: &'static str = "GetFromGameObjectGetterComponentProvider";
...
impl crate::Zenject::GetFromGameObjectGetterComponentProvider {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (componentType, gameObjectGetter, matchSingle))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "Zenject+GetFromGameObjectGetterComponentProvider")]
impl AsRef<crate::Zenject::IProvider> for crate::Zenject::GetFromGameObjectGetterComponentProvider {
    fn as_ref(&self) -> &crate::Zenject::IProvider {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+GetFromGameObjectGetterComponentProvider")]
impl AsMut<crate::Zenject::IProvider> for crate::Zenject::GetFromGameObjectGetterComponentProvider {
