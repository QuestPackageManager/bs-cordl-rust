...
impl crate::Zenject::ScopableBindingFinalizer {
    pub fn FinalizeBindingConcrete(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ScopableBindingFinalizer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ScopableBindingFinalizer as
