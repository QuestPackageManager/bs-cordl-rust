...
#[cfg(feature = "Zenject+ZenjectManagersInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenjectManagersInstaller {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ZenjectManagersInstaller";
...
impl crate::Zenject::ZenjectManagersInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ZenjectManagersInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ZenjectManagersInstaller as
