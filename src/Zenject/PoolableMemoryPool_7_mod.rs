#[cfg(feature = "Zenject+PoolableMemoryPool_7")]
#[repr(C)]
#[derive(Debug)]
pub struct PoolableMemoryPool_7<
...
for crate::Zenject::PoolableMemoryPool_7<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "PoolableMemoryPool`7";
...
impl<
    ...
    TParam6: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPool_7<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPool_7<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPool_7 < TParam1, TParam2, TParam3,
                    TParam4, TParam5, TParam6, TValue > as quest_hook::libil2cpp::Type >
