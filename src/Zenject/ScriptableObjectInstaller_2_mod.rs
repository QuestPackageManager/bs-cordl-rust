...
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "ScriptableObjectInstaller`2")
                .unwrap()
