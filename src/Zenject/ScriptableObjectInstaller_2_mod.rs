...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::ScriptableObjectInstaller_2 < TParam1,
    TDerived > => "Zenject"."ScriptableObjectInstaller`2" < TParam1, TDerived >
);
#[cfg(feature = "Zenject+ScriptableObjectInstaller_2")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
...
> crate::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived> {
    pub fn InstallFromResource_Gc_TParam1_1(
    ...
    pub fn InstallFromResource_TParam1_0(
        container: quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
        p1: TParam1,
    ) -> quest_hook::libil2cpp::Result<TDerived>
    where
