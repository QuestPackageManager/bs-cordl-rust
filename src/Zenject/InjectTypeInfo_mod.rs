...
impl crate::Zenject::InjectTypeInfo_InjectConstructorInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (factory, parameters))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Zenject::InjectTypeInfo_InjectMemberInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (setter, info))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Zenject::InjectTypeInfo_InjectMethodInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (action, parameters, name))?
        };
        Ok(__cordl_ret.into())
    }
}
