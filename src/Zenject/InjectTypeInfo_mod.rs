...
pub struct InjectTypeInfo {
    ...
    pub InjectMembers: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub InjectConstructor:
        quest_hook::libil2cpp::Gc<crate::Zenject::InjectTypeInfo_InjectConstructorInfo>,
    pub _BaseTypeInfo_k__BackingField: quest_hook::libil2cpp::Gc<crate::Zenject::InjectTypeInfo>,
}
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo")]
...
impl crate::Zenject::InjectTypeInfo {
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Zenject::InjectableInfo>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<get_AllInjectables>b__0", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::InjectableInfo> =
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "<get_AllInjectables>b__1", 1usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo+InjectConstructorInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::InjectTypeInfo_InjectConstructorInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
...
impl crate::Zenject::InjectTypeInfo_InjectConstructorInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (factory, parameters))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo+InjectConstructorInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::InjectTypeInfo_InjectConstructorInfo {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo+InjectMemberInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::InjectTypeInfo_InjectMemberInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
...
impl crate::Zenject::InjectTypeInfo_InjectMemberInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (setter, info))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo+InjectMemberInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::InjectTypeInfo_InjectMemberInfo {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
...
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo+InjectMethodInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::InjectTypeInfo_InjectMethodInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
...
impl crate::Zenject::InjectTypeInfo_InjectMethodInfo {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (action, parameters, name))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+InjectTypeInfo+InjectMethodInfo")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::InjectTypeInfo_InjectMethodInfo {
    fn as_object(&self) -> &quest_hook::libil2cpp::Il2CppObject {
        quest_hook::libil2cpp::ObjectType::as_object(&self.__cordl_parent)
    }
    fn as_object_mut(&mut self) -> &mut quest_hook::libil2cpp::Il2CppObject {
