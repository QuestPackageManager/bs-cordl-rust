...
impl crate::Zenject::PrefabProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabProvider as quest_hook::libil2cpp::Type >
