#[cfg(feature = "Zenject+MonoPoolableMemoryPool_4")]
#[repr(C)]
#[derive(Debug)]
pub struct MonoPoolableMemoryPool_4<
...
for crate::Zenject::MonoPoolableMemoryPool_4<TParam1, TParam2, TParam3, TValue> {
    ...
    const CLASS_NAME: &'static str = "MonoPoolableMemoryPool`4";
...
impl<
    ...
    TParam3: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::MonoPoolableMemoryPool_4<TParam1, TParam2, TParam3, TValue> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoPoolableMemoryPool_4<
            TParam1,
            TParam2,
            TParam3,
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoPoolableMemoryPool_4 < TParam1, TParam2,
