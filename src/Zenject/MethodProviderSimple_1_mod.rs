...
for crate::Zenject::MethodProviderSimple_1<TReturn> {
    ...
    const CLASS_NAME: &'static str = "MethodProviderSimple`1";
...
> crate::Zenject::MethodProviderSimple_1<TReturn> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MethodProviderSimple_1<
            TReturn,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MethodProviderSimple_1 < TReturn > as
