    ...
    for crate::Zenject::MethodProviderSimple_1<TReturn>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MethodProviderSimple`1")
                .unwrap()
...
#[cfg(feature = "Zenject+MethodProviderSimple_1")]
impl<TReturn: quest_hook::libil2cpp::Type> crate::Zenject::MethodProviderSimple_1<TReturn> {
