...
impl<T: quest_hook::libil2cpp::Type> crate::Zenject::PrefabResourceFactory_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabResourceFactory_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabResourceFactory_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 1usize
                )
            });
        let __cordl_ret: T = unsafe {
            method.invoke_unchecked(self, (prefabResourceName))?
        };
        Ok(__cordl_ret.into())
    }
