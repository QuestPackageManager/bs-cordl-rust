#[cfg(feature = "cordl_class_Zenject+PrefabResourceFactory_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Zenject::PrefabResourceFactory_1<T>
{
    ...
    const CLASS_NAME: &'static str = "PrefabResourceFactory`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PrefabResourceFactory`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
impl<T: quest_hook::libil2cpp::Type> crate::Zenject::PrefabResourceFactory_1<T> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T =
            unsafe { cordl_method_info.invoke_unchecked(self, (prefabResourceName))? };
        Ok(__cordl_ret.into())
    }
