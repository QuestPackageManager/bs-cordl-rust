...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::NoTransitionInstaller {
    ...
    const CLASS_NAME: &'static str = "NoTransitionInstaller";
...
#[cfg(feature = "Zenject+NoTransitionInstaller")]
impl crate::Zenject::NoTransitionInstaller {
    pub fn InstallBindings(
        &mut self,
        container: quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::NoTransitionInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::NoTransitionInstaller as quest_hook::libil2cpp::Type
