#[cfg(feature = "Zenject+FactoryToChoiceIdBinder_6")]
#[repr(C)]
#[derive(Debug)]
pub struct FactoryToChoiceIdBinder_6<
...
> {
    __cordl_parent: crate::Zenject::FactoryArgumentsToChoiceBinder_6<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::FactoryToChoiceIdBinder_6 < TParam1,
    TParam2, TParam3, TParam4, TParam5, TContract > => "Zenject"
    ."FactoryToChoiceIdBinder`6" < TParam1, TParam2, TParam3, TParam4, TParam5, TContract
    >
);
#[cfg(feature = "Zenject+FactoryToChoiceIdBinder_6")]
impl<
    ...
    TContract: quest_hook::libil2cpp::Type,
> std::ops::Deref
for crate::Zenject::FactoryToChoiceIdBinder_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
    ...
    TContract,
> {
    type Target = crate::Zenject::FactoryArgumentsToChoiceBinder_6<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
> {
    ...
    pub fn WithId(
        ...
        *mut crate::Zenject::FactoryArgumentsToChoiceBinder_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::Zenject::FactoryArgumentsToChoiceBinder_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
