...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::IValidatable {
    ...
    const CLASS_NAME: &'static str = "IValidatable";
...
impl crate::Zenject::IValidatable {
    pub fn Validate(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IValidatable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Validate")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::IValidatable as quest_hook::libil2cpp::Type >
