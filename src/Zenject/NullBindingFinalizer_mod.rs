...
impl crate::Zenject::NullBindingFinalizer {
    pub fn FinalizeBinding(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::NullBindingFinalizer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::NullBindingFinalizer as quest_hook::libil2cpp::Type
