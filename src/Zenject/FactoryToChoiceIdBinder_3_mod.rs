#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceIdBinder_3")]
#[repr(C)]
...
> {
    __cordl_parent: crate::Zenject::FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>,
    ...
    for crate::Zenject::FactoryToChoiceIdBinder_3<TParam1, TParam2, TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceIdBinder`3")
                .unwrap()
...
impl<
        ...
        TParam2: quest_hook::libil2cpp::Type,
        TContract: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::FactoryToChoiceIdBinder_3<TParam1, TParam2, TContract>
{
    type Target = crate::Zenject::FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>;
