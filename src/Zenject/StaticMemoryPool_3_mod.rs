...
> {
    ...
    pub _onSpawnMethod:
        quest_hook::libil2cpp::Gc<crate::System::Action_3<TParam1, TParam2, TValue>>,
...
unsafe impl<
        ...
        TParam2: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::Zenject::StaticMemoryPool_3<TParam1, TParam2, TValue>
{
...
{
    pub fn New(
        onSpawnMethod: quest_hook::libil2cpp::Gc<crate::System::Action_3<TParam1, TParam2, TValue>>,
    ...
    pub fn Spawn(&mut self, p1: TParam1, p2: TParam2) -> quest_hook::libil2cpp::Result<TValue>
    where
        TParam1: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = unsafe { cordl_method_info.invoke_unchecked(self, (p1, p2))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
    ...
    pub fn set_OnSpawnMethod(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::System::Action_3<TParam1, TParam2, TValue>>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TParam1: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
...
impl<
    ...
    for crate::Zenject::StaticMemoryPool_3<TParam1, TParam2, TValue>
{
    fn as_mut(&mut self) -> &mut crate::Zenject::IMemoryPool_3<TParam1, TParam2, TValue> {
        unsafe { std::mem::transmute(self) }
    }
}
