...
#[cfg(feature = "Zenject+MonoInstallerUtil")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::MonoInstallerUtil {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "MonoInstallerUtil";
...
impl crate::Zenject::MonoInstallerUtil {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoInstallerUtil as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoInstallerUtil as quest_hook::libil2cpp::Type >
                    ::class(), "CreateInstaller", 2usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoInstallerUtil as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::MonoInstallerUtil as quest_hook::libil2cpp::Type >
                    ::class(), "GetDefaultResourcePath", 0usize
                )
            });
