...
impl<
        ...
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>
{
    ...
    > crate::Zenject::KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TBase =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, param1, param2, param3))? };
        Ok(__cordl_ret.into())
    }
