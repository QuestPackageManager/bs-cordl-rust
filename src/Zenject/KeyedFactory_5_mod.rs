...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::KeyedFactory_5 < TBase, TKey, TParam1,
    TParam2, TParam3 > => "Zenject"."KeyedFactory`5" < TBase, TKey, TParam1, TParam2,
    TParam3 >
);
#[cfg(feature = "Zenject+KeyedFactory_5")]
impl<
...
> crate::Zenject::KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TBase = __cordl_object
            .invoke("Create", (key, param1, param2, param3))?;
        Ok(__cordl_ret.into())
    }
