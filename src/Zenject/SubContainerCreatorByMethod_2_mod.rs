...
for crate::Zenject::SubContainerCreatorByMethod_2<TParam1, TParam2> {
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorByMethod`2";
...
> crate::Zenject::SubContainerCreatorByMethod_2<TParam1, TParam2> {
    ...
    where
        ...
        TParam2: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByMethod_2<
            TParam1,
            TParam2,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByMethod_2 < TParam1, TParam2 >
                    as quest_hook::libil2cpp::Type > ::class(), "CreateSubContainer",
                    2usize
                )
            });
