#[cfg(feature = "cordl_class_Zenject+PoolableMemoryPool_5")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct PoolableMemoryPool_5<
    ...
    for crate::Zenject::PoolableMemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
    ...
    const CLASS_NAME: &'static str = "PoolableMemoryPool`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableMemoryPool`5")
                .unwrap()
...
#[cfg(feature = "Zenject+PoolableMemoryPool_5")]
impl<
        TParam1: quest_hook::libil2cpp::Type,
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
...
impl<
        ...
        TParam4: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > crate::Zenject::PoolableMemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
