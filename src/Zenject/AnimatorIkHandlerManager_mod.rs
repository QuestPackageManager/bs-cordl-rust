...
impl crate::Zenject::AnimatorIkHandlerManager {
    pub fn Construct(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::AnimatorIkHandlerManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::AnimatorIkHandlerManager as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::AnimatorIkHandlerManager as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::AnimatorIkHandlerManager as
                    quest_hook::libil2cpp::Type > ::class(), "OnAnimatorIk", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
