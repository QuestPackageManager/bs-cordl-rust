...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::TypeValuePair {
    ...
    const CLASS_NAME: &'static str = "TypeValuePair";
...
impl crate::Zenject::TypeValuePair {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::TypeValuePair as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::TypeValuePair as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 2usize
                )
            });
