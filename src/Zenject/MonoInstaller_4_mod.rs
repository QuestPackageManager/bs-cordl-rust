...
> {
    __cordl_parent: quest_hook::libil2cpp::Gc<crate::Zenject::MonoInstallerBase>,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::MonoInstaller_4 < TParam1, TParam2,
    TParam3, TDerived > => "Zenject"."MonoInstaller`4" < TParam1, TParam2, TParam3,
    TDerived >
);
#[cfg(feature = "Zenject+MonoInstaller_4")]
impl<
...
for crate::Zenject::MonoInstaller_4<TParam1, TParam2, TParam3, TDerived> {
    type Target = quest_hook::libil2cpp::Gc<crate::Zenject::MonoInstallerBase>;
...
> crate::Zenject::MonoInstaller_4<TParam1, TParam2, TParam3, TDerived> {
    pub fn InstallFromResource_Gc_TParam1_TParam2_TParam3_1(
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        let __cordl_ret: TDerived = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("InstallFromResource", (resourcePath, container, p1, p2, p3))?;
        Ok(__cordl_ret.into())
    }
    pub fn InstallFromResource_TParam1_TParam2_TParam3_0(
        container: quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
        p1: TParam1,
        p2: TParam2,
        p3: TParam3,
    ...
    {
        let __cordl_ret: TDerived = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("InstallFromResource", (container, p1, p2, p3))?;
        Ok(__cordl_ret.into())
    }
