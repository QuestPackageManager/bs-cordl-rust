...
> crate::Zenject::MonoInstaller_4<TParam1, TParam2, TParam3, TDerived> {
    ...
    where
        ...
        TDerived: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoInstaller_4<
            TParam1,
            TParam2,
            TParam3,
            TDerived,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoInstaller_4 < TParam1, TParam2, TParam3,
                    TDerived > as quest_hook::libil2cpp::Type > ::class(),
                    "InstallFromResource", 5usize
                )
            });
        let __cordl_ret: TDerived = unsafe {
            method.invoke_unchecked((), (resourcePath, container, p1, p2, p3))?
        };
        Ok(__cordl_ret.into())
    }
