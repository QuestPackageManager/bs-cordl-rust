...
#[cfg(feature = "cordl_class_Zenject+PoolExceededFixedSizeException")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::PoolExceededFixedSizeException {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "PoolExceededFixedSizeException";
...
impl crate::Zenject::PoolExceededFixedSizeException {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (errorMessage))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Zenject+PoolExceededFixedSizeException")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::PoolExceededFixedSizeException {
