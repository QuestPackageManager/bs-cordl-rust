...
> crate::Zenject::ConcreteBinderGeneric_1<TContract> {
    ...
    where
        TContract: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ConcreteBinderGeneric_1<
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ConcreteBinderGeneric_1 < TContract > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ConcreteBinderGeneric_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "<ToSelf>b__1_0", 2usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ConcreteBinderGeneric_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "<To>b__5_0", 1usize
                )
            });
