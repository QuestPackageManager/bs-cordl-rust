...
> crate::Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByNewGameObjectMethod_1<
            TParam1,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByNewGameObjectMethod_1 < TParam1
                    > as quest_hook::libil2cpp::Type > ::class(), "AddInstallers", 2usize
                )
            });
