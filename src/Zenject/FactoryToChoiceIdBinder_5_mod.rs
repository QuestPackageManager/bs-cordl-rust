...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::FactoryToChoiceIdBinder_5 < TParam1,
    TParam2, TParam3, TParam4, TContract > => "Zenject"."FactoryToChoiceIdBinder`5" <
...
> {
    ...
    pub fn WithId(
        ...
        *mut crate::Zenject::FactoryArgumentsToChoiceBinder_5<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::Zenject::FactoryArgumentsToChoiceBinder_5<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
