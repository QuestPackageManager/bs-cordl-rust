#[cfg(feature = "cordl_class_Zenject+DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder")]
#[repr(C)]
...
impl std::ops::Deref for crate::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder {
...
#[cfg(feature = "Zenject+DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder")]
impl std::ops::DerefMut for crate::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder {
...
impl crate::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder {
    ...
    pub fn OptionalSubscriber(
        ...
        quest_hook::libil2cpp::Gc<crate::Zenject::DeclareSignalAsyncTickPriorityCopyBinder>,
    > {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::Zenject::DeclareSignalAsyncTickPriorityCopyBinder,
                    >, 0usize>("OptionalSubscriberWithWarning")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
