...
impl crate::Zenject::ScriptableObjectResourceProvider {
    pub fn GetAllInstancesWithInjectSplit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ScriptableObjectResourceProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<crate::Zenject::InjectContext>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ScriptableObjectResourceProvider as
