...
#[cfg(feature = "cordl_class_Zenject+SubContainerBindingFinalizer")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::SubContainerBindingFinalizer {
...
impl crate::Zenject::SubContainerBindingFinalizer {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (bindInfo, subIdentifier, resolveAll, creatorFactory))?
        };
        Ok(__cordl_ret.into())
    }
}
