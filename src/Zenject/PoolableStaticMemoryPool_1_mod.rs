#[cfg(feature = "cordl_class_Zenject+PoolableStaticMemoryPool_1")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Zenject::PoolableStaticMemoryPool_1<TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableStaticMemoryPool`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Zenject+PoolableStaticMemoryPool_1")]
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::PoolableStaticMemoryPool_1<TValue> {
    ...
    pub fn OnSpawned(value: TValue) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TValue: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
