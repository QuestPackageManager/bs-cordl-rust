...
> crate::Zenject::GetterProvider_2<TObj, TResult> {
    ...
    where
        ...
        TResult: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::GetterProvider_2<
            TObj,
            TResult,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::GetterProvider_2 < TObj, TResult > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::GetterProvider_2 < TObj, TResult > as
                    quest_hook::libil2cpp::Type > ::class(), "GetSubContext", 1usize
                )
            });
