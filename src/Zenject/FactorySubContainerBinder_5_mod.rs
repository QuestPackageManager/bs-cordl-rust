...
unsafe impl<
    ...
    for crate::Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactorySubContainerBinder`5")
                .unwrap()
...
impl<
        ...
        TParam4: quest_hook::libil2cpp::Type,
        TContract: quest_hook::libil2cpp::Type,
    > crate::Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>
{
    pub fn ByMethod(
        &mut self,
