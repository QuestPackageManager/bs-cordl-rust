    ...
    for crate::Zenject::MemoryPoolMaxSizeBinder_1<TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MemoryPoolMaxSizeBinder`1")
                .unwrap()
...
#[cfg(feature = "Zenject+MemoryPoolMaxSizeBinder_1")]
impl<TContract: quest_hook::libil2cpp::Type> crate::Zenject::MemoryPoolMaxSizeBinder_1<TContract> {
    pub fn New(
