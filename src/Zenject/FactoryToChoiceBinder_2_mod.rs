...
> crate::Zenject::FactoryToChoiceBinder_2<TParam1, TContract> {
    ...
    pub fn To<TConcrete>(
        ...
        *mut crate::Zenject::FactoryFromBinder_2<TParam1, TConcrete>,
    >
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::Zenject::FactoryFromBinder_2<TParam1, TConcrete> = __cordl_object
            .invoke("To", ())?;
        Ok(__cordl_ret)
    }
    pub fn ToSelf(
        ...
        *mut crate::Zenject::FactoryFromBinder_2<TParam1, TContract>,
    >
    where
        TParam1: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::Zenject::FactoryFromBinder_2<TParam1, TContract> = __cordl_object
            .invoke("ToSelf", ())?;
        Ok(__cordl_ret)
    }
    pub fn _ctor(
