#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceBinder_2")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceBinder_2")]
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "FactoryToChoiceBinder`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceBinder`2")
                .unwrap()
                .make_generic::<(TParam1, TContract)>()
                .unwrap()
                .unwrap()
        })
    }
...
impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type> std::ops::Deref
...
#[cfg(feature = "Zenject+FactoryToChoiceBinder_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    ...
    crate::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>
{
    ...
    pub fn To<TConcrete>(
        ...
        quest_hook::libil2cpp::Gc<crate::Zenject::FactoryFromBinder_2<TParam1, TConcrete>>,
    >
    where
        TParam1: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
    ...
    pub fn ToSelf(
        ...
        quest_hook::libil2cpp::Gc<crate::Zenject::FactoryFromBinder_2<TParam1, TContract>>,
    >
    where
        TParam1: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
