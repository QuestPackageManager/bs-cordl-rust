    ...
    for crate::Zenject::Factory_1<TValue>
{
    ...
    const CLASS_NAME: &'static str = "Factory`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "Factory`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
impl<TValue: quest_hook::libil2cpp::Type> std::ops::Deref for crate::Zenject::Factory_1<TValue> {
...
#[cfg(feature = "Zenject+Factory_1")]
impl<TValue: quest_hook::libil2cpp::Type> std::ops::DerefMut for crate::Zenject::Factory_1<TValue> {
