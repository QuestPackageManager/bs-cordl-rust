...
> {
    ...
    pub _onSpawnMethod: quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue>,
...
> crate::Zenject::StaticMemoryPool_4<TParam1, TParam2, TParam3, TValue> {
    pub fn New(
        onSpawnMethod: quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue>,
    ...
    pub fn set_OnSpawnMethod(
        &mut self,
        value: quest_hook::libil2cpp::Gc<TParam1, TParam2, TParam3, TValue>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TParam1: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
