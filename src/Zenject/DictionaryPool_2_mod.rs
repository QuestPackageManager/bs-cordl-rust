...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::DictionaryPool_2<TKey, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "DictionaryPool`2")
                .unwrap()
...
impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::Zenject::DictionaryPool_2<TKey, TValue>
{
    ...
    crate::Zenject::DictionaryPool_2<TKey, TValue>
{
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::Dictionary_2<TKey, TValue>,
                    >), quest_hook::libil2cpp::Void, 1usize>("OnDespawned")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::Dictionary_2<TKey, TValue>,
                    >), quest_hook::libil2cpp::Void, 1usize>("OnSpawned")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::DictionaryPool_2<TKey, TValue>> =
