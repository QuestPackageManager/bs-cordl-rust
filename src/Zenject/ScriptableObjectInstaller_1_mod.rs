    ...
    for crate::Zenject::ScriptableObjectInstaller_1<TDerived>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "ScriptableObjectInstaller`1")
                .unwrap()
...
#[cfg(feature = "Zenject+ScriptableObjectInstaller_1")]
impl<TDerived: quest_hook::libil2cpp::Type> crate::Zenject::ScriptableObjectInstaller_1<TDerived> {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TDerived = unsafe { cordl_method_info.invoke_unchecked((), (container))? };
        Ok(__cordl_ret.into())
    }
