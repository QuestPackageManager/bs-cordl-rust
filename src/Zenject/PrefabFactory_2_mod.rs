...
pub struct PrefabFactory_2<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type> {
...
#[cfg(feature = "cordl_class_Zenject+PrefabFactory_2")]
unsafe impl<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::PrefabFactory_2<P1, T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "PrefabFactory`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PrefabFactory`2")
                .unwrap()
                .make_generic::<(P1, T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Zenject+PrefabFactory_2")]
impl<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    crate::Zenject::PrefabFactory_2<P1, T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1),
                        T,
                        2usize,
                    >("Create")
                    .unwrap_or_else(|e| {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (prefab, param))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "Zenject+PrefabFactory_2")]
impl<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    AsRef<crate::Zenject::IFactory> for crate::Zenject::PrefabFactory_2<P1, T>
{
...
#[cfg(feature = "Zenject+PrefabFactory_2")]
impl<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    AsMut<crate::Zenject::IFactory> for crate::Zenject::PrefabFactory_2<P1, T>
{
...
#[cfg(feature = "Zenject+PrefabFactory_2")]
impl<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    AsRef<crate::Zenject::IFactory_3<quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1, T>>
    for crate::Zenject::PrefabFactory_2<P1, T>
{
    fn as_ref(
        &self,
    ) -> &crate::Zenject::IFactory_3<quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1, T>
    {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+PrefabFactory_2")]
impl<P1: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    AsMut<crate::Zenject::IFactory_3<quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1, T>>
    for crate::Zenject::PrefabFactory_2<P1, T>
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::Zenject::IFactory_3<quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1, T>
    {
        unsafe { std::mem::transmute(self) }
    }
}
