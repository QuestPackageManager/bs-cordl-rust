...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::MonoInstaller {
    ...
    const CLASS_NAME: &'static str = "MonoInstaller";
...
impl crate::Zenject::MonoInstaller {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoInstaller as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Zenject::InjectTypeInfo>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoInstaller as quest_hook::libil2cpp::Type >
