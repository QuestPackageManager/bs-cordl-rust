...
impl crate::Zenject::ProjectKernel {
    pub fn DestroyEverythingInOrder(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ProjectKernel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ProjectKernel as quest_hook::libil2cpp::Type >
                    ::class(), "DestroyEverythingInOrder", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ProjectKernel as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ProjectKernel as quest_hook::libil2cpp::Type >
                    ::class(), "ForceUnloadAllScenes", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ProjectKernel as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ProjectKernel as quest_hook::libil2cpp::Type >
                    ::class(), "OnApplicationQuit", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, ())?
