...
> crate::Zenject::MonoInstaller_2<TParam1, TDerived> {
    ...
    where
        ...
        TDerived: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoInstaller_2<
            TParam1,
            TDerived,
        > as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>, TParam1),
                TDerived,
                2usize,
            >("InstallFromResource")
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoInstaller_2 < TParam1, TDerived > as
                    quest_hook::libil2cpp::Type > ::class(), "InstallFromResource",
                    2usize
                )
            });
        let __cordl_ret: TDerived = unsafe {
            method.invoke_unchecked((), (container, p1))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TDerived = unsafe {
            method.invoke_unchecked((), (resourcePath, container, p1))?
        };
        Ok(__cordl_ret.into())
    }
