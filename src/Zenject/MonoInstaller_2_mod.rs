...
#[cfg(feature = "cordl_class_Zenject+MonoInstaller_2")]
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Zenject::MonoInstaller_2<TParam1, TDerived>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "MonoInstaller`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MonoInstaller`2")
                .unwrap()
...
impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type> std::ops::Deref
...
#[cfg(feature = "Zenject+MonoInstaller_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::Zenject::MonoInstaller_2<TParam1, TDerived>
{
...
#[cfg(feature = "Zenject+MonoInstaller_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type>
    crate::Zenject::MonoInstaller_2<TParam1, TDerived>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        TParam1,
                    ), TDerived, 2usize>("InstallFromResource")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: TDerived =
            unsafe { cordl_method_info.invoke_unchecked((), (container, p1))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
                        TParam1,
                    ), TDerived, 3usize>("InstallFromResource")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: TDerived =
            unsafe { cordl_method_info.invoke_unchecked((), (resourcePath, container, p1))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Zenject+MonoInstaller_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TDerived: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::Zenject::MonoInstaller_2<TParam1, TDerived>
{
