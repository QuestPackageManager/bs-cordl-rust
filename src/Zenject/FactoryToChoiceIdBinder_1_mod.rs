#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceIdBinder_1")]
#[repr(C)]
    ...
    for crate::Zenject::FactoryToChoiceIdBinder_1<TContract>
{
    ...
    const CLASS_NAME: &'static str = "FactoryToChoiceIdBinder`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceIdBinder`1")
                .unwrap()
...
#[cfg(feature = "Zenject+FactoryToChoiceIdBinder_1")]
impl<TContract: quest_hook::libil2cpp::Type> crate::Zenject::FactoryToChoiceIdBinder_1<TContract> {
    pub fn New(
