...
> {
    ...
    const CLASS_NAME: &'static str = "FactoryToChoiceBinder`11";
...
> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::FactoryToChoiceBinder_11<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::FactoryToChoiceBinder_11 < TParam1, TParam2,
