#[cfg(feature = "Zenject+IPoolable_8")]
#[repr(C)]
#[derive(Debug)]
pub struct IPoolable_8<
...
> {
    ...
    const CLASS_NAME: &'static str = "IPoolable`8";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IPoolable`8")
                    .unwrap()
                    .make_generic::<
                        (
                            TParam1,
...
> {
    ...
    where
        ...
        TParam8: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IPoolable_8<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IPoolable_8 < TParam1, TParam2, TParam3, TParam4,
                    TParam5, TParam6, TParam7, TParam8 > as quest_hook::libil2cpp::Type >
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IPoolable_8 < TParam1, TParam2, TParam3, TParam4,
                    TParam5, TParam6, TParam7, TParam8 > as quest_hook::libil2cpp::Type >
                    ::class(), "OnSpawned", 8usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p1, p2, p3, p4, p5, p6, p7, p8))?
        };
        Ok(__cordl_ret.into())
    }
