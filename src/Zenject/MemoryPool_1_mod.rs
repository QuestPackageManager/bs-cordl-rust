...
impl<TValue: quest_hook::libil2cpp::Type> std::ops::Deref for crate::Zenject::MemoryPool_1<TValue> {
...
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::MemoryPool_1<TValue> {
    ...
    pub fn Zenject_IFactory_TValue__Create(&mut self) -> quest_hook::libil2cpp::Result<TValue>
    where
        TValue: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
