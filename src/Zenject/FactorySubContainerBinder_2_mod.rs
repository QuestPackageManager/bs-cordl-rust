    ...
    for crate::Zenject::FactorySubContainerBinder_2<TParam1, TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactorySubContainerBinder`2")
                .unwrap()
...
impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    std::ops::DerefMut for crate::Zenject::FactorySubContainerBinder_2<TParam1, TContract>
{
