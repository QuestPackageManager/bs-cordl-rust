...
> {
    ...
    pub _onSpawnMethod: *mut crate::System::Action_8<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::StaticMemoryPool_8 < TParam1, TParam2,
    TParam3, TParam4, TParam5, TParam6, TParam7, TValue > => "Zenject"
    ."StaticMemoryPool`8" < TParam1, TParam2, TParam3, TParam4, TParam5, TParam6,
    TParam7, TValue >
);
#[cfg(feature = "Zenject+StaticMemoryPool_8")]
impl<
...
> {
    pub fn New(
        onSpawnMethod: *mut crate::System::Action_8<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = __cordl_object
            .invoke("Spawn", (p1, p2, p3, p4, p5, p6, p7))?;
        Ok(__cordl_ret)
    }
    pub fn _ctor(
        &mut self,
    ...
    pub fn set_OnSpawnMethod(
        &mut self,
        value: *mut crate::System::Action_8<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
