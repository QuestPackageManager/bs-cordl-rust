...
> {
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorByNewGameObjectMethod`3";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        "Zenject",
                        "SubContainerCreatorByNewGameObjectMethod`3",
                    )
                    .unwrap()
...
> crate::Zenject::SubContainerCreatorByNewGameObjectMethod_3<TParam1, TParam2, TParam3> {
    ...
    where
        ...
        TParam3: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByNewGameObjectMethod_3<
            TParam1,
            TParam2,
            TParam3,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByNewGameObjectMethod_3 <
                    TParam1, TParam2, TParam3 > as quest_hook::libil2cpp::Type >
