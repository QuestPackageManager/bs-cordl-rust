#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorByNewGameObjectMethod_3")]
#[repr(C)]
#[derive(Debug)]
...
unsafe impl<
    ...
    for crate::Zenject::SubContainerCreatorByNewGameObjectMethod_3<TParam1, TParam2, TParam3>
{
