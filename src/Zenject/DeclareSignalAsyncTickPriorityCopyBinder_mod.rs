#[cfg(feature = "cordl_class_Zenject+DeclareSignalAsyncTickPriorityCopyBinder")]
#[repr(C)]
...
impl crate::Zenject::DeclareSignalAsyncTickPriorityCopyBinder {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::SignalTickPriorityCopyBinder> =
