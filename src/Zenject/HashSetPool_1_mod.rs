...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::HashSetPool_1 < T > => "Zenject"
    ."HashSetPool`1" < T >
);
#[cfg(feature = "Zenject+HashSetPool_1")]
...
impl<T: quest_hook::libil2cpp::Type> crate::Zenject::HashSetPool_1<T> {
    ...
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::HashSetPool_1<T>> = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("get_Instance", ())?;
        Ok(__cordl_ret.into())
    }
}
