...
for crate::Zenject::SubContainerCreatorDynamicContext {
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorDynamicContext";
...
impl crate::Zenject::SubContainerCreatorDynamicContext {
    pub fn AddInstallers(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorDynamicContext as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorDynamicContext as
