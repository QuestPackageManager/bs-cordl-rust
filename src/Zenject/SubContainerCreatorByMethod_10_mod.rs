#[cfg(feature = "Zenject+SubContainerCreatorByMethod_10")]
#[repr(C)]
#[derive(Debug)]
pub struct SubContainerCreatorByMethod_10<
...
for crate::Zenject::SubContainerCreatorByMethod_10<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorByMethod`10";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        "Zenject",
                        "SubContainerCreatorByMethod`10",
                    )
                    .unwrap()
                    .make_generic::<
                        (
...
impl<
    ...
    TParam9: quest_hook::libil2cpp::Type,
    TParam10: quest_hook::libil2cpp::Type,
> crate::Zenject::SubContainerCreatorByMethod_10<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TParam10: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByMethod_10<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByMethod_10 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9,
                    TParam10 > as quest_hook::libil2cpp::Type > ::class(),
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByMethod_10 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9,
                    TParam10 > as quest_hook::libil2cpp::Type > ::class(), ".ctor",
                    3usize
                )
            });
