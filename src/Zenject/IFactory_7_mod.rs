...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::IFactory_7 < TParam1, TParam2, TParam3,
    TParam4, TParam5, TParam6, TValue > => "Zenject"."IFactory`7" < TParam1, TParam2,
