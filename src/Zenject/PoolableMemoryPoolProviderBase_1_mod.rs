...
> crate::Zenject::PoolableMemoryPoolProviderBase_1<TContract> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPoolProviderBase_1<
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPoolProviderBase_1 < TContract > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::PoolableMemoryPoolProviderBase_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "get_PoolId", 0usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::PoolableMemoryPoolProviderBase_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "set_PoolId", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (value))?
