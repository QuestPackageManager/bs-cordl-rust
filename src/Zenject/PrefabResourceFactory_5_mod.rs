...
unsafe impl<
        ...
        P4: quest_hook::libil2cpp::Type,
        T: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::Zenject::PrefabResourceFactory_5<P1, P2, P3, P4, T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PrefabResourceFactory`5")
                .unwrap()
    ...
    > crate::Zenject::PrefabResourceFactory_5<P1, P2, P3, P4, T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (prefabResourceName, param, param2, param3, param4))?
        };
        Ok(__cordl_ret.into())
    }
