...
#[cfg(feature = "Zenject+IPrefabProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::IPrefabProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "IPrefabProvider";
...
impl crate::Zenject::IPrefabProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IPrefabProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IPrefabProvider as quest_hook::libil2cpp::Type >
