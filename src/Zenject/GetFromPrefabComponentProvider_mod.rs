...
impl crate::Zenject::GetFromPrefabComponentProvider {
    pub fn GetAllInstancesWithInjectSplit(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::GetFromPrefabComponentProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::GetFromPrefabComponentProvider as
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method
                .invoke_unchecked(
                    self,
                    (componentType, prefabInstantiator, matchSingle),
                )?
        };
        Ok(__cordl_ret.into())
    }
