...
> crate::Zenject::FactoryFromBinder_1<TContract> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::FactoryFromBinder_1<
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::FactoryFromBinder_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "FromComponentInHierarchy",
                    1usize
                )
            });
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::ConditionCopyNonLazyBinder,
        > = unsafe { method.invoke_unchecked(self, (subIdentifier, method))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::ConditionCopyNonLazyBinder,
        > = unsafe { method.invoke_unchecked(self, (subIdentifier, method, source))? };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::FactoryFromBinder_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "FromSubContainerResolve",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
