...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenMemberSetterMethod {
    ...
    const CLASS_NAME: &'static str = "ZenMemberSetterMethod";
...
impl crate::Zenject::ZenMemberSetterMethod {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ZenMemberSetterMethod as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ZenMemberSetterMethod as quest_hook::libil2cpp::Type
                    > ::class(), "BeginInvoke", 4usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method.invoke_unchecked(self, (obj, value, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
