...
impl crate::Zenject::SubContainerDependencyProvider {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerDependencyProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    quest_hook::libil2cpp::Gc<crate::Zenject::InjectContext>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerDependencyProvider as
                    quest_hook::libil2cpp::Type > ::class(), "CreateSubContext", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::InjectContext> = unsafe {
            method.invoke_unchecked(self, (parent, subContainer))?
        };
        Ok(__cordl_ret.into())
    }
