#[cfg(feature = "cordl_class_Zenject+MemoryPool_5")]
#[repr(C)]
#[derive(Debug)]
...
impl<
        ...
        TParam4: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::MemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
    ...
    > crate::Zenject::MemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p1, p2, p3, p4, item))? };
        Ok(__cordl_ret.into())
    }
    pub fn Spawn(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TParam1, TParam2, TParam3, TParam4), TValue, 4usize>(
        ...
        let __cordl_ret: TValue =
            unsafe { cordl_method_info.invoke_unchecked(self, (p1, p2, p3, p4))? };
        Ok(__cordl_ret.into())
    }
    pub fn __zenCreate(
...
impl<
    ...
    for crate::Zenject::MemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
    fn as_ref(&self) -> &crate::Zenject::IFactory_5<TParam1, TParam2, TParam3, TParam4, TValue> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+MemoryPool_5")]
...
impl<
    ...
    for crate::Zenject::MemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
    fn as_ref(&self) -> &crate::Zenject::IMemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+MemoryPool_5")]
