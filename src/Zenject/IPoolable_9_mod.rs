#[cfg(feature = "cordl_class_Zenject+IPoolable_9")]
#[derive(Debug)]
#[repr(C)]
    ...
    >
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        TParam8,
                        TParam9,
                    ), quest_hook::libil2cpp::Void, 9usize>("OnSpawned")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (p1, p2, p3, p4, p5, p6, p7, p8, p9))?
        };
        Ok(__cordl_ret.into())
    }
