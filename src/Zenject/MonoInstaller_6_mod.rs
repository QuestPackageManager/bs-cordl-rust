...
for crate::Zenject::MonoInstaller_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MonoInstaller`6")
                    .unwrap()
                    .make_generic::<
                        (TParam1, TParam2, TParam3, TParam4, TParam5, TDerived),
                    >()
                    .unwrap()
                    .unwrap()
            })
...
> {
    ...
    where
        ...
        TDerived: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoInstaller_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoInstaller_6 < TParam1, TParam2, TParam3,
                    TParam4, TParam5, TDerived > as quest_hook::libil2cpp::Type >
                    ::class(), "InstallFromResource", 6usize
                )
            });
        let __cordl_ret: TDerived = unsafe {
            method.invoke_unchecked((), (container, p1, p2, p3, p4, p5))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoInstaller_6 < TParam1, TParam2, TParam3,
                    TParam4, TParam5, TDerived > as quest_hook::libil2cpp::Type >
                    ::class(), "InstallFromResource", 7usize
                )
            });
        let __cordl_ret: TDerived = unsafe {
            method.invoke_unchecked((), (resourcePath, container, p1, p2, p3, p4, p5))?
        };
        Ok(__cordl_ret.into())
    }
