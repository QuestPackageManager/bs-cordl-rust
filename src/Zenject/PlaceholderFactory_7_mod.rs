#[cfg(feature = "cordl_class_Zenject+PlaceholderFactory_7")]
#[repr(C)]
#[derive(Debug)]
    ...
    >
{
    ...
    const CLASS_NAME: &'static str = "PlaceholderFactory`7";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PlaceholderFactory`7")
                .unwrap()
