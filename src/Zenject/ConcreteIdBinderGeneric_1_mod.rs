#[cfg(feature = "cordl_class_Zenject+ConcreteIdBinderGeneric_1")]
#[repr(C)]
    ...
    for crate::Zenject::ConcreteIdBinderGeneric_1<TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "ConcreteIdBinderGeneric`1")
                .unwrap()
...
#[cfg(feature = "Zenject+ConcreteIdBinderGeneric_1")]
impl<TContract: quest_hook::libil2cpp::Type> crate::Zenject::ConcreteIdBinderGeneric_1<TContract> {
    pub fn New(
