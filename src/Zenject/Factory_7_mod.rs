#[cfg(feature = "cordl_class_Zenject+Factory_7")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct Factory_7<
...
> {
    __cordl_parent: crate::Zenject::PlaceholderFactory_7<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
unsafe impl<
    ...
    for crate::Zenject::Factory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "Factory`7";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "Factory`7")
                .unwrap()
...
impl<
    ...
    for crate::Zenject::Factory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>
{
    type Target = crate::Zenject::PlaceholderFactory_7<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
impl<
        ...
        TParam6: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > crate::Zenject::Factory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>
{
