#[cfg(feature = "Zenject+IFactoryProvider_1")]
#[repr(C)]
#[derive(Debug)]
pub struct IFactoryProvider_1<TContract: quest_hook::libil2cpp::Type> {
...
for crate::Zenject::IFactoryProvider_1<TContract> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "IFactoryProvider`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IFactoryProvider`1")
                    .unwrap()
...
> crate::Zenject::IFactoryProvider_1<TContract> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IFactoryProvider_1<
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IFactoryProvider_1 < TContract > as
