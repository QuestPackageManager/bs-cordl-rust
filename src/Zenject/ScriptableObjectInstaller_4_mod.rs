#[cfg(feature = "cordl_class_Zenject+ScriptableObjectInstaller_4")]
#[repr(C)]
#[derive(Debug)]
...
for crate::Zenject::ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived> {
    ...
    const CLASS_NAME: &'static str = "ScriptableObjectInstaller`4";
...
> crate::Zenject::ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TDerived = unsafe {
            cordl_method_info.invoke_unchecked((), (container, p1, p2, p3))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TDerived = unsafe {
            cordl_method_info
                .invoke_unchecked((), (resourcePath, container, p1, p2, p3))?
        };
        Ok(__cordl_ret.into())
    }
