...
impl crate::Zenject::SubContainerCreatorByMethodBase {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByMethodBase as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByMethodBase as
                    quest_hook::libil2cpp::Type > ::class(), "CreateEmptySubContainer",
                    0usize
                )
            });
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (container, containerBindInfo))?
        };
        Ok(__cordl_ret.into())
    }
}
