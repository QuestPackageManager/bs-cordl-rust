...
unsafe impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::Type for crate::Zenject::PrefabFactory_3<P1, P2, T> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "PrefabFactory`3";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PrefabFactory`3")
                    .unwrap()
                    .make_generic::<(P1, P2, T)>()
                    .unwrap()
                    .unwrap()
            })
    }
...
impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> std::ops::Deref for crate::Zenject::PrefabFactory_3<P1, P2, T> {
...
impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> std::ops::DerefMut for crate::Zenject::PrefabFactory_3<P1, P2, T> {
...
impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> crate::Zenject::PrefabFactory_3<P1, P2, T> {
    pub fn Create(
        &mut self,
    ...
    where
        ...
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabFactory_3<
            P1,
            P2,
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1, P2),
                T,
                3usize,
            >("Create")
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabFactory_3 < P1, P2, T > as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 3usize
                )
            });
        let __cordl_ret: T = unsafe {
            method.invoke_unchecked(self, (prefab, param, param2))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::PrefabFactory_3 < P1, P2, T > as
                    quest_hook::libil2cpp::Type > ::class(), "__zenFieldSetter0", 2usize
                )
            });
...
impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::ObjectType for crate::Zenject::PrefabFactory_3<P1, P2, T> {
...
impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> AsRef<crate::Zenject::IFactory> for crate::Zenject::PrefabFactory_3<P1, P2, T> {
...
impl<
    ...
    P2: quest_hook::libil2cpp::Type,
    T: quest_hook::libil2cpp::Type,
> AsMut<crate::Zenject::IFactory> for crate::Zenject::PrefabFactory_3<P1, P2, T> {
...
> AsRef<
    crate::Zenject::IFactory_4<
        ...
        T,
    >,
> for crate::Zenject::PrefabFactory_3<P1, P2, T> {
    fn as_ref(
        &self,
    ) -> &crate::Zenject::IFactory_4<
        quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>,
