#[cfg(feature = "cordl_class_Zenject+PoolableStaticMemoryPool_8")]
#[repr(C)]
#[derive(Debug)]
    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableStaticMemoryPool`8")
                .unwrap()
                .make_generic::<(
                    TParam1,
                    TParam2,
    ...
    >
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (p1, p2, p3, p4, p5, p6, p7, value))? };
        Ok(__cordl_ret.into())
    }
