...
for crate::Zenject::PrefabResourceBindingFinalizer {
    ...
    const CLASS_NAME: &'static str = "PrefabResourceBindingFinalizer";
...
impl crate::Zenject::PrefabResourceBindingFinalizer {
    pub fn FinalizeBindingConcrete(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabResourceBindingFinalizer as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabResourceBindingFinalizer as
