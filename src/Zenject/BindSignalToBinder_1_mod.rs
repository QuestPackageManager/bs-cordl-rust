...
> crate::Zenject::BindSignalToBinder_1<TSignal> {
    ...
    where
        TSignal: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::BindSignalToBinder_1<
            TSignal,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::BindSignalToBinder_1 < TSignal > as
                    quest_hook::libil2cpp::Type > ::class(), "ToMethod", 1usize
                )
            });
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::System::Action_2<TObject, TSignal>>),
                quest_hook::libil2cpp::Gc<
                    crate::Zenject::BindSignalFromBinder_2<TObject, TSignal>,
                >,
                1usize,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::BindSignalFromBinder_2<TObject, TSignal>,
        > = unsafe { method.invoke_unchecked(self, (handler))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::BindSignalFromBinder_2<TObject, TSignal>,
        > = unsafe { method.invoke_unchecked(self, (handlerGetter))? };
        Ok(__cordl_ret.into())
    }
