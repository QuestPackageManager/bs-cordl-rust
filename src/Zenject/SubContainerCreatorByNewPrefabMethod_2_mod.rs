#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorByNewPrefabMethod_2")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct SubContainerCreatorByNewPrefabMethod_2<
...
#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorByNewPrefabMethod_2")]
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TParam2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "SubContainerCreatorByNewPrefabMethod`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find(
                "Zenject",
                "SubContainerCreatorByNewPrefabMethod`2",
            )
            .unwrap()
...
#[cfg(feature = "Zenject+SubContainerCreatorByNewPrefabMethod_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TParam2: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>
{
...
#[cfg(feature = "Zenject+SubContainerCreatorByNewPrefabMethod_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TParam2: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>
{
...
#[cfg(feature = "Zenject+SubContainerCreatorByNewPrefabMethod_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TParam2: quest_hook::libil2cpp::Type>
    crate::Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>
{
