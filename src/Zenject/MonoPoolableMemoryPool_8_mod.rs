#[cfg(feature = "Zenject+MonoPoolableMemoryPool_8")]
#[repr(C)]
#[derive(Debug)]
pub struct MonoPoolableMemoryPool_8<
...
for crate::Zenject::MonoPoolableMemoryPool_8<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "MonoPoolableMemoryPool`8";
...
impl<
    ...
    TParam7: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::MonoPoolableMemoryPool_8<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoPoolableMemoryPool_8<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoPoolableMemoryPool_8 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TParam6, TParam7, TValue > as
