...
impl crate::Zenject::InitializableManager {
    ...
    pub fn Add_IInitializable0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::InitializableManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::InitializableManager as quest_hook::libil2cpp::Type
                    > ::class(), "Add", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (initializable))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Add_i32_1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::InitializableManager as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::Zenject::IInitializable>, i32),
                quest_hook::libil2cpp::Void,
                2usize,
            >("Add")
            .unwrap_or_else(|e| {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (initializable, priority))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Initialize(
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (initializables, priorities))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Zenject::InitializableManager_InitializableInfo {
    ...
    pub fn __zenCreate(
        ...
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::InitializableManager_InitializableInfo as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::InitializableManager_InitializableInfo as
