...
for crate::Zenject::MonoMemoryPool_1<TValue> {
    ...
    const CLASS_NAME: &'static str = "MonoMemoryPool`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MonoMemoryPool`1")
                    .unwrap()
                    .make_generic::<(TValue)>()
                    .unwrap()
                    .unwrap()
...
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::MonoMemoryPool_1<TValue> {
    ...
    where
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoMemoryPool_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoMemoryPool_1 < TValue > as
