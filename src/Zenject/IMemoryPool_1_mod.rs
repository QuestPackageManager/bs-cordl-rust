...
for crate::Zenject::IMemoryPool_1<TValue> {
    ...
    const CLASS_NAME: &'static str = "IMemoryPool`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IMemoryPool`1")
                    .unwrap()
                    .make_generic::<(TValue)>()
                    .unwrap()
                    .unwrap()
...
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::IMemoryPool_1<TValue> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IMemoryPool_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IMemoryPool_1 < TValue > as
