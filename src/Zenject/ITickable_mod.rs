...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ITickable {
    ...
    const CLASS_NAME: &'static str = "ITickable";
...
#[cfg(feature = "Zenject+ITickable")]
impl crate::Zenject::ITickable {
    pub fn Tick(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ITickable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Tick")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ITickable as quest_hook::libil2cpp::Type >
                    ::class(), "Tick", 0usize
                )
            });
