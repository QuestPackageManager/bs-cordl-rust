...
#[repr(C)]
#[derive(Debug)]
pub struct MemoryPoolIdInitialSizeMaxSizeBinder_1<TContract: quest_hook::libil2cpp::Type> {
    ...
    for crate::Zenject::MemoryPoolIdInitialSizeMaxSizeBinder_1<TContract>
{
    ...
    const CLASS_NAME: &'static str = "MemoryPoolIdInitialSizeMaxSizeBinder`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find(
                "Zenject",
                "MemoryPoolIdInitialSizeMaxSizeBinder`1",
            )
            .unwrap()
    ...
    crate::Zenject::MemoryPoolIdInitialSizeMaxSizeBinder_1<TContract>
{
    ...
    pub fn WithId(
        ...
        quest_hook::libil2cpp::Gc<crate::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>>,
    >
    where
        TContract: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
