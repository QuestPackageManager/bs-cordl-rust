...
> crate::Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::FactoryFromBinder_3<
            TParam1,
            TParam2,
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::FactoryFromBinder_3 < TParam1, TParam2, TContract >
                    as quest_hook::libil2cpp::Type > ::class(), "FromFactory", 0usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::FactoryFromBinder_3 < TParam1, TParam2, TContract >
                    as quest_hook::libil2cpp::Type > ::class(), "FromMethod", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::ConditionCopyNonLazyBinder,
