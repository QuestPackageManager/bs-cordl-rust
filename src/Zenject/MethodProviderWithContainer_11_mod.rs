...
> {
    ...
    pub _method: *mut crate::System::Func_12<
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::MethodProviderWithContainer_11 <
    TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9,
    TParam10, TValue > => "Zenject"."MethodProviderWithContainer`11" < TParam1, TParam2,
