#[cfg(feature = "cordl_class_Zenject+FactoryArgumentsToChoiceBinder_2")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct FactoryArgumentsToChoiceBinder_2<
    TParam1: quest_hook::libil2cpp::Type,
    TContract: quest_hook::libil2cpp::Type,
> {
    __cordl_parent: crate::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>,
...
unsafe impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    ...
    for crate::Zenject::FactoryArgumentsToChoiceBinder_2<TParam1, TContract>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "FactoryArgumentsToChoiceBinder`2";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryArgumentsToChoiceBinder`2")
                .unwrap()
...
#[cfg(feature = "Zenject+FactoryArgumentsToChoiceBinder_2")]
impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::Zenject::FactoryArgumentsToChoiceBinder_2<TParam1, TContract>
{
    type Target = crate::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>;
...
impl<TParam1: quest_hook::libil2cpp::Type, TContract: quest_hook::libil2cpp::Type>
    std::ops::DerefMut for crate::Zenject::FactoryArgumentsToChoiceBinder_2<TParam1, TContract>
{
    ...
    crate::Zenject::FactoryArgumentsToChoiceBinder_2<TParam1, TContract>
{
    ...
    pub fn WithFactoryArgumentsExplicit(
        ...
        quest_hook::libil2cpp::Gc<crate::Zenject::FactoryToChoiceBinder_2<TParam1, TContract>>,
    >
    where
        TParam1: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
