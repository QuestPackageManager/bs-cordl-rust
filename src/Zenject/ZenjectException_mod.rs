...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ZenjectException {
    ...
    const CLASS_NAME: &'static str = "ZenjectException";
...
impl crate::Zenject::ZenjectException {
    ...
    pub fn _ctor_Exception1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ZenjectException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ZenjectException as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 2usize
                )
            });
