#[cfg(feature = "cordl_class_Zenject+KeyedFactory_3")]
#[repr(C)]
#[derive(Debug)]
...
unsafe impl<
        ...
        TKey: quest_hook::libil2cpp::Type,
        TParam1: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type for crate::Zenject::KeyedFactory_3<TBase, TKey, TParam1>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "KeyedFactory`3";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "KeyedFactory`3")
                .unwrap()
                .make_generic::<(TBase, TKey, TParam1)>()
                .unwrap()
                .unwrap()
        })
    }
...
{
    pub fn Create(&mut self, key: TKey, param1: TParam1) -> quest_hook::libil2cpp::Result<TBase>
    where
        TBase: quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TKey, TParam1), TBase, 2usize>("Create")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: TBase =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, param1))? };
        Ok(__cordl_ret.into())
    }
...
impl<
        ...
        TKey: quest_hook::libil2cpp::Type,
        TParam1: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::ObjectType for crate::Zenject::KeyedFactory_3<TBase, TKey, TParam1>
{
