...
> crate::Zenject::KeyedFactory_3<TBase, TKey, TParam1> {
    ...
    where
        ...
        TParam1: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::KeyedFactory_3<
            TBase,
            TKey,
            TParam1,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::KeyedFactory_3 < TBase, TKey, TParam1 > as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 2usize
                )
            });
        let __cordl_ret: TBase = unsafe {
            method.invoke_unchecked(self, (key, param1))?
        };
        Ok(__cordl_ret.into())
    }
