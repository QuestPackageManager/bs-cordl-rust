    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableMemoryPoolProvider`5")
                .unwrap()
                .make_generic::<(TParam1, TParam2, TParam3, TContract, TMemoryPool)>()
                .unwrap()
                .unwrap()
        })
    }
...
impl<
        ...
        TMemoryPool: quest_hook::libil2cpp::Type,
    >
    crate::Zenject::PoolableMemoryPoolProvider_5<TParam1, TParam2, TParam3, TContract, TMemoryPool>
{
