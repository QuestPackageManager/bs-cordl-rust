#[cfg(feature = "Zenject+IPoolable_11")]
#[repr(C)]
#[derive(Debug)]
pub struct IPoolable_11<
    ...
    TParam11: quest_hook::libil2cpp::Type,
> {
    ...
    __cordl_phantom_TParam11: std::marker::PhantomData<TParam11>,
}
#[cfg(feature = "Zenject+IPoolable_11")]
unsafe impl<
    TParam1: quest_hook::libil2cpp::Type,
...
for crate::Zenject::IPoolable_11<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "IPoolable`11";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IPoolable`11")
                    .unwrap()
                    .make_generic::<
                        (
                            TParam1,
...
> {
    ...
    where
        ...
        TParam10: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
        TParam11: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::IPoolable_11<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IPoolable_11 < TParam1, TParam2, TParam3, TParam4,
                    TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TParam11 > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::IPoolable_11 < TParam1, TParam2, TParam3, TParam4,
                    TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TParam11 > as
                    quest_hook::libil2cpp::Type > ::class(), "OnSpawned", 11usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method
                .invoke_unchecked(self, (p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11))?
        };
        Ok(__cordl_ret.into())
    }
