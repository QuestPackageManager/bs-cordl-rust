#[cfg(feature = "cordl_class_Zenject+ScriptableObjectInstallerBase")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Zenject+ScriptableObjectInstallerBase")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ScriptableObjectInstallerBase {
...
impl crate::Zenject::ScriptableObjectInstallerBase {
    ...
    pub fn Zenject_IInstaller_get_IsEnabled(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_Zenject+ScriptableObjectInstallerBase")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::ScriptableObjectInstallerBase {
...
#[cfg(feature = "Zenject+ScriptableObjectInstallerBase")]
impl AsRef<crate::Zenject::IInstaller> for crate::Zenject::ScriptableObjectInstallerBase {
    fn as_ref(&self) -> &crate::Zenject::IInstaller {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Zenject+ScriptableObjectInstallerBase")]
impl AsMut<crate::Zenject::IInstaller> for crate::Zenject::ScriptableObjectInstallerBase {
