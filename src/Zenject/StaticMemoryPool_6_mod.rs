...
> {
    ...
    pub _onSpawnMethod: *mut crate::System::Action_6<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::StaticMemoryPool_6 < TParam1, TParam2,
    TParam3, TParam4, TParam5, TValue > => "Zenject"."StaticMemoryPool`6" < TParam1,
...
> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: TValue = __cordl_object.invoke("Spawn", (p1, p2, p3, p4, p5))?;
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
