...
for crate::Zenject::StaticMemoryPool_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
impl<
    ...
    TParam5: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::StaticMemoryPool_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::StaticMemoryPool_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::StaticMemoryPool_6 < TParam1, TParam2, TParam3,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::StaticMemoryPool_6 < TParam1, TParam2, TParam3,
                    TParam4, TParam5, TValue > as quest_hook::libil2cpp::Type >
                    ::class(), "set_OnSpawnMethod", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
...
> {
    fn as_mut(
        &mut self,
    ) -> &mut crate::Zenject::IMemoryPool_6<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
