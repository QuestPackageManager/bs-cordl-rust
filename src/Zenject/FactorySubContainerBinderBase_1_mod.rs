#[cfg(feature = "cordl_class_Zenject+FactorySubContainerBinderBase_1")]
#[repr(C)]
#[derive(Debug)]
pub struct FactorySubContainerBinderBase_1<TContract: quest_hook::libil2cpp::Type> {
    ...
    pub _FactoryBindInfo_k__BackingField:
    ...
    pub _SubIdentifier_k__BackingField:
    ...
    for crate::Zenject::FactorySubContainerBinderBase_1<TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactorySubContainerBinderBase`1")
                .unwrap()
    ...
    crate::Zenject::FactorySubContainerBinderBase_1<TContract>
{
    ...
    pub fn get_FactoryBindInfo(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::Zenject::FactoryBindInfo>>
    where
        TContract: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::Zenject::FactoryBindInfo> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Func_2<
                            ...
                            quest_hook::libil2cpp::Gc<crate::Zenject::IProvider>,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("set_ProviderFunc")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
