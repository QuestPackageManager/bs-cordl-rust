...
#[cfg(feature = "Zenject+ILateTickable")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ILateTickable {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ILateTickable";
...
impl crate::Zenject::ILateTickable {
    pub fn LateTick(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ILateTickable as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("LateTick")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::ILateTickable as quest_hook::libil2cpp::Type >
                    ::class(), "LateTick", 0usize
                )
            });
