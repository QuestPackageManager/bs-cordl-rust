...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::PoolableStaticMemoryPool_7 < TParam1,
    TParam2, TParam3, TParam4, TParam5, TParam6, TValue > => "Zenject"
    ."PoolableStaticMemoryPool`7" < TParam1, TParam2, TParam3, TParam4, TParam5, TParam6,
    TValue >
);
#[cfg(feature = "Zenject+PoolableStaticMemoryPool_7")]
impl<
...
> {
    ...
    {
        let __cordl_ret: quest_hook::libil2cpp::Void = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("OnSpawned", (p1, p2, p3, p4, p5, p6, value))?;
        Ok(__cordl_ret.into())
    }
