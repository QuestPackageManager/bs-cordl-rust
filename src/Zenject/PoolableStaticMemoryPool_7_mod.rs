#[cfg(feature = "Zenject+PoolableStaticMemoryPool_7")]
#[repr(C)]
#[derive(Debug)]
pub struct PoolableStaticMemoryPool_7<
...
for crate::Zenject::PoolableStaticMemoryPool_7<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "PoolableStaticMemoryPool`7";
...
impl<
    ...
    TParam6: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableStaticMemoryPool_7<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableStaticMemoryPool_7<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableStaticMemoryPool_7 < TParam1, TParam2,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableStaticMemoryPool_7 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TParam6, TValue > as
                    quest_hook::libil2cpp::Type > ::class(), "OnSpawned", 7usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (p1, p2, p3, p4, p5, p6, value))?
        };
        Ok(__cordl_ret.into())
    }
