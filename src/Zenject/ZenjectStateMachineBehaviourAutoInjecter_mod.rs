...
for crate::Zenject::ZenjectStateMachineBehaviourAutoInjecter {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "ZenjectStateMachineBehaviourAutoInjecter";
...
#[cfg(feature = "Zenject+ZenjectStateMachineBehaviourAutoInjecter")]
impl crate::Zenject::ZenjectStateMachineBehaviourAutoInjecter {
    pub fn Construct(
        &mut self,
        container: quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ZenjectStateMachineBehaviourAutoInjecter as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ZenjectStateMachineBehaviourAutoInjecter as
