...
> crate::Zenject::DecoratorToChoiceFromBinder_1<TContract> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::DecoratorToChoiceFromBinder_1<
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::DecoratorToChoiceFromBinder_1 < TContract > as
                    quest_hook::libil2cpp::Type > ::class(), "With", 0usize
                )
            });
