#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorByMethod_3")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct SubContainerCreatorByMethod_3<
    ...
    for crate::Zenject::SubContainerCreatorByMethod_3<TParam1, TParam2, TParam3>
{
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorByMethod`3";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "SubContainerCreatorByMethod`3")
                .unwrap()
...
#[cfg(feature = "Zenject+SubContainerCreatorByMethod_3")]
impl<
        TParam1: quest_hook::libil2cpp::Type,
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::SubContainerCreatorByMethod_3<TParam1, TParam2, TParam3>
{
...
impl<
        ...
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
    > crate::Zenject::SubContainerCreatorByMethod_3<TParam1, TParam2, TParam3>
{
