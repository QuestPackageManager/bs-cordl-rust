...
> crate::Zenject::SubContainerCreatorByMethod_3<TParam1, TParam2, TParam3> {
    ...
    where
        ...
        TParam3: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByMethod_3<
            TParam1,
            TParam2,
            TParam3,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByMethod_3 < TParam1, TParam2,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::SubContainerCreatorByMethod_3 < TParam1, TParam2,
                    TParam3 > as quest_hook::libil2cpp::Type > ::class(), ".ctor", 3usize
                )
            });
