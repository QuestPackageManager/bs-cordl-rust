#[cfg(feature = "cordl_class_Zenject+PoolableMemoryPool_8")]
#[repr(C)]
    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PoolableMemoryPool`8")
                .unwrap()
                .make_generic::<(
                    TParam1,
                    TParam2,
    ...
    >
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        TParam7,
                        TValue,
                    ), quest_hook::libil2cpp::Void, 8usize>("Reinitialize")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (p1, p2, p3, p4, p5, p6, p7, item))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn __zenCreate(
