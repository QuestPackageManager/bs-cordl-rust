#[cfg(feature = "Zenject+PoolableMemoryPool_8")]
#[repr(C)]
#[derive(Debug)]
pub struct PoolableMemoryPool_8<
...
> {
    __cordl_parent: crate::Zenject::MemoryPool_8<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
for crate::Zenject::PoolableMemoryPool_8<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    const CLASS_NAME: &'static str = "PoolableMemoryPool`8";
...
for crate::Zenject::PoolableMemoryPool_8<
    ...
    TValue,
> {
    type Target = crate::Zenject::MemoryPool_8<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
impl<
    ...
    TParam7: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::PoolableMemoryPool_8<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PoolableMemoryPool_8<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPool_8 < TParam1, TParam2, TParam3,
                    TParam4, TParam5, TParam6, TParam7, TValue > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PoolableMemoryPool_8 < TParam1, TParam2, TParam3,
                    TParam4, TParam5, TParam6, TParam7, TValue > as
                    quest_hook::libil2cpp::Type > ::class(), "Reinitialize", 8usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p1, p2, p3, p4, p5, p6, p7, item))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn __zenCreate(
