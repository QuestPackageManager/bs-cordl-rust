#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceIdBinder_4")]
#[repr(C)]
#[derive(Debug)]
...
> {
    __cordl_parent:
        crate::Zenject::FactoryArgumentsToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>,
    ...
    for crate::Zenject::FactoryToChoiceIdBinder_4<TParam1, TParam2, TParam3, TContract>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceIdBinder`4")
                .unwrap()
