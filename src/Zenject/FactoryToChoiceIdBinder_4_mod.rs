#[cfg(feature = "Zenject+FactoryToChoiceIdBinder_4")]
#[repr(C)]
#[derive(Debug)]
pub struct FactoryToChoiceIdBinder_4<
...
for crate::Zenject::FactoryToChoiceIdBinder_4<TParam1, TParam2, TParam3, TContract> {
    ...
    const CLASS_NAME: &'static str = "FactoryToChoiceIdBinder`4";
...
> crate::Zenject::FactoryToChoiceIdBinder_4<TParam1, TParam2, TParam3, TContract> {
    ...
    where
        ...
        TContract: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::FactoryToChoiceIdBinder_4<
            TParam1,
            TParam2,
            TParam3,
            TContract,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::FactoryToChoiceIdBinder_4 < TParam1, TParam2,
                    TParam3, TContract > as quest_hook::libil2cpp::Type > ::class(),
                    "WithId", 1usize
                )
            });
