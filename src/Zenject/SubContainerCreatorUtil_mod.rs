#[cfg(feature = "cordl_class_Zenject+SubContainerCreatorUtil")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::Zenject::SubContainerCreatorUtil {
    pub fn ApplyBindSettings(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("ApplyBindSettings")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (subContainerBindInfo, subContainer))?
        };
        Ok(__cordl_ret.into())
    }
}
