...
impl crate::Zenject::SubContainerCreatorUtil {
    pub fn ApplyBindSettings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorUtil as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorUtil as
                    quest_hook::libil2cpp::Type > ::class(), "ApplyBindSettings", 2usize
                )
            });
