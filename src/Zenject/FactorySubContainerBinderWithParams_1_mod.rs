...
pub struct FactorySubContainerBinderWithParams_1<TContract: quest_hook::libil2cpp::Type> {
    ...
    crate::Zenject::FactorySubContainerBinderWithParams_1<TContract>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder,
                    >, 2usize>("ByNewContextPrefabResource")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (installerType, resourcePath))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (installerType, prefab))? };
        Ok(__cordl_ret.into())
    }
