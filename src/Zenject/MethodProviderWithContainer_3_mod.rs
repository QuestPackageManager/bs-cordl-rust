#[cfg(feature = "cordl_class_Zenject+MethodProviderWithContainer_3")]
#[repr(C)]
    ...
    for crate::Zenject::MethodProviderWithContainer_3<TParam1, TParam2, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MethodProviderWithContainer`3")
                .unwrap()
...
impl<
        ...
        TParam2: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    > std::ops::Deref for crate::Zenject::MethodProviderWithContainer_3<TParam1, TParam2, TValue>
{
