#[cfg(feature = "Zenject+MethodProviderWithContainer_3")]
#[repr(C)]
#[derive(Debug)]
pub struct MethodProviderWithContainer_3<
...
for crate::Zenject::MethodProviderWithContainer_3<TParam1, TParam2, TValue> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "MethodProviderWithContainer`3";
...
impl<
    ...
    TParam2: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::MethodProviderWithContainer_3<TParam1, TParam2, TValue> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MethodProviderWithContainer_3<
            TParam1,
            TParam2,
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MethodProviderWithContainer_3 < TParam1, TParam2,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::MethodProviderWithContainer_3 < TParam1, TParam2,
                    TValue > as quest_hook::libil2cpp::Type > ::class(), "get_IsCached",
                    0usize
                )
            });
