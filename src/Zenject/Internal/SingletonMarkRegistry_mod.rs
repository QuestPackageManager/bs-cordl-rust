...
#[cfg(feature = "cordl_class_Zenject+Internal+SingletonMarkRegistry")]
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::Internal::SingletonMarkRegistry {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject.Internal";
    const CLASS_NAME: &'static str = "SingletonMarkRegistry";
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Unmark",
                            1usize
                        )
                    })
            });
...
#[cfg(feature = "cordl_class_Zenject+Internal+SingletonMarkRegistry")]
impl quest_hook::libil2cpp::ObjectType for crate::Zenject::Internal::SingletonMarkRegistry {
