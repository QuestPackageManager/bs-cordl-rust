...
> crate::Zenject::MemoryPool_3<TParam1, TParam2, TValue> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MemoryPool_3<
            TParam1,
            TParam2,
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MemoryPool_3 < TParam1, TParam2, TValue > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    "Zenject.IFactory<TParam1,TParam2,TValue>.Create", 2usize
                )
            });
