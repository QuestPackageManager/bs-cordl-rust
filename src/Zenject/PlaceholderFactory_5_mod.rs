#[cfg(feature = "cordl_class_Zenject+PlaceholderFactory_5")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Zenject::PlaceholderFactory_5<TParam1, TParam2, TParam3, TParam4, TValue>
{
    ...
    const CLASS_NAME: &'static str = "PlaceholderFactory`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "PlaceholderFactory`5")
                .unwrap()
