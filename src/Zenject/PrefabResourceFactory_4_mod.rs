...
> crate::Zenject::PrefabResourceFactory_4<P1, P2, P3, T> {
    ...
    where
        ...
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabResourceFactory_4<
            P1,
            P2,
            P3,
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabResourceFactory_4 < P1, P2, P3, T > as
                    quest_hook::libil2cpp::Type > ::class(), "Create", 4usize
                )
            });
        let __cordl_ret: T = unsafe {
            method.invoke_unchecked(self, (prefabResourceName, param, param2, param3))?
        };
        Ok(__cordl_ret.into())
    }
