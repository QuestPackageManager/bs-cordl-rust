...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::PrefabResourceFactory_4 < P1, P2, P3, T
    > => "Zenject"."PrefabResourceFactory`4" < P1, P2, P3, T >
);
#[cfg(feature = "Zenject+PrefabResourceFactory_4")]
impl<
    P1: quest_hook::libil2cpp::Type,
...
> crate::Zenject::PrefabResourceFactory_4<P1, P2, P3, T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = __cordl_object
            .invoke("Create", (prefabResourceName, param, param2, param3))?;
        Ok(__cordl_ret.into())
    }
...
impl<
    ...
    T: quest_hook::libil2cpp::Type,
> AsRef<
    crate::Zenject::IFactory_5<*mut quest_hook::libil2cpp::Il2CppString, P1, P2, P3, T>,
> for crate::Zenject::PrefabResourceFactory_4<P1, P2, P3, T> {
    fn as_ref(
        &self,
