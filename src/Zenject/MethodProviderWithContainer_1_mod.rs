...
pub struct MethodProviderWithContainer_1<TValue: quest_hook::libil2cpp::Type> {
    ...
    pub _method: quest_hook::libil2cpp::Gc<
        crate::System::Func_2<quest_hook::libil2cpp::Gc<crate::Zenject::DiContainer>, TValue>,
    >,
    ...
    for crate::Zenject::MethodProviderWithContainer_1<TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MethodProviderWithContainer`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Zenject+MethodProviderWithContainer_1")]
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::MethodProviderWithContainer_1<TValue> {
