#[cfg(feature = "cordl_class_Zenject+FactoryToChoiceBinder_5")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct FactoryToChoiceBinder_5<
...
unsafe impl<
    ...
    for crate::Zenject::FactoryToChoiceBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Zenject";
    const CLASS_NAME: &'static str = "FactoryToChoiceBinder`5";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryToChoiceBinder`5")
                .unwrap()
...
#[cfg(feature = "Zenject+FactoryToChoiceBinder_5")]
impl<
        TParam1: quest_hook::libil2cpp::Type,
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
    ...
    > crate::Zenject::FactoryToChoiceBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>
{
    ...
    pub fn To<TConcrete>(
        ...
        quest_hook::libil2cpp::Gc<
            crate::Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TConcrete>,
        >,
    >
    where
        TParam1: quest_hook::libil2cpp::Type
