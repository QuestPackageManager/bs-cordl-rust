#[cfg(feature = "cordl_class_Zenject+IDespawnableMemoryPool_1")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::Zenject::IDespawnableMemoryPool_1<TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "IDespawnableMemoryPool`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Zenject+IDespawnableMemoryPool_1")]
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::IDespawnableMemoryPool_1<TValue> {
    pub fn Despawn(
        &mut self,
        item: TValue,
