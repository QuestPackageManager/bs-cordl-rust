...
for crate::Zenject::SubContainerCreatorByNewPrefabMethod_1<TParam1> {
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorByNewPrefabMethod`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        "Zenject",
                        "SubContainerCreatorByNewPrefabMethod`1",
                    )
                    .unwrap()
...
> crate::Zenject::SubContainerCreatorByNewPrefabMethod_1<TParam1> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByNewPrefabMethod_1<
            TParam1,
