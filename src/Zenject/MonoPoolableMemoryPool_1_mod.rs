    ...
    for crate::Zenject::MonoPoolableMemoryPool_1<TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MonoPoolableMemoryPool`1")
                .unwrap()
                .make_generic::<(TValue)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Zenject+MonoPoolableMemoryPool_1")]
impl<TValue: quest_hook::libil2cpp::Type> crate::Zenject::MonoPoolableMemoryPool_1<TValue> {
