...
for crate::Zenject::MonoPoolableMemoryPool_1<TValue> {
    ...
    const CLASS_NAME: &'static str = "MonoPoolableMemoryPool`1";
...
> crate::Zenject::MonoPoolableMemoryPool_1<TValue> {
    ...
    where
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoPoolableMemoryPool_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoPoolableMemoryPool_1 < TValue > as
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoPoolableMemoryPool_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(TValue), quest_hook::libil2cpp::Void, 1usize>("Reinitialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::MonoPoolableMemoryPool_1 < TValue > as
