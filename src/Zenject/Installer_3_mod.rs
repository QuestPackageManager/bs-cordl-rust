...
for crate::Zenject::Installer_3<TParam1, TParam2, TDerived> {
    ...
    const CLASS_NAME: &'static str = "Installer`3";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find("Zenject", "Installer`3")
                    .unwrap()
...
> crate::Zenject::Installer_3<TParam1, TParam2, TDerived> {
    ...
    where
        ...
        TDerived: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::Installer_3<
            TParam1,
            TParam2,
            TDerived,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::Installer_3 < TParam1, TParam2, TDerived > as
                    quest_hook::libil2cpp::Type > ::class(), "Install", 3usize
                )
            });
