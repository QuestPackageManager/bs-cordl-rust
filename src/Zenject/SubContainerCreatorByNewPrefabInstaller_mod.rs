...
for crate::Zenject::SubContainerCreatorByNewPrefabInstaller {
    ...
    const CLASS_NAME: &'static str = "SubContainerCreatorByNewPrefabInstaller";
...
impl crate::Zenject::SubContainerCreatorByNewPrefabInstaller {
    pub fn AddInstallers(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::SubContainerCreatorByNewPrefabInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::SubContainerCreatorByNewPrefabInstaller as
