...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::IFactory_10 < TParam1, TParam2,
    TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TValue > => "Zenject"
    ."IFactory`10" < TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7,
    TParam8, TParam9, TValue >
);
#[cfg(feature = "Zenject+IFactory_10")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
