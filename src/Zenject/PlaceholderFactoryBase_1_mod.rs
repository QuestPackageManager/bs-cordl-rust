...
> crate::Zenject::PlaceholderFactoryBase_1<TValue> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PlaceholderFactoryBase_1<
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PlaceholderFactoryBase_1 < TValue > as
                    quest_hook::libil2cpp::Type > ::class(), "Construct", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (provider, injectContext))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Zenject::PlaceholderFactoryBase_1 < TValue > as
                    quest_hook::libil2cpp::Type > ::class(), "CreateInternal", 1usize
                )
            });
        let __cordl_ret: TValue = unsafe { method.invoke_unchecked(self, (extraArgs))? };
        Ok(__cordl_ret.into())
    }
