#[cfg(feature = "Zenject+FactoryArgumentsToChoiceBinder_5")]
#[repr(C)]
#[derive(Debug)]
pub struct FactoryArgumentsToChoiceBinder_5<
...
> {
    __cordl_parent: crate::Zenject::FactoryToChoiceBinder_5<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::FactoryArgumentsToChoiceBinder_5 <
    TParam1, TParam2, TParam3, TParam4, TContract > => "Zenject"
    ."FactoryArgumentsToChoiceBinder`5" < TParam1, TParam2, TParam3, TParam4, TContract >
);
#[cfg(feature = "Zenject+FactoryArgumentsToChoiceBinder_5")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
    ...
    TContract: quest_hook::libil2cpp::Type,
> std::ops::Deref
for crate::Zenject::FactoryArgumentsToChoiceBinder_5<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
    TContract,
> {
    type Target = crate::Zenject::FactoryToChoiceBinder_5<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
...
> {
    ...
    pub fn WithFactoryArgumentsExplicit(
        ...
        *mut crate::Zenject::FactoryToChoiceBinder_5<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::Zenject::FactoryToChoiceBinder_5<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
