#[cfg(feature = "cordl_class_Zenject+FactoryArgumentsToChoiceBinder_5")]
#[repr(C)]
...
> {
    __cordl_parent:
        crate::Zenject::FactoryToChoiceBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>,
    ...
    >
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "FactoryArgumentsToChoiceBinder`5")
                .unwrap()
...
impl<
        ...
        TContract: quest_hook::libil2cpp::Type,
    >
    crate::Zenject::FactoryArgumentsToChoiceBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>
{
    pub fn New(
