...
unsafe impl quest_hook::libil2cpp::Type for crate::Zenject::ScriptableObjectInstaller {
    ...
    const CLASS_NAME: &'static str = "ScriptableObjectInstaller";
...
impl crate::Zenject::ScriptableObjectInstaller {
    ...
    pub fn __zenCreate(
        ...
        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::ScriptableObjectInstaller as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::ScriptableObjectInstaller as
