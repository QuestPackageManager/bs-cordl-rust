...
#[repr(C)]
#[derive(Debug)]
pub struct SubContainerCreatorByNewPrefabMethod_4<
...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Zenject::SubContainerCreatorByNewPrefabMethod_4
    < TParam1, TParam2, TParam3, TParam4 > => "Zenject"
    ."SubContainerCreatorByNewPrefabMethod`4" < TParam1, TParam2, TParam3, TParam4 >
);
#[cfg(feature = "Zenject+SubContainerCreatorByNewPrefabMethod_4")]
impl<
    TParam1: quest_hook::libil2cpp::Type,
    ...
    TParam4: quest_hook::libil2cpp::Type,
> std::ops::Deref
for crate::Zenject::SubContainerCreatorByNewPrefabMethod_4<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
impl<
    ...
    TParam3: quest_hook::libil2cpp::Type,
    TParam4: quest_hook::libil2cpp::Type,
> crate::Zenject::SubContainerCreatorByNewPrefabMethod_4<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
> {
    #[cfg(
        feature = "Zenject+SubContainerCreatorByNewPrefabMethod_4+__c__DisplayClass2_0"
    )]
    pub type __c__DisplayClass2_0 = crate::Zenject::SubContainerCreatorByNewPrefabMethod_4___c__DisplayClass2_0<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
