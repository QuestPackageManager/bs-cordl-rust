...
> crate::Zenject::PrefabFactory_4<P1, P2, P3, T> {
    ...
    where
        ...
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::PrefabFactory_4<
            P1,
            P2,
            P3,
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (quest_hook::libil2cpp::Gc<crate::UnityEngine::Object>, P1, P2, P3),
                T,
                4usize,
            >("Create")
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::PrefabFactory_4 < P1, P2, P3, T > as
