#[cfg(feature = "cordl_class_Zenject+MonoPoolableMemoryPool_6")]
#[repr(C)]
#[derive(Debug)]
pub struct MonoPoolableMemoryPool_6<
...
unsafe impl<
    ...
    for crate::Zenject::MonoPoolableMemoryPool_6<
        TParam1,
        TParam2,
        TParam3,
        TParam4,
    ...
    >
{
    ...
    const CLASS_NAME: &'static str = "MonoPoolableMemoryPool`6";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Zenject", "MonoPoolableMemoryPool`6")
                .unwrap()
                .make_generic::<(TParam1, TParam2, TParam3, TParam4, TParam5, TValue)>()
                .unwrap()
                .unwrap()
        })
    }
...
#[cfg(feature = "Zenject+MonoPoolableMemoryPool_6")]
impl<
        TParam1: quest_hook::libil2cpp::Type,
        TParam2: quest_hook::libil2cpp::Type,
        TParam3: quest_hook::libil2cpp::Type,
    ...
    >
{
    type Target = crate::Zenject::MemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>;
...
impl<
        ...
        TValue: quest_hook::libil2cpp::Type,
    >
    crate::Zenject::MonoPoolableMemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (TParam1, TParam2, TParam3, TParam4, TParam5, TValue),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (p1, p2, p3, p4, p5, item))? };
        Ok(__cordl_ret.into())
    }
    pub fn __zenCreate(
