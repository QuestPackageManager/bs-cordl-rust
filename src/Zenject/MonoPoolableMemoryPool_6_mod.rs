...
impl<
    ...
    TParam5: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Zenject::MonoPoolableMemoryPool_6<
    TParam1,
    TParam2,
    TParam3,
    TParam4,
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Zenject::MonoPoolableMemoryPool_6<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoPoolableMemoryPool_6 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TValue > as quest_hook::libil2cpp::Type >
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Zenject::MonoPoolableMemoryPool_6 < TParam1, TParam2,
                    TParam3, TParam4, TParam5, TValue > as quest_hook::libil2cpp::Type >
                    ::class(), "Reinitialize", 6usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (p1, p2, p3, p4, p5, item))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn __zenCreate(
