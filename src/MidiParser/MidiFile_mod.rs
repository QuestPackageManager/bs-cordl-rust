...
pub struct MidiFile {
    ...
    pub tracks: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<quest_hook::libil2cpp::Gc<crate::MidiParser::MidiTrack>>,
    >,
    pub tracksCount: i32,
}
#[cfg(feature = "cordl_class_MidiParser+MidiFile")]
unsafe impl quest_hook::libil2cpp::Type for crate::MidiParser::MidiFile {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "MidiParser";
    const CLASS_NAME: &'static str = "MidiFile";
...
impl crate::MidiParser::MidiFile {
    ...
    pub fn ParseMetaEvent(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (data, position, metaEventType, data1, data2))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ParseTrack(
        ...
        data: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
        position: quest_hook::libil2cpp::ByRefMut<i32>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<crate::MidiParser::MidiTrack>>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), quest_hook::libil2cpp::Gc<crate::MidiParser::MidiTrack>, 3usize>(
                        "ParseTrack",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::MidiParser::MidiTrack> =
            unsafe { cordl_method_info.invoke_unchecked((), (index, data, position))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_MidiParser+MidiFile+Reader")]
unsafe impl quest_hook::libil2cpp::Type for crate::MidiParser::MidiFile_Reader {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "MidiParser";
...
impl crate::MidiParser::MidiFile_Reader {
    pub fn Read16(
        ...
        let __cordl_ret: i32 = unsafe { cordl_method_info.invoke_unchecked((), (data, i))? };
        Ok(__cordl_ret.into())
    }
    pub fn Read32(
        data: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<u8>>,
    ...
    pub fn Read8(
        ...
        let __cordl_ret: u8 = unsafe { cordl_method_info.invoke_unchecked((), (data, i))? };
        Ok(__cordl_ret.into())
    }
