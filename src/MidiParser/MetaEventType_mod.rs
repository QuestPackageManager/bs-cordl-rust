#[cfg(feature = "cordl_class_MidiParser+MetaEventType")]
...
#[cfg(feature = "cordl_class_MidiParser+MetaEventType")]
unsafe impl quest_hook::libil2cpp::Type for crate::MidiParser::MetaEventType {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "MidiParser";
    const CLASS_NAME: &'static str = "MetaEventType";
