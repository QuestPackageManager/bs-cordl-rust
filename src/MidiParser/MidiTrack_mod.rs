...
unsafe impl quest_hook::libil2cpp::Type for crate::MidiParser::MidiTrack {
    ...
    const CLASS_NAME: &'static str = "MidiTrack";
...
impl crate::MidiParser::MidiTrack {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::MidiParser::MidiTrack as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::MidiParser::MidiTrack as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
