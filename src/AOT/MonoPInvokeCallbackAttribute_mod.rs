...
impl crate::AOT::MonoPInvokeCallbackAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::AOT::MonoPInvokeCallbackAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::AOT::MonoPInvokeCallbackAttribute as
