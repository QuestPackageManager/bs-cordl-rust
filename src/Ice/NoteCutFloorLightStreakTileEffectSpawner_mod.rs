...
impl crate::Ice::NoteCutFloorLightStreakTileEffectSpawner {
    pub fn HandleNoteWasCut(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Ice::NoteCutFloorLightStreakTileEffectSpawner as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Ice::NoteCutFloorLightStreakTileEffectSpawner as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Ice::NoteCutFloorLightStreakTileEffectSpawner as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Ice::NoteCutFloorLightStreakTileEffectSpawner as
                    quest_hook::libil2cpp::Type > ::class(), "get_spawnColor", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Ice::NoteCutFloorLightStreakTileEffectSpawner as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Ice::NoteCutFloorLightStreakTileEffectSpawner as
                    quest_hook::libil2cpp::Type > ::class(), "set_spawnColor", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
