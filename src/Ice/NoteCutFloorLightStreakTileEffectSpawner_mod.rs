...
pub struct NoteCutFloorLightStreakTileEffectSpawner {
    ...
    pub _floorLightStreakTileEffect:
        quest_hook::libil2cpp::Gc<crate::Ice::FloorLightStreakTileEffect>,
...
#[cfg(feature = "cordl_class_Ice+NoteCutFloorLightStreakTileEffectSpawner")]
unsafe impl quest_hook::libil2cpp::Type for crate::Ice::NoteCutFloorLightStreakTileEffectSpawner {
...
impl crate::Ice::NoteCutFloorLightStreakTileEffectSpawner {
    ...
    pub fn get_spawnColor(&mut self) -> quest_hook::libil2cpp::Result<crate::UnityEngine::Color> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::UnityEngine::Color, 0usize>("get_spawnColor")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Ice+NoteCutFloorLightStreakTileEffectSpawner")]
impl quest_hook::libil2cpp::ObjectType for crate::Ice::NoteCutFloorLightStreakTileEffectSpawner {
