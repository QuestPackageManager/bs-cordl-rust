...
#[cfg(feature = "Ice+BeatmapFloorLightTilesGrid")]
unsafe impl quest_hook::libil2cpp::Type for crate::Ice::BeatmapFloorLightTilesGrid {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Ice";
    const CLASS_NAME: &'static str = "BeatmapFloorLightTilesGrid";
...
impl crate::Ice::BeatmapFloorLightTilesGrid {
    ...
    pub fn Start(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Ice::BeatmapFloorLightTilesGrid as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Start")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Ice::BeatmapFloorLightTilesGrid as
