#[cfg(feature = "cordl_class_Internal+Runtime+Augments+ReflectionExecutionDomainCallbacks")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Internal::Runtime::Augments::ReflectionExecutionDomainCallbacks
{
    ...
    const CLASS_NAME: &'static str = "ReflectionExecutionDomainCallbacks";
...
impl std::ops::Deref for crate::Internal::Runtime::Augments::ReflectionExecutionDomainCallbacks {
...
#[cfg(feature = "Internal+Runtime+Augments+ReflectionExecutionDomainCallbacks")]
impl std::ops::DerefMut for crate::Internal::Runtime::Augments::ReflectionExecutionDomainCallbacks {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateMissingMetadataException", 1usize
                        )
                    })
            });
