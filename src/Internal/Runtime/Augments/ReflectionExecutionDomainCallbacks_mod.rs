...
impl crate::Internal::Runtime::Augments::ReflectionExecutionDomainCallbacks {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Internal::Runtime::Augments::ReflectionExecutionDomainCallbacks as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::Internal::Runtime::Augments::ReflectionExecutionDomainCallbacks as
