...
unsafe impl quest_hook::libil2cpp::Type for crate::LIV::SDK::Unity::SDKResolution {
    ...
    const CLASS_NAME: &'static str = "SDKResolution";
...
#[cfg(feature = "cordl_class_LIV+SDK+Unity+SDKResolution")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::LIV::SDK::Unity::SDKResolution {
    type Type = Self;
...
impl crate::LIV::SDK::Unity::SDKResolution {
    ...
    pub fn get_zero() -> quest_hook::libil2cpp::Result<crate::LIV::SDK::Unity::SDKResolution> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::LIV::SDK::Unity::SDKResolution, 0usize>(
                        "get_zero",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
