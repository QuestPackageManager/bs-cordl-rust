...
impl crate::LIV::SDK::Unity::SDKPriority {
    ...
    pub fn get_empty() -> quest_hook::libil2cpp::Result<crate::LIV::SDK::Unity::SDKPriority> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::LIV::SDK::Unity::SDKPriority, 0usize>(
                        "get_empty",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::SDKPriority =
