...
impl crate::LIV::SDK::Unity::SDKPriority {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LIV::SDK::Unity::SDKPriority as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::LIV::SDK::Unity::SDKPriority as quest_hook::libil2cpp::Type >
    ...
    > {
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::SDKPriority = unsafe {
