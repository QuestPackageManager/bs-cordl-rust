...
impl crate::LIV::SDK::Unity::SDKUtils {
    pub fn ApplyUserSpaceTransform(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (render))? };
        Ok(__cordl_ret.into())
    }
    pub fn CleanCameraBehaviours(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (camera, excludeBehaviours))? };
        Ok(__cordl_ret.into())
    }
    pub fn ContainsFlag(flags: u64, flag: u64) -> quest_hook::libil2cpp::Result<bool> {
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (flags, flag))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CreateClipPlane(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                        f32,
                    ), quest_hook::libil2cpp::Void, 5usize>("CreateClipPlane")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (mesh, resX, resY, useQuads, skirtLength))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateTexture(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (renderTexture, width, height, depth, format))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::ByRefMut<T>), bool, 1usize>(
                        "DestroyObject",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (reference))? };
        Ok(__cordl_ret.into())
    }
    pub fn DestroyTexture(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::ByRefMut<
                        quest_hook::libil2cpp::Gc<crate::UnityEngine::RenderTexture>,
                    >), quest_hook::libil2cpp::Void, 1usize>("DestroyTexture")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (_renderTexture))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn FeatureEnabled(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (features, feature))? };
        Ok(__cordl_ret.into())
    }
    pub fn ForceForwardRendering(
        cameraInstance: quest_hook::libil2cpp::Gc<crate::UnityEngine::Camera>,
        clipPlaneMesh: quest_hook::libil2cpp::Gc<crate::UnityEngine::Mesh>,
        forceForwardRenderingMaterial: quest_hook::libil2cpp::Gc<crate::UnityEngine::Material>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn GetCameraPositionAndRotation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (pose, originLocalToWorldMatrix, position, rotation))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetColorSpace(
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::TEXTURE_COLOR_SPACE =
            unsafe { cordl_method_info.invoke_unchecked((), (renderTexture))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetDevice() -> quest_hook::libil2cpp::Result<crate::LIV::SDK::Unity::TEXTURE_DEVICE> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::LIV::SDK::Unity::TEXTURE_DEVICE, 0usize>(
                        "GetDevice",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::TEXTURE_DEVICE =
    ...
    pub fn GetReadWriteFromColorSpace(
        ...
        let __cordl_ret: crate::UnityEngine::RenderTextureReadWrite =
            unsafe { cordl_method_info.invoke_unchecked((), (colorSpace))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetRenderingPipeline(
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::RENDERING_PIPELINE =
            unsafe { cordl_method_info.invoke_unchecked((), (renderingPath))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetTrackedSpace(
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::SDKTrackedSpace =
    ...
    pub fn RestoreStandardAssets(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (behaviours, wasBehaviourEnabled))? };
        Ok(__cordl_ret.into())
    }
    pub fn RotateQuaternionByMatrix(
        ...
        let __cordl_ret: crate::UnityEngine::Quaternion =
            unsafe { cordl_method_info.invoke_unchecked((), (matrix, rotation))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetCamera(
        camera: quest_hook::libil2cpp::Gc<crate::UnityEngine::Camera>,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::Matrix4x4,
                        i32,
                    ), quest_hook::libil2cpp::Void, 5usize>("SetCamera")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn SetFlag(flags: u64, flag: u64, enabled: bool) -> quest_hook::libil2cpp::Result<u64> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let __cordl_ret: u64 =
            unsafe { cordl_method_info.invoke_unchecked((), (flags, flag, enabled))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_GetDefaultColorSpace(
    ) -> quest_hook::libil2cpp::Result<crate::LIV::SDK::Unity::TEXTURE_COLOR_SPACE> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::LIV::SDK::Unity::TEXTURE_COLOR_SPACE, 0usize>(
