...
unsafe impl quest_hook::libil2cpp::Type for crate::LIV::SDK::Unity::SDKTransform {
    ...
    const CLASS_NAME: &'static str = "SDKTransform";
...
#[cfg(feature = "cordl_class_LIV+SDK+Unity+SDKTransform")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::LIV::SDK::Unity::SDKTransform {
    type Type = Self;
...
impl crate::LIV::SDK::Unity::SDKTransform {
    ...
    pub fn get_empty() -> quest_hook::libil2cpp::Result<crate::LIV::SDK::Unity::SDKTransform> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::LIV::SDK::Unity::SDKTransform, 0usize>(
                        "get_empty",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::LIV::SDK::Unity::SDKTransform =
