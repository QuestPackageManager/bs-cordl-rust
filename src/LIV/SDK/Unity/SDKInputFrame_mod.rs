...
impl crate::LIV::SDK::Unity::SDKInputFrame {
    pub fn ObtainControl(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::LIV::SDK::Unity::SDKInputFrame as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ObtainControl")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::LIV::SDK::Unity::SDKInputFrame as quest_hook::libil2cpp::Type
                    > ::class(), "ObtainControl", 0usize
                )
            });
