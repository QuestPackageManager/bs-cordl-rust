#[cfg(feature = "cordl_class_LIV+SDK+Unity+SDKConstants")]
...
#[cfg(feature = "cordl_class_LIV+SDK+Unity+SDKConstants")]
unsafe impl quest_hook::libil2cpp::Type for crate::LIV::SDK::Unity::SDKConstants {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "LIV.SDK.Unity";
    const CLASS_NAME: &'static str = "SDKConstants";
...
#[cfg(feature = "cordl_class_LIV+SDK+Unity+SDKConstants")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::LIV::SDK::Unity::SDKConstants {
    type Type = Self;
