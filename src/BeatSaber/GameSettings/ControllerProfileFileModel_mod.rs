...
impl crate::BeatSaber::GameSettings::ControllerProfileFileModel {
    ...
    pub fn LoadAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::GameSettings::ControllerProfileFileModel as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Threading::Tasks::Task_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::GameSettings::ControllerProfileFileModel as
    ...
    > {
        ...
        > = unsafe { method.invoke_unchecked(self, (profileSaveDataContainer))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::GameSettings::ControllerProfileFileModel as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::GameSettings::ControllerProfileFileModel as
                    quest_hook::libil2cpp::Type > ::class(), "get_fileStorage", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
