...
impl crate::BeatSaber::GameSettings::ControllerProfilesSettingsViewController {
    ...
    pub fn CopyProfileResponse(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (wasCanceled, selectedDropdownIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CopyValuesFromOtherProfile(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (otherProfileIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn DidActivate(
    ...
    pub fn ProfileSelected(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (view, index))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn RefreshView(
