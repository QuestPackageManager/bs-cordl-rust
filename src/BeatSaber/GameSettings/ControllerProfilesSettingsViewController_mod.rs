#[cfg(feature = "cordl_class_BeatSaber+GameSettings+ControllerProfilesSettingsViewController")]
#[repr(C)]
...
pub struct ControllerProfilesSettingsViewController {
    ...
    pub _transformSettingsViewControllers: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<
            quest_hook::libil2cpp::Gc<crate::BeatSaber::GameSettings::ControllersTransformSettings>,
        >,
    >,
    ...
    pub _copyFromProfileButton: quest_hook::libil2cpp::Gc<crate::UnityEngine::UI::Button>,
    pub _profileModel:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::GameSettings::ControllerProfilesModel>,
...
impl std::ops::Deref for crate::BeatSaber::GameSettings::ControllerProfilesSettingsViewController {
...
impl crate::BeatSaber::GameSettings::ControllerProfilesSettingsViewController {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CopyFormLeftToRight")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn CopyFromRightToLeft(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CopyFromRightToLeft")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn CopyProfileResponse(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (wasCanceled, selectedDropdownIndex))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CopyValuesFromOtherProfile(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (otherProfileIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn DidActivate(
        &mut self,
    ...
    pub fn GetControllerProfileDisplayName(
        profile: quest_hook::libil2cpp::Gc<crate::BeatSaber::GameSettings::ControllerProfile>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (profile))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ProfileSelected(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        i32,
                    ), quest_hook::libil2cpp::Void, 2usize>("ProfileSelected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (view, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn RefreshView(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("RefreshView")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn ShowCopyFromProfile(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("ShowCopyFromProfile")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
