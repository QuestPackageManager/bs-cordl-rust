...
pub struct ControllerProfilesModel {
    ...
    pub _fileModel:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::GameSettings::ControllerProfileFileModel>,
...
impl crate::BeatSaber::GameSettings::ControllerProfilesModel {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::IEnumerable_1<
                            ...
                            >,
                        >,
                    >, 0usize>("GetControllerProfilesSaveData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn GetDefaultController(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), crate::BeatSaber::GameSettings::Controller, 0usize>(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::BeatSaber::GameSettings::ControllerProfile,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (localizationKey, index, modifiable))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::BeatSaber::GameSettings::ControllerProfile,
        > = unsafe { cordl_method_info.invoke_unchecked(self, (profileIndex))? };
        Ok(__cordl_ret.into())
    }
    pub fn GetSelectedProfileIndexFromSettings(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked(self, (builtInProfilesCount))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateSelectedProfile(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (newSelectedProfileIndex, forceUpdate))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BeatSaber+GameSettings+ControllerProfilesModel")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::GameSettings::ControllerProfilesModel {
