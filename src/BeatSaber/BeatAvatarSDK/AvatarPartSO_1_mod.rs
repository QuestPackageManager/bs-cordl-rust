...
for crate::BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T> {
    ...
    const CLASS_NAME: &'static str = "AvatarPartSO`1";
...
impl<T: quest_hook::libil2cpp::Type> crate::BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T> {
    ...
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::BeatAvatarSDK::AvatarPartSO_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::BeatAvatarSDK::AvatarPartSO_1 < T > as
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::BeatAvatarSDK::AvatarPartSO_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_localizationKey",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::BeatAvatarSDK::AvatarPartSO_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), T, 0usize>("get_partAsset")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::BeatAvatarSDK::AvatarPartSO_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_partAsset", 0usize
                )
            });
