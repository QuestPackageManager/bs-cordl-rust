...
pub struct BeatAvatarVisualController {
    ...
    pub _leftHandsHairMeshFilter: quest_hook::libil2cpp::Gc<crate::UnityEngine::MeshFilter>,
    pub _rightHandsHairMeshFilter: quest_hook::libil2cpp::Gc<crate::UnityEngine::MeshFilter>,
    ...
    >,
    pub _glassesPropertyBlockColorSetter:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter>,
    pub _facialHairPropertyBlockColorSetter:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter>,
    pub _skinPropertyBlockColorSetter:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter>,
...
impl crate::BeatSaber::BeatAvatarSDK::BeatAvatarVisualController {
    #[cfg(feature = "BeatSaber+BeatAvatarSDK+BeatAvatarVisualController+HighlighterDelegate")]
    pub type HighlighterDelegate =
        crate::BeatSaber::BeatAvatarSDK::BeatAvatarVisualController_HighlighterDelegate;
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "HighlightEditedPart", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (editPart, uvSegment))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateAvatarColors(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("UpdateAvatarColors")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateAvatarVisual", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (avatarData))? };
        Ok(__cordl_ret.into())
    }
...
impl crate::BeatSaber::BeatAvatarSDK::BeatAvatarVisualController_HighlighterDelegate {
    pub fn BeginInvoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (highlighted, uvSegmentNumber, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
    ...
    pub fn Invoke(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, i32), quest_hook::libil2cpp::Void, 2usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (highlighted, uvSegmentNumber))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
        object: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
