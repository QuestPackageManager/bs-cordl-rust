...
impl crate::BeatSaber::BeatAvatarSDK::BeatAvatarVisualController {
    ...
    pub fn HighlightEditedPart(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (editPart, uvSegment))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn UpdateAvatarVisual(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (avatarData))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
...
impl crate::BeatSaber::BeatAvatarSDK::BeatAvatarVisualController_HighlighterDelegate {
    ...
    pub fn Invoke(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (highlighted, uvSegmentNumber))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
