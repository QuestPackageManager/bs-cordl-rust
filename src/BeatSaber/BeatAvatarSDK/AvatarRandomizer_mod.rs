#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarSDK+AvatarRandomizer")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarSDK+AvatarRandomizer")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::BeatAvatarSDK::AvatarRandomizer {
...
impl crate::BeatSaber::BeatAvatarSDK::AvatarRandomizer {
    pub fn RandomizeAll(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::BeatSaber::BeatAvatarSDK::AvatarPartsModel,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("RandomizeAll")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (avatarData, avatarPartsModel))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::BeatSaber::BeatAvatarSDK::AvatarPartsModel,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("RandomizeModels")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarSDK+AvatarRandomizer")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::BeatAvatarSDK::AvatarRandomizer {
