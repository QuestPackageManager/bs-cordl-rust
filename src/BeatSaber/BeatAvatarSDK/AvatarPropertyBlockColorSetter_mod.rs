    ...
    for crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter
{
    ...
    const CLASS_NAME: &'static str = "AvatarPropertyBlockColorSetter";
...
impl std::ops::Deref for crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter {
...
#[cfg(feature = "BeatSaber+BeatAvatarSDK+AvatarPropertyBlockColorSetter")]
impl std::ops::DerefMut for crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter {
...
impl crate::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter {
    ...
    pub fn SetColors(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (mainColor, rimLightColor))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetHighlight(
        &mut self,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool, i32), quest_hook::libil2cpp::Void, 2usize>("SetHighlight")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (highlighted, uvSegment))? };
        Ok(__cordl_ret.into())
    }
