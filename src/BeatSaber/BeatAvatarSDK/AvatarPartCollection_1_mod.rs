#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarSDK+AvatarPartCollection_1")]
#[repr(C)]
...
#[cfg(feature = "BeatSaber+BeatAvatarSDK+AvatarPartCollection_1")]
impl<T: quest_hook::libil2cpp::Type> crate::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T> {
    pub fn GetById(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(), "GetById",
                            1usize
                        )
                    })
            });
