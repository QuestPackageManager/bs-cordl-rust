#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarSDK+IAvatarPart")]
#[derive(Debug)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarSDK+IAvatarPart")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::BeatAvatarSDK::IAvatarPart {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BeatSaber.BeatAvatarSDK";
    const CLASS_NAME: &'static str = "IAvatarPart";
