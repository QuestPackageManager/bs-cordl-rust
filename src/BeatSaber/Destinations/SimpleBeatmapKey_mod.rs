...
for crate::BeatSaber::Destinations::SimpleBeatmapKey {
...
impl crate::BeatSaber::Destinations::SimpleBeatmapKey {
    ...
    pub fn ToStruct(
        ...
        let __cordl_ret: crate::GlobalNamespace::BeatmapKey = unsafe {
            cordl_method_info.invoke_unchecked(self, (characteristicCollection))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (characteristic, difficulty, levelId))?
        };
        Ok(__cordl_ret.into())
    }
}
