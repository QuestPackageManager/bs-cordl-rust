...
#[cfg(feature = "BeatSaber+Main+Leaderboards+QueryLeaderboardFriends")]
impl std::ops::DerefMut for crate::BeatSaber::Main::Leaderboards::QueryLeaderboardFriends {
...
impl crate::BeatSaber::Main::Leaderboards::QueryLeaderboardFriends {
    ...
    pub fn CreateQuery(
        ...
        quest_hook::libil2cpp::Gc<crate::BeatSaber::Main::GraphQL::Queries::BSLeaderboardFriends>,
    > {
