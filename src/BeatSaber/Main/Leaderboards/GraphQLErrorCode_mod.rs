...
for crate::BeatSaber::Main::Leaderboards::GraphQLErrorCode {
...
impl crate::BeatSaber::Main::Leaderboards::GraphQLErrorCode {
    ...
    pub const BEAT_GAMES__SCHEDULE_CONFLICTING_CONTENT_VERSIONS_WITH_SAME_MINIMUM_CLIENT_VERSION: i32 = 3789036i32;
