...
#[cfg(feature = "cordl_class_BeatSaber+RecPlay+PlayerPoseSampler")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::RecPlay::PlayerPoseSampler {
...
impl crate::BeatSaber::RecPlay::PlayerPoseSampler {
    ...
    pub fn Sample(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("Sample")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_time, player))? };
        Ok(__cordl_ret.into())
    }
