...
pub struct PlayerPoseCapturer {
    ...
    pub frames: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::BeatSaber::RecPlay::PlayerPoseFrame>,
    >,
}
#[cfg(feature = "cordl_class_BeatSaber+RecPlay+PlayerPoseCapturer")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::RecPlay::PlayerPoseCapturer {
...
impl crate::BeatSaber::RecPlay::PlayerPoseCapturer {
    pub fn Capture(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (_cordl_time, pose))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreatePlayerPoseFrames(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatSaber::RecPlay::PlayerPoseFrames, 0usize>(
...
#[cfg(feature = "cordl_class_BeatSaber+RecPlay+PlayerPoseCapturer")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::RecPlay::PlayerPoseCapturer {
