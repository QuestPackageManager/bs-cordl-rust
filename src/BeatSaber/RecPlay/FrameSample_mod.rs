#[cfg(feature = "cordl_class_BeatSaber+RecPlay+FrameSample")]
...
#[cfg(feature = "cordl_class_BeatSaber+RecPlay+FrameSample")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::RecPlay::FrameSample {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "BeatSaber.RecPlay";
    const CLASS_NAME: &'static str = "FrameSample";
...
#[cfg(feature = "cordl_class_BeatSaber+RecPlay+FrameSample")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::BeatSaber::RecPlay::FrameSample {
    type Type = Self;
