...
impl crate::BeatSaber::RecPlay::PoseSampler {
    pub fn FindPoseSample(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        f32,
                        i32,
                    ), crate::BeatSaber::RecPlay::FrameSample, 3usize>(
                        "FindPoseSample"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatSaber::RecPlay::FrameSample =
            unsafe { cordl_method_info.invoke_unchecked((), (frames, _cordl_time, nearest))? };
        Ok(__cordl_ret.into())
    }
    pub fn InterpolatePoseSample(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<
                            ...
                            >,
                        >,
                        quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::RecPlay::FrameSample>,
                    ), crate::UnityEngine::Pose, 2usize>("InterpolatePoseSample")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::UnityEngine::Pose =
            unsafe { cordl_method_info.invoke_unchecked((), (frames, sample))? };
        Ok(__cordl_ret.into())
    }
    pub fn SamplePose(
        frames: quest_hook::libil2cpp::Gc<
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Pose, 3usize>("SamplePose")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
