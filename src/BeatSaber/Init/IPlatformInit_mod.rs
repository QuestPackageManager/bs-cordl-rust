...
#[cfg(feature = "BeatSaber+Init+IPlatformInit")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::Init::IPlatformInit {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BeatSaber.Init";
    const CLASS_NAME: &'static str = "IPlatformInit";
...
impl crate::BeatSaber::Init::IPlatformInit {
    pub fn GetAppVersionAsync(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::Init::IPlatformInit as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Threading::Tasks::Task_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::Init::IPlatformInit as quest_hook::libil2cpp::Type
