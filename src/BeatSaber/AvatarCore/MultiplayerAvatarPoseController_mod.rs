...
pub struct MultiplayerAvatarPoseController {
    ...
    pub didUpdatePoseEvent:
        quest_hook::libil2cpp::Gc<crate::System::Action_1<crate::UnityEngine::Vector3>>,
}
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+MultiplayerAvatarPoseController")]
...
#[cfg(feature = "BeatSaber+AvatarCore+MultiplayerAvatarPoseController")]
impl std::ops::DerefMut for crate::BeatSaber::AvatarCore::MultiplayerAvatarPoseController {
...
impl crate::BeatSaber::AvatarCore::MultiplayerAvatarPoseController {
    ...
    pub fn add_didUpdatePoseEvent(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::System::Action_1<crate::UnityEngine::Vector3>>,
    ...
    pub fn set_connectedPlayer(
        &mut self,
        value: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::IBeatSaberConnectedPlayer>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
