...
for crate::BeatSaber::AvatarCore::MultiplayerAvatarAudioController {
    ...
    const CLASS_NAME: &'static str = "MultiplayerAvatarAudioController";
...
impl crate::BeatSaber::AvatarCore::MultiplayerAvatarAudioController {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::MultiplayerAvatarAudioController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Collections::IEnumerator>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::AvatarCore::MultiplayerAvatarAudioController as
