...
impl crate::BeatSaber::AvatarCore::IAvatarPoseRestriction {
    pub fn RestrictPose(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::IAvatarPoseRestriction as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::AvatarCore::IAvatarPoseRestriction as
