...
impl crate::BeatSaber::AvatarCore::AvatarController {
    pub fn LoadAndDisplayAvatar(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::AvatarController as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::AvatarCore::AvatarController as
                    quest_hook::libil2cpp::Type > ::class(), "LoadAndDisplayAvatar",
                    0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::AvatarController as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::AvatarCore::AvatarController as
                    quest_hook::libil2cpp::Type > ::class(), "get_avatar", 0usize
                )
            });
