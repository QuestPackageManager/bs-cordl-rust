#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarController")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::AvatarCore::AvatarController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BeatSaber.AvatarCore";
    const CLASS_NAME: &'static str = "AvatarController";
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("LoadAndDisplayAvatar")
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarController")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::AvatarCore::AvatarController {
