...
for crate::BeatSaber::AvatarCore::MultiplayerGameAvatarInstaller {
    ...
    const CLASS_NAME: &'static str = "MultiplayerGameAvatarInstaller";
...
impl crate::BeatSaber::AvatarCore::MultiplayerGameAvatarInstaller {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::MultiplayerGameAvatarInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::AvatarCore::MultiplayerGameAvatarInstaller as
