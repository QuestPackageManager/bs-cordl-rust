...
for crate::BeatSaber::AvatarCore::AbstractAdapterInstallerSO {
    ...
    const CLASS_NAME: &'static str = "AbstractAdapterInstallerSO";
...
impl crate::BeatSaber::AvatarCore::AbstractAdapterInstallerSO {
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::AbstractAdapterInstallerSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::AvatarCore::AbstractAdapterInstallerSO as
