#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarVisualController")]
#[repr(C)]
#[derive(Debug)]
pub struct AvatarVisualController {
    __cordl_parent: crate::UnityEngine::MonoBehaviour,
    pub _avatarController:
        quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::AvatarController>,
}
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarVisualController")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::AvatarCore::AvatarVisualController {
...
impl crate::BeatSaber::AvatarCore::AvatarVisualController {
    ...
    pub fn __SetAvatarController(
        &mut self,
        avatarController: quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::AvatarController>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (avatarController))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarVisualController")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::AvatarCore::AvatarVisualController {
