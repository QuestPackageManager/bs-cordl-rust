...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+BinaryReadWriteHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::AvatarCore::BinaryReadWriteHelper {
...
impl crate::BeatSaber::AvatarCore::BinaryReadWriteHelper {
    pub fn ReadColor(
        ...
        let __cordl_ret: crate::UnityEngine::Color =
            unsafe { cordl_method_info.invoke_unchecked((), (binaryReader))? };
        Ok(__cordl_ret.into())
    }
    pub fn Write(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (binaryWriter, color))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+BinaryReadWriteHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::AvatarCore::BinaryReadWriteHelper {
