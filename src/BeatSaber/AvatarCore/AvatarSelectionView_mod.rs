...
impl crate::BeatSaber::AvatarCore::AvatarSelectionView {
    ...
    pub fn SetCreated(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isCreated))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn SetPreferred(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (isPreferred))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Start(
