...
pub struct AvatarsAsyncInstaller {
    __cordl_parent: crate::BGLib::AppFlow::Initialization::AddressablesAsyncInstaller_1<
        quest_hook::libil2cpp::Gc<crate::BeatSaber::AvatarCore::AbstractAdapterInstallerSO>,
    >,
}
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarsAsyncInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::AvatarCore::AvatarsAsyncInstaller {
...
impl crate::BeatSaber::AvatarCore::AvatarsAsyncInstaller {
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (adaptersInstallers, registry))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+AvatarsAsyncInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::AvatarCore::AvatarsAsyncInstaller {
