...
for crate::BeatSaber::AvatarCore::LobbyAvatarInstaller {
    ...
    const CLASS_NAME: &'static str = "LobbyAvatarInstaller";
...
#[cfg(feature = "BeatSaber+AvatarCore+LobbyAvatarInstaller")]
impl crate::BeatSaber::AvatarCore::LobbyAvatarInstaller {
    pub fn InstallBindings(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::AvatarCore::LobbyAvatarInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::AvatarCore::LobbyAvatarInstaller as
