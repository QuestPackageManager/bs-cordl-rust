#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+BeatAvatarSelectionView")]
#[repr(C)]
#[derive(Debug)]
pub struct BeatAvatarSelectionView {
    ...
    pub _beatAvatarVisualController:
...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+BeatAvatarSelectionView")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::AvatarCore::BeatAvatarSelectionView {
...
impl crate::BeatSaber::AvatarCore::BeatAvatarSelectionView {
    ...
    pub fn UpdateAvatarVisuals(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("UpdateAvatarVisuals")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_BeatSaber+AvatarCore+BeatAvatarSelectionView")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::AvatarCore::BeatAvatarSelectionView {
