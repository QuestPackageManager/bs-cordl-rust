#[cfg(feature = "cordl_class_BeatSaber+BeatAvatarAdapter+AvatarEditor+AvatarEditHistory")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarEditHistory {
...
#[cfg(feature = "BeatSaber+BeatAvatarAdapter+AvatarEditor+AvatarEditHistory")]
impl std::ops::DerefMut for crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarEditHistory {
...
impl crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarEditHistory {
    ...
    pub fn Redo(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 2usize>("UpdateEditHistory")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn get_lastEditedPart(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::BeatSaber::BeatAvatarSDK::AvatarPart, 0usize>(
                        "get_lastEditedPart",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::BeatSaber::BeatAvatarSDK::AvatarPart =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
