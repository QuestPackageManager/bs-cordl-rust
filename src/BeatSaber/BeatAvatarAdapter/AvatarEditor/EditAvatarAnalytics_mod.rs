...
pub struct EditAvatarAnalytics {
    ...
    pub _avatarEditorFlowCoordinator:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::BeatAvatarEditorFlowCoordinator>,
...
impl std::ops::Deref for crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics {
...
#[cfg(feature = "BeatSaber+BeatAvatarAdapter+AvatarEditor+EditAvatarAnalytics")]
impl std::ops::DerefMut for crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics {
...
impl crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::Dictionary_2<
                            ...
                            quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                        >,
                    >, 0usize>("CreateEditAvatarEventData")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn HandleAvatarEditorFlowCoordinatorDidFinish(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (flowCoordinator, avatarSystemMetadata, finishAction))?
        };
        Ok(__cordl_ret.into())
    }
