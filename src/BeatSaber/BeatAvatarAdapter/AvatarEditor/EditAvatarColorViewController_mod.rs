...
pub struct EditAvatarColorViewController {
    ...
    pub _previousColorPanelController:
        quest_hook::libil2cpp::Gc<crate::GlobalNamespace::PreviousColorPanelController>,
...
#[cfg(feature = "BeatSaber+BeatAvatarAdapter+AvatarEditor+EditAvatarColorViewController")]
impl std::ops::Deref
    for crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarColorViewController
{
...
impl crate::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarColorViewController {
    ...
    pub fn HandleHSVPanelControllerColorDidChange(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (color, colorChangeUIEventType))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetColorCallback", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (colorCallback))? };
        Ok(__cordl_ret.into())
    }
