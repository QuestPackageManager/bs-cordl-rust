...
impl crate::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO {
    pub fn InstallBindings_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO as
