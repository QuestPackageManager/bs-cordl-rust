...
impl crate::BeatSaber::Settings::LegacySettingsV1 {
    pub fn ApplyTo(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BeatSaber::Settings::LegacySettingsV1 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BeatSaber::Settings::LegacySettingsV1 as
                    quest_hook::libil2cpp::Type > ::class(), "ApplyTo", 1usize
                )
            });
