...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SettingValidations")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::Settings::SettingValidations {
...
impl crate::BeatSaber::Settings::SettingValidations {
    pub fn AdjustAudioSettings(
        settings: quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::AudioSettings>,
        presetLatency: f32,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::AudioSettings>,
                        f32,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (settings, presetLatency))? };
        Ok(__cordl_ret.into())
    }
    pub fn AdjustControllerSettings(
        settings: quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::ControllerSettings>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn AdjustRoomSettings(
        settings: quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::RoomSettings>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        f32,
                    ), quest_hook::libil2cpp::Void, 2usize>("AdjustSettings")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn AdjustSmoothCameraSettings(
        settings: quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::SmoothCameraSettings>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn AdjustStandalone(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::ByRefMut<crate::BeatSaber::Settings::Settings>,
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("AdjustStandalone")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (settings, forceApplyQualityAll))? };
        Ok(__cordl_ret.into())
    }
    pub fn Clamp(
    ...
    pub fn Wrap_f32_1(value: f32, min: f32, max: f32) -> quest_hook::libil2cpp::Result<f32> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SettingValidations")]
impl quest_hook::libil2cpp::ObjectType for crate::BeatSaber::Settings::SettingValidations {
