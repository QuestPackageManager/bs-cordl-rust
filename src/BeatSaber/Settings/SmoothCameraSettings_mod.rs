...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SmoothCameraSettings")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatSaber::Settings::SmoothCameraSettings {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SmoothCameraSettings")]
unsafe impl quest_hook::libil2cpp::Argument for crate::BeatSaber::Settings::SmoothCameraSettings {
    type Type = Self;
...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SmoothCameraSettings")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::BeatSaber::Settings::SmoothCameraSettings {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SmoothCameraSettings")]
unsafe impl quest_hook::libil2cpp::Returned for crate::BeatSaber::Settings::SmoothCameraSettings {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_BeatSaber+Settings+SmoothCameraSettings")]
unsafe impl quest_hook::libil2cpp::Return for crate::BeatSaber::Settings::SmoothCameraSettings {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
