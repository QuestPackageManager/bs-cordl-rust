...
pub struct LightGroupDuplicationGroup {
    ...
    pub _duplicationGroupName: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
...
#[cfg(feature = "BeatSaber+TrackDefinitions+LightGroupDuplicationGroup")]
impl std::ops::DerefMut for crate::BeatSaber::TrackDefinitions::LightGroupDuplicationGroup {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_duplicationGroupName", 0usize
                        )
                    })
            });
