...
#[cfg(feature = "BeatSaber+TrackDefinitions+DataModels+EnvironmentTrackDefinitionsListModel")]
impl std::ops::Deref
    for crate::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionsListModel
{
...
impl crate::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionsListModel {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (environmentTrackDefinitions))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Item(
        &mut self,
