...
impl crate::ENet::Host {
    pub fn Broadcast_Il2CppArray2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ENet::Host as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    u8,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::ENet::Host as quest_hook::libil2cpp::Type > ::class(),
                    "Broadcast", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (channelID, packet, peers))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Broadcast_Peer1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (channelID, packet, excludedPeer))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CheckEvents(
        ...
        let __cordl_ret: i32 = unsafe { method.invoke_unchecked(self, (event))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Connect_i32_1(
        ...
        let __cordl_ret: crate::ENet::Peer = unsafe {
            method.invoke_unchecked(self, (address, channelLimit))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Connect_i32_u32_2(
        ...
        let __cordl_ret: crate::ENet::Peer = unsafe {
            method.invoke_unchecked(self, (address, channelLimit, data))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Create(
    ...
    pub fn Service(
        ...
        let __cordl_ret: i32 = unsafe {
            method.invoke_unchecked(self, (timeout, event))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ENet::Host as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::ENet::Host as quest_hook::libil2cpp::Type > ::class(),
                    "SetBandwidthLimit", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (incomingBandwidth, outgoingBandwidth))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ENet::Host as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::ENet::Host as quest_hook::libil2cpp::Type > ::class(),
                    "SetChannelLimit", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (channelLimit))?
        };
        Ok(__cordl_ret.into())
    }
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ENet::Host as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::ENet::Host as quest_hook::libil2cpp::Type > ::class(),
                    "ThrowIfChannelsExceeded", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked((), (channelLimit))?
        };
        Ok(__cordl_ret.into())
    }
