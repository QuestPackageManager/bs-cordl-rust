...
unsafe impl quest_hook::libil2cpp::Type for crate::ENet::NoMemoryCallback {
    ...
    const CLASS_NAME: &'static str = "NoMemoryCallback";
...
#[cfg(feature = "ENet+NoMemoryCallback")]
impl crate::ENet::NoMemoryCallback {
    pub fn BeginInvoke(
        &mut self,
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ENet::NoMemoryCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::ENet::NoMemoryCallback as quest_hook::libil2cpp::Type >
