...
unsafe impl quest_hook::libil2cpp::Type for crate::ENet::AllocCallback {
    ...
    const CLASS_NAME: &'static str = "AllocCallback";
...
impl crate::ENet::AllocCallback {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ENet::AllocCallback as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    crate::System::IntPtr,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::ENet::AllocCallback as quest_hook::libil2cpp::Type >
                    ::class(), "BeginInvoke", 3usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::IAsyncResult> = unsafe {
            method.invoke_unchecked(self, (_cordl_size, callback, object))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn EndInvoke(
