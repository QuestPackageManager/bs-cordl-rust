...
impl crate::Tweening::QuaternionTween {
    pub fn GetValue(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Tweening::QuaternionTween as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), crate::UnityEngine::Quaternion, 1usize>("GetValue")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Tweening::QuaternionTween as quest_hook::libil2cpp::Type >
