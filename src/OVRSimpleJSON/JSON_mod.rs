...
impl crate::OVRSimpleJSON::JSON {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::OVRSimpleJSON::JSON as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::OVRSimpleJSON::JSON as quest_hook::libil2cpp::Type >
                    ::class(), "Parse", 1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::OVRSimpleJSON::JSONNode> = unsafe {
            method.invoke_unchecked((), (aJSON))?
        };
        Ok(__cordl_ret.into())
    }
}
