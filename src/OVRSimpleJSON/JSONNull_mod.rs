...
impl crate::OVRSimpleJSON::JSONNull {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::OVRSimpleJSON::JSONNull as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::OVRSimpleJSON::JSONNull>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::OVRSimpleJSON::JSONNull as quest_hook::libil2cpp::Type >
                    ::class(), "CreateOrGet", 0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::OVRSimpleJSON::JSONNull> = unsafe {
