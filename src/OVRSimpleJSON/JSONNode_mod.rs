...
pub struct JSONNode_Enumerator {
    pub _cordl_type: crate::OVRSimpleJSON::Enumerator_Type,
...
impl crate::OVRSimpleJSON::JSONNode_Enumerator {
    ...
    pub type Type = crate::OVRSimpleJSON::Enumerator_Type;
...
#[cfg(feature = "OVRSimpleJSON+JSONNode+Enumerator+Type")]
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate ::OVRSimpleJSON::Enumerator_Type =>
