#[cfg(feature = "cordl_class_OVRSimpleJSON+JSONBool")]
#[repr(C)]
#[derive(Debug)]
pub struct JSONBool {
...
#[cfg(feature = "cordl_class_OVRSimpleJSON+JSONBool")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVRSimpleJSON::JSONBool {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OVRSimpleJSON";
    const CLASS_NAME: &'static str = "JSONBool";
