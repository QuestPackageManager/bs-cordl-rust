#[cfg(feature = "cordl_class_OVRSimpleJSON+JSONNumber")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_OVRSimpleJSON+JSONNumber")]
unsafe impl quest_hook::libil2cpp::Type for crate::OVRSimpleJSON::JSONNumber {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OVRSimpleJSON";
    const CLASS_NAME: &'static str = "JSONNumber";
...
impl crate::OVRSimpleJSON::JSONNumber {
    ...
    pub fn New_f64_0(aData: f64) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (aData))?;
    ...
    pub fn _ctor_Il2CppString1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (aData))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_f64_0(
        &mut self,
