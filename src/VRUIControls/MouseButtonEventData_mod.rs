...
#[cfg(feature = "VRUIControls+MouseButtonEventData")]
unsafe impl quest_hook::libil2cpp::Type for crate::VRUIControls::MouseButtonEventData {
...
impl crate::VRUIControls::MouseButtonEventData {
    ...
    pub fn PressedThisFrame(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::VRUIControls::MouseButtonEventData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("PressedThisFrame")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::VRUIControls::MouseButtonEventData as
                    quest_hook::libil2cpp::Type > ::class(), "PressedThisFrame", 0usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::VRUIControls::MouseButtonEventData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::VRUIControls::MouseButtonEventData as
                    quest_hook::libil2cpp::Type > ::class(), "ReleasedThisFrame", 0usize
                )
            });
        let __cordl_ret: bool = unsafe { method.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
