...
#[cfg(feature = "cordl_class_VRUIControls+PhysicsRaycasterWithCache")]
unsafe impl quest_hook::libil2cpp::Type for crate::VRUIControls::PhysicsRaycasterWithCache {
...
impl crate::VRUIControls::PhysicsRaycasterWithCache {
    ...
    pub fn Raycast(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (ray, hitInfo, maxDistance, layerMask))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_VRUIControls+PhysicsRaycasterWithCache")]
impl quest_hook::libil2cpp::ObjectType for crate::VRUIControls::PhysicsRaycasterWithCache {
