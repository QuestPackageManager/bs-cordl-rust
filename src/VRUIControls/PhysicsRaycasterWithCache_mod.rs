...
impl crate::VRUIControls::PhysicsRaycasterWithCache {
    ...
    pub fn Raycast(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::VRUIControls::PhysicsRaycasterWithCache as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::VRUIControls::PhysicsRaycasterWithCache as
                    quest_hook::libil2cpp::Type > ::class(), "Raycast", 4usize
                )
            });
...
impl crate::VRUIControls::PhysicsRaycasterWithCache_CachedRaycast {
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::VRUIControls::PhysicsRaycasterWithCache_CachedRaycast as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
                    bool,
                    crate::UnityEngine::Ray,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::VRUIControls::PhysicsRaycasterWithCache_CachedRaycast as
