...
#[cfg(feature = "VRUIControls+VRLaserPointer")]
unsafe impl quest_hook::libil2cpp::Type for crate::VRUIControls::VRLaserPointer {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "VRUIControls";
    const CLASS_NAME: &'static str = "VRLaserPointer";
...
impl crate::VRUIControls::VRLaserPointer {
    ...
    pub fn SetFadeDistance(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::VRUIControls::VRLaserPointer as quest_hook::libil2cpp::Type>::class()
            .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("SetFadeDistance")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::VRUIControls::VRLaserPointer as quest_hook::libil2cpp::Type >
                    ::class(), "SetFadeDistance", 1usize
                )
            });
