...
#[cfg(feature = "cordl_class_BGLib+AppFlow+Initialization+AsyncInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::AppFlow::Initialization::AsyncInstaller {
...
#[cfg(feature = "cordl_class_BGLib+AppFlow+Initialization+AsyncInstaller")]
impl quest_hook::libil2cpp::ObjectType for crate::BGLib::AppFlow::Initialization::AsyncInstaller {
...
#[cfg(feature = "BGLib+AppFlow+Initialization+AsyncInstaller+IInstallerRegistry")]
impl std::ops::Deref for crate::BGLib::AppFlow::Initialization::AsyncInstaller_IInstallerRegistry {
...
impl crate::BGLib::AppFlow::Initialization::AsyncInstaller_IInstallerRegistry {
    pub fn AddMonoInstaller(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newMonoInstaller))? };
        Ok(__cordl_ret.into())
    }
    pub fn AddScriptableObjectInstaller(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (newScriptableObjectInstaller))? };
        Ok(__cordl_ret.into())
    }
