...
#[cfg(feature = "BGLib+AppFlow+Initialization+ScriptableObjectReferenceAsyncInstaller_1")]
...
{
    pub fn InstallBindings(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
