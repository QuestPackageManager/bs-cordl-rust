...
for crate::BGLib::AppFlow::Initialization::ScriptableObjectReferenceAsyncInstaller_1<T> {
    ...
    const CLASS_NAME: &'static str = "ScriptableObjectReferenceAsyncInstaller`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        ...
                        "ScriptableObjectReferenceAsyncInstaller`1",
                    )
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
...
> crate::BGLib::AppFlow::Initialization::ScriptableObjectReferenceAsyncInstaller_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::AppFlow::Initialization::ScriptableObjectReferenceAsyncInstaller_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::BGLib::AppFlow::Initialization::ScriptableObjectReferenceAsyncInstaller_1
                    < T > as quest_hook::libil2cpp::Type > ::class(), "InstallBindings",
                    0usize
                )
            });
