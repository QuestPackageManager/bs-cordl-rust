...
impl crate::BGLib::AppFlow::Initialization::FeatureAsyncPreloader {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::AppFlow::Initialization::FeatureAsyncPreloader as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<crate::System::Threading::Tasks::Task>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGLib::AppFlow::Initialization::FeatureAsyncPreloader as
