...
#[cfg(feature = "cordl_class_BGLib+AppFlow+FeatureAsyncInstaller")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::AppFlow::FeatureAsyncInstaller {
...
impl crate::BGLib::AppFlow::FeatureAsyncInstaller {
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (scriptableObjectInstallers, registry))?
        };
        Ok(__cordl_ret.into())
    }
