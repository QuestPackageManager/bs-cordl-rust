...
for crate::BGLib::AppFlow::FeatureAsyncInstaller {
    ...
    const NAMESPACE: &'static str = "BGLib.AppFlow";
    const CLASS_NAME: &'static str = "FeatureAsyncInstaller";
...
impl crate::BGLib::AppFlow::FeatureAsyncInstaller {
    ...
    pub fn InstallBindings(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::AppFlow::FeatureAsyncInstaller as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("InstallBindings")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BGLib::AppFlow::FeatureAsyncInstaller as
    ...
    pub fn LoadResourcesBeforeInstall(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (scriptableObjectInstallers, registry))?
        };
        Ok(__cordl_ret.into())
    }
