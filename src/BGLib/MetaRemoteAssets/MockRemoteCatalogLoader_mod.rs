...
impl crate::BGLib::MetaRemoteAssets::MockRemoteCatalogLoader {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::MetaRemoteAssets::MockRemoteCatalogLoader as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGLib::MetaRemoteAssets::MockRemoteCatalogLoader as
