...
#[cfg(feature = "BGLib+MetaRemoteAssets+MetaRemoteAssetsCatalogUpdater")]
impl std::ops::DerefMut for crate::BGLib::MetaRemoteAssets::MetaRemoteAssetsCatalogUpdater {
...
impl crate::BGLib::MetaRemoteAssets::MetaRemoteAssetsCatalogUpdater {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CheckForCatalogUpdateWithInterval", 1usize
                        )
                    })
            });
    ...
    pub fn New(
        ...
        >,
        scenesManager: quest_hook::libil2cpp::Gc<crate::GlobalNamespace::GameScenesManager>,
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (remoteAssetsManager, scenesManager))?
        };
        Ok(__cordl_ret.into())
    }
}
