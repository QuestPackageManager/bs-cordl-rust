    ...
    for crate::BGLib::Polyglot::LocalizedTextComponent_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("BGLib.Polyglot", "LocalizedTextComponent`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "BGLib+Polyglot+LocalizedTextComponent_1")]
impl<T: quest_hook::libil2cpp::Type> crate::BGLib::Polyglot::LocalizedTextComponent_1<T> {
    pub fn ClearParameters(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (component, direction))? };
        Ok(__cordl_ret.into())
    }
