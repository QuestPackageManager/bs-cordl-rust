...
> crate::BGLib::Polyglot::LocalizedTextComponent_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::Polyglot::LocalizedTextComponent_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGLib::Polyglot::LocalizedTextComponent_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "ClearParameters", 0usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BGLib::Polyglot::LocalizedTextComponent_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "get_MaintainTextAlignment",
                    0usize
                )
            });
