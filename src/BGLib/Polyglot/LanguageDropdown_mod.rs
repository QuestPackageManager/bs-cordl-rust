...
impl crate::BGLib::Polyglot::LanguageDropdown {
    pub fn CreateDropdown(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::Polyglot::LanguageDropdown as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("CreateDropdown")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::BGLib::Polyglot::LanguageDropdown as
                    quest_hook::libil2cpp::Type > ::class(), "CreateDropdown", 0usize
                )
            });
