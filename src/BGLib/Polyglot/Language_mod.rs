#[cfg(feature = "cordl_class_BGLib+Polyglot+Language")]
#[repr(i32)]
...
#[cfg(feature = "cordl_class_BGLib+Polyglot+Language")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::Polyglot::Language {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "BGLib.Polyglot";
    const CLASS_NAME: &'static str = "Language";
