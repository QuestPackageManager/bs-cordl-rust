...
impl crate::BGLib::Polyglot::SaveLanguagePreference {
    ...
    pub fn OnLocalize(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::Polyglot::SaveLanguagePreference as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGLib::Polyglot::SaveLanguagePreference as
