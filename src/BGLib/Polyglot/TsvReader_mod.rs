...
impl crate::BGLib::Polyglot::TsvReader {
    ...
    pub fn Parse(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::Polyglot::TsvReader as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::List_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGLib::Polyglot::TsvReader as quest_hook::libil2cpp::Type >
                    ::class(), "Parse", 1usize
                )
            });
