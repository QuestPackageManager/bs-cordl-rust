...
pub struct Localization {
    ...
    pub supportedLanguages: quest_hook::libil2cpp::Gc<
        crate::System::Collections::Generic::List_1<crate::BGLib::Polyglot::LocalizationLanguage>,
    >,
    pub selectedLanguage: crate::BGLib::Polyglot::LocalizationLanguage,
    pub fallbackLanguage: crate::BGLib::Polyglot::LocalizationLanguage,
}
#[cfg(feature = "cordl_class_BGLib+Polyglot+Localization")]
...
impl crate::BGLib::Polyglot::Localization {
    ...
    pub fn IsLanguageSupported(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::BGLib::Polyglot::LocalizationLanguage), bool, 1usize>(
                        "IsLanguageSupported",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (language))? };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "SetSingletonInstance", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (model))? };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::BGLib::Polyglot::LocalizationModel> =
            unsafe { cordl_method_info.invoke_unchecked((), ())? };
        Ok(__cordl_ret.into())
    }
