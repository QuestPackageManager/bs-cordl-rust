...
#[cfg(feature = "cordl_class_BGLib+Polyglot+LocalizedTextMeshPro")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::Polyglot::LocalizedTextMeshPro {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BGLib.Polyglot";
    const CLASS_NAME: &'static str = "LocalizedTextMeshPro";
...
impl crate::BGLib::Polyglot::LocalizedTextMeshPro {
    pub fn IsAlignmentLeft(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(crate::TMPro::TextAlignmentOptions), bool, 1usize>(
                        "IsAlignmentLeft",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (alignment))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn IsOppositeDirection(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (alignment, direction))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn SetText(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (text, value))? };
        Ok(__cordl_ret.into())
    }
    pub fn UpdateAlignment(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        quest_hook::libil2cpp::Gc<crate::TMPro::TextMeshPro>,
                        crate::BGLib::Polyglot::LanguageDirection,
                    ), quest_hook::libil2cpp::Void, 2usize>("UpdateAlignment")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (text, direction))? };
        Ok(__cordl_ret.into())
    }
