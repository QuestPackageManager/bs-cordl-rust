#[cfg(feature = "cordl_class_BGLib+DotnetExtension+IntegerExtensions")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BGLib+DotnetExtension+IntegerExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::DotnetExtension::IntegerExtensions {
...
impl crate::BGLib::DotnetExtension::IntegerExtensions {
    pub fn ToUInt(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), quest_hook::libil2cpp::Void, 3usize>("ToUInt")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (number, uNumber, isNegative))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BGLib+DotnetExtension+IntegerExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::BGLib::DotnetExtension::IntegerExtensions {
