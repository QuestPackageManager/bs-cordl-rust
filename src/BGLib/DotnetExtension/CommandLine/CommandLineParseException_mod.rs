...
impl crate::BGLib::DotnetExtension::CommandLine::CommandLineParseException {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::DotnetExtension::CommandLine::CommandLineParseException as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::BGLib::DotnetExtension::CommandLine::CommandLineParseException as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (hint, innerException))?
        };
        Ok(__cordl_ret.into())
    }
}
