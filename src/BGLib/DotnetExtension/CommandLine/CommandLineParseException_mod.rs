#[cfg(feature = "cordl_class_BGLib+DotnetExtension+CommandLine+CommandLineParseException")]
#[repr(C)]
    ...
    for crate::BGLib::DotnetExtension::CommandLine::CommandLineParseException
{
    ...
    const CLASS_NAME: &'static str = "CommandLineParseException";
...
impl std::ops::Deref for crate::BGLib::DotnetExtension::CommandLine::CommandLineParseException {
...
#[cfg(feature = "BGLib+DotnetExtension+CommandLine+CommandLineParseException")]
impl std::ops::DerefMut for crate::BGLib::DotnetExtension::CommandLine::CommandLineParseException {
...
impl crate::BGLib::DotnetExtension::CommandLine::CommandLineParseException {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hint, innerException))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BGLib+DotnetExtension+CommandLine+CommandLineParseException")]
