...
impl std::ops::Deref for crate::BGLib::DotnetExtension::Disposables::DisposableExtensions {
...
#[cfg(feature = "BGLib+DotnetExtension+Disposables+DisposableExtensions")]
impl std::ops::DerefMut for crate::BGLib::DotnetExtension::Disposables::DisposableExtensions {
...
impl crate::BGLib::DotnetExtension::Disposables::DisposableExtensions {
    pub fn AddTo_CompositeDisposable0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (disposable, compositeDisposable))? };
        Ok(__cordl_ret.into())
    }
