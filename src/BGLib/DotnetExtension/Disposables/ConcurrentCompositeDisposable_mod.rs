#[cfg(feature = "cordl_class_BGLib+DotnetExtension+Disposables+ConcurrentCompositeDisposable")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::BGLib::DotnetExtension::Disposables::ConcurrentCompositeDisposable {
