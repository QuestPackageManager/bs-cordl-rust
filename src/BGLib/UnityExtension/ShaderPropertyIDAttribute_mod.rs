...
impl crate::BGLib::UnityExtension::ShaderPropertyIDAttribute {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::UnityExtension::ShaderPropertyIDAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::BGLib::UnityExtension::ShaderPropertyIDAttribute as
