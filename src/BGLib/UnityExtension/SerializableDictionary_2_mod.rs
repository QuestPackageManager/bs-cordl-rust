...
> {
    __cordl_parent:
        crate::BGLib::UnityExtension::SerializableDictionaryBase_3<TKey, TValue, TValue>,
    ...
    for crate::BGLib::UnityExtension::SerializableDictionary_2<TKey, TValue>
{
    ...
    const CLASS_NAME: &'static str = "SerializableDictionary`2";
...
impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::BGLib::UnityExtension::SerializableDictionary_2<TKey, TValue>
{
    type Target = crate::BGLib::UnityExtension::SerializableDictionaryBase_3<TKey, TValue, TValue>;
    ...
    crate::BGLib::UnityExtension::SerializableDictionary_2<TKey, TValue>
{
    pub fn GetValue(
        &mut self,
        storage: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<TValue>>,
        i: i32,
