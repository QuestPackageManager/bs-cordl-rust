#[cfg(feature = "cordl_class_BGLib+UnityExtension+ExternalFileReader")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_BGLib+UnityExtension+ExternalFileReader")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::UnityExtension::ExternalFileReader {
