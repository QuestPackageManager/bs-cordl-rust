...
#[cfg(feature = "cordl_class_BGLib+UnityExtension+ButtonAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::UnityExtension::ButtonAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BGLib.UnityExtension";
    const CLASS_NAME: &'static str = "ButtonAttribute";
...
impl crate::BGLib::UnityExtension::ButtonAttribute {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (title))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BGLib+UnityExtension+ButtonAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::BGLib::UnityExtension::ButtonAttribute {
