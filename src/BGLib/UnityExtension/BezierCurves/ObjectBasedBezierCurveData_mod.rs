...
impl crate::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData as
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate
                    ::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData as
                    quest_hook::libil2cpp::Type > ::class(), "get_hasReferences", 0usize
                )
            });
