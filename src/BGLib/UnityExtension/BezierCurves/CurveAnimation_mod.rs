...
pub struct CurveAnimation {
    ...
    pub _bezierCurve:
        quest_hook::libil2cpp::Gc<crate::BGLib::UnityExtension::BezierCurves::BaseBezierCurve>,
    pub _duration: f32,
    pub _delay: f32,
...
impl crate::BGLib::UnityExtension::BezierCurves::CurveAnimation {
    ...
    pub type CurveEvent_1<T: quest_hook::libil2cpp::Type> =
...
#[cfg(feature = "BGLib+UnityExtension+BezierCurves+CurveAnimation+CurveEvent")]
impl std::ops::Deref for crate::BGLib::UnityExtension::BezierCurves::CurveAnimation_CurveEvent {
...
#[cfg(feature = "BGLib+UnityExtension+BezierCurves+CurveAnimation+CurveEvent")]
impl std::ops::DerefMut for crate::BGLib::UnityExtension::BezierCurves::CurveAnimation_CurveEvent {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
