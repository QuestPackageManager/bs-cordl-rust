#[cfg(feature = "cordl_class_BGLib+UnityExtension+ShaderPropertyIDFromRendererAttribute")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute {
...
#[cfg(feature = "BGLib+UnityExtension+ShaderPropertyIDFromRendererAttribute")]
impl std::ops::DerefMut for crate::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute {
...
impl crate::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (propertyName, nameFilter, filterPropType))?
        };
        Ok(__cordl_ret.into())
    }
}
