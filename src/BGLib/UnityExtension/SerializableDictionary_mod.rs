...
for crate::BGLib::UnityExtension::SerializableDictionary {
...
impl crate::BGLib::UnityExtension::SerializableDictionary {
    ...
    pub type Storage_1<T: quest_hook::libil2cpp::Type> = crate::BGLib::UnityExtension::SerializableDictionary_Storage_1<
        T,
    >;
}
#[cfg(feature = "cordl_class_BGLib+UnityExtension+SerializableDictionary")]
