...
pub struct SerializableHashSet_1<T: quest_hook::libil2cpp::Type> {
    ...
    pub m_hashSet: quest_hook::libil2cpp::Gc<
        crate::BGLib::UnityExtension::SerializableHashSetBase_HashSet_1<T>,
    >,
    pub m_keys: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppArray<T>>,
    __cordl_phantom_T: std::marker::PhantomData<T>,
}
#[cfg(feature = "cordl_class_BGLib+UnityExtension+SerializableHashSet_1")]
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::BGLib::UnityExtension::SerializableHashSet_1<T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "BGLib.UnityExtension";
    const CLASS_NAME: &'static str = "SerializableHashSet`1";
...
#[cfg(feature = "BGLib+UnityExtension+SerializableHashSet_1")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::BGLib::UnityExtension::SerializableHashSet_1<T>
{
    type Target = crate::BGLib::UnityExtension::SerializableHashSetBase;
...
#[cfg(feature = "BGLib+UnityExtension+SerializableHashSet_1")]
impl<T: quest_hook::libil2cpp::Type> crate::BGLib::UnityExtension::SerializableHashSet_1<T> {
    ...
    pub fn CopyFrom(
        &mut self,
        set: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::ISet_1<T>>,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::Gc<
                            crate::System::Collections::Generic::ISet_1<T>,
                        >),
...
#[cfg(feature = "BGLib+UnityExtension+SerializableHashSet_1")]
impl<T: quest_hook::libil2cpp::Type> AsRef<crate::UnityEngine::ISerializationCallbackReceiver>
    for crate::BGLib::UnityExtension::SerializableHashSet_1<T>
{
...
#[cfg(feature = "BGLib+UnityExtension+SerializableHashSet_1")]
impl<T: quest_hook::libil2cpp::Type> AsMut<crate::UnityEngine::ISerializationCallbackReceiver>
    for crate::BGLib::UnityExtension::SerializableHashSet_1<T>
{
