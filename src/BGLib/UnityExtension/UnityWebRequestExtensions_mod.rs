    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::System::Threading::Tasks::Task_1<
                crate::UnityEngine::Networking::UnityWebRequest_Result,
            >,
        > = unsafe { cordl_method_info.invoke_unchecked((), (request, cancellationToken))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_BGLib+UnityExtension+UnityWebRequestExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::BGLib::UnityExtension::UnityWebRequestExtensions {
