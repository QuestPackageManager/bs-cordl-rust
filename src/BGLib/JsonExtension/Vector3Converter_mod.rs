...
#[cfg(feature = "cordl_class_BGLib+JsonExtension+Vector3Converter")]
unsafe impl quest_hook::libil2cpp::Type for crate::BGLib::JsonExtension::Vector3Converter {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::UnityEngine::Vector3, 5usize>("ReadJson")
                    .unwrap_or_else(|e| {
                        panic!(
...
#[cfg(feature = "cordl_class_BGLib+JsonExtension+Vector3Converter")]
impl quest_hook::libil2cpp::ObjectType for crate::BGLib::JsonExtension::Vector3Converter {
