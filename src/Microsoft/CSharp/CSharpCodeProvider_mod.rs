...
#[cfg(feature = "Microsoft+CSharp+CSharpCodeProvider")]
impl crate::Microsoft::CSharp::CSharpCodeProvider {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Microsoft::CSharp::CSharpCodeProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Microsoft::CSharp::CSharpCodeProvider as
