...
#[cfg(feature = "Microsoft+CSharp+CodeDomProvider")]
unsafe impl quest_hook::libil2cpp::Type for crate::Microsoft::CSharp::CodeDomProvider {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Microsoft.CSharp";
    const CLASS_NAME: &'static str = "CodeDomProvider";
...
impl crate::Microsoft::CSharp::CodeDomProvider {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Microsoft::CSharp::CodeDomProvider as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Microsoft::CSharp::CodeDomProvider as
