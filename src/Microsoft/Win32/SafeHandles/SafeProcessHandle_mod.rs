...
impl crate::Microsoft::Win32::SafeHandles::SafeProcessHandle {
    ...
    pub fn ReleaseHandle(&mut self) -> quest_hook::libil2cpp::Result<bool> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Microsoft::Win32::SafeHandles::SafeProcessHandle as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), bool, 0usize>("ReleaseHandle")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Microsoft::Win32::SafeHandles::SafeProcessHandle as
