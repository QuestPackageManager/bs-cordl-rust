#[cfg(feature = "cordl_class_crypto+Security")]
#[repr(C)]
#[derive(Debug)]
pub struct Security {
...
impl crate::crypto::Security {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { cordl_method_info.invoke_unchecked((), (text, salt))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateCipher(
        isEncryption: bool,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::IBufferedCipher,
        > = unsafe { cordl_method_info.invoke_unchecked((), (isEncryption, key, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn Decrypt(
    ...
    > {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Decrypt",
                            3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { cordl_method_info.invoke_unchecked((), (cipherText, key, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn Encrypt(
    ...
    > {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(), "Encrypt",
                            3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { cordl_method_info.invoke_unchecked((), (plainText, key, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn GenerateText(
        _cordl_size: i32,
