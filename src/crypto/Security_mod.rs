...
impl crate::crypto::Security {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::crypto::Security as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::crypto::Security as quest_hook::libil2cpp::Type > ::class(),
                    "ComputeHash", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (text, salt))? };
        Ok(__cordl_ret.into())
    }
    pub fn CreateCipher(
        isEncryption: bool,
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            crate::Org::BouncyCastle::Crypto::IBufferedCipher,
        > = unsafe { method.invoke_unchecked((), (isEncryption, key, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn Decrypt(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (cipherText, key, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn Encrypt(
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppString,
        > = unsafe { method.invoke_unchecked((), (plainText, key, iv))? };
        Ok(__cordl_ret.into())
    }
    pub fn GenerateText(
        _cordl_size: i32,
