#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened")]
#[repr(C)]
#[derive(Debug)]
pub struct HierarchyFlattened {
...
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Hierarchy::HierarchyFlattened {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Hierarchy";
    const CLASS_NAME: &'static str = "HierarchyFlattened";
...
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened")]
impl std::ops::Deref for crate::Unity::Hierarchy::HierarchyFlattened {
...
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened")]
impl std::ops::DerefMut for crate::Unity::Hierarchy::HierarchyFlattened {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened")]
impl crate::Unity::Hierarchy::HierarchyFlattened {
    #[cfg(feature = "Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
    pub type BindingsMarshaller = crate::Unity::Hierarchy::HierarchyFlattened_BindingsMarshaller;
    #[cfg(feature = "Unity+Hierarchy+HierarchyFlattened+Enumerator")]
    pub type Enumerator = crate::Unity::Hierarchy::HierarchyFlattened_Enumerator;
    pub fn Contains(
        &mut self,
    ...
    pub fn Create(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), crate::System::IntPtr, 5usize>("Create")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info
                .invoke_unchecked((), (handlePtr, hierarchy, nodesPtr, nodesCount, version))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn CreateHierarchyFlattened(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), crate::System::IntPtr, 5usize>("CreateHierarchyFlattened")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info
                .invoke_unchecked((), (nativePtr, hierarchyPtr, nodesPtr, nodesCount, version))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Create_Injected(
        handlePtr: crate::System::IntPtr,
        hierarchy: crate::System::IntPtr,
        nodesPtr: quest_hook::libil2cpp::ByRefMut<crate::System::IntPtr>,
        nodesCount: quest_hook::libil2cpp::ByRefMut<i32>,
        version: quest_hook::libil2cpp::ByRefMut<i32>,
    ) -> quest_hook::libil2cpp::Result<crate::System::IntPtr> {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<i32>,
                        quest_hook::libil2cpp::ByRefMut<i32>,
                    ), crate::System::IntPtr, 5usize>("Create_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn EnumerateChildren(
        &mut self,
        node: quest_hook::libil2cpp::ByRefMut<crate::Unity::Hierarchy::HierarchyNode>,
    ) -> quest_hook::libil2cpp::Result<crate::Unity::Hierarchy::HierarchyFlattenedNodeChildren>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
        ...
        let __cordl_ret: crate::Unity::Hierarchy::HierarchyFlattenedNodeChildren =
    ...
    pub fn GetEnumerator(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Unity::Hierarchy::HierarchyFlattened_Enumerator> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (),
                        crate::Unity::Hierarchy::HierarchyFlattened_Enumerator,
                        0usize,
                    >("GetEnumerator")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Unity::Hierarchy::HierarchyFlattened_Enumerator =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn IndexOf(
    ...
    pub fn New_Hierarchy0(
        hierarchy: quest_hook::libil2cpp::Gc<crate::Unity::Hierarchy::Hierarchy>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
        let __cordl_object: &mut Self =
            <Self as quest_hook::libil2cpp::Type>::class().instantiate();
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (hierarchy))?;
        Ok(__cordl_object.into())
    }
    pub fn New_IntPtr_Hierarchy_IntPtr_i32_i32_1(
        nativePtr: crate::System::IntPtr,
        hierarchy: quest_hook::libil2cpp::Gc<crate::Unity::Hierarchy::Hierarchy>,
        nodesPtr: crate::System::IntPtr,
        nodesCount: i32,
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object).invoke_void(
            ".ctor",
            (nativePtr, hierarchy, nodesPtr, nodesCount, version),
        )?;
        Ok(__cordl_object.into())
    }
    ...
    pub fn UpdateHierarchyFlattened(
        handlePtr: crate::System::IntPtr,
        nodesPtr: crate::System::IntPtr,
        nodesCount: i32,
        version: i32,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "UpdateHierarchyFlattened", 4usize
                        )
                    })
            });
    ...
    pub fn _ctor_IntPtr_Hierarchy_IntPtr_i32_i32_1(
        &mut self,
        nativePtr: crate::System::IntPtr,
        hierarchy: quest_hook::libil2cpp::Gc<crate::Unity::Hierarchy::Hierarchy>,
        nodesPtr: crate::System::IntPtr,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (nativePtr, hierarchy, nodesPtr, nodesCount, version))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::Hierarchy::HierarchyFlattened {
...
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened")]
impl AsRef<crate::System::IDisposable> for crate::Unity::Hierarchy::HierarchyFlattened {
    fn as_ref(&self) -> &crate::System::IDisposable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened")]
impl AsMut<crate::System::IDisposable> for crate::Unity::Hierarchy::HierarchyFlattened {
    fn as_mut(&mut self) -> &mut crate::System::IDisposable {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
#[repr(C)]
#[derive(Debug)]
pub struct HierarchyFlattened_BindingsMarshaller {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
}
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::Unity::Hierarchy::HierarchyFlattened_BindingsMarshaller
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Hierarchy";
    const CLASS_NAME: &'static str = "HierarchyFlattened/BindingsMarshaller";
    fn matches_reference_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        ty.class()
            .is_assignable_from(<Self as quest_hook::libil2cpp::Type>::class())
    }
...
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
impl std::ops::Deref for crate::Unity::Hierarchy::HierarchyFlattened_BindingsMarshaller {
    type Target = quest_hook::libil2cpp::Il2CppObject;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
...
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
impl std::ops::DerefMut for crate::Unity::Hierarchy::HierarchyFlattened_BindingsMarshaller {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
impl crate::Unity::Hierarchy::HierarchyFlattened_BindingsMarshaller {
    pub fn ConvertToNative(
        ...
        let __cordl_ret: crate::System::IntPtr =
            unsafe { cordl_method_info.invoke_unchecked((), (hierarchyFlattened))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened+BindingsMarshaller")]
...
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened+Enumerator")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
pub struct HierarchyFlattened_Enumerator {
...
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyFlattened+Enumerator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Hierarchy::HierarchyFlattened_Enumerator {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Hierarchy";
    const CLASS_NAME: &'static str = "HierarchyFlattened/Enumerator";
...
unsafe impl quest_hook::libil2cpp::Argument
    for crate::Unity::Hierarchy::HierarchyFlattened_Enumerator
{
    type Type = Self;
...
#[cfg(feature = "Unity+Hierarchy+HierarchyFlattened+Enumerator")]
impl crate::Unity::Hierarchy::HierarchyFlattened_Enumerator {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hierarchyFlattened))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
        &mut self,
