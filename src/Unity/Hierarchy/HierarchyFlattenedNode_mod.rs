...
pub struct HierarchyFlattenedNode {
    ...
    pub m_ParentOffset: i32,
    pub m_NextSiblingOffset: i32,
...
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Hierarchy::HierarchyFlattenedNode {
    ...
    const CLASS_NAME: &'static str = "HierarchyFlattenedNode";
...
impl crate::Unity::Hierarchy::HierarchyFlattenedNode {
    pub fn Equals_HierarchyFlattenedNode0(
        &mut self,
    ...
    pub fn GetNodeByRef(
        hierarchyFlattenedNode: quest_hook::libil2cpp::ByRefMut<
