...
impl crate::Unity::Hierarchy::HierarchyFlattenedNodeChildren {
    ...
    > {
        ...
        let __cordl_ret: crate::Unity::Hierarchy::HierarchyFlattenedNodeChildren_Enumerator =
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hierarchyFlattened, node))? };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Unity::Hierarchy::HierarchyFlattenedNodeChildren_Enumerator {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (enumerable, node))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
        &mut self,
