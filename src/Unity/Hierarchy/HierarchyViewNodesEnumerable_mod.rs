...
pub struct HierarchyViewNodesEnumerable {
    ...
    pub m_Predicate:
        quest_hook::libil2cpp::Gc<crate::Unity::Hierarchy::HierarchyViewNodesEnumerable_Predicate>,
    pub m_Flags: crate::Unity::Hierarchy::HierarchyNodeFlags,
}
#[cfg(feature = "cordl_class_Unity+Hierarchy+HierarchyViewNodesEnumerable")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Hierarchy::HierarchyViewNodesEnumerable {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
impl crate::Unity::Hierarchy::HierarchyViewNodesEnumerable {
    ...
    > {
        ...
        let __cordl_ret: crate::Unity::Hierarchy::HierarchyViewNodesEnumerable_Enumerator =
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (viewModel, flags, predicate))? };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "Unity+Hierarchy+HierarchyViewNodesEnumerable+Predicate")]
impl std::ops::Deref for crate::Unity::Hierarchy::HierarchyViewNodesEnumerable_Predicate {
...
#[cfg(feature = "Unity+Hierarchy+HierarchyViewNodesEnumerable+Predicate")]
impl std::ops::DerefMut for crate::Unity::Hierarchy::HierarchyViewNodesEnumerable_Predicate {
