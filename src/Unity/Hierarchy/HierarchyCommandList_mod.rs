...
for crate::Unity::Hierarchy::HierarchyCommandList {
...
impl crate::Unity::Hierarchy::HierarchyCommandList {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (nativePtr))?
        };
        Ok(__cordl_ret.into())
    }
}
...
impl crate::Unity::Hierarchy::HierarchyCommandList_BindingsMarshaller {
    pub fn ConvertToNative(
        ...
        let __cordl_ret: crate::System::IntPtr = unsafe {
            cordl_method_info.invoke_unchecked((), (cmdList))?
        };
        Ok(__cordl_ret.into())
    }
}
