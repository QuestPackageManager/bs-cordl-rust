...
#[cfg(feature = "cordl_class_Unity+Profiling+Memory+MemoryProfiler")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Profiling::Memory::MemoryProfiler {
...
impl crate::Unity::Profiling::Memory::MemoryProfiler {
    pub fn FinalizeSnapshot(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        bool,
                    ), quest_hook::libil2cpp::Void, 2usize>("FinalizeSnapshot")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (path, result))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn WriteIntToByteArray(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        i32,
                    ), i32, 3usize>("WriteIntToByteArray")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (array, offset, value))? };
        Ok(__cordl_ret.into())
    }
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        i32,
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>,
                    ), i32, 3usize>("WriteStringToByteArray")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Unity+Profiling+Memory+MemoryProfiler")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::Profiling::Memory::MemoryProfiler {
