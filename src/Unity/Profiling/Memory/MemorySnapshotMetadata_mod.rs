...
for crate::Unity::Profiling::Memory::MemorySnapshotMetadata {
    ...
    const CLASS_NAME: &'static str = "MemorySnapshotMetadata";
...
impl crate::Unity::Profiling::Memory::MemorySnapshotMetadata {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Profiling::Memory::MemorySnapshotMetadata as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Profiling::Memory::MemorySnapshotMetadata as
