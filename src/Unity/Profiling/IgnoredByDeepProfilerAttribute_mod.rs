...
for crate::Unity::Profiling::IgnoredByDeepProfilerAttribute {
    ...
    const CLASS_NAME: &'static str = "IgnoredByDeepProfilerAttribute";
...
#[cfg(feature = "Unity+Profiling+IgnoredByDeepProfilerAttribute")]
impl crate::Unity::Profiling::IgnoredByDeepProfilerAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Profiling::IgnoredByDeepProfilerAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Profiling::IgnoredByDeepProfilerAttribute as
