...
#[repr(C)]
pub struct ProfilerMarker_2<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type> {
    __cordl_phantom_TP1: std::marker::PhantomData<TP1>,
    __cordl_phantom_TP2: std::marker::PhantomData<TP2>,
}
#[cfg(feature = "cordl_class_Unity+Profiling+ProfilerMarker_2")]
unsafe impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Unity::Profiling::ProfilerMarker_2<TP1, TP2>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Profiling", "ProfilerMarker`2")
                .unwrap()
...
#[cfg(feature = "cordl_class_Unity+Profiling+ProfilerMarker_2")]
unsafe impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Argument for crate::Unity::Profiling::ProfilerMarker_2<TP1, TP2>
{
    type Type = Self;
...
#[cfg(feature = "cordl_class_Unity+Profiling+ProfilerMarker_2")]
unsafe impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Parameter for crate::Unity::Profiling::ProfilerMarker_2<TP1, TP2>
{
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Profiling+ProfilerMarker_2")]
unsafe impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Returned for crate::Unity::Profiling::ProfilerMarker_2<TP1, TP2>
{
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Profiling+ProfilerMarker_2")]
unsafe impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ThisArgument for crate::Unity::Profiling::ProfilerMarker_2<TP1, TP2>
{
    type Type = Self;
...
impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    crate::Unity::Profiling::ProfilerMarker_2<TP1, TP2>
{
    ...
    pub fn Auto(
        ...
        p1: TP1,
        p2: TP2,
    ) -> quest_hook::libil2cpp::Result<crate::Unity::Profiling::ProfilerMarker_2_AutoScope<TP1, TP2>>
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Profiling::ProfilerMarker_2_AutoScope<TP1, TP2> =
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TP1, TP2), quest_hook::libil2cpp::Void, 2usize>("Begin")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (name, param1Name, param2Name))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (category, name, param1Name, param2Name))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "cordl_class_Unity+Profiling+ProfilerMarker_2+AutoScope")]
unsafe impl<TP1: quest_hook::libil2cpp::Type, TP2: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Unity::Profiling::ProfilerMarker_2_AutoScope<TP1, TP2>
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Profiling";
    ...
    crate::Unity::Profiling::ProfilerMarker_2_AutoScope<TP1, TP2>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (marker, p1, p2))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "Unity+Profiling+ProfilerMarker_2+AutoScope")]
