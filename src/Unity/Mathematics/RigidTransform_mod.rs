...
#[cfg(feature = "cordl_class_Unity+Mathematics+RigidTransform")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Unity::Mathematics::RigidTransform {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Unity+Mathematics+RigidTransform")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Unity::Mathematics::RigidTransform {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Mathematics+RigidTransform")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Unity::Mathematics::RigidTransform {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Mathematics+RigidTransform")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::Unity::Mathematics::RigidTransform {
    type Type = Self;
...
impl crate::Unity::Mathematics::RigidTransform {
    pub fn AxisAngle(
        ...
        let __cordl_ret: crate::Unity::Mathematics::RigidTransform =
    ...
    pub fn Equals_RigidTransform0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(crate::Unity::Mathematics::RigidTransform), bool, 1usize>(
                        "Equals",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::Unity::Mathematics::RigidTransform, 2usize>(
                        "Euler"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn RotateX(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(f32), crate::Unity::Mathematics::RigidTransform, 1usize>(
                        "RotateX",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn Translate(
        ...
        let __cordl_ret: crate::Unity::Mathematics::RigidTransform =
            unsafe { cordl_method_info.invoke_unchecked((), (vector))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_float3x3_float3_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (rotation, translation))? };
        Ok(__cordl_ret.into())
    }
