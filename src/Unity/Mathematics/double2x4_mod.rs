...
#[cfg(feature = "Unity+Mathematics+double2x4")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double2x4>>
for crate::Unity::Mathematics::double2x4 {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double2x4> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+double2x4")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double2x4>>
for crate::Unity::Mathematics::double2x4 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double2x4> {
        todo!()
    }
}
