...
for crate::Unity::Mathematics::PostNormalizeAttribute {
    ...
    const CLASS_NAME: &'static str = "PostNormalizeAttribute";
...
#[cfg(feature = "Unity+Mathematics+PostNormalizeAttribute")]
impl crate::Unity::Mathematics::PostNormalizeAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Mathematics::PostNormalizeAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Mathematics::PostNormalizeAttribute as
