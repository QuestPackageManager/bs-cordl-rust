...
#[cfg(feature = "Unity+Mathematics+int3")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3>>
for crate::Unity::Mathematics::int3 {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+int3")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3>>
for crate::Unity::Mathematics::int3 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3> {
        todo!()
    }
}
