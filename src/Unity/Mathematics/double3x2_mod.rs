...
#[cfg(feature = "Unity+Mathematics+double3x2")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double3x2>>
for crate::Unity::Mathematics::double3x2 {
    fn as_ref(
        &self,
    ) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double3x2> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+double3x2")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double3x2>>
for crate::Unity::Mathematics::double3x2 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::double3x2> {
        todo!()
    }
}
