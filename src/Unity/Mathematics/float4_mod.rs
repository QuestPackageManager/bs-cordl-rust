...
#[cfg(feature = "Unity+Mathematics+float4")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::float4>>
for crate::Unity::Mathematics::float4 {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::float4> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+float4")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::float4>>
for crate::Unity::Mathematics::float4 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::float4> {
        todo!()
    }
}
