...
impl crate::Unity::Mathematics::float2x4 {
    pub fn Equals_Il2CppObject1(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Mathematics::float2x4 as quest_hook::libil2cpp::Type>::class()
            .find_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Mathematics::float2x4 as quest_hook::libil2cpp::Type >
                    ::class(), "Equals", 1usize
                )
            });
