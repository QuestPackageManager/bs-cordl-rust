...
#[cfg(feature = "Unity+Mathematics+int4")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4>>
for crate::Unity::Mathematics::int4 {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+int4")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4>>
for crate::Unity::Mathematics::int4 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4> {
        todo!()
    }
}
