...
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate ::Unity::Mathematics::int4x2 =>
...
#[cfg(feature = "Unity+Mathematics+int4x2")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4x2>>
for crate::Unity::Mathematics::int4x2 {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4x2> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+int4x2")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4x2>>
for crate::Unity::Mathematics::int4x2 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int4x2> {
        todo!()
    }
}
