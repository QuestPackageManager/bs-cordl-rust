#[cfg(feature = "cordl_class_Unity+Mathematics+DoNotNormalizeAttribute")]
#[repr(C)]
#[derive(Debug)]
...
#[cfg(feature = "cordl_class_Unity+Mathematics+DoNotNormalizeAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Mathematics::DoNotNormalizeAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Mathematics";
    const CLASS_NAME: &'static str = "DoNotNormalizeAttribute";
...
#[cfg(feature = "cordl_class_Unity+Mathematics+DoNotNormalizeAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::Mathematics::DoNotNormalizeAttribute {
