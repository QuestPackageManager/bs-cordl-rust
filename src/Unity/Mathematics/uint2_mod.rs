...
impl crate::Unity::Mathematics::uint2 {
    ...
    pub fn _ctor_uint2_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (xy))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "Unity+Mathematics+uint2")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::uint2>>
for crate::Unity::Mathematics::uint2 {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::uint2> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+uint2")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::uint2>>
for crate::Unity::Mathematics::uint2 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::uint2> {
        todo!()
    }
}
