...
quest_hook::libil2cpp::unsafe_impl_value_type!(
    in quest_hook::libil2cpp for crate ::Unity::Mathematics::int3x4 =>
...
#[cfg(feature = "Unity+Mathematics+int3x4")]
impl AsRef<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3x4>>
for crate::Unity::Mathematics::int3x4 {
    fn as_ref(&self) -> &quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3x4> {
        todo!()
    }
}
#[cfg(feature = "Unity+Mathematics+int3x4")]
impl AsMut<quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3x4>>
for crate::Unity::Mathematics::int3x4 {
    fn as_mut(
        &mut self,
    ) -> &mut quest_hook::libil2cpp::Gc<crate::Unity::Mathematics::int3x4> {
        todo!()
    }
}
