...
> {
    pub m_HashMapData:
        crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2<TKey, TValue>,
    ...
    for crate::Unity::Collections::NativeParallelHashMap_2<TKey, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Collections", "NativeParallelHashMap`2")
                .unwrap()
    ...
    crate::Unity::Collections::NativeParallelHashMap_2<TKey, TValue>
{
    ...
    pub type ReadOnly = crate::Unity::Collections::NativeParallelHashMap_2_ReadOnly<TKey, TValue>;
    pub fn Add(
        &mut self,
        key: TKey,
        item: TValue,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeParallelHashMap_2_ReadOnly<TKey, TValue> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
> {
    pub m_Writer:
        crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ParallelWriter<
            TKey,
            TValue,
        >,
    __cordl_phantom_TKey: std::marker::PhantomData<TKey>,
    ...
    crate::Unity::Collections::NativeParallelHashMap_2_ParallelWriter<TKey, TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (key, item, threadIndexOverride))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Capacity(&mut self) -> quest_hook::libil2cpp::Result<i32>
    where
    ...
    crate::Unity::Collections::NativeParallelHashMap_2_ReadOnly<TKey, TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (hashMapData))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Capacity(&mut self) -> quest_hook::libil2cpp::Result<i32>
    where
