...
for crate::Unity::Collections::NativeArrayExtensions {
...
impl crate::Unity::Collections::NativeArrayExtensions {
    ...
    pub type NativeArrayStaticId_1<T: quest_hook::libil2cpp::Type> = crate::Unity::Collections::NativeArrayExtensions_NativeArrayStaticId_1<
        T,
    >;
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (array, length, allocator, options))?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeArray_1<U> = unsafe {
            cordl_method_info.invoke_unchecked((), (array))?
        };
        Ok(__cordl_ret.into())
    }
...
#[cfg(
    feature = "cordl_class_Unity+Collections+NativeArrayExtensions+NativeArrayStaticId_1"
)]
#[repr(C)]
