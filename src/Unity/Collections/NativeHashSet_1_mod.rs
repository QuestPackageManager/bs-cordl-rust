...
impl<T: quest_hook::libil2cpp::Type> crate::Unity::Collections::NativeHashSet_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeHashSet_1_ReadOnly<T> = unsafe {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeHashSet_1_Enumerator<T> = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (initialCapacity, allocator))?
        };
        Ok(__cordl_ret.into())
    }
...
pub struct NativeHashSet_1_Enumerator<T: quest_hook::libil2cpp::Type> {
    pub m_Enumerator: crate::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1_Enumerator<
        T,
    >,
    __cordl_phantom_T: std::marker::PhantomData<T>,
}
