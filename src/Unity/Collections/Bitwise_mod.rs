...
impl crate::Unity::Collections::Bitwise {
    pub fn AlignDown(value: i32, alignPow2: i32) -> quest_hook::libil2cpp::Result<i32> {
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (value, alignPow2))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn CountBits(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (ptr, length, pos, numBits))? };
        Ok(__cordl_ret.into())
    }
    pub fn ExtractBits_u32_u32_0(
        ...
        let __cordl_ret: u32 =
            unsafe { cordl_method_info.invoke_unchecked((), (input, pos, mask))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Find(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (ptr, pos, count, numBits))? };
        Ok(__cordl_ret.into())
    }
    pub fn FindByte(
        ptr: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (ptr, beginBit, endBit, numBits))? };
        Ok(__cordl_ret.into())
    }
    pub fn FindUint(
        ptr: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
    ...
    pub fn IsSet(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked((), (ptr, pos))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReplaceBits_u32_u32_u32_0(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(u32, i32, u32, u32), u32, 4usize>("ReplaceBits")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: u32 =
            unsafe { cordl_method_info.invoke_unchecked((), (input, pos, mask, value))? };
        Ok(__cordl_ret.into())
    }
    pub fn ReplaceBits_u64_u64_u64_1(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(u64, i32, u64, u64), u64, 4usize>("ReplaceBits")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
