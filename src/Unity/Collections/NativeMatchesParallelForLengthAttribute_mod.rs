...
impl std::ops::Deref for crate::Unity::Collections::NativeMatchesParallelForLengthAttribute {
...
#[cfg(feature = "Unity+Collections+NativeMatchesParallelForLengthAttribute")]
impl std::ops::DerefMut for crate::Unity::Collections::NativeMatchesParallelForLengthAttribute {
