...
impl crate::Unity::Collections::FixedString32Bytes {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CheckCopyError", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (error, source))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    > {
        ...
        let __cordl_ret: crate::Unity::Collections::FixedString32Bytes_Enumerator = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Initialize_Il2CppObject_i32_2(
        ...
        let __cordl_ret: crate::Unity::Collections::FormatError = unsafe {
            cordl_method_info.invoke_unchecked(self, (srcBytes, srcLength))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Initialize_Unicode_Rune_i32_1(
        ...
        let __cordl_ret: crate::Unity::Collections::FormatError = unsafe {
            cordl_method_info.invoke_unchecked(self, (rune, count))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
    ...
    pub fn TryResize(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (newLength, clearOptions))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "get_UTF8MaxLengthInBytes", 0usize
                        )
                    })
            });
    ...
    pub fn op_Implicit_ByRefMut0(
        ...
        let __cordl_ret: crate::Unity::Collections::FixedString64Bytes = unsafe {
            cordl_method_info.invoke_unchecked((), (fs))?
        };
        Ok(__cordl_ret.into())
    }
