...
impl<T: quest_hook::libil2cpp::Type> crate::Unity::Collections::FixedList4096Bytes_1<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::FixedList4096Bytes_1_Enumerator<T> = unsafe {
            cordl_method_info.invoke_unchecked(self, ())?
        };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::FixedList4096Bytes_1<T> = unsafe {
