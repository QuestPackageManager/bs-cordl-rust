#[cfg(feature = "cordl_class_Unity+Collections+LeakCategory")]
...
#[cfg(feature = "cordl_class_Unity+Collections+LeakCategory")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Collections::LeakCategory {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections";
    const CLASS_NAME: &'static str = "LeakCategory";
...
#[cfg(feature = "cordl_class_Unity+Collections+LeakCategory")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Unity::Collections::LeakCategory {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
