...
impl<T: quest_hook::libil2cpp::Type> crate::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T> {
    #[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeList_1+Enumerator")]
    pub type Enumerator = crate::Unity::Collections::LowLevel::Unsafe::UnsafeList_1_Enumerator<T>;
    ...
    pub type ReadOnly = crate::Unity::Collections::LowLevel::Unsafe::UnsafeList_1_ReadOnly<T>;
    pub fn Add(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::LowLevel::Unsafe::UnsafeList_1_ReadOnly<T> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32, i32), quest_hook::libil2cpp::Void, 2usize>("CheckBeginEnd")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (length, index))? };
        Ok(__cordl_ret.into())
    }
    pub fn CheckNull(
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        quest_hook::libil2cpp::ByRefMut<U>,
                    ), quest_hook::libil2cpp::Void, 2usize>("Destroy")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (listData, allocator))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::LowLevel::Unsafe::UnsafeList_1_Enumerator<T> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn InsertRange(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (allocator, newCapacity))? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("ResizeExact")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (allocator, capacity))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeList_1+ParallelReader")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeList_1+ParallelWriter")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
