...
for crate::Unity::Collections::LowLevel::Unsafe::NativeContainerIsReadOnlyAttribute {
    ...
    const CLASS_NAME: &'static str = "NativeContainerIsReadOnlyAttribute";
...
impl crate::Unity::Collections::LowLevel::Unsafe::NativeContainerIsReadOnlyAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Collections::LowLevel::Unsafe::NativeContainerIsReadOnlyAttribute as quest_hook::libil2cpp::Type>::class()
