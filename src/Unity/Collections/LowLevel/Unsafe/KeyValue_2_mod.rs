#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+KeyValue_2")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
pub struct KeyValue_2<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type> {
...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::KeyValue_2<TKey, TValue>
{
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+KeyValue_2")]
