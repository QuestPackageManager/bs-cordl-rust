#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashMapDisposeJob")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
#[cfg_attr(feature = "derive_Clone", derive(Clone))]
#[cfg_attr(feature = "derive_Default", derive(Default))]
#[cfg_attr(feature = "derive_PartialEq", derive(PartialEq))]
#[repr(C)]
pub struct UnsafeParallelHashMapDisposeJob {
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDisposeJob
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeParallelHashMapDisposeJob";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashMapDisposeJob")]
impl crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDisposeJob {
