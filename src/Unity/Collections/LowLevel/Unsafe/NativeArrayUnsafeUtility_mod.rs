#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+NativeArrayUnsafeUtility")]
#[repr(C)]
#[derive(Debug)]
...
impl std::ops::Deref for crate::Unity::Collections::LowLevel::Unsafe::NativeArrayUnsafeUtility {
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+NativeArrayUnsafeUtility")]
impl std::ops::DerefMut for crate::Unity::Collections::LowLevel::Unsafe::NativeArrayUnsafeUtility {
...
impl crate::Unity::Collections::LowLevel::Unsafe::NativeArrayUnsafeUtility {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeArray_1<T> =
            unsafe { cordl_method_info.invoke_unchecked((), (dataPointer, length, allocator))? };
        Ok(__cordl_ret.into())
    }
