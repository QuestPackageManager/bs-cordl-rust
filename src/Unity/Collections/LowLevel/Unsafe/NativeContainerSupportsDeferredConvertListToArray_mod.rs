...
impl crate::Unity::Collections::LowLevel::Unsafe::NativeContainerSupportsDeferredConvertListToArray {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Collections::LowLevel::Unsafe::NativeContainerSupportsDeferredConvertListToArray as quest_hook::libil2cpp::Type>::class()
