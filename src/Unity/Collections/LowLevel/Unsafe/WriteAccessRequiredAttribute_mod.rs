...
impl crate::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute as quest_hook::libil2cpp::Type>::class()
