#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+WriteAccessRequiredAttribute")]
#[repr(C)]
#[derive(Debug)]
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute
{
    ...
    const CLASS_NAME: &'static str = "WriteAccessRequiredAttribute";
...
impl std::ops::Deref for crate::Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute {
