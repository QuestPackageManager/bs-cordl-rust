...
unsafe impl quest_hook::libil2cpp::Type
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataDisposeJob
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeParallelHashMapDataDisposeJob";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashMapDataDisposeJob")]
impl crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataDisposeJob {
