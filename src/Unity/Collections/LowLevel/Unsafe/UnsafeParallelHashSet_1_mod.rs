...
> crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1<T> {
    #[cfg(
        feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashSet_1+Enumerator"
    )]
    pub type Enumerator = crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1_Enumerator<
        T,
    >;
    #[cfg(
        feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashSet_1+ParallelWriter"
    )]
    pub type ParallelWriter = crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1_ParallelWriter<
        T,
    >;
    #[cfg(
        feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashSet_1+ReadOnly"
    )]
    pub type ReadOnly = crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1_ReadOnly<
        T,
    >;
...
#[cfg(
    feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashSet_1+Enumerator"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
...
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1_ParallelWriter<
    T,
> {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(
    feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashSet_1+ReadOnly"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
