...
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeListTDebugView_1<T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeListTDebugView`1";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeListTDebugView_1")]
...
impl<T: quest_hook::libil2cpp::Type>
    crate::Unity::Collections::LowLevel::Unsafe::UnsafeListTDebugView_1<T>
{
    pub fn New(
        data: crate::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>,
