...
> {
    ...
    pub m_Target: crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<
        TKey,
        TValue,
    >,
...
#[cfg(
    feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelMultiHashMapDebuggerTypeProxy_2"
)]
impl<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
