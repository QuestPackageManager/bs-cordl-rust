#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeText")]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
pub struct UnsafeText {
    pub m_UntypedListData: crate::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeList,
}
#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeText")]
unsafe impl quest_hook::libil2cpp::Type
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeText {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeText";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeText")]
impl crate::Unity::Collections::LowLevel::Unsafe::UnsafeText {
    pub fn Alloc(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CheckCapacityInRange", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (value, length))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ThrowCopyError", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (error, source))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn ToString(
