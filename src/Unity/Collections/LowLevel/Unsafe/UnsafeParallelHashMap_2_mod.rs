    ...
    crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2<TKey, TValue>
{
    ...
    pub type Enumerator =
        crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_Enumerator<
            ...
            TValue,
        >;
    #[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashMap_2+ParallelWriter")]
    ...
    pub type ReadOnly =
        crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ReadOnly<TKey, TValue>;
    pub fn Add(
        &mut self,
        key: TKey,
        item: TValue,
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashMap_2+Enumerator")]
impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_Enumerator<TKey, TValue>
{
...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2_ReadOnly<TKey, TValue>
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
