...
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<
    T,
> {
...
#[cfg(
    feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashSetDebuggerTypeProxy_1"
)]
...
> crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<
    T,
> {
    pub fn New(
