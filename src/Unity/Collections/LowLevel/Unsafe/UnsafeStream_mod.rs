    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream
{
    ...
    const CLASS_NAME: &'static str = "UnsafeStream";
...
impl crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream {
    ...
    pub type Reader = crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader;
    #[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeStream+Writer")]
    pub type Writer = crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer;
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_ConstructJob
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeStream/ConstructJob";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_ConstructJobList
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeStream/ConstructJobList";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_DisposeJob
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeStream/DisposeJob";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeStream/Reader";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
pub struct UnsafeStream_Writer {
    ...
    pub m_FirstOffset: i32,
    pub m_NumberOfBlocks: i32,
    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer
{
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeStream/Writer";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeStream+Writer")]
impl crate::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer {
    pub fn Allocate_0<T>(
        &mut self,
