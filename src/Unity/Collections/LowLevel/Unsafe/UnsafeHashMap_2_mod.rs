#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2")]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
pub struct UnsafeHashMap_2<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> {
    pub m_Data: crate::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1<TKey>,
...
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2<TKey, TValue> {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeHashMap`2";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2")]
impl<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2<TKey, TValue> {
    #[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2+Enumerator")]
    pub type Enumerator = crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_Enumerator<
        TKey,
        TValue,
    >;
    #[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2+ReadOnly")]
    pub type ReadOnly = crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_ReadOnly<
        TKey,
        TValue,
    >;
    pub fn Add(
    ...
    pub fn AsReadOnly(
        ...
        crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_ReadOnly<
            TKey,
            TValue,
        >,
    >
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_ReadOnly<
            TKey,
            TValue,
    ...
    pub fn GetEnumerator(
        ...
        crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_Enumerator<
            TKey,
            TValue,
        >,
    >
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_Enumerator<
            TKey,
            TValue,
        > = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
...
#[cfg(
    feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2+Enumerator"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
pub struct UnsafeHashMap_2_Enumerator<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> {
...
unsafe impl<
    ...
    TValue: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::Type
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_Enumerator<
    TKey,
    TValue,
> {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeHashMap`2/Enumerator";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<
            &'static quest_hook::libil2cpp::Il2CppClass,
        > = ::std::sync::OnceLock::new();
...
impl<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_Enumerator<TKey, TValue> {
    pub fn Dispose(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
...
#[cfg(
    feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2+ReadOnly"
)]
#[repr(C)]
#[derive(Debug, Clone, Default, PartialEq)]
pub struct UnsafeHashMap_2_ReadOnly<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> {
    pub m_Data: crate::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1<TKey>,
...
unsafe impl<
    ...
    TValue: quest_hook::libil2cpp::Type,
> quest_hook::libil2cpp::Type
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_ReadOnly<TKey, TValue> {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
    const CLASS_NAME: &'static str = "UnsafeHashMap`2/ReadOnly";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<
            &'static quest_hook::libil2cpp::Il2CppClass,
        > = ::std::sync::OnceLock::new();
...
impl<
    TKey: quest_hook::libil2cpp::Type,
    TValue: quest_hook::libil2cpp::Type,
> crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_ReadOnly<TKey, TValue> {
    pub fn ContainsKey(&mut self, key: TKey) -> quest_hook::libil2cpp::Result<bool>
    where
        TKey: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        (quest_hook::libil2cpp::ByRefMut<
                            crate::Unity::Collections::LowLevel::Unsafe::HashMapHelper_1<
                                TKey,
                            >,
                        >),
                        quest_hook::libil2cpp::Void,
