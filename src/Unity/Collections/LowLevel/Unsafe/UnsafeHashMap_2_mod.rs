...
#[repr(C)]
pub struct UnsafeHashMap_2<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type> {
...
#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2+Enumerator")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
...
unsafe impl<TKey: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Unity::Collections::LowLevel::Unsafe::UnsafeHashMap_2_Enumerator<TKey, TValue>
{
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections.LowLevel.Unsafe";
...
#[cfg(feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeHashMap_2+ReadOnly")]
#[derive(Debug, Clone, Default, PartialEq)]
#[repr(C)]
