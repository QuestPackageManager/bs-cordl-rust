    ...
    for crate::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeParallelHashMap
{
    ...
    const CLASS_NAME: &'static str = "UntypedUnsafeParallelHashMap";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UntypedUnsafeParallelHashMap")]
impl crate::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeParallelHashMap {}
