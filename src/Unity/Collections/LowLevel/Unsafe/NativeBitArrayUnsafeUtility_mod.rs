#[cfg(
    feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+NativeBitArrayUnsafeUtility"
)]
#[repr(C)]
#[derive(Debug)]
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ConvertExistingDataToNativeBitArray", 3usize
                        )
                    })
            });
        let __cordl_ret: crate::Unity::Collections::NativeBitArray = unsafe {
            cordl_method_info.invoke_unchecked((), (ptr, sizeInBytes, allocator))?
        };
        Ok(__cordl_ret.into())
    }
}
