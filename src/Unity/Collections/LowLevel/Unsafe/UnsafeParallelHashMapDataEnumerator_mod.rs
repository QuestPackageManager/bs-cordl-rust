...
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataEnumerator {
    ...
    const CLASS_NAME: &'static str = "UnsafeParallelHashMapDataEnumerator";
...
#[cfg(feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelHashMapDataEnumerator")]
impl crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataEnumerator {
    pub fn GetCurrent<TKey, TValue>(
        &mut self,
