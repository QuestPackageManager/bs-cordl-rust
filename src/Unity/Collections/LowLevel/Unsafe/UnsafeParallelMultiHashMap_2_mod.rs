#[cfg(
    feature = "cordl_class_Unity+Collections+LowLevel+Unsafe+UnsafeParallelMultiHashMap_2"
)]
#[repr(C)]
...
for crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<
    TKey,
    TValue,
> {
    type Held<'a> = Self;
...
> {
    #[cfg(
        feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelMultiHashMap_2+Enumerator"
    )]
    pub type Enumerator = crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_Enumerator<
        TKey,
        TValue,
    >;
    #[cfg(
    ...
    pub type ParallelWriter = crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_ParallelWriter<
        TKey,
        TValue,
    >;
    #[cfg(
        feature = "Unity+Collections+LowLevel+Unsafe+UnsafeParallelMultiHashMap_2+ReadOnly"
    )]
    pub type ReadOnly = crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_ReadOnly<
        TKey,
        TValue,
    >;
    pub fn Add(
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
        TValueEQ: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> = std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo = METHOD
...
pub struct UnsafeParallelMultiHashMap_2_Enumerator<
    ...
    TValue: quest_hook::libil2cpp::Type,
> {
    pub hashmap: crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<
        TKey,
        TValue,
    >,
    pub key: TKey,
