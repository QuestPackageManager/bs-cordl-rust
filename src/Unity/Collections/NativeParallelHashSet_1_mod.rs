...
> crate::Unity::Collections::NativeParallelHashSet_1<T> {
    ...
    pub type Enumerator = crate::Unity::Collections::NativeParallelHashSet_1_Enumerator<
        T,
    >;
    #[cfg(feature = "Unity+Collections+NativeParallelHashSet_1+ParallelWriter")]
    pub type ParallelWriter = crate::Unity::Collections::NativeParallelHashSet_1_ParallelWriter<
        T,
    >;
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeParallelHashSet_1_ParallelWriter<
            T,
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeParallelHashSet_1_ReadOnly<
            T,
        > = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Collections::NativeParallelHashSet_1_Enumerator<
            T,
        > = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
...
pub struct NativeParallelHashSet_1_ParallelWriter<T: quest_hook::libil2cpp::Type> {
    pub m_Data: crate::Unity::Collections::NativeParallelHashMap_2_ParallelWriter<
        T,
        bool,
    >,
    __cordl_phantom_T: std::marker::PhantomData<T>,
...
> crate::Unity::Collections::NativeParallelHashSet_1_ParallelWriter<T> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked(self, (item, threadIndexOverride))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Capacity(&mut self) -> quest_hook::libil2cpp::Result<i32>
...
pub struct NativeParallelHashSet_1_ReadOnly<T: quest_hook::libil2cpp::Type> {
    pub m_Data: crate::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2<
        T,
        bool,
    >,
    __cordl_phantom_T: std::marker::PhantomData<T>,
