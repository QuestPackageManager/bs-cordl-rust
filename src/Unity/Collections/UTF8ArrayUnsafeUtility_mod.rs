...
#[cfg(feature = "cordl_class_Unity+Collections+UTF8ArrayUnsafeUtility")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Collections::UTF8ArrayUnsafeUtility {
...
impl crate::Unity::Collections::UTF8ArrayUnsafeUtility {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        i32,
                    ), crate::Unity::Collections::CopyError, 5usize>("Append")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppObject>,
                        i32,
                    ), crate::Unity::Collections::CopyError, 5usize>("Copy")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
    ...
    pub fn EqualsUTF8Bytes(
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked((), (aBytes, aLength, bBytes, bLength))? };
        Ok(__cordl_ret.into())
    }
...
#[cfg(feature = "cordl_class_Unity+Collections+UTF8ArrayUnsafeUtility")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::Collections::UTF8ArrayUnsafeUtility {
...
impl crate::Unity::Collections::UTF8ArrayUnsafeUtility_Comparison {
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (runeA, errorA, runeB, errorB))? };
        Ok(__cordl_ret.into())
    }
}
