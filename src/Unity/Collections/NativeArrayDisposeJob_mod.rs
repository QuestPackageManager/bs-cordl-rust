...
impl crate::Unity::Collections::NativeArrayDisposeJob {
    pub fn Execute(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Collections::NativeArrayDisposeJob as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Execute")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Collections::NativeArrayDisposeJob as
