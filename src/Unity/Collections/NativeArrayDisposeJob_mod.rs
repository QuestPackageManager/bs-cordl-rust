...
#[cfg(feature = "cordl_class_Unity+Collections+NativeArrayDisposeJob")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Collections::NativeArrayDisposeJob {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_Unity+Collections+NativeArrayDisposeJob")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Unity::Collections::NativeArrayDisposeJob {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Unity+Collections+NativeArrayDisposeJob")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Unity::Collections::NativeArrayDisposeJob {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Collections+NativeArrayDisposeJob")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Unity::Collections::NativeArrayDisposeJob {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Collections+NativeArrayDisposeJob")]
unsafe impl quest_hook::libil2cpp::Return for crate::Unity::Collections::NativeArrayDisposeJob {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
impl crate::Unity::Collections::NativeArrayDisposeJob {
    ...
    pub fn RegisterNativeArrayDisposeJobReflectionData(
...
#[cfg(feature = "Unity+Collections+NativeArrayDisposeJob")]
impl AsRef<crate::Unity::Jobs::IJob> for crate::Unity::Collections::NativeArrayDisposeJob {
    fn as_ref(&self) -> &crate::Unity::Jobs::IJob {
        todo!()
    }
}
#[cfg(feature = "Unity+Collections+NativeArrayDisposeJob")]
impl AsMut<crate::Unity::Jobs::IJob> for crate::Unity::Collections::NativeArrayDisposeJob {
