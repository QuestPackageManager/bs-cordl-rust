#[cfg(feature = "cordl_class_Unity+Collections+Allocator")]
...
#[cfg(feature = "cordl_class_Unity+Collections+Allocator")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Collections::Allocator {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Collections";
    const CLASS_NAME: &'static str = "Allocator";
