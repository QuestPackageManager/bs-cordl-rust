...
#[cfg(feature = "cordl_class_Unity+IntegerTime+RationalTimeExtensions")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::IntegerTime::RationalTimeExtensions {
...
impl crate::Unity::IntegerTime::RationalTimeExtensions {
    pub fn Convert(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    ), crate::Unity::IntegerTime::RationalTime, 2usize>(
                        "Convert"
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::Unity::IntegerTime::RationalTime =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_time, rate))? };
        Ok(__cordl_ret.into())
    }
    pub fn Convert_Injected(
        _cordl_time: quest_hook::libil2cpp::ByRefMut<crate::Unity::IntegerTime::RationalTime>,
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        quest_hook::libil2cpp::ByRefMut<crate::Unity::IntegerTime::RationalTime>,
                        quest_hook::libil2cpp::ByRefMut<
                            crate::Unity::IntegerTime::RationalTime_TicksPerSecond,
                        >,
                        quest_hook::libil2cpp::ByRefMut<crate::Unity::IntegerTime::RationalTime>,
                    ), quest_hook::libil2cpp::Void, 3usize>("Convert_Injected")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (_cordl_time, rate, ret))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Unity+IntegerTime+RationalTimeExtensions")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::IntegerTime::RationalTimeExtensions {
