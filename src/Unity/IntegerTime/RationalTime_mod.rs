...
#[cfg(feature = "cordl_class_Unity+IntegerTime+RationalTime")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::IntegerTime::RationalTime {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.IntegerTime";
    const CLASS_NAME: &'static str = "RationalTime";
...
#[cfg(feature = "cordl_class_Unity+IntegerTime+RationalTime")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Unity::IntegerTime::RationalTime {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Unity+IntegerTime+RationalTime")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Unity::IntegerTime::RationalTime {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+IntegerTime+RationalTime")]
unsafe impl quest_hook::libil2cpp::Return for crate::Unity::IntegerTime::RationalTime {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "Unity+IntegerTime+RationalTime")]
impl crate::Unity::IntegerTime::RationalTime {
...
for crate::Unity::IntegerTime::RationalTime_TicksPerSecond {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.IntegerTime";
    const CLASS_NAME: &'static str = "RationalTime/TicksPerSecond";
    fn matches_value_argument(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
        !ty.is_ref()
            && ty
                .class()
...
#[cfg(feature = "Unity+IntegerTime+RationalTime+TicksPerSecond")]
impl crate::Unity::IntegerTime::RationalTime_TicksPerSecond {
