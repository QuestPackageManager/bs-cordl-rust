...
#[cfg(feature = "Unity+Jobs+IJobParallelFor")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Jobs::IJobParallelFor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Jobs";
    const CLASS_NAME: &'static str = "IJobParallelFor";
...
impl crate::Unity::Jobs::IJobParallelFor {
    pub fn Execute(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Jobs::IJobParallelFor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i32), quest_hook::libil2cpp::Void, 1usize>("Execute")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Jobs::IJobParallelFor as quest_hook::libil2cpp::Type >
