...
impl crate::Unity::Jobs::IJobForExtensions {
    ...
    pub type ForJobStruct_1<T: quest_hook::libil2cpp::Type> =
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Jobs::JobHandle = unsafe {
            cordl_method_info
                .invoke_unchecked((), (jobData, arrayLength, innerloopBatchCount, dependency))?
        };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "Unity+Jobs+IJobForExtensions+ForJobStruct_1")]
impl<T: quest_hook::libil2cpp::Type> crate::Unity::Jobs::IJobForExtensions_ForJobStruct_1<T> {
    #[cfg(feature = "Unity+Jobs+IJobForExtensions+ForJobStruct_1+ExecuteJobFunction")]
