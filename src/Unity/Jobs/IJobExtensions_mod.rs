...
#[repr(C)]
#[derive(Debug)]
pub struct JobStruct_1_ExecuteJobFunction<T: quest_hook::libil2cpp::Type> {
    __cordl_parent: crate::System::MulticastDelegate,
    __cordl_phantom_T: std::marker::PhantomData<T>,
}
#[cfg(feature = "Unity+Jobs+IJobExtensions+JobStruct_1+ExecuteJobFunction")]
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Unity::Jobs::JobStruct_1_ExecuteJobFunction < T
    > => "Unity.Jobs"."IJobExtensions/JobStruct`1/ExecuteJobFunction" < T >
);
#[cfg(feature = "Unity+Jobs+IJobExtensions+JobStruct_1+ExecuteJobFunction")]
impl<T: quest_hook::libil2cpp::Type> std::ops::Deref
for crate::Unity::Jobs::JobStruct_1_ExecuteJobFunction<T> {
...
> crate::Unity::Jobs::JobStruct_1_ExecuteJobFunction<T> {
    pub fn Invoke(
        &mut self,
...
impl<T: quest_hook::libil2cpp::Type> crate::Unity::Jobs::IJobExtensions_JobStruct_1<T> {
    #[cfg(feature = "Unity+Jobs+IJobExtensions+JobStruct_1+ExecuteJobFunction")]
    pub type ExecuteJobFunction = crate::Unity::Jobs::JobStruct_1_ExecuteJobFunction<T>;
}
