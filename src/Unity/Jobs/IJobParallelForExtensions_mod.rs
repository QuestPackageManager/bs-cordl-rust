...
for crate::Unity::Jobs::IJobParallelForExtensions {
    ...
    const CLASS_NAME: &'static str = "IJobParallelForExtensions";
...
impl crate::Unity::Jobs::IJobParallelForExtensions {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Jobs::IJobParallelForExtensions as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(), crate::System::IntPtr, 0usize>("GetReflectionData")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Jobs::IJobParallelForExtensions as
                    quest_hook::libil2cpp::Type > ::class(), "GetReflectionData", 0usize
                )
            });
            ...
            + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Jobs::IJobParallelForExtensions as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Jobs::IJobParallelForExtensions as
                    quest_hook::libil2cpp::Type > ::class(), "Schedule", 4usize
                )
            });
        let __cordl_ret: crate::Unity::Jobs::JobHandle = unsafe {
            method
                .invoke_unchecked(
                    (),
                    (jobData, arrayLength, innerloopBatchCount, dependsOn),
                )?
        };
        Ok(__cordl_ret.into())
    }
...
for crate::Unity::Jobs::IJobParallelForExtensions_ParallelForJobStruct_1<T> {
    ...
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "Unity.Jobs";
    const CLASS_NAME: &'static str = "IJobParallelForExtensions/ParallelForJobStruct`1";
        ...
        CLASS
            .get_or_init(|| {
                quest_hook::libil2cpp::Il2CppClass::find(
                        "Unity.Jobs",
                        "IJobParallelForExtensions/ParallelForJobStruct`1",
                    )
                    .unwrap()
                    .make_generic::<(T)>()
                    .unwrap()
...
> crate::Unity::Jobs::IJobParallelForExtensions_ParallelForJobStruct_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Jobs::IJobParallelForExtensions_ParallelForJobStruct_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Jobs::IJobParallelForExtensions_ParallelForJobStruct_1
                    < T > as quest_hook::libil2cpp::Type > ::class(), "Execute", 5usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Jobs::IJobParallelForExtensions_ParallelForJobStruct_1
                    < T > as quest_hook::libil2cpp::Type > ::class(), "Initialize",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
...
#[repr(C)]
#[derive(Debug)]
pub struct ParallelForJobStruct_1_IJobParallelForExtensions_ExecuteJobFunction<
    T: quest_hook::libil2cpp::Type,
> {
...
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
for crate::Unity::Jobs::ParallelForJobStruct_1_IJobParallelForExtensions_ExecuteJobFunction<
    T,
> {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
...
impl<
    T: quest_hook::libil2cpp::Type,
> crate::Unity::Jobs::ParallelForJobStruct_1_IJobParallelForExtensions_ExecuteJobFunction<
    T,
> {
    pub fn Invoke(
        &mut self,
    ...
    where
        T: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Jobs::ParallelForJobStruct_1_IJobParallelForExtensions_ExecuteJobFunction<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate
                    ::Unity::Jobs::ParallelForJobStruct_1_IJobParallelForExtensions_ExecuteJobFunction
                    < T > as quest_hook::libil2cpp::Type > ::class(), "Invoke", 5usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method
