...
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Jobs::IJob {
    ...
    const CLASS_NAME: &'static str = "IJob";
...
impl crate::Unity::Jobs::IJob {
    pub fn Execute(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Jobs::IJob as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Execute")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Jobs::IJob as quest_hook::libil2cpp::Type > ::class(),
                    "Execute", 0usize
                )
            });
