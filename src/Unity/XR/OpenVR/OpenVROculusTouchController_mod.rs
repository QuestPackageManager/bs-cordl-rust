#[cfg(feature = "cordl_class_Unity+XR+OpenVR+OpenVROculusTouchController")]
#[repr(C)]
...
#[cfg(feature = "cordl_class_Unity+XR+OpenVR+OpenVROculusTouchController")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::XR::OpenVR::OpenVROculusTouchController {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.XR.OpenVR";
    const CLASS_NAME: &'static str = "OpenVROculusTouchController";
...
#[cfg(feature = "Unity+XR+OpenVR+OpenVROculusTouchController")]
impl crate::Unity::XR::OpenVR::OpenVROculusTouchController {
...
#[cfg(feature = "cordl_class_Unity+XR+OpenVR+OpenVROculusTouchController")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::XR::OpenVR::OpenVROculusTouchController {
