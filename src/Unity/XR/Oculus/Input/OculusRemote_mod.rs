...
#[cfg(feature = "cordl_class_Unity+XR+Oculus+Input+OculusRemote")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::XR::Oculus::Input::OculusRemote {
...
#[cfg(feature = "cordl_class_Unity+XR+Oculus+Input+OculusRemote")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::XR::Oculus::Input::OculusRemote {
