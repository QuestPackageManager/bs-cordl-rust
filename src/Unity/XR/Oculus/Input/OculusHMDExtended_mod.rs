...
#[cfg(feature = "cordl_class_Unity+XR+Oculus+Input+OculusHMDExtended")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::XR::Oculus::Input::OculusHMDExtended {
...
#[cfg(feature = "cordl_class_Unity+XR+Oculus+Input+OculusHMDExtended")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::XR::Oculus::Input::OculusHMDExtended {
