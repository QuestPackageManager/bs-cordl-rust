...
for crate::Unity::XR::Oculus::Input::OculusTrackingReference {
    ...
    const CLASS_NAME: &'static str = "OculusTrackingReference";
...
impl crate::Unity::XR::Oculus::Input::OculusTrackingReference {
    pub fn FinishSetup(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::XR::Oculus::Input::OculusTrackingReference as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("FinishSetup")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::XR::Oculus::Input::OculusTrackingReference as
