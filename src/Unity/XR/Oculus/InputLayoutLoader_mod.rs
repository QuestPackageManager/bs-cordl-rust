...
#[cfg(feature = "Unity+XR+Oculus+InputLayoutLoader")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::XR::Oculus::InputLayoutLoader {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.XR.Oculus";
    const CLASS_NAME: &'static str = "InputLayoutLoader";
...
impl crate::Unity::XR::Oculus::InputLayoutLoader {
    ...
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::XR::Oculus::InputLayoutLoader as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (),
                quest_hook::libil2cpp::Void,
                0usize,
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::XR::Oculus::InputLayoutLoader as
                    quest_hook::libil2cpp::Type > ::class(), "RegisterInputLayouts",
                    0usize
                )
            });
