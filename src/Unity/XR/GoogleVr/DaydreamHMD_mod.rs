...
#[cfg(feature = "Unity+XR+GoogleVr+DaydreamHMD")]
impl std::ops::DerefMut for crate::Unity::XR::GoogleVr::DaydreamHMD {
    fn deref_mut(&mut self) -> &mut Self::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Unity+XR+GoogleVr+DaydreamHMD")]
impl crate::Unity::XR::GoogleVr::DaydreamHMD {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::XR::GoogleVr::DaydreamHMD as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::XR::GoogleVr::DaydreamHMD as
...
#[cfg(feature = "Unity+XR+GoogleVr+DaydreamHMD")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::XR::GoogleVr::DaydreamHMD {
