...
for crate::Unity::IO::LowLevel::Unsafe::AsyncReadManager {
...
impl crate::Unity::IO::LowLevel::Unsafe::AsyncReadManager {
    pub fn CloseFileAsync(
        fileHandle: quest_hook::libil2cpp::ByRefMut<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CloseFileAsync", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::Unity::Jobs::JobHandle = unsafe {
            cordl_method_info.invoke_unchecked((), (fileHandle, dependency))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CloseFileAsync_Injected", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (fileHandle, dependency, ret))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn GetFileInfo(
        ...
        let __cordl_ret: crate::Unity::IO::LowLevel::Unsafe::ReadHandle = unsafe {
            cordl_method_info.invoke_unchecked((), (filename, result))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetFileInfoInternal", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::Unity::IO::LowLevel::Unsafe::ReadHandle = unsafe {
            cordl_method_info.invoke_unchecked((), (filename, cmd))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetFileInfoInternal_Injected", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (filename, cmd, ret))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "OpenFileAsync_Internal_Injected", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (fileName, ret))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn Read(
        ...
        let __cordl_ret: crate::Unity::IO::LowLevel::Unsafe::ReadHandle = unsafe {
            cordl_method_info.invoke_unchecked((), (fileHandle, readCmdArray))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadWithHandlesInternal_NativeCopy", 2usize
                        )
                    })
            });
        let __cordl_ret: crate::Unity::IO::LowLevel::Unsafe::ReadHandle = unsafe {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "ReadWithHandlesInternal_NativeCopy_Injected", 3usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (fileHandle, readCmdArray, ret))?
        };
        Ok(__cordl_ret.into())
    }
}
