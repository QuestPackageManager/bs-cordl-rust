...
pub struct AsyncReadManagerMetricsFilters {
    ...
    pub States: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<crate::Unity::IO::LowLevel::Unsafe::ProcessingState>,
    >,
    pub ReadTypes: quest_hook::libil2cpp::Gc<
        quest_hook::libil2cpp::Il2CppArray<crate::Unity::IO::LowLevel::Unsafe::FileReadType>,
    >,
...
impl std::ops::Deref for crate::Unity::IO::LowLevel::Unsafe::AsyncReadManagerMetricsFilters {
...
#[cfg(feature = "Unity+IO+LowLevel+Unsafe+AsyncReadManagerMetricsFilters")]
impl std::ops::DerefMut for crate::Unity::IO::LowLevel::Unsafe::AsyncReadManagerMetricsFilters {
