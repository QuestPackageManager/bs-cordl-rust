#[cfg(feature = "cordl_class_Unity+Properties+IDictionaryPropertyBagAccept_1")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
#[repr(C)]
pub struct IDictionaryPropertyBagAccept_1<TContainer: quest_hook::libil2cpp::Type> {
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::Unity::Properties::IDictionaryPropertyBagAccept_1<TContainer>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "IDictionaryPropertyBagAccept`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find(
                "Unity.Properties",
                "IDictionaryPropertyBagAccept`1",
            )
            .unwrap()
...
#[cfg(feature = "Unity+Properties+IDictionaryPropertyBagAccept_1")]
...
impl<TContainer: quest_hook::libil2cpp::Type>
    crate::Unity::Properties::IDictionaryPropertyBagAccept_1<TContainer>
{
    pub fn Accept(
        &mut self,
