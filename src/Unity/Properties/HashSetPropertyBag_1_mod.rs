...
quest_hook::libil2cpp::unsafe_impl_reference_type!(
    in quest_hook::libil2cpp for crate ::Unity::Properties::HashSetPropertyBag_1 <
    TElement > => "Unity.Properties"."HashSetPropertyBag`1" < TElement >
);
#[cfg(feature = "Unity+Properties+HashSetPropertyBag_1")]
...
> crate::Unity::Properties::HashSetPropertyBag_1<TElement> {
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: *mut crate::System::Collections::Generic::HashSet_1<TElement> = __cordl_object
            .invoke("Instantiate", ())?;
        Ok(__cordl_ret)
    }
