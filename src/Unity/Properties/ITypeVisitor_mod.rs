...
#[cfg(feature = "Unity+Properties+ITypeVisitor")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Properties::ITypeVisitor {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "ITypeVisitor";
...
impl crate::Unity::Properties::ITypeVisitor {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::ITypeVisitor as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Visit")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Properties::ITypeVisitor as
