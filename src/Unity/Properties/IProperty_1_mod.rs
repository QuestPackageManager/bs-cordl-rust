    ...
    for crate::Unity::Properties::IProperty_1<TContainer>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "IProperty`1")
                .unwrap()
...
#[cfg(feature = "Unity+Properties+IProperty_1")]
impl<TContainer: quest_hook::libil2cpp::Type> crate::Unity::Properties::IProperty_1<TContainer> {
