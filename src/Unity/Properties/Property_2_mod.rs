#[cfg(feature = "cordl_class_Unity+Properties+Property_2")]
#[repr(C)]
#[derive(Debug)]
pub struct Property_2<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
{
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Unity::Properties::Property_2<TContainer, TValue>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "Property`2")
                .unwrap()
    ...
    crate::Unity::Properties::Property_2<TContainer, TValue>
{
    ...
    pub fn GetAttribute<TAttribute>(&mut self) -> quest_hook::libil2cpp::Result<TAttribute>
    where
        TContainer: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
        ...
        TValue: quest_hook::libil2cpp::Type
            ...
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
        TAttribute: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), TAttribute, 0usize>("GetAttribute")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: TAttribute = unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn GetValue(
        &mut self,
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "Unity.Properties.Internal.IAttributes.AddAttribute", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void =
    ...
    pub fn Unity_Properties_Internal_IAttributes_CreateAttributesScope(
        &mut self,
    ...
    pub fn Unity_Properties_Internal_IAttributes_get_Attributes(
        &mut self,
    ...
    pub fn Unity_Properties_Internal_IAttributes_set_Attributes(
        &mut self,
...
#[cfg(feature = "cordl_class_Unity+Properties+Property_2")]
impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::ObjectType for crate::Unity::Properties::Property_2<TContainer, TValue>
{
...
impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    ...
    for crate::Unity::Properties::Property_2<TContainer, TValue>
{
    fn as_mut(&mut self) -> &mut crate::Unity::Properties::IPropertyAccept_1<TContainer> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Unity+Properties+Property_2")]
