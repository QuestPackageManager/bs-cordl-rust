...
#[cfg(feature = "Unity+Properties+TypeTraits")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Properties::TypeTraits {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "TypeTraits";
...
impl crate::Unity::Properties::TypeTraits {
    pub fn IsContainer(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::TypeTraits as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Properties::TypeTraits as quest_hook::libil2cpp::Type
                    > ::class(), "IsContainer", 1usize
                )
            });
