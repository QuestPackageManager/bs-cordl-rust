...
for crate::Unity::Properties::Internal::DefaultPropertyBagInitializer {
    ...
    const CLASS_NAME: &'static str = "DefaultPropertyBagInitializer";
...
impl crate::Unity::Properties::Internal::DefaultPropertyBagInitializer {
    pub fn Initialize() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::Internal::DefaultPropertyBagInitializer as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<(), quest_hook::libil2cpp::Void, 0usize>("Initialize")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Properties::Internal::DefaultPropertyBagInitializer as
