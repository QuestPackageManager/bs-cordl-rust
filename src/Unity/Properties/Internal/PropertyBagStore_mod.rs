...
#[cfg(feature = "cordl_class_Unity+Properties+Internal+PropertyBagStore")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Properties::Internal::PropertyBagStore {
...
impl crate::Unity::Properties::Internal::PropertyBagStore {
    ...
    pub type TypedStore_1<TContainer: quest_hook::libil2cpp::Type> =
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(quest_hook::libil2cpp::Gc<
                        crate::Unity::Properties::IPropertyBag_1<TContainer>,
                    >), quest_hook::libil2cpp::Void, 1usize>("AddPropertyBag")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn CreatePropertyBagProvider() -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn get_ReflectedPropertyBagProvider() -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::Unity::Properties::Internal::ReflectedPropertyBagProvider>,
    > {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    >, 0usize>("get_ReflectedPropertyBagProvider")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Unity+Properties+Internal+PropertyBagStore")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::Properties::Internal::PropertyBagStore {
