...
impl crate::Unity::Properties::Internal::IPropertyBagRegister {
    pub fn Register(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::Internal::IPropertyBagRegister as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>("Register")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Properties::Internal::IPropertyBagRegister as
