...
for crate::Unity::Properties::Internal::ReflectedPropertyBag_1<TContainer> {
    ...
    const CLASS_NAME: &'static str = "ReflectedPropertyBag`1";
...
> crate::Unity::Properties::Internal::ReflectedPropertyBag_1<TContainer> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::Internal::ReflectedPropertyBag_1<
            TContainer,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    TContainer > as quest_hook::libil2cpp::Type > ::class(),
                    "AddProperty", 1usize
                )
            });
        ...
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Properties::Internal::ReflectedPropertyBag_1 <
                    TContainer > as quest_hook::libil2cpp::Type > ::class(), ".ctor",
                    0usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
