...
impl crate::Unity::Properties::Internal::ReflectedPropertyBagProvider {
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<TList> = __cordl_object
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<TDictionary> = __cordl_object
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<TContainer> = __cordl_object
            .invoke("CreatePropertyBag", ())?;
        Ok(__cordl_ret.into())
    }
    pub fn CreatePropertyBag_Gc0(
        &mut self,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<TSet> = __cordl_object
    ...
    > {
        ...
        > = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("GetPropertyMembers", (_cordl_type))?;
        Ok(__cordl_ret.into())
    }
    pub fn IsValidMember(
        ...
        let __cordl_ret: bool = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("IsValidMember", (memberInfo))?;
        Ok(__cordl_ret.into())
    }
    pub fn IsValidPropertyType(
        ...
        let __cordl_ret: bool = <Self as quest_hook::libil2cpp::Type>::class()
            .invoke("IsValidPropertyType", (_cordl_type))?;
        Ok(__cordl_ret.into())
    }
