...
> crate::Unity::Properties::PropertyGetter_2<TContainer, TValue> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::PropertyGetter_2<
            TContainer,
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Properties::PropertyGetter_2 < TContainer, TValue > as
                    quest_hook::libil2cpp::Type > ::class(), "Invoke", 1usize
                )
            });
        let __cordl_ret: TValue = unsafe { method.invoke_unchecked(self, (container))? };
        Ok(__cordl_ret.into())
    }
    pub fn New(
