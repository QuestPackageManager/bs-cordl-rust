...
> crate::Unity::Properties::IConstructorWithCount_1<T> {
    ...
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::IConstructorWithCount_1<
            T,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Properties::IConstructorWithCount_1 < T > as
                    quest_hook::libil2cpp::Type > ::class(), "InstantiateWithCount",
                    1usize
                )
            });
