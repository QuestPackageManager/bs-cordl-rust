#[cfg(feature = "cordl_class_Unity+Properties+IConstructorWithCount_1")]
#[derive(Debug)]
#[repr(C)]
    ...
    for crate::Unity::Properties::IConstructorWithCount_1<T>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "IConstructorWithCount`1")
                .unwrap()
                .make_generic::<(T)>()
                .unwrap()
                .unwrap()
...
#[cfg(feature = "Unity+Properties+IConstructorWithCount_1")]
impl<T: quest_hook::libil2cpp::Type> crate::Unity::Properties::IConstructorWithCount_1<T> {
    pub fn InstantiateWithCount(&mut self, count: i32) -> quest_hook::libil2cpp::Result<T>
    where
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: T = unsafe { cordl_method_info.invoke_unchecked(self, (count))? };
        Ok(__cordl_ret.into())
    }
