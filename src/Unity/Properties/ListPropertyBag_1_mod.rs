    ...
    for crate::Unity::Properties::ListPropertyBag_1<TElement>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "ListPropertyBag`1")
                .unwrap()
...
#[cfg(feature = "Unity+Properties+ListPropertyBag_1")]
impl<TElement: quest_hook::libil2cpp::Type> crate::Unity::Properties::ListPropertyBag_1<TElement> {
    pub fn Instantiate(
        &mut self,
