...
#[cfg(feature = "cordl_class_Unity+Properties+CreatePropertyAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Properties::CreatePropertyAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "CreatePropertyAttribute";
...
impl std::ops::Deref for crate::Unity::Properties::CreatePropertyAttribute {
    type Target = crate::UnityEngine::Scripting::RequiredMemberAttribute;
...
#[cfg(feature = "cordl_class_Unity+Properties+CreatePropertyAttribute")]
impl quest_hook::libil2cpp::ObjectType for crate::Unity::Properties::CreatePropertyAttribute {
