...
> crate::Unity::Properties::SetPropertyBagBase_2<TSet, TElement> {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::System::Collections::Generic::IEnumerable_1<
                                quest_hook::libil2cpp::Gc<
                                    crate::Unity::Properties::IProperty_1<TSet>,
                                >,
                            >,
                        >,
                        1usize,
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetPropertiesEnumerable", 1usize
                        )
                    })
            });
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Properties::PropertyCollection_1<TSet> = unsafe {
    ...
    pub fn Unity_Properties_ISetPropertyBagAccept_TSet__Accept(
        &mut self,
        visitor: quest_hook::libil2cpp::Gc<
            crate::Unity::Properties::ISetPropertyBagVisitor,
        >,
        container: quest_hook::libil2cpp::ByRefMut<TSet>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "Unity.Properties.ISetPropertyBagAccept<TSet>.Accept", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
...
for crate::Unity::Properties::SetPropertyBagBase_2<TSet, TElement> {
    fn as_mut(
        &mut self,
    ) -> &mut crate::Unity::Properties::ISetPropertyBag_2<TSet, TElement> {
        unsafe { std::mem::transmute(self) }
    }
}
