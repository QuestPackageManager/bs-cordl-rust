...
> crate::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::KeyValueCollectionPropertyBag_3<
            TDictionary,
            TKey,
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Properties::KeyValueCollectionPropertyBag_3 <
                    TDictionary, TKey, TValue > as quest_hook::libil2cpp::Type >
                    ::class(), ".ctor", 0usize
                )
            });
...
> {
    ...
    where
        ...
        TValue: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::KeyValueCollectionPropertyBag_3_KeyValuePairProperty<
            TDictionary,
            TKey,
            TValue,
        > as quest_hook::libil2cpp::Type>::class()
