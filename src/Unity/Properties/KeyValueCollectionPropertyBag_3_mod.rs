...
> {
    ...
    >,
    pub m_Previous: TKey,
    pub m_Keys: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::List_1<TKey>>,
    pub m_Position: i32,
...
#[cfg(feature = "Unity+Properties+KeyValueCollectionPropertyBag_3+Enumerable+Enumerator")]
impl<
        TDictionary: quest_hook::libil2cpp::Type,
        TKey: quest_hook::libil2cpp::Type,
        TValue: quest_hook::libil2cpp::Type,
    ...
    >
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (dictionary, property))? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Current(
        &mut self,
...
unsafe impl<
        ...
        TValue: quest_hook::libil2cpp::Type,
    > quest_hook::libil2cpp::Type
    for crate::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    ...
    > crate::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>
{
    ...
    pub fn GetProperties_0(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::Unity::Properties::PropertyCollection_1<TDictionary>>
    where
        TDictionary: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: crate::Unity::Properties::PropertyCollection_1<TDictionary> =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn Unity_Properties_IDictionaryPropertyBagAccept_TDictionary__Accept(
        &mut self,
        visitor: quest_hook::libil2cpp::Gc<crate::Unity::Properties::IDictionaryPropertyBagVisitor>,
        container: quest_hook::libil2cpp::ByRefMut<TDictionary>,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        TDictionary: quest_hook::libil2cpp::Type
    ...
    for crate::Unity::Properties::KeyValueCollectionPropertyBag_3<TDictionary, TKey, TValue>
{
    fn as_mut(
        &mut self,
    ) -> &mut crate::Unity::Properties::IDictionaryPropertyBag_3<TDictionary, TKey, TValue> {
        unsafe { std::mem::transmute(self) }
    }
}
#[cfg(feature = "Unity+Properties+KeyValueCollectionPropertyBag_3")]
...
impl<
        ...
        TValue: quest_hook::libil2cpp::Type,
    >
    crate::Unity::Properties::KeyValueCollectionPropertyBag_3_Enumerable<TDictionary, TKey, TValue>
{
    #[cfg(feature = "Unity+Properties+KeyValueCollectionPropertyBag_3+Enumerable+Enumerator")]
    pub type Enumerator =
        crate::Unity::Properties::Enumerable_KeyValueCollectionPropertyBag_3_Enumerator<
    ...
    >
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TKey), quest_hook::libil2cpp::Void, 1usize>("set_Key")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
