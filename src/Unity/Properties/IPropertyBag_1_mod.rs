    ...
    for crate::Unity::Properties::IPropertyBag_1<TContainer>
{
    ...
    const CLASS_NAME: &'static str = "IPropertyBag`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "IPropertyBag`1")
                .unwrap()
...
#[cfg(feature = "Unity+Properties+IPropertyBag_1")]
impl<TContainer: quest_hook::libil2cpp::Type> crate::Unity::Properties::IPropertyBag_1<TContainer> {
    pub fn Accept(
        &mut self,
...
#[cfg(feature = "Unity+Properties+IPropertyBag_1")]
impl<TContainer: quest_hook::libil2cpp::Type> AsRef<crate::Unity::Properties::IPropertyBag>
    for crate::Unity::Properties::IPropertyBag_1<TContainer>
{
...
#[cfg(feature = "Unity+Properties+IPropertyBag_1")]
impl<TContainer: quest_hook::libil2cpp::Type> AsMut<crate::Unity::Properties::IPropertyBag>
    for crate::Unity::Properties::IPropertyBag_1<TContainer>
{
