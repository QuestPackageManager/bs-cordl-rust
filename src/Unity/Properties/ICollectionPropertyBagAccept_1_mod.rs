#[cfg(feature = "cordl_class_Unity+Properties+ICollectionPropertyBagAccept_1")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
#[repr(C)]
pub struct ICollectionPropertyBagAccept_1<TContainer: quest_hook::libil2cpp::Type> {
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::Unity::Properties::ICollectionPropertyBagAccept_1<TContainer>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "ICollectionPropertyBagAccept`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find(
                "Unity.Properties",
                "ICollectionPropertyBagAccept`1",
            )
            .unwrap()
...
#[cfg(feature = "Unity+Properties+ICollectionPropertyBagAccept_1")]
...
impl<TContainer: quest_hook::libil2cpp::Type>
    crate::Unity::Properties::ICollectionPropertyBagAccept_1<TContainer>
{
    pub fn Accept(
        &mut self,
