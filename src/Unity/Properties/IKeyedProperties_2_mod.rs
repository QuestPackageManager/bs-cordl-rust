...
#[cfg(feature = "cordl_class_Unity+Properties+IKeyedProperties_2")]
unsafe impl<TContainer: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type for crate::Unity::Properties::IKeyedProperties_2<TContainer, TKey>
{
    ...
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        ...
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "IKeyedProperties`2")
                .unwrap()
...
impl<TContainer: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type> std::ops::Deref
...
#[cfg(feature = "Unity+Properties+IKeyedProperties_2")]
impl<TContainer: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::Unity::Properties::IKeyedProperties_2<TContainer, TKey>
{
...
#[cfg(feature = "Unity+Properties+IKeyedProperties_2")]
impl<TContainer: quest_hook::libil2cpp::Type, TKey: quest_hook::libil2cpp::Type>
