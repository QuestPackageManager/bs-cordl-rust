#[cfg(feature = "cordl_class_Unity+Properties+INamedProperties_1")]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
#[repr(C)]
pub struct INamedProperties_1<TContainer: quest_hook::libil2cpp::Type> {
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::Unity::Properties::INamedProperties_1<TContainer>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "INamedProperties`1";
    fn class() -> &'static quest_hook::libil2cpp::Il2CppClass {
        static CLASS: ::std::sync::OnceLock<&'static quest_hook::libil2cpp::Il2CppClass> =
            ::std::sync::OnceLock::new();
        CLASS.get_or_init(|| {
            quest_hook::libil2cpp::Il2CppClass::find("Unity.Properties", "INamedProperties`1")
                .unwrap()
...
#[cfg(feature = "Unity+Properties+INamedProperties_1")]
...
impl<TContainer: quest_hook::libil2cpp::Type>
    crate::Unity::Properties::INamedProperties_1<TContainer>
{
