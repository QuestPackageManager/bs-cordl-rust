...
#[cfg(feature = "Unity+Properties+IMemberInfo")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Properties::IMemberInfo {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    const CLASS_NAME: &'static str = "IMemberInfo";
...
impl crate::Unity::Properties::IMemberInfo {
    pub fn GetCustomAttributes(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Properties::IMemberInfo as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (),
                quest_hook::libil2cpp::Gc<
                    crate::System::Collections::Generic::IEnumerable_1<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Properties::IMemberInfo as quest_hook::libil2cpp::Type
                    > ::class(), "GetCustomAttributes", 0usize
                )
            });
