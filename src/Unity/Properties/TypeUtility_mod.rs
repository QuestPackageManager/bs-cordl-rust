                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "CreateValueTypeInstance", 0usize
                        )
                    })
            });
        let __cordl_ret: T = unsafe { method.invoke_unchecked((), ())? };
