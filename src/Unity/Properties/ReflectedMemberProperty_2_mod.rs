...
> {
    ...
    pub m_GetClassValueAction: quest_hook::libil2cpp::Gc<
        crate::Unity::Properties::ReflectedMemberProperty_2_GetClassValueAction<TContainer, TValue>,
    >,
    pub m_SetClassValueAction: quest_hook::libil2cpp::Gc<
        crate::Unity::Properties::ReflectedMemberProperty_2_SetClassValueAction<TContainer, TValue>,
    >,
...
impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    std::ops::DerefMut for crate::Unity::Properties::ReflectedMemberProperty_2<TContainer, TValue>
{
    ...
    crate::Unity::Properties::ReflectedMemberProperty_2<TContainer, TValue>
{
    ...
    pub fn New(
        info: quest_hook::libil2cpp::Gc<crate::Unity::Properties::IMemberInfo>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (info, name))? };
        Ok(__cordl_ret.into())
    }
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Unity::Properties::ReflectedMemberProperty_2_GetClassValueAction<TContainer, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
...
impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    crate::Unity::Properties::ReflectedMemberProperty_2_GetClassValueAction<TContainer, TValue>
{
    pub fn Invoke(&mut self, container: TContainer) -> quest_hook::libil2cpp::Result<TValue>
    where
        TContainer: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TContainer), TValue, 1usize>("Invoke")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Unity::Properties::ReflectedMemberProperty_2_GetStructValueAction<TContainer, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
...
#[cfg(feature = "Unity+Properties+ReflectedMemberProperty_2+GetStructValueAction")]
impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    crate::Unity::Properties::ReflectedMemberProperty_2_GetStructValueAction<TContainer, TValue>
{
    pub fn Invoke(
        &mut self,
        container: quest_hook::libil2cpp::ByRefMut<TContainer>,
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Unity::Properties::ReflectedMemberProperty_2_SetClassValueAction<TContainer, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
    ...
    crate::Unity::Properties::ReflectedMemberProperty_2_SetClassValueAction<TContainer, TValue>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(TContainer, TValue), quest_hook::libil2cpp::Void, 2usize>(
                        "Invoke",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
...
unsafe impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::Unity::Properties::ReflectedMemberProperty_2_SetStructValueAction<TContainer, TValue>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Properties";
...
#[cfg(feature = "Unity+Properties+ReflectedMemberProperty_2+SetStructValueAction")]
impl<TContainer: quest_hook::libil2cpp::Type, TValue: quest_hook::libil2cpp::Type>
    crate::Unity::Properties::ReflectedMemberProperty_2_SetStructValueAction<TContainer, TValue>
{
    pub fn Invoke(
        &mut self,
        container: quest_hook::libil2cpp::ByRefMut<TContainer>,
