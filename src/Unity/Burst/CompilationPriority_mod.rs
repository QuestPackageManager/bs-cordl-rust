...
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Burst::CompilationPriority {
    ...
    const CLASS_NAME: &'static str = "CompilationPriority";
...
#[cfg(feature = "cordl_class_Unity+Burst+CompilationPriority")]
unsafe impl quest_hook::libil2cpp::Argument for crate::Unity::Burst::CompilationPriority {
    type Type = Self;
...
#[cfg(feature = "cordl_class_Unity+Burst+CompilationPriority")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::Unity::Burst::CompilationPriority {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_Unity+Burst+CompilationPriority")]
unsafe impl quest_hook::libil2cpp::Returned for crate::Unity::Burst::CompilationPriority {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
