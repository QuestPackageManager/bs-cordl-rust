...
#[cfg(feature = "Unity+Burst+SafeStringArrayHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Burst::SafeStringArrayHelper {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Burst";
    const CLASS_NAME: &'static str = "SafeStringArrayHelper";
...
impl crate::Unity::Burst::SafeStringArrayHelper {
    pub fn DeserialiseStringArraySafe(
        ...
        >,
    > {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Burst::SafeStringArrayHelper as quest_hook::libil2cpp::Type>::class()
            .find_static_method::<
                (quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>),
                quest_hook::libil2cpp::Gc<
                    quest_hook::libil2cpp::Il2CppArray<
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::Unity::Burst::SafeStringArrayHelper as
                    quest_hook::libil2cpp::Type > ::class(),
                    "DeserialiseStringArraySafe", 1usize
                )
            });
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Burst::SafeStringArrayHelper as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Burst::SafeStringArrayHelper as
                    quest_hook::libil2cpp::Type > ::class(), "SerialiseStringArraySafe",
                    1usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
