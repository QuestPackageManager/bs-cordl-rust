...
#[cfg(feature = "Unity+Burst+BurstDiscardAttribute")]
unsafe impl quest_hook::libil2cpp::Type for crate::Unity::Burst::BurstDiscardAttribute {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Unity.Burst";
    const CLASS_NAME: &'static str = "BurstDiscardAttribute";
...
impl crate::Unity::Burst::BurstDiscardAttribute {
    ...
    pub fn _ctor(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Burst::BurstDiscardAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(), quest_hook::libil2cpp::Void, 0usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Burst::BurstDiscardAttribute as
