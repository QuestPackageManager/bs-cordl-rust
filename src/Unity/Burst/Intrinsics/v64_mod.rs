#[cfg(feature = "cordl_class_Unity+Burst+Intrinsics+v64")]
...
#[cfg(feature = "cordl_class_Unity+Burst+Intrinsics+v64")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::Unity::Burst::Intrinsics::v64 {
    type Type = Self;
...
impl crate::Unity::Burst::Intrinsics::v64 {
    ...
    pub fn _ctor_i16_i16_i16_i16_5(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(i16, i16, i16, i16), quest_hook::libil2cpp::Void, 4usize>(
                        ".ctor",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn _ctor_u16_u16_u16_u16_7(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(u16, u16, u16, u16), quest_hook::libil2cpp::Void, 4usize>(
                        ".ctor",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
