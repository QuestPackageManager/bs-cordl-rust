#[cfg(feature = "cordl_class_Unity+Burst+CompilerServices+IgnoreWarningAttribute")]
#[repr(C)]
...
#[cfg(feature = "Unity+Burst+CompilerServices+IgnoreWarningAttribute")]
impl std::ops::DerefMut for crate::Unity::Burst::CompilerServices::IgnoreWarningAttribute {
...
impl crate::Unity::Burst::CompilerServices::IgnoreWarningAttribute {
    pub fn New(warning: i32) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<Self>> {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (warning))? };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_Unity+Burst+CompilerServices+IgnoreWarningAttribute")]
