...
for crate::Unity::Burst::CompilerServices::AssumeRangeAttribute {
    ...
    const CLASS_NAME: &'static str = "AssumeRangeAttribute";
...
impl crate::Unity::Burst::CompilerServices::AssumeRangeAttribute {
    ...
    pub fn _ctor_i64_i64_0(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::Unity::Burst::CompilerServices::AssumeRangeAttribute as quest_hook::libil2cpp::Type>::class()
            .find_method::<(i64, i64), quest_hook::libil2cpp::Void, 2usize>(".ctor")
            .unwrap_or_else(|e| {
                panic!(
                    "no matching methods found for non-void {}.{}({}) Cause: {e:?}", <
                    crate ::Unity::Burst::CompilerServices::AssumeRangeAttribute as
