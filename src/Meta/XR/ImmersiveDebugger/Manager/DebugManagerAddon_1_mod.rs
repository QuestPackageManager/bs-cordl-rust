#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+DebugManagerAddon_1")]
#[repr(C)]
#[derive(Debug)]
pub struct DebugManagerAddon_1<Type: quest_hook::libil2cpp::Type> {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub _instanceCache:
        quest_hook::libil2cpp::Gc<crate::Meta::XR::ImmersiveDebugger::Utils::InstanceCache>,
    pub _subDebugManagers: quest_hook::libil2cpp::Gc<
...
unsafe impl<Type: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::Manager::DebugManagerAddon_1<Type>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "DebugManagerAddon`1";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+DebugManagerAddon_1")]
...
impl<Type: quest_hook::libil2cpp::Type>
    crate::Meta::XR::ImmersiveDebugger::Manager::DebugManagerAddon_1<Type>
{
    ...
    pub fn InitSubManagers(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        Type: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::Meta::XR::ImmersiveDebugger::Manager::DebugManager,
                    >), quest_hook::libil2cpp::Void, 1usize>("OnReady")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (debugManager))? };
        Ok(__cordl_ret.into())
    }
    pub fn OnReadyInternal(&mut self) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void>
    where
        Type: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
    ...
    pub fn get_Instance() -> quest_hook::libil2cpp::Result<Type>
    where
        Type: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), Type, 0usize>("get_Instance")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: Type = unsafe { cordl_method_info.invoke_unchecked((), ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Method(
        &mut self,
    ...
    pub fn get__subManagersToInitialize() -> quest_hook::libil2cpp::Result<
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(), quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            ...
                            >,
                        >,
                    >, 0usize>("get__subManagersToInitialize")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
