...
impl crate::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils {
    ...
    pub type RegisterMember_1<T: quest_hook::libil2cpp::Type> =
...
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+ManagerUtils+RegisterMember_1")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
    ...
    crate::Meta::XR::ImmersiveDebugger::Manager::ManagerUtils_RegisterMember_1<T>
{
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (memberController, member, attribute, instanceHandle))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn New(
