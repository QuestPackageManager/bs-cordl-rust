...
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+SubManagerForAddon")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon {
