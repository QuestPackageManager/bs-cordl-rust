#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+WatchManagerForAddon")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct WatchManagerForAddon {
    __cordl_parent: crate::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon,
}
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+WatchManagerForAddon")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::Manager::WatchManagerForAddon
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "WatchManagerForAddon";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+WatchManagerForAddon")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::WatchManagerForAddon {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+WatchManagerForAddon")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::WatchManagerForAddon {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+WatchManagerForAddon")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::WatchManagerForAddon {
