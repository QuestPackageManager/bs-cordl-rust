#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+IDebugManager")]
#[repr(C)]
#[derive(Debug)]
...
for crate::Meta::XR::ImmersiveDebugger::Manager::IDebugManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "IDebugManager";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+IDebugManager")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::IDebugManager {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+IDebugManager")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::IDebugManager {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+IDebugManager")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::IDebugManager {
