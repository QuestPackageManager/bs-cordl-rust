#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+WatchManager")]
#[repr(C)]
#[derive(Debug)]
pub struct WatchManager {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub WatchesDict: quest_hook::libil2cpp::Gc<
...
for crate::Meta::XR::ImmersiveDebugger::Manager::WatchManager {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "WatchManager";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+WatchManager")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::WatchManager {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+WatchManager")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::WatchManager {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+WatchManager")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::WatchManager {
            ...
            .get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<
                        ...
                        bool,
                        1usize,
                    >("IsMemberValidForWatch")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "IsMemberValidForWatch", 1usize
                        )
                    })
            });
