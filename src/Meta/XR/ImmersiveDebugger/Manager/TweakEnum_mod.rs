...
pub struct TweakEnum {
    ...
    pub _Tween_k__BackingField: f32,
}
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+TweakEnum")]
unsafe impl quest_hook::libil2cpp::Type for crate::Meta::XR::ImmersiveDebugger::Manager::TweakEnum {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "TweakEnum";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakEnum")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::TweakEnum {
    type Target = crate::Meta::XR::ImmersiveDebugger::Manager::Tweak;
    fn deref(&self) -> &<Self as std::ops::Deref>::Target {
        unsafe { &self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakEnum")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::TweakEnum {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakEnum")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::TweakEnum {
    pub fn New(
        ...
        quest_hook::libil2cpp::ObjectType::as_object_mut(__cordl_object)
            .invoke_void(".ctor", (memberInfo, instanceHandle, attribute, enumType))?;
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (memberInfo, instanceHandle, attribute, enumType))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_Member(
    ...
    pub fn set_Tween(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(f32), quest_hook::libil2cpp::Void, 1usize>("set_Tween")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
...
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+TweakEnum")]
impl quest_hook::libil2cpp::ObjectType for crate::Meta::XR::ImmersiveDebugger::Manager::TweakEnum {
