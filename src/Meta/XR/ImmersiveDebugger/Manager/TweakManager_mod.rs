#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+TweakManager")]
#[repr(C)]
#[derive(Debug)]
pub struct TweakManager {
    __cordl_parent: quest_hook::libil2cpp::Il2CppObject,
    pub TweaksDict: quest_hook::libil2cpp::Gc<
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::Manager::TweakManager
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "TweakManager";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakManager")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::TweakManager {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakManager")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::TweakManager {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakManager")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::TweakManager {
