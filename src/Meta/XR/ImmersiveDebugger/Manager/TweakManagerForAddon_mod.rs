#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+TweakManagerForAddon")]
#[repr(C)]
#[derive(Debug)]
pub struct TweakManagerForAddon {
    __cordl_parent: crate::Meta::XR::ImmersiveDebugger::Manager::SubManagerForAddon,
}
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+TweakManagerForAddon")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::Manager::TweakManagerForAddon
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "TweakManagerForAddon";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakManagerForAddon")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::TweakManagerForAddon {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakManagerForAddon")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::TweakManagerForAddon {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+TweakManagerForAddon")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::TweakManagerForAddon {
