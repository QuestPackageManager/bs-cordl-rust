#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+ActionHook")]
#[repr(C)]
#[derive(Debug)]
pub struct ActionHook {
    __cordl_parent: crate::Meta::XR::ImmersiveDebugger::Manager::Hook,
    pub _Delegate_k__BackingField: quest_hook::libil2cpp::Gc<crate::System::Action>,
}
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+ActionHook")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::Manager::ActionHook
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.Manager";
    const CLASS_NAME: &'static str = "ActionHook";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+ActionHook")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::Manager::ActionHook {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+ActionHook")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::Manager::ActionHook {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+Manager+ActionHook")]
impl crate::Meta::XR::ImmersiveDebugger::Manager::ActionHook {
    pub fn New(
...
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+Manager+ActionHook")]
impl quest_hook::libil2cpp::ObjectType for crate::Meta::XR::ImmersiveDebugger::Manager::ActionHook {
