...
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+IDebugUIPanel")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel {
...
impl crate::Meta::XR::ImmersiveDebugger::UserInterface::IDebugUIPanel {
    pub fn GetInspector(
        ...
        quest_hook::libil2cpp::Gc<crate::Meta::XR::ImmersiveDebugger::UserInterface::IInspector>,
    > {
    ...
    pub fn UnregisterInspector(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (instance, category, allCategories))?
        };
        Ok(__cordl_ret.into())
    }
