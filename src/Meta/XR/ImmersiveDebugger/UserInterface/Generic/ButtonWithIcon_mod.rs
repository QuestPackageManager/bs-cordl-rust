#[cfg(
    feature = "cordl_class_Meta+XR+ImmersiveDebugger+UserInterface+Generic+ButtonWithIcon"
)]
#[repr(C)]
#[derive(Debug)]
pub struct ButtonWithIcon {
    __cordl_parent: crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Button,
    pub _icon: quest_hook::libil2cpp::Gc<
    ...
    >,
    pub _iconStyle: quest_hook::libil2cpp::Gc<
        crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ImageStyle,
    >,
}
#[cfg(
...
for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon {
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.UserInterface.Generic";
    const CLASS_NAME: &'static str = "ButtonWithIcon";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+ButtonWithIcon")]
impl std::ops::Deref
for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+ButtonWithIcon")]
impl crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::ButtonWithIcon {
