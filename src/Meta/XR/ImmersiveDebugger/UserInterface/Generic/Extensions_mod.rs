#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+UserInterface+Generic+Extensions")]
#[repr(C)]
...
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Extensions {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+Extensions")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Extensions {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        crate::UnityEngine::Vector2,
                        bool,
                    ), quest_hook::libil2cpp::Void, 5usize>("SetSizeOptimized")
                    .unwrap_or_else(|e| {
                        panic!(
