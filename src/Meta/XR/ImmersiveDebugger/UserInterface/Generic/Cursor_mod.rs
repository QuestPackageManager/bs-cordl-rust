...
pub struct Cursor {
    ...
    pub _normal: crate::UnityEngine::Vector3,
    pub _hit: bool,
    pub _pressState: crate::UnityEngine::EventSystems::PointerEventData_FramePressState,
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor
{
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+Cursor")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+Cursor")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+Cursor")]
impl crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Cursor {
    pub const _pressedScale: f32 = 0.8f32;
    pub const _releasedScale: f32 = 1f32;
    pub fn Attach(
        &mut self,
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::Panel,
                    >), quest_hook::libil2cpp::Void, 1usize>("Attach")
                    .unwrap_or_else(|e| {
                        panic!(
    ...
    pub fn SetClickState(
        &mut self,
        state: crate::UnityEngine::EventSystems::PointerEventData_FramePressState,
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Void> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
    ...
    pub fn SetCursorStartDest(
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        crate::UnityEngine::Vector3,
                        crate::UnityEngine::Vector3,
                    ), quest_hook::libil2cpp::Void, 3usize>("SetCursorStartDest")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (start, dest, normal))? };
        Ok(__cordl_ret.into())
    }
