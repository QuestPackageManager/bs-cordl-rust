#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+UserInterface+Generic+OverlayCanvas")]
#[repr(C)]
...
pub struct OverlayCanvas {
    ...
    pub _quad: quest_hook::libil2cpp::Gc<crate::UnityEngine::Mesh>,
    pub _defaultMat: quest_hook::libil2cpp::Gc<crate::UnityEngine::Material>,
    pub _scaleViewport: bool,
    pub _Panel_k__BackingField: quest_hook::libil2cpp::Gc<
        crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvasPanel,
    >,
}
#[cfg(feature = "cordl_class_Meta+XR+ImmersiveDebugger+UserInterface+Generic+OverlayCanvas")]
unsafe impl quest_hook::libil2cpp::Type
    for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "Meta.XR.ImmersiveDebugger.UserInterface.Generic";
    const CLASS_NAME: &'static str = "OverlayCanvas";
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+OverlayCanvas")]
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+Generic+OverlayCanvas")]
impl crate::Meta::XR::ImmersiveDebugger::UserInterface::Generic::OverlayCanvas {
    pub const MaxTextureSize: i32 = 1600i32;
    pub const MinTextureSize: i32 = 200i32;
    pub const PixelsPerUnit: f32 = 1f32;
    ...
    pub fn ShouldRender(
        ...
        let __cordl_ret: bool = unsafe { cordl_method_info.invoke_unchecked(self, (baseCamera))? };
        Ok(__cordl_ret.into())
    }
