...
impl std::ops::Deref for crate::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry {
...
#[cfg(feature = "Meta+XR+ImmersiveDebugger+UserInterface+SeverityEntry")]
impl std::ops::DerefMut for crate::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry {
...
impl crate::Meta::XR::ImmersiveDebugger::UserInterface::SeverityEntry {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (owner, label, icon, imageStyle, pillStyle))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn set_ShouldShow(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(bool), quest_hook::libil2cpp::Void, 1usize>("set_ShouldShow")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
