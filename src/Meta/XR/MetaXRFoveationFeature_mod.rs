...
impl crate::Meta::XR::MetaXRFoveationFeature {
    pub const extensionList: &'static str =
        "XR_FB_foveation XR_FB_foveation_configuration XR_FB_foveation_vulkan ";
    ...
    pub fn FBGetFoveationDynamic(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (dynamic))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn FBSetFoveationLevel(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (session, level, verticalOffset, dynamic))?
        };
        Ok(__cordl_ret.into())
    }
