...
impl std::ops::Deref for crate::Meta::XR::MultiplayerBlocks::Shared::IAvatarStreamConfig {
...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Shared+IAvatarStreamConfig")]
impl std::ops::DerefMut for crate::Meta::XR::MultiplayerBlocks::Shared::IAvatarStreamConfig {
...
impl crate::Meta::XR::MultiplayerBlocks::Shared::IAvatarStreamConfig {
    pub fn SetAvatarStreamLOD(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (lod))? };
        Ok(__cordl_ret.into())
    }
