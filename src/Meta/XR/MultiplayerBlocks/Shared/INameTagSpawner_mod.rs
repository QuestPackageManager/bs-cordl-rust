...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Shared+INameTagSpawner")]
impl std::ops::Deref for crate::Meta::XR::MultiplayerBlocks::Shared::INameTagSpawner {
...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Shared+INameTagSpawner")]
impl std::ops::DerefMut for crate::Meta::XR::MultiplayerBlocks::Shared::INameTagSpawner {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Shared+INameTagSpawner")]
impl crate::Meta::XR::MultiplayerBlocks::Shared::INameTagSpawner {
    pub fn Spawn(
        &mut self,
