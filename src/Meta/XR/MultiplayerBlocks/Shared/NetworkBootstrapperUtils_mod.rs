...
impl std::ops::Deref for crate::Meta::XR::MultiplayerBlocks::Shared::NetworkBootstrapperUtils {
...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Shared+NetworkBootstrapperUtils")]
impl std::ops::DerefMut for crate::Meta::XR::MultiplayerBlocks::Shared::NetworkBootstrapperUtils {
...
impl crate::Meta::XR::MultiplayerBlocks::Shared::NetworkBootstrapperUtils {
    ...
    pub fn SetEntitlementIds(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            crate::Meta::XR::MultiplayerBlocks::Shared::NetworkBootstrapperParams,
                        >,
                    ), quest_hook::libil2cpp::Void, 2usize>("SetEntitlementIds")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (info, param))? };
        Ok(__cordl_ret.into())
    }
    pub fn SetUpAndStartAutomaticColocation(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked((), (param, anchorPrefab, networkData, networkMessenger))?
        };
        Ok(__cordl_ret.into())
    }
}
