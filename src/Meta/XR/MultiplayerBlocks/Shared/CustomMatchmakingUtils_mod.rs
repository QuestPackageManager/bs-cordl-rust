...
impl std::ops::Deref for crate::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmakingUtils {
...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Shared+CustomMatchmakingUtils")]
impl std::ops::DerefMut for crate::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmakingUtils {
...
impl crate::Meta::XR::MultiplayerBlocks::Shared::CustomMatchmakingUtils {
    pub fn DecodeMatchInfoWithStruct(
    ...
    ) -> quest_hook::libil2cpp::Result<crate::Meta::XR::MultiplayerBlocks::Shared::MatchInfo> {
        ...
        let __cordl_ret: crate::Meta::XR::MultiplayerBlocks::Shared::MatchInfo =
            unsafe { cordl_method_info.invoke_unchecked((), (matchInfoString))? };
        Ok(__cordl_ret.into())
    }
    ...
    ) -> quest_hook::libil2cpp::Result<quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString>>
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<quest_hook::libil2cpp::Il2CppString> =
            unsafe { cordl_method_info.invoke_unchecked((), (roomId, roomPassword, extra))? };
        Ok(__cordl_ret.into())
    }
