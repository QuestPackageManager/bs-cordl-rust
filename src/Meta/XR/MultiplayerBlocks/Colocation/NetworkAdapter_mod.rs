...
impl crate::Meta::XR::MultiplayerBlocks::Colocation::NetworkAdapter {
    pub fn SetConfig(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked((), (networkData, networkMessenger))?
        };
        Ok(__cordl_ret.into())
    }
