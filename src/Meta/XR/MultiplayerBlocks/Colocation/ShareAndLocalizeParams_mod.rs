    ...
    for crate::Meta::XR::MultiplayerBlocks::Colocation::ShareAndLocalizeParams
{
    ...
    const CLASS_NAME: &'static str = "ShareAndLocalizeParams";
...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Colocation+ShareAndLocalizeParams")]
