...
impl std::ops::Deref for crate::Meta::XR::MultiplayerBlocks::Colocation::INetworkMessenger {
...
#[cfg(feature = "Meta+XR+MultiplayerBlocks+Colocation+INetworkMessenger")]
impl std::ops::DerefMut for crate::Meta::XR::MultiplayerBlocks::Colocation::INetworkMessenger {
...
impl crate::Meta::XR::MultiplayerBlocks::Colocation::INetworkMessenger {
    pub fn RegisterLocalPlayer(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (localPlayerId))? };
        Ok(__cordl_ret.into())
    }
    pub fn SendAnchorShareCompleted(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info.invoke_unchecked(self, (targetPlayerId, shareAndLocalizeParams))?
        };
        Ok(__cordl_ret.into())
    }
