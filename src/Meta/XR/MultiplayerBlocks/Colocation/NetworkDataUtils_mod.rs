...
impl crate::Meta::XR::MultiplayerBlocks::Colocation::NetworkDataUtils {
    ...
    > {
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            ...
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetAllPlayersColocatedWith", 2usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked((), (oculusId, includeMyself))?
        };
        Ok(__cordl_ret.into())
    }
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    ...
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            < Self as quest_hook::libil2cpp::Type > ::class(),
                            "GetAllPlayersFromColocationGroupId", 1usize
                        )
                    })
            });
        let __cordl_ret: quest_hook::libil2cpp::Gc<
    ...
    pub fn GetOculusIdOfColocatedGroupOwnerFromColocationGroupId(
        ...
        let __cordl_ret: crate::System::Nullable_1<u64> = unsafe {
            cordl_method_info.invoke_unchecked((), (colocationGroupId))?
        };
        Ok(__cordl_ret.into())
    }
