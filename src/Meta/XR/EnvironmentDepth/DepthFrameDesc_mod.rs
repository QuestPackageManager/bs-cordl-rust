...
pub struct DepthFrameDesc {
    ...
    pub fovLeftAngleTangent: f32,
    pub fovRightAngleTangent: f32,
    pub fovTopAngleTangent: f32,
    pub fovDownAngleTangent: f32,
    pub nearZ: f32,
    pub farZ: f32,
}
#[cfg(feature = "cordl_class_Meta+XR+EnvironmentDepth+DepthFrameDesc")]
unsafe impl quest_hook::libil2cpp::Type for crate::Meta::XR::EnvironmentDepth::DepthFrameDesc {
    ...
    const CLASS_NAME: &'static str = "DepthFrameDesc";
...
#[cfg(feature = "Meta+XR+EnvironmentDepth+DepthFrameDesc")]
impl crate::Meta::XR::EnvironmentDepth::DepthFrameDesc {}
