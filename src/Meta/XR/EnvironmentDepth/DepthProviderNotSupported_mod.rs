...
#[cfg(feature = "Meta+XR+EnvironmentDepth+DepthProviderNotSupported")]
impl std::ops::DerefMut for crate::Meta::XR::EnvironmentDepth::DepthProviderNotSupported {
...
impl crate::Meta::XR::EnvironmentDepth::DepthProviderNotSupported {
    pub fn Meta_XR_EnvironmentDepth_IDepthProvider_SetDepthEnabled(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (isEnabled, removeHands))? };
        Ok(__cordl_ret.into())
    }
    pub fn Meta_XR_EnvironmentDepth_IDepthProvider_TryGetUpdatedDepthTexture(
        ...
        frameDescriptors: quest_hook::libil2cpp::Gc<
            quest_hook::libil2cpp::Il2CppArray<crate::Meta::XR::EnvironmentDepth::DepthFrameDesc>,
        >,
        ...
        let __cordl_ret: bool =
            unsafe { cordl_method_info.invoke_unchecked(self, (depthTexture, frameDescriptors))? };
        Ok(__cordl_ret.into())
    }
