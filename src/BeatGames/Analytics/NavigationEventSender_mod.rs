...
impl std::ops::Deref for crate::BeatGames::Analytics::NavigationEventSender {
...
#[cfg(feature = "BeatGames+Analytics+NavigationEventSender")]
impl std::ops::DerefMut for crate::BeatGames::Analytics::NavigationEventSender {
