...
> crate::ModestTree::Util::ValuePair_3<T1, T2, T3> {
    ...
    where
        ...
        T3: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::ModestTree::Util::ValuePair_3<
            T1,
            T2,
            T3,
        > as quest_hook::libil2cpp::Type>::class()
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::ModestTree::Util::ValuePair_3 < T1, T2, T3 > as
            ...
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (first, second, third))?
        };
        Ok(__cordl_ret.into())
    }
}
...
for crate::ModestTree::Util::ValuePair_3<T1, T2, T3> {
