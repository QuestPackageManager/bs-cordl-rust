#[cfg(feature = "cordl_class_ModestTree+MiscExtensions")]
#[repr(C)]
#[derive(Debug)]
...
impl crate::ModestTree::MiscExtensions {
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IList_1<T>>,
                    ), quest_hook::libil2cpp::Void, 2usize>("AllocFreeAddRange")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (list, items))? };
        Ok(__cordl_ret.into())
    }
    pub fn Fmt(
    ...
    where
        TKey: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
        TVal: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument
            + quest_hook::libil2cpp::Returned,
    {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
        ...
        let __cordl_ret: TVal =
            unsafe { cordl_method_info.invoke_unchecked((), (dictionary, key))? };
        Ok(__cordl_ret.into())
    }
    pub fn IndexOf<T>(
        list: quest_hook::libil2cpp::Gc<crate::System::Collections::Generic::IList_1<T>>,
            ...
            + quest_hook::libil2cpp::Returned,
    {
            ...
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        >,
                        T,
                    ), quest_hook::libil2cpp::Void, 2usize>("RemoveWithConfirm")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked((), (set, item))? };
        Ok(__cordl_ret.into())
    }
