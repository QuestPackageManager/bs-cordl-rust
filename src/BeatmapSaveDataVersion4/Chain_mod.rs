#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+Chain")]
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+Chain")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataVersion4::Chain {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "BeatmapSaveDataVersion4";
    const CLASS_NAME: &'static str = "Chain";
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+Chain")]
unsafe impl quest_hook::libil2cpp::ThisArgument for crate::BeatmapSaveDataVersion4::Chain {
    type Type = Self;
