#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+LightColorEventBox")]
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+LightColorEventBox")]
unsafe impl quest_hook::libil2cpp::Type for crate::BeatmapSaveDataVersion4::LightColorEventBox {
    type Held<'a> = Self;
    type HeldRaw = Self;
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+LightColorEventBox")]
unsafe impl quest_hook::libil2cpp::Argument for crate::BeatmapSaveDataVersion4::LightColorEventBox {
    type Type = Self;
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+LightColorEventBox")]
unsafe impl quest_hook::libil2cpp::Returned for crate::BeatmapSaveDataVersion4::LightColorEventBox {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_BeatmapSaveDataVersion4+LightColorEventBox")]
unsafe impl quest_hook::libil2cpp::Return for crate::BeatmapSaveDataVersion4::LightColorEventBox {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
