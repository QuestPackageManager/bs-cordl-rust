...
impl crate::MS::Internal::Xml::XPath::Function {
    ...
    pub fn _ctor_Function_FunctionType_AstNode2(
        ...
        static method: &'static quest_hook::libil2cpp::MethodInfo = <crate::MS::Internal::Xml::XPath::Function as quest_hook::libil2cpp::Type>::class()
            .find_method::<
                (
            ...
            .unwrap_or_else(|e| {
                panic!(
                    ...
                    crate ::MS::Internal::Xml::XPath::Function as
                    quest_hook::libil2cpp::Type > ::class(), ".ctor", 2usize
                )
            });
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ftype, arg))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Function_FunctionType_List_1_0(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (ftype, argumentList))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor_Il2CppString_Il2CppString_List_1_1(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            method.invoke_unchecked(self, (prefix, name, argumentList))?
        };
        Ok(__cordl_ret.into())
    }
