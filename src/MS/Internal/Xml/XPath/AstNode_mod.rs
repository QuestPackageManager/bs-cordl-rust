...
impl crate::MS::Internal::Xml::XPath::AstNode {
    ...
    pub fn get_ReturnType(
        ...
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::System::Xml::XPath::XPathResultType, 0usize>(
                        "get_ReturnType",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::System::Xml::XPath::XPathResultType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
    pub fn get_Type(
        &mut self,
    ) -> quest_hook::libil2cpp::Result<crate::MS::Internal::Xml::XPath::AstNode_AstType> {
        static METHOD: std::sync::OnceLock<&'static quest_hook::libil2cpp::MethodInfo> =
            std::sync::OnceLock::new();
        let cordl_method_info: &'static quest_hook::libil2cpp::MethodInfo =
            METHOD.get_or_init(|| {
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(), crate::MS::Internal::Xml::XPath::AstNode_AstType, 0usize>(
                        "get_Type",
                    )
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: crate::MS::Internal::Xml::XPath::AstNode_AstType =
            unsafe { cordl_method_info.invoke_unchecked(self, ())? };
        Ok(__cordl_ret.into())
    }
}
...
#[cfg(feature = "cordl_class_MS+Internal+Xml+XPath+AstNode+AstType")]
unsafe impl quest_hook::libil2cpp::Type for crate::MS::Internal::Xml::XPath::AstNode_AstType {
    type Held<'a> = Self;
    type HeldRaw = Self;
    const NAMESPACE: &'static str = "MS.Internal.Xml.XPath";
...
#[cfg(feature = "cordl_class_MS+Internal+Xml+XPath+AstNode+AstType")]
unsafe impl quest_hook::libil2cpp::Argument for crate::MS::Internal::Xml::XPath::AstNode_AstType {
    type Type = Self;
...
#[cfg(feature = "cordl_class_MS+Internal+Xml+XPath+AstNode+AstType")]
unsafe impl quest_hook::libil2cpp::Parameter for crate::MS::Internal::Xml::XPath::AstNode_AstType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_MS+Internal+Xml+XPath+AstNode+AstType")]
unsafe impl quest_hook::libil2cpp::Returned for crate::MS::Internal::Xml::XPath::AstNode_AstType {
    type Type = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
...
#[cfg(feature = "cordl_class_MS+Internal+Xml+XPath+AstNode+AstType")]
unsafe impl quest_hook::libil2cpp::Return for crate::MS::Internal::Xml::XPath::AstNode_AstType {
    type Actual = Self;
    fn matches(ty: &quest_hook::libil2cpp::Il2CppType) -> bool {
