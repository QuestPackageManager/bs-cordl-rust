...
#[cfg(feature = "cordl_class_MS+Internal+Xml+Cache+XPathNodeHelper")]
unsafe impl quest_hook::libil2cpp::Type for crate::MS::Internal::Xml::Cache::XPathNodeHelper {
...
impl crate::MS::Internal::Xml::Cache::XPathNodeHelper {
    pub fn GetInScopeNamespaces(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_static_method::<(
                        ...
                        quest_hook::libil2cpp::ByRefMut<
                            ...
                            >,
                        >,
                    ), i32, 3usize>("GetInScopeNamespaces")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (pageElem, idxElem, pageNmsp))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetLocation(
        ...
        let __cordl_ret: i32 =
            unsafe { cordl_method_info.invoke_unchecked((), (pageNode, idxNode))? };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn GetTextFollowing(
        ...
        let __cordl_ret: bool = unsafe {
            cordl_method_info.invoke_unchecked((), (pageCurrent, idxCurrent, pageEnd, idxEnd))?
        };
        Ok(__cordl_ret.into())
    }
}
#[cfg(feature = "cordl_class_MS+Internal+Xml+Cache+XPathNodeHelper")]
impl quest_hook::libil2cpp::ObjectType for crate::MS::Internal::Xml::Cache::XPathNodeHelper {
