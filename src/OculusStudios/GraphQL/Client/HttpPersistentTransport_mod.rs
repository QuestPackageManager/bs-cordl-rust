...
#[cfg(feature = "OculusStudios+GraphQL+Client+HttpPersistentTransport")]
impl std::ops::DerefMut for crate::OculusStudios::GraphQL::Client::HttpPersistentTransport {
...
impl crate::OculusStudios::GraphQL::Client::HttpPersistentTransport {
    ...
    > {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<
            ...
            >,
        > = unsafe {
            cordl_method_info.invoke_unchecked(self, (graphQLRequest, MinimalMainThreadExecutor))?
        };
        Ok(__cordl_ret.into())
    }
    ...
    pub fn ReadFromStream(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(
                        ...
                        quest_hook::libil2cpp::Gc<
                            crate::OculusStudios::GraphQL::Client::MinimalMainThreadExecutor,
                        >,
                    ), quest_hook::libil2cpp::Void, 3usize>("ReadFromStream")
                    .unwrap_or_else(|e| {
                        panic!(
                            "no matching methods found for non-void {}.{}({}) Cause: {e:?}",
                            <Self as quest_hook::libil2cpp::Type>::class(),
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (liveQuery, responseStream, MinimalMainThreadExecutor))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
