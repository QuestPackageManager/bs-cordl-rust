...
#[cfg(feature = "cordl_class_OculusStudios+GraphQL+Client+ConcreteListConverter_2")]
unsafe impl<I: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    quest_hook::libil2cpp::Type
    for crate::OculusStudios::GraphQL::Client::ConcreteListConverter_2<I, T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OculusStudios.GraphQL.Client";
    const CLASS_NAME: &'static str = "ConcreteListConverter`2";
...
#[cfg(feature = "OculusStudios+GraphQL+Client+ConcreteListConverter_2")]
impl<I: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type> std::ops::Deref
    for crate::OculusStudios::GraphQL::Client::ConcreteListConverter_2<I, T>
{
...
#[cfg(feature = "OculusStudios+GraphQL+Client+ConcreteListConverter_2")]
impl<I: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type> std::ops::DerefMut
    for crate::OculusStudios::GraphQL::Client::ConcreteListConverter_2<I, T>
{
...
#[cfg(feature = "OculusStudios+GraphQL+Client+ConcreteListConverter_2")]
impl<I: quest_hook::libil2cpp::Type, T: quest_hook::libil2cpp::Type>
    crate::OculusStudios::GraphQL::Client::ConcreteListConverter_2<I, T>
{
    pub fn CanConvert(
        &mut self,
