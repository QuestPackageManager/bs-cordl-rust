...
impl std::ops::Deref for crate::OculusStudios::GraphQL::Client::QueryRequest {
...
#[cfg(feature = "OculusStudios+GraphQL+Client+QueryRequest")]
impl std::ops::DerefMut for crate::OculusStudios::GraphQL::Client::QueryRequest {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "OculusStudios+GraphQL+Client+QueryRequest")]
impl crate::OculusStudios::GraphQL::Client::QueryRequest {
