#[cfg(feature = "cordl_class_OculusStudios+GraphQL+Client+NestedFragmentConverter_1")]
#[repr(C)]
#[cfg_attr(feature = "derive_Debug", derive(Debug))]
pub struct NestedFragmentConverter_1<T: quest_hook::libil2cpp::Type> {
    __cordl_parent: crate::Newtonsoft::Json::JsonConverter,
    __cordl_phantom_T: std::marker::PhantomData<T>,
}
#[cfg(feature = "cordl_class_OculusStudios+GraphQL+Client+NestedFragmentConverter_1")]
unsafe impl<T: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::OculusStudios::GraphQL::Client::NestedFragmentConverter_1<T>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OculusStudios.GraphQL.Client";
    const CLASS_NAME: &'static str = "NestedFragmentConverter`1";
...
#[cfg(feature = "OculusStudios+GraphQL+Client+NestedFragmentConverter_1")]
...
impl<T: quest_hook::libil2cpp::Type>
    crate::OculusStudios::GraphQL::Client::NestedFragmentConverter_1<T>
{
    pub fn CanConvert(
        &mut self,
