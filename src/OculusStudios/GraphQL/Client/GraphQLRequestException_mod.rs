...
unsafe impl quest_hook::libil2cpp::Type
    for crate::OculusStudios::GraphQL::Client::GraphQLRequestException
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OculusStudios.GraphQL.Client";
    const CLASS_NAME: &'static str = "GraphQLRequestException";
...
#[cfg(feature = "OculusStudios+GraphQL+Client+GraphQLRequestException")]
impl std::ops::Deref for crate::OculusStudios::GraphQL::Client::GraphQLRequestException {
...
#[cfg(feature = "OculusStudios+GraphQL+Client+GraphQLRequestException")]
impl std::ops::DerefMut for crate::OculusStudios::GraphQL::Client::GraphQLRequestException {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "OculusStudios+GraphQL+Client+GraphQLRequestException")]
impl crate::OculusStudios::GraphQL::Client::GraphQLRequestException {
