#[cfg(feature = "cordl_class_OculusStudios+GraphQL+Client+DateTimeConverter")]
#[repr(C)]
...
unsafe impl quest_hook::libil2cpp::Type
    for crate::OculusStudios::GraphQL::Client::DateTimeConverter
{
...
#[cfg(feature = "OculusStudios+GraphQL+Client+DateTimeConverter")]
impl std::ops::Deref for crate::OculusStudios::GraphQL::Client::DateTimeConverter {
...
#[cfg(feature = "OculusStudios+GraphQL+Client+DateTimeConverter")]
impl std::ops::DerefMut for crate::OculusStudios::GraphQL::Client::DateTimeConverter {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "OculusStudios+GraphQL+Client+DateTimeConverter")]
impl crate::OculusStudios::GraphQL::Client::DateTimeConverter {
    pub fn CanConvert(
        &mut self,
