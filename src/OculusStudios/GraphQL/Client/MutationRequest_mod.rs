...
pub struct MutationRequest {
    ...
    pub performRequestCalled: quest_hook::libil2cpp::Gc<
        ...
        >,
    >,
    pub mutation: quest_hook::libil2cpp::Gc<
...
impl crate::OculusStudios::GraphQL::Client::MutationRequest {
    ...
    pub fn _ctor(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (mutation, forceRequestWhenOffline))?
        };
        Ok(__cordl_ret.into())
    }
...
for crate::OculusStudios::GraphQL::Client::MutationRequest {
    fn as_mut(
        &mut self,
    ) -> &mut crate::OculusStudios::GraphQL::ClientInterface::IMutationRequest {
        unsafe { std::mem::transmute(self) }
    }
}
