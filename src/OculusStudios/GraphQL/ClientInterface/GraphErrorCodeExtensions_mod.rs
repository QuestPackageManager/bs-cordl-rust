#[cfg(
    feature = "cordl_class_OculusStudios+GraphQL+ClientInterface+GraphErrorCodeExtensions"
)]
#[repr(C)]
#[derive(Debug)]
...
impl crate::OculusStudios::GraphQL::ClientInterface::GraphErrorCodeExtensions {
    ...
    > {
        ...
        let __cordl_ret: crate::OculusStudios::GraphQL::ClientInterface::GraphErrorCode = unsafe {
