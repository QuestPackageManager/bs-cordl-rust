#[cfg(
    feature = "cordl_class_OculusStudios+GraphQL+ClientInterface+IRequestWithResultConversion_2"
)]
#[repr(C)]
#[derive(Debug)]
...
> {
    ...
    >
    where
        TBackend: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
        TFrontend: quest_hook::libil2cpp::Type + quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Argument + quest_hook::libil2cpp::Returned,
    {
