...
#[cfg(feature = "cordl_class_OculusStudios+Platform+Core+Product")]
unsafe impl quest_hook::libil2cpp::Type for crate::OculusStudios::Platform::Core::Product {
...
impl crate::OculusStudios::Platform::Core::Product {
    ...
    pub fn SetChildren(
                ...
                <Self as quest_hook::libil2cpp::Type>::class()
                    .find_method::<(quest_hook::libil2cpp::Gc<
                        crate::System::Collections::Generic::List_1<
                            ...
                            >,
                        >,
                    >), quest_hook::libil2cpp::Void, 1usize>("SetChildren")
                    .unwrap_or_else(|e| {
                        panic!(
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void =
            unsafe { cordl_method_info.invoke_unchecked(self, (children))? };
        Ok(__cordl_ret.into())
    }
    pub fn _ctor(
        &mut self,
        ...
        let __cordl_ret: quest_hook::libil2cpp::Void = unsafe {
            cordl_method_info
                .invoke_unchecked(self, (definition, idForVendor, dlcInstallStatus, selfOwned))?
        };
        Ok(__cordl_ret.into())
    }
    pub fn get_children(
...
#[cfg(feature = "cordl_class_OculusStudios+Platform+Core+Product")]
impl quest_hook::libil2cpp::ObjectType for crate::OculusStudios::Platform::Core::Product {
