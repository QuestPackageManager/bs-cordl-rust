...
impl std::ops::Deref for crate::OculusStudios::Platform::Core::MockedEntitlements {
...
#[cfg(feature = "OculusStudios+Platform+Core+MockedEntitlements")]
impl std::ops::DerefMut for crate::OculusStudios::Platform::Core::MockedEntitlements {
    fn deref_mut(&mut self) -> &mut <Self as std::ops::Deref>::Target {
        unsafe { &mut self.__cordl_parent }
    }
}
#[cfg(feature = "OculusStudios+Platform+Core+MockedEntitlements")]
impl crate::OculusStudios::Platform::Core::MockedEntitlements {
