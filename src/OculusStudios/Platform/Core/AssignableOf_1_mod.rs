...
unsafe impl<TBase: quest_hook::libil2cpp::Type> quest_hook::libil2cpp::Type
    for crate::OculusStudios::Platform::Core::AssignableOf_1<TBase>
{
    type Held<'a> = ::std::option::Option<&'a mut Self>;
    type HeldRaw = *mut Self;
    const NAMESPACE: &'static str = "OculusStudios.Platform.Core";
    const CLASS_NAME: &'static str = "AssignableOf`1";
...
#[cfg(feature = "OculusStudios+Platform+Core+AssignableOf_1")]
...
impl<TBase: quest_hook::libil2cpp::Type>
    crate::OculusStudios::Platform::Core::AssignableOf_1<TBase>
{
    pub fn New(
    ...
    pub fn op_Implicit_AssignableOf_1_1(
            ...
            + quest_hook::libil2cpp::Returned,
    {
        ...
        let __cordl_ret: quest_hook::libil2cpp::Gc<crate::System::Type> =
            unsafe { cordl_method_info.invoke_unchecked((), (wrapper))? };
        Ok(__cordl_ret.into())
    }
    pub fn op_Implicit_Type0(
        obj: quest_hook::libil2cpp::Gc<crate::System::Type>,
    ) -> quest_hook::libil2cpp::Result<
        quest_hook::libil2cpp::Gc<crate::OculusStudios::Platform::Core::AssignableOf_1<TBase>>,
    >
    where
        TBase: quest_hook::libil2cpp::Type
            + quest_hook::libil2cpp::Type
